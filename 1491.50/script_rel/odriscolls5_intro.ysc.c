...
BOOL func_29(var uParam0) // Position - 0x1579 Hash - 0x4A050335 ^0x216F0993
{
	int i;
	...
	PED::_SET_AMBIENT_PED_DENSITY_MULTIPLIER_THIS_FRAME(0.7f);
	VEHICLE::SET_RANDOM_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0.7f);
	func_131(uParam0, Global_35, 0, 0, 0, true);

	if (!ENTITY::IS_ENTITY_DEAD(pedLocal_25))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_25, true);
		WEAPON::SET_CURRENT_PED_WEAPON(pedLocal_25, joaat("WEAPON_UNARMED"), true, 0, false, false);
		func_139(pedLocal_25, func_138(0, 0), 2, 1073741824);
		func_131(uParam0, pedLocal_25, 0, 0, 0, true);
		func_140(uParam0, pedLocal_25, false);
	}

	if (!ENTITY::IS_ENTITY_DEAD(pedLocal_26))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_26, true);
		WEAPON::SET_CURRENT_PED_WEAPON(pedLocal_26, joaat("WEAPON_UNARMED"), true, 0, false, false);
		func_139(pedLocal_26, func_138(0, 1), 2, 1073741824);
		func_131(uParam0, pedLocal_26, 0, 0, 0, true);
		func_140(uParam0, pedLocal_26, false);
	}

	if (!ENTITY::IS_ENTITY_DEAD(pedLocal_27))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_27, true);
		func_139(pedLocal_27, func_138(0, 2), 2, 1073741824);
		func_131(uParam0, pedLocal_27, 0, 0, 0, true);
		func_140(uParam0, pedLocal_27, false);
	}
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[i]) && i == 2 || i == 1 || i == 0 || i == 6)
		{
			func_142(uParam0, isLocal_14.f_2[i], 0, 0, 0, true, false);
			func_140(uParam0, isLocal_14.f_2[i], false);
		}
	}

	for (i = 0; i < 7; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[i]) && i == 5 || i == 4 || i == 3)
		{
			if (i == 4)
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(ansLocal_24, "p_cs_sacklarge01x^1", isLocal_14.f_2[i], 0);
			else
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(ansLocal_24, func_143(isLocal_14.f_2[i]), isLocal_14.f_2[i], 0);
		
			func_144(&(uParam0->f_428), isLocal_14.f_2[i], func_143(isLocal_14.f_2[i]), 0, 0, false);
		}
	}

	ANIMSCENE::START_ANIM_SCENE(ansLocal_24);
	volLocal_30 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2793.85f, -1169.772f, 47.924f, 0f, 0f, 59.473335f, 7.5f, 7f, 3.115668f, "m_sbiIntroBlockingVolume");
	anLocal_31 = func_145(volLocal_30, 0, false, 0);
	func_146(-74215266, true, 0, false, false, 0, false, false);
	return true;
}

BOOL func_30(int iParam0) // Position - 0x17C2 Hash - 0x73030ECA ^0x73030ECA
{
...
int func_31(int iParam0) // Position - 0x17E1 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_81(iParam0))
		return 0;
...
int func_32(int iParam0) // Position - 0x1801 Hash - 0x6B3238EF ^0x6B3238EF
{
	int i;
...
void func_33(var uParam0) // Position - 0x1842 Hash - 0xCB18FF6A ^0x66639F66
{
	var scriptName;
...
void func_34(var uParam0) // Position - 0x185C Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_35(var uParam0) // Position - 0x1864 Hash - 0x83855E48 ^0x18FFB4E2
{
	func_56(uParam0);
	func_2(&Global_1935630, 32768);
	func_148(uParam0);
...
int func_36(var uParam0) // Position - 0x1990 Hash - 0xEE957788 ^0xA3E8E28F
{
	int i;

	PED::REMOVE_SCENARIO_BLOCKING_AREA(anLocal_31, false);
	func_154(138, false, true, false, false);

	for (i = 0; i < 7; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[i]))
			func_140(uParam0, isLocal_14.f_2[i], false);
	}
...
void func_37(int iParam0) // Position - 0x19DA Hash - 0x1B8AD279 ^0xAD8E3F31
{
	int num;
	const char* name;
...
void func_38(var uParam0) // Position - 0x1A3A Hash - 0x1A9741E5 ^0x2BC1F7E8
{
	var unk;
	var unk4;
...
int func_39(var uParam0) // Position - 0x1AEE Hash - 0x3B93AF13 ^0x17E25A09
{
	if (func_158() > 0.8f)
		func_159(0.8f);

	if (!bLocal_28 && func_160(Global_35, pedLocal_25, true, true) < 15f && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(0, 0, 0) && func_162(&(uParam0->f_958.f_1771), func_161("ODR5_DUTSADBNT"), false, -1, false, false))
		bLocal_28 = true;

	return 1;
}

BOOL func_40(int iParam0, int iParam1) // Position - 0x1B55 Hash - 0x7572A314 ^0x4B13FBB8
{
	return func_30(iParam0) && Global_1898346[iParam0 /*6*/].f_1 && iParam1 != false;
}

BOOL func_41(var uParam0) // Position - 0x1B77 Hash - 0x3FAFCBCF ^0x3FAFCBCF
{
	if (func_7(uParam0))
	{
		func_164(&(uParam0->f_958), func_163(uParam0), uParam0->f_958, false);
...
BOOL func_42(var uParam0, int iParam1) // Position - 0x1BCE Hash - 0xE749F1D9 ^0xE749F1D9
{
	return func_63(&(uParam0->f_958), iParam1);
}

void func_43(var uParam0) // Position - 0x1BE1 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_44(var uParam0) // Position - 0x1BE9 Hash - 0x62EFFC31 ^0x62EFFC31
{
	if (func_7(uParam0))
		return func_164(&(uParam0->f_958), func_163(uParam0), uParam0->f_958, false);

	return func_106(uParam0);
}

BOOL func_45(int iParam0, int iParam1) // Position - 0x1C18 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_46(var uParam0) // Position - 0x1C27 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_47(var uParam0) // Position - 0x1C2F Hash - 0x459AE2FC ^0x7FCFE727
{
...
float func_48(var uParam0) // Position - 0x1C8B Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_18(uParam0))
		return uParam0->f_1;
...
float func_49(var uParam0) // Position - 0x1CC0 Hash - 0x9BB76AD4 ^0x9BB76AD4
{
	return uParam0->f_2887;
}

int func_50(var uParam0) // Position - 0x1CCD Hash - 0x51136ED0 ^0x51136ED0
{
	return *uParam0;
}

void func_51(var uParam0) // Position - 0x1CD8 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_52(var uParam0) // Position - 0x1CE0 Hash - 0x277B5DDC ^0x1F100BD7
{
	var unk;
	BOOL flag;
...
BOOL func_53(var uParam0) // Position - 0x1DA0 Hash - 0x628F6845 ^0x88CA8099
{
	int i;
	...
	if (!func_5(uParam0, 1024))
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[i]))
				OBJECT::DELETE_OBJECT(&isLocal_14.f_2[i]);
		}
	}
...
void func_54(var uParam0) // Position - 0x1DF7 Hash - 0x3BACEE7F ^0x78661F61
{
...
void func_55(var uParam0) // Position - 0x1E14 Hash - 0xB0D02BD0 ^0xD08373B5
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_425))
	{
...
void func_56(var uParam0) // Position - 0x1E68 Hash - 0xE2CC04A7 ^0x2A331FD5
{
	BOOL flag;
	BOOL flag2;
	eStackSize i;
...
void func_57(var uParam0) // Position - 0x1EF1 Hash - 0x4DD6AE05 ^0xF30F3284
{
	func_173(&(uParam0->f_8), &(uParam0->f_24), &(uParam0->f_35), &(uParam0->f_51), &(uParam0->f_55), &(uParam0->f_57), &(uParam0->f_393), &(uParam0->f_398), &(uParam0->f_404), &(uParam0->f_408), &(uParam0->f_412), &(uParam0->f_417), -1);
	return;
}

int func_58(var uParam0) // Position - 0x1F34 Hash - 0xE1806B8B ^0x92A87595
{
	int i;
...
void func_59(int iParam0) // Position - 0x1FAB Hash - 0x7B2832AA ^0x5B57D776
{
	if (!func_81(iParam0))
		return;
...
void func_60(int iParam0) // Position - 0x1FE1 Hash - 0x4260FC74 ^0xBC5A0A21
{
	if (!func_81(iParam0))
		return;
...
void func_61(BOOL bParam0) // Position - 0x2001 Hash - 0xAD1429D0 ^0xAD1429D0
{
	if (bParam0)
...
void func_62() // Position - 0x203F Hash - 0x4AC3BB62 ^0x697E6320
{
	eStackSize i;
	eStackSize stackSize;
	Ped ped;
...
BOOL func_63(var uParam0, int iParam1) // Position - 0x20A4 Hash - 0x6B2D4FF8 ^0x6B2D4FF8
{
	return uParam0->f_1664 && iParam1 != false;
}

void func_64(var uParam0) // Position - 0x20B6 Hash - 0xD2C7E52D ^0xD2F1F334
{
	int i;
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x2171 Hash - 0x42AB6152 ^0x293FEC39
{
	int i;
...
void func_66(var uParam0, int iParam1) // Position - 0x2232 Hash - 0xA4EAD31F ^0x77D45044
{
	uParam0->f_2 = uParam0->f_2 - uParam0->f_2 && iParam1;
	return;
}

void func_67(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x224A Hash - 0x7990926B ^0xBD6909E0
{
	AUDIO::_STOP_ALL_SCRIPTED_CONVERSIONS(bParam0, bParam1, bParam2);
	return;
}

void func_68() // Position - 0x225C Hash - 0xAF223956 ^0x1583E805
{
	int num;

	if (func_178(Global_1898437) && func_179(Global_1898437) == 1)
	{
		num = func_180(Global_1898437);
...
int func_69(var uParam0) // Position - 0x22CC Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

void func_70(var uParam0) // Position - 0x22D5 Hash - 0xC3FF5F57 ^0xC3FF5F57
{
	var unk;

	unk = { func_181(uParam0) };
	func_182(uParam0, &unk);
	return;
}

void func_71(var uParam0) // Position - 0x22F0 Hash - 0xB8BC3099 ^0xE98994D
{
	var name;
	var name2;
...
void func_72(int iParam0) // Position - 0x238F Hash - 0xA1813BF8 ^0x43F7F42C
{
	var textBlock;
...
void func_73(int iParam0) // Position - 0x23B2 Hash - 0xA1813BF8 ^0x43F7F42C
{
	var textBlock;
...
BOOL func_74(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x23D5 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_180(Global_1898164.f_1[0 /*5*/]);
...
void func_75(var uParam0, int iParam1) // Position - 0x25D9 Hash - 0xB961644E ^0xB961644E
{
	func_96(&(uParam0->f_428), iParam1);
	return;
}

void func_76(var uParam0) // Position - 0x25EC Hash - 0x1CCC9FAE ^0x1CCC9FAE
{
	func_193(&(uParam0->f_428), &(uParam0->f_958));
	return;
}

BOOL func_77(var uParam0, const char* sParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2602 Hash - 0xB6AB086B ^0x5535D393
{
	var unk;
	float num;
...
void func_78(int iParam0, int iParam1) // Position - 0x299E Hash - 0xD320CA35 ^0x5C62EB93
{
	if (!func_30(iParam0))
		return;
...
BOOL func_79(int iParam0) // Position - 0x29D5 Hash - 0xDFF4679C ^0x26F038D0
{
...
Ped func_80(int iParam0) // Position - 0x2A7F Hash - 0x10419DB6 ^0x10419DB6
{
...
BOOL func_81(int iParam0) // Position - 0x2AAB Hash - 0x77BA7B03 ^0x77BA7B03
{
	return iParam0 > -1 && iParam0 <= 80;
}

void func_82(var uParam0, const char* sParam1) // Position - 0x2AC1 Hash - 0x97F7326 ^0x6639CFA8
{
	int num;
...
BOOL func_83(var uParam0, int iParam1) // Position - 0x2B39 Hash - 0x718DD1EF ^0x5F4D390E
{
	return uParam0->f_8 && iParam1 != false;
}

void func_84(var uParam0) // Position - 0x2B4A Hash - 0xFCCC8B7D ^0xB8745C5D
{
	BOOL flag;
	int currentMessage;
	BOOL flag2;
...
void func_85(var uParam0, char* sParam1) // Position - 0x2C57 Hash - 0xA419EFA1 ^0x99DB3BF
{
	var unk;
	var unk9;
...
void func_86(var uParam0, int iParam1) // Position - 0x2D5F Hash - 0x77441219 ^0x1DE6F6A1
{
	*uParam0 = iParam1;
	func_26(&(uParam0->f_1));
	return;
...
BOOL func_87(var uParam0, int iParam1) // Position - 0x2D74 Hash - 0x6B2D4FF8 ^0x6B2D4FF8
{
	return uParam0->f_439 && iParam1 != false;
}

void func_88(var uParam0) // Position - 0x2D86 Hash - 0xC673333B ^0xFC27ADE6
{
...
Vector3 func_89(var uParam0) // Position - 0x2DE7 Hash - 0xD2D3D44D ^0x694345D8
{
	return uParam0->f_5;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2DF5 Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_91(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2E1F Hash - 0x4F47D7F1 ^0x1C676405
{
...
void func_92(BOOL bParam0) // Position - 0x2E7A Hash - 0x70653DE9 ^0x49B958F9
{
...
void func_93(BOOL bParam0, BOOL bParam1) // Position - 0x2EAE Hash - 0xBAE5AEB2 ^0x9ABFBA0B
{
	if (func_231())
...
void func_94(var uParam0) // Position - 0x2EDD Hash - 0x44102911 ^0x57A42251
{
	var unk;
	...
	if (!func_83(uParam0, 4))
	{
		...
		func_237(uParam0, 0f, 0f, 0f);
		func_238(uParam0);
		func_239(uParam0);
		func_240(uParam0, 0f, 0f, 0f, 0, false);
		func_241(uParam0);
		func_96(uParam0, 4);
		func_242(uParam0, false);
		func_243(&(Global_1946054.f_1497), Global_35, true, 64, true, true, true);
...
BOOL func_95(var uParam0, BOOL bParam1) // Position - 0x2F9D Hash - 0xC4864CFD ^0x7244F873
{
...
void func_96(var uParam0, int iParam1) // Position - 0x3028 Hash - 0x53A96DDB ^0x69C93C85
{
	uParam0->f_8 = uParam0->f_8 || iParam1;
	return;
}

int func_97(var uParam0) // Position - 0x303B Hash - 0xF7D2A495 ^0x426C6775
{
...
int func_98(var uParam0) // Position - 0x3078 Hash - 0xF7D2A495 ^0xF4909E0
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_444) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_444, false))
		return -1;
...
BOOL func_99(var uParam0, Ped pedParam1, int iParam2) // Position - 0x30B5 Hash - 0xC6E5AF5F ^0x4744F9B8
{
	int i;

	for (i = 0; i < 35; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_13[i /*12*/]) && uParam0->f_13[i /*12*/] == pedParam1 && func_244(&uParam0->f_13[i /*12*/], iParam2))
			return true;
	}
...
BOOL func_100(var uParam0) // Position - 0x3107 Hash - 0x3CCCD36D ^0x3C3A8A88
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_444))
		return true;
...
void func_101(var uParam0) // Position - 0x3164 Hash - 0xCD2CB56 ^0x848D9CDE
{
...
void func_102(var uParam0) // Position - 0x31AB Hash - 0x795EBF5D ^0x531CDFF2
{
...
void func_103(var uParam0, int iParam1, BOOL bParam2) // Position - 0x327F Hash - 0x4C22909C ^0xA24D6B06
{
...
void func_104(var uParam0, int iParam1) // Position - 0x32CC Hash - 0xFE5D8273 ^0x73A78C82
{
	if (Global_1935630.f_12)
		return;
	...
	{
		func_253(Global_35, -383172193, 0, 1742327865, false, true, false, false, true, false);
		func_254(joaat("kit_bandana"), false);
	}

	func_243(&(Global_1946054.f_1497), Global_35, true, 49217, true, true, true);
...
void func_105() // Position - 0x33DD Hash - 0xD4ABC353 ^0xB5896EA9
{
	Global_1935630.f_52 = 1;
	return;
}

BOOL func_106(var uParam0) // Position - 0x33EC Hash - 0xF077D70E ^0x7B568537
{
	BOOL isPedOnFoot;
	int num;
	...
	if (!func_5(uParam0, 1048576))
	{
		...
		else
		{
			...
			if (func_255(Global_35, &(uParam0->f_421), 0, SPC_LEAVE_CAMERA_CONTROL_ON, num, 1084227584, 100, 0, 0))
				PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), true, 0, false);
		}
	}
...
void func_107(int iParam0) // Position - 0x35C2 Hash - 0xB7DA3075 ^0x9010CBC
{
	int num;
...
void func_108(BOOL bParam0) // Position - 0x35EC Hash - 0x5D1342E6 ^0x2E0382D7
{
	if (bParam0)
	{
...
void func_109(int iParam0, int iParam1) // Position - 0x368F Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_110(int iParam0) // Position - 0x36A0 Hash - 0x4A1A3440 ^0xAE5E6967
{
	eStackSize i;
	...
	for (i = 0; i < 27; i = i + 1)
	{
		if (func_258(func_257(i), 0))
			if (PED::IS_PED_GROUP_MEMBER(func_257(i), func_259(), true))
				func_260(i, iParam0);
	}
...
void func_111(var uParam0) // Position - 0x36EE Hash - 0x6215D6B9 ^0xC793DEB6
{
	...
	func_261(true, 0, true);
	return;
}

void func_112(BOOL bParam0) // Position - 0x371A Hash - 0x6D9C7C2F ^0xEFFA22A7
{
	if (bParam0)
...
BOOL func_113(int iParam0, int iParam1) // Position - 0x37D2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_114(eStackSize essParam0) // Position - 0x37E1 Hash - 0xFD10BCB1 ^0xFD10BCB1
{
...
BOOL func_115(eStackSize essParam0) // Position - 0x3800 Hash - 0xDA629583 ^0xDA629583
{
	return func_265(essParam0, 16, true);
}

BOOL func_116(eStackSize essParam0) // Position - 0x3811 Hash - 0xC2BA9D92 ^0x340F97FF
{
...
BOOL func_117(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x3845 Hash - 0x3E30B0B5 ^0x3E30B0B5
{
	int num;
...
BOOL func_118(var uParam0) // Position - 0x38CE Hash - 0x39705408 ^0x39705408
{
	return func_113(*uParam0, 2);
}

float func_119() // Position - 0x38DE Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_120(var uParam0) // Position - 0x3910 Hash - 0xEDF5DFB4 ^0xAE1B7E7A
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_444))
		ANIMSCENE::_DELETE_ANIM_SCENE(uParam0->f_444);
...
void func_121(var uParam0, int iParam1) // Position - 0x392D Hash - 0x5F6D01C3 ^0x5F6D01C3
{
	func_266(uParam0, 4);
	func_267(uParam0, 10);
...
void func_122(var uParam0, float fParam1) // Position - 0x394D Hash - 0x30433BAB ^0xF854D531
{
...
void func_123(int iParam0, ItemSet isParam1, ItemSet isParam2, ItemSet isParam3) // Position - 0x3973 Hash - 0x68078886 ^0xC044E3DC
{
	if (!func_81(iParam0))
		return;
...
Vector3 func_124(var uParam0) // Position - 0x39DD Hash - 0x1BDFA5C4 ^0x1BDFA5C4
{
	return func_89(&(uParam0->f_428));
}

Vector3 func_125(var uParam0) // Position - 0x39EE Hash - 0xC8CA6991 ^0x9DE3152C
{
	var unk;
	var position;
	var rotation;
	...
	TEXT_LABEL_COPY(&unk, { func_272(uParam0) }, 8);
...
Vector3 func_126(int iParam0) // Position - 0x3A78 Hash - 0x3E6E91A9 ^0x3E6E91A9
{
	return func_184(iParam0);
}

void func_127(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3A86 Hash - 0x11E48EAB ^0x11E48EAB
{
	func_194(&(uParam0->f_428), uParam1);
	return;
}

BOOL func_128(var uParam0) // Position - 0x3A9B Hash - 0x2A5B98CC ^0x76F345F9
{
	PED::_SET_AMBIENT_PED_DENSITY_MULTIPLIER_THIS_FRAME(0.7f);
	VEHICLE::SET_RANDOM_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0.7f);
	...
	func_274(uParam0, 0, &pedLocal_25, false, true, 0, 0, 0, 0, 0, true, false, false);
	func_274(uParam0, 11, &pedLocal_26, false, true, 0, 0, 0, 0, 0, true, false, false);
	pedLocal_27 = func_275(138, true, false, false, true, true);
	!ENTITY::DOES_ENTITY_EXIST(pedLocal_25);
	!ENTITY::DOES_ENTITY_EXIST(pedLocal_26);
	!ENTITY::DOES_ENTITY_EXIST(pedLocal_27);

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_25) && ENTITY::DOES_ENTITY_EXIST(pedLocal_26) && ENTITY::DOES_ENTITY_EXIST(pedLocal_27))
	{
		ansLocal_24 = ANIMSCENE::_CREATE_ANIM_SCENE("script@story@dst5@leadin@INT@static_scene_props", 1, 0, false, true);
		func_276();
		func_278(&(uParam0->f_428), func_277("dst5_int"));
		return true;
	}
...
void func_129(var uParam0) // Position - 0x3B74 Hash - 0x958064E2 ^0xE1905352
{
...
void func_130(var uParam0) // Position - 0x3B8D Hash - 0x4DD6AE05 ^0xF30F3284
{
	func_173(&(uParam0->f_8), &(uParam0->f_24), &(uParam0->f_35), &(uParam0->f_51), &(uParam0->f_55), &(uParam0->f_57), &(uParam0->f_393), &(uParam0->f_398), &(uParam0->f_404), &(uParam0->f_408), &(uParam0->f_412), &(uParam0->f_417), -1);
	return;
}

void func_131(var uParam0, Ped pedParam1, const char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3BD0 Hash - 0x82689B8E ^0x82689B8E
{
	func_142(uParam0, pedParam1, sParam2, iParam3, iParam4, bParam5, false);
	return;
}

void func_132(var uParam0) // Position - 0x3BE9 Hash - 0x6254ECC0 ^0x4456B255
{
	var unk;
...
void func_133(var uParam0) // Position - 0x3C4C Hash - 0xDECB73AA ^0xDECB73AA
{
	...
	switch (*uParam0)
	{
		case 31:
			...
			func_282(&(uParam0->f_428), 75f);
			break;
	
		case 34:
			func_281(&(uParam0->f_428), 35f);
			func_282(&(uParam0->f_428), 50f);
			break;
	
		case 62:
			func_281(&(uParam0->f_428), 25f);
			func_282(&(uParam0->f_428), 30f);
			break;
...
BOOL func_134(var uParam0) // Position - 0x3CF9 Hash - 0x4CAB5FDE ^0x94139C79
{
	return func_283(&(uParam0->f_8), &(uParam0->f_24), &(uParam0->f_35), &(uParam0->f_51), &(uParam0->f_55), &(uParam0->f_57), &(uParam0->f_393), &(uParam0->f_398), &(uParam0->f_404), &(uParam0->f_408), &(uParam0->f_412), &(uParam0->f_417), -1);
}

BOOL func_135(var uParam0, BOOL bParam1) // Position - 0x3D3C Hash - 0x668AF7F9 ^0x2C83E00
{
	eStackSize stackSize;
	...
	stackSize = func_284(*uParam0);

	if (!func_114(stackSize))
		return true;

	uParam0->f_4 = ENTITY::DOES_ENTITY_EXIST(func_257(stackSize));
	return func_274(uParam0, stackSize, &(uParam0->f_3), bParam1, true, uParam0->f_2903, uParam0->f_2903.f_1, uParam0->f_2903.f_2, 0, 0, false, false, false);
}

BOOL func_136(int iParam0, BOOL bParam1) // Position - 0x3DA9 Hash - 0xD12F2026 ^0xFD6D81DE
{
	BOOL num;
	var label;
	var unk8;
...
BOOL func_137() // Position - 0x3E16 Hash - 0xCE6D0112 ^0xE0B7D23
{
	if (!STREAMING::HAS_MODEL_LOADED(joaat("p_cigar02x")))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(joaat("p_bottlebeer01x")))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(joaat("p_beermugglass01x")))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(joaat("p_nutbowl01x")))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(joaat("p_cs_sacklarge01x")))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(joaat("p_cs_dressbox01x")))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(joaat("p_cs_barrag01x")))
		return false;

	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(ansLocal_24, true, false))
		return false;

	return true;
}

struct<4> func_138(int iParam0, int iParam1) // Position - 0x3EA6 Hash - 0x4833EBA6 ^0x4833EBA6
{
	return func_287(iParam0, iParam1);
}

void func_139(Ped pedParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0x3EB6 Hash - 0xF73E422B ^0x72D662B4
{
	func_288(pedParam0, uParam1, uParam1.f_3, iParam5, iParam6);
	return;
}

void func_140(var uParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3ED0 Hash - 0x326B058E ^0x60290EA9
{
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x3F23 Hash - 0x1D055B01 ^0xDCF5FEAC
{
	...
	{
		isLocal_14.f_2[0] = OBJECT::CREATE_OBJECT(joaat("p_cigar02x"), 2791.1062f, -1169.4258f, 48.1392f, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(isLocal_14.f_2[0], 0f, 0f, -19.001f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(isLocal_14.f_2[0], bParam1);
	}

	func_290(isLocal_14.f_2[0], isLocal_14);
	func_290(isLocal_14.f_2[0], isLocal_14.f_1);

	if (!ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[1]) && iParam0 == -1 || iParam0 == 1)
	{
		isLocal_14.f_2[1] = OBJECT::CREATE_OBJECT(joaat("p_bottlebeer01x"), 2791.1062f, -1169.4258f, 48.1392f, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(isLocal_14.f_2[1], 0f, 0f, -19.001f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(isLocal_14.f_2[1], bParam1);
	}

	func_290(isLocal_14.f_2[1], isLocal_14);
	func_290(isLocal_14.f_2[1], isLocal_14.f_1);

	if (!ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[2]) && iParam0 == -1 || iParam0 == 2)
	{
		isLocal_14.f_2[2] = OBJECT::CREATE_OBJECT(joaat("p_beermugglass01x"), 2791.1062f, -1169.4258f, 48.1392f, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(isLocal_14.f_2[2], 0f, 0f, -19.001f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(isLocal_14.f_2[2], bParam1);
	}

	func_290(isLocal_14.f_2[2], isLocal_14);
	func_290(isLocal_14.f_2[2], isLocal_14.f_1);

	if (!ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[3]) && iParam0 == -1 || iParam0 == 3)
	{
		isLocal_14.f_2[3] = OBJECT::CREATE_OBJECT(joaat("p_nutbowl01x"), 2791.1062f, -1169.4258f, 48.1392f, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(isLocal_14.f_2[3], 0f, 0f, -19.001f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(isLocal_14.f_2[3], bParam1);
	}

	func_290(isLocal_14.f_2[3], isLocal_14);
	func_290(isLocal_14.f_2[3], isLocal_14.f_1);

	if (!ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[4]) && iParam0 == -1 || iParam0 == 4)
	{
		isLocal_14.f_2[4] = OBJECT::CREATE_OBJECT(joaat("p_cs_sacklarge01x"), 2791.1062f, -1169.4258f, 48.1392f, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(isLocal_14.f_2[4], 0f, 0f, -19.001f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(isLocal_14.f_2[4], bParam1);
	}

	func_290(isLocal_14.f_2[4], isLocal_14);
	func_290(isLocal_14.f_2[4], isLocal_14.f_1);

	if (!ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[5]) && iParam0 == -1 || iParam0 == 5)
	{
		isLocal_14.f_2[5] = OBJECT::CREATE_OBJECT(joaat("p_cs_dressbox01x"), 2791.1062f, -1169.4258f, 48.1392f, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(isLocal_14.f_2[5], 0f, 0f, -19.001f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(isLocal_14.f_2[5], bParam1);
	}

	func_290(isLocal_14.f_2[5], isLocal_14);
	func_290(isLocal_14.f_2[5], isLocal_14.f_1);

	if (!ENTITY::DOES_ENTITY_EXIST(isLocal_14.f_2[6]) && iParam0 == -1 || iParam0 == 6)
	{
		isLocal_14.f_2[6] = OBJECT::CREATE_OBJECT(joaat("p_cs_barrag01x"), 2791.1062f, -1169.4258f, 48.1392f, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(isLocal_14.f_2[6], 0f, 0f, -19.001f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(isLocal_14.f_2[6], bParam1);
	}

	func_290(isLocal_14.f_2[6], isLocal_14);
	func_290(isLocal_14.f_2[6], isLocal_14.f_1);
	return;
}

void func_142(var uParam0, Ped pedParam1, const char* sParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x42D6 Hash - 0x9BD375D2 ^0x9BD375D2
{
	func_144(&(uParam0->f_428), pedParam1, sParam2, iParam3, iParam4, bParam6);
...
char* func_143(Object obParam0) // Position - 0x4308 Hash - 0xDC87D160 ^0x6D1175E4
{
	Hash entityModel;
...
void func_144(var uParam0, Entity eParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x432E Hash - 0x37E325FF ^0x56E9093A
{
	int num;
	Entity entity;
	...
	{
		entity = func_296(uParam0, sParam2);
	
		if (ENTITY::DOES_ENTITY_EXIST(entity) && entity != eParam1)
			func_297(uParam0, entity);
	}
	...
	if (num != -1)
	{
		...
		if (bParam5)
			func_299(&uParam0->f_13[num /*12*/], 2);
		else
			func_300(&uParam0->f_13[num /*12*/], 2);
	}

	return;
}

Any func_145(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x447D Hash - 0xDFB996B4 ^0xC287A71C
{
	Any any;
...
void func_146(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x44C4 Hash - 0xD777F4CF ^0xBFF3124C
{
	func_302(hParam0, false, false);
	...
	if (func_303(hParam0))
	{
		...
		if (bParam3)
			func_304(hParam0, iParam2, true, bParam6);
		else if (bParam1)
			if (bParam4)
				func_305(hParam0, true);
			else
				func_306(hParam0, true);
		else
			func_307(hParam0, true);
...
struct<4> func_147(int iParam0) // Position - 0x454F Hash - 0x6D11454D ^0xB12E3BC9
{
	var unk;
...
void func_148(var uParam0) // Position - 0x4574 Hash - 0x70AF85D1 ^0xF30741F3
{
	var unk;
	int i;
...
BOOL func_149() // Position - 0x45D9 Hash - 0x5976C0FC ^0x467B462C
{
	return func_310(SCRIPTS::GET_ID_OF_THIS_THREAD());
}

void func_150() // Position - 0x45E9 Hash - 0x8DA4BA54 ^0x8DA4BA54
{
	if (func_149())
	{
		Global_18 = false;
...
void func_151(var uParam0, var uParam1) // Position - 0x460D Hash - 0x4D904C7 ^0x7235D696
{
	var unk;
...
BOOL func_152(var uParam0, int iParam1) // Position - 0x4772 Hash - 0x68CD914D ^0x68CD914D
{
	BOOL flag;
...
int func_153(int iParam0) // Position - 0x4792 Hash - 0x86FFCEDA ^0x86FFCEDA
{
	if (iParam0 & 36 == 4)
		return 6;
...
void func_154(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x47ED Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_318(iParam0) && func_319(iParam0))
		return;

	func_320(iParam0, 1);
	func_321(iParam0);

	if (func_323(func_322(iParam0)))
	{
		persChar = func_324(iParam0);
...
BOOL func_155(int iParam0) // Position - 0x48D9 Hash - 0xBF7DEF91 ^0x6E26B7C2
{
...
const char* func_156(int iParam0) // Position - 0x4905 Hash - 0xBDAEC5FF ^0xCF2E1D60
{
	const char* str;
...
int func_157(var uParam0, var uParam1) // Position - 0x4926 Hash - 0x8FE20AD3 ^0xDE446A76
{
...
float func_158() // Position - 0x49C0 Hash - 0xC6C7E40 ^0x14F37B93
{
	return func_327(150f, BUILTIN::TO_FLOAT(Global_1934765.f_286)) / BUILTIN::TO_FLOAT(300);
}

void func_159(float fParam0) // Position - 0x49E4 Hash - 0x9F434E95 ^0x27EA0342
{
	func_328(BUILTIN::CEIL(BUILTIN::TO_FLOAT(300) - (BUILTIN::TO_FLOAT(300) * fParam0)));
	return;
}

float func_160(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4A06 Hash - 0xD54E86C ^0xB31A48E2
{
...
Vector3 func_161(char* sParam0) // Position - 0x4A4E Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_162(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4A60 Hash - 0x4863E989 ^0xB2E91EEF
{
	BOOL flag;
...
struct<4> func_163(var uParam0) // Position - 0x4ABA Hash - 0xBD3347D6 ^0xBD3347D6
{
	return uParam0->f_2880;
}

BOOL func_164(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6) // Position - 0x4AC9 Hash - 0xDC5ABFED ^0x648CB452
{
	BOOL flag;
	...
	{
		uParam0->f_1896 = func_330(PLAYER::GET_PLAYER_INDEX(), false, false, true);
	...
	if (_STOPWATCH_IS_INITIALIZED_0(uParam0) < 10)
	{
		if (_STOPWATCH_IS_INITIALIZED_0(uParam0) == 3)
		{
			func_332(uParam0, iParam5, bParam6);
		}
		else if (_STOPWATCH_IS_INITIALIZED_0(uParam0) > 3)
		{
			...
			if (uParam0->f_1684 >= 0)
			{
				...
				if (func_337(uParam0, uParam0->f_1684))
					if (func_338(uParam0) < 7 && uParam0->f_1688 >= 0)
						func_339(uParam0, uParam0->f_1016[uParam0->f_1688 /*41*/].f_27, uParam0->f_1345[uParam0->f_1688 /*22*/].f_1, 1065353216);
	...
	flag = func_341(uParam0, iParam5, bParam6);
	...
	if (flag)
	{
		if (!func_63(uParam0, 268435456) && isFirstPersonCameraActive && !func_63(uParam0, 262144))
		{
			...
			{
				func_342(uParam0, 131072);
				func_342(uParam0, 268435456);
			}
		}
	
		if (func_314(uParam0, 64) || uParam0->f_1684 >= 0 && !func_315(&uParam0->f_1016[uParam0->f_1684 /*41*/], 524288))
		{
			if (CAM::GET_LETTER_BOX_RATIO() > 0f || func_333(uParam0) == 0)
			{
	...
	{
		case 0:
			func_349(uParam0, uParam1, iParam5);
			break;
		...
		case 3:
			...
			{
				func_110(2);
				func_339(uParam0, uParam0->f_1016[uParam0->f_1684 /*41*/].f_27, uParam0->f_1345[uParam0->f_1684 /*22*/].f_1, 1065353216);
		...
		case 8:
			...
			{
				if (func_356(uParam0, iParam5))
				{
					if (func_357(uParam0))
					{
						uParam0->f_1685 = func_358(uParam0);
						func_26(&(uParam0->f_1872));
						PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), true, 0, false);
						HUD::_DISABLE_HUD_CONTEXT(joaat("HUD_CTX_IN_MISSION_CUTSCENE"));
...
BOOL func_165(var uParam0) // Position - 0x50B5 Hash - 0x1C410021 ^0x1C410021
{
	return func_352(&(uParam0->f_958));
}

BOOL func_166(var uParam0) // Position - 0x50C6 Hash - 0x396BFA19 ^0x9045C8D3
{
	float num;
	Volume volume;
	...
	{
		if (func_359(Global_35, volume, true, 0))
		{
			func_25(uParam0, 8388608);
			return true;
		}
...
BOOL func_167(var uParam0) // Position - 0x515C Hash - 0xAA225417 ^0xEBFC9AC8
{
	int i;
	AnimScene animScene;
	int j;
		...
		if (uParam0->f_475[i /*18*/].f_17 == 0 && uParam0->f_475[i /*18*/].f_2 == 9 && uParam0->f_475[i /*18*/].f_4 >= 0)
		{
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(animScene) && ANIMSCENE::IS_ANIM_SCENE_LOADED(animScene, true, false))
			{
				for (j = 0; j < 35; j = j + 1)
				{
					...
					{
						entityId = { func_360(uParam0, uParam0->f_3[j /*13*/].f_2) };
...
void func_168(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x525D Hash - 0x19C13D4E ^0x60116C62
{
	int i;
	BOOL flag;
	...
	for (i = 0; i < 11; i = i + 1)
	{
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_1522[i /*10*/].f_8))
		{
			if (bParam1)
			{
				...
				else if (func_63(uParam0, 32768) && func_361(&uParam0->f_1522[i /*10*/], 128))
				{
					func_362(uParam0->f_1522[i /*10*/].f_8, 10000, 1, -1, false);
				}
				else
				{
					if (bParam2)
...
BOOL func_169() // Position - 0x536A Hash - 0x477323 ^0x8EF93AF8
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_43800) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_43800, false);
}

void func_170(Volume volParam0) // Position - 0x5386 Hash - 0x4A7DD833 ^0xF771448B
{
	var volumeCoords;
	...
	func_363(volumeCoords, 0);
	return;
}

void func_171(var uParam0, Volume volParam1, BOOL bParam2) // Position - 0x53AE Hash - 0x2EB65318 ^0x737362FB
{
...
void func_172(var uParam0, eStackSize essParam1, Ped pedParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x53E6 Hash - 0x277B3662 ^0x2E25C4D2
{
	BOOL flag;
	...
	if (bParam4)
		func_365(uParam0, pedParam2, 0);

	if (!bParam6)
	{
		if (!func_5(uParam0, 4194304))
		{
			bParam6 = func_366(&Global_1835011[*uParam0 /*74*/], 1024);
			flag = func_366(&Global_1835011[*uParam0 /*74*/], 65536);
		}
	}

	func_367(essParam1, bParam3, bParam4, bParam5, -1082130432, true, true, bParam6, flag, false, false);
	return;
}

void func_173(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12) // Position - 0x546E Hash - 0x4B672E42 ^0x6C5B61A2
{
	int i;
	int j;
	...
	{
		if (func_368(&uParam0->[i /*3*/]))
			if (func_369(uParam0->[i /*3*/].f_2, iParam12))
				func_370(&uParam0->[i /*3*/]);
	}

	for (i = 0; i < *uParam1; i = i + 1)
	{
		if (func_371(&uParam1->[i /*5*/]))
			if (func_369(uParam1->[i /*5*/].f_4, iParam12))
				func_372(&uParam1->[i /*5*/]);
	}

	for (i = 0; i < *uParam2; i = i + 1)
	{
		if (func_373(&uParam2->[i /*3*/]))
			if (func_369(uParam2->[i /*3*/].f_2, iParam12))
				func_374(&uParam2->[i /*3*/]);
	}

	for (i = 0; i < *uParam3; i = i + 1)
	{
		if (func_375(&uParam3->[i /*3*/]))
			if (func_369(uParam3->[i /*3*/].f_2, iParam12))
				func_376(&uParam3->[i /*3*/]);
	}

	if (func_369(uParam4->f_1, iParam12))
		func_377(uParam4);

	for (i = 0; i < *uParam5; i = i + 1)
	{
		if (func_378(&uParam5->[i /*67*/]))
			if (func_369(uParam5->[i /*67*/].f_3, iParam12))
				func_379(&uParam5->[i /*67*/]);
	}
	...
	for (i = 0; i < *uParam5; i = i + 1)
	{
		if (func_378(&uParam5->[i /*67*/]))
		{
			for (j = 0; j < 20; j = j + 1)
			{
				if (func_380(&uParam5->[i /*67*/].f_4[j /*3*/]))
					if (func_369(uParam5->[i /*67*/].f_4[j /*3*/].f_2, iParam12))
						func_381(&uParam5->[i /*67*/].f_4[j /*3*/], uParam5->[i /*67*/].f_1);
			}
		}
	}
	...
	{
		if (func_382(&uParam6->[i /*4*/]))
			if (func_369(uParam6->[i /*4*/].f_3, iParam12))
				func_383(&uParam6->[i /*4*/]);
	}

	for (i = 0; i < *uParam7; i = i + 1)
	{
		if (func_384(&uParam7->[i /*5*/]))
			if (func_369(uParam7->[i /*5*/].f_4, iParam12))
				func_385(&uParam7->[i /*5*/]);
	}

	for (i = 0; i < *uParam8; i = i + 1)
	{
		if (func_386(&uParam8->[i /*3*/]))
			if (func_369(uParam8->[i /*3*/].f_2, iParam12))
				func_387(&uParam8->[i /*3*/]);
	}

	for (i = 0; i < *uParam9; i = i + 1)
	{
		if (func_388(&uParam9->[i /*3*/]))
			if (func_369(uParam9->[i /*3*/].f_2, iParam12))
				func_389(&uParam9->[i /*3*/]);
	}

	for (i = 0; i < *uParam10; i = i + 1)
	{
		if (func_390(&uParam10->[i /*4*/]))
			if (func_369(uParam10->[i /*4*/].f_3, iParam12))
				func_391(&uParam10->[i /*4*/]);
	}

	for (i = 0; i < *uParam11; i = i + 1)
	{
		if (func_392(&uParam11->[i /*3*/]))
			if (func_369(uParam11->[i /*3*/].f_2, iParam12))
				func_393(&uParam11->[i /*3*/]);
	}

	return;
}

void func_174(BOOL bParam0) // Position - 0x57B9 Hash - 0x70EE66C ^0x88F73934
{
	Global_1935496.f_18 = !bParam0;
	return;
}

BOOL func_175() // Position - 0x57CA Hash - 0x9B720BCA ^0x99D774A5
{
	int i;
...
void func_176() // Position - 0x5844 Hash - 0x7A8E89A ^0xC1ACE39F
{
	int i;
...
BOOL func_177(Ped pedParam0) // Position - 0x58C8 Hash - 0x570B88CE ^0x1868A37B
{
	int i;
...
BOOL func_178(int iParam0) // Position - 0x5926 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_179(int iParam0) // Position - 0x5959 Hash - 0x355AD4D4 ^0x355AD4D4
{
	if (!func_178(iParam0))
		return 0;

	return func_395(func_394(iParam0));
}

int func_180(int iParam0) // Position - 0x5979 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_178(iParam0))
		return -1;

	return func_396(func_394(iParam0));
}

struct<8> func_181(var uParam0) // Position - 0x5999 Hash - 0x34F395B4 ^0x4D7F9139
{
	var unk;

	unk = { func_397(uParam0) };
...
void func_182(var uParam0, const char* sParam1) // Position - 0x59C3 Hash - 0x25E063BB ^0x16263A15
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return;
...
char* func_183() // Position - 0x59E0 Hash - 0x84223A14 ^0x84223A14
{
	return "unnamed";
}

Vector3 func_184(int iParam0) // Position - 0x59EB Hash - 0xACD6F870 ^0xDE230469
{
	if (func_399(iParam0))
...
void func_185(var uParam0, Volume volParam1, int iParam2) // Position - 0x5A11 Hash - 0x366C12BA ^0x33183664
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam1))
		return;
	...
	func_66(uParam0, 512);
	uParam0->f_427 = func_145(volParam1, 0, false, 0);
	return;
}

void func_186(int iParam0, Volume volParam1) // Position - 0x5A66 Hash - 0x8F213D8E ^0x152F2000
{
	if (!func_81(iParam0))
		return;
...
void func_187(var uParam0, Volume volParam1) // Position - 0x5A9E Hash - 0x5750941F ^0xB5ADF4FC
{
	var unk;
	...
	func_402(volParam1, &unk, true, 0, 0, false, -1082130432);
	return;
}

struct<2> func_188(int iParam0) // Position - 0x5ADA Hash - 0x49479BE1 ^0x49479BE1
{
	var unk;
...
struct<2> func_189(int iParam0) // Position - 0x5AF1 Hash - 0x3EC691D0 ^0x3EC691D0
{
	var unk;
...
BOOL func_190() // Position - 0x5B0E Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
BOOL func_191(int iParam0) // Position - 0x5B61 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_192(int iParam0, int iParam1) // Position - 0x5B77 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_193(var uParam0, var uParam1) // Position - 0x5B86 Hash - 0xB353E28A ^0x2F5BCD55
{
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam1->f_1016[i /*41*/].f_30)))
			func_403(uParam0, &(uParam1->f_1016[i /*41*/].f_30), true);
	}

	return;
}

void func_194(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x5BC6 Hash - 0x2559B2A1 ^0x79D637E0
{
...
int func_195(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5BE6 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_196(var uParam0) // Position - 0x5C0E Hash - 0x9BB76AD4 ^0x9BB76AD4
{
	return uParam0->f_435;
}

void func_197() // Position - 0x5C1B Hash - 0xFA72027F ^0xFA72027F
{
	int num;
...
void func_198(var uParam0) // Position - 0x5C4A Hash - 0x56A63D83 ^0x32CB1163
{
	int i;
...
void func_199(var uParam0) // Position - 0x5CE5 Hash - 0x8073496 ^0x6EC7F710
{
...
float func_200(var uParam0) // Position - 0x5D4C Hash - 0x9BB76AD4 ^0x9BB76AD4
{
	return uParam0->f_434;
}

struct<8> func_201(var uParam0) // Position - 0x5D59 Hash - 0xDB13DC73 ^0xDB13DC73
{
	return uParam0->f_446;
}

void func_202(var uParam0) // Position - 0x5D69 Hash - 0xA1CFA37E ^0xA1CFA37E
{
	var unk;
...
void func_203(var uParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x5D82 Hash - 0x444CF639 ^0xB97B3688
{
	if (func_83(uParam0, 16))
		return;

	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_4) && !func_407(uParam0->f_5, 0f, 0f, 0f))
	{
	...
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_4))
	{
		...
		func_408(uParam0, uParam0->f_4, false, true);
...
BOOL func_204() // Position - 0x5E22 Hash - 0xAE743BBD ^0xB1C5A13D
{
	return Global_1946054.f_1497 != Global_1946054.f_2163.f_1;
}

void func_205(int iParam0) // Position - 0x5E3B Hash - 0x1B3C2724 ^0xC6DA7F4E
{
	int num;

	if (func_409(iParam0, 4096))
		Global_1946054.f_858 = Global_1946054.f_858 + 1;
...
int func_206() // Position - 0x5E7F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899516;
}

Hash func_207() // Position - 0x5E8B Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

int func_208(Hash hParam0) // Position - 0x5E97 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(hParam0, 12) & 31;
}

int func_209(int iParam0) // Position - 0x5EAA Hash - 0x802A6C1 ^0x802A6C1
{
	if (iParam0 == 7)
...
struct<8> func_210(char* sParam0, const char* sParam1, BOOL bParam2, int iParam3) // Position - 0x5EC3 Hash - 0xB13D7CEF ^0x4DD40A33
{
...
BOOL func_211(int iParam0, int iParam1) // Position - 0x5F7A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_212() // Position - 0x5F89 Hash - 0xF2FB1A38 ^0xF2FB1A38
{
	if (func_410(Global_43801))
		func_411(&Global_43801, false, false);

	return;
}

char* func_213(Ped pedParam0) // Position - 0x5FA4 Hash - 0xB363CFB9 ^0xF2B5EFCD
{
	Hash entityModel;
	...
	return func_412(entityModel);
}

BOOL func_214(int iParam0) // Position - 0x5FF0 Hash - 0x531420D5 ^0x3A11B780
{
	int messageState;
...
BOOL func_215(int iParam0, BOOL bParam1) // Position - 0x6039 Hash - 0xC074CB7F ^0xC074CB7F
{
	if (bParam1 && !func_410(iParam0))
		return false;

	return !func_414(iParam0, 4);
}

BOOL func_216(BOOL bParam0, BOOL bParam1) // Position - 0x605E Hash - 0xDB63BA21 ^0x8ADA0DEC
{
	if (!func_410(Global_43801))
	{
		Global_43801 = func_415("CUTSCENE_SKIP", joaat("INPUT_SKIP_CUTSCENE"), 5, 570, 4000, 10, 1073741824, 0, 1065353216, false, 3, joaat("LONG_TIMED_EVENT"), false);
		Global_1945188[Global_43801 /*18*/].f_16 = Global_23[3];
		func_416(Global_43801, false, true);
		func_417(Global_43801, 6, true);
	
		if (bParam1)
			func_417(Global_43801, 14, true);
	}
	else
	{
		if (!func_215(Global_43801, false))
			func_418(Global_43801, true, true);
...
BOOL func_217(int iParam0, int iParam1) // Position - 0x611C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_218(var uParam0, const char* sParam1) // Position - 0x612B Hash - 0xD359B1E0 ^0x32AEA5DC
{
	int i;
	var unk;
...
void func_219(var uParam0, char* sParam1) // Position - 0x61F2 Hash - 0xEBF6CAFB ^0xB90E227B
{
...
void func_220(var uParam0, BOOL bParam1) // Position - 0x623F Hash - 0xA338CC7 ^0xAFB97042
{
	var weaponHash;
...
BOOL func_221() // Position - 0x62B1 Hash - 0x35A4808D ^0x7E542F56
{
	return SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("doc_player_journal")) > 0;
}

void func_222() // Position - 0x62C4 Hash - 0x9198443F ^0xEDA86CC9
{
	int i;
...
BOOL func_223() // Position - 0x6316 Hash - 0x3CA1BB47 ^0x6A0D5C15
{
...
void func_224(BOOL bParam0) // Position - 0x6330 Hash - 0x9AA8C616 ^0xCCF3BF7F
{
	if (func_223())
		Global_1357509 = 1;
...
void func_225(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x6381 Hash - 0xBAB7BE58 ^0xBAB7BE58
{
	uParam0->f_440 = { uParam1 };
	return;
}

BOOL func_226() // Position - 0x6394 Hash - 0xBA0B7E94 ^0x198E4494
{
...
void func_227(var uParam0) // Position - 0x63B8 Hash - 0xB9A4813D ^0x4EB23AD7
{
	int i;
	var unk;
...
void func_228(var uParam0, BOOL bParam1) // Position - 0x6416 Hash - 0x360C8D66 ^0x4FD9930
{
	int i;
	Ped pedIndexFromEntityIndex;
	...
	for (i = 0; i < 35; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_13[i /*12*/]) || func_244(&uParam0->f_13[i /*12*/], 2))
		{
			if (func_244(&uParam0->f_13[i /*12*/], 1) || ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(uParam0->f_444, &(uParam0->f_13[i /*12*/].f_1)))
			{
				...
				if (bParam1 && ENTITY::IS_ENTITY_A_PED(uParam0->f_13[i /*12*/]))
				{
					...
					if (pedIndexFromEntityIndex != Global_35 && !func_244(&uParam0->f_13[i /*12*/], 16))
...
void func_229(var uParam0) // Position - 0x64EC Hash - 0x44F320D ^0x91B8DCFF
{
	int i;
	...
	for (i = 0; i < 35; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_13[i /*12*/]) || func_244(&uParam0->f_13[i /*12*/], 2))
			if (ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(uParam0->f_444, &(uParam0->f_13[i /*12*/].f_1)))
				func_299(&uParam0->f_13[i /*12*/], 1);
	}

	return;
}

float func_230(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6575 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_231() // Position - 0x6593 Hash - 0x497997A3 ^0xEB2F5273
{
	return func_413(UIFEED::UI_FEED_GET_CURRENT_MESSAGE(3));
}

BOOL func_232() // Position - 0x65A4 Hash - 0xBA23ABC ^0x93F0A0D4
{
	int currentMessage;
...
void func_233(BOOL bParam0) // Position - 0x65C4 Hash - 0x6C3953AD ^0xF72D6E5A
{
	UIFEED::UI_FEED_CLEAR_CHANNEL(1, bParam0, false);
	return;
}

Vector3 func_234(var uParam0) // Position - 0x65D4 Hash - 0xBDA8105E ^0xBDA8105E
{
	return uParam0->f_502;
}

void func_235(var uParam0) // Position - 0x65E3 Hash - 0xC68D2F1F ^0xFC9AB41F
{
	Hash hash;
	...
	if (func_426(&hash))
	{
		if (func_427(hash, 0))
		{
			if (func_428(hash) == -525676072)
			{
				...
				func_253(Global_35, -2065815962, 0, 1108822547, false, true, false, false, false, false);
			}
			else
			{
...
void func_236(var uParam0, eSetPlayerControlFlags espcfParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, BOOL bParam6) // Position - 0x6653 Hash - 0x3C079E71 ^0x58721EE9
{
	ItemSet itemset;
	BOOL flag;
	int i;
...
void func_237(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x69E1 Hash - 0xB3E33ED8 ^0xB3E33ED8
{
	uParam0->f_502 = { fParam1 };
	return;
}

void func_238(var uParam0) // Position - 0x69F4 Hash - 0x6CEFB5BE ^0xE5B7A16E
{
	BOOL flag;
	Ped lastMount;
	int num;
	...
	if (func_83(uParam0, 2048) && !_IS_NULL_VECTOR(func_441(uParam0)))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(lastMount) && flag && ENTITY::IS_ENTITY_IN_VOLUME(lastMount, uParam0->f_4, true, 0) || func_83(uParam0, -2147483648) && PED::GET_MOUNT(Global_35) != lastMount)
		{
			...
			func_288(lastMount, func_441(uParam0), func_442(uParam0), num, 1073741824);
		}
		...
		if (!ENTITY::IS_ENTITY_DEAD(playersLastVehicle) && flag && ENTITY::IS_ENTITY_IN_VOLUME(playersLastVehicle, uParam0->f_4, true, 0) || func_83(uParam0, -2147483648) && !PED::IS_PED_IN_VEHICLE(Global_35, playersLastVehicle, true))
			func_288(playersLastVehicle, func_441(uParam0), func_442(uParam0), 2, 1073741824);
	}

	return;
}

void func_239(var uParam0) // Position - 0x6B00 Hash - 0x12FA3EB8 ^0xDBEBE05A
{
	...
	if (func_83(uParam0, 268435456) && !_IS_NULL_VECTOR(func_441(uParam0)) && PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(vehiclePedIsUsing))
		{
			...
			func_288(vehiclePedIsUsing, unk, func_443(unk, Global_36, 1), 2, 1073741824);
...
void func_240(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4, BOOL bParam5) // Position - 0x6B86 Hash - 0x5730B1F6 ^0x27D7CDB5
{
...
void func_241(var uParam0) // Position - 0x6BD1 Hash - 0x45D298F4 ^0x58CEE6C4
{
	int i;
	Ped pedIndexFromEntityIndex;
	...
	for (i = 0; i < 35; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_13[i /*12*/]) && ENTITY::IS_ENTITY_A_PED(uParam0->f_13[i /*12*/]) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0->f_13[i /*12*/]) != Global_35)
		{
			...
			if (PED::IS_PED_HUMAN(pedIndexFromEntityIndex))
			{
				if (ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(uParam0->f_444, &(uParam0->f_13[i /*12*/].f_1)))
				{
					if (!func_244(&uParam0->f_13[i /*12*/], 8))
					{
						if (func_445(func_444(pedIndexFromEntityIndex, 0, true, false)))
							if (!func_446(uParam0, WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(pedIndexFromEntityIndex, 0)))
								WEAPON::SET_CURRENT_PED_WEAPON(pedIndexFromEntityIndex, joaat("WEAPON_UNARMED"), true, 0, false, false);
					
						if (func_445(func_444(pedIndexFromEntityIndex, 1, true, false)))
							if (!func_446(uParam0, WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(pedIndexFromEntityIndex, 1)))
...
void func_242(var uParam0, BOOL bParam1) // Position - 0x6CCD Hash - 0x5BF0A49C ^0x170505BF
{
...
void func_243(Hash hParam0, Ped pedParam1, BOOL bParam2, Hash hParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6CFF Hash - 0xABE0892F ^0x49EF76F7
{
	int i;
	int num;
	Hash componentHash;
	...
	else
	{
		...
		{
			func_448(pedParam1, 29, isMp, true, 0);
			func_448(pedParam1, 31, isMp, true, 0);
			func_448(pedParam1, 30, isMp, true, 0);
			func_448(pedParam1, 22, isMp, true, 0);
			func_448(pedParam1, 37, isMp, true, 0);
		}
	}

	if (func_449(32768) && func_450(1108822547, 8) && func_451(10, hParam3))
		func_452(pedParam1, false, true);
	...
	for (i = 0; i < 39; i = i + 1)
	{
		...
		else
		{
			...
			else
			{
				...
				if (!func_451(num, hParam3))
				{
				}
				else if (func_450(num2, 6) || hParam0->f_1[num /*3*/] == Global_1946054.f_57[num /*11*/] || hParam0->f_1[num /*3*/].f_1 == 289238755)
				{
					if (!func_450(num2, 1) || bParam2)
					{
						Global_1946054.f_857 = Global_1946054.f_857 + 1;
					
						if (!bParam6)
							func_448(pedParam1, num, isMp, true, 0);
					...
					if (!bParam6)
					{
						...
						else
						{
							if (Global_1946054.f_57[num /*11*/].f_1 > 1)
								func_448(pedParam1, num, isMp, true, hParam0->f_1[num /*3*/]);
...
BOOL func_244(var uParam0, int iParam1) // Position - 0x7048 Hash - 0x718DD1EF ^0x4872DFB3
{
	return uParam0->f_11 && iParam1 != false;
}

void func_245(var uParam0) // Position - 0x7059 Hash - 0x635809ED ^0x635809ED
{
...
void func_246(var uParam0) // Position - 0x7080 Hash - 0xB5AC7806 ^0xE01DFDB3
{
	int i;
...
void func_247(var uParam0) // Position - 0x70A6 Hash - 0xBA5A1D5A ^0x2C0A2EA5
{
	uParam0->f_8 = 0;
	return;
}

void func_248(var uParam0, int iParam1) // Position - 0x70B3 Hash - 0xBB77BED ^0x97F7EDBC
{
	int i;

	for (i = 0; i < 35; i = i + 1)
	{
		func_300(&uParam0->f_13[i /*12*/], iParam1);
	}

	return;
}

void func_249(var uParam0) // Position - 0x70DC Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_250(BOOL bParam0) // Position - 0x70F2 Hash - 0x5446617D ^0x88932A5B
{
...
void func_251(int iParam0) // Position - 0x7136 Hash - 0x7AE52724 ^0x9315F21B
{
	func_458();
...
void func_252() // Position - 0x7154 Hash - 0x47CA4FE0 ^0xED93DC86
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return;
...
int func_253(Ped pedParam0, Hash hParam1, Hash hParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x717B Hash - 0x20E8246C ^0x1B874796
{
	var unk;
	int num;
	...
	func_463(true, func_256() == -1 && bParam5, true);

	switch (iParam3)
	{
		case 1108822547:
			if (func_449(32768) && hParam1 != Global_1946054.f_57[func_461(iParam3, 1) /*11*/])
			{
				func_465();
...
void func_254(Hash hParam0, BOOL bParam1) // Position - 0x72EA Hash - 0xE53C6141 ^0xE235D8BA
{
	var unk;
	var guid;
...
BOOL func_255(Ped pedParam0, var uParam1, int iParam2, eSetPlayerControlFlags espcfParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x7334 Hash - 0x6CEE72B9 ^0x4A7A32FD
{
	int taskSequenceId;
...
BOOL func_256() // Position - 0x78E8 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_257(eStackSize essParam0) // Position - 0x78F6 Hash - 0x81E6D8DD ^0x27F8E742
{
...
BOOL func_258(Ped pedParam0, int iParam1) // Position - 0x7930 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
int func_259() // Position - 0x7A2F Hash - 0xDED80B4D ^0x98F74967
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_260(eStackSize essParam0, int iParam1) // Position - 0x7A3F Hash - 0xA6154E40 ^0x8BCE8EFE
{
	Ped ped;
...
void func_261(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x7A7F Hash - 0x1EC8ECF ^0x1D5EA1D9
{
	ItemSet itemset;
	int i;
	Entity entityFromItem;
...
void func_262(float fParam0) // Position - 0x7B32 Hash - 0xD5DAF5A7 ^0xD5DAF5A7
{
	func_480(10, fParam0);
	return;
}

BOOL func_263() // Position - 0x7B42 Hash - 0x37EC066 ^0xC9B08D38
{
	if (func_256() != -1)
		return false;
...
void func_264() // Position - 0x7B68 Hash - 0x7A2C63BA ^0x37AC1250
{
...
BOOL func_265(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7B7E Hash - 0x456A22D3 ^0x456A22D3
{
	if (bParam2)
		if (!func_479(essParam0))
			return false;
...
void func_266(var uParam0, int iParam1) // Position - 0x7BA8 Hash - 0xCFA1A9B8 ^0xCFA1A9B8
{
	uParam0->f_1683 = iParam1;
	return;
}

void func_267(var uParam0, int iParam1) // Position - 0x7BB7 Hash - 0x4F8BE4B5 ^0x2E599B99
{
	uParam0->f_1 = iParam1;
	return;
}

int func_268(var uParam0, int iParam1) // Position - 0x7BC5 Hash - 0x2F59A919 ^0x849F5606
{
	int i;
	...
	if (func_314(uParam0, 8) && CAM::_IS_CAM_DATA_DICT_LOADED(func_484()))
...
void func_269(var uParam0, int iParam1) // Position - 0x7E4C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_270(var uParam0, int iParam1) // Position - 0x7E5D Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_271(int iParam0) // Position - 0x7E72 Hash - 0xBF7DEF91 ^0x6E26B7C2
{
	if (!(iParam0 > -1 && iParam0 <= 80))
		return false;
...
struct<4> func_272(var uParam0) // Position - 0x7E9E Hash - 0xBD3347D6 ^0xBD3347D6
{
	return uParam0->f_440;
}

BOOL func_273(int iParam0) // Position - 0x7EAD Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_487(iParam0))
		return false;

	return func_488(iParam0, 8);
}

BOOL func_274(var uParam0, eStackSize essParam1, var uParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x7ECB Hash - 0xDE3125D6 ^0xDE3125D6
{
	var unk;
...
Ped func_275(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7FE3 Hash - 0xA79BCAF1 ^0x183F1850
{
	Ped ped;
	PersChar persChar;

	if (!func_498(iParam0, true))
		return 0;
	...
	if (bParam4 && !func_318(iParam0) && !ENTITY::IS_ENTITY_DEAD(ped))
	{
...
void func_276() // Position - 0x80A3 Hash - 0xCC21511A ^0xCBC1A85F
{
	STREAMING::REQUEST_MODEL(joaat("p_cigar02x"), false);
	STREAMING::REQUEST_MODEL(joaat("p_bottlebeer01x"), false);
	STREAMING::REQUEST_MODEL(joaat("p_beermugglass01x"), false);
	STREAMING::REQUEST_MODEL(joaat("p_nutbowl01x"), false);
	STREAMING::REQUEST_MODEL(joaat("p_cs_sacklarge01x"), false);
	STREAMING::REQUEST_MODEL(joaat("p_cs_dressbox01x"), false);
	STREAMING::REQUEST_MODEL(joaat("p_cs_barrag01x"), false);
	ANIMSCENE::LOAD_ANIM_SCENE(ansLocal_24);
	return;
}

struct<8> func_277(char* sParam0) // Position - 0x80F7 Hash - 0x8E82EE3 ^0x8E82EE3
{
	var unk;
...
void func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x810A Hash - 0x866B14EA ^0x34A2DC1D
{
...
BOOL func_279(const char* sParam0) // Position - 0x812B Hash - 0x29A59279 ^0x5A6314BB
{
...
void func_280(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x8145 Hash - 0x841F0948 ^0x99E588B6
{
...
void func_281(var uParam0, float fParam1) // Position - 0x816E Hash - 0xCFA1A9B8 ^0xCFA1A9B8
{
	uParam0->f_434 = fParam1;
	return;
}

void func_282(var uParam0, float fParam1) // Position - 0x817D Hash - 0xCFA1A9B8 ^0xCFA1A9B8
{
	uParam0->f_435 = fParam1;
	return;
}

BOOL func_283(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12) // Position - 0x818C Hash - 0xD95A8F5E ^0xE6E823B0
{
	int num;
	int i;
	int j;
...
eStackSize func_284(int iParam0) // Position - 0x8538 Hash - 0x1C89A65E ^0x1C89A65E
{
	if (!func_81(iParam0))
		return 1;
...
BOOL func_285(int iParam0) // Position - 0x8558 Hash - 0xADFE2C00 ^0x32F0B336
{
	var textBlock;
...
BOOL func_286(int iParam0) // Position - 0x8583 Hash - 0xADFE2C00 ^0x32F0B336
{
	var textBlock;
...
struct<4> func_287(int iParam0, int iParam1) // Position - 0x85AE Hash - 0x3C2FFB17 ^0xFAA3DF9B
{
	var unk;

	unk = { func_515(iParam0, iParam1) };
	unk.f_3 = func_516(iParam0, iParam1);
	return unk;
}

void func_288(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6) // Position - 0x85D2 Hash - 0xF46E0F16 ^0xED4BA72A
{
	Vehicle vehiclePedIsIn;
	Ped pedIndexFromEntityIndex;
	Ped mount;
	...
	if (func_518(pedParam0))
		if (func_519(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
	...
	if (func_471(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, iParam4, true, func_471(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, iParam4, true, func_471(iParam5, 32), true);
	...
	else if (func_471(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, vParam1, func_471(iParam5, 32), true, true);
...
char* func_289() // Position - 0x8854 Hash - 0x306ACA3A ^0x987949EE
{
	return "cutDeleteMe";
}

void func_290(Entity eParam0, ItemSet isParam1) // Position - 0x8860 Hash - 0x955A01D6 ^0x57994D09
{
...
void func_291(var uParam0, Entity eParam1, const char* sParam2) // Position - 0x8893 Hash - 0x6D9EF6A2 ^0x6D9EF6A2
{
	func_520(&(uParam0->f_958), eParam1, sParam2, false);
	return;
}

void func_292(var uParam0, Entity eParam1) // Position - 0x88A9 Hash - 0x47841D83 ^0x41367717
{
	Ped pedIndexFromEntityIndex;
...
char* func_293(Hash hParam0) // Position - 0x896F Hash - 0xE6862179 ^0x88ED573
{
	switch (hParam0)
	{
...
const char* func_294(Entity eParam0) // Position - 0x9A1F Hash - 0x1DD66752 ^0xB5F83440
{
	if (!ENTITY::DOES_ENTITY_EXIST(eParam0))
		return "";

	if (ENTITY::IS_ENTITY_A_PED(eParam0))
		return func_213(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(eParam0));
	else if (ENTITY::IS_ENTITY_AN_OBJECT(eParam0))
		return func_143(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(eParam0));
	else if (ENTITY::IS_ENTITY_A_VEHICLE(eParam0))
		return func_521(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(eParam0));

	return "";
}

int func_295(var uParam0, Entity eParam1) // Position - 0x9A82 Hash - 0xD8D08AD0 ^0x705BA6E9
{
	int i;
...
Entity func_296(var uParam0, const char* sParam1) // Position - 0x9AD0 Hash - 0x36449D70 ^0x8893C58B
{
	int i;
...
void func_297(var uParam0, Entity eParam1) // Position - 0x9B1B Hash - 0x833023BF ^0x3D3CC7FB
{
	var unk;
	int i;
...
int func_298(var uParam0) // Position - 0x9B63 Hash - 0x977F3323 ^0x1DC224A5
{
	int i;
...
void func_299(var uParam0, int iParam1) // Position - 0x9B94 Hash - 0x53A96DDB ^0x5EF2061
{
	uParam0->f_11 = uParam0->f_11 || iParam1;
	return;
}

void func_300(var uParam0, int iParam1) // Position - 0x9BA7 Hash - 0xA4EAD31F ^0x1843FE5B
{
	uParam0->f_11 = uParam0->f_11 - uParam0->f_11 && iParam1;
	return;
}

void func_301(Volume volParam0, BOOL bParam1) // Position - 0x9BBF Hash - 0xD6642292 ^0x5A7BA218
{
	int num;
...
Hash func_302(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9BE2 Hash - 0xEC5804B5 ^0x15A1D925
{
...
BOOL func_303(Hash hParam0) // Position - 0x9C86 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_522(hParam0))
...
void func_304(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9CA1 Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_303(hParam0))
	{
...
void func_305(Hash hParam0, BOOL bParam1) // Position - 0x9CD9 Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_303(hParam0))
...
void func_306(Hash hParam0, BOOL bParam1) // Position - 0x9D07 Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_303(hParam0))
...
void func_307(Hash hParam0, BOOL bParam1) // Position - 0x9D35 Hash - 0x4844A91D ^0x50E23246
{
	if (func_303(hParam0))
...
BOOL func_308() // Position - 0x9D63 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

int func_309(var uParam0) // Position - 0x9D6C Hash - 0x2E4FC1F3 ^0xE8B2CC59
{
	int num;
	int i;
...
BOOL func_310(int iParam0) // Position - 0x9DA3 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43884 == iParam0;
}

Vector3 func_311(var uParam0, int iParam1) // Position - 0x9DB1 Hash - 0xC77CD708 ^0x10C9D8E0
{
	var unk;
	float num;
	var unk10;
...
void func_312(var uParam0, int iParam1) // Position - 0x9FD0 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_313(var uParam0, int iParam1) // Position - 0x9FE1 Hash - 0xB94A85A8 ^0xB94A85A8
{
	uParam0->f_1664 = uParam0->f_1664 - uParam0->f_1664 && iParam1;
	return;
}

BOOL func_314(var uParam0, int iParam1) // Position - 0x9FFC Hash - 0x4D54295E ^0x1FD812C3
{
	return uParam0->f_1666.f_1 && iParam1 != false;
}

BOOL func_315(var uParam0, int iParam1) // Position - 0xA010 Hash - 0xBD0B8CC9 ^0xE0A10783
{
	return func_524(uParam0->f_27, iParam1);
}

BOOL func_316(int iParam0) // Position - 0xA022 Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

BOOL func_317(int iParam0, BOOL bParam1) // Position - 0xA039 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_256() != -1)
		return false;
...
BOOL func_318(int iParam0) // Position - 0xA067 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_316(iParam0))
		return false;
...
BOOL func_319(int iParam0) // Position - 0xA08C Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_316(iParam0))
		return false;
...
void func_320(int iParam0, BOOL bParam1) // Position - 0xA0B0 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_256() != -1)
		return;
...
void func_321(int iParam0) // Position - 0xA0E9 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
Hash func_322(int iParam0) // Position - 0xA12D Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_316(iParam0))
		return 0;
...
BOOL func_323(Hash hParam0) // Position - 0xA14B Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

PersChar func_324(int iParam0) // Position - 0xA157 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_316(iParam0))
		return 0;
...
int func_325(int iParam0, BOOL bParam1) // Position - 0xA177 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_316(iParam0))
		return 0;
	...
	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_324(iParam0)))
		return 1;

	if (func_317(iParam0, true) && !bParam1)
	{
		func_499(iParam0, 128);
		return 1;
	}

	func_320(iParam0, 129);
	func_321(iParam0);
	PERSCHAR::_DELETE_PERSCHAR(func_324(iParam0));
	func_526(iParam0, 0);
	return 1;
}

BOOL func_326(int iParam0) // Position - 0xA1FA Hash - 0xCAB4B86D ^0xCAB4B86D
{
	int num;
...
float func_327(float fParam0, float fParam1) // Position - 0xA218 Hash - 0x99935A7D ^0x99935A7D
{
	if (fParam0 > fParam1)
		return fParam0;
...
void func_328(int iParam0) // Position - 0xA22F Hash - 0x299A116B ^0x246DE950
{
	int num;
	...
	if (func_528(&num))
	{
		if (Global_1934765.f_275[num /*2*/].f_1 != iParam0)
		{
			...
			STREAMING::SET_POPULATION_BUDGET_MULTIPLIER(func_158());
		}
...
void func_329(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xA2FC Hash - 0xFDACD718 ^0x658C9335
{
	int i;
...
int func_330(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA34E Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_530(bParam1, bParam2, bParam3);
...
void func_331(var uParam0) // Position - 0xA483 Hash - 0x2A7EDE58 ^0xD47FE61A
{
	BOOL flag;
	...
	if (!func_63(uParam0, 134217728))
	{
		...
		STREAMING::REQUEST_ANIM_DICT(func_531(1));
	
		if (!STREAMING::HAS_ANIM_DICT_LOADED(func_531(1)))
			flag = false;
	
		if (flag)
			func_342(uParam0, 134217728);
	}

	return;
}

void func_332(var uParam0, int iParam1, BOOL bParam2) // Position - 0xA4DF Hash - 0xE249989D ^0x5084807A
{
	float num;
	BOOL flag;
	int i;
	...
	func_340(uParam0);
	func_532(uParam0, uParam0->f_1897, uParam0->f_1899);
	func_533(uParam0);
	...
	if (uParam0->f_1900 && !uParam0->f_1899)
	{
		...
		{
			func_534(uParam0, uParam0->f_1897);
			return;
		}
	}
	...
	if (!func_63(uParam0, 4))
	{
		...
		{
			num = func_536(uParam0, uParam0->f_1690);
	...
	if (func_63(uParam0, 16))
	{
		...
		if (num3 <= uParam0->f_1016[uParam0->f_1688 /*41*/].f_17 || VOLUME::IS_POINT_IN_VOLUME(uParam0->f_1875, uParam0->f_1879))
		{
			...
			if (Global_36.f_2 >= uParam0->f_1016[uParam0->f_1688 /*41*/].f_1.f_2 && Global_36.f_2 <= uParam0->f_1016[uParam0->f_1688 /*41*/].f_1.f_2 + uParam0->f_1016[uParam0->f_1688 /*41*/].f_10)
				func_339(uParam0, uParam0->f_1016[uParam0->f_1688 /*41*/].f_27, uParam0->f_1345[uParam0->f_1688 /*22*/].f_1, num5);
	...
	{
		if (VOLUME::IS_POINT_IN_VOLUME(uParam0->f_1875, uParam0->f_1879) && func_536(uParam0, uParam0->f_1688) < 10000f && func_63(uParam0, 16) || func_63(uParam0, 4))
		{
			if (!func_63(uParam0, 4))
				func_342(uParam0, 4);
			...
			if (!func_337(uParam0, uParam0->f_1688))
				num6 = num6 | 2048;
		
			if (func_255(Global_35, &(uParam0->f_1686), num6, 0, 0, 1084227584, 100, uParam0->f_1016[uParam0->f_1688 /*41*/].f_7, uParam0->f_1016[uParam0->f_1688 /*41*/].f_7.f_1))
			{
				PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), true, 0, false);
				uParam0->f_1686 = 0;
				func_313(uParam0, 4);
...
int func_333(var uParam0) // Position - 0xAB0D Hash - 0x51136ED0 ^0x51136ED0
{
	return *uParam0;
}

void func_334(var uParam0) // Position - 0xAB18 Hash - 0x31DD3BA1 ^0x69C4D341
{
	if (CAM::IS_SCREEN_FADING_OUT() || CAM::IS_SCREEN_FADED_OUT())
		return;
	...
	{
		CAM::DO_SCREEN_FADE_OUT(1000);
		func_342(uParam0, 524288);
	}

	return;
}

void func_335(BOOL bParam0) // Position - 0xAB6E Hash - 0x67777C1C ^0xA5A55B03
{
	if (bParam0)
		func_538(4);
...
void func_336() // Position - 0xAB90 Hash - 0x92C2AC43 ^0x92C2AC43
{
	Global_1905944.f_5695 = 1;
	return;
}

BOOL func_337(var uParam0, var uParam1) // Position - 0xABA0 Hash - 0x70AAE99F ^0x19403F76
{
	int i;
...
int func_338(var uParam0) // Position - 0xABF3 Hash - 0xD73B9827 ^0x6B119A2B
{
	return uParam0->f_2;
}

void func_339(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xABFF Hash - 0x72EE5845 ^0x601C9141
{
	int num;
	int num2;
	...
	func_539(&num2, iParam2);
	func_540(&(uParam0->f_1904), num, num2, iParam3);
...
void func_340(var uParam0) // Position - 0xACD8 Hash - 0x1D31964B ^0x1A4D86D8
{
	int num;
	BOOL flag;
	var string1;
	...
	if (num >= 0 && !func_346(uParam0, 2))
	{
		...
		if (flag)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1345[num /*22*/].f_2)))
				TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_1692), func_543(uParam0->f_1345[num /*22*/].f_2), 64);
			else
				TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_1692), func_484(), 64);
		
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1345[num /*22*/].f_10)))
				TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_1692.f_8), func_543(uParam0->f_1345[num /*22*/].f_10), 64);
			else
				TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_1692.f_8), func_544(), 64);
		...
		{
			if (!func_545(uParam0->f_1345[num /*22*/].f_1, 8))
			{
				if (!func_545(uParam0->f_1345[num /*22*/].f_1, 8))
				{
					func_539(&num2, uParam0->f_1345[num /*22*/].f_1);
					func_546(&(uParam0->f_1904), num2);
				}
			}
			else
			{
				...
				if (func_545(uParam0->f_1345[num /*22*/].f_1, 16) && num3 >= 0)
				{
					...
					if (uParam0->f_1345[num /*22*/].f_18 != 0f || uParam0->f_1345[num /*22*/].f_19 != 0f)
						entityCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(entityCoords, func_547(Global_35, entity, 1), uParam0->f_1345[num /*22*/].f_18, 0f, uParam0->f_1345[num /*22*/].f_19) };
				}
				...
				flag3 = func_545(uParam0->f_1345[num /*22*/].f_1, 2);
				flag4 = func_545(uParam0->f_1345[num /*22*/].f_1, 1) && !flag3;
				flag5 = func_545(uParam0->f_1345[num /*22*/].f_1, 4);
				flag6 = false;
				...
				if (CAM::_0x4138EE36BC3DC0A7(&(uParam0->f_1692), 4))
				{
					...
					flag6 = flag6 || !func_549(uParam0->f_1708.f_17, entityCoords, 1056964608, true);
				...
				if (CAM::_0x4138EE36BC3DC0A7(&(uParam0->f_1692), 9))
				{
					...
					flag6 = flag6 || !func_549(uParam0->f_1731.f_17, entityCoords, 1056964608, true);
...
BOOL func_341(var uParam0, int iParam1, BOOL bParam2) // Position - 0xB29C Hash - 0xB8AA09D1 ^0xB8AA09D1
{
	int num;
	...
	if (func_551(uParam0, &num))
	{
		func_552(uParam0, num);
		return 1;
	}
...
void func_342(var uParam0, int iParam1) // Position - 0xB2CF Hash - 0x537D9C68 ^0x537D9C68
{
	uParam0->f_1664 = uParam0->f_1664 || iParam1;
	return;
}

void func_343(var uParam0) // Position - 0xB2E4 Hash - 0xF1EF36AF ^0xD4804A84
{
	int num;
	float num2;
...
void func_344(var uParam0, int iParam1) // Position - 0xB451 Hash - 0x9118FA6F ^0x438ACC34
{
	int i;
	BOOL flag;
	int num;
	...
	if (_STOPWATCH_IS_INITIALIZED_0(uParam0) > 3)
	{
		for (i = 0; i < uParam0->f_1894; i = i + 1)
		{
			...
			{
				func_553(uParam0, i, iParam1);
			}
			else if (uParam0->f_475[i /*18*/].f_6)
			{
				flag = func_554(uParam0, i);
...
void func_345(var uParam0) // Position - 0xB562 Hash - 0x2D6560B4 ^0xCF174C5E
{
	int i;
	int itemsetSize;
	ScrHandle indexedItemInItemset;
...
BOOL func_346(var uParam0, int iParam1) // Position - 0xB5BB Hash - 0x6B2D4FF8 ^0x6B2D4FF8
{
	return uParam0->f_1665 && iParam1 != false;
}

void func_347(var uParam0) // Position - 0xB5CD Hash - 0xE490C58 ^0xE490C58
{
	func_557(&(uParam0->f_1904));
	return;
}

void func_348(var uParam0) // Position - 0xB5DE Hash - 0xB7743C40 ^0xB7743C40
{
	uParam0->f_1665 = 0;
	return;
}

void func_349(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0xB5EC Hash - 0xF90EDA2C ^0xF90EDA2C
{
	func_558(uParam0, 4);

	if (func_559(uParam0, &uParam1, iParam5))
		func_267(uParam0, 1);

	return;
}

void func_350(var uParam0) // Position - 0xB60F Hash - 0xA8653B4C ^0xE273D469
{
	if (!func_560(uParam0))
		return;
...
void func_351(var uParam0) // Position - 0xB65E Hash - 0x476EAC02 ^0x476EAC02
{
	uParam0->f_1685 = -1;
	func_266(uParam0, 0);
	func_267(uParam0, 3);
	func_565(uParam0, 0);
	func_249(&(uParam0->f_1869));
	func_566(uParam0);
	func_249(&(uParam0->f_1872));
	return;
}

BOOL func_352(var uParam0) // Position - 0xB699 Hash - 0x3E0BE1C5 ^0x3E0BE1C5
{
	if (uParam0->f_1770)
		return false;
...
void func_353() // Position - 0xB6B2 Hash - 0x34DFCE1E ^0x82FD7E0E
{
	Global_18 = true;
...
BOOL func_354(var uParam0) // Position - 0xB6C5 Hash - 0xD11B2D8F ^0xAF993603
{
	if (uParam0->f_1684 >= 0)
...
BOOL func_355(var uParam0) // Position - 0xB72F Hash - 0xD11B2D8F ^0x7DF32AFD
{
	if (uParam0->f_1684 >= 0)
...
BOOL func_356(var uParam0, int iParam1) // Position - 0xB799 Hash - 0xAD745B57 ^0xE275B512
{
	...
	switch (uParam0->f_475[uParam0->f_1685 /*18*/].f_2)
	{
		...
		case 9:
			if (!uParam0->f_1768)
			{
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(func_567(uParam0)) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(func_567(uParam0), false))
					uParam0->f_1768 = 1;
			}
			else
			{
				animScenePhase = ANIMSCENE::GET_ANIM_SCENE_PHASE(func_567(uParam0));
				isAnimSceneFinished = ANIMSCENE::IS_ANIM_SCENE_FINISHED(func_567(uParam0), false);
				isAnimSceneExitingThisFrame = ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(func_567(uParam0));
...
BOOL func_357(var uParam0) // Position - 0xB8BB Hash - 0xC826A15F ^0x5EB78367
{
	int i;
...
int func_358(var uParam0) // Position - 0xB8EA Hash - 0x50F804CE ^0x820D79BE
{
	int i;

	for (i = 0; i < 30; i = i + 1)
	{
		if (uParam0->f_475[i /*18*/].f_17 == 2 && func_568(&uParam0->f_475[i /*18*/], 4))
			return i;
	}
...
BOOL func_359(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0xB92E Hash - 0x6735ACA9 ^0xD6205CC6
{
...
struct<8> func_360(var uParam0, Entity eParam1) // Position - 0xB964 Hash - 0xD113665C ^0x816D8C19
{
	var unk;
	int num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(eParam1))
	{
		TEXT_LABEL_ASSIGN_STRING(&unk, func_294(eParam1), 64);
	
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&unk))
		{
			num = func_569(uParam0, eParam1);
...
BOOL func_361(var uParam0, int iParam1) // Position - 0xB9AF Hash - 0x718DD1EF ^0xF9145158
{
	return uParam0->f_9 && iParam1 != false;
}

void func_362(AnimScene ansParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xB9C0 Hash - 0xFFE17847 ^0x68A7B4F3
{
	int i;
...
void func_363(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xBA55 Hash - 0x303BFB8D ^0xBCF80455
{
	int i;
	...
	for (i = 0; i < Global_1911670; i = i + 1)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(volLockRequestId))
		{
			...
			if (func_549(vector, uParam0, 2f, true))
			{
...
void func_364(Ped pedParam0) // Position - 0xBAD9 Hash - 0xF249FD1D ^0xC50FDB38
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_365(var uParam0, Ped pedParam1, const char* sParam2) // Position - 0xBB15 Hash - 0xB02DACC7 ^0xB02DACC7
{
	func_570(&(uParam0->f_428), pedParam1, sParam2);
	return;
}

BOOL func_366(int iParam0, int iParam1) // Position - 0xBB2A Hash - 0x718DD1EF ^0x863E326
{
	return iParam0->f_63 && iParam1 != false;
}

void func_367(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0xBB3B Hash - 0xA4706F79 ^0xAF27D1D3
{
	BOOL flag;
	PersChar persChar;
	BOOL flag2;
	...
	func_572(essParam0, 4, false);
	func_573(essParam0);
	func_574(essParam0);
	func_575(essParam0, 37, true);
	flag = func_258(Global_1360165[essParam0 /*1157*/], 0);
	persChar = func_576(essParam0, false);
	...
	if (func_491(essParam0, 64, true))
		func_575(essParam0, 64, true);

	if (bParam3)
	{
		func_575(essParam0, 33, true);
		func_575(essParam0, 34, true);
		func_577(essParam0, 1056964608, -1, 1061158912);
		func_578(essParam0, true, true, false);
	...
	else
	{
		...
		func_578(essParam0, false, true, false);
		...
		{
			func_249(&(Global_1360165[essParam0 /*1157*/].f_130));
		}
	...
	if (bParam1 || bParam2)
		if (ENTITY::DOES_ENTITY_EXIST(Global_1360165[essParam0 /*1157*/]))
			func_580(essParam0, bParam2, bParam2, bParam2, false);
	else if (flag)
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Global_1360165[essParam0 /*1157*/], false);

	if (func_491(essParam0, 45, true))
		func_575(essParam0, 45, true);

	func_581(essParam0, 16, true);
	func_575(essParam0, 44, true);
	Global_1360165[essParam0 /*1157*/].f_129 = 0;
	Global_40.f_4942[essParam0 /*60*/].f_4 = 0;

	if (bParam5)
		if (func_258(func_582(essParam0), 0))
			func_583(0, essParam0, bParam3, 0, bParam2);

	return;
}

BOOL func_368(var uParam0) // Position - 0xBDF0 Hash - 0x68548E72 ^0x68548E72
{
	return *uParam0 != 0;
}

BOOL func_369(int iParam0, int iParam1) // Position - 0xBDFD Hash - 0xD6EFA90F ^0xD6EFA90F
{
	int num;
...
void func_370(var uParam0) // Position - 0xBE14 Hash - 0xCE9A6290 ^0xF286CA0E
{
...
BOOL func_371(var uParam0) // Position - 0xBE3A Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

void func_372(var uParam0) // Position - 0xBE4A Hash - 0x25B0A6DE ^0x72F31499
{
...
BOOL func_373(var uParam0) // Position - 0xBE99 Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

void func_374(var uParam0) // Position - 0xBEA9 Hash - 0xA22DA6B0 ^0x16EE41FE
{
	if (!func_585(uParam0->f_1, 1))
	{
...
BOOL func_375(var uParam0) // Position - 0xBECE Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

BOOL func_376(var uParam0) // Position - 0xBEDE Hash - 0xBB45F689 ^0x6A44F33B
{
...
BOOL func_377(var uParam0) // Position - 0xBF21 Hash - 0x628E0BDA ^0x4AB4005A
{
...
BOOL func_378(var uParam0) // Position - 0xBF5D Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

void func_379(var uParam0) // Position - 0xBF6D Hash - 0x23BD7ECC ^0x33E0A7D4
{
	char* entityId;
	...
	if (!func_585(uParam0->f_2, 1))
	{
		if (func_505(uParam0))
		{
			...
			{
				entityId = func_412(ENTITY::GET_ENTITY_MODEL(Global_35));
				...
				else if (ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(uParam0->f_1, "player_three") && func_589())
...
BOOL func_380(var uParam0) // Position - 0xC02D Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

void func_381(var uParam0, AnimScene ansParam1) // Position - 0xC03D Hash - 0xF5E93730 ^0x42495AA1
{
	if (!func_585(uParam0->f_1, 1))
	{
...
BOOL func_382(var uParam0) // Position - 0xC074 Hash - 0x68548E72 ^0x68548E72
{
	return *uParam0 != 0;
}

void func_383(var uParam0) // Position - 0xC081 Hash - 0xA1E8590D ^0xEFF60CC2
{
	if (!func_585(uParam0->f_2, 1))
	{
...
BOOL func_384(var uParam0) // Position - 0xC0A7 Hash - 0x68548E72 ^0x68548E72
{
	return *uParam0 != 0;
}

void func_385(var uParam0) // Position - 0xC0B4 Hash - 0x11C7E32E ^0x57AC62D0
{
	if (!func_585(uParam0->f_3, 1))
	{
...
BOOL func_386(var uParam0) // Position - 0xC0E1 Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

void func_387(var uParam0) // Position - 0xC0F1 Hash - 0xA1E8590D ^0x17E137DF
{
	if (!func_585(uParam0->f_1, 1))
	{
...
BOOL func_388(var uParam0) // Position - 0xC117 Hash - 0x1C63C0A9 ^0x1C63C0A9
{
	return func_590(*uParam0);
}

void func_389(var uParam0) // Position - 0xC126 Hash - 0xA22DA6B0 ^0xCD6F15BE
{
	if (!func_585(uParam0->f_1, 1))
	{
...
BOOL func_390(var uParam0) // Position - 0xC14B Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

void func_391(var uParam0) // Position - 0xC15B Hash - 0x7949534F ^0x690C4E7
{
	if (!func_585(uParam0->f_2, 1))
	{
...
BOOL func_392(var uParam0) // Position - 0xC188 Hash - 0x5BEBB5CC ^0x4764F1AF
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(*uParam0);
}

void func_393(var uParam0) // Position - 0xC198 Hash - 0xA22DA6B0 ^0xA4C9F2CE
{
	if (!func_585(uParam0->f_1, 1))
	{
...
BOOL func_394(int iParam0) // Position - 0xC1BD Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_395(BOOL bParam0) // Position - 0xC1FB Hash - 0x825A04C0 ^0x825A04C0
{
	return bParam0 & 31;
}

int func_396(BOOL bParam0) // Position - 0xC208 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

struct<8> func_397(var uParam0) // Position - 0xC21B Hash - 0xDB13DC73 ^0xDB13DC73
{
	return uParam0->f_454;
}

struct<8> func_398() // Position - 0xC22B Hash - 0x964AA7CC ^0xB5E9340F
{
	var unk;
...
BOOL func_399(int iParam0) // Position - 0xC240 Hash - 0x67D822A ^0x67D822A
{
	switch (iParam0)
	{
		case 14:
...
Vector3 func_400(int iParam0) // Position - 0xC270 Hash - 0x695A7658 ^0x6D3D4EDB
{
	switch (iParam0)
	{
		case 14:
...
void func_401(Volume volParam0) // Position - 0xC2C2 Hash - 0x93784101 ^0x333F564B
{
	int i;
	...
	for (i = 0; i < Global_1393237.f_11; i = i + 1)
	{
		...
		{
			func_591(i, 4096, false);
			func_591(i, 131072, false);
			func_592(i, 1);
		}
	}
...
Volume func_402(Volume volParam0, var uParam1, BOOL bParam2, Entity eParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0xC321 Hash - 0x6F9FCD12 ^0xB17393EA
{
	var volumeCoords;
	float volumeScale;
	Volume volume;
	...
	volume = func_593(volumeCoords, volumeScale, uParam1, bParam2, eParam3, iParam4, bParam5, iParam6);
	return volume;
}

void func_403(var uParam0, const char* sParam1, BOOL bParam2) // Position - 0xC365 Hash - 0x77539CD1 ^0x7EE21A9
{
	int i;
...
void func_404(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC431 Hash - 0x1074C30B ^0x1074C30B
{
	int i;
	int num;
	...
	if (func_596(iParam0))
	{
		for (i = 0; i < Global_1946054.f_852; i = i + 1)
		{
			...
			if (Global_1946054.f_769[num /*4*/] == 34 && func_596(20))
				return;
		}
	}
...
void func_405(var uParam0) // Position - 0xC535 Hash - 0xA0536A87 ^0xE1A3FD9C
{
...
struct<8> func_406() // Position - 0xC551 Hash - 0x964AA7CC ^0xBF03D2C1
{
	var unk;
...
BOOL func_407(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0xC566 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_408(var uParam0, Volume volParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC58F Hash - 0x7AEE4E7D ^0x4CE819C0
{
	int num;
...
BOOL func_409(int iParam0, int iParam1) // Position - 0xC5CE Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_410(int iParam0) // Position - 0xC5DD Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
void func_411(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC61C Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
char* func_412(Hash hParam0) // Position - 0xC670 Hash - 0xE6862179 ^0x49E02EC9
{
	switch (hParam0)
	{
...
BOOL func_413(int iParam0) // Position - 0xD1F9 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return iParam0 != 0;
}

BOOL func_414(int iParam0, int iParam1) // Position - 0xD205 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
int func_415(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, int iParam10, Hash hParam11, BOOL bParam12) // Position - 0xD226 Hash - 0x6B838E14 ^0xADF883E0
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_600(num, hParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, bParam9, false, 0, hParam11, bParam12);
		return num;
	}
...
void func_416(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD2AC Hash - 0x139797B1 ^0x139797B1
{
	int num;

	if (bParam2 && !func_410(iParam0))
		return;

	num = func_598(iParam0);
	func_601(num, bParam1);
	return;
}

void func_417(int iParam0, int iParam1, BOOL bParam2) // Position - 0xD2D8 Hash - 0x90B9FBB4 ^0x1E664566
{
	int num;
...
void func_418(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD321 Hash - 0x89AE2BEC ^0x89AE2BEC
{
	int num;
...
float func_419(int iParam0, BOOL bParam1) // Position - 0xD370 Hash - 0x376EA9F4 ^0xA7A80B21
{
	int num;
...
BOOL func_420(int iParam0, BOOL bParam1) // Position - 0xD3C8 Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
BOOL func_421(var uParam0) // Position - 0xD420 Hash - 0x69DF0810 ^0x1B578435
{
	var string1;
	var string2;
...
BOOL func_422(Hash hParam0) // Position - 0xD446 Hash - 0x798E6037 ^0xDD3AB35C
{
	int i;
...
void func_423(var uParam0, const char* sParam1) // Position - 0xD486 Hash - 0xF23C2839 ^0x7A33E8E5
{
	var string1;
...
void func_424(var uParam0, const char* sParam1, Entity eParam2, int iParam3) // Position - 0xD4DD Hash - 0x8115405E ^0x889845AA
{
...
void func_425(Ped pedParam0) // Position - 0xD51B Hash - 0xC848742E ^0xD171C7FA
{
	int i;
...
BOOL func_426(var uParam0) // Position - 0xD551 Hash - 0xF2A750AD ^0xEE67A154
{
...
BOOL func_427(Hash hParam0, int iParam1) // Position - 0xD596 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
Hash func_428(Hash hParam0) // Position - 0xD5B0 Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
void func_429(int iParam0, BOOL bParam1) // Position - 0xD5DB Hash - 0x9D46840B ^0xDAAD5146
{
	int value;
	int healthAmount;
...
void func_430(int iParam0) // Position - 0xD64C Hash - 0xD46386C8 ^0x5B34A14E
{
	int num;
...
void func_431(BOOL bParam0, BOOL bParam1) // Position - 0xD689 Hash - 0x26C4C089 ^0x53EE9A65
{
	int ammoInPedWeapon;
	int weaponClipSize;
	int i;
	...
	for (i = 0; i < 29; i = i + 1)
	{
		...
		{
			if (func_445(weaponHash) && WEAPON::IS_WEAPON_A_GUN(weaponHash))
			{
				if (bParam0)
...
void func_432() // Position - 0xD766 Hash - 0x2910738C ^0x2910738C
{
	Hash weaponHash;

	weaponHash = func_444(Global_35, 9, true, false);

	if (func_445(weaponHash))
		return;
	...
	if (func_445(weaponHash) && WEAPON::_IS_WEAPON_TWO_HANDED(weaponHash))
	{
...
Object* func_433() // Position - 0xD8E1 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1900383.f_393;
}

int func_434(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xD8F0 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_435(int iParam0) // Position - 0xD9E7 Hash - 0xC20F1267 ^0xD623971A
{
	Global_40.f_1095.f_3054.f_1 = iParam0;
	return;
}

void func_436(int iParam0) // Position - 0xD9FC Hash - 0xF15D3FA8 ^0xF15D3FA8
{
	Global_40.f_1095.f_3054 = iParam0;
	return;
}

void func_437(var uParam0, var uParam1, var uParam2) // Position - 0xDA0F Hash - 0xD65C08CA ^0xEAB2D54F
{
	Global_40.f_1095.f_3054.f_77 = { uParam0 };
	return;
}

Hash func_438() // Position - 0xDA28 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_439(Hash hParam0) // Position - 0xDA34 Hash - 0xC20F1267 ^0x9F8567FC
{
	Global_40.f_1095.f_3054.f_2 = hParam0;
	return;
}

BOOL func_440() // Position - 0xDA49 Hash - 0x3630EC94 ^0x3630EC94
{
	return func_613() || func_614();
}

Vector3 func_441(var uParam0) // Position - 0xDA5F Hash - 0xBDA8105E ^0xBDA8105E
{
	return uParam0->f_505;
}

float func_442(var uParam0) // Position - 0xDA6E Hash - 0x9BB76AD4 ^0x9BB76AD4
{
	return uParam0->f_508;
}

float func_443(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0xDA7B Hash - 0x9F66817B ^0xCA5C01B6
{
	float num;
	float num2;
	float num3;
...
Hash func_444(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xDAE0 Hash - 0x1C2A4A11 ^0x6B00CBB4
{
	int weaponHash;
...
BOOL func_445(Hash hParam0) // Position - 0xDB06 Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

BOOL func_446(var uParam0, Ped pedParam1) // Position - 0xDB21 Hash - 0x299AC54D ^0xA15A1941
{
	int i;
...
void func_447(BOOL bParam0) // Position - 0xDB6E Hash - 0xB6AD8D7C ^0xB6AD8D7C
{
	Global_1946054 = Global_1946054 || bParam0;
	return;
}

void func_448(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0xDB81 Hash - 0x767FA5CE ^0x6D58A5B0
{
	int i;
	Hash shopItemComponentCategory;
	int num;

	num = func_453(iParam1, 1);
...
BOOL func_449(BOOL bParam0) // Position - 0xDC7E Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1946054 && bParam0 != false;
}

BOOL func_450(int iParam0, int iParam1) // Position - 0xDC8F Hash - 0x5EDC7379 ^0x87AAB49F
{
	return Global_1946054.f_57[func_461(iParam0, 1) /*11*/].f_10 && iParam1 != false;
}

BOOL func_451(int iParam0, Hash hParam1) // Position - 0xDCAD Hash - 0xECB143B0 ^0x61AB85CB
{
	return Global_1946054.f_57[iParam0 /*11*/].f_9 && hParam1 != false;
}

void func_452(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDCC6 Hash - 0x1EA557EC ^0xC168425
{
	int num;

	num = 10;

	if (func_450(1108822547, 6))
	{
		if (bParam2)
		{
			func_448(pedParam0, num, func_256() != -1, false, 0);
...
int func_453(int iParam0, int iParam1) // Position - 0xDD8E Hash - 0xE1D12727 ^0xA46110B3
{
	switch (iParam0)
	{
		case 0:
...
void func_454(int iParam0, int iParam1, int iParam2) // Position - 0xDFDD Hash - 0x10354A04 ^0xEB1297F4
{
	Global_1946054.f_57[func_461(iParam0, 1) /*11*/].f_10 = Global_1946054.f_57[func_461(iParam0, 1) /*11*/].f_10 || iParam1;
	return;
}

void func_455(int iParam0, int iParam1, int iParam2) // Position - 0xE00A Hash - 0x8A858A95 ^0xC4492E92
{
...
void func_456(var uParam0) // Position - 0xE049 Hash - 0x191996BC ^0x191996BC
{
	var unk;
...
void func_457(var uParam0) // Position - 0xE05E Hash - 0x726DEA7F ^0x726DEA7F
{
	int i;
...
void func_458() // Position - 0xE086 Hash - 0xEB0D43DD ^0xEB0D43DD
{
	Global_1911774 = true;
	return;
}

struct<5> func_459(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE093 Hash - 0xE6705E3C ^0xB9EA38F4
{
	var unk;
	var unk6;
	var unk28;
...
int func_460(var uParam0) // Position - 0xE350 Hash - 0x10AF8248 ^0x703E5ADF
{
	int i;
...
int func_461(int iParam0, int iParam1) // Position - 0xE38B Hash - 0x9D981F95 ^0x9D981F95
{
	switch (iParam0)
	{
		case -1944638739:
...
BOOL func_462(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE55C Hash - 0x5BE0E7EF ^0xB7318963
{
	var unk;
	int num;
	int i;
	...
	if (func_449(32768) && iParam2 == 10 && hParam0 != Global_1946054.f_57[iParam2 /*11*/])
		func_628(func_453(iParam2, 1));
	...
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_633(hParam0, iParam2, hParam1, func_256() != -1);
	...
	if (bParam3)
	{
		for (i = 0; i < Global_1946054.f_2589; i = i + 1)
		{
			if (Global_1946054.f_2589.f_2[i /*2*/] >= 0 && Global_1946054.f_2589.f_2[i /*2*/] < 39)
			{
				...
				func_455(func_453(Global_1946054.f_2589.f_2[i /*2*/], 1), 1, 6);
			}
		}
	}
...
void func_463(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE769 Hash - 0x5AF76643 ^0x5AF76643
{
	func_635(&(Global_1946054.f_2589), bParam0, bParam1, bParam2);
	return;
}

void func_464(int iParam0, int iParam1, int iParam2, Ped pedParam3, BOOL bParam4) // Position - 0xE782 Hash - 0x32CA993A ^0x90267B41
{
	int num;
...
void func_465() // Position - 0xE7B4 Hash - 0xB6203BF0 ^0x217DD714
{
	func_637(&(Global_1946054.f_2776));
	func_638(32768);
	func_455(1108822547, 8, 6);
	return;
}

int func_466(int iParam0) // Position - 0xE7DB Hash - 0x6D41B005 ^0x1854201E
{
	int num;
	int num2;
...
void func_467(int iParam0, int iParam1, int iParam2) // Position - 0xE83F Hash - 0xE79F3F0D ^0xAC72E90D
{
	int num;
...
struct<4> func_468(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xE85F Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
int func_469(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xE890 Hash - 0xD01EE834 ^0xC97ABD1E
{
	var guid;
...
int func_470(BOOL bParam0) // Position - 0xE8D8 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_256() == -1)
	{
...
BOOL func_471(int iParam0, int iParam1) // Position - 0xE919 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_472(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xE928 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
BOOL func_473(Ped pedParam0) // Position - 0xE981 Hash - 0xD8557B87 ^0xA36AC234
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_474(Ped pedParam0, var uParam1, var uParam2, var uParam3) // Position - 0xEA2B Hash - 0x4FB200FB ^0x9AEFCD02
{
	var entityCoords;
	var unk3;
...
BOOL func_475(int iParam0, int iParam1) // Position - 0xEA5E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_476(var uParam0, int iParam1) // Position - 0xEA6D Hash - 0xF55E891F ^0xF55E891F
{
	func_640(uParam0, iParam1);
	return;
}

BOOL func_477(Ped pedParam0, int iParam1) // Position - 0xEA7D Hash - 0x8826373E ^0x6E06CE7E
{
...
void func_478(var uParam0, int iParam1) // Position - 0xEAFE Hash - 0xF55E891F ^0xF55E891F
{
	func_641(uParam0, iParam1);
	return;
}

BOOL func_479(eStackSize essParam0) // Position - 0xEB0E Hash - 0xEC8E4F18 ^0xEC8E4F18
{
	return essParam0 > -1;
}

void func_480(int iParam0, float fParam1) // Position - 0xEB1A Hash - 0x45CA0D9B ^0xFE71E5A0
{
	int num;
	BOOL flag;
	char* str;
...
void func_481(var uParam0, int iParam1) // Position - 0xEBF0 Hash - 0x659ACE5B ^0xF162830A
{
	uParam0->f_1666.f_1 = uParam0->f_1666.f_1 || iParam1;
	return;
}

BOOL func_482(var uParam0, int iParam1) // Position - 0xEC09 Hash - 0x718DD1EF ^0xD2A89BB9
{
	return uParam0->f_26 && iParam1 != false;
}

char* func_483(int iParam0) // Position - 0xEC1A Hash - 0x2020ACF ^0x72C99EF7
{
	switch (iParam0)
	{
		case 1:
...
char* func_484() // Position - 0xEC3E Hash - 0x306ACA3A ^0x2DEB4EE5
{
	return "default_leadin_camera";
}

void func_485() // Position - 0xEC4A Hash - 0x603315F4 ^0x107C5E3F
{
	SCRIPTS::SET_SCRIPT_WITH_NAME_HASH_AS_NO_LONGER_NEEDED(joaat("bandana"));
	STREAMING::REMOVE_ANIM_DICT(func_531(1));
	return;
}

BOOL func_486(int iParam0) // Position - 0xEC64 Hash - 0x8EF26C67 ^0x9855652A
{
	int num;
...
BOOL func_487(int iParam0) // Position - 0xECCF Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_488(int iParam0, BOOL bParam1) // Position - 0xECE5 Hash - 0x34A2E44 ^0x39A823C1
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_489(var uParam0, Entity eParam1) // Position - 0xED18 Hash - 0x9ADF6CEA ^0xA4B4891F
{
	if (!ENTITY::DOES_ENTITY_EXIST(eParam1))
		return false;
...
Ped func_490(eStackSize essParam0) // Position - 0xED48 Hash - 0xFBADD85B ^0xFBADD85B
{
	if (func_114(essParam0))
		return Global_1360165[essParam0 /*1157*/];
...
BOOL func_491(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0xED66 Hash - 0x6ED0C3E9 ^0xD0355731
{
	int num;
	int offset;
	...
	func_648(iParam1, &num, &offset);
	return MISC::IS_BIT_SET(Global_1360165[essParam0 /*1157*/].f_58[num], offset);
}

void func_492(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0xEDA1 Hash - 0xA83ABB27 ^0x3839CF85
{
	int num;
	int offset;
	...
	switch (Global_1360165[essParam0 /*1157*/].f_11)
	{
		case 0:
			if (func_491(essParam0, 2, true))
				func_575(essParam0, 2, true);
		
			if (func_265(essParam0, 16, true))
			{
				if (Global_1360165[essParam0 /*1157*/].f_129 != SCRIPTS::GET_ID_OF_THIS_THREAD())
				{
					...
					{
						func_367(essParam0, false, false, true, -1082130432, true, true, false, false, false, false);
					}
				
					return 0;
				}
				else if (func_258(Global_1360165[essParam0 /*1157*/], 0))
				{
					return Global_1360165[essParam0 /*1157*/];
				}
			}
		
			if (func_258(Global_1360165[essParam0 /*1157*/], 0))
			{
		...
		case 1:
			...
			if (func_651(essParam0, unk, iParam13, false, true, bParam17, bParam20, -1, 1, false))
				func_650(essParam0, 2);
			break;
		...
		case 2:
			...
			func_578(essParam0, bParam9, true, false);
			...
			func_575(essParam0, 33, true);
			func_575(essParam0, 34, true);
			func_575(essParam0, 29, true);
		
			if (!_IS_NULL_VECTOR(unk) && bParam7)
				func_650(essParam0, 3);
			else if (iParam13 != 0)
				func_650(essParam0, 4);
			else
				func_650(essParam0, 5);
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[essParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[essParam0 /*1157*/], -1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(Global_1360165[essParam0 /*1157*/]))
				{
					...
					{
						func_649(essParam0, true, "Teleporting a stolen companion using a scenario.");
					}
					else
					{
		...
		case 4:
			if (iParam13 != 0 || flag)
			{
				...
				if (func_652(essParam0, iParam13))
				{
					if (PED::IS_PED_READY_TO_RENDER(Global_1360165[essParam0 /*1157*/]))
					{
						func_653(essParam0, iParam13, false);
						func_654(essParam0, Global_1360165[essParam0 /*1157*/], iParam13, true);
					
						if (func_491(essParam0, 25, false))
							func_575(essParam0, 25, false);
		...
		case 6:
			if (func_258(Global_1360165[essParam0 /*1157*/], 0))
			{
				...
				if (bParam21)
				{
					...
					func_656(Global_1360165[essParam0 /*1157*/], 1);
				}
			}
		
			func_650(essParam0, 7);
			[[fallthrough]];
	
		case 7:
			func_578(essParam0, bParam9, bParam15, false);
			func_572(essParam0, 4, bParam11);
			func_574(essParam0);
		
			if (bParam20)
				func_657(Global_1360165[essParam0 /*1157*/]);
		
			func_658(essParam0, Global_1360165[essParam0 /*1157*/]);
...
void func_494(var uParam0, Entity eParam1) // Position - 0xF44B Hash - 0x47841D83 ^0x16951740
{
	if (!ENTITY::DOES_ENTITY_EXIST(eParam1))
		return;
...
void func_495(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF4A3 Hash - 0xD36E5344 ^0xE44BBDDC
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_496(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF558 Hash - 0xE11FEEB6 ^0xE11FEEB6
{
	if (!func_114(essParam0))
		return;
...
void func_497(eStackSize essParam0) // Position - 0xF59D Hash - 0xA9477085 ^0x50DAE8B3
{
	Ped ped;
...
BOOL func_498(int iParam0, BOOL bParam1) // Position - 0xF5CF Hash - 0x5C4302E7 ^0x5C4302E7
{
	if (!func_316(iParam0))
		return false;

	if (func_317(iParam0, true) && !func_318(iParam0) && func_319(iParam0))
		return false;
	...
	if (!bParam1)
		if (!func_664(iParam0, false))
			return false;

	return true;
}

void func_499(int iParam0, BOOL bParam1) // Position - 0xF62F Hash - 0x61515A20 ^0x61515A20
{
	if (func_256() != -1)
		return;
...
void func_500(int iParam0) // Position - 0xF660 Hash - 0x5A948764 ^0xFC1342AE
{
	if (!func_316(iParam0))
		return;
...
void func_501(var uParam0, int iParam1) // Position - 0xF683 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

BOOL func_502(var uParam0) // Position - 0xF690 Hash - 0xBB45F689 ^0x2A0151A
{
	if (func_585(uParam0->f_1, 2))
		return true;
...
BOOL func_503(var uParam0) // Position - 0xF6D3 Hash - 0x81A22FBD ^0x560BCA36
{
...
BOOL func_504(var uParam0) // Position - 0xF753 Hash - 0xBB45F689 ^0xA82EEDBE
{
	if (func_585(uParam0->f_1, 2))
		return true;
...
BOOL func_505(var uParam0) // Position - 0xF796 Hash - 0x4763A261 ^0x3D853F54
{
	Vector3 position;
	var rotation;
...
BOOL func_506(var uParam0) // Position - 0xF802 Hash - 0x2427C87C ^0x36B2F4F4
{
...
BOOL func_507(var uParam0, AnimScene ansParam1) // Position - 0xF848 Hash - 0x41147E93 ^0xD471A2
{
	if (func_585(uParam0->f_1, 2))
		return true;
...
BOOL func_508(var uParam0) // Position - 0xF8AD Hash - 0xBB45F689 ^0x72E400CF
{
	if (func_585(uParam0->f_2, 2))
		return true;
...
BOOL func_509(var uParam0) // Position - 0xF8F0 Hash - 0xBB45F689 ^0x4D63B708
{
	if (func_585(uParam0->f_3, 2))
		return true;
...
BOOL func_510(var uParam0) // Position - 0xF933 Hash - 0xBB45F689 ^0x9398190A
{
	if (func_585(uParam0->f_1, 2))
		return true;
...
BOOL func_511(var uParam0) // Position - 0xF976 Hash - 0xBB45F689 ^0xBECABA13
{
	if (func_585(uParam0->f_1, 2))
		return true;
...
BOOL func_512(var uParam0) // Position - 0xF9B9 Hash - 0xE08F88B3 ^0x1237832E
{
	if (func_585(uParam0->f_2, 2))
		return true;
...
BOOL func_513(var uParam0) // Position - 0xFA03 Hash - 0xBB45F689 ^0xF403CE54
{
	if (func_585(uParam0->f_1, 2))
		return true;
...
int func_514(int iParam0) // Position - 0xFA46 Hash - 0x297139D9 ^0x297139D9
{
	if (!func_81(iParam0))
		return 1;
...
Vector3 func_515(int iParam0, int iParam1) // Position - 0xFC7A Hash - 0x9D2068FE ^0x9D2068FE
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 2794.382f, -1170.1671f, 46.924f;
			
				case 1:
					return 2793.8894f, -1169.1044f, 46.924f;
			
				case 2:
					return 2792.7307f, -1167.9827f, 46.9323f;
			}
			break;
	}
...
float func_516(int iParam0, int iParam1) // Position - 0xFCEF Hash - 0xC9A0637 ^0xC9A0637
{
	switch (iParam0)
	{
		case 0:
...
Ped func_517(Ped pedParam0) // Position - 0xFD44 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_518(Ped pedParam0) // Position - 0xFD4E Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_519(Ped pedParam0) // Position - 0xFD80 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_520(var uParam0, Entity eParam1, const char* sParam2, BOOL bParam3) // Position - 0xFDC2 Hash - 0xC30FA1B5 ^0xC172D664
{
	int num;
	var src;
	...
	if (bParam3)
	{
		...
		num = func_667(uParam0, sParam2);
	
		if (num == -1)
		{
			num = func_668(uParam0);
		}
		else
		{
...
char* func_521(Vehicle veParam0) // Position - 0xFEBF Hash - 0xE38AE9F ^0x138A7FEA
{
	Hash entityModel;
...
BOOL func_522(Hash hParam0) // Position - 0xFFEA Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

Vector3 func_523(float fParam0, var uParam1, var uParam2) // Position - 0xFFF6 Hash - 0xF4699381 ^0x5B6AE21A
{
	float num;
	float num2;
...
BOOL func_524(int iParam0, int iParam1) // Position - 0x10036 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

Ped func_525(int iParam0) // Position - 0x10045 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
void func_526(int iParam0, int iParam1) // Position - 0x10073 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_316(iParam0))
		return;
...
int func_527(int iParam0) // Position - 0x10094 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_178(iParam0))
		return -1;
...
BOOL func_528(var uParam0) // Position - 0x100B0 Hash - 0xB9A83C95 ^0x1D119752
{
	int i;
...
int func_529() // Position - 0x100FC Hash - 0x7DC7EE6A ^0xA1EBC045
{
	int i;
...
int func_530(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10130 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
char* func_531(int iParam0) // Position - 0x101CE Hash - 0xE6862179 ^0x3B8EA78
{
	switch (iParam0)
	{
		case 0:
...
void func_532(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10241 Hash - 0x87AE3855 ^0x8F9717D1
{
	Vector3 vector;
	...
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_1875))
	{
		if (!bParam1)
			...
			func_671(uParam0, uParam0->f_1898);
	}
	else
	{
		...
		if (bParam1)
		{
			vector = { uParam0->f_1882 * F2V(func_672(uParam0->f_1898)) };
		
			if (!func_549(vector, VOLUME::GET_VOLUME_SCALE(uParam0->f_1875), 1056964608, true) && !_IS_NULL_VECTOR(vector))
...
void func_533(var uParam0) // Position - 0x10347 Hash - 0x17D766C4 ^0x20455F02
{
	int i;
	Ped ped;
	...
	if (uParam0->f_1899 && ENTITY::DOES_ENTITY_EXIST(uParam0->f_1901) && VEHICLE::IS_DRAFT_VEHICLE(uParam0->f_1901))
	{
		...
		if (!func_63(uParam0, 8192))
			...
			else if (!func_673(512) || func_674(2) && VEHICLE::_GET_DRAFT_VEHICLE_DESIRED_SPEED(uParam0->f_1901) != 50f)
				VEHICLE::_SET_DRAFT_VEHICLE_DESIRED_SPEED(uParam0->f_1901, 50f);
	}
...
void func_534(var uParam0, BOOL bParam1) // Position - 0x10499 Hash - 0xAEC80ACE ^0xD5108EEE
{
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (uParam0->f_1633[i /*15*/].f_11 && VOLUME::DOES_VOLUME_EXIST(uParam0->f_1633[i /*15*/].f_12))
		{
			...
			if (!bParam1)
			{
				...
				if (func_675(Global_35, uParam0->f_1633[i /*15*/].f_12, 0, true))
				{
					if (uParam0->f_1688 >= 0)
					{
						func_339(uParam0, uParam0->f_1633[i /*15*/].f_10, uParam0->f_1345[uParam0->f_1688 /*22*/].f_1, 1065353216);
					...
					func_677(uParam0, i, firstEntityPedIsCarrying, flag2);
				}
				else if (func_678(&uParam0->f_1633[i /*15*/]) != 0)
				{
					func_677(uParam0, i, firstEntityPedIsCarrying, flag2);
				}
			}
			else if (func_524(uParam0->f_1633[i /*15*/].f_10, 4))
			{
				if (uParam0->f_1688 >= 0)
				{
					if (func_195(Global_35, uParam0->f_1016[uParam0->f_1688 /*41*/].f_1, true) > uParam0->f_1016[uParam0->f_1688 /*41*/].f_17 && func_675(uParam0->f_1898, uParam0->f_1633[i /*15*/].f_12, 0, true) || uParam0->f_1687 != 0 || func_63(uParam0, 33554432))
					{
						num = 5152;
					
						if (func_255(Global_35, &(uParam0->f_1687), num, 0, 0, 1084227584, 100, 0, 0))
						{
							PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), true, 0, false);
							uParam0->f_1687 = 0;
							func_313(uParam0, 33554432);
...
BOOL func_535(var uParam0) // Position - 0x106E9 Hash - 0x40B1DAD9 ^0xF3CFBA4F
{
	if (uParam0->f_1688 < 0)
		return false;
...
float func_536(var uParam0, int iParam1) // Position - 0x10769 Hash - 0x32CD4B9C ^0x7B337939
{
	var unk;
	Vector3 vector;
	var unk6;
	...
	switch (uParam0->f_1016[iParam1 /*41*/])
	{
		case 0:
			...
			if (func_679(&vector, uParam0->f_1016[iParam1 /*41*/].f_1, uParam0->f_1016[iParam1 /*41*/].f_4, unk, Global_36))
		...
		case 1:
			...
			{
				func_680(uParam0, iParam1, &unk6, unk9, &distanceBetweenCoords, &distanceBetweenCoords2, &num, &num2);
...
void func_537(var uParam0) // Position - 0x1090D Hash - 0xECA377F5 ^0xCD78B682
{
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (uParam0->f_1016[i /*41*/].f_29)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1016[i /*41*/].f_22)) && func_682(uParam0, i) && !func_482(&uParam0->f_1016[i /*41*/], 1))
			{
				if (!func_683(uParam0, &(uParam0->f_1016[i /*41*/].f_22)))
					func_162(&(uParam0->f_1771), uParam0->f_1016[i /*41*/].f_22, false, -1, true, false);
			
				func_684(&uParam0->f_1016[i /*41*/], 1);
			}
		}
	}
...
void func_538(int iParam0) // Position - 0x109AE Hash - 0x3A524DDA ^0x3A524DDA
{
	Global_1900383.f_316 = Global_1900383.f_316 || iParam0;
	return;
}

void func_539(var uParam0, int iParam1) // Position - 0x109C7 Hash - 0xE99A472E ^0xE99A472E
{
	*uParam0 = 0;

	if (!func_545(iParam1, 8))
		if (func_545(iParam1, 1))
			*uParam0 = 1;
		else if (func_545(iParam1, 4))
			*uParam0 = 4;
		else if (func_545(iParam1, 2))
			*uParam0 = 2;

	return;
}

void func_540(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10A0F Hash - 0xF379C9A0 ^0xF379C9A0
{
	func_546(sParam0, iParam2);
	func_685(iParam1, iParam3);
	return;
}

void func_541() // Position - 0x10A27 Hash - 0x88D1B502 ^0x73E48908
{
...
void func_542(var uParam0, int iParam1) // Position - 0x10A47 Hash - 0x537D9C68 ^0x537D9C68
{
	uParam0->f_1665 = uParam0->f_1665 || iParam1;
	return;
}

const char* func_543(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x10A5C Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

char* func_544() // Position - 0x10A70 Hash - 0x306ACA3A ^0x10711D5
{
	return "CAMERA_LEADIN_ACTIVE_CONVERSATION_REQUEST";
}

BOOL func_545(int iParam0, int iParam1) // Position - 0x10A7C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_546(char* sParam0, int iParam1) // Position - 0x10A8B Hash - 0x483685B7 ^0x8E6341E2
{
	if (iParam1 != 0)
	{
		if (!sParam0->f_16)
...
float func_547(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x10B14 Hash - 0x1516E186 ^0x4796BFA2
{
	var entityCoords;
	var entityCoords2;
...
void func_548(int iParam0, int iParam1) // Position - 0x10B42 Hash - 0x2D5EA878 ^0x4B3C84DD
{
...
BOOL func_549(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x10B60 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
void func_550(var uParam0, int iParam1) // Position - 0x10BB5 Hash - 0xB94A85A8 ^0xB94A85A8
{
	uParam0->f_1665 = uParam0->f_1665 - uParam0->f_1665 && iParam1;
	return;
}

BOOL func_551(var uParam0, var uParam1) // Position - 0x10BD0 Hash - 0xC60794FE ^0xC60794FE
{
	float num;
	float num2;
	var unk5;
	...
	if (uParam0->f_1016[uParam0->f_1688 /*41*/].f_29)
	{
		if (uParam0->f_1016[uParam0->f_1688 /*41*/] == 0)
		{
			...
			if (func_679(&num, uParam0->f_1765, Global_36, unk5, uParam0->f_1016[uParam0->f_1688 /*41*/].f_1))
			{
				num3 = 1;
...
void func_552(var uParam0, int iParam1) // Position - 0x10E17 Hash - 0xD3E61FFE ^0xFAF29D46
{
	if (iParam1 >= 0)
	{
...
void func_553(var uParam0, int iParam1, int iParam2) // Position - 0x10E4A Hash - 0x8C643353 ^0x26BA9222
{
	int i;
	float animScenePhase;
	...
	{
		case 4:
			func_556(uParam0, iParam1, false, false);
			break;
		...
		case 9:
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_1522[uParam0->f_475[iParam1 /*18*/].f_4 /*10*/].f_8) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_1522[uParam0->f_475[iParam1 /*18*/].f_4 /*10*/].f_8, false))
			{
				...
				if (func_568(&uParam0->f_475[iParam1 /*18*/], 4) && uParam0->f_475[iParam1 /*18*/].f_12 < 1f && animScenePhase >= uParam0->f_475[iParam1 /*18*/].f_12 && !PLAYER::IS_PLAYER_SCRIPT_CONTROL_ON(PLAYER::GET_PLAYER_INDEX()))
				{
					TASK::CLEAR_PED_TASKS(Global_35, true, false);
					PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), true, 0, false);
				}
			
				if (func_568(&uParam0->f_475[iParam1 /*18*/], 64) && func_687(uParam0, iParam1, false))
			...
			if (uParam0->f_475[iParam1 /*18*/].f_3 >= 0 && uParam0->f_475[iParam1 /*18*/].f_5 >= 0 && uParam0->f_475[iParam1 /*18*/].f_3 != uParam0->f_475[iParam1 /*18*/].f_5)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_3 /*13*/].f_2) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_5 /*13*/].f_2))
				{
					if (ENTITY::IS_ENTITY_A_PED(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_3 /*13*/].f_2) && PED::IS_PED_HUMAN(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_3 /*13*/].f_2)))
						func_689(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_3 /*13*/].f_2), uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_5 /*13*/].f_2, uParam0->f_475[iParam1 /*18*/].f_13, uParam0->f_475[iParam1 /*18*/].f_14);
				
					if (func_568(&uParam0->f_475[iParam1 /*18*/], 128) && ENTITY::IS_ENTITY_A_PED(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_5 /*13*/].f_2) && PED::IS_PED_HUMAN(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_5 /*13*/].f_2)))
						func_689(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_5 /*13*/].f_2), uParam0->f_3[uParam0->f_475[iParam1 /*18*/].f_3 /*13*/].f_2, uParam0->f_475[iParam1 /*18*/].f_13, uParam0->f_475[iParam1 /*18*/].f_14);
				}
			}
			break;
	}
...
BOOL func_554(var uParam0, int iParam1) // Position - 0x11182 Hash - 0x410F5B0E ^0xC3246AF5
{
	...
	if (_STOPWATCH_IS_INITIALIZED_0(uParam0) > 3 && uParam0->f_475[iParam1 /*18*/].f_17 == 1 && func_338(uParam0) != 11 && func_337(uParam0, uParam0->f_1684) && uParam0->f_475[iParam1 /*18*/].f_2 != 4)
		return 0;
	...
	if (uParam0->f_475[iParam1 /*18*/].f_2 == 9 && uParam0->f_475[iParam1 /*18*/].f_4 >= 0 && ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_1522[uParam0->f_475[iParam1 /*18*/].f_4 /*10*/].f_8))
		if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_1522[uParam0->f_475[iParam1 /*18*/].f_4 /*10*/].f_8, true, false))
			...
			if (func_361(&uParam0->f_1522[uParam0->f_475[iParam1 /*18*/].f_4 /*10*/], 4))
				if (!PED::_0xA218D2BBCAA7388C(Global_35, 1))
					return 0;
			else if (func_361(&uParam0->f_1522[uParam0->f_475[iParam1 /*18*/].f_4 /*10*/], 8))
...
void func_555(var uParam0, int iParam1, int iParam2) // Position - 0x1139D Hash - 0x4D6EAA0A ^0x8E3394B2
{
	switch (uParam0->f_475[iParam1 /*18*/].f_2)
	{
		case 4:
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_19)) && !MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_22)))
			{
				if (func_48(&(uParam0->f_1872)) >= (float)uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_25 / 1000)
				{
					...
					if (!AUDIO::_IS_SCRIPTED_CONVERSATION_CREATED(&(uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_22)))
						func_162(&(uParam0->f_1771), uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_22, false, -1, false, false);
					else
...
int func_556(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1150E Hash - 0x2E486115 ^0x9E8CE588
{
	BOOL flag;
	int num;
	int num2;
	...
	switch (func_338(uParam0))
	{
		case 0:
			if (!bParam3)
			{
				if (!func_691(uParam0, num2))
					uParam0->f_1685 = iParam1;
			
				uParam0->f_475[iParam1 /*18*/].f_7 = 1;
			}
		
			if (!func_315(&uParam0->f_1016[num2 /*41*/], 32) && func_692() && !MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_459)) || !func_315(&uParam0->f_1016[num2 /*41*/], 128) && uParam0->f_1899)
			{
				if (uParam0->f_1899)
				{
		...
		case 1:
			...
			if (!func_472(Global_35, SCRIPT_TASK_SWAP_WEAPON) && !func_472(Global_35, SCRIPT_TASK_PERFORM_SEQUENCE) && func_21(&(uParam0->f_1869)) >= 2.5f || !func_445(func_444(Global_35, 0, true, false)) && !func_445(func_444(Global_35, 1, true, false)) || flag)
			{
				func_693(uParam0);
				flag;
			}
		...
		case 4:
			...
			if (func_315(&uParam0->f_1016[num2 /*41*/], 256) || !func_426(&unk) || flag)
			{
				if (func_697())
				{
					func_698();
		...
		case 6:
			...
			if (func_255(Global_35, &(uParam0->f_1686), num, 0, 0, 1084227584, 100, num3, num4))
				func_693(uParam0);
			...
			if (!uParam0->f_1897 && !uParam0->f_1899 || flag)
			{
				...
				if (func_338(uParam0) == 5 || iParam1 < 0)
				{
					func_693(uParam0);
				}
				else
		...
		case 7:
			...
			if (func_695(Global_35, SCRIPT_TASK_PERFORM_SEQUENCE) || flag)
			{
				func_565(uParam0, 3);
				flag;
			}
		...
		case 8:
			...
			if (func_255(Global_35, &(uParam0->f_1686), num, 0, 0, 1084227584, 100, num3, num4) || flag)
			{
				uParam0->f_1686 = 0;
...
void func_557(const char* sParam0) // Position - 0x119D0 Hash - 0x509DAE22 ^0xD2C73440
{
	if (sParam0->f_16)
	{
...
void func_558(var uParam0, int iParam1) // Position - 0x11A15 Hash - 0xC988EF2 ^0xEEB0F4F5
{
	uParam0->f_1666.f_1 = uParam0->f_1666.f_1 - uParam0->f_1666.f_1 && iParam1;
	return;
}

BOOL func_559(var uParam0, const char* sParam1, int iParam2) // Position - 0x11A36 Hash - 0x7378698E ^0xF7CF98FA
{
	BOOL flag;
	BOOL flag2;
	var unk;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		...
		{
			if (func_703(uParam0, 43, &num))
			{
				if (num >= 0)
				{
					uParam0->f_1016[num /*41*/].f_27 = 0;
					func_704(uParam0, 1, &(uParam0->f_1016[num /*41*/].f_1));
					func_704(uParam0, 2, &(uParam0->f_1016[num /*41*/].f_1.f_1));
					func_704(uParam0, 3, &(uParam0->f_1016[num /*41*/].f_1.f_2));
					func_704(uParam0, 4, &(uParam0->f_1016[num /*41*/].f_11));
					func_704(uParam0, 5, &(uParam0->f_1016[num /*41*/].f_12));
					func_704(uParam0, 6, &(uParam0->f_1016[num /*41*/].f_13));
					func_704(uParam0, 7, &(uParam0->f_1016[num /*41*/].f_4));
					func_704(uParam0, 8, &(uParam0->f_1016[num /*41*/].f_4.f_1));
					func_704(uParam0, 9, &(uParam0->f_1016[num /*41*/].f_4.f_2));
					func_704(uParam0, 10, &(uParam0->f_1016[num /*41*/].f_7));
					func_704(uParam0, 11, &(uParam0->f_1016[num /*41*/].f_7.f_1));
					func_704(uParam0, 12, &(uParam0->f_1016[num /*41*/].f_7.f_2));
					func_704(uParam0, 13, &(uParam0->f_1016[num /*41*/].f_10));
					func_704(uParam0, 14, &(uParam0->f_1016[num /*41*/].f_14));
					func_704(uParam0, 15, &(uParam0->f_1016[num /*41*/].f_15));
				
					if (func_703(uParam0, 16, &num2))
						uParam0->f_1016[num /*41*/] = num2;
				
					func_704(uParam0, 19, &(uParam0->f_1016[num /*41*/].f_16));
					func_704(uParam0, 20, &(uParam0->f_1016[num /*41*/].f_17));
					func_704(uParam0, 31, &(uParam0->f_1016[num /*41*/].f_18));
				
					if (func_705(uParam0, 21, &unk14))
						TEXT_LABEL_COPY(&(uParam0->f_1016[num /*41*/].f_19), { unk14 }, 3);
				
					if (func_705(uParam0, 22, &unk14))
						TEXT_LABEL_COPY(&(uParam0->f_1016[num /*41*/].f_22), { unk14 }, 3);
				
					func_703(uParam0, 23, &(uParam0->f_1016[num /*41*/].f_25));
					func_706(uParam0, &(uParam0->f_1016[num /*41*/].f_27));
					func_705(uParam0, 35, &(uParam0->f_1016[num /*41*/].f_30));
				
					if (func_703(uParam0, 39, &num2))
						uParam0->f_1016[num /*41*/].f_39 = num2;
					else
						uParam0->f_1016[num /*41*/].f_39 = 1;
				
					if (func_704(uParam0, 40, &(uParam0->f_1016[num /*41*/].f_40)))
						func_684(&uParam0->f_1016[num /*41*/], 2);
				
					if (MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1016[num /*41*/].f_30)))
						uParam0->f_1016[num /*41*/].f_30 = { func_406() };
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (uParam0->f_1016[i /*41*/].f_29)
		{
			if (!func_707(unk22, uParam0->f_1016[i /*41*/].f_1, 5f, true))
			{
				uParam0->f_1900 = 0;
				break;
			}
	...
	for (i = 0; i < 11; i = i + 1)
	{
		...
		if (func_702(uParam0, 45))
		{
			if (func_703(uParam0, 47, &num))
			{
				if (num >= 0)
				{
					func_708(&uParam0->f_1522[num /*10*/], 2);
					func_705(uParam0, 46, &uParam0->f_1522[num /*10*/]);
				
					if (func_709(uParam0, 48, &flag4))
						if (flag4)
							func_708(&uParam0->f_1522[num /*10*/], 1);
				
					if (func_703(uParam0, 49, &num2))
						if (num2 == 1)
							func_708(&uParam0->f_1522[num /*10*/], 8);
						else if (num2 == 2)
							func_708(&uParam0->f_1522[num /*10*/], 4);
				}
			}
		}
	}
	...
	for (i = 0; i < 35; i = i + 1)
	{
		...
		if (func_702(uParam0, 50))
		{
			if (func_703(uParam0, 51, &num2))
				unk.f_1 = num2;
		
			func_703(uParam0, 43, &(unk.f_3));
		
			if (func_705(uParam0, 52, &unk14))
				TEXT_LABEL_COPY(&(unk.f_4), { unk14 }, 4);
		
			func_704(uParam0, 53, &(unk.f_8));
		
			if (func_703(uParam0, 54, &num2))
				unk.f_10 = num2;
		
			func_709(uParam0, 55, &(unk.f_11));
			func_709(uParam0, 56, &(unk.f_12));
			num3 = -1;
		
			if (func_710(uParam0, unk.f_1, &num3))
			{
				if (num3 >= 0 && num3 < 35)
				{
	...
	if (func_702(uParam0, 82))
	{
		if (func_705(uParam0, 83, &unk14))
			TEXT_LABEL_COPY(&(uParam0->f_459), { unk14 }, 4);
	
		func_705(uParam0, 84, &(uParam0->f_459.f_4));
		...
		if (func_702(uParam0, 57))
		{
			if (func_703(uParam0, 43, &num))
			{
				if (num >= 0)
				{
					...
					func_703(uParam0, 58, &uParam0->f_475[num /*18*/]);
				
					if (func_703(uParam0, 59, &num2))
						uParam0->f_475[num /*18*/].f_1 = func_712(num2);
				
					if (func_703(uParam0, 60, &num2))
						uParam0->f_475[num /*18*/].f_2 = func_713(num2);
				
					func_703(uParam0, 61, &(uParam0->f_475[num /*18*/].f_3));
					func_704(uParam0, 67, &(uParam0->f_475[num /*18*/].f_10));
					func_704(uParam0, 70, &(uParam0->f_475[num /*18*/].f_11));
					func_704(uParam0, 68, &(uParam0->f_475[num /*18*/].f_9));
					func_703(uParam0, 72, &(uParam0->f_475[num /*18*/].f_5));
					func_704(uParam0, 77, &(uParam0->f_475[num /*18*/].f_12));
					func_703(uParam0, 78, &(uParam0->f_475[num /*18*/].f_13));
					func_703(uParam0, 79, &(uParam0->f_475[num /*18*/].f_14));
				
					if (func_703(uParam0, 73, &num2))
						uParam0->f_475[num /*18*/].f_17 = num2;
				
					if (func_703(uParam0, 75, &num2))
					{
						uParam0->f_475[num /*18*/].f_4 = num2;
						flag3 = true;
					}
				
					func_704(uParam0, 80, &(uParam0->f_475[num /*18*/].f_15));
				
					if (func_709(uParam0, 63, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 1;
				
					if (func_709(uParam0, 81, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 512;
				
					if (func_709(uParam0, 64, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 2;
				
					if (func_709(uParam0, 66, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 16;
				
					if (func_709(uParam0, 69, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 32;
				
					if (func_709(uParam0, 65, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 4;
				
					if (func_709(uParam0, 74, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 64;
				
					if (func_709(uParam0, 71, &flag4))
						if (flag4)
							uParam0->f_475[num /*18*/].f_8 = uParam0->f_475[num /*18*/].f_8 | 128;
				
					if (func_709(uParam0, 76, &flag4))
						if (flag4)
	...
	for (i = 0; i < 8; i = i + 1)
	{
		...
		if (func_702(uParam0, 85))
		{
			func_703(uParam0, 86, &num);
		
			if (num >= 0)
			{
				func_709(uParam0, 87, &uParam0->f_1345[i /*22*/]);
				func_705(uParam0, 96, &(uParam0->f_1345[i /*22*/].f_2));
				func_705(uParam0, 97, &(uParam0->f_1345[i /*22*/].f_10));
				func_704(uParam0, 93, &(uParam0->f_1345[i /*22*/].f_18));
				func_704(uParam0, 94, &(uParam0->f_1345[i /*22*/].f_19));
				func_703(uParam0, 95, &(uParam0->f_1345[i /*22*/].f_20));
				uParam0->f_1345[i /*22*/].f_1 = 0;
				func_714(uParam0, &(uParam0->f_1345[i /*22*/].f_1));
			}
		}
	}
		...
		if (func_702(uParam0, 98))
		{
			if (func_703(uParam0, 43, &num))
			{
				if (num >= 0)
				{
					...
					func_715(uParam0, 99, &uParam0->f_1633[num /*15*/]);
					func_715(uParam0, 100, &(uParam0->f_1633[num /*15*/].f_6));
					func_715(uParam0, 101, &(uParam0->f_1633[num /*15*/].f_3));
				
					if (func_703(uParam0, 102, &num2))
						uParam0->f_1633[num /*15*/].f_9 = num2;
				
					func_706(uParam0, &(uParam0->f_1633[num /*15*/].f_10));
	...
	func_342(uParam0, 1);
	func_342(uParam0, 16384);
	func_716(uParam0);
	return true;
}

BOOL func_560(var uParam0) // Position - 0x125E4 Hash - 0xE2E246FD ^0x717ACDCC
{
	int i;

	for (i = 0; i < 11; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&uParam0->f_1522[i /*10*/]) && func_361(&uParam0->f_1522[i /*10*/], 2) && !func_361(&uParam0->f_1522[i /*10*/], 16) && func_717(uParam0, i))
		{
			if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_1522[i /*10*/].f_8))
			{
			...
			if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(uParam0->f_1522[i /*10*/].f_8, "pl_breakout"))
				func_708(&uParam0->f_1522[i /*10*/], 32);
		
			ANIMSCENE::_DELETE_ANIM_SCENE(uParam0->f_1522[i /*10*/].f_8);
			func_708(&uParam0->f_1522[i /*10*/], 16);
		}
	}
...
void func_561(var uParam0) // Position - 0x126E8 Hash - 0xDEFFFE22 ^0x89678B74
{
	int i;
	int flags;
	var unk;
	...
	for (i = 0; i < 11; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&uParam0->f_1522[i /*10*/]) && func_361(&uParam0->f_1522[i /*10*/], 2))
		{
			flags = 0;
		
			if (func_717(uParam0, i))
				flags = flags | 1;
	...
	TEXT_LABEL_ASSIGN_STRING(&unk, func_484(), 64);
	TEXT_LABEL_ASSIGN_STRING(&(unk.f_8), func_544(), 64);
	uParam0->f_1708 = { unk };
	uParam0->f_1731 = { unk };

	if (!func_314(uParam0, 8))
	{
		CAM::_LOAD_CAMERA_DATA_DICT(func_484());
		func_481(uParam0, 8);
	}

	for (i = 0; i < 8; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1345[i /*22*/].f_2)) && !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_1345[i /*22*/].f_2), func_484()))
		{
...
BOOL func_562(var uParam0) // Position - 0x12813 Hash - 0x4AF41662 ^0xDF22F701
{
	int i;
	BOOL flag;
	...
	for (i = 0; i < 11; i = i + 1)
	{
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_1522[i /*10*/].f_8))
		{
			if (!func_361(&uParam0->f_1522[i /*10*/], 64))
			{
				if (ANIMSCENE::IS_ANIM_SCENE_METADATA_LOADED(uParam0->f_1522[i /*10*/].f_8, false))
				{
					func_718(uParam0, uParam0->f_1522[i /*10*/].f_8);
					ANIMSCENE::LOAD_ANIM_SCENE(uParam0->f_1522[i /*10*/].f_8);
					flag = false;
					func_708(&uParam0->f_1522[i /*10*/], 64);
				}
				else
				{
					flag = false;
...
void func_563(var uParam0) // Position - 0x12A5E Hash - 0x8B348C33 ^0xFC38948B
{
	int i;
	Ped pedIndexFromEntityIndex;
	...
	for (i = 0; i < 35; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3[i /*13*/].f_2) && ENTITY::IS_ENTITY_A_PED(uParam0->f_3[i /*13*/].f_2) && !func_518(uParam0->f_3[i /*13*/].f_2) && func_445(uParam0->f_3[i /*13*/].f_10) && !func_711(uParam0->f_3[i /*13*/].f_1))
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(pedIndexFromEntityIndex))
			{
				if (!WEAPON::HAS_PED_GOT_WEAPON(pedIndexFromEntityIndex, uParam0->f_3[i /*13*/].f_10, 0, false))
					if (func_719(uParam0->f_3[i /*13*/].f_10))
				...
				if (uParam0->f_3[i /*13*/].f_11)
					if (func_720(pedIndexFromEntityIndex, false, 0, false) != uParam0->f_3[i /*13*/].f_10)
...
void func_564(var uParam0) // Position - 0x12C05 Hash - 0x4FE91EE4 ^0xFFAD755A
{
	int i;
	...
	for (i = 0; i < 35; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_3[i /*13*/].f_2) && uParam0->f_3[i /*13*/].f_12)
			func_721(&uParam0->f_3[i /*13*/]);
	}

	return;
}

void func_565(var uParam0, int iParam1) // Position - 0x12C4D Hash - 0x28F4EA76 ^0x7924DFD0
{
	uParam0->f_2 = iParam1;
	func_26(&(uParam0->f_1869));
	return;
...
void func_566(var uParam0) // Position - 0x12C64 Hash - 0x49584173 ^0x49584173
{
	func_722(uParam0);
	func_723(uParam0);
	return;
...
AnimScene func_567(var uParam0) // Position - 0x12C78 Hash - 0x4E93C1A2 ^0xE15CCA7
{
...
BOOL func_568(var uParam0, int iParam1) // Position - 0x12CBB Hash - 0x718DD1EF ^0x5F4D390E
{
	return uParam0->f_8 && iParam1 != false;
}

int func_569(var uParam0, Entity eParam1) // Position - 0x12CCC Hash - 0x8EA37FF1 ^0x91318814
{
	int num;
	int i;
...
void func_570(var uParam0, Ped pedParam1, const char* sParam2) // Position - 0x12D3A Hash - 0x6FCAA044 ^0x92A4A55D
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_444))
		return;

	if (!func_446(uParam0, pedParam1))
		return;

	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		sParam2 = func_724(uParam0, pedParam1);
...
void func_571(eStackSize essParam0, BOOL bParam1) // Position - 0x12DF5 Hash - 0x7065DB4C ^0xB94EA2C3
{
	if (!func_479(essParam0))
		return;

	if (bParam1)
		if (func_725(&(Global_1360165[essParam0 /*1157*/].f_12), 1))
			func_572(essParam0, 1, false);

	func_572(essParam0, 16, bParam1);
	return;
}

void func_572(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x12E37 Hash - 0x322BF689 ^0x724E8BC3
{
	if (!func_479(essParam0))
		return;

	func_726(&(Global_1360165[essParam0 /*1157*/].f_13), iParam1, bParam2);
	return;
}

void func_573(eStackSize essParam0) // Position - 0x12E5F Hash - 0x7895582D ^0x7895582D
{
	func_572(essParam0, 8, false);
	return;
}

void func_574(eStackSize essParam0) // Position - 0x12E70 Hash - 0x8577BCFD ^0x8577BCFD
{
	func_492(essParam0, 36, true);
	return;
}

void func_575(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x12E81 Hash - 0xA83ABB27 ^0xCD66A93E
{
	int num;
	int offset;
...
PersChar func_576(eStackSize essParam0, BOOL bParam1) // Position - 0x12EBB Hash - 0xA2FCAA5A ^0xC4849EF1
{
	if (!func_114(essParam0))
		return 0;
...
void func_577(eStackSize essParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12EFA Hash - 0x31BF1139 ^0xA046F8A2
{
	int pedMaxHealth;
	Ped ped;
	...
	if (func_491(essParam0, 5, true))
		PED::SET_PED_CONFIG_FLAG(func_257(essParam0), 137, true);

	return;
}

void func_578(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x12F4C Hash - 0x4B52E53C ^0x4B52E53C
{
	if (!func_479(essParam0))
		return;
	...
	if (bParam1)
	{
		func_575(essParam0, 50, true);
		func_575(essParam0, 48, true);
		func_575(essParam0, 49, true);
		func_575(essParam0, 51, true);
		func_575(essParam0, 52, true);
		func_575(essParam0, 54, true);
		func_575(essParam0, 55, true);
	}
	else
	{
...
void func_579(eStackSize essParam0, BOOL bParam1) // Position - 0x1301E Hash - 0x2F921122 ^0x884B6C77
{
	if (!func_479(essParam0))
		return;

	if (bParam1)
		PED::SET_PED_CONFIG_FLAG(func_257(essParam0), 204, true);
	else
		PED::SET_PED_CONFIG_FLAG(func_257(essParam0), 204, false);

	return;
}

void func_580(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13055 Hash - 0x6E8FD624 ^0x6E8FD624
{
	PersChar char;
	Ped ped;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped) && func_729(essParam0) < 10000f && !bParam3 && !CAM::IS_SCREEN_FADED_OUT())
		return;
...
void func_581(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13163 Hash - 0xC1057B0F ^0xC1057B0F
{
	if (bParam2)
		if (!func_114(essParam0))
			return;
...
Player func_582(eStackSize essParam0) // Position - 0x1319F Hash - 0x8D7C83E2 ^0x9E26FAD3
{
	if (!func_114(essParam0))
		return 0;
...
void func_583(int iParam0, eStackSize essParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x131DF Hash - 0xBD80856C ^0xBD80856C
{
	Player player;
	...
	player = func_582(essParam1);

	if (func_731(essParam1))
		if (!func_732(essParam1))
			return;

	func_575(essParam1, 39, true);
	func_733(essParam1, 64, false);
	Global_1360165[essParam1 /*1157*/].f_70.f_11 = 0;
	func_733(essParam1, 8, false);

	if (ENTITY::DOES_ENTITY_EXIST(player))
	{
		if (!bParam2)
		{
			func_733(essParam1, 512, true);
		...
		if (bParam4)
			func_734(essParam1, false, true, true, true);
	}

	return;
}

int func_584(int iParam0) // Position - 0x13281 Hash - 0xA18FC425 ^0xA18FC425
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_585(int iParam0, int iParam1) // Position - 0x1341A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_586(var uParam0, int iParam1) // Position - 0x13429 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_587(var uParam0) // Position - 0x1343A Hash - 0xA22DA6B0 ^0x3A3D1E32
{
	if (!func_585(uParam0->f_1, 1))
	{
...
void func_588(var uParam0) // Position - 0x1345F Hash - 0x68EBB57D ^0x1E166DCF
{
	if (!func_585(*uParam0, 1))
	{
...
BOOL func_589() // Position - 0x1347E Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_256() != -1)
		return false;
...
BOOL func_590(int iParam0) // Position - 0x134A3 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return iParam0 != 0;
}

void func_591(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x134AF Hash - 0x125DC0A8 ^0x7CF66474
{
...
void func_592(int iParam0, int iParam1) // Position - 0x134F3 Hash - 0x3095F76B ^0x9DAA87F4
{
...
Volume func_593(Vector3 vParam0, var uParam1, var uParam2, float fParam3, var uParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x13519 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
	...
	func_736(volume, bParam8);
	return volume;
}

BOOL func_594(var uParam0, const char* sParam1) // Position - 0x135D3 Hash - 0xA68E0030 ^0xA87ABB5F
{
	int i;
...
BOOL func_595(var uParam0, const char* sParam1) // Position - 0x13624 Hash - 0xDC19080A ^0x79CF59FD
{
	var string2;
...
BOOL func_596(int iParam0) // Position - 0x1364C Hash - 0xEA95855 ^0xEA95855
{
	return Global_1946054.f_529[iParam0] > 0;
}

void func_597(int iParam0) // Position - 0x13661 Hash - 0x9BC08F2D ^0x9BC08F2D
{
	Global_1946054.f_529[iParam0] = Global_1946054.f_529[iParam0] + 1;
	return;
}

int func_598(int iParam0) // Position - 0x13681 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

void func_599(int iParam0) // Position - 0x1368B Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_737(iParam0))
		return;
...
void func_600(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, Volume volParam10, Volume volParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x1373E Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
	...
	func_601(iParam0, true);
	func_603(iParam0, true);
	func_604(iParam0, 128);
	return;
}

void func_601(int iParam0, BOOL bParam1) // Position - 0x139E4 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
		if (Global_1945188[iParam0 /*18*/].f_5 == 5 && !func_414(iParam0, 8))
...
void func_602(int iParam0, int iParam1) // Position - 0x13A3C Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_603(int iParam0, BOOL bParam1) // Position - 0x13A6F Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_604(int iParam0, int iParam1) // Position - 0x13A98 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
void func_605(int iParam0) // Position - 0x13AC0 Hash - 0xBEE7BE6F ^0x7416FECE
{
	var unk;
...
Hash func_606(Hash hParam0) // Position - 0x13B20 Hash - 0x98D45ADB ^0x674EF0A2
{
	int num;

	num = func_461(func_738(hParam0), 1);
...
BOOL func_607(var uParam0) // Position - 0x13B4F Hash - 0x313F44CF ^0x6235E18A
{
...
BOOL func_608(Hash hParam0, var uParam1) // Position - 0x13B7C Hash - 0xE98237F5 ^0x5BEBEE9E
{
	Hash hash;
	int num;
...
void func_609(int iParam0) // Position - 0x13BF3 Hash - 0x3A3EA746 ^0x311B4E59
{
	PLAYER::_SPECIAL_ABILITY_RESTORE_BY_AMOUNT(PLAYER::PLAYER_ID(), BUILTIN::TO_FLOAT(iParam0 * 14), 0, 0, 0);
	return;
}

Hash func_610() // Position - 0x13C0E Hash - 0x7AE16C89 ^0x6C5D08B9
{
	if (!func_445(Global_1935630.f_45))
		return joaat("WEAPON_UNARMED");

	return Global_1935630.f_45;
}

Hash func_611(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13) // Position - 0x13C32 Hash - 0xAB9CFACB ^0x8DB6D77C
{
	Hash weaponHash;
		...
		default:
			...
			if (WEAPON::IS_WEAPON_A_GUN(weaponHash) || WEAPON::IS_WEAPON_MELEE_WEAPON(weaponHash) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(pedParam0) == joaat("rel_gang_dutchs"))
			{
				...
				if (!Global_43891 && MISC::_DOES_STRING_EXIST_IN_STRING(&string1, "_DUALWIELD"))
				{
					...
					if (func_445(hashKey) && WEAPON::_0xF252A85B8F3F8C58(defaultPedWeaponCollection, hashKey))
						flag = true;
				}
				...
				if (!flag)
				{
					...
					if (weapontypeGroup != 0 && defaultPedWeaponCollection != 0)
					{
						...
						if (!Global_43891)
							if (func_445(hash) && hash != weaponHash)
								weaponHash = hash;
						else
							hash == weaponHash;
					}
	...
	if (func_256() == -1 && !func_739(weaponHash))
	{
	...
	if (iParam9 < 0)
	{
		if (pedParam0 != Global_35 && func_445(weaponHash))
		{
	...
	if (pedParam0 == Global_35)
	{
		func_740(weaponHash, iParam9, bParam2, bParam5, bParam4, bParam11, 752097756, false);
	}
	else if (!bParam13)
	{
		permanentDegradation = 0f;
		func_741(pedParam0, &weaponHash, &permanentDegradation);
...
Hash func_612(int iParam0, int iParam1) // Position - 0x13FDE Hash - 0xAED4FBA4 ^0xAED4FBA4
{
	var unk;

	return func_743(&unk, iParam0, iParam1);
}

BOOL func_613() // Position - 0x13FF0 Hash - 0xEBB05467 ^0xEBB05467
{
	return Global_1935436 == 1;
}

BOOL func_614() // Position - 0x13FFE Hash - 0x893CA78F ^0x893CA78F
{
	return Global_1935436 == 2;
}

Hash func_615(Hash hParam0) // Position - 0x1400E Hash - 0xBBE66644 ^0xEC72F4B4
{
	Hash hash;
...
struct<4> func_616(BOOL bParam0) // Position - 0x14043 Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_468(joaat("character"), func_744(), joaat("SLOTID_NONE"), bParam0);
}

int func_617(Hash hParam0) // Position - 0x1405F Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
struct<4> func_618(BOOL bParam0) // Position - 0x1408A Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
	...
	if (num == 2)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223200))
			Global_1223200 = { func_468(923904168, func_616(bParam0), -740156546, bParam0) };
	...
	else if (num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223208))
			Global_1223208 = { func_468(923904168, func_616(bParam0), -740156546, false) };
	
		return Global_1223208;
	}

	return func_468(923904168, func_616(bParam0), -740156546, false);
}

BOOL func_619(Hash hParam0, BOOL bParam1) // Position - 0x1411F Hash - 0x62864AB ^0xBC339691
{
...
BOOL func_620(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3) // Position - 0x14158 Hash - 0x4285A587 ^0x4285A587
{
	return func_469(hParam0, *uParam1, hParam2, bParam3) > 0;
}

BOOL func_621(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x14170 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;

	if (func_746(hParam0, &unk, panParam1, hParam2))
		return panParam1->f_17 > 0f;

	return false;
}

struct<4> func_622(BOOL bParam0) // Position - 0x14191 Hash - 0x8A689EFF ^0x60C7E77C
{
	int num;
	...
	if (num == 2 || num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223204))
			Global_1223204 = { func_468(271701509, func_616(bParam0), 12999093, false) };
	
		return Global_1223204;
	}

	return func_468(271701509, func_616(bParam0), 12999093, false);
}

BOOL func_623(Hash hParam0, Hash hParam1) // Position - 0x141F5 Hash - 0x1874093C ^0x7F0FACAB
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_624(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6) // Position - 0x14254 Hash - 0xC40FC7D1 ^0x18789FFF
{
...
void func_625() // Position - 0x14284 Hash - 0xAC3F2945 ^0x4C166717
{
	int i;
...
BOOL func_626(Hash hParam0, Hash hParam1) // Position - 0x142CB Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
int func_627(Hash hParam0) // Position - 0x142FC Hash - 0xAD4E1DF8 ^0x7BAA459F
{
	int num;
	int num2;
	...
	if (hParam0->f_1[num2 /*3*/] != Global_1946054.f_57[num2 /*11*/] && func_626(hParam0->f_1[num2 /*3*/], 866047851))
		num = num + 1;
...
void func_628(int iParam0) // Position - 0x1444D Hash - 0x65A082AE ^0x65A082AE
{
	func_455(iParam0, 8, 6);
	return;
}

void func_629(int iParam0) // Position - 0x1445E Hash - 0x20214C72 ^0x20214C72
{
	func_747(&(Global_1946054.f_2589), iParam0);
	return;
}

void func_630(int iParam0, int iParam1) // Position - 0x14473 Hash - 0x2AD6C09E ^0x2AD6C09E
{
	func_748(&(Global_1946054.f_2589), iParam0, iParam1);
	return;
}

void func_631(Hash hParam0, int iParam1, int iParam2) // Position - 0x1448A Hash - 0xDEDED6D0 ^0xA620FD73
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

void func_632(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1449D Hash - 0xC0B7C171 ^0x28B721CF
{
	int num;
	int num2;
	Hash hash;
	...
	if (func_451(iParam2, 65536) && hParam0->f_1[num2 /*3*/] == -452402570)
	{
	...
	if (func_749(-1586649372) && func_451(iParam2, 524288))
	{
		num2 = 33;
		hParam0->f_1[num2 /*3*/] = Global_1946054.f_57[num2 /*11*/];
		hParam0->f_1[num2 /*3*/].f_1 = 0;
	...
	switch (hash)
	{
		...
		case 1096747416:
		case 1282123855:
			func_750(hParam0, true & bParam4, true & bParam4, true & bParam4, bParam3);
			break;
		...
		case -923693316:
			...
			if (hParam0->f_1[iParam2 /*3*/] != Global_1946054.f_57[iParam2 /*11*/] && func_751(Global_1946054.f_1497.f_1[num2 /*3*/]) || func_626(Global_1946054.f_1497.f_1[num2 /*3*/], -1638171711))
			{
				hParam0->f_1[iParam2 /*3*/] = Global_1946054.f_57[iParam2 /*11*/];
				hParam0->f_1[iParam2 /*3*/].f_1 = 0;
		...
		case -839140560:
			...
			else
			{
				...
				if (func_751(hParam1) && hParam0->f_1[num2 /*3*/] != Global_1946054.f_57[num2 /*11*/] && -923693316 == func_428(hParam0->f_1[num2 /*3*/]))
				{
					hParam0->f_1[num2 /*3*/] = Global_1946054.f_57[num2 /*11*/];
					hParam0->f_1[num2 /*3*/].f_1 = 0;
		...
		case -497931013:
			func_750(hParam0, true & bParam4, false, true, bParam3);
			break;
	
		case 688587926:
			func_750(hParam0, false, true & bParam4, true & bParam4, bParam3);
			num2 = 22;
		...
		case 1769055947:
			...
			if (hParam0->f_1[iParam2 /*3*/] != Global_1946054.f_57[iParam2 /*11*/] && func_626(Global_1946054.f_1497.f_1[num2 /*3*/], -1638171711))
			{
				hParam0->f_1[iParam2 /*3*/] = Global_1946054.f_57[iParam2 /*11*/];
				hParam0->f_1[iParam2 /*3*/].f_1 = 0;
		...
		case 1868067663:
			func_750(hParam0, true & bParam4, true & bParam4, false, bParam3);
			num2 = 22;
	...
	switch (func_428(hParam1))
	{
		case -525676072:
			...
			if (81053684 == func_428(hParam0->f_1[num2 /*3*/]) || func_626(hParam0->f_1[num2 /*3*/], 866047851))
			{
				hParam0->f_1[num2 /*3*/] = Global_1946054.f_57[num2 /*11*/];
				hParam0->f_1[num2 /*3*/].f_1 = 0;
...
Hash func_633(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3) // Position - 0x14AE1 Hash - 0x68649B2F ^0x68649B2F
{
	BOOL flag;

	flag = func_752(0);

	if (hParam2 != 0 && func_753(hParam0, flag, hParam2, bParam3) != -1)
		return hParam2;

	if (func_754(hParam0, func_453(iParam1, 1), &hParam2))
		return hParam2;

	return 0;
}

void func_634(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x14B27 Hash - 0xE06CF505 ^0xBC49746F
{
	int num;
	int num2;
	int i;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		...
		else
		{
			...
			else if (func_450(num5, 6) || hParam0->f_1[num /*3*/] == Global_1946054.f_57[num /*11*/])
			{
			}
			else
			{
				num4 = func_755(hParam0->f_1[num /*3*/], num5, flag2, flag);
...
void func_635(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x14D44 Hash - 0x234E957C ^0xF69883
{
	int i;
	...
	{
		func_757(iParam0->f_2[i /*2*/], bParam1, bParam2);
	}

	if (func_256() == -1)
	{
		if (Global_40.f_7729 != 0 || !func_758(2, Global_26796.f_776) || Global_1946054.f_1497 != func_759(0))
		{
			if (Global_40.f_7157[Global_40.f_7729 /*3*/] & 512 != 0)
			{
				...
				Global_1946054.f_1497 = func_759(Global_40.f_7729);
				Global_1946054.f_1378 = func_759(Global_40.f_7729);
...
void func_636(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x14E63 Hash - 0x21CB5355 ^0x21CB5355
{
	int i;
	int num;
...
void func_637(var uParam0) // Position - 0x1506F Hash - 0x7C3D914C ^0xB1998A7B
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_8 = 0;
...
void func_638(BOOL bParam0) // Position - 0x150CD Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1946054 = Global_1946054 - Global_1946054 && bParam0;
	return;
}

BOOL func_639(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x150E5 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

void func_640(var uParam0, int iParam1) // Position - 0x1510E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_641(var uParam0, int iParam1) // Position - 0x1511F Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

var func_642(BOOL bParam0, var uParam1, var uParam2) // Position - 0x15134 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_643(int iParam0, BOOL bParam1, BOOL bParam2, char* sParam3) // Position - 0x1514B Hash - 0x3C2F3887 ^0xD0B646ED
{
...
void func_644(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1518F Hash - 0x620F816C ^0x10DFE187
{
	char* str;

	str = func_762(0, 1, bParam0, bParam1);
...
int func_645(int iParam0) // Position - 0x15287 Hash - 0xC1A484EF ^0xB46B3CEC
{
	float num;
...
void func_646() // Position - 0x152AB Hash - 0xEE37C7BE ^0xEE37C7BE
{
	func_763();
	func_764();
	func_765();
...
int func_647(int iParam0) // Position - 0x152C2 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_648(int iParam0, var uParam1, var uParam2) // Position - 0x15303 Hash - 0x28CD1A67 ^0x28CD1A67
{
	int num;
...
void func_649(eStackSize essParam0, BOOL bParam1, char* sParam2) // Position - 0x15320 Hash - 0x4393BBFF ^0x711C558C
{
	Ped ped;
...
void func_650(eStackSize essParam0, int iParam1) // Position - 0x15367 Hash - 0x61FF61E0 ^0x2C6117ED
{
	if (!func_479(essParam0))
		return;
...
BOOL func_651(eStackSize essParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9, BOOL bParam10, BOOL bParam11) // Position - 0x15389 Hash - 0x5B7A656E ^0x3AAC2B26
{
	if (!func_479(essParam0))
		return false;
	...
	switch (Global_1360165[essParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			{
				if (iParam9 != -1)
					iParam4 = func_767(essParam0, iParam9, bParam7, true);
				else if (Global_1360165[essParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[essParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[essParam0 /*60*/].f_59 && func_486(Global_1360165[essParam0 /*1157*/].f_4.f_2) || func_326(Global_1360165[essParam0 /*1157*/].f_4.f_2))
					iParam4 = Global_1360165[essParam0 /*1157*/].f_4.f_1;
				else
					iParam4 = func_767(essParam0, Global_40.f_4283, bParam7, true);
			
				if (Global_1360165[essParam0 /*1157*/].f_63 != iParam4 && func_768(Global_1360165[essParam0 /*1157*/].f_63))
					if (!func_769(essParam0, false))
						func_492(essParam0, 25, false);
			}
		
			Global_1360165[essParam0 /*1157*/].f_4 = { func_770(essParam0, iParam4, uParam1, bParam5, bParam6, bParam8, Global_40.f_4942[essParam0 /*60*/].f_59, bParam11) };
		...
		case 2:
			if (!func_258(func_257(essParam0), 0))
				return false;
...
BOOL func_652(eStackSize essParam0, int iParam1) // Position - 0x15572 Hash - 0xB10CB915 ^0x7678EBC
{
	BOOL flag;
	...
	flag = func_771(essParam0, iParam1);
	return flag;
}

void func_653(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x155B1 Hash - 0xE34CA2E4 ^0x9C7D0427
{
	if (!func_114(essParam0))
		return;

	if (!func_652(essParam0, iParam1))
		return;
...
void func_654(eStackSize essParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x155F1 Hash - 0x1300E8EE ^0xFBE7C64E
{
	Hash hash;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (func_772(iParam2))
		{
			hash = func_773(iParam2, -1);
		
			if (func_774(pedParam1, hash))
			{
				if (func_775(pedParam1, hash))
				{
					if (func_776(pedParam1, hash))
					{
...
void func_655(eStackSize essParam0) // Position - 0x156C7 Hash - 0x73C1F6C ^0x73C1F6C
{
	func_779(essParam0);
...
void func_656(Ped pedParam0, int iParam1) // Position - 0x156DC Hash - 0x7F605CB ^0x28CA17AF
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
...
BOOL func_657(Ped pedParam0) // Position - 0x15737 Hash - 0x4E8A039F ^0x9F8FB293
{
	int i;
	Hash weaponHash;
	BOOL num;
...
void func_658(eStackSize essParam0, Ped pedParam1) // Position - 0x157B5 Hash - 0x9D727A3E ^0xB12CD64B
{
	if (!func_479(essParam0))
		return;
...
void func_659(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1582F Hash - 0x2E4D3D00 ^0x2E4D3D00
{
	if (bParam2)
		if (!func_114(essParam0))
			return;
...
void func_660(eStackSize essParam0, BOOL bParam1) // Position - 0x15860 Hash - 0x14E0BC6D ^0x14E0BC6D
{
	Ped ped;
...
void func_661(eStackSize essParam0, BOOL bParam1) // Position - 0x15897 Hash - 0x14E0BC6D ^0x14E0BC6D
{
	Ped ped;
...
void func_662(eStackSize essParam0, BOOL bParam1) // Position - 0x158CE Hash - 0xD602D5AC ^0xD602D5AC
{
	Ped ped;
...
void func_663(eStackSize essParam0, BOOL bParam1) // Position - 0x15912 Hash - 0x1364490 ^0x1364490
{
	Ped ped;
...
BOOL func_664(int iParam0, BOOL bParam1) // Position - 0x15949 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_256() != -1)
		return false;
	...
	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_324(iParam0));
}

void func_665(var uParam0) // Position - 0x159A1 Hash - 0xA464A779 ^0x65ED5EF
{
	int i;
	var src;
...
int func_666(var uParam0, Entity eParam1) // Position - 0x15A00 Hash - 0x197FCA3B ^0x71B5D82B
{
	int i;
...
int func_667(var uParam0, const char* sParam1) // Position - 0x15A46 Hash - 0x1E7A04C0 ^0xECFDB53A
{
	int i;
...
int func_668(var uParam0) // Position - 0x15A9C Hash - 0x75A484F1 ^0xC0750852
{
	int i;
...
void func_669(var uParam0) // Position - 0x15AD1 Hash - 0xC120EC26 ^0x27847E6
{
	float minimum;
	float maximum;
	Vector3 vector;

	func_790(uParam0->f_1875);
...
void func_670(var uParam0) // Position - 0x15B68 Hash - 0x6577CF7D ^0xCB0B07E
{
	Vehicle vehiclePedIsUsing;
	Hash entityModel;
	var minimum;
	...
	func_342(uParam0, 2097152);
	func_313(uParam0, 1048576);
	return;
}

void func_671(var uParam0, Ped pedParam1) // Position - 0x15C81 Hash - 0xB06B36E ^0x8A3CD518
{
	Hash entityModel;
	var minimum;
	var maximum;
	...
	vector = { uParam0->f_1882 * F2V(func_672(pedParam1)) };
	...
	func_342(uParam0, 1048576);
	func_313(uParam0, 2097152);
	return;
}

float func_672(Ped pedParam0) // Position - 0x15D21 Hash - 0x310B7B6C ^0xF3314E53
{
...
BOOL func_673(int iParam0) // Position - 0x15D66 Hash - 0xF2C0DFFC ^0xF2C0DFFC
{
	switch (func_256())
	{
		case -1:
...
BOOL func_674(int iParam0) // Position - 0x15D91 Hash - 0xF2C0DFFC ^0xF2C0DFFC
{
	switch (func_256())
	{
		case -1:
...
BOOL func_675(Ped pedParam0, Volume volParam1, int iParam2, BOOL bParam3) // Position - 0x15DBC Hash - 0x425E360D ^0xB9BEF16F
{
...
void func_676() // Position - 0x15DF0 Hash - 0x3C4FB117 ^0x9BA96F20
{
...
void func_677(var uParam0, int iParam1, Entity eParam2, BOOL bParam3) // Position - 0x15E19 Hash - 0x2C68431A ^0x29BECF38
{
	switch (func_678(&uParam0->f_1633[iParam1 /*15*/]))
	{
		case 0:
			if (!bParam3)
				return;
			...
			if (!func_524(uParam0->f_1633[iParam1 /*15*/].f_10, 256))
			{
				...
				{
					func_696(uParam0->f_1903, false);
					func_791(&uParam0->f_1633[iParam1 /*15*/], 2);
				}
			}
			break;
		...
		case 1:
			if (!func_524(uParam0->f_1633[iParam1 /*15*/].f_10, 256))
				if (!func_792())
					func_791(&uParam0->f_1633[iParam1 /*15*/], 0);
			else
				func_791(&uParam0->f_1633[iParam1 /*15*/], 0);
			break;
...
int func_678(var uParam0) // Position - 0x15EE9 Hash - 0xD73B9827 ^0x62D87830
{
	return uParam0->f_14;
}

BOOL func_679(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x15EF5 Hash - 0x69C2658A ^0x69C2658A
{
	var unk;
	var unk4;
	float value;
	...
	value = func_794(uParam7, unk);
	num = -func_794(uParam7, unk4);
...
void func_680(var uParam0, int iParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9) // Position - 0x15F75 Hash - 0x6A773471 ^0xCE8C1844
{
	Vector3 vector;
	var unk3;
	var unk16;
...
void func_681(var uParam0) // Position - 0x16452 Hash - 0x7C37F9FC ^0x468CB9EE
{
	int i;
	...
	for (i = 0; i < uParam0->f_3; i = i + 1)
	{
		if (uParam0->f_3[i /*13*/].f_1 != 0)
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_3[i /*13*/].f_2) && ENTITY::IS_ENTITY_A_PED(uParam0->f_3[i /*13*/].f_2) && !MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_3[i /*13*/].f_4)))
				func_796(&(uParam0->f_1771), ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0->f_3[i /*13*/].f_2), &(uParam0->f_3[i /*13*/].f_4), false);
	}

	return;
}

BOOL func_682(var uParam0, int iParam1) // Position - 0x164DA Hash - 0x863EF868 ^0xAF66834E
{
	int i;
...
BOOL func_683(var uParam0, const char* sParam1) // Position - 0x1651C Hash - 0xA8A159A8 ^0x1A1470EB
{
	int i;
	...
	{
		if (uParam0->f_1016[i /*41*/].f_29)
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1016[i /*41*/].f_22)) && MISC::ARE_STRINGS_EQUAL(&(uParam0->f_1016[i /*41*/].f_22), sParam1) && func_482(&uParam0->f_1016[i /*41*/], 1))
				return true;
	}
...
void func_684(var uParam0, int iParam1) // Position - 0x16593 Hash - 0x53A96DDB ^0x5D0D073D
{
	uParam0->f_26 = uParam0->f_26 || iParam1;
	return;
}

void func_685(int iParam0, int iParam1) // Position - 0x165A6 Hash - 0xBF4EFB52 ^0x1406135A
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
	...
	if (!(func_798(17) && func_195(Global_35, Global_1835011[17 /*74*/].f_18, false) < 10f))
...
BOOL func_686(int iParam0, int iParam1) // Position - 0x1675F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_687(var uParam0, int iParam1, BOOL bParam2) // Position - 0x1676E Hash - 0x8087C902 ^0x562AA6AF
{
...
void func_688(var uParam0, AnimScene ansParam1, var uParam2, var uParam3) // Position - 0x167FB Hash - 0xD2CBF6CE ^0x3079964C
{
	int i;
	var entityId;
	Ped pedIndexFromEntityIndex;
	...
	for (i = 0; i < uParam0->f_3; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_3[i /*13*/].f_2) && ENTITY::IS_ENTITY_A_PED(uParam0->f_3[i /*13*/].f_2))
		{
			...
			if (MISC::IS_STRING_NULL_OR_EMPTY(&entityId))
				entityId = { func_360(uParam0, uParam0->f_3[i /*13*/].f_2) };
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&entityId) && ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(ansParam1, &entityId))
			{
				...
				if (PED::IS_PED_HUMAN(pedIndexFromEntityIndex) && pedIndexFromEntityIndex != Global_35)
					func_689(pedIndexFromEntityIndex, Global_35, uParam2, uParam3);
			}
		}
	}
...
void func_689(Ped pedParam0, Ped pedParam1, var uParam2, var uParam3) // Position - 0x168B0 Hash - 0x704770AE ^0xFFE3A1B1
{
	var args;
...
void func_690(var uParam0, int iParam1, int iParam2) // Position - 0x1692A Hash - 0x1A1426CF ^0x5AAACB7
{
	int num;
	Vector3 position;
	Vector3 rotation;
	...
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_1522[num /*10*/].f_8))
	{
		...
		{
			func_718(uParam0, uParam0->f_1522[num /*10*/].f_8);
			ANIMSCENE::GET_ANIM_SCENE_ORIGIN(uParam0->f_1522[num /*10*/].f_8, &position, &rotation, 2);
		
			if (func_361(&uParam0->f_1522[num /*10*/], 1))
			{
			...
			if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_1522[num /*10*/].f_8, false))
			{
				if (ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(uParam0->f_1522[num /*10*/].f_8, "b_PlayerArthur"))
					ANIMSCENE::SET_ANIM_SCENE_BOOL(uParam0->f_1522[num /*10*/].f_8, "b_PlayerArthur", !func_589(), false);
			
				ANIMSCENE::START_ANIM_SCENE(uParam0->f_1522[num /*10*/].f_8);
			
				if (uParam0->f_475[iParam2 /*18*/].f_17 == 0)
				{
					func_708(&uParam0->f_1522[num /*10*/], 128);
				
					if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(uParam0->f_1522[num /*10*/].f_8, "pl_breakout"))
						func_362(uParam0->f_1522[num /*10*/].f_8, 10000, 0, -1, false);
				}
			}
			...
			if (func_568(&uParam0->f_475[iParam2 /*18*/], 4))
			{
				uParam0->f_1685 = iParam2;
			
				if (func_333(uParam0) == 0 && !CAM::HAS_LETTER_BOX() && uParam0->f_475[iParam2 /*18*/].f_17 == 1 && uParam0->f_475[iParam2 /*18*/] < 8 && !func_315(&uParam0->f_1016[uParam0->f_475[iParam2 /*18*/] /*41*/], 32768) && !func_315(&uParam0->f_1016[uParam0->f_475[iParam2 /*18*/] /*41*/], 524288))
				{
					CAM::_REQUEST_LETTER_BOX_OVERTIME(-1, -1, false, 17, true, false);
					func_481(uParam0, 64);
				}
			...
			if (ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(uParam0->f_1522[num /*10*/].f_8, func_213(Global_35)) && uParam0->f_475[iParam2 /*18*/].f_17 != 0 && !func_315(&uParam0->f_1016[uParam0->f_475[iParam2 /*18*/] /*41*/], 32768))
...
BOOL func_691(var uParam0, var uParam1) // Position - 0x16CF5 Hash - 0x3B184D5A ^0x3B184D5A
{
	int i;
	...
	for (i = 0; i < 30; i = i + 1)
	{
		...
		{
			if (func_568(&uParam0->f_475[i /*18*/], 4))
				return true;
...
BOOL func_692() // Position - 0x16D48 Hash - 0x5A8ACC64 ^0x692AB1B6
{
	return ENTITY::DOES_ENTITY_EXIST(PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(Global_35));
}

void func_693(var uParam0) // Position - 0x16D5B Hash - 0xCA4D7661 ^0x1E51F2C9
{
	int taskSequenceId;
	...
	if (!uParam0->f_1897)
	{
		...
		if (!func_315(&uParam0->f_1016[uParam0->f_1684 /*41*/], 65536) || !func_445(func_444(Global_35, 0, true, false)) && !func_445(func_444(Global_35, 1, true, false)))
			if (func_337(uParam0, uParam0->f_1684))
				func_801(uParam0->f_1016[uParam0->f_1684 /*41*/].f_7);
	}

	if (!func_315(&uParam0->f_1016[uParam0->f_1684 /*41*/], 16) && func_445(func_444(Global_35, 0, true, false)) || func_445(func_444(Global_35, 1, true, false)))
	{
	...
	else if (!func_337(uParam0, uParam0->f_1684) && !func_346(uParam0, 4) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1))
	{
		PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), true, 0, false);
		func_565(uParam0, 3);
	}
...
void func_694(var uParam0, int iParam1, BOOL bParam2) // Position - 0x16EE9 Hash - 0x1F2BCE4F ^0x1F2BCE4F
{
	float num;
	var unk;
	var unk4;
	...
	func_800(uParam0, func_545(uParam0->f_1345[uParam0->f_475[iParam1 /*18*/] /*22*/].f_1, 8));
	func_26(&(uParam0->f_1869));
	...
	if (uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_39 != 0)
	{
		...
		{
			func_684(&uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/], 4);
			PED::_SET_PED_BLACKBOARD_BOOL(Global_35, func_483(uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_39), true, -1);
		}
	}
	...
	if (func_568(&uParam0->f_475[iParam1 /*18*/], 16))
	{
...
BOOL func_695(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x1706F Hash - 0x37FB14EB ^0x7E496A4A
{
...
int func_696(Hash hParam0, BOOL bParam1) // Position - 0x17098 Hash - 0xA79D5BF ^0xE827C189
{
	int num;
...
BOOL func_697() // Position - 0x170EC Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1357517;
}

void func_698() // Position - 0x170F8 Hash - 0xFEC7C9F6 ^0xFEC7C9F6
{
	Global_1357516 = false;
	return;
}

void func_699(var uParam0) // Position - 0x17105 Hash - 0x6AAFAA72 ^0x841F1948
{
	int i;
...
void func_700(var uParam0) // Position - 0x17132 Hash - 0x2D4DF8B2 ^0xF56C6F3C
{
	int i;
	var unk;
	var unk17;
...
void func_701(var uParam0, int iParam1) // Position - 0x1728D Hash - 0x48393E99 ^0xAC441161
{
...
BOOL func_702(var uParam0, int iParam1) // Position - 0x172A6 Hash - 0x9687758B ^0xB43AF6CA
{
	BOOL flag;
...
BOOL func_703(var uParam0, int iParam1, int* piParam2) // Position - 0x172CB Hash - 0xB51CEC78 ^0x87BA819C
{
	BOOL flag;
...
BOOL func_704(var uParam0, int iParam1, float* pfParam2) // Position - 0x172EB Hash - 0xB51CEC78 ^0x1FC802AC
{
	BOOL flag;
...
BOOL func_705(var uParam0, int iParam1, char* sParam2) // Position - 0x1730B Hash - 0xB51CEC78 ^0x5213D4A2
{
	BOOL flag;
...
void func_706(var uParam0, var uParam1) // Position - 0x1732B Hash - 0x9946949B ^0x9946949B
{
	BOOL flag;

	if (func_709(uParam0, 24, &flag))
		if (flag)
			*uParam1 = *uParam1 | 4;

	if (func_709(uParam0, 25, &flag))
		if (flag)
			*uParam1 = *uParam1 | 2;

	if (func_709(uParam0, 26, &flag))
		if (flag)
			*uParam1 = *uParam1 | 8;

	if (func_709(uParam0, 27, &flag))
		if (flag)
			*uParam1 = *uParam1 | 16;

	if (func_709(uParam0, 28, &flag))
		if (flag)
			*uParam1 = *uParam1 | 32;

	if (func_709(uParam0, 29, &flag))
		if (flag)
			*uParam1 = *uParam1 | 128;

	if (func_709(uParam0, 32, &flag))
		if (flag)
			*uParam1 = *uParam1 | 256;

	if (func_709(uParam0, 33, &flag))
		if (flag)
			*uParam1 = *uParam1 | 512;

	if (func_709(uParam0, 34, &flag))
		if (flag)
			*uParam1 = *uParam1 | 8192;

	if (func_709(uParam0, 36, &flag))
		if (flag)
			*uParam1 = *uParam1 | 32768;

	if (func_709(uParam0, 37, &flag))
		if (flag)
			*uParam1 = *uParam1 | 65536;

	if (func_709(uParam0, 38, &flag))
		if (flag)
			*uParam1 = *uParam1 | 131072;

	if (func_709(uParam0, 41, &flag))
		if (flag)
			*uParam1 = *uParam1 | 262144;

	if (func_709(uParam0, 42, &flag))
		if (flag)
...
BOOL func_707(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x174B8 Hash - 0x4421204 ^0x961A610F
{
	if (bParam7)
...
void func_708(var uParam0, int iParam1) // Position - 0x174EC Hash - 0x53A96DDB ^0xBEDE3844
{
	uParam0->f_9 = uParam0->f_9 || iParam1;
	return;
}

BOOL func_709(var uParam0, int iParam1, BOOL* pbParam2) // Position - 0x174FF Hash - 0xB51CEC78 ^0x28C98354
{
	BOOL flag;
...
BOOL func_710(var uParam0, Hash hParam1, var uParam2) // Position - 0x1751F Hash - 0xDE74FB24 ^0x48C70EE2
{
	int i;
	...
	for (i = 0; i < uParam0->f_3; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_3[i /*13*/].f_2))
		{
			if (func_711(hParam1) && !uParam0->f_3[i /*13*/] && ENTITY::IS_ENTITY_A_PED(uParam0->f_3[i /*13*/].f_2) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0->f_3[i /*13*/].f_2) == Global_35)
			...
			{
				if (MISC::ARE_STRINGS_EQUAL(uParam0->f_3[i /*13*/].f_9, func_412(hParam1)))
				{
					if (!uParam0->f_3[i /*13*/])
					{
						uParam0->f_3[i /*13*/].f_1 = ENTITY::GET_ENTITY_MODEL(uParam0->f_3[i /*13*/].f_2);
	...
	for (i = 0; i < uParam0->f_3; i = i + 1)
	{
		...
		{
			if (ENTITY::IS_ENTITY_A_PED(uParam0->f_3[i /*13*/].f_2) && STREAMING::IS_MODEL_A_PED(hParam1) && !MISC::IS_STRING_NULL_OR_EMPTY(func_412(hParam1)))
			{
				if (MISC::_DOES_STRING_EXIST_IN_STRING(uParam0->f_3[i /*13*/].f_9, func_412(hParam1)))
				{
					if (!uParam0->f_3[i /*13*/])
					{
						uParam0->f_3[i /*13*/].f_1 = ENTITY::GET_ENTITY_MODEL(uParam0->f_3[i /*13*/].f_2);
...
BOOL func_711(Hash hParam0) // Position - 0x17946 Hash - 0x6FC938DF ^0x56919C64
{
	return hParam0 == joaat("Player_Zero") || hParam0 == joaat("Player_One") || hParam0 == joaat("Player_Two") || hParam0 == joaat("player_three");
}

int func_712(int iParam0) // Position - 0x1797F Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_713(int iParam0) // Position - 0x179EB Hash - 0xB78BCDD0 ^0xB78BCDD0
{
	switch (iParam0)
	{
		case 7:
...
void func_714(var uParam0, var uParam1) // Position - 0x17A5B Hash - 0x5B4DB9F6 ^0x5B4DB9F6
{
	BOOL flag;

	if (func_709(uParam0, 88, &flag))
		if (flag)
			*uParam1 = *uParam1 | 1;

	if (func_709(uParam0, 89, &flag))
		if (flag)
			*uParam1 = *uParam1 | 2;

	if (func_709(uParam0, 90, &flag))
		if (flag)
			*uParam1 = *uParam1 | 4;

	if (func_709(uParam0, 91, &flag))
		if (flag)
			*uParam1 = *uParam1 | 8;

	if (func_709(uParam0, 92, &flag))
		if (flag)
			*uParam1 = *uParam1 | 16;
...
BOOL func_715(var uParam0, int iParam1, Vector3* pvParam2) // Position - 0x17AE7 Hash - 0xB51CEC78 ^0x14A55C60
{
	BOOL flag;
...
void func_716(var uParam0) // Position - 0x17B07 Hash - 0xD86A23E9 ^0x7D03CB55
{
	int i;
	Vector3 vector;
...
BOOL func_717(var uParam0, int iParam1) // Position - 0x17D5A Hash - 0xA0C1E573 ^0xE690FDAB
{
	int i;

	for (i = 0; i < 30; i = i + 1)
	{
		if (uParam0->f_475[i /*18*/].f_2 == 9 && uParam0->f_475[i /*18*/].f_4 == iParam1 && !func_361(&uParam0->f_1522[iParam1 /*10*/], 32) && uParam0->f_475[i /*18*/].f_1 == 0 && !func_568(&uParam0->f_475[i /*18*/], 512) || func_568(&uParam0->f_475[i /*18*/], 1))
			return true;
	}
...
void func_718(var uParam0, AnimScene ansParam1) // Position - 0x17DEF Hash - 0xFF61192A ^0x96EC2DBF
{
	int i;
	var entityId;
	...
	for (i = 0; i < uParam0->f_3; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_3[i /*13*/].f_2))
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&entityId))
			{
				...
				else if (func_711(uParam0->f_3[i /*13*/].f_1))
				{
					if (func_589())
					{
						TEXT_LABEL_ASSIGN_STRING(&entityId, func_412(joaat("Player_Zero")), 64);
					...
					{
						TEXT_LABEL_ASSIGN_STRING(&entityId, func_412(joaat("player_three")), 64);
...
BOOL func_719(Hash hParam0) // Position - 0x17F2E Hash - 0xD6E12BEB ^0x5BC6EDF6
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

Hash func_720(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x17F3C Hash - 0xDD2F88C2 ^0x29E97850
{
	Hash weaponHash;
...
void func_721(var uParam0) // Position - 0x17F7E Hash - 0x891BE8FA ^0x57EC5935
{
	int i;
	Ped pedInDraftHarness;
...
void func_722(var uParam0) // Position - 0x17FD4 Hash - 0x23B904F0 ^0xC5B77813
{
	int i;

	for (i = 0; i < 2; i = i + 1)
	{
		func_790(uParam0->f_1633[i /*15*/].f_12);
	}

	return;
}

void func_723(var uParam0) // Position - 0x17FFD Hash - 0xA664E5E6 ^0xD5ABD26
{
	int i;
...
const char* func_724(var uParam0, Ped pedParam1) // Position - 0x18118 Hash - 0xB4E9EFD3 ^0x44E3906D
{
	int i;
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_13[i /*12*/]) && uParam0->f_13[i /*12*/] == pedParam1)
			return func_812(uParam0->f_13[i /*12*/].f_1);
	}

	return "";
}

BOOL func_725(int iParam0, int iParam1) // Position - 0x18179 Hash - 0xE46677C2 ^0xE46677C2
{
	return *iParam0 && iParam1 != false;
}

void func_726(int iParam0, int iParam1, BOOL bParam2) // Position - 0x18189 Hash - 0x70644665 ^0x70644665
{
	if (bParam2)
		*iParam0 = *iParam0 || iParam1;
	else
...
void func_727(eStackSize essParam0) // Position - 0x181AF Hash - 0x7F4CEA57 ^0x7A0A798F
{
	Hash hash;
...
void func_728(eStackSize essParam0) // Position - 0x18217 Hash - 0xA3F1079A ^0xFE58BB91
{
	if (func_114(essParam0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_257(essParam0)))
		{
			func_659(essParam0, 67108864, true);
			func_575(essParam0, 19, true);
		}
	}
...
float func_729(eStackSize essParam0) // Position - 0x1824A Hash - 0xA42CC07F ^0x2E7483CB
{
	if (!func_479(essParam0))
		return 0f;
...
void func_730(eStackSize essParam0) // Position - 0x1826B Hash - 0xC4A0D69D ^0x461393B6
{
	Ped ped;
	PersChar persChar;
	BOOL flag;
...
BOOL func_731(eStackSize essParam0) // Position - 0x182C5 Hash - 0x6410553A ^0x46627D03
{
	if (!func_479(essParam0))
		return false;
...
BOOL func_732(eStackSize essParam0) // Position - 0x18311 Hash - 0xDC3E0094 ^0xA822A7E2
{
	if (!func_479(essParam0))
		return false;
...
void func_733(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x18339 Hash - 0x7FA68C0F ^0xF104E0DF
{
	if (!func_479(essParam0))
		return;
...
int func_734(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1839E Hash - 0x9AECF115 ^0xB93A91A1
{
	Player mount;
	Hash hash;
	PersChar persChar;
	...
	mount = func_582(essParam0);

	if (func_258(mount, 0))
	{
		if (func_258(PED::_GET_RIDER_OF_MOUNT(mount, false), 0) && !bParam4)
			return 0;
	
		if (bParam1 || !func_731(essParam0) || func_732(essParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(mount) && func_815(PLAYER::PLAYER_PED_ID(), mount, true) < 10000f))
			{
				hash = func_816(essParam0, true);
				...
				if (hash != 0)
				{
					...
					func_817(essParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_818(essParam0, false));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_818(essParam0, false));
					func_819(essParam0);
				}
			}
			else
			{
				if (func_265(essParam0, 32768, true))
				{
					persChar = func_818(essParam0, false);
					PERSCHAR::_0xB65E7F733956CF25(persChar);
					PERSCHAR::_0xFCC6DB8DBE709BC8(persChar);
				}
				else
	...
	{
		if (func_258(Global_1360165[essParam0 /*1157*/].f_124, 0))
		{
			if (func_265(essParam0, 32768, true))
			{
	...
	func_820(essParam0, 0);
	return 1;
}

BOOL func_735(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1854F Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_736(Volume volParam0, BOOL bParam1) // Position - 0x18569 Hash - 0xEA796703 ^0x695D7925
{
	Volume volLockRequestId;
	int i;
...
BOOL func_737(int iParam0) // Position - 0x185D1 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_414(iParam0, 2);
}

int func_738(Hash hParam0) // Position - 0x185E0 Hash - 0xADA620BC ^0xEF3A3B3A
{
	var outSlotId;
...
BOOL func_739(Hash hParam0) // Position - 0x18603 Hash - 0x8C6B1607 ^0xFBDEB3EC
{
	Hash weaponUnlock;
...
int func_740(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x1862B Hash - 0x61DE9CAE ^0x4ADCEE54
{
	var unk;
	Hash hash;
	var unk6;
		...
		for (i = 0; i < 4; i = i + 1)
		{
			...
			if (func_620(hParam0, &unk, hash, false))
			{
				if (func_621(hParam0, &unk6, hash))
				{
					...
					func_822(hParam0, &unk28, &unk, 1, -142743235, 1, false);
					break;
				}
			}
		}
	...
	if (func_823(false))
	{
		...
		func_824(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0), iParam1, hParam6);
		func_825(hParam0, iParam1);
		return 1;
	}
...
void func_741(Ped pedParam0, var uParam1, var uParam2) // Position - 0x1877D Hash - 0x236D39D4 ^0x39F583A
{
	BOOL flag;
	Hash entityModel;
...
BOOL func_742(Hash hParam0) // Position - 0x18994 Hash - 0xE6B34BF5 ^0xE4729149
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_743(Any anParam0, int iParam1, int iParam2) // Position - 0x189A6 Hash - 0xE564BF7A ^0x1E6E4842
{
	Hash weaponHash;
	int num;
	int num2;
	...
	flag = func_826(iParam1, 128);

	if (func_827("ALL WEAPONS", &num, &num2, joaat("SLOTID_NONE"), false))
	{
		unk19.f_9 = joaat("SLOTID_NONE");
	
		for (i = 0; i < num2; i = i + 1)
		{
			if (!func_828(&unk, i, num, num2))
			{
			}
			else if (!func_445(unk.f_4))
			{
			}
			...
			else if (!func_826(iParam1, 512) && func_746(unk.f_4, &unk15, &unk19, joaat("SLOTID_WEAPON_0")) && !unk19.f_21)
			{
			}
			else if (!flag || WEAPON::IS_PED_CARRYING_WEAPON(Global_35, unk.f_4))
			{
				if (WEAPON::_IS_WEAPON_TWO_HANDED(unk.f_4) || func_719(unk.f_4) && !WEAPON::IS_WEAPON_SHOTGUN(unk.f_4) || func_826(iParam1, 16) && !WEAPON::_IS_WEAPON_SNIPER(unk.f_4) || func_826(iParam1, 4) && !func_719(unk.f_4) || func_826(iParam1, 8) && !WEAPON::IS_WEAPON_REPEATER(unk.f_4) || !func_826(iParam1, 8388608) && !WEAPON::IS_WEAPON_RIFLE(unk.f_4) || !func_826(iParam1, 1048576))
				{
	...
	else if (!func_826(iParam1, 512) && !func_826(iParam1, 1024))
	{
		iParam1 = iParam1 | 512;
		return func_743(anParam0, iParam1, iParam2);
	}
	else if (func_826(iParam1, 256))
	{
		weaponHash = joaat("WEAPON_UNARMED");
	}
...
struct<4> func_744() // Position - 0x18BD5 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
BOOL func_745(int iParam0) // Position - 0x18BE1 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_830(iParam0))
		return false;
...
BOOL func_746(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x18BFD Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;

	inventoryId = func_470(false);
	*panParam1 = { func_468(hParam0, func_618(false), hParam3, false) };
...
void func_747(int iParam0, int iParam1) // Position - 0x18C42 Hash - 0x19A9221A ^0x79EEA925
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (i < *iParam0)
		{
			if (func_832(&iParam0->f_2[i /*2*/], 2) || iParam0->f_2[i /*2*/] == iParam1 || iParam0->f_2[i /*2*/] == 39)
			{
				iParam0->f_2[i /*2*/] = { unk };
			}
			else
			{
				if (func_832(&iParam0->f_2[i /*2*/], 1))
					func_833(&iParam0->f_2[i /*2*/], 2, 6);
...
void func_748(int iParam0, int iParam1, int iParam2) // Position - 0x18D6E Hash - 0x194BB6D7 ^0x6A98F372
{
	if (*iParam0 + 1 >= 10)
		return;
...
BOOL func_749(int iParam0) // Position - 0x18DB5 Hash - 0xEB793C30 ^0xF0C7C18C
{
...
void func_750(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x18DED Hash - 0xE34B9CEC ^0xAFBB60FB
{
	int num;
	int num2;
	int num3;
...
BOOL func_751(Hash hParam0) // Position - 0x18ED9 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (hParam0)
	{
...
BOOL func_752(int iParam0) // Position - 0x18F1C Hash - 0x9F9FF8A1 ^0x4AEA2041
{
	int num;
...
int func_753(Hash hParam0, BOOL bParam1, Hash hParam2, BOOL bParam3) // Position - 0x18F42 Hash - 0x3A135443 ^0x969430D9
{
	int i;
...
BOOL func_754(Hash hParam0, int iParam1, var uParam2) // Position - 0x18F86 Hash - 0x266D0BAD ^0x37A4495C
{
	*uParam2 = joaat("base");
	return true;
}

int func_755(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x18F97 Hash - 0xFB14E414 ^0x5DDCA43D
{
	int num;
...
int func_756(Hash hParam0) // Position - 0x19002 Hash - 0x3AB81F84 ^0x2BD03E57
{
	int num;
	int num2;
...
void func_757(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1904D Hash - 0x475F4FBD ^0x5DA546E8
{
	if (bParam1)
	...
	if (func_256() == -1)
		func_837(&Global_1946054.f_1497.f_1[iParam0 /*3*/], iParam0, Global_26796.f_776);
	else
		func_838(&Global_1946054.f_1497.f_1[iParam0 /*3*/], iParam0, Global_36638.f_45.f_350.f_1011);

	return;
}

BOOL func_758(BOOL bParam0, eStackSize essParam1) // Position - 0x190C3 Hash - 0xAAB46313 ^0xDBD30AAB
{
	if (func_256() == -1)
	{
		if (essParam1 == -1)
...
Hash func_759(eStackSize essParam0) // Position - 0x19140 Hash - 0xB8EC44B7 ^0xE877E9C4
{
	switch (essParam0)
	{
		case 0:
...
void func_760(eStackSize essParam0, BOOL bParam1, int iParam2) // Position - 0x19675 Hash - 0x1F3A52DA ^0x1F3A52DA
{
	func_839(&(Global_1946054.f_1378), essParam0);
	func_840(2, essParam0, 6);
...
void func_761(BOOL bParam0, BOOL bParam1) // Position - 0x1969D Hash - 0x4F2782D4 ^0x9FBFC876
{
	if (bParam1)
		func_841(0);
...
char* func_762(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x196D0 Hash - 0xC24B5846 ^0xE2D0AD77
{
	switch (iParam0)
	{
		case 0:
...
float func_763() // Position - 0x19778 Hash - 0xB0642BCC ^0x4D6FEEA4
{
	float num;
	float num2;
	float num3;
	...
	num = num * num6;
	num7 = 200f / num;
	num7 = num7 * (30f / func_848());
	num8 = func_843(2) - num7;
	value = BUILTIN::ROUND((num / 60f) * BUILTIN::TO_FLOAT(7));
	num9 = 100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(value));
	num10 = (num8 + 100f) / 200f;
	func_849(3, BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * num10), false);
	func_850(3, num9, num9 > 100f);
	return func_851(num8, -100f, 100f);
}

float func_764() // Position - 0x198A1 Hash - 0x951B1CCC ^0x7B312694
{
	float num;
	float num2;
	float num3;
	...
	num7 = 200f / num;
	num7 = num7 * (30f / func_848());
	num8 = func_843(1) - num7;
	value = BUILTIN::ROUND((num / 60f) * BUILTIN::TO_FLOAT(7));
	num9 = 100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(value));
	num10 = (num8 + 100f) / 200f;
	func_849(2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * num10), false);
	func_850(2, num9, num9 > 100f);
	return func_851(num8, -100f, 100f);
}

float func_765() // Position - 0x199CA Hash - 0x4D146F4A ^0xFC60D2FE
{
	float num;
	float num2;
	float num3;
	...
	num7 = 200f / num;
	num7 = num7 * (30f / func_848());
	num8 = func_843(0) - num7;
	value = BUILTIN::ROUND((num / 60f) * BUILTIN::TO_FLOAT(7));
	num9 = 100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(value));
	num10 = (num8 + 100f) / 200f;
	func_849(1, BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * num10), false);
	func_850(1, num9, num9 > 100f);
...
int func_766(int iParam0) // Position - 0x19B71 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
int func_767(eStackSize essParam0, eStackSize essParam1, BOOL bParam2, BOOL bParam3) // Position - 0x19BF2 Hash - 0xEC801E93 ^0x8D937378
{
	int num;
	var unk;
	int endRange;
	...
	switch (essParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_854(Global_1835011[4 /*74*/].f_1, true))
						unk[0] = -695701225;
					else
						unk[0] = 404503428;
					break;
		...
		case 1:
			switch (essParam0)
			{
				...
				case 10:
					if (func_854(Global_1347702[63 /*49*/].f_15, true) || func_326(Global_1347702[63 /*49*/].f_15))
						unk[0] = -268604689;
					else
						unk[0] = -310473775;
					break;
				...
				case 18:
					if (!func_854(Global_1835011[14 /*74*/].f_1, true))
					{
						unk[0] = -268604689;
						unk[1] = -1632589543;
						endRange = 2;
					}
					else if (func_265(18, 134217728, true))
					{
						unk[0] = 961676983;
					}
					else
		...
		case 3:
			switch (essParam0)
			{
				...
				case 11:
					if (func_854(Global_1347702[134 /*49*/].f_15, true) || func_326(Global_1347702[134 /*49*/].f_15))
					{
						unk[0] = -2040275819;
						unk[1] = 1205492208;
						endRange = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_854(Global_1835011[38 /*74*/].f_1, true))
						unk[0] = -1559986688;
					else
						unk[0] = -1874208704;
					break;
		...
		case 7:
			...
			{
				case 4:
					if (func_856(joaat("CSTAG_FLOW_MAR8_POST"), true) && !func_854(Global_1347702[1 /*49*/].f_15, true))
						unk[0] = -1155031950;
					else
						unk[0] = -1341683964;
					break;
	...
	if (bParam3 && ENTITY::DOES_ENTITY_EXIST(func_257(essParam0)))
	{
	...
	if (!func_652(essParam0, num2))
		num2 = Global_40.f_4942[essParam0 /*60*/].f_3;

	return num2;
}

BOOL func_768(int iParam0) // Position - 0x1A9DA Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case -1205468859:
...
BOOL func_769(eStackSize essParam0, BOOL bParam1) // Position - 0x1AA07 Hash - 0xAA2527A1 ^0x8C2C75CE
{
	int num;
...
struct<7> func_770(eStackSize essParam0, int iParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0x1AA90 Hash - 0xDA7D22BD ^0xF82EFD7F
{
	eStackSize stackSize;
...
BOOL func_771(eStackSize essParam0, int iParam1) // Position - 0x1AAF3 Hash - 0xE0095B63 ^0x929CAC47
{
	int num;
	int offset;
	...
	func_857(iParam1, &num, &offset);
	return MISC::IS_BIT_SET(Global_1360165[essParam0 /*1157*/].f_65[num], offset);
}

BOOL func_772(int iParam0) // Position - 0x1AB29 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
Hash func_773(int iParam0, eStackSize essParam1) // Position - 0x1AB3C Hash - 0xE1D12727 ^0x6E706E61
{
	int num;
	...
	switch (iParam0)
	{
		...
		case 296923297:
			num = func_858(296923297, essParam1);
			return func_859(num);
		...
		case 1237718549:
			num = func_858(1237718549, essParam1);
			return func_859(num);
...
BOOL func_774(Ped pedParam0, Hash hParam1) // Position - 0x1AFDE Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_775(Ped pedParam0, Hash hParam1) // Position - 0x1B00C Hash - 0xA54F3032 ^0xCE2A3519
{
	Hash _int;
...
BOOL func_776(Ped pedParam0, Hash hParam1) // Position - 0x1B05D Hash - 0xA54F3032 ^0xCE2A3519
{
	Hash _int;
	int _int2;
...
void func_777(Ped pedParam0) // Position - 0x1B0CF Hash - 0x446F1BDD ^0xD54BFEF8
{
...
void func_778(eStackSize essParam0, Ped pedParam1, BOOL bParam2) // Position - 0x1B0ED Hash - 0xF8298322 ^0x7D3D3E5
{
	...
	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 1 > 0 && func_774(pedParam1, 860729266))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 860729266);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 4096 > 0 && func_774(pedParam1, 879715242))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 879715242);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & MICRO > 0 && func_774(pedParam1, 1606325429))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 1606325429);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 256 > 0 && func_774(pedParam1, 1743550585))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 1743550585);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & MINI > 0 && func_774(pedParam1, 1064646155))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 1064646155);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 1024 > 0 && func_774(pedParam1, -536694793))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -536694793);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 2048 > 0 && func_774(pedParam1, -1304053509))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -1304053509);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & -2147483648 > 0 && func_774(pedParam1, 718939204))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 718939204);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 65536 > 0 && func_774(pedParam1, -972364774))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -972364774);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 16384 > 0 && func_774(pedParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 262144 > 0 && func_774(pedParam1, 1153596794))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 1153596794);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 524288 > 0 && func_774(pedParam1, 1016389820))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 1016389820);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 1048576 > 0 && func_774(pedParam1, -726966617))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -726966617);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 2097152 > 0 && func_774(pedParam1, 1365901568))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 1365901568);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 32768 > 0 && func_774(pedParam1, -1658942149))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -1658942149);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 131072 > 0 && func_774(pedParam1, -1980913856))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -1980913856);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 4194304 > 0 && func_774(pedParam1, 491764525))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 491764525);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 8388608 > 0 && func_774(pedParam1, -76015264))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -76015264);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 16777216 > 0 && func_774(pedParam1, 622113465))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 622113465);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 33554432 > 0 && func_774(pedParam1, 781533162))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 781533162);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 67108864 > 0 && func_774(pedParam1, -271415321))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -271415321);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 134217728 > 0 && func_774(pedParam1, -1683207356))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -1683207356);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 268435456 > 0 && func_774(pedParam1, -254794762))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -254794762);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 536870912 > 0 && func_774(pedParam1, 609066278))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, 609066278);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 1073741824 > 0 && func_774(pedParam1, -1712783565))
		PED::_EQUIP_META_PED_OUTFIT(pedParam1, -1712783565);

	if (Global_40.f_4942[essParam0 /*60*/].f_5 & 8192 > 0 && func_774(pedParam1, 1544915253))
...
void func_779(eStackSize essParam0) // Position - 0x1B6CB Hash - 0x83966A8E ^0x24FDDDED
{
	func_860(essParam0, 1);
	func_860(essParam0, MICRO);
	func_860(essParam0, 256);
	func_860(essParam0, MINI);
	func_860(essParam0, 1024);
	func_860(essParam0, 2048);
	func_860(essParam0, 4096);
	func_860(essParam0, 65536);
	func_860(essParam0, 16384);
	func_860(essParam0, 262144);
	func_860(essParam0, 524288);
	func_860(essParam0, 1048576);
	func_860(essParam0, 2097152);
	func_860(essParam0, 32768);
	func_860(essParam0, 131072);
	func_860(essParam0, 134217728);
	func_860(essParam0, 1073741824);
	return;
}

void func_780(eStackSize essParam0, BOOL bParam1) // Position - 0x1B774 Hash - 0xA7580A6E ^0x3ECD7689
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_1360165[essParam0 /*1157*/]))
		return;
...
void func_781(Player plParam0) // Position - 0x1B7E7 Hash - 0x68A3D5AB ^0x62583FE3
{
	if (func_861(plParam0, false))
		return;
...
void func_782(eStackSize essParam0) // Position - 0x1B833 Hash - 0xB1E2E498 ^0xC7EBD371
{
	Player player;
	...
	if (func_816(essParam0, false) == 0)
		return;

	player = func_582(essParam0);
	func_781(player);
	func_733(essParam0, 8192, true);
	return;
}

void func_783(Player plParam0) // Position - 0x1B86E Hash - 0xB38DCC50 ^0x941BF21E
{
	if (func_861(plParam0, false))
		return;
...
void func_784(eStackSize essParam0) // Position - 0x1B89B Hash - 0x28CD0E89 ^0xB9FC8A12
{
	Player player;
	...
	player = func_582(essParam0);
	func_783(player);
	func_733(essParam0, 8192, false);
	return;
}

void func_785(Player plParam0) // Position - 0x1B8D6 Hash - 0x26D51EE5 ^0xA25A14D9
{
	if (func_861(plParam0, false))
		return;
...
void func_786(Ped pedParam0) // Position - 0x1B90C Hash - 0x6EDA2DDB ^0x823A87C9
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_787(eStackSize essParam0) // Position - 0x1B98B Hash - 0xB1E2E498 ^0x545B1681
{
	Player player;
	...
	player = func_582(essParam0);
	func_785(player);
	func_733(essParam0, 16384, true);
	return;
}

void func_788(Player plParam0) // Position - 0x1B9C6 Hash - 0x972BAF6E ^0xD19596A6
{
	if (func_861(plParam0, false))
		return;
...
void func_789(eStackSize essParam0) // Position - 0x1B9FA Hash - 0x28CD0E89 ^0x67E48CA5
{
	Player player;
	...
	player = func_582(essParam0);
	func_788(player);
	func_733(essParam0, 16384, false);
	return;
}

void func_790(Volume volParam0) // Position - 0x1BA35 Hash - 0x7DD010A2 ^0x16530136
{
	if (VOLUME::DOES_VOLUME_EXIST(volParam0))
...
void func_791(var uParam0, int iParam1) // Position - 0x1BA4C Hash - 0x4F8BE4B5 ^0x4310E6A5
{
	uParam0->f_14 = iParam1;
	return;
}

BOOL func_792() // Position - 0x1BA5A Hash - 0xBA2FE0DB ^0xBA2FE0DB
{
	return func_862();
}

BOOL func_793() // Position - 0x1BA66 Hash - 0xBA2FE0DB ^0xBA2FE0DB
{
	return func_863();
}

float func_794(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1BA72 Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_795(var uParam0, int iParam1) // Position - 0x1BA93 Hash - 0x27ED4AFD ^0x27ED4AFD
{
	var unk;
	...
	if (func_445(func_720(Global_35, false, 0, false)) && !func_315(&uParam0->f_1016[iParam1 /*41*/], 16) && !func_315(&uParam0->f_1016[iParam1 /*41*/], 64))
		return true;

	return false;
}

void func_796(var uParam0, Ped pedParam1, const char* sParam2, BOOL bParam3) // Position - 0x1BAF3 Hash - 0x5AD955B5 ^0x43BD5215
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam1))
		return;
	...
	if (func_864(uParam0, pedParam1, sParam2))
...
BOOL func_797(int iParam0, int iParam1) // Position - 0x1BB50 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_798(eStackSize essParam0) // Position - 0x1BB5F Hash - 0x1D38F5CA ^0xC923C5D1
{
	eStackSize i;
...
void func_799(var uParam0, BOOL bParam1) // Position - 0x1BC03 Hash - 0x34798522 ^0x2CB7B22C
{
	Hash weaponHash;

	if (!func_63(uParam0, 64) && func_333(uParam0) != 0)
		return;

	if (!bParam1)
	{
		weaponHash = func_720(Global_35, false, 0, false);
		...
		weaponHash = func_720(Global_35, false, 1, false);
...
void func_800(var uParam0, BOOL bParam1) // Position - 0x1BCB3 Hash - 0x35E0B933 ^0x12591F16
{
	if (bParam1)
		PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, SPC_REMOVE_FIRES | 16 | 32 | 256, false);
	else
	...
	if (func_333(uParam0) == 0 && uParam0->f_1684 >= 0 && !func_315(&uParam0->f_1016[uParam0->f_1684 /*41*/], 524288))
	{
		CAM::_REQUEST_LETTER_BOX_OVERTIME(-1, -1, false, 17, true, false);
		func_481(uParam0, 64);
	}
...
void func_801(var uParam0, var uParam1, var uParam2) // Position - 0x1BD73 Hash - 0x142BE781 ^0xCEFD9802
{
	int duration;
	float entityHeading;
	...
	if (func_445(func_444(Global_35, 0, true, false)) || func_445(func_444(Global_35, 1, true, false)))
		duration = 2000;
...
void func_802(var uParam0, int iParam1, var uParam2, var uParam3) // Position - 0x1BDF2 Hash - 0x8427A12E ^0xF1B5D9E8
{
	if (func_568(&uParam0->f_475[iParam1 /*18*/], 32))
	{
		if (func_63(uParam0, 8))
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1684 /*41*/].f_1 + func_523(Global_36 - uParam0->f_1016[uParam0->f_1684 /*41*/].f_1) };
		
			if (!func_482(&uParam0->f_1016[uParam0->f_1684 /*41*/], 2))
		...
		else
		{
			*uParam2 = { uParam0->f_1016[uParam0->f_1688 /*41*/].f_1 + func_523(Global_36 - uParam0->f_1016[uParam0->f_1688 /*41*/].f_1) };
			...
			if (!func_482(&uParam0->f_1016[uParam0->f_1688 /*41*/], 2))
		...
		*uParam2 = { func_867(uParam0) };
		...
		if (func_63(uParam0, 8))
			if (!func_482(&uParam0->f_1016[uParam0->f_1684 /*41*/], 2))
				...
				*uParam3 = uParam0->f_1016[uParam0->f_1684 /*41*/].f_40;
		else if (!func_482(&uParam0->f_1016[uParam0->f_1688 /*41*/], 2))
			*uParam3 = func_443(Global_36, uParam0->f_1016[uParam0->f_1688 /*41*/].f_1, 1);
		else
			*uParam3 = uParam0->f_1016[uParam0->f_1688 /*41*/].f_40;
	}
...
BOOL func_803(var uParam0, var uParam1) // Position - 0x1BFAB Hash - 0xBCB28A71 ^0xA9158D0F
{
	var matrix;
	int i;
	AnimScene animScene;
...
void func_804(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7) // Position - 0x1C073 Hash - 0xF044DCF1 ^0x1D0FFAEF
{
	var unk;
	var unk8;
	int i;
	...
	func_868(&unk, 0f, Global_36 - { 1f, 0f, 0f }, -2f * BUILTIN::SIN(ENTITY::GET_ENTITY_HEADING(Global_35)), 2f * BUILTIN::COS(ENTITY::GET_ENTITY_HEADING(Global_35)), 0f);
	func_868(&unk8, 1f, uParam3, -2f * BUILTIN::SIN(fParam6), 2f * BUILTIN::COS(fParam6), 0f);
	...
	*uParam7 = { uParam0->f_1016[iParam1 /*41*/].f_1 + { 0f, BUILTIN::COS(value) * (uParam0->f_1016[iParam1 /*41*/].f_11 / 2f), BUILTIN::SIN(value) * (uParam0->f_1016[iParam1 /*41*/].f_11 / 2f) } };
	...
	for (i = 0; i < 5; i = i + 1)
	{
		uParam2->[i /*3*/] = { func_869(Global_36, *uParam7, uParam3, (float)i + 1 / BUILTIN::TO_FLOAT(5)) };
	}

	return;
}

void func_805(var uParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x1C247 Hash - 0xFDBBF8B2 ^0xA5CA9FD
{
	Vector3 vector;
	...
	if (func_482(&uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/], 2))
	{
		TASK::TASK_ACHIEVE_HEADING(0, uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/].f_40, 0);
	}
	else
	{
		vector = { func_870(uParam0, iParam1) };
...
void func_806(var uParam0, int iParam1, BOOL bParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1C2D9 Hash - 0x8CCACFE2 ^0x8CCACFE2
{
	Vector3 vector;
	float heading;
	int flags;
	...
	if (!_IS_NULL_VECTOR(vector))
	{
		...
		if (func_568(&uParam0->f_475[iParam1 /*18*/], 256))
		{
		...
		if (!func_482(&uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/], 4) && !func_482(&uParam0->f_1016[uParam0->f_475[iParam1 /*18*/] /*41*/], 2))
		{
			TASK::TASK_TURN_PED_TO_FACE_COORD(0, vector, -1);
		}
		else
...
BOOL func_807() // Position - 0x1C44B Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1946054.f_2792;
}

BOOL func_808(Hash hParam0) // Position - 0x1C45A Hash - 0x2759F6FA ^0x4BDB091E
{
	if (func_862())
		return false;
...
BOOL func_809(Hash hParam0) // Position - 0x1C491 Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_872(hParam0);
}

int func_810(Hash hParam0, int iParam1) // Position - 0x1C49F Hash - 0x4FF8311F ^0x88E4CE75
{
...
char* func_811(int iParam0) // Position - 0x1C572 Hash - 0xE6862179 ^0x215471AC
{
	switch (iParam0)
	{
		case 0:
...
char* func_812(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x1CBF2 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

Hash func_813(int iParam0) // Position - 0x1CC06 Hash - 0xBA965109 ^0xCB1D208B
{
	switch (iParam0)
	{
		case 0:
...
void func_814(eStackSize essParam0, Ped pedParam1) // Position - 0x1CDE2 Hash - 0xC6503D1A ^0x107B4B14
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam1))
		func_878(pedParam1);
...
float func_815(Ped pedParam0, Player plParam1, BOOL bParam2) // Position - 0x1CDFC Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
Hash func_816(eStackSize essParam0, BOOL bParam1) // Position - 0x1CE53 Hash - 0xA64DC151 ^0x7D83907B
{
	if (!func_479(essParam0))
		return 0;
	...
	if (bParam1)
	{
		Global_1360165[essParam0 /*1157*/].f_127 = func_879(essParam0);
		return Global_1360165[essParam0 /*1157*/].f_127;
	}
...
void func_817(eStackSize essParam0) // Position - 0x1CF98 Hash - 0xF7FD9E75 ^0xF411CFCB
{
	Player player;
	ItemSet itemset;
	int i;
...
PersChar func_818(eStackSize essParam0, BOOL bParam1) // Position - 0x1D00E Hash - 0xF1265AC3 ^0xD7133EF8
{
	if (!func_479(essParam0))
		return 0;

	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(Global_1360165[essParam0 /*1157*/].f_126) && bParam1)
		Global_1360165[essParam0 /*1157*/].f_126 = func_880(essParam0);

	return Global_1360165[essParam0 /*1157*/].f_126;
}

void func_819(eStackSize essParam0) // Position - 0x1D05A Hash - 0xA6C3B06B ^0x3AB8265A
{
	int i;
...
void func_820(eStackSize essParam0, int iParam1) // Position - 0x1D0AD Hash - 0xEBFF508D ^0x493427AF
{
	if (!func_479(essParam0))
		return;
...
Hash func_821(int iParam0, int iParam1) // Position - 0x1D0D1 Hash - 0xE1D12727 ^0x71D656A6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_822(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x1F21B Hash - 0xA0AA5F74 ^0x6BC7AEA2
{
	var unk;
	int num;
...
BOOL func_823(BOOL bParam0) // Position - 0x1F2AB Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_256() == -1)
		return true;
...
int func_824(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1F2C9 Hash - 0xCABE5725 ^0xB186E46E
{
	if (iParam1 < 1)
		return 1;
...
void func_825(Hash hParam0, int iParam1) // Position - 0x1F304 Hash - 0xBFC80B98 ^0x997FC438
{
	int ammo;
	int ammo2;
	...
	{
		ammo2 = func_883(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
BOOL func_826(int iParam0, int iParam1) // Position - 0x1F34C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_827(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x1F35B Hash - 0xA7F38D3E ^0x25D43AAB
{
...
BOOL func_828(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1F382 Hash - 0xF1DE71ED ^0x4F212F50
{
	if (iParam2 < 0)
		return false;
...
int func_829(int iParam0) // Position - 0x1F3BD Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_830(int iParam0) // Position - 0x1F3DE Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_831(int iParam0) // Position - 0x1F3F1 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
BOOL func_832(var uParam0, int iParam1) // Position - 0x1F41B Hash - 0x718DD1EF ^0xA172DFD1
{
	return uParam0->f_1 && iParam1 != false;
}

void func_833(var uParam0, int iParam1, int iParam2) // Position - 0x1F42C Hash - 0xDEDED6D0 ^0xB4D62998
{
	uParam0->f_1 = uParam0->f_1 || iParam1;
	return;
}

BOOL func_834(int iParam0, int iParam1) // Position - 0x1F43F Hash - 0x718DD1EF ^0xA172DFD1
{
	return iParam0->f_1 && iParam1 != false;
}

void func_835(int iParam0, int iParam1) // Position - 0x1F450 Hash - 0x53A96DDB ^0x6089064A
{
	iParam0->f_1 = iParam0->f_1 || iParam1;
	return;
}

int func_836() // Position - 0x1F463 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_1946054.f_1;
}

void func_837(Hash hParam0, int iParam1, eStackSize essParam2) // Position - 0x1F471 Hash - 0xC2C59C9E ^0x9DCB6812
{
...
void func_838(Hash hParam0, int iParam1, eStackSize essParam2) // Position - 0x1F4CC Hash - 0x7711D950 ^0x19070BC5
{
...
void func_839(Hash hParam0, eStackSize essParam1) // Position - 0x1F536 Hash - 0x5B4F430F ^0xA0DE91CC
{
	int i;
	...
	if (func_256() == -1)
	{
		...
		for (i = 0; i < 39; i = i + 1)
		{
			func_837(&hParam0->f_1[i /*3*/], i, essParam1);
		}
	...
	for (i = 0; i < 39; i = i + 1)
	{
		func_838(&hParam0->f_1[i /*3*/], i, essParam1);
	}

	return;
}

void func_840(BOOL bParam0, eStackSize essParam1, int iParam2) // Position - 0x1F5D1 Hash - 0x22FA317E ^0x7C0991BF
{
	if (func_256() == -1)
	{
		if (essParam1 == -1)
...
void func_841(int iParam0) // Position - 0x1F659 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1946054.f_978 = iParam0;
	return;
}

BOOL func_842() // Position - 0x1F66A Hash - 0xAD9852FF ^0x906C33C9
{
	if (Global_1572887.f_12 != -1)
		return false;
...
float func_843(int iParam0) // Position - 0x1F686 Hash - 0xB9E2D182 ^0xB9E2D182
{
	return Global_40.f_11095[iParam0];
}

float func_844() // Position - 0x1F698 Hash - 0x85B5D708 ^0x4351E399
{
	float num;
	int num2;
...
float func_845() // Position - 0x1F6DB Hash - 0x82C14FCE ^0x536BA17
{
	if (PED::IS_PED_ON_MOUNT(Global_35))
		return 0.25f;
...
float func_846() // Position - 0x1F6F6 Hash - 0xC978DB91 ^0xB55E9465
{
	if (func_886())
...
float func_847() // Position - 0x1F715 Hash - 0xA5EDFE9E ^0x34BC3E89
{
	if (Global_40.f_39 == joaat("player_three"))
		return 0f;
...
var func_848() // Position - 0x1F757 Hash - 0x4228A1C2 ^0x5D82C45B
{
	return Global_1954815.f_3;
}

void func_849(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1F765 Hash - 0x99040EF7 ^0xDDBC8DE3
{
	char* str;

	str = func_762(iParam0, 1, false, false);
...
void func_850(int iParam0, float fParam1, BOOL bParam2) // Position - 0x1F7B1 Hash - 0x96E8475F ^0x25D18765
{
	char* str;

	str = func_762(iParam0, 2, false, false);
...
float func_851(float fParam0, float fParam1, float fParam2) // Position - 0x1F8F7 Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_852() // Position - 0x1F91E Hash - 0x8E60F5AE ^0x8E60F5AE
{
	return func_884(12) <= -99f;
}

BOOL func_853() // Position - 0x1F932 Hash - 0xAF9CDCF ^0xAF9CDCF
{
	return func_884(12) >= 99f;
}

BOOL func_854(int iParam0, BOOL bParam1) // Position - 0x1F946 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_855(int iParam0, int iParam1, int iParam2) // Position - 0x1F977 Hash - 0xD8381BE7 ^0xD8381BE7
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_856(int iParam0, BOOL bParam1) // Position - 0x1FA20 Hash - 0xB6F2B948 ^0x8948B8BB
{
	int i;
...
int func_857(int iParam0, var uParam1, var uParam2) // Position - 0x1FA5F Hash - 0x44294A7 ^0x44294A7
{
	int num;

	num = func_888(iParam0, 1);
	*uParam1 = num / 31;
	*uParam2 = num % 31;
	return 1;
}

int func_858(int iParam0, eStackSize essParam1) // Position - 0x1FA81 Hash - 0x2641680 ^0x6B70222B
{
	int randomIntInRange;
	int num;
	int num2;
	...
	if (essParam1 != -1)
		if (func_652(essParam1, num))
			num2 = num;

	return num2;
}

int func_859(int iParam0) // Position - 0x1FB58 Hash - 0xDEAE5330 ^0x7DE1135D
{
	switch (iParam0)
	{
		case -2040275819:
...
void func_860(eStackSize essParam0, eStackSize essParam1) // Position - 0x1FBCF Hash - 0x319C37AC ^0x8ABBFC1F
{
	Global_40.f_4942[essParam0 /*60*/].f_5 = Global_40.f_4942[essParam0 /*60*/].f_5 - Global_40.f_4942[essParam0 /*60*/].f_5 && essParam1;
	return;
}

BOOL func_861(Ped pedParam0, BOOL bParam1) // Position - 0x1FBFF Hash - 0x4B9AB644 ^0x1F788987
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (bParam1)
...
BOOL func_862() // Position - 0x1FC2C Hash - 0x8905DA1C ^0xB020CE54
{
...
BOOL func_863() // Position - 0x1FC76 Hash - 0x3CA1BB47 ^0x53BEDD8B
{
...
BOOL func_864(var uParam0, Ped pedParam1, const char* sParam2) // Position - 0x1FC90 Hash - 0xFB1C2C0E ^0x6794528D
{
	BOOL flag;
	int i;
...
void func_865(int iParam0) // Position - 0x1FD0E Hash - 0x18700B53 ^0xA392AC83
{
	Hash weaponHash;

	weaponHash = func_720(Global_35, false, iParam0, false);

	if (func_445(weaponHash))
	{
		if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(weaponHash))
			WEAPON::MAKE_PED_DROP_WEAPON(Global_35, true, iParam0, true, false);
		else if (func_719(weaponHash))
			if (func_445(func_720(Global_35, false, 7, false)) || func_445(func_720(Global_35, false, 9, false)))
				if (func_445(func_720(Global_35, false, 8, false)))
					func_890(weaponHash);
				else
					WEAPON::SET_CURRENT_PED_WEAPON(Global_35, weaponHash, true, 8, false, false);
			else
			...
			if (func_445(func_720(Global_35, false, 7, false)) || func_445(func_720(Global_35, false, 9, false)))
				if (func_445(func_720(Global_35, false, 10, false)))
					func_890(weaponHash);
				else
			...
			if (iParam0 == 0)
				if (!func_445(func_720(Global_35, false, 2, false)))
...
void func_866(BOOL bParam0) // Position - 0x1FE8E Hash - 0xDA8F6A70 ^0xDA8F6A70
{
	if (bParam0)
		Global_1935689 = 1;
	else
...
Vector3 func_867(var uParam0) // Position - 0x1FEA8 Hash - 0x5635D4CD ^0xE791861D
{
	if (func_63(uParam0, 8))
...
void func_868(var uParam0, float fParam1, var uParam2, var uParam3, var uParam4, float fParam5, float fParam6, float fParam7) // Position - 0x1FEED Hash - 0xCAC517D3 ^0xA22AB5D
{
	*uParam0 = fParam1;
	uParam0->f_4 = { uParam2 };
	uParam0->f_1 = { fParam5 };
...
Vector3 func_869(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9) // Position - 0x1FF0E Hash - 0xE27EC6B ^0xE27EC6B
{
	var unk;
	var unk4;

	unk = { func_891(uParam0, uParam3, fParam9) };
	unk4 = { func_891(uParam3, uParam6, fParam9) };
	return func_891(unk, unk4, fParam9);
}

Vector3 func_870(var uParam0, int iParam1) // Position - 0x1FF48 Hash - 0xC86EE5DE ^0x7AA7604
{
	int i;
...
BOOL func_871(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x1FFE2 Hash - 0x67CFF016 ^0xEE558762
{
	int num;
	...
	return func_893(hParam0, false, bParam2) >= iParam1;
}

BOOL func_872(Hash hParam0) // Position - 0x2004E Hash - 0x76026CA6 ^0xF319C9CA
{
	Hash hash;
...
BOOL func_873(Hash hParam0) // Position - 0x2007C Hash - 0x2073EBE2 ^0x2073EBE2
{
	Hash hash;
...
Hash func_874() // Position - 0x200A6 Hash - 0xFCC5278F ^0xAA4EF978
{
	int num;
...
Hash func_875() // Position - 0x200FD Hash - 0xFCC5278F ^0x56FDCD49
{
	int num;
...
Hash func_876() // Position - 0x20154 Hash - 0xFCC5278F ^0xB987E402
{
	int num;
...
Hash func_877() // Position - 0x201AB Hash - 0xFCC5278F ^0xD976DFE7
{
	int num;
...
void func_878(Ped pedParam0) // Position - 0x20202 Hash - 0xE7050FE7 ^0x250D9197
{
	int _int;
...
Hash func_879(eStackSize essParam0) // Position - 0x2026A Hash - 0xEB890713 ^0xB40CD388
{
	Hash hash;
	int i;
...
PersChar func_880(eStackSize essParam0) // Position - 0x2034B Hash - 0xF15D53A9 ^0x3132AAF6
{
	Hash persCharHash;
	...
	{
		persCharHash = func_816(essParam0, true);
...
BOOL func_881(Hash hParam0) // Position - 0x203E7 Hash - 0xC561A1F5 ^0xE0EE3BCE
{
...
BOOL func_882(Hash hParam0) // Position - 0x203FD Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_883(int iParam0, int iParam1) // Position - 0x2040B Hash - 0x20FBB09E ^0x20FBB09E
{
	if (iParam0 > iParam1)
		return iParam1;
...
float func_884(int iParam0) // Position - 0x20421 Hash - 0x2C71CF8D ^0x7FC35B16
{
	return Global_40.f_11095.f_11[iParam0];
}

int func_885(float fParam0) // Position - 0x20435 Hash - 0x28AB1AA4 ^0x3CDB2B4C
{
	return BUILTIN::ROUND((fParam0 / 100f) * BUILTIN::TO_FLOAT(10));
}

BOOL func_886() // Position - 0x20450 Hash - 0x11DC3931 ^0x9BD7583B
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_887(int iParam0) // Position - 0x20461 Hash - 0x8232DC08 ^0x5AF1E79C
{
	int num;
	int offset;

	func_895(iParam0, &num, &offset);
	return MISC::IS_BIT_SET(Global_1357549.f_1866[num], offset);
}

int func_888(int iParam0, int iParam1) // Position - 0x20485 Hash - 0xB7443904 ^0xB7443904
{
	switch (iParam0)
	{
		case -2051275045:
...
BOOL func_889() // Position - 0x20819 Hash - 0xFF29F962 ^0xFF29F962
{
	int num;
...
void func_890(Hash hParam0) // Position - 0x208BE Hash - 0x452F6FEB ^0x9AFB0A30
{
	if (!WEAPON::IS_WEAPON_VALID(hParam0))
		return;
...
Vector3 func_891(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x208F7 Hash - 0x4C194BC9 ^0x4C194BC9
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

BOOL func_892(Hash hParam0, int iParam1) // Position - 0x20912 Hash - 0x2A2D0794 ^0x8C1DA314
{
	Hash hash;
	int num;
	int num2;
...
int func_893(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x209BA Hash - 0x27EBD222 ^0x461275A8
{
	int num;
	Hash ammoType;
...
int func_894() // Position - 0x20A3C Hash - 0x6AC5469B ^0xEA730EC
{
	Hash weaponHash;
	int weaponHash2;
	...
	if (weaponHash2 == joaat("WEAPON_UNARMED"))
		if (weaponHash == joaat("WEAPON_UNARMED"))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(weaponHash) && WEAPON::_IS_WEAPON_TWO_HANDED(weaponHash) && !func_719(weaponHash) && !PED::IS_PED_FULLY_ON_MOUNT(Global_35, true) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_35, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
			return 3;
		else if (weaponHash == joaat("weapon_kit_binoculars"))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(weaponHash) && func_719(weaponHash) || weaponHash == joaat("WEAPON_LASSO"))
			return 1;
		else
			return 0;
	else if (weaponHash == joaat("WEAPON_UNARMED"))
...
int func_895(int iParam0, var uParam1, var uParam2) // Position - 0x20B32 Hash - 0x44294A7 ^0x44294A7
{
	int num;

	num = func_898(iParam0, 1);
	*uParam1 = num / 31;
	*uParam2 = num % 31;
	return 1;
}

Hash func_896(Hash hParam0, int iParam1) // Position - 0x20B54 Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
...
int func_897(Hash hParam0, BOOL bParam1) // Position - 0x20BCE Hash - 0x884C76BA ^0xDB141D11
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_900(hParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) };

	if (bParam1)
		func_901(&unk, func_618(false));

	if (!func_902(&unk, &num, &num2, false))
		return 0;
...
int func_898(int iParam0, int iParam1) // Position - 0x20C2C Hash - 0x99A93628 ^0x27AE8C83
{
	switch (iParam0)
	{
...
void func_899(Hash hParam0, var uParam1, var uParam2) // Position - 0x22339 Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_900(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22545 Hash - 0x84700F53 ^0xB9E7AA96
{
	Hash hash;
...
void func_901(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x22617 Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_902(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x22632 Hash - 0xA09A22CB ^0x2B47F617
{
