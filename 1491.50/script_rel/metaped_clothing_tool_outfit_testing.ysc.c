...
void main() // Position - 0x0 Hash - 0x54EEC9CE ^0x54EEC9CE
{
	BOOL flag;
	...
	{
		if (func_2() != -1)
			flag = func_3(false, false);
	
		func_4(&iLocal_131, &uLocal_9);
		BUILTIN::WAIT(0);
	}
...
void func_1(int iParam0) // Position - 0x49 Hash - 0xA615CB24 ^0xCD525F7D
{
...
BOOL func_2() // Position - 0x5F Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0x6D Hash - 0x8CDC02F2 ^0xEB873068
{
	int i;
...
void func_4(var uParam0, var uParam1) // Position - 0x14D Hash - 0x4B8F9A25 ^0xC5A077E5
{
	switch (*uParam0)
	{
		case 0:
...
void func_5() // Position - 0x19E Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_6(var uParam0, int iParam1) // Position - 0x1AA Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}
