...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x491782E
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_c_bighornram_01");
	iLocal_10 = joaat("META_OUTFIT_DEFAULT");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x56E2B7EF
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x2BDD90CD ^0x4740F535
{
	int num;

	func_46(uParam0, "RAMS_HEADBUTT", "script@ambient@animal@RAMS_HEADBUTT@action", uParam1, uParam4);
	num = func_47();

	if (num == 12 || num == 1)
		iLocal_10 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAM_001");
	else if (num == 13 || num == 14 || num == 15)
		iLocal_10 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAMDESERT_001");
	else
		iLocal_10 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAMROCKY_001");

	uParam0->f_16 = 1;
	func_48(uParam0, 1, "pbl_action", "", 0);
	func_49(uParam0, 0, "RAM1", iLocal_9, 0f, 0f, 0f, 0f, 0, 1, 1, 1, iLocal_10, 0);
	func_49(uParam0, 1, "RAM2", iLocal_9, 0f, 0f, 0f, 0f, 0, 1, 1, 1, iLocal_10, 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C74 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D14 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E2E Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FF7 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2000 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21B0 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2224 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2273 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22CB Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2434 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x275B Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2892 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29C2 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A01 Hash - 0x74F10F98 ^0x53256055
{
...
void func_29(var uParam0) // Position - 0x2A91 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2AC3 Hash - 0x295F8D23 ^0x295F8D23
{
	...
	func_65(&uLocal_11, 65);
	return 1;
}

int func_31(var uParam0) // Position - 0x2B05 Hash - 0xE2CB8432 ^0x2E46D4F8
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	...
	{
		if (!bLocal_39)
			if (func_66(uParam0, &uLocal_11, true) || func_67(Global_35, uParam0->f_20[0 /*14*/], true) <= 400f || func_67(Global_35, uParam0->f_20[1 /*14*/], true) <= 400f)
				bLocal_39 = true;
	...
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[4])
			{
				if (func_75(uParam0, 1065353216, 1116471296, 4, joaat("Action"), true))
				{
					func_71(*uParam0, uParam0->f_483, true);
					uParam0->f_469[4] = 1;
				}
...
int func_32(var uParam0, var uParam1) // Position - 0x2DFC Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_76(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2E0E Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2E2B Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F67 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x30A0 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x314A Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x31C2 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3251 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x336C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3378 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3500 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x35A0 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x35B3 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x35CD Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3635 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x3661 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

void func_48(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x366F Hash - 0xF0D98862 ^0x21440CE
{
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x36A0 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x372E Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x3932 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3946 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3955 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_77() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3970 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x39CF Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x3A11 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A3D Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3A65 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3AE1 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3B07 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3B29 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3B4B Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3B6D Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_102(iParam0, 4);
	else
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3B8B Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_65(var uParam0, int iParam1) // Position - 0x3BAF Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_66(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3BBD Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_67(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x3C17 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_68(var uParam0) // Position - 0x3C6E Hash - 0x5001E582 ^0x5001E582
{
	return func_105(*uParam0, 1);
}

void func_69(var uParam0) // Position - 0x3C7E Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_106(uParam0, 0f);
	return;
}

void func_70(var uParam0) // Position - 0x3C8D Hash - 0xB9AF1204 ^0xB9AF1204
{
	if (!uParam0->f_469[5])
	{
...
void func_71(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3CB2 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_72(var uParam0) // Position - 0x3DB6 Hash - 0xFC457B8 ^0xB47AF66B
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
...
BOOL func_73(var uParam0, int iParam1) // Position - 0x3E68 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_68(uParam0))
		return false;
...
BOOL func_74(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E8F Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_67(Global_35, uParam0->f_20[i /*14*/], true);
...
BOOL func_75(var uParam0, int iParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x409B Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_67(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_68(&(uParam0->f_490)))
							func_118(&(uParam0->f_490), false);
					
						if (func_119(&(uParam0->f_490)))
							func_120(&(uParam0->f_490));
					
						if (func_73(&(uParam0->f_490), iParam1))
							return true;
						else
							return false;
					}
		...
		if (func_68(&(uParam0->f_490)) && !func_119(&(uParam0->f_490)))
...
void func_76(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x41C4 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_77() // Position - 0x4318 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_78(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4326 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x438D Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x43B6 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_81(var uParam0, var uParam1, var uParam2) // Position - 0x4402 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_82(int iParam0) // Position - 0x4451 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_83(int iParam0) // Position - 0x4476 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_84(int iParam0) // Position - 0x4489 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_85(int iParam0) // Position - 0x449C Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_86(int iParam0) // Position - 0x44AF Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_87(int iParam0) // Position - 0x44C1 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_88(int iParam0, int iParam1) // Position - 0x44D3 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x456D Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_90() // Position - 0x45A5 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_91(int iParam0) // Position - 0x45F8 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_94(iParam0))
		return -1;
...
BOOL func_92(int iParam0) // Position - 0x4618 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_93(int iParam0, int iParam1) // Position - 0x462E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_94(int iParam0) // Position - 0x463D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_95(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4670 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4751 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_102(iParam0, 8);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4771 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_102(iParam0, 16);
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x479C Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_102(iParam0, 32);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x47BC Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_102(iParam0, 64);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x47DC Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x47FE Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_102(int iParam0, int iParam1) // Position - 0x4822 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_103(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4833 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_104(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4E5C Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x4E7A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_106(var uParam0, float fParam1) // Position - 0x4E89 Hash - 0x30433BAB ^0xF854D531
{
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x4EAF Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_108(int iParam0) // Position - 0x4F86 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_170(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_170(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_170(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_109(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5007 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_110(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x50F8 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_111(var uParam0) // Position - 0x5151 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_68(uParam0))
		return uParam0->f_1;
...
BOOL func_112(Ped pedParam0) // Position - 0x5186 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_113(Ped pedParam0) // Position - 0x51A1 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_114(int iParam0) // Position - 0x51BD Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_115(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5204 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_116(var uParam0, float fParam1) // Position - 0x5222 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_117(var uParam0) // Position - 0x5240 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_118(var uParam0, BOOL bParam1) // Position - 0x5256 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_119(var uParam0) // Position - 0x5276 Hash - 0x39705408 ^0x39705408
{
	return func_105(*uParam0, 2);
}

void func_120(var uParam0) // Position - 0x5286 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_68(uParam0);
...
void func_121(var uParam0) // Position - 0x52BA Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_68(uParam0);
...
BOOL func_122(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x52EA Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_123(BOOL bParam0, var uParam1, var uParam2) // Position - 0x533F Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_124(int iParam0, int iParam1) // Position - 0x5356 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_125(int iParam0, int iParam1) // Position - 0x53DC Hash - 0x96B01D2A ^0x81E68218
{
...
void func_126(int iParam0, int iParam1) // Position - 0x5418 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_127(int iParam0, int iParam1) // Position - 0x546B Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_128(int iParam0, int iParam1) // Position - 0x54A6 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_129(int iParam0, int iParam1) // Position - 0x54DF Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_130(int iParam0) // Position - 0x5517 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_131(BOOL bParam0) // Position - 0x5555 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_132(ePedType eptParam0) // Position - 0x5568 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_133(Ped pedParam0, Hash hParam1) // Position - 0x59BB Hash - 0x2AE02BA5 ^0x88C8652A
{
...
void func_134(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5A62 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_135(Ped pedParam0, BOOL bParam1) // Position - 0x5A92 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_136(Ped pedParam0, int iParam1) // Position - 0x5AD7 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_137(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5AFE Hash - 0x37D64B11 ^0xE7060A9E
{
	func_175(iParam2);
		...
		case 0:
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					...
					else if (!(*iParam0 & &func_19 != 0))
						if (func_177(true))
							func_102(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_177(true) || *iParam0 & &func_19 != 0)
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5CC9 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_139(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5DA0 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x5DDD Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_141(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5EC4 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x5F9A Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_143(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x60A3 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0x61D8 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x620F Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6316 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6381 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_148(Ped pedParam0, int iParam1) // Position - 0x64C9 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_149(var uParam0, int iParam1) // Position - 0x66A5 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x671D Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_151(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x674C Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_152(int iParam0, Ped pedParam1) // Position - 0x68D2 Hash - 0xB78652F5 ^0x2C24F7C8
{
	int _int;
...
BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x691F Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_202(iParam0))
		return true;
...
BOOL func_154(Ped pedParam0, Ped pedParam1) // Position - 0x69BC Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_155() // Position - 0x6A09 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6A11 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_157() // Position - 0x6AD2 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_158() // Position - 0x6AF0 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6B3D Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_160(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6C59 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6CA1 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x6EFA Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_212(0))
		return false;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x6F33 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_164(var uParam0, int iParam1) // Position - 0x6F62 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x6F76 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_157() - iParam1->f_4 > func_213(iParam1))
		return func_214(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_166(int iParam0, Ped pedParam1) // Position - 0x6FC3 Hash - 0x76630E04 ^0x49D57A15
{
...
float func_167() // Position - 0x7016 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_168(var uParam0, int iParam1) // Position - 0x7048 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_169(var uParam0, int iParam1) // Position - 0x7059 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_170(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x706E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x70FA Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x7128 Hash - 0x6F1F6F14 ^0xC2F8EB84
{
	Hash _int;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x7176 Hash - 0x6F1F6F14 ^0xC2F8EB84
{
	Hash _int;
	int _int2;
...
void func_174(Ped pedParam0) // Position - 0x71E4 Hash - 0xF4FF5B9D ^0xD76A6574
{
...
void func_175(int iParam0) // Position - 0x7200 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_176(int iParam0) // Position - 0x736C Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_177(BOOL bParam0) // Position - 0x737F Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_178(int iParam0) // Position - 0x7399 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_179(int iParam0) // Position - 0x7431 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_180(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7458 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_181(Ped pedParam0, Ped pedParam1) // Position - 0x7551 Hash - 0xF9959663 ^0xF9959663
{
	return func_203(pedParam0, pedParam1, true, true);
}

float func_182(int iParam0) // Position - 0x7563 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_183(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x756F Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_184(int iParam0, BOOL bParam1) // Position - 0x75D4 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_185() // Position - 0x75FA Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_186(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x760E Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_187(int iParam0) // Position - 0x776E Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_188(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x777A Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_189(int iParam0) // Position - 0x77DB Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_190(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x77E7 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_191(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x78A9 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_192(int iParam0) // Position - 0x7947 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_193(int iParam0) // Position - 0x7953 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_194(int iParam0) // Position - 0x795F Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_195(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7A9C Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_196(Ped pedParam0) // Position - 0x7ADF Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B45 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B8C Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7BD7 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_200(Ped pedParam0, var uParam1) // Position - 0x7C50 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_201(Ped pedParam0, Ped pedParam1) // Position - 0x7C9D Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_202(int iParam0) // Position - 0x7CE5 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_203(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7CF5 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_204(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7D3D Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_205(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7D69 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_206(int iParam0) // Position - 0x7D91 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_207(Ped pedParam0) // Position - 0x7D9D Hash - 0x518A2A38 ^0x52CAD4E7
{
...
int func_208(Ped pedParam0) // Position - 0x7DF1 Hash - 0x46B6111F ^0xC1ACA74A
{
...
BOOL func_209(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7E5B Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_210(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7FCB Hash - 0x10D5ECF8 ^0x71437C44
{
	Ped ped;
	Ped ped2;
...
BOOL func_211(int iParam0, Ped pedParam1) // Position - 0x80BA Hash - 0x27FC2906 ^0xE5C3A09A
{
...
BOOL func_212(int iParam0) // Position - 0x8130 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_229())
		return false;
...
int func_213(int iParam0) // Position - 0x8152 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_214(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x815E Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_215(int iParam0) // Position - 0x81D9 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_216() // Position - 0x81EC Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_217() // Position - 0x81FA Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_231())
		return false;
...
void func_218(Any* panParam0, int iParam1) // Position - 0x8250 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_219(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82F8 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_220(int iParam0) // Position - 0x83BF Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_221(int iParam0) // Position - 0x8467 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_222(Ped pedParam0, int iParam1) // Position - 0x84CC Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_223(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x84E3 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_224(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8511 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x855B Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_226(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x859C Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_227(Ped pedParam0) // Position - 0x8615 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_228(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x86FD Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_229() // Position - 0x873F Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_216() != -1)
		return false;
...
BOOL func_230(int iParam0, BOOL bParam1) // Position - 0x8764 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_231() // Position - 0x8795 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_232(int iParam0) // Position - 0x87C6 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_94(iParam0))
		return -1;
...
int func_233(int iParam0) // Position - 0x87E2 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_234(int iParam0) // Position - 0x8823 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
