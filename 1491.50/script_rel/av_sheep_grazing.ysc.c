#region Local Var
	...
	Hash hLocal_10 = 0;
	int iLocal_11 = 0;
	Volume volLocal_12 = 0;
	Volume volLocal_13 = 0;
	var uLocal_14 = 0;
	var uLocal_15 = 0;
	var uLocal_16 = 0;
	var uLocal_17 = 0;
	...
	var uLocal_29 = 0;
	var uLocal_30 = 0;
	var uLocal_31 = 1097859072;
	var uLocal_32 = 1000;
	var uLocal_33 = 1067450368;
	var uLocal_34 = 5000;
	var uLocal_35 = 42;
	var uLocal_36 = 1103626240;
	var uLocal_37 = 1077936128;
	var uLocal_38 = 1106247680;
	var uLocal_39 = 1103101952;
...
void main() // Position - 0x0 Hash - 0x67D32DD8 ^0xD67BC900
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_m_m_rancher_01");
	hLocal_10 = joaat("world_animal_sheep_grazing");
	hLocal_70 = joaat("a_c_sheep_01");
	iLocal_71 = 56;
	hLocal_72 = 1071881105;
	iLocal_94 = 5;
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_1(var uParam0) // Position - 0x59D Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x5AB Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x641 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9E7 Hash - 0x4DA9BC8C ^0x6CAE5983
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0xA01 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA18 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAD6 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB00 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC51 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC66 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD0A Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1ABB Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B21 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BDB Hash - 0x33CD67 ^0x457916E8
{
	func_46(uParam0, "SHEEP_GRAZING", "", vParam1, uParam4);

	switch (*uParam0)
	{
		case 5:
			hLocal_10 = joaat("world_animal_cow_grazing");
			hLocal_70 = joaat("A_C_Cow");
			iLocal_9 = joaat("a_m_m_rancher_01");
			hLocal_72 = -1983185436;
			uLocal_80 = { 2254.331f, -97.407f, 44.618f };
			fLocal_95 = 154.8f;
			uLocal_83 = { 2256.156f, -97.059f, 44.471f };
			fLocal_96 = 152.64f;
			uLocal_86 = { 2255.22f, -104.21f, 44.79f };
			fLocal_97 = -133.984f;
			uLocal_89 = { 2251.53f, -115.28f, 44.95f };
			fLocal_98 = 119.957f;
			break;
	
		case 8:
			hLocal_10 = joaat("world_animal_goat_grazing_domestic");
			iLocal_9 = joaat("a_m_m_rancher_01");
			hLocal_70 = joaat("a_c_goat_01");
			uLocal_80 = { -5189.384f, -2130.353f, 11.053f };
			fLocal_95 = 97.2f;
			uLocal_83 = { -5189.521f, -2128.847f, 11.053f };
			fLocal_96 = 97.2f;
			uLocal_86 = { -5219.56f, -2130.54f, 11.16f };
			fLocal_97 = -11.14f;
			uLocal_89 = { -5198.76f, -2129.81f, 11.05f };
			fLocal_98 = -107.478f;
			break;
	
		case 15:
			hLocal_10 = joaat("world_animal_sheep_grazing");
			iLocal_9 = func_48(func_47(), true, false, true, false, false, false);
			hLocal_70 = joaat("a_c_sheep_01");
			iLocal_94 = 5;
			hLocal_72 = 1071881105;
			uLocal_80 = { -230.685f, 637.878f, 112.425f };
			fLocal_95 = 48.96f;
			uLocal_83 = { -228.877f, 638.1553f, 112.389f };
			fLocal_96 = 60.2229f;
			break;
	}

	func_49(uParam0, 0, "SGP_MAN", iLocal_9, vParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "SGP_DOG", joaat("a_c_dogamericanfoxhound_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1.25f, 0f, 0f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);

	if (Global_1415419.f_9757 != -310375866)
	{
		func_49(uParam0, 2, "SGP_SHEEP_1", hLocal_70, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1.15f, 4.5f, 0f), 45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 3, "SGP_SHEEP_2", hLocal_70, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.25f, 5.25f, 0f), 120f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}

	return;
}

Vector3 func_15(var uParam0) // Position - 0x1E43 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1EE3 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1FFD Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x21C6 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x21CF Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x237F Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x23F3 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2442 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x249A Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2603 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_55(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_25(var uParam0) // Position - 0x292A Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2A61 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2B91 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2BD0 Hash - 0x13D3DC7C ^0x225806ED
{
	if (!VOLUME::DOES_VOLUME_EXIST(volLocal_13))
	{
		if (*uParam0 == 15)
		{
			if (Global_1415419.f_9757 == -310375866)
			{
				uLocal_77 = { -235.30568f, 640.79584f, 113.024055f };
				volLocal_13 = VOLUME::CREATE_VOLUME_BOX(uLocal_77, 0f, 0f, -37.02594f, 9.625906f, 8.149053f, 4.805788f);
			}
		}
	}
...
void func_29(var uParam0) // Position - 0x2C2D Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2C5F Hash - 0xCEF23394 ^0xCEF23394
{
	func_57(&uLocal_14, false);
	func_58(&uLocal_14, true);
	func_59(&uLocal_14, true);
	func_60(&uLocal_14, true);
	func_61(&uLocal_14, true);
	func_62(&uLocal_14, true);
	func_63(&uLocal_14, true);
	func_57(&uLocal_42, false);
	func_59(&uLocal_42, true);
	func_60(&uLocal_42, true);
	func_61(&uLocal_42, true);
	func_62(&uLocal_42, true);

	if (*uParam0 == 15)
		if (Global_1415419.f_9757 == -310375866)
			uLocal_74 = { -218.93866f, 643.78644f, 113.522026f };

	return 1;
}

int func_31(var uParam0) // Position - 0x2CE6 Hash - 0xB1049480 ^0x36037BE8
{
	var unk;
	var unk2;
	...
	if (!uParam0->f_469[0])
	{
		if (MISC::GET_FRAME_COUNT() % 2 == 0)
			if (func_64(uParam0->f_20[0 /*14*/], 0, &uLocal_14, &unk, 0, 0))
				uParam0->f_469[0] = 1;
		else if (func_64(uParam0->f_20[1 /*14*/], 0, &uLocal_42, &unk2, 0, 0))
			uParam0->f_469[0] = 1;
	...
	if (!bLocal_92)
	{
		if (func_65(Global_35, uLocal_74, true) <= 400f && !func_66(uParam0))
		{
			func_67(uParam0);
			bLocal_92 = true;
		}
	...
	if (*uParam0 != 8 && *uParam0 != 5)
		if (iLocal_11 < 6)
			if (!func_68(hLocal_72))
				func_69(hLocal_72, false, 1f, true, true, 0, false, false);
	...
	switch (iLocal_11)
	{
		case 0:
			...
			if (func_71(uParam0->f_20[0 /*14*/], 0))
			{
				...
				if (Global_1415419.f_9757 == -310375866)
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("world_human_crouch_inspect"), -216.29f, 650.41f, 112.07f, 153.346f, 0, false, true, 0, -1082130432, false);
				}
				else
				{
					func_72(&(uParam0->f_20[0 /*14*/].f_5), 50, 10, false);
					...
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], joaat("world_human_crouch_inspect"), 0, false, 0, -1082130432, false);
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("world_human_crouch_inspect"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
				}
			
				PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], false);
				func_73(&uParam0->f_20[0 /*14*/], false, true);
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_72(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("Stand"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[2 /*14*/]))
			{
				...
				{
					func_72(&(uParam0->f_20[2 /*14*/].f_5), 50, 10, false);
					...
					PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[0 /*14*/], uParam0->f_20[2 /*14*/], false);
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[2 /*14*/], hLocal_10, uParam0->f_20[2 /*14*/].f_5, uParam0->f_20[2 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
					func_73(&uParam0->f_20[2 /*14*/], false, true);
				}
			}
		
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[3 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
				{
					func_72(&(uParam0->f_20[3 /*14*/].f_5), 50, 10, false);
					...
					PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[0 /*14*/], uParam0->f_20[3 /*14*/], false);
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[3 /*14*/], hLocal_10, uParam0->f_20[3 /*14*/].f_5, uParam0->f_20[3 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
					func_73(&uParam0->f_20[3 /*14*/], false, true);
				}
			}
		
			if (func_71(uParam0->f_20[1 /*14*/], 0) && Global_1415419.f_9757 == -310375866)
				func_74(uParam0->f_20[1 /*14*/], -214.15f, 648.98f, 111.96f, 111.96f, 2, 1073741824);
		...
		case 1:
			if (func_75(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				func_77(*uParam0, uParam0->f_483, false);
			
				if (func_71(uParam0->f_20[0 /*14*/], 0))
					TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
			
				if (func_71(uParam0->f_20[1 /*14*/], 0))
				{
					TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
				
					if (Global_1415419.f_9757 == -310375866)
						TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("world_animal_dog_guard_growl"), -214.15f, 648.98f, 111.96f, 111.96f, 0, true, true, 0, -1082130432, false);
					else
						TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], joaat("world_animal_dog_guard_growl"), 0, true, 0, -1082130432, false);
				}
		...
		case 2:
			if (func_79(&uLocal_99, 1.5f))
			{
				if (func_71(uParam0->f_20[1 /*14*/], 0))
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("world_animal_dog_sitting"), uLocal_83, fLocal_96, 0, true, false, 0, -1082130432, false);
		...
		case 3:
			if (func_79(&uLocal_99, 3f))
			{
				if (func_71(uParam0->f_20[0 /*14*/], 0))
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("world_human_stare_stoic"), uLocal_80, fLocal_95, 0, true, false, 0, -1082130432, false);
				...
				if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_497))
				{
					POPULATION::_REMOVE_AMBIENT_AVOIDANCE_RESTRICTION(uParam0->f_497);
					POPULATION::_REMOVE_AMBIENT_SPAWN_RESTRICTION(uParam0->f_497);
					func_5(uParam0->f_497);
				}
			
				if (*uParam0 == 15 && Global_1415419.f_9757 == -310375866)
				{
					func_80(uParam0);
				}
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[2 /*14*/]))
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
						{
							func_72(&uLocal_86, 50, 10, false);
							TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[2 /*14*/], hLocal_10, uLocal_86, fLocal_97, 0, true, false, 0, -1082130432, false);
						}
					}
					...
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[3 /*14*/]))
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
						{
							func_72(&uLocal_89, 50, 10, false);
							TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[3 /*14*/], hLocal_10, uLocal_89, fLocal_98, 0, true, false, 0, -1082130432, false);
						}
					}
				}
		...
		case 4:
			if (TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 0))
			{
				if (!bLocal_93)
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
					{
						PED::SET_PED_USING_ACTION_MODE(uParam0->f_20[1 /*14*/], false, -1, 0);
						bLocal_93 = true;
					}
				}
			
				if (!func_81(&uLocal_99))
					func_78(&uLocal_99);
			
				if (func_79(&uLocal_99, 5f))
				{
					func_78(&uLocal_99);
					iLocal_11 = 6;
				}
		...
		case 6:
			if (func_66(uParam0) || func_79(&uLocal_99, 15f))
			{
				if (*uParam0 == 15)
					if (Global_1415419.f_9757 != -310375866)
						func_82(uParam0);
...
int func_32(var uParam0, var uParam1) // Position - 0x3427 Hash - 0xF9D73244 ^0x43B031AD
{
	if (*uParam0 == 15)
		if (Global_1415419.f_9757 == -310375866)
			func_80(uParam0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		PED::_0x45FEA6D5539BD474(uParam0->f_20[1 /*14*/], 0);
		PED::_0xE37ACEE15AC50C7E(uParam0->f_20[1 /*14*/], 0);
	}

	func_83(uParam0, false, false, false);

	if (ITEMSET::IS_ITEMSET_VALID(isLocal_73))
		ITEMSET::DESTROY_ITEMSET(isLocal_73);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34B5 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x34D2 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x360E Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3747 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x37F1 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3869 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x38F8 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3A13 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3A1F Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3BA7 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3C47 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3C5A Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3C74 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3CDC Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x3D08 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3D16 Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
void func_49(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3F08 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F96 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x419C Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x41B0 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x41BF Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_84() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x41DA Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x4239 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x427B Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x42A7 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x4323 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x4347 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x436D Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x438F Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
		func_9(&(uParam0->f_1), 2);
	else
		func_110(&(uParam0->f_1), 2);

	return;
}

void func_62(var uParam0, BOOL bParam1) // Position - 0x43B1 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
		func_9(&(uParam0->f_1), 1);
	else
		func_110(&(uParam0->f_1), 1);

	return;
}

void func_63(var uParam0, BOOL bParam1) // Position - 0x43D3 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_64(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x43F7 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_111(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_113(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_115(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_113(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_117(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_118(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_119(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_113(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_120(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_113(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_121(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_113(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_121(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_113(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_124(iParam2, 4000))
				{
					if (func_125(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_126(iParam2, pedParam0) && func_127(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_113(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_125(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_126(iParam2, pedParam0) && func_127(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_113(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_128(pedParam0, Global_1935630.f_41))
							{
								func_129();
								*uParam3 = 2;
								func_113(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_130(iParam2, pedParam0) || iParam2->f_9 > 0 && func_131() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_132())
					{
						if (func_128(pedParam0, Global_1935630.f_42))
						{
							func_129();
							*uParam3 = 2;
							func_113(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_134(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_113(pedParam0, iParam2, *uParam3);
					return true;
...
float func_65(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4A20 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_141(entityCoords, vParam1);
}

BOOL func_66(var uParam0) // Position - 0x4A70 Hash - 0xE4E311BC ^0x72A206FC
{
	int i;
	int itemsetSize;
	...
	if (ITEMSET::IS_ITEMSET_VALID(isLocal_73))
	{
		itemsetSize = ITEMSET::GET_ITEMSET_SIZE(isLocal_73);
	
		for (i = 0; i < itemsetSize; i = i + 1)
		{
			indexedItemInItemset = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(i, isLocal_73);
			pedFromIndexedItem = MISC::_GET_PED_FROM_INDEXED_ITEM(indexedItemInItemset);
		
			if (!ENTITY::IS_ENTITY_DEAD(pedFromIndexedItem))
				if (!ENTITY::IS_ENTITY_IN_VOLUME(pedFromIndexedItem, volLocal_13, true, 0))
					return false;
		}
	}
...
void func_67(var uParam0) // Position - 0x4ACB Hash - 0x179F03C3 ^0xCCA43A71
{
	int i;
	int itemsetSize;
	ScrHandle indexedItemInItemset;
	...
	if (ITEMSET::IS_ITEMSET_VALID(isLocal_73))
	{
		...
		for (i = 0; i < itemsetSize; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(pedFromIndexedItem))
			{
				TASK::CLEAR_PED_TASKS(pedFromIndexedItem, true, false);
				TASK::_TASK_FLEE_FROM_PED(pedFromIndexedItem, Global_35, uLocal_77, -1f, 10000, 1280, 1.5f, 0);
				PED::SET_PED_KEEP_TASK(pedFromIndexedItem, true);
			}
		}
	}
...
BOOL func_68(Hash hParam0) // Position - 0x4B3C Hash - 0x783D8692 ^0xC2190628
{
	func_142(hParam0, false, false);
...
void func_69(Hash hParam0, BOOL bParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4B64 Hash - 0xD777F4CF ^0xBFF3124C
{
	func_142(hParam0, false, false);
	...
	if (func_143(hParam0))
	{
		...
		if (bParam3)
			func_144(hParam0, fParam2, true, bParam6);
		else if (bParam1)
			if (bParam4)
...
BOOL func_70(var uParam0) // Position - 0x4BEF Hash - 0xE765C90C ^0x12C8D9A3
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(volLocal_12))
		if (*uParam0 == 15)
			if (Global_1415419.f_9757 == -310375866)
				volLocal_12 = VOLUME::CREATE_VOLUME_BOX(uLocal_74, 0f, 0f, -37.02594f, 9.625906f, 8.149053f, 4.805788f);
	...
	if (!ITEMSET::IS_ITEMSET_VALID(isLocal_73))
		isLocal_73 = ITEMSET::CREATE_ITEMSET(true);

	matchingEntities = ENTITY::GET_MATCHING_ENTITIES(volLocal_13, isLocal_73, 1, 1, hLocal_70, 0);

	if (matchingEntities < iLocal_94)
	{
		ITEMSET::_CLEAR_ITEMSET(isLocal_73);
	
		if (func_149(iLocal_71, false, 0, 0, 0, false))
			PERSCHAR::_0x6759BEE6762E140B(func_150(iLocal_71));
	...
	for (i = 0; i < matchingEntities; i = i + 1)
	{
		...
		if (func_71(pedFromIndexedItem, 0))
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(pedFromIndexedItem, false, true);
			num = 1f;
			func_74(pedFromIndexedItem, uLocal_74 + { 0f, 0f, (float)i * num }, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 2, 1073741824);
			func_73(&pedFromIndexedItem, true, true);
			TASK::TASK_ANIMAL_UNALERTED(pedFromIndexedItem, -1, volLocal_12, 0, 0);
		}
	}
...
BOOL func_71(Ped pedParam0, int iParam1) // Position - 0x4D37 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
int func_72(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4E36 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_73(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4F2D Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_74(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x4F55 Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_153(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_154(pedParam0))
		if (func_155(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
	...
	if (func_151(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_74(vehiclePedIsIn, fParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_74(mount, fParam1, fParam4, iParam5, iParam6);
			}
	...
	if (func_151(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, fParam1, fParam4, true, func_151(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, fParam1, fParam4, true, func_151(iParam5, 32), true);
	...
	else if (func_151(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, fParam1, func_151(iParam5, 32), true, true);
...
BOOL func_75(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x51D7 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_156(Global_35))
		{
			ped = func_157(Global_35);
		...
		num = num * num;
		fParam2 = func_158(fParam2);
		num2 = func_159(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_160(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_81(&(uParam0->f_490)))
							func_78(&(uParam0->f_490));
					
						if (func_161(&(uParam0->f_490), fParam1))
						{
							func_162(&(uParam0->f_490));
							return true;
						}
...
void func_76(int iParam0, BOOL bParam1) // Position - 0x53E2 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_77(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x54B9 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_78(var uParam0) // Position - 0x55BD Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_165(uParam0, 0f);
	return;
}

BOOL func_79(var uParam0, float fParam1) // Position - 0x55CC Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_81(uParam0))
		return false;

	if (func_166(uParam0) > fParam1)
		return true;

	return false;
}

void func_80(var uParam0) // Position - 0x55F3 Hash - 0x60D2DC3A ^0xC98E5ED5
{
	int i;
	int itemsetSize;
	ScrHandle indexedItemInItemset;
	...
	if (ITEMSET::IS_ITEMSET_VALID(isLocal_73))
	{
		...
		for (i = 0; i < itemsetSize; i = i + 1)
		{
			...
			{
				TASK::CLEAR_PED_TASKS(pedFromIndexedItem, true, false);
				TASK::TASK_PERSISTENT_CHARACTER(pedFromIndexedItem);
				PED::SET_PED_KEEP_TASK(pedFromIndexedItem, true);
			}
		}
	
		if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_150(iLocal_71)))
...
BOOL func_81(var uParam0) // Position - 0x5667 Hash - 0x5001E582 ^0x5001E582
{
	return func_167(*uParam0, 1);
}

void func_82(var uParam0) // Position - 0x5677 Hash - 0x179F03C3 ^0xCCA43A71
{
	int i;
	int itemsetSize;
	ScrHandle indexedItemInItemset;
	...
	if (ITEMSET::IS_ITEMSET_VALID(isLocal_73))
	{
		...
		for (i = 0; i < itemsetSize; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(pedFromIndexedItem))
				if (ENTITY::IS_ENTITY_IN_VOLUME(pedFromIndexedItem, volLocal_13, true, 0))
					func_73(&pedFromIndexedItem, false, true);
		}
	}
...
void func_83(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x56D4 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_84() // Position - 0x5828 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_85(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x5836 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_86(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x589D Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_87(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x58C6 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_168(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_88(var uParam0, var uParam1, var uParam2) // Position - 0x5912 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_168(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_89(int iParam0) // Position - 0x5961 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_90(int iParam0) // Position - 0x5986 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_91(int iParam0) // Position - 0x5999 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_92(int iParam0) // Position - 0x59AC Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_93(int iParam0) // Position - 0x59BF Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_94(int iParam0) // Position - 0x59D1 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_95(int iParam0, int iParam1) // Position - 0x59E3 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5A7D Hash - 0xA65AB937 ^0xA65AB937
{
	func_170(iParam0, iParam6);
	func_171(iParam0, iParam5);
	func_172(iParam0, iParam4);
	func_173(iParam0, iParam3);
	func_174(iParam0, iParam2);
	func_175(iParam0, iParam1);
	return;
}

BOOL func_97() // Position - 0x5AB5 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_98(int iParam0) // Position - 0x5B08 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_101(iParam0))
		return -1;

	return func_177(func_176(iParam0));
}

BOOL func_99(int iParam0) // Position - 0x5B28 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_100(int iParam0, int iParam1) // Position - 0x5B3E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_101(int iParam0) // Position - 0x5B4D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_102(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5B80 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_178(eptParam1))
		{
			func_179(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_181(pedParam0, false);
			flag = true;
		}
	
		func_182(pedParam0, iParam2);
	}
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x5C61 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_110(iParam0, 4);
	else
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x5C7F Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_110(iParam0, 8);
	else
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x5C9F Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_110(iParam0, 16);
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x5CCA Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_110(iParam0, 32);
	else
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x5CEA Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_110(iParam0, 64);
	else
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x5D0A Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x5D2C Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_110(iParam0, 1048576);
	else
...
void func_110(int iParam0, int iParam1) // Position - 0x5D50 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_111(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5D61 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_183(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_185(true))
							func_110(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_185(true) || *iParam0 & 8192 != 0)
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_186(iParam0))
				iParam0->f_15 = func_131();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_131() - iParam0->f_15 > 500)
			{
...
BOOL func_112(Ped pedParam0, int iParam1) // Position - 0x5F2C Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_188(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_189(pedParam0, pedIndexFromEntityIndex) <= func_190(iParam1))
				return true;
			break;
	}
...
void func_113(Ped pedParam0, int iParam1, int iParam2) // Position - 0x6003 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_191(iParam2, 1, 1, 1, 0))
		func_110(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_192(iParam1, true);
	func_193();
	return;
}

BOOL func_114(Ped pedParam0, int iParam1) // Position - 0x6040 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_194(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_196(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_197(iParam1);
...
BOOL func_115(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6127 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_198(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_195(iParam2);
	
		if (func_196(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_197(iParam2))
				{
					func_192(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_116(Ped pedParam0, int iParam1) // Position - 0x61FD Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_188(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_197(iParam1))
		{
			customDistance = func_195(iParam1);
...
BOOL func_117(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6306 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_118(int iParam0, int iParam1) // Position - 0x643B Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_119(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6472 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_120(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6579 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_201(iParam2))
	{
...
BOOL func_121(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x65E4 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_203(pedParam1, entityCoords, outCoords))
					{
						func_192(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_203(pedParam1, entityCoords, outCoords2))
					{
						func_192(iParam2, true);
						return true;
					}
...
BOOL func_122(Ped pedParam0, int iParam1) // Position - 0x672C Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_188(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_204(Global_1935630.f_34[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false), entityCoords);
		
			if (func_56(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
			...
			if (func_205(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_206(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_207(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_123(var uParam0, int iParam1) // Position - 0x6908 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_124(int iParam0, int iParam1) // Position - 0x6980 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_125(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x69AF Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_126(int iParam0, Ped pedParam1) // Position - 0x6B35 Hash - 0x4BE36437 ^0x8BFA4ECC
{
	int _int;
...
BOOL func_127(int iParam0, Ped pedParam1) // Position - 0x6B82 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_210(iParam0))
		return true;
...
BOOL func_128(Ped pedParam0, Ped pedParam1) // Position - 0x6C1F Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_211(pedParam0, pedParam1, true, true) < 4f)
...
void func_129() // Position - 0x6C6C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_130(int iParam0, Ped pedParam1) // Position - 0x6C74 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_212(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_131();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_213(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_131() // Position - 0x6D35 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_132() // Position - 0x6D53 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_131() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_133(int iParam0, Ped pedParam1) // Position - 0x6DA0 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_214(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_215(pedParam1);
	num2 = func_216(iParam0->f_14);
...
BOOL func_134(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6EBC Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_217(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x6F04 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_218(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_219(iParam1, pedParam0))
						if (func_213(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x715D Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_220(0))
		return false;
...
BOOL func_137(int iParam0, int iParam1) // Position - 0x7196 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_138(var uParam0, int iParam1) // Position - 0x71C5 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x71D9 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_131();
	else if (func_131() - iParam1->f_4 > func_221(iParam1))
		return func_222(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_140(int iParam0, Ped pedParam1) // Position - 0x7226 Hash - 0x3C2BFB38 ^0xA5F130C
{
...
float func_141(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7279 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
Hash func_142(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7297 Hash - 0xEC5804B5 ^0x15A1D925
{
...
BOOL func_143(Hash hParam0) // Position - 0x733B Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_223(hParam0))
...
void func_144(Hash hParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7356 Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_143(hParam0))
	{
...
void func_145(Hash hParam0, BOOL bParam1) // Position - 0x738E Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_143(hParam0))
...
void func_146(Hash hParam0, BOOL bParam1) // Position - 0x73BC Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_143(hParam0))
...
void func_147(Hash hParam0, BOOL bParam1) // Position - 0x73EA Hash - 0x4844A91D ^0x50E23246
{
	if (func_143(hParam0))
...
BOOL func_148() // Position - 0x7418 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_149(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x7421 Hash - 0x4673E62 ^0xCF31A97
{
	var unk;
	Entity entity;
	...
	{
		func_227(iParam0, false);
		return false;
	}

	unk = { iParam2, iParam3, iParam4 };

	if (!func_228(iParam0, false))
		if (bParam1)
			if (!func_229(iParam0))
				return false;
		else
	...
	if (!_IS_NULL_VECTOR(unk))
		PERSCHAR::_0x59C7AD6FEA2AC449(func_150(iParam0), unk);

	if (bParam5)
		entity = PERSCHAR::_0x08FC896D2CB31FCC(func_150(iParam0), false);
	else
		entity = PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_150(iParam0), false);

	if (!_IS_NULL_VECTOR(unk))
		PERSCHAR::_0xBB68908CD11AEBDC(func_150(iParam0));
...
PersChar func_150(int iParam0) // Position - 0x74F2 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_224(iParam0))
		return 0;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x7512 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_152(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7521 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Ped func_153(Ped pedParam0) // Position - 0x754A Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_154(Ped pedParam0) // Position - 0x7554 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_155(Ped pedParam0) // Position - 0x7586 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_156(Ped pedParam0) // Position - 0x75C8 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_157(Ped pedParam0) // Position - 0x75E3 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_158(float fParam0) // Position - 0x75FF Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_159(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7646 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_160(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x7664 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_141(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_161(var uParam0, float fParam1) // Position - 0x76BB Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_162(var uParam0) // Position - 0x76D9 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_163(int iParam0) // Position - 0x76EF Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_230(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_230(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_230(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_164(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7770 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_168(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
void func_165(var uParam0, float fParam1) // Position - 0x7861 Hash - 0x30433BAB ^0xF854D531
{
...
float func_166(var uParam0) // Position - 0x7887 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_81(uParam0))
		return uParam0->f_1;
...
BOOL func_167(int iParam0, int iParam1) // Position - 0x78BC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_168(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x78CB Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_169(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7920 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_170(int iParam0, int iParam1) // Position - 0x7937 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_171(int iParam0, int iParam1) // Position - 0x79BD Hash - 0x96B01D2A ^0x81E68218
{
...
void func_172(int iParam0, int iParam1) // Position - 0x79F9 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_173(int iParam0, int iParam1) // Position - 0x7A4C Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_174(int iParam0, int iParam1) // Position - 0x7A87 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_175(int iParam0, int iParam1) // Position - 0x7AC0 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_176(int iParam0) // Position - 0x7AF8 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_177(BOOL bParam0) // Position - 0x7B36 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_178(ePedType eptParam0) // Position - 0x7B49 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_179(Ped pedParam0, Hash hParam1) // Position - 0x7F9C Hash - 0x6DE2E6FC ^0x86849FB3
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_180(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8044 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_181(Ped pedParam0, BOOL bParam1) // Position - 0x8074 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_182(Ped pedParam0, int iParam1) // Position - 0x80B9 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_183(int iParam0) // Position - 0x80E0 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_240(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_184(int iParam0) // Position - 0x824C Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_185(BOOL bParam0) // Position - 0x825F Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_241(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_186(int iParam0) // Position - 0x8279 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_187(int iParam0) // Position - 0x8311 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_188(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x8338 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_216(pedParam2);
	else
		num2 = func_215(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_216(pedParam0);
	else
		num = func_215(pedParam0);

	if (num2 == num)
		if (num2 != -1)
			return true;

	if (func_52(*iParam1, 8388608))
		return true;
...
float func_189(Ped pedParam0, Ped pedParam1) // Position - 0x8431 Hash - 0xF9959663 ^0xF9959663
{
	return func_211(pedParam0, pedParam1, true, true);
}

float func_190(int iParam0) // Position - 0x8443 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_191(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x844F Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_192(int iParam0, BOOL bParam1) // Position - 0x84B4 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_193() // Position - 0x84DA Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_194(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x84EE Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_211(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_195(int iParam0) // Position - 0x864E Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_196(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x865A Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_197(int iParam0) // Position - 0x86BB Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_198(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x86C7 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_245(ped, 0)))
			if (func_247(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_199(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8789 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_200(int iParam0) // Position - 0x8827 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_201(int iParam0) // Position - 0x8833 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_202(int iParam0) // Position - 0x883F Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x897C Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_248(pedParam0, vParam4, 0.5f))
...
BOOL func_204(Ped pedParam0) // Position - 0x89BF Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_249(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_205(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8A25 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_206(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8A6C Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_207(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x8AB7 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_208(Ped pedParam0, var uParam1) // Position - 0x8B30 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_209(Ped pedParam0, Ped pedParam1) // Position - 0x8B7D Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_251(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_210(int iParam0) // Position - 0x8BC5 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_211(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8BD5 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_212(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8C1D Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_213(veParam0, uParam2, true);
...
float func_213(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8C49 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_214(int iParam0) // Position - 0x8C71 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_215(Ped pedParam0) // Position - 0x8C7D Hash - 0x6414A9B3 ^0x1A6FF997
{
...
int func_216(Ped pedParam0) // Position - 0x8CD1 Hash - 0xA8826453 ^0x2CAB8624
{
...
BOOL func_217(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8D3B Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_211(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_211(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_218(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8EAB Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_241(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_219(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_219(iParam1, ped2))
					if (func_213(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_219(int iParam0, Ped pedParam1) // Position - 0x8F99 Hash - 0xEBA0A5BE ^0x30650E95
{
...
BOOL func_220(int iParam0) // Position - 0x900D Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_252())
		return false;

	return func_253(Global_1347702[58 /*49*/].f_15, true);
}

int func_221(int iParam0) // Position - 0x902F Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_222(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x903B Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
BOOL func_223(Hash hParam0) // Position - 0x90B6 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_224(int iParam0) // Position - 0x90C2 Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

Hash func_225(int iParam0) // Position - 0x90D9 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_224(iParam0))
		return 0;
...
BOOL func_226(Hash hParam0) // Position - 0x90F7 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

int func_227(int iParam0, BOOL bParam1) // Position - 0x9103 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_224(iParam0))
		return 0;
	...
	if (func_254(iParam0, 32) && !bParam1)
	{
		func_255(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_225(iParam0)));
	
		if (func_242() == -1)
		{
			if (func_254(iParam0, 2048))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_150(iParam0));
				func_256(iParam0, 2048);
			}
	...
	if (!func_257(iParam0) && func_242() == -1)
		return 0;
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x91EE Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_242() != -1)
		return false;
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_258(iParam0)))
		return false;

	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_150(iParam0));
}

BOOL func_229(int iParam0) // Position - 0x9246 Hash - 0x365567CB ^0x68796F4
{
	if (!func_224(iParam0))
		return false;
	...
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_150(iParam0)))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_150(iParam0), false)))
			return false;
	}
...
void func_230(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x928C Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_259(iParam0) == 1 && bParam7)
		return;
...
float func_231() // Position - 0x9318 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_232(var uParam0, int iParam1) // Position - 0x934A Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_233(var uParam0, int iParam1) // Position - 0x935B Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_234(var uParam0) // Position - 0x9370 Hash - 0x39705408 ^0x39705408
{
	return func_167(*uParam0, 2);
}

BOOL func_235(Ped pedParam0, Hash hParam1) // Position - 0x9380 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_236(Ped pedParam0, Hash hParam1) // Position - 0x93AE Hash - 0x3B817AFB ^0xD015FE74
{
	Hash _int;
...
BOOL func_237(Ped pedParam0, Hash hParam1) // Position - 0x93FC Hash - 0x3B817AFB ^0xD015FE74
{
	Hash _int;
	int _int2;
...
void func_238(Ped pedParam0) // Position - 0x946A Hash - 0x228DA784 ^0x3A12C2D8
{
...
BOOL func_239() // Position - 0x9486 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_260())
		return false;
...
void func_240(Any* panParam0, int iParam1) // Position - 0x94DC Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_241(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9584 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_242() // Position - 0x964B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_243(int iParam0) // Position - 0x9659 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_244(int iParam0) // Position - 0x9701 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_245(Ped pedParam0, int iParam1) // Position - 0x9766 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_246(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x977D Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_247(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_247(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x97AB Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_248(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x97F5 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_249(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9836 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_250(Ped pedParam0) // Position - 0x98AF Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_251(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x9997 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_252() // Position - 0x99D9 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_242() != -1)
		return false;
...
BOOL func_253(int iParam0, BOOL bParam1) // Position - 0x99FE Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_254(int iParam0, BOOL bParam1) // Position - 0x9A2F Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_242() != -1)
		return false;
...
void func_255(int iParam0, PersChar pchParam1) // Position - 0x9A5D Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_224(iParam0))
		return;
...
void func_256(int iParam0, BOOL bParam1) // Position - 0x9A7E Hash - 0x452DF11A ^0x452DF11A
{
	if (func_242() != -1)
		return;
...
BOOL func_257(int iParam0) // Position - 0x9AB7 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_224(iParam0))
		return false;
...
Ped func_258(int iParam0) // Position - 0x9ADD Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
int func_259(int iParam0) // Position - 0x9B0B Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_260() // Position - 0x9B1E Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_261(int iParam0) // Position - 0x9B4F Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_101(iParam0))
		return -1;
...
int func_262(int iParam0) // Position - 0x9B6B Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_263(int iParam0) // Position - 0x9BAC Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
