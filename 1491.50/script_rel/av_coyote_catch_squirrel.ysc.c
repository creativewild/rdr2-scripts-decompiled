...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x49CF7891
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_37 = joaat("a_c_coyote_01");
	iLocal_38 = joaat("a_c_squirrel_01");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x1460CA61
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x4391C28E ^0x80C65785
{
	func_46(uParam0, "COYOTE_CATCH_SQUIRREL", "script@ambient@animal@COYOTE_CATCH_SQUIRREL@action", uParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "COYOTE", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "SQUIRREL", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	return;
}
...
BOOL func_28(var uParam0) // Position - 0x29B6 Hash - 0x6AA6E00C ^0x77988359
{
...
void func_29(var uParam0) // Position - 0x2A2B Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A5D Hash - 0x45274411 ^0x45274411
{
	func_57(&uLocal_9, false);
...
int func_31(var uParam0) // Position - 0x2A91 Hash - 0xCC20BFEB ^0xCC20BFEB
{
	char* animDict;
	char* animName;
	char* animName2;
	...
	animDict = "script_amb@animal@coyote_catch_squirrel";
	animName = "coyote_exit_a";
	animName2 = "squirrel_exit_a";
	vector = { 0f, 0f, 0f };
	vector2 = { 0f, 0f, 0f };
	...
	{
		if (!bLocal_39)
			if (func_63(uParam0, &uLocal_9, true) || func_64(Global_35, uParam0->f_20[0 /*14*/], true) <= 625f)
				bLocal_39 = true;
		...
		if (bLocal_39)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (!uParam0->f_469[6])
				{
					func_68(*uParam0, uParam0->f_483, true);
					uParam0->f_469[6] = 1;
				}
	...
	if (uParam0->f_469[0])
		if (func_70(&uLocal_40, 3f))
			return 1;

	if (!uParam0->f_469[0] && !bLocal_39)
	{
		if (!uParam0->f_469[1])
		{
					...
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								PED::_0x10F96086123B939F(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 5000f);
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
							}
						...
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("endsinrun")))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									...
									PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], joaat("MotionState_Sprint"), false, 0, false);
								
									if (!ENTITY::IS_ENTITY_DEAD(Global_35))
									{
										TASK::TASK_FLEE_COORD(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, 3, 256, -1082130432, -1, 0);
										func_56(&uParam0->f_20[0 /*14*/], false, true);
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2F11 Hash - 0xFBD382D6 ^0xDE753D8A
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	{
		if (!flag || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uParam0->f_20[1 /*14*/], false, false), 0.5f, true, true) || MISC::_0x7A76104CC2CC69E8(uParam0->f_20[0 /*14*/], 1, 1))
		{
			ENTITY::DETACH_ENTITY(uParam0->f_20[1 /*14*/], true, true);
		
			if (flag2)
				func_73(uParam0->f_20[1 /*14*/], false, false);
	...
	if (!bParam1)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
				if (uParam0->f_469[4] && !uParam0->f_469[5] && func_64(uParam0->f_20[i /*14*/], Global_35, true) < 22500f)
					return 0;
		}
	}

	func_74(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x302C Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x3049 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3185 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x32BE Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3368 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x33E0 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x346F Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x358A Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3596 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x371E Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x37BE Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x37D1 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x37EB Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3853 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x387F Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x38B0 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x393E Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3B42 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3B56 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3B65 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_75() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3B80 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3BDF Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3C21 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C4D Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x3C75 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3CF1 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3D17 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3D39 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3D5B Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_62(var uParam0, int iParam1) // Position - 0x3D7F Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_63(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3D8D Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_64(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3DE7 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_103(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_65(var uParam0) // Position - 0x3E3E Hash - 0x5001E582 ^0x5001E582
{
	return func_104(*uParam0, 1);
}

void func_66(var uParam0) // Position - 0x3E4E Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_105(uParam0, 0f);
	return;
}

void func_67(var uParam0) // Position - 0x3E5D Hash - 0x5F88D024 ^0x5F88D024
{
	if (!uParam0->f_469[7])
	{
		func_106(*uParam0, true);
		uParam0->f_469[7] = 1;
	}
...
void func_68(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3E82 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_69(var uParam0) // Position - 0x3F86 Hash - 0x5C40EAAE ^0x9E86D55
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], 2027708073))
		{
		...
		else
		{
			...
			func_56(&uParam0->f_20[1 /*14*/], false, true);
			PED::SET_PED_KEEP_TASK(uParam0->f_20[1 /*14*/], true);
		}
	}

	if (!func_109(uParam0->f_20[0 /*14*/], 518218985))
	{
...
BOOL func_70(var uParam0, float fParam1) // Position - 0x4076 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_65(uParam0))
		return false;
...
BOOL func_71(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x409D Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_64(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_65(&(uParam0->f_490)))
							func_66(&(uParam0->f_490));
...
BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x42A8 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_64(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_65(&(uParam0->f_490)))
							func_117(&(uParam0->f_490), false);
		...
		if (func_65(&(uParam0->f_490)) && !func_118(&(uParam0->f_490)))
...
void func_73(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x43D1 Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
void func_74(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x440D Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_75() // Position - 0x4561 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_76(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x456F Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x45D6 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x45FF Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_79(var uParam0, var uParam1, var uParam2) // Position - 0x464B Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_80(int iParam0) // Position - 0x469A Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_81(int iParam0) // Position - 0x46BF Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_82(int iParam0) // Position - 0x46D2 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_83(int iParam0) // Position - 0x46E5 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_84(int iParam0) // Position - 0x46F8 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_85(int iParam0) // Position - 0x470A Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_86(int iParam0, int iParam1) // Position - 0x471C Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x47B6 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_88() // Position - 0x47EE Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_89(int iParam0) // Position - 0x4841 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_92(iParam0))
		return -1;
...
BOOL func_90(int iParam0) // Position - 0x4861 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_91(int iParam0, int iParam1) // Position - 0x4877 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(int iParam0) // Position - 0x4886 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_93(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x48B9 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x499A Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_101(iParam0, 4);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x49B8 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_101(iParam0, 8);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x49D8 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_101(iParam0, 16);
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4A03 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_101(iParam0, 32);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4A23 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_101(iParam0, 64);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4A43 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4A65 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_101(int iParam0, int iParam1) // Position - 0x4A89 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4A9A Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x50C3 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x50E1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_105(var uParam0, float fParam1) // Position - 0x50F0 Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_166() - fParam1;
	func_167(uParam0, 1);
	func_168(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x5116 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_107(int iParam0) // Position - 0x51ED Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_169(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_169(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_169(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x526E Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_109(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x535F Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_110(var uParam0) // Position - 0x53B8 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_65(uParam0))
		return uParam0->f_1;
	...
	return func_166() - uParam0->f_1;
}

BOOL func_111(Ped pedParam0) // Position - 0x53ED Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_112(Ped pedParam0) // Position - 0x5408 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_113(float fParam0) // Position - 0x5424 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_114(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x546B Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_115(var uParam0, float fParam1) // Position - 0x5489 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x54A7 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_117(var uParam0, BOOL bParam1) // Position - 0x54BD Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_118(var uParam0) // Position - 0x54DD Hash - 0x39705408 ^0x39705408
{
	return func_104(*uParam0, 2);
}

void func_119(var uParam0) // Position - 0x54ED Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_65(uParam0);

	if (func_118(uParam0))
	{
		uParam0->f_1 = func_166() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_168(uParam0, 2);
	}
...
void func_120(var uParam0) // Position - 0x5521 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_65(uParam0);

	if (!func_118(uParam0))
	{
		uParam0->f_2 = func_166() - uParam0->f_1;
		func_167(uParam0, 2);
	}
...
BOOL func_121(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5551 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_122(BOOL bParam0, var uParam1, var uParam2) // Position - 0x55A6 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_123(int iParam0, int iParam1) // Position - 0x55BD Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_124(int iParam0, int iParam1) // Position - 0x5643 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_125(int iParam0, int iParam1) // Position - 0x567F Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_126(int iParam0, int iParam1) // Position - 0x56D2 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_127(int iParam0, int iParam1) // Position - 0x570D Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_128(int iParam0, int iParam1) // Position - 0x5746 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_129(int iParam0) // Position - 0x577E Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_130(BOOL bParam0) // Position - 0x57BC Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_131(ePedType eptParam0) // Position - 0x57CF Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_132(Ped pedParam0, Hash hParam1) // Position - 0x5C22 Hash - 0xD634A2E3 ^0xD9C4265F
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_133(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5CC9 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_134(Ped pedParam0, BOOL bParam1) // Position - 0x5CF9 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_135(Ped pedParam0, int iParam1) // Position - 0x5D3E Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_136(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5D65 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_174(iParam2);
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5F30 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_138(Ped pedParam0, int iParam1, int iParam2) // Position - 0x6007 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x6044 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_140(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x612B Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x6201 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_142(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x630A Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x643F Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6476 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x657D Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x65E8 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_147(Ped pedParam0, int iParam1) // Position - 0x6730 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_148(var uParam0, int iParam1) // Position - 0x6910 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x6988 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_150(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x69B7 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_151(int iParam0, Ped pedParam1) // Position - 0x6B3D Hash - 0x42A83B1F ^0x7E130235
{
	int _int;
...
BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x6B8D Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_201(iParam0))
		return true;
...
BOOL func_153(Ped pedParam0, Ped pedParam1) // Position - 0x6C2A Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_154() // Position - 0x6C77 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6C7F Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_156() // Position - 0x6D40 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_157() // Position - 0x6D5E Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_156() - Global_1935630.f_43 >= &func_25)
		return false;

	return true;
}

BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6DAB Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_159(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6EC7 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6F0F Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x7168 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_211(0))
		return false;
...
BOOL func_162(int iParam0, int iParam1) // Position - 0x71A1 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_163(var uParam0, int iParam1) // Position - 0x71D0 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x71E4 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_156() - iParam1->f_4 > func_212(iParam1))
		return func_213(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_165(int iParam0, Ped pedParam1) // Position - 0x7231 Hash - 0x38969C1D ^0xCAC46574
{
...
float func_166() // Position - 0x7284 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_167(var uParam0, int iParam1) // Position - 0x72B6 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_168(var uParam0, int iParam1) // Position - 0x72C7 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_169(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x72DC Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_214(iParam0) == 1 && bParam7)
		return;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x7368 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x7396 Hash - 0x453B9D58 ^0x9699DFA8
{
	Hash _int;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x73E6 Hash - 0x453B9D58 ^0x9699DFA8
{
	Hash _int;
	int _int2;
...
void func_173(Ped pedParam0) // Position - 0x7456 Hash - 0x9A19297A ^0x15BDF71C
{
...
void func_174(int iParam0) // Position - 0x7473 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_175(int iParam0) // Position - 0x75DF Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_176(BOOL bParam0) // Position - 0x75F2 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_177(int iParam0) // Position - 0x760C Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_178(int iParam0) // Position - 0x76A6 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_179(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x76CD Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_180(Ped pedParam0, Ped pedParam1) // Position - 0x77C6 Hash - 0xF9959663 ^0xF9959663
{
	return func_202(pedParam0, pedParam1, true, true);
}

float func_181(int iParam0) // Position - 0x77D8 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_182(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77E4 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x7849 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_184() // Position - 0x786F Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_185(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7883 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_221(ped, 0)))
			if (func_222(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_186(int iParam0) // Position - 0x79E3 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x79EF Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_188(int iParam0) // Position - 0x7A50 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_189(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7A5C Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_221(ped, 0)))
			if (func_223(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_190(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7B1E Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_191(int iParam0) // Position - 0x7BBC Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_192(int iParam0) // Position - 0x7BC8 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_193(int iParam0) // Position - 0x7BD4 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7D11 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_224(pedParam0, vParam4, 0.5f))
...
BOOL func_195(Ped pedParam0) // Position - 0x7D54 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_225(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7DBA Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7E01 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7E4C Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_199(Ped pedParam0, var uParam1) // Position - 0x7EC5 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_200(Ped pedParam0, Ped pedParam1) // Position - 0x7F12 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_227(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_201(int iParam0) // Position - 0x7F5A Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_202(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7F6A Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_203(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7FB2 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7FDE Hash - 0x2AA3CC7D ^0xACF63696
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_205(int iParam0) // Position - 0x8007 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_206(Ped pedParam0) // Position - 0x8013 Hash - 0xEB445B10 ^0x65925016
{
...
int func_207(Ped pedParam0) // Position - 0x806B Hash - 0x6E063231 ^0xE5FA7150
{
...
BOOL func_208(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x80DB Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x824B Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_210(int iParam0, Ped pedParam1) // Position - 0x8339 Hash - 0x27FC2906 ^0x4FABDE4B
{
...
BOOL func_211(int iParam0) // Position - 0x83AF Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_228())
		return false;

	return func_229(Global_1347702[58 /*49*/].f_15, true);
}

int func_212(int iParam0) // Position - 0x83D1 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x83DD Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_214(int iParam0) // Position - 0x8458 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_215() // Position - 0x846B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_216() // Position - 0x8479 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x84CF Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8579 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_219(int iParam0) // Position - 0x8640 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x86E8 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_221(Ped pedParam0, int iParam1) // Position - 0x874D Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8764 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_223(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_223(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8792 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_224(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x87DC Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x881D Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_226(Ped pedParam0) // Position - 0x8896 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_227(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x897E Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_228() // Position - 0x89C0 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_215() != -1)
		return false;
...
BOOL func_229(int iParam0, BOOL bParam1) // Position - 0x89E5 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_230() // Position - 0x8A16 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x8A47 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_92(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x8A63 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_233(int iParam0) // Position - 0x8AA4 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
