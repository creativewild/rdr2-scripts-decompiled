...
void main() // Position - 0x0 Hash - 0xEE84C2AC ^0x98AB34B3
{
	var unk;
	BOOL flag;
	...
	iLocal_10 = joaat("a_c_bear_01");
	sLocal_39 = "CREATURES_MAMMAL@DEER@NORMAL@DEAD";
	sLocal_40 = "dead_right";
	iLocal_45 = MISC::GET_RANDOM_INT_IN_RANGE(60, 71);
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_1(var uParam0) // Position - 0x59A Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x5A8 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x63E Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9E5 Hash - 0x4DA9BC8C ^0x23CDA2D8
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9FF Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA16 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAD4 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAFE Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC4F Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC64 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD08 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AB9 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B1F Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD9 Hash - 0xC88998A8 ^0x7A0B5E5
{
	func_46(uParam0, "BEAR_VS_WOLVES", "script@ambient@animal@bear_vs_wolves@action", uParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "WOLF1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "WOLF2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 2, "WOLF3", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 3, "BEAR", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 4, "carcass", joaat("a_c_deer_01"), uParam1, uParam4.f_2, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C91 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D31 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E4B Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2014 Hash - 0xE4DD5F40 ^0xC5E800F0
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_39))
		return 0;

	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(joaat("world_animal_bear_eat_carcass"), false))
		return 0;

	return func_49(uParam0, uParam0->f_20[4 /*14*/].f_5);
}

BOOL func_19(var uParam0) // Position - 0x204D Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21FD Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2271 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22C0 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2318 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2481 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27A8 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28DF Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A0F Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A4E Hash - 0x2B0E7CA4 ^0xA9CB2D8C
{
	int i;

	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[0 /*14*/]);
	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[1 /*14*/]);
	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[2 /*14*/]);

	if (!PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[0 /*14*/]) || !PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[1 /*14*/]) || !PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[2 /*14*/]))
		return false;

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[4 /*14*/]))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[4 /*14*/], 186, true);
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[4 /*14*/], 243, true);
		PED::_SET_PED_QUALITY(uParam0->f_20[4 /*14*/], 0);
		TASK::TASK_PLAY_ANIM(uParam0->f_20[4 /*14*/], sLocal_39, sLocal_40, 1000f, -1000f, -1, 131072, 0, false, 0, false, 0, false);
		MISC::SET_PED_DECOMPOSED(uParam0->f_20[4 /*14*/], true);
		PERSISTENCE::_0x3CA5E58C9731A16B(uParam0->f_20[4 /*14*/], iLocal_45);
		PED::SET_PED_KEEP_TASK(uParam0->f_20[4 /*14*/], true);
		ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[4 /*14*/], uParam0->f_20[3 /*14*/], true);
		ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[3 /*14*/], uParam0->f_20[4 /*14*/], true);
	}
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
		{
			PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), uParam0->f_20[i /*14*/], 26, 0, true);
			func_57(&uParam0->f_20[i /*14*/], true, true);
		}
	}
...
void func_29(var uParam0) // Position - 0x2BB7 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2BE9 Hash - 0x558CDC8 ^0x7A1730F8
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_39);
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("world_animal_bear_eat_carcass"), 1, joaat("a_c_bear_01"), 0);
	func_58(&uLocal_11, false);
	func_59(&uLocal_11, true);
	func_60(&uLocal_11, true);
	func_61(&uLocal_11, true);
	func_62(&uLocal_11, true);
	func_63(&uLocal_11, true);
	func_64(&uLocal_11, true);
	func_65(&uLocal_11, 55);
	return 1;
}

int func_31(var uParam0) // Position - 0x2C42 Hash - 0x7B66AEE3 ^0x7B66AEE3
{
	int i;
	...
	{
		if (!bLocal_41 == true)
			if (func_67(uParam0, &uLocal_11, true) || func_68(Global_35, uParam0->f_483, true) <= 625f)
				bLocal_41 = true;
	
		if (bLocal_41)
		{
			if (!func_69(&uLocal_42))
				func_70(&uLocal_42);
			...
			func_72(uParam0);
			func_57(&uParam0->f_20[3 /*14*/], false, true);
			func_73(uParam0);
			uParam0->f_469[0] = 1;
		}
	}
	...
	if (!uParam0->f_469[0] && !bLocal_41)
	{
		if (!uParam0->f_469[1])
		{
			if (!ENTITY::IS_ENTITY_DEAD(Global_35) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (func_76(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[8])
			{
				if (func_77(uParam0, 1.5f, 80f, 4, joaat("Action"), true))
				{
					func_71(*uParam0, uParam0->f_483, false);
					uParam0->f_469[8] = 1;
				}
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							for (i = 0; i <= 2; i = i + 1)
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[i /*14*/], 1935919182))
									TASK::_0x2E1D6D87346BB7D2(uParam0->f_20[i /*14*/], uParam0->f_20[3 /*14*/], 0, 0);
							}
							...
							if (!uParam0->f_469[3])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("endsinwalk")))
									{
										...
										TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[3 /*14*/], 2, 256, -1082130432, -1, 0);
										TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_20[0 /*14*/], 1f);
										func_57(&uParam0->f_20[0 /*14*/], false, true);
								...
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], joaat("endsinrun")))
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
											TASK::TASK_FLEE_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[3 /*14*/], 3, 256, -1082130432, -1, 0);
									
										TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_20[1 /*14*/], 2f);
										func_57(&uParam0->f_20[1 /*14*/], false, true);
							...
							if (!uParam0->f_469[5])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[2 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[2 /*14*/], joaat("endsinrun")))
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
											TASK::TASK_FLEE_PED(uParam0->f_20[2 /*14*/], uParam0->f_20[3 /*14*/], 3, 256, -1082130432, -1, 0);
									
										TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_20[2 /*14*/], 2f);
										func_57(&uParam0->f_20[2 /*14*/], false, true);
							...
							if (!uParam0->f_469[6])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[3 /*14*/].f_1))
								{
									TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[3 /*14*/], joaat("world_animal_bear_eat_carcass"), 30000, false, 0, 0.25f, false);
									PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam0->f_20[3 /*14*/], false, false);
							...
							if (uParam0->f_469[3] && uParam0->f_469[4] && uParam0->f_469[5] && uParam0->f_469[6])
							{
								uParam0->f_469[7] = 1;
								return 1;
							}
...
int func_32(var uParam0, var uParam1) // Position - 0x315D Hash - 0xB51079E8 ^0xE600429
{
	int i;

	func_78(uParam0, true, false, false);

	for (i = 0; i < uParam0->f_19; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[i /*14*/]))
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
				PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), uParam0->f_20[i /*14*/], 26, 0, false);
	}

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x31B7 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x31D4 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3310 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3449 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x34F3 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x356B Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x35FA Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3715 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3721 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x38A9 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3949 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x395C Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3976 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x39DE Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3A0A Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3A3B Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_49(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x3AC9 Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
	...
	{
		if (func_68(entity, vParam1, true) <= 1f)
		{
			func_92(*uParam0, uParam0->f_483);
			uParam0->f_499 = 1;
			return 0;
		}
	}
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B20 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_94(Global_1898164.f_1[0 /*5*/]);
	
		if (func_95(num) && func_96(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_51(int iParam0) // Position - 0x3D24 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3D38 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3D47 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_79() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3D62 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3DC1 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_98(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_56(Ped pedParam0) // Position - 0x3E03 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3E2F Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3E57 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3ED3 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3EF9 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3F1B Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3F3D Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3F5F Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_105(iParam0, 4);
	else
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3F7D Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_65(var uParam0, int iParam1) // Position - 0x3FA1 Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

void func_66(var uParam0) // Position - 0x3FAF Hash - 0xE7639F12 ^0xDC74A371
{
	int i;
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			TASK::_0x2E1D6D87346BB7D2(uParam0->f_20[i /*14*/], Global_35, 0, 1);
	}

	return;
}

BOOL func_67(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3FEA Hash - 0xEADB0096 ^0xB7D0B28
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_106(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
float func_68(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4045 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_107(entityCoords, vParam1);
}

BOOL func_69(var uParam0) // Position - 0x4095 Hash - 0x5001E582 ^0x5001E582
{
	return func_108(*uParam0, 1);
}

void func_70(var uParam0) // Position - 0x40A5 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_109(uParam0, 0f);
	return;
}

void func_71(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x40B4 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_72(var uParam0) // Position - 0x41B8 Hash - 0x3C854650 ^0x3C854650
{
	if (!uParam0->f_469[9])
	{
		func_111(*uParam0, false);
		uParam0->f_469[9] = 1;
	}
...
void func_73(var uParam0) // Position - 0x41DF Hash - 0xE31609DB ^0x701C8366
{
	int i;
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
		{
			if (!func_112(uParam0->f_20[i /*14*/], 518218985))
			{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
	{
		if (!func_112(uParam0->f_20[3 /*14*/], SCRIPT_TASK_COMBAT))
		{
			TASK::TASK_COMBAT_PED(uParam0->f_20[3 /*14*/], Global_35, 0, 0);
			PED::SET_PED_KEEP_TASK(uParam0->f_20[3 /*14*/], true);
		}
	}
...
BOOL func_74(var uParam0, float fParam1) // Position - 0x4284 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_69(uParam0))
		return false;

	if (func_113(uParam0) > fParam1)
		return true;

	return false;
}

void func_75(var uParam0) // Position - 0x42AB Hash - 0xB50DFA90 ^0x828EAFAD
{
	int i;
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			func_57(&uParam0->f_20[i /*14*/], false, true);
	}

	return;
}

BOOL func_76(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x42E3 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_116(fParam2);
		num2 = func_117(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_118(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_69(&(uParam0->f_490)))
							func_70(&(uParam0->f_490));
...
BOOL func_77(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x44EE Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_118(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_69(&(uParam0->f_490)))
							func_121(&(uParam0->f_490), false);
					
						if (func_122(&(uParam0->f_490)))
							func_123(&(uParam0->f_490));
		...
		if (func_69(&(uParam0->f_490)) && !func_122(&(uParam0->f_490)))
...
void func_78(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4617 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_79() // Position - 0x476B Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_80(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4779 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x47E0 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_82(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4809 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_125(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_83(var uParam0, var uParam1, var uParam2) // Position - 0x4855 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_125(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_84(int iParam0) // Position - 0x48A4 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_85(int iParam0) // Position - 0x48C9 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_86(int iParam0) // Position - 0x48DC Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_87(int iParam0) // Position - 0x48EF Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_88(int iParam0) // Position - 0x4902 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_89(int iParam0) // Position - 0x4914 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_90(int iParam0, int iParam1) // Position - 0x4926 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x49C0 Hash - 0xA65AB937 ^0xA65AB937
{
	func_127(iParam0, iParam6);
	func_128(iParam0, iParam5);
	func_129(iParam0, iParam4);
	func_130(iParam0, iParam3);
	func_131(iParam0, iParam2);
	func_132(iParam0, iParam1);
	return;
}

void func_92(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x49F8 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_125(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_93() // Position - 0x4AE9 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_94(int iParam0) // Position - 0x4B3C Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_97(iParam0))
		return -1;

	return func_134(func_133(iParam0));
}

BOOL func_95(int iParam0) // Position - 0x4B5C Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_96(int iParam0, int iParam1) // Position - 0x4B72 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_97(int iParam0) // Position - 0x4B81 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_98(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4BB4 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_135(eptParam1))
		{
			func_136(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_138(pedParam0, false);
			flag = true;
		}
	
		func_139(pedParam0, iParam2);
	}
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4C95 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_105(iParam0, 8);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4CB5 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_105(iParam0, 16);
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4CE0 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_105(iParam0, 32);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4D00 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_105(iParam0, 64);
	else
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4D20 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x4D42 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_105(int iParam0, int iParam1) // Position - 0x4D66 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_106(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4D77 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_107(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x53A0 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x53BE Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_109(var uParam0, float fParam1) // Position - 0x53CD Hash - 0x30433BAB ^0xF854D531
{
...
void func_110(int iParam0) // Position - 0x53F3 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_173(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_173(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_173(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_111(int iParam0, BOOL bParam1) // Position - 0x5474 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_112(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x554B Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_113(var uParam0) // Position - 0x55A4 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_69(uParam0))
		return uParam0->f_1;
...
BOOL func_114(Ped pedParam0) // Position - 0x55D9 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_115(Ped pedParam0) // Position - 0x55F4 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_116(float fParam0) // Position - 0x5610 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_117(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5657 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_118(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x5675 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_107(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_119(var uParam0, float fParam1) // Position - 0x56CC Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_120(var uParam0) // Position - 0x56EA Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_121(var uParam0, BOOL bParam1) // Position - 0x5700 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_122(var uParam0) // Position - 0x5720 Hash - 0x39705408 ^0x39705408
{
	return func_108(*uParam0, 2);
}

void func_123(var uParam0) // Position - 0x5730 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_69(uParam0);
...
void func_124(var uParam0) // Position - 0x5764 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_69(uParam0);
...
BOOL func_125(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5794 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_126(BOOL bParam0, var uParam1, var uParam2) // Position - 0x57E9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_127(int iParam0, int iParam1) // Position - 0x5800 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_128(int iParam0, int iParam1) // Position - 0x5886 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_129(int iParam0, int iParam1) // Position - 0x58C2 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_130(int iParam0, int iParam1) // Position - 0x5915 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_131(int iParam0, int iParam1) // Position - 0x5950 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_132(int iParam0, int iParam1) // Position - 0x5989 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_133(int iParam0) // Position - 0x59C1 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_134(BOOL bParam0) // Position - 0x59FF Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_135(ePedType eptParam0) // Position - 0x5A12 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_136(Ped pedParam0, Hash hParam1) // Position - 0x5E65 Hash - 0xE621C41 ^0xBDCBCABA
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_137(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5F0C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_138(Ped pedParam0, BOOL bParam1) // Position - 0x5F3C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_139(Ped pedParam0, int iParam1) // Position - 0x5F81 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_140(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5FA8 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_178(iParam2);
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x6173 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_142(Ped pedParam0, int iParam1, int iParam2) // Position - 0x624A Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x6287 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_144(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x636E Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x6444 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_146(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x654D Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x6682 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x66B9 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_149(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x67C0 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_150(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x682B Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_151(Ped pedParam0, int iParam1) // Position - 0x6973 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_152(var uParam0, int iParam1) // Position - 0x6B4F Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x6BC7 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_154(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6BF6 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_155(int iParam0, Ped pedParam1) // Position - 0x6D7C Hash - 0x42A83B1F ^0xC54AC0BF
{
	int _int;
...
BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6DCC Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_205(iParam0))
		return true;
...
BOOL func_157(Ped pedParam0, Ped pedParam1) // Position - 0x6E69 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_158() // Position - 0x6EB6 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6EBE Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_160() // Position - 0x6F7F Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_161() // Position - 0x6F9D Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_162(int iParam0, Ped pedParam1) // Position - 0x6FEA Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_163(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x7106 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x714E Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x73A7 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_215(0))
		return false;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x73E0 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_167(var uParam0, int iParam1) // Position - 0x740F Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_168(Ped pedParam0, int iParam1) // Position - 0x7423 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_160() - iParam1->f_4 > func_216(iParam1))
		return func_217(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_169(int iParam0, Ped pedParam1) // Position - 0x7470 Hash - 0xC757990E ^0x8C7CB24B
{
...
float func_170() // Position - 0x74C3 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_171(var uParam0, int iParam1) // Position - 0x74F5 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_172(var uParam0, int iParam1) // Position - 0x7506 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_173(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x751B Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_218(iParam0) == 1 && bParam7)
		return;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x75A7 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x75D5 Hash - 0xEC0A6625 ^0x6047B923
{
	Hash _int;
...
BOOL func_176(Ped pedParam0, Hash hParam1) // Position - 0x7625 Hash - 0xEC0A6625 ^0x6047B923
{
	Hash _int;
	int _int2;
...
void func_177(Ped pedParam0) // Position - 0x7695 Hash - 0x1618AC33 ^0xFE1CC3D1
{
...
void func_178(int iParam0) // Position - 0x76B2 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_221(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_179(int iParam0) // Position - 0x781E Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_180(BOOL bParam0) // Position - 0x7831 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_222(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_181(int iParam0) // Position - 0x784B Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_182(int iParam0) // Position - 0x78E5 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_183(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x790C Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_184(Ped pedParam0, Ped pedParam1) // Position - 0x7A05 Hash - 0xF9959663 ^0xF9959663
{
	return func_206(pedParam0, pedParam1, true, true);
}

float func_185(int iParam0) // Position - 0x7A17 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_186(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A23 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_187(int iParam0, BOOL bParam1) // Position - 0x7A88 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_188() // Position - 0x7AAE Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_189(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7AC2 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_225(ped, 0)))
			if (func_226(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_190(int iParam0) // Position - 0x7C22 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_191(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7C2E Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_192(int iParam0) // Position - 0x7C8F Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_193(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7C9B Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_225(ped, 0)))
			if (func_227(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_194(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7D5D Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_195(int iParam0) // Position - 0x7DFB Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_196(int iParam0) // Position - 0x7E07 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_197(int iParam0) // Position - 0x7E13 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7F50 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_228(pedParam0, vParam4, 0.5f))
...
BOOL func_199(Ped pedParam0) // Position - 0x7F93 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_229(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7FF9 Hash - 0x6CF85689 ^0xA973475A
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8042 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_202(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x808D Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_203(Ped pedParam0, var uParam1) // Position - 0x8106 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_204(Ped pedParam0, Ped pedParam1) // Position - 0x8153 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_231(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_205(int iParam0) // Position - 0x819B Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_206(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x81AB Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_207(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x81F3 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_208(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x821F Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_209(int iParam0) // Position - 0x8247 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_210(Ped pedParam0) // Position - 0x8253 Hash - 0xC0DBB17F ^0x6CDB9D93
{
...
int func_211(Ped pedParam0) // Position - 0x82A7 Hash - 0x2ABD5A3 ^0x1ACB46EE
{
...
BOOL func_212(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8313 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8483 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_222(true, &ped, &ped2);
...
BOOL func_214(int iParam0, Ped pedParam1) // Position - 0x8571 Hash - 0x27FC2906 ^0x7AEF2242
{
...
BOOL func_215(int iParam0) // Position - 0x85E7 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_232())
		return false;

	return func_233(Global_1347702[58 /*49*/].f_15, true);
}

int func_216(int iParam0) // Position - 0x8609 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_217(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8615 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_218(int iParam0) // Position - 0x8690 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_219() // Position - 0x86A3 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_220() // Position - 0x86B1 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_234())
		return false;
...
void func_221(Any* panParam0, int iParam1) // Position - 0x8707 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_222(BOOL bParam0, var uParam1, var uParam2) // Position - 0x87AF Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_223(int iParam0) // Position - 0x8876 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_224(int iParam0) // Position - 0x891E Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_225(Ped pedParam0, int iParam1) // Position - 0x8983 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_226(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x899A Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_227(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_227(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x89C8 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_228(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8A12 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_229(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8A53 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_230(Ped pedParam0) // Position - 0x8ACC Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_231(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8BB4 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_232() // Position - 0x8BF6 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_219() != -1)
		return false;
...
BOOL func_233(int iParam0, BOOL bParam1) // Position - 0x8C1B Hash - 0xAA5BFD67 ^0xAA5BFD67
{
	switch (func_235(iParam0))
	{
		case 5:
			return 1;
...
BOOL func_234() // Position - 0x8C4C Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_235(int iParam0) // Position - 0x8C7D Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_97(iParam0))
		return -1;
...
int func_236(int iParam0) // Position - 0x8C99 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_237(int iParam0) // Position - 0x8CDA Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
