...
void main() // Position - 0x0 Hash - 0x660C08F ^0xD41284A0
{
	...
	fLocal_8 = 1f;
	iLocal_61 = 20000;
	iLocal_64 = iScriptParam_0;
	iLocal_62 = iScriptParam_0.f_2;
	func_1();
	func_2();
	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_63)
		{
			...
			switch (iLocal_62)
			{
				...
				case 7:
					if (iLocal_65 < MISC::GET_GAME_TIMER() || func_20() != false || Global_1051260.f_3790)
					{
						_DEBUG_PRINT_0_0(iLocal_64);
						func_22();
...
BOOL func_11() // Position - 0x7BC Hash - 0x18988E9C ^0xF9F943
{
	volLocal_14 = Global_1888801[65 /*35*/].f_4;

	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_46())
		{
			volLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Cornwall Factory - m_volThreat Agg");
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 483.178f, 665.0614f, 120.43297f, 0f, 0f, -93.35709f, 8.68444f, 49.20877f, 14.623455f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 482.09155f, 681.50946f, 120.567215f, 0f, 0f, -94.03097f, 27.479866f, 53.573696f, 19.23399f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 457.98853f, 669.17664f, 117.48532f, 0f, 0f, -94.12511f, 8.672241f, 4.046204f, 6.331274f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 510.65903f, 674.02026f, 119.39037f, 0f, 0f, -95.193054f, 28.262396f, 14.371403f, 11.821211f);
			volLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Cornwall Factory - m_volGuardRestricted Agg");
			VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_17, volLocal_18);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 487.05838f, 658.134f, 120.43297f, 0f, 0f, -93.35709f, 4.866049f, 58.953804f, 14.623455f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 512.4396f, 693.6117f, 119.39037f, 0f, 0f, -95.193054f, 11.775095f, 14.371403f, 11.821211f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 503.4485f, 696.99896f, 115.9772f, 0f, 0f, 159.30441f, 15.948196f, 28.709929f, 3.623619f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 516.3637f, 679.51544f, 117.30182f, 0f, 0f, -92.51744f, 37.735287f, 11.094971f, 5.907578f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 511.5199f, 700.011f, 116.27089f, 0f, 0f, 113.6843f, 8.967957f, 14.123047f, 2.935638f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 480.13504f, 701.7899f, 117.89701f, 0f, 0f, -4.999341f, 41.32953f, 28.425232f, 10.075285f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 453.42404f, 691.80835f, 117.513214f, 0f, 0f, -94.064705f, 40.29486f, 13.868652f, 13.542791f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 458.9319f, 701.61975f, 116.60651f, 0f, 0f, -155.92549f, 13.568848f, 23.869598f, 3.378769f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 554.05695f, 575.44f, 113.71673f, 0f, 0f, 136.47997f, 13.649523f, 28.594656f, 13.594255f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 540.82794f, 571.68097f, 113.71673f, 0f, 0f, 30.172714f, 14.612732f, 28.594656f, 13.594255f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 491.22778f, 613.2062f, 112.20748f, 0f, 0f, -4.999341f, 27.968128f, 34.230473f, 9.418887f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 552.5515f, 589.0593f, 119.349236f, 0f, 0f, 49.88169f, 13.649523f, 28.594656f, 25.660076f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 593.56024f, 645.5485f, 119.349236f, 0f, 0f, -58.693172f, 18.08833f, 22.270567f, 29.434355f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 462.6024f, 617.6337f, 112.20748f, 0f, 0f, -6.355762f, 13.444691f, 12.239287f, 9.418887f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 593.6999f, 568.38336f, 119.349236f, 0f, 0f, -51.107002f, 9.175362f, 25.9578f, 19.576004f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 480.8508f, 580.7621f, 111.224304f, 0f, 0f, 176.47012f, 6.750173f, 9.77781f, 9.26247f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 463.89264f, 603.6877f, 110.885895f, 0f, 0f, -1.895059f, 2.506407f, 1.922996f, 3.633349f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 498.46957f, 575.9198f, 110.505806f, 0f, 0f, -4.668038f, 8.271279f, 8.106345f, 10.344636f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 508.87463f, 561.9025f, 110.505806f, 0f, 0f, -2.831406f, 5.281865f, 5.289512f, 10.344636f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 518.02045f, 567.31616f, 111.224304f, 0f, 0f, -179.0915f, 4.385738f, 3.794377f, 9.26247f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 517.9248f, 560.3237f, 111.224304f, 0f, 0f, 175.60127f, 5.138474f, 4.176085f, 9.26247f);
			volLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Cornwall Factory - m_volGuardWarning Agg");
			VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_19, volLocal_17);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 452.28348f, 693.4625f, 116.60651f, 0f, 0f, 159.83592f, 35.04748f, 60.009586f, 10.541837f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 452.5653f, 703.8395f, 117.48532f, 0f, 0f, -94.12511f, 44.30179f, 39.03862f, 12.838612f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 523.2607f, 682.0091f, 116.60651f, 0f, 0f, 176.25269f, 24.050518f, 60.57968f, 14.662614f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 530.38464f, 678.65356f, 116.60651f, 0f, 0f, 122.806465f, 27.481153f, 23.157776f, 14.662614f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 490.20734f, 645.64996f, 120.43297f, 0f, 0f, -93.35709f, 19.974922f, 82.01701f, 22.909313f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 543.405f, 598.4362f, 113.50104f, 0f, 0f, 176.25269f, 158.18797f, 75.22622f, 13.087737f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 511.57114f, 544.44763f, 113.7875f, 0f, 0f, 176.25269f, 70.74225f, 51.73241f, 12.49486f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 581.2699f, 545.92535f, 114.072975f, 0f, 0f, 176.25269f, 70.74225f, 40.813396f, 11.935585f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 467.4143f, 614.5461f, 113.28671f, 0f, 0f, 176.25269f, 25.771759f, 46.62182f, 13.569695f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 592.3509f, 634.554f, 114.072975f, 0f, 0f, -145.30815f, 48.81504f, 43.126972f, 11.935585f);
			volLocal_16 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(533.19476f, 634.73315f, 111.72138f, 0f, 0f, 0f, 125.811195f, 137.92268f, 20.390244f, "Cornwall Factory - m_volGuardRegistration");
			sLocal_15 = "CORNWALL_KEROSENE";
			LAW::_CREATE_GUARD_ZONE(sLocal_15);
			LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_15, volLocal_16);
			LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_15, volLocal_17);
			LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_15, volLocal_18);
			LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_15, volLocal_19);
			LAW::_SET_GUARD_ZONE_POSITION(sLocal_15, 479.7f, 675f, 118f);
			LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_15, volLocal_16);
			iLocal_60 = 1;
		}
	
		if (func_47(45))
		{
			POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(volLocal_14, 10208, 0, 0, -1, -1, 0);
			POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(volLocal_14, 10208, 0, 0, -1, -1, 0);
		}
		else
		{
...
void _DEBUG_PRINT(int iParam0) // Position - 0xE94 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_13(int iParam0) // Position - 0xEA0 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void func_14(int iParam0) // Position - 0xEAD Hash - 0x9618F3C5 ^0x356E8B20
{
	iParam0 = iParam0;

	if (func_20() == -1 && !func_48(664571177))
	{
		func_49(&uLocal_20, &func_3, 5, "", joaat("cart05"), 442.7123f, 667.0687f, 114.9347f, 8.68f, 0, 0);
...
BOOL func_15(int iParam0) // Position - 0xF21 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xF2E Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0, BOOL bParam1) // Position - 0xF3A Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1897952[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_18(int iParam0) // Position - 0xF4F Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_50(iParam0, -1, -1, false);
}

void func_19(int iParam0, BOOL bParam1) // Position - 0xF60 Hash - 0x1F53BD85 ^0xA70B55E5
{
...
BOOL func_20() // Position - 0xFA3 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xFB1 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_22() // Position - 0xFBD Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_23(int iParam0, BOOL bParam1) // Position - 0xFC5 Hash - 0x26407603 ^0x721F15B0
{
	if (func_51(iParam0))
		return true;
...
void func_24() // Position - 0x10DF Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_25() // Position - 0x10E7 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0x10EF Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27(int iParam0) // Position - 0x10F7 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x10FF Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_29() // Position - 0x110B Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_30() // Position - 0x1113 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_31(int iParam0) // Position - 0x111B Hash - 0xF7C4AEFF ^0xF7C4AEFF
{
	func_54(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_32() // Position - 0x1133 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_33(var uParam0) // Position - 0x1164 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_34(int iParam0, var uParam1) // Position - 0x11AA Hash - 0x41BC629D ^0x41BC629D
{
	iParam0 = iParam0;
...
void func_35(int iParam0) // Position - 0x11BF Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_56(iParam0))
		return;
...
BOOL func_36(BOOL bParam0) // Position - 0x11D8 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1894899 && bParam0 != false;
}

void func_37(BOOL bParam0) // Position - 0x11E9 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1894899 = Global_1894899 - Global_1894899 && bParam0;
	return;
}

BOOL func_38(int iParam0) // Position - 0x1201 Hash - 0xAC8526B ^0x8BEBE95D
{
	if (func_20() == -1 && !func_48(664571177))
	{
		func_58(&uLocal_20);
...
void func_39(var uParam0, int iParam1) // Position - 0x122E Hash - 0x8A7E7334 ^0x9F0B10C1
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_40(int iParam0) // Position - 0x13BB Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_41() // Position - 0x13C8 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_42(int iParam0) // Position - 0x13FE Hash - 0xA6DB229E ^0x72633A56
{
	if (iParam0 == 0)
	{
		func_76();
		LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), 0);
		func_19(iLocal_64, 2048);
...
BOOL func_43(int iParam0) // Position - 0x148F Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_56(iParam0))
		return false;
...
BOOL func_44(int iParam0) // Position - 0x14AD Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1894899.f_7 && iParam0 != false;
}

void func_45(int iParam0) // Position - 0x14C0 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1894899.f_7 = Global_1894899.f_7 - Global_1894899.f_7 && iParam0;
	return;
}

BOOL func_46() // Position - 0x14DE Hash - 0x802DEA4 ^0xA1D51257
{
	if (func_47(45))
		return false;
	...
	if (func_59(Global_1935630, 2048) && Global_1347343.f_2 == Global_1835011[58 /*74*/].f_1)
		return false;

	return true;
}

BOOL func_47(int iParam0) // Position - 0x1529 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_48(int iParam0) // Position - 0x1545 Hash - 0xBF89485 ^0x62E162D4
{
	int num;
	int num2;
	int offset;

	num = func_87(iParam0, 1);
	num2 = num / 31;
	offset = num % 31;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, int iParam10) // Position - 0x1594 Hash - 0x6A889D02 ^0x36FF6B48
{
	uParam0->f_1 = iParam1;
	uParam0->f_2 = iParam2;
	uParam0->f_3 = { func_88(sParam3) };
...
BOOL func_50(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x15D7 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_51(int iParam0) // Position - 0x16CF Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1935630 && iParam0 != false;
}

BOOL func_52(int iParam0) // Position - 0x16E0 Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1898438;
}

int func_53(int iParam0) // Position - 0x16F4 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

void func_54(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1708 Hash - 0x1E885EDE ^0x3AA465F4
{
...
void func_55(var uParam0, Volume volParam1, int iParam2) // Position - 0x1730 Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_56(int iParam0) // Position - 0x1789 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_57() // Position - 0x179F Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_58(var uParam0) // Position - 0x17CC Hash - 0xE17148D1 ^0xCE70BB3C
{
...
BOOL func_59(int iParam0, int iParam1) // Position - 0x1A32 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_60(var uParam0, int iParam1) // Position - 0x1A41 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_61() // Position - 0x1A52 Hash - 0x463DA432 ^0x3948CA04
{
	return func_59(Global_1935630, 4096);
}

BOOL func_62(var uParam0, int iParam1) // Position - 0x1A65 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_63(int iParam0) // Position - 0x1A76 Hash - 0x97598EC0 ^0xADF7FB13
{
	if (!func_56(iParam0))
		return false;
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x1AB6 Hash - 0xA98B69C6 ^0xAD9FDA10
{
...
int func_65() // Position - 0x1AE3 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

void func_66(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1AF1 Hash - 0xBF70A74C ^0x9D3E9794
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	Global_1934266.f_148 = func_122(str, str2, 4000, 0, 0, 0, false, true);
	return;
}

void func_67(var uParam0, int iParam1) // Position - 0x1D5E Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_68(int iParam0, BOOL bParam1) // Position - 0x1D71 Hash - 0x1E78A51E ^0x8BB44A98
{
...
BOOL func_69() // Position - 0x23E6 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_128() != -1;
}

void func_70() // Position - 0x2401 Hash - 0x18ACD9D3 ^0xB2ADEAB8
{
...
void func_71(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2474 Hash - 0xEF5C52D ^0xEF5C52D
{
	int i;
	int num;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		if (func_129(num) && !func_132(num, iParam2) && !bParam3 || !func_133(num) && !bParam4 || !func_134(num))
			if (num != iParam0)
				func_135(i);
	}
...
void func_72(BOOL bParam0) // Position - 0x2502 Hash - 0xC844E228 ^0x91C15397
{
	BOOL flag;
...
int func_73() // Position - 0x2549 Hash - 0xC5B83CF5 ^0xD520990E
{
	return Global_40.f_4283.f_1;
}

void func_74(BOOL bParam0) // Position - 0x2559 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
BOOL func_75(int iParam0) // Position - 0x2582 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_76() // Position - 0x25C7 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_77(int iParam0, BOOL bParam1) // Position - 0x25CF Hash - 0x2B17ED40 ^0x23FC9AA5
{
	if (Global_1572887.f_12 == -1)
	{
...
void func_78(int iParam0) // Position - 0x2628 Hash - 0xC141B9C5 ^0x98D73D2B
{
	...
	if (iLocal_60 == 1)
	{
		...
		func_136(volLocal_19);
		func_136(volLocal_16);
		func_136(volLocal_18);
	}

	if (VOLUME::DOES_VOLUME_EXIST(volLocal_17))
	{
		VOLUME::_0x998202B206872672(volLocal_17);
		VOLUME::_0x6D5F9E69BA1BE783(volLocal_17);
		func_136(volLocal_17);
	}
...
void func_79(int iParam0) // Position - 0x26AB Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_80(int iParam0) // Position - 0x26DC Hash - 0xB8A02AF0 ^0xD2299111
{
	int i;
...
void func_81(int iParam0) // Position - 0x270F Hash - 0x315657D9 ^0xE44E20F6
{
	int num;
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x275F Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2815 Hash - 0x34A2E44 ^0x39A823C1
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_84(int iParam0) // Position - 0x2848 Hash - 0xBF7DEF91 ^0x6E26B7C2
{
...
BOOL func_85(int iParam0) // Position - 0x2874 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_86(int iParam0) // Position - 0x2887 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
int func_87(int iParam0, int iParam1) // Position - 0x28B1 Hash - 0x8FA0E29 ^0xC3F68E87
{
	switch (iParam0)
	{
		case -2106445152:
...
struct<8> func_88(char* sParam0) // Position - 0x39CA Hash - 0x8E82EE3 ^0x8E82EE3
{
	var unk;
...
BOOL func_89(int iParam0) // Position - 0x39DD Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_56(iParam0))
		return false;
...
BOOL func_90(int iParam0) // Position - 0x39FE Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_56(iParam0))
		return false;
...
BOOL func_91(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3A51 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_92(int iParam0) // Position - 0x4111 Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

BOOL func_93(int iParam0) // Position - 0x4128 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_94(int iParam0, BOOL bParam1) // Position - 0x416B Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_95(int iParam0) // Position - 0x4256 Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_96(int iParam0) // Position - 0x426C Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4282 Hash - 0x16E871AD ^0x10C54C39
{
...
Hash func_98(int iParam0) // Position - 0x42AC Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_99(var uParam0) // Position - 0x42CA Hash - 0x2EB17CA4 ^0xF9B0B2A3
{
	float num;
...
BOOL func_100(var uParam0) // Position - 0x4326 Hash - 0xFAD512A0 ^0x885E7B40
{
	BOOL num;
...
BOOL func_101(var uParam0) // Position - 0x4359 Hash - 0x8B11D54A ^0xEDE0BA6C
{
	PersChar persChar;
	Vector3 vector;

	persChar = PERSCHAR::_0x112DDF56300BC6E5(func_98(uParam0->f_1));
...
BOOL func_102(var uParam0) // Position - 0x439E Hash - 0x3A8809B5 ^0xDC0517CE
{
...
BOOL func_103(var uParam0) // Position - 0x4411 Hash - 0x5D4E2F88 ^0xF53800AB
{
	if (MISC::GET_FRAME_COUNT() % 6 != 0)
		return false;
...
void func_104(var uParam0) // Position - 0x4458 Hash - 0xCE2A1393 ^0xDE10F739
{
	int i;
...
BOOL func_105(var uParam0) // Position - 0x44B3 Hash - 0x7DA68C00 ^0xC6954B4D
{
...
BOOL func_106(var uParam0) // Position - 0x44DA Hash - 0x62F00392 ^0x9025E0F0
{
	int i;
	Ped pedInDraftHarness;
...
BOOL func_107(int iParam0) // Position - 0x455B Hash - 0x43A4311 ^0x43A4311
{
...
BOOL func_108() // Position - 0x4590 Hash - 0xB5F1D039 ^0x491A8075
{
	if (Global_16)
		return false;
...
const char* func_109(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x45D3 Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;
...
BOOL func_110(int iParam0) // Position - 0x5039 Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_111(int iParam0) // Position - 0x504E Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
Hash func_112(int iParam0) // Position - 0x5109 Hash - 0x7493E565 ^0x5CB7541E
{
	if (!func_110(iParam0))
		return -1;
...
int func_113(int iParam0) // Position - 0x5143 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_114(int iParam0) // Position - 0x529E Hash - 0x86A6B481 ^0x1B2BE0F4
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_115(int iParam0, int iParam1) // Position - 0x52D8 Hash - 0x60CCFF55 ^0x376285D7
{
	if (!func_7(iParam0))
		return false;
...
BOOL func_116(int iParam0, int iParam1) // Position - 0x531C Hash - 0xD0DCDA48 ^0x4E1FA2FB
{
	if (!func_110(iParam0))
		return false;
...
int func_117() // Position - 0x5364 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

int func_118(int iParam0) // Position - 0x5370 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_119(int iParam0) // Position - 0x5383 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_120(float fParam0) // Position - 0x5395 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_121(var uParam0, int iParam1) // Position - 0x53AB Hash - 0xB0CFF0C3 ^0xBEAF44CB
{
...
int func_122(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x53E1 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_123(int iParam0) // Position - 0x5424 Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_124(int iParam0) // Position - 0x5437 Hash - 0xEC19E423 ^0x3F24553E
{
	int num;
	...
	if (func_157())
		if (!func_158(Global_1835011[3 /*74*/].f_1, true))
			return num == 7 || num == 6;

	return true;
}

void func_125(int iParam0, int iParam1) // Position - 0x5489 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_126(int iParam0, int iParam1) // Position - 0x549A Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_127(var uParam0, var uParam1, int iParam2) // Position - 0x54B0 Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

int func_128() // Position - 0x54C0 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_129(int iParam0) // Position - 0x54CE Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

void func_130(int iParam0) // Position - 0x54E4 Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

int func_131() // Position - 0x54F4 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_132(int iParam0, int iParam1) // Position - 0x5503 Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_129(iParam0))
		return false;
...
BOOL func_133(int iParam0) // Position - 0x5526 Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_129(iParam0))
		return false;
...
BOOL func_134(int iParam0) // Position - 0x555E Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_129(iParam0))
		return false;
...
void func_135(int iParam0) // Position - 0x557E Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_136(Volume volParam0) // Position - 0x55E7 Hash - 0x7DD010A2 ^0x16530136
{
...
void func_137(int iParam0) // Position - 0x55FE Hash - 0x3E288458 ^0xC75F9664
{
...
void func_138(int iParam0) // Position - 0x5709 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;
...
int func_139(int iParam0) // Position - 0x58E8 Hash - 0xAC39A336 ^0xDF4F13BE
{
	int i;
...
void func_140(Hash hParam0) // Position - 0x591A Hash - 0xDB9A74EC ^0x13B3F16D
{
...
BOOL func_141(int iParam0, BOOL bParam1) // Position - 0x593A Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_20() != -1)
		return false;
...
int func_142(int iParam0, BOOL bParam1) // Position - 0x5968 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_143(int iParam0) // Position - 0x59EB Hash - 0xCAB4B86D ^0xCAB4B86D
{
	int num;
...
void func_144(int iParam0, PersChar pchParam1) // Position - 0x5A09 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_92(iParam0))
		return;
...
PersChar func_145(int iParam0) // Position - 0x5A2A Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_92(iParam0))
		return 0;
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x5A4A Hash - 0x452DF11A ^0x452DF11A
{
	if (func_20() != -1)
		return;
...
BOOL func_147(int iParam0) // Position - 0x5A83 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_92(iParam0))
		return false;
...
void func_148(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5AA9 Hash - 0xBE6CC08C ^0x4B31B8AF
{
	int num;
...
BOOL func_149() // Position - 0x5ADF Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_20() != -1)
		return false;
...
BOOL func_150() // Position - 0x5B04 Hash - 0x7BF82DA8 ^0x7BF82DA8
{
	if (func_20() != false)
		return true;
...
BOOL func_151(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5B19 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
const char* func_152(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5D1D Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_153(var uParam0, var uParam1, var uParam2) // Position - 0x5D31 Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_154(int iParam0) // Position - 0x5D5F Hash - 0xE6862179 ^0x7BEB6006
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_155(int iParam0) // Position - 0x6041 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
const char* func_156(const char* sParam0, int iParam1) // Position - 0x606B Hash - 0x9E99F03 ^0x60ABD137
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

BOOL func_157() // Position - 0x6085 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_158(int iParam0, BOOL bParam1) // Position - 0x60A4 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_159(int iParam0) // Position - 0x60D5 Hash - 0xDDC0076D ^0xDDC0076D
{
	return Global_1310750.f_16035 && iParam0 != false;
}

BOOL func_160(int iParam0) // Position - 0x60E9 Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_132(iParam0, Global_1310750.f_16072 | 64);
}

void func_161(int iParam0) // Position - 0x6101 Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
void func_162(int iParam0, BOOL bParam1) // Position - 0x618E Hash - 0x2F9EB0B9 ^0x9B1A8867
{
	char* ambientZone;
...
void func_163(int iParam0, BOOL bParam1) // Position - 0x61C2 Hash - 0x342D57CF ^0xF9EC90D9
{
	switch (iParam0)
	{
		case 5:
...
void func_164(int iParam0, int iParam1) // Position - 0x61F7 Hash - 0x823E3440 ^0x340E01B4
{
	func_183(&(Global_1935369.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_165(int iParam0) // Position - 0x6211 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_92(iParam0))
		return false;
...
void func_166(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6236 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
...
void func_167(int iParam0, BOOL bParam1) // Position - 0x6322 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_186(iParam0))
		return;
...
void func_168(int iParam0, int iParam1) // Position - 0x6378 Hash - 0xD75877A8 ^0xA8B353E5
{
	if (!func_191(iParam0))
		return;
...
int func_169(int iParam0) // Position - 0x63B8 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1914319.f_3[iParam0 /*446*/].f_408;
}

void func_170(int iParam0) // Position - 0x63CE Hash - 0x53643336 ^0x7E4A5E20
{
	Global_1914319.f_3[iParam0 /*446*/].f_7 = 0;
	return;
}

void func_171(int iParam0, BOOL bParam1) // Position - 0x63E4 Hash - 0x1BC36FD9 ^0xDFBA1F0
{
	int num;
	int num2;
	int offset;
...
BOOL func_172(Hash hParam0) // Position - 0x6435 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_192(hParam0))
...
BOOL func_173() // Position - 0x6450 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

void func_174(int iParam0, BOOL bParam1) // Position - 0x6459 Hash - 0x61515A20 ^0x61515A20
{
	if (func_20() != -1)
		return;
...
void func_175(int iParam0) // Position - 0x648A Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
int func_176(int iParam0) // Position - 0x64CE Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_181(iParam0))
		return -1;
...
BOOL func_177() // Position - 0x64EA Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_178(int iParam0) // Position - 0x653D Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_181(iParam0))
		return -1;
...
BOOL func_179(int iParam0) // Position - 0x655D Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_180(int iParam0, int iParam1) // Position - 0x6573 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_181(int iParam0) // Position - 0x6582 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_182(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x65B5 Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;

	func_197(iParam3, &unk, &num, &num2);

	if (func_198(uParam0, unk, num, num.f_1, num2))
		return true;

	return false;
}

void func_183(int iParam0, int iParam1) // Position - 0x65E5 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_184(int iParam0) // Position - 0x65FA Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_185(Hash hParam0) // Position - 0x661E Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_186(int iParam0) // Position - 0x662A Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

BOOL func_187(int iParam0, BOOL bParam1) // Position - 0x6640 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_186(iParam0))
		return false;
...
void func_188(int iParam0, BOOL bParam1) // Position - 0x6666 Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_186(iParam0))
		return;
...
void func_189(int iParam0, BOOL bParam1) // Position - 0x6694 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_186(iParam0))
		return;
...
void func_190(int iParam0) // Position - 0x66CE Hash - 0xB29062D ^0xB29062D
{
	func_200(func_199(iParam0));
	return;
}

BOOL func_191(int iParam0) // Position - 0x66E0 Hash - 0x895544C2 ^0x895544C2
{
	return iParam0 > -1 && iParam0 < 35;
}

BOOL func_192(Hash hParam0) // Position - 0x66F6 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

Ped func_193(int iParam0) // Position - 0x6702 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
int func_194(int iParam0) // Position - 0x6730 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_195(int iParam0) // Position - 0x6771 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_196(BOOL bParam0) // Position - 0x67AF Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

void func_197(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x67C2 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_198(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x725F Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_199(int iParam0) // Position - 0x72C5 Hash - 0x1497AC6A ^0x1497AC6A
{
...
void func_200(int iParam0) // Position - 0x7719 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1914319.f_15923 = iParam0;
	return;
}

int func_201(int iParam0) // Position - 0x772A Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
