...
void main() // Position - 0x0 Hash - 0x4B6ECF75 ^0x356BC22F
{
	var unk;
	BOOL flag;
...
void func_1(var uParam0) // Position - 0x57D Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x58B Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x621 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9C7 Hash - 0x4DA9BC8C ^0xF9CF1A8
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9E1 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0x9F8 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAB6 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAE0 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC31 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC46 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xCEA Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1A9B Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B01 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBB Hash - 0x523C4DBB ^0x523C4DBB
{
	int num;
	int num2;

	iLocal_38 = func_47(func_46());

	if (!func_48(iLocal_38, true))
	{
		uParam0->f_499 = 1;
		return;
	}
	...
	num = func_49(func_46());
	num2 = func_50();
	func_51(uParam0, "BARBER_SHAVING", "script@ambient@town@barber_shave@action", uParam1, uParam4);
	func_52(uParam0, 1, "pl_action", "", 0);
	func_53(uParam0, 0, "BARBER", num2, uParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_53(uParam0, 1, "CUSTOMER", num, uParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_54(uParam0, 0, "RAZOR", joaat("p_straightrazor01x"), 0f, 0f, 0f, 0f, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C63 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D03 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E1D Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FE6 Hash - 0x1F269C29 ^0x91C85EA4
{
	if (iLocal_38 == -1)
		return 1;
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_55(iLocal_38)))
			uParam0->f_20[0 /*14*/] = func_56(iLocal_38, false, false, true, true, true);
		else
			func_57(iLocal_38, false, 0, 0, 0, false);
...
BOOL func_19(var uParam0) // Position - 0x2055 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2205 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2279 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22C8 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2320 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2489 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_65(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_25(var uParam0) // Position - 0x27B0 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28E7 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A17 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A56 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A5F Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A91 Hash - 0x6C10550A ^0x6C10550A
{
	func_67(&uLocal_9, false);
	func_68(&uLocal_9, true);
	func_69(&uLocal_9, true);
	func_70(&uLocal_9, true);
	func_71(&uLocal_9, true);
	func_72(&uLocal_9, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2AC4 Hash - 0x94A0D06D ^0xFA229AD6
{
	var unk;
	int i;
	int taskSequenceId;
	...
	if (!uParam0->f_469[0])
	{
		for (i = 0; i < 2; i = i + 1)
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				if (func_73(uParam0->f_20[i /*14*/], 0, &uLocal_9, &unk, 0, 0))
				{
					func_74(uParam0);
				
					if (!uParam0->f_469[2])
					{
						func_75(*uParam0, uParam0->f_483, true);
						uParam0->f_469[2] = 1;
					}
	...
	if (!uParam0->f_469[1])
	{
		if (func_76(uParam0, 2f, 15f, 4, 5f, 1112014848))
		{
			func_74(uParam0);
			ANIMSCENE::SET_ANIM_SCENE_BOOL(uParam0->f_3.f_1, "Base_Loop", true, false);
			uParam0->f_469[1] = 1;
		}
	}
	...
	if (uParam0->f_469[1])
	{
		if (!uParam0->f_469[2])
		{
			if (func_77(uParam0, 1f, 15f, 4, joaat("Action"), false))
			{
				func_75(*uParam0, uParam0->f_483, true);
				uParam0->f_469[2] = 1;
			}
	...
	if (uParam0->f_469[1])
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
			{
				...
				TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(uParam0->f_20[0 /*14*/], -306.483f, 814.287f, 117.984f, 1f, 65000, false, true, false, false);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
			
				if (iLocal_38 != -1)
					if (func_78(iLocal_38))
						func_79(iLocal_38, false, true, false, false);
		...
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -308.2f, 801.8f, 119f, 1f, -1, 1048576000, 1, 1193033728);
				TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
				TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
				TASK::TASK_PERFORM_SEQUENCE(uParam0->f_20[1 /*14*/], taskSequenceId);
		...
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[0 /*8*/]))
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_372[0 /*8*/].f_1))
				OBJECT::DELETE_OBJECT(&uParam0->f_372[0 /*8*/]);
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2D47 Hash - 0xEE382175 ^0xF5022587
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[0 /*8*/]))
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uParam0->f_372[0 /*8*/]);

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uParam0->f_20[0 /*14*/]);

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uParam0->f_20[1 /*14*/]);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DC5 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DE2 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F1E Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3057 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3101 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3179 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_82(entityForwardVector, unk5);
	...
	if (func_83(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3208 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3323 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x332F Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	for (m = func_92(i, num); num2 > m; m = func_92(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_93(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34B7 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3557 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x356A Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3584 Hash - 0xEA796703 ^0x695D7925
{
...
int func_46() // Position - 0x35EC Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_47(int iParam0) // Position - 0x35FA Hash - 0xA17B1449 ^0xA17B1449
{
	int num;
...
BOOL func_48(int iParam0, BOOL bParam1) // Position - 0x3629 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_94() != -1)
		return false;
...
int func_49(int iParam0) // Position - 0x3681 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;

	num = joaat("a_m_m_vallaborer_01");

	switch (iParam0)
	{
		case 0:
			num = joaat("a_m_m_middlesdtownfolk_01");
			break;
	
		case 1:
			num = joaat("a_m_m_strtownfolk_01");
			break;
	
		case 6:
			num = joaat("a_m_o_waptownfolk_01");
			break;
		...
		case 10:
			...
			{
				case 78:
					num = joaat("a_m_m_asbtownfolk_01");
					break;
			
				case 82:
					num = joaat("a_m_m_btchillbilly_01");
					break;
				...
				case 92:
					...
					{
						case 0:
							num = joaat("a_m_m_vhttownfolk_01");
							break;
		...
		case 11:
			num = joaat("a_m_m_rhdupperclass_01");
			break;
	
		case 13:
			num = joaat("a_m_m_tumtownfolk_01");
			break;
	
		case 15:
			num = joaat("a_m_m_armtownfolk_01");
			break;
	}
...
int func_50() // Position - 0x3772 Hash - 0xD3FC7EF0 ^0xFEAB50B1
{
	switch (func_81())
	{
		case 82:
			return joaat("a_m_o_btchillbilly_01");
	
		default:
		
	}

	return joaat("u_m_m_valbarber_01");
}

void func_51(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3797 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_52(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x37C3 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37F4 Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_54(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3882 Hash - 0xD25940D1 ^0x34109BE0
{
...
Ped func_55(int iParam0) // Position - 0x38DB Hash - 0xEEC501EA ^0xEEC501EA
{
	if (!func_95(iParam0))
		return 0;
	...
	return PED::_0xE76687023D8C8505(func_101(iParam0), 0);
}

Ped func_56(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x3921 Hash - 0x816A3A36 ^0x24211010
{
	Ped ped;
	PersChar persChar;

	if (!func_102(iParam0, true))
		return 0;

	if (func_100(func_99(iParam0)))
	{
		persChar = func_96(iParam0);
	...
	if (bParam4 && !func_78(iParam0) && !ENTITY::IS_ENTITY_DEAD(ped))
	{
...
int func_57(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x39DE Hash - 0x4673E62 ^0xCF31A97
{
	var unk;
	Entity entity;
	...
	if (!_IS_NULL_VECTOR(unk))
		PERSCHAR::_0x59C7AD6FEA2AC449(func_96(iParam0), unk);

	if (bParam5)
		entity = PERSCHAR::_0x08FC896D2CB31FCC(func_96(iParam0), false);
	else
		entity = PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_96(iParam0), false);
...
BOOL func_58(int iParam0, int iParam1) // Position - 0x3AAF Hash - 0x60723DEF ^0xAD385CAF
{
	if (!func_107(iParam0))
		return false;

	return func_62(Global_1914319.f_3[iParam0 /*446*/].f_8, iParam1);
}

void func_59(int iParam0, int iParam1) // Position - 0x3AD8 Hash - 0x63A5F33B ^0x9487B029
{
	if (!func_107(iParam0))
		return;

	func_108(&(Global_1914319.f_3[iParam0 /*446*/].f_8), iParam1);
	return;
}

BOOL func_60(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B00 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_110(Global_1898164.f_1[0 /*5*/]);
	
		if (func_111(num) && func_112(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}

	if (iParam0 == 0 && func_113(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_61(int iParam0) // Position - 0x3D04 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_62(int iParam0, int iParam1) // Position - 0x3D18 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_63() // Position - 0x3D27 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_81() != -1;
}

BOOL func_64(var uParam0, Any* panParam1) // Position - 0x3D42 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_65(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3DA1 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_114(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_66(Ped pedParam0) // Position - 0x3DE3 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_67(int iParam0, BOOL bParam1) // Position - 0x3E0F Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_68(var uParam0, BOOL bParam1) // Position - 0x3E8B Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x3EB1 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_70(var uParam0, BOOL bParam1) // Position - 0x3ED3 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_71(var uParam0, BOOL bParam1) // Position - 0x3EF5 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_72(var uParam0, BOOL bParam1) // Position - 0x3F17 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_73(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x3F3B Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_122(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_124(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_126(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_124(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_128(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_129(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_130(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_124(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_131(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_124(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_132(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_124(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_132(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_124(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				...
				{
					if (func_136(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_137(iParam2, pedParam0) && func_138(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_124(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_136(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_137(iParam2, pedParam0) && func_138(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_124(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_139(pedParam0, Global_1935630.f_41))
							{
								func_140();
								*uParam3 = 2;
								func_124(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_141(iParam2, pedParam0) || iParam2->f_9 > 0 && func_142() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_143())
					{
						if (func_139(pedParam0, Global_1935630.f_42))
						{
							func_140();
							*uParam3 = 2;
							func_124(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_145(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_124(pedParam0, iParam2, *uParam3);
					return true;
...
void func_74(var uParam0) // Position - 0x4567 Hash - 0x1B3E56A8 ^0x1B3E56A8
{
	if (!uParam0->f_469[1])
	{
...
void func_75(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x458C Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_76(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4690 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_157(fParam2);
		num2 = func_158(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_159(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_160(&(uParam0->f_490)))
							func_161(&(uParam0->f_490));
					
						if (func_162(&(uParam0->f_490), fParam1))
						{
							func_163(&(uParam0->f_490));
							return true;
						}
...
BOOL func_77(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x489B Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_159(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_160(&(uParam0->f_490)))
							func_164(&(uParam0->f_490), false);
					
						if (func_165(&(uParam0->f_490)))
							func_166(&(uParam0->f_490));
					
						if (func_167(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_160(&(uParam0->f_490)) && !func_165(&(uParam0->f_490)))
			func_168(&(uParam0->f_490));
	}

	return false;
}

BOOL func_78(int iParam0) // Position - 0x49C4 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_95(iParam0))
		return false;
...
void func_79(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x49E9 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!func_98(iParam0, true))
		return;

	if (!func_98(iParam0, 2))
		return;

	if (!bParam4 && !func_78(iParam0) && func_169(iParam0))
		return;

	func_170(iParam0, true);
	func_171(iParam0);
	...
	if (func_98(iParam0, 128) && !bParam3)
		func_172(iParam0, false);

	return;
}

void func_80(int iParam0, int iParam1) // Position - 0x4AD5 Hash - 0x63A5F33B ^0x9487B029
{
	if (!func_107(iParam0))
		return;
...
int func_81() // Position - 0x4AFD Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_82(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4B0B Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_83(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4B72 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_84(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4B9B Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_173(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_85(var uParam0, var uParam1, var uParam2) // Position - 0x4BE7 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_173(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_86(int iParam0) // Position - 0x4C36 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_87(int iParam0) // Position - 0x4C5B Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_88(int iParam0) // Position - 0x4C6E Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_89(int iParam0) // Position - 0x4C81 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_90(int iParam0) // Position - 0x4C94 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_91(int iParam0) // Position - 0x4CA6 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_92(int iParam0, int iParam1) // Position - 0x4CB8 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4D52 Hash - 0xA65AB937 ^0xA65AB937
{
	func_175(iParam0, iParam6);
	func_176(iParam0, iParam5);
	func_177(iParam0, iParam4);
	func_178(iParam0, iParam3);
	func_179(iParam0, iParam2);
	func_180(iParam0, iParam1);
	return;
}

BOOL func_94() // Position - 0x4D8A Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_95(int iParam0) // Position - 0x4D98 Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

PersChar func_96(int iParam0) // Position - 0x4DAF Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_95(iParam0))
		return 0;
...
Ped func_97(int iParam0) // Position - 0x4DCF Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_98(int iParam0, BOOL bParam1) // Position - 0x4DFD Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_94() != -1)
		return false;
...
Hash func_99(int iParam0) // Position - 0x4E2B Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_95(iParam0))
		return 0;
...
BOOL func_100(Hash hParam0) // Position - 0x4E49 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

Hash func_101(int iParam0) // Position - 0x4E55 Hash - 0xED567DFA ^0x7CDFEFC2
{
	if (!func_95(iParam0))
		return 0;
...
BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x4E77 Hash - 0x5C4302E7 ^0x5C4302E7
{
	if (!func_95(iParam0))
		return false;

	if (func_98(iParam0, true) && !func_78(iParam0) && func_169(iParam0))
		return false;
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4ED7 Hash - 0x61515A20 ^0x61515A20
{
	if (func_94() != -1)
		return;
...
void func_104(int iParam0) // Position - 0x4F08 Hash - 0x5A948764 ^0xFC1342AE
{
	if (!func_95(iParam0))
		return;
...
int func_105(int iParam0, BOOL bParam1) // Position - 0x4F2B Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_95(iParam0))
		return 0;
	...
	if (func_98(iParam0, 32) && !bParam1)
	{
		func_181(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_99(iParam0)));
	
		if (func_94() == -1)
		{
			if (func_98(iParam0, 2048))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_96(iParam0));
				func_170(iParam0, 2048);
			}
...
BOOL func_106(int iParam0) // Position - 0x5016 Hash - 0x365567CB ^0x68796F4
{
	if (!func_95(iParam0))
		return false;
	...
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_96(iParam0)))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_96(iParam0), false)))
			return false;
	}
...
BOOL func_107(int iParam0) // Position - 0x505C Hash - 0x895544C2 ^0x895544C2
{
	return iParam0 > -1 && iParam0 < 35;
}

void func_108(int iParam0, int iParam1) // Position - 0x5072 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_109() // Position - 0x5083 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_110(int iParam0) // Position - 0x50D6 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_113(iParam0))
		return -1;
...
BOOL func_111(int iParam0) // Position - 0x50F6 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_112(int iParam0, int iParam1) // Position - 0x510C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_113(int iParam0) // Position - 0x511B Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_114(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x514E Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_185(eptParam1))
		{
			func_186(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_188(pedParam0, false);
			flag = true;
		}
	
		func_189(pedParam0, iParam2);
	}
...
void func_115(int iParam0, BOOL bParam1) // Position - 0x522F Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_108(iParam0, 4);
	else
...
void func_116(int iParam0, BOOL bParam1) // Position - 0x524D Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_108(iParam0, 8);
	else
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x526D Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_108(iParam0, 16);
...
void func_118(int iParam0, BOOL bParam1) // Position - 0x5298 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_108(iParam0, 32);
	else
...
void func_119(int iParam0, BOOL bParam1) // Position - 0x52B8 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_108(iParam0, 64);
	else
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x52D8 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x52FA Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_122(int iParam0, BOOL bParam1, int iParam2) // Position - 0x531E Hash - 0x37D64B11 ^0xE7060A9E
{
	func_190(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_192(true))
							func_108(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_192(true) || *iParam0 & 8192 != 0)
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_193(iParam0))
				iParam0->f_15 = func_142();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_142() - iParam0->f_15 > 500)
			{
...
BOOL func_123(Ped pedParam0, int iParam1) // Position - 0x54E9 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_195(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_196(pedParam0, pedIndexFromEntityIndex) <= func_197(iParam1))
				return true;
			break;
	}
...
void func_124(Ped pedParam0, int iParam1, int iParam2) // Position - 0x55C0 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_198(iParam2, 1, 1, 1, 0))
		func_108(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_199(iParam1, true);
	func_200();
	return;
}

BOOL func_125(Ped pedParam0, int iParam1) // Position - 0x55FD Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	{
		if (func_201(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_203(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_204(iParam1);
...
BOOL func_126(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x56E4 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_205(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_202(iParam2);
	
		if (func_203(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_204(iParam2))
				{
					func_199(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_127(Ped pedParam0, int iParam1) // Position - 0x57BA Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_195(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_204(iParam1))
		{
			customDistance = func_202(iParam1);
...
BOOL func_128(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x58C3 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_206(bParam1, bParam2, bParam3);
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x59F8 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_130(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5A2F Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_131(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5B36 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_208(iParam2))
	{
...
BOOL func_132(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5BA1 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_210(pedParam1, entityCoords, outCoords))
					{
						func_199(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_210(pedParam1, entityCoords, outCoords2))
					{
						func_199(iParam2, true);
						return true;
					}
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x5CE9 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_195(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_211(Global_1935630.f_34[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false), entityCoords);
		
			if (func_66(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
			...
			if (func_212(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_213(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_214(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_134(var uParam0, int iParam1) // Position - 0x5EC5 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_135(int iParam0, int iParam1) // Position - 0x5F3D Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_136(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5F6C Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_137(int iParam0, Ped pedParam1) // Position - 0x60F2 Hash - 0x76E45BE4 ^0x19B47CA8
{
	int _int;
...
BOOL func_138(int iParam0, Ped pedParam1) // Position - 0x613F Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_217(iParam0))
		return true;
...
BOOL func_139(Ped pedParam0, Ped pedParam1) // Position - 0x61DC Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_218(pedParam0, pedParam1, true, true) < 4f)
...
void func_140() // Position - 0x6229 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_141(int iParam0, Ped pedParam1) // Position - 0x6231 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_219(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_142();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_220(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_142() // Position - 0x62F2 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_143() // Position - 0x6310 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_142() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_144(int iParam0, Ped pedParam1) // Position - 0x635D Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_221(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_222(pedParam1);
	num2 = func_223(iParam0->f_14);
...
BOOL func_145(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6479 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_224(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_146(Ped pedParam0, int iParam1) // Position - 0x64C1 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_225(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_226(iParam1, pedParam0))
						if (func_220(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_147(Ped pedParam0, int iParam1) // Position - 0x671A Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_227(0))
		return false;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x6753 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_149(var uParam0, int iParam1) // Position - 0x6782 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_150(Ped pedParam0, int iParam1) // Position - 0x6796 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_142();
	else if (func_142() - iParam1->f_4 > func_228(iParam1))
		return func_229(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x67E3 Hash - 0xDAAF1E60 ^0xD1D12EC0
{
...
void func_152(int iParam0, BOOL bParam1) // Position - 0x6836 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_153(int iParam0) // Position - 0x690D Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_154(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x698E Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_173(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_155(Ped pedParam0) // Position - 0x6A7F Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_156(Ped pedParam0) // Position - 0x6A9A Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_157(float fParam0) // Position - 0x6AB6 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_158(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6AFD Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_159(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x6B1B Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_231(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_160(var uParam0) // Position - 0x6B72 Hash - 0x5001E582 ^0x5001E582
{
	return func_232(*uParam0, 1);
}

void func_161(var uParam0) // Position - 0x6B82 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_233(uParam0, 0f);
	return;
}

BOOL func_162(var uParam0, float fParam1) // Position - 0x6B91 Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_167(uParam0, fParam1))
	{
		func_163(uParam0);
		return true;
	}
...
void func_163(var uParam0) // Position - 0x6BAF Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_164(var uParam0, BOOL bParam1) // Position - 0x6BC5 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_165(var uParam0) // Position - 0x6BE5 Hash - 0x39705408 ^0x39705408
{
	return func_232(*uParam0, 2);
}

void func_166(var uParam0) // Position - 0x6BF5 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_160(uParam0);

	if (func_165(uParam0))
	{
		uParam0->f_1 = func_234() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_235(uParam0, 2);
	}
...
BOOL func_167(var uParam0, float fParam1) // Position - 0x6C29 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_160(uParam0))
		return false;
...
void func_168(var uParam0) // Position - 0x6C50 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_160(uParam0);

	if (!func_165(uParam0))
	{
		uParam0->f_2 = func_234() - uParam0->f_1;
		func_237(uParam0, 2);
	}
...
BOOL func_169(int iParam0) // Position - 0x6C80 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_95(iParam0))
		return false;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x6CA4 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_94() != -1)
		return;
...
void func_171(int iParam0) // Position - 0x6CDD Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
int func_172(int iParam0, BOOL bParam1) // Position - 0x6D21 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_95(iParam0))
		return 0;
	...
	if (func_98(iParam0, true) && !bParam1)
	{
		func_103(iParam0, 128);
		return 1;
	}

	func_170(iParam0, 129);
	func_171(iParam0);
	PERSCHAR::_DELETE_PERSCHAR(func_96(iParam0));
	func_181(iParam0, 0);
	return 1;
}

BOOL func_173(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x6DA4 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_174(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6DF9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_175(int iParam0, int iParam1) // Position - 0x6E10 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_176(int iParam0, int iParam1) // Position - 0x6E96 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_177(int iParam0, int iParam1) // Position - 0x6ED2 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_92(num, num2))
		return;
...
void func_178(int iParam0, int iParam1) // Position - 0x6F25 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_179(int iParam0, int iParam1) // Position - 0x6F60 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_180(int iParam0, int iParam1) // Position - 0x6F99 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_181(int iParam0, PersChar pchParam1) // Position - 0x6FD1 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_95(iParam0))
		return;
...
BOOL func_182(int iParam0) // Position - 0x6FF2 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_95(iParam0))
		return false;
...
BOOL func_183(int iParam0) // Position - 0x7018 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_184(BOOL bParam0) // Position - 0x7056 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_185(ePedType eptParam0) // Position - 0x7069 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_186(Ped pedParam0, Hash hParam1) // Position - 0x74BC Hash - 0xB8532846 ^0xE30CC5F4
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_187(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7563 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_188(Ped pedParam0, BOOL bParam1) // Position - 0x7593 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_189(Ped pedParam0, int iParam1) // Position - 0x75D8 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_190(int iParam0) // Position - 0x75FF Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_243(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_191(int iParam0) // Position - 0x776B Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_192(BOOL bParam0) // Position - 0x777E Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_244(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_193(int iParam0) // Position - 0x7798 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_194(int iParam0) // Position - 0x7830 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_195(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7857 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_223(pedParam2);
	else
		num2 = func_222(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_223(pedParam0);
	else
		num = func_222(pedParam0);

	if (num2 == num)
		if (num2 != -1)
			return true;

	if (func_62(*iParam1, 8388608))
		return true;
...
float func_196(Ped pedParam0, Ped pedParam1) // Position - 0x7950 Hash - 0xF9959663 ^0xF9959663
{
	return func_218(pedParam0, pedParam1, true, true);
}

float func_197(int iParam0) // Position - 0x7962 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_198(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x796E Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_199(int iParam0, BOOL bParam1) // Position - 0x79D3 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_200() // Position - 0x79F9 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_201(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7A0D Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_218(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_247(ped, 0)))
			if (func_248(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_202(int iParam0) // Position - 0x7B6D Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_203(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7B79 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_204(int iParam0) // Position - 0x7BDA Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_205(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7BE6 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_247(ped, 0)))
			if (func_249(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_206(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7CA8 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_207(int iParam0) // Position - 0x7D46 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_208(int iParam0) // Position - 0x7D52 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_209(int iParam0) // Position - 0x7D5E Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_210(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7E9B Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_250(pedParam0, vParam4, 0.5f))
...
BOOL func_211(Ped pedParam0) // Position - 0x7EDE Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_251(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_212(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F44 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_213(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F8B Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_214(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7FD6 Hash - 0x9FBFA6DC ^0x166FBC07
{
	float num;
...
BOOL func_215(Ped pedParam0, var uParam1) // Position - 0x8052 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_216(Ped pedParam0, Ped pedParam1) // Position - 0x809F Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_253(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_217(int iParam0) // Position - 0x80E7 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_218(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x80F7 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_219(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x813F Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_220(veParam0, uParam2, true);
...
float func_220(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x816B Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_221(int iParam0) // Position - 0x8193 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_222(Ped pedParam0) // Position - 0x819F Hash - 0xFDC16C9A ^0x1067A362
{
...
int func_223(Ped pedParam0) // Position - 0x81F3 Hash - 0xB5166352 ^0xDE219EA5
{
...
BOOL func_224(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x825D Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_218(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_218(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x83CD Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_244(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_226(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_226(iParam1, ped2))
					if (func_220(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_226(int iParam0, Ped pedParam1) // Position - 0x84BB Hash - 0xC35E0BCD ^0x2E7DD558
{
...
BOOL func_227(int iParam0) // Position - 0x852F Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_254())
		return false;

	return func_255(Global_1347702[58 /*49*/].f_15, true);
}

int func_228(int iParam0) // Position - 0x8551 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_229(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x855D Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_230(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x85D8 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_256(iParam0) == 1 && bParam7)
		return;
...
float func_231(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x8664 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_232(int iParam0, int iParam1) // Position - 0x8682 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_233(var uParam0, float fParam1) // Position - 0x8691 Hash - 0x30433BAB ^0xF854D531
{
...
float func_234() // Position - 0x86B7 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_235(var uParam0, int iParam1) // Position - 0x86E9 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_236(var uParam0) // Position - 0x86FE Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_160(uParam0))
		return uParam0->f_1;
...
void func_237(var uParam0, int iParam1) // Position - 0x8733 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_238(Ped pedParam0, Hash hParam1) // Position - 0x8744 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x8772 Hash - 0x8D9151F ^0xE5056040
{
	Hash _int;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x87C0 Hash - 0x8D9151F ^0xE5056040
{
	Hash _int;
	int _int2;
...
void func_241(Ped pedParam0) // Position - 0x882E Hash - 0xA0EC4282 ^0xAFE105E9
{
...
BOOL func_242() // Position - 0x884A Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_257())
		return false;
...
void func_243(Any* panParam0, int iParam1) // Position - 0x88A0 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_244(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8948 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_245(int iParam0) // Position - 0x8A0F Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_246(int iParam0) // Position - 0x8AB7 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_247(Ped pedParam0, int iParam1) // Position - 0x8B1C Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_248(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8B33 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_249(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_249(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8B61 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_250(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8BAB Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_251(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8BEC Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_252(Ped pedParam0) // Position - 0x8C65 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_253(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8D4D Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_254() // Position - 0x8D8F Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_94() != -1)
		return false;
...
BOOL func_255(int iParam0, BOOL bParam1) // Position - 0x8DB4 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_256(int iParam0) // Position - 0x8DE5 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_257() // Position - 0x8DF8 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_258(int iParam0) // Position - 0x8E29 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_113(iParam0))
		return -1;
...
int func_259(int iParam0) // Position - 0x8E45 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_260(int iParam0) // Position - 0x8E86 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
