...
void main() // Position - 0x0 Hash - 0x60F41C82 ^0xE715C0E6
{
	var unk;
	BOOL flag;
...
void func_1(var uParam0) // Position - 0x584 Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x592 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x628 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9CE Hash - 0x4DA9BC8C ^0x61C7F51B
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9E8 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0x9FF Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xABD Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAE7 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC38 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC4D Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xCF1 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AA2 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B08 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC2 Hash - 0x507D87CC ^0x507D87CC
{
	Hash entityModel;
	...
	{
		case 23:
			func_46(uParam0, "VOMIT_SIT_FEMALE", "script@ambient@town@wall_vomit_sit@female01", uParam1, uParam4);
			entityModel = func_48(func_47());
			func_49(uParam0, 0, "BUCKET", joaat("p_cs_bucket01bx"), 0f, 0f, 0f, 0f, 1);
			break;
	
		case 24:
			func_46(uParam0, "VOMIT_SIT_MALE", "script@ambient@town@wall_vomit_sit@male01", uParam1, uParam4);
			entityModel = func_50(func_47());
			func_49(uParam0, 0, "BUCKET", joaat("p_cs_bucket01bx"), 0f, 0f, 0f, 0f, 1);
			bLocal_37 = true;
			break;
	
		case 25:
			func_46(uParam0, "VOMIT_WALL_FEMALE", "script@ambient@town@wall_vomit@female01", uParam1, uParam4);
		
			if (func_51(uParam0->f_20[0 /*14*/], 0))
				entityModel = ENTITY::GET_ENTITY_MODEL(uParam0->f_20[0 /*14*/]);
			else
				entityModel = func_48(func_47());
		...
		case 26:
			func_46(uParam0, "VOMIT_WALL_MALE", "script@ambient@town@wall_vomit@male01", uParam1, uParam4);
	...
	func_52(uParam0, 1, "PBL_ACTION", "", 0);
	func_53(uParam0, 0, "ped", entityModel, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1D0B Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1DAB Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1EC5 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x208E Hash - 0xA87773 ^0xA87773
{
	if (!func_54(hLocal_39))
		return 0;

	return 1;
}

BOOL func_19(var uParam0) // Position - 0x20A5 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2255 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x22C9 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2318 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2370 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24D9 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_60(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_25(var uParam0) // Position - 0x2800 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2937 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A67 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2AA6 Hash - 0x1F5294F9 ^0x5487E3A1
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 1) && !func_62(uParam0->f_20[0 /*14*/], SCRIPT_TASK_START_SCENARIO_IN_PLACE))
			func_63(uParam0->f_20[0 /*14*/], hLocal_39, 0, false, 0, -1082130432);
	
		if (func_64(uParam0, &uLocal_9, false))
		{
			uParam0->f_499 = 1;
			return false;
		}
	
		if (TASK::_PED_IS_IN_SCENARIO_BASE(uParam0->f_20[0 /*14*/]))
		{
			if (func_65(uParam0, 1065353216, 1116471296, 4, 10f, 1112014848))
			{
				PED::_SET_PED_DRUNKNESS(uParam0->f_20[0 /*14*/], true, 0.7f);
				func_66(uParam0);
				return true;
			}
		}
...
void func_29(var uParam0) // Position - 0x2B66 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B98 Hash - 0x4DBC088D ^0x32A840F4
{
	if (bLocal_38)
	{
		hLocal_39 = joaat("world_human_drunk_brace_wall");
	
		if (bLocal_37)
			func_67(hLocal_39, 15, 0, joaat("WORLD_HUMAN_DRUNK_BRACE_WALL_MALE_A"));
		else
			func_67(hLocal_39, 15, 0, joaat("WORLD_HUMAN_DRUNK_BRACE_WALL_FEMALE_A"));
	}
	else
	{
		hLocal_39 = joaat("world_human_sit_back_exhausted");
	
		if (bLocal_37)
			func_67(hLocal_39, 15, 0, joaat("world_human_sit_back_exhausted_male_a"));
		else
			func_67(hLocal_39, 15, 0, joaat("WORLD_HUMAN_SIT_BACK_EXHAUSTED_FEMALE_A"));
	}

	func_68(&uLocal_9, false);
	func_69(&uLocal_9, true);
	func_70(&uLocal_9, true);
	func_71(&uLocal_9, true);
	func_72(&uLocal_9, true);
	func_73(&uLocal_9, true);
	func_74(&uLocal_9, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2C34 Hash - 0xE3EC09FE ^0x592BEC0
{
	if (!uParam0->f_469[0])
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	...
	if (!uParam0->f_469[3])
	{
		if (!uParam0->f_469[4])
		{
			if (!bLocal_38 && bLocal_37)
				fLocal_40 = 2.5f;
		
			if (func_76(uParam0, fLocal_40, 1116471296, 4, joaat("Action"), true))
			{
				func_75(*uParam0, uParam0->f_483, true);
				uParam0->f_469[4] = 1;
			}
	...
	if (!uParam0->f_469[3])
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
			{
				...
				{
					if (bLocal_38)
						TASK::TASK_WANDER_STANDARD(uParam0->f_20[0 /*14*/], 1193033728, 0);
					else
						func_63(uParam0->f_20[0 /*14*/], hLocal_39, 45000, false, 0, -1082130432);
...
int func_32(var uParam0, var uParam1) // Position - 0x2DC0 Hash - 0xCF134B31 ^0xCF134B31
{
	func_77(uParam0, false, true, false);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DE8 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2E05 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F41 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x307A Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3124 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x319C Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x322B Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3346 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3352 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34DA Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x357A Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x358D Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x35A7 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x360F Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x363B Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_48(int iParam0) // Position - 0x3649 Hash - 0xA6D0F253 ^0x6683D66D
{
	int num;

	num = joaat("a_f_m_valtownfolk_01");

	switch (iParam0)
	{
		case 0:
			num = joaat("a_f_m_middlesdtownfolk_01");
			break;
	
		case 1:
			num = joaat("a_f_m_strtownfolk_01");
			break;
	
		case 4:
			num = joaat("a_f_m_blwtownfolk_01");
			break;
		...
		case 10:
			...
			{
				case 78:
					num = joaat("a_f_m_asbtownfolk_01");
					break;
			
				case 82:
					num = joaat("a_f_m_btchillbilly_01");
					break;
				...
				case 92:
					...
					{
						case 0:
							num = joaat("a_f_m_vhttownfolk_01");
							break;
		...
		case 11:
			num = joaat("a_f_m_rhdupperclass_01");
			break;
	
		case 13:
			num = joaat("a_f_m_tumtownfolk_01");
			break;
	
		case 15:
			num = joaat("a_f_m_armtownfolk_01");
			break;
	}
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3738 Hash - 0xD25940D1 ^0x34109BE0
{
...
Hash func_50(int iParam0) // Position - 0x3791 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
BOOL func_51(Ped pedParam0, int iParam1) // Position - 0x3882 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
void func_52(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3981 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_53(var uParam0, int iParam1, char* sParam2, Hash hParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x39B2 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_54(Hash hParam0) // Position - 0x3A40 Hash - 0xF47DA3FB ^0x3523541A
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(hParam0, false);
}

BOOL func_55(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A4F Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_56(int iParam0) // Position - 0x3C53 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_57(int iParam0, int iParam1) // Position - 0x3C67 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_58() // Position - 0x3C76 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_79() != -1;
}

BOOL func_59(var uParam0, Any* panParam1) // Position - 0x3C91 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_60(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3CF0 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_61(Ped pedParam0) // Position - 0x3D32 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
BOOL func_62(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3D5E Hash - 0x37FB14EB ^0x7E496A4A
{
...
void func_63(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x3D87 Hash - 0x5050B938 ^0x5BDC33E5
{
	TASK::TASK_START_SCENARIO_IN_PLACE_HASH(pedParam0, hParam1, iParam2, bParam3, hParam4, iParam5, false);
	return;
}

BOOL func_64(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3DA0 Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_99(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
BOOL func_65(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x3DFA Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	int num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_100(Global_35))
		{
			ped = func_101(Global_35);
		...
		num = num * num;
		iParam2 = func_102(iParam2);
		num2 = func_103(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_104(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < iParam2 * iParam2)
				{
					...
					{
						if (!func_105(&(uParam0->f_490)))
							func_106(&(uParam0->f_490));
					
						if (func_107(&(uParam0->f_490), iParam1))
						{
...
void func_66(var uParam0) // Position - 0x4008 Hash - 0xB9AF1204 ^0xB9AF1204
{
	if (!uParam0->f_469[5])
	{
...
int func_67(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x402D Hash - 0x4C6F92F6 ^0x312B6988
{
	return STREAMING::_REQUEST_SCENARIO_TYPE(hParam0, iParam1, iParam2, iParam3);
}

void func_68(int iParam0, BOOL bParam1) // Position - 0x4041 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
	...
	else
	{
		...
		func_113(iParam0, false);
		func_114(iParam0, false);
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x40BD Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_70(var uParam0, BOOL bParam1) // Position - 0x40E1 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
		func_9(&(uParam0->f_1), 256);
	else
		func_117(&(uParam0->f_1), 256);

	return;
}

void func_71(var uParam0, BOOL bParam1) // Position - 0x4107 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_72(var uParam0, BOOL bParam1) // Position - 0x4129 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_73(var uParam0, BOOL bParam1) // Position - 0x414B Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
		func_9(&(uParam0->f_1), 1);
	else
		func_117(&(uParam0->f_1), 1);

	return;
}

void func_74(var uParam0, BOOL bParam1) // Position - 0x416D Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_75(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4191 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_76(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4295 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_104(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_105(&(uParam0->f_490)))
		...
		if (func_105(&(uParam0->f_490)) && !func_121(&(uParam0->f_490)))
...
void func_77(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x43BE Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
Any func_78(Hash hParam0) // Position - 0x4512 Hash - 0xD6E12BEB ^0xAA87004A
{
	return STREAMING::_REMOVE_SCENARIO_ASSET(hParam0);
}

int func_79() // Position - 0x4520 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_80(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x452E Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4595 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_82(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x45BE Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_83(var uParam0, var uParam1, var uParam2) // Position - 0x460A Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_84(int iParam0) // Position - 0x4659 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_85(int iParam0) // Position - 0x467E Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_86(int iParam0) // Position - 0x4691 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_87(int iParam0) // Position - 0x46A4 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_88(int iParam0) // Position - 0x46B7 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_89(int iParam0) // Position - 0x46C9 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_90(int iParam0, int iParam1) // Position - 0x46DB Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4775 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x47AD Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_93() // Position - 0x47BC Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_94(int iParam0) // Position - 0x480F Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_97(iParam0))
		return -1;
...
BOOL func_95(int iParam0) // Position - 0x482F Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_96(int iParam0, int iParam1) // Position - 0x4845 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_97(int iParam0) // Position - 0x4854 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_98(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4887 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
BOOL func_99(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4968 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
BOOL func_100(Ped pedParam0) // Position - 0x4F91 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_101(Ped pedParam0) // Position - 0x4FAC Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_102(int iParam0) // Position - 0x4FC8 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x500F Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_104(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x502D Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_105(var uParam0) // Position - 0x5084 Hash - 0x5001E582 ^0x5001E582
{
	return func_171(*uParam0, 1);
}

void func_106(var uParam0) // Position - 0x5094 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_172(uParam0, 0f);
	return;
}

BOOL func_107(var uParam0, int iParam1) // Position - 0x50A3 Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_123(uParam0, iParam1))
	{
		func_108(uParam0);
		return true;
	}
...
void func_108(var uParam0) // Position - 0x50C1 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x50D7 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_110(int iParam0, BOOL bParam1) // Position - 0x51AE Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_117(iParam0, 4);
	else
...
void func_111(int iParam0, BOOL bParam1) // Position - 0x51CC Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_117(iParam0, 8);
	else
...
void func_112(int iParam0, BOOL bParam1) // Position - 0x51EC Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_117(iParam0, 16);
...
void func_113(int iParam0, BOOL bParam1) // Position - 0x5217 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_117(iParam0, 32);
	else
...
void func_114(int iParam0, BOOL bParam1) // Position - 0x5237 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_117(iParam0, 64);
	else
...
void func_115(int iParam0, BOOL bParam1) // Position - 0x5257 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_117(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_116(int iParam0, BOOL bParam1) // Position - 0x5279 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_117(iParam0, 1048576);
	else
...
void func_117(int iParam0, int iParam1) // Position - 0x529D Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_118(int iParam0) // Position - 0x52AE Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_119(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x532F Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
void func_120(var uParam0, BOOL bParam1) // Position - 0x5420 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_121(var uParam0) // Position - 0x5440 Hash - 0x39705408 ^0x39705408
{
	return func_171(*uParam0, 2);
}

void func_122(var uParam0) // Position - 0x5450 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_105(uParam0);
...
BOOL func_123(var uParam0, float fParam1) // Position - 0x5484 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_105(uParam0))
		return false;
...
void func_124(var uParam0) // Position - 0x54AB Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_105(uParam0);
...
BOOL func_125(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x54DB Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_126(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5530 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_127(int iParam0, int iParam1) // Position - 0x5547 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_128(int iParam0, int iParam1) // Position - 0x55CD Hash - 0x96B01D2A ^0x81E68218
{
...
void func_129(int iParam0, int iParam1) // Position - 0x5609 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_130(int iParam0, int iParam1) // Position - 0x565C Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_131(int iParam0, int iParam1) // Position - 0x5697 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_132(int iParam0, int iParam1) // Position - 0x56D0 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_133(int iParam0) // Position - 0x5708 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_134(BOOL bParam0) // Position - 0x5746 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_135(ePedType eptParam0) // Position - 0x5759 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_136(Ped pedParam0, Hash hParam1) // Position - 0x5BAC Hash - 0xEA1C858E ^0xDCEC28EB
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_178(pedParam0, hParam1))
		{
			if (func_179(pedParam0, hParam1))
			{
				if (func_180(pedParam0, hParam1))
				{
...
void func_137(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5C56 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_138(Ped pedParam0, BOOL bParam1) // Position - 0x5C86 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_139(Ped pedParam0, int iParam1) // Position - 0x5CCB Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_140(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5CF2 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_182(iParam2);
				...
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						if (PED::IS_PED_PLANTING_BOMB(Global_35))
							func_117(iParam0, 33554432);
					else if (!(*iParam0 & 8192 != 0))
						if (func_184(true))
							func_117(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_184(true) || *iParam0 & 8192 != 0)
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x5EBD Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_187(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_188(pedParam0, pedIndexFromEntityIndex) <= func_189(iParam1))
				return true;
			break;
	}
...
void func_142(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5F95 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_190(iParam2, 1, 1, 1, 0))
		func_117(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_191(iParam1, true);
	func_192();
	return;
}

BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x5FD2 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_193(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_195(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_196(iParam1);
...
BOOL func_144(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x60B9 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_197(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_194(iParam2);
	
		if (func_195(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_196(iParam2))
				{
					func_191(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x618F Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_187(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_196(iParam1))
		{
			customDistance = func_194(iParam1);
...
BOOL func_146(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6298 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_198(bParam1, bParam2, bParam3);
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x63CD Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6404 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_149(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x650B Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_200(iParam2))
	{
...
BOOL func_150(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6576 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_202(pedParam1, entityCoords, outCoords))
					{
						func_191(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_202(pedParam1, entityCoords, outCoords2))
					{
						func_191(iParam2, true);
						return true;
					}
...
BOOL func_151(Ped pedParam0, int iParam1) // Position - 0x66BE Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_187(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_203(Global_1935630.f_34[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false), entityCoords);
		
			if (func_61(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
			...
			if (func_204(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_205(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_206(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_152(var uParam0, int iParam1) // Position - 0x689E Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x6916 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_154(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6945 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_155(int iParam0, Ped pedParam1) // Position - 0x6ACB Hash - 0x42A83B1F ^0xB0A041F3
{
	int _int;
...
BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6B1B Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_209(iParam0))
		return true;
...
BOOL func_157(Ped pedParam0, Ped pedParam1) // Position - 0x6BB8 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_210(pedParam0, pedParam1, true, true) < 4f)
...
void func_158() // Position - 0x6C05 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6C0D Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_211(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_212(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_160() // Position - 0x6CCE Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_161() // Position - 0x6CEC Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_162(int iParam0, Ped pedParam1) // Position - 0x6D39 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_213(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_214(pedParam1);
	num2 = func_215(iParam0->f_14);
...
BOOL func_163(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6E55 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_216(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x6E9D Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_217(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_218(iParam1, pedParam0))
						if (func_212(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x70F6 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_219(0))
		return false;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x712F Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_167(var uParam0, int iParam1) // Position - 0x715E Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_168(Ped pedParam0, int iParam1) // Position - 0x7172 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_160() - iParam1->f_4 > func_220(iParam1))
		return func_221(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_169(int iParam0, Ped pedParam1) // Position - 0x71BF Hash - 0x2978E171 ^0x5E75739A
{
...
float func_170(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7213 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_171(int iParam0, int iParam1) // Position - 0x7231 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_172(var uParam0, float fParam1) // Position - 0x7240 Hash - 0x30433BAB ^0xF854D531
{
...
void func_173(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7266 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_222(iParam0) == 1 && bParam7)
		return;
...
float func_174() // Position - 0x72F2 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_175(var uParam0, int iParam1) // Position - 0x7324 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_176(var uParam0) // Position - 0x7339 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_105(uParam0))
		return uParam0->f_1;
...
void func_177(var uParam0, int iParam1) // Position - 0x736E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_178(Ped pedParam0, Hash hParam1) // Position - 0x737F Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_179(Ped pedParam0, Hash hParam1) // Position - 0x73AD Hash - 0xA54F3032 ^0x6A17F426
{
	Hash _int;
...
BOOL func_180(Ped pedParam0, Hash hParam1) // Position - 0x73FE Hash - 0xA54F3032 ^0x6A17F426
{
	Hash _int;
	int _int2;
...
void func_181(Ped pedParam0) // Position - 0x7470 Hash - 0x446F1BDD ^0x1ED7AD2C
{
...
void func_182(int iParam0) // Position - 0x748E Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_225(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_183(int iParam0) // Position - 0x75FA Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_184(BOOL bParam0) // Position - 0x760D Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_226(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_185(int iParam0) // Position - 0x7627 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_186(int iParam0) // Position - 0x76C1 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_187(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x76E8 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_188(Ped pedParam0, Ped pedParam1) // Position - 0x77E1 Hash - 0xF9959663 ^0xF9959663
{
	return func_210(pedParam0, pedParam1, true, true);
}

float func_189(int iParam0) // Position - 0x77F3 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_190(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77FF Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_191(int iParam0, BOOL bParam1) // Position - 0x7864 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_117(iParam0, 134217728);
	else
...
void func_192() // Position - 0x788A Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_193(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x789E Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_210(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_229(ped, 0)))
			if (func_230(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_194(int iParam0) // Position - 0x79FE Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_195(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7A0A Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_196(int iParam0) // Position - 0x7A6B Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_197(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7A77 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_229(ped, 0)))
			if (func_231(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_198(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7B39 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_199(int iParam0) // Position - 0x7BD7 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_200(int iParam0) // Position - 0x7BE3 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_201(int iParam0) // Position - 0x7BEF Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7D2C Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_232(pedParam0, vParam4, 0.5f))
...
BOOL func_203(Ped pedParam0) // Position - 0x7D6F Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_233(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_204(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7DD5 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_205(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7E1C Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_206(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7E67 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_207(Ped pedParam0, var uParam1) // Position - 0x7EE0 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_208(Ped pedParam0, Ped pedParam1) // Position - 0x7F2D Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_235(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_209(int iParam0) // Position - 0x7F75 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_210(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7F85 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_211(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7FCD Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_212(veParam0, uParam2, true);
...
float func_212(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7FF9 Hash - 0xC64FBD6D ^0xB72E40C1
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_213(int iParam0) // Position - 0x8023 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_214(Ped pedParam0) // Position - 0x802F Hash - 0xEB445B10 ^0x8A4C6027
{
...
int func_215(Ped pedParam0) // Position - 0x8087 Hash - 0x6E063231 ^0x61676D
{
...
BOOL func_216(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x80F7 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_210(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_210(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_217(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8267 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_226(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_218(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_218(iParam1, ped2))
					if (func_212(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_218(int iParam0, Ped pedParam1) // Position - 0x8355 Hash - 0x27FC2906 ^0xF60F50C2
{
...
BOOL func_219(int iParam0) // Position - 0x83CB Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_236())
		return false;

	return func_237(Global_1347702[58 /*49*/].f_15, true);
}

int func_220(int iParam0) // Position - 0x83ED Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_221(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x83F9 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_222(int iParam0) // Position - 0x8474 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_223() // Position - 0x8487 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_224() // Position - 0x8495 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_238())
		return false;
...
void func_225(Any* panParam0, int iParam1) // Position - 0x84EB Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_226(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8596 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_227(int iParam0) // Position - 0x865D Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_228(int iParam0) // Position - 0x8705 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_229(Ped pedParam0, int iParam1) // Position - 0x876A Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_230(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8781 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_231(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_231(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x87AF Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_232(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x87F9 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_233(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x883A Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_234(Ped pedParam0) // Position - 0x88B3 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_235(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x899B Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_236() // Position - 0x89DD Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_223() != -1)
		return false;
...
BOOL func_237(int iParam0, BOOL bParam1) // Position - 0x8A02 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_238() // Position - 0x8A33 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_239(int iParam0) // Position - 0x8A64 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_97(iParam0))
		return -1;
...
int func_240(int iParam0) // Position - 0x8A80 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_241(int iParam0) // Position - 0x8AC1 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
