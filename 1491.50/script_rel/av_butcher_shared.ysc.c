...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0x496560EE
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0xDB6161B3 ^0xDB6161B3
{
	iLocal_42 = func_47(func_46());

	if (iLocal_42 != -1)
	{
		if (func_48(iLocal_42, 1))
		{
			uParam0->f_499 = 1;
			return;
		}
	...
	func_49(uParam0, 0, "HANGER" /*Hanger Way*/, joaat("p_cs_meathanger01x"), 0f, 0f, 0f, 0f, 1);

	if (uParam0->f_489 == 0)
		func_49(uParam0, 1, "FRAME", joaat("p_targetframe01x"), uParam1, uParam4.f_2, 0);

	switch (*uParam0)
	{
		case 2:
			func_50(uParam0, "AV_BUTCHER_BLEED_DEER", "script@ambient@campfiregeneral@BUTCHER_BLEED_HANGING_CARCASS@action", uParam1, uParam4);
			func_49(uParam0, 2, "KNIFE", joaat("p_knife03x"), 0f, 0f, 0f, 0f, 1);
			break;
	
		case 3:
			func_50(uParam0, "BUTCHER_HANG", "script@ambient@campfireGeneral@BUTCHER_HANG_CARCASS@Action", uParam1, uParam4);
			break;
	}

	func_51(uParam0, 1, "PL_ACTION", "", 0);
	func_52(uParam0, 0, "MALE", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_52(uParam0, 1, "DEER", joaat("a_c_deer_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1CBF Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D5F Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E79 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2042 Hash - 0x561CA78 ^0xE41E21FC
{
	var unk;
	var unk3;
	int num;
	...
	if (uParam0->f_489 == 0)
	{
		if (!STREAMING::HAS_MODEL_LOADED(joaat("p_targetframe01x")))
			return 0;
	}
	else
	{
		if (eLocal_44 == 0)
		{
			unk = 1;
			unk3 = 1;
			unk3[0] = joaat("p_basin01x");
			num = func_53(&unk, &unk3, 1, uParam0->f_483, 2f);
		
			if (num > 0)
			{
				entityCoords = { ENTITY::GET_ENTITY_COORDS(unk[0], true, false) };
				eLocal_44 = ENTITY::PIN_CLOSEST_MAP_ENTITY(unk3[0], entityCoords, 15);
			}
			else
			{
				uParam0->f_499 = 1;
		...
		if (eLocal_44 != 0)
			if (ENTITY::IS_MAP_ENTITY_PINNED(eLocal_44))
				uParam0->f_372[3 /*8*/] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_GET_PINNED_MAP_ENTITY(eLocal_44));
			else
				eLocal_44 = 0;
	}
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_54(iLocal_42)))
			uParam0->f_20[0 /*14*/] = func_55(iLocal_42, false, false, true, true, true);
		else
			func_56(iLocal_42, false, 0, 0, 0, false);
	
		return 0;
	}

	if (!func_57(10, 524288))
	{
		func_58(10, 524288);
		bLocal_45 = true;
	}
...
BOOL func_19(var uParam0) // Position - 0x2164 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2314 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2388 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x23D7 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x242F Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2598 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_64(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_25(var uParam0) // Position - 0x28BF Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x29F6 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2B26 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2B65 Hash - 0x493CA097 ^0x5480EDED
{
	...
	if (uParam0->f_489 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[1 /*8*/]))
			return false;
	}
	else
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[3 /*8*/]))
			return false;
	
		if (!bLocal_46)
		{
			offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_483, uParam0->f_486.f_2, 0.156614f, -0.0456434f, 0.0362015f) };
			ENTITY::SET_ENTITY_COORDS(uParam0->f_372[3 /*8*/], offsetFromCoordAndHeadingInWorldCoords, true, false, true, true);
			ENTITY::PLACE_ENTITY_ON_GROUND_PROPERLY(uParam0->f_372[3 /*8*/], false);
			ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_372[3 /*8*/], true);
			bLocal_46 = true;
		}
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
		return false;

	if (uParam0->f_489 == 0)
	{
		ENTITY::PLACE_ENTITY_ON_GROUND_PROPERLY(uParam0->f_372[1 /*8*/], false);
		ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_3.f_1, ENTITY::GET_ENTITY_COORDS(uParam0->f_372[1 /*8*/], true, false), ENTITY::GET_ENTITY_ROTATION(uParam0->f_372[1 /*8*/], 2), 2);
	}

	return true;
}

void func_29(var uParam0) // Position - 0x2C55 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2C87 Hash - 0x82FBE928 ^0xDAC175E0
{
	if (uParam0->f_489 == 0)
		STREAMING::REQUEST_MODEL(joaat("p_targetframe01x"), false);

	if (hLocal_43 != 0)
		STREAMING::_REQUEST_SCENARIO_TYPE(hLocal_43, 1, 0, 0);

	func_67(&uLocal_14, false);
	func_68(&uLocal_14, true);
	func_69(&uLocal_14, true);
	func_70(&uLocal_14, true);
	func_71(&uLocal_14, true);
	func_72(&uLocal_14, true);
	func_73(&uLocal_14, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2CE4 Hash - 0x3AFCBE0B ^0x3AFCBE0B
{
	if (!uParam0->f_469[0])
	{
		if (func_74(uParam0, &uLocal_14, false))
		{
			func_75(uParam0);
			func_76(uParam0);
	...
	if (!uParam0->f_469[2])
	{
		if (func_78(uParam0, 1065353216, 1116471296, 4, 1109393408, 1112014848))
		{
			func_76(uParam0);
			ANIMSCENE::SET_ANIM_SCENE_BOOL(uParam0->f_3.f_1, "BOOL_BASE", true, false);
			uParam0->f_469[2] = 1;
		}
	}
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[5])
		{
			if (func_79(uParam0, 3f, 1116471296, 4, joaat("Action"), true))
			{
				func_77(*uParam0, uParam0->f_483, false);
				uParam0->f_469[5] = 1;
			}
	...
	if (uParam0->f_469[2])
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[2 /*8*/]))
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_372[2 /*8*/].f_1))
				OBJECT::DELETE_OBJECT(&uParam0->f_372[2 /*8*/]);
	
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
				uParam0->f_469[3] = 1;
	
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
			{
				func_75(uParam0);
				uParam0->f_469[4] = 1;
			}
	...
	if (uParam0->f_469[3] && uParam0->f_469[4])
	{
		if (iLocal_42 != -1)
			if (func_80(iLocal_42))
				func_81(iLocal_42, false, true, false, false);
...
int func_32(var uParam0, var uParam1) // Position - 0x2E98 Hash - 0xAFE131E8 ^0xF2690E5F
{
	func_82(uParam0, true, false, false);

	if (eLocal_44 != 0)
		if (ENTITY::IS_MAP_ENTITY_PINNED(eLocal_44))
			ENTITY::_UNPIN_MAP_ENTITY(eLocal_44);

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[3 /*8*/]))
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uParam0->f_372[3 /*8*/]);

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[1 /*8*/]))
	{
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uParam0->f_372[1 /*8*/]);
		OBJECT::_0xCAAF2BCCFEF37F77(uParam0->f_372[1 /*8*/], 40);
	}

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[0 /*8*/]))
	{
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uParam0->f_372[0 /*8*/]);
		OBJECT::_0xCAAF2BCCFEF37F77(uParam0->f_372[0 /*8*/], 40);
	}

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[2 /*8*/]))
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uParam0->f_372[2 /*8*/]);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F6F Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F8C Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x30C8 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3201 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x32AB Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3323 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x33B2 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x34CD Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x34D9 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3661 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3701 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3714 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x372E Hash - 0xEA796703 ^0x695D7925
{
...
int func_46() // Position - 0x3796 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

int func_47(int iParam0) // Position - 0x37A4 Hash - 0x51EA6078 ^0xC495F1F3
{
	int num;
...
BOOL func_48(int iParam0, BOOL bParam1) // Position - 0x37FD Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_96() != -1)
		return false;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x382B Hash - 0xD25940D1 ^0x34109BE0
{
	uParam0->f_372[iParam1 /*8*/].f_1 = sParam2;
	uParam0->f_372[iParam1 /*8*/].f_2 = iParam3;
	uParam0->f_372[iParam1 /*8*/].f_3 = { fParam4 };
	uParam0->f_372[iParam1 /*8*/].f_6 = fParam7;
	uParam0->f_372[iParam1 /*8*/].f_7 = iParam8;
	uParam0->f_371 = uParam0->f_371 + 1;
	return;
}

void func_50(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3884 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_51(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x38B0 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_52(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x38E1 Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_53(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6) // Position - 0x396F Hash - 0x76785467 ^0x34019397
{
	Volume volume;
	int num;

	volume = VOLUME::CREATE_VOLUME_SPHERE(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	num = func_98(uParam0, uParam1, volume, iParam2);
	func_5(volume);
	return num;
}

Ped func_54(int iParam0) // Position - 0x39A0 Hash - 0xEEC501EA ^0xEEC501EA
{
	if (!func_97(iParam0))
		return 0;
...
Ped func_55(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x39E6 Hash - 0x816A3A36 ^0x24211010
{
	Ped ped;
	PersChar persChar;

	if (!func_103(iParam0, true))
		return 0;

	if (func_100(func_99(iParam0)))
	{
		persChar = func_104(iParam0);
...
int func_56(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3AA3 Hash - 0x4673E62 ^0xCF31A97
{
	var unk;
	Entity entity;
	...
	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_104(iParam0)))
	{
	...
	if (!_IS_NULL_VECTOR(unk))
		PERSCHAR::_0x59C7AD6FEA2AC449(func_104(iParam0), unk);

	if (bParam5)
		entity = PERSCHAR::_0x08FC896D2CB31FCC(func_104(iParam0), false);
	else
		entity = PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_104(iParam0), false);

	if (!_IS_NULL_VECTOR(unk))
		PERSCHAR::_0xBB68908CD11AEBDC(func_104(iParam0));
...
BOOL func_57(int iParam0, int iParam1) // Position - 0x3B74 Hash - 0x60723DEF ^0xAD385CAF
{
	if (!func_110(iParam0))
		return false;

	return func_61(Global_1914319.f_3[iParam0 /*446*/].f_8, iParam1);
}

void func_58(int iParam0, int iParam1) // Position - 0x3B9D Hash - 0x63A5F33B ^0x9487B029
{
	if (!func_110(iParam0))
		return;

	func_111(&(Global_1914319.f_3[iParam0 /*446*/].f_8), iParam1);
	return;
}

BOOL func_59(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3BC5 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_114(num) && func_115(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}

	if (iParam0 == 0 && func_116(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_60(int iParam0) // Position - 0x3DC9 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_61(int iParam0, int iParam1) // Position - 0x3DDD Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_62() // Position - 0x3DEC Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_46() != -1;
}

BOOL func_63(var uParam0, Any* panParam1) // Position - 0x3E07 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_64(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3E66 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_117(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_65(Ped pedParam0) // Position - 0x3EA8 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_66(var uParam0) // Position - 0x3ED4 Hash - 0x7E7F30CE ^0x3F4BF7E5
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
	{
		func_118(uParam0->f_20[1 /*14*/], false);
		ENTITY::_SET_ENTITY_CARRYING_FLAG(uParam0->f_20[1 /*14*/], 7, false);
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 385, true);
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 243, true);
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 186, false);
	}

	return;
}

void func_67(int iParam0, BOOL bParam1) // Position - 0x3F2E Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_68(var uParam0, BOOL bParam1) // Position - 0x3FAA Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
		func_9(&(uParam0->f_1), 8);
	else
		func_111(&(uParam0->f_1), 8);

	return;
}

void func_69(var uParam0, BOOL bParam1) // Position - 0x3FCE Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_70(var uParam0, BOOL bParam1) // Position - 0x3FF4 Hash - 0x1FD1EFBB ^0xD473E6A3
{
	if (bParam1)
...
void func_71(var uParam0, BOOL bParam1) // Position - 0x4018 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
		func_9(&(uParam0->f_1), 2);
	else
		func_111(&(uParam0->f_1), 2);

	return;
}

void func_72(var uParam0, BOOL bParam1) // Position - 0x403A Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
		func_9(&(uParam0->f_1), 1);
	else
		func_111(&(uParam0->f_1), 1);

	return;
}

void func_73(var uParam0, BOOL bParam1) // Position - 0x405C Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
		func_9(&(uParam0->f_1), 16);
	else
		func_111(&(uParam0->f_1), 16);

	return;
}

BOOL func_74(var uParam0, int iParam1, BOOL bParam2) // Position - 0x4080 Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_126(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_75(var uParam0) // Position - 0x40DA Hash - 0xF36A9902 ^0x789731E5
{
	int pedBoneIndex;
	int pedBoneIndex2;
	...
	pedBoneIndex = PED::GET_PED_BONE_INDEX(uParam0->f_20[1 /*14*/], 53081);
	pedBoneIndex2 = PED::GET_PED_BONE_INDEX(uParam0->f_20[1 /*14*/], 41273);
	entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(uParam0->f_372[0 /*8*/], "bottomHookInd02");
	entityBoneIndexByName2 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(uParam0->f_372[0 /*8*/], "bottomHookInd01");

	if (pedBoneIndex == -1 || pedBoneIndex2 == -1 || entityBoneIndexByName == -1 || entityBoneIndexByName2 == -1)
	{
		ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[1 /*14*/], true);
		return;
	}

	worldPositionOfEntityBone = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(uParam0->f_372[0 /*8*/], entityBoneIndexByName) };
	worldPositionOfEntityBone2 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(uParam0->f_372[0 /*8*/], entityBoneIndexByName2) };
	PED::SET_PED_TO_RAGDOLL(uParam0->f_20[1 /*14*/], 10000, 15000, 0, false, true, 0);
	PED::_0xE1AADD0055D76603(uParam0->f_20[1 /*14*/], uParam0->f_372[0 /*8*/], pedBoneIndex, entityBoneIndexByName, worldPositionOfEntityBone, -1f, false, false, 0);
	PED::_0xE1AADD0055D76603(uParam0->f_20[1 /*14*/], uParam0->f_372[0 /*8*/], pedBoneIndex2, entityBoneIndexByName2, worldPositionOfEntityBone2, -1f, false, false, 0);
	return;
}

void func_76(var uParam0) // Position - 0x41DF Hash - 0xCCDA6E04 ^0xCCDA6E04
{
	if (!uParam0->f_469[6])
	{
...
void func_77(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4204 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_78(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4308 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	int num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_130(Global_35))
		{
			ped = func_131(Global_35);
		...
		else
		{
			...
			{
				num = num * 0.7f;
				iParam2 = iParam2 * 0.7f;
			}
		}
	
		num = num * num;
		iParam2 = func_132(iParam2);
		num2 = func_133(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_134(Global_35, uParam0->f_20[i /*14*/], true);
			
				if (num3 < num)
					return true;
			
				if (num3 < iParam2 * iParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_135(&(uParam0->f_490)))
							func_136(&(uParam0->f_490));
					
						if (func_137(&(uParam0->f_490), iParam1))
						{
...
BOOL func_79(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4513 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_134(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_135(&(uParam0->f_490)))
							func_139(&(uParam0->f_490), false);
					
						if (func_140(&(uParam0->f_490)))
							func_141(&(uParam0->f_490));
					
						if (func_142(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_135(&(uParam0->f_490)) && !func_140(&(uParam0->f_490)))
			func_143(&(uParam0->f_490));
	}

	return false;
}

BOOL func_80(int iParam0) // Position - 0x463C Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_97(iParam0))
		return false;
...
void func_81(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4661 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_80(iParam0) && func_144(iParam0))
		return;
...
void func_82(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x474D Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
void func_83(int iParam0, int iParam1) // Position - 0x48A1 Hash - 0x63A5F33B ^0x9487B029
{
	if (!func_110(iParam0))
		return;

	func_9(&(Global_1914319.f_3[iParam0 /*446*/].f_8), iParam1);
	return;
}

float func_84(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x48C9 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_85(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4930 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_86(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4959 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_148(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_87(var uParam0, var uParam1, var uParam2) // Position - 0x49A5 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_148(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_88(int iParam0) // Position - 0x49F4 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_89(int iParam0) // Position - 0x4A19 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_90(int iParam0) // Position - 0x4A2C Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_91(int iParam0) // Position - 0x4A3F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_92(int iParam0) // Position - 0x4A52 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_93(int iParam0) // Position - 0x4A64 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_94(int iParam0, int iParam1) // Position - 0x4A76 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4B10 Hash - 0xA65AB937 ^0xA65AB937
{
	func_150(iParam0, iParam6);
	func_151(iParam0, iParam5);
	func_152(iParam0, iParam4);
	func_153(iParam0, iParam3);
	func_154(iParam0, iParam2);
	func_155(iParam0, iParam1);
	return;
}

BOOL func_96() // Position - 0x4B48 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_97(int iParam0) // Position - 0x4B56 Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

int func_98(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x4B6D Hash - 0xF4BE06E5 ^0x21E9A98D
{
	ItemSet itemSet;
...
Hash func_99(int iParam0) // Position - 0x4C28 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_97(iParam0))
		return 0;
...
BOOL func_100(Hash hParam0) // Position - 0x4C46 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

Ped func_101(int iParam0) // Position - 0x4C52 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
Hash func_102(int iParam0) // Position - 0x4C80 Hash - 0xED567DFA ^0x7CDFEFC2
{
	if (!func_97(iParam0))
		return 0;
...
BOOL func_103(int iParam0, BOOL bParam1) // Position - 0x4CA2 Hash - 0x5C4302E7 ^0x5C4302E7
{
	if (!func_97(iParam0))
		return false;

	if (func_48(iParam0, true) && !func_80(iParam0) && func_144(iParam0))
		return false;
...
PersChar func_104(int iParam0) // Position - 0x4D02 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_97(iParam0))
		return 0;
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x4D22 Hash - 0x61515A20 ^0x61515A20
{
	if (func_96() != -1)
		return;
...
void func_106(int iParam0) // Position - 0x4D53 Hash - 0x5A948764 ^0xFC1342AE
{
	if (!func_97(iParam0))
		return;
...
int func_107(int iParam0, BOOL bParam1) // Position - 0x4D76 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_97(iParam0))
		return 0;
	...
	{
		func_156(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_99(iParam0)));
	
		if (func_96() == -1)
		{
			if (func_48(iParam0, 2048))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_104(iParam0));
				func_145(iParam0, 2048);
			}
		
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_104(iParam0));
		}
	
		return 0;
	}

	if (!func_157(iParam0) && func_96() == -1)
		return 0;
	...
	func_156(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_99(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_104(iParam0));
...
BOOL func_108(int iParam0, BOOL bParam1) // Position - 0x4E61 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_96() != -1)
		return false;
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_101(iParam0)))
		return false;

	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_104(iParam0));
}

BOOL func_109(int iParam0) // Position - 0x4EB9 Hash - 0x365567CB ^0x68796F4
{
	if (!func_97(iParam0))
		return false;
	...
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_104(iParam0)))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_104(iParam0), false)))
			return false;
	}
...
BOOL func_110(int iParam0) // Position - 0x4EFF Hash - 0x895544C2 ^0x895544C2
{
	return iParam0 > -1 && iParam0 < 35;
}

void func_111(int iParam0, int iParam1) // Position - 0x4F15 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_112() // Position - 0x4F26 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_113(int iParam0) // Position - 0x4F79 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_116(iParam0))
		return -1;

	return func_159(func_158(iParam0));
}

BOOL func_114(int iParam0) // Position - 0x4F99 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_115(int iParam0, int iParam1) // Position - 0x4FAF Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_116(int iParam0) // Position - 0x4FBE Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_117(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4FF1 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_160(eptParam1))
		{
			func_161(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_163(pedParam0, false);
			flag = true;
		}
	
		func_164(pedParam0, iParam2);
	}
...
void func_118(Entity eParam0, BOOL bParam1) // Position - 0x50D2 Hash - 0xF55E891F ^0xF55E891F
{
	func_165(eParam0, bParam1);
	return;
}

void func_119(int iParam0, BOOL bParam1) // Position - 0x50E2 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_111(iParam0, 4);
	else
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x5100 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_111(iParam0, 8);
	else
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x5120 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_111(iParam0, 16);
...
void func_122(int iParam0, BOOL bParam1) // Position - 0x514B Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_111(iParam0, 32);
	else
...
void func_123(int iParam0, BOOL bParam1) // Position - 0x516B Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_111(iParam0, 64);
	else
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x518B Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x51AD Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_111(iParam0, 1048576);
	else
...
BOOL func_126(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x51D1 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_166(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_168(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_170(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_168(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_172(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_173(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_174(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_168(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_175(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_168(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_176(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_168(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_176(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_168(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_179(iParam2, 4000))
				{
					if (func_180(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_181(iParam2, pedParam0) && func_182(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_168(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_180(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_181(iParam2, pedParam0) && func_182(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_168(pedParam0, iParam2, *uParam3);
					return true;
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_185(iParam2, pedParam0) || iParam2->f_9 > 0 && func_186() - iParam2->f_9 < 2000)
				{
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_189(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_168(pedParam0, iParam2, *uParam3);
					return true;
...
void func_127(int iParam0, BOOL bParam1) // Position - 0x57FA Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_128(int iParam0) // Position - 0x58D1 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_196(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_196(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_196(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_129(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5952 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_148(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_130(Ped pedParam0) // Position - 0x5A43 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_131(Ped pedParam0) // Position - 0x5A5E Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_132(int iParam0) // Position - 0x5A7A Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_133(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5AC1 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_134(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x5ADF Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_197(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_135(var uParam0) // Position - 0x5B36 Hash - 0x5001E582 ^0x5001E582
{
	return func_198(*uParam0, 1);
}

void func_136(var uParam0) // Position - 0x5B46 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_199(uParam0, 0f);
	return;
}

BOOL func_137(var uParam0, int iParam1) // Position - 0x5B55 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_138(var uParam0) // Position - 0x5B73 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_139(var uParam0, BOOL bParam1) // Position - 0x5B89 Hash - 0xA95D0C2 ^0xA95D0C2
{
	if (bParam1 || !func_135(uParam0))
		func_136(uParam0);

	return;
}

BOOL func_140(var uParam0) // Position - 0x5BA9 Hash - 0x39705408 ^0x39705408
{
	return func_198(*uParam0, 2);
}

void func_141(var uParam0) // Position - 0x5BB9 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_135(uParam0);
...
BOOL func_142(var uParam0, float fParam1) // Position - 0x5BED Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_135(uParam0))
		return false;
...
void func_143(var uParam0) // Position - 0x5C14 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_135(uParam0);
...
BOOL func_144(int iParam0) // Position - 0x5C44 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_97(iParam0))
		return false;
...
void func_145(int iParam0, BOOL bParam1) // Position - 0x5C68 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_96() != -1)
		return;
...
void func_146(int iParam0) // Position - 0x5CA1 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0x5CE5 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_97(iParam0))
		return 0;
	...
	func_146(iParam0);
	PERSCHAR::_DELETE_PERSCHAR(func_104(iParam0));
	func_156(iParam0, 0);
	return 1;
}

BOOL func_148(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5D68 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_149(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5DBD Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_150(int iParam0, int iParam1) // Position - 0x5DD4 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_151(int iParam0, int iParam1) // Position - 0x5E5A Hash - 0x96B01D2A ^0x81E68218
{
...
void func_152(int iParam0, int iParam1) // Position - 0x5E96 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_153(int iParam0, int iParam1) // Position - 0x5EE9 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_154(int iParam0, int iParam1) // Position - 0x5F24 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_155(int iParam0, int iParam1) // Position - 0x5F5D Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_156(int iParam0, PersChar pchParam1) // Position - 0x5F95 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_97(iParam0))
		return;
...
BOOL func_157(int iParam0) // Position - 0x5FB6 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_97(iParam0))
		return false;
...
BOOL func_158(int iParam0) // Position - 0x5FDC Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_159(BOOL bParam0) // Position - 0x601A Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_160(ePedType eptParam0) // Position - 0x602D Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_161(Ped pedParam0, Hash hParam1) // Position - 0x6480 Hash - 0x4D6406DD ^0xFCB8AE48
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_204(pedParam0, hParam1))
		{
			if (func_205(pedParam0, hParam1))
			{
				if (func_206(pedParam0, hParam1))
				{
...
void func_162(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6529 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_163(Ped pedParam0, BOOL bParam1) // Position - 0x6559 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_164(Ped pedParam0, int iParam1) // Position - 0x659E Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_165(Entity eParam0, BOOL bParam1) // Position - 0x65C5 Hash - 0xC07A2C0 ^0x19A8A219
{
...
void func_166(int iParam0, BOOL bParam1, int iParam2) // Position - 0x6601 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_208(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_210(true))
							func_111(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_210(true) || *iParam0 & 8192 != 0)
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_211(iParam0))
				iParam0->f_15 = func_186();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_186() - iParam0->f_15 > 500)
			{
...
BOOL func_167(Ped pedParam0, int iParam1) // Position - 0x67CC Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_213(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_214(pedParam0, pedIndexFromEntityIndex) <= func_215(iParam1))
				return true;
			break;
	}
...
void func_168(Ped pedParam0, int iParam1, int iParam2) // Position - 0x68A4 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_216(iParam2, 1, 1, 1, 0))
		func_111(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_217(iParam1, true);
	func_218();
	return;
}

BOOL func_169(Ped pedParam0, int iParam1) // Position - 0x68E1 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_219(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_221(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_222(iParam1);
...
BOOL func_170(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x69C8 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_223(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_220(iParam2);
	
		if (func_221(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_222(iParam2))
				{
					func_217(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_171(Ped pedParam0, int iParam1) // Position - 0x6A9E Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_213(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_222(iParam1))
		{
			customDistance = func_220(iParam1);
...
BOOL func_172(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6BA7 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_224(bParam1, bParam2, bParam3);
...
BOOL func_173(int iParam0, int iParam1) // Position - 0x6CDC Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_174(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6D13 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_175(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6E1A Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_226(iParam2))
	{
...
BOOL func_176(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6E85 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_228(pedParam1, entityCoords, outCoords))
					{
						func_217(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_228(pedParam1, entityCoords, outCoords2))
					{
						func_217(iParam2, true);
						return true;
					}
...
BOOL func_177(Ped pedParam0, int iParam1) // Position - 0x6FCD Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_213(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_229(Global_1935630.f_34[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false), entityCoords);
		
			if (func_65(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
			...
			if (func_230(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_231(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_232(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_178(var uParam0, int iParam1) // Position - 0x71AD Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_179(int iParam0, int iParam1) // Position - 0x7225 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_180(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7254 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_181(int iParam0, Ped pedParam1) // Position - 0x73DA Hash - 0x42A83B1F ^0x5D65D537
{
	int _int;
...
BOOL func_182(int iParam0, Ped pedParam1) // Position - 0x742A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_235(iParam0))
		return true;
...
BOOL func_183(Ped pedParam0, Ped pedParam1) // Position - 0x74C7 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_236(pedParam0, pedParam1, true, true) < 4f)
...
void func_184() // Position - 0x7514 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_185(int iParam0, Ped pedParam1) // Position - 0x751C Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_237(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_186();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_238(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_186() // Position - 0x75DD Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_187() // Position - 0x75FB Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_188(int iParam0, Ped pedParam1) // Position - 0x7648 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_239(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_240(pedParam1);
	num2 = func_241(iParam0->f_14);
...
BOOL func_189(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x7764 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_242(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_190(Ped pedParam0, int iParam1) // Position - 0x77AC Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_243(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_244(iParam1, pedParam0))
						if (func_238(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x7A05 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_245(0))
		return false;
...
BOOL func_192(int iParam0, int iParam1) // Position - 0x7A3E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_193(var uParam0, int iParam1) // Position - 0x7A6D Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_194(Ped pedParam0, int iParam1) // Position - 0x7A81 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_186();
	else if (func_186() - iParam1->f_4 > func_246(iParam1))
		return func_247(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_195(int iParam0, Ped pedParam1) // Position - 0x7ACE Hash - 0x2978E171 ^0xA04F2503
{
...
void func_196(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7B22 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_248(iParam0) == 1 && bParam7)
		return;
...
float func_197(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7BAE Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_198(int iParam0, int iParam1) // Position - 0x7BCC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_199(var uParam0, float fParam1) // Position - 0x7BDB Hash - 0x30433BAB ^0xF854D531
{
...
float func_200() // Position - 0x7C01 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_201(var uParam0, int iParam1) // Position - 0x7C33 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_202(var uParam0) // Position - 0x7C48 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_135(uParam0))
		return uParam0->f_1;
...
void func_203(var uParam0, int iParam1) // Position - 0x7C7D Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_204(Ped pedParam0, Hash hParam1) // Position - 0x7C8E Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_205(Ped pedParam0, Hash hParam1) // Position - 0x7CBC Hash - 0x294DAA1E ^0x33838EC5
{
	Hash _int;
...
BOOL func_206(Ped pedParam0, Hash hParam1) // Position - 0x7D0C Hash - 0x294DAA1E ^0x33838EC5
{
	Hash _int;
	int _int2;
...
void func_207(Ped pedParam0) // Position - 0x7D7C Hash - 0xE2B15D20 ^0xF8A32AD1
{
...
void func_208(int iParam0) // Position - 0x7D99 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_250(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_209(int iParam0) // Position - 0x7F05 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_210(BOOL bParam0) // Position - 0x7F18 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_251(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_211(int iParam0) // Position - 0x7F32 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_212(int iParam0) // Position - 0x7FCC Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_213(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7FF3 Hash - 0xE8C91E0D ^0x7E10E7AD
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_241(pedParam2);
	else
		num2 = func_240(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_241(pedParam0);
	else
...
float func_214(Ped pedParam0, Ped pedParam1) // Position - 0x80ED Hash - 0xF9959663 ^0xF9959663
{
	return func_236(pedParam0, pedParam1, true, true);
}

float func_215(int iParam0) // Position - 0x80FF Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_216(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x810B Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_217(int iParam0, BOOL bParam1) // Position - 0x8170 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_218() // Position - 0x8196 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_219(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x81AA Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_236(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_254(ped, 0)))
			if (func_255(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_220(int iParam0) // Position - 0x830A Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_221(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x8316 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_222(int iParam0) // Position - 0x8377 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_223(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x8383 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_254(ped, 0)))
			if (func_256(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_224(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8445 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_225(int iParam0) // Position - 0x84E3 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_226(int iParam0) // Position - 0x84EF Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_227(int iParam0) // Position - 0x84FB Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_228(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x8638 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_257(pedParam0, vParam4, 0.5f))
...
BOOL func_229(Ped pedParam0) // Position - 0x867B Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_258(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_230(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x86E1 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_231(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8728 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_232(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x8773 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_233(Ped pedParam0, var uParam1) // Position - 0x87EC Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_234(Ped pedParam0, Ped pedParam1) // Position - 0x8839 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_260(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_235(int iParam0) // Position - 0x8881 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_236(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8891 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_237(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x88D9 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_238(veParam0, uParam2, true);
...
float func_238(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8905 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_239(int iParam0) // Position - 0x892D Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_240(Ped pedParam0) // Position - 0x8939 Hash - 0xEB445B10 ^0xBA9AA075
{
...
int func_241(Ped pedParam0) // Position - 0x8991 Hash - 0x6E063231 ^0x2C3CF94D
{
...
BOOL func_242(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8A01 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_236(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_236(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_243(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8B71 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_251(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_244(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_244(iParam1, ped2))
					if (func_238(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_244(int iParam0, Ped pedParam1) // Position - 0x8C5F Hash - 0x27FC2906 ^0x5343D19
{
...
BOOL func_245(int iParam0) // Position - 0x8CD5 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_261())
		return false;

	return func_262(Global_1347702[58 /*49*/].f_15, true);
}

int func_246(int iParam0) // Position - 0x8CF7 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_247(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8D03 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_248(int iParam0) // Position - 0x8D7E Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_249() // Position - 0x8D91 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_263())
		return false;
...
void func_250(Any* panParam0, int iParam1) // Position - 0x8DE7 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_251(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E92 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_252(int iParam0) // Position - 0x8F59 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_253(int iParam0) // Position - 0x9001 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_254(Ped pedParam0, int iParam1) // Position - 0x9066 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_255(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x907D Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_256(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_256(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x90AB Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_257(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x90F5 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_258(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9136 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_259(Ped pedParam0) // Position - 0x91AF Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_260(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x9297 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_261() // Position - 0x92D9 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_96() != -1)
		return false;
...
BOOL func_262(int iParam0, BOOL bParam1) // Position - 0x92FE Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_263() // Position - 0x932F Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_264(int iParam0) // Position - 0x9360 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_116(iParam0))
		return -1;
...
int func_265(int iParam0) // Position - 0x937C Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_266(int iParam0) // Position - 0x93BD Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
