#region Local Var
	...
	var uLocal_43 = 1065353216;
	var uLocal_44 = 0;
	var uLocal_45 = 0;
	var uLocal_46 = 0;
	var uLocal_47 = 1065353216;
	var uLocal_48 = 1065353216;
	var uLocal_49 = 0;
	var uLocal_50 = 0;
	var uLocal_51 = 0;
	var uLocal_52 = 1065353216;
	var uLocal_53 = 1065353216;
	var uLocal_54 = 0;
	var uLocal_55 = 1040187392;
	var uLocal_56 = 1040187392;
	var uLocal_57 = -1;
	var uLocal_58 = 0;
	var uLocal_59 = 0;
	var uLocal_60 = 0;
...
void main() // Position - 0x0 Hash - 0x2B927B7C ^0x71D20CD7
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	hLocal_78 = func_1(joaat("horse_class_riding"), true);
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
Hash func_1(int iParam0, BOOL bParam1) // Position - 0x586 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_2(var uParam0) // Position - 0x640 Hash - 0x646928F0 ^0x646928F0
{
	func_5(uParam0);
	return;
}

void func_3(var uParam0) // Position - 0x64E Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_4(var uParam0) // Position - 0x6E4 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_5(var uParam0) // Position - 0xA8A Hash - 0x4DA9BC8C ^0x4116B12F
{
	func_34(uParam0, &func_31, &func_32, &func_33);
	return;
}

void func_6(Volume volParam0) // Position - 0xAA4 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_7(var uParam0) // Position - 0xABB Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xB79 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_9(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xBA3 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_10(int iParam0, int iParam1) // Position - 0xCF4 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_11(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD09 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_12(int iParam0) // Position - 0xDAD Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_13(int iParam0) // Position - 0x1B5E Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_44(iParam0))
	{
...
Volume func_14(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1BC4 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_15(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1C7E Hash - 0x6E468719 ^0x51A4031F
{
	int num;
	float heading;
	Hash hash;

	func_47(uParam0, "RIDER_WHISTLING", "", vParam1, uParam4);
	num = 1;
	heading = func_48(vParam1);
	hash = func_1(joaat("horse_class_work"), true);

	if (*uParam0 == 52)
	{
		if (func_49())
			hLocal_77 = joaat("g_m_m_unicriminals_01");
		else
			hLocal_77 = func_51(func_50(), true, false, false, true, false, true);
	
		func_52(uParam0, 0, "RWP_HORSE", hLocal_78, vParam1, heading, num, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_52(uParam0, 2, "RWP_HORSE_2", hash, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, heading, 0f, -4.5f, 0f), heading, num, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
	else
	{
		if (uParam0->f_489 == 1)
			...
			hLocal_77 = func_51(func_50(), true, true, true, true, false, true);
	
		func_52(uParam0, 0, "RWP_HORSE", hLocal_78, vParam1, heading, num, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}

	func_52(uParam0, 1, "RWP_MAN", hLocal_77, vParam1, heading, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_16(var uParam0) // Position - 0x1D82 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_17(var uParam0) // Position - 0x1E22 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_18(var uParam0) // Position - 0x1F3C Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_19(var uParam0) // Position - 0x2105 Hash - 0xA2073E13 ^0x4CEF117A
{
	if (*uParam0 == 52)
		if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(iLocal_112))
			if (!PED::_HAS_META_PED_OUTFIT_LOADED(iLocal_112))
				return 0;
		else
			func_53(uParam0);
...
BOOL func_20(var uParam0) // Position - 0x2136 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_21(var uParam0) // Position - 0x22E6 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_22(int iParam0) // Position - 0x235A Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_23(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x23A9 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_24(var uParam0) // Position - 0x2401 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_25(var uParam0) // Position - 0x256A Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_59(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_26(var uParam0) // Position - 0x2891 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_27(var uParam0) // Position - 0x29C8 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_28(var uParam0) // Position - 0x2AF8 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_29(var uParam0) // Position - 0x2B37 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_30(var uParam0) // Position - 0x2B40 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_31(var uParam0) // Position - 0x2B72 Hash - 0xFB958CDA ^0xFB958CDA
{
	func_61(&uLocal_10, false);
	func_62(&uLocal_10, true);
	func_63(&uLocal_10, true);
	func_64(&uLocal_10, true);
	func_65(&uLocal_10, true);
	func_66(&uLocal_10, true);
	func_67(&uLocal_10, true);
	func_68(&uLocal_10, true);
	func_69(&uLocal_10, true);
	uLocal_79 = { 0f, 0f, 0f };
	uLocal_79.f_8 = 2;
	uLocal_79.f_4 = 21030;
	uLocal_79.f_13 = 0;
...
int func_32(var uParam0) // Position - 0x2C03 Hash - 0x41131EE3 ^0xE1C5E6E
{
	if (*uParam0 == 52)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
		{
			func_70(uParam0->f_20[1 /*14*/], uParam0->f_20[2 /*14*/], false, false, true, false, true, true, false, true, true);
			func_71(uParam0->f_20[2 /*14*/], uParam0->f_20[1 /*14*/], true, false, true, false, true, true, false, true, true);
		
			if (!bLocal_110)
			{
				if (PED::IS_PED_LASSOED(uParam0->f_20[2 /*14*/]))
				{
					TASK::TASK_COMBAT_PED(uParam0->f_20[1 /*14*/], Global_35, 0, 0);
					bLocal_110 = true;
					return 1;
				}
			}
	...
	if (!uParam0->f_469[1])
	{
		if (func_73(uParam0, &uLocal_10, false))
		{
			func_74(uParam0);
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_9)
	{
		case 0:
			if (*uParam0 == 52)
				if (!PED::IS_PED_READY_TO_RENDER(uParam0->f_20[2 /*14*/]))
					return 0;
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_75(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
				func_76(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, 1073741824);
				func_77(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], true, -1, true);
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("weapon_revolver_cattleman"), 999, false, true, 0, false, 1056964608, 1065353216, 752097756, false, 0, false);
				...
				if (*uParam0 == 52)
				{
					...
					PED::_SET_PED_INTERACTION_PERSONALITY(uParam0->f_20[1 /*14*/], joaat("aggressive"));
					func_78(uParam0->f_20[1 /*14*/], uParam0->f_20[2 /*14*/], &uLocal_38, 0f, 0f, 0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1f, 1092616192, -1, true, 0, 0, 0, true);
					PED::_0xAAC0EE3B4999ABB5(uParam0->f_20[1 /*14*/], 0);
				}
			
				TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[1 /*14*/], 0.101f, 132, 0);
				func_79(&uParam0->f_20[1 /*14*/], false, true);
			...
			if (*uParam0 == 52)
			{
				...
				{
					uLocal_107[0] = Global_35;
					PED::_0x34EDDD59364AD74A(uParam0->f_20[2 /*14*/], &uLocal_107);
					PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), uParam0->f_20[2 /*14*/], 5, 0, true);
					PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), uParam0->f_20[2 /*14*/], 27, 0, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 388, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 442, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 136, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 209, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 214, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 419, true);
					iLocal_111 = PED::CREATE_GROUP(0);
					PED::SET_PED_AS_GROUP_LEADER(uParam0->f_20[1 /*14*/], iLocal_111, false);
					PED::SET_PED_AS_GROUP_MEMBER(uParam0->f_20[2 /*14*/], iLocal_111);
					PED::SET_PED_LASSO_HOGTIE_FLAG(uParam0->f_20[2 /*14*/], 0, false);
				
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
					{
						PED::_EQUIP_META_PED_OUTFIT(uParam0->f_20[2 /*14*/], hLocal_76);
						PED::_UPDATE_PED_VARIATION(uParam0->f_20[2 /*14*/], false, true, true, true, false);
					}
				
					func_80(uParam0->f_20[2 /*14*/], uParam0->f_20[1 /*14*/], &uLocal_38, -1082130432, 0, 0, -1082130432, 1f, true, 32, 0, -4.5f, 4.5f, 1073741824, 1050253722, 1067030938, 0, 0, -1, true, -1082130432, -1082130432, true);
				}
			}
		...
		case 1:
			if (func_81(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				func_74(uParam0);
				iLocal_9 = 2;
			}
...
int func_33(var uParam0, var uParam1) // Position - 0x2FEF Hash - 0x6C36480D ^0x1063DBB6
{
	if (*uParam0 == 52)
	{
		if (!(ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/])))
		{
			func_82(uParam0->f_20[1 /*14*/], true);
			func_83(uParam0->f_20[2 /*14*/], true);
		}
	
		if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(iLocal_112))
			PED::_RELEASE_META_PED_OUTFIT_REQUEST(iLocal_112);
	}

	func_84(uParam0, false, false, false);
	return 1;
}

void func_34(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3050 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_35(int iParam0) // Position - 0x306D Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_36(int iParam0) // Position - 0x31A9 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_37(int iParam0) // Position - 0x32E2 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_38(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x338C Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_39(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3404 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_86(entityForwardVector, unk5);
	...
	if (func_87(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_40(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3493 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_41() // Position - 0x35AE Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x35BA Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	for (m = func_96(i, num); num2 > m; m = func_96(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_97(iParam0, l, k, j, num2, i, num);
	return;
}

void func_43(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3742 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_44(int iParam0) // Position - 0x37E2 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_45(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x37F5 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_46(Volume volParam0, BOOL bParam1) // Position - 0x380F Hash - 0xEA796703 ^0x695D7925
{
...
void func_47(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3877 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
float func_48(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x38A3 Hash - 0x8F7EA071 ^0xF9E8D612
{
	float outHeading;
	var outPosition;
	var unk3;
	...
	unk3 = { Global_36 - vParam0 };
	unk3.f_2 = 0f;
	unk3 = { func_98(unk3) };
	unk6 = { -BUILTIN::SIN(outHeading), BUILTIN::COS(outHeading), 0f };

	if (func_99(unk3, unk6) < 0f)
		outHeading = outHeading + 180f;

	return outHeading;
}

BOOL func_49() // Position - 0x390D Hash - 0xEE877ACE ^0xCCE9C802
{
...
int func_50() // Position - 0x392E Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_51(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x393C Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
void func_52(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3B2E Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_53(var uParam0) // Position - 0x3BBC Hash - 0xA2A3D9 ^0xFA86D531
{
	if (uParam0->f_489 == 0)
	...
	switch (uParam0->f_489)
	{
		...
		default:
			hLocal_76 = 1175090374;
			break;
	}

	iLocal_112 = PED::_REQUEST_META_PED_OUTFIT(hLocal_78, hLocal_76);
	return;
}

BOOL func_54(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C37 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_101(Global_1898164.f_1[0 /*5*/]);
	
		if (func_102(num) && func_103(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}

	if (iParam0 == 0 && func_104(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_55(int iParam0) // Position - 0x3E3B Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_56(int iParam0, int iParam1) // Position - 0x3E4F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_57() // Position - 0x3E5E Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_85() != -1;
}

BOOL func_58(var uParam0, Any* panParam1) // Position - 0x3E79 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_59(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3ED8 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_105(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_60(Ped pedParam0) // Position - 0x3F1A Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x3F46 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3FC2 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3FE8 Hash - 0x6EED3367 ^0xD21C1372
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x400C Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x402E Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x4052 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x4074 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_68(var uParam0, BOOL bParam1) // Position - 0x4098 Hash - 0x97140DD8 ^0xA3B87048
{
	if (bParam1)
...
void func_69(int iParam0, BOOL bParam1) // Position - 0x40BE Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_70(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x40E0 Hash - 0x512642D4 ^0x98AD20B9
{
	...
	if (PED::IS_PED_A_PLAYER(pedParam0))
	{
		...
		func_113(bParam4, bParam5, bParam6, bParam7, bParam3, bParam9, bParam10);
...
void func_71(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x414A Hash - 0x512642D4 ^0x98AD20B9
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
	ENTITY::IS_ENTITY_DEAD(eParam1);
...
void func_72(var uParam0) // Position - 0x41B4 Hash - 0x56E8F0BF ^0x87DE6842
{
	Vector3 vector;

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (!PED::_GET_IS_PED_IN_DISPUTE_WITH_PED(uParam0->f_20[1 /*14*/], 0) && func_114(uParam0->f_20[1 /*14*/], Global_35, true) > 225f)
		{
			if (!func_115(&uLocal_104))
			{
				if (bLocal_109)
					vector = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-15f, -5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f) };
				else
					vector = { MISC::GET_RANDOM_FLOAT_IN_RANGE(5f, 15f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f) };
			
				uLocal_79 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[1 /*14*/], vector) };
				uLocal_79.f_7 = 0;
				bLocal_109 = !bLocal_109;
				func_116(&uLocal_104, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 4.5f));
			}
		
			if (func_117(&uLocal_104, 15f))
				func_118(&uLocal_104);
		
			IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &uLocal_79);
		}
	}
...
BOOL func_73(var uParam0, int iParam1, BOOL bParam2) // Position - 0x42AD Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_119(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_74(var uParam0) // Position - 0x4307 Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
	...
	if (!uParam0->f_469[2])
	{
		func_121(*uParam0, uParam0->f_483, false);
		uParam0->f_469[2] = 1;
	}
...
int func_75(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4350 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_76(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x4447 Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_123(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_124(pedParam0))
		if (func_125(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
	...
	if (func_126(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_76(vehiclePedIsIn, vParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_76(mount, vParam1, fParam4, iParam5, iParam6);
			}
	...
	if (func_126(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_126(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_126(iParam5, 32), true);
...
int func_77(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x46C9 Hash - 0x32B863AB ^0xCE62541D
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
void func_78(Ped pedParam0, Ped pedParam1, Any* panParam2, float fParam3, float fParam4, float fParam5, const char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, int iParam14, BOOL bParam15, int iParam16, int iParam17, int iParam18, BOOL bParam19) // Position - 0x470E Hash - 0x2E4DC4EA ^0x436F8340
{
	int num;
	int num2;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam6))
	{
		...
		num.f_7 = iParam16;
		num.f_9 = iParam17;
		TASK::TASK_LEAD_AND_CONVERSE(pedParam0, pedParam1, &num, iParam8, iParam9, iParam10, iParam11, iParam13, fParam12);
	}
	else if (!func_122(fParam3, 0f, 0f, 0f))
	{
		num2 = 0;
		num2.f_1 = { fParam3 };
		num2.f_7 = iParam16;
		num2.f_9 = iParam17;
		num2.f_8 = iParam18;
		TASK::TASK_LEAD_AND_CONVERSE(pedParam0, pedParam1, &num2, iParam8, iParam9, iParam10, iParam11, iParam13, fParam12);
	}
	...
	if (bParam19)
		func_127(pedParam0, pedParam1, iParam14);

	return;
}

void func_79(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x47E5 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_80(Ped pedParam0, Ped pedParam1, Any* panParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, BOOL bParam8, int iParam9, int iParam10, float fParam11, float fParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, BOOL bParam19, int iParam20, int iParam21, BOOL bParam22) // Position - 0x480D Hash - 0xD43A93AF ^0x2E43CB6B
{
	int num;
	...
	{
		TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(pedParam0, pedParam1, iParam4, iParam5, iParam6, fParam7, iParam9, iParam10, fParam11, fParam12, iParam13);
	}
	...
	if (bParam22)
		func_127(pedParam0, pedParam1, iParam18);

	return;
}

BOOL func_81(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x48F0 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_130(fParam2);
		num2 = func_131(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_114(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_115(&(uParam0->f_490)))
							func_132(&(uParam0->f_490));
					
						if (func_133(&(uParam0->f_490), fParam1))
						{
							func_118(&(uParam0->f_490));
							return true;
						}
...
void func_82(Ped pedParam0, BOOL bParam1) // Position - 0x4AFB Hash - 0xE86A6E05 ^0xDD9C6259
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
...
void func_83(Ped pedParam0, BOOL bParam1) // Position - 0x4B45 Hash - 0xF488F7A0 ^0x5D55D9DE
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
	PED::_0xAAC0EE3B4999ABB5(pedParam0, 0);
...
void func_84(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4BD5 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_85() // Position - 0x4D29 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_86(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4D37 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_87(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4D9E Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_88(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4DC7 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_134(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_89(var uParam0, var uParam1, var uParam2) // Position - 0x4E13 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_134(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_90(int iParam0) // Position - 0x4E62 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_91(int iParam0) // Position - 0x4E87 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_92(int iParam0) // Position - 0x4E9A Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_93(int iParam0) // Position - 0x4EAD Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_94(int iParam0) // Position - 0x4EC0 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_95(int iParam0) // Position - 0x4ED2 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_96(int iParam0, int iParam1) // Position - 0x4EE4 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4F7E Hash - 0xA65AB937 ^0xA65AB937
{
	func_136(iParam0, iParam6);
	func_137(iParam0, iParam5);
	func_138(iParam0, iParam4);
	func_139(iParam0, iParam3);
	func_140(iParam0, iParam2);
	func_141(iParam0, iParam1);
	return;
}

Vector3 func_98(float fParam0, var uParam1, var uParam2) // Position - 0x4FB6 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
float func_99(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x4FF5 Hash - 0x9ECDD667 ^0x170D4E4C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL func_100() // Position - 0x500C Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_101(int iParam0) // Position - 0x505F Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_104(iParam0))
		return -1;

	return func_143(func_142(iParam0));
}

BOOL func_102(int iParam0) // Position - 0x507F Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_103(int iParam0, int iParam1) // Position - 0x5095 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_104(int iParam0) // Position - 0x50A4 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_105(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x50D7 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_147(pedParam0, false);
			flag = true;
		}
	
		func_148(pedParam0, iParam2);
	}
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x51B8 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_112(iParam0, 4);
	else
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x51D6 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_112(iParam0, 8);
	else
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x51F6 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_112(iParam0, 16);
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x5221 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_112(iParam0, 32);
	else
...
void func_110(int iParam0, BOOL bParam1) // Position - 0x5241 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_112(iParam0, 64);
	else
...
void func_111(int iParam0, BOOL bParam1) // Position - 0x5261 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_112(iParam0, 1048576);
	else
...
void func_112(int iParam0, int iParam1) // Position - 0x5285 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_113(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5296 Hash - 0x25DC51B ^0x2C9FE3CE
{
	if (bParam5)
...
float func_114(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x53CC Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_150(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_115(var uParam0) // Position - 0x5423 Hash - 0x5001E582 ^0x5001E582
{
	return func_151(*uParam0, 1);
}

void func_116(var uParam0, float fParam1) // Position - 0x5433 Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_152() - fParam1;
	func_153(uParam0, 1);
	func_154(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
BOOL func_117(var uParam0, float fParam1) // Position - 0x5459 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_115(uParam0))
		return false;
...
void func_118(var uParam0) // Position - 0x5480 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_119(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x5496 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_156(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_158(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_160(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_158(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_162(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_163(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_164(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_158(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_165(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_158(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_166(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_158(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_166(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_158(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_169(iParam2, 4000))
				{
					if (func_170(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_171(iParam2, pedParam0) && func_172(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_158(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_170(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_171(iParam2, pedParam0) && func_172(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_158(pedParam0, iParam2, *uParam3);
					return true;
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_175(iParam2, pedParam0) || iParam2->f_9 > 0 && func_176() - iParam2->f_9 < 2000)
				{
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_179(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_158(pedParam0, iParam2, *uParam3);
					return true;
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x5ABF Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_41();
...
void func_121(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5B96 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_41();
	...
	func_186(iParam0);
	func_187(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

BOOL func_122(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x5C9A Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Ped func_123(Ped pedParam0) // Position - 0x5CC3 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_124(Ped pedParam0) // Position - 0x5CCD Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_125(Ped pedParam0) // Position - 0x5CFF Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x5D41 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_127(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5D50 Hash - 0xF6D5211C ^0xAA9A46C4
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
...
BOOL func_128(Ped pedParam0) // Position - 0x5D8A Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_129(Ped pedParam0) // Position - 0x5DA5 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_130(float fParam0) // Position - 0x5DC1 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_131(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5E08 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_132(var uParam0) // Position - 0x5E26 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_116(uParam0, 0f);
	return;
}

BOOL func_133(var uParam0, float fParam1) // Position - 0x5E35 Hash - 0xBBD67703 ^0xBBD67703
{
...
BOOL func_134(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5E53 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_135(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5EA8 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_136(int iParam0, int iParam1) // Position - 0x5EBF Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_137(int iParam0, int iParam1) // Position - 0x5F45 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_138(int iParam0, int iParam1) // Position - 0x5F81 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_96(num, num2))
		return;
...
void func_139(int iParam0, int iParam1) // Position - 0x5FD4 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_140(int iParam0, int iParam1) // Position - 0x600F Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_141(int iParam0, int iParam1) // Position - 0x6048 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_142(int iParam0) // Position - 0x6080 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_143(BOOL bParam0) // Position - 0x60BE Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_144(ePedType eptParam0) // Position - 0x60D1 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_145(Ped pedParam0, Hash hParam1) // Position - 0x6524 Hash - 0xDA681702 ^0xF7BC0D12
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_146(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x65CB Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_147(Ped pedParam0, BOOL bParam1) // Position - 0x65FB Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_148(Ped pedParam0, int iParam1) // Position - 0x6640 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_149(BOOL bParam0) // Position - 0x6667 Hash - 0x67777C1C ^0xA5A55B03
{
	if (bParam0)
		func_192(4);
...
float func_150(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6689 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x66A7 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_152() // Position - 0x66B6 Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_153(var uParam0, int iParam1) // Position - 0x66E8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_154(var uParam0, int iParam1) // Position - 0x66F9 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_155(var uParam0) // Position - 0x670E Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_115(uParam0))
		return uParam0->f_1;
	...
	return func_152() - uParam0->f_1;
}

void func_156(int iParam0, BOOL bParam1, int iParam2) // Position - 0x6743 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_194(iParam2);
...
BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x690E Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_158(Ped pedParam0, int iParam1, int iParam2) // Position - 0x69E5 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6A22 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_160(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6B09 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6BDF Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_162(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6CE8 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x6E1D Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_164(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6E54 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_165(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6F5B Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_166(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6FC6 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_167(Ped pedParam0, int iParam1) // Position - 0x710E Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	for (i = 0; i < Global_1935630.f_39; i = i + 1)
	{
		...
		else
		{
			...
			if (func_60(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
...
BOOL func_168(var uParam0, int iParam1) // Position - 0x72EA Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0x7362 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_170(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7391 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_171(int iParam0, Ped pedParam1) // Position - 0x7517 Hash - 0x6AF03725 ^0xC539EF34
{
	int _int;
...
BOOL func_172(int iParam0, Ped pedParam1) // Position - 0x7564 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_221(iParam0))
		return true;
...
BOOL func_173(Ped pedParam0, Ped pedParam1) // Position - 0x7601 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_174() // Position - 0x764E Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_175(int iParam0, Ped pedParam1) // Position - 0x7656 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_176() // Position - 0x7717 Hash - 0xE698BCC8 ^0x3E64CD04
{
	int networkTimeAccurate;
...
BOOL func_177() // Position - 0x7735 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_178(int iParam0, Ped pedParam1) // Position - 0x7782 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_179(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x789E Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_180(Ped pedParam0, int iParam1) // Position - 0x78E6 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_181(Ped pedParam0, int iParam1) // Position - 0x7B3F Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_231(0))
		return false;
...
BOOL func_182(int iParam0, int iParam1) // Position - 0x7B78 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_183(var uParam0, int iParam1) // Position - 0x7BA7 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_184(Ped pedParam0, int iParam1) // Position - 0x7BBB Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_176() - iParam1->f_4 > func_232(iParam1))
		return func_233(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_185(int iParam0, Ped pedParam1) // Position - 0x7C08 Hash - 0x306991E1 ^0xF8FA656D
{
...
void func_186(int iParam0) // Position - 0x7C5B Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_44(iParam0))
	{
		...
		{
			case 1:
				func_234(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_234(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_234(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_187(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7CDC Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_134(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_188(Ped pedParam0, Hash hParam1) // Position - 0x7DCD Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_189(Ped pedParam0, Hash hParam1) // Position - 0x7DFB Hash - 0xF6091507 ^0xAD1943A1
{
	Hash _int;
...
BOOL func_190(Ped pedParam0, Hash hParam1) // Position - 0x7E49 Hash - 0xF6091507 ^0xAD1943A1
{
	Hash _int;
	int _int2;
...
void func_191(Ped pedParam0) // Position - 0x7EB7 Hash - 0xDDFA2C1F ^0xFD22A3F2
{
...
void func_192(int iParam0) // Position - 0x7ED3 Hash - 0x3A524DDA ^0x3A524DDA
{
	Global_1900383.f_316 = Global_1900383.f_316 || iParam0;
	return;
}

BOOL func_193(var uParam0) // Position - 0x7EEC Hash - 0x39705408 ^0x39705408
{
	return func_151(*uParam0, 2);
}

void func_194(int iParam0) // Position - 0x7EFC Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_236(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_195(int iParam0) // Position - 0x806A Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_196(BOOL bParam0) // Position - 0x807D Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_237(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_197(int iParam0) // Position - 0x8097 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_198(int iParam0) // Position - 0x812F Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_199(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x8156 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_200(Ped pedParam0, Ped pedParam1) // Position - 0x824F Hash - 0xF9959663 ^0xF9959663
{
	return func_222(pedParam0, pedParam1, true, true);
}

float func_201(int iParam0) // Position - 0x8261 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_202(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x826D Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_203(int iParam0, BOOL bParam1) // Position - 0x82D2 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_204() // Position - 0x82F8 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_205(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x830C Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_241(ped, 0)))
			if (func_242(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_206(int iParam0) // Position - 0x846C Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_207(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x8478 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_208(int iParam0) // Position - 0x84D9 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_209(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x84E5 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_241(ped, 0)))
			if (func_243(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_210(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x85A7 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_211(int iParam0) // Position - 0x8645 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_212(int iParam0) // Position - 0x8651 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_213(int iParam0) // Position - 0x865D Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_214(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x879A Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_244(pedParam0, vParam4, 0.5f))
...
BOOL func_215(Ped pedParam0) // Position - 0x87DD Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_245(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_216(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8843 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_217(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x888A Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_218(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x88D5 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_219(Ped pedParam0, var uParam1) // Position - 0x894E Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_220(Ped pedParam0, Ped pedParam1) // Position - 0x899B Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_247(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_221(int iParam0) // Position - 0x89E3 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_222(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x89F3 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_223(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8A3B Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_224(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8A67 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_225(int iParam0) // Position - 0x8A8F Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_226(Ped pedParam0) // Position - 0x8A9B Hash - 0x1D6A0697 ^0x8E50F180
{
...
int func_227(Ped pedParam0) // Position - 0x8AEF Hash - 0x113FC06E ^0x5A4574AA
{
...
BOOL func_228(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8B59 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_229(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8CC9 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_237(true, &ped, &ped2);
...
BOOL func_230(int iParam0, Ped pedParam1) // Position - 0x8DB7 Hash - 0x27FC2906 ^0xC7B1CA0F
{
...
BOOL func_231(int iParam0) // Position - 0x8E2D Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_248())
		return false;
...
int func_232(int iParam0) // Position - 0x8E4F Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_233(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8E5B Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_234(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x8ED6 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_235() // Position - 0x8F62 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_251())
		return false;
...
void func_236(Any* panParam0, int iParam1) // Position - 0x8FB8 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_237(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9060 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_238() // Position - 0x9127 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_239(int iParam0) // Position - 0x9135 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_240(int iParam0) // Position - 0x91DD Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_241(Ped pedParam0, int iParam1) // Position - 0x9242 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_242(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x9259 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_243(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_243(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x9287 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_244(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x92D1 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_245(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9312 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_246(Ped pedParam0) // Position - 0x938B Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_247(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x9473 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_248() // Position - 0x94B5 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_238() != -1)
		return false;
...
BOOL func_249(int iParam0, BOOL bParam1) // Position - 0x94DA Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_250(int iParam0) // Position - 0x950B Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_251() // Position - 0x951E Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_252(int iParam0) // Position - 0x954F Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_104(iParam0))
		return -1;
...
int func_253(int iParam0) // Position - 0x956B Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_254(int iParam0) // Position - 0x95AC Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
