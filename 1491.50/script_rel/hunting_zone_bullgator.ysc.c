...
BOOL func_4() // Position - 0x5FA Hash - 0xC67DD2B2 ^0xC67DD2B2
{
	return !func_34(68);
}

BOOL func_5(var uParam0) // Position - 0x609 Hash - 0xBA3CD49A ^0x8BDBEB72
{
	BOOL flag;
	BOOL flag2;
	int num;
	...
	if (uParam0->f_11 > 0)
	{
		...
		if (func_35() || func_36(Global_1935630, 131072))
			flag = true;
	
		if (SCRIPTS::IS_THREAD_EXIT_REQUESTED() && SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("Hunting1")) == 0 && !func_37(15))
		{
			flag = true;
		}
		else if (func_38() && *uParam0 != 0)
		{
			num = func_39(0);
		...
		else if (func_40(PLAYER::PLAYER_ID(), true, false, true))
		{
		...
		if (flag)
		{
			if (uParam0->f_622)
			{
				...
				if (!flag2)
					func_42(Global_35, "HUNTING_LOST_TRAIL", joaat("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
...
BOOL func_6(var uParam0) // Position - 0x799 Hash - 0xD9E3A7D5 ^0xBB379E2E
{
	switch (uParam0->f_11)
	{
		case 0:
		...
		case 2:
			if (uParam0->f_623)
				PED::_RESERVE_AMBIENT_PEDS(func_45(0) + 1);
			else
		...
		case 3:
			if (PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY() && func_47(uParam0))
				uParam0->f_11 = 4;
			break;
		...
		case 8:
			if (func_54(func_26(joaat("killed"), func_24(*uParam0))) < 1)
				func_27(func_26(joaat("killed"), func_24(*uParam0)), 1);
...
int func_7(int iParam0) // Position - 0x9E9 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_8(int iParam0) // Position - 0xA0E Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_9(int iParam0) // Position - 0xA21 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_10(int iParam0) // Position - 0xA34 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_11(int iParam0) // Position - 0xA47 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_12(int iParam0) // Position - 0xA59 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_13(int iParam0, int iParam1) // Position - 0xA6B Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_14(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB05 Hash - 0xA65AB937 ^0xA65AB937
{
	func_57(hParam0, iParam6);
	func_58(hParam0, iParam5);
	func_59(hParam0, iParam4);
	func_60(hParam0, iParam3);
	func_61(hParam0, iParam2);
	func_62(hParam0, iParam1);
	return;
}

Hash func_15(int iParam0) // Position - 0xB3D Hash - 0xED7149D6 ^0x70CFB709
{
	switch (iParam0)
	{
		case 0:
...
Hash func_16(int iParam0) // Position - 0xC2D Hash - 0x2AB77E3A ^0xDDF0AC0D
{
	switch (iParam0)
	{
		case 0:
...
void func_17(BOOL bParam0, int iParam1) // Position - 0xD1D Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
BOOL func_18(int iParam0) // Position - 0xD63 Hash - 0x6F6E313E ^0xFDA66EDA
{
	int num;
	int num2;
	int offset;
...
int func_19(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xDA8 Hash - 0x16C9DD13 ^0x16C9DD13
{
	int i;
	int num;
	int num2;
					...
					if (bParam3)
					{
						...
						else
						{
							if (bParam2)
							{
								...
								{
									num3 = func_73(Global_35, func_72(i), true);
...
void func_20(int iParam0, int iParam1, int iParam2) // Position - 0xE50 Hash - 0xAB9DB255 ^0xDE3F0264
{
...
BOOL func_21(Ped pedParam0) // Position - 0xE77 Hash - 0x8F7DFED5 ^0x8768F0B4
{
	var lootTarget;
...
Entity func_22(Ped pedParam0) // Position - 0xEE1 Hash - 0x3D354C79 ^0x6A3F9034
{
	Entity lootTarget;
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xF41 Hash - 0xF955E936 ^0xF52EED36
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	if (num2 > 0 && num2 < 15)
	{
		...
		for (i = 0; i < num2; i = i + 1)
		{
			...
			if (func_76(unk[i], 369710026, &num))
			{
				num = num - func_77(unk[i], 1);
			
				if (num > 0)
					if (func_78(unk[i], 1))
						if (!func_79(unk[i], 1, num))
							flag = false;
						else
							flag2 = true;
			}
		
			if (bParam1 && func_76(unk[i], -768110908, &num))
			{
				num = num - func_77(unk[i], 0);
			
				if (num > 0)
					if (func_78(unk[i], 0))
						if (!func_79(unk[i], 0, num))
							flag = false;
						else
							flag2 = true;
			}
		...
		if (flag)
		{
			...
			func_80(&(Global_20710.f_2407), num3);
...
Hash func_24(int iParam0) // Position - 0x1081 Hash - 0xB8EC44B7 ^0x7CA82820
{
	switch (iParam0)
	{
		case 0:
...
void func_25(Hash hParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1172 Hash - 0x1E507D43 ^0xD4646B2A
{
...
struct<2> func_26(int iParam0, Hash hParam1) // Position - 0x1224 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_27(var uParam0, var uParam1, int iParam2) // Position - 0x123A Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

void func_28(Volume volParam0) // Position - 0x124A Hash - 0x4A7DD833 ^0xF771448B
{
	var volumeCoords;
	...
	func_83(volumeCoords, 0);
	return;
}

void func_29(var uParam0, Volume volParam1, BOOL bParam2) // Position - 0x1272 Hash - 0x2EB65318 ^0x737362FB
{
...
int func_30() // Position - 0x12AA Hash - 0x710DEC78 ^0x710DEC78
{
	return 9;
}

void func_31(Volume volParam0) // Position - 0x12B4 Hash - 0x7DD010A2 ^0x16530136
{
	if (VOLUME::DOES_VOLUME_EXIST(volParam0))
...
void func_32(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x12CB Hash - 0xDB5555BD ^0xDAB11740
{
	int num;

	if (bParam1 && !func_84(*uParam0))
	{
		*uParam0 = 0;
		return;
	}
...
void func_33(var uParam0) // Position - 0x131F Hash - 0x6E0E5DAC ^0x576FCDC5
{
	if (uParam0->f_680)
	{
		AUDIO::_0x6AB944DF68B512D3(uParam0->f_679);
...
BOOL func_34(int iParam0) // Position - 0x135F Hash - 0x6E1FF8D2 ^0xA37D6FD2
{
	if (func_65() != -1)
		return false;
	...
	return func_88(Global_1347702[iParam0 /*49*/].f_15, true);
}

BOOL func_35() // Position - 0x1390 Hash - 0x7DF1A9A5 ^0x80A37AC6
{
	return func_36(Global_1935630, 4096) || SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("respawn_dump_body")) > 0;
}

BOOL func_36(int iParam0, int iParam1) // Position - 0x13B4 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_37(int iParam0) // Position - 0x13C3 Hash - 0xBF7DEF91 ^0x6E26B7C2
{
	if (!(iParam0 > -1 && iParam0 <= 80))
		return false;

	return func_89(Global_1835011[iParam0 /*74*/].f_1);
}

BOOL func_38() // Position - 0x13EF Hash - 0x4228A1C2 ^0x70D4FBDE
{
	return Global_1898164.f_163;
}

int func_39(int iParam0) // Position - 0x13FD Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_40(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1411 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
void func_41(int iParam0, BOOL bParam1) // Position - 0x1546 Hash - 0x8A4CBA15 ^0x8A4CBA15
{
	int num;
	int num2;
...
BOOL func_42(Ped pedParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1573 Hash - 0x281BDD5E ^0x8899ECCD
{
	char* str;
	...
	str.f_5 = iParam4;
	str.f_6 = iParam7;
	return func_94(pedParam0, &str);
}

BOOL func_43(var uParam0) // Position - 0x15BA Hash - 0xEC5E9552 ^0xFA2A76BD
{
	uParam0->f_677 = "AZ_Legendary_Bayou_Bullgator";
	uParam0->f_678 = "Bayou_Bullgator_MixGroup";
	uParam0->f_679 = -856398593;
	*uParam0 = 7;
	uParam0->f_1 = 3;
	uParam0->f_572[0] = joaat("brokensticks_ab");
	uParam0->f_572[1] = joaat("p_gatorkillremain01x");
	uParam0->f_572[2] = joaat("p_gatorkillremain01x");
	uParam0->f_580[0] = 4;
	uParam0->f_580[1] = 2;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = joaat("a_c_alligator_02");
	uParam0->f_12.f_4 = 1f;
	return true;
}

BOOL func_44(var uParam0) // Position - 0x1670 Hash - 0x90008B47 ^0xA0ACAD4E
{
	float num;
	var unk;
	var unk6;
	...
	if (*uParam0 == 1)
		if (func_96(123) || func_97(123) || func_98(123))
			return true;
		else
			num = 10f;
	else if (*uParam0 == 13)
...
int func_45(int iParam0) // Position - 0x1787 Hash - 0x7F390DDD ^0x7F390DDD
{
	int num;
...
void func_46(var uParam0) // Position - 0x17BD Hash - 0xF060930F ^0x679498F2
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x1807 Hash - 0x7B76A2ED ^0x317722B6
{
	int i;
...
BOOL func_48(var uParam0) // Position - 0x18CC Hash - 0xA0F05319 ^0x8CC52E7B
{
	float scaleX;
	...
	func_99(uParam0->f_3, "Hunting Zone Target Pending", false, 0, 8192, false, -1082130432);
	return true;
}

BOOL func_49(var uParam0) // Position - 0x1913 Hash - 0xC25AB6F8 ^0xC25AB6F8
{
	int i;
	int j;

	for (i = 0; i < func_100(); i = i + 1)
	{
		for (j = 0; j < func_45(i); j = j + 1)
		{
			func_101(uParam0, i, j);
...
BOOL func_50(var uParam0) // Position - 0x195E Hash - 0x10BF63DF ^0x638AC662
{
	int i;
	float radius;
	var unk;
	...
	uParam0->f_12.f_13 = { 0f, 0f, func_102(0) };
	...
	if (uParam0->f_12.f_1 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		{
			if (uParam0->f_12.f_5)
				...
				uParam0->f_12 = func_103(uParam0->f_12.f_1, uParam0->f_12.f_10, 0, true, true, 0, true, false, true, false, false, false, false);
	...
	for (i = 0; i < func_30(); i = i + 1)
	{
		if (uParam0->f_31[i /*36*/].f_4 != 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[i /*36*/].f_1) && uParam0->f_31[i /*36*/].f_28 < 3)
			{
				...
				{
					uParam0->f_31[i /*36*/].f_2 = func_103(uParam0->f_31[i /*36*/].f_4, uParam0->f_31[i /*36*/].f_17, 0, true, true, 0, true, true, true, false, false, false, false);
				
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[i /*36*/].f_2))
					{
						func_105(uParam0->f_31[i /*36*/].f_2, false, false);
					...
					uParam0->f_31[i /*36*/].f_1 = func_106(uParam0->f_31[i /*36*/].f_2);
				}
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[i /*36*/].f_1))
				{
					...
					unk6 = { func_107(unk3, 1.5f) };
					unk9 = { func_107(unk3, num) };
					...
					func_108(&uParam0->f_630[1 /*8*/], 50, 10, false);
					func_108(&uParam0->f_630[2 /*8*/], 50, 10, false);
					func_108(&uParam0->f_630[3 /*8*/], 50, 10, false);
					func_108(&uParam0->f_630[4 /*8*/], 50, 10, false);
					TASK::_CREATE_WAYPOINT_PATH(func_109(&(uParam0->f_31[i /*36*/].f_29)), &(uParam0->f_630), 5, 0);
				}
...
void func_51(var uParam0) // Position - 0x1EFE Hash - 0x85508A28 ^0x573D2B47
{
	float num;
	int num2;
	int i;
	...
	for (i = 0; i < func_30(); i = i + 1)
	{
		...
		if (uParam0->f_31[i /*36*/].f_13)
		{
			...
			num3 = func_110(Global_35, uParam0->f_31[i /*36*/].f_17, true);
...
void func_52(var uParam0) // Position - 0x1FC4 Hash - 0x46A37087 ^0x6FADEB49
{
	int i;
	int duration;
	int num;
	...
	for (i = 0; i < uParam0->f_618; i = i + 1)
	{
		if (!uParam0->f_31[i /*36*/].f_14)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[i /*36*/].f_1))
			{
				num3 = func_111(Global_35, uParam0->f_31[i /*36*/].f_1, true);
				...
				if (uParam0->f_31[i /*36*/].f_13 && num3 < 2500f && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_31[i /*36*/].f_1))
				{
					...
					if (num3 < 6.25f && !func_112() && !isPedOnMount)
					{
						flag2 = false;
					
						if (!func_84(uParam0->f_31[i /*36*/].f_16))
						{
							uParam0->f_31[i /*36*/].f_16 = func_113("INSPECT_GENERIC", joaat("INPUT_CONTEXT_Y"), uParam0->f_31[i /*36*/].f_1, 2, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("MEDIUM_TIMED_EVENT"), false, false);
							func_114(uParam0->f_31[i /*36*/].f_16, 2.5f, false);
							func_115(&(uParam0->f_31[i /*36*/].f_16), uParam0->f_31[i /*36*/].f_1);
						}
						else if (uParam0->f_31[i /*36*/].f_8 == 5)
						{
							HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(Global_35, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[i /*36*/].f_1), func_109(&(uParam0->f_31[i /*36*/].f_31)), 2);
						}
						else
						{
							HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(uParam0->f_31[i /*36*/].f_1, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[i /*36*/].f_1), func_109(&(uParam0->f_31[i /*36*/].f_31)), 2);
						}
					
						if (func_116(uParam0->f_31[i /*36*/].f_16, true))
						{
							...
							if (uParam0->f_614 == 0)
								func_42(Global_35, "HUNTING_START", joaat("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
						
							func_117(uParam0->f_31[i /*36*/].f_16, false, true);
							...
							func_118(uParam0, uParam0->f_31[i /*36*/].f_27);
						}
					}
					...
					if (flag2 && func_84(uParam0->f_31[i /*36*/].f_16))
						func_32(&(uParam0->f_31[i /*36*/].f_16), true, true);
				}
		...
		else if (uParam0->f_31[i /*36*/].f_15)
		{
			if (uParam0->f_31[i /*36*/].f_8 == 5)
				HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(Global_35, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[i /*36*/].f_1), func_109(&(uParam0->f_31[i /*36*/].f_33)), 2);
			else
				HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(uParam0->f_31[i /*36*/].f_1, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[i /*36*/].f_1), func_109(&(uParam0->f_31[i /*36*/].f_33)), 2);
		
			gameTimer = MISC::GET_GAME_TIMER();
		
			if (gameTimer - uParam0->f_31[i /*36*/].f_25 > num2 || gameTimer - uParam0->f_31[i /*36*/].f_25 > duration && !func_119(Global_35, SCRIPT_TASK_PERFORM_SEQUENCE))
			{
				func_120(uParam0->f_614 - 1, *uParam0);
				func_32(&(uParam0->f_31[i /*36*/].f_16), true, true);
			...
			{
				func_121(uParam0->f_12, func_109(&(uParam0->f_31[i /*36*/].f_29)), true, 0.762f, 1053609165, 0, 2f, true);
			
				if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_31[i /*36*/].f_10))
					func_122(uParam0->f_31[i /*36*/].f_10);
	...
	if (uParam0->f_614 > 0)
	{
		if (!uParam0->f_624)
		{
			...
			else if (func_110(Global_35, uParam0->f_12.f_10, true) > 400f && !CAM::IS_SPHERE_VISIBLE(uParam0->f_12.f_10, 1f))
			{
				uParam0->f_621 = 1;
				func_124(uParam0);
				uParam0->f_624 = 1;
...
void func_53(var uParam0) // Position - 0x2685 Hash - 0x271CC8B9 ^0x72DC5E80
{
	int taskSequenceId;
	float num;
	...
	{
		if (func_110(uParam0->f_12, uParam0->f_12.f_16, true) >= 2500f && func_111(Global_35, uParam0->f_12, true) > 400f && !PED::IS_PED_INJURED(uParam0->f_12) && !func_119(uParam0->f_12, SCRIPT_TASK_PERFORM_SEQUENCE))
		{
			func_125(uParam0);
			uParam0->f_12.f_2 = 1;
			num = 3f;
	...
	else if (func_110(uParam0->f_12, uParam0->f_12.f_16, true) >= 100f)
	{
		uParam0->f_12.f_2 = 0;
	}
...
int func_54(var uParam0, var uParam1) // Position - 0x277A Hash - 0x3AAD93D4 ^0x6348F3E3
{
	int unk;
...
BOOL func_55(var uParam0) // Position - 0x278D Hash - 0x26561433 ^0x8D630CC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		return true;
...
var func_56(BOOL bParam0, var uParam1, var uParam2) // Position - 0x27C2 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_57(Hash hParam0, int iParam1) // Position - 0x27D9 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_58(Hash hParam0, int iParam1) // Position - 0x285F Hash - 0x96B01D2A ^0x81E68218
{
...
void func_59(Hash hParam0, int iParam1) // Position - 0x289B Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_60(Hash hParam0, int iParam1) // Position - 0x28EE Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_61(Hash hParam0, int iParam1) // Position - 0x2929 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_62(Hash hParam0, int iParam1) // Position - 0x2962 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_63(Hash hParam0, int iParam1) // Position - 0x299A Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_64() // Position - 0x29AD Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_65() // Position - 0x29CC Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_66(int iParam0) // Position - 0x29DA Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

int func_67(int iParam0) // Position - 0x29F0 Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_68(int iParam0) // Position - 0x2E44 Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_126(iParam0, 1);
}

int func_69(int iParam0) // Position - 0x2E54 Hash - 0xA776614E ^0xA776614E
{
	if (!func_66(iParam0))
		return -1;

	if (iParam0 == 34 && func_127() == MICRO)
		return 128;
...
BOOL func_70(int iParam0) // Position - 0x329A Hash - 0x14DDF3C9 ^0xAD14D790
{
...
BOOL func_71(int iParam0) // Position - 0x32E3 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_128(iParam0))
		return false;
...
Vector3 func_72(int iParam0) // Position - 0x3304 Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_66(iParam0))
		return 0f, 0f, 0f;
...
float func_73(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3B2B Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_74(int iParam0) // Position - 0x3B53 Hash - 0x23547602 ^0x23547602
{
	switch (iParam0)
	{
		case 0:
...
int func_75(int iParam0, var uParam1) // Position - 0x3C4A Hash - 0x4931B454 ^0x88362C28
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_76(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3DAB Hash - 0x49B3EF5C ^0x9505D01C
{
	var data;
	int size;
	int collectionId;
	...
	if (!func_130(hParam0, 0))
		return false;

	*uParam2 = 0;
	data = { func_131(joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0, hParam1, 0, -1, 0, 0) };
	...
	if (collectionId != -1)
	{
		...
		for (i = 0; i < size; i = i + 1)
		{
			...
			{
				if (func_132(outKey, hParam1, &unk10, &num, true, false))
				{
					for (j = 0; j < num; j = j + 1)
					{
...
int func_77(Hash hParam0, int iParam1) // Position - 0x3E5E Hash - 0x3B4883DD ^0xBE4A62CA
{
	var unk;
	var guid;
	...
	unk = { func_133(false) };
	unk.f_4 = func_134(iParam1);
	guid = { func_135(hParam0, unk, unk.f_4, false) };

	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&guid))
		return 0;

	inventoryItemCountWithGuid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_136(false), &guid, false);
	return inventoryItemCountWithGuid;
}

BOOL func_78(Hash hParam0, int iParam1) // Position - 0x3EB9 Hash - 0xD7B4F3C5 ^0x943C8C22
{
	var unk;
	int num;
	int num2;
	...
	if (!func_137(hParam0, unk.f_4))
		return false;

	num = func_138(hParam0, &unk, true, false);
	num2 = func_139(hParam0, false);
...
BOOL func_79(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F17 Hash - 0xC758F57F ^0x801747D0
{
	int num;
	var unk;
	var unk6;

	if (!func_78(hParam0, iParam1))
		return false;

	if (iParam1 == 1)
	{
		if (func_140(hParam0) && func_141(hParam0))
		{
			num = 0;
		
			if (func_76(hParam0, 369710026, &num))
				iParam2 = num;
		}
	}
	...
	if (!func_142(hParam0, &unk6, &unk, iParam2, 752097756, true))
		return false;

	return true;
}

void func_80(var uParam0, int iParam1) // Position - 0x3F8E Hash - 0xF55E891F ^0xF55E891F
{
	func_143(uParam0, iParam1);
	return;
}

int func_81(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F9E Hash - 0xB04D1B6E ^0xB04D1B6E
{
	switch (hParam0)
	{
...
void func_82(int iParam0, int iParam1) // Position - 0x5B4F Hash - 0xF5E9551B ^0xF5E9551B
{
	int i;
...
void func_83(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x5BA7 Hash - 0x303BFB8D ^0xBCF80455
{
	int i;
...
BOOL func_84(int iParam0) // Position - 0x5C2B Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
int func_85(int iParam0) // Position - 0x5C6A Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

void func_86(int iParam0) // Position - 0x5C74 Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_148(iParam0))
		return;
...
BOOL func_87(int iParam0) // Position - 0x5D27 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_88(int iParam0, BOOL bParam1) // Position - 0x5D3D Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_89(int iParam0) // Position - 0x5D6E Hash - 0xCAB4B86D ^0xCAB4B86D
{
	int num;
...
BOOL func_90(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5D8C Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
void func_91(int iParam0, var uParam1, var uParam2) // Position - 0x5E2A Hash - 0xE3170F06 ^0xE3170F06
{
	int num;
...
BOOL func_92(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x5E46 Hash - 0x7B1D1D5F ^0x7B1D1D5F
{
	...
	if (Global_1898164.f_163 && !func_153(iParam0, 1) || func_154(32768))
		if (!func_153(iParam0, 262144) || !Global_1905944.f_5696)
			return false;
...
void func_93(int iParam0, int iParam1) // Position - 0x5EE8 Hash - 0x978E21B ^0xA1438975
{
	int address;
...
BOOL func_94(Ped pedParam0, Any* panParam1) // Position - 0x5F0C Hash - 0x2ACCF512 ^0x38357878
{
	return AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, panParam1);
}

BOOL func_95(int iParam0) // Position - 0x5F1C Hash - 0x7F255B4B ^0xCD4BFF4B
{
	if (!(iParam0 > -1 && iParam0 <= 80))
		return false;

	if (Global_1572887.f_12 == -1)
		return func_88(Global_1835011[iParam0 /*74*/].f_1, true);

	return UNLOCK::UNLOCK_IS_UNLOCKED(Global_1835011[iParam0 /*74*/].f_2) && !UNLOCK::UNLOCK_IS_VISIBLE(Global_1835011[iParam0 /*74*/].f_2);
}

BOOL func_96(int iParam0) // Position - 0x5F7B Hash - 0x107F2F0B ^0xDB4FB10D
{
	if (func_65() != -1)
		return false;
	...
	return func_156(Global_1347702[iParam0 /*49*/].f_15);
}

BOOL func_97(int iParam0) // Position - 0x5FAB Hash - 0x107F2F0B ^0xDB4FB10D
{
	if (func_65() != -1)
		return false;
	...
	return func_89(Global_1347702[iParam0 /*49*/].f_15);
}

BOOL func_98(int iParam0) // Position - 0x5FDB Hash - 0xAD2044D7 ^0xA119206F
{
	if (func_65() != -1)
		return false;

	if (SCRIPTS::IS_THREAD_ACTIVE(Global_1347702[iParam0 /*49*/].f_42, false) && !func_89(Global_1347702[iParam0 /*49*/].f_15) && !func_157(Global_1347702[iParam0 /*49*/].f_13, 4))
		return true;

	return false;
}

Volume func_99(Volume volParam0, char* sParam1, BOOL bParam2, Entity eParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x602F Hash - 0x6F9FCD12 ^0xB17393EA
{
	var volumeCoords;
	float volumeScale;
	Volume volume;
	...
	volume = func_158(volumeCoords, volumeScale, sParam1, bParam2, eParam3, iParam4, bParam5, iParam6);
	return volume;
}

int func_100() // Position - 0x6073 Hash - 0xDF9E118A ^0xDF9E118A
{
	return 3;
}

void func_101(var uParam0, int iParam1, int iParam2) // Position - 0x607C Hash - 0x8F422A6A ^0x6E6CA92A
{
	uParam0->f_31[uParam0->f_618 /*36*/].f_4 = uParam0->f_572[iParam1];
	uParam0->f_31[uParam0->f_618 /*36*/].f_5 = 0;
	uParam0->f_31[uParam0->f_618 /*36*/].f_17 = { func_159(iParam1, iParam2) };
	uParam0->f_31[uParam0->f_618 /*36*/].f_23 = func_160(iParam1, iParam2);
	...
	else if (uParam0->f_580[iParam1] == 5)
	{
		...
		uParam0->f_31[uParam0->f_618 /*36*/].f_33 = { func_166() };
	}
	...
	if (iParam1 == 0)
	{
		...
		func_167(&(uParam0->f_31[uParam0->f_618 /*36*/].f_10), uParam0->f_31[uParam0->f_618 /*36*/].f_17, 0f, 0f, 0f, uParam0->f_7, uParam0->f_7, uParam0->f_7, "volHerbBlocking - Legendary Tracking Clue");
	
		if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_31[uParam0->f_618 /*36*/].f_10))
			func_168(uParam0->f_31[uParam0->f_618 /*36*/].f_10, 1);
	}

	if (iParam1 + 1 < func_100())
		uParam0->f_31[uParam0->f_618 /*36*/].f_20 = { func_159(iParam1 + 1, iParam2) };
	else
		uParam0->f_31[uParam0->f_618 /*36*/].f_20 = { func_169(iParam2) };

	return;
}

float func_102(int iParam0) // Position - 0x63EB Hash - 0x566AD102 ^0x566AD102
{
	return func_170(0, iParam0);
}

Ped func_103(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x63FA Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_171(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

void func_104(var uParam0) // Position - 0x643C Hash - 0xB1EA7205 ^0x42F352D8
{
	PED::_SET_PED_SCALE(uParam0->f_12, uParam0->f_12.f_4);
	PED::_SET_PED_PROMPT_NAME_FROM_GXT_ENTRY(uParam0->f_12, func_172());
...
void func_105(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x66D8 Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
Ped func_106(Ped pedParam0) // Position - 0x6714 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

Vector3 func_107(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x671E Hash - 0x88200B15 ^0xE07B704A
{
	float num;
...
int func_108(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6755 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
const char* func_109(const char* sParam0) // Position - 0x684C Hash - 0xC9D82232 ^0xC9D82232
{
	return sParam0;
}

float func_110(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x6856 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_174(entityCoords, vParam1);
}

float func_111(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x68A6 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_174(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_112() // Position - 0x68FD Hash - 0x7A8E245E ^0x59FC764
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) || func_175(Global_35))
		return true;
...
int func_113(char* sParam0, Hash hParam1, Object obParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x6921 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_177(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, iParam8, 0, obParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, bParam16);
		return num;
	}
...
void func_114(int iParam0, float fParam1, BOOL bParam2) // Position - 0x69F8 Hash - 0x9018D919 ^0x90AC92B6
{
	int num;

	if (bParam2 && !func_84(iParam0))
		return;
...
int func_115(var uParam0, Entity eParam1) // Position - 0x6A57 Hash - 0x583186B5 ^0x1718BFF6
{
	int num;
...
BOOL func_116(int iParam0, BOOL bParam1) // Position - 0x6A9C Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_117(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6AF4 Hash - 0x89AE2BEC ^0x89AE2BEC
{
	int num;
...
void func_118(var uParam0, var uParam1) // Position - 0x6B43 Hash - 0x2173EF1C ^0x6EFEA7E5
{
	int i;
	int num;
	int num2;
	...
	if (uParam0->f_614 == 0)
	{
		...
		uParam0->f_12.f_10 = { func_169(uParam0->f_615) };
		uParam0->f_12.f_16 = { func_169(uParam0->f_615) };
		uParam0->f_4 = VOLUME::CREATE_VOLUME_CYLINDER(uParam0->f_12.f_10, 0f, 0f, 0f, 50f, 50f, 50f);
		uParam0->f_5 = func_182(uParam0->f_4, 0, false, 0);
		func_183(uParam0);
		...
		func_184(-1, false, 0, false, false);
		func_185();
		func_186(num2, 0, true);
		func_28(uParam0->f_3);
		...
		func_99(uParam0->f_3, "Hunting Zone Target", false, 0, 0, false, -1082130432);
		uParam0->f_622 = 1;
	}

	uParam0->f_614 = uParam0->f_614 + 1;

	if (!(uParam0->f_614 >= func_100()))
	{
		for (i = 0; i < num; i = i + 1)
		{
			if (uParam0->f_614 == uParam0->f_31[i /*36*/].f_26 && uParam0->f_615 == uParam0->f_31[i /*36*/].f_27)
			{
				func_167(&(uParam0->f_31[i /*36*/].f_10), uParam0->f_31[i /*36*/].f_17, 0f, 0f, 0f, uParam0->f_7, uParam0->f_7, uParam0->f_7, "volHerbBlocking - Legendary Tracking Clue");
			
				if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_31[i /*36*/].f_10))
					func_168(uParam0->f_31[i /*36*/].f_10, 1);
...
BOOL func_119(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x6D6B Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
void func_120(int iParam0, int iParam1) // Position - 0x6DC4 Hash - 0x95CEEAD4 ^0x50515D22
{
	if (iParam1 == 0)
		if (iParam0 == 0)
			func_42(Global_35, "HUNTING_MEDIUM", joaat("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
		else if (iParam0 == 1)
			func_42(Global_35, "HUNTING_NEAR", joaat("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
	else if (iParam0 == 0)
		func_42(Global_35, "HUNTING_FAR", joaat("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
	else if (iParam0 == 1)
		func_42(Global_35, "HUNTING_MEDIUM", joaat("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
	else if (iParam0 == 2)
		func_42(Global_35, "HUNTING_NEAR", joaat("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
...
int func_121(Entity eParam0, const char* sParam1, BOOL bParam2, float fParam3, int iParam4, int iParam5, float fParam6, BOOL bParam7) // Position - 0x6E6A Hash - 0xF2C93E75 ^0x2DDAA8D0
{
	int points;
...
void func_122(Volume volParam0) // Position - 0x6ED6 Hash - 0x530B7370 ^0x1B8FEE27
{
	int i;
...
BOOL func_123(int iParam0) // Position - 0x6F07 Hash - 0x90A8253B ^0x90A8253B
{
	switch (iParam0)
	{
		case 0:
...
void func_124(var uParam0) // Position - 0x6F80 Hash - 0x8EF783D9 ^0x83F1A18A
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
		func_187(uParam0->f_12, uParam0->f_12.f_10, func_102(uParam0->f_615), 2, 1073741824);
...
void func_125(var uParam0) // Position - 0x6FFB Hash - 0x6C6259DC ^0xF1EA64EB
{
	int num;

	num = func_189(0, func_188(), uParam0->f_616);
	uParam0->f_616 = num;
	uParam0->f_12.f_16 = { func_169(num) };
	return;
}

BOOL func_126(int iParam0, BOOL bParam1) // Position - 0x7028 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_66(iParam0))
		return false;
...
eStackSize func_127() // Position - 0x704E Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_128(int iParam0) // Position - 0x705C Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_129(int iParam0, BOOL bParam1) // Position - 0x7072 Hash - 0x34A2E44 ^0x39A823C1
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_130(Hash hParam0, int iParam1) // Position - 0x70A5 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
struct<10> func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x70BF Hash - 0x440EE211 ^0xAE2816F9
{
	int num;
...
BOOL func_132(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7193 Hash - 0x72399051 ^0x6D1C1C66
{
	var outData;
	int i;
	...
	*uParam3 = outData.f_3;
	...
	if (bParam4)
		func_190(hParam0, hParam1, uParam2, *uParam3);

	return true;
}

struct<4> func_133(BOOL bParam0) // Position - 0x7230 Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_135(joaat("character"), func_191(), joaat("SLOTID_NONE"), bParam0);
}

int func_134(int iParam0) // Position - 0x724C Hash - 0xF3DAE918 ^0xA65130AC
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_135(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x7299 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_136(bParam6), &uParam1, hParam0, hParam5, &outGuid);
	return outGuid;
}

int func_136(BOOL bParam0) // Position - 0x72CA Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_65() == -1)
	{
...
BOOL func_137(Hash hParam0, var uParam1) // Position - 0x730B Hash - 0x6C0FFC3B ^0xB2795CB6
{
	int i;
	var outSlotId;
	var unk;
	...
	if (hParam0 != 0)
	{
		category = func_192(hParam0);
	
		if (category != 0)
		{
			num = func_193(hParam0);
...
int func_138(Hash hParam0, Any* panParam1, BOOL bParam2, BOOL bParam3) // Position - 0x735F Hash - 0x9D75BA2C ^0xE0E521B7
{
	if (!func_130(hParam0, 0))
		return 0;
	...
	if (bParam2 || !func_195(hParam0))
		return INVENTORY::_GET_ITEM_SLOT_MAX_COUNT(hParam0, panParam1->f_4);

	return INVENTORY::_GET_ITEM_ROLE_MAX_LEVEL_COUNT(func_136(bParam3), hParam0);
}

int func_139(Hash hParam0, BOOL bParam1) // Position - 0x73AD Hash - 0xE0F47B47 ^0x52A64D28
{
	if (func_196(hParam0))
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_35, hParam0);

	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_136(bParam1), hParam0, false);
}

BOOL func_140(Hash hParam0) // Position - 0x73D7 Hash - 0x5E6E1858 ^0x84C97687
{
	!func_130(hParam0, 0);

	if (func_197(hParam0, 173360570))
		return true;

	return false;
}

BOOL func_141(Hash hParam0) // Position - 0x73FD Hash - 0x33F7D399 ^0xEB534519
{
	if (!func_130(hParam0, 0))
		return false;
...
BOOL func_142(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x741A Hash - 0x86E39CDA ^0xCF922D1
{
	!func_130(hParam0, 0);
	...
	if (func_198(hParam0, panParam2, iParam3, bParam5, false))
		return false;

	if (!func_194(false))
		return false;

	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_136(false), panParam1, panParam2, hParam0, panParam2->f_4, iParam3, hParam4))
		return false;

	return true;
}

void func_143(var uParam0, int iParam1) // Position - 0x747C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_144(int iParam0, int iParam1) // Position - 0x748D Hash - 0xC0D8FAC3 ^0xE4233006
{
...
void func_145(int iParam0) // Position - 0x74A6 Hash - 0x23AE6B73 ^0x23AE6B73
{
	int i;
	int num;
	...
	for (i = 0; i < 20; i = i + 1)
	{
		...
		func_144(Global_40.f_11922[i], 0);
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7514 Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_147(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x753E Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_148(int iParam0) // Position - 0x7593 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_176(iParam0, 2);
}

int func_149(int iParam0) // Position - 0x75A2 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_200(iParam0))
		return -1;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x75BE Hash - 0xDD376ADC ^0x3FEE2146
{
	if (func_65() != -1)
...
BOOL func_151(int iParam0) // Position - 0x75F1 Hash - 0x3E25647A ^0x3E25647A
{
	if (func_65() != -1)
		if (func_153(iParam0, 4))
			return false;
	else if (func_153(iParam0, 2))
		return false;

	return true;
}

BOOL func_152(int iParam0) // Position - 0x7621 Hash - 0xF83B91D5 ^0xBF549DB5
{
	int i;
	int cloudTimeAsInt;
	int num;
	...
	if (!func_153(iParam0, 65536) && !func_153(iParam0, 32768))
		return false;
	...
	for (i = 0; i < Global_40.f_7756; i = i + 1)
	{
		if (Global_40.f_7756[i /*3*/].f_2 == iParam0)
		{
			...
			if (num < 1800 && func_153(iParam0, 32768))
				return true;
		}
	}
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x76CD Hash - 0xECB143B0 ^0x9BF3D063
{
	return Global_1905944.f_22[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_154(int iParam0) // Position - 0x76E6 Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_155() // Position - 0x76F9 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1905944.f_5694;
}

BOOL func_156(int iParam0) // Position - 0x7708 Hash - 0x8EF26C67 ^0x9855652A
{
	int num;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x7773 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

Volume func_158(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x7782 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
	...
	func_203(volume, bParam8);
	return volume;
}

Vector3 func_159(int iParam0, int iParam1) // Position - 0x783C Hash - 0xFF60DCDC ^0xFF60DCDC
{
	var unk;
	...
	{
		case 0:
			unk = { func_204(1, iParam1) };
			break;
	
		case 1:
			unk = { func_204(2, iParam1) };
			break;
	
		case 2:
			unk = { func_204(3, iParam1) };
			break;
	}
...
float func_160(int iParam0, int iParam1) // Position - 0x788C Hash - 0xA6D14BD7 ^0xA6D14BD7
{
	float num;
	...
	{
		case 0:
			num = func_170(1, iParam1);
			break;
	
		case 1:
			num = func_170(2, iParam1);
			break;
	
		case 2:
			num = func_170(3, iParam1);
			break;
	}
...
Vector3 func_161() // Position - 0x78D4 Hash - 0x6D35D642 ^0x6D35D642
{
	return func_205("ATZ_INS_EXC");
}

Vector3 func_162() // Position - 0x78E3 Hash - 0xAD647359 ^0xAD647359
{
	return func_205("ATZ_INS_FUR");
}

Vector3 func_163() // Position - 0x78F2 Hash - 0x5F8001D4 ^0x5F8001D4
{
	return func_205("ATZ_INS_KLR");
}

Vector3 func_164() // Position - 0x7901 Hash - 0xB1C9805 ^0xB1C9805
{
	return func_205("ATZ_INS_BLD");
}

Vector3 func_165() // Position - 0x7910 Hash - 0x1DA0618A ^0x6185B5AF
{
	return func_205("ATZ_INS_BRK");
}

Vector3 func_166() // Position - 0x7920 Hash - 0x1DA0618A ^0xD6544647
{
	return func_205("ATZ_INS_TRB");
}

void func_167(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, char* sParam10) // Position - 0x7930 Hash - 0x3A05F50D ^0x6A8E2731
{
	*uParam0 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam1, fParam4, vParam7, sParam10);
	return;
}

void func_168(Volume volParam0, int iParam1) // Position - 0x794D Hash - 0x28736565 ^0xF0314607
{
	if (func_206(volParam0))
		return;

	if (func_207(volParam0) == iParam1)
		return;
...
Vector3 func_169(int iParam0) // Position - 0x7999 Hash - 0x783205AD ^0x783205AD
{
	return func_204(0, iParam0);
}

float func_170(int iParam0, int iParam1) // Position - 0x79A8 Hash - 0x7009ECAD ^0x7009ECAD
{
	switch (iParam0)
	{
		case 0:
...
void func_171(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7AC9 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_208(eptParam1))
		{
			func_209(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_211(pedParam0, false);
			flag = true;
		}
	
		func_212(pedParam0, iParam2);
	}
...
Hash func_172() // Position - 0x7BAA Hash - 0x9F572D68 ^0x39044234
{
	return 1983113051;
}

BOOL func_173(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7BB7 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_174(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7BE0 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_175(Ped pedParam0) // Position - 0x7BFE Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_213(pedParam0, 4) || func_213(pedParam0, 5);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0x7C1A Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_177(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Object obParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x7C3B Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
...
void func_178(int iParam0, int iParam1) // Position - 0x7EE1 Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x7F14 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x7F6C Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_181(int iParam0, int iParam1) // Position - 0x7F95 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
Any func_182(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7FBD Hash - 0xDFB996B4 ^0xC287A71C
{
	Any any;
...
void func_183(var uParam0) // Position - 0x8005 Hash - 0xC6A5F393 ^0x3F787E83
{
	int i;
...
void func_184(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x806A Hash - 0xEF5C52D ^0xEF5C52D
{
	int i;
	int num;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		if (func_216(num) && !func_217(num, iParam2) && !bParam3 || !func_218(num) && !bParam4 || !func_219(num))
			if (num != iParam0)
				func_220(i);
	}
...
void func_185() // Position - 0x80F8 Hash - 0x18ACD9D3 ^0xB2ADEAB8
{
	if (!func_216(Global_1327479))
		return;
...
void func_186(int iParam0, int iParam1, BOOL bParam2) // Position - 0x816B Hash - 0xD61623D0 ^0x48AE56A
{
	Global_1327479.f_4 = MISC::GET_GAME_TIMER();
	func_222(iParam0, iParam1, bParam2);
	return;
}

void func_187(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x8187 Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_106(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_223(pedParam0))
		if (func_224(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
	...
	if (func_225(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_187(vehiclePedIsIn, vParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_187(mount, vParam1, fParam4, iParam5, iParam6);
			}
	...
	if (func_225(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_225(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_225(iParam5, 32), true);
...
int func_188() // Position - 0x8409 Hash - 0xDF9E118A ^0xDF9E118A
{
	return 3;
}

int func_189(int iParam0, int iParam1, int iParam2) // Position - 0x8412 Hash - 0xC76BC009 ^0xD35219B8
{
	...
	if (randomIntInRange == iParam2)
	{
		...
		if (randomIntInRange < iParam0 || randomIntInRange >= iParam1)
			randomIntInRange = func_226() ? iParam0 : iParam1 - 1;
	}

	return randomIntInRange;
}

void func_190(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x84B8 Hash - 0x7EFAC478 ^0x4E4217E0
{
	int i;
	int j;
	int k;
...
struct<4> func_191() // Position - 0x861F Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
Hash func_192(Hash hParam0) // Position - 0x862B Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
int func_193(Hash hParam0) // Position - 0x8656 Hash - 0xF4E671A6 ^0x338FA446
{
	Hash category;
...
BOOL func_194(BOOL bParam0) // Position - 0x8685 Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_65() == -1)
		return true;

	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_136(bParam0));
}

BOOL func_195(Hash hParam0) // Position - 0x86A3 Hash - 0x1BC045DA ^0x469FDDE1
{
	if (func_227(hParam0, joaat("DEFAULT")) == 0)
		return false;

	return true;
}

BOOL func_196(Hash hParam0) // Position - 0x86BF Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_197(Hash hParam0, Hash hParam1) // Position - 0x86CD Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
BOOL func_198(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x86FE Hash - 0x6FD18E8B ^0x7C3C83FA
{
	var unk;
	var unk5;
	var unk27;
	...
	if (func_229(hParam0) && WEAPON::IS_WEAPON_A_GUN(hParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(hParam0))
		{
			...
			if (!func_231(hParam0, &unk, joaat("SLOTID_WEAPON_0"), false))
				return false;
			else if (func_232(hParam0, &unk5, joaat("SLOTID_WEAPON_0")))
				return false;
		
			if (func_233(hParam0, true))
				if (!func_231(hParam0, &unk, joaat("SLOTID_WEAPON_1"), false))
					return false;
				else if (func_232(hParam0, &unk5, joaat("SLOTID_WEAPON_1")))
					return false;
		}
		else if (!func_234(hParam0, &unk27, false))
		{
			return false;
		}
	...
	num = func_138(hParam0, panParam1, bParam3, bParam4);
	...
	if (bParam3 || !func_195(hParam0))
		inventoryItemCountWithItemid = func_235(hParam0, *panParam1, panParam1->f_4, bParam4);
	else
		inventoryItemCountWithItemid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_136(bParam4), hParam0, false);
...
void func_199(BOOL bParam0) // Position - 0x8843 Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
		func_236(&(Global_40.f_12019.f_42), 1);
	else
		func_237(&(Global_40.f_12019.f_42), 1);

	return;
}

BOOL func_200(int iParam0) // Position - 0x886D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_201(int iParam0) // Position - 0x88A0 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_202(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x88E1 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_203(Volume volParam0, BOOL bParam1) // Position - 0x88FB Hash - 0xEA796703 ^0x695D7925
{
	Volume volLockRequestId;
	int i;
...
Vector3 func_204(int iParam0, int iParam1) // Position - 0x8963 Hash - 0x24E72BF3 ^0x24E72BF3
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 2176.2432f, -818.1503f, 40.528f;
			
				case 1:
					return 2135.6338f, -778.7705f, 40.52f;
			
				case 2:
					return 2146.854f, -749.9665f, 40.52f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return 2114.9404f, -726.4951f, 40.5653f;
			
				case 1:
					return 2129.3462f, -859.8976f, 40.6406f;
			
				case 2:
					return 2228.6582f, -820.9073f, 40.6338f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return 2116.437f, -764.7084f, 40.5833f;
			
				case 1:
					return 2160.5896f, -850.282f, 40.5404f;
			
				case 2:
					return 2187.1572f, -819.4145f, 40.6378f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return 2122.9841f, -796.6561f, 40.6865f;
			
				case 1:
					return 2167.422f, -827.3166f, 40.6391f;
			
				case 2:
					return 2150.8818f, -809.5778f, 40.52f;
			}
			break;
	}
...
Vector3 func_205(char* sParam0) // Position - 0x8AFE Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_206(Volume volParam0) // Position - 0x8B10 Hash - 0x1D6344D9 ^0x1D6344D9
{
	int i;
...
int func_207(Volume volParam0) // Position - 0x8B3C Hash - 0x67695E3A ^0xB4A144D5
{
	int i;
...
BOOL func_208(ePedType eptParam0) // Position - 0x8B71 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_209(Ped pedParam0, Hash hParam1) // Position - 0x8FC4 Hash - 0xEA1C858E ^0x774E8E96
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_210(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x906E Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_211(Ped pedParam0, BOOL bParam1) // Position - 0x909E Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_212(Ped pedParam0, int iParam1) // Position - 0x90E3 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_213(Ped pedParam0, int iParam1) // Position - 0x910A Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
void func_214(Volume volParam0, BOOL bParam1) // Position - 0x9149 Hash - 0xD6642292 ^0x5A7BA218
{
	int num;
...
int func_215() // Position - 0x916C Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_216(int iParam0) // Position - 0x917B Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

BOOL func_217(int iParam0, int iParam1) // Position - 0x9191 Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_216(iParam0))
		return false;
...
BOOL func_218(int iParam0) // Position - 0x91B4 Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_216(iParam0))
		return false;

	if (func_243(64) && func_244(iParam0))
		return true;

	return Global_1310750[iParam0 /*111*/].f_46;
}

BOOL func_219(int iParam0) // Position - 0x91EC Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_216(iParam0))
		return false;
...
void func_220(int iParam0) // Position - 0x920C Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_221(int iParam0) // Position - 0x9275 Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

void func_222(int iParam0, int iParam1, BOOL bParam2) // Position - 0x9285 Hash - 0x4464293B ^0x680D2F86
{
...
BOOL func_223(Ped pedParam0) // Position - 0x930A Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_224(Ped pedParam0) // Position - 0x933C Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_225(int iParam0, int iParam1) // Position - 0x937E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_226() // Position - 0x938D Hash - 0xEE877ACE ^0xCCE9C802
{
...
int func_227(Hash hParam0, Hash hParam1) // Position - 0x93AE Hash - 0x39B5DB67 ^0xD5694E3C
{
	if (hParam1 == 0)
		return 0;
...
int func_228(var uParam0) // Position - 0x93C8 Hash - 0xE0B16A5D ^0x1D9BDFB4
{
...
BOOL func_229(Hash hParam0) // Position - 0x9444 Hash - 0x1B551CF7 ^0xF7F1B098
{
	return func_246(hParam0) == joaat("WEAPON");
}

struct<4> func_230(BOOL bParam0) // Position - 0x9458 Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;

	num = func_136(bParam0);

	if (num == 2)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223200))
			Global_1223200 = { func_135(923904168, func_133(bParam0), -740156546, bParam0) };
	...
	else if (num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223208))
			Global_1223208 = { func_135(923904168, func_133(bParam0), -740156546, false) };
	
		return Global_1223208;
	}

	return func_135(923904168, func_133(bParam0), -740156546, false);
}

BOOL func_231(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3) // Position - 0x94ED Hash - 0x4285A587 ^0x4285A587
{
	return func_235(hParam0, *uParam1, hParam2, bParam3) > 0;
}

BOOL func_232(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x9505 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;

	if (func_247(hParam0, &unk, panParam1, hParam2))
		return panParam1->f_17 > 0f;

	return false;
}

BOOL func_233(Hash hParam0, BOOL bParam1) // Position - 0x9526 Hash - 0x62864AB ^0xBC339691
{
	if (func_192(hParam0) == 1779021115)
		return false;
...
BOOL func_234(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x955F Hash - 0xDE5D4AAC ^0xDB35B0F6
{
	var unk;
	Hash hash;
	var unk6;
	...
	unk = { func_249(hParam0, false, true) };
	...
	for (i = 0; i < 4; i = i + 1)
	{
		hash = func_250(398 + i, 1);
	
		if (func_231(hParam0, &unk, hash, false))
		{
			flag = func_232(hParam0, &unk6, hash);
...
int func_235(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x95F3 Hash - 0xD01EE834 ^0xC97ABD1E
{
	var guid;
	int inventoryItemCountWithGuid;
	...
	guid = { func_135(hParam0, uParam1, hParam5, bParam6) };

	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&guid))
		return 0;

	inventoryItemCountWithGuid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_136(bParam6), &guid, false);
	return inventoryItemCountWithGuid;
}

void func_236(BOOL bParam0, int iParam1) // Position - 0x963B Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

void func_237(BOOL bParam0, int iParam1) // Position - 0x964C Hash - 0x9815F445 ^0x9815F445
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

int func_238(int iParam0) // Position - 0x9661 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x96E2 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x9710 Hash - 0xA54F3032 ^0x5F4E4EED
{
	Hash _int;
...
BOOL func_241(Ped pedParam0, Hash hParam1) // Position - 0x9761 Hash - 0xA54F3032 ^0x5F4E4EED
{
	Hash _int;
	int _int2;
...
void func_242(Ped pedParam0) // Position - 0x97D3 Hash - 0x446F1BDD ^0xB4620476
{
...
BOOL func_243(int iParam0) // Position - 0x97F1 Hash - 0xDDC0076D ^0xDDC0076D
{
	return Global_1310750.f_16035 && iParam0 != false;
}

BOOL func_244(int iParam0) // Position - 0x9805 Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_217(iParam0, Global_1310750.f_16072 | 64);
}

void func_245(int iParam0) // Position - 0x981D Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
int func_246(Hash hParam0) // Position - 0x98AA Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_247(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x98D5 Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;

	inventoryId = func_136(false);
	*panParam1 = { func_135(hParam0, func_230(false), hParam3, false) };
...
BOOL func_248(int iParam0) // Position - 0x991A Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_251(iParam0))
		return false;
...
struct<5> func_249(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9936 Hash - 0xE6705E3C ^0xB9EA38F4
{
	var unk;
	var unk6;
	var unk28;

	unk = { func_133(bParam1) };
	unk.f_4 = joaat("SLOTID_SATCHEL");

	switch (func_246(hParam0))
	{
		case joaat("UPGRADE"):
			if (func_254(hParam0, -1823706425))
			{
				unk = { func_135(joaat("kit_camp"), unk, joaat("SLOTID_SATCHEL"), bParam1) };
				unk.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(hParam0, joaat("kit_camp"));
			}
			else if (func_254(hParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				unk = { func_135(joaat("WARDROBE"), unk, joaat("SLOTID_WARDROBE"), bParam1) };
		...
		case joaat("WEAPON"):
			unk = { func_230(bParam1) };
		
			if (bParam2 && func_233(hParam0, true))
			{
				unk6.f_9 = joaat("SLOTID_NONE");
			
				if (!func_231(hParam0, &unk, joaat("SLOTID_WEAPON_0"), false))
					unk.f_4 = joaat("SLOTID_WEAPON_0");
				else if (!func_231(hParam0, &unk, joaat("SLOTID_WEAPON_1"), false))
					unk.f_4 = joaat("SLOTID_WEAPON_1");
				else if (func_232(hParam0, &unk6, joaat("SLOTID_WEAPON_0")))
					unk.f_4 = joaat("SLOTID_WEAPON_0");
				else
					unk.f_4 = joaat("SLOTID_WEAPON_1");
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(hParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_255(unk, &unk28, bParam1, false))
				{
					unk.f_4 = 0;
				}
				else
...
Hash func_250(int iParam0, int iParam1) // Position - 0x9BF3 Hash - 0xE1D12727 ^0x71D656A6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_251(int iParam0) // Position - 0xBD3D Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_252(int iParam0) // Position - 0xBD50 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
struct<4> func_253(BOOL bParam0) // Position - 0xBD7A Hash - 0x8A689EFF ^0x60C7E77C
{
	int num;
	...
	if (num == 2 || num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223204))
			Global_1223204 = { func_135(271701509, func_133(bParam0), 12999093, false) };
	
		return Global_1223204;
	}

	return func_135(271701509, func_133(bParam0), 12999093, false);
}

BOOL func_254(Hash hParam0, Hash hParam1) // Position - 0xBDDE Hash - 0x1874093C ^0x7F0FACAB
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBE3D Hash - 0xC40FC7D1 ^0x18789FFF
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam0))
		return false;

	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_136(bParam5), &uParam0, panParam4, !bParam6))
		return false;
