...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0x49B50422
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x29BCC9CD ^0xD3D92FFA
{
	int num;

	func_46(uParam0, "MAN_JUMP_FENCE", "", uParam1, uParam4);
	num = joaat("a_m_m_lowersdtownfolk_01");
	func_47(uParam0, 0, "MJFP_MAN", num, uParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1BF9 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1C99 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DB3 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1F7C Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1F85 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2135 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21A9 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x21F8 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2250 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23B9 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x26E0 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2817 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2947 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2986 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x298F Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x29C1 Hash - 0x67E68B94 ^0x67E68B94
{
	func_55(&uLocal_10, false);
	func_56(&uLocal_10, true);
...
int func_31(var uParam0) // Position - 0x29FB Hash - 0xC38F5672 ^0xC38F5672
{
	if (!uParam0->f_469[1])
	{
		if (func_62(uParam0, &uLocal_10, false))
		{
			func_63(uParam0);
		
			if (!uParam0->f_469[2])
			{
				func_64(*uParam0, uParam0->f_483, false);
				uParam0->f_469[2] = 1;
			}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				PED::_SET_PED_DESIRED_LOCO_MOTION_TYPE(uParam0->f_20[0 /*14*/], "Nervous");
				func_65(&uParam0->f_20[0 /*14*/], false, true);
		...
		case 1:
			...
			{
				func_63(uParam0);
				TASK::TASK_CLIMB(uParam0->f_20[0 /*14*/], false);
				iLocal_9 = 2;
			}
			break;
		...
		case 2:
			if (!uParam0->f_469[2])
			{
				if (func_67(uParam0, 0.1f, 1116471296, 4, joaat("Action"), false))
				{
					func_64(*uParam0, uParam0->f_483, false);
					uParam0->f_469[2] = 1;
				}
			...
			if (!func_68(uParam0->f_20[0 /*14*/], SCRIPT_TASK_CLIMB))
			{
...
int func_32(var uParam0, var uParam1) // Position - 0x2B7D Hash - 0x3105A36D ^0x3105A36D
{
	func_69(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B8F Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2BAC Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2CE8 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2E21 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2ECB Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x2F43 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x2FD2 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x30ED Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x30F9 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3281 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3321 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3334 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x334E Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x33B6 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x33E2 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_48(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3470 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_49(int iParam0) // Position - 0x3674 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x3688 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_51() // Position - 0x3697 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_70() != -1;
}

BOOL func_52(var uParam0, Any* panParam1) // Position - 0x36B2 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_53(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3711 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_54(Ped pedParam0) // Position - 0x3753 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_55(int iParam0, BOOL bParam1) // Position - 0x377F Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_56(var uParam0, BOOL bParam1) // Position - 0x37FB Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3821 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3843 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3865 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
		func_9(&(uParam0->f_1), 8);
	else
		func_96(&(uParam0->f_1), 8);

	return;
}

void func_60(var uParam0, BOOL bParam1) // Position - 0x3889 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x38AB Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_62(var uParam0, int iParam1, BOOL bParam2) // Position - 0x38CF Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_63(var uParam0) // Position - 0x3929 Hash - 0xADB2AF74 ^0xADB2AF74
{
	if (!uParam0->f_469[3])
	{
...
void func_64(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x394E Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_65(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A52 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_66(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3A7A Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_67(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3C85 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_103(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_105(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_106(&(uParam0->f_490)))
...
BOOL func_68(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3DAE Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_69(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3E07 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_70() // Position - 0x3F5B Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_71(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x3F69 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_72(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x3FD0 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3FF9 Hash - 0xF728A2B7 ^0x2D93028C
{
	int i;
...
BOOL func_74(var uParam0, var uParam1, var uParam2) // Position - 0x4046 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_75(int iParam0) // Position - 0x4095 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_76(int iParam0) // Position - 0x40BA Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_77(int iParam0) // Position - 0x40CD Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_78(int iParam0) // Position - 0x40E0 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_79(int iParam0) // Position - 0x40F3 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_80(int iParam0) // Position - 0x4105 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_81(int iParam0, int iParam1) // Position - 0x4117 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x41B1 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_83() // Position - 0x41E9 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_84(int iParam0) // Position - 0x423C Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_87(iParam0))
		return -1;
...
BOOL func_85(int iParam0) // Position - 0x425C Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_86(int iParam0, int iParam1) // Position - 0x4272 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_87(int iParam0) // Position - 0x4281 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_88(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x42B4 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_89(int iParam0, BOOL bParam1) // Position - 0x4395 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_96(iParam0, 4);
	else
...
void func_90(int iParam0, BOOL bParam1) // Position - 0x43B3 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_96(iParam0, 8);
	else
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x43D3 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_96(iParam0, 16);
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x43FE Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_96(iParam0, 32);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x441E Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_96(iParam0, 64);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x443E Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4460 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_96(int iParam0, int iParam1) // Position - 0x4484 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_97(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4495 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4ABE Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_99(int iParam0) // Position - 0x4B95 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_100(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4C16 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_101(Ped pedParam0) // Position - 0x4D07 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_102(Ped pedParam0) // Position - 0x4D22 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_103(int iParam0) // Position - 0x4D3E Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_104(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4D85 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_105(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4DA3 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_161(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_106(var uParam0) // Position - 0x4DFA Hash - 0x5001E582 ^0x5001E582
{
	return func_162(*uParam0, 1);
}

void func_107(var uParam0) // Position - 0x4E0A Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_163(uParam0, 0f);
	return;
}

BOOL func_108(var uParam0, float fParam1) // Position - 0x4E19 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_109(var uParam0) // Position - 0x4E37 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_110(var uParam0, BOOL bParam1) // Position - 0x4E4D Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_111(var uParam0) // Position - 0x4E6D Hash - 0x39705408 ^0x39705408
{
	return func_162(*uParam0, 2);
}

void func_112(var uParam0) // Position - 0x4E7D Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_106(uParam0);
...
BOOL func_113(var uParam0, float fParam1) // Position - 0x4EB1 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_106(uParam0))
		return false;
...
void func_114(var uParam0) // Position - 0x4ED8 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_106(uParam0);
...
BOOL func_115(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x4F08 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_116(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4F5D Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_117(int iParam0, int iParam1) // Position - 0x4F74 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_118(int iParam0, int iParam1) // Position - 0x4FFA Hash - 0x96B01D2A ^0x81E68218
{
...
void func_119(int iParam0, int iParam1) // Position - 0x5036 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_120(int iParam0, int iParam1) // Position - 0x5089 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_121(int iParam0, int iParam1) // Position - 0x50C4 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_122(int iParam0, int iParam1) // Position - 0x50FD Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_123(int iParam0) // Position - 0x5135 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_124(BOOL bParam0) // Position - 0x5173 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_125(ePedType eptParam0) // Position - 0x5186 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_126(Ped pedParam0, Hash hParam1) // Position - 0x55D9 Hash - 0x643265E4 ^0x3536BF7D
{
...
void func_127(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5680 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_128(Ped pedParam0, BOOL bParam1) // Position - 0x56B0 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_129(Ped pedParam0, int iParam1) // Position - 0x56F5 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_130(int iParam0, BOOL bParam1, int iParam2) // Position - 0x571C Hash - 0x37D64B11 ^0xE7060A9E
{
	func_172(iParam2);
...
BOOL func_131(Ped pedParam0, int iParam1) // Position - 0x58E7 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_132(Ped pedParam0, int iParam1, int iParam2) // Position - 0x59BE Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x59FB Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_134(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5AE2 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5BB8 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_136(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5CC1 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_137(int iParam0, int iParam1) // Position - 0x5DF6 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_138(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5E2D Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_139(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5F34 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_140(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5F9F Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x60E7 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_142(var uParam0, int iParam1) // Position - 0x62C3 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x633B Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_144(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x636A Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_145(int iParam0, Ped pedParam1) // Position - 0x64F0 Hash - 0xEB9B7B82 ^0xAB21D5F5
{
	int _int;
...
BOOL func_146(int iParam0, Ped pedParam1) // Position - 0x653D Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_199(iParam0))
		return true;
...
BOOL func_147(Ped pedParam0, Ped pedParam1) // Position - 0x65DA Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_148() // Position - 0x6627 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_149(int iParam0, Ped pedParam1) // Position - 0x662F Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_150() // Position - 0x66F0 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_151() // Position - 0x670E Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x675B Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_153(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6877 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_154(Ped pedParam0, int iParam1) // Position - 0x68BF Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_155(Ped pedParam0, int iParam1) // Position - 0x6B18 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_209(0))
		return false;
...
BOOL func_156(int iParam0, int iParam1) // Position - 0x6B51 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_157(var uParam0, int iParam1) // Position - 0x6B80 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_158(Ped pedParam0, int iParam1) // Position - 0x6B94 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_150() - iParam1->f_4 > func_210(iParam1))
		return func_211(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6BE1 Hash - 0x7F1E839D ^0xAF09344B
{
...
void func_160(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6C34 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_161(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6CC0 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_162(int iParam0, int iParam1) // Position - 0x6CDE Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_163(var uParam0, float fParam1) // Position - 0x6CED Hash - 0x30433BAB ^0xF854D531
{
...
float func_164() // Position - 0x6D13 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_165(var uParam0, int iParam1) // Position - 0x6D45 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_166(var uParam0) // Position - 0x6D5A Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_106(uParam0))
		return uParam0->f_1;
...
void func_167(var uParam0, int iParam1) // Position - 0x6D8F Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_168(Ped pedParam0, Hash hParam1) // Position - 0x6DA0 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x6DCE Hash - 0xD94052D8 ^0x32C7C1E8
{
	Hash _int;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x6E1C Hash - 0xD94052D8 ^0x32C7C1E8
{
	Hash _int;
	int _int2;
...
void func_171(Ped pedParam0) // Position - 0x6E8A Hash - 0x7FF8F9C1 ^0x969B4B02
{
...
void func_172(int iParam0) // Position - 0x6EA6 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_173(int iParam0) // Position - 0x7012 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_174(BOOL bParam0) // Position - 0x7025 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_175(int iParam0) // Position - 0x703F Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_176(int iParam0) // Position - 0x70D7 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_177(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x70FE Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_178(Ped pedParam0, Ped pedParam1) // Position - 0x71F7 Hash - 0xF9959663 ^0xF9959663
{
	return func_200(pedParam0, pedParam1, true, true);
}

float func_179(int iParam0) // Position - 0x7209 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_180(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7215 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_181(int iParam0, BOOL bParam1) // Position - 0x727A Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_182() // Position - 0x72A0 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_183(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x72B4 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_184(int iParam0) // Position - 0x7414 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_185(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7420 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_186(int iParam0) // Position - 0x7481 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_187(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x748D Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_188(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x754F Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_189(int iParam0) // Position - 0x75ED Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_190(int iParam0) // Position - 0x75F9 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_191(int iParam0) // Position - 0x7605 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_192(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7742 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_193(Ped pedParam0) // Position - 0x7785 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_194(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77EB Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7832 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x787D Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_197(Ped pedParam0, var uParam1) // Position - 0x78F6 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_198(Ped pedParam0, Ped pedParam1) // Position - 0x7943 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_199(int iParam0) // Position - 0x798B Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_200(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x799B Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_201(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x79E3 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7A0F Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_203(int iParam0) // Position - 0x7A37 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_204(Ped pedParam0) // Position - 0x7A43 Hash - 0x8791554D ^0x7BBB1671
{
...
int func_205(Ped pedParam0) // Position - 0x7A97 Hash - 0x54E13D1E ^0x12FE0B49
{
...
BOOL func_206(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7B01 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_207(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7C71 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_208(int iParam0, Ped pedParam1) // Position - 0x7D5F Hash - 0x11946994 ^0xE190A18E
{
...
BOOL func_209(int iParam0) // Position - 0x7DD3 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_226())
		return false;
...
int func_210(int iParam0) // Position - 0x7DF5 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_211(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7E01 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_212(int iParam0) // Position - 0x7E7C Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_213() // Position - 0x7E8F Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_214() // Position - 0x7E9D Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_228())
		return false;
...
void func_215(Any* panParam0, int iParam1) // Position - 0x7EF3 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_216(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7F9B Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_217(int iParam0) // Position - 0x8064 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_218(int iParam0) // Position - 0x810C Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_219(Ped pedParam0, int iParam1) // Position - 0x8171 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_220(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8188 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_221(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x81B6 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_222(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8200 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_223(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8241 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_224(Ped pedParam0) // Position - 0x82BA Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_225(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x83A2 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_226() // Position - 0x83E4 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_213() != -1)
		return false;
...
BOOL func_227(int iParam0, BOOL bParam1) // Position - 0x8409 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_228() // Position - 0x843A Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_229(int iParam0) // Position - 0x846B Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_87(iParam0))
		return -1;
...
int func_230(int iParam0) // Position - 0x8487 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_231(int iParam0) // Position - 0x84C8 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
