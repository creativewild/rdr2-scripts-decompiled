...
void main() // Position - 0x0 Hash - 0x54A9ED6B ^0xBF64DCBB
{
	...
	iLocal_24.f_1 = anScriptParam_0.f_1;
		...
		switch (iLocal_22)
		{
			case 0:
				if (func_3(&iLocal_24))
				{
					...
					if (iLocal_24.f_4 == -1)
						iLocal_24.f_4 = func_4(&iLocal_24);
				}
				break;
...
BOOL func_3(var uParam0) // Position - 0xD1 Hash - 0xF06FC284 ^0xC0DEC5DC
{
	...
	if (iLocal_24 == 0)
	{
		...
		iLocal_24 = func_10(scenarioPointType);
		return false;
	}

	if (func_11(iLocal_24, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0) // Position - 0xA35 Hash - 0xA68EA19D ^0x4924BDDF
{
	var unk;
	...
	switch (iLocal_14)
	{
		case 0:
			...
			if (func_51() && func_52() && !PED::IS_PED_FULLY_ON_MOUNT(Global_35, true))
				func_50(&iLocal_14, 1);
			break;
		...
		case 1:
			...
			if (!func_54(&iLocal_14.f_2[0], unk.f_10, unk, unk.f_3, unk.f_6, unk.f_9))
				return;
		...
		case 2:
			if (!func_51() || !func_52() || PED::IS_PED_ON_MOUNT(Global_35))
				func_50(&iLocal_14, 0);
		
			if (VOLUME::DOES_VOLUME_EXIST(iLocal_14.f_2[0]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_14.f_2[0], true, 0))
			{
				if (!func_39(iLocal_14.f_7, 2) && AUDIO::PREPARE_SOUND("LIGHTENING_STRIKE", "DSLIT_Sounds", -2))
					func_40(&(iLocal_14.f_7), 2);
			
				if (!func_24(&(iLocal_14.f_4)))
				{
					func_25(&(iLocal_14.f_4));
					STREAMING::REQUEST_ANIM_DICT(func_55(func_15()));
				}
			
				if (func_26(&(iLocal_14.f_4)) > 3000 && STREAMING::HAS_ANIM_DICT_LOADED(func_55(func_15())))
					func_50(&iLocal_14, 3);
			}
			else if (func_24(&(iLocal_14.f_4)))
			{
				func_23(&(iLocal_14.f_4));
			}
			break;
	
		case 3:
			iLocal_14.f_1 = 0;
			func_40(&(iLocal_14.f_7), 1);
			func_25(&(iLocal_14.f_4));
			func_50(&iLocal_14, 4);
			break;
		...
		case 4:
			...
			if (func_39(iLocal_14.f_7, 2) && !func_39(iLocal_14.f_7, 4))
			{
				AUDIO::_PLAY_SOUND_FROM_POSITION("LIGHTENING_STRIKE", ENTITY::GET_ENTITY_COORDS(Global_35, true, false), "DSLIT_Sounds", false, 0, true, 0);
				func_40(&(iLocal_14.f_7), 4);
			}
		
			if (func_39(iLocal_14.f_7, 1) && func_26(&(iLocal_14.f_4)) > 500)
			{
				...
				GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_crackpot_rc_lightening", entityCoords, 0f, 0f, 0f, 1065353216, false, false, false);
				GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_crackpot_rc_lightening_exp", entityCoords, 0f, 0f, 0f, 1065353216, false, false, false);
				func_43(&(iLocal_14.f_7), 1);
				TASK::TASK_PLAY_ANIM(Global_35, func_55(func_15()), func_56(0), 8f, -8f, -1, 2, 0, false, 0, false, 0, false);
				ENTITY::SET_ENTITY_HEALTH(Global_35, 1, 0);
			}
		
			if (func_26(&(iLocal_14.f_4)) > 2000)
			{
				func_23(&(iLocal_14.f_4));
				func_57(uParam0);
				func_58(Global_35, false, false);
				func_50(&iLocal_14, 5);
			}
			break;
...
void func_9(var uParam0) // Position - 0xD12 Hash - 0x8AE9D721 ^0xDBA6EF79
{
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_14.f_2[0]))
		VOLUME::DELETE_VOLUME(iLocal_14.f_2[0]);

	return;
}

int func_10(Hash hParam0) // Position - 0xD33 Hash - 0xB8EC44B7 ^0xB12C5BE7
{
	switch (hParam0)
	{
...
BOOL func_11(int iParam0, BOOL bParam1) // Position - 0x1524 Hash - 0x92045BA6 ^0x92045BA6
{
	if (!func_59(iParam0))
		return false;

	return Global_40.f_8863[func_60(iParam0, 1)] && bParam1 != false;
}

void func_12(var uParam0) // Position - 0x154E Hash - 0xDA8817E5 ^0xAD3AC0C4
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
Vector3 func_13(var uParam0, int iParam1) // Position - 0x1A39 Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case -1859023693:
...
float func_14(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1EEF Hash - 0x3DAE1415 ^0x2267FA69
{
...
BOOL func_15() // Position - 0x1F17 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_64() != -1)
		return false;
...
BOOL func_16(int iParam0) // Position - 0x1F3C Hash - 0x7F255B4B ^0xCD4BFF4B
{
...
BOOL func_17(var uParam0) // Position - 0x1F9B Hash - 0x700EF42A ^0x1FB24E73
{
...
void func_18(var uParam0) // Position - 0x1FB4 Hash - 0xB1BE772 ^0x50C155FC
{
	if (func_33(uParam0->f_6.f_8))
		func_66(&(uParam0->f_6.f_8), true, true);
...
void func_19(var uParam0, int iParam1) // Position - 0x1FF4 Hash - 0x4F8BE4B5 ^0x8A18C31F
{
	uParam0->f_5 = iParam1;
	return;
}

BOOL func_20(var uParam0) // Position - 0x2002 Hash - 0x52835008 ^0x3922FFAC
{
	switch (*uParam0)
	{
		case -1859023693:
...
void func_21(var uParam0) // Position - 0x2CBD Hash - 0x32186C70 ^0xD26CF7E4
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2ED5 Hash - 0x16E871AD ^0x10C54C39
{
...
void func_23(var uParam0) // Position - 0x2EFF Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_24(var uParam0) // Position - 0x2F15 Hash - 0x5001E582 ^0x5001E582
{
	return func_68(*uParam0, 1);
}

void func_25(var uParam0) // Position - 0x2F25 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_69(uParam0, 0f);
	return;
}

int func_26(var uParam0) // Position - 0x2F34 Hash - 0xE440ADBD ^0x7BE35012
{
	if (!func_24(uParam0))
	...
	return func_71() - BUILTIN::ROUND(uParam0->f_1 * 1000f);
}

BOOL func_27(var uParam0, BOOL bParam1) // Position - 0x2F87 Hash - 0x1ACEECAF ^0xDBC34297
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (bParam1)
	{
		...
		if (*uParam0 == -1761578407 || *uParam0 == 404434344 || *uParam0 == -1243267511 || *uParam0 == -607940493 || *uParam0 == 1535254161)
		{
			...
			if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, uParam0->f_6.f_9, true, 0) || !func_74(Global_35, uParam0->f_6.f_2, 0))
				return true;
		}
		else if (func_14(Global_35, uParam0->f_6.f_2, true) > uParam0->f_6.f_1 + 0.5f || !func_74(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
	else
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, true) <= uParam0->f_6.f_1 && func_74(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
...
void func_28(var uParam0) // Position - 0x31A9 Hash - 0x96ECE1F9 ^0x14A28936
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_49(*uParam0))
			{
				uParam0->f_6.f_8 = func_75("DISCO_FOCUS", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
				func_34(uParam0->f_6.f_8, false, true);
			}
			else
			{
				uParam0->f_6.f_8 = func_75("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_75("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_75("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
		}
	
		func_76(uParam0->f_6.f_8, 13, true, true);
		func_77(uParam0->f_6.f_8);
	}

	return;
}

char* func_29(var uParam0) // Position - 0x35F9 Hash - 0x7223E95E ^0xD5221EFC
{
	if (*uParam0 == 404434344)
		if (func_49(*uParam0))
...
void func_30(var uParam0, int iParam1, char* sParam2, BOOL bParam3) // Position - 0x3E6A Hash - 0x92B8786B ^0x6992BF35
{
	int num;
	int num2;
	int num3;
...
BOOL func_31(var uParam0) // Position - 0x3F35 Hash - 0x87BF472A ^0x8A3FB963
{
	if (func_79(uParam0->f_6.f_8, true))
		return true;

	return false;
}

void func_32(int iParam0, BOOL bParam1) // Position - 0x3F50 Hash - 0x54AA129E ^0x54AA129E
{
	if (!func_59(iParam0))
		return;

	Global_40.f_8863[func_60(iParam0, 1)] = Global_40.f_8863[func_60(iParam0, 1)] || bParam1;
	return;
}

BOOL func_33(int iParam0) // Position - 0x3F86 Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
void func_34(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3FC5 Hash - 0x139797B1 ^0x139797B1
{
	int num;
...
void func_35(var uParam0) // Position - 0x3FF1 Hash - 0x9587B5D6 ^0x1009B0AA
{
	if (func_64() != -1)
		return;
	...
	if (*uParam0 == -321841939)
	{
		if (func_81(uParam0->f_4) != 0)
		{
			if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(uParam0->f_4))
				MAP::_MAP_DISCOVER_REGION(func_81(uParam0->f_4));
	...
	{
		if (func_82(*uParam0, uParam0->f_4) != 0)
		{
			if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(func_82(*uParam0, uParam0->f_4)))
				MAP::_MAP_DISCOVER_REGION(func_82(*uParam0, uParam0->f_4));
...
void func_36(var uParam0, BOOL bParam1) // Position - 0x4081 Hash - 0x3BBAC949 ^0x751C9296
{
	int num;
	...
	if (bParam1)
		num = func_87(*uParam0, func_86(), uParam0->f_4);
	else
		num = func_88(*uParam0, uParam0->f_4);
		...
		if (bParam1)
		{
			...
			if (*uParam0 == -890175011)
			{
				if (func_90() == 5 - 1)
				{
					if (func_86())
					{
						func_89(joaat("journal_town_secret_vampmap_ar"), 0);
						num = joaat("journal_town_secret_vampmap_ar");
					}
					else
					{
						func_89(joaat("journal_town_secret_vampmap_jn"), 0);
...
void func_37(BOOL bParam0, int iParam1) // Position - 0x4152 Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
float func_38(int iParam0, BOOL bParam1) // Position - 0x4198 Hash - 0x376EA9F4 ^0xA7A80B21
{
	int num;
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x41F0 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_40(var uParam0, int iParam1) // Position - 0x41FF Hash - 0xF55E891F ^0xF55E891F
{
	func_94(uParam0, iParam1);
	return;
}

void func_41(var uParam0) // Position - 0x420F Hash - 0x7DD80D7C ^0x2A3ED7AA
{
...
void func_42(var uParam0) // Position - 0x4256 Hash - 0xC9354E8F ^0x12F79925
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
void func_43(var uParam0, int iParam1) // Position - 0x4276 Hash - 0xF55E891F ^0xF55E891F
{
	func_95(uParam0, iParam1);
	return;
}

void func_44(var uParam0) // Position - 0x4286 Hash - 0x90A3D13B ^0x25DA303B
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
BOOL func_45(int iParam0) // Position - 0x42A2 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -1891628345:
...
BOOL func_46(var uParam0) // Position - 0x4320 Hash - 0xA77C53D8 ^0x41543EB2
{
	Vector3 vector;
	var coords;
	...
	{
		func_96(*uParam0, &vector);
	
		if (FIRE::GET_OWNER_OF_EXPLOSION_IN_ANGLED_AREA(-1, vector, vector.f_3, vector.f_6) == func_97(Global_35))
		{
			return true;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, const char* sParam3, Entity eParam4, BOOL bParam5, int iParam6, BOOL bParam7) // Position - 0x43A9 Hash - 0xA48CCCFA ^0xD20D1AD3
{
	int num;
	int num2;
	int i;
	...
	{
		func_100(num, false, iParam0, iParam1, sParam3, eParam4, bParam5, bParam7);
	}
	else
	{
		num2 = -1;
		...
		if (num2 >= 0)
			func_101(num2, num, iParam0, iParam1, eParam4, bParam5);
		else
			func_100(num, true, iParam0, iParam1, sParam3, eParam4, bParam5, false);
	}

	return;
}

int func_48() // Position - 0x44A8 Hash - 0x9F572D68 ^0x82B5A9E9
{
	return -715636193;
}

BOOL func_49(int iParam0) // Position - 0x44B5 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_11(iParam0, 2);
}

void func_50(var uParam0, int iParam1) // Position - 0x44C4 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

BOOL func_51() // Position - 0x44D1 Hash - 0x983FC776 ^0x983FC776
{
	if (func_102(0, 4) || func_102(22, 24))
		return true;

	return false;
}

BOOL func_52() // Position - 0x44F4 Hash - 0xF6FE3717 ^0x16AFE3BA
{
	var weatherType1;
	var weatherType2;
...
struct<11> func_53(int iParam0) // Position - 0x4522 Hash - 0x3827C57D ^0xCFC3D5EF
{
	var unk;
	...
	{
		case 0:
			unk = { 2535.516f, 1192.1382f, 165.53082f };
			unk.f_3 = { 3.545323f, 0f, 0f };
			unk.f_6 = { 3f, 3f, 3f };
			unk.f_9 = "LIGHTNING_TREE_CENTER";
...
BOOL func_54(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, Vector3 vParam5, var uParam6, var uParam7, Vector3 vParam8, var uParam9, var uParam10, const char* sParam11) // Position - 0x457A Hash - 0x596E5C13 ^0x19FA27CC
{
	if (!VOLUME::DOES_VOLUME_EXIST(*uParam0))
	{
		if (MISC::IS_STRING_NULL_OR_EMPTY(sParam11))
			sParam11 = "Discoverable_Volume";
...
char* func_55(BOOL bParam0) // Position - 0x45C3 Hash - 0x4CE9C4A5 ^0x6AAB40C3
{
	if (bParam0)
		return "script_amb@discoverables@lightning_trees@john";

	return "script_amb@discoverables@lightning_trees@arthur";
}

char* func_56(int iParam0) // Position - 0x45DB Hash - 0x958AD60F ^0xFA208C1D
{
	switch (iParam0)
	{
		case 0:
			return "lightning_fall";
	
		case 1:
			return "lightning_stumble";
...
void func_57(var uParam0) // Position - 0x4609 Hash - 0x46A0187B ^0x46A0187B
{
	if (!func_49(*uParam0))
	{
		func_104(*uParam0);
...
void func_58(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4629 Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
BOOL func_59(int iParam0) // Position - 0x4665 Hash - 0x1965A61D ^0x1965A61D
{
	int num;

	num = func_60(iParam0, 1);
	return num >= 0 && num < 143;
}

int func_60(int iParam0, int iParam1) // Position - 0x4684 Hash - 0x18EDA9F0 ^0x18EDA9F0
{
	switch (iParam0)
	{
		case -2108030724:
...
Vector3 func_61(var uParam0, int iParam1) // Position - 0x4CCD Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case 2000209669:
...
Vector3 func_62(var uParam0, int iParam1) // Position - 0x4DDE Hash - 0xC47AB599 ^0xC47AB599
{
	switch (*uParam0)
	{
		case -2009137002:
		...
		case 2000209669:
			if (iParam1 == 11)
				return func_61(uParam0, 11);
			else
				return func_61(uParam0, 7);
			break;
...
Vector3 func_63(var uParam0, int iParam1) // Position - 0x5756 Hash - 0xBAE0ABDC ^0xBAE0ABDC
{
	switch (*uParam0)
	{
		case -1887999095:
...
BOOL func_64() // Position - 0x59E8 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0, BOOL bParam1) // Position - 0x59F6 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_66(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5A27 Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
void func_67(var uParam0) // Position - 0x5A7B Hash - 0x87234A3C ^0x21D7A27C
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
	...
	if (*uParam0 == 404434344)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vector, vector2, vector3, func_109(uParam0));
	}
	else if (*uParam0 == -1761578407)
	{
		if (uParam0->f_4 == 0)
	...
	else if (*uParam0 == -1243267511 || *uParam0 == 1535254161 || *uParam0 == -607940493)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			if (*uParam0 == -607940493)
				...
				uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vector, vector2, vector3, func_109(uParam0));
	}
	else if (*uParam0 == -890175011)
	{
		if (uParam0->f_4 == 0)
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x5FEC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_69(var uParam0, float fParam1) // Position - 0x5FFB Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_70(var uParam0) // Position - 0x6021 Hash - 0x39705408 ^0x39705408
{
	return func_68(*uParam0, 2);
}

int func_71() // Position - 0x6031 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_72(var uParam0) // Position - 0x604F Hash - 0xD965F2AB ^0x4503AF3C
{
	switch (*uParam0)
	{
		case -1300082860:
			if (func_113(Global_35, func_105(uParam0, 0), 3f, true, true))
				return true;
			break;
...
BOOL func_73(var uParam0, int iParam1) // Position - 0x6120 Hash - 0x787E614B ^0xC23272A0
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (!func_114(iParam1, 2) && !func_115())
		return false;

	if (!func_114(iParam1, 4) && !func_116())
		return false;

	if (!func_114(iParam1, 128) && !func_117())
		return false;

	if (!func_114(iParam1, 2048) && !func_118(false))
		return false;

	if (!func_114(iParam1, 32) && !func_119(iParam1))
		return false;

	if (!func_114(iParam1, 64) && !func_120())
		return false;

	if (!func_114(iParam1, 256) && CAM::IS_CINEMATIC_CAM_RENDERING())
		return false;

	if (!func_114(iParam1, 512))
		if (PED::GET_PED_CROUCH_MOVEMENT(Global_35))
			return false;

	if (!func_114(iParam1, 1024))
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1))
		return false;
	else if (func_121(Global_35, 1369124074))
		return false;
	else if (func_121(Global_35, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
		return false;

	return true;
}

BOOL func_74(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x62A3 Hash - 0xE63CB60C ^0x5133A9E3
{
...
int func_75(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x62E4 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_123(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, iParam8, 0, pedParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, bParam16);
		return num;
	}
...
void func_76(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x63BB Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
void func_77(int iParam0) // Position - 0x6406 Hash - 0x4FCB23E1 ^0x764A8AAB
{
	int num;
...
int func_78(int iParam0) // Position - 0x6448 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

BOOL func_79(int iParam0, BOOL bParam1) // Position - 0x6452 Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_80(int iParam0, BOOL bParam1) // Position - 0x64AA Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
		if (Global_1945188[iParam0 /*18*/].f_5 == 5 && !func_122(iParam0, 8))
...
Hash func_81(int iParam0) // Position - 0x6502 Hash - 0xB8EC44B7 ^0x184A6D50
{
	switch (iParam0)
	{
		case 0:
...
Hash func_82(int iParam0, int iParam1) // Position - 0x662B Hash - 0xE1D12727 ^0x5FD78BB4
{
	switch (iParam0)
	{
		case -2009137002:
...
void func_83(var uParam0) // Position - 0x6913 Hash - 0x12B095D ^0x8F05BAE7
{
	if (func_64() != -1)
		return;

	if (func_124(*uParam0) != 0)
	{
		if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(func_124(*uParam0)))
			MAP::_MAP_DISCOVER_REGION(func_124(*uParam0));
...
int func_84() // Position - 0x6954 Hash - 0x1767447B ^0x234018D7
{
	int i;
	int num;
	int num2;
...
BOOL func_85() // Position - 0x6992 Hash - 0xA0319B77 ^0x14CE505F
{
	int i;
	int num;
...
BOOL func_86() // Position - 0x69CE Hash - 0x37EC066 ^0xC9B08D38
{
	if (func_64() != -1)
		return false;
...
int func_87(int iParam0, int iParam1, int iParam2) // Position - 0x69F4 Hash - 0xFCD0B11D ^0x62D50FE4
{
	if (iParam1 == true)
	{
		switch (iParam0)
...
int func_88(int iParam0, int iParam1) // Position - 0x7200 Hash - 0xF3B2DCFE ^0x9CB24CD5
{
	int num;

	num = func_87(iParam0, 1, iParam1);

	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(num))
		return num;

	num = func_87(iParam0, 0, iParam1);
...
void func_89(int iParam0, int iParam1) // Position - 0x723D Hash - 0xC0D8FAC3 ^0xE4233006
{
...
int func_90() // Position - 0x7256 Hash - 0xFA45A8A9 ^0x233CB2BD
{
	int num;
...
BOOL func_91() // Position - 0x72DC Hash - 0x4A33814C ^0x6E4357BF
{
	Hash item;

	if (!func_127(joaat("document_player_journal"), 1, false))
	{
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) || func_121(Global_35, 1369124074))
		return false;
	...
	if (INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(func_129(false), item, false))
		return false;
...
void func_92(Hash hParam0, int iParam1) // Position - 0x7409 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_93() // Position - 0x741C Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

void func_94(var uParam0, int iParam1) // Position - 0x743B Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_95(var uParam0, int iParam1) // Position - 0x744C Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_96(Volume volParam0, var uParam1) // Position - 0x7461 Hash - 0x7513460B ^0x6C9F3BDD
{
	float volumeScale;
...
Ped func_97(Ped pedParam0) // Position - 0x74E1 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_98(int iParam0) // Position - 0x74EB Hash - 0xA05361F6 ^0xF8A0FD3E
{
	switch (iParam0)
	{
...
int func_99(int iParam0) // Position - 0x7601 Hash - 0xC25EDEC0 ^0x47BF4274
{
	switch (iParam0)
	{
		case 0:
...
void func_100(int iParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, Entity eParam5, BOOL bParam6, BOOL bParam7) // Position - 0x76E8 Hash - 0x9A51185A ^0xB4CF4D6B
{
	int num;
	int num2;
	int num3;
	...
	Global_40.f_11095.f_35 = func_134(Global_40.f_11095.f_35, num4, num3);
	num2 = func_131();

	if (num2 != num && num2 != 0 || iParam3 == joaat("honor_event_cheat") || bParam7)
	{
		num7 = func_135(num2);
		func_137(func_136(), false, 4000);
		func_138(Global_40.f_11095.f_35);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_141(func_140(joaat("honor_positive_total")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
				else
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
			}
		}
		else
		{
			func_141(func_140(joaat("honor_negative_total")), 1);
			Global_1347477.f_204 = 0;
		
			if (!bParam1)
			{
				if (iParam0 < func_99(4))
				{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
				else
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
			}
		}
	}

	statId = { func_140(joaat("honor_current")) };
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3, Entity eParam4, BOOL bParam5) // Position - 0x7A8D Hash - 0x686957A ^0x8F82E8D6
{
...
int func_102(int iParam0, int iParam1) // Position - 0x7AEC Hash - 0x47F9E16C ^0x979A6503
{
	return func_145(CLOCK::GET_CLOCK_HOURS(), iParam0, iParam1);
}

int func_103(int iParam0) // Position - 0x7B00 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("THUNDER"):
...
void func_104(int iParam0) // Position - 0x7B27 Hash - 0xDA84A767 ^0xDA84A767
{
	func_32(iParam0, 2);
	func_146(iParam0);
	return;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
Vector3 func_105(var uParam0, int iParam1) // Position - 0x7B3C Hash - 0xE500AA03 ^0xE500AA03
{
	switch (*uParam0)
	{
		case -2108030724:
...
Vector3 func_106(var uParam0, int iParam1) // Position - 0x864A Hash - 0xABFFD40 ^0xABFFD40
{
	switch (*uParam0)
	{
		case -2108030724:
...
int func_107(int iParam0) // Position - 0x9199 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_149(iParam0))
		return -1;
...
void func_108(int iParam0) // Position - 0x91B5 Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_151(iParam0))
		return;
...
char* func_109(var uParam0) // Position - 0x9268 Hash - 0x8601690B ^0xB403DBFD
{
	switch (*uParam0)
	{
		case -1761578407:
...
float func_110() // Position - 0x942F Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_111(var uParam0, int iParam1) // Position - 0x9461 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_112(var uParam0, int iParam1) // Position - 0x9472 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_113(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9487 Hash - 0x4F47D7F1 ^0x1C676405
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
	...
	if (bParam6)
		if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
			return true;
	else if (func_152(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
		return true;

	return false;
}

BOOL func_114(int iParam0, int iParam1) // Position - 0x94E2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_115() // Position - 0x94F1 Hash - 0xD50A7FC ^0x92986A81
{
...
BOOL func_116() // Position - 0x9591 Hash - 0x52218EDE ^0x68EAB229
{
...
BOOL func_117() // Position - 0x9626 Hash - 0xD14A8C13 ^0x8AD85514
{
	if (func_154(Global_35) && !Global_1392040.f_2)
		return false;

	if (func_155(Global_35) && !Global_1392040.f_2)
		return false;

	return true;
}

BOOL func_118(BOOL bParam0) // Position - 0x9663 Hash - 0x19762284 ^0x556D18B9
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !Global_1392040.f_2)
	{
		if (bParam0)
			func_156("ITEM_UNUSABLE_CARRYING", 10000, 0, 0, 0, true);
...
BOOL func_119(int iParam0) // Position - 0x969B Hash - 0xEEF44B5 ^0x85627F39
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if (!func_114(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35) && VEHICLE::GET_DRIVER_OF_VEHICLE(vehiclePedIsUsing) == Global_35)
			return false;
	}
...
BOOL func_120() // Position - 0x9773 Hash - 0xFFDF5CA4 ^0x50D2CF98
{
...
BOOL func_121(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x978A Hash - 0x37FB14EB ^0x7E496A4A
{
...
BOOL func_122(int iParam0, int iParam1) // Position - 0x97B3 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_123(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Ped pedParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x97D4 Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
	...
	func_80(iParam0, true);
	func_158(iParam0, true);
	func_159(iParam0, 128);
	return;
}

Hash func_124(int iParam0) // Position - 0x9A7A Hash - 0xB8EC44B7 ^0xC091C19D
{
	switch (iParam0)
	{
		case -2060865802:
...
int func_125(int iParam0) // Position - 0x9B6B Hash - 0x333EB83A ^0x37C96C1F
{
	switch (iParam0)
	{
		case 0:
...
void func_126(BOOL bParam0) // Position - 0x9C69 Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
		func_160(&(Global_40.f_12019.f_42), 1);
	else
		func_161(&(Global_40.f_12019.f_42), 1);

	return;
}

BOOL func_127(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x9C93 Hash - 0x41C0912B ^0x734B270C
{
	int num;

	if (!func_162(hParam0, 0))
		return false;
	...
	if (num == joaat("WEAPON"))
		...
		if (!func_164(hParam0, 1))
			return false;

	return func_165(hParam0, false, bParam2) >= iParam1;
}

BOOL func_128(int iParam0) // Position - 0x9CFD Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_166(iParam0);
}

int func_129(BOOL bParam0) // Position - 0x9D0B Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_64() == -1)
	{
...
void func_130() // Position - 0x9D4C Hash - 0x5808700A ^0x37855CE9
{
...
int func_131() // Position - 0x9DA1 Hash - 0x990ADDDC ^0x7D78C12
{
	int num;
...
int func_132(int iParam0) // Position - 0x9EB4 Hash - 0xFA6423C1 ^0xB73AD7F1
{
	float num;
	float value;
...
BOOL func_133(int iParam0) // Position - 0x9F59 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_169(iParam0))
		return false;
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0x9F75 Hash - 0x1D7642BB ^0x1D7642BB
{
	if (iParam0 > iParam2)
		return iParam2;
...
int func_135(int iParam0) // Position - 0x9F9A Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case -320:
...
Hash func_136() // Position - 0xA051 Hash - 0xA46C8CCA ^0x71ABACD2
{
...
void func_137(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xA1A9 Hash - 0x25ED411C ^0xE6F9BEA9
{
	func_171(MISC::GET_GAME_TIMER() + iParam2, !bParam1);
	DATABINDING::_DATABINDING_WRITE_DATA_INT(Global_1954819.f_1.f_2.f_1, hParam0);
	func_172(hParam0);
	return;
}

void func_138(int iParam0) // Position - 0xA1D5 Hash - 0x1FF74488 ^0xA40278BB
{
	...
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1954819.f_5.f_2[0 /*36*/].f_20[2], func_173(iParam0));
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1954819.f_5.f_2[0 /*36*/].f_24[2], "pausemenu_player");
	return;
}

// Unhandled jump detected. Output should be considered invalid
void func_139(BOOL bParam0) // Position - 0xA239 Hash - 0x9BEFE017 ^0x9BEFE017
{
	int num;
	Hash unlockHash;
	Hash hash;
		...
		for (i = 0; i < num2; i = i + 1)
		{
			if (func_175(i, &hash, &num))
			{
				...
				else
				{
					...
					if (func_163(hash) == joaat("weapon_mod"))
						if (num == 1014511709)
							flag = func_131() <= -160;
...
struct<2> func_140(int iParam0) // Position - 0xA2FA Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_141(var uParam0, var uParam1, int iParam2) // Position - 0xA30A Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

const char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xA31A Hash - 0xA17D549C ^0x45A070B0
{
	switch (iParam0)
	{
		case joaat("honor_event_abandon_animals"):
...
int func_143(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xA466 Hash - 0x72075C17 ^0x3AC6D3FB
{
	int num;
	var unk13;
	int num2;
	...
	func_178(sParam0, sParam1, hParam2);
	return num2;
}

int func_144(int iParam0, int iParam1) // Position - 0xA4C9 Hash - 0x969A241 ^0xB7B020D1
{
	Hash chalHash;
	Hash goalHash;
	...
	if (!func_180(iParam0, &chalHash, &goalHash))
		return 0;
...
int func_145(int iParam0, int iParam1, int iParam2) // Position - 0xA524 Hash - 0xD8381BE7 ^0xD8381BE7
{
	BOOL flag;
	int num;
	int num2;
...
void func_146(int iParam0) // Position - 0xA5CD Hash - 0xF9F788B3 ^0x8192C5D9
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_181(iParam0))
			func_141(func_140(joaat("discoverable_found")), 1);
	}

	return;
}

BOOL func_147() // Position - 0xA609 Hash - 0x18690106 ^0x764E08E6
{
	if (func_182(932909855))
		return true;

	return false;
}

BOOL func_148() // Position - 0xA622 Hash - 0x18690106 ^0xE41C0B15
{
	if (func_182(2051822093))
		return true;

	return false;
}

BOOL func_149(int iParam0) // Position - 0xA63B Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_150(int iParam0) // Position - 0xA66E Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_151(int iParam0) // Position - 0xA6AF Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_122(iParam0, 2);
}

float func_152(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xA6BE Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_153(Ped pedParam0) // Position - 0xA6DC Hash - 0xF2F988FE ^0xA63CD631
{
...
BOOL func_154(Ped pedParam0) // Position - 0xA7C4 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_184(pedParam0, 4) || func_184(pedParam0, 5);
}

BOOL func_155(Ped pedParam0) // Position - 0xA7E0 Hash - 0x8F7DFED5 ^0x8768F0B4
{
	var lootTarget;
...
int func_156(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xA84A Hash - 0x8EBD6187 ^0x42F0F0AC
{
	int num;
	var unk13;
	int num2;
...
BOOL func_157(int iParam0) // Position - 0xA885 Hash - 0xCB0CD3AF ^0x98FF0773
{
	Ped mount;

	mount = PED::GET_MOUNT(Global_35);

	if (!func_185(Global_35))
		return false;

	if (!func_114(iParam0, 16) && !func_186(mount, false))
		return false;

	return true;
}

void func_158(int iParam0, BOOL bParam1) // Position - 0xA8C3 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_159(int iParam0, int iParam1) // Position - 0xA8EC Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
void func_160(int iParam0, int iParam1) // Position - 0xA914 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_161(int iParam0, int iParam1) // Position - 0xA925 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_162(Hash hParam0, int iParam1) // Position - 0xA93A Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
int func_163(Hash hParam0) // Position - 0xA954 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_164(Hash hParam0, int iParam1) // Position - 0xA97F Hash - 0x2A2D0794 ^0x8C1DA314
{
	Hash hash;
	int num;
	int num2;
	...
	hash = func_187(hParam0, iParam1);
	unk.f_9 = joaat("SLOTID_NONE");

	if (func_188("ALL WEAPONS", &num, &num2, joaat("SLOTID_NONE"), false))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			if (!func_189(&unk, i, num, num2))
			{
			}
			else if (!func_190(unk.f_4))
			{
			}
...
int func_165(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAA27 Hash - 0x27EBD222 ^0x461275A8
{
	int num;
	Hash ammoType;
	...
	{
		return func_192(hParam0, false);
	}

	inventoryItemCountWithItemid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_129(bParam2), hParam0, false);
	return inventoryItemCountWithItemid;
}

BOOL func_166(int iParam0) // Position - 0xAAA9 Hash - 0xA059D395 ^0xE600C05
{
	return func_39(Global_1935496.f_27, iParam0);
}

int func_167() // Position - 0xAABD Hash - 0xC5B83CF5 ^0xDBC2A9A7
{
	return Global_40.f_11095.f_35;
}

var func_168(BOOL bParam0, var uParam1, var uParam2) // Position - 0xAACD Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_169(int iParam0) // Position - 0xAAE4 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_170(int iParam0) // Position - 0xAAF7 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_171(int iParam0, BOOL bParam1) // Position - 0xAB21 Hash - 0xE5C16A63 ^0x600C7934
{
...
void func_172(Hash hParam0) // Position - 0xAB3C Hash - 0x246AED7E ^0x92A2F577
{
	COMPAPP::_0x74BCCEB233AD95B2(joaat("HonorMeterValue"), hParam0);
	return;
}

char* func_173(int iParam0) // Position - 0xAB4F Hash - 0x8FB6A40C ^0xB26F6F75
{
	if (iParam0 <= -320)
		return "HONOR_BAD_8";
	else if (iParam0 <= -280)
...
BOOL func_174(var uParam0) // Position - 0xAC70 Hash - 0x89D7A86C ^0xC5CDC47A
{
	var unk;
...
BOOL func_175(int iParam0, var uParam1, var uParam2) // Position - 0xACB8 Hash - 0x2D6E55B7 ^0xC1202559
{
	var unk;
	var unk6;
...
Hash func_176(Hash hParam0) // Position - 0xAD38 Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

int func_177() // Position - 0xAD42 Hash - 0xE17CEFF5 ^0x60DBA116
{
	int num;
...
void func_178(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0xAD91 Hash - 0xC233DF85 ^0x5FF82D96
{
...
BOOL func_179(int iParam0) // Position - 0xADC2 Hash - 0xB0C53BA8 ^0xB0C53BA8
{
...
BOOL func_180(int iParam0, var uParam1, var uParam2) // Position - 0xADE1 Hash - 0xB903AED3 ^0x206B1C87
{
	if (!func_179(iParam0))
		return false;
...
BOOL func_181(int iParam0) // Position - 0xAFB0 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -2009137002:
...
BOOL func_182(int iParam0) // Position - 0xB0DC Hash - 0xBF89485 ^0x62E162D4
{
	int num;
	int num2;
	int offset;
...
int func_183(int iParam0) // Position - 0xB12B Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
int func_184(Ped pedParam0, int iParam1) // Position - 0xB1AC Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
BOOL func_185(Ped pedParam0) // Position - 0xB1EB Hash - 0x28235D58 ^0x5BD1001B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_186(Ped pedParam0, BOOL bParam1) // Position - 0xB208 Hash - 0x6BE4D4B ^0xC7F6BBCD
{
	float entitySpeed;
	float num;
...
Hash func_187(Hash hParam0, int iParam1) // Position - 0xB25E Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_188(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xB2D8 Hash - 0xA7F38D3E ^0x25D43AAB
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_129(bParam4), sParam0, hParam3, piParam2);
...
BOOL func_189(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB2FF Hash - 0xF1DE71ED ^0x4F212F50
{
	if (iParam2 < 0)
		return false;
...
BOOL func_190(Hash hParam0) // Position - 0xB33A Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_191(int iParam0) // Position - 0xB355 Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
int func_192(Hash hParam0, BOOL bParam1) // Position - 0xB376 Hash - 0x884C76BA ^0xDB141D11
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_198(hParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) };

	if (bParam1)
		func_200(&unk, func_199(false));

	if (!func_201(&unk, &num, &num2, false))
		return 0;
...
void func_193(BOOL bParam0) // Position - 0xB3D4 Hash - 0x970FE035 ^0x92589DF6
{
	func_202(bParam0);
...
BOOL func_194(int iParam0, var uParam1) // Position - 0xB407 Hash - 0xDBBC0B25 ^0xDBBC0B25
{
	if (!func_203(iParam0))
		return false;
...
int func_195(int iParam0, int iParam1) // Position - 0xB434 Hash - 0x8FA0E29 ^0xC3F68E87
{
	switch (iParam0)
	{
		case -2106445152:
...
BOOL func_196(Hash hParam0, Hash hParam1) // Position - 0xC54F Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
void func_197(Hash hParam0, var uParam1, var uParam2) // Position - 0xC580 Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_198(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC78C Hash - 0x84700F53 ^0xB9E7AA96
{
	Hash hash;
...
struct<4> func_199(BOOL bParam0) // Position - 0xC85E Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;

	num = func_129(bParam0);

	if (num == 2)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223200))
			Global_1223200 = { func_205(923904168, func_204(bParam0), -740156546, bParam0) };
	...
	else if (num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223208))
			Global_1223208 = { func_205(923904168, func_204(bParam0), -740156546, false) };
	
		return Global_1223208;
	}

	return func_205(923904168, func_204(bParam0), -740156546, false);
}

void func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xC8F3 Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_201(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xC90E Hash - 0xA09A22CB ^0x2B47F617
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_129(bParam3), panParam0, piParam2);
...
void func_202(BOOL bParam0) // Position - 0xC933 Hash - 0x246AED7E ^0xB30D729F
{
	COMPAPP::_0xB6FD96420C0126A1(joaat("HonorMeterVisible"), bParam0);
	return;
}

BOOL func_203(int iParam0) // Position - 0xC946 Hash - 0x3270B633 ^0x3270B633
{
	return iParam0 > -1 && iParam0 < 25;
}

struct<4> func_204(BOOL bParam0) // Position - 0xC95C Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_205(joaat("character"), func_206(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> func_205(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xC978 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_129(bParam6), &uParam1, hParam0, hParam5, &outGuid);
	return outGuid;
}

struct<4> func_206() // Position - 0xC9A9 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
