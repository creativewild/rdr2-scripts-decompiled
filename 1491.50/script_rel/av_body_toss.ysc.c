...
void main() // Position - 0x0 Hash - 0x9DC4ED7A ^0xB73C57E1
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9C7 Hash - 0x4DA9BC8C ^0xC28EDC68
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBB Hash - 0x404943F0 ^0x404943F0
{
	int num;

	func_46(uParam0, "AV_BODY_TOSS", "script@ambient@generic@Body_Toss@Action", uParam1, uParam4);
	func_47(uParam0, 1, "pl_Action", "", 0);
	num = func_49(func_48());
	func_50(uParam0, 0, "MALE_A", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "MALE_B", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 2, "MALE_DEAD", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C3D Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CDD Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DF7 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FC0 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FC9 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2179 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21ED Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x223C Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2294 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23FD Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2724 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x285B Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x298B Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29CA Hash - 0x7B015ACE ^0x45F393DE
{
	PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 186, true);
	PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 385, true);
	return true;
}

void func_29(var uParam0) // Position - 0x29F0 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A22 Hash - 0x67E68B94 ^0x67E68B94
{
...
int func_31(var uParam0) // Position - 0x2A5C Hash - 0x3AA43069 ^0x1DDA8F0C
{
	var unk;
	int i;
	...
	if (!uParam0->f_469[0])
	{
		for (i = 0; i < 3; i = i + 1)
		{
			...
			{
				if (func_65(uParam0->f_20[i /*14*/], 0, &uLocal_9, &unk, 0, 0))
				{
		...
		if (uParam0->f_469[0])
		{
			...
			PED::SET_PED_TO_RAGDOLL(uParam0->f_20[2 /*14*/], 3000, &func_58, 0, false, true, 0);
			return 1;
		}
	}
	...
	if (!uParam0->f_469[4])
	{
		if (PED::IS_PED_DEAD_OR_DYING(uParam0->f_20[2 /*14*/], true))
		{
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
			{
				PERSISTENCE::_0x3CA5E58C9731A16B(uParam0->f_20[2 /*14*/], 60);
				uParam0->f_469[4] = 1;
			}
		}
	}
	...
	if (!uParam0->f_469[2])
	{
		if (func_68(uParam0, 1065353216, 50f, 4, 25f, 1112014848))
		{
			func_66(uParam0);
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[7])
		{
			if (func_69(uParam0, fLocal_37, 50f, 4, joaat("Action"), true))
			{
				func_67(*uParam0, uParam0->f_483, true);
				uParam0->f_469[7] = 1;
			}
	...
	if (uParam0->f_469[2])
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
			{
				...
				TASK::TASK_WANDER_STANDARD(uParam0->f_20[1 /*14*/], ENTITY::GET_ENTITY_HEADING(uParam0->f_20[1 /*14*/]), 1);
...
int func_32(var uParam0, var uParam1) // Position - 0x2D66 Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_70(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D78 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D95 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2ED1 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x300A Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30B4 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x312C Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31BB Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x32D6 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x32E2 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x346A Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x350A Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x351D Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3537 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x359F Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x35CB Hash - 0xF0D98862 ^0x21440CE
{
...
int func_48() // Position - 0x35FC Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_49(int iParam0) // Position - 0x360A Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
void func_50(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x36FB Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3789 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x398D Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x39A1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x39B0 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_71() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x39CB Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3A2A Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3A6C Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3A98 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3B14 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3B38 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3B5E Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3B80 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3BA2 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3BC4 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_65(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x3BE8 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_98(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		{
			if (func_99(pedParam0, iParam2))
			{
				*uParam3 = 128;
				func_100(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_102(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_100(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_104(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_105(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_106(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_100(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_107(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_100(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_108(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_100(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_108(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_100(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_111(iParam2, 4000))
				{
					if (func_112(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_113(iParam2, pedParam0) && func_114(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_100(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_112(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_113(iParam2, pedParam0) && func_114(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_100(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_115(pedParam0, Global_1935630.f_41))
							{
								func_116();
								*uParam3 = 2;
								func_100(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_117(iParam2, pedParam0) || iParam2->f_9 > 0 && func_118() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_119())
					{
						if (func_115(pedParam0, Global_1935630.f_42))
						{
							func_116();
							*uParam3 = 2;
							func_100(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_121(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_100(pedParam0, iParam2, *uParam3);
					return true;
...
void func_66(var uParam0) // Position - 0x4212 Hash - 0xEFEA48FE ^0xEFEA48FE
{
	if (!uParam0->f_469[8])
	{
...
void func_67(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4239 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_68(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x433D Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_131(Global_35))
		{
			ped = func_132(Global_35);
		...
		num = num * num;
		fParam2 = func_133(fParam2);
		num2 = func_134(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_135(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_136(&(uParam0->f_490)))
							func_137(&(uParam0->f_490));
					
						if (func_138(&(uParam0->f_490), iParam1))
						{
...
BOOL func_69(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4548 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_135(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_136(&(uParam0->f_490)))
							func_140(&(uParam0->f_490), false);
		...
		if (func_136(&(uParam0->f_490)) && !func_141(&(uParam0->f_490)))
...
void func_70(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4671 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_71() // Position - 0x47C5 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_72(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x47D3 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x483A Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_74(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4863 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_145(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_75(var uParam0, var uParam1, var uParam2) // Position - 0x48AF Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_145(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_76(int iParam0) // Position - 0x48FE Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_77(int iParam0) // Position - 0x4923 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_78(int iParam0) // Position - 0x4936 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_79(int iParam0) // Position - 0x4949 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_80(int iParam0) // Position - 0x495C Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_81(int iParam0) // Position - 0x496E Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_82(int iParam0, int iParam1) // Position - 0x4980 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4A1A Hash - 0xA65AB937 ^0xA65AB937
{
	func_147(iParam0, iParam6);
	func_148(iParam0, iParam5);
	func_149(iParam0, iParam4);
	func_150(iParam0, iParam3);
	func_151(iParam0, iParam2);
	func_152(iParam0, iParam1);
	return;
}

BOOL func_84() // Position - 0x4A52 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_85(int iParam0) // Position - 0x4AA5 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_88(iParam0))
		return -1;

	return func_154(func_153(iParam0));
}

BOOL func_86(int iParam0) // Position - 0x4AC5 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_87(int iParam0, int iParam1) // Position - 0x4ADB Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_88(int iParam0) // Position - 0x4AEA Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_89(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4B1D Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_155(eptParam1))
		{
			func_156(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_158(pedParam0, false);
			flag = true;
		}
	
		func_159(pedParam0, iParam2);
	}
...
void func_90(int iParam0, BOOL bParam1) // Position - 0x4BFE Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_97(iParam0, 4);
	else
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x4C1C Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_97(iParam0, 8);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4C3C Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_97(iParam0, 16);
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4C67 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_97(iParam0, 32);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4C87 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_97(iParam0, 64);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4CA7 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4CC9 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_97(int iParam0, int iParam1) // Position - 0x4CED Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_98(int iParam0, BOOL bParam1, int iParam2) // Position - 0x4CFE Hash - 0x37D64B11 ^0xE7060A9E
{
	func_160(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_162(true))
							func_97(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_162(true) || *iParam0 & 8192 != 0)
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_163(iParam0))
				iParam0->f_15 = func_118();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_118() - iParam0->f_15 > 500)
			{
...
BOOL func_99(Ped pedParam0, int iParam1) // Position - 0x4EC9 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_165(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_166(pedParam0, pedIndexFromEntityIndex) <= func_167(iParam1))
				return true;
			break;
	}
...
void func_100(Ped pedParam0, int iParam1, int iParam2) // Position - 0x4FA0 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_168(iParam2, 1, 1, 1, 0))
		func_97(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_169(iParam1, true);
	func_170();
	return;
}

BOOL func_101(Ped pedParam0, int iParam1) // Position - 0x4FDD Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	{
		if (func_171(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_173(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_174(iParam1);
...
BOOL func_102(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x50C4 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_175(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_172(iParam2);
	
		if (func_173(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_174(iParam2))
				{
					func_169(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_103(Ped pedParam0, int iParam1) // Position - 0x519A Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_165(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_174(iParam1))
		{
			customDistance = func_172(iParam1);
...
BOOL func_104(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x52A3 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x53D8 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_106(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x540F Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_107(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5516 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_178(iParam2))
	{
...
BOOL func_108(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5581 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_180(pedParam1, entityCoords, outCoords))
					{
						func_169(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_180(pedParam1, entityCoords, outCoords2))
					{
						func_169(iParam2, true);
						return true;
					}
...
BOOL func_109(Ped pedParam0, int iParam1) // Position - 0x56C9 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_165(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_181(Global_1935630.f_34[i]);
			...
			if (func_182(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_183(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_184(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_110(var uParam0, int iParam1) // Position - 0x58A5 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_111(int iParam0, int iParam1) // Position - 0x591D Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_112(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x594C Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_113(int iParam0, Ped pedParam1) // Position - 0x5AD2 Hash - 0x471C77A9 ^0xD6A13638
{
	int _int;
...
BOOL func_114(int iParam0, Ped pedParam1) // Position - 0x5B1F Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_187(iParam0))
		return true;
...
BOOL func_115(Ped pedParam0, Ped pedParam1) // Position - 0x5BBC Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_188(pedParam0, pedParam1, true, true) < 4f)
...
void func_116() // Position - 0x5C09 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_117(int iParam0, Ped pedParam1) // Position - 0x5C11 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_189(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_118();
			return true;
		}
...
int func_118() // Position - 0x5CD2 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_119() // Position - 0x5CF0 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_118() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_120(int iParam0, Ped pedParam1) // Position - 0x5D3D Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_191(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_192(pedParam1);
	num2 = func_193(iParam0->f_14);
...
BOOL func_121(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5E59 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_194(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_122(Ped pedParam0, int iParam1) // Position - 0x5EA1 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_195(pedParam0, iParam1, true))
			return true;
...
BOOL func_123(Ped pedParam0, int iParam1) // Position - 0x60FA Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_197(0))
		return false;
...
BOOL func_124(int iParam0, int iParam1) // Position - 0x6133 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_125(var uParam0, int iParam1) // Position - 0x6162 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_126(Ped pedParam0, int iParam1) // Position - 0x6176 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_118();
	else if (func_118() - iParam1->f_4 > func_198(iParam1))
		return func_199(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_127(int iParam0, Ped pedParam1) // Position - 0x61C3 Hash - 0xF86C09C8 ^0x717CEFB3
{
...
void func_128(int iParam0, BOOL bParam1) // Position - 0x6216 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_129(int iParam0) // Position - 0x62ED Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_200(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_200(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_200(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_130(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x636E Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_145(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_131(Ped pedParam0) // Position - 0x645F Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_132(Ped pedParam0) // Position - 0x647A Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_133(float fParam0) // Position - 0x6496 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_134(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x64DD Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_135(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x64FB Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_201(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_136(var uParam0) // Position - 0x6552 Hash - 0x5001E582 ^0x5001E582
{
	return func_202(*uParam0, 1);
}

void func_137(var uParam0) // Position - 0x6562 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_203(uParam0, 0f);
	return;
}

BOOL func_138(var uParam0, int iParam1) // Position - 0x6571 Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_143(uParam0, iParam1))
	{
		func_139(uParam0);
		return true;
	}
...
void func_139(var uParam0) // Position - 0x658F Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_140(var uParam0, BOOL bParam1) // Position - 0x65A5 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_141(var uParam0) // Position - 0x65C5 Hash - 0x39705408 ^0x39705408
{
	return func_202(*uParam0, 2);
}

void func_142(var uParam0) // Position - 0x65D5 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_136(uParam0);

	if (func_141(uParam0))
	{
		uParam0->f_1 = func_204() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_205(uParam0, 2);
	}
...
BOOL func_143(var uParam0, float fParam1) // Position - 0x6609 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_136(uParam0))
		return false;
...
void func_144(var uParam0) // Position - 0x6630 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_136(uParam0);

	if (!func_141(uParam0))
	{
		uParam0->f_2 = func_204() - uParam0->f_1;
		func_207(uParam0, 2);
	}
...
BOOL func_145(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x6660 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_146(BOOL bParam0, var uParam1, var uParam2) // Position - 0x66B5 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_147(int iParam0, int iParam1) // Position - 0x66CC Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_148(int iParam0, int iParam1) // Position - 0x6752 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_149(int iParam0, int iParam1) // Position - 0x678E Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_150(int iParam0, int iParam1) // Position - 0x67E1 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_151(int iParam0, int iParam1) // Position - 0x681C Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_152(int iParam0, int iParam1) // Position - 0x6855 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_153(int iParam0) // Position - 0x688D Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_154(BOOL bParam0) // Position - 0x68CB Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_155(ePedType eptParam0) // Position - 0x68DE Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_156(Ped pedParam0, Hash hParam1) // Position - 0x6D31 Hash - 0x58B21248 ^0xAF3AC581
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_208(pedParam0, hParam1))
		{
...
void func_157(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6DD8 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_158(Ped pedParam0, BOOL bParam1) // Position - 0x6E08 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_159(Ped pedParam0, int iParam1) // Position - 0x6E4D Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_160(int iParam0) // Position - 0x6E74 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_213(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_161(int iParam0) // Position - 0x6FE0 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_162(BOOL bParam0) // Position - 0x6FF3 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_214(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_163(int iParam0) // Position - 0x700D Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_164(int iParam0) // Position - 0x70A5 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_165(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x70CC Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_193(pedParam2);
	else
		num2 = func_192(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_193(pedParam0);
	else
		num = func_192(pedParam0);
...
float func_166(Ped pedParam0, Ped pedParam1) // Position - 0x71C5 Hash - 0xF9959663 ^0xF9959663
{
	return func_188(pedParam0, pedParam1, true, true);
}

float func_167(int iParam0) // Position - 0x71D7 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_168(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x71E3 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x7248 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_170() // Position - 0x726E Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_171(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7282 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_188(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_218(ped, 0)))
			if (func_219(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_172(int iParam0) // Position - 0x73E2 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_173(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x73EE Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_174(int iParam0) // Position - 0x744F Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_175(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x745B Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_218(ped, 0)))
			if (func_220(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_176(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x751D Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_177(int iParam0) // Position - 0x75BB Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_178(int iParam0) // Position - 0x75C7 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_179(int iParam0) // Position - 0x75D3 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_180(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7710 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_221(pedParam0, vParam4, 0.5f))
...
BOOL func_181(Ped pedParam0) // Position - 0x7753 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_222(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_182(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77B9 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_183(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7800 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_184(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x784B Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_185(Ped pedParam0, var uParam1) // Position - 0x78C4 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_186(Ped pedParam0, Ped pedParam1) // Position - 0x7911 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_224(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_187(int iParam0) // Position - 0x7959 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_188(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7969 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_189(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x79B1 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_190(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x79DD Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_191(int iParam0) // Position - 0x7A05 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_192(Ped pedParam0) // Position - 0x7A11 Hash - 0xE615854F ^0xBB8F8F86
{
...
int func_193(Ped pedParam0) // Position - 0x7A65 Hash - 0x68033859 ^0x877F86FF
{
...
BOOL func_194(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7ACF Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_188(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_188(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_195(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7C3F Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_214(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_196(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_196(iParam1, ped2))
...
BOOL func_196(int iParam0, Ped pedParam1) // Position - 0x7D2D Hash - 0x5758D472 ^0x35F89F7A
{
...
BOOL func_197(int iParam0) // Position - 0x7DA1 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_225())
		return false;

	return func_226(Global_1347702[58 /*49*/].f_15, true);
}

int func_198(int iParam0) // Position - 0x7DC3 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_199(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7DCF Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_200(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7E4A Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_227(iParam0) == 1 && bParam7)
		return;
...
float func_201(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7ED6 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_202(int iParam0, int iParam1) // Position - 0x7EF4 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_203(var uParam0, float fParam1) // Position - 0x7F03 Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_204() - fParam1;
	func_207(uParam0, 1);
	func_205(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
float func_204() // Position - 0x7F29 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_205(var uParam0, int iParam1) // Position - 0x7F5B Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_206(var uParam0) // Position - 0x7F70 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_136(uParam0))
		return uParam0->f_1;
	...
	return func_204() - uParam0->f_1;
}

void func_207(var uParam0, int iParam1) // Position - 0x7FA5 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_208(Ped pedParam0, Hash hParam1) // Position - 0x7FB6 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_209(Ped pedParam0, Hash hParam1) // Position - 0x7FE4 Hash - 0x773BC648 ^0xB2B7D15D
{
	Hash _int;
...
BOOL func_210(Ped pedParam0, Hash hParam1) // Position - 0x8038 Hash - 0xAA3D953 ^0xF8ECFED3
{
	Hash _int;
	int _int2;
...
void func_211(Ped pedParam0) // Position - 0x80A8 Hash - 0x2342CD6D ^0x69F576C6
{
...
BOOL func_212() // Position - 0x80C5 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_228())
		return false;
...
void func_213(Any* panParam0, int iParam1) // Position - 0x811B Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_214(BOOL bParam0, var uParam1, var uParam2) // Position - 0x81C3 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_215() // Position - 0x828A Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_216(int iParam0) // Position - 0x8298 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_217(int iParam0) // Position - 0x8340 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_218(Ped pedParam0, int iParam1) // Position - 0x83A5 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_219(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x83BC Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_220(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_220(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x83EA Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_221(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8434 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_222(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8475 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_223(Ped pedParam0) // Position - 0x84EE Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_224(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x85D6 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_225() // Position - 0x8618 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_215() != -1)
		return false;
...
BOOL func_226(int iParam0, BOOL bParam1) // Position - 0x863D Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_227(int iParam0) // Position - 0x866E Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_228() // Position - 0x8681 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_229(int iParam0) // Position - 0x86B2 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_88(iParam0))
		return -1;
...
int func_230(int iParam0) // Position - 0x86CE Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_231(int iParam0) // Position - 0x870F Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
