#region Local Var
	...
	var uLocal_31 = 0;
	var uLocal_32 = 0;
	var uLocal_33 = 1097859072;
	var uLocal_34 = 1000;
	var uLocal_35 = 1067450368;
	var uLocal_36 = 5000;
	var uLocal_37 = 42;
	var uLocal_38 = 1103626240;
	var uLocal_39 = 1077936128;
	var uLocal_40 = 1106247680;
	var uLocal_41 = 1103101952;
...
void main() // Position - 0x0 Hash - 0xE95FC2B3 ^0xE11F036B
{
	var unk;
	BOOL flag;
...
BOOL func_1() // Position - 0x580 Hash - 0xEE877ACE ^0xCCE9C802
{
...
void func_2(var uParam0) // Position - 0x5A1 Hash - 0x646928F0 ^0x646928F0
{
	func_5(uParam0);
	return;
}

void func_3(var uParam0) // Position - 0x5AF Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_4(var uParam0) // Position - 0x645 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_5(var uParam0) // Position - 0x9EB Hash - 0x4DA9BC8C ^0x65E95319
{
	func_34(uParam0, &func_31, &func_32, &func_33);
	return;
}

void func_6(Volume volParam0) // Position - 0xA05 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_7(var uParam0) // Position - 0xA1C Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xADA Hash - 0x16E871AD ^0x10C54C39
{
...
int func_9(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB04 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_10(int iParam0, int iParam1) // Position - 0xC55 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_11(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC6A Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_12(int iParam0) // Position - 0xD0E Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_13(int iParam0) // Position - 0x1ABF Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_44(iParam0))
	{
...
Volume func_14(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B25 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_15(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BDF Hash - 0x3AC4E9C1 ^0xEF7523BE
{
	Hash hash;
	Hash hash2;

	func_47(uParam0, "RIDGELINE_RIDER", "", uParam1, uParam4);
	hash = func_49(func_48(), true, true, true, true, false, true);
	hash2 = func_50(joaat("horse_class_riding"), true);
	func_51(uParam0, 0, "RR_HORSE", hash2, uParam1, 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "RR_MAN", hash, uParam1, 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_16(var uParam0) // Position - 0x1C57 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_17(var uParam0) // Position - 0x1CF7 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_18(var uParam0) // Position - 0x1E11 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_19(var uParam0) // Position - 0x1FDA Hash - 0xBD31767A ^0x21009BE6
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED("AI_GESTURES@GEN_MALE@STANDING@SPEAKER"))
		return 0;

	return 1;
}

BOOL func_20(var uParam0) // Position - 0x1FF2 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_21(var uParam0) // Position - 0x21A2 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_22(int iParam0) // Position - 0x2216 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_23(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2265 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_24(var uParam0) // Position - 0x22BD Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_25(var uParam0) // Position - 0x2426 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_26(var uParam0) // Position - 0x274D Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_27(var uParam0) // Position - 0x2884 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_28(var uParam0) // Position - 0x29B4 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_29(var uParam0) // Position - 0x29F3 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_30(var uParam0) // Position - 0x29FC Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_31(var uParam0) // Position - 0x2A2E Hash - 0xD6A92F95 ^0x72EC2886
{
	STREAMING::REQUEST_ANIM_DICT("AI_GESTURES@GEN_MALE@STANDING@SPEAKER");
	func_59(&uLocal_16, false);
	func_60(&uLocal_16, true);
	func_61(&uLocal_16, true);
	func_62(&uLocal_16, true);
	func_63(&uLocal_16, true);
	func_64(&uLocal_16, true);
	func_65(&uLocal_16, true);
	return 1;
}

int func_32(var uParam0) // Position - 0x2A6F Hash - 0xEE939489 ^0xEE939489
{
	int taskSequenceId;

	if (!uParam0->f_469[1])
	{
		if (func_66(uParam0, &uLocal_16, false))
		{
			func_67(uParam0);
			uParam0->f_469[1] = 1;
			iLocal_9 = 2;
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_68(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, 1073741824);
				func_69(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], true, -1, true);
				PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], false);
				func_70(&uParam0->f_20[1 /*14*/], false, true);
			}
		...
		case 1:
			if (func_72(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					TASK::TASK_LOOK_AT_ENTITY(uParam0->f_20[1 /*14*/], Global_35, -1, 0, 51, 0);
					TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
					TASK::TASK_STAND_STILL(0, BUILTIN::FLOOR(5f * 1000f));
				
					if (bLocal_15)
						TASK::TASK_PLAY_ANIM(0, "AI_GESTURES@GEN_MALE@STANDING@SPEAKER", "NEUTRAL_WAVE_FL_001", 4f, -4f, 1000, 8, 0, false, 0, false, 0, false);
				
					TASK::TASK_MOVE_IN_TRAFFIC(0, 1f, 4, 0);
		...
		case 2:
			if (!bLocal_14)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					...
					if (TASK::GET_SEQUENCE_PROGRESS(uParam0->f_20[1 /*14*/]) == iLocal_13)
					{
						TASK::TASK_CLEAR_LOOK_AT(uParam0->f_20[1 /*14*/]);
						bLocal_14 = true;
					}
				}
			}
		
			if (TASK::GET_SEQUENCE_PROGRESS(uParam0->f_20[1 /*14*/]) == iLocal_13 || uParam0->f_469[1])
				return 1;
			break;
	}
...
int func_33(var uParam0, var uParam1) // Position - 0x2C50 Hash - 0x3105A36D ^0x3105A36D
{
	func_73(uParam0, false, false, false);
	return 1;
}

void func_34(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2C62 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_35(int iParam0) // Position - 0x2C7F Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_36(int iParam0) // Position - 0x2DBB Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_37(int iParam0) // Position - 0x2EF4 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_38(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2F9E Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_39(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3016 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_75(entityForwardVector, unk5);
	...
	if (func_76(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_40(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x30A5 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_41() // Position - 0x31C0 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x31CC Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	func_86(iParam0, l, k, j, num2, i, num);
	return;
}

void func_43(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3354 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_44(int iParam0) // Position - 0x33F4 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_45(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3407 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_46(Volume volParam0, BOOL bParam1) // Position - 0x3421 Hash - 0xEA796703 ^0x695D7925
{
...
void func_47(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3489 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_48() // Position - 0x34B5 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_49(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x34C3 Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
Hash func_50(int iParam0, BOOL bParam1) // Position - 0x36B5 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_51(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x376F Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_52(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37FD Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_88(Global_1898164.f_1[0 /*5*/]);
	
		if (func_89(num) && func_90(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_53(int iParam0) // Position - 0x3A01 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_54(int iParam0, int iParam1) // Position - 0x3A15 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_55() // Position - 0x3A24 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_74() != -1;
}

BOOL func_56(var uParam0, Any* panParam1) // Position - 0x3A3F Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_57(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3A9E Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_58(Ped pedParam0) // Position - 0x3AE0 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_59(int iParam0, BOOL bParam1) // Position - 0x3B0C Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3B88 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3BAE Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3BD0 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3BF2 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3C14 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3C38 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
BOOL func_66(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C5C Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_101(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_67(var uParam0) // Position - 0x3CB6 Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
		func_102(*uParam0, false);
		uParam0->f_469[3] = 1;
	}

	if (!uParam0->f_469[2])
	{
		func_103(*uParam0, uParam0->f_483, false);
		uParam0->f_469[2] = 1;
	}
...
void func_68(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3CFF Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_104(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_105(pedParam0))
		if (func_106(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
			PHYSICS::_UNHITCH_HORSE(pedParam0);

	if (func_107(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0);
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_68(vehiclePedIsIn, vParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_68(mount, vParam1, fParam4, iParam5, iParam6);
			}
	...
	if (func_107(iParam5, 2))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(pedParam0))
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_107(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_107(iParam5, 32), true);
	...
	else if (func_107(iParam5, 129))
	{
		if (func_107(iParam5, 128))
			if (WATER::GET_WATER_HEIGHT_NO_WAVES(vParam1, &height))
				vParam1.f_2 = height;
	
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, vParam1, func_107(iParam5, 32), true, true);
	...
	if (isEntityAPed)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0) == Global_35 && !func_107(iParam5, 64))
		{
...
int func_69(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x3F81 Hash - 0x32B863AB ^0xCE62541D
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
void func_70(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3FC6 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_71(var uParam0) // Position - 0x3FEE Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_108(uParam0, 0f);
	return;
}

BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3FFD Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_109(Global_35))
		{
			ped = func_110(Global_35);
		...
		num = num * num;
		fParam2 = func_111(fParam2);
		num2 = func_112(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_113(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_114(&(uParam0->f_490)))
							func_71(&(uParam0->f_490));
					
						if (func_115(&(uParam0->f_490), fParam1))
						{
							func_116(&(uParam0->f_490));
							return true;
						}
...
void func_73(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x420B Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_74() // Position - 0x435F Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_75(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x436D Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x43D4 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x43FD Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_117(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_78(var uParam0, var uParam1, var uParam2) // Position - 0x4449 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_117(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_79(int iParam0) // Position - 0x4498 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_80(int iParam0) // Position - 0x44BD Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_81(int iParam0) // Position - 0x44D0 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_82(int iParam0) // Position - 0x44E3 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_83(int iParam0) // Position - 0x44F6 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_84(int iParam0) // Position - 0x4508 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_85(int iParam0, int iParam1) // Position - 0x451A Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x45B4 Hash - 0xA65AB937 ^0xA65AB937
{
	func_119(iParam0, iParam6);
	func_120(iParam0, iParam5);
	func_121(iParam0, iParam4);
	func_122(iParam0, iParam3);
	func_123(iParam0, iParam2);
	func_124(iParam0, iParam1);
	return;
}

BOOL func_87() // Position - 0x45EC Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_88(int iParam0) // Position - 0x463F Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_91(iParam0))
		return -1;
...
BOOL func_89(int iParam0) // Position - 0x465F Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_90(int iParam0, int iParam1) // Position - 0x4675 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_91(int iParam0) // Position - 0x4684 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_92(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x46B7 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_130(pedParam0, false);
			flag = true;
		}
	
		func_131(pedParam0, iParam2);
	}
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4798 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_100(iParam0, 4);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x47B6 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_100(iParam0, 8);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x47D6 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_100(iParam0, 16);
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4801 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_100(iParam0, 32);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4821 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_100(iParam0, 64);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4841 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_100(iParam0, 1024);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4863 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_100(iParam0, 1048576);
	else
...
void func_100(int iParam0, int iParam1) // Position - 0x4887 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_101(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4898 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_132(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_134(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_136(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_134(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_138(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_139(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_142(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_134(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_142(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_134(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_145(iParam2, 4000))
				{
					if (func_146(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_147(iParam2, pedParam0) && func_148(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_134(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_146(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_147(iParam2, pedParam0) && func_148(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_134(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_149(pedParam0, Global_1935630.f_41))
							{
								func_150();
								*uParam3 = 2;
								func_134(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_151(iParam2, pedParam0) || iParam2->f_9 > 0 && func_152() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_153())
					{
						if (func_149(pedParam0, Global_1935630.f_42))
						{
							func_150();
							*uParam3 = 2;
							func_134(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_155(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_134(pedParam0, iParam2, *uParam3);
					return true;
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4EC1 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_41();
...
void func_103(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4F98 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_41();
...
Ped func_104(Ped pedParam0) // Position - 0x509C Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_105(Ped pedParam0) // Position - 0x50A6 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_106(Ped pedParam0) // Position - 0x50D8 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x511A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_108(var uParam0, float fParam1) // Position - 0x5129 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_109(Ped pedParam0) // Position - 0x514F Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_110(Ped pedParam0) // Position - 0x516A Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_111(float fParam0) // Position - 0x5186 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_112(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x51CD Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_113(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x51EB Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_167(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_114(var uParam0) // Position - 0x5242 Hash - 0x5001E582 ^0x5001E582
{
	return func_168(*uParam0, 1);
}

BOOL func_115(var uParam0, float fParam1) // Position - 0x5252 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x5270 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_117(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5286 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_118(BOOL bParam0, var uParam1, var uParam2) // Position - 0x52DB Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_119(int iParam0, int iParam1) // Position - 0x52F2 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_120(int iParam0, int iParam1) // Position - 0x5378 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_121(int iParam0, int iParam1) // Position - 0x53B4 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_122(int iParam0, int iParam1) // Position - 0x5407 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_123(int iParam0, int iParam1) // Position - 0x5442 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_124(int iParam0, int iParam1) // Position - 0x547B Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_125(int iParam0) // Position - 0x54B3 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_126(BOOL bParam0) // Position - 0x54F1 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_127(ePedType eptParam0) // Position - 0x5504 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_128(Ped pedParam0, Hash hParam1) // Position - 0x5957 Hash - 0x3F21ECC2 ^0xDB52B83C
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_170(pedParam0, hParam1))
		{
...
void func_129(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x59FE Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_130(Ped pedParam0, BOOL bParam1) // Position - 0x5A2E Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_131(Ped pedParam0, int iParam1) // Position - 0x5A73 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_132(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5A9A Hash - 0x37D64B11 ^0xE7060A9E
{
	func_174(iParam2);
				...
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						if (PED::IS_PED_PLANTING_BOMB(Global_35))
							func_100(iParam0, 33554432);
					else if (!(*iParam0 & 8192 != 0))
						if (func_176(true))
							func_100(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_176(true) || *iParam0 & 8192 != 0)
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_177(iParam0))
				iParam0->f_15 = func_152();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_152() - iParam0->f_15 > 500)
			{
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x5C65 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_179(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_180(pedParam0, pedIndexFromEntityIndex) <= func_181(iParam1))
				return true;
			break;
	}
...
void func_134(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5D3C Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_182(iParam2, 1, 1, 1, 0))
		func_100(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_183(iParam1, true);
	func_184();
	return;
}

BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5D79 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_185(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_187(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_188(iParam1);
...
BOOL func_136(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5E60 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_189(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_186(iParam2);
	
		if (func_187(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_188(iParam2))
				{
					func_183(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5F36 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_179(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_188(iParam1))
		{
			customDistance = func_186(iParam1);
...
BOOL func_138(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x603F Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_190(bParam1, bParam2, bParam3);
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x6174 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_140(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x61AB Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x62B2 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_192(iParam2))
	{
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x631D Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_194(pedParam1, entityCoords, outCoords))
					{
						func_183(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_194(pedParam1, entityCoords, outCoords2))
					{
						func_183(iParam2, true);
						return true;
					}
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x6465 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_179(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_195(Global_1935630.f_34[i]);
			...
			if (func_196(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_197(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_198(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_144(var uParam0, int iParam1) // Position - 0x6641 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x66B9 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_146(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x66E8 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_147(int iParam0, Ped pedParam1) // Position - 0x686E Hash - 0x9D42CABC ^0xE4955CE9
{
	int _int;
...
BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x68BB Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_201(iParam0))
		return true;
...
BOOL func_149(Ped pedParam0, Ped pedParam1) // Position - 0x6958 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_202(pedParam0, pedParam1, true, true) < 4f)
...
void func_150() // Position - 0x69A5 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x69AD Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_203(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_152();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_204(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_152() // Position - 0x6A6E Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_153() // Position - 0x6A8C Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_152() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6AD9 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_205(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_206(pedParam1);
	num2 = func_207(iParam0->f_14);
...
BOOL func_155(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6BF5 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_208(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_156(Ped pedParam0, int iParam1) // Position - 0x6C3D Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_209(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_210(iParam1, pedParam0))
						if (func_204(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6E96 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_211(0))
		return false;
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x6ECF Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_159(var uParam0, int iParam1) // Position - 0x6EFE Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6F12 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_152();
	else if (func_152() - iParam1->f_4 > func_212(iParam1))
		return func_213(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_161(int iParam0, Ped pedParam1) // Position - 0x6F5F Hash - 0xC640100A ^0xA453A45D
{
...
void func_162(int iParam0) // Position - 0x6FB2 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_44(iParam0))
	{
		...
		{
			case 1:
				func_214(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_214(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_214(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_163(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7033 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_117(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
float func_164() // Position - 0x7124 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_165(var uParam0, int iParam1) // Position - 0x7156 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_166(var uParam0, int iParam1) // Position - 0x7167 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_167(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x717C Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_168(int iParam0, int iParam1) // Position - 0x719A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_169(var uParam0, float fParam1) // Position - 0x71A9 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_114(uParam0))
		return false;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x71D0 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x71FE Hash - 0xF4FE5684 ^0x95C1CF1B
{
	Hash _int;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x724C Hash - 0xF4FE5684 ^0x95C1CF1B
{
	Hash _int;
	int _int2;
...
void func_173(Ped pedParam0) // Position - 0x72BA Hash - 0xAC63CB06 ^0x207ADF23
{
...
void func_174(int iParam0) // Position - 0x72D6 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_217(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_175(int iParam0) // Position - 0x7442 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_176(BOOL bParam0) // Position - 0x7455 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_218(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_177(int iParam0) // Position - 0x746F Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_178(int iParam0) // Position - 0x7507 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_179(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x752E Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_180(Ped pedParam0, Ped pedParam1) // Position - 0x7627 Hash - 0xF9959663 ^0xF9959663
{
	return func_202(pedParam0, pedParam1, true, true);
}

float func_181(int iParam0) // Position - 0x7639 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_182(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7645 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x76AA Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_100(iParam0, 134217728);
	else
...
void func_184() // Position - 0x76D0 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_185(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x76E4 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_202(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_186(int iParam0) // Position - 0x7844 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7850 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_188(int iParam0) // Position - 0x78B1 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_189(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x78BD Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_190(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x797F Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_191(int iParam0) // Position - 0x7A1D Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_192(int iParam0) // Position - 0x7A29 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_193(int iParam0) // Position - 0x7A35 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7B72 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_195(Ped pedParam0) // Position - 0x7BB5 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C1B Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C62 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7CAD Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_199(Ped pedParam0, var uParam1) // Position - 0x7D26 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_200(Ped pedParam0, Ped pedParam1) // Position - 0x7D73 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_201(int iParam0) // Position - 0x7DBB Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_202(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7DCB Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_203(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7E13 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_204(veParam0, uParam2, true);
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7E3F Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_205(int iParam0) // Position - 0x7E67 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_206(Ped pedParam0) // Position - 0x7E73 Hash - 0x6BEA2DE ^0x7CEAB9C2
{
...
int func_207(Ped pedParam0) // Position - 0x7EC7 Hash - 0x2D2D2A83 ^0xF6F1A6C9
{
...
BOOL func_208(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7F31 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_202(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_202(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x80A3 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_218(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_210(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_210(iParam1, ped2))
					if (func_204(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_210(int iParam0, Ped pedParam1) // Position - 0x8191 Hash - 0x27FC2906 ^0xAEACCAB
{
...
BOOL func_211(int iParam0) // Position - 0x8207 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_229())
		return false;
...
int func_212(int iParam0) // Position - 0x8229 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8235 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_214(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x82B0 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_231(iParam0) == 1 && bParam7)
		return;
...
float func_215(var uParam0) // Position - 0x833C Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_114(uParam0))
		return uParam0->f_1;
...
BOOL func_216() // Position - 0x8371 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_233())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x83C7 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x846F Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_219() // Position - 0x8536 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_220(int iParam0) // Position - 0x8544 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_221(int iParam0) // Position - 0x85EC Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_222(Ped pedParam0, int iParam1) // Position - 0x8651 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_223(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8668 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_224(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8696 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x86E0 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_226(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8721 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_227(Ped pedParam0) // Position - 0x879A Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_228(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8882 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_229() // Position - 0x88C4 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_219() != -1)
		return false;
...
BOOL func_230(int iParam0, BOOL bParam1) // Position - 0x88E9 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_231(int iParam0) // Position - 0x891A Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_232(var uParam0) // Position - 0x892D Hash - 0x39705408 ^0x39705408
{
	return func_168(*uParam0, 2);
}

BOOL func_233() // Position - 0x893D Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_234(int iParam0) // Position - 0x896E Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_91(iParam0))
		return -1;
...
int func_235(int iParam0) // Position - 0x898A Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_236(int iParam0) // Position - 0x89CB Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
