...
BOOL func_15(int iParam0) // Position - 0x7EA Hash - 0x7C1E363C ^0x7C1E363C
{
	return func_48(&uLocal_14, 16, &uLocal_14, func_46(), 0, func_47(), false, 0, false);
}
...
int func_46() // Position - 0xD8B Hash - 0x4083F80A ^0x4083F80A
{
	return 51;
}
...
void func_62(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11A6 Hash - 0xDA12D038 ^0x734593B0
{
	BOOL flag;
	const char* str;
	char* str2;
...
char* func_107(int iParam0) // Position - 0x3F61 Hash - 0x21CE226B ^0x33BB3189
{
	switch (iParam0)
	{
		case 0:
...
const char* func_114(var uParam0, int iParam1) // Position - 0x4070 Hash - 0xB0CFF0C3 ^0x88519718
{
...
const char* func_160(int iParam0) // Position - 0x4B7C Hash - 0xE6862179 ^0x21A3341
{
	switch (iParam0)
	{
		case 0:
...
const char* func_163(const char* sParam0, int iParam1) // Position - 0x4EA6 Hash - 0x9E99F03 ^0xB717443F
{
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x4FC9 Hash - 0x2F9EB0B9 ^0xF34948B
{
	char* ambientZone;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x4FFD Hash - 0x342D57CF ^0x2219BC86
{
	switch (iParam0)
	{
		case 5:
