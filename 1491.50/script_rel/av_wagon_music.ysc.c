...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x648514AC
{
	var unk;
	BOOL flag;
	...
	hLocal_43 = joaat("pg_veh_wagon02x_1");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0xCE7F709F
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x4C1FCB22 ^0x3ED40E32
{
	int num;

	func_46(uParam0, "WAGON_BACK_PASSENGER", "", vParam1, uParam4);
	iLocal_44 = MISC::GET_RANDOM_INT_IN_RANGE(1, 3);
	iLocal_45 = MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
	...
	switch (iLocal_45)
	{
		...
		case 1:
			hLocal_43 = joaat("pg_veh_wagon02x_2");
			break;
	
		case 2:
			hLocal_43 = joaat("pg_veh_wagon02x_3");
			break;
	}

	num = func_48(func_47(), true, false, true, true, false, false);
	func_49(uParam0, 0, "WBPP_MAN_1", num, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 3f, 0f, 0f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "WBPP_MAN_2", num, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -3f, 0f, 0f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 2, "WBPP_HORSE_1", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 3, "WBPP_HORSE_2", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, "WAGON", iLocal_38, vParam1, uParam4.f_2, 0, 0, 0, 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1CD9 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D79 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E93 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x205C Hash - 0x1971F48 ^0x9B29DB1B
{
	if (!PROPSET::_HAS_PROP_SET_LOADED(hLocal_43))
		return 0;

	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2073 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2223 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2297 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22E6 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x233E Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24A7 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27CE Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2905 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A35 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A74 Hash - 0x269055 ^0x232AEC2C
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
	{
		VEHICLE::SET_VEHICLE_EXTRA(uParam0->f_453, iLocal_44, false);
		VEHICLE::_SET_VEHICLE_TINT(uParam0->f_453, 0);
		PROPSET::_ADD_PROP_SET_FOR_VEHICLE(uParam0->f_453, hLocal_43);
	}

	return true;
}

void func_29(var uParam0) // Position - 0x2AAB Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2ADD Hash - 0xC1E309A4 ^0x5434271A
{
	PROPSET::_REQUEST_PROP_SET(hLocal_43);
...
int func_31(var uParam0) // Position - 0x2B1E Hash - 0xD3C4CA6D ^0x90F9EEB2
{
	int i;

	if (!uParam0->f_469[1])
	{
		if (func_65(uParam0, &uLocal_10, false))
			uParam0->f_469[1] = 1;
	...
	switch (iLocal_9)
	{
		case 0:
			for (i = 0; i < 4; i = i + 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[i /*14*/]))
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
					{
						PED::SET_PED_CONFIG_FLAG(uParam0->f_20[i /*14*/], 297, true);
						PED::SET_PED_CONFIG_FLAG(uParam0->f_20[i /*14*/], 130, false);
						func_67(&uParam0->f_20[i /*14*/], false, true);
					}
				}
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				PED::ADD_RELATIONSHIP_GROUP("WBPP", &hLocal_46);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_20[0 /*14*/], hLocal_46);
				TASK::TASK_VEHICLE_DRIVE_WANDER(uParam0->f_20[0 /*14*/], uParam0->f_453, 3f, 524419);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_20[1 /*14*/], hLocal_46);
		...
		case 2:
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				func_66(uParam0);
				...
				{
					if (uParam0->f_489 == 0)
						uParam0->f_489 = MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
				
					switch (uParam0->f_489)
					{
						case 0:
						case 1:
							PED::_GIVE_PED_HASH_COMMAND(uParam0->f_20[1 /*14*/], joaat("WAGON_PASSENGER_TRANS_HARMONICA"), 10f);
							break;
					
						case 2:
							PED::_GIVE_PED_HASH_COMMAND(uParam0->f_20[1 /*14*/], joaat("WAGON_PASSENGER_TRANS_WHISTLING"), 10f);
							break;
					
						case 3:
							PED::_GIVE_PED_HASH_COMMAND(uParam0->f_20[1 /*14*/], joaat("WAGON_PASSENGER_TRANS_JAWHARP"), 10f);
							break;
					}
				}
...
int func_32(var uParam0, var uParam1) // Position - 0x2E06 Hash - 0xD65176CC ^0x11CE554D
{
	int i;
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				if (!uParam0->f_469[1])
				{
					if (i == 0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
						{
							if (!func_70(uParam0->f_20[i /*14*/], SCRIPT_TASK_VEHICLE_DRIVE_WANDER))
							{
	...
	if (PROPSET::DOES_PROP_SET_EXIST(prsLocal_47))
		PROPSET::_SET_PROP_SET_AS_NO_LONGER_NEEDED(prsLocal_47);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2EFC Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F19 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3055 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x318E Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3238 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x32B0 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x333F Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x345A Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3466 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35EE Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x368E Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36A1 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x36BB Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3723 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x374F Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x375D Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x394F Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_50(var uParam0, char* sParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x39DD Hash - 0x3AAEDE3B ^0x68D4DDC3
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A31 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x3C35 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3C49 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3C58 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_71() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x3C73 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3CD2 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3D14 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3D40 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3DBC Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3DE2 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3E04 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3E26 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3E4A Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3E6C Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_65(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3E90 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_66(var uParam0) // Position - 0x3EEA Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
	...
	if (!uParam0->f_469[2])
	{
		func_100(*uParam0, uParam0->f_483, false);
		uParam0->f_469[2] = 1;
	}
...
void func_67(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F33 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_68(var uParam0) // Position - 0x3F5B Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_101(uParam0, 0f);
	return;
}

BOOL func_69(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3F6A Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_108(&(uParam0->f_490), fParam1))
						{
...
BOOL func_70(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x4176 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
int func_71() // Position - 0x41CF Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_72(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x41DD Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4244 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_74(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x426D Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_110(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_75(var uParam0, var uParam1, var uParam2) // Position - 0x42B9 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_110(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_76(int iParam0) // Position - 0x4308 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_77(int iParam0) // Position - 0x432D Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_78(int iParam0) // Position - 0x4340 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_79(int iParam0) // Position - 0x4353 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_80(int iParam0) // Position - 0x4366 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_81(int iParam0) // Position - 0x4378 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_82(int iParam0, int iParam1) // Position - 0x438A Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4424 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_84() // Position - 0x445C Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_85(int iParam0) // Position - 0x44AF Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_88(iParam0))
		return -1;

	return func_119(func_118(iParam0));
}

BOOL func_86(int iParam0) // Position - 0x44CF Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_87(int iParam0, int iParam1) // Position - 0x44E5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_88(int iParam0) // Position - 0x44F4 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_89(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4527 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_123(pedParam0, false);
			flag = true;
		}
	
		func_124(pedParam0, iParam2);
	}
...
void func_90(int iParam0, BOOL bParam1) // Position - 0x4608 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_97(iParam0, 4);
	else
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x4626 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_97(iParam0, 8);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4646 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_97(iParam0, 16);
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4671 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_97(iParam0, 32);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4691 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_97(iParam0, 64);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x46B1 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x46D3 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_97(int iParam0, int iParam1) // Position - 0x46F7 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_98(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4708 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_125(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_127(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_129(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_127(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_131(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_132(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_133(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_127(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_134(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_127(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_135(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_127(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_135(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_127(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_138(iParam2, 4000))
				{
					if (func_139(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_140(iParam2, pedParam0) && func_141(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_127(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_139(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_140(iParam2, pedParam0) && func_141(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_127(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_142(pedParam0, Global_1935630.f_41))
							{
								func_143();
								*uParam3 = 2;
								func_127(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_144(iParam2, pedParam0) || iParam2->f_9 > 0 && func_145() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_146())
					{
						if (func_142(pedParam0, Global_1935630.f_42))
						{
							func_143();
							*uParam3 = 2;
							func_127(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_148(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_127(pedParam0, iParam2, *uParam3);
					return true;
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4D31 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_100(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4E08 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_101(var uParam0, float fParam1) // Position - 0x4F0C Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_102(Ped pedParam0) // Position - 0x4F32 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_103(Ped pedParam0) // Position - 0x4F4D Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_104(float fParam0) // Position - 0x4F69 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_105(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4FB0 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_106(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4FCE Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_107(var uParam0) // Position - 0x5025 Hash - 0x5001E582 ^0x5001E582
{
	return func_161(*uParam0, 1);
}

BOOL func_108(var uParam0, float fParam1) // Position - 0x5035 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_109(var uParam0) // Position - 0x5053 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_110(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5069 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_111(BOOL bParam0, var uParam1, var uParam2) // Position - 0x50BE Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_112(int iParam0, int iParam1) // Position - 0x50D5 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_113(int iParam0, int iParam1) // Position - 0x515B Hash - 0x96B01D2A ^0x81E68218
{
...
void func_114(int iParam0, int iParam1) // Position - 0x5197 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_115(int iParam0, int iParam1) // Position - 0x51EA Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_116(int iParam0, int iParam1) // Position - 0x5225 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_117(int iParam0, int iParam1) // Position - 0x525E Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_118(int iParam0) // Position - 0x5296 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_119(BOOL bParam0) // Position - 0x52D4 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_120(ePedType eptParam0) // Position - 0x52E7 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_121(Ped pedParam0, Hash hParam1) // Position - 0x573A Hash - 0x5D6130DD ^0x64696EA2
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_163(pedParam0, hParam1))
		{
			if (func_164(pedParam0, hParam1))
			{
...
void func_122(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x57E1 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_123(Ped pedParam0, BOOL bParam1) // Position - 0x5811 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_124(Ped pedParam0, int iParam1) // Position - 0x5856 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_125(int iParam0, BOOL bParam1, int iParam2) // Position - 0x587D Hash - 0x37D64B11 ^0xE7060A9E
{
	func_167(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_169(true))
							func_97(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_169(true) || *iParam0 & 8192 != 0)
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_170(iParam0))
				iParam0->f_15 = func_145();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_145() - iParam0->f_15 > 500)
			{
...
BOOL func_126(Ped pedParam0, int iParam1) // Position - 0x5A48 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_172(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_173(pedParam0, pedIndexFromEntityIndex) <= func_174(iParam1))
				return true;
			break;
	}
...
void func_127(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5B1F Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_175(iParam2, 1, 1, 1, 0))
		func_97(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_176(iParam1, true);
	func_177();
	return;
}

BOOL func_128(Ped pedParam0, int iParam1) // Position - 0x5B5C Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_178(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_180(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_181(iParam1);
...
BOOL func_129(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5C43 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_182(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_179(iParam2);
	
		if (func_180(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_181(iParam2))
				{
					func_176(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_130(Ped pedParam0, int iParam1) // Position - 0x5D19 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_172(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_181(iParam1))
		{
			customDistance = func_179(iParam1);
...
BOOL func_131(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5E22 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_183(bParam1, bParam2, bParam3);
...
BOOL func_132(int iParam0, int iParam1) // Position - 0x5F57 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_133(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5F8E Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_134(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6095 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_185(iParam2))
	{
...
BOOL func_135(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6100 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_187(pedParam1, entityCoords, outCoords))
					{
						func_176(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_187(pedParam1, entityCoords, outCoords2))
					{
						func_176(iParam2, true);
						return true;
					}
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x6248 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_172(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_188(Global_1935630.f_34[i]);
			...
			if (func_189(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_190(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_191(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_137(var uParam0, int iParam1) // Position - 0x6424 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_138(int iParam0, int iParam1) // Position - 0x649C Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_139(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x64CB Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_140(int iParam0, Ped pedParam1) // Position - 0x6651 Hash - 0x98A64D3A ^0x21190905
{
	int _int;
...
BOOL func_141(int iParam0, Ped pedParam1) // Position - 0x669E Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_194(iParam0))
		return true;
...
BOOL func_142(Ped pedParam0, Ped pedParam1) // Position - 0x673B Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_195(pedParam0, pedParam1, true, true) < 4f)
...
void func_143() // Position - 0x6788 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_144(int iParam0, Ped pedParam1) // Position - 0x6790 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_196(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_145();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_197(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_145() // Position - 0x6851 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_146() // Position - 0x686F Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_145() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_147(int iParam0, Ped pedParam1) // Position - 0x68BC Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_198(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_199(pedParam1);
	num2 = func_200(iParam0->f_14);
...
BOOL func_148(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x69D8 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_201(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_149(Ped pedParam0, int iParam1) // Position - 0x6A20 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_202(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_203(iParam1, pedParam0))
						if (func_197(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_150(Ped pedParam0, int iParam1) // Position - 0x6C79 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_204(0))
		return false;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x6CB2 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_152(var uParam0, int iParam1) // Position - 0x6CE1 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_153(Ped pedParam0, int iParam1) // Position - 0x6CF5 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_145();
	else if (func_145() - iParam1->f_4 > func_205(iParam1))
		return func_206(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6D42 Hash - 0x80473B3F ^0x1AA8DAD
{
...
void func_155(int iParam0) // Position - 0x6D95 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_156(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6E16 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_110(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
float func_157() // Position - 0x6F07 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_158(var uParam0, int iParam1) // Position - 0x6F39 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_159(var uParam0, int iParam1) // Position - 0x6F4A Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_160(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6F5F Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x6F7D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_162(var uParam0, float fParam1) // Position - 0x6F8C Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_107(uParam0))
		return false;
...
BOOL func_163(Ped pedParam0, Hash hParam1) // Position - 0x6FB3 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_164(Ped pedParam0, Hash hParam1) // Position - 0x6FE1 Hash - 0xFD4C3CDF ^0x9A370263
{
	Hash _int;
...
BOOL func_165(Ped pedParam0, Hash hParam1) // Position - 0x702F Hash - 0xFD4C3CDF ^0x9A370263
{
	Hash _int;
	int _int2;
...
void func_166(Ped pedParam0) // Position - 0x709D Hash - 0x1B851481 ^0xA5DA895
{
...
void func_167(int iParam0) // Position - 0x70B9 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_210(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_168(int iParam0) // Position - 0x7225 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_169(BOOL bParam0) // Position - 0x7238 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_211(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_170(int iParam0) // Position - 0x7252 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_171(int iParam0) // Position - 0x72EA Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_172(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7311 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_200(pedParam2);
	else
		num2 = func_199(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_200(pedParam0);
	else
		num = func_199(pedParam0);
...
float func_173(Ped pedParam0, Ped pedParam1) // Position - 0x740A Hash - 0xF9959663 ^0xF9959663
{
	return func_195(pedParam0, pedParam1, true, true);
}

float func_174(int iParam0) // Position - 0x741C Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_175(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7428 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x748D Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_177() // Position - 0x74B3 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_178(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x74C7 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_195(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_215(ped, 0)))
			if (func_216(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_179(int iParam0) // Position - 0x7627 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_180(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7633 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_181(int iParam0) // Position - 0x7694 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_182(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x76A0 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_215(ped, 0)))
			if (func_217(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_183(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7762 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_184(int iParam0) // Position - 0x7800 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_185(int iParam0) // Position - 0x780C Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_186(int iParam0) // Position - 0x7818 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_187(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7955 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_218(pedParam0, vParam4, 0.5f))
...
BOOL func_188(Ped pedParam0) // Position - 0x7998 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_219(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_189(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x79FE Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_190(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A45 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_191(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7A90 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_192(Ped pedParam0, var uParam1) // Position - 0x7B09 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_193(Ped pedParam0, Ped pedParam1) // Position - 0x7B56 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_221(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_194(int iParam0) // Position - 0x7B9E Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_195(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7BAE Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_196(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7BF6 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_197(veParam0, uParam2, true);
...
float func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7C22 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_198(int iParam0) // Position - 0x7C4A Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_199(Ped pedParam0) // Position - 0x7C56 Hash - 0x32FFD95E ^0x848A871E
{
...
int func_200(Ped pedParam0) // Position - 0x7CAA Hash - 0xBDAD2721 ^0x8BBF99A6
{
...
BOOL func_201(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7D14 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_195(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_195(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_202(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7E84 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_211(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_203(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_203(iParam1, ped2))
					if (func_197(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_203(int iParam0, Ped pedParam1) // Position - 0x7F72 Hash - 0x439E806C ^0x66CB9ED3
{
...
BOOL func_204(int iParam0) // Position - 0x7FE6 Hash - 0x723482DE ^0xFC238DA7
{
	if (func_222())
		return false;

	return func_223(Global_1347702[58 /*49*/].f_15, true);
}

int func_205(int iParam0) // Position - 0x800A Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_206(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8016 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_207(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x8091 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_224(iParam0) == 1 && bParam7)
		return;
...
float func_208(var uParam0) // Position - 0x811D Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_107(uParam0))
		return uParam0->f_1;
...
BOOL func_209() // Position - 0x8152 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_226())
		return false;
...
void func_210(Any* panParam0, int iParam1) // Position - 0x81A8 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_211(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8250 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_212() // Position - 0x8317 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_213(int iParam0) // Position - 0x8325 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_214(int iParam0) // Position - 0x83CD Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_215(Ped pedParam0, int iParam1) // Position - 0x8432 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_216(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8449 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_217(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_217(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8477 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_218(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x84C1 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_219(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8502 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_220(Ped pedParam0) // Position - 0x857B Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_221(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8663 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_222() // Position - 0x86A5 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_212() != -1)
		return false;
...
BOOL func_223(int iParam0, BOOL bParam1) // Position - 0x86CA Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_224(int iParam0) // Position - 0x86FB Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_225(var uParam0) // Position - 0x870E Hash - 0x39705408 ^0x39705408
{
	return func_161(*uParam0, 2);
}

BOOL func_226() // Position - 0x871E Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_227(int iParam0) // Position - 0x874F Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_88(iParam0))
		return -1;
...
int func_228(int iParam0) // Position - 0x876B Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_229(int iParam0) // Position - 0x87AC Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
