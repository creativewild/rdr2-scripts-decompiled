...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x9D94F862
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_c_moose_01");
	iLocal_41 = joaat("META_OUTFIT_DEFAULT");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x8EC8373C
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x2D0A7D78 ^0x2D0A7D78
{
	int num;
	BOOL flag;

	func_46(uParam0, "MOOSE_SLIPPING", "script@ambient@animal@moose_fall_on_ice@action", uParam1, uParam4);
	...
	{
		num = 0;
		iLocal_41 = joaat("META_OUTFIT_ANIMAL_MOOSE_M_001");
	}

	iLocal_9 = joaat("a_c_moose_01");
	func_49(uParam0, 0, "MOOSE", iLocal_9, 0f, 0f, 0f, 0f, num, 1, 1, 1, iLocal_41, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C27 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CC7 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DE1 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FAA Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FB3 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2163 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21D7 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2226 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x227E Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23E7 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x270E Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2845 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2975 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29B4 Hash - 0x28DA310A ^0xA2138FBE
{
	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[0 /*14*/]);
	PED::_REQUEST_MOTION_TYPE_ASSET(515906784, uParam0->f_20[0 /*14*/]);

	if (!PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[0 /*14*/]) || !PED::HAS_MOTION_TYPE_ASSET_LOADED(515906784, uParam0->f_20[0 /*14*/]))
		return false;
...
void func_29(var uParam0) // Position - 0x2A44 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A76 Hash - 0x6C10550A ^0x6C10550A
{
...
int func_31(var uParam0) // Position - 0x2AA9 Hash - 0x4F31F1E6 ^0xA0BC9973
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	...
	{
		if (!bLocal_42 == true)
			if (func_64(uParam0, &uLocal_10, false) || func_65(Global_35, uParam0->f_20[0 /*14*/], true) <= 225f)
				bLocal_42 = true;
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!uParam0->f_469[4])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("endsinrun")))
							{
								...
								TASK::TASK_SMART_FLEE_COORD(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, -1f, -1, 0, 2f);
...
int func_32(var uParam0, var uParam1) // Position - 0x2D68 Hash - 0x8BBB018D ^0x62BD969A
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 388, false);
		PED::SET_PED_LASSO_HOGTIE_FLAG(uParam0->f_20[0 /*14*/], 0, true);
	}
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DA5 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DC2 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2EFE Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3037 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30E1 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3159 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31E8 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3303 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x330F Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3497 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3537 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x354A Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3564 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35CC Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x35F8 Hash - 0xF0D98862 ^0x21440CE
{
...
BOOL func_48() // Position - 0x3629 Hash - 0xEE877ACE ^0xCCE9C802
{
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x364A Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x36D8 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x38DC Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x38F0 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x38FF Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_75() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x391A Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3979 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x39BB Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x39E7 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3A0F Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3A8B Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3AB1 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3AD3 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3AF5 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3B17 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_64(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3B3B Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_65(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x3B95 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_66(var uParam0) // Position - 0x3BEC Hash - 0x5001E582 ^0x5001E582
{
	return func_104(*uParam0, 1);
}

void func_67(var uParam0) // Position - 0x3BFC Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_105(uParam0, 0f);
	return;
}

void func_68(var uParam0) // Position - 0x3C0B Hash - 0x9E21C5F4 ^0x9E21C5F4
{
	if (!uParam0->f_469[6])
	{
...
void func_69(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3C30 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_70(var uParam0) // Position - 0x3D34 Hash - 0xFC457B8 ^0xB47AF66B
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
...
BOOL func_71(var uParam0, float fParam1) // Position - 0x3D91 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_66(uParam0))
		return false;
...
BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3DB8 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_73(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3FC3 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
...
void func_74(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x40EE Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_75() // Position - 0x4242 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_76(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4250 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x42B7 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x42E0 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_79(var uParam0, var uParam1, var uParam2) // Position - 0x432C Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_80(int iParam0) // Position - 0x437B Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_81(int iParam0) // Position - 0x43A0 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_82(int iParam0) // Position - 0x43B3 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_83(int iParam0) // Position - 0x43C6 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_84(int iParam0) // Position - 0x43D9 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_85(int iParam0) // Position - 0x43EB Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_86(int iParam0, int iParam1) // Position - 0x43FD Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4497 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_88() // Position - 0x44CF Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_89(int iParam0) // Position - 0x4522 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_92(iParam0))
		return -1;
...
BOOL func_90(int iParam0) // Position - 0x4542 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_91(int iParam0, int iParam1) // Position - 0x4558 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(int iParam0) // Position - 0x4567 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_93(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x459A Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x467B Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_101(iParam0, 4);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4699 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_101(iParam0, 8);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x46B9 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_101(iParam0, 16);
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x46E4 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_101(iParam0, 32);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4704 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_101(iParam0, 64);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4724 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4746 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_101(int iParam0, int iParam1) // Position - 0x476A Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x477B Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4DA4 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x4DC2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_105(var uParam0, float fParam1) // Position - 0x4DD1 Hash - 0x30433BAB ^0xF854D531
{
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x4DF7 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_107(int iParam0) // Position - 0x4ECE Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4F4F Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_109(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x5040 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_110(var uParam0) // Position - 0x5099 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_66(uParam0))
		return uParam0->f_1;
...
BOOL func_111(Ped pedParam0) // Position - 0x50CE Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_112(Ped pedParam0) // Position - 0x50E9 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_113(int iParam0) // Position - 0x5105 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_114(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x514C Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_115(var uParam0, float fParam1) // Position - 0x516A Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x5188 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_117(var uParam0, BOOL bParam1) // Position - 0x519E Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_118(var uParam0) // Position - 0x51BE Hash - 0x39705408 ^0x39705408
{
	return func_104(*uParam0, 2);
}

void func_119(var uParam0) // Position - 0x51CE Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_66(uParam0);
...
void func_120(var uParam0) // Position - 0x5202 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_66(uParam0);
...
BOOL func_121(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5232 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_122(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5287 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_123(int iParam0, int iParam1) // Position - 0x529E Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_124(int iParam0, int iParam1) // Position - 0x5324 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_125(int iParam0, int iParam1) // Position - 0x5360 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_126(int iParam0, int iParam1) // Position - 0x53B3 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_127(int iParam0, int iParam1) // Position - 0x53EE Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_128(int iParam0, int iParam1) // Position - 0x5427 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_129(int iParam0) // Position - 0x545F Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_130(BOOL bParam0) // Position - 0x549D Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_131(ePedType eptParam0) // Position - 0x54B0 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_132(Ped pedParam0, Hash hParam1) // Position - 0x5903 Hash - 0xC2FEE4DE ^0x56EBDB9F
{
...
void func_133(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x59AA Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_134(Ped pedParam0, BOOL bParam1) // Position - 0x59DA Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_135(Ped pedParam0, int iParam1) // Position - 0x5A1F Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_136(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5A46 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_174(iParam2);
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5C11 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_138(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5CE8 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5D25 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_140(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5E0C Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x5EE2 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_142(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5FEB Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x6120 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6157 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x625E Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x62C9 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_147(Ped pedParam0, int iParam1) // Position - 0x6411 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_148(var uParam0, int iParam1) // Position - 0x65ED Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x6665 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_150(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6694 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_151(int iParam0, Ped pedParam1) // Position - 0x681A Hash - 0xDCAFE7CB ^0xD3346B77
{
	int _int;
...
BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x6867 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_201(iParam0))
		return true;
...
BOOL func_153(Ped pedParam0, Ped pedParam1) // Position - 0x6904 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_154() // Position - 0x6951 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6959 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_156() // Position - 0x6A1A Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_157() // Position - 0x6A38 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6A85 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_159(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6BA1 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6BE9 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6E42 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_211(0))
		return false;
...
BOOL func_162(int iParam0, int iParam1) // Position - 0x6E7B Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_163(var uParam0, int iParam1) // Position - 0x6EAA Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x6EBE Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_165(int iParam0, Ped pedParam1) // Position - 0x6F0B Hash - 0x34514255 ^0xAA54A634
{
...
float func_166() // Position - 0x6F5E Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_167(var uParam0, int iParam1) // Position - 0x6F90 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_168(var uParam0, int iParam1) // Position - 0x6FA1 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_169(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6FB6 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x7042 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x7070 Hash - 0x5900AA8D ^0x6A956B58
{
	Hash _int;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x70BE Hash - 0x5900AA8D ^0x6A956B58
{
	Hash _int;
	int _int2;
...
void func_173(Ped pedParam0) // Position - 0x712C Hash - 0x210F5DC5 ^0x554A1B5A
{
...
void func_174(int iParam0) // Position - 0x7148 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_175(int iParam0) // Position - 0x72B4 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_176(BOOL bParam0) // Position - 0x72C7 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_177(int iParam0) // Position - 0x72E1 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_178(int iParam0) // Position - 0x7379 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_179(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x73A0 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_180(Ped pedParam0, Ped pedParam1) // Position - 0x7499 Hash - 0xF9959663 ^0xF9959663
{
	return func_202(pedParam0, pedParam1, true, true);
}

float func_181(int iParam0) // Position - 0x74AB Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_182(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x74B7 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x751C Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_184() // Position - 0x7542 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_185(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7556 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_186(int iParam0) // Position - 0x76B6 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x76C2 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_188(int iParam0) // Position - 0x7723 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_189(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x772F Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_190(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x77F1 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_191(int iParam0) // Position - 0x788F Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_192(int iParam0) // Position - 0x789B Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_193(int iParam0) // Position - 0x78A7 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x79E4 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_195(Ped pedParam0) // Position - 0x7A27 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A8D Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7AD4 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7B1F Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_199(Ped pedParam0, var uParam1) // Position - 0x7B98 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_200(Ped pedParam0, Ped pedParam1) // Position - 0x7BE5 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_201(int iParam0) // Position - 0x7C2D Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_202(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7C3D Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_203(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7C85 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7CB1 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_205(int iParam0) // Position - 0x7CD9 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_206(Ped pedParam0) // Position - 0x7CE5 Hash - 0xCD5B5081 ^0x23D23C6C
{
...
int func_207(Ped pedParam0) // Position - 0x7D39 Hash - 0x6B2CE628 ^0xB3C93EAB
{
...
BOOL func_208(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7DA3 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7F13 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_210(int iParam0, Ped pedParam1) // Position - 0x8003 Hash - 0x27FC2906 ^0x4A22CC23
{
...
BOOL func_211(int iParam0) // Position - 0x8079 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_228())
		return false;
...
int func_212(int iParam0) // Position - 0x809B Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x80A7 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_214(int iParam0) // Position - 0x8122 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_215() // Position - 0x8135 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_216() // Position - 0x8143 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x8199 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8241 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_219(int iParam0) // Position - 0x8308 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x83B0 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_221(Ped pedParam0, int iParam1) // Position - 0x8415 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x842C Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_223(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x845A Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_224(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x84A4 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x84E5 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_226(Ped pedParam0) // Position - 0x855E Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_227(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8646 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_228() // Position - 0x8688 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_215() != -1)
		return false;
...
BOOL func_229(int iParam0, BOOL bParam1) // Position - 0x86AD Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_230() // Position - 0x86DE Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x870F Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_92(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x872B Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_233(int iParam0) // Position - 0x876C Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
