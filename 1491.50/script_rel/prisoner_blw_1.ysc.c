...
void func_18(var uParam0) // Position - 0x702 Hash - 0x392844B5 ^0xD359F022
{
	...
	switch (iLocal_14)
	{
		case 1:
			...
			TEXT_LABEL_ASSIGN_STRING(&playbackListName, "PleadList", 16);
			TEXT_LABEL_APPEND_INT(&playbackListName, iLocal_15, 16);
			uParam0->f_6 = ANIMSCENE::_CREATE_ANIM_SCENE("script@proc@bountyhunting@cell_blackwater", 4, &playbackListName, false, true);
			ANIMSCENE::LOAD_ANIM_SCENE(uParam0->f_6);
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_6, "Bounty", uParam0->f_3, 0);
			iLocal_14 = 2;
			break;
		...
		case 2:
			...
			{
				ANIMSCENE::SET_ANIM_SCENE_BOOL(uParam0->f_6, "bSeatedLoop", true, false);
				iLocal_14 = 3;
			}
			break;
...
PersChar func_19(int iParam0) // Position - 0x843 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_44(iParam0))
		return 0;
...
void func_20(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x863 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
...
BOOL func_21(var uParam0) // Position - 0x94F Hash - 0x5001E582 ^0x5001E582
{
	return func_50(*uParam0, 1);
}

eStackSize func_22() // Position - 0x95F Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_23(int iParam0, BOOL bParam1) // Position - 0x96D Hash - 0x5C4302E7 ^0x5C4302E7
{
	if (!func_44(iParam0))
		return false;

	if (func_45(iParam0, true) && !func_26(iParam0) && func_46(iParam0))
		return false;
	...
	if (!bParam1)
		if (!func_51(iParam0, false))
			return false;

	return true;
}

Hash func_24(int iParam0) // Position - 0x9CD Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_44(iParam0))
		return 0;
...
BOOL func_25(Hash hParam0) // Position - 0x9EB Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_26(int iParam0) // Position - 0x9F7 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_44(iParam0))
		return false;
...
void func_27(int iParam0, BOOL bParam1) // Position - 0xA1C Hash - 0x61515A20 ^0x61515A20
{
	if (func_52() != -1)
		return;
...
void func_28(int iParam0) // Position - 0xA4D Hash - 0x5A948764 ^0xFC1342AE
{
	if (!func_44(iParam0))
		return;
...
BOOL func_29(var uParam0) // Position - 0xA70 Hash - 0x39705408 ^0x39705408
{
	return func_50(*uParam0, 2);
}

float func_30() // Position - 0xA80 Hash - 0xB5A1F69B ^0x5409CF38
{
...
BOOL func_31(Hash hParam0) // Position - 0xAB2 Hash - 0x783D8692 ^0xC2190628
{
	func_53(hParam0, false, false);
...
BOOL func_32(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xADA Hash - 0x37FB14EB ^0x7E496A4A
{
...
Vector3 func_33(Hash hParam0) // Position - 0xB03 Hash - 0x34D25890 ^0x7B9C5400
{
	if (ENTITY::DOES_ENTITY_EXIST(func_55(hParam0, 0)))
		return ENTITY::GET_ENTITY_COORDS(func_55(hParam0, 0), false, false);

	return 0f, 0f, 0f;
}

void func_34(var uParam0, float fParam1) // Position - 0xB2C Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_35(int iParam0, int iParam1) // Position - 0xB52 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_36(int iParam0, int iParam1) // Position - 0xB61 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_37(int iParam0, int iParam1) // Position - 0xB72 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_38() // Position - 0xB87 Hash - 0xF52733D8 ^0x9DC58B2B
{
	volLocal_46 = VOLUME::CREATE_VOLUME_AGGREGATE();
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_46, -763.0246f, -1269.2827f, 43.617596f, 0f, 0f, 0f, 12.036367f, 8.528987f, 5.107259f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_46, -764.71735f, -1263.4929f, 43.76242f, 0f, 0f, 0f, 7.664316f, 3.774002f, 5.107259f);
	func_58(&uLocal_17);
	iLocal_14 = 1;
	return;
}

void func_39(var uParam0) // Position - 0xBEC Hash - 0x6D6D8AA3 ^0x57023CC
{
	if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_6, false))
	{
		if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(uParam0->f_6, "SitToCower") && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(uParam0->f_6, "SitToCower"))
			ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "SitToCower");
	
		if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(uParam0->f_6, "StandToCower") && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(uParam0->f_6, "StandToCower"))
			ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "StandToCower");
	
		if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(uParam0->f_6, "flinch1") && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(uParam0->f_6, "flinch1"))
			ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "flinch1");
	
		if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(uParam0->f_6, "flinch2") && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(uParam0->f_6, "flinch2"))
			ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "flinch2");
	}

	if (VOLUME::IS_POINT_IN_VOLUME(volLocal_46, Global_36) && PED::IS_PED_SHOOTING(Global_35))
	{
		func_59(uParam0);
		bLocal_16 = true;
	}
	else if (func_60(uParam0->f_3, 0, &uLocal_17, &uLocal_45, 0, 0))
	{
		func_59(uParam0);
		bLocal_16 = false;
	}
...
BOOL func_40(Ped pedParam0, int iParam1) // Position - 0xCF1 Hash - 0xDD93B4F3 ^0x6AEE47CE
{
	float num;
...
void func_41(var uParam0) // Position - 0xD3B Hash - 0x7AB23D16 ^0xB6B36312
{
	var unk;
	var unk4;
	var unk7;
	...
	switch (uParam0->f_8)
	{
		case 0:
			if (func_61(uParam0))
			{
				...
				{
					HUD::TEXT_BLOCK_REQUEST(func_62(uParam0->f_7, 1));
		...
		case 1:
			...
			{
				unk = { func_63(uParam0->f_7, uParam0->f_65, 0) };
				func_64(&Global_1396116, uParam0->f_3, func_62(uParam0->f_7, 0), false);
			
				if (func_65())
					func_64(&Global_1396116, Global_35, "JOHN", false);
				else
					func_64(&Global_1396116, Global_35, "ARTHUR", false);
			
				if (func_66(uParam0->f_7, uParam0->f_65))
				{
					func_67(uParam0);
					uParam0->f_8 = 2;
				}
				else if (MISC::ARE_STRINGS_EQUAL(func_68(unk), ""))
				{
					uParam0->f_8 = 2;
				}
				else if (func_69(&Global_1396116, unk, false, -1, false, false))
				{
					func_67(uParam0);
					uParam0->f_8 = 2;
				}
		...
		case 2:
			if (!func_70(true))
			{
				func_71(&uParam0->f_30[0 /*17*/], "INTERACT_GREET", " ", joaat("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0, true, 0);
				func_71(&uParam0->f_30[1 /*17*/], "INTERACT_INSULT", " ", joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, true, 0);
				uParam0->f_66 = -1;
				uParam0->f_8 = 3;
			}
			break;
		...
		case 3:
			if (uParam0->f_66 == -1)
			{
				uParam0->f_66 = func_72(&(uParam0->f_3), &(uParam0->f_9), 7f, &(uParam0->f_30), 0, 1, 1, 0, 2520, 0, 0, 2, -1082130432);
			
				if (uParam0->f_66 == 0)
				{
					func_73(&uParam0->f_30[0 /*17*/], false, false);
					func_73(&uParam0->f_30[1 /*17*/], false, false);
					func_72(&(uParam0->f_3), &(uParam0->f_9), 7f, &(uParam0->f_30), 0, 1, 1, 0, 2520, 0, 0, 2, -1082130432);
					func_67(uParam0);
				}
			...
			if (uParam0->f_66 == 0)
				if (func_69(&Global_1396116, func_63(uParam0->f_7, uParam0->f_65, 1), false, -1, false, false))
					uParam0->f_8 = 4;
			else if (uParam0->f_66 == 1)
				if (func_69(&Global_1396116, func_63(uParam0->f_7, uParam0->f_65, 2), false, -1, false, false))
					uParam0->f_8 = 4;
			break;
		...
		case 4:
			if (!func_70(true))
			{
				if (uParam0->f_66 == 0)
				{
					unk4 = { func_63(uParam0->f_7, uParam0->f_65, 3) };
				
					if (MISC::ARE_STRINGS_EQUAL(func_68(unk4), ""))
					{
						if (func_74(uParam0))
							uParam0->f_8 = 7;
						else
						...
						func_75(&(uParam0->f_3));
						func_76(&(uParam0->f_30), 0, false, true, false);
						uParam0->f_8 = 8;
					}
					else if (func_69(&Global_1396116, unk4, false, -1, false, false))
					{
						uParam0->f_8 = 5;
					}
				}
				...
				{
					unk7 = { func_63(uParam0->f_7, uParam0->f_65, 5) };
				
					if (MISC::ARE_STRINGS_EQUAL(func_68(unk7), ""))
					{
						if (func_74(uParam0))
							uParam0->f_8 = 7;
						else
					...
					else if (func_69(&Global_1396116, unk7, false, -1, false, false))
					{
						uParam0->f_8 = 5;
					}
				}
		...
		case 5:
			if (!func_70(true))
			{
				if (uParam0->f_66 == 0)
				{
					unk10 = { func_63(uParam0->f_7, uParam0->f_65, 4) };
				
					if (MISC::ARE_STRINGS_EQUAL(func_68(unk10), ""))
					{
						if (func_74(uParam0))
							uParam0->f_8 = 7;
						else
					...
					else if (func_69(&Global_1396116, unk10, false, -1, false, false))
					{
						uParam0->f_8 = 6;
					}
				}
				...
				{
					unk13 = { func_63(uParam0->f_7, uParam0->f_65, 6) };
				
					if (MISC::ARE_STRINGS_EQUAL(func_68(unk13), ""))
					{
						if (func_74(uParam0))
							uParam0->f_8 = 7;
						else
					...
					else if (func_69(&Global_1396116, unk13, false, -1, false, false))
					{
						uParam0->f_8 = 6;
					}
				}
		...
		case 7:
			if (func_77(uParam0))
			{
				unk16 = { func_63(uParam0->f_7, uParam0->f_65, 7) };
			
				if (func_69(&Global_1396116, unk16, false, -1, false, false))
					uParam0->f_8 = 8;
			}
			break;
...
void func_42(var uParam0) // Position - 0x12A4 Hash - 0x47563C56 ^0xB40EBCD6
{
	if (uParam0->f_8 == 3)
	{
		func_75(&(uParam0->f_3));
...
BOOL func_43(var uParam0, int iParam1) // Position - 0x12DC Hash - 0x8C916355 ^0x7DE67209
{
	if (func_70(true))
		return false;
	...
	{
		case 1:
			func_78(uParam0->f_3, "NPE_PRIS_GREET", joaat("SPEECH_PARAMS_ADD_BLIP"), 0, 1, 0, 0, 1);
			return true;
	}
...
BOOL func_44(int iParam0) // Position - 0x131E Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

BOOL func_45(int iParam0, BOOL bParam1) // Position - 0x1335 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_52() != -1)
		return false;
...
BOOL func_46(int iParam0) // Position - 0x1363 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_44(iParam0))
		return false;
...
void func_47(int iParam0, BOOL bParam1) // Position - 0x1387 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_52() != -1)
		return;
...
void func_48(int iParam0) // Position - 0x13C0 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
int func_49(int iParam0, BOOL bParam1) // Position - 0x1404 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_44(iParam0))
		return 0;
	...
	if (func_45(iParam0, true) && !bParam1)
	{
		func_27(iParam0, 128);
		return 1;
	}
...
BOOL func_50(int iParam0, int iParam1) // Position - 0x1487 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_51(int iParam0, BOOL bParam1) // Position - 0x1496 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_52() != -1)
		return false;
...
BOOL func_52() // Position - 0x14EE Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Hash func_53(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x14FC Hash - 0xEC5804B5 ^0x15A1D925
{
...
BOOL func_54(Hash hParam0) // Position - 0x15A0 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_80(hParam0))
...
Entity func_55(Hash hParam0, int iParam1) // Position - 0x15BB Hash - 0x3D4C4025 ^0x9DFFA56D
{
...
void func_56(var uParam0, int iParam1) // Position - 0x15F1 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_57(var uParam0, int iParam1) // Position - 0x1602 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_58(int iParam0) // Position - 0x1617 Hash - 0xD2F4094 ^0xD2F4094
{
	func_81(iParam0, false);
	func_82(iParam0, false);
	func_83(iParam0, true);
	func_84(iParam0, true);
	func_85(iParam0, false);
	func_86(iParam0, true);
	func_87(iParam0, true, true, true);
	return;
}

void func_59(var uParam0) // Position - 0x1652 Hash - 0xFDE77592 ^0xCC05639C
{
	switch (iLocal_14)
	{
		case 1:
			if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(uParam0->f_6, "SitToCower") && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_6, "SitToCower"))
			{
				ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "SitToCower", true);
				iLocal_14 = 5;
			}
			break;
		...
		case 3:
		case 4:
			if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(uParam0->f_6, "StandToCower") && !ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_6, "StandToCower"))
			{
				ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "StandToCower", true);
				iLocal_14 = 5;
			}
			break;
	
		case 5:
			if (bLocal_16 && ANIMSCENE::IS_ANIM_SCENE_IN_SECTION(uParam0->f_6, "Cower", true))
			{
				if (func_88() == 1)
				{
					if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_6, "flinch1"))
					{
						ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "flinch1", true);
						bLocal_16 = false;
						iLocal_14 = 5;
					}
				}
				...
				{
					ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(uParam0->f_6, "flinch2", true);
					bLocal_16 = false;
					iLocal_14 = 5;
				}
			}
...
BOOL func_60(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x1748 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
BOOL func_61(var uParam0) // Position - 0x1D71 Hash - 0xEDEF0818 ^0x5DCD1BEB
{
	Hash entityModel;
	int num;
...
char* func_62(int iParam0, int iParam1) // Position - 0x1DC5 Hash - 0xF811D051 ^0xF811D051
{
	switch (iParam0)
	{
		case 2:
...
Vector3 func_63(int iParam0, int iParam1, int iParam2) // Position - 0x202A Hash - 0xE0BFB579 ^0x6294E9C0
{
	char* str;
	var unk;
...
void func_64(var uParam0, Ped pedParam1, char* sParam2, BOOL bParam3) // Position - 0x31D8 Hash - 0x5AD955B5 ^0x43BD5215
{
...
BOOL func_65() // Position - 0x3235 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_52() != -1)
		return false;
...
BOOL func_66(int iParam0, var uParam1) // Position - 0x325A Hash - 0x1FCCC7D5 ^0x1FCCC7D5
{
	switch (iParam0)
	{
		case 9:
...
void func_67(var uParam0) // Position - 0x3278 Hash - 0x727A72BA ^0xDFF642D6
{
	if (uParam0->f_65 == 0)
		func_16(*uParam0, 16);
...
const char* func_68(var uParam0, var uParam1, var uParam2) // Position - 0x32B9 Hash - 0xE300744B ^0x46E4843E
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_69(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x32CD Hash - 0x4863E989 ^0xB2E91EEF
{
	BOOL flag;
...
BOOL func_70(BOOL bParam0) // Position - 0x3327 Hash - 0xD6E12BEB ^0xD87564B0
{
	return AUDIO::_0xFE5C6177064BD390(bParam0);
}

void func_71(int* piParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8) // Position - 0x3335 Hash - 0x77C6B9D1 ^0xC3EDC08A
{
...
int func_72(var uParam0, int* piParam1, float fParam2, var uParam3, int iParam4, int iParam5, int iParam6, char* sParam7, int iParam8, Volume volParam9, int iParam10, int iParam11, int iParam12) // Position - 0x33E8 Hash - 0x66907D63 ^0x41228033
{
	int num;
	BOOL flag;
	BOOL flag2;
		...
		switch (piParam1->f_2)
		{
			case 0:
				if (flag2)
				{
					if (func_132(uParam0, piParam1, uParam3, fParam2, iParam8, sParam7, iParam11, num2))
					{
						piParam1->f_1 = -1;
						piParam1->f_2 = 1;
						return func_72(uParam0, piParam1, fParam2, uParam3, iParam4, iParam5, iParam6, sParam7, iParam8, volParam9, iParam10, iParam11, iParam12);
					}
				}
				break;
			...
			case 1:
				...
				else
				{
					...
					{
						func_76(uParam3, 0, false, true, true);
...
void func_73(int* piParam0, BOOL bParam1, BOOL bParam2) // Position - 0x382C Hash - 0xAC8CE43 ^0x1A2D07F
{
...
BOOL func_74(var uParam0) // Position - 0x3872 Hash - 0x79E27FFF ^0x43744348
{
...
void func_75(var uParam0) // Position - 0x38A2 Hash - 0x43696AC2 ^0x4C06F87D
{
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
...
void func_76(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x38C8 Hash - 0x5EBCB35A ^0x47D35D05
{
	int i;
...
BOOL func_77(var uParam0) // Position - 0x3973 Hash - 0xF490F975 ^0x19C69C8E
{
...
BOOL func_78(Ped pedParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x39AC Hash - 0x281BDD5E ^0x8899ECCD
{
	char* str;
...
void func_79(int iParam0, int iParam1) // Position - 0x39F3 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_44(iParam0))
		return;
...
BOOL func_80(Hash hParam0) // Position - 0x3A14 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

void func_81(int iParam0, BOOL bParam1) // Position - 0x3A20 Hash - 0x97140DD8 ^0xF9889272
{
	if (bParam1)
...
void func_82(int iParam0, BOOL bParam1) // Position - 0x3A46 Hash - 0x97140DD8 ^0xBDBF7A5
{
	if (bParam1)
...
void func_83(int iParam0, BOOL bParam1) // Position - 0x3A6C Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_84(int iParam0, BOOL bParam1) // Position - 0x3A92 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_36(iParam0, 16);
...
void func_85(int iParam0, BOOL bParam1) // Position - 0x3ABD Hash - 0x32CE93C6 ^0x60BFF41C
{
	if (bParam1)
...
void func_86(int iParam0, BOOL bParam1) // Position - 0x3AE1 Hash - 0x9CA625A6 ^0xD96D8959
{
	if (bParam1)
		func_36(iParam0, 256);
	else
...
void func_87(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3B03 Hash - 0x3145AA70 ^0xBCD5B3EB
{
	if (!bParam1)
...
int func_88() // Position - 0x3B68 Hash - 0xEE877ACE ^0xCCE9C802
{
...
void func_89(int iParam0, BOOL bParam1, int iParam2) // Position - 0x3B89 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_153(iParam2);
...
BOOL func_90(Ped pedParam0, int iParam1) // Position - 0x3D54 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_91(Ped pedParam0, int iParam1, int iParam2) // Position - 0x3E2C Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_92(Ped pedParam0, int iParam1) // Position - 0x3E69 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_93(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x3F50 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_94(Ped pedParam0, int iParam1) // Position - 0x4027 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_95(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4130 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_96(int iParam0, int iParam1) // Position - 0x4265 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_97(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x429C Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_98(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x43A3 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_99(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x440E Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_100(Ped pedParam0, int iParam1) // Position - 0x4556 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_101(var uParam0, int iParam1) // Position - 0x4736 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_102(int iParam0, int iParam1) // Position - 0x47AE Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_103(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x47DD Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_104(int iParam0, Ped pedParam1) // Position - 0x4963 Hash - 0x42A83B1F ^0x2AC66201
{
	int _int;
...
BOOL func_105(int iParam0, Ped pedParam1) // Position - 0x49B3 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_181(iParam0))
		return true;
...
BOOL func_106(Ped pedParam0, Ped pedParam1) // Position - 0x4A50 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_107() // Position - 0x4A9D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_108(int iParam0, Ped pedParam1) // Position - 0x4AA5 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_109() // Position - 0x4B66 Hash - 0xE698BCC8 ^0x3E64CD04
{
	int networkTimeAccurate;
...
BOOL func_110() // Position - 0x4B84 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_111(int iParam0, Ped pedParam1) // Position - 0x4BD1 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_112(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x4CED Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_113(Ped pedParam0, int iParam1) // Position - 0x4D35 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_114(Ped pedParam0, int iParam1) // Position - 0x4F8E Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_191(0))
		return false;
...
BOOL func_115(int iParam0, int iParam1) // Position - 0x4FC7 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_116(var uParam0, int iParam1) // Position - 0x4FF6 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_117(Ped pedParam0, int iParam1) // Position - 0x500A Hash - 0xA06525EC ^0x3DA5C48E
{
...
BOOL func_118(int iParam0, Ped pedParam1) // Position - 0x5057 Hash - 0x2978E171 ^0x103C6309
{
...
int func_119(Hash hParam0) // Position - 0x50AB Hash - 0xA10EBB5C ^0xA10EBB5C
{
	switch (hParam0)
	{
...
char* func_120(char* sParam0, char* sParam1) // Position - 0x5150 Hash - 0x17C60719 ^0x17C60719
{
	if (func_65())
		return sParam0;
...
BOOL func_121(int iParam0, int iParam1) // Position - 0x5166 Hash - 0xC3DE0614 ^0x9804EDD5
{
	int num;
...
BOOL func_122(var uParam0, Entity eParam1, char* sParam2) // Position - 0x518E Hash - 0xFB1C2C0E ^0x6794528D
{
	BOOL flag;
	int i;
...
void func_123(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x520C Hash - 0xFDACD718 ^0x658C9335
{
	int i;
...
BOOL func_124(int iParam0) // Position - 0x525E Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
void func_125(int iParam0, const char* sParam1, var uParam2, BOOL bParam3) // Position - 0x529D Hash - 0x2048C918 ^0x83757B6C
{
	int num;
...
void func_126(int iParam0, const char* sParam1, BOOL bParam2) // Position - 0x52ED Hash - 0x90B9FBB4 ^0x1E664566
{
	int num;
...
void func_127(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5336 Hash - 0x89AE2BEC ^0x89AE2BEC
{
	int num;
...
void func_128(int* piParam0, const char* sParam1) // Position - 0x5385 Hash - 0x94802979 ^0xDA357E7D
{
...
void func_129(var uParam0) // Position - 0x53BC Hash - 0x9DBECFB8 ^0xE52A4E97
{
	if (*uParam0 & 1 != 0)
...
var func_130(BOOL bParam0, var uParam1, var uParam2) // Position - 0x53DF Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_131(Ped pedParam0, int* piParam1, var uParam2) // Position - 0x53F6 Hash - 0x84A3184B ^0x2FCA8561
{
	if (piParam1->f_11 != 0)
	{
		if (func_201(pedParam0, piParam1))
		{
			if (!func_35(piParam1->f_10, 1))
			{
				...
				func_76(uParam2, 0, false, true, false);
...
BOOL func_132(var uParam0, int* piParam1, var uParam2, float fParam3, int iParam4, char* sParam5, Hash hParam6, int iParam7) // Position - 0x54A0 Hash - 0x95336F37 ^0x42E85BA7
{
	var text;
	BOOL flag;
	Prompt prompt;
...
void func_133(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5791 Hash - 0x61822EFB ^0x98C55DC1
{
...
BOOL func_134(int* piParam0, int iParam1) // Position - 0x57B7 Hash - 0x5B2730C0 ^0x9239CD27
{
	return MISC::IS_BIT_SET(*piParam0, iParam1);
}

BOOL func_135(var uParam0, int iParam1, Volume volParam2, BOOL bParam3) // Position - 0x57C8 Hash - 0x89673EF ^0xD8D31C9
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_136(var uParam0, BOOL bParam1, int* piParam2, float fParam3, var uParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, char* sParam9, int iParam10, Volume volParam11, int iParam12, int iParam13, BOOL bParam14) // Position - 0x582C Hash - 0x3FED85C6 ^0x1A53C527
{
	int i;
...
void func_137(int iParam0) // Position - 0x58A1 Hash - 0x5A9B862A ^0x7ECCD484
{
	...
	for (i = 0; i < *uParam4; i = i + 1)
	{
		...
		if (func_215(*uParam0, piParam1, &uParam4->[i /*17*/], flag2, fParam3, iParam2, iParam7, iParam8, bParam14, bParam16, bParam17, isPedOnFoot, isPedInjured, bParam15, num2, flag7, num))
		{
			if (!bParam18 && !flag3)
			{
				...
				{
					if (!flag5)
						func_76(uParam4, 0, false, true, bParam5);
...
void func_139(var uParam0) // Position - 0x5BA6 Hash - 0x14F6CB16 ^0xBB9D41ED
{
	int i;
...
void func_140(int* piParam0, var uParam1, int iParam2) // Position - 0x5BF9 Hash - 0x9063AD98 ^0x85323D11
{
	int i;
...
BOOL func_141(Ped pedParam0, int* piParam1, var uParam2) // Position - 0x5C3C Hash - 0xEB1F3A6C ^0xB0CA3802
{
...
BOOL func_142(var uParam0, int* piParam1, int iParam2, BOOL bParam3) // Position - 0x5C94 Hash - 0x384F04E1 ^0xEB00389B
{
	if (piParam1->f_9)
	{
...
void func_143(Object obParam0, int* piParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5D3E Hash - 0x415C2438 ^0x87B17E4A
{
	int num;
...
void func_144(int* piParam0, int iParam1) // Position - 0x5D8A Hash - 0xAEE04633 ^0x4F653A94
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_145(int* piParam0, var uParam1) // Position - 0x5D9A Hash - 0xC7765EDD ^0x9C4E31FE
{
	int i;
	var src;
	var src2;
	...
	func_76(uParam1, 0, true, true, false);
...
BOOL func_146(int* piParam0, int iParam1) // Position - 0x5E2B Hash - 0x5B2730C0 ^0x9239CD27
{
	return MISC::IS_BIT_SET(*piParam0, iParam1);
}

void func_147(int* piParam0, int iParam1) // Position - 0x5E3C Hash - 0xAEE04633 ^0x5DF885B3
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

void func_148(int* piParam0, int iParam1) // Position - 0x5E4C Hash - 0xAEE04633 ^0x4F653A94
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_149(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5E5C Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
void func_150(int iParam0, var uParam1) // Position - 0x5EB0 Hash - 0x9E3E50A0 ^0xC9C1BEC0
{
...
BOOL func_151(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x6053 Hash - 0x6735ACA9 ^0xD6205CC6
{
	if (bParam2 && ENTITY::IS_ENTITY_DEAD(pedParam0))
		return false;
...
BOOL func_152(Ped pedParam0, Any* panParam1) // Position - 0x6089 Hash - 0x2ACCF512 ^0x38357878
{
	return AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, panParam1);
}

void func_153(int iParam0) // Position - 0x6099 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_154(int iParam0) // Position - 0x6205 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_155(BOOL bParam0) // Position - 0x6218 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_156(int iParam0) // Position - 0x6232 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_157(int iParam0) // Position - 0x62CC Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_158(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x62F3 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_159(Ped pedParam0, Ped pedParam1) // Position - 0x63EC Hash - 0xF9959663 ^0xF9959663
{
	return func_182(pedParam0, pedParam1, true, true);
}

float func_160(int iParam0) // Position - 0x63FE Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_161(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x640A Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_162(int iParam0, BOOL bParam1) // Position - 0x646F Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_163() // Position - 0x6495 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_164(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x64A9 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_165(int iParam0) // Position - 0x6609 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_166(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x6615 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_167(int iParam0) // Position - 0x6676 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_168(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x6682 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_169(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6744 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_170(int iParam0) // Position - 0x67E2 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_171(int iParam0) // Position - 0x67EE Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_172(int iParam0) // Position - 0x67FA Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_173(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x6937 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_174(Ped pedParam0) // Position - 0x697A Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_175(Ped pedParam0) // Position - 0x69E0 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
BOOL func_176(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6A0C Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_177(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6A53 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_178(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x6A9E Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_179(Ped pedParam0, var uParam1) // Position - 0x6B17 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_180(Ped pedParam0, Ped pedParam1) // Position - 0x6B64 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_181(int iParam0) // Position - 0x6BAC Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_182(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6BBC Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_183(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x6C04 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_184(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x6C30 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_185(int iParam0) // Position - 0x6C58 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_186(Ped pedParam0) // Position - 0x6C64 Hash - 0xEB445B10 ^0x7C662877
{
...
int func_187(Ped pedParam0) // Position - 0x6CBC Hash - 0x6E063231 ^0x92231582
{
...
BOOL func_188(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x6D2C Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_189(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6E9C Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_190(int iParam0, Ped pedParam1) // Position - 0x6F8A Hash - 0x27FC2906 ^0xC3ECBBD2
{
...
BOOL func_191(int iParam0) // Position - 0x7000 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_65())
		return false;
...
int func_192(int iParam0) // Position - 0x7022 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_193(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x702E Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_194(int iParam0) // Position - 0x70A9 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_239(iParam0))
		return -1;
...
BOOL func_195(int iParam0, int iParam1) // Position - 0x70C5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_196(int iParam0) // Position - 0x70D4 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

void func_197(int iParam0, int iParam1) // Position - 0x70DE Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_198(int iParam0, BOOL bParam1) // Position - 0x7111 Hash - 0x7190BAC6 ^0x6DC372CF
{
...
void func_199(int iParam0, BOOL bParam1) // Position - 0x7169 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_200(int iParam0, int iParam1) // Position - 0x7192 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
BOOL func_201(Ped pedParam0, int* piParam1) // Position - 0x71BA Hash - 0xFB53563C ^0x22205B46
{
	BOOL flag;
	BOOL flag2;
...
void func_202(var uParam0) // Position - 0x7232 Hash - 0xBF3B7066 ^0xBF3B7066
{
	int i;
...
void func_203(int* piParam0, var uParam1, BOOL bParam2) // Position - 0x7267 Hash - 0x6F91FC09 ^0xBA0ABE9A
{
...
Prompt func_204(Object obParam0, int* piParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x72A1 Hash - 0xAAA1EE43 ^0x1865183
{
	int num;
...
int func_205(var uParam0) // Position - 0x7311 Hash - 0x642E71C7 ^0x2B612313
{
	int num;
	int num2;
...
int func_206(var uParam0, int iParam1) // Position - 0x738F Hash - 0x2E6C9ADE ^0xD0DFC5BC
{
	int i;
...
void func_207(int* piParam0, int* piParam1) // Position - 0x73BE Hash - 0xFCEC0C12 ^0x65EC5F60
{
...
BOOL func_208(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x73FB Hash - 0x8E7018BE ^0x1BA834FB
{
	Entity outEntity;
...
void func_209(Object obParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x7470 Hash - 0x1F7F43A4 ^0x1F7F43A4
{
	int i;
...
int func_210(int iParam0) // Position - 0x74B5 Hash - 0x17F3724D ^0x89A0993C
{
	return MONEY::_MONEY_GET_CASH_BALANCE();
}

BOOL func_211(Ped pedParam0) // Position - 0x74C1 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_249(pedParam0, 4) || func_249(pedParam0, 5);
}

BOOL func_212(Ped pedParam0) // Position - 0x74DD Hash - 0xE0409C42 ^0xE0409C42
{
	return func_249(pedParam0, 7);
}

BOOL func_213(Ped pedParam0) // Position - 0x74EC Hash - 0xC9A2E10A ^0xC9A2E10A
{
	return func_249(pedParam0, 6);
}

void func_214(Object obParam0, int* piParam1, float fParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6) // Position - 0x74FB Hash - 0x28F375A9 ^0x20CFE665
{
...
BOOL func_215(Object obParam0, int* piParam1, int* piParam2, BOOL bParam3, float fParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, float fParam14, BOOL bParam15, int iParam16) // Position - 0x7533 Hash - 0x9E28CA55 ^0x9E28CA55
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_216(int iParam0, int iParam1) // Position - 0x75B1 Hash - 0xFED1B5B5 ^0xFED1B5B5
{
...
void func_217(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x75FB Hash - 0x6249DB64 ^0x6249DB64
{
	int i;
...
BOOL func_218(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x7625 Hash - 0xD16C56E3 ^0xCC194231
{
	if (piParam0->f_2 != 3)
...
void func_219(int* piParam0, int iParam1) // Position - 0x7649 Hash - 0xCA0C813A ^0x642D602A
{
...
BOOL func_220(int* piParam0) // Position - 0x7686 Hash - 0xA750EC1D ^0xA62AC3E5
{
...
BOOL func_221(Ped pedParam0) // Position - 0x769F Hash - 0x38F1F494 ^0xD89820BA
{
	int i;
	int numberOfEvents;
	int num;
...
void func_222(int* piParam0, int iParam1) // Position - 0x771D Hash - 0xAEE04633 ^0x5DF885B3
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

void func_223(var uParam0) // Position - 0x772D Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_224(var uParam0, int iParam1) // Position - 0x7743 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_225(int iParam0) // Position - 0x7761 Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_257(iParam0))
		return;
...
BOOL func_226() // Position - 0x7814 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_258())
		return false;
...
void func_227(int iParam0, int iParam1) // Position - 0x786A Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_228(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7915 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_229(int iParam0) // Position - 0x79DC Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_230(int iParam0) // Position - 0x7A84 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_231(Ped pedParam0, int iParam1) // Position - 0x7AE9 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_232(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x7B00 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_233(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x7B2E Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_234(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x7B78 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_235(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7BB9 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_236(Ped pedParam0) // Position - 0x7C32 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_237(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x7D1A Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_238(int iParam0, BOOL bParam1) // Position - 0x7D5C Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_239(int iParam0) // Position - 0x7D8D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_240(int iParam0) // Position - 0x7DC0 Hash - 0xB1EC3C9 ^0x256D499C
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_241(int iParam0, int iParam1) // Position - 0x7DDF Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
Ped func_242(BOOL bParam0, Ped pedParam1, Ped pedParam2) // Position - 0x7E00 Hash - 0xCF32FBA5 ^0xCF32FBA5
{
	if (bParam0)
		return pedParam1;
...
void func_243(int* piParam0, int iParam1) // Position - 0x7E14 Hash - 0x5F94E6 ^0xC34AEB03
{
	*piParam0 = 0;
	piParam0->f_1 = -1;
	piParam0->f_2 = 0;
...
void func_244(Object obParam0, int* piParam1, float fParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7E32 Hash - 0x9E5AD4FF ^0xCE9B419A
{
	const char* str;
	int num;
...
int func_245(Ped pedParam0) // Position - 0x7F89 Hash - 0xB2D81349 ^0xACC293B5
{
	Hash pedRelationshipGroupDefaultHash;
...
void func_246(int* piParam0, int iParam1) // Position - 0x7FDE Hash - 0x3586A1C6 ^0xF27C3C86
{
...
BOOL func_247(BOOL bParam0) // Position - 0x800B Hash - 0x8C844EEB ^0x8C844EEB
{
	return Global_22 && bParam0 != false;
}

void func_248(BOOL bParam0) // Position - 0x801B Hash - 0x88AD5D ^0x88AD5D
{
	Global_22 = Global_22 || bParam0;
	return;
}

BOOL func_249(Ped pedParam0, int iParam1) // Position - 0x802C Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
BOOL func_250(int* piParam0, int* piParam1, Object obParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, float fParam9, BOOL bParam10, int iParam11) // Position - 0x806B Hash - 0x99448FD3 ^0x2F09ABA3
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_251(int iParam0, BOOL bParam1) // Position - 0x81A5 Hash - 0xC074CB7F ^0xC074CB7F
{
...
void func_252(int iParam0, Object obParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x81CA Hash - 0x8A4F30F0 ^0xE1CE78DB
{
	int num;
...
BOOL func_253(int iParam0, BOOL bParam1) // Position - 0x822F Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
BOOL func_254(int iParam0, BOOL bParam1) // Position - 0x8287 Hash - 0xAAB142C4 ^0xBB29AF2
{
	int num;
...
void func_255(int iParam0, BOOL bParam1) // Position - 0x82BA Hash - 0x23556CE7 ^0xE508C6D9
{
	int num;
...
BOOL func_256(var uParam0, int iParam1) // Position - 0x82EC Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_21(uParam0))
		return false;
...
BOOL func_257(int iParam0) // Position - 0x8313 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_241(iParam0, 2);
}

BOOL func_258() // Position - 0x8322 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_259(int iParam0) // Position - 0x8353 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_239(iParam0))
		return -1;
...
int func_260(const char* sParam0, Hash hParam1, Object obParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x836F Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
...
void func_261(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8446 Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
void func_262(int iParam0, const char* sParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8491 Hash - 0x3019E4B2 ^0x1E9F9706
{
	int num;
...
int func_263(int iParam0) // Position - 0x84E4 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_265(int iParam0) // Position - 0x87CB Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
