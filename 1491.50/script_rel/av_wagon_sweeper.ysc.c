...
void main() // Position - 0x0 Hash - 0xA112627F ^0x73202530
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0x3F0E66A0
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x61A2A966 ^0xA2293917
{
	int num;
	...
	func_50(uParam0, "WAGON_SWEEPER", "script@ambient@town@wagon_sweeper@action", uParam1, uParam4);
	func_51(uParam0, 1, "pbl_action", "", 0);
	func_52(uParam0, 0, "male", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_53(uParam0, 0, "Broom", joaat("p_broom02x"), 0f, 0f, 0f, 0f, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C58 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CF8 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
BOOL func_17(var uParam0) // Position - 0x1E12 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
BOOL func_18(var uParam0) // Position - 0x1FDB Hash - 0x66B297EB ^0x2E31C1AE
{
	return STREAMING::HAS_MODEL_LOADED(hLocal_37);
}

BOOL func_19(var uParam0) // Position - 0x1FE9 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2199 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x220D Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x225C Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22B4 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x241D Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2744 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x287B Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29AB Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29EA Hash - 0x1103DC0D ^0x1DA25E8B
{
	int i;
	...
	{
		uParam0->f_453 = VEHICLE::CREATE_VEHICLE(hLocal_37, uParam0->f_483, uParam0->f_486.f_2, true, true, true, false);
		return false;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_453))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
		{
			for (i = 1; i <= 10; i = i + 1)
			{
				if (VEHICLE::DOES_EXTRA_EXIST(uParam0->f_453, i))
					VEHICLE::SET_VEHICLE_EXTRA(uParam0->f_453, i, true);
			}
		
			ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_453, true);
			return true;
		}
	}
...
void func_29(var uParam0) // Position - 0x2A93 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2AC5 Hash - 0x1FD179BA ^0xD7E6735A
{
	func_62(&uLocal_9, false);
...
int func_31(var uParam0) // Position - 0x2AFF Hash - 0x49A9EE9B ^0x42BF79F8
{
	Vector3 vector;
	...
	if (!uParam0->f_469[0])
	{
		if (func_68(uParam0, &uLocal_9, false))
		{
			...
			if (!uParam0->f_469[6])
			{
				func_70(*uParam0, uParam0->f_483, false);
				uParam0->f_469[6] = 1;
			}
	...
	if (!uParam0->f_469[2])
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
			if (func_71(uParam0, 1065353216, 55f, 4, 15f, 1112014848))
			{
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					func_69(uParam0);
					ANIMSCENE::SET_ANIM_SCENE_BOOL(uParam0->f_3.f_1, "Loop", true, false);
					PED::_REQUEST_PROP_SCENARIO_PED(uParam0->f_20[0 /*14*/], uParam0->f_372[0 /*8*/], "p_broom02x_PH_R_HAND", "WORLD_HUMAN_BROOM_PUTDOWN", "", true);
					uParam0->f_469[1] = 1;
					uParam0->f_469[2] = 1;
					return 0;
				}
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[6])
		{
			if (func_72(uParam0, 1065353216, 1116471296, 4, joaat("Action"), true))
			{
				func_70(*uParam0, uParam0->f_483, false);
				uParam0->f_469[6] = 1;
			}
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
					{
						...
						PED::_GIVE_PED_SCENARIO_PROP(uParam0->f_20[0 /*14*/], uParam0->f_372[0 /*8*/], "p_broom02x_PH_R_HAND", "WORLD_HUMAN_BROOM_PUTDOWN", 0, true);
						vector = { func_73(uParam0) };
					
						if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vector, 0.5f, true, 0, false) && !TASK::_DOES_SCENARIO_POINT_HAVE_PROPS(TASK::FIND_SCENARIO_OF_TYPE_HASH(vector, joaat("world_human_broom_putdown"), 0.5f, 0, false)))
							TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(uParam0->f_20[0 /*14*/], vector, 0.5f, 1000, false, false, false, false);
						else
							TASK::TASK_WANDER_STANDARD(uParam0->f_20[0 /*14*/], ENTITY::GET_ENTITY_HEADING(uParam0->f_20[0 /*14*/]), 0);
					
						PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], -1401977097, false, 0, true);
...
int func_32(var uParam0, var uParam1) // Position - 0x2DB1 Hash - 0x11289E8F ^0xE6C65D5C
{
	func_61(uParam0, true);
	ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_453, false);
	func_74(uParam0, true, true, true);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DD4 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DF1 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F2D Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3066 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3110 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3188 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3217 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3332 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x333E Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34C6 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3566 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3579 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3593 Hash - 0xEA796703 ^0x695D7925
{
...
int func_46() // Position - 0x35FB Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_47(int iParam0) // Position - 0x3609 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
int func_48() // Position - 0x36FA Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

int func_49(int iParam0) // Position - 0x3708 Hash - 0xA6D0F253 ^0xBA6871A0
{
	int num;
...
void func_50(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3781 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_51(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x37AD Hash - 0xF0D98862 ^0x21440CE
{
...
void func_52(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37DE Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x386C Hash - 0xD25940D1 ^0x34109BE0
{
...
BOOL func_54(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x38C5 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_55(int iParam0) // Position - 0x3AC9 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_56(int iParam0, int iParam1) // Position - 0x3ADD Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_57() // Position - 0x3AEC Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_48() != -1;
}

BOOL func_58(var uParam0, Any* panParam1) // Position - 0x3B07 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_59(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3B66 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_60(Ped pedParam0) // Position - 0x3BA8 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3BD4 Hash - 0x945455B8 ^0xE07FD65F
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]) || !ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[0 /*8*/]))
		return;

	ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[0 /*14*/], !bParam1);
	PED::SET_PED_CAN_RAGDOLL(uParam0->f_20[0 /*14*/], bParam1);
	ENTITY::SET_ENTITY_COLLISION(uParam0->f_20[0 /*14*/], bParam1, false);
	ENTITY::SET_ENTITY_COLLISION(uParam0->f_372[0 /*8*/], bParam1, false);
	return;
}

void func_62(int iParam0, BOOL bParam1) // Position - 0x3C39 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3CB5 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3CDB Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3CFD Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3D1F Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x3D41 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_68(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3D65 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_69(var uParam0) // Position - 0x3DBF Hash - 0xE62223CB ^0xE62223CB
{
	if (!uParam0->f_469[7])
	{
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3DE4 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_71(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3EE8 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_112(&(uParam0->f_490), iParam1))
						{
...
BOOL func_72(var uParam0, int iParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x40F5 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
...
Vector3 func_73(var uParam0) // Position - 0x421E Hash - 0x3448702C ^0x3448702C
{
	var unk;
	float num;
	int num2;
	...
	switch (func_46())
	{
		case 0:
			...
			{
				case 5:
					num2[0 /*3*/] = { 2601.62f, -1490.32f, 44.97f };
					break;
			}
			break;
		...
		case 9:
			...
			{
				case 76:
					num2[0 /*3*/] = { -283.55f, 775.36f, 117.82f };
					num2[1 /*3*/] = { -269.29f, 641.98f, 112.46f };
					num2[2 /*3*/] = { -366.72f, 778.44f, 115.18f };
					break;
			}
			break;
		...
		case 11:
			...
			{
				case 105:
					num2[0 /*3*/] = { 1326.37f, -1370.9f, 78.99f };
					break;
			
				default:
					num2[0 /*3*/] = { 1051.79f, -1126.71f, 66.9f };
					break;
			}
			break;
	}
...
void func_74(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4372 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
float func_75(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x44C6 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x452D Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4556 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_78(var uParam0, var uParam1, var uParam2) // Position - 0x45A2 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_79(int iParam0) // Position - 0x45F1 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_80(int iParam0) // Position - 0x4616 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_81(int iParam0) // Position - 0x4629 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_82(int iParam0) // Position - 0x463C Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_83(int iParam0) // Position - 0x464F Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_84(int iParam0) // Position - 0x4661 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_85(int iParam0, int iParam1) // Position - 0x4673 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x470D Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_87() // Position - 0x4745 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_88(int iParam0) // Position - 0x4798 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_91(iParam0))
		return -1;
...
BOOL func_89(int iParam0) // Position - 0x47B8 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_90(int iParam0, int iParam1) // Position - 0x47CE Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_91(int iParam0) // Position - 0x47DD Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_92(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4810 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x48F1 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_100(iParam0, 4);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x490F Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_100(iParam0, 8);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x492F Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_100(iParam0, 16);
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x495A Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_100(iParam0, 32);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x497A Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_100(iParam0, 64);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x499A Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x49BC Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_100(int iParam0, int iParam1) // Position - 0x49E0 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_101(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x49F1 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x501A Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_103(int iParam0) // Position - 0x50F1 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_104(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5172 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_105(Ped pedParam0) // Position - 0x5263 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_106(Ped pedParam0) // Position - 0x527E Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_107(int iParam0) // Position - 0x529A Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_108(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x52E1 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_109(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x52FF Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_110(var uParam0) // Position - 0x5356 Hash - 0x5001E582 ^0x5001E582
{
	return func_166(*uParam0, 1);
}

void func_111(var uParam0) // Position - 0x5366 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_167(uParam0, 0f);
	return;
}

BOOL func_112(var uParam0, int iParam1) // Position - 0x5375 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_113(var uParam0) // Position - 0x5393 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_114(var uParam0, BOOL bParam1) // Position - 0x53A9 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_115(var uParam0) // Position - 0x53C9 Hash - 0x39705408 ^0x39705408
{
	return func_166(*uParam0, 2);
}

void func_116(var uParam0) // Position - 0x53D9 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_110(uParam0);
...
BOOL func_117(var uParam0, int iParam1) // Position - 0x540D Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_110(uParam0))
		return false;
...
void func_118(var uParam0) // Position - 0x5434 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_110(uParam0);
...
BOOL func_119(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5464 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_120(BOOL bParam0, var uParam1, var uParam2) // Position - 0x54B9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_121(int iParam0, int iParam1) // Position - 0x54D0 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_122(int iParam0, int iParam1) // Position - 0x5556 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_123(int iParam0, int iParam1) // Position - 0x5592 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_124(int iParam0, int iParam1) // Position - 0x55E5 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_125(int iParam0, int iParam1) // Position - 0x5620 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_126(int iParam0, int iParam1) // Position - 0x5659 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_127(int iParam0) // Position - 0x5691 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_128(BOOL bParam0) // Position - 0x56CF Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_129(ePedType eptParam0) // Position - 0x56E2 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_130(Ped pedParam0, Hash hParam1) // Position - 0x5B35 Hash - 0xF95BC2CA ^0x1BECDE08
{
...
void func_131(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5BDC Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_132(Ped pedParam0, BOOL bParam1) // Position - 0x5C0C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_133(Ped pedParam0, int iParam1) // Position - 0x5C51 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_134(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5C78 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_176(iParam2);
...
BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5E43 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_136(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5F1A Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5F57 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_138(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x603E Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x6114 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_140(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x621D Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_141(int iParam0, int iParam1) // Position - 0x6352 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6389 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6490 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x64FB Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x6643 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_146(var uParam0, int iParam1) // Position - 0x681F Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x6897 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_148(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x68C6 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_149(int iParam0, Ped pedParam1) // Position - 0x6A4C Hash - 0x6A720048 ^0xD383F83C
{
	int _int;
...
BOOL func_150(int iParam0, Ped pedParam1) // Position - 0x6A99 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_203(iParam0))
		return true;
...
BOOL func_151(Ped pedParam0, Ped pedParam1) // Position - 0x6B36 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_152() // Position - 0x6B83 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x6B8B Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_154() // Position - 0x6C4C Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_155() // Position - 0x6C6A Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6CB7 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_157(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6DD3 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_158(Ped pedParam0, int iParam1) // Position - 0x6E1B Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x7074 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_213(0))
		return false;
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x70AD Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_161(var uParam0, int iParam1) // Position - 0x70DC Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x70F0 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_163(int iParam0, Ped pedParam1) // Position - 0x713D Hash - 0x8E6A2820 ^0xE8F60617
{
...
void func_164(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7190 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_165(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x721C Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x723A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_167(var uParam0, float fParam1) // Position - 0x7249 Hash - 0x30433BAB ^0xF854D531
{
...
float func_168() // Position - 0x726F Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_169(var uParam0, int iParam1) // Position - 0x72A1 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_170(var uParam0) // Position - 0x72B6 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_110(uParam0))
		return uParam0->f_1;
...
void func_171(var uParam0, int iParam1) // Position - 0x72EB Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x72FC Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x732A Hash - 0x4147A569 ^0xA0A8DA2B
{
	Hash _int;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x7378 Hash - 0x4147A569 ^0xA0A8DA2B
{
	Hash _int;
	int _int2;
...
void func_175(Ped pedParam0) // Position - 0x73E6 Hash - 0x973F0B91 ^0x400EFA1E
{
...
void func_176(int iParam0) // Position - 0x7402 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_177(int iParam0) // Position - 0x756E Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_178(BOOL bParam0) // Position - 0x7581 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_179(int iParam0) // Position - 0x759B Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_180(int iParam0) // Position - 0x7635 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_181(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x765C Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_182(Ped pedParam0, Ped pedParam1) // Position - 0x7755 Hash - 0xF9959663 ^0xF9959663
{
	return func_204(pedParam0, pedParam1, true, true);
}

float func_183(int iParam0) // Position - 0x7767 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_184(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7773 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_185(int iParam0, BOOL bParam1) // Position - 0x77D8 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_186() // Position - 0x77FE Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_187(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7812 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_188(int iParam0) // Position - 0x7972 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_189(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x797E Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_190(int iParam0) // Position - 0x79DF Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_191(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x79EB Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_192(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7AAD Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_193(int iParam0) // Position - 0x7B4B Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_194(int iParam0) // Position - 0x7B57 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_195(int iParam0) // Position - 0x7B63 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_196(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7CA0 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_197(Ped pedParam0) // Position - 0x7CE3 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D49 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D90 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7DDB Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_201(Ped pedParam0, var uParam1) // Position - 0x7E54 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_202(Ped pedParam0, Ped pedParam1) // Position - 0x7EA1 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_203(int iParam0) // Position - 0x7EE9 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_204(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7EF9 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_205(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7F41 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7F6D Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_207(int iParam0) // Position - 0x7F95 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_208(Ped pedParam0) // Position - 0x7FA1 Hash - 0x644A6F0A ^0xFC9E6630
{
...
int func_209(Ped pedParam0) // Position - 0x7FF5 Hash - 0xEB51F584 ^0xB91FCB10
{
...
BOOL func_210(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8062 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_211(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x81D2 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_212(int iParam0, Ped pedParam1) // Position - 0x82C0 Hash - 0x27FC2906 ^0xEFF6A25F
{
...
BOOL func_213(int iParam0) // Position - 0x8336 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_230())
		return false;
...
int func_214(int iParam0) // Position - 0x8358 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_215(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8364 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_216(int iParam0) // Position - 0x83DF Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_217() // Position - 0x83F2 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_218() // Position - 0x8400 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_232())
		return false;
...
void func_219(Any* panParam0, int iParam1) // Position - 0x8456 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_220(BOOL bParam0, var uParam1, var uParam2) // Position - 0x84FE Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_221(int iParam0) // Position - 0x85C5 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_222(int iParam0) // Position - 0x866D Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_223(Ped pedParam0, int iParam1) // Position - 0x86D2 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_224(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x86E9 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_225(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8717 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_226(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8761 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_227(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x87A2 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_228(Ped pedParam0) // Position - 0x881B Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_229(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8903 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_230() // Position - 0x8945 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_217() != -1)
		return false;
...
BOOL func_231(int iParam0, BOOL bParam1) // Position - 0x896A Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_232() // Position - 0x899B Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_233(int iParam0) // Position - 0x89CC Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_91(iParam0))
		return -1;
...
int func_234(int iParam0) // Position - 0x89E8 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_235(int iParam0) // Position - 0x8A29 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
