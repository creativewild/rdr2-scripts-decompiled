...
BOOL func_11() // Position - 0x7BC Hash - 0xB3A9A8CA ^0xF610D91C
{
	if (func_20() == -1)
	{
		volLocal_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2251.375f, -1915.508f, 117.618f, 0f, 0f, -66.588f, 7.714f, 7.649f, 7.583f, "Tall Trees Trapper - m_volTrapper");
		volLocal_10 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2250.752f, -1916.897f, 117.618f, 0f, 0f, -66.562f, 1.423f, 2.798f, 4.201f, "Tall Trees Trapper - m_volTrapperPrompt");
		volLocal_11 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2251.891f, -1914.261f, 117.618f, 0f, 0f, -66.562f, 2.755f, 4.58f, 4.201f, "Tall Trees Trapper - m_volTrapperOfflimits");
	}
...
void func_51() // Position - 0x11FE Hash - 0x52F6350D ^0x52F6350D
{
...
void func_61(eStackSize essParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1318 Hash - 0xB6F2F238 ^0x96196553
{
	BOOL flag;
	const char* str;
	char* str2;
...
void func_96(int iParam0) // Position - 0x47D9 Hash - 0xD3C02079 ^0xED43DA09
{
...
void func_97(int iParam0) // Position - 0x49EB Hash - 0x6D28C6C0 ^0x3842FB4B
{
	if (iParam0 == 76)
	{
...
void func_98() // Position - 0x4A95 Hash - 0x31690749 ^0xC8EA45D0
{
	int randomIntInRange;
	int randomIntInRange2;
...
void func_99() // Position - 0x4AF6 Hash - 0xBBE64FEF ^0x98D6DE0C
{
	switch (MISC::GET_RANDOM_INT_IN_RANGE(0, 6))
	{
		case 0:
...
char* func_111(int iParam0) // Position - 0x59AF Hash - 0xC8B4DC56 ^0x5793989
{
	switch (iParam0)
	{
		case 0:
...
const char* func_118(var uParam0, int iParam1) // Position - 0x5ABC Hash - 0xB0CFF0C3 ^0x230A6F79
{
...
BOOL func_144(Object obParam0, Object obParam1) // Position - 0x5FDA Hash - 0x178D9C09 ^0x178D9C09
{
...
BOOL func_155(int iParam0, Object obParam1) // Position - 0x62EB Hash - 0x36B8C524 ^0xE0AE37EE
{
	return func_144(Global_1914319.f_3[iParam0 /*446*/].f_6, obParam1);
}
...
const char* func_170(int iParam0) // Position - 0x69C1 Hash - 0xE6862179 ^0x1A4383A0
{
	switch (iParam0)
	{
		case 0:
...
const char* func_173(const char* sParam0, int iParam1) // Position - 0x6CE9 Hash - 0x9E99F03 ^0x1D826F79
{
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x6E0C Hash - 0x2F9EB0B9 ^0x2F8FF37E
{
	char* ambientZone;
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x6E40 Hash - 0x342D57CF ^0x52481E55
{
	switch (iParam0)
	{
		case 5:
