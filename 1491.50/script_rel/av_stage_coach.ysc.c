...
void main() // Position - 0x0 Hash - 0xA112627F ^0xB8E2E0C2
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0x1A0D6847
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x6B37C3E6 ^0x4595B6AF
{
	int num;

	if (Global_1430231.f_6)
	{
		uParam0->f_499 = 1;
		return;
	}
	...
	func_46(uParam0, "AV_STAGE_COACH", "", vParam1, uParam4);
	num = func_48(func_47());
	func_49(uParam0, 0, "PASSENGER", num, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -4.5f, 1.5f, 0f), uParam4.f_2 - 75f, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "WAGON_DRIVER", joaat("s_m_m_coachtaxidriver_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1f, 1.5f, 0f), uParam4.f_2 + 110f, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 2, "STAGE_COACH_HORSE_1", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 3, "STAGE_COACH_HORSE_2", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 4, "STAGE_COACH_HORSE_3", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 5, "STAGE_COACH_HORSE_4", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, "COACH" /*Dashound*/, iLocal_38, vParam1, uParam4.f_2, 0, 0, 0, 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1CE6 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D86 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1EA0 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2069 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2072 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2222 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2296 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22E5 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x233D Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24A6 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27CD Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2904 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A34 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A73 Hash - 0xBE755180 ^0xC5E1CDB7
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		...
		func_58(uParam0->f_20[1 /*14*/], joaat("world_human_smoke"), 0, false, joaat("world_human_smoke_male_a"), -1082130432);
	}

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		PED::SET_PED_AS_GROUP_MEMBER(uParam0->f_20[0 /*14*/], iLocal_37);
		func_58(uParam0->f_20[0 /*14*/], joaat("world_human_stare_stoic"), 0, false, 0, -1082130432);
	}

	return true;
}

void func_29(var uParam0) // Position - 0x2AF0 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B22 Hash - 0xF853357A ^0xFFFE980E
{
...
int func_31(var uParam0) // Position - 0x2B9D Hash - 0x70A4A161 ^0x70A4A161
{
	int taskSequenceId;
	...
	if (!uParam0->f_469[0])
	{
		if (func_68(uParam0, &uLocal_9, false))
		{
			...
			if (!uParam0->f_469[6])
			{
				func_71(*uParam0, uParam0->f_483, true);
				uParam0->f_469[6] = 1;
			}
	...
	if (!uParam0->f_469[2])
	{
		if (func_72(uParam0, 1065353216, 80f, 4, 60f, 1112014848))
		{
			func_70(uParam0);
			TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
			TASK::TASK_ENTER_VEHICLE(0, uParam0->f_453, -1, -1, 1f, 0, 0);
			TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
			TASK::_TASK_PERFORM_SEQUENCE_2(uParam0->f_20[1 /*14*/], taskSequenceId, 3f, 6f);
			TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
			TASK::TASK_ENTER_VEHICLE(uParam0->f_20[0 /*14*/], uParam0->f_453, -1, 1, 1f, 1, 0);
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[6])
		{
			if (func_73(uParam0, 1.5f, 1116471296, 4, joaat("Action"), false))
			{
				func_71(*uParam0, uParam0->f_483, true);
				uParam0->f_469[6] = 1;
			}
	...
	if (uParam0->f_469[2])
	{
		if (PED::IS_PED_IN_VEHICLE(uParam0->f_20[1 /*14*/], uParam0->f_453, false) && !func_74(uParam0->f_20[0 /*14*/], SCRIPT_TASK_ENTER_VEHICLE))
		{
			TASK::TASK_VEHICLE_DRIVE_WANDER(uParam0->f_20[1 /*14*/], uParam0->f_453, 3f, 524419);
...
int func_32(var uParam0, var uParam1) // Position - 0x2D47 Hash - 0xC22D1364 ^0xC846E7C0
{
	Global_1430231.f_2 = 0;
	func_75(uParam0, false, false, true);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D60 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D7D Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2EB9 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2FF2 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x309C Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3114 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31A3 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x32BE Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x32CA Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3452 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x34F2 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3505 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x351F Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3587 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x35B3 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_48(int iParam0) // Position - 0x35C1 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x36B2 Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_50(var uParam0, char* sParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x3740 Hash - 0x3AAEDE3B ^0x68D4DDC3
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3794 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x3998 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x39AC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x39BB Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_76() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x39D6 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3A35 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3A77 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x3AA3 Hash - 0x5050B938 ^0x5BDC33E5
{
	TASK::TASK_START_SCENARIO_IN_PLACE_HASH(pedParam0, hParam1, iParam2, bParam3, hParam4, iParam5, false);
	return;
}

int func_59(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3ABC Hash - 0x4C6F92F6 ^0x312B6988
{
	return STREAMING::_REQUEST_SCENARIO_TYPE(hParam0, iParam1, iParam2, iParam3);
}

BOOL func_60(Hash hParam0) // Position - 0x3AD0 Hash - 0xF47DA3FB ^0x3523541A
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(hParam0, false);
}

void func_61(int iParam0, BOOL bParam1) // Position - 0x3ADF Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3B5B Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3B7F Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3BA5 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3BC7 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3BE9 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x3C0B Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_68(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C2F Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_103(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_69(var uParam0) // Position - 0x3C89 Hash - 0x2CE3B0A ^0xB76A76EF
{
	int i;
	...
	for (i = 0; i < 6; i = i + 1)
	{
		...
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_20[i /*14*/], false, true);
		
			if (PED::IS_PED_IN_VEHICLE(uParam0->f_20[i /*14*/], uParam0->f_453, false))
				func_104(uParam0, i);
		}
	}
...
void func_70(var uParam0) // Position - 0x3CEF Hash - 0x5F88D024 ^0x5F88D024
{
	if (!uParam0->f_469[7])
	{
		func_105(*uParam0, true);
		uParam0->f_469[7] = 1;
	}
...
void func_71(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3D14 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
	...
	func_106(iParam0);
	func_107(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

BOOL func_72(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E18 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_108(Global_35))
		{
			ped = func_109(Global_35);
		...
		num2 = func_111(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_112(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_113(&(uParam0->f_490)))
							func_114(&(uParam0->f_490));
					
						if (func_115(&(uParam0->f_490), iParam1))
						{
...
BOOL func_73(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4025 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_110(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_112(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_113(&(uParam0->f_490)))
						...
						if (func_120(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_113(&(uParam0->f_490)) && !func_118(&(uParam0->f_490)))
...
BOOL func_74(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x414E Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_75(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x41A7 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_76() // Position - 0x42FB Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_77(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4309 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4370 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4399 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_80(var uParam0, var uParam1, var uParam2) // Position - 0x43E5 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_81(int iParam0) // Position - 0x4434 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_82(int iParam0) // Position - 0x4459 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_83(int iParam0) // Position - 0x446C Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_84(int iParam0) // Position - 0x447F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_85(int iParam0) // Position - 0x4492 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_86(int iParam0) // Position - 0x44A4 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_87(int iParam0, int iParam1) // Position - 0x44B6 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4550 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_89() // Position - 0x4588 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_90(int iParam0) // Position - 0x45DB Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_93(iParam0))
		return -1;
...
BOOL func_91(int iParam0) // Position - 0x45FB Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_92(int iParam0, int iParam1) // Position - 0x4611 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_93(int iParam0) // Position - 0x4620 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_94(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4653 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4734 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_102(iParam0, 4);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4752 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_102(iParam0, 8);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4772 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_102(iParam0, 16);
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x479D Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_102(iParam0, 32);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x47BD Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_102(iParam0, 64);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x47DD Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_102(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x47FF Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_102(iParam0, 1048576);
	else
...
void func_102(int iParam0, int iParam1) // Position - 0x4823 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_103(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4834 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_137(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_139(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_141(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_139(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_143(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_147(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_139(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_147(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_139(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				...
				{
					if (func_151(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_152(iParam2, pedParam0) && func_153(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_139(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_151(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_152(iParam2, pedParam0) && func_153(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_139(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_154(pedParam0, Global_1935630.f_41))
							{
								func_155();
								*uParam3 = 2;
								func_139(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_156(iParam2, pedParam0) || iParam2->f_9 > 0 && func_157() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_158())
					{
						if (func_154(pedParam0, Global_1935630.f_42))
						{
							func_155();
							*uParam3 = 2;
							func_139(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_160(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_139(pedParam0, iParam2, *uParam3);
					return true;
...
void func_104(var uParam0, int iParam1) // Position - 0x4E5D Hash - 0x126B462 ^0x702EA458
{
	int taskSequenceId;

	if (VEHICLE::IS_VEHICLE_SEAT_FREE(uParam0->f_453, -1))
	{
		TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
		TASK::TASK_LEAVE_VEHICLE(0, uParam0->f_453, 4096, 0);
		TASK::TASK_SMART_FLEE_PED(0, Global_35, -1f, -1, 0, 1077936128, 0);
		TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
		TASK::TASK_PERFORM_SEQUENCE(uParam0->f_20[iParam1 /*14*/], taskSequenceId);
		TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
		PED::SET_PED_KEEP_TASK(uParam0->f_20[iParam1 /*14*/], true);
	}
	else
	{
		TASK::TASK_SMART_FLEE_PED(uParam0->f_20[iParam1 /*14*/], Global_35, -1f, -1, 0, 1077936128, 0);
	}

	return;
}

void func_105(int iParam0, BOOL bParam1) // Position - 0x4ED9 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_106(int iParam0) // Position - 0x4FB0 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_107(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5031 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_108(Ped pedParam0) // Position - 0x5122 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_109(Ped pedParam0) // Position - 0x513D Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_110(int iParam0) // Position - 0x5159 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_111(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x51A0 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_112(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x51BE Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_113(var uParam0) // Position - 0x5215 Hash - 0x5001E582 ^0x5001E582
{
	return func_169(*uParam0, 1);
}

void func_114(var uParam0) // Position - 0x5225 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_170(uParam0, 0f);
	return;
}

BOOL func_115(var uParam0, int iParam1) // Position - 0x5234 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x5252 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_117(var uParam0, BOOL bParam1) // Position - 0x5268 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_118(var uParam0) // Position - 0x5288 Hash - 0x39705408 ^0x39705408
{
	return func_169(*uParam0, 2);
}

void func_119(var uParam0) // Position - 0x5298 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_113(uParam0);

	if (func_118(uParam0))
	{
		uParam0->f_1 = func_171() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_172(uParam0, 2);
	}
...
BOOL func_120(var uParam0, float fParam1) // Position - 0x52CC Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_113(uParam0))
		return false;
...
void func_121(var uParam0) // Position - 0x52F3 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_113(uParam0);

	if (!func_118(uParam0))
	{
		uParam0->f_2 = func_171() - uParam0->f_1;
		func_174(uParam0, 2);
	}
...
BOOL func_122(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5323 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_123(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5378 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_124(int iParam0, int iParam1) // Position - 0x538F Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_125(int iParam0, int iParam1) // Position - 0x5415 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_126(int iParam0, int iParam1) // Position - 0x5451 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_127(int iParam0, int iParam1) // Position - 0x54A4 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_128(int iParam0, int iParam1) // Position - 0x54DF Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_129(int iParam0, int iParam1) // Position - 0x5518 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_130(int iParam0) // Position - 0x5550 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_131(BOOL bParam0) // Position - 0x558E Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_132(ePedType eptParam0) // Position - 0x55A1 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_133(Ped pedParam0, Hash hParam1) // Position - 0x59F4 Hash - 0x9F3E77E2 ^0xFD05F6D5
{
...
void func_134(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5A9B Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_135(Ped pedParam0, BOOL bParam1) // Position - 0x5ACB Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_136(Ped pedParam0, int iParam1) // Position - 0x5B10 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_137(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5B37 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_179(iParam2);
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5D02 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_139(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5DD9 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_187(iParam2, 1, 1, 1, 0))
		func_102(iParam1, 2048);
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x5E16 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_141(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5EFD Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x5FD3 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_143(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x60DC Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0x6211 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6248 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x634F Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x63BA Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_148(Ped pedParam0, int iParam1) // Position - 0x6502 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_149(var uParam0, int iParam1) // Position - 0x66DE Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x6756 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_151(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6785 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_152(int iParam0, Ped pedParam1) // Position - 0x690B Hash - 0xA59C9F26 ^0x2D40AA28
{
	int _int;
...
BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x6958 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_206(iParam0))
		return true;
...
BOOL func_154(Ped pedParam0, Ped pedParam1) // Position - 0x69F5 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_155() // Position - 0x6A42 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6A4A Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_157() // Position - 0x6B0B Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_158() // Position - 0x6B29 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6B76 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_160(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6C92 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6CDA Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x6F33 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_216(0))
		return false;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x6F6C Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_164(var uParam0, int iParam1) // Position - 0x6F9B Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x6FAF Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_157() - iParam1->f_4 > func_217(iParam1))
		return func_218(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_166(int iParam0, Ped pedParam1) // Position - 0x6FFC Hash - 0x9FAAC084 ^0x5F9794B1
{
...
void func_167(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x704F Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_168(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x70DB Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0x70F9 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_170(var uParam0, float fParam1) // Position - 0x7108 Hash - 0x30433BAB ^0xF854D531
{
...
float func_171() // Position - 0x712E Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_172(var uParam0, int iParam1) // Position - 0x7160 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_173(var uParam0) // Position - 0x7175 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_113(uParam0))
		return uParam0->f_1;
...
void func_174(var uParam0, int iParam1) // Position - 0x71AA Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x71BB Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_176(Ped pedParam0, Hash hParam1) // Position - 0x71E9 Hash - 0x775758B3 ^0xB9C8ED6
{
	Hash _int;
...
BOOL func_177(Ped pedParam0, Hash hParam1) // Position - 0x7237 Hash - 0x775758B3 ^0xB9C8ED6
{
	Hash _int;
	int _int2;
...
void func_178(Ped pedParam0) // Position - 0x72A5 Hash - 0x2C4EF677 ^0xD83B89E9
{
...
void func_179(int iParam0) // Position - 0x72C1 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_180(int iParam0) // Position - 0x742D Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_181(BOOL bParam0) // Position - 0x7440 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_182(int iParam0) // Position - 0x745A Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_183(int iParam0) // Position - 0x74F4 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_184(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x751B Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_185(Ped pedParam0, Ped pedParam1) // Position - 0x7614 Hash - 0xF9959663 ^0xF9959663
{
	return func_207(pedParam0, pedParam1, true, true);
}

float func_186(int iParam0) // Position - 0x7626 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_187(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7632 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_188(int iParam0, BOOL bParam1) // Position - 0x7697 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_189() // Position - 0x76BD Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_190(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x76D1 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_191(int iParam0) // Position - 0x7831 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_192(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x783D Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_193(int iParam0) // Position - 0x789E Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_194(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x78AA Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x796C Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_196(int iParam0) // Position - 0x7A0A Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_197(int iParam0) // Position - 0x7A16 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_198(int iParam0) // Position - 0x7A22 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_199(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7B5F Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_200(Ped pedParam0) // Position - 0x7BA2 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C08 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_202(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C4F Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_203(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7C9A Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_204(Ped pedParam0, var uParam1) // Position - 0x7D13 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_205(Ped pedParam0, Ped pedParam1) // Position - 0x7D60 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_206(int iParam0) // Position - 0x7DA8 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_207(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7DB8 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_208(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7E00 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_209(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7E2C Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_210(int iParam0) // Position - 0x7E54 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_211(Ped pedParam0) // Position - 0x7E60 Hash - 0x22F16231 ^0xC72D713F
{
...
int func_212(Ped pedParam0) // Position - 0x7EB4 Hash - 0x6B61AEFB ^0x282A94C1
{
...
BOOL func_213(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7F20 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_214(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8091 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_215(int iParam0, Ped pedParam1) // Position - 0x817F Hash - 0x27FC2906 ^0x786D70F1
{
...
BOOL func_216(int iParam0) // Position - 0x81F5 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_233())
		return false;
...
int func_217(int iParam0) // Position - 0x8217 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_218(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8223 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_219(int iParam0) // Position - 0x829E Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_220() // Position - 0x82B1 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_221() // Position - 0x82BF Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_235())
		return false;
...
void func_222(Any* panParam0, int iParam1) // Position - 0x8315 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_223(BOOL bParam0, var uParam1, var uParam2) // Position - 0x83BD Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_224(int iParam0) // Position - 0x8484 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_225(int iParam0) // Position - 0x852C Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_226(Ped pedParam0, int iParam1) // Position - 0x8591 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_227(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x85A8 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_228(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x85D6 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_229(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8620 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_230(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8661 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_231(Ped pedParam0) // Position - 0x86DA Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_232(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x87C2 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_233() // Position - 0x8804 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_220() != -1)
		return false;
...
BOOL func_234(int iParam0, BOOL bParam1) // Position - 0x8829 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_235() // Position - 0x885A Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_236(int iParam0) // Position - 0x888B Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_93(iParam0))
		return -1;
...
int func_237(int iParam0) // Position - 0x88A7 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_238(int iParam0) // Position - 0x88E8 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
