#region Local Var
	...
	var uLocal_24 = 0;
	var uLocal_25 = 0;
	var uLocal_26 = 1097859072;
	var uLocal_27 = 1000;
	var uLocal_28 = 1067450368;
	var uLocal_29 = 5000;
	var uLocal_30 = 42;
	var uLocal_31 = 1103626240;
	var uLocal_32 = 1077936128;
	var uLocal_33 = 1106247680;
	...
	var uLocal_44 = 1065353216;
	var uLocal_45 = 0;
	var uLocal_46 = 0;
	var uLocal_47 = 0;
	var uLocal_48 = 1065353216;
	var uLocal_49 = 1065353216;
	var uLocal_50 = 0;
	var uLocal_51 = 0;
	var uLocal_52 = 0;
...
void main() // Position - 0x0 Hash - 0xBC6FDBA ^0xEF10865C
{
	var unk;
	BOOL flag;
...
void func_1(var uParam0) // Position - 0x57F Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x58D Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x623 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9C9 Hash - 0x4DA9BC8C ^0x9970BCCA
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9E3 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0x9FA Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAB8 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAE2 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC33 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC48 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xCEC Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1A9D Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B03 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBD Hash - 0x1AA0A668 ^0x9590A1DB
{
	if (func_46())
	{
		uParam0->f_499 = 1;
	...
	{
		case 48:
			func_48(uParam0, "AV_MACFARLANE_FARMER", "script@vignette@mcfarlane_farmer_1@ACTION", uParam1, uParam4);
			break;
	}
...
Vector3 func_15(var uParam0) // Position - 0x1C48 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CE8 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E02 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FCB Hash - 0xF3D8E106 ^0xAC358005
{
	if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_47(iLocal_38)))
			uParam0->f_20[0 /*14*/] = func_50(iLocal_38, false, false, true, true, true);
		else
			func_51(iLocal_38, false, 0, 0, 0, false);
...
BOOL func_19(var uParam0) // Position - 0x2015 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21C5 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2239 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2288 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22E0 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2449 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_57(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_25(var uParam0) // Position - 0x2770 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28A7 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29D7 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A16 Hash - 0xF5FDF1BF ^0x5EF603CC
{
	if (!uParam0->f_469[2])
	{
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, "IG_JohnMarston", Global_35, 0);
		TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("world_human_smoke"), uParam0->f_483, uParam0->f_486.f_2, 0, false, true, 0, -1082130432, false);
		uParam0->f_469[2] = 1;
	}

	if (!uParam0->f_469[0])
	{
		if (func_59(uParam0, &uLocal_9, false))
		{
	...
	if (!uParam0->f_469[3] && ENTITY::GET_ENTITY_SPEED(Global_35) < 8f && func_60(uParam0, 1065353216, 25f, 4, 5f, 15f))
	{
...
void func_29(var uParam0) // Position - 0x2B0A Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B3C Hash - 0x67E68B94 ^0x67E68B94
{
	func_64(&uLocal_9, false);
	func_65(&uLocal_9, true);
	func_66(&uLocal_9, true);
	func_67(&uLocal_9, true);
	func_68(&uLocal_9, true);
	func_69(&uLocal_9, true);
	func_70(&uLocal_9, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2B76 Hash - 0x5BF6637D ^0x249A3B74
{
	if (!bLocal_37)
	{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (func_71(Global_35, uParam0->f_20[0 /*14*/], true, true) > 30f)
		{
			TASK::TASK_SMART_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, -1f, -1, 0, 1077936128, 0);
			uParam0->f_469[0] = 1;
			return 1;
	...
	if (uParam0->f_469[3])
	{
		if (!uParam0->f_469[5])
		{
			if (func_72(uParam0, 1f, 45f, 4, joaat("Action"), false))
			{
				func_73(*uParam0, uParam0->f_483, false);
				uParam0->f_469[5] = 1;
			}
		}
	}
	...
	if (uParam0->f_469[3])
	{
		...
		if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, "IG_JohnMarston"))
			bLocal_37 = true;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2CD5 Hash - 0xE93EC89F ^0xE93EC89F
{
	func_75(uParam0);
	func_76(uParam0, true, true, false);

	if (func_77(iLocal_38))
		func_78(iLocal_38, false, true, false, false);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D00 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D1D Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2E59 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2F92 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x303C Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x30B4 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_80(entityForwardVector, unk5);
	...
	if (func_81(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3143 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x325E Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x326A Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	func_91(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x33F2 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3492 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x34A5 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x34BF Hash - 0xEA796703 ^0x695D7925
{
...
BOOL func_46() // Position - 0x3527 Hash - 0x37EC066 ^0xC9B08D38
{
	if (func_92() != -1)
		return false;
...
Ped func_47(int iParam0) // Position - 0x354D Hash - 0xEEC501EA ^0xEEC501EA
{
	if (!func_93(iParam0))
		return 0;
	...
	if (func_96(func_95(iParam0)))
		return func_97(iParam0);

	return PED::_0xE76687023D8C8505(func_98(iParam0), 0);
}

void func_48(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3593 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x35BF Hash - 0x960D7EB7 ^0x57019BBE
{
...
Ped func_50(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x364D Hash - 0x816A3A36 ^0x24211010
{
	Ped ped;
	PersChar persChar;

	if (!func_99(iParam0, true))
		return 0;
	...
	if (bParam4 && !func_77(iParam0) && !ENTITY::IS_ENTITY_DEAD(ped))
	{
...
int func_51(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x370A Hash - 0x4673E62 ^0xCF31A97
{
	var unk;
	Entity entity;
	...
	if (!_IS_NULL_VECTOR(unk))
		PERSCHAR::_0x59C7AD6FEA2AC449(func_100(iParam0), unk);

	if (bParam5)
		entity = PERSCHAR::_0x08FC896D2CB31FCC(func_100(iParam0), false);
	else
		entity = PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_100(iParam0), false);

	if (!_IS_NULL_VECTOR(unk))
		PERSCHAR::_0xBB68908CD11AEBDC(func_100(iParam0));
...
BOOL func_52(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37DB Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	if (iParam0 == 0 && func_110(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_53(int iParam0) // Position - 0x39DF Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_54(int iParam0, int iParam1) // Position - 0x39F3 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_55() // Position - 0x3A02 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_79() != -1;
}

BOOL func_56(var uParam0, Any* panParam1) // Position - 0x3A1D Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_57(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3A7C Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_111(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_58(Ped pedParam0) // Position - 0x3ABE Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
BOOL func_59(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3AEA Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_112(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
BOOL func_60(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, float fParam5) // Position - 0x3B44 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_115(fParam2);
		num2 = func_116(Global_36, uParam0->f_483);
	
		if (num2 < uParam0->f_502)
			uParam0->f_502 = num2;
		else if (num2 - uParam0->f_502 > fParam5)
			return true;
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_117(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_118(&(uParam0->f_490)))
							func_119(&(uParam0->f_490));
					
						if (func_120(&(uParam0->f_490), iParam1))
						{
							func_121(&(uParam0->f_490));
							return true;
						}
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x3D4F Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_62(var uParam0) // Position - 0x3E26 Hash - 0xD35FF7C7 ^0x5FCF74F
{
	func_122(Global_35, uParam0->f_20[0 /*14*/], &uLocal_39, 0f, 0f, 0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1056964608, 1092616192, -1, true, 0, 0, 0, true);
	func_123(uParam0->f_20[0 /*14*/], Global_35, &uLocal_39, -1082130432, 0, 0, -1082130432, -1082130432, true, 8, 0, 0, 1069547520, 1073741824, 1050253722, 1067030938, 0, 0, -1, true, -1082130432, -1082130432, true);
	func_124(&uLocal_77);
	return;
}

void func_63(int iParam0) // Position - 0x3EB2 Hash - 0x78C3C0D2 ^0x51173FE9
{
	if (!func_43(iParam0))
		return;
...
void func_64(int iParam0, BOOL bParam1) // Position - 0x3EE0 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
		func_126(iParam0, true);
		func_127(iParam0, true);
		func_128(iParam0, true);
		func_129(iParam0, true);
		func_130(iParam0, true);
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3F5C Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
		func_9(&(uParam0->f_1), 8);
	else
		func_133(&(uParam0->f_1), 8);

	return;
}

void func_66(var uParam0, BOOL bParam1) // Position - 0x3F80 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x3FA6 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
		func_9(&(uParam0->f_1), 4);
	else
		func_133(&(uParam0->f_1), 4);

	return;
}

void func_68(var uParam0, BOOL bParam1) // Position - 0x3FC8 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
		func_9(&(uParam0->f_1), 2);
	else
		func_133(&(uParam0->f_1), 2);

	return;
}

void func_69(var uParam0, BOOL bParam1) // Position - 0x3FEA Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_70(var uParam0, BOOL bParam1) // Position - 0x400C Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
		func_9(&(uParam0->f_1), 16);
	else
		func_133(&(uParam0->f_1), 16);

	return;
}

float func_71(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4030 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4078 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_117(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_118(&(uParam0->f_490)))
							func_134(&(uParam0->f_490), false);
		...
		if (func_118(&(uParam0->f_490)) && !func_135(&(uParam0->f_490)))
...
void func_73(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x41A1 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_74(var uParam0) // Position - 0x42A5 Hash - 0x51CEFAB6 ^0xCE9DCEA3
{
	func_141(Global_35, uParam0->f_20[0 /*14*/], true, true, true, false, true, true, false, true, true);
	func_142(uParam0->f_20[0 /*14*/], Global_35, true, true, true, false, true, true, false, true, true);
	func_143(&uLocal_77, uParam0->f_20[0 /*14*/]);
	return;
}

void func_75(var uParam0) // Position - 0x42E8 Hash - 0x58838D3 ^0xF2BC2ABB
{
	func_144(&uLocal_77);
	func_145(Global_35, uParam0->f_469[3]);
	func_146(uParam0->f_20[0 /*14*/], true);
	return;
}

void func_76(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4311 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
BOOL func_77(int iParam0) // Position - 0x4465 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_93(iParam0))
		return false;
...
void func_78(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x448A Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!func_94(iParam0, true))
		return;

	if (!func_94(iParam0, 2))
		return;

	if (!bParam4 && !func_77(iParam0) && func_147(iParam0))
		return;
...
int func_79() // Position - 0x4576 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_80(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4584 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x45EB Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_82(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4614 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_151(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_83(var uParam0, var uParam1, var uParam2) // Position - 0x4660 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_151(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_84(int iParam0) // Position - 0x46AF Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_85(int iParam0) // Position - 0x46D4 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_86(int iParam0) // Position - 0x46E7 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_87(int iParam0) // Position - 0x46FA Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_88(int iParam0) // Position - 0x470D Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_89(int iParam0) // Position - 0x471F Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_90(int iParam0, int iParam1) // Position - 0x4731 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x47CB Hash - 0xA65AB937 ^0xA65AB937
{
	func_153(iParam0, iParam6);
	func_154(iParam0, iParam5);
	func_155(iParam0, iParam4);
	func_156(iParam0, iParam3);
	func_157(iParam0, iParam2);
	func_158(iParam0, iParam1);
	return;
}

BOOL func_92() // Position - 0x4803 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_93(int iParam0) // Position - 0x4811 Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

BOOL func_94(int iParam0, BOOL bParam1) // Position - 0x4828 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_92() != -1)
		return false;
...
Hash func_95(int iParam0) // Position - 0x4856 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_93(iParam0))
		return 0;
...
BOOL func_96(Hash hParam0) // Position - 0x4874 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

Ped func_97(int iParam0) // Position - 0x4880 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
Hash func_98(int iParam0) // Position - 0x48AE Hash - 0xED567DFA ^0x7CDFEFC2
{
	if (!func_93(iParam0))
		return 0;
...
BOOL func_99(int iParam0, BOOL bParam1) // Position - 0x48D0 Hash - 0x5C4302E7 ^0x5C4302E7
{
	if (!func_93(iParam0))
		return false;

	if (func_94(iParam0, true) && !func_77(iParam0) && func_147(iParam0))
		return false;
...
PersChar func_100(int iParam0) // Position - 0x4930 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_93(iParam0))
		return 0;
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4950 Hash - 0x61515A20 ^0x61515A20
{
	if (func_92() != -1)
		return;
...
void func_102(int iParam0) // Position - 0x4981 Hash - 0x5A948764 ^0xFC1342AE
{
	if (!func_93(iParam0))
		return;
...
int func_103(int iParam0, BOOL bParam1) // Position - 0x49A4 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_93(iParam0))
		return 0;
	...
	{
		func_159(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_95(iParam0)));
	
		if (func_92() == -1)
		{
			if (func_94(iParam0, 2048))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_100(iParam0));
				func_148(iParam0, 2048);
			}
		
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_100(iParam0));
		}
	
		return 0;
	}

	if (!func_160(iParam0) && func_92() == -1)
		return 0;
	...
	func_159(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_95(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_100(iParam0));
...
BOOL func_104(int iParam0, BOOL bParam1) // Position - 0x4A8F Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_92() != -1)
		return false;
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_97(iParam0)))
		return false;

	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_100(iParam0));
}

BOOL func_105(int iParam0) // Position - 0x4AE7 Hash - 0x365567CB ^0x68796F4
{
	if (!func_93(iParam0))
		return false;
	...
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_100(iParam0)))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_100(iParam0), false)))
			return false;
	}
...
BOOL func_106() // Position - 0x4B2D Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_107(int iParam0) // Position - 0x4B80 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_110(iParam0))
		return -1;
...
BOOL func_108(int iParam0) // Position - 0x4BA0 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_109(int iParam0, int iParam1) // Position - 0x4BB6 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_110(int iParam0) // Position - 0x4BC5 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_111(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4BF8 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
BOOL func_112(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4CD9 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_168(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_170(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_172(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_170(pedParam0, iParam2, *uParam3);
					return true;
...
BOOL func_113(Ped pedParam0) // Position - 0x5302 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_114(Ped pedParam0) // Position - 0x531D Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_115(float fParam0) // Position - 0x5339 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_116(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5380 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_117(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x539E Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_198(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_118(var uParam0) // Position - 0x53F5 Hash - 0x5001E582 ^0x5001E582
{
	return func_199(*uParam0, 1);
}

void func_119(var uParam0) // Position - 0x5405 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_200(uParam0, 0f);
	return;
}

BOOL func_120(var uParam0, int iParam1) // Position - 0x5414 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_121(var uParam0) // Position - 0x5432 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_122(Ped pedParam0, Ped pedParam1, Any* panParam2, float fParam3, float fParam4, float fParam5, const char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15, int iParam16, int iParam17, int iParam18, BOOL bParam19) // Position - 0x5448 Hash - 0x2E4DC4EA ^0x436F8340
{
	int num;
	int num2;
	...
	else if (!func_201(fParam3, 0f, 0f, 0f))
	{
		num2 = 0;
		num2.f_1 = { fParam3 };
		num2.f_7 = iParam16;
	...
	if (bParam19)
		func_202(pedParam0, pedParam1, iParam14);

	return;
}

void func_123(Ped pedParam0, Ped pedParam1, Any* panParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, BOOL bParam19, int iParam20, int iParam21, BOOL bParam22) // Position - 0x551F Hash - 0xD43A93AF ^0x2E43CB6B
{
	int num;
	...
	if (bParam22)
		func_202(pedParam0, pedParam1, iParam18);

	return;
}

void func_124(char* sParam0) // Position - 0x5602 Hash - 0x7B12801F ^0x777B92E0
{
...
BOOL func_125(int iParam0) // Position - 0x5620 Hash - 0xAD1AEF5B ^0x61666D1A
{
...
void func_126(int iParam0, BOOL bParam1) // Position - 0x563B Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_133(iParam0, 4);
	else
...
void func_127(int iParam0, BOOL bParam1) // Position - 0x5659 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_133(iParam0, 8);
	else
...
void func_128(int iParam0, BOOL bParam1) // Position - 0x5679 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_133(iParam0, 16);
...
void func_129(int iParam0, BOOL bParam1) // Position - 0x56A4 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_133(iParam0, 32);
	else
...
void func_130(int iParam0, BOOL bParam1) // Position - 0x56C4 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_133(iParam0, 64);
	else
...
void func_131(int iParam0, BOOL bParam1) // Position - 0x56E4 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_133(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_132(int iParam0, BOOL bParam1) // Position - 0x5706 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_133(iParam0, 1048576);
	else
...
void func_133(int iParam0, int iParam1) // Position - 0x572A Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_134(var uParam0, BOOL bParam1) // Position - 0x573B Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_135(var uParam0) // Position - 0x575B Hash - 0x39705408 ^0x39705408
{
	return func_199(*uParam0, 2);
}

void func_136(var uParam0) // Position - 0x576B Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_118(uParam0);

	if (func_135(uParam0))
	{
		uParam0->f_1 = func_203() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_204(uParam0, 2);
	}
...
BOOL func_137(var uParam0, float fParam1) // Position - 0x579F Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_118(uParam0))
		return false;
...
void func_138(var uParam0) // Position - 0x57C6 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_118(uParam0);

	if (!func_135(uParam0))
	{
		uParam0->f_2 = func_203() - uParam0->f_1;
		func_206(uParam0, 2);
	}
...
void func_139(int iParam0) // Position - 0x57F6 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_207(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_207(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_207(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_140(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5877 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_151(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
void func_141(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x5968 Hash - 0x512642D4 ^0x98AD20B9
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
	...
	if (PED::IS_PED_A_PLAYER(pedParam0))
	{
		...
		func_208(bParam4, bParam5, bParam6, bParam7, bParam3, bParam9, bParam10);
...
void func_142(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x59D2 Hash - 0x512642D4 ^0x98AD20B9
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
	ENTITY::IS_ENTITY_DEAD(pedParam1);
...
void func_143(const char* sParam0, var uParam1) // Position - 0x5A3C Hash - 0x28D21139 ^0x5367531D
{
	var unk;
...
void func_144(const char* sParam0) // Position - 0x5A73 Hash - 0x4275D6A5 ^0xECD450FD
{
...
void func_145(Ped pedParam0, BOOL bParam1) // Position - 0x5A90 Hash - 0xE86A6E05 ^0xDD9C6259
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
...
void func_146(Ped pedParam0, BOOL bParam1) // Position - 0x5ADA Hash - 0xDEFBFF2D ^0x8F3AA87D
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
	PED::_0xAAC0EE3B4999ABB5(pedParam0, 0);
...
BOOL func_147(int iParam0) // Position - 0x5B6A Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_93(iParam0))
		return false;
...
void func_148(int iParam0, BOOL bParam1) // Position - 0x5B8E Hash - 0x452DF11A ^0x452DF11A
{
	if (func_92() != -1)
		return;
...
void func_149(int iParam0) // Position - 0x5BC7 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
int func_150(int iParam0, BOOL bParam1) // Position - 0x5C0B Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_93(iParam0))
		return 0;
...
BOOL func_151(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5C8E Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_152(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5CE3 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_153(int iParam0, int iParam1) // Position - 0x5CFA Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_154(int iParam0, int iParam1) // Position - 0x5D80 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_155(int iParam0, int iParam1) // Position - 0x5DBC Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_156(int iParam0, int iParam1) // Position - 0x5E0F Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_157(int iParam0, int iParam1) // Position - 0x5E4A Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_158(int iParam0, int iParam1) // Position - 0x5E83 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_159(int iParam0, PersChar pchParam1) // Position - 0x5EBB Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_93(iParam0))
		return;
...
BOOL func_160(int iParam0) // Position - 0x5EDC Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_93(iParam0))
		return false;
...
BOOL func_161(int iParam0) // Position - 0x5F02 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_162(BOOL bParam0) // Position - 0x5F40 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_163(ePedType eptParam0) // Position - 0x5F53 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_164(Ped pedParam0, Hash hParam1) // Position - 0x63A6 Hash - 0x2B7DC6DD ^0x319C29E8
{
...
void func_165(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x644D Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_166(Ped pedParam0, BOOL bParam1) // Position - 0x647D Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_167(Ped pedParam0, int iParam1) // Position - 0x64C2 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_168(int iParam0, BOOL bParam1, int iParam2) // Position - 0x64E9 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_213(iParam2);
				...
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						if (PED::IS_PED_PLANTING_BOMB(Global_35))
							func_133(iParam0, 33554432);
					else if (!(*iParam0 & 8192 != 0))
						if (func_215(true))
							func_133(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_215(true) || *iParam0 & 8192 != 0)
...
BOOL func_169(Ped pedParam0, int iParam1) // Position - 0x66B4 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_218(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_219(pedParam0, pedIndexFromEntityIndex) <= func_220(iParam1))
				return true;
			break;
	}
...
void func_170(Ped pedParam0, int iParam1, int iParam2) // Position - 0x678B Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_221(iParam2, 1, 1, 1, 0))
		func_133(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_222(iParam1, true);
	func_223();
	return;
}

BOOL func_171(Ped pedParam0, int iParam1) // Position - 0x67C8 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_224(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_226(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_227(iParam1);
...
BOOL func_172(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x68AF Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_228(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_225(iParam2);
	
		if (func_226(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_227(iParam2))
				{
					func_222(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_173(Ped pedParam0, int iParam1) // Position - 0x6985 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_218(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_227(iParam1))
		{
			customDistance = func_225(iParam1);
...
BOOL func_174(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6A8E Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_229(bParam1, bParam2, bParam3);
...
BOOL func_175(int iParam0, int iParam1) // Position - 0x6BC3 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_176(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6BFA Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_177(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6D01 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_231(iParam2))
	{
...
BOOL func_178(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6D6C Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_233(pedParam1, entityCoords, outCoords))
					{
						func_222(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_233(pedParam1, entityCoords, outCoords2))
					{
						func_222(iParam2, true);
						return true;
					}
...
BOOL func_179(Ped pedParam0, int iParam1) // Position - 0x6EB4 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_218(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_234(Global_1935630.f_34[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false), entityCoords);
		
			if (func_58(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
			...
			if (func_235(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_236(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_237(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_180(var uParam0, int iParam1) // Position - 0x7090 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_181(int iParam0, int iParam1) // Position - 0x7108 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_182(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7137 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_183(int iParam0, Ped pedParam1) // Position - 0x72BD Hash - 0x2CFF9A36 ^0x397C6E8B
{
	int _int;
...
BOOL func_184(int iParam0, Ped pedParam1) // Position - 0x730A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_240(iParam0))
		return true;
...
BOOL func_185(Ped pedParam0, Ped pedParam1) // Position - 0x73A7 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_71(pedParam0, pedParam1, true, true) < 4f)
...
void func_186() // Position - 0x73F4 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_187(int iParam0, Ped pedParam1) // Position - 0x73FC Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_241(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_242(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_188() // Position - 0x74BD Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_189() // Position - 0x74DB Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_190(int iParam0, Ped pedParam1) // Position - 0x7528 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_243(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_244(pedParam1);
	num2 = func_245(iParam0->f_14);
...
BOOL func_191(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x7644 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_246(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_192(Ped pedParam0, int iParam1) // Position - 0x768C Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_247(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_248(iParam1, pedParam0))
						if (func_242(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_193(Ped pedParam0, int iParam1) // Position - 0x78E5 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_249(0))
		return false;
...
BOOL func_194(int iParam0, int iParam1) // Position - 0x791E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_195(var uParam0, int iParam1) // Position - 0x794D Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_196(Ped pedParam0, int iParam1) // Position - 0x7961 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_188() - iParam1->f_4 > func_250(iParam1))
		return func_251(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_197(int iParam0, Ped pedParam1) // Position - 0x79AE Hash - 0xCD68754E ^0x631072AC
{
...
float func_198(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7A01 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_199(int iParam0, int iParam1) // Position - 0x7A1F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_200(var uParam0, float fParam1) // Position - 0x7A2E Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_203() - fParam1;
	func_206(uParam0, 1);
	func_204(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
BOOL func_201(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7A54 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_202(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x7A7D Hash - 0xF6D5211C ^0xAA9A46C4
{
	ENTITY::IS_ENTITY_DEAD(pedParam0);
...
float func_203() // Position - 0x7AB7 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_204(var uParam0, int iParam1) // Position - 0x7AE9 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_205(var uParam0) // Position - 0x7AFE Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_118(uParam0))
		return uParam0->f_1;
	...
	return func_203() - uParam0->f_1;
}

void func_206(var uParam0, int iParam1) // Position - 0x7B33 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_207(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7B44 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
void func_208(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7BD0 Hash - 0x25DC51B ^0x2C9FE3CE
{
	if (bParam5)
...
BOOL func_209(Ped pedParam0, Hash hParam1) // Position - 0x7D06 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_210(Ped pedParam0, Hash hParam1) // Position - 0x7D34 Hash - 0x7C7F925F ^0x789823AB
{
	Hash _int;
...
BOOL func_211(Ped pedParam0, Hash hParam1) // Position - 0x7D84 Hash - 0x7C7F925F ^0x789823AB
{
	Hash _int;
	int _int2;
...
void func_212(Ped pedParam0) // Position - 0x7DF4 Hash - 0x956BF55 ^0xE12A3631
{
...
void func_213(int iParam0) // Position - 0x7E11 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_255(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_214(int iParam0) // Position - 0x7F7D Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_215(BOOL bParam0) // Position - 0x7F90 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_256(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_216(int iParam0) // Position - 0x7FAA Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_217(int iParam0) // Position - 0x8046 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_218(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x806D Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_245(pedParam2);
	else
		num2 = func_244(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_245(pedParam0);
	else
		num = func_244(pedParam0);

	if (num2 == num)
		if (num2 != -1)
			return true;

	if (func_54(*iParam1, 8388608))
		return true;
...
float func_219(Ped pedParam0, Ped pedParam1) // Position - 0x8166 Hash - 0xF9959663 ^0xF9959663
{
	return func_71(pedParam0, pedParam1, true, true);
}

float func_220(int iParam0) // Position - 0x8178 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_221(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8184 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_222(int iParam0, BOOL bParam1) // Position - 0x81E9 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_133(iParam0, 134217728);
	else
...
void func_223() // Position - 0x820F Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_224(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x8223 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_71(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_259(ped, 0)))
			if (func_260(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_225(int iParam0) // Position - 0x8383 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_226(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x838F Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_227(int iParam0) // Position - 0x83F0 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_228(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x83FC Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_259(ped, 0)))
			if (func_261(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_229(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x84BE Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_230(int iParam0) // Position - 0x855C Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_231(int iParam0) // Position - 0x8568 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_232(int iParam0) // Position - 0x8574 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_233(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x86B1 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_262(pedParam0, vParam4, 0.5f))
...
BOOL func_234(Ped pedParam0) // Position - 0x86F4 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_263(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_235(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x875A Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_236(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x87A1 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_237(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x87EC Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_238(Ped pedParam0, var uParam1) // Position - 0x8865 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_239(Ped pedParam0, Ped pedParam1) // Position - 0x88B2 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_265(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_240(int iParam0) // Position - 0x88FA Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

BOOL func_241(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x890A Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_242(veParam0, uParam2, true);
...
float func_242(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8936 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_243(int iParam0) // Position - 0x895E Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_244(Ped pedParam0) // Position - 0x896A Hash - 0xFFEED300 ^0x55020158
{
...
int func_245(Ped pedParam0) // Position - 0x89BE Hash - 0xE6B6B757 ^0x65AFDC4B
{
...
BOOL func_246(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8A2A Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_71(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_71(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_247(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8B9A Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_256(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_248(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_248(iParam1, ped2))
					if (func_242(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_248(int iParam0, Ped pedParam1) // Position - 0x8C88 Hash - 0x27FC2906 ^0xD5409D11
{
...
BOOL func_249(int iParam0) // Position - 0x8CFE Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_266())
		return false;

	return func_267(Global_1347702[58 /*49*/].f_15, true);
}

int func_250(int iParam0) // Position - 0x8D20 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_251(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8D2C Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_252(int iParam0) // Position - 0x8DA7 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

void func_253(BOOL bParam0) // Position - 0x8DBA Hash - 0x67777C1C ^0xA5A55B03
{
	if (bParam0)
		func_268(4);
...
BOOL func_254() // Position - 0x8DDC Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_269())
		return false;
...
void func_255(Any* panParam0, int iParam1) // Position - 0x8E32 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_256(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8EDA Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_257(int iParam0) // Position - 0x8FA1 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_258(int iParam0) // Position - 0x9049 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_259(Ped pedParam0, int iParam1) // Position - 0x90AE Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_260(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x90C5 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_261(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_261(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x90F3 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_262(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x913D Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_263(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x917E Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_264(Ped pedParam0) // Position - 0x91F7 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_265(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x92DF Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_266() // Position - 0x9321 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_92() != -1)
		return false;
...
BOOL func_267(int iParam0, BOOL bParam1) // Position - 0x9346 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_268(int iParam0) // Position - 0x9377 Hash - 0x3A524DDA ^0x3A524DDA
{
	Global_1900383.f_316 = Global_1900383.f_316 || iParam0;
	return;
}

BOOL func_269() // Position - 0x9390 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_270(int iParam0) // Position - 0x93C1 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_110(iParam0))
		return -1;
...
int func_271(int iParam0) // Position - 0x93DD Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_272(int iParam0) // Position - 0x941E Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
