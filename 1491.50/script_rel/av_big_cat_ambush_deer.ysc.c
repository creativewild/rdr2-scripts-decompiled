...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0xDB4F1059
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0xDB633E76
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x3490DACE ^0x99F919C
{
	func_46(uParam0, "BIG_CAT_AMBUSH_DEER", "script@ambient@animal@BIG_CAT_AMBUSH_DEER@action", uParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "COUGAR", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "DEER", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	fLocal_61 = MISC::GET_RANDOM_FLOAT_IN_RANGE(10f, 20f);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C39 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CD9 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DF3 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FBC Hash - 0x6C3DF270 ^0x86A3F3E9
{
...
BOOL func_19(var uParam0) // Position - 0x1FD7 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2187 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21FB Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x224A Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22A2 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x240B Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2732 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2869 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2999 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29D8 Hash - 0xCB80CB04 ^0xEC5D7EDF
{
	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[1 /*14*/]);

	if (!PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[1 /*14*/]))
		return false;

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		func_56(&uParam0->f_20[0 /*14*/], true, true);

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		func_56(&uParam0->f_20[1 /*14*/], true, true);
...
void func_29(var uParam0) // Position - 0x2A4F Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A81 Hash - 0x61F01D8 ^0xC1500E74
{
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("world_animal_big_cat_eating"), 1, 0, 0);
	func_57(&uLocal_23, false);
	func_58(&uLocal_23, true);
	func_59(&uLocal_23, true);
	func_60(&uLocal_23, true);
	func_61(&uLocal_23, true);
	func_62(&uLocal_23, true);
	func_63(&uLocal_23, true);
	func_64(&uLocal_23, 85);
	return 1;
}

int func_31(var uParam0) // Position - 0x2AD0 Hash - 0x97C84207 ^0x7B03088B
{
	var unk;

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
		TASK::_0x2E1D6D87346BB7D2(uParam0->f_20[1 /*14*/], Global_35, 0, 1);
	...
	{
		if (!bLocal_51 == true)
			if (func_65(uParam0, &uLocal_23, true) || func_66(Global_35, uParam0->f_20[0 /*14*/], true) <= 400f || func_66(Global_35, uParam0->f_20[1 /*14*/], true) <= 400f)
				bLocal_51 = true;
		...
		if (bLocal_51)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (!uParam0->f_469[5])
				{
					func_70(*uParam0, uParam0->f_483, true);
					uParam0->f_469[5] = 1;
				}
	...
	if (uParam0->f_469[0])
		if (func_72(&uLocal_55, 15f))
			return 1;

	func_73(uParam0);

	if (!uParam0->f_469[0] && !bLocal_51)
	{
		if (!uParam0->f_469[1])
		{
			if (!ENTITY::IS_ENTITY_DEAD(Global_35) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (func_74(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1, &uLocal_11, true, "pbl_action", 2))
									func_75(&(uLocal_11.f_6), 50, 10, false);
					...
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
							{
								...
								unk = 1;
								unk[0] = Global_35;
								PED::_0x34EDDD59364AD74A(uParam0->f_20[0 /*14*/], &unk);
								PED::SET_PED_SHOULD_PLAY_NORMAL_SCENARIO_EXIT(uParam0->f_20[0 /*14*/]);
								TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("world_animal_big_cat_eating"), uLocal_11.f_6, uLocal_11.f_9.f_2, 0, false, true, 0, -1082130432, false);
								PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam0->f_20[0 /*14*/], false, false);
								uParam0->f_469[3] = 1;
								func_77(&uLocal_58, false);
							}
						}
					}
				}
			}
			else if (!uParam0->f_469[4])
			{
				if (func_67(&uLocal_58) && func_78(&uLocal_58) > fLocal_61)
				{
					if (PED::IS_PED_USING_SCENARIO_HASH(uParam0->f_20[0 /*14*/], joaat("world_animal_big_cat_eating")))
					{
						if (!TASK::IS_PED_EXITING_SCENARIO(uParam0->f_20[0 /*14*/], false) && !func_79(&uLocal_58))
						{
							TASK::TASK_SMART_FLEE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 25f, -1, 0, 1f, 0);
...
int func_32(var uParam0, var uParam1) // Position - 0x2ED7 Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_81(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2EE9 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F06 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3042 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x317B Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3225 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x329D Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_83(entityForwardVector, unk5);
	...
	if (func_84(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x332C Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3447 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3453 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	func_94(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35DB Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x367B Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x368E Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x36A8 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3710 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x373C Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x376D Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37FB Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x39FF Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3A13 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3A22 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_82() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3A3D Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3A9C Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_100(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_55(Ped pedParam0) // Position - 0x3ADE Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B0A Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x3B32 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
		func_62(iParam0, true);
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3BAE Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3BD4 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3BF6 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3C18 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_62(int iParam0, BOOL bParam1) // Position - 0x3C3A Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_107(iParam0, 4);
	else
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3C58 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_64(var uParam0, int iParam1) // Position - 0x3C7C Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_65(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C8A Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_108(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
float func_66(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3CE4 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_109(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_67(var uParam0) // Position - 0x3D3B Hash - 0x5001E582 ^0x5001E582
{
	return func_110(*uParam0, 1);
}

void func_68(var uParam0) // Position - 0x3D4B Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_111(uParam0, 0f);
	return;
}

void func_69(var uParam0) // Position - 0x3D5A Hash - 0x9E21C5F4 ^0x9E21C5F4
{
	if (!uParam0->f_469[6])
	{
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3D7F Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_71(var uParam0) // Position - 0x3E83 Hash - 0x3F06B0E0 ^0xEAFB6906
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], 830334344))
		{
			...
			func_115(uParam0->f_20[1 /*14*/], false, false);
		}
		else if (!func_116(uParam0->f_20[1 /*14*/], 518218985))
		{
			if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], -344192410))
			{
				if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!func_116(uParam0->f_20[0 /*14*/], 1287254818))
		{
			PED::SET_PED_SHOULD_PLAY_COMBAT_SCENARIO_EXIT(uParam0->f_20[0 /*14*/], Global_36, 0);
		
			if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 8631722))
				if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
					PED::SET_PED_TO_RAGDOLL(uParam0->f_20[0 /*14*/], 250, 250, 0, false, false, 0);
		
			if (func_66(uParam0->f_20[0 /*14*/], Global_35, true) < 900f)
				TASK::TASK_COMBAT_PED(uParam0->f_20[0 /*14*/], Global_35, 0, 0);
			else
				TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 2, 256, -1082130432, -1, 0);
...
BOOL func_72(var uParam0, float fParam1) // Position - 0x4013 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_67(uParam0))
		return false;
...
void func_73(var uParam0) // Position - 0x403A Hash - 0x8925AFFC ^0xFA85CDD8
{
	if (!bLocal_53)
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 8631722))
		{
			PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 138, true);
			bLocal_53 = true;
		}
	}
	else if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 8631722))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 138, false);
		bLocal_53 = false;
	}
	...
	if (!bLocal_54)
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], -344192410))
		{
			PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 138, true);
			bLocal_54 = true;
		}
	}
	else if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], -344192410))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 138, false);
		bLocal_54 = false;
	}
...
BOOL func_74(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x40E4 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_117(Global_35))
		{
			ped = func_118(Global_35);
		...
		num = num * num;
		fParam2 = func_119(fParam2);
		num2 = func_120(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_66(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_67(&(uParam0->f_490)))
							func_68(&(uParam0->f_490));
					
						if (func_121(&(uParam0->f_490), fParam1))
						{
...
int func_75(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x42EF Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
BOOL func_76(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x43E6 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_66(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_67(&(uParam0->f_490)))
							func_77(&(uParam0->f_490), false);
					
						if (func_79(&(uParam0->f_490)))
							func_124(&(uParam0->f_490));
					
						if (func_72(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_67(&(uParam0->f_490)) && !func_79(&(uParam0->f_490)))
			func_80(&(uParam0->f_490));
	}

	return false;
}

void func_77(var uParam0, BOOL bParam1) // Position - 0x450F Hash - 0xA95D0C2 ^0xA95D0C2
{
	if (bParam1 || !func_67(uParam0))
		func_68(uParam0);

	return;
}

float func_78(var uParam0) // Position - 0x452F Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_67(uParam0))
		return uParam0->f_1;
...
BOOL func_79(var uParam0) // Position - 0x4564 Hash - 0x39705408 ^0x39705408
{
	return func_110(*uParam0, 2);
}

void func_80(var uParam0) // Position - 0x4574 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_67(uParam0);

	if (!func_79(uParam0))
	{
		uParam0->f_2 = func_125() - uParam0->f_1;
		func_126(uParam0, 2);
	}
...
void func_81(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x45A4 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_82() // Position - 0x46F8 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_83(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4706 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_84(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x476D Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_85(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4796 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_127(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_86(var uParam0, var uParam1, var uParam2) // Position - 0x47E2 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_127(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_87(int iParam0) // Position - 0x4831 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_88(int iParam0) // Position - 0x4856 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_89(int iParam0) // Position - 0x4869 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_90(int iParam0) // Position - 0x487C Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_91(int iParam0) // Position - 0x488F Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_92(int iParam0) // Position - 0x48A1 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_93(int iParam0, int iParam1) // Position - 0x48B3 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x494D Hash - 0xA65AB937 ^0xA65AB937
{
	func_129(iParam0, iParam6);
	func_130(iParam0, iParam5);
	func_131(iParam0, iParam4);
	func_132(iParam0, iParam3);
	func_133(iParam0, iParam2);
	func_134(iParam0, iParam1);
	return;
}

BOOL func_95() // Position - 0x4985 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_96(int iParam0) // Position - 0x49D8 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_99(iParam0))
		return -1;

	return func_136(func_135(iParam0));
}

BOOL func_97(int iParam0) // Position - 0x49F8 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_98(int iParam0, int iParam1) // Position - 0x4A0E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_99(int iParam0) // Position - 0x4A1D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_100(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4A50 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4B31 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_107(iParam0, 8);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4B51 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_107(iParam0, 16);
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4B7C Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_107(iParam0, 32);
	else
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x4B9C Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_107(iParam0, 64);
	else
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x4BBC Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_107(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x4BDE Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_107(iParam0, 1048576);
	else
...
void func_107(int iParam0, int iParam1) // Position - 0x4C02 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_108(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4C13 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_142(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_144(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_146(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_144(pedParam0, iParam2, *uParam3);
					return true;
		...
		{
			if (func_149(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_150(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_144(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_151(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_144(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_152(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_144(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_152(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_144(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				...
				{
					if (func_156(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_157(iParam2, pedParam0) && func_158(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_144(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_156(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_157(iParam2, pedParam0) && func_158(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_144(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_159(pedParam0, Global_1935630.f_41))
							{
								func_160();
								*uParam3 = 2;
								func_144(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_161(iParam2, pedParam0) || iParam2->f_9 > 0 && func_162() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_163())
					{
						if (func_159(pedParam0, Global_1935630.f_42))
						{
							func_160();
							*uParam3 = 2;
							func_144(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_165(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_144(pedParam0, iParam2, *uParam3);
					return true;
...
float func_109(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x523C Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_110(int iParam0, int iParam1) // Position - 0x525A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_111(var uParam0, float fParam1) // Position - 0x5269 Hash - 0x30433BAB ^0xF854D531
{
...
void func_112(int iParam0, BOOL bParam1) // Position - 0x528F Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_113(int iParam0) // Position - 0x5366 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_114(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x53E7 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_127(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
void func_115(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x54D8 Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
BOOL func_116(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x5514 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
BOOL func_117(Ped pedParam0) // Position - 0x556D Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_118(Ped pedParam0) // Position - 0x5588 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_119(float fParam0) // Position - 0x55A4 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_120(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x55EB Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_121(var uParam0, float fParam1) // Position - 0x5609 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_122(var uParam0) // Position - 0x5627 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_123(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x563D Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_124(var uParam0) // Position - 0x5666 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_67(uParam0);

	if (func_79(uParam0))
	{
		uParam0->f_1 = func_125() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_172(uParam0, 2);
	}
...
float func_125() // Position - 0x569A Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_126(var uParam0, int iParam1) // Position - 0x56CC Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_127(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x56DD Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_128(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5732 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_129(int iParam0, int iParam1) // Position - 0x5749 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_130(int iParam0, int iParam1) // Position - 0x57CF Hash - 0x96B01D2A ^0x81E68218
{
...
void func_131(int iParam0, int iParam1) // Position - 0x580B Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_132(int iParam0, int iParam1) // Position - 0x585E Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_133(int iParam0, int iParam1) // Position - 0x5899 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_134(int iParam0, int iParam1) // Position - 0x58D2 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_135(int iParam0) // Position - 0x590A Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_136(BOOL bParam0) // Position - 0x5948 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_137(ePedType eptParam0) // Position - 0x595B Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_138(Ped pedParam0, Hash hParam1) // Position - 0x5DAE Hash - 0xC94DBC60 ^0x4A2C8887
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_139(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5E55 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_140(Ped pedParam0, BOOL bParam1) // Position - 0x5E85 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_141(Ped pedParam0, int iParam1) // Position - 0x5ECA Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_142(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5EF1 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_178(iParam2);
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_181(iParam0))
				iParam0->f_15 = func_162();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_162() - iParam0->f_15 > 500)
			{
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x60BC Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_144(Ped pedParam0, int iParam1, int iParam2) // Position - 0x6193 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_186(iParam2, 1, 1, 1, 0))
		func_107(iParam1, 2048);
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x61D0 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_146(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x62B7 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_147(Ped pedParam0, int iParam1) // Position - 0x638D Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_148(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6496 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x65CB Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_150(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6602 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_151(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6709 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_152(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6774 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_153(Ped pedParam0, int iParam1) // Position - 0x68BC Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_154(var uParam0, int iParam1) // Position - 0x6A98 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_155(int iParam0, int iParam1) // Position - 0x6B10 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_156(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6B3F Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_157(int iParam0, Ped pedParam1) // Position - 0x6CC5 Hash - 0x8ADFD1FB ^0x523DD3D1
{
	int _int;
...
BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6D12 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_205(iParam0))
		return true;
...
BOOL func_159(Ped pedParam0, Ped pedParam1) // Position - 0x6DAF Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_160() // Position - 0x6DFC Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_161(int iParam0, Ped pedParam1) // Position - 0x6E04 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_162() // Position - 0x6EC5 Hash - 0xE698BCC8 ^0x3E64CD04
{
	int networkTimeAccurate;
...
BOOL func_163() // Position - 0x6EE3 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_162() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_164(int iParam0, Ped pedParam1) // Position - 0x6F30 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_165(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x704C Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_166(Ped pedParam0, int iParam1) // Position - 0x7094 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_167(Ped pedParam0, int iParam1) // Position - 0x72ED Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_215(0))
		return false;
...
BOOL func_168(int iParam0, int iParam1) // Position - 0x7326 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_169(var uParam0, int iParam1) // Position - 0x7355 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_170(Ped pedParam0, int iParam1) // Position - 0x7369 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_162();
	else if (func_162() - iParam1->f_4 > func_216(iParam1))
		return func_217(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_171(int iParam0, Ped pedParam1) // Position - 0x73B6 Hash - 0x6912DD03 ^0xDD5E3737
{
...
void func_172(var uParam0, int iParam1) // Position - 0x7409 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_173(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x741E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x74AA Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x74D8 Hash - 0x87F44CAC ^0x41B28447
{
	Hash _int;
...
BOOL func_176(Ped pedParam0, Hash hParam1) // Position - 0x7526 Hash - 0x87F44CAC ^0x41B28447
{
	Hash _int;
	int _int2;
...
void func_177(Ped pedParam0) // Position - 0x7594 Hash - 0x21D59AB6 ^0x5C3DFA36
{
...
void func_178(int iParam0) // Position - 0x75B0 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_179(int iParam0) // Position - 0x771C Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_180(BOOL bParam0) // Position - 0x772F Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_181(int iParam0) // Position - 0x7749 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_182(int iParam0) // Position - 0x77E1 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_183(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7808 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_184(Ped pedParam0, Ped pedParam1) // Position - 0x7901 Hash - 0xF9959663 ^0xF9959663
{
	return func_206(pedParam0, pedParam1, true, true);
}

float func_185(int iParam0) // Position - 0x7913 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_186(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x791F Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_187(int iParam0, BOOL bParam1) // Position - 0x7984 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_107(iParam0, 134217728);
	else
...
void func_188() // Position - 0x79AA Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_189(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x79BE Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_190(int iParam0) // Position - 0x7B1E Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_191(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7B2A Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_192(int iParam0) // Position - 0x7B8B Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_193(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7B97 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_194(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7C59 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_195(int iParam0) // Position - 0x7CF7 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_196(int iParam0) // Position - 0x7D03 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_197(int iParam0) // Position - 0x7D0F Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7E4C Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_199(Ped pedParam0) // Position - 0x7E8F Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7EF5 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F3C Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_202(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7F87 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_203(Ped pedParam0, var uParam1) // Position - 0x8000 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_204(Ped pedParam0, Ped pedParam1) // Position - 0x804D Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_205(int iParam0) // Position - 0x8095 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_206(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x80A5 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_207(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x80ED Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_208(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8119 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_209(int iParam0) // Position - 0x8141 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_210(Ped pedParam0) // Position - 0x814D Hash - 0xEC5EEC58 ^0x448F7193
{
...
int func_211(Ped pedParam0) // Position - 0x81A1 Hash - 0x88C65627 ^0xAC3AF55D
{
...
BOOL func_212(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x820B Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x837B Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_214(int iParam0, Ped pedParam1) // Position - 0x8469 Hash - 0x27FC2906 ^0xCE9D2300
{
...
BOOL func_215(int iParam0) // Position - 0x84DF Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_232())
		return false;
...
int func_216(int iParam0) // Position - 0x8501 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_217(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x850D Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_218(int iParam0) // Position - 0x8588 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_219() // Position - 0x859B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_220() // Position - 0x85A9 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_234())
		return false;
...
void func_221(Any* panParam0, int iParam1) // Position - 0x85FF Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_222(BOOL bParam0, var uParam1, var uParam2) // Position - 0x86A7 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_223(int iParam0) // Position - 0x876E Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_224(int iParam0) // Position - 0x8816 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_225(Ped pedParam0, int iParam1) // Position - 0x887B Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_226(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8892 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_227(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x88C0 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_228(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x890A Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_229(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x894B Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_230(Ped pedParam0) // Position - 0x89C4 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_231(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8AAC Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_232() // Position - 0x8AEE Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_219() != -1)
		return false;
...
BOOL func_233(int iParam0, BOOL bParam1) // Position - 0x8B13 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_234() // Position - 0x8B44 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_235(int iParam0) // Position - 0x8B75 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_99(iParam0))
		return -1;
...
int func_236(int iParam0) // Position - 0x8B91 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_237(int iParam0) // Position - 0x8BD2 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
