...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0xB9509642
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0xEC1CF94 ^0x7FF6083A
{
	Hash hash;
	Hash hash2;

	func_46(uParam0, "RIDER_GALLOP", "", uParam1, uParam4);
	hash = func_48(func_47(), true, true, true, true, false, true);
	hash2 = func_49(joaat("horse_class_riding"), true);
	func_50(uParam0, 0, "RGP_HORSE", hash2, uParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "RGP_MAN", hash, uParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C2C Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CCC Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DE6 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FAF Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FB8 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2168 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21DC Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x222B Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2283 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23EC Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2713 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x284A Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x297A Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29B9 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29C2 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x29F4 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

int func_31(var uParam0) // Position - 0x29FD Hash - 0x33F20EE1 ^0xA85CC355
{
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_58(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
				...
				func_60(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], true, -1, true);
		...
		case 1:
			if (func_62(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					TASK::_0x673A8779D229BA5A(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, 0, 0);
				
					if (uParam0->f_489 == 1)
						TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[1 /*14*/], 0.55f, 128, 0);
					else
						TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[1 /*14*/], 2.5f, 256, 0);
				
					PED::SET_PED_KEEP_TASK(uParam0->f_20[1 /*14*/], true);
				}
			
				func_63(*uParam0, true);
				func_64(*uParam0, uParam0->f_483, true);
				func_65(&uLocal_10);
				iLocal_9 = 2;
			}
			break;
...
int func_32(var uParam0, var uParam1) // Position - 0x2B8B Hash - 0x3105A36D ^0x3105A36D
{
	func_67(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B9D Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2BBA Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2CF6 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2E2F Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2ED9 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x2F51 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_69(entityForwardVector, unk5);
	...
	if (func_70(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x2FE0 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x30FB Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3107 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	for (m = func_79(i, num); num2 > m; m = func_79(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_80(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x328F Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x332F Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3342 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x335C Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x33C4 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x33F0 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x33FE Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
Hash func_49(int iParam0, BOOL bParam1) // Position - 0x35F0 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_50(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x36AA Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3738 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_82(Global_1898164.f_1[0 /*5*/]);
	
		if (func_83(num) && func_84(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_52(int iParam0) // Position - 0x393C Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3950 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x395F Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_68() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x397A Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x39D9 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Entity eParam0) // Position - 0x3A1B Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
int func_58(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3A47 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_59(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3B3E Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_88(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_89(pedParam0))
		if (func_90(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
			PHYSICS::_UNHITCH_HORSE(pedParam0);

	if (func_91(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0);
	...
	if (func_91(iParam5, 2))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(pedParam0))
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_91(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_91(iParam5, 32), true);
	...
	else if (func_91(iParam5, 129))
	{
		if (func_91(iParam5, 128))
			if (WATER::GET_WATER_HEIGHT_NO_WAVES(vParam1, &height))
				vParam1.f_2 = height;
	
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, vParam1, func_91(iParam5, 32), true, true);
	...
	if (isEntityAPed)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0) == Global_35 && !func_91(iParam5, 64))
		{
...
int func_60(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x3DC0 Hash - 0x32B863AB ^0xCE62541D
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
void func_61(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3E05 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_62(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E2D Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_94(fParam2);
		num2 = func_95(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_96(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_97(&(uParam0->f_490)))
							func_65(&(uParam0->f_490));
					
						if (func_98(&(uParam0->f_490), fParam1))
						{
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x403A Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_64(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4111 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_65(var uParam0) // Position - 0x4215 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_102(uParam0, 0f);
	return;
}

BOOL func_66(var uParam0, float fParam1) // Position - 0x4224 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_97(uParam0))
		return false;
...
void func_67(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x424B Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_68() // Position - 0x439F Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_69(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x43AD Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_70(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4414 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_71(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x443D Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_104(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_72(var uParam0, var uParam1, var uParam2) // Position - 0x4489 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_104(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_73(int iParam0) // Position - 0x44D8 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_74(int iParam0) // Position - 0x44FD Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_75(int iParam0) // Position - 0x4510 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_76(int iParam0) // Position - 0x4523 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_77(int iParam0) // Position - 0x4536 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_78(int iParam0) // Position - 0x4548 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_79(int iParam0, int iParam1) // Position - 0x455A Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x45F4 Hash - 0xA65AB937 ^0xA65AB937
{
	func_106(iParam0, iParam6);
	func_107(iParam0, iParam5);
	func_108(iParam0, iParam4);
	func_109(iParam0, iParam3);
	func_110(iParam0, iParam2);
	func_111(iParam0, iParam1);
	return;
}

BOOL func_81() // Position - 0x462C Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_82(int iParam0) // Position - 0x467F Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_85(iParam0))
		return -1;

	return func_113(func_112(iParam0));
}

BOOL func_83(int iParam0) // Position - 0x469F Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_84(int iParam0, int iParam1) // Position - 0x46B5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_85(int iParam0) // Position - 0x46C4 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_86(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x46F7 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_114(eptParam1))
		{
			func_115(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_117(pedParam0, false);
			flag = true;
		}
	
		func_118(pedParam0, iParam2);
	}
...
BOOL func_87(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x47D8 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Ped func_88(Ped pedParam0) // Position - 0x4801 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_89(Ped pedParam0) // Position - 0x480B Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_90(Ped pedParam0) // Position - 0x483D Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_91(int iParam0, int iParam1) // Position - 0x487F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(Ped pedParam0) // Position - 0x488E Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_93(Ped pedParam0) // Position - 0x48A9 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_94(float fParam0) // Position - 0x48C5 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_95(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x490C Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_96(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x492A Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_97(var uParam0) // Position - 0x4981 Hash - 0x5001E582 ^0x5001E582
{
	return func_120(*uParam0, 1);
}

BOOL func_98(var uParam0, float fParam1) // Position - 0x4991 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_99(var uParam0) // Position - 0x49AF Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_100(int iParam0) // Position - 0x49C5 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_121(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_121(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_121(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_101(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4A46 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_104(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
void func_102(var uParam0, float fParam1) // Position - 0x4B37 Hash - 0x30433BAB ^0xF854D531
{
...
float func_103(var uParam0) // Position - 0x4B5D Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_97(uParam0))
		return uParam0->f_1;
...
BOOL func_104(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x4B92 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_105(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4BE7 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_106(int iParam0, int iParam1) // Position - 0x4BFE Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_107(int iParam0, int iParam1) // Position - 0x4C84 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_108(int iParam0, int iParam1) // Position - 0x4CC0 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_79(num, num2))
		return;
...
void func_109(int iParam0, int iParam1) // Position - 0x4D13 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_110(int iParam0, int iParam1) // Position - 0x4D4E Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_111(int iParam0, int iParam1) // Position - 0x4D87 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_112(int iParam0) // Position - 0x4DBF Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_113(BOOL bParam0) // Position - 0x4DFD Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_114(ePedType eptParam0) // Position - 0x4E10 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_115(Ped pedParam0, Hash hParam1) // Position - 0x5263 Hash - 0x73475E86 ^0x8900AC4D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_126(pedParam0, hParam1))
		{
			if (func_127(pedParam0, hParam1))
			{
				if (func_128(pedParam0, hParam1))
				{
...
void func_116(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x530A Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_117(Ped pedParam0, BOOL bParam1) // Position - 0x533A Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_118(Ped pedParam0, int iParam1) // Position - 0x537F Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
float func_119(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x53A6 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_120(int iParam0, int iParam1) // Position - 0x53C4 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_121(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x53D3 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_130(iParam0) == 1 && bParam7)
		return;
...
float func_122() // Position - 0x545F Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_123(var uParam0, int iParam1) // Position - 0x5491 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_124(var uParam0, int iParam1) // Position - 0x54A2 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_125(var uParam0) // Position - 0x54B7 Hash - 0x39705408 ^0x39705408
{
	return func_120(*uParam0, 2);
}

BOOL func_126(Ped pedParam0, Hash hParam1) // Position - 0x54C7 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_127(Ped pedParam0, Hash hParam1) // Position - 0x54F5 Hash - 0x4CC61C6 ^0x2A263234
{
	Hash _int;
...
BOOL func_128(Ped pedParam0, Hash hParam1) // Position - 0x5543 Hash - 0x4CC61C6 ^0x2A263234
{
	Hash _int;
	int _int2;
...
void func_129(Ped pedParam0) // Position - 0x55B1 Hash - 0x39F95A97 ^0x61F5E431
{
...
int func_130(int iParam0) // Position - 0x55CD Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_131() // Position - 0x55E0 Hash - 0x4228A1C2 ^0x6E8485BE
{
