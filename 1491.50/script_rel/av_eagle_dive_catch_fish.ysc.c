...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0xC4031ACB
{
	var unk;
	BOOL flag;
	...
	iLocal_10 = joaat("a_c_fishrockbass_01_ms");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x3350C40D
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x41A7420D ^0x41A7420D
{
	func_46(uParam0, "EAGLE_DIVE_CATCH_FISH", "script@ambient@animal@eagle_dive_catch_fish@action", uParam1, uParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 1, "FISH", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C24 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CC4 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DDE Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FA7 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FB0 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2160 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21D4 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2223 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x227B Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23E4 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x270B Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2842 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2972 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29B1 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29BA Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x29EC Hash - 0x2DC81C53 ^0x2DC81C53
{
...
int func_31(var uParam0) // Position - 0x2A11 Hash - 0x4E3BB2A0 ^0x4E3BB2A0
{
	char* animDict;
	char* animName;
	char* animName2;
	...
	animDict = "script_amb@animal@eagle_dive_catch_fish";
	animName = "eagle_exit_a";
	animName2 = "fish_exit_a";
	vector = { 0f, 0f, 0f };
	vector2 = { 0f, 0f, 0f };
	...
	if (!uParam0->f_469[0])
	{
		...
		if (!bLocal_39 == true)
			if (func_60(uParam0, &uLocal_11, false) || func_61(uParam0->f_20[0 /*14*/], Global_35, true) < 225f || func_62(Global_35, uParam0->f_483, true) < 49f)
				bLocal_39 = true;
				...
				if (func_70(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							...
							{
								func_65(uParam0);
								func_71(&uParam0->f_20[0 /*14*/], true, true);
							...
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
									{
										...
										ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 38142), vector, vector2, true, false, false, false, 2, true, true, false);
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2E52 Hash - 0xFBD382D6 ^0xDE753D8A
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F5A Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F77 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x30B3 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x31EC Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3296 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x330E Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x339D Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x34B8 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x34C4 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x364C Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x36EC Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36FF Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3719 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3781 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x37AD Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37DE Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x386C Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3A70 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3A84 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3A93 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_75() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3AAE Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3B0D Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3B4F Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3B7B Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3BF7 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3C19 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3C3B Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_60(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C5F Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_61(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3CB9 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_62(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3D10 Hash - 0x1A58F423 ^0x2317B76D
{
...
BOOL func_63(var uParam0) // Position - 0x3D60 Hash - 0x5001E582 ^0x5001E582
{
	return func_104(*uParam0, 1);
}

void func_64(var uParam0) // Position - 0x3D70 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_105(uParam0, 0f);
	return;
}

void func_65(var uParam0) // Position - 0x3D7F Hash - 0x5F88D024 ^0x5F88D024
{
	if (!uParam0->f_469[7])
	{
...
void func_66(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3DA4 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_67(var uParam0) // Position - 0x3EA8 Hash - 0x3B3F3300 ^0xF68D7450
{
	int taskSequenceId;
...
void func_68(var uParam0) // Position - 0x3F17 Hash - 0x5C40EAAE ^0xDEBCF9CA
{
...
BOOL func_69(var uParam0, int iParam1) // Position - 0x3F92 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_63(uParam0))
		return false;
...
BOOL func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3FB9 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
void func_71(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x41C7 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_72(var uParam0, int iParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x41EF Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (!bParam5 || ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[i /*14*/], hParam4))
				{
					if (func_61(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_69(&(uParam0->f_490), iParam1))
							return true;
						else
							return false;
					}
...
void func_73(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4318 Hash - 0xC26AC0FE ^0xFF80BBA5
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (bParam1)
...
void func_74(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4354 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_75() // Position - 0x44A8 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_76(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x44B6 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x451D Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4546 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_79(var uParam0, var uParam1, var uParam2) // Position - 0x4592 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_80(int iParam0) // Position - 0x45E1 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_81(int iParam0) // Position - 0x4606 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_82(int iParam0) // Position - 0x4619 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_83(int iParam0) // Position - 0x462C Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_84(int iParam0) // Position - 0x463F Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_85(int iParam0) // Position - 0x4651 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_86(int iParam0, int iParam1) // Position - 0x4663 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x46FD Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_88() // Position - 0x4735 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_89(int iParam0) // Position - 0x4788 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_92(iParam0))
		return -1;
...
BOOL func_90(int iParam0) // Position - 0x47A8 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_91(int iParam0, int iParam1) // Position - 0x47BE Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(int iParam0) // Position - 0x47CD Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_93(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4800 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x48E1 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_101(iParam0, 4);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x48FF Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_101(iParam0, 8);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x491F Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_101(iParam0, 16);
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x494A Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_101(iParam0, 32);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x496A Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_101(iParam0, 64);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x498A Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x49AC Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_101(int iParam0, int iParam1) // Position - 0x49D0 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x49E1 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x500A Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x5028 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_105(var uParam0, float fParam1) // Position - 0x5037 Hash - 0x30433BAB ^0xF854D531
{
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x505D Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_107(int iParam0) // Position - 0x5134 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x51B5 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_109(var uParam0) // Position - 0x52A6 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_63(uParam0))
		return uParam0->f_1;
...
BOOL func_110(Ped pedParam0) // Position - 0x52DB Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_111(Ped pedParam0) // Position - 0x52F6 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_112(int iParam0) // Position - 0x5312 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_113(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5359 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_114(var uParam0, float fParam1) // Position - 0x5377 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_115(var uParam0) // Position - 0x5395 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_116(var uParam0, BOOL bParam1) // Position - 0x53AB Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_117(var uParam0) // Position - 0x53CB Hash - 0x39705408 ^0x39705408
{
	return func_104(*uParam0, 2);
}

void func_118(var uParam0) // Position - 0x53DB Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_63(uParam0);
...
void func_119(var uParam0) // Position - 0x540F Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_63(uParam0);
...
BOOL func_120(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x543F Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_121(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5494 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_122(int iParam0, int iParam1) // Position - 0x54AB Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_123(int iParam0, int iParam1) // Position - 0x5531 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_124(int iParam0, int iParam1) // Position - 0x556D Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_125(int iParam0, int iParam1) // Position - 0x55C0 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_126(int iParam0, int iParam1) // Position - 0x55FB Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_127(int iParam0, int iParam1) // Position - 0x5634 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_128(int iParam0) // Position - 0x566C Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_129(BOOL bParam0) // Position - 0x56AA Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_130(ePedType eptParam0) // Position - 0x56BD Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_131(Ped pedParam0, Hash hParam1) // Position - 0x5B10 Hash - 0xFC9AC4CE ^0xC2E8DFAA
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_132(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5BB7 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_133(Ped pedParam0, BOOL bParam1) // Position - 0x5BE7 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_134(Ped pedParam0, int iParam1) // Position - 0x5C2C Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_135(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5C53 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_173(iParam2);
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x5E1E Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_137(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5EF5 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5F32 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_139(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6019 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x60EF Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_141(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x61F8 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x632D Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6364 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x646B Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x64D6 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_146(Ped pedParam0, int iParam1) // Position - 0x661E Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_147(var uParam0, int iParam1) // Position - 0x67FD Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x6875 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_149(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x68A4 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_150(int iParam0, Ped pedParam1) // Position - 0x6A2A Hash - 0x42A83B1F ^0xE04BA54F
{
	int _int;
...
BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x6A7A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_200(iParam0))
		return true;
...
BOOL func_152(Ped pedParam0, Ped pedParam1) // Position - 0x6B17 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_153() // Position - 0x6B64 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6B6C Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_155() // Position - 0x6C2D Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_156() // Position - 0x6C4B Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6C98 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_158(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6DB4 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6DFC Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x7055 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_210(0))
		return false;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x708E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_162(var uParam0, int iParam1) // Position - 0x70BD Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x70D1 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_164(int iParam0, Ped pedParam1) // Position - 0x711E Hash - 0x7BB711C3 ^0xA3452182
{
...
float func_165() // Position - 0x7171 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_166(var uParam0, int iParam1) // Position - 0x71A3 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_167(var uParam0, int iParam1) // Position - 0x71B4 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_168(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x71C9 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x7255 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x7283 Hash - 0x8465E5D5 ^0x28B3FC75
{
	Hash _int;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x72D3 Hash - 0x8465E5D5 ^0x28B3FC75
{
	Hash _int;
	int _int2;
...
void func_172(Ped pedParam0) // Position - 0x7343 Hash - 0x9DA1CFCD ^0x987626EE
{
...
void func_173(int iParam0) // Position - 0x7360 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_174(int iParam0) // Position - 0x74CC Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_175(BOOL bParam0) // Position - 0x74DF Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_176(int iParam0) // Position - 0x74F9 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_177(int iParam0) // Position - 0x7593 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_178(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x75BA Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_179(Ped pedParam0, Ped pedParam1) // Position - 0x76B3 Hash - 0xF9959663 ^0xF9959663
{
	return func_201(pedParam0, pedParam1, true, true);
}

float func_180(int iParam0) // Position - 0x76C5 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_181(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x76D1 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_182(int iParam0, BOOL bParam1) // Position - 0x7736 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_183() // Position - 0x775C Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_184(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7770 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_185(int iParam0) // Position - 0x78D0 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_186(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x78DC Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_187(int iParam0) // Position - 0x793D Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_188(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7949 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_189(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7A0B Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_190(int iParam0) // Position - 0x7AA9 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_191(int iParam0) // Position - 0x7AB5 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_192(int iParam0) // Position - 0x7AC1 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_193(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7BFE Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_194(Ped pedParam0) // Position - 0x7C41 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7CA7 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7CEE Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7D39 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_198(Ped pedParam0, var uParam1) // Position - 0x7DB2 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_199(Ped pedParam0, Ped pedParam1) // Position - 0x7DFF Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_200(int iParam0) // Position - 0x7E47 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_201(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7E57 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_202(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7E9F Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7ECB Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_204(int iParam0) // Position - 0x7EF3 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_205(Ped pedParam0) // Position - 0x7EFF Hash - 0xEB445B10 ^0xFAE928EB
{
...
int func_206(Ped pedParam0) // Position - 0x7F57 Hash - 0xF0727F92 ^0x487D9A75
{
...
BOOL func_207(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7FC5 Hash - 0x641E929 ^0xC0F38E9E
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8136 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_209(int iParam0, Ped pedParam1) // Position - 0x8224 Hash - 0x27FC2906 ^0xBD3A894C
{
...
BOOL func_210(int iParam0) // Position - 0x829A Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_227())
		return false;
...
int func_211(int iParam0) // Position - 0x82BC Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x82C8 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_213(int iParam0) // Position - 0x8343 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_214() // Position - 0x8356 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_215() // Position - 0x8364 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_229())
		return false;
...
void func_216(Any* panParam0, int iParam1) // Position - 0x83BA Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_217(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8463 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_218(int iParam0) // Position - 0x852A Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_219(int iParam0) // Position - 0x85D2 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_220(Ped pedParam0, int iParam1) // Position - 0x8637 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_221(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x864E Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_222(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x867C Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_223(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x86C6 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_224(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8707 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_225(Ped pedParam0) // Position - 0x8780 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_226(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8868 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_227() // Position - 0x88AA Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_214() != -1)
		return false;
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x88CF Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_229() // Position - 0x8900 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_230(int iParam0) // Position - 0x8931 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_92(iParam0))
		return -1;
...
int func_231(int iParam0) // Position - 0x894D Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_232(int iParam0) // Position - 0x898E Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
