...
BOOL func_15(int iParam0) // Position - 0x7EA Hash - 0xD30D217A ^0xD30D217A
{
	return func_48(&uLocal_14, 32, &uLocal_14, func_46(), 0, func_47(), false, 0, false);
}
...
int func_46() // Position - 0xD8B Hash - 0x45910AF6 ^0x45910AF6
{
	return 41;
}
...
void func_62(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11A6 Hash - 0xC6F251A1 ^0x9A1E59AF
{
	BOOL flag;
	const char* str;
	char* str2;
...
char* func_107(int iParam0) // Position - 0x3F61 Hash - 0x21CE226B ^0x12E84085
{
	switch (iParam0)
	{
		case 0:
...
const char* func_114(var uParam0, int iParam1) // Position - 0x4070 Hash - 0xB0CFF0C3 ^0xE8206505
{
...
const char* func_160(int iParam0) // Position - 0x4B7C Hash - 0xE6862179 ^0xC2C9BDCE
{
	switch (iParam0)
	{
		case 0:
...
const char* func_163(const char* sParam0, int iParam1) // Position - 0x4EA6 Hash - 0x9E99F03 ^0x2601EF80
{
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x4FC9 Hash - 0x2F9EB0B9 ^0xD6E5BF3B
{
	char* ambientZone;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x4FFD Hash - 0x342D57CF ^0x292C879A
{
	switch (iParam0)
	{
		case 5:
