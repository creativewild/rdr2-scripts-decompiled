...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0xF75DB199
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x878737D6 ^0x46A8FDA1
{
	Hash hash;
	Hash hash2;

	func_46(uParam0, "MAN_SIT_READ", "", vParam1, uParam4);
	hash = func_48(func_47(), true, false, true, false, false, true);
	hash2 = func_49(joaat("horse_class_riding"), true);
	func_50(uParam0, 0, "MSRP_HORSE", hash2, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, 2.2f, 0f), 60f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "MSRP_MAN", hash, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C4C Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CEC Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E06 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FCF Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FD8 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2188 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21FC Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x224B Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22A3 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x240C Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2733 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x286A Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x299A Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29D9 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29E2 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A14 Hash - 0xFB958CDA ^0xFB958CDA
{
...
int func_31(var uParam0) // Position - 0x2A5C Hash - 0xCC4580A6 ^0x6170E260
{
	if (!uParam0->f_469[0])
	{
		if (func_67(uParam0, &uLocal_10, false))
		{
			func_68(uParam0);
			uParam0->f_469[0] = 1;
		}
	
		if (PED::_GET_IS_PED_IN_DISPUTE_WITH_PED(uParam0->f_20[1 /*14*/], Global_35))
		{
			if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[1 /*14*/], 0))
			{
				func_68(uParam0);
				uParam0->f_469[0] = 1;
			}
	...
	if (!bLocal_40)
	{
		...
		if (func_70(4) || func_71(uLocal_41))
		{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_73(&(uParam0->f_20[1 /*14*/].f_5), 1, 10, false);
				...
				func_75(uParam0->f_20[1 /*14*/], joaat("world_human_sit_ground_reading_book_stow"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1082130432);
			...
			{
				func_73(&(uParam0->f_20[0 /*14*/].f_5), 1, 10, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("world_animal_horse_grazing"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
				func_76(&uParam0->f_20[0 /*14*/], false, true);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
			}
		
			iLocal_38 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[1 /*14*/].f_5, 4f, 1, 36, 0);
			iLocal_39 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[1 /*14*/].f_5, 1.5f, 2, -1, 0);
			iLocal_9 = 1;
			break;
	
		case 1:
			if (func_77(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				func_68(uParam0);
				iLocal_9 = 2;
			}
...
int func_32(var uParam0, var uParam1) // Position - 0x2C88 Hash - 0x40F5F587 ^0x5D311A50
{
	func_78(uParam0, false, false, false);

	if (iLocal_38 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_38, 1);

	if (iLocal_39 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_39, 1);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2CB4 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2CD1 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2E0D Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2F46 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2FF0 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3068 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x30F7 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3212 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x321E Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x33A6 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3446 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3459 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3473 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x34DB Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x3507 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3515 Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
Hash func_49(int iParam0, BOOL bParam1) // Position - 0x3707 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_50(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37C1 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x384F Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x3A53 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3A67 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3A76 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_79() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x3A91 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3AF0 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3B32 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3B5E Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3BDA Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3C00 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3C22 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3C44 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3C66 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3C8A Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_65(int iParam0, BOOL bParam1) // Position - 0x3CAE Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_104(iParam0, 16);
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3CD9 Hash - 0x97140DD8 ^0xA3B87048
{
	if (bParam1)
...
BOOL func_67(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3CFF Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_68(var uParam0) // Position - 0x3D59 Hash - 0xC4C556C ^0xC4C556C
{
	if (!uParam0->f_469[2])
	{
...
var func_69() // Position - 0x3DA2 Hash - 0x1372AFBD ^0xAE723118
{
	var weatherType1;
	var weatherType2;
...
int func_70(int iParam0) // Position - 0x3DCC Hash - 0x259E3CFD ^0x259E3CFD
{
	int num;
...
int func_71(int iParam0) // Position - 0x4021 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_72(var uParam0) // Position - 0x4066 Hash - 0x21F83DAF ^0xDA73F14E
{
	int taskSequenceId;
...
int func_73(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x40C6 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_74(var uParam0, Ped pedParam1, Ped pedParam2, int iParam3) // Position - 0x41BD Hash - 0xE2C49436 ^0xE2C49436
{
	func_110(uParam0, pedParam1, iParam3);
	func_111(uParam0, pedParam2, iParam3);
	return;
}

void func_75(Ped pedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, int iParam6, BOOL bParam7, BOOL bParam8, const char* sParam9, int iParam10) // Position - 0x41D9 Hash - 0xFE770A83 ^0xBFD078B3
{
	TASK::TASK_START_SCENARIO_AT_POSITION(pedParam0, hParam1, vParam2, fParam5, iParam6, bParam7, bParam8, sParam9, iParam10, false);
	return;
}

void func_76(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x41FA Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_77(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4222 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_112(Global_35))
		{
			ped = func_113(Global_35);
		...
		num2 = func_115(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_116(Global_35, uParam0->f_20[i /*14*/], true);
...
void func_78(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x442D Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_79() // Position - 0x4581 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_80(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x458F Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x45F6 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_82(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x461F Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_83(var uParam0, var uParam1, var uParam2) // Position - 0x466B Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_84(int iParam0) // Position - 0x46BA Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_85(int iParam0) // Position - 0x46DF Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_86(int iParam0) // Position - 0x46F2 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_87(int iParam0) // Position - 0x4705 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_88(int iParam0) // Position - 0x4718 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_89(int iParam0) // Position - 0x472A Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_90(int iParam0, int iParam1) // Position - 0x473C Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x47D6 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_92() // Position - 0x480E Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_93(int iParam0) // Position - 0x4861 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_96(iParam0))
		return -1;

	return func_130(func_129(iParam0));
}

BOOL func_94(int iParam0) // Position - 0x4881 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_95(int iParam0, int iParam1) // Position - 0x4897 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_96(int iParam0) // Position - 0x48A6 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_97(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x48D9 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_131(eptParam1))
		{
			func_132(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_134(pedParam0, false);
			flag = true;
		}
	
		func_135(pedParam0, iParam2);
	}
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x49BA Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_104(iParam0, 4);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x49D8 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_104(iParam0, 8);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x49F8 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_104(iParam0, 32);
	else
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4A18 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_104(iParam0, 64);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4A38 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4A5A Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_104(int iParam0, int iParam1) // Position - 0x4A7E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_105(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4A8F Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_136(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_138(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_140(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_138(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_142(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_143(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
				...
				{
					if (func_145(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_138(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_146(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_138(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_146(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_138(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				...
				{
					if (func_150(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_151(iParam2, pedParam0) && func_152(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_138(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_150(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_151(iParam2, pedParam0) && func_152(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_138(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_153(pedParam0, Global_1935630.f_41))
							{
								func_154();
								*uParam3 = 2;
								func_138(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_155(iParam2, pedParam0) || iParam2->f_9 > 0 && func_156() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_157())
					{
						if (func_153(pedParam0, Global_1935630.f_42))
						{
							func_154();
							*uParam3 = 2;
							func_138(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_159(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_138(pedParam0, iParam2, *uParam3);
					return true;
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x50B8 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_107(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x518F Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
	...
	func_166(iParam0);
	func_167(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

int func_108() // Position - 0x5293 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

BOOL func_109(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x529F Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_110(var uParam0, Ped pedParam1, int iParam2) // Position - 0x52C8 Hash - 0xC3D6C274 ^0xA4235D0E
{
...
void func_111(var uParam0, Ped pedParam1, int iParam2) // Position - 0x532F Hash - 0x3732AADF ^0xAC7FACDB
{
	if (PED::IS_PED_HUMAN(pedParam1))
		return;
...
BOOL func_112(Ped pedParam0) // Position - 0x53A3 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_113(Ped pedParam0) // Position - 0x53BE Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_114(float fParam0) // Position - 0x53DA Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_115(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5421 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_116(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x543F Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_117(var uParam0) // Position - 0x5496 Hash - 0x5001E582 ^0x5001E582
{
	return func_169(*uParam0, 1);
}

void func_118(var uParam0) // Position - 0x54A6 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_170(uParam0, 0f);
	return;
}

BOOL func_119(var uParam0, float fParam1) // Position - 0x54B5 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_120(var uParam0) // Position - 0x54D3 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_121(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x54E9 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_122(BOOL bParam0, var uParam1, var uParam2) // Position - 0x553E Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_123(int iParam0, int iParam1) // Position - 0x5555 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_124(int iParam0, int iParam1) // Position - 0x55DB Hash - 0x96B01D2A ^0x81E68218
{
...
void func_125(int iParam0, int iParam1) // Position - 0x5617 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_126(int iParam0, int iParam1) // Position - 0x566A Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_127(int iParam0, int iParam1) // Position - 0x56A5 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_128(int iParam0, int iParam1) // Position - 0x56DE Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_129(int iParam0) // Position - 0x5716 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_130(BOOL bParam0) // Position - 0x5754 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_131(ePedType eptParam0) // Position - 0x5767 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_132(Ped pedParam0, Hash hParam1) // Position - 0x5BBA Hash - 0xD4517B55 ^0xCBAD1F3A
{
...
void func_133(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5C61 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_134(Ped pedParam0, BOOL bParam1) // Position - 0x5C91 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_135(Ped pedParam0, int iParam1) // Position - 0x5CD6 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_136(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5CFD Hash - 0x37D64B11 ^0xE7060A9E
{
	func_176(iParam2);
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_179(iParam0))
				iParam0->f_15 = func_156();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_156() - iParam0->f_15 > 500)
			{
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5EC8 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_181(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_182(pedParam0, pedIndexFromEntityIndex) <= func_183(iParam1))
				return true;
			break;
	}
...
void func_138(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5F9F Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_184(iParam2, 1, 1, 1, 0))
		func_104(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_185(iParam1, true);
	func_186();
	return;
}

BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5FDC Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_187(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			num2 = func_188(iParam1);
		
			if (func_189(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_190(iParam1);
...
BOOL func_140(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x60C3 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_191(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_188(iParam2);
	
		if (func_189(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_190(iParam2))
				{
					func_185(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x6199 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_181(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_190(iParam1))
		{
			customDistance = func_188(iParam1);
...
BOOL func_142(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x62A2 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x63D7 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x640E Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6515 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_194(iParam2))
	{
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6580 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_196(pedParam1, entityCoords, outCoords))
					{
						func_185(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_196(pedParam1, entityCoords, outCoords2))
					{
						func_185(iParam2, true);
						return true;
					}
...
BOOL func_147(Ped pedParam0, int iParam1) // Position - 0x66C8 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_181(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_197(Global_1935630.f_34[i]);
			...
			if (func_198(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_199(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_200(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_148(var uParam0, int iParam1) // Position - 0x68A4 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x691C Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_150(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x694B Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_151(int iParam0, Ped pedParam1) // Position - 0x6AD1 Hash - 0xDE0EC47C ^0x9E08952C
{
	int _int;
...
BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x6B1E Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_203(iParam0))
		return true;
...
BOOL func_153(Ped pedParam0, Ped pedParam1) // Position - 0x6BBB Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_204(pedParam0, pedParam1, true, true) < 4f)
...
void func_154() // Position - 0x6C08 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6C10 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_205(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_156();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_206(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_156() // Position - 0x6CD1 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_157() // Position - 0x6CEF Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_156() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6D3C Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_207(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_208(pedParam1);
	num2 = func_209(iParam0->f_14);
...
BOOL func_159(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6E58 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_210(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6EA0 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_211(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_212(iParam1, pedParam0))
						if (func_206(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x70F9 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_213(0))
		return false;
...
BOOL func_162(int iParam0, int iParam1) // Position - 0x7132 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_163(var uParam0, int iParam1) // Position - 0x7161 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x7175 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_156();
	else if (func_156() - iParam1->f_4 > func_214(iParam1))
		return func_215(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_165(int iParam0, Ped pedParam1) // Position - 0x71C2 Hash - 0x3FC8687F ^0x398BD957
{
...
void func_166(int iParam0) // Position - 0x7215 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_216(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_216(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_216(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_167(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7296 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_168(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7387 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0x73A5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_170(var uParam0, float fParam1) // Position - 0x73B4 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_171(var uParam0, float fParam1) // Position - 0x73DA Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_117(uParam0))
		return false;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x7401 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x742F Hash - 0x36C9FBD3 ^0x30E510F4
{
	Hash _int;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x747D Hash - 0x36C9FBD3 ^0x30E510F4
{
	Hash _int;
	int _int2;
...
void func_175(Ped pedParam0) // Position - 0x74EB Hash - 0x2AECC4A ^0x6F12D992
{
...
void func_176(int iParam0) // Position - 0x7507 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_177(int iParam0) // Position - 0x7673 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_178(BOOL bParam0) // Position - 0x7686 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_179(int iParam0) // Position - 0x76A0 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_180(int iParam0) // Position - 0x7738 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_181(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x775F Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_182(Ped pedParam0, Ped pedParam1) // Position - 0x7858 Hash - 0xF9959663 ^0xF9959663
{
	return func_204(pedParam0, pedParam1, true, true);
}

float func_183(int iParam0) // Position - 0x786A Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_184(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7876 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_185(int iParam0, BOOL bParam1) // Position - 0x78DB Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_186() // Position - 0x7901 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_187(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7915 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_204(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_188(int iParam0) // Position - 0x7A75 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_189(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7A81 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_190(int iParam0) // Position - 0x7AE2 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_191(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7AEE Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_192(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7BB0 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_193(int iParam0) // Position - 0x7C4E Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_194(int iParam0) // Position - 0x7C5A Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_195(int iParam0) // Position - 0x7C66 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_196(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7DA3 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_197(Ped pedParam0) // Position - 0x7DE6 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7E4C Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7E93 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7EDE Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_201(Ped pedParam0, var uParam1) // Position - 0x7F57 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_202(Ped pedParam0, Ped pedParam1) // Position - 0x7FA4 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_203(int iParam0) // Position - 0x7FEC Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_204(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7FFC Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_205(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8048 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_206(veParam0, uParam2, true);
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8074 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_207(int iParam0) // Position - 0x809C Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_208(Ped pedParam0) // Position - 0x80A8 Hash - 0x5C941F34 ^0xD215F0C3
{
...
int func_209(Ped pedParam0) // Position - 0x80FC Hash - 0x181223E8 ^0x60BA5E1
{
...
BOOL func_210(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8166 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_204(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_204(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_211(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x82D6 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_212(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_212(iParam1, ped2))
					if (func_206(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_212(int iParam0, Ped pedParam1) // Position - 0x83C4 Hash - 0x6C21293B ^0xE115056A
{
...
BOOL func_213(int iParam0) // Position - 0x8438 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_234())
		return false;
...
int func_214(int iParam0) // Position - 0x845A Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_215(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8466 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_216(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x84E1 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_217() // Position - 0x856D Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_218(var uParam0, int iParam1) // Position - 0x859F Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_219(var uParam0, int iParam1) // Position - 0x85B0 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_220(var uParam0) // Position - 0x85C5 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_117(uParam0))
		return uParam0->f_1;
...
BOOL func_221() // Position - 0x85FA Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_238())
		return false;
...
void func_222(Any* panParam0, int iParam1) // Position - 0x8650 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_223(BOOL bParam0, var uParam1, var uParam2) // Position - 0x86F8 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_224() // Position - 0x87BF Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_225(int iParam0) // Position - 0x87CD Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_226(int iParam0) // Position - 0x8875 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_227(Ped pedParam0, int iParam1) // Position - 0x88DA Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_228(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x88F1 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_229(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x891F Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_230(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8969 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_231(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x89AA Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_232(Ped pedParam0) // Position - 0x8A23 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_233(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8B0B Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_234() // Position - 0x8B4D Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_224() != -1)
		return false;
...
BOOL func_235(int iParam0, BOOL bParam1) // Position - 0x8B72 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_236(int iParam0) // Position - 0x8BA3 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_237(var uParam0) // Position - 0x8BB6 Hash - 0x39705408 ^0x39705408
{
	return func_169(*uParam0, 2);
}

BOOL func_238() // Position - 0x8BC6 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_239(int iParam0) // Position - 0x8BF7 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_96(iParam0))
		return -1;
...
int func_240(int iParam0) // Position - 0x8C13 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_241(int iParam0) // Position - 0x8C54 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
