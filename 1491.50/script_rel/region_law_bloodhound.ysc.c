#region Local Var
	...
	int iLocal_72 = 0;
	int iLocal_73 = 0;
	ePedType eptLocal_74 = PED_TYPE_PLAYER_0;
	ePedType eptLocal_75 = PED_TYPE_PLAYER_0;
	var uLocal_76 = 0;
	var uLocal_77 = 0;
	var uLocal_78 = 0;
	var uLocal_79 = 0;
...
void main() // Position - 0x0 Hash - 0x71DCDE9F ^0x4DD38AA7
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	eptLocal_74 = joaat("a_c_doghound_01");
...
void func_1(int iParam0) // Position - 0x4B Hash - 0x7D44A06A ^0x18EEBC0A
{
	...
	MAP::REMOVE_BLIP(&(uLocal_41[iParam0 /*10*/].f_8));

	for (i = 0; i < 4; i = i + 1)
	{
		if (func_5(uLocal_41[iParam0 /*10*/].f_1[i], 0))
		{
			func_6(uLocal_41[iParam0 /*10*/].f_1[i]);
			func_7(&uLocal_41[iParam0 /*10*/].f_1[i], true, false, true);
		}
	}

	if (PED::DOES_GROUP_EXIST(uLocal_41[iParam0 /*10*/].f_7))
		PED::REMOVE_GROUP(uLocal_41[iParam0 /*10*/].f_7);
...
void func_2() // Position - 0xC3 Hash - 0xE8F6A95B ^0xF8106717
{
	...
	{
		case 76:
			uLocal_85 = { -297.8979f, 783.4763f, 117.3506f };
			break;
	
		default:
			uLocal_85 = { func_8(iLocal_72, true) };
			break;
	}
...
BOOL func_3(int iParam0) // Position - 0x105 Hash - 0x77FD5BE6 ^0xA9DC4264
{
	if (func_9() != -1)
		return false;
...
void func_4() // Position - 0x154 Hash - 0x8A567523 ^0xC3AF0E5C
{
	int i;
	...
	{
		case 1:
			eptLocal_75 = func_14(2, 2, -156825994, true, false, 0f, 0f, 0f);
		
			if (!STREAMING::IS_MODEL_VALID(eptLocal_75))
				eptLocal_75 = joaat("s_m_m_ambientlawrural_01");
		
			iLocal_73 = 2;
			break;
	
		case 2:
			STREAMING::REQUEST_MODEL(eptLocal_74, false);
			STREAMING::REQUEST_MODEL(eptLocal_75, false);
		
			if (STREAMING::HAS_MODEL_LOADED(eptLocal_74) && STREAMING::HAS_MODEL_LOADED(eptLocal_75) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
				iLocal_73 = 4;
			break;
		...
		case 5:
			...
			{
				if (uLocal_41[i /*10*/] == 1)
					if (func_5(uLocal_41[i /*10*/].f_6, 0))
						if (func_12(Global_35, uLocal_41[i /*10*/].f_9, true, 0))
							func_18(i);
					else if (func_12(Global_35, uLocal_41[i /*10*/].f_9, true, 0))
						func_18(i);
					else
						uLocal_41[i /*10*/] = 3;
				else if (uLocal_41[i /*10*/] == 2)
					if (func_5(uLocal_41[i /*10*/].f_6, 0))
						if (!PED::IS_PED_IN_COMBAT(uLocal_41[i /*10*/].f_6, 0) && !func_12(Global_35, uLocal_41[i /*10*/].f_9, true, 0))
							func_17(i);
				else if (uLocal_41[i /*10*/] == 3)
					func_1(i);
			}
			break;
...
BOOL func_5(Ped pedParam0, int iParam1) // Position - 0x2C4 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
void func_6(Entity eParam0) // Position - 0x3C3 Hash - 0x467611EC ^0x3EE822E5
{
	Blip blipFromEntity;
	...
	func_20(&blipFromEntity);
	return;
}

void func_7(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3E6 Hash - 0xEB76F1D1 ^0xF1B7E213
{
...
Vector3 func_8(int iParam0, BOOL bParam1) // Position - 0x454 Hash - 0x5496E9AE ^0xF55F17AE
{
...
BOOL func_9() // Position - 0x4B4 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_10(int iParam0, BOOL bParam1) // Position - 0x4C2 Hash - 0x34A2E44 ^0x39A823C1
{
...
Volume func_11(int iParam0) // Position - 0x4F5 Hash - 0xE4DA9E55 ^0x6DBF788A
{
	if (!func_21(iParam0))
		return 0;
...
BOOL func_12(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x515 Hash - 0x6735ACA9 ^0xD6205CC6
{
...
BOOL func_13(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x54B Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
ePedType func_14(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4, float fParam5, float fParam6, float fParam7) // Position - 0x680 Hash - 0x5FAF754B ^0x127DAE42
{
	if (!func_23(iParam0))
		return 0;
	...
	return POPULATION::GET_RANDOM_MODEL_FROM_POPULATION_SET(func_24(iParam0), iParam1, hParam2, bParam3, bParam4, fParam5);
}

BOOL func_15() // Position - 0x6BA Hash - 0xD951786B ^0x3A83AF92
{
	float num;
	float num2;
	var unk;
	...
	if (!func_25(uLocal_85, &uLocal_76, &unk, 1, true, 1127481344, 50f, num, num2, 0))
		return false;

	uLocal_88 = { uLocal_76.f_3 };
	return true;
}

void func_16(int iParam0) // Position - 0x700 Hash - 0x8174A387 ^0x4096E0F5
{
	var unk;
	int i;

	if (!PED::DOES_GROUP_EXIST(uLocal_41[iParam0 /*10*/].f_7))
		uLocal_41[iParam0 /*10*/].f_7 = PED::CREATE_GROUP(1);

	unk = { func_26(uLocal_88, 3f, 1f) };
	uLocal_41[iParam0 /*10*/].f_6 = func_27(eptLocal_75, unk, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), true, true, 0, true, true, true, false, false, false, false);
	PED::SET_PED_CONFIG_FLAG(uLocal_41[iParam0 /*10*/].f_6, 279, true);
	PED::SET_PED_AS_GROUP_LEADER(uLocal_41[iParam0 /*10*/].f_6, uLocal_41[iParam0 /*10*/].f_7, false);
	TASK::TASK_POLICE(uLocal_41[iParam0 /*10*/].f_6, false);
	PED::SET_PED_CONFIG_FLAG(uLocal_41[iParam0 /*10*/].f_6, 188, true);

	for (i = 0; i < 4; i = i + 1)
	{
		uLocal_41[iParam0 /*10*/].f_1[i] = func_27(eptLocal_74, unk, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), true, true, 0, true, true, true, false, false, false, false);
		func_5(uLocal_41[iParam0 /*10*/].f_1[i], 0);
	}

	return;
}

void func_17(int iParam0) // Position - 0x7EB Hash - 0x6BA91EDC ^0xC2ADC66C
{
	int i;
	Vector3 vector;

	if (!func_5(uLocal_41[iParam0 /*10*/].f_6, 0))
		return;

	uLocal_41[iParam0 /*10*/] = 1;

	if (!VOLUME::DOES_VOLUME_EXIST(uLocal_41[iParam0 /*10*/].f_9))
	{
		uLocal_41[iParam0 /*10*/].f_9 = VOLUME::CREATE_VOLUME_CYLINDER(ENTITY::GET_ENTITY_COORDS(uLocal_41[iParam0 /*10*/].f_6, true, false), 0f, 0f, 0f, 35f, 35f, 10f);
		PED::_ATTACH_VOLUME_TO_ENTITY(uLocal_41[iParam0 /*10*/].f_9, uLocal_41[iParam0 /*10*/].f_6, 0f, 0f, 0f, 0f, 0f, 0f, 2, true);
	}

	if (!MAP::DOES_BLIP_EXIST(uLocal_41[iParam0 /*10*/].f_8))
		uLocal_41[iParam0 /*10*/].f_8 = MAP::_BLIP_ADD_FOR_VOLUME(joaat("BLIP_STYLE_RADIUS"), uLocal_41[iParam0 /*10*/].f_9);
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (func_5(uLocal_41[iParam0 /*10*/].f_1[i], 0))
		{
			...
			func_6(uLocal_41[iParam0 /*10*/].f_1[i]);
			TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_41[iParam0 /*10*/].f_1[i], uLocal_41[iParam0 /*10*/].f_6, vector, 2f, -1, 1036831949, true, true, false, false, true, false);
		}
	}
...
void func_18(int iParam0) // Position - 0x8FE Hash - 0x359652D4 ^0x3231A7A7
{
	int i;
	...
	uLocal_41[iParam0 /*10*/] = 2;

	for (i = 0; i < 4; i = i + 1)
	{
		if (func_5(uLocal_41[iParam0 /*10*/].f_1[i], 0))
		{
			PED::REMOVE_PED_FROM_GROUP(uLocal_41[iParam0 /*10*/].f_1[i]);
			TASK::TASK_COMBAT_PED(uLocal_41[iParam0 /*10*/].f_1[i], Global_35, 0, 0);
			MAP::BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_ENEMY"), uLocal_41[iParam0 /*10*/].f_1[i]);
			MAP::REMOVE_BLIP(&(uLocal_41[iParam0 /*10*/].f_8));
		}
	}
...
BOOL func_19(int iParam0, int iParam1) // Position - 0x989 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_20(Blip* pblParam0) // Position - 0x998 Hash - 0xB0965077 ^0xCF35C455
{
...
BOOL func_21(eStackSize essParam0) // Position - 0x9B0 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return essParam0 >= 0 && essParam0 <= 150;
}

BOOL func_22(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9C6 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
BOOL func_23(int iParam0) // Position - 0xA64 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

Hash func_24(int iParam0) // Position - 0xA7A Hash - 0x8D65EDFB ^0x8D65EDFB
{
	int num;
...
BOOL func_25(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, int iParam7, float fParam8, float fParam9, float fParam10, int iParam11) // Position - 0xABD Hash - 0xC31BF175 ^0x915D2C1C
{
	int num;
	...
	switch (*uParam3)
	{
		case 0:
			...
			func_30(&(uParam3->f_1), uParam3->f_2, uParam0, iParam5, iParam7, fParam8, fParam9, fParam10, iParam11);
...
Vector3 func_26(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0xBDE Hash - 0xC59B327E ^0x28F503C3
{
	var unk;
	float endRange;
	...
	endRange = fParam4 / 2f;
	unk = { func_34(unk, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
	unk.f_2 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-endRange, endRange);
	return uParam0 + unk;
}

Ped func_27(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0xC26 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_35(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

eStackSize func_28() // Position - 0xC68 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

int func_29(eStackSize essParam0) // Position - 0xC76 Hash - 0xE4DA9E55 ^0xA7262997
{
	if (!func_21(essParam0))
		return 0;

	return Global_1888801[essParam0 /*35*/].f_20;
}

void func_30(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10) // Position - 0xC96 Hash - 0xF3743088 ^0xD7A675F3
{
...
void func_31(var uParam0, int iParam1) // Position - 0x1652 Hash - 0x8FE085B4 ^0xC2CC5B51
{
	switch (iParam1)
	{
		case 0:
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1D87 Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_33(float fParam0, var uParam1, var uParam2) // Position - 0x1DB1 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
Vector3 func_34(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x1DF0 Hash - 0x88200B15 ^0xE07B704A
{
	float num;
...
void func_35(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1E27 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_37(eptParam1))
		{
			func_38(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
float func_36(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x1F08 Hash - 0x3A11F625 ^0x3A11F625
{
	float num;
...
BOOL func_37(ePedType eptParam0) // Position - 0x1F2D Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_38(Ped pedParam0, Hash hParam1) // Position - 0x2380 Hash - 0x6550EB7D ^0xA447AF75
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_42(pedParam0, hParam1))
		{
			if (func_43(pedParam0, hParam1))
			{
				if (func_44(pedParam0, hParam1))
				{
...
void func_39(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x2426 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_40(Ped pedParam0, BOOL bParam1) // Position - 0x2456 Hash - 0xC422C7A4 ^0x3D93F520
{
...
void func_41(Ped pedParam0, int iParam1) // Position - 0x249B Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
BOOL func_42(Ped pedParam0, Hash hParam1) // Position - 0x24C2 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_43(Ped pedParam0, Hash hParam1) // Position - 0x24F0 Hash - 0x6BF0A137 ^0x1EC73650
{
	Hash _int;
...
BOOL func_44(Ped pedParam0, Hash hParam1) // Position - 0x253D Hash - 0x6BF0A137 ^0x1EC73650
{
	Hash _int;
	int _int2;
...
void func_45(Ped pedParam0) // Position - 0x25A9 Hash - 0xA371E61 ^0x916A75BC
{
