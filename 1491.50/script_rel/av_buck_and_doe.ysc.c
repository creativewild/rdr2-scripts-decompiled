...
void main() // Position - 0x0 Hash - 0xA112627F ^0xCCD7CCC7
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	hLocal_10 = joaat("world_animal_deer_grazing");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0x8C77C0D3
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0xFFB64398 ^0xBB3679D2
{
	func_46(uParam0, "BUCK_AND_DOE", "", vParam1, uParam4);
	func_47(uParam0, 0, "BADP_BUCK_1", joaat("a_c_buck_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), -180f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "BADP_DOE_1", joaat("a_c_deer_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.25f, -4f, 0f), 75f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}
...
int func_30(var uParam0) // Position - 0x2A0F Hash - 0xCBCF885E ^0xCBCF885E
{
	func_55(&uLocal_17, false);
	func_56(&uLocal_17, true);
...
int func_31(var uParam0) // Position - 0x2AB5 Hash - 0xEEEA1954 ^0x13004ABB
{
	if (!uParam0->f_469[1])
	{
		if (func_62(uParam0, &uLocal_17, false) || func_63(uParam0->f_20[0 /*14*/], Global_35, true, true) < 20f)
		{
			func_64(uParam0);
			func_65(uParam0);
			iLocal_9 = 8;
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_66(&(uParam0->f_20[0 /*14*/].f_5), 50, 10, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], hLocal_10, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
		...
		case 1:
			...
			{
				func_65(uParam0);
				uLocal_45.f_3 = uParam0->f_20[0 /*14*/];
				uLocal_45.f_7 = 0;
				func_69(&uLocal_14);
				PED::SET_PED_SHOULD_PLAY_FLEE_SCENARIO_EXIT(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, 1);
				PED::SET_PED_SHOULD_PLAY_FLEE_SCENARIO_EXIT(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, 1);
				TASK::REACT_LOOK_AT(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1, 1, 6f, 1, 0, 0, 0);
				iLocal_9 = 2;
			}
			break;
		...
		case 2:
			...
			{
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &uLocal_45);
			
				if (func_70(&uLocal_14, 5f))
				{
					TASK::TASK_GO_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], -1, 3f, 1f, 1073741824, 0);
					TASK::REACT_LOOK_AT(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 1, 1, 100f, 1, 0, 0, 0);
					iLocal_9 = 3;
				}
			}
			break;
		...
		case 4:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				if (!func_71(uParam0->f_20[1 /*14*/], SCRIPT_TASK_GO_TO_ENTITY))
				{
					uLocal_70.f_3 = uParam0->f_20[1 /*14*/];
					uLocal_70.f_7 = 0;
					func_69(&uLocal_14);
					iLocal_9 = 5;
				}
		...
		case 5:
			...
			{
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &uLocal_45);
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[0 /*14*/], &uLocal_70);
			
				if (func_70(&uLocal_14, 4f))
				{
					TASK::TASK_SMART_FLEE_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1000f, -1, 256, 1.25f, 0);
					iLocal_9 = 6;
				}
			}
			break;
		...
		case 6:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &uLocal_45);
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[0 /*14*/], &uLocal_70);
				TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_20[1 /*14*/], 1.25f);
				PED::SET_PED_MAX_MOVE_BLEND_RATIO(uParam0->f_20[1 /*14*/], 1.25f);
			
				if (func_72(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], true) > 16f)
				{
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], -2f, -4f, 0f, 1.5f, -1, 1036831949, true, true, false, false, true, false);
					func_69(&uLocal_14);
					iLocal_9 = 7;
				}
			}
...
int func_32(var uParam0, var uParam1) // Position - 0x2F30 Hash - 0x22B3CA4B ^0xAF9A36FB
{
	int i;
	...
	for (i = 0; i < uParam0->f_19; i = i + 1)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_11[i]))
			TASK::_DELETE_SCENARIO_POINT(uLocal_11[i]);
	}

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F6E Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F8B Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x30C7 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3200 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x32AA Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3322 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x33B1 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x34CC Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x34D8 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3660 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3700 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3713 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x372D Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3795 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37C1 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_48(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x384F Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_49(int iParam0) // Position - 0x3A53 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x3A67 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_51() // Position - 0x3A76 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_74() != -1;
}

BOOL func_52(var uParam0, Any* panParam1) // Position - 0x3A91 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_53(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3AF0 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_54(Ped pedParam0) // Position - 0x3B32 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_55(int iParam0, BOOL bParam1) // Position - 0x3B5E Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_56(var uParam0, BOOL bParam1) // Position - 0x3BDA Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3C00 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3C22 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3C44 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x3C66 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_99(iParam0, 4);
	else
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3C84 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_62(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3CA8 Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_63(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3D02 Hash - 0xD54E86C ^0xB31A48E2
{
...
void func_64(var uParam0) // Position - 0x3D4A Hash - 0x5905BFA7 ^0x4C55A007
{
	int i;
	...
	for (i = 0; i <= 1; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
		{
			PED::SET_PED_SHOULD_PLAY_FLEE_SCENARIO_EXIT(uParam0->f_20[i /*14*/], Global_36, 0);
...
void func_65(var uParam0) // Position - 0x3D95 Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
...
int func_66(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3DDE Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_67(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3ED5 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3EFD Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_72(Global_35, uParam0->f_20[i /*14*/], true);
...
void func_69(var uParam0) // Position - 0x410A Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_111(uParam0, 0f);
	return;
}

BOOL func_70(var uParam0, float fParam1) // Position - 0x4119 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_108(uParam0))
		return false;
...
BOOL func_71(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x4140 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_72(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4199 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_113(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

void func_73(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x41F0 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_74() // Position - 0x4344 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_75(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4352 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x43B9 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x43E2 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_78(var uParam0, var uParam1, var uParam2) // Position - 0x442E Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_79(int iParam0) // Position - 0x447D Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_80(int iParam0) // Position - 0x44A2 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_81(int iParam0) // Position - 0x44B5 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_82(int iParam0) // Position - 0x44C8 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_83(int iParam0) // Position - 0x44DB Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_84(int iParam0) // Position - 0x44ED Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_85(int iParam0, int iParam1) // Position - 0x44FF Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4599 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_87() // Position - 0x45D1 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_88(int iParam0) // Position - 0x4624 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_91(iParam0))
		return -1;
...
BOOL func_89(int iParam0) // Position - 0x4644 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_90(int iParam0, int iParam1) // Position - 0x465A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_91(int iParam0) // Position - 0x4669 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_92(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x469C Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x477D Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_99(iParam0, 8);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x479D Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_99(iParam0, 16);
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x47C8 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_99(iParam0, 32);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x47E8 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_99(iParam0, 64);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4808 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x482A Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_99(int iParam0, int iParam1) // Position - 0x484E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_100(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x485F Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4E88 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_102(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4F5F Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x5063 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_104(Ped pedParam0) // Position - 0x508C Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_105(Ped pedParam0) // Position - 0x50A7 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_106(float fParam0) // Position - 0x50C3 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_107(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x510A Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_109(var uParam0, float fParam1) // Position - 0x5138 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_110(var uParam0) // Position - 0x5156 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_111(var uParam0, float fParam1) // Position - 0x516C Hash - 0x30433BAB ^0xF854D531
{
...
float func_112(var uParam0) // Position - 0x5192 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_108(uParam0))
		return uParam0->f_1;
...
float func_113(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x51C7 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_114(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x51E5 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_115(BOOL bParam0, var uParam1, var uParam2) // Position - 0x523A Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_116(int iParam0, int iParam1) // Position - 0x5251 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_117(int iParam0, int iParam1) // Position - 0x52D7 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_118(int iParam0, int iParam1) // Position - 0x5313 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_119(int iParam0, int iParam1) // Position - 0x5366 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_120(int iParam0, int iParam1) // Position - 0x53A1 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_121(int iParam0, int iParam1) // Position - 0x53DA Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_122(int iParam0) // Position - 0x5412 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_123(BOOL bParam0) // Position - 0x5450 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_124(ePedType eptParam0) // Position - 0x5463 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_125(Ped pedParam0, Hash hParam1) // Position - 0x58B6 Hash - 0xD4EA0F84 ^0xF3C77D01
{
...
void func_126(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x595D Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_127(Ped pedParam0, BOOL bParam1) // Position - 0x598D Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_128(Ped pedParam0, int iParam1) // Position - 0x59D2 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_129(int iParam0, BOOL bParam1, int iParam2) // Position - 0x59F9 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_170(iParam2);
...
BOOL func_130(Ped pedParam0, int iParam1) // Position - 0x5BC4 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_131(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5C9B Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x5CD8 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_133(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5DBF Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x5E95 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_135(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5F9E Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x60D3 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_137(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x610A Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_138(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6211 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_139(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x627C Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x63C4 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_141(var uParam0, int iParam1) // Position - 0x65A0 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x6618 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_143(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6647 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_144(int iParam0, Ped pedParam1) // Position - 0x67CD Hash - 0x5A1B3CB6 ^0x5A71EE62
{
	int _int;
...
BOOL func_145(int iParam0, Ped pedParam1) // Position - 0x681A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_197(iParam0))
		return true;
...
BOOL func_146(Ped pedParam0, Ped pedParam1) // Position - 0x68B7 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_63(pedParam0, pedParam1, true, true) < 4f)
...
void func_147() // Position - 0x6904 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x690C Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_149() // Position - 0x69CD Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_150() // Position - 0x69EB Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x6A38 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_152(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6B54 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_153(Ped pedParam0, int iParam1) // Position - 0x6B9C Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_154(Ped pedParam0, int iParam1) // Position - 0x6DF5 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_206(0))
		return false;
...
BOOL func_155(int iParam0, int iParam1) // Position - 0x6E2E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_156(var uParam0, int iParam1) // Position - 0x6E5D Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6E71 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6EBE Hash - 0x9141B4E2 ^0xB76D7C81
{
...
void func_159(int iParam0) // Position - 0x6F11 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_209(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_209(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_209(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_160(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6F92 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x7083 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_162() // Position - 0x7092 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_163(var uParam0, int iParam1) // Position - 0x70C4 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_164(var uParam0, int iParam1) // Position - 0x70D5 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_165(var uParam0) // Position - 0x70EA Hash - 0x39705408 ^0x39705408
{
	return func_161(*uParam0, 2);
}

BOOL func_166(Ped pedParam0, Hash hParam1) // Position - 0x70FA Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_167(Ped pedParam0, Hash hParam1) // Position - 0x7128 Hash - 0x95585F5C ^0xA8FC23B0
{
	Hash _int;
...
BOOL func_168(Ped pedParam0, Hash hParam1) // Position - 0x7176 Hash - 0x95585F5C ^0xA8FC23B0
{
	Hash _int;
	int _int2;
...
void func_169(Ped pedParam0) // Position - 0x71E4 Hash - 0x86E54973 ^0x42D0F148
{
...
void func_170(int iParam0) // Position - 0x7200 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_171(int iParam0) // Position - 0x736C Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_172(BOOL bParam0) // Position - 0x737F Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_173(int iParam0) // Position - 0x7399 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_174(int iParam0) // Position - 0x7431 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_175(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7458 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_176(Ped pedParam0, Ped pedParam1) // Position - 0x7551 Hash - 0xF9959663 ^0xF9959663
{
	return func_63(pedParam0, pedParam1, true, true);
}

float func_177(int iParam0) // Position - 0x7563 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_178(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x756F Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x75D4 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_180() // Position - 0x75FA Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_181(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x760E Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_63(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_182(int iParam0) // Position - 0x776E Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_183(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x777A Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_184(int iParam0) // Position - 0x77DB Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_185(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x77E7 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_186(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x78A9 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_187(int iParam0) // Position - 0x7947 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_188(int iParam0) // Position - 0x7953 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_189(int iParam0) // Position - 0x795F Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_190(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7A9C Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_191(Ped pedParam0) // Position - 0x7ADF Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_192(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B45 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_193(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B8C Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_194(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7BD7 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_195(Ped pedParam0, var uParam1) // Position - 0x7C50 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_196(Ped pedParam0, Ped pedParam1) // Position - 0x7C9D Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_197(int iParam0) // Position - 0x7CE5 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

BOOL func_198(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7CF5 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_199(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7D21 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_200(int iParam0) // Position - 0x7D49 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_201(Ped pedParam0) // Position - 0x7D55 Hash - 0x1496B810 ^0xF99B0D07
{
...
int func_202(Ped pedParam0) // Position - 0x7DA9 Hash - 0x7C9DA11 ^0xAC40549C
{
...
BOOL func_203(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7E13 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_63(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_63(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_204(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7F83 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_205(int iParam0, Ped pedParam1) // Position - 0x8072 Hash - 0x643A0E51 ^0xB36B3D8
{
...
BOOL func_206(int iParam0) // Position - 0x80E6 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_223())
		return false;
...
int func_207(int iParam0) // Position - 0x8108 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8114 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_209(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x818F Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_210() // Position - 0x821B Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_226())
		return false;
...
void func_211(Any* panParam0, int iParam1) // Position - 0x8271 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_212(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8319 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_213() // Position - 0x83E0 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_214(int iParam0) // Position - 0x83EE Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_215(int iParam0) // Position - 0x8496 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_216(Ped pedParam0, int iParam1) // Position - 0x84FB Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_217(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8512 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_218(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8540 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_219(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x858A Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_220(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x85CB Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_221(Ped pedParam0) // Position - 0x8644 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_222(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x872C Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_223() // Position - 0x876E Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_213() != -1)
		return false;
...
BOOL func_224(int iParam0, BOOL bParam1) // Position - 0x8793 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_225(int iParam0) // Position - 0x87C4 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_226() // Position - 0x87D7 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_227(int iParam0) // Position - 0x8808 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_91(iParam0))
		return -1;
...
int func_228(int iParam0) // Position - 0x8824 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_229(int iParam0) // Position - 0x8865 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
