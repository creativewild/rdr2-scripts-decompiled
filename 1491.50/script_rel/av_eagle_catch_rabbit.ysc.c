...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x6944BA4C
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0xF92772DC
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x9B017057 ^0x3B80BFDB
{
	func_46(uParam0, "EAGLE_CATCH_RABBIT", "script@ambient@animal@EAGLE_CATCH_RABBIT@action", uParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 1, "RABBIT", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}
...
BOOL func_28(var uParam0) // Position - 0x29B6 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29BF Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x29F1 Hash - 0xEC3C72EE ^0xEC3C72EE
{
	func_56(&uLocal_11, false);
	func_57(&uLocal_11, true);
	func_58(&uLocal_11, true);
	func_59(&uLocal_11, true);
	func_60(&uLocal_11, 65);
	return 1;
}

int func_31(var uParam0) // Position - 0x2A1E Hash - 0x150E6707 ^0x150E6707
{
	char* animDict;
	char* animName;
	char* animName2;
	...
	animDict = "script_amb@animal@EAGLE_CATCH_RABBIT";
	animName = "eagle_exit_a";
	animName2 = "rabbit_exit_a";
	vector = { 0f, 0f, 0f };
	vector2 = { 0f, 0f, 0f };
	...
	if (!bLocal_40)
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534))
		{
			func_61(&uParam0->f_20[0 /*14*/], true, true);
			func_61(&uParam0->f_20[1 /*14*/], true, true);
			bLocal_40 = true;
		}
	}
	else if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534))
	{
		func_61(&uParam0->f_20[0 /*14*/], false, true);
		func_61(&uParam0->f_20[1 /*14*/], false, true);
		bLocal_40 = false;
	}
	...
	if (!uParam0->f_469[0])
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			STREAMING::_0x5288B7F0690F7C1F(uParam0->f_20[0 /*14*/]);
	
		if (!bLocal_39 == true)
			if (func_62(uParam0, &uLocal_11, false) || func_63(uParam0->f_20[0 /*14*/], Global_35, true) < 225f || func_63(uParam0->f_20[1 /*14*/], Global_35, true) < 225f || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uParam0->f_20[1 /*14*/], true, false), 2f, true, true))
				bLocal_39 = true;
	...
	if (uParam0->f_469[0] == 1)
		if (func_70(&uLocal_41, 3f))
			return 1;
	...
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_72(uParam0, 1065353216, 100f, 4, joaat("Action"), true))
				{
					func_67(*uParam0, uParam0->f_483, true);
					uParam0->f_469[6] = 1;
				}
							...
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
									{
										...
										TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], animDict, animName, 8f, -1056964608, -1, 65553, 0, false, 0, false, "LegsOnlyBird_filter", false);
										PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_20[1 /*14*/], false);
										ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 38142), vector, vector2, false, false, false, false, 2, true, true, false);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
			...
			if (!uParam0->f_469[3])
			{
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 1688442774))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1, uParam0->f_20[0 /*14*/]);
									PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], -1299979036, false, 0, false);
									TASK::TASK_FLY_AWAY(uParam0->f_20[0 /*14*/], Global_35);
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2F28 Hash - 0xFBD382D6 ^0xDE753D8A
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	if (!bParam1)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
				if (uParam0->f_469[4] && !uParam0->f_469[5] && func_63(uParam0->f_20[i /*14*/], Global_35, true) < 22500f)
					return 0;
		}
	}
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3030 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x304D Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3189 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x32C2 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x336C Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x33E4 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3473 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x358E Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x359A Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3722 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x37C2 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x37D5 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x37EF Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3857 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3883 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x38B4 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3942 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3B46 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3B5A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3B69 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_75() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3B84 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3BE3 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3C25 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3C51 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3CCD Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3CEF Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3D11 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_60(var uParam0, int iParam1) // Position - 0x3D35 Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

void func_61(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D43 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_62(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3D6B Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_63(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3DC5 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_64(var uParam0) // Position - 0x3E1C Hash - 0x5001E582 ^0x5001E582
{
	return func_104(*uParam0, 1);
}

void func_65(var uParam0) // Position - 0x3E2C Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_105(uParam0, 0f);
	return;
}

void func_66(var uParam0) // Position - 0x3E3B Hash - 0x5F88D024 ^0x5F88D024
{
	if (!uParam0->f_469[7])
	{
...
void func_67(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3E60 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_68(var uParam0) // Position - 0x3F64 Hash - 0x3B3F3300 ^0xF68D7450
{
	int taskSequenceId;
...
void func_69(var uParam0) // Position - 0x3FD3 Hash - 0xD330CA2C ^0xE9039E5C
{
	int taskSequenceId;
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		motionStateHash = joaat("MotionState_Sprint");
	
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], joaat("BREAKOUT_RABBIT")))
		{
		...
		{
			if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], 1118956789))
				motionStateHash = joaat("MotionState_Idle");
		
			TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
			TASK::TASK_FORCE_MOTION_STATE(0, motionStateHash, false);
			TASK::TASK_FLEE_PED(0, Global_35, 3, 256, -1082130432, -1, 0);
			TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
...
BOOL func_70(var uParam0, int iParam1) // Position - 0x40AB Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_64(uParam0))
		return false;
...
BOOL func_71(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x40D2 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_110(Global_35))
		{
			ped = func_111(Global_35);
		...
		num = num * num;
		fParam2 = func_112(fParam2);
		num2 = func_113(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_63(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_114(&(uParam0->f_490), fParam1))
						{
...
BOOL func_72(var uParam0, int iParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x42DD Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_63(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_64(&(uParam0->f_490)))
						...
						if (func_70(&(uParam0->f_490), iParam1))
							return true;
						else
							return false;
					}
		...
		if (func_64(&(uParam0->f_490)) && !func_117(&(uParam0->f_490)))
...
void func_73(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4406 Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
void func_74(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4442 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_75() // Position - 0x4596 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_76(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x45A4 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x460B Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4634 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_79(var uParam0, var uParam1, var uParam2) // Position - 0x4680 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_80(int iParam0) // Position - 0x46CF Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_81(int iParam0) // Position - 0x46F4 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_82(int iParam0) // Position - 0x4707 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_83(int iParam0) // Position - 0x471A Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_84(int iParam0) // Position - 0x472D Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_85(int iParam0) // Position - 0x473F Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_86(int iParam0, int iParam1) // Position - 0x4751 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x47EB Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_88() // Position - 0x4823 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_89(int iParam0) // Position - 0x4876 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_92(iParam0))
		return -1;
...
BOOL func_90(int iParam0) // Position - 0x4896 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_91(int iParam0, int iParam1) // Position - 0x48AC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(int iParam0) // Position - 0x48BB Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_93(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x48EE Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x49CF Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_101(iParam0, 4);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x49ED Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_101(iParam0, 8);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4A0D Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_101(iParam0, 16);
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4A38 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_101(iParam0, 32);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4A58 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_101(iParam0, 64);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4A78 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4A9A Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_101(int iParam0, int iParam1) // Position - 0x4ABE Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4ACF Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x50F8 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x5116 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_105(var uParam0, float fParam1) // Position - 0x5125 Hash - 0x30433BAB ^0xF854D531
{
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x514B Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_107(int iParam0) // Position - 0x5222 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x52A3 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_109(var uParam0) // Position - 0x5394 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_64(uParam0))
		return uParam0->f_1;
...
BOOL func_110(Ped pedParam0) // Position - 0x53C9 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_111(Ped pedParam0) // Position - 0x53E4 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_112(float fParam0) // Position - 0x5400 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_113(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5447 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_114(var uParam0, float fParam1) // Position - 0x5465 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_115(var uParam0) // Position - 0x5483 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_116(var uParam0, BOOL bParam1) // Position - 0x5499 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_117(var uParam0) // Position - 0x54B9 Hash - 0x39705408 ^0x39705408
{
	return func_104(*uParam0, 2);
}

void func_118(var uParam0) // Position - 0x54C9 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_64(uParam0);

	if (func_117(uParam0))
	{
		uParam0->f_1 = func_165() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_167(uParam0, 2);
	}
...
void func_119(var uParam0) // Position - 0x54FD Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_64(uParam0);

	if (!func_117(uParam0))
	{
		uParam0->f_2 = func_165() - uParam0->f_1;
		func_166(uParam0, 2);
	}
...
BOOL func_120(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x552D Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_121(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5582 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_122(int iParam0, int iParam1) // Position - 0x5599 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_123(int iParam0, int iParam1) // Position - 0x561F Hash - 0x96B01D2A ^0x81E68218
{
...
void func_124(int iParam0, int iParam1) // Position - 0x565B Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_125(int iParam0, int iParam1) // Position - 0x56AE Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_126(int iParam0, int iParam1) // Position - 0x56E9 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_127(int iParam0, int iParam1) // Position - 0x5722 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_128(int iParam0) // Position - 0x575A Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_129(BOOL bParam0) // Position - 0x5798 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_130(ePedType eptParam0) // Position - 0x57AB Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_131(Ped pedParam0, Hash hParam1) // Position - 0x5BFE Hash - 0x99CA91AB ^0xC5800876
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_132(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5CA5 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_133(Ped pedParam0, BOOL bParam1) // Position - 0x5CD5 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_134(Ped pedParam0, int iParam1) // Position - 0x5D1A Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_135(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5D41 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_173(iParam2);
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x5F0C Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_137(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5FE3 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x6020 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_139(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6107 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x61DD Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_141(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x62E6 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x641B Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6452 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6559 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x65C4 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_146(Ped pedParam0, int iParam1) // Position - 0x670C Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_147(var uParam0, int iParam1) // Position - 0x68EA Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x6962 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_149(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6991 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_150(int iParam0, Ped pedParam1) // Position - 0x6B17 Hash - 0x42A83B1F ^0xA4D337FB
{
	int _int;
...
BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x6B67 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_200(iParam0))
		return true;
...
BOOL func_152(Ped pedParam0, Ped pedParam1) // Position - 0x6C04 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_153() // Position - 0x6C51 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6C59 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_155() // Position - 0x6D1A Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_156() // Position - 0x6D38 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_155() - Global_1935630.f_43 >= &func_25)
		return false;

	return true;
}

BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6D85 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_158(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6EA1 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6EE9 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x7142 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_210(0))
		return false;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x717B Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_162(var uParam0, int iParam1) // Position - 0x71AA Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x71BE Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_155() - iParam1->f_4 > func_211(iParam1))
		return func_212(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_164(int iParam0, Ped pedParam1) // Position - 0x720B Hash - 0x8A201CDF ^0xFB70E08
{
...
float func_165() // Position - 0x725E Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_166(var uParam0, int iParam1) // Position - 0x7290 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_167(var uParam0, int iParam1) // Position - 0x72A1 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_168(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x72B6 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_213(iParam0) == 1 && bParam7)
		return;
...
BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x7342 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x7370 Hash - 0xD32F464E ^0x7D70FFAD
{
	Hash _int;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x73C0 Hash - 0xD32F464E ^0x7D70FFAD
{
	Hash _int;
	int _int2;
...
void func_172(Ped pedParam0) // Position - 0x7430 Hash - 0xDBF4773 ^0xC18CD898
{
...
void func_173(int iParam0) // Position - 0x744D Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_216(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_174(int iParam0) // Position - 0x75B9 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_175(BOOL bParam0) // Position - 0x75CC Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_217(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_176(int iParam0) // Position - 0x75E6 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_177(int iParam0) // Position - 0x7680 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_178(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x76A7 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_179(Ped pedParam0, Ped pedParam1) // Position - 0x77A0 Hash - 0xF9959663 ^0xF9959663
{
	return func_201(pedParam0, pedParam1, true, true);
}

float func_180(int iParam0) // Position - 0x77B2 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_181(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77BE Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_182(int iParam0, BOOL bParam1) // Position - 0x7823 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_183() // Position - 0x7849 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_184(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x785D Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_185(int iParam0) // Position - 0x79BD Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_186(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x79C9 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_187(int iParam0) // Position - 0x7A2A Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_188(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7A36 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_189(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7AF8 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_190(int iParam0) // Position - 0x7B96 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_191(int iParam0) // Position - 0x7BA2 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_192(int iParam0) // Position - 0x7BAE Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_193(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7CEB Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_194(Ped pedParam0) // Position - 0x7D2E Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D94 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7DDB Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7E26 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_198(Ped pedParam0, var uParam1) // Position - 0x7E9F Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_199(Ped pedParam0, Ped pedParam1) // Position - 0x7EEC Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_200(int iParam0) // Position - 0x7F34 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_201(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7F44 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_202(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7F8C Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7FB8 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_204(int iParam0) // Position - 0x7FE0 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_205(Ped pedParam0) // Position - 0x7FEC Hash - 0x7727966B ^0x5D7684BE
{
...
int func_206(Ped pedParam0) // Position - 0x8042 Hash - 0x7789B5D7 ^0x94E70B02
{
...
BOOL func_207(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x80B0 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8220 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_217(true, &ped, &ped2);
...
BOOL func_209(int iParam0, Ped pedParam1) // Position - 0x830E Hash - 0x27FC2906 ^0x3097AE3A
{
...
BOOL func_210(int iParam0) // Position - 0x8384 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_227())
		return false;
...
int func_211(int iParam0) // Position - 0x83A6 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x83B2 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_213(int iParam0) // Position - 0x842D Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_214() // Position - 0x8440 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_215() // Position - 0x844E Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_229())
		return false;
...
void func_216(Any* panParam0, int iParam1) // Position - 0x84A4 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_217(BOOL bParam0, var uParam1, var uParam2) // Position - 0x854D Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_218(int iParam0) // Position - 0x8614 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_219(int iParam0) // Position - 0x86BC Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_220(Ped pedParam0, int iParam1) // Position - 0x8721 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_221(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8738 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_222(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8766 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_223(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x87B0 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_224(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x87F1 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_225(Ped pedParam0) // Position - 0x886A Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_226(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8952 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_227() // Position - 0x8994 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_214() != -1)
		return false;
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x89B9 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_229() // Position - 0x89EA Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_230(int iParam0) // Position - 0x8A1B Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_92(iParam0))
		return -1;
...
int func_231(int iParam0) // Position - 0x8A37 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_232(int iParam0) // Position - 0x8A78 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
