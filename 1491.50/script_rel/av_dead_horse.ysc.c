...
void main() // Position - 0x0 Hash - 0x5DC49547 ^0xDACC1EA0
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	hLocal_10 = joaat("a_c_dogbluetickcoonhound_01");
	sLocal_12 = "creatures_mammal@horse@normal@dead";
	sLocal_13 = "dead_left";
	iLocal_14 = MISC::GET_RANDOM_INT_IN_RANGE(60, 71);
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9DE Hash - 0x4DA9BC8C ^0xE4F95E53
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD2 Hash - 0x3824E2E0 ^0x9BD8C351
{
	func_46(uParam0, "DEAD_HORSE", "", vParam1, uParam4);
	func_47(&vParam1, 50, 10, false);
	hLocal_9 = func_48(joaat("horse_class_riding"), true);
	func_49(uParam0, 0, "DHP_HORSE", hLocal_9, vParam1, uParam4.f_2, 1, 1, 0, 1, joaat("META_OUTFIT_DEFAULT"), 1);

	if (*uParam0 == 150)
		func_49(uParam0, 1, "RDED1_DOG_1", hLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1.25f, 0.2f, 0f), 90f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);

	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C62 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D02 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E1C Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FE5 Hash - 0x92ED3FDF ^0xD78BADED
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_12))
		return 0;

	return func_50(uParam0, uParam0->f_20[0 /*14*/].f_5);
}

BOOL func_19(var uParam0) // Position - 0x200C Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21BC Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2230 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x227F Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22D7 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2440 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2767 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x289E Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29CE Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A0D Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A16 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A48 Hash - 0xD4B75367 ^0x13501F11
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_12);
	func_58(&uLocal_20, false);
	func_59(&uLocal_20, true);
	func_60(&uLocal_20, true);
	func_61(&uLocal_20, true);
	func_62(&uLocal_20, true);
	func_63(&uLocal_20, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2A81 Hash - 0xDFA489DD ^0xDFA489DD
{
	if (!uParam0->f_469[1])
	{
		if (func_64(uParam0, &uLocal_20, false))
		{
			func_65(uParam0);
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_12, sLocal_13, 1000f, -1000f, -1, 131072, 0, false, 0, false, 0, false);
				MISC::SET_PED_DECOMPOSED(uParam0->f_20[0 /*14*/], true);
				PERSISTENCE::_0x3CA5E58C9731A16B(uParam0->f_20[0 /*14*/], iLocal_14);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
				iLocal_15 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1f, 1, 36, 0);
				iLocal_16 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1.5f, 2, -1, 0);
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_47(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_SNIFFING_GROUND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
...
int func_32(var uParam0, var uParam1) // Position - 0x2C32 Hash - 0xB4C009B ^0xB010FED1
{
	func_69(uParam0, false, false, false);
	STREAMING::REMOVE_ANIM_DICT(sLocal_12);

	if (iLocal_15 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_15, 1);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2C64 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2C81 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2DBD Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2EF6 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2FA0 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3018 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x30A7 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x31C2 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x31CE Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3356 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x33F6 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3409 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3423 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x348B Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x34B7 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
Hash func_48(int iParam0, BOOL bParam1) // Position - 0x35AE Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_49(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3668 Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_50(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x36F6 Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
	...
	{
		if (func_84(entity, vParam1, true) <= 1f)
		{
			func_85(*uParam0, uParam0->f_483);
			uParam0->f_499 = 1;
			return 0;
		}
	}
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x374D Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x3951 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3965 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3974 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_70() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x398F Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x39EE Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3A30 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3A5C Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3AD8 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3AFE Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3B20 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3B42 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3B64 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_64(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3B88 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_65(var uParam0) // Position - 0x3BE2 Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
...
void func_66(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C2B Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_67(var uParam0) // Position - 0x3C53 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_103(uParam0, 0f);
	return;
}

BOOL func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3C62 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
void func_69(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3E6D Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_70() // Position - 0x3FC1 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_71(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x3FCF Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_72(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4037 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4060 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_112(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_74(var uParam0, var uParam1, var uParam2) // Position - 0x40AC Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_112(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_75(int iParam0) // Position - 0x40FB Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_76(int iParam0) // Position - 0x4120 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_77(int iParam0) // Position - 0x4133 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_78(int iParam0) // Position - 0x4146 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_79(int iParam0) // Position - 0x4159 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_80(int iParam0) // Position - 0x416B Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_81(int iParam0, int iParam1) // Position - 0x417D Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4217 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_83(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x424F Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_84(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4278 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_120(entityCoords, vParam1);
}

void func_85(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x42C8 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_112(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_86() // Position - 0x43B9 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_87(int iParam0) // Position - 0x440C Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_90(iParam0))
		return -1;
...
BOOL func_88(int iParam0) // Position - 0x442C Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_89(int iParam0, int iParam1) // Position - 0x4442 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_90(int iParam0) // Position - 0x4451 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_91(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4484 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4565 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_99(iParam0, 4);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4583 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_99(iParam0, 8);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x45A3 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_99(iParam0, 16);
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x45CE Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_99(iParam0, 32);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x45EE Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_99(iParam0, 64);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x460E Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4630 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_99(int iParam0, int iParam1) // Position - 0x4654 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_100(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4665 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4C8E Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_102(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4D65 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_104(Ped pedParam0) // Position - 0x4E8F Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_105(Ped pedParam0) // Position - 0x4EAA Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_106(float fParam0) // Position - 0x4EC6 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_107(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4F0D Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_108(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4F2B Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_120(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_109(var uParam0) // Position - 0x4F82 Hash - 0x5001E582 ^0x5001E582
{
	return func_162(*uParam0, 1);
}

BOOL func_110(var uParam0, float fParam1) // Position - 0x4F92 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_111(var uParam0) // Position - 0x4FB0 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_112(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x4FC6 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_113(BOOL bParam0, var uParam1, var uParam2) // Position - 0x501B Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_114(int iParam0, int iParam1) // Position - 0x5032 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_115(int iParam0, int iParam1) // Position - 0x50B8 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_116(int iParam0, int iParam1) // Position - 0x50F4 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_117(int iParam0, int iParam1) // Position - 0x5147 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_118(int iParam0, int iParam1) // Position - 0x5182 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_119(int iParam0, int iParam1) // Position - 0x51BB Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
float func_120(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x51F3 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_121(int iParam0) // Position - 0x5211 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_122(BOOL bParam0) // Position - 0x524F Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_123(ePedType eptParam0) // Position - 0x5262 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_124(Ped pedParam0, Hash hParam1) // Position - 0x56B5 Hash - 0x7AD2A60D ^0xB49D2891
{
...
void func_125(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x575C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_126(Ped pedParam0, BOOL bParam1) // Position - 0x578C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_127(Ped pedParam0, int iParam1) // Position - 0x57D1 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_128(int iParam0, BOOL bParam1, int iParam2) // Position - 0x57F8 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_168(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_170(true))
							func_99(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_170(true) || *iParam0 & 8192 != 0)
...
BOOL func_129(Ped pedParam0, int iParam1) // Position - 0x59C3 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_173(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_174(pedParam0, pedIndexFromEntityIndex) <= func_175(iParam1))
				return true;
			break;
	}
...
void func_130(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5A9A Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_176(iParam2, 1, 1, 1, 0))
		func_99(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_177(iParam1, true);
	func_178();
	return;
}

BOOL func_131(Ped pedParam0, int iParam1) // Position - 0x5AD7 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_179(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_181(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_182(iParam1);
...
BOOL func_132(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5BBE Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_183(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_180(iParam2);
	
		if (func_181(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_182(iParam2))
				{
					func_177(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x5C94 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_173(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_182(iParam1))
		{
			customDistance = func_180(iParam1);
...
BOOL func_134(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5D9D Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_184(bParam1, bParam2, bParam3);
...
BOOL func_135(int iParam0, int iParam1) // Position - 0x5ED2 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_136(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5F09 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_137(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6010 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_186(iParam2))
	{
...
BOOL func_138(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x607B Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_188(pedParam1, entityCoords, outCoords))
					{
						func_177(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_188(pedParam1, entityCoords, outCoords2))
					{
						func_177(iParam2, true);
						return true;
					}
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x61C3 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_173(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_189(Global_1935630.f_34[i]);
			...
			if (func_190(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_191(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_192(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_140(var uParam0, int iParam1) // Position - 0x639F Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_141(int iParam0, int iParam1) // Position - 0x6417 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_142(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6446 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_143(int iParam0, Ped pedParam1) // Position - 0x65CC Hash - 0x94BE8160 ^0x41232801
{
	int _int;
...
BOOL func_144(int iParam0, Ped pedParam1) // Position - 0x6619 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_195(iParam0))
		return true;
...
BOOL func_145(Ped pedParam0, Ped pedParam1) // Position - 0x66B6 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_196(pedParam0, pedParam1, true, true) < 4f)
...
void func_146() // Position - 0x6703 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_147(int iParam0, Ped pedParam1) // Position - 0x670B Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_197(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_198(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_148() // Position - 0x67CC Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_149() // Position - 0x67EA Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_150(int iParam0, Ped pedParam1) // Position - 0x6837 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_199(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_200(pedParam1);
	num2 = func_201(iParam0->f_14);
...
BOOL func_151(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6953 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_202(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_152(Ped pedParam0, int iParam1) // Position - 0x699B Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_203(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_204(iParam1, pedParam0))
						if (func_198(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_153(Ped pedParam0, int iParam1) // Position - 0x6BF4 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_205(0))
		return false;
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x6C2D Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_155(var uParam0, int iParam1) // Position - 0x6C5C Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_156(Ped pedParam0, int iParam1) // Position - 0x6C70 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_148() - iParam1->f_4 > func_206(iParam1))
		return func_207(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6CBD Hash - 0xACF87A80 ^0x1CBD3F07
{
...
void func_158(int iParam0) // Position - 0x6D10 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_208(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_208(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_208(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
float func_159() // Position - 0x6D91 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_160(var uParam0, int iParam1) // Position - 0x6DC3 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_161(var uParam0, int iParam1) // Position - 0x6DD4 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_162(int iParam0, int iParam1) // Position - 0x6DE9 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_163(var uParam0, float fParam1) // Position - 0x6DF8 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_109(uParam0))
		return false;
...
BOOL func_164(Ped pedParam0, Hash hParam1) // Position - 0x6E1F Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_165(Ped pedParam0, Hash hParam1) // Position - 0x6E4D Hash - 0x5B47EEDE ^0x92B0B111
{
	Hash _int;
...
BOOL func_166(Ped pedParam0, Hash hParam1) // Position - 0x6E9B Hash - 0x5B47EEDE ^0x92B0B111
{
	Hash _int;
	int _int2;
...
void func_167(Ped pedParam0) // Position - 0x6F09 Hash - 0x2E5231E3 ^0x3A5DA4B8
{
...
void func_168(int iParam0) // Position - 0x6F25 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_169(int iParam0) // Position - 0x7091 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_170(BOOL bParam0) // Position - 0x70A4 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_171(int iParam0) // Position - 0x70BE Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_172(int iParam0) // Position - 0x7156 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_173(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x717D Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_174(Ped pedParam0, Ped pedParam1) // Position - 0x7276 Hash - 0xF9959663 ^0xF9959663
{
	return func_196(pedParam0, pedParam1, true, true);
}

float func_175(int iParam0) // Position - 0x7288 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_176(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7294 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x72F9 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_178() // Position - 0x731F Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_179(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7333 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_196(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_180(int iParam0) // Position - 0x7493 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_181(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x749F Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_182(int iParam0) // Position - 0x7500 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_183(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x750C Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x75CE Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_185(int iParam0) // Position - 0x766C Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_186(int iParam0) // Position - 0x7678 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_187(int iParam0) // Position - 0x7684 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_188(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x77C1 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_189(Ped pedParam0) // Position - 0x7804 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_190(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x786A Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_191(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78B1 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_192(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x78FC Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_193(Ped pedParam0, var uParam1) // Position - 0x7975 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_194(Ped pedParam0, Ped pedParam1) // Position - 0x79C2 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_195(int iParam0) // Position - 0x7A0A Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_196(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7A1A Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_197(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7A62 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_198(veParam0, uParam2, true);
...
float func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7A8E Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_199(int iParam0) // Position - 0x7AB6 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_200(Ped pedParam0) // Position - 0x7AC2 Hash - 0x1D26116D ^0x20A7CDB4
{
...
int func_201(Ped pedParam0) // Position - 0x7B16 Hash - 0x8425E12B ^0x690FE5D3
{
...
BOOL func_202(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7B80 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_196(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_196(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_203(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7CF0 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_204(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_204(iParam1, ped2))
					if (func_198(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_204(int iParam0, Ped pedParam1) // Position - 0x7DDE Hash - 0x2FA1F02D ^0x83840078
{
...
BOOL func_205(int iParam0) // Position - 0x7E52 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_223())
		return false;
...
int func_206(int iParam0) // Position - 0x7E74 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_207(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7E80 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_208(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7EFB Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_209(var uParam0) // Position - 0x7F87 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_109(uParam0))
		return uParam0->f_1;
...
BOOL func_210() // Position - 0x7FBC Hash - 0x325B9532 ^0xD14853A5
{
	if (func_227())
		return false;
...
void func_211(Any* panParam0, int iParam1) // Position - 0x8014 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_212(BOOL bParam0, var uParam1, var uParam2) // Position - 0x80BC Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_213() // Position - 0x8183 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_214(int iParam0) // Position - 0x8191 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_215(int iParam0) // Position - 0x8239 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_216(Ped pedParam0, int iParam1) // Position - 0x829E Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_217(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x82B5 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_218(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x82E3 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_219(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x832D Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_220(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x836E Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_221(Ped pedParam0) // Position - 0x83E7 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_222(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x84CF Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_223() // Position - 0x8511 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_213() != -1)
		return false;
...
BOOL func_224(int iParam0, BOOL bParam1) // Position - 0x8536 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_225(int iParam0) // Position - 0x8567 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_226(var uParam0) // Position - 0x857A Hash - 0x39705408 ^0x39705408
{
	return func_162(*uParam0, 2);
}

BOOL func_227() // Position - 0x858A Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_228(int iParam0) // Position - 0x85BB Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_90(iParam0))
		return -1;
...
int func_229(int iParam0) // Position - 0x85D7 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_230(int iParam0) // Position - 0x8618 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
