...
void main() // Position - 0x0 Hash - 0x449A58AB ^0x48D4B7BC
{
	var unk;
	BOOL flag;
	...
	iLocal_10 = joaat("a_c_eagle_01");
	iLocal_11 = joaat("a_c_deer_01");
	iLocal_41 = MISC::GET_RANDOM_INT_IN_RANGE(60, 71);
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9E2 Hash - 0x4DA9BC8C ^0xA88C875C
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD6 Hash - 0xEF0D7EEE ^0xEF0D7EEE
{
	func_46(uParam0, "CROWS_AND_EAGLES_EAT_DEER", "script@ambient@animal@scavengers@crows_eagle_eating_deer@action", uParam1, uParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "CROW_1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 1, "CROW_2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 2, "CROW_3", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 3, "CROW_4", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 4, "EAGLE_1", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 5, "EAGLE_2", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 6, "EAGLE_3", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 7, "DEER", iLocal_11, uParam1, -90f + uParam4.f_2, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1CDA Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D7A Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E94 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x205D Hash - 0x5D34732 ^0x89E83C97
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED("SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_EAGLES_EATING_DEER_CARCASS_A"))
		return 0;

	return func_49(uParam0, uParam0->f_20[7 /*14*/].f_5);
}

BOOL func_19(var uParam0) // Position - 0x2085 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2235 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x22A9 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22F8 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2350 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24B9 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27E0 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2917 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A47 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A86 Hash - 0xFFD7288D ^0x36734FE9
{
	int i;
	...
	for (i = 0; i <= 6; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
		{
			...
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[i /*14*/], uParam0->f_20[7 /*14*/], true);
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[7 /*14*/], uParam0->f_20[i /*14*/], true);
		}
	}

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[7 /*14*/]))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[7 /*14*/], 186, true);
		PED::_SET_PED_QUALITY(uParam0->f_20[7 /*14*/], 0);
		TASK::TASK_PLAY_ANIM(uParam0->f_20[7 /*14*/], "SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_EAGLES_EATING_DEER_CARCASS_A", "LOOP_DEER", 1000f, -1000f, -1, 131072, 0, false, 0, false, 0, false);
		ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[7 /*14*/], true);
		MISC::SET_PED_DECOMPOSED(uParam0->f_20[7 /*14*/], true);
		PERSISTENCE::_0x3CA5E58C9731A16B(uParam0->f_20[7 /*14*/], iLocal_41);
		func_57(&uParam0->f_20[7 /*14*/], true, true);
...
void func_29(var uParam0) // Position - 0x2B74 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2BA6 Hash - 0x10E51541 ^0xBD10EC7A
{
	STREAMING::REQUEST_ANIM_DICT("SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_EAGLES_EATING_DEER_CARCASS_A");
	...
	func_65(&uLocal_13, 80);
	return 1;
}

// Unhandled jump detected. Output should be considered invalid
int func_31(var uParam0) // Position - 0x2BEF Hash - 0xC52FA4EA ^0xEFB8F074
{
	int i;
	...
	if (!uParam0->f_469[1])
	{
		...
		{
			if (func_66(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848) || func_67(uParam0, &uLocal_13, true))
			{
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[7 /*14*/], false);
							iLocal_12 = 0;
							uParam0->f_469[1] = 1;
							return 0;
						}
	...
	{
		if (func_69(uParam0, 1.5f, 40f, 4, joaat("Action"), true))
		{
				...
				if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
				{
					if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
					{
						for (i = 0; i <= 6; i = i + 1)
						{
							...
							if (func_72(uParam0->f_20[i /*14*/], 518218985))
								goto 0x166;
...
int func_32(var uParam0, var uParam1) // Position - 0x2D78 Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_75(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D8A Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DA7 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2EE3 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x301C Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30C6 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x313E Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31CD Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x32E8 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x32F4 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x347C Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x351C Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x352F Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3549 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35B1 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x35DD Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x360E Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_49(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x369C Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x36F3 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x38F7 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x390B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x391A Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_76() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3935 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3994 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x39D6 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A02 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3A2A Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3AA6 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3ACC Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3AEE Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3B10 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3B32 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_103(iParam0, 4);
	else
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3B50 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_65(var uParam0, int iParam1) // Position - 0x3B74 Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

int func_66(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3B82 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
int func_67(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3D8D Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_113(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return 1;
...
void func_68(int iParam0, BOOL bParam1) // Position - 0x3DE7 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_69(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3EBE Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_108(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_109(&(uParam0->f_490)))
		...
		if (func_109(&(uParam0->f_490)) && !func_115(&(uParam0->f_490)))
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3FE7 Hash - 0xECA34429 ^0xC074DE71
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_71(var uParam0, int iParam1) // Position - 0x40ED Hash - 0x937E8C4 ^0xC4DA331A
{
...
BOOL func_72(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x4112 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_73(var uParam0, int iParam1) // Position - 0x416B Hash - 0x238E8D89 ^0x8E899489
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iParam1 /*14*/]))
	{
		if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[iParam1 /*14*/].f_1))
		{
			...
			func_57(&uParam0->f_20[iParam1 /*14*/], true, true);
...
BOOL func_74(var uParam0) // Position - 0x4216 Hash - 0xC4425C54 ^0x8D206AEF
{
	int i;
...
void func_75(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x425A Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_76() // Position - 0x43AE Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_77(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x43BC Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4423 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x444C Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_80(var uParam0, var uParam1, var uParam2) // Position - 0x4498 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_81(int iParam0) // Position - 0x44E7 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_82(int iParam0) // Position - 0x450C Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_83(int iParam0) // Position - 0x451F Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_84(int iParam0) // Position - 0x4532 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_85(int iParam0) // Position - 0x4545 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_86(int iParam0) // Position - 0x4557 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_87(int iParam0, int iParam1) // Position - 0x4569 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4603 Hash - 0xA65AB937 ^0xA65AB937
{
...
float func_89(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x463B Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_128(entityCoords, vParam1);
}

void func_90(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x468B Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_91() // Position - 0x477C Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_92(int iParam0) // Position - 0x47CF Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_95(iParam0))
		return -1;
...
BOOL func_93(int iParam0) // Position - 0x47EF Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_94(int iParam0, int iParam1) // Position - 0x4805 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_95(int iParam0) // Position - 0x4814 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_96(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4847 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4928 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_103(iParam0, 8);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4948 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_103(iParam0, 16);
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4973 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_103(iParam0, 32);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4993 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_103(iParam0, 64);
	else
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x49B3 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x49D5 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_103(int iParam0, int iParam1) // Position - 0x49F9 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_104(Ped pedParam0) // Position - 0x4A0A Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_105(Ped pedParam0) // Position - 0x4A25 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_106(float fParam0) // Position - 0x4A41 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_107(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4A88 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_108(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4AA6 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_128(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_109(var uParam0) // Position - 0x4AFD Hash - 0x5001E582 ^0x5001E582
{
	return func_136(*uParam0, 1);
}

void func_110(var uParam0) // Position - 0x4B0D Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_137(uParam0, 0f);
	return;
}

BOOL func_111(var uParam0, float fParam1) // Position - 0x4B1C Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_112(var uParam0) // Position - 0x4B3A Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_113(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4B50 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_114(var uParam0, BOOL bParam1) // Position - 0x5179 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_115(var uParam0) // Position - 0x5199 Hash - 0x39705408 ^0x39705408
{
	return func_136(*uParam0, 2);
}

void func_116(var uParam0) // Position - 0x51A9 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_109(uParam0);
...
BOOL func_117(var uParam0, float fParam1) // Position - 0x51DD Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_109(uParam0))
		return false;
...
void func_118(var uParam0) // Position - 0x5204 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_109(uParam0);
...
void func_119(int iParam0) // Position - 0x5234 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
BOOL func_120(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x52B5 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_121(BOOL bParam0, var uParam1, var uParam2) // Position - 0x530A Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_122(int iParam0, int iParam1) // Position - 0x5321 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_123(int iParam0, int iParam1) // Position - 0x53A7 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_124(int iParam0, int iParam1) // Position - 0x53E3 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_125(int iParam0, int iParam1) // Position - 0x5436 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_126(int iParam0, int iParam1) // Position - 0x5471 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_127(int iParam0, int iParam1) // Position - 0x54AA Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
float func_128(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x54E2 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_129(int iParam0) // Position - 0x5500 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_130(BOOL bParam0) // Position - 0x553E Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_131(ePedType eptParam0) // Position - 0x5551 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_132(Ped pedParam0, Hash hParam1) // Position - 0x59A4 Hash - 0x7F521EE7 ^0x6D9E9A7D
{
...
void func_133(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5A4D Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_134(Ped pedParam0, BOOL bParam1) // Position - 0x5A7D Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_135(Ped pedParam0, int iParam1) // Position - 0x5AC2 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x5AE9 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_137(var uParam0, float fParam1) // Position - 0x5AF8 Hash - 0x30433BAB ^0xF854D531
{
...
void func_138(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5B1E Hash - 0x37D64B11 ^0xE7060A9E
{
	func_177(iParam2);
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5CE9 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_140(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5DC1 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x5DFE Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_142(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5EE5 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x5FBB Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_144(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x60C4 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x61F9 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6230 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6337 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x63A2 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_149(Ped pedParam0, int iParam1) // Position - 0x64EA Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_150(var uParam0, int iParam1) // Position - 0x66CA Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x6742 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_152(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6771 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_153(int iParam0, Ped pedParam1) // Position - 0x68F7 Hash - 0x42A83B1F ^0x7F09BDCE
{
	int _int;
...
BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6947 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_204(iParam0))
		return true;
...
BOOL func_155(Ped pedParam0, Ped pedParam1) // Position - 0x69E4 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_156() // Position - 0x6A31 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6A39 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_158() // Position - 0x6AFA Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_159() // Position - 0x6B18 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_160(int iParam0, Ped pedParam1) // Position - 0x6B65 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_161(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6C81 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x6CC9 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x6F22 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_214(0))
		return false;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x6F5B Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_165(var uParam0, int iParam1) // Position - 0x6F8A Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_166(Ped pedParam0, int iParam1) // Position - 0x6F9E Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_167(int iParam0, Ped pedParam1) // Position - 0x6FEB Hash - 0x2978E171 ^0xBDFB1F03
{
...
float func_168() // Position - 0x703F Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_169(var uParam0, int iParam1) // Position - 0x7071 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_170(var uParam0) // Position - 0x7086 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_109(uParam0))
		return uParam0->f_1;
...
void func_171(var uParam0, int iParam1) // Position - 0x70BB Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_172(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x70CC Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x7158 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x7186 Hash - 0xCF292BA ^0x490216BE
{
	Hash _int;
...
BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x71D6 Hash - 0xCF292BA ^0x490216BE
{
	Hash _int;
	int _int2;
...
void func_176(Ped pedParam0) // Position - 0x7246 Hash - 0xB4EEDA72 ^0xD64E05D9
{
...
void func_177(int iParam0) // Position - 0x7263 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_178(int iParam0) // Position - 0x73CF Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_179(BOOL bParam0) // Position - 0x73E2 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_180(int iParam0) // Position - 0x73FC Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_181(int iParam0) // Position - 0x7496 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_182(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x74BD Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_183(Ped pedParam0, Ped pedParam1) // Position - 0x75B6 Hash - 0xF9959663 ^0xF9959663
{
	return func_205(pedParam0, pedParam1, true, true);
}

float func_184(int iParam0) // Position - 0x75C8 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_185(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x75D4 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_186(int iParam0, BOOL bParam1) // Position - 0x7639 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_187() // Position - 0x765F Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_188(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7673 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_189(int iParam0) // Position - 0x77D3 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_190(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x77DF Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_191(int iParam0) // Position - 0x7840 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_192(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x784C Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_193(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x790E Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_194(int iParam0) // Position - 0x79AC Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_195(int iParam0) // Position - 0x79B8 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_196(int iParam0) // Position - 0x79C4 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7B01 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_198(Ped pedParam0) // Position - 0x7B44 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7BAA Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7BF1 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7C3C Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_202(Ped pedParam0, var uParam1) // Position - 0x7CB5 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_203(Ped pedParam0, Ped pedParam1) // Position - 0x7D02 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_204(int iParam0) // Position - 0x7D4A Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_205(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7D5A Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_206(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7DA2 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7DCE Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_208(int iParam0) // Position - 0x7DF6 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_209(Ped pedParam0) // Position - 0x7E02 Hash - 0xEB445B10 ^0xD9E00E6C
{
...
int func_210(Ped pedParam0) // Position - 0x7E5A Hash - 0x6E063231 ^0x1AB04672
{
...
BOOL func_211(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7ECA Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x803B Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_213(int iParam0, Ped pedParam1) // Position - 0x8129 Hash - 0x27FC2906 ^0x8A198377
{
...
BOOL func_214(int iParam0) // Position - 0x819F Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_231())
		return false;
...
int func_215(int iParam0) // Position - 0x81C1 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_216(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x81CD Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_217(int iParam0) // Position - 0x8248 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_218() // Position - 0x825B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_219() // Position - 0x8269 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_233())
		return false;
...
void func_220(Any* panParam0, int iParam1) // Position - 0x82BF Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_221(BOOL bParam0, var uParam1, var uParam2) // Position - 0x836A Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_222(int iParam0) // Position - 0x8431 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_223(int iParam0) // Position - 0x84D9 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_224(Ped pedParam0, int iParam1) // Position - 0x853E Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_225(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8555 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_226(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8583 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_227(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x85CD Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_228(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x860E Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_229(Ped pedParam0) // Position - 0x8687 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_230(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x876F Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_231() // Position - 0x87B1 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_218() != -1)
		return false;
...
BOOL func_232(int iParam0, BOOL bParam1) // Position - 0x87D6 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_233() // Position - 0x8807 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_234(int iParam0) // Position - 0x8838 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_95(iParam0))
		return -1;
...
int func_235(int iParam0) // Position - 0x8854 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_236(int iParam0) // Position - 0x8895 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
