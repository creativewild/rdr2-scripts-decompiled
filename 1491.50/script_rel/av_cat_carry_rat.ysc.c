...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0xA9612413
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_37 = joaat("A_C_Cat_01");
	iLocal_38 = joaat("a_c_rat_01");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x868A610
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0xEEF861A ^0xEE3519DD
{
	func_46(uParam0, "CAT_CARRY_RAT", "script@ambient@animal@cat_carry_rat@action", uParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "CAT", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "RAT", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C29 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CC9 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DE3 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FAC Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FB5 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2165 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21D9 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2228 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2280 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23E9 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2710 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2847 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2977 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29B6 Hash - 0x3F43A3FD ^0x35FD648B
{
	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[0 /*14*/]);

	if (!PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[0 /*14*/]))
		return false;

	return true;
}

void func_29(var uParam0) // Position - 0x29E7 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A19 Hash - 0xA15E41A7 ^0xA15E41A7
{
	func_56(&uLocal_9, false);
	func_57(&uLocal_9, true);
	func_58(&uLocal_9, true);
	func_59(&uLocal_9, true);
	func_60(&uLocal_9, true);
	func_61(&uLocal_9, 50);
	return 1;
}

int func_31(var uParam0) // Position - 0x2A4D Hash - 0x4EDD9551 ^0x4EDD9551
{
	char* animDict;
	char* animName;
	char* animName2;
	...
	animDict = "script_amb@animal@cat_carry_rat";
	animName = "cat_exit";
	animName2 = "rat_exit";
	vector = { 0f, 0f, 0f };
	vector2 = { 0f, 0f, 0f };
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		TASK::_0x2E1D6D87346BB7D2(uParam0->f_20[0 /*14*/], Global_35, 0, 1);

	if (!uParam0->f_469[0])
	{
		if (!bLocal_42 == true)
			if (func_62(uParam0, &uLocal_9, true) || func_63(Global_35, uParam0->f_483, true) <= 9f)
				bLocal_42 = true;
	
		if (bLocal_42)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!func_64(&uLocal_43))
					func_65(&uLocal_43);
	...
	if (!uParam0->f_469[0])
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							...
							{
								func_66(uParam0);
								PED::_0x10F96086123B939F(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 180f);
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_72(uParam0, 1.5f, 40f, 4, joaat("Action"), true))
				{
					func_67(*uParam0, uParam0->f_483, false);
					uParam0->f_469[6] = 1;
				}
						...
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									...
									{
										!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]);
										ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1, uParam0->f_20[1 /*14*/]);
										ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], false);
										ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], false);
										func_73(&uParam0->f_20[1 /*14*/], true, true);
										PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_20[1 /*14*/], false);
										TASK::TASK_PLAY_ANIM(uParam0->f_20[1 /*14*/], animDict, animName2, 8f, -1056964608, -1, 1, 0, false, 0, false, 0, false);
										TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], animDict, animName, 8f, -1056964608, -1, 65553, 0, false, 0, false, "FacialWithPHJaw_filter", false);
										ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 61276), vector, vector2, true, false, false, false, 2, true, true, false);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
						...
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("endsinwalk")))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									...
									func_73(&uParam0->f_20[0 /*14*/], true, true);
									func_75(uParam0->f_20[0 /*14*/], joaat("world_animal_cat_resting"), uLocal_39, 0f, -1, true, false, 0, -1082130432);
									PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
								
									if (TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 1) && !TASK::_PED_IS_IN_SCENARIO_BASE(uParam0->f_20[0 /*14*/]))
									{
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2EF7 Hash - 0xFBD382D6 ^0xDE753D8A
{
	BOOL flag;
	BOOL flag2;
	int i;

	flag = !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]);
	flag2 = !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]);

	if (uParam0->f_469[4] && !uParam0->f_469[5])
	{
		if (!flag || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uParam0->f_20[1 /*14*/], false, false), 0.5f, true, true))
		{
			ENTITY::DETACH_ENTITY(uParam0->f_20[1 /*14*/], true, true);
		
			if (flag2)
				func_76(uParam0->f_20[1 /*14*/], false, false);
		
			uParam0->f_469[1] = 1;
		}
		else if (TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 0) && TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(uParam0->f_20[0 /*14*/]) == joaat("world_animal_cat_resting"))
		{
			TASK::CLEAR_PED_SECONDARY_TASK(uParam0->f_20[0 /*14*/]);
			TASK::CLEAR_PED_SECONDARY_TASK(uParam0->f_20[1 /*14*/]);
			ENTITY::DETACH_ENTITY(uParam0->f_20[1 /*14*/], true, true);
			PED::SET_PED_TO_RAGDOLL(uParam0->f_20[1 /*14*/], &func_25, &func_25, 0, false, false, 0);
	...
	if (!bParam1 && uParam0->f_469[4] && !uParam0->f_469[5])
	{
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
				if (func_77(uParam0->f_20[i /*14*/], Global_35, true) < 22500f)
					return 0;
		}
	}
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3076 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x3093 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x31CF Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3308 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x33B2 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x342A Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x34B9 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x35D4 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x35E0 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3768 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3808 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x381B Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3835 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x389D Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x38C9 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x38FA Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3988 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3B8C Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3BA0 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3BAF Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_79() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3BCA Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3C29 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3C6B Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3C97 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3D13 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3D39 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3D5B Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3D7D Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_61(var uParam0, int iParam1) // Position - 0x3DA1 Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_62(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3DAF Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_63(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3E09 Hash - 0x1A58F423 ^0x2317B76D
{
...
BOOL func_64(var uParam0) // Position - 0x3E59 Hash - 0x5001E582 ^0x5001E582
{
	return func_108(*uParam0, 1);
}

void func_65(var uParam0) // Position - 0x3E69 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_109(uParam0, 0f);
	return;
}

void func_66(var uParam0) // Position - 0x3E78 Hash - 0xE62223CB ^0xE62223CB
{
	if (!uParam0->f_469[7])
	{
		func_110(*uParam0, false);
		uParam0->f_469[7] = 1;
	}
...
void func_67(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3E9D Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_68(var uParam0) // Position - 0x3FA1 Hash - 0x28326647 ^0x16D32202
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (uParam0->f_468 == 256 || uParam0->f_468 == 4 || uParam0->f_468 == 2 || uParam0->f_468 == 16)
		{
			if (!func_113(uParam0->f_20[0 /*14*/], 518218985))
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 256, -1082130432, -1, 0);
				func_73(&uParam0->f_20[0 /*14*/], false, true);
			}
		}
		else if (!func_113(uParam0->f_20[0 /*14*/], 1139527981))
		{
...
void func_69(var uParam0) // Position - 0x4066 Hash - 0x5C40EAAE ^0xBBCD77A0
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], -1767074329))
		{
...
BOOL func_70(var uParam0, float fParam1) // Position - 0x40EB Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_64(uParam0))
		return false;

	if (func_114(uParam0) > fParam1)
		return true;

	return false;
}

BOOL func_71(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4112 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_115(Global_35))
		{
			ped = func_116(Global_35);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_77(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_64(&(uParam0->f_490)))
							func_65(&(uParam0->f_490));
...
BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x431D Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_77(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_64(&(uParam0->f_490)))
						...
						if (func_70(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_64(&(uParam0->f_490)) && !func_122(&(uParam0->f_490)))
...
void func_73(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4446 Hash - 0x6DE5BABD ^0x14BE368D
{
...
Vector3 func_74(var uParam0) // Position - 0x446E Hash - 0xE3B15515 ^0xE3B15515
{
	var unk;
	float num;
	int num2;
	...
	num = 1E+11f;
	num2 = 3;
	num2[0 /*3*/] = { 1459.4622f, 301.6016f, 89.5523f };

	for (i = 0; i < num2; i = i + 1)
	{
		if (!_IS_NULL_VECTOR(num2[i /*3*/]))
		{
			num3 = BUILTIN::VDIST2(uParam0->f_483, num2[i /*3*/]);
...
void func_75(Ped pedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, int iParam6, BOOL bParam7, BOOL bParam8, const char* sParam9, int iParam10) // Position - 0x44F3 Hash - 0xFE770A83 ^0xBFD078B3
{
	TASK::TASK_START_SCENARIO_AT_POSITION(pedParam0, hParam1, vParam2, fParam5, iParam6, bParam7, bParam8, sParam9, iParam10, false);
	return;
}

void func_76(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4514 Hash - 0xC26AC0FE ^0xFF80BBA5
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (bParam1)
...
float func_77(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x4550 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
void func_78(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x45A7 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_79() // Position - 0x46FB Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_80(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4709 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4770 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_82(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4799 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_83(var uParam0, var uParam1, var uParam2) // Position - 0x47E5 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_84(int iParam0) // Position - 0x4834 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_85(int iParam0) // Position - 0x4859 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_86(int iParam0) // Position - 0x486C Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_87(int iParam0) // Position - 0x487F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_88(int iParam0) // Position - 0x4892 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_89(int iParam0) // Position - 0x48A4 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_90(int iParam0, int iParam1) // Position - 0x48B6 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4950 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_92() // Position - 0x4988 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_93(int iParam0) // Position - 0x49DB Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_96(iParam0))
		return -1;
...
BOOL func_94(int iParam0) // Position - 0x49FB Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_95(int iParam0, int iParam1) // Position - 0x4A11 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_96(int iParam0) // Position - 0x4A20 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_97(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4A53 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4B34 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_105(iParam0, 4);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4B52 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_105(iParam0, 8);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4B72 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_105(iParam0, 16);
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4B9D Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_105(iParam0, 32);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4BBD Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_105(iParam0, 64);
	else
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4BDD Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x4BFF Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_105(int iParam0, int iParam1) // Position - 0x4C23 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_106(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4C34 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_107(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x525D Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x527B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_109(var uParam0, float fParam1) // Position - 0x528A Hash - 0x30433BAB ^0xF854D531
{
...
void func_110(int iParam0, BOOL bParam1) // Position - 0x52B0 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_111(int iParam0) // Position - 0x5387 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_112(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5408 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_113(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x54F9 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_114(var uParam0) // Position - 0x5552 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_64(uParam0))
		return uParam0->f_1;
...
BOOL func_115(Ped pedParam0) // Position - 0x5587 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_116(Ped pedParam0) // Position - 0x55A2 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_117(float fParam0) // Position - 0x55BE Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_118(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5605 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_119(var uParam0, float fParam1) // Position - 0x5623 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_120(var uParam0) // Position - 0x5641 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_121(var uParam0, BOOL bParam1) // Position - 0x5657 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_122(var uParam0) // Position - 0x5677 Hash - 0x39705408 ^0x39705408
{
	return func_108(*uParam0, 2);
}

void func_123(var uParam0) // Position - 0x5687 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_64(uParam0);
...
void func_124(var uParam0) // Position - 0x56BB Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_64(uParam0);
...
BOOL func_125(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x56EB Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_126(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5740 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_127(int iParam0, int iParam1) // Position - 0x5757 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_128(int iParam0, int iParam1) // Position - 0x57DD Hash - 0x96B01D2A ^0x81E68218
{
...
void func_129(int iParam0, int iParam1) // Position - 0x5819 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_130(int iParam0, int iParam1) // Position - 0x586C Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_131(int iParam0, int iParam1) // Position - 0x58A7 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_132(int iParam0, int iParam1) // Position - 0x58E0 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_133(int iParam0) // Position - 0x5918 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_134(BOOL bParam0) // Position - 0x5956 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_135(ePedType eptParam0) // Position - 0x5969 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_136(Ped pedParam0, Hash hParam1) // Position - 0x5DBC Hash - 0xFC0422EA ^0x13ACF3B7
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_137(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5E63 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_138(Ped pedParam0, BOOL bParam1) // Position - 0x5E93 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_139(Ped pedParam0, int iParam1) // Position - 0x5ED8 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_140(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5EFF Hash - 0x37D64B11 ^0xE7060A9E
{
	func_178(iParam2);
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x60CA Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_142(Ped pedParam0, int iParam1, int iParam2) // Position - 0x61A1 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x61DE Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_144(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x62C5 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x639B Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_146(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x64A4 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x65D9 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6610 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_149(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6717 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_150(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6782 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_151(Ped pedParam0, int iParam1) // Position - 0x68CA Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_152(var uParam0, int iParam1) // Position - 0x6AA6 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x6B1E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_154(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6B4D Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_155(int iParam0, Ped pedParam1) // Position - 0x6CD3 Hash - 0x42A83B1F ^0xEA3A2883
{
	int _int;
...
BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6D23 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_205(iParam0))
		return true;
...
BOOL func_157(Ped pedParam0, Ped pedParam1) // Position - 0x6DC0 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_158() // Position - 0x6E0D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6E15 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_160() // Position - 0x6ED6 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_161() // Position - 0x6EF4 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_160() - Global_1935630.f_43 >= &func_25)
		return false;

	return true;
}

BOOL func_162(int iParam0, Ped pedParam1) // Position - 0x6F41 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_163(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x705D Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x70A5 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x72FE Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_215(0))
		return false;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x7337 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_167(var uParam0, int iParam1) // Position - 0x7366 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_168(Ped pedParam0, int iParam1) // Position - 0x737A Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_169(int iParam0, Ped pedParam1) // Position - 0x73C7 Hash - 0x6A2A3ADB ^0x2BB4AA9F
{
...
float func_170() // Position - 0x741A Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_171(var uParam0, int iParam1) // Position - 0x744C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_172(var uParam0, int iParam1) // Position - 0x745D Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_173(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7472 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x74FE Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x752C Hash - 0x4252B6E4 ^0x87BCD88A
{
	Hash _int;
...
BOOL func_176(Ped pedParam0, Hash hParam1) // Position - 0x757C Hash - 0x4252B6E4 ^0x87BCD88A
{
	Hash _int;
	int _int2;
...
void func_177(Ped pedParam0) // Position - 0x75EC Hash - 0x12A19BD ^0x2C86239F
{
...
void func_178(int iParam0) // Position - 0x7609 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_179(int iParam0) // Position - 0x7775 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_180(BOOL bParam0) // Position - 0x7788 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_181(int iParam0) // Position - 0x77A2 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_182(int iParam0) // Position - 0x783C Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_183(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7863 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_184(Ped pedParam0, Ped pedParam1) // Position - 0x795C Hash - 0xF9959663 ^0xF9959663
{
	return func_206(pedParam0, pedParam1, true, true);
}

float func_185(int iParam0) // Position - 0x796E Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_186(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x797A Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_187(int iParam0, BOOL bParam1) // Position - 0x79DF Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_188() // Position - 0x7A05 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_189(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7A19 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_190(int iParam0) // Position - 0x7B79 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_191(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7B85 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_192(int iParam0) // Position - 0x7BE6 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_193(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7BF2 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_194(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7CB4 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_195(int iParam0) // Position - 0x7D52 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_196(int iParam0) // Position - 0x7D5E Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_197(int iParam0) // Position - 0x7D6A Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7EA7 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_199(Ped pedParam0) // Position - 0x7EEA Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F50 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F97 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_202(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7FE2 Hash - 0xD77296DF ^0x66C3F600
{
	float num;
...
BOOL func_203(Ped pedParam0, var uParam1) // Position - 0x805D Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_204(Ped pedParam0, Ped pedParam1) // Position - 0x80AA Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_205(int iParam0) // Position - 0x80F2 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_206(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8102 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_207(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x814A Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_208(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8176 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_209(int iParam0) // Position - 0x819E Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_210(Ped pedParam0) // Position - 0x81AA Hash - 0x9302C393 ^0xD5B8371F
{
...
int func_211(Ped pedParam0) // Position - 0x81FE Hash - 0x85BE14AD ^0x548ED1B6
{
...
BOOL func_212(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x826A Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x83DA Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_214(int iParam0, Ped pedParam1) // Position - 0x84C8 Hash - 0x27FC2906 ^0x15FE9842
{
...
BOOL func_215(int iParam0) // Position - 0x853E Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_232())
		return false;
...
int func_216(int iParam0) // Position - 0x8560 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_217(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x856C Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_218(int iParam0) // Position - 0x85E7 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_219() // Position - 0x85FA Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_220() // Position - 0x8608 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_234())
		return false;
...
void func_221(Any* panParam0, int iParam1) // Position - 0x865E Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_222(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8706 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_223(int iParam0) // Position - 0x87CD Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_224(int iParam0) // Position - 0x8875 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_225(Ped pedParam0, int iParam1) // Position - 0x88DA Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_226(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x88F1 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_227(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x891F Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_228(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8969 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_229(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x89AA Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_230(Ped pedParam0) // Position - 0x8A23 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_231(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8B0B Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_232() // Position - 0x8B4D Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_219() != -1)
		return false;
...
BOOL func_233(int iParam0, BOOL bParam1) // Position - 0x8B72 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_234() // Position - 0x8BA3 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_235(int iParam0) // Position - 0x8BD4 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_96(iParam0))
		return -1;
...
int func_236(int iParam0) // Position - 0x8BF0 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_237(int iParam0) // Position - 0x8C31 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
