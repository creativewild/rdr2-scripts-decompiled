...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0x86809AD1
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x6F35024D ^0x73EF3E05
{
	int num;

	uParam0->f_16 = 1;
	func_46(uParam0, "DROP_RABBIT_TABLE", "script@ambient@campfireGeneral@Drop_Rabbit_Table@Action", uParam1, uParam4);
	func_47(uParam0, 2, "Pl_Drop_Exit_Back", "PL_DROP_ADDRESS_EXIT", 0);
	num = func_49(func_48());
	func_50(uParam0, 0, "MALE", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "RABBIT", joaat("A_C_Rabbit_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C28 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CC8 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DE2 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FAB Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FB4 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2164 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21D8 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2227 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x227F Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23E8 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x270F Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2846 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2976 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29B5 Hash - 0x1BAD133C ^0x898C153A
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
	{
		PED::SET_LOOTING_FLAG(uParam0->f_20[1 /*14*/], 0, false);
		PED::SET_LOOTING_FLAG(uParam0->f_20[1 /*14*/], 1, false);
...
void func_29(var uParam0) // Position - 0x2A14 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A46 Hash - 0x897944CB ^0x1C1D82E8
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;

	offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_483, uParam0->f_486.f_2, 1.3375f, -0.4125f, 0.85f) };
	volLocal_37 = VOLUME::_CREATE_VOLUME_BY_HASH(joaat("volBox"), offsetFromCoordAndHeadingInWorldCoords, uParam0->f_486, 2.2825f, 2.6175f, 2.0875f);
	func_58(&uLocal_9, false);
...
int func_31(var uParam0) // Position - 0x2ACA Hash - 0xF5F42978 ^0xAE713125
{
	var unk;
	...
	if (!uParam0->f_469[0])
	{
		...
		{
			if (func_65(uParam0->f_20[0 /*14*/], 0, &uLocal_9, &unk, 0, 0))
			{
	...
	if (!uParam0->f_469[1])
	{
		if (func_68(uParam0, 1065353216, 90f, 4, 1109393408, 1112014848))
		{
			func_66(uParam0);
	...
	if (uParam0->f_469[1])
	{
		if (!uParam0->f_469[2])
		{
			if (func_71(uParam0, 1.2f, 1116471296, 4, joaat("Action"), true))
			{
				func_67(*uParam0, uParam0->f_483, true);
				uParam0->f_469[2] = 1;
			}
	...
	if (uParam0->f_469[1])
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			...
			{
				TASK::TASK_WANDER_STANDARD(uParam0->f_20[0 /*14*/], ENTITY::GET_ENTITY_HEADING(uParam0->f_20[0 /*14*/]), 1);
...
int func_32(var uParam0, var uParam1) // Position - 0x2CF9 Hash - 0x74FE5ACB ^0x74FE5ACB
{
	func_72(uParam0, false, false, false);
	func_5(volLocal_37);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D11 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D2E Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2E6A Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2FA3 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x304D Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x30C5 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3154 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x326F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x327B Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3403 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x34A3 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x34B6 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x34D0 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3538 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3564 Hash - 0xF0D98862 ^0x21440CE
{
...
int func_48() // Position - 0x3595 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_49(int iParam0) // Position - 0x35A3 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
void func_50(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3694 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3722 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x3926 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x393A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3949 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_73() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x3964 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x39C3 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3A05 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3A31 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3AAD Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3AD1 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3AF7 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3B19 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3B3B Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3B5D Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_65(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x3B81 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_66(var uParam0) // Position - 0x41AC Hash - 0x1B3E56A8 ^0x1B3E56A8
{
	if (!uParam0->f_469[1])
	{
...
void func_67(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x41D1 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_68(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x42D5 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_69() // Position - 0x44E0 Hash - 0xCD0FDAB7 ^0xDAFF1072
{
	Ped ped;

	ped = func_143(func_142(func_73()));

	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (func_144(ped, volLocal_37, true, 0))
			return true;

	return false;
}

int func_70(var uParam0) // Position - 0x4511 Hash - 0xA69EEAEA ^0x74F1A0DA
{
	AnimScene animScene;
	char* playbackListName;

	animScene = uParam0->f_3.f_1;
	playbackListName = "PL_DROP_ADDRESS_EXIT";
	...
	ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(animScene, playbackListName, true);
	return 1;
}

BOOL func_71(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x456E Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (!bParam5 || ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[i /*14*/], hParam4))
				{
					if (func_137(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_148(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_138(&(uParam0->f_490)) && !func_146(&(uParam0->f_490)))
...
void func_72(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4697 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_73() // Position - 0x47EB Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x47F9 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4860 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4889 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_150(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_77(var uParam0, var uParam1, var uParam2) // Position - 0x48D5 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_150(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_78(int iParam0) // Position - 0x4924 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_79(int iParam0) // Position - 0x4949 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_80(int iParam0) // Position - 0x495C Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_81(int iParam0) // Position - 0x496F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_82(int iParam0) // Position - 0x4982 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_83(int iParam0) // Position - 0x4994 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_84(int iParam0, int iParam1) // Position - 0x49A6 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4A40 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_86() // Position - 0x4A78 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_87(int iParam0) // Position - 0x4ACB Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_90(iParam0))
		return -1;
...
BOOL func_88(int iParam0) // Position - 0x4AEB Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_89(int iParam0, int iParam1) // Position - 0x4B01 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_90(int iParam0) // Position - 0x4B10 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_91(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4B43 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4C24 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_99(iParam0, 4);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4C42 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_99(iParam0, 8);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4C62 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_99(iParam0, 16);
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4C8D Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_99(iParam0, 32);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4CAD Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_99(iParam0, 64);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4CCD Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4CEF Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_99(int iParam0, int iParam1) // Position - 0x4D13 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_100(int iParam0, BOOL bParam1, int iParam2) // Position - 0x4D24 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_165(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_167(true))
							func_99(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_167(true) || *iParam0 & 8192 != 0)
...
BOOL func_101(Ped pedParam0, int iParam1) // Position - 0x4EEF Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_170(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_171(pedParam0, pedIndexFromEntityIndex) <= func_172(iParam1))
				return true;
			break;
	}
...
void func_102(Ped pedParam0, int iParam1, int iParam2) // Position - 0x4FC6 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_173(iParam2, 1, 1, 1, 0))
		func_99(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_174(iParam1, true);
	func_175();
	return;
}

BOOL func_103(Ped pedParam0, int iParam1) // Position - 0x5003 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	{
		if (func_176(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			num2 = func_177(iParam1);
		
			if (func_178(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_179(iParam1);
...
BOOL func_104(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x50EA Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_180(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_177(iParam2);
	
		if (func_178(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_179(iParam2))
				{
					func_174(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_105(Ped pedParam0, int iParam1) // Position - 0x51C0 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_170(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_179(iParam1))
		{
			customDistance = func_177(iParam1);
...
BOOL func_106(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x52C9 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x53FE Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_108(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5435 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_109(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x553C Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_183(iParam2))
	{
...
BOOL func_110(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x55A7 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_185(pedParam1, entityCoords, outCoords))
					{
						func_174(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_185(pedParam1, entityCoords, outCoords2))
					{
						func_174(iParam2, true);
						return true;
					}
...
BOOL func_111(Ped pedParam0, int iParam1) // Position - 0x56EF Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_170(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_186(Global_1935630.f_34[i]);
			...
			if (func_187(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_188(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_189(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_112(var uParam0, int iParam1) // Position - 0x58CB Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_113(int iParam0, int iParam1) // Position - 0x5943 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_114(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5972 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_115(int iParam0, Ped pedParam1) // Position - 0x5AF8 Hash - 0x6FE758CA ^0xD5DE1FE0
{
	int _int;
...
BOOL func_116(int iParam0, Ped pedParam1) // Position - 0x5B45 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_192(iParam0))
		return true;
...
BOOL func_117(Ped pedParam0, Ped pedParam1) // Position - 0x5BE2 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_193(pedParam0, pedParam1, true, true) < 4f)
...
void func_118() // Position - 0x5C2F Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_119(int iParam0, Ped pedParam1) // Position - 0x5C37 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_194(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_195(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_120() // Position - 0x5CF8 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_121() // Position - 0x5D16 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_122(int iParam0, Ped pedParam1) // Position - 0x5D63 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_196(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_197(pedParam1);
	num2 = func_198(iParam0->f_14);
...
BOOL func_123(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5E7F Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_199(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_124(Ped pedParam0, int iParam1) // Position - 0x5EC7 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_200(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_201(iParam1, pedParam0))
						if (func_195(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_125(Ped pedParam0, int iParam1) // Position - 0x6120 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_202(0))
		return false;
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x6159 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_127(var uParam0, int iParam1) // Position - 0x6188 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_128(Ped pedParam0, int iParam1) // Position - 0x619C Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_120() - iParam1->f_4 > func_203(iParam1))
		return func_204(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_129(int iParam0, Ped pedParam1) // Position - 0x61E9 Hash - 0x7C07F65B ^0x1F066FD6
{
...
void func_130(int iParam0, BOOL bParam1) // Position - 0x623C Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_131(int iParam0) // Position - 0x6313 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_205(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_205(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_205(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_132(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6394 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_150(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_133(Ped pedParam0) // Position - 0x6485 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_134(Ped pedParam0) // Position - 0x64A0 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_135(int iParam0) // Position - 0x64BC Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_136(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6503 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_137(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x6521 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_206(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_138(var uParam0) // Position - 0x6578 Hash - 0x5001E582 ^0x5001E582
{
	return func_207(*uParam0, 1);
}

void func_139(var uParam0) // Position - 0x6588 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_208(uParam0, 0f);
	return;
}

BOOL func_140(var uParam0, int iParam1) // Position - 0x6597 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_141(var uParam0) // Position - 0x65B5 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_142(int iParam0) // Position - 0x65CB Hash - 0x51EA6078 ^0xC495F1F3
{
	int num;
...
Ped func_143(int iParam0) // Position - 0x6624 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;

	persChar = func_209(iParam0);
...
BOOL func_144(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x6652 Hash - 0x6735ACA9 ^0xD6205CC6
{
...
void func_145(var uParam0, BOOL bParam1) // Position - 0x6688 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_146(var uParam0) // Position - 0x66A8 Hash - 0x39705408 ^0x39705408
{
	return func_207(*uParam0, 2);
}

void func_147(var uParam0) // Position - 0x66B8 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_138(uParam0);
...
BOOL func_148(var uParam0, float fParam1) // Position - 0x66EC Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_138(uParam0))
		return false;
...
void func_149(var uParam0) // Position - 0x6713 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_138(uParam0);
...
BOOL func_150(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x6743 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_151(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6798 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_152(int iParam0, int iParam1) // Position - 0x67AF Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_153(int iParam0, int iParam1) // Position - 0x6835 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_154(int iParam0, int iParam1) // Position - 0x6871 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_155(int iParam0, int iParam1) // Position - 0x68C4 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_156(int iParam0, int iParam1) // Position - 0x68FF Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_157(int iParam0, int iParam1) // Position - 0x6938 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_158(int iParam0) // Position - 0x6970 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_159(BOOL bParam0) // Position - 0x69AE Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_160(ePedType eptParam0) // Position - 0x69C1 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_161(Ped pedParam0, Hash hParam1) // Position - 0x6E14 Hash - 0x135A6B02 ^0xC6733837
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_162(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6EBD Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_163(Ped pedParam0, BOOL bParam1) // Position - 0x6EED Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_164(Ped pedParam0, int iParam1) // Position - 0x6F32 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_165(int iParam0) // Position - 0x6F59 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_166(int iParam0) // Position - 0x70C5 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_167(BOOL bParam0) // Position - 0x70D8 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_168(int iParam0) // Position - 0x70F2 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_169(int iParam0) // Position - 0x718C Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_170(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x71B3 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_198(pedParam2);
	else
		num2 = func_197(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_198(pedParam0);
	else
...
float func_171(Ped pedParam0, Ped pedParam1) // Position - 0x72AC Hash - 0xF9959663 ^0xF9959663
{
	return func_193(pedParam0, pedParam1, true, true);
}

float func_172(int iParam0) // Position - 0x72BE Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_173(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x72CA Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_174(int iParam0, BOOL bParam1) // Position - 0x732F Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_175() // Position - 0x7355 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_176(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7369 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_193(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_177(int iParam0) // Position - 0x74C9 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_178(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x74D5 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_179(int iParam0) // Position - 0x7536 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_180(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7542 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_181(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7604 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_182(int iParam0) // Position - 0x76A2 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_183(int iParam0) // Position - 0x76AE Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_184(int iParam0) // Position - 0x76BA Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_185(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x77F7 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_186(Ped pedParam0) // Position - 0x783A Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_187(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78A0 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_188(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78E7 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_189(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7932 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_190(Ped pedParam0, var uParam1) // Position - 0x79AB Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_191(Ped pedParam0, Ped pedParam1) // Position - 0x79F8 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_192(int iParam0) // Position - 0x7A40 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_193(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7A50 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_194(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7A98 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_195(veParam0, uParam2, true);
...
float func_195(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7AC4 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_196(int iParam0) // Position - 0x7AEC Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_197(Ped pedParam0) // Position - 0x7AF8 Hash - 0x2739C471 ^0xB2B3BB8F
{
...
int func_198(Ped pedParam0) // Position - 0x7B4C Hash - 0x5776B619 ^0xBAE3281D
{
...
BOOL func_199(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7BB8 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_193(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_193(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_200(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7D28 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_201(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_201(iParam1, ped2))
					if (func_195(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_201(int iParam0, Ped pedParam1) // Position - 0x7E16 Hash - 0x27FC2906 ^0xDD264BE7
{
...
BOOL func_202(int iParam0) // Position - 0x7E8C Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_231())
		return false;
...
int func_203(int iParam0) // Position - 0x7EAE Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_204(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7EBA Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_205(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7F35 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_233(iParam0) == 1 && bParam7)
		return;
...
float func_206(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7FC1 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_207(int iParam0, int iParam1) // Position - 0x7FDF Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_208(var uParam0, float fParam1) // Position - 0x7FEE Hash - 0x36F1A656 ^0x534C102E
{
...
PersChar func_209(int iParam0) // Position - 0x8016 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_234(iParam0))
		return 0;
...
float func_210() // Position - 0x8036 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_211(var uParam0, int iParam1) // Position - 0x8068 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_212(var uParam0) // Position - 0x807D Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_138(uParam0))
		return uParam0->f_1;
...
void func_213(var uParam0, int iParam1) // Position - 0x80B2 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_214(Ped pedParam0, Hash hParam1) // Position - 0x80C3 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_215(Ped pedParam0, Hash hParam1) // Position - 0x80F1 Hash - 0x63112271 ^0xE3E62B05
{
	Hash _int;
...
BOOL func_216(Ped pedParam0, Hash hParam1) // Position - 0x8141 Hash - 0x63112271 ^0xE3E62B05
{
	Hash _int;
	int _int2;
...
void func_217(Ped pedParam0) // Position - 0x81B1 Hash - 0x84FD9DAD ^0xDA583C58
{
...
BOOL func_218() // Position - 0x81CE Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_235())
		return false;
...
void func_219(Any* panParam0, int iParam1) // Position - 0x8224 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_220(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82CC Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_221() // Position - 0x8393 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_222(int iParam0) // Position - 0x83A1 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_223(int iParam0) // Position - 0x8449 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_224(Ped pedParam0, int iParam1) // Position - 0x84AE Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_225(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x84C5 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_226(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x84F3 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_227(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x853D Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_228(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x857E Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_229(Ped pedParam0) // Position - 0x85F7 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_230(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x86DF Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_231() // Position - 0x8721 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_221() != -1)
		return false;
...
BOOL func_232(int iParam0, BOOL bParam1) // Position - 0x8746 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_233(int iParam0) // Position - 0x8777 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_234(int iParam0) // Position - 0x878A Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

BOOL func_235() // Position - 0x87A1 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_236(int iParam0) // Position - 0x87D2 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_90(iParam0))
		return -1;
...
int func_237(int iParam0) // Position - 0x87EE Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_238(int iParam0) // Position - 0x882F Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
