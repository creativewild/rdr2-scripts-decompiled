...
BOOL func_42(var uParam0) // Position - 0x1583 Hash - 0x84A1E042 ^0x44647031
{
	*uParam0 = 2;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = joaat("p_bighornramscat_01x");
	uParam0->f_572[1] = joaat("eag_eye_trck_ram_aa");
	uParam0->f_572[2] = joaat("p_bighorntufts01x");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 5;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_596[2] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_671 = { -0.0868241f, 0.492404f, 1.33f };
	uParam0->f_12.f_1 = joaat("a_c_bighornram_01");
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = joaat("META_OUTFIT_ANIMAL_ALBINO_BIGHORNRAM");
	uParam0->f_12.f_3 = 1.1f;
	return true;
}
...
{
	return func_204("ATZ_INS_EXC_BG");
}

Vector3 func_161() // Position - 0x78E0 Hash - 0x1DA0618A ^0xAC40CBAA
{
	return func_204("ATZ_INS_FUR_BG");
}
...
{
	return func_204("ATZ_INS_TRB_BG");
}
...
Hash func_171() // Position - 0x7BA7 Hash - 0x9F572D68 ^0x9A8CCD75
{
	return -808485662;
}
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0x8961 Hash - 0x24E72BF3 ^0x24E72BF3
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -1053.9426f, 774.46f, 123.397f;
			
				case 1:
					return -948.5314f, 895.2468f, 138.4047f;
			
				case 2:
					return -1004.8444f, 750.6244f, 116.6094f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return -945.6205f, 851.603f, 129.2862f;
			
				case 1:
					return -1084.2081f, 835.4189f, 116.1535f;
			
				case 2:
					return -1054.1022f, 867.2668f, 121.9913f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return -959.266f, 818.441f, 120.111f;
			
				case 1:
					return -1025.412f, 850.984f, 117.683f;
			
				case 2:
					return -1009.462f, 864.066f, 119.961f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return -1002.5039f, 798.8792f, 117.5009f;
			
				case 1:
					return -996.9072f, 884.1312f, 124.106f;
			
				case 2:
					return -1010.1081f, 820.0167f, 117.1967f;
			}
			break;
	}
