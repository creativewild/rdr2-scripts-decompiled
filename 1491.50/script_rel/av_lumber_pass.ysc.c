...
void main() // Position - 0x0 Hash - 0x110FF481 ^0x5F9B3684
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x85137DF3
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0xBB1B032D ^0xE9170EFD
{
	func_46(uParam0, "LUMBER_PASS_BALCONY", "script@ambient@town@LUMBER_PASS_BALCONY@action", uParam1, uParam4);
	uParam0->f_17 = 1;

	switch (*uParam0)
	{
		case 10:
			func_47(uParam0, 1, "pbl_ActionDown", "", 0);
			break;
	
		case 11:
			func_47(uParam0, 1, "pbl_ActionUp", "", 0);
			break;
	}

	func_48(uParam0, 0, "Male01", joaat("a_m_m_vallaborer_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 1, "male", joaat("a_m_m_vallaborer_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 0, "LUMBER", joaat("p_lumber09_piece01x"), 0f, 0f, 0f, 0f, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C6C Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D0C Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E26 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FEF Hash - 0x6C3DF270 ^0x791ED27E
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(joaat("world_human_crouch_inspect"), false))
		return 0;

	return 1;
}

BOOL func_19(var uParam0) // Position - 0x200A Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21BA Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x222E Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x227D Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22D5 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x243E Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2765 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x289C Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29CC Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A0B Hash - 0xD33DF612 ^0xFF22A7DF
{
	if (*uParam0 == 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			PED::_REQUEST_MOTION_TYPE_ASSET(835253196, uParam0->f_20[0 /*14*/]);
		
			if (PED::HAS_MOTION_TYPE_ASSET_LOADED(835253196, uParam0->f_20[0 /*14*/]))
				return true;
		}
...
void func_29(var uParam0) // Position - 0x2A55 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A87 Hash - 0xEFD6F2C8 ^0xD88DE985
{
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("world_human_crouch_inspect"), 5, 0, joaat("world_human_crouch_inspect_male_c"));
...
int func_31(var uParam0) // Position - 0x2AD9 Hash - 0x8610EB01 ^0x76461A9
{
	int taskSequenceId;

	if (!uParam0->f_469[0])
	{
		if (func_65(uParam0, &uLocal_9, true))
			uParam0->f_469[0] = 1;
		else if (ANIMSCENE::_0xA96619FE85159ED2(uParam0->f_3.f_1) || ANIMSCENE::_0xD70C7A30412F8FA0(uParam0->f_3.f_1) || ANIMSCENE::_0x9AAE3C1148A09BCA(uParam0->f_3.f_1))
			uParam0->f_469[0] = 1;
	...
	if (!uParam0->f_469[1])
	{
		if (!ENTITY::IS_ENTITY_DEAD(Global_35) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
			if (func_68(uParam0, 0.5f, fLocal_37, 4, fLocal_38, 1112014848))
			{
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
	...
	if (uParam0->f_469[2] && !uParam0->f_469[3])
	{
		if (!uParam0->f_469[7])
		{
			if (func_69(uParam0, 1065353216, 1116471296, 4, joaat("Action"), true))
			{
				func_67(*uParam0, uParam0->f_483, false);
				uParam0->f_469[7] = 1;
			}
		...
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
		{
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
			{
				...
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_372[0 /*8*/]))
					{
						if (*uParam0 == 10)
						{
							PED::_GIVE_PED_SCENARIO_PROP(uParam0->f_20[0 /*14*/], uParam0->f_372[0 /*8*/], "p_lumber09_piece01x_PH_R_HAND", "WORLD_HUMAN_LUMBER_PUT_DOWN_1", 0, true);
							bLocal_39 = true;
						}
						else
						{
				...
				if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
					{
						...
						if (*uParam0 == 10)
							TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(0, -297.13f, 816.86f, 117.82f, 0.5f, 1000, true, true, false, false);
					
						TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(0, -300.2f, 817.09f, 117.63f, 0.5f, 90000, true, true, false, false);
				...
				if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
				{
					...
					{
						TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], joaat("world_human_crouch_inspect"), 5000, false, joaat("world_human_crouch_inspect_male_c"), 0.3f, false);
	...
	if (bLocal_39)
		PED::SET_PED_RESET_FLAG(uParam0->f_20[0 /*14*/], 202, true);

	if (uParam0->f_469[5] && uParam0->f_469[6] && uParam0->f_469[4])
		uParam0->f_469[3] = 1;
...
int func_32(var uParam0, var uParam1) // Position - 0x2E31 Hash - 0xA57FA590 ^0xBC66D2C8
{
	if (*uParam0 == 10)
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			PED::_REMOVE_MOTION_TYPE_ASSET(835253196, uParam0->f_20[0 /*14*/]);
	else if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_372[0 /*8*/]))
		ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_372[0 /*8*/], false);

	func_70(uParam0, true, true, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2E99 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2EB6 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2FF2 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x312B Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x31D5 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x324D Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_72(entityForwardVector, unk5);
	...
	if (func_73(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x32DC Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x33F7 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3403 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	for (m = func_82(i, num); num2 > m; m = func_82(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_83(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x358B Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x362B Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x363E Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3658 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x36C0 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x36EC Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x371D Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x37AB Hash - 0xD25940D1 ^0x34109BE0
{
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3804 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_86(num) && func_87(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_51(int iParam0) // Position - 0x3A08 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3A1C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3A2B Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_71() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3A46 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3AA5 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_89(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_56(Ped pedParam0) // Position - 0x3AE7 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x3B13 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
		func_90(iParam0, true);
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3B8F Hash - 0x97140DD8 ^0xF9889272
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3BB5 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3BDB Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3BFD Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3C1F Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3C41 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
		func_9(&(uParam0->f_1), 16);
	else
		func_97(&(uParam0->f_1), 16);

	return;
}

void func_64(var uParam0, BOOL bParam1) // Position - 0x3C65 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
BOOL func_65(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C89 Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_98(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_66(var uParam0) // Position - 0x3CE3 Hash - 0xC18BD09E ^0xC18BD09E
{
	if (!uParam0->f_469[8])
	{
...
void func_67(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3D0A Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
	...
	func_100(iParam0);
	func_101(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

BOOL func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E0E Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_102(Global_35))
		{
			ped = func_103(Global_35);
		...
		num = num * num;
		fParam2 = func_104(fParam2);
		num2 = func_105(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_106(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_109(&(uParam0->f_490), fParam1))
						{
...
BOOL func_69(var uParam0, int iParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4019 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_104(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_106(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_107(&(uParam0->f_490)))
							func_111(&(uParam0->f_490), false);
					
						if (func_112(&(uParam0->f_490)))
							func_113(&(uParam0->f_490));
					
						if (func_114(&(uParam0->f_490), iParam1))
							return true;
						else
							return false;
					}
		...
		if (func_107(&(uParam0->f_490)) && !func_112(&(uParam0->f_490)))
...
void func_70(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4142 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_71() // Position - 0x4296 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_72(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x42A4 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x430B Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_74(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4334 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_75(var uParam0, var uParam1, var uParam2) // Position - 0x4380 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_76(int iParam0) // Position - 0x43CF Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_77(int iParam0) // Position - 0x43F4 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_78(int iParam0) // Position - 0x4407 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_79(int iParam0) // Position - 0x441A Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_80(int iParam0) // Position - 0x442D Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_81(int iParam0) // Position - 0x443F Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_82(int iParam0, int iParam1) // Position - 0x4451 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x44EB Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_84() // Position - 0x4523 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_85(int iParam0) // Position - 0x4576 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_88(iParam0))
		return -1;
...
BOOL func_86(int iParam0) // Position - 0x4596 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_87(int iParam0, int iParam1) // Position - 0x45AC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_88(int iParam0) // Position - 0x45BB Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_89(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x45EE Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_90(int iParam0, BOOL bParam1) // Position - 0x46CF Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_97(iParam0, 4);
	else
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x46ED Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_97(iParam0, 8);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x470D Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_97(iParam0, 16);
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4738 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_97(iParam0, 32);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4758 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_97(iParam0, 64);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4778 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_97(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x479A Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_97(iParam0, 1048576);
	else
...
void func_97(int iParam0, int iParam1) // Position - 0x47BE Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_98(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x47CF Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4DF8 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_100(int iParam0) // Position - 0x4ECF Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_161(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_161(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_161(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_101(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4F50 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_102(Ped pedParam0) // Position - 0x5041 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_103(Ped pedParam0) // Position - 0x505C Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_104(int iParam0) // Position - 0x5078 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_105(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x50BF Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_106(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x50DD Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_162(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_107(var uParam0) // Position - 0x5134 Hash - 0x5001E582 ^0x5001E582
{
	return func_163(*uParam0, 1);
}

void func_108(var uParam0) // Position - 0x5144 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_164(uParam0, 0f);
	return;
}

BOOL func_109(var uParam0, float fParam1) // Position - 0x5153 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_110(var uParam0) // Position - 0x5171 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_111(var uParam0, BOOL bParam1) // Position - 0x5187 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_112(var uParam0) // Position - 0x51A7 Hash - 0x39705408 ^0x39705408
{
	return func_163(*uParam0, 2);
}

void func_113(var uParam0) // Position - 0x51B7 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_107(uParam0);
...
BOOL func_114(var uParam0, int iParam1) // Position - 0x51EB Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_107(uParam0))
		return false;

	if (func_167(uParam0) > iParam1)
		return true;

	return false;
}

void func_115(var uParam0) // Position - 0x5212 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_107(uParam0);
...
BOOL func_116(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5242 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_117(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5297 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_118(int iParam0, int iParam1) // Position - 0x52AE Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_119(int iParam0, int iParam1) // Position - 0x5334 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_120(int iParam0, int iParam1) // Position - 0x5370 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;

	num = func_77(*iParam0);
	num2 = func_76(*iParam0);

	if (iParam1 < 1 || iParam1 > func_82(num, num2))
		return;
...
void func_121(int iParam0, int iParam1) // Position - 0x53C3 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_122(int iParam0, int iParam1) // Position - 0x53FE Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_123(int iParam0, int iParam1) // Position - 0x5437 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_124(int iParam0) // Position - 0x546F Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_125(BOOL bParam0) // Position - 0x54AD Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_126(ePedType eptParam0) // Position - 0x54C0 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_127(Ped pedParam0, Hash hParam1) // Position - 0x5913 Hash - 0x600926AD ^0x863E7669
{
...
void func_128(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x59BA Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_129(Ped pedParam0, BOOL bParam1) // Position - 0x59EA Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_130(Ped pedParam0, int iParam1) // Position - 0x5A2F Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_131(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5A56 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_173(iParam2);
...
BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x5C21 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_133(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5CF8 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_181(iParam2, 1, 1, 1, 0))
		func_97(iParam1, 2048);
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x5D35 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_135(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5E1C Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x5EF2 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_137(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5FFB Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_138(int iParam0, int iParam1) // Position - 0x6130 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_139(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6167 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_140(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x626E Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x62D9 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x6421 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_143(var uParam0, int iParam1) // Position - 0x65FF Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0x6677 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_145(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x66A6 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_146(int iParam0, Ped pedParam1) // Position - 0x682C Hash - 0x42A83B1F ^0x7A8E423C
{
	int _int;
...
BOOL func_147(int iParam0, Ped pedParam1) // Position - 0x687C Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_200(iParam0))
		return true;
...
BOOL func_148(Ped pedParam0, Ped pedParam1) // Position - 0x6919 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_149() // Position - 0x6966 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_150(int iParam0, Ped pedParam1) // Position - 0x696E Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_151() // Position - 0x6A2F Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_152() // Position - 0x6A4D Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x6A9A Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_154(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6BB6 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_155(Ped pedParam0, int iParam1) // Position - 0x6BFE Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_156(Ped pedParam0, int iParam1) // Position - 0x6E57 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_210(0))
		return false;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x6E90 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_158(var uParam0, int iParam1) // Position - 0x6EBF Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6ED3 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_160(int iParam0, Ped pedParam1) // Position - 0x6F20 Hash - 0x8EC05B04 ^0x6D6A6AE3
{
...
void func_161(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6F73 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_162(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6FFF Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x701D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_164(var uParam0, float fParam1) // Position - 0x702C Hash - 0x30433BAB ^0xF854D531
{
...
float func_165() // Position - 0x7052 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_166(var uParam0, int iParam1) // Position - 0x7084 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_167(var uParam0) // Position - 0x7099 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_107(uParam0))
		return uParam0->f_1;
...
void func_168(var uParam0, int iParam1) // Position - 0x70CE Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x70DF Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x710D Hash - 0x4EE5921D ^0x3BA328C
{
	Hash _int;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x715D Hash - 0x4EE5921D ^0x3BA328C
{
	Hash _int;
	int _int2;
...
void func_172(Ped pedParam0) // Position - 0x71CD Hash - 0x8A0583BB ^0x63E98ECD
{
...
void func_173(int iParam0) // Position - 0x71EA Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_174(int iParam0) // Position - 0x7356 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_175(BOOL bParam0) // Position - 0x7369 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_176(int iParam0) // Position - 0x7383 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_177(int iParam0) // Position - 0x741D Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_178(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7444 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_179(Ped pedParam0, Ped pedParam1) // Position - 0x753D Hash - 0xF9959663 ^0xF9959663
{
	return func_201(pedParam0, pedParam1, true, true);
}

float func_180(int iParam0) // Position - 0x754F Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_181(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x755B Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_182(int iParam0, BOOL bParam1) // Position - 0x75C0 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_97(iParam0, 134217728);
	else
...
void func_183() // Position - 0x75E6 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_184(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x75FA Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_185(int iParam0) // Position - 0x775A Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_186(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7766 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_187(int iParam0) // Position - 0x77C7 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_188(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x77D3 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_189(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7895 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_190(int iParam0) // Position - 0x7933 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_191(int iParam0) // Position - 0x793F Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_192(int iParam0) // Position - 0x794B Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_193(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7A88 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_194(Ped pedParam0) // Position - 0x7ACB Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B31 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B78 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7BC3 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_198(Ped pedParam0, var uParam1) // Position - 0x7C3C Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_199(Ped pedParam0, Ped pedParam1) // Position - 0x7C89 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_200(int iParam0) // Position - 0x7CD1 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_201(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7CE1 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_202(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7D29 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7D55 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_204(int iParam0) // Position - 0x7D7D Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_205(Ped pedParam0) // Position - 0x7D89 Hash - 0xAF17A200 ^0xB42249EB
{
...
int func_206(Ped pedParam0) // Position - 0x7DDF Hash - 0x56CB4449 ^0x95F325C3
{
...
BOOL func_207(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7E4D Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7FBD Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_209(int iParam0, Ped pedParam1) // Position - 0x80B0 Hash - 0x27FC2906 ^0x1D54C33A
{
...
BOOL func_210(int iParam0) // Position - 0x8126 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_227())
		return false;
...
int func_211(int iParam0) // Position - 0x8148 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8154 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_213(int iParam0) // Position - 0x81CF Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_214() // Position - 0x81E2 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_215() // Position - 0x81F0 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_229())
		return false;
...
void func_216(Any* panParam0, int iParam1) // Position - 0x8246 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_217(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82EF Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_218(int iParam0) // Position - 0x83B6 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_219(int iParam0) // Position - 0x845E Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_220(Ped pedParam0, int iParam1) // Position - 0x84C3 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_221(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x84DA Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_222(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8508 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_223(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8552 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_224(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8593 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_225(Ped pedParam0) // Position - 0x860C Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_226(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x86F4 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_227() // Position - 0x8736 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_214() != -1)
		return false;
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x875B Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_229() // Position - 0x878C Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_230(int iParam0) // Position - 0x87BD Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_88(iParam0))
		return -1;
...
int func_231(int iParam0) // Position - 0x87D9 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_232(int iParam0) // Position - 0x881A Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
