...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0xDE9699AD
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x4719BE1F
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0xCD0DF656 ^0x816C662F
{
	func_46(uParam0, "SWIM_WOLF_CHASE_MOOSE", "", vParam1, uParam4);
	func_47(uParam0, 0, "SWCMP_WOLF", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -18.5f, 0f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "SWCMP_ANIMAL", iLocal_10, vParam1, uParam4.f_2, 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_MOOSE_M_001"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C2D Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CCD Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DE7 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FB0 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FB9 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2169 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21DD Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x222C Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2284 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23ED Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2714 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x284B Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x297B Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29BA Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29C3 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x29F5 Hash - 0x6C10550A ^0x6C10550A
{
	func_55(&uLocal_22, false);
	func_56(&uLocal_22, true);
	func_57(&uLocal_22, true);
	func_58(&uLocal_22, true);
	func_59(&uLocal_22, true);
	func_60(&uLocal_22, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2A28 Hash - 0x38115BE5 ^0xFA272A7B
{
	int taskSequenceId;

	if (!uParam0->f_469[1])
	{
		if (func_61(uParam0, &uLocal_22, false))
		{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			{
				uLocal_12[0] = func_63(joaat("Stand"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, false);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], uLocal_12[0], 0, 0, false, true, 0, false, -1082130432, false);
				TASK::_SET_SCENARIO_POINT_FLAG(uLocal_12[0], 20, true);
				TASK::_SET_SCENARIO_POINT_FLAG(uLocal_12[0], 25, true);
				TASK::_SET_SCENARIO_POINT_FLAG(uLocal_12[0], 23, true);
				TASK::SET_PED_PATH_PREFER_TO_AVOID_WATER(uParam0->f_20[0 /*14*/], false, 1065353216);
				func_64(&uParam0->f_20[0 /*14*/], true, true);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				TASK::_0x2E1D6D87346BB7D2(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0, 0);
				uLocal_12[1] = func_63(joaat("Stand"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, false);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], uLocal_12[1], 0, 0, false, true, 0, false, -1082130432, false);
				TASK::_SET_SCENARIO_POINT_FLAG(uLocal_12[1], 20, true);
				func_64(&uParam0->f_20[1 /*14*/], true, true);
		...
		case 1:
			...
			{
				func_62(uParam0);
				uLocal_15 = { func_66(uParam0) };
			
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					func_64(&uParam0->f_20[1 /*14*/], true, true);
					TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[1 /*14*/], 0f, 20f, 0f), 3f, -1, 1048576000, 8193, 1193033728);
					TASK::TASK_FLEE_PED(0, uParam0->f_20[0 /*14*/], 3, 256, -1082130432, -1, 0);
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					func_64(&uParam0->f_20[0 /*14*/], true, true);
					TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[1 /*14*/], 0f, 5f, 0f, 2f, 12000, 1036831949, true, true, false, true, true, false);
					func_67(0, joaat("world_animal_wolf_resting"), uLocal_15, uParam0->f_20[1 /*14*/].f_8, 45000, true, false, 0, -1082130432);
					TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
		...
		case 4:
			if (!bLocal_18)
			{
				if (func_69(uParam0->f_20[0 /*14*/], Global_35, true) < 225f)
				{
					func_64(&uParam0->f_20[0 /*14*/], false, true);
					bLocal_18 = true;
				}
			}
		
			if (!func_70(uParam0->f_20[0 /*14*/], SCRIPT_TASK_PERFORM_SEQUENCE))
				return 1;
			break;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2D57 Hash - 0x22B3CA4B ^0xAF9A36FB
{
	int i;
	...
	for (i = 0; i < uParam0->f_19; i = i + 1)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_12[i]))
			TASK::_DELETE_SCENARIO_POINT(uLocal_12[i]);
	}

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D95 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DB2 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2EEE Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3027 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30D1 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3149 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31D8 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x32F3 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x32FF Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3487 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3527 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x353A Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3554 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35BC Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x35E8 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_48(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3676 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_49(int iParam0) // Position - 0x387A Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x388E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_51() // Position - 0x389D Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_72() != -1;
}

BOOL func_52(var uParam0, Any* panParam1) // Position - 0x38B8 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_53(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3917 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_54(Ped pedParam0) // Position - 0x3959 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_55(int iParam0, BOOL bParam1) // Position - 0x3985 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_56(var uParam0, BOOL bParam1) // Position - 0x3A01 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3A27 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3A49 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3A6B Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3A8D Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_61(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3AB1 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_62(var uParam0) // Position - 0x3B0B Hash - 0x49BD0E06 ^0x49BD0E06
{
	if (!uParam0->f_469[2])
	{
	...
	if (!uParam0->f_469[3])
	{
		func_101(*uParam0, uParam0->f_483, false);
		uParam0->f_469[3] = 1;
	}
...
int func_63(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3B54 Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

void func_64(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B6E Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_65(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3B96 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_69(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_106(&(uParam0->f_490)))
							func_68(&(uParam0->f_490));
					
						if (func_107(&(uParam0->f_490), fParam1))
						{
...
Vector3 func_66(var uParam0) // Position - 0x3DA1 Hash - 0xC402B86B ^0xC402B86B
{
	var unk;
	float num;
	int num2;
	...
	num = 1E+11f;
	num2 = 2;
	num2[0 /*3*/] = { -2447.719f, -521.309f, 141.189f };
	num2[1 /*3*/] = { 619.494f, 2197.675f, 221.987f };
	num2[1 /*3*/] = { -1872.153f, 1824.989f, 234.83f };
...
void func_67(Ped pedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, int iParam6, BOOL bParam7, BOOL bParam8, const char* sParam9, int iParam10) // Position - 0x3E52 Hash - 0xFE770A83 ^0xBFD078B3
{
	TASK::TASK_START_SCENARIO_AT_POSITION(pedParam0, hParam1, vParam2, fParam5, iParam6, bParam7, bParam8, sParam9, iParam10, false);
	return;
}

void func_68(var uParam0) // Position - 0x3E73 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_109(uParam0, 0f);
	return;
}

float func_69(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3E82 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_110(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_70(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3ED9 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_71(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3F32 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_72() // Position - 0x4088 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_73(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4096 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_74(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x40FD Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4126 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_76(var uParam0, var uParam1, var uParam2) // Position - 0x4172 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_77(int iParam0) // Position - 0x41C1 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_78(int iParam0) // Position - 0x41E6 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_79(int iParam0) // Position - 0x41F9 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_80(int iParam0) // Position - 0x420C Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_81(int iParam0) // Position - 0x421F Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_82(int iParam0) // Position - 0x4231 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_83(int iParam0, int iParam1) // Position - 0x4243 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x42DD Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_85() // Position - 0x4315 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_86(int iParam0) // Position - 0x4368 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_89(iParam0))
		return -1;

	return func_120(func_119(iParam0));
}

BOOL func_87(int iParam0) // Position - 0x4388 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_88(int iParam0, int iParam1) // Position - 0x439E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_89(int iParam0) // Position - 0x43AD Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_90(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x43E0 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_121(eptParam1))
		{
			func_122(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_124(pedParam0, false);
			flag = true;
		}
	
		func_125(pedParam0, iParam2);
	}
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x44C1 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_98(iParam0, 4);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x44DF Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_98(iParam0, 8);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x44FF Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_98(iParam0, 16);
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x452A Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_98(iParam0, 32);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x454A Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_98(iParam0, 64);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x456A Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x458C Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_98(int iParam0, int iParam1) // Position - 0x45B0 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_99(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x45C1 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_126(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_128(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_130(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_128(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_132(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_133(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_136(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_128(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_136(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_128(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				...
				{
					if (func_140(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_141(iParam2, pedParam0) && func_142(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_128(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_140(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_141(iParam2, pedParam0) && func_142(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_128(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_143(pedParam0, Global_1935630.f_41))
							{
								func_144();
								*uParam3 = 2;
								func_128(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_145(iParam2, pedParam0) || iParam2->f_9 > 0 && func_146() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_147())
					{
						if (func_143(pedParam0, Global_1935630.f_42))
						{
							func_144();
							*uParam3 = 2;
							func_128(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_149(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_128(pedParam0, iParam2, *uParam3);
					return true;
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4BEA Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_101(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4CC1 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
Ped func_103(Ped pedParam0) // Position - 0x4DE0 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_104(float fParam0) // Position - 0x4DFC Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_105(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4E43 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_106(var uParam0) // Position - 0x4E61 Hash - 0x5001E582 ^0x5001E582
{
	return func_158(*uParam0, 1);
}

BOOL func_107(var uParam0, float fParam1) // Position - 0x4E71 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_108(var uParam0) // Position - 0x4E8F Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_109(var uParam0, float fParam1) // Position - 0x4EA5 Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_160() - fParam1;
	func_161(uParam0, 1);
	func_162(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
float func_110(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4ECB Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_111(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x4EE9 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_112(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4F3E Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_113(int iParam0, int iParam1) // Position - 0x4F55 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_114(int iParam0, int iParam1) // Position - 0x4FDB Hash - 0x96B01D2A ^0x81E68218
{
...
void func_115(int iParam0, int iParam1) // Position - 0x5017 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_116(int iParam0, int iParam1) // Position - 0x506A Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_117(int iParam0, int iParam1) // Position - 0x50A5 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_118(int iParam0, int iParam1) // Position - 0x50DE Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_119(int iParam0) // Position - 0x5116 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_120(BOOL bParam0) // Position - 0x5154 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_121(ePedType eptParam0) // Position - 0x5167 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_122(Ped pedParam0, Hash hParam1) // Position - 0x55BA Hash - 0x242ED45F ^0xEDACBC5A
{
...
void func_123(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5661 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_124(Ped pedParam0, BOOL bParam1) // Position - 0x5691 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_125(Ped pedParam0, int iParam1) // Position - 0x56D6 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_126(int iParam0, BOOL bParam1, int iParam2) // Position - 0x56FD Hash - 0x37D64B11 ^0xE7060A9E
{
	func_167(iParam2);
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_170(iParam0))
				iParam0->f_15 = func_146();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_146() - iParam0->f_15 > 500)
			{
...
BOOL func_127(Ped pedParam0, int iParam1) // Position - 0x58C8 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_128(Ped pedParam0, int iParam1, int iParam2) // Position - 0x599F Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_129(Ped pedParam0, int iParam1) // Position - 0x59DC Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_130(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5AC3 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_131(Ped pedParam0, int iParam1) // Position - 0x5B99 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_132(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5CA2 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x5DD7 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_134(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5E0E Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_135(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5F15 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_136(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5F80 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x60C8 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_138(var uParam0, int iParam1) // Position - 0x62A4 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x631C Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_140(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x634B Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_141(int iParam0, Ped pedParam1) // Position - 0x64D1 Hash - 0xC1DDC87A ^0xAF960886
{
	int _int;
...
BOOL func_142(int iParam0, Ped pedParam1) // Position - 0x651E Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_194(iParam0))
		return true;
...
BOOL func_143(Ped pedParam0, Ped pedParam1) // Position - 0x65BB Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_144() // Position - 0x6608 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_145(int iParam0, Ped pedParam1) // Position - 0x6610 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_146() // Position - 0x66D1 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_147() // Position - 0x66EF Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_146() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x673C Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_149(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6858 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_150(Ped pedParam0, int iParam1) // Position - 0x68A0 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_151(Ped pedParam0, int iParam1) // Position - 0x6AF9 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_204(0))
		return false;
...
BOOL func_152(int iParam0, int iParam1) // Position - 0x6B32 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_153(var uParam0, int iParam1) // Position - 0x6B61 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_154(Ped pedParam0, int iParam1) // Position - 0x6B75 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_146();
	else if (func_146() - iParam1->f_4 > func_205(iParam1))
		return func_206(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6BC2 Hash - 0xED2DEA79 ^0xA54532F9
{
...
void func_156(int iParam0) // Position - 0x6C15 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_157(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6C96 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x6D87 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_159(var uParam0, float fParam1) // Position - 0x6D96 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_106(uParam0))
		return false;
...
float func_160() // Position - 0x6DBD Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_161(var uParam0, int iParam1) // Position - 0x6DEF Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_162(var uParam0, int iParam1) // Position - 0x6E00 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_163(Ped pedParam0, Hash hParam1) // Position - 0x6E15 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_164(Ped pedParam0, Hash hParam1) // Position - 0x6E43 Hash - 0x798DCAF ^0xB4028207
{
	Hash _int;
...
BOOL func_165(Ped pedParam0, Hash hParam1) // Position - 0x6E91 Hash - 0x798DCAF ^0xB4028207
{
	Hash _int;
	int _int2;
...
void func_166(Ped pedParam0) // Position - 0x6EFF Hash - 0xE38B061 ^0x16D726C0
{
...
void func_167(int iParam0) // Position - 0x6F1B Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_168(int iParam0) // Position - 0x7087 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_169(BOOL bParam0) // Position - 0x709A Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_170(int iParam0) // Position - 0x70B4 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_171(int iParam0) // Position - 0x714C Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_172(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7173 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_173(Ped pedParam0, Ped pedParam1) // Position - 0x726C Hash - 0xF9959663 ^0xF9959663
{
	return func_195(pedParam0, pedParam1, true, true);
}

float func_174(int iParam0) // Position - 0x727E Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_175(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x728A Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x72EF Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_177() // Position - 0x7315 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_178(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7329 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_179(int iParam0) // Position - 0x7489 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_180(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7495 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_181(int iParam0) // Position - 0x74F6 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_182(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7502 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_183(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x75C4 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_184(int iParam0) // Position - 0x7662 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_185(int iParam0) // Position - 0x766E Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_186(int iParam0) // Position - 0x767A Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_187(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x77B7 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_188(Ped pedParam0) // Position - 0x77FA Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_189(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7860 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_190(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78A7 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_191(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x78F2 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_192(Ped pedParam0, var uParam1) // Position - 0x796B Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_193(Ped pedParam0, Ped pedParam1) // Position - 0x79B8 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_194(int iParam0) // Position - 0x7A00 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_195(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7A10 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_196(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7A58 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7A84 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_198(int iParam0) // Position - 0x7AAC Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_199(Ped pedParam0) // Position - 0x7AB8 Hash - 0xB32FFFCE ^0x93B18802
{
...
int func_200(Ped pedParam0) // Position - 0x7B0C Hash - 0xC048F8F ^0x383E933C
{
...
BOOL func_201(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7B76 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_202(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7CE6 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_203(int iParam0, Ped pedParam1) // Position - 0x7DD4 Hash - 0x3EAECAE4 ^0x135ED17E
{
...
BOOL func_204(int iParam0) // Position - 0x7E48 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_222())
		return false;
...
int func_205(int iParam0) // Position - 0x7E6A Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_206(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7E76 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_207(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7EF1 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_208(var uParam0) // Position - 0x7F7D Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_106(uParam0))
		return uParam0->f_1;
	...
	return func_160() - uParam0->f_1;
}

BOOL func_209() // Position - 0x7FB2 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_226())
		return false;
...
void func_210(Any* panParam0, int iParam1) // Position - 0x8009 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_211(BOOL bParam0, var uParam1, var uParam2) // Position - 0x80B1 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_212() // Position - 0x8178 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_213(int iParam0) // Position - 0x8186 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_214(int iParam0) // Position - 0x822E Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_215(Ped pedParam0, int iParam1) // Position - 0x8293 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_216(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x82AA Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_217(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x82D8 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_218(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8322 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_219(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8363 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_220(Ped pedParam0) // Position - 0x83DC Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_221(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x84C4 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_222() // Position - 0x8506 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_212() != -1)
		return false;
...
BOOL func_223(int iParam0, BOOL bParam1) // Position - 0x852B Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_224(int iParam0) // Position - 0x855C Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_225(var uParam0) // Position - 0x856F Hash - 0x39705408 ^0x39705408
{
	return func_158(*uParam0, 2);
}

BOOL func_226() // Position - 0x857F Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_227(int iParam0) // Position - 0x85B0 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_89(iParam0))
		return -1;
...
int func_228(int iParam0) // Position - 0x85CC Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_229(int iParam0) // Position - 0x860D Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
