...
void main() // Position - 0x0 Hash - 0x54A9ED6B ^0xBF64DCBB
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	anLocal_128 = anScriptParam_0;
	iLocal_129.f_1 = anScriptParam_0.f_1;
		...
		switch (iLocal_127)
		{
			case 0:
				if (func_3(&iLocal_129))
				{
					...
					if (iLocal_129.f_4 == -1)
						iLocal_129.f_4 = func_4(&iLocal_129);
				}
				break;
		
			case 1:
				if (func_5(&iLocal_129))
					func_6(&iLocal_129);
...
{
	func_9(uParam0);
	SCRIPTS::_0xE7282390542F570D(anLocal_128);
...
BOOL func_3(var uParam0) // Position - 0xD1 Hash - 0xF06FC284 ^0xC0DEC5DC
{
	...
	if (iLocal_129 == 0)
	{
		...
		iLocal_129 = func_10(scenarioPointType);
		return false;
	}

	if (func_11(iLocal_129, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0) // Position - 0xA35 Hash - 0xD4DB6D6D ^0x85AA39BC
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return;

	if (func_48(1091556515))
	{
		func_49(&iLocal_14, 5);
		return;
	}

	if (func_50(0, false, true) && iLocal_14 < 3)
		func_49(&iLocal_14, 4);

	switch (iLocal_14)
	{
		case 0:
			if (HUD::_DOES_TEXT_BLOCK_EXIST(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(0)))
				HUD::TEXT_BLOCK_REQUEST(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(0));
		
			PED::_RESERVE_AMBIENT_PEDS_TOTAL(1);
			STREAMING::REQUEST_MODEL(func_52(0), false);
			func_49(&iLocal_14, 1);
			break;
		...
		case 1:
			if (PED::_GET_NUM_RESERVED_AMBIENT_PEDS_READY() != 1)
				return;
			else if (!func_55(&iLocal_14.f_103[0], func_52(0), func_53(1), func_54(1), false))
				return;
			else if (!func_57(&iLocal_14.f_105[0], func_56(0)))
				return;
			else if (!func_60(&iLocal_14.f_107[0], &(iLocal_14.f_110), func_58(0), func_59(0), true, 0))
				return;
		
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_14.f_103[0]))
			{
				func_61(&(iLocal_14.f_2), iLocal_14.f_103[0], AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(2), false);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_14.f_103[0], true);
				func_62(iLocal_14.f_103[0], 2131255687);
			}
		
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_14.f_107[0]))
			{
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_14.f_107[0], "Cougarman", iLocal_14.f_103[0], 0);
				ANIMSCENE::START_ANIM_SCENE(iLocal_14.f_107[0]);
				func_63(&iLocal_14.f_107[0], func_59(0));
			}
		
			func_64(&iLocal_14.f_107[0], func_59(1));
			func_49(&iLocal_14, 2);
			break;
	
		case 2:
			if (!VOLUME::DOES_VOLUME_EXIST(iLocal_14.f_105[0]))
			{
				return;
			}
			else if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_14.f_105[0], true, 0))
			{
				func_65(&(iLocal_14.f_1), 1);
				func_49(&iLocal_14, 3);
			}
			break;
		...
		case 3:
			if (!func_11(*uParam0, 32))
				if (VOLUME::DOES_VOLUME_EXIST(iLocal_14.f_105[0]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_14.f_105[0], true, 0))
					func_66(*uParam0);
		
			if (func_67(&iLocal_14))
			{
				func_68(uParam0);
				func_49(&iLocal_14, 5);
			}
		...
		case 4:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_14.f_103[0]))
				PED::DELETE_PED(&iLocal_14.f_103[0]);
			else
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_14.f_103[0]);
...
void func_9(var uParam0) // Position - 0xC9F Hash - 0x6BF6139 ^0x934DBDD9
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_14.f_103[0]))
		PED::DELETE_PED(&iLocal_14.f_103[0]);
	else
...
int func_10(Hash hParam0) // Position - 0xCCF Hash - 0xB8EC44B7 ^0xB12C5BE7
{
	switch (hParam0)
	{
...
BOOL func_11(int iParam0, BOOL bParam1) // Position - 0x14C0 Hash - 0x92045BA6 ^0x92045BA6
{
	if (!func_69(iParam0))
		return false;

	return Global_40.f_8863[func_70(iParam0, 1)] && bParam1 != false;
}

void func_12(var uParam0) // Position - 0x14EA Hash - 0xDA8817E5 ^0xAD3AC0C4
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
Vector3 func_13(var uParam0, int iParam1) // Position - 0x19CF Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case -1859023693:
		...
		case 404434344:
			if (iParam1 == 9)
				...
				return func_72(uParam0, iParam1);
			break;
		...
		case 870958936:
			return func_73(uParam0, iParam1);
...
float func_14(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1E85 Hash - 0x3DAE1415 ^0x2267FA69
{
...
BOOL func_15() // Position - 0x1EAD Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_74() != -1)
		return false;
...
BOOL func_16(int iParam0) // Position - 0x1ED2 Hash - 0x7F255B4B ^0xCD4BFF4B
{
	if (!(iParam0 > -1 && iParam0 <= 80))
		return false;

	if (Global_1572887.f_12 == -1)
		return func_75(Global_1835011[iParam0 /*74*/].f_1, true);

	return UNLOCK::UNLOCK_IS_UNLOCKED(Global_1835011[iParam0 /*74*/].f_2) && !UNLOCK::UNLOCK_IS_VISIBLE(Global_1835011[iParam0 /*74*/].f_2);
}

BOOL func_17(var uParam0) // Position - 0x1F31 Hash - 0x700EF42A ^0x1FB24E73
{
...
void func_18(var uParam0) // Position - 0x1F4A Hash - 0xB1BE772 ^0x50C155FC
{
	if (func_33(uParam0->f_6.f_8))
		func_76(&(uParam0->f_6.f_8), true, true);
...
void func_19(var uParam0, int iParam1) // Position - 0x1F8A Hash - 0x4F8BE4B5 ^0x8A18C31F
{
	uParam0->f_5 = iParam1;
	return;
}

BOOL func_20(var uParam0) // Position - 0x1F98 Hash - 0x52835008 ^0x3922FFAC
{
	switch (*uParam0)
	{
		case -1859023693:
...
void func_21(var uParam0) // Position - 0x2C53 Hash - 0x32186C70 ^0xD26CF7E4
{
	uParam0->f_6.f_2 = { func_72(uParam0, uParam0->f_4) };
	uParam0->f_6.f_1 = 5f;
	uParam0->f_6 = 10f;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2E6B Hash - 0x16E871AD ^0x10C54C39
{
...
void func_23(var uParam0) // Position - 0x2E95 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_24(var uParam0) // Position - 0x2EAB Hash - 0x5001E582 ^0x5001E582
{
	return func_78(*uParam0, 1);
}

void func_25(var uParam0) // Position - 0x2EBB Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_79(uParam0, 0f);
	return;
}

int func_26(var uParam0) // Position - 0x2ECA Hash - 0xE440ADBD ^0x7BE35012
{
	if (!func_24(uParam0))
	...
	return func_81() - BUILTIN::ROUND(uParam0->f_1 * 1000f);
}

BOOL func_27(var uParam0, BOOL bParam1) // Position - 0x2F1D Hash - 0x1ACEECAF ^0xDBC34297
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (bParam1)
	{
		...
		if (*uParam0 == -1761578407 || *uParam0 == 404434344 || *uParam0 == -1243267511 || *uParam0 == -607940493 || *uParam0 == 1535254161)
		{
			...
			if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, uParam0->f_6.f_9, true, 0) || !func_84(Global_35, uParam0->f_6.f_2, 0))
				return true;
		}
		else if (func_14(Global_35, uParam0->f_6.f_2, true) > uParam0->f_6.f_1 + 0.5f || !func_84(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
	else
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, true) <= uParam0->f_6.f_1 && func_84(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
...
void func_28(var uParam0) // Position - 0x313F Hash - 0x50DD0CEE ^0xD4CE235D
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_48(*uParam0))
			{
				uParam0->f_6.f_8 = func_85("DISCO_FOCUS", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
				func_34(uParam0->f_6.f_8, false, true);
			}
			else
			{
				uParam0->f_6.f_8 = func_85("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_85("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_85("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
		}
	
		func_86(uParam0->f_6.f_8, 13, true, true);
		func_87(uParam0->f_6.f_8);
	}

	return;
}

char* func_29(var uParam0) // Position - 0x3581 Hash - 0x70C2E158 ^0xD4AD6CD1
{
	if (*uParam0 == 404434344)
		if (func_48(*uParam0))
...
void func_30(var uParam0, int iParam1, char* sParam2, BOOL bParam3) // Position - 0x3DF0 Hash - 0x92B8786B ^0x6992BF35
{
	int num;
	int num2;
	int num3;
...
BOOL func_31(var uParam0) // Position - 0x3EBB Hash - 0x87BF472A ^0x8A3FB963
{
	if (func_89(uParam0->f_6.f_8, true))
		return true;

	return false;
}

void func_32(int iParam0, BOOL bParam1) // Position - 0x3ED6 Hash - 0x54AA129E ^0x54AA129E
{
	if (!func_69(iParam0))
		return;

	Global_40.f_8863[func_70(iParam0, 1)] = Global_40.f_8863[func_70(iParam0, 1)] || bParam1;
	return;
}

BOOL func_33(int iParam0) // Position - 0x3F0C Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
void func_34(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F4B Hash - 0x139797B1 ^0x139797B1
{
	int num;
...
void func_35(var uParam0) // Position - 0x3F77 Hash - 0xB093A844 ^0xA61CDF5C
{
	if (func_74() != -1)
		return;
	...
	if (*uParam0 == -321841939)
	{
		if (func_91(uParam0->f_4) != 0)
		{
			if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(uParam0->f_4))
				MAP::_MAP_DISCOVER_REGION(func_91(uParam0->f_4));
	...
	{
		if (func_92(*uParam0, uParam0->f_4) != 0)
		{
			if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(func_92(*uParam0, uParam0->f_4)))
				MAP::_MAP_DISCOVER_REGION(func_92(*uParam0, uParam0->f_4));
...
void func_36(var uParam0, BOOL bParam1) // Position - 0x4007 Hash - 0x3BBAC949 ^0x751C9296
{
	int num;
	...
	if (bParam1)
		num = func_97(*uParam0, func_96(), uParam0->f_4);
	else
		num = func_98(*uParam0, uParam0->f_4);
		...
		if (bParam1)
		{
			...
			if (*uParam0 == -890175011)
			{
				if (func_100() == 5 - 1)
				{
					if (func_96())
					{
						func_99(joaat("journal_town_secret_vampmap_ar"), 0);
						num = joaat("journal_town_secret_vampmap_ar");
					}
					else
					{
						func_99(joaat("journal_town_secret_vampmap_jn"), 0);
...
void func_37(BOOL bParam0, int iParam1) // Position - 0x40D8 Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
float func_38(int iParam0, BOOL bParam1) // Position - 0x411E Hash - 0x376EA9F4 ^0xA7A80B21
{
	int num;
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x4176 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_40(var uParam0, int iParam1) // Position - 0x4185 Hash - 0xF55E891F ^0xF55E891F
{
	func_104(uParam0, iParam1);
	return;
}

void func_41(var uParam0) // Position - 0x4195 Hash - 0x7DD80D7C ^0x2A3ED7AA
{
	...
	uParam0->f_6.f_10 = { func_72(uParam0, uParam0->f_4) };
	return;
}

void func_42(var uParam0) // Position - 0x41DC Hash - 0xC9354E8F ^0x12F79925
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
void func_43(var uParam0, int iParam1) // Position - 0x41FC Hash - 0xF55E891F ^0xF55E891F
{
	func_105(uParam0, iParam1);
	return;
}

void func_44(var uParam0) // Position - 0x420C Hash - 0x90A3D13B ^0x25DA303B
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
BOOL func_45(int iParam0) // Position - 0x4228 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -1891628345:
...
BOOL func_46(var uParam0) // Position - 0x42A6 Hash - 0xA77C53D8 ^0x41543EB2
{
	Vector3 vector;
	var coords;
	...
	{
		func_106(*uParam0, &vector);
	
		if (FIRE::GET_OWNER_OF_EXPLOSION_IN_ANGLED_AREA(-1, vector, vector.f_3, vector.f_6) == func_107(Global_35))
		{
			return true;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, const char* sParam3, Entity eParam4, BOOL bParam5, int iParam6, BOOL bParam7) // Position - 0x432F Hash - 0xA48CCCFA ^0xD20D1AD3
{
	int num;
	int num2;
	int i;
	...
	if (Global_36616 && func_108(iParam1) != false)
		return;
	...
	{
		func_110(num, false, iParam0, iParam1, sParam3, eParam4, bParam5, bParam7);
	}
	else
	{
		num2 = -1;
		...
		if (num2 >= 0)
			func_111(num2, num, iParam0, iParam1, eParam4, bParam5);
		else
			func_110(num, true, iParam0, iParam1, sParam3, eParam4, bParam5, false);
	}

	return;
}

BOOL func_48(int iParam0) // Position - 0x442E Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_11(iParam0, 2);
}

void func_49(var uParam0, int iParam1) // Position - 0x443D Hash - 0x6140DB6F ^0x6140DB6F
{
	if (*uParam0 != iParam1)
		*uParam0 = iParam1;
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4452 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x4656 Hash - 0xA17D549C ^0xAF9441B1
{
	switch (iParam0)
	{
		case 0:
...
ePedType func_52(int iParam0) // Position - 0x46C5 Hash - 0xE65A3A10 ^0xFDFC5727
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_53(int iParam0) // Position - 0x46E4 Hash - 0x563C355B ^0x563C355B
{
	switch (iParam0)
	{
		case 0:
			return -2456.4685f, -2857.2493f, 69.99371f;
	
		case 1:
			return -2456.585f, -2857.6526f, 78.8708f;
	
		case 2:
			return -2456.57f, -2857.3577f, 78.92656f;
	
		case 3:
			return -2434.659f, -2833.719f, 67.594f;
	
		case 4:
			return -2455.7778f, -2857.4307f, 69.95318f;
		...
		case 7:
			return -2459.414f, -2859.3381f, 78.18844f;
	
		case 8:
			return -2455.226f, -2857.0608f, 80.80578f;
...
float func_54(int iParam0) // Position - 0x47C3 Hash - 0xEA18A35E ^0xEA18A35E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_55(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x47F0 Hash - 0xE56A0C5F ^0xF94510B6
{
	STREAMING::REQUEST_MODEL(eptParam1, false);

	if (STREAMING::HAS_MODEL_LOADED(eptParam1) && !ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*uParam0 = func_117(eptParam1, uParam2, fParam5, true, true, 0, true, true, bParam6, false, false, false, false);
		return false;
	}
...
struct<11> func_56(int iParam0) // Position - 0x4843 Hash - 0x141958D4 ^0xDA171AF7
{
	var unk;
	...
	switch (iParam0)
	{
		case 0:
			...
			unk.f_3 = { func_53(5) };
			unk.f_6 = { func_53(6) };
			unk.f_9 = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(6);
...
BOOL func_57(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x4892 Hash - 0xC822A061 ^0xC4A17121
{
	if (!VOLUME::DOES_VOLUME_EXIST(*uParam0))
...
char* func_58(int iParam0) // Position - 0x48D4 Hash - 0xDEB3DA4B ^0x2497433A
{
	switch (iParam0)
	{
		case 0:
			return "script@ambient@discoverables@tree_house@treehouse";
	
		default:
		
	}

	return "FAIL -- anim scene not added";
}

char* func_59(int iParam0) // Position - 0x48F5 Hash - 0x958AD60F ^0xEF024EE5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_60(var uParam0, var uParam1, char* sParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0x4923 Hash - 0xFE40ED25 ^0xA6C47ED4
{
...
void func_61(var uParam0, Ped pedParam1, char* sParam2, BOOL bParam3) // Position - 0x497F Hash - 0x5AD955B5 ^0x43BD5215
{
	...
	if (func_118(uParam0, pedParam1, sParam2))
...
void func_62(Ped pedParam0, Hash hParam1) // Position - 0x49DC Hash - 0xEA1C858E ^0x614E57D0
{
...
void func_63(var uParam0, char* sParam1) // Position - 0x4A86 Hash - 0xFAFD3C4D ^0x5D87C9FD
{
...
void func_64(var uParam0, char* sParam1) // Position - 0x4AEE Hash - 0xA5BD55B2 ^0x32ED83B4
{
	if (ANIMSCENE::_DOES_ANIM_SCENE_PLAY_LIST_EXIST(*uParam0, sParam1))
...
void func_65(var uParam0, int iParam1) // Position - 0x4B0F Hash - 0x6140DB6F ^0x6140DB6F
{
	if (*uParam0 != iParam1)
		*uParam0 = iParam1;
...
void func_66(int iParam0) // Position - 0x4B24 Hash - 0xF9F788B3 ^0x8192C5D9
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_123(iParam0))
			func_125(func_124(joaat("discoverable_found")), 1);
	}

	return;
}

BOOL func_67(var uParam0) // Position - 0x4B60 Hash - 0x2429E4DA ^0x5E0688FD
{
	if (uParam0->f_1 < 3)
		if (func_126())
			func_65(&(uParam0->f_1), 3);

	if (uParam0->f_1 < 5)
	{
		if (func_127())
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_103[0]))
			{
				PED::SET_PED_CONFIG_FLAG(uParam0->f_103[0], 88, true);
				ENTITY::SET_ENTITY_PROOFS(uParam0->f_103[0], 4, false);
			}
		
			FIRE::ADD_EXPLOSION(func_53(2), 12, 2f, false, true, 0f);
			func_63(&uParam0->f_107[0], func_59(1));
			func_65(&(uParam0->f_1), 5);
		}
	}
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			if (!func_24(&(uParam0->f_100)))
			{
				func_25(&(uParam0->f_100));
			}
			else if (func_128(uParam0, 3))
			{
				if (uParam0->f_109 < 1)
				{
					MAP::FORCE_SONAR_BLIPS_THIS_FRAME();
					MAP::ALLOW_SONAR_BLIPS(true);
					MAP::_TRIGGER_SONAR_BLIP_ON_ENTITY(1715123483, uParam0->f_103[0]);
				}
		...
		case 2:
			if (func_129(&(uParam0->f_100), 8f))
			{
				if (func_128(uParam0, 4))
				{
					if (uParam0->f_109 < 3)
					{
						MAP::FORCE_SONAR_BLIPS_THIS_FRAME();
						MAP::ALLOW_SONAR_BLIPS(true);
						MAP::_TRIGGER_SONAR_BLIP_ON_ENTITY(1715123483, uParam0->f_103[0]);
						uParam0->f_109 = uParam0->f_109 + 1;
					}
				
					uParam0->f_111 = uParam0->f_111 + 1;
					func_25(&(uParam0->f_100));
				
					if (uParam0->f_111 > 3)
					{
						func_23(&(uParam0->f_100));
						uParam0->f_111 = 0;
						func_65(&(uParam0->f_1), 0);
					}
				}
			}
			break;
		...
		case 5:
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_103[0]) && ENTITY::IS_ENTITY_DEAD(uParam0->f_103[0]))
			{
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_107[0]))
					ANIMSCENE::_DELETE_ANIM_SCENE(uParam0->f_107[0]);
			
				func_65(&(uParam0->f_1), 6);
			}
			break;
	
		case 6:
			func_131(&uParam0->f_103[0], false);
			PED::SET_PED_CONFIG_FLAG(uParam0->f_103[0], 26, true);
			PED::SET_PED_LASSO_HOGTIE_FLAG(uParam0->f_103[0], 1, false);
			func_132(&uParam0->f_103[0], 0);
			func_65(&(uParam0->f_1), 7);
			break;
...
void func_68(var uParam0) // Position - 0x4DF4 Hash - 0x46A0187B ^0x46A0187B
{
	if (!func_48(*uParam0))
	{
		func_133(*uParam0);
...
BOOL func_69(int iParam0) // Position - 0x4E14 Hash - 0x1965A61D ^0x1965A61D
{
	int num;

	num = func_70(iParam0, 1);
	return num >= 0 && num < 143;
}

int func_70(int iParam0, int iParam1) // Position - 0x4E33 Hash - 0x18EDA9F0 ^0x18EDA9F0
{
	switch (iParam0)
	{
		case -2108030724:
...
Vector3 func_71(var uParam0, int iParam1) // Position - 0x547C Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case 2000209669:
...
Vector3 func_72(var uParam0, int iParam1) // Position - 0x558D Hash - 0xC47AB599 ^0xC47AB599
{
	switch (*uParam0)
	{
		case -2009137002:
		...
		case 2000209669:
			if (iParam1 == 11)
				return func_71(uParam0, 11);
			else
				return func_71(uParam0, 7);
			break;
...
Vector3 func_73(var uParam0, int iParam1) // Position - 0x5F05 Hash - 0xBAE0ABDC ^0xBAE0ABDC
{
	switch (*uParam0)
	{
		case -1887999095:
...
BOOL func_74() // Position - 0x6197 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_75(int iParam0, BOOL bParam1) // Position - 0x61A5 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_76(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x61D6 Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
void func_77(var uParam0) // Position - 0x622A Hash - 0x87234A3C ^0x21D7A27C
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
	...
	if (*uParam0 == 404434344)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vector, vector2, vector3, func_138(uParam0));
	}
	else if (*uParam0 == -1761578407)
	{
		if (uParam0->f_4 == 0)
	...
	else if (*uParam0 == -1243267511 || *uParam0 == 1535254161 || *uParam0 == -607940493)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			if (*uParam0 == -607940493)
				...
				uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vector, vector2, vector3, func_138(uParam0));
	}
	else if (*uParam0 == -890175011)
	{
		if (uParam0->f_4 == 0)
...
BOOL func_78(int iParam0, int iParam1) // Position - 0x679B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_79(var uParam0, float fParam1) // Position - 0x67AA Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_80(var uParam0) // Position - 0x67D0 Hash - 0x39705408 ^0x39705408
{
	return func_78(*uParam0, 2);
}

int func_81() // Position - 0x67E0 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_82(var uParam0) // Position - 0x67FE Hash - 0xD965F2AB ^0x4503AF3C
{
	switch (*uParam0)
	{
		case -1300082860:
			if (func_142(Global_35, func_134(uParam0, 0), 3f, true, true))
				return true;
			break;
...
BOOL func_83(var uParam0, int iParam1) // Position - 0x68CF Hash - 0x787E614B ^0xC23272A0
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (!func_143(iParam1, 2) && !func_144())
		return false;

	if (!func_143(iParam1, 4) && !func_145())
		return false;

	if (!func_143(iParam1, 128) && !func_146())
		return false;

	if (!func_143(iParam1, 2048) && !func_147(false))
		return false;

	if (!func_143(iParam1, 32) && !func_148(iParam1))
		return false;

	if (!func_143(iParam1, 64) && !func_149())
		return false;

	if (!func_143(iParam1, 256) && CAM::IS_CINEMATIC_CAM_RENDERING())
		return false;

	if (!func_143(iParam1, 512))
		if (PED::GET_PED_CROUCH_MOVEMENT(Global_35))
			return false;

	if (!func_143(iParam1, 1024))
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1))
		return false;
	else if (func_150(Global_35, 1369124074))
		return false;
	else if (func_150(Global_35, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
		return false;

	return true;
}

BOOL func_84(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6A52 Hash - 0xE63CB60C ^0x5133A9E3
{
...
int func_85(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x6A93 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_152(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, iParam8, 0, pedParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, bParam16);
		return num;
	}
...
void func_86(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6B6A Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
void func_87(int iParam0) // Position - 0x6BB5 Hash - 0x4FCB23E1 ^0x764A8AAB
{
	int num;
...
int func_88(int iParam0) // Position - 0x6BF7 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

BOOL func_89(int iParam0, BOOL bParam1) // Position - 0x6C01 Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_90(int iParam0, BOOL bParam1) // Position - 0x6C59 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
		if (Global_1945188[iParam0 /*18*/].f_5 == 5 && !func_151(iParam0, 8))
...
Hash func_91(int iParam0) // Position - 0x6CB1 Hash - 0xB8EC44B7 ^0x184A6D50
{
	switch (iParam0)
	{
		case 0:
...
Hash func_92(int iParam0, int iParam1) // Position - 0x6DDA Hash - 0xE1D12727 ^0x5FD78BB4
{
	switch (iParam0)
	{
		case -2009137002:
...
void func_93(var uParam0) // Position - 0x70C2 Hash - 0x12B095D ^0x8F05BAE7
{
	if (func_74() != -1)
		return;
	...
	{
		if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(func_153(*uParam0)))
			MAP::_MAP_DISCOVER_REGION(func_153(*uParam0));
...
int func_94() // Position - 0x7103 Hash - 0x1767447B ^0x234018D7
{
	int i;
	int num;
	int num2;
...
BOOL func_95() // Position - 0x7141 Hash - 0xA0319B77 ^0x14CE505F
{
	int i;
	int num;
...
BOOL func_96() // Position - 0x717D Hash - 0x37EC066 ^0xC9B08D38
{
	if (func_74() != -1)
		return false;
...
int func_97(int iParam0, int iParam1, int iParam2) // Position - 0x71A3 Hash - 0xFCD0B11D ^0x62D50FE4
{
	if (iParam1 == true)
	{
		switch (iParam0)
...
int func_98(int iParam0, int iParam1) // Position - 0x79AF Hash - 0xF3B2DCFE ^0x9CB24CD5
{
	int num;

	num = func_97(iParam0, 1, iParam1);

	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(num))
		return num;

	num = func_97(iParam0, 0, iParam1);
...
void func_99(int iParam0, int iParam1) // Position - 0x79EC Hash - 0xC0D8FAC3 ^0xE4233006
{
...
int func_100() // Position - 0x7A05 Hash - 0xFA45A8A9 ^0x233CB2BD
{
	int num;
...
BOOL func_101() // Position - 0x7A8B Hash - 0x4A33814C ^0x6E4357BF
{
	Hash item;

	if (!func_156(joaat("document_player_journal"), 1, false))
	{
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) || func_150(Global_35, 1369124074))
		return false;
	...
	if (INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(func_158(false), item, false))
		return false;
...
void func_102(Hash hParam0, int iParam1) // Position - 0x7BB8 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_103() // Position - 0x7BCB Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

void func_104(var uParam0, int iParam1) // Position - 0x7BEA Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_105(var uParam0, int iParam1) // Position - 0x7BFB Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_106(Volume volParam0, var uParam1) // Position - 0x7C10 Hash - 0x7513460B ^0x6C9F3BDD
{
	float volumeScale;
...
Ped func_107(Ped pedParam0) // Position - 0x7C90 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_108(int iParam0) // Position - 0x7C9A Hash - 0xA05361F6 ^0xF8A0FD3E
{
	switch (iParam0)
	{
...
int func_109(int iParam0) // Position - 0x7DB0 Hash - 0xC25EDEC0 ^0x47BF4274
{
	switch (iParam0)
	{
		case 0:
...
void func_110(int iParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, Entity eParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7E97 Hash - 0x9A51185A ^0xCF0132EB
{
	int num;
	int num2;
	int num3;
	...
	Global_40.f_11095.f_35 = func_163(Global_40.f_11095.f_35, num4, num3);
	num2 = func_160();

	if (num2 != num && num2 != 0 || iParam3 == joaat("honor_event_cheat") || bParam7)
	{
		num7 = func_164(num2);
		func_166(func_165(), false, 4000);
		func_167(Global_40.f_11095.f_35);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_125(func_124(joaat("honor_positive_total")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_170(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
				else
					func_170(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
			}
		}
		else
		{
			func_125(func_124(joaat("honor_negative_total")), 1);
			Global_1347477.f_204 = 0;
		
			if (!bParam1)
			{
				if (iParam0 < func_109(4))
				{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_170(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
				else
					func_170(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
			}
		}
	}

	statId = { func_124(joaat("honor_current")) };
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3, Entity eParam4, BOOL bParam5) // Position - 0x823C Hash - 0x686957A ^0x8F82E8D6
{
...
BOOL func_112() // Position - 0x829B Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_113(int iParam0) // Position - 0x82EE Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_116(iParam0))
		return -1;

	return func_173(func_172(iParam0));
}

BOOL func_114(int iParam0) // Position - 0x830E Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_115(int iParam0, int iParam1) // Position - 0x8324 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_116(int iParam0) // Position - 0x8333 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
Ped func_117(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x8366 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_174(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_118(var uParam0, Entity eParam1, char* sParam2) // Position - 0x83A8 Hash - 0xFB1C2C0E ^0x6794528D
{
	BOOL flag;
	int i;
...
BOOL func_119(Ped pedParam0, Hash hParam1) // Position - 0x8426 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_120(Ped pedParam0, Hash hParam1) // Position - 0x8454 Hash - 0xA54F3032 ^0xB97469CD
{
	Hash _int;
...
BOOL func_121(Ped pedParam0, Hash hParam1) // Position - 0x84A5 Hash - 0xA54F3032 ^0xB97469CD
{
	Hash _int;
	int _int2;
...
void func_122(Ped pedParam0) // Position - 0x8517 Hash - 0x446F1BDD ^0x51006575
{
...
BOOL func_123(int iParam0) // Position - 0x8535 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -2009137002:
...
struct<2> func_124(int iParam0) // Position - 0x8661 Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_125(var uParam0, var uParam1, int iParam2) // Position - 0x8671 Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

BOOL func_126() // Position - 0x8681 Hash - 0xC96CB8E1 ^0xDC528A8E
{
	return MISC::HAS_BULLET_IMPACTED_IN_BOX(func_53(7), func_53(8), true, true);
}

BOOL func_127() // Position - 0x869A Hash - 0xA708DBF8 ^0x89175CA
{
	return MISC::IS_BULLET_IN_AREA(func_53(2), 0.5f, true);
}

BOOL func_128(var uParam0, int iParam1) // Position - 0x86B1 Hash - 0x1FA16F73 ^0x3A8AA668
{
	return func_176(&(uParam0->f_2), func_175(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam1)), true, -1, false, false);
}

BOOL func_129(var uParam0, float fParam1) // Position - 0x86CF Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_24(uParam0))
		return false;

	if (func_177(uParam0) > fParam1)
		return true;

	return false;
}

BOOL func_130(BOOL bParam0) // Position - 0x86F6 Hash - 0xD6E12BEB ^0xEB8894D
{
	return AUDIO::_IS_ANY_CONVERSATION_PLAYING(bParam0);
}

void func_131(var uParam0, BOOL bParam1) // Position - 0x8704 Hash - 0x269AE132 ^0xDBFF7BF3
{
...
void func_132(var uParam0, int iParam1) // Position - 0x8740 Hash - 0x2DC9D323 ^0x1A471F8A
{
	int flags;
...
void func_133(int iParam0) // Position - 0x8764 Hash - 0xDA84A767 ^0xDA84A767
{
	func_32(iParam0, 2);
	func_66(iParam0);
	return;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
Vector3 func_134(var uParam0, int iParam1) // Position - 0x8779 Hash - 0xE500AA03 ^0xE500AA03
{
	switch (*uParam0)
	{
		case -2108030724:
...
Vector3 func_135(var uParam0, int iParam1) // Position - 0x927F Hash - 0xABFFD40 ^0xABFFD40
{
	switch (*uParam0)
	{
		case -2108030724:
...
int func_136(int iParam0) // Position - 0x9DCE Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_116(iParam0))
		return -1;
...
void func_137(int iParam0) // Position - 0x9DEA Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_181(iParam0))
		return;
...
char* func_138(var uParam0) // Position - 0x9E9D Hash - 0x8601690B ^0xC7771A79
{
	switch (*uParam0)
	{
		case -1761578407:
...
float func_139() // Position - 0xA064 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_140(var uParam0, int iParam1) // Position - 0xA096 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_141(var uParam0, int iParam1) // Position - 0xA0A7 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_142(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0xA0BC Hash - 0x4F47D7F1 ^0x1C676405
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
	...
	if (bParam6)
		if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
			return true;
	else if (func_182(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
		return true;

	return false;
}

BOOL func_143(int iParam0, int iParam1) // Position - 0xA117 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_144() // Position - 0xA126 Hash - 0xD50A7FC ^0x92986A81
{
...
BOOL func_145() // Position - 0xA1C6 Hash - 0x52218EDE ^0x68EAB229
{
...
BOOL func_146() // Position - 0xA25B Hash - 0xD14A8C13 ^0x8AD85514
{
	if (func_184(Global_35) && !Global_1392040.f_2)
		return false;

	if (func_185(Global_35) && !Global_1392040.f_2)
		return false;

	return true;
}

BOOL func_147(BOOL bParam0) // Position - 0xA298 Hash - 0x19762284 ^0x80C0314
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !Global_1392040.f_2)
	{
		if (bParam0)
			func_186("ITEM_UNUSABLE_CARRYING", 10000, 0, 0, 0, true);
...
BOOL func_148(int iParam0) // Position - 0xA2D0 Hash - 0xEEF44B5 ^0x85627F39
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if (!func_143(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35) && VEHICLE::GET_DRIVER_OF_VEHICLE(vehiclePedIsUsing) == Global_35)
			return false;
	}
...
BOOL func_149() // Position - 0xA3A8 Hash - 0xFFDF5CA4 ^0x50D2CF98
{
...
BOOL func_150(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xA3BF Hash - 0x37FB14EB ^0x7E496A4A
{
...
BOOL func_151(int iParam0, int iParam1) // Position - 0xA3E8 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_152(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Ped pedParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0xA409 Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
...
Hash func_153(int iParam0) // Position - 0xA6AF Hash - 0xB8EC44B7 ^0xC091C19D
{
	switch (iParam0)
	{
		case -2060865802:
...
int func_154(int iParam0) // Position - 0xA7A0 Hash - 0x333EB83A ^0x37C96C1F
{
	switch (iParam0)
	{
		case 0:
...
void func_155(BOOL bParam0) // Position - 0xA89E Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_156(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xA8C8 Hash - 0x41C0912B ^0x734B270C
{
	int num;

	if (!func_192(hParam0, 0))
		return false;
	...
	if (num == joaat("WEAPON"))
		...
		if (!func_194(hParam0, 1))
			return false;

	return func_195(hParam0, false, bParam2) >= iParam1;
}

BOOL func_157(int iParam0) // Position - 0xA932 Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_196(iParam0);
}

int func_158(BOOL bParam0) // Position - 0xA940 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_74() == -1)
	{
...
void func_159() // Position - 0xA981 Hash - 0x5808700A ^0x37855CE9
{
...
int func_160() // Position - 0xA9D6 Hash - 0x990ADDDC ^0x7D78C12
{
	int num;
...
int func_161(int iParam0) // Position - 0xAAE9 Hash - 0xFA6423C1 ^0xB73AD7F1
{
	float num;
	float value;
...
BOOL func_162(int iParam0) // Position - 0xAB8E Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_199(iParam0))
		return false;
...
int func_163(int iParam0, int iParam1, int iParam2) // Position - 0xABAA Hash - 0x1D7642BB ^0x1D7642BB
{
	if (iParam0 > iParam2)
		return iParam2;
...
int func_164(int iParam0) // Position - 0xABCF Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case -320:
...
Hash func_165() // Position - 0xAC86 Hash - 0xA46C8CCA ^0x71ABACD2
{
...
void func_166(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xADDE Hash - 0x25ED411C ^0xE6F9BEA9
{
	func_201(MISC::GET_GAME_TIMER() + iParam2, !bParam1);
	DATABINDING::_DATABINDING_WRITE_DATA_INT(Global_1954819.f_1.f_2.f_1, hParam0);
	func_202(hParam0);
	return;
}

void func_167(int iParam0) // Position - 0xAE0A Hash - 0x1FF74488 ^0xA40278BB
{
	...
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1954819.f_5.f_2[0 /*36*/].f_20[2], func_203(iParam0));
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1954819.f_5.f_2[0 /*36*/].f_24[2], "pausemenu_player");
	return;
}

// Unhandled jump detected. Output should be considered invalid
void func_168(BOOL bParam0) // Position - 0xAE6E Hash - 0x9BEFE017 ^0x9BEFE017
{
	int num;
	Hash unlockHash;
	Hash hash;
		...
		for (i = 0; i < num2; i = i + 1)
		{
			if (func_205(i, &hash, &num))
			{
				...
				else
				{
					...
					if (func_193(hash) == joaat("weapon_mod"))
						if (num == 1014511709)
							flag = func_160() <= -160;
...
const char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0xAF2F Hash - 0xA17D549C ^0xC5EA28D8
{
	switch (iParam0)
	{
		case joaat("honor_event_abandon_animals"):
...
int func_170(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xB07B Hash - 0x72075C17 ^0x3AC6D3FB
{
	int num;
	var unk13;
	int num2;
	...
	func_208(sParam0, sParam1, hParam2);
	return num2;
}

int func_171(int iParam0, int iParam1) // Position - 0xB0DE Hash - 0x969A241 ^0xB7B020D1
{
	Hash chalHash;
	Hash goalHash;
	...
	if (!func_210(iParam0, &chalHash, &goalHash))
		return 0;
...
BOOL func_172(int iParam0) // Position - 0xB139 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_173(BOOL bParam0) // Position - 0xB177 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

void func_174(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB18A Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_213(pedParam0, false);
			flag = true;
		}
	
		func_214(pedParam0, iParam2);
	}
...
Vector3 func_175(char* sParam0) // Position - 0xB26B Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_176(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB27D Hash - 0x4863E989 ^0xB2E91EEF
{
	BOOL flag;
...
float func_177(var uParam0) // Position - 0xB2D7 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_24(uParam0))
		return uParam0->f_1;
...
BOOL func_178() // Position - 0xB30C Hash - 0x18690106 ^0x764E08E6
{
	if (func_216(932909855))
		return true;

	return false;
}

BOOL func_179() // Position - 0xB325 Hash - 0x18690106 ^0xE41C0B15
{
	if (func_216(2051822093))
		return true;

	return false;
}

int func_180(int iParam0) // Position - 0xB33E Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_181(int iParam0) // Position - 0xB37F Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_151(iParam0, 2);
}

float func_182(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xB38E Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_183(Ped pedParam0) // Position - 0xB3AC Hash - 0xF2F988FE ^0xA63CD631
{
...
BOOL func_184(Ped pedParam0) // Position - 0xB494 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_218(pedParam0, 4) || func_218(pedParam0, 5);
}

BOOL func_185(Ped pedParam0) // Position - 0xB4B0 Hash - 0x8F7DFED5 ^0x8768F0B4
{
	var lootTarget;
...
int func_186(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xB51A Hash - 0x8EBD6187 ^0x42F0F0AC
{
	int num;
	var unk13;
	int num2;
...
BOOL func_187(int iParam0) // Position - 0xB555 Hash - 0xCB0CD3AF ^0x98FF0773
{
	Ped mount;
	...
	if (!func_143(iParam0, 16) && !func_220(mount, false))
		return false;

	return true;
}

void func_188(int iParam0, BOOL bParam1) // Position - 0xB593 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_189(int iParam0, int iParam1) // Position - 0xB5BC Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
void func_190(int iParam0, int iParam1) // Position - 0xB5E4 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_191(int iParam0, int iParam1) // Position - 0xB5F5 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_192(Hash hParam0, int iParam1) // Position - 0xB60A Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
int func_193(Hash hParam0) // Position - 0xB624 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_194(Hash hParam0, int iParam1) // Position - 0xB64F Hash - 0x2A2D0794 ^0x8C1DA314
{
	Hash hash;
	int num;
	int num2;
...
int func_195(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB6F7 Hash - 0x27EBD222 ^0x461275A8
{
	int num;
	Hash ammoType;
...
BOOL func_196(int iParam0) // Position - 0xB779 Hash - 0xA059D395 ^0xE600C05
{
	return func_39(Global_1935496.f_27, iParam0);
}

int func_197() // Position - 0xB78D Hash - 0xC5B83CF5 ^0xDBC2A9A7
{
	return Global_40.f_11095.f_35;
}

var func_198(BOOL bParam0, var uParam1, var uParam2) // Position - 0xB79D Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_199(int iParam0) // Position - 0xB7B4 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_200(int iParam0) // Position - 0xB7C7 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_201(int iParam0, BOOL bParam1) // Position - 0xB7F1 Hash - 0xE5C16A63 ^0x600C7934
{
...
void func_202(Hash hParam0) // Position - 0xB80C Hash - 0x246AED7E ^0x92A2F577
{
	COMPAPP::_0x74BCCEB233AD95B2(joaat("HonorMeterValue"), hParam0);
	return;
}

char* func_203(int iParam0) // Position - 0xB81F Hash - 0x8FB6A40C ^0x913B5FF1
{
	if (iParam0 <= -320)
		return "HONOR_BAD_8";
	else if (iParam0 <= -280)
...
BOOL func_204(var uParam0) // Position - 0xB940 Hash - 0x89D7A86C ^0xC5CDC47A
{
	var unk;
...
BOOL func_205(int iParam0, var uParam1, var uParam2) // Position - 0xB988 Hash - 0x2D6E55B7 ^0xC1202559
{
	var unk;
	var unk6;
...
Hash func_206(Hash hParam0) // Position - 0xBA08 Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

int func_207() // Position - 0xBA12 Hash - 0xE17CEFF5 ^0x60DBA116
{
	int num;
...
void func_208(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0xBA61 Hash - 0xC233DF85 ^0x5FF82D96
{
...
BOOL func_209(int iParam0) // Position - 0xBA92 Hash - 0xB0C53BA8 ^0xB0C53BA8
{
...
BOOL func_210(int iParam0, var uParam1, var uParam2) // Position - 0xBAB1 Hash - 0xB903AED3 ^0x206B1C87
{
	if (!func_209(iParam0))
		return false;
...
BOOL func_211(ePedType eptParam0) // Position - 0xBC80 Hash - 0x899A1C9C ^0x899A1C9C
{
	switch (eptParam0)
	{
...
void func_212(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0xC44C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_213(Ped pedParam0, BOOL bParam1) // Position - 0xC47C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_214(Ped pedParam0, int iParam1) // Position - 0xC4C1 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_215(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC4E8 Hash - 0xFDACD718 ^0x658C9335
{
	int i;
...
BOOL func_216(int iParam0) // Position - 0xC53A Hash - 0xBF89485 ^0x62E162D4
{
	int num;
	int num2;
	int offset;
...
int func_217(int iParam0) // Position - 0xC589 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
int func_218(Ped pedParam0, int iParam1) // Position - 0xC60A Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
BOOL func_219(Ped pedParam0) // Position - 0xC649 Hash - 0x28235D58 ^0x5BD1001B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_220(Ped pedParam0, BOOL bParam1) // Position - 0xC666 Hash - 0x6BE4D4B ^0xC7F6BBCD
{
	float entitySpeed;
	float num;
...
Hash func_221(Hash hParam0, int iParam1) // Position - 0xC6BC Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_222(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xC736 Hash - 0xA7F38D3E ^0x25D43AAB
{
...
BOOL func_223(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC75D Hash - 0xF1DE71ED ^0x4F212F50
{
	if (iParam2 < 0)
		return false;
...
BOOL func_224(Hash hParam0) // Position - 0xC798 Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_225(int iParam0) // Position - 0xC7B3 Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
int func_226(Hash hParam0, BOOL bParam1) // Position - 0xC7D4 Hash - 0x884C76BA ^0xDB141D11
{
	var unk;
	int num;
	int num2;
...
void func_227(BOOL bParam0) // Position - 0xC832 Hash - 0x970FE035 ^0x92589DF6
{
	func_236(bParam0);
...
BOOL func_228(int iParam0, var uParam1) // Position - 0xC865 Hash - 0xDBBC0B25 ^0xDBBC0B25
{
	if (!func_237(iParam0))
		return false;
...
int func_229(int iParam0, int iParam1) // Position - 0xC892 Hash - 0x8FA0E29 ^0xC3F68E87
{
	switch (iParam0)
	{
		case -2106445152:
...
BOOL func_230(Hash hParam0, Hash hParam1) // Position - 0xD9AB Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
void func_231(Hash hParam0, var uParam1, var uParam2) // Position - 0xD9DC Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_232(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBE8 Hash - 0x84700F53 ^0xB9E7AA96
{
	Hash hash;
...
struct<4> func_233(BOOL bParam0) // Position - 0xDCBA Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
...
void func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDD4F Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_235(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xDD6A Hash - 0xA09A22CB ^0x2B47F617
{
...
void func_236(BOOL bParam0) // Position - 0xDD8F Hash - 0x246AED7E ^0xB30D729F
{
	COMPAPP::_0xB6FD96420C0126A1(joaat("HonorMeterVisible"), bParam0);
	return;
}

BOOL func_237(int iParam0) // Position - 0xDDA2 Hash - 0x3270B633 ^0x3270B633
{
	return iParam0 > -1 && iParam0 < 25;
}

struct<4> func_238(BOOL bParam0) // Position - 0xDDB8 Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_239(joaat("character"), func_240(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> func_239(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xDDD4 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
struct<4> func_240() // Position - 0xDE05 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
