...
void main() // Position - 0x0 Hash - 0xC19DE6C9 ^0x8840F10A
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_c_bearblack_01");
	sLocal_38 = "CREATURES_MAMMAL@DEER@NORMAL@DEAD";
	sLocal_39 = "dead_left";
	iLocal_40 = MISC::GET_RANDOM_INT_IN_RANGE(60, 71);
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9DE Hash - 0x4DA9BC8C ^0x3C8E317
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD2 Hash - 0x9EE24140 ^0x82397A6F
{
	func_46(uParam0, "BEARBLACK_INTIMIDATE_BEARBLACK", "script@ambient@animal@bearblack_intimidate_bearblack_backdown@action", vParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "bear_a", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "bear_b", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 2, "carcass", joaat("a_c_deer_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), uParam4.f_2 - 90f, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C67 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D07 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E21 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FEA Hash - 0xD087F48F ^0x763C85E2
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_38))
		return 0;

	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(joaat("world_animal_bearblack_eat_carcass"), false))
		return 0;

	return func_49(uParam0, uParam0->f_20[2 /*14*/].f_5);
}

BOOL func_19(var uParam0) // Position - 0x2023 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21D3 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2247 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2296 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22EE Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2457 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x277E Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28B5 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29E5 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A24 Hash - 0x74F10F98 ^0x53256055
{
	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[0 /*14*/]);
	PED::_REQUEST_MOTION_TYPE_ASSET(-1918659017, uParam0->f_20[1 /*14*/]);

	if (!PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[0 /*14*/]) || !PED::HAS_MOTION_TYPE_ASSET_LOADED(-1918659017, uParam0->f_20[1 /*14*/]))
		return false;

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		EVENT::_0x9520175B35E2268D(uParam0->f_20[0 /*14*/], true);
		func_57(&uParam0->f_20[0 /*14*/], true, true);
	}

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		EVENT::_0x9520175B35E2268D(uParam0->f_20[1 /*14*/], true);
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
	{
		...
		TASK::TASK_PLAY_ANIM(uParam0->f_20[2 /*14*/], sLocal_38, sLocal_39, 1000f, -1000f, -1, 131072, 0, false, 0, false, 0, false);
...
void func_29(var uParam0) // Position - 0x2B70 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2BA2 Hash - 0x558CDC8 ^0x3397E3DB
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_38);
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("world_animal_bearblack_eat_carcass"), 1, joaat("a_c_bearblack_01"), 0);
	...
	func_65(&uLocal_10, 75);
	return 1;
}

int func_31(var uParam0) // Position - 0x2BFB Hash - 0xE2CB8432 ^0x2E46D4F8
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	...
	{
		if (!bLocal_44 == true)
			if (func_66(uParam0, &uLocal_10, true) || func_67(Global_35, uParam0->f_483, true) <= 400f)
				bLocal_44 = true;
	
		if (bLocal_44)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!func_68(&uLocal_41))
					func_69(&uLocal_41);
	...
	if (uParam0->f_469[0])
		if (func_73(&uLocal_41, 3f))
			return 1;

	if (!uParam0->f_469[0] && !bLocal_44)
	{
		if (!uParam0->f_469[1])
		{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_75(uParam0, 1.5f, 80f, 4, joaat("Action"), true))
				{
					func_70(*uParam0, uParam0->f_483, true);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!uParam0->f_469[3])
							{
								...
								{
									TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], joaat("world_animal_bearblack_eat_carcass"), 35000, false, 0, -1082130432, false);
							...
							if (!uParam0->f_469[4])
							{
								...
								{
									TASK::TASK_FLEE_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 3, 256, -1082130432, -1, 0);
...
int func_32(var uParam0, var uParam1) // Position - 0x2F5D Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3796 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x37C2 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37F3 Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_49(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x3881 Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
	...
	{
		if (func_67(entity, vParam1, true) <= 1f)
		{
			func_90(*uParam0, uParam0->f_483);
			uParam0->f_499 = 1;
			return 0;
		}
	}
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x38D8 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x3ADC Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3AF0 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3AFF Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_77() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3B1A Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3B79 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x3BBB Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3BE7 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3C0F Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3C8B Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3CB1 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3CD3 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3CF5 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3D17 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_103(iParam0, 4);
	else
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3D35 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_65(var uParam0, int iParam1) // Position - 0x3D59 Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_66(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3D67 Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_67(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3DC1 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_105(entityCoords, vParam1);
}

BOOL func_68(var uParam0) // Position - 0x3E11 Hash - 0x5001E582 ^0x5001E582
{
	return func_106(*uParam0, 1);
}

void func_69(var uParam0) // Position - 0x3E21 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_107(uParam0, 0f);
	return;
}

void func_70(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3E30 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_71(var uParam0) // Position - 0x3F34 Hash - 0x5F88D024 ^0x5F88D024
{
	if (!uParam0->f_469[7])
	{
...
void func_72(var uParam0) // Position - 0x3F59 Hash - 0xFC457B8 ^0xB47AF66B
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!func_110(uParam0->f_20[0 /*14*/], 518218985))
		{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (!func_110(uParam0->f_20[1 /*14*/], 518218985))
		{
...
BOOL func_73(var uParam0, float fParam1) // Position - 0x400C Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_68(uParam0))
		return false;

	if (func_111(uParam0) > fParam1)
		return true;

	return false;
}

BOOL func_74(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4033 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_68(&(uParam0->f_490)))
							func_69(&(uParam0->f_490));
...
BOOL func_75(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x423E Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_116(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_68(&(uParam0->f_490)))
						...
						if (func_73(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_68(&(uParam0->f_490)) && !func_120(&(uParam0->f_490)))
...
void func_76(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4367 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_77() // Position - 0x44BB Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_78(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x44C9 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4530 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4559 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_81(var uParam0, var uParam1, var uParam2) // Position - 0x45A5 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_82(int iParam0) // Position - 0x45F4 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_83(int iParam0) // Position - 0x4619 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_84(int iParam0) // Position - 0x462C Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_85(int iParam0) // Position - 0x463F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_86(int iParam0) // Position - 0x4652 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_87(int iParam0) // Position - 0x4664 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_88(int iParam0, int iParam1) // Position - 0x4676 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4710 Hash - 0xA65AB937 ^0xA65AB937
{
...
void func_90(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4748 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_91() // Position - 0x4839 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_92(int iParam0) // Position - 0x488C Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_95(iParam0))
		return -1;
...
BOOL func_93(int iParam0) // Position - 0x48AC Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_94(int iParam0, int iParam1) // Position - 0x48C2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_95(int iParam0) // Position - 0x48D1 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_96(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4904 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x49E5 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_103(iParam0, 8);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4A05 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_103(iParam0, 16);
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4A30 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_103(iParam0, 32);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4A50 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_103(iParam0, 64);
	else
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4A70 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4A92 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_103(int iParam0, int iParam1) // Position - 0x4AB6 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_104(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4AC7 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_105(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x50F0 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x510E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_107(var uParam0, float fParam1) // Position - 0x511D Hash - 0x30433BAB ^0xF854D531
{
...
void func_108(int iParam0) // Position - 0x5143 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x51C4 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_110(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x529B Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_111(var uParam0) // Position - 0x52F4 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_68(uParam0))
		return uParam0->f_1;
...
BOOL func_112(Ped pedParam0) // Position - 0x5329 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_113(Ped pedParam0) // Position - 0x5344 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_114(float fParam0) // Position - 0x5360 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_115(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x53A7 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_116(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x53C5 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_105(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_117(var uParam0, float fParam1) // Position - 0x541C Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_118(var uParam0) // Position - 0x543A Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_119(var uParam0, BOOL bParam1) // Position - 0x5450 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_120(var uParam0) // Position - 0x5470 Hash - 0x39705408 ^0x39705408
{
	return func_106(*uParam0, 2);
}

void func_121(var uParam0) // Position - 0x5480 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_68(uParam0);
...
void func_122(var uParam0) // Position - 0x54B4 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_68(uParam0);
...
BOOL func_123(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x54E4 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_124(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5539 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_125(int iParam0, int iParam1) // Position - 0x5550 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_126(int iParam0, int iParam1) // Position - 0x55D6 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_127(int iParam0, int iParam1) // Position - 0x5612 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_128(int iParam0, int iParam1) // Position - 0x5665 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_129(int iParam0, int iParam1) // Position - 0x56A0 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_130(int iParam0, int iParam1) // Position - 0x56D9 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_131(int iParam0) // Position - 0x5711 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_132(BOOL bParam0) // Position - 0x574F Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_133(ePedType eptParam0) // Position - 0x5762 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_134(Ped pedParam0, Hash hParam1) // Position - 0x5BB5 Hash - 0x1DEF1AE3 ^0xB1DDA2
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_135(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5C5C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_136(Ped pedParam0, BOOL bParam1) // Position - 0x5C8C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_137(Ped pedParam0, int iParam1) // Position - 0x5CD1 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_138(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5CF8 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_176(iParam2);
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5EC3 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_140(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5F9A Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x5FD7 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_142(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x60BE Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x6194 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_144(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x629D Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x63D2 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6409 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6510 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x657B Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_149(Ped pedParam0, int iParam1) // Position - 0x66C3 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_150(var uParam0, int iParam1) // Position - 0x68A2 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x691A Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_152(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6949 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_153(int iParam0, Ped pedParam1) // Position - 0x6ACF Hash - 0x42A83B1F ^0x3E04C260
{
	int _int;
...
BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6B1F Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_203(iParam0))
		return true;
...
BOOL func_155(Ped pedParam0, Ped pedParam1) // Position - 0x6BBC Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_156() // Position - 0x6C09 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6C11 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_158() // Position - 0x6CD2 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_159() // Position - 0x6CF0 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_160(int iParam0, Ped pedParam1) // Position - 0x6D3D Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_161(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6E59 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x6EA1 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x70FA Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_213(0))
		return false;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x7133 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_165(var uParam0, int iParam1) // Position - 0x7162 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_166(Ped pedParam0, int iParam1) // Position - 0x7176 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_167(int iParam0, Ped pedParam1) // Position - 0x71C3 Hash - 0x356B0B1 ^0xEAE6FF19
{
...
float func_168() // Position - 0x7216 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_169(var uParam0, int iParam1) // Position - 0x7248 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_170(var uParam0, int iParam1) // Position - 0x7259 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_171(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x726E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x72FA Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x7328 Hash - 0x14518B52 ^0xBBBB7026
{
	Hash _int;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x7378 Hash - 0x14518B52 ^0xBBBB7026
{
	Hash _int;
	int _int2;
...
void func_175(Ped pedParam0) // Position - 0x73E8 Hash - 0xF13EB6AE ^0x14E7C099
{
...
void func_176(int iParam0) // Position - 0x7405 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_177(int iParam0) // Position - 0x7571 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_178(BOOL bParam0) // Position - 0x7584 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_179(int iParam0) // Position - 0x759E Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_180(int iParam0) // Position - 0x7638 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_181(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x765F Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_182(Ped pedParam0, Ped pedParam1) // Position - 0x7758 Hash - 0xF9959663 ^0xF9959663
{
	return func_204(pedParam0, pedParam1, true, true);
}

float func_183(int iParam0) // Position - 0x776A Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_184(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7776 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_185(int iParam0, BOOL bParam1) // Position - 0x77DB Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_186() // Position - 0x7801 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_187(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7815 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_188(int iParam0) // Position - 0x7975 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_189(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7981 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_190(int iParam0) // Position - 0x79E2 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_191(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x79EE Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_192(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7AB0 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_193(int iParam0) // Position - 0x7B4E Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_194(int iParam0) // Position - 0x7B5A Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_195(int iParam0) // Position - 0x7B66 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_196(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7CA3 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_197(Ped pedParam0) // Position - 0x7CE6 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D4C Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D93 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7DDE Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_201(Ped pedParam0, var uParam1) // Position - 0x7E57 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_202(Ped pedParam0, Ped pedParam1) // Position - 0x7EA4 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_203(int iParam0) // Position - 0x7EEC Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_204(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7EFC Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_205(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7F44 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7F70 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_207(int iParam0) // Position - 0x7F98 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_208(Ped pedParam0) // Position - 0x7FA4 Hash - 0xEB445B10 ^0x5F7F6E69
{
...
int func_209(Ped pedParam0) // Position - 0x7FFC Hash - 0x9F5EF0F0 ^0x5BC44D36
{
...
BOOL func_210(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x806E Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_211(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x81DE Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_212(int iParam0, Ped pedParam1) // Position - 0x82CC Hash - 0x27FC2906 ^0x38E3CB94
{
...
BOOL func_213(int iParam0) // Position - 0x8342 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_230())
		return false;
...
int func_214(int iParam0) // Position - 0x8364 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_215(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8370 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_216(int iParam0) // Position - 0x83EB Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_217() // Position - 0x83FE Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_218() // Position - 0x840C Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_232())
		return false;
...
void func_219(Any* panParam0, int iParam1) // Position - 0x8462 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_220(BOOL bParam0, var uParam1, var uParam2) // Position - 0x850B Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_221(int iParam0) // Position - 0x85D2 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_222(int iParam0) // Position - 0x867A Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_223(Ped pedParam0, int iParam1) // Position - 0x86DF Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_224(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x86F6 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_225(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8724 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_226(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x876E Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_227(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x87AF Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_228(Ped pedParam0) // Position - 0x8828 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_229(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8910 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_230() // Position - 0x8952 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_217() != -1)
		return false;
...
BOOL func_231(int iParam0, BOOL bParam1) // Position - 0x8977 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_232() // Position - 0x89A8 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_233(int iParam0) // Position - 0x89D9 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_95(iParam0))
		return -1;
...
int func_234(int iParam0) // Position - 0x89F5 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_235(int iParam0) // Position - 0x8A36 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
