...
void main() // Position - 0x0 Hash - 0xA112627F ^0x5C12F648
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0x707CF17D
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x83E4297 ^0x83E4297
{
	func_46(uParam0, "PUMP_CART", "", uParam1, uParam4);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1BDB Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1C7B Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1D95 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1F5E Hash - 0x8EA5507F ^0xC39C854A
{
	if (!STREAMING::HAS_MODEL_LOADED(hLocal_10))
		return 0;

	if (!ENTITY::DOES_ENTITY_EXIST(veLocal_11))
		veLocal_11 = VEHICLE::_CREATE_MISSION_TRAIN(1054492269, VEHICLE::_GET_NEAREST_TRAIN_TRACK_POSITION(uParam0->f_483), true, false, true, true);

	if (!VEHICLE::_HAS_TRAIN_LOADED(veLocal_11))
		return 0;

	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FA7 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2157 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21CB Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x221A Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2272 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23DB Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_52(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_25(var uParam0) // Position - 0x2702 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2839 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2969 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29A8 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29B1 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x29E3 Hash - 0x30553250 ^0x1A428C5E
{
	STREAMING::REQUEST_MODEL(hLocal_10, false);
	return 1;
}

int func_31(var uParam0) // Position - 0x29F3 Hash - 0xBDAB81CC ^0x883743AB
{
	switch (iLocal_9)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(veLocal_11))
			{
				if (!func_54(veLocal_11))
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(veLocal_11, true);
			
				AUDIO::SET_HORN_ENABLED(veLocal_11, false);
				VEHICLE::SET_TRAIN_SPEED(veLocal_11, 0f);
				VEHICLE::SET_TRAIN_CRUISE_SPEED(veLocal_11, 0f);
			}
...
int func_32(var uParam0, var uParam1) // Position - 0x2A8D Hash - 0xFD968C1E ^0x623FCE6A
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_11))
		VEHICLE::SET_MISSION_TRAIN_AS_NO_LONGER_NEEDED(&veLocal_11, 0);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2AA6 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2AC3 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2BFF Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2D38 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2DE2 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x2E5A Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_59(entityForwardVector, unk5);
	...
	if (func_60(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x2EE9 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3004 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3010 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3198 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3238 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x324B Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3265 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x32CD Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
BOOL func_47(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x32F9 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_72(Global_1898164.f_1[0 /*5*/]);
	
		if (func_73(num) && func_74(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}

	if (iParam0 == 0 && func_75(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_48(int iParam0) // Position - 0x34FD Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_49(int iParam0, int iParam1) // Position - 0x3511 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_50() // Position - 0x3520 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_58() != -1;
}

BOOL func_51(var uParam0, Any* panParam1) // Position - 0x353B Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_52(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x359A Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_53(Entity eParam0) // Position - 0x35DC Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
BOOL func_54(Vehicle veParam0) // Position - 0x3608 Hash - 0xDB9FF7DE ^0x3509E001
{
...
BOOL func_55(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x364B Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_79(fParam2);
		num2 = func_80(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_81(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_82(&(uParam0->f_490)))
							func_83(&(uParam0->f_490));
					
						if (func_84(&(uParam0->f_490), fParam1))
						{
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3856 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_57(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x392D Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
	...
	func_86(iParam0);
	func_87(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

int func_58() // Position - 0x3A31 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_59(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x3A3F Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_60(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x3AA6 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_61(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3ACF Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_88(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_62(var uParam0, var uParam1, var uParam2) // Position - 0x3B1B Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_88(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_63(int iParam0) // Position - 0x3B6A Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_64(int iParam0) // Position - 0x3B8F Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_65(int iParam0) // Position - 0x3BA2 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_66(int iParam0) // Position - 0x3BB5 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_67(int iParam0) // Position - 0x3BC8 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_68(int iParam0) // Position - 0x3BDA Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_69(int iParam0, int iParam1) // Position - 0x3BEC Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3C86 Hash - 0xA65AB937 ^0xA65AB937
{
	func_90(iParam0, iParam6);
	func_91(iParam0, iParam5);
	func_92(iParam0, iParam4);
	func_93(iParam0, iParam3);
	func_94(iParam0, iParam2);
	func_95(iParam0, iParam1);
	return;
}

BOOL func_71() // Position - 0x3CBE Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_72(int iParam0) // Position - 0x3D11 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_75(iParam0))
		return -1;
...
BOOL func_73(int iParam0) // Position - 0x3D31 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_74(int iParam0, int iParam1) // Position - 0x3D47 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_75(int iParam0) // Position - 0x3D56 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_76(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3D89 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_98(eptParam1))
		{
			func_99(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_101(pedParam0, false);
			flag = true;
		}
	
		func_102(pedParam0, iParam2);
	}
...
BOOL func_77(Ped pedParam0) // Position - 0x3E6A Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_78(Ped pedParam0) // Position - 0x3E85 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_79(float fParam0) // Position - 0x3EA1 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_80(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x3EE8 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_81(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x3F06 Hash - 0x867DEA0 ^0xA060BC32
{
...
BOOL func_82(var uParam0) // Position - 0x3F5D Hash - 0x5001E582 ^0x5001E582
{
	return func_104(*uParam0, 1);
}

void func_83(var uParam0) // Position - 0x3F6D Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_105(uParam0, 0f);
	return;
}

BOOL func_84(var uParam0, float fParam1) // Position - 0x3F7C Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_106(uParam0, fParam1))
	{
		func_85(uParam0);
		return true;
	}
...
void func_85(var uParam0) // Position - 0x3F9A Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_86(int iParam0) // Position - 0x3FB0 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_107(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_107(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_107(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_87(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4032 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_88(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_88(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x4123 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_89(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4178 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_90(int iParam0, int iParam1) // Position - 0x418F Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_91(int iParam0, int iParam1) // Position - 0x4215 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_92(int iParam0, int iParam1) // Position - 0x4251 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_93(int iParam0, int iParam1) // Position - 0x42A4 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_94(int iParam0, int iParam1) // Position - 0x42DF Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_95(int iParam0, int iParam1) // Position - 0x4318 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_96(int iParam0) // Position - 0x4350 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_97(BOOL bParam0) // Position - 0x438E Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_98(ePedType eptParam0) // Position - 0x43A1 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_99(Ped pedParam0, Hash hParam1) // Position - 0x47F4 Hash - 0x5A2CB120 ^0x96BDB7B3
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_108(pedParam0, hParam1))
		{
			if (func_109(pedParam0, hParam1))
			{
...
void func_100(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x489B Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_101(Ped pedParam0, BOOL bParam1) // Position - 0x48CB Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_102(Ped pedParam0, int iParam1) // Position - 0x4910 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4937 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x4955 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_105(var uParam0, float fParam1) // Position - 0x4964 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_106(var uParam0, float fParam1) // Position - 0x498A Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_82(uParam0))
		return false;
...
void func_107(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x49B1 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_116(iParam0) == 1 && bParam7)
		return;
...
BOOL func_108(Ped pedParam0, Hash hParam1) // Position - 0x4A3D Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_109(Ped pedParam0, Hash hParam1) // Position - 0x4A6B Hash - 0xD16E6CC ^0x630F288
{
	Hash _int;
...
BOOL func_110(Ped pedParam0, Hash hParam1) // Position - 0x4AB9 Hash - 0xD16E6CC ^0x630F288
{
	Hash _int;
	int _int2;
...
void func_111(Ped pedParam0) // Position - 0x4B27 Hash - 0x24A6D71E ^0x5625BE9E
{
...
float func_112() // Position - 0x4B43 Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_113(var uParam0, int iParam1) // Position - 0x4B75 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_114(var uParam0, int iParam1) // Position - 0x4B86 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_115(var uParam0) // Position - 0x4B9B Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_82(uParam0))
		return uParam0->f_1;
...
int func_116(int iParam0) // Position - 0x4BD0 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_117() // Position - 0x4BE3 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_118(var uParam0) // Position - 0x4BF1 Hash - 0x39705408 ^0x39705408
{
