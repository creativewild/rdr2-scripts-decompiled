...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0x373D42D1
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x85CD3DCE ^0x85CD3DCE
{
	int num;

	num = func_47(func_46());
	func_48(uParam0, "AV_CHAMBERPOT_TOSS", "", vParam1, uParam4);
	func_49(uParam0, 0, "Ped", num, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -6f, 0f), uParam4.f_2, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C0B Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CAB Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DC5 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1F8E Hash - 0x596E9FDA ^0x5442BA89
{
	...
	{
		iLocal_37 = func_50(joaat("world_human_chamberpot_empty_railing"), uParam0->f_483, uParam0->f_486.f_2, 0, 1000f, false);
	}

	return 0;
}

BOOL func_19(var uParam0) // Position - 0x1FD9 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2189 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21FD Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x224C Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22A4 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x240D Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2734 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x286B Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x299B Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29DA Hash - 0xA6D16C25 ^0xB3314236
{
...
void func_29(var uParam0) // Position - 0x2A18 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A4A Hash - 0x5BBCAFD2 ^0x38F36BE
{
	iLocal_37 = func_50(joaat("world_human_chamberpot_empty_railing"), uParam0->f_483, uParam0->f_486.f_2, 0, 1000f, false);
...
int func_31(var uParam0) // Position - 0x2AA4 Hash - 0xB09748A1 ^0x36F98548
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!uParam0->f_469[0])
		{
			if (func_65(uParam0, &uLocal_9, false))
			{
		...
		if (!uParam0->f_469[2])
		{
			if (func_68(uParam0, 0.1f, 60f, 4, 33f, 1112014848))
			{
				func_66(uParam0);
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
				{
					if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_37))
					{
						TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_37, 0, 1000, true, false, 0, true, -1082130432, false);
						uParam0->f_469[2] = 1;
					}
				}
			}
		...
		if (uParam0->f_469[2])
		{
			if (func_69(uParam0->f_20[0 /*14*/], -76381094))
			{
				if (!uParam0->f_469[4])
				{
					if (func_70(uParam0, 1065353216, 1116471296, 4, joaat("Action"), false))
					{
						func_67(*uParam0, uParam0->f_483, false);
						uParam0->f_469[4] = 1;
					}
			...
			else if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 1))
			{
...
int func_32(var uParam0, var uParam1) // Position - 0x2C2F Hash - 0x3105A36D ^0x3105A36D
{
	func_71(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2C41 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2C5E Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2D9A Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2ED3 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2F7D Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x2FF5 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3084 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x319F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x31AB Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3333 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x33D3 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x33E6 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3400 Hash - 0xEA796703 ^0x695D7925
{
...
int func_46() // Position - 0x3468 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_47(int iParam0) // Position - 0x3476 Hash - 0xA6D0F253 ^0x6683D66D
{
	int num;
...
void func_48(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3565 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3591 Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_50(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6, BOOL bParam7) // Position - 0x361F Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, fParam6, bParam7);
}

BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3639 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x383D Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3851 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3860 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_72() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x387B Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x38DA Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x391C Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3948 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x39C4 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x39E8 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3A0E Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3A30 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3A52 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3A74 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_65(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3A98 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_66(var uParam0) // Position - 0x3AF2 Hash - 0xCF07921A ^0xCF07921A
{
	if (!uParam0->f_469[5])
	{
...
void func_67(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3B17 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3C1B Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_69(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3E26 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
BOOL func_70(var uParam0, int iParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3E7F Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_105(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_107(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_108(&(uParam0->f_490)))
							func_112(&(uParam0->f_490), false);
		...
		if (func_108(&(uParam0->f_490)) && !func_113(&(uParam0->f_490)))
...
void func_71(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3FA8 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_72() // Position - 0x40FD Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_73(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x410B Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_74(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4172 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x419B Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_76(var uParam0, var uParam1, var uParam2) // Position - 0x41E7 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_77(int iParam0) // Position - 0x4236 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_78(int iParam0) // Position - 0x425B Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_79(int iParam0) // Position - 0x426E Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_80(int iParam0) // Position - 0x4281 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_81(int iParam0) // Position - 0x4294 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_82(int iParam0) // Position - 0x42A6 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_83(int iParam0, int iParam1) // Position - 0x42B8 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4352 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_85() // Position - 0x438A Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_86(int iParam0) // Position - 0x43DD Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_89(iParam0))
		return -1;
...
BOOL func_87(int iParam0) // Position - 0x43FD Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_88(int iParam0, int iParam1) // Position - 0x4413 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_89(int iParam0) // Position - 0x4422 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_90(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4455 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x4536 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_98(iParam0, 4);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4554 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_98(iParam0, 8);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4574 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_98(iParam0, 16);
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x459F Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_98(iParam0, 32);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x45BF Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_98(iParam0, 64);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x45DF Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4601 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_98(int iParam0, int iParam1) // Position - 0x4625 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_99(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4636 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4C5F Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_101(int iParam0) // Position - 0x4D36 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_102(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4DB7 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_103(Ped pedParam0) // Position - 0x4EA8 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_104(Ped pedParam0) // Position - 0x4EC3 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_105(int iParam0) // Position - 0x4EDF Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_106(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4F26 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_107(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4F44 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_108(var uParam0) // Position - 0x4F9B Hash - 0x5001E582 ^0x5001E582
{
	return func_164(*uParam0, 1);
}

void func_109(var uParam0) // Position - 0x4FAB Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_165(uParam0, 0f);
	return;
}

BOOL func_110(var uParam0, float fParam1) // Position - 0x4FBA Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_111(var uParam0) // Position - 0x4FD8 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_112(var uParam0, BOOL bParam1) // Position - 0x4FEE Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_113(var uParam0) // Position - 0x500E Hash - 0x39705408 ^0x39705408
{
	return func_164(*uParam0, 2);
}

void func_114(var uParam0) // Position - 0x501E Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_108(uParam0);
...
BOOL func_115(var uParam0, int iParam1) // Position - 0x5052 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_108(uParam0))
		return false;
...
void func_116(var uParam0) // Position - 0x5079 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_108(uParam0);
...
BOOL func_117(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x50A9 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_118(BOOL bParam0, var uParam1, var uParam2) // Position - 0x50FE Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_119(int iParam0, int iParam1) // Position - 0x5115 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_120(int iParam0, int iParam1) // Position - 0x519B Hash - 0x96B01D2A ^0x81E68218
{
...
void func_121(int iParam0, int iParam1) // Position - 0x51D7 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_122(int iParam0, int iParam1) // Position - 0x522A Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_123(int iParam0, int iParam1) // Position - 0x5265 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_124(int iParam0, int iParam1) // Position - 0x529E Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_125(int iParam0) // Position - 0x52D6 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_126(BOOL bParam0) // Position - 0x5314 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_127(ePedType eptParam0) // Position - 0x5327 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_128(Ped pedParam0, Hash hParam1) // Position - 0x577A Hash - 0x7BE5C407 ^0x4D721747
{
...
void func_129(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5821 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_130(Ped pedParam0, BOOL bParam1) // Position - 0x5851 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_131(Ped pedParam0, int iParam1) // Position - 0x5896 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_132(int iParam0, BOOL bParam1, int iParam2) // Position - 0x58BD Hash - 0x37D64B11 ^0xE7060A9E
{
	func_174(iParam2);
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x5A88 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_134(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5B5F Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5B9C Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_136(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5C83 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5D59 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_138(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5E62 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x5F97 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_140(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5FCE Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x60D5 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6140 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x6288 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_144(var uParam0, int iParam1) // Position - 0x6464 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x64DC Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_146(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x650B Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_147(int iParam0, Ped pedParam1) // Position - 0x6691 Hash - 0x742B19C1 ^0x6F383A30
{
	int _int;
...
BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x66DE Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_201(iParam0))
		return true;
...
BOOL func_149(Ped pedParam0, Ped pedParam1) // Position - 0x677B Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_150() // Position - 0x67C8 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x67D0 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_152() // Position - 0x6891 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_153() // Position - 0x68AF Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x68FC Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_155(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6A18 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_156(Ped pedParam0, int iParam1) // Position - 0x6A60 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6CB9 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_211(0))
		return false;
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x6CF2 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_159(var uParam0, int iParam1) // Position - 0x6D21 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6D35 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_161(int iParam0, Ped pedParam1) // Position - 0x6D82 Hash - 0x55956AC2 ^0x8A1BF034
{
...
void func_162(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6DD5 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_163(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6E61 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x6E7F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_165(var uParam0, float fParam1) // Position - 0x6E8E Hash - 0x30433BAB ^0xF854D531
{
...
float func_166() // Position - 0x6EB4 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_167(var uParam0, int iParam1) // Position - 0x6EE6 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_168(var uParam0) // Position - 0x6EFB Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_108(uParam0))
		return uParam0->f_1;
...
void func_169(var uParam0, int iParam1) // Position - 0x6F30 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x6F41 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x6F6F Hash - 0xE7572CC4 ^0xF8551185
{
	Hash _int;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x6FBD Hash - 0xE7572CC4 ^0xF8551185
{
	Hash _int;
	int _int2;
...
void func_173(Ped pedParam0) // Position - 0x702B Hash - 0x34FDD8E1 ^0xCF403719
{
...
void func_174(int iParam0) // Position - 0x7047 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_175(int iParam0) // Position - 0x71B3 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_176(BOOL bParam0) // Position - 0x71C6 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_177(int iParam0) // Position - 0x71E0 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_178(int iParam0) // Position - 0x7278 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_179(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x729F Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_180(Ped pedParam0, Ped pedParam1) // Position - 0x7398 Hash - 0xF9959663 ^0xF9959663
{
	return func_202(pedParam0, pedParam1, true, true);
}

float func_181(int iParam0) // Position - 0x73AA Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_182(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x73B6 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x741B Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_184() // Position - 0x7441 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_185(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7455 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_186(int iParam0) // Position - 0x75B5 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x75C1 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_188(int iParam0) // Position - 0x7622 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_189(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x762E Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_190(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x76F0 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_191(int iParam0) // Position - 0x778E Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_192(int iParam0) // Position - 0x779A Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_193(int iParam0) // Position - 0x77A6 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x78E3 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_195(Ped pedParam0) // Position - 0x7926 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x798C Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x79D3 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7A1E Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_199(Ped pedParam0, var uParam1) // Position - 0x7A97 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_200(Ped pedParam0, Ped pedParam1) // Position - 0x7AE4 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_201(int iParam0) // Position - 0x7B2C Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_202(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7B3C Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_203(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7B84 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7BB0 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_205(int iParam0) // Position - 0x7BD8 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_206(Ped pedParam0) // Position - 0x7BE4 Hash - 0xDDCB0ED9 ^0x4B7AE834
{
...
int func_207(Ped pedParam0) // Position - 0x7C38 Hash - 0x4543E8DA ^0xEA7ADE73
{
...
BOOL func_208(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7CA2 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7E12 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_210(int iParam0, Ped pedParam1) // Position - 0x7F00 Hash - 0x501C7AD ^0xEA0C7EFB
{
...
BOOL func_211(int iParam0) // Position - 0x7F74 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_228())
		return false;
...
int func_212(int iParam0) // Position - 0x7F96 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7FA2 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_214(int iParam0) // Position - 0x801F Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_215() // Position - 0x8032 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_216() // Position - 0x8040 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x8096 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x813E Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_219(int iParam0) // Position - 0x8205 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x82AD Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_221(Ped pedParam0, int iParam1) // Position - 0x8312 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8329 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_223(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8357 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_224(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x83A1 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x83E2 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_226(Ped pedParam0) // Position - 0x845B Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_227(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8543 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_228() // Position - 0x8585 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_215() != -1)
		return false;
...
BOOL func_229(int iParam0, BOOL bParam1) // Position - 0x85AA Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_230() // Position - 0x85DB Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x860C Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_89(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x8628 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_233(int iParam0) // Position - 0x8669 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
