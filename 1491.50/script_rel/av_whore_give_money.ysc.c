...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0xF918B63D
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x4CDB473F ^0x4CDB473F
{
	func_46(uParam0, "WHORE_GIVE_MONEY", "script@ambient@town@WHORE_GIVE_MONEY_MADAM@action", uParam1, uParam4);
	func_47(uParam0, 1, "pbl_Action", "", 0);
	func_50(uParam0, 0, "FEMALE_A", func_49(func_48()), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "FEMALE_B", func_49(func_48()), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 0, "p_cigarette01x", joaat("p_cigarette_cs01x"), 0f, 0f, 0f, 0f, 1);
	func_51(uParam0, 1, "MONEY", joaat("p_foldedbills01x"), 0f, 0f, 0f, 0f, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C4A Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CEA Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E04 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FCD Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FD6 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2186 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21FA Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2249 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22A1 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x240A Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2731 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2868 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2998 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29D7 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29E0 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A12 Hash - 0xEC0A8BB4 ^0x16DC5CF3
{
	func_59(joaat("world_human_smoke"), 1, 0, joaat("world_human_smoke_female_a"));

	if (!func_60(joaat("world_human_smoke")))
		return 0;
...
int func_31(var uParam0) // Position - 0x2A67 Hash - 0x32EFA01C ^0x9A6D9B2A
{
	var unk;
	BOOL flag;
			...
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
					if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
						flag = true;
					else if (func_67(uParam0->f_20[0 /*14*/], 0, &uLocal_9, &unk, 0, 0))
						flag = true;
				...
				if (flag)
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
						TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 32832, -1082130432, -1, 0);
	...
	if (!uParam0->f_469[0])
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (func_70(uParam0, 0.5f, 15f, 4, 5f, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 1065353216, 1116471296, 4, joaat("Action"), true))
				{
					func_69(*uParam0, uParam0->f_483, false);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!uParam0->f_469[4])
						{
							if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
							{
								...
								PED::_GIVE_PED_SCENARIO_PROP(uParam0->f_20[1 /*14*/], uParam0->f_372[0 /*8*/], "p_cigarette_cs01x_PH_R_HAND", "WORLD_HUMAN_SMOKE", 0, true);
								func_72(uParam0->f_20[1 /*14*/], joaat("world_human_smoke"), 15000, false, joaat("world_human_smoke_female_a"), 0.8f);
						...
						if (!uParam0->f_469[5])
						{
							if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
							{
								...
								if (func_74(uParam0->f_483, -315.5648f, 812.581f, 120.9763f, 2f, false))
									TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(uParam0->f_20[0 /*14*/], -313.02f, 812.19f, 117.98f, 0.5f, 0, false, true, false, false);
								else
									TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0, 256, 1000f, 30000, 0);
...
int func_32(var uParam0, var uParam1) // Position - 0x2E0F Hash - 0xD7E03AF4 ^0xD7E03AF4
{
	func_75(uParam0, true, true, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2E21 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2E3E Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F7A Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x30B3 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x315D Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x31D5 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3264 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x337F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x338B Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3513 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x35B3 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x35C6 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x35E0 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3648 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3674 Hash - 0xF0D98862 ^0x21440CE
{
...
int func_48() // Position - 0x36A5 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_49(int iParam0) // Position - 0x36B3 Hash - 0x43976D23 ^0x3578710
{
	int num;

	num = joaat("a_f_m_valprostitute_01");
	...
	switch (iParam0)
	{
		...
		case 10:
			switch (func_76())
			{
				...
				case 92:
					...
					{
						case 0:
							num = joaat("a_f_m_vhtprostitute_01");
							break;
		...
		case 11:
			num = joaat("a_f_m_rhdprostitute_01");
			break;
...
void func_50(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3754 Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x37E2 Hash - 0xD25940D1 ^0x34109BE0
{
...
BOOL func_52(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x383B Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_53(int iParam0) // Position - 0x3A3F Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_54(int iParam0, int iParam1) // Position - 0x3A53 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_55() // Position - 0x3A62 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_76() != -1;
}

BOOL func_56(var uParam0, Any* panParam1) // Position - 0x3A7D Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_57(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3ADC Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_58(Ped pedParam0) // Position - 0x3B1E Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
int func_59(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3B4A Hash - 0x4C6F92F6 ^0x312B6988
{
	return STREAMING::_REQUEST_SCENARIO_TYPE(hParam0, iParam1, iParam2, iParam3);
}

BOOL func_60(Hash hParam0) // Position - 0x3B5E Hash - 0xF47DA3FB ^0x3523541A
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(hParam0, false);
}

void func_61(int iParam0, BOOL bParam1) // Position - 0x3B6D Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3BE9 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3C0F Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3C31 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3C53 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3C75 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_67(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x3C99 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_103(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		{
			if (func_104(pedParam0, iParam2))
			{
				*uParam3 = 128;
				func_105(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_107(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_105(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_109(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_110(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
				...
				{
					if (func_112(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_105(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_113(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_105(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_113(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_105(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_116(iParam2, 4000))
				{
					if (func_117(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_118(iParam2, pedParam0) && func_119(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_105(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_117(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_118(iParam2, pedParam0) && func_119(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_105(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_120(pedParam0, Global_1935630.f_41))
							{
								func_121();
								*uParam3 = 2;
								func_105(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_122(iParam2, pedParam0) || iParam2->f_9 > 0 && func_123() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_124())
					{
						if (func_120(pedParam0, Global_1935630.f_42))
						{
							func_121();
							*uParam3 = 2;
							func_105(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_126(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_105(pedParam0, iParam2, *uParam3);
					return true;
...
void func_68(var uParam0) // Position - 0x42C2 Hash - 0xE62223CB ^0xE62223CB
{
	if (!uParam0->f_469[7])
	{
...
void func_69(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x42E7 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x43EB Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_136(Global_35))
		{
			ped = func_137(Global_35);
		...
		num = num * num;
		fParam2 = func_138(fParam2);
		num2 = func_139(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_140(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_141(&(uParam0->f_490)))
							func_142(&(uParam0->f_490));
					
						if (func_143(&(uParam0->f_490), fParam1))
						{
...
BOOL func_71(var uParam0, int iParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x45F6 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_138(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_140(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_141(&(uParam0->f_490)))
							func_145(&(uParam0->f_490), false);
					
						if (func_146(&(uParam0->f_490)))
							func_147(&(uParam0->f_490));
					
						if (func_148(&(uParam0->f_490), iParam1))
							return true;
						else
							return false;
					}
		...
		if (func_141(&(uParam0->f_490)) && !func_146(&(uParam0->f_490)))
			func_149(&(uParam0->f_490));
	}

	return false;
}

void func_72(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, float fParam5) // Position - 0x471F Hash - 0x5050B938 ^0x5BDC33E5
{
	TASK::TASK_START_SCENARIO_IN_PLACE_HASH(pedParam0, hParam1, iParam2, bParam3, hParam4, fParam5, false);
	return;
}

void func_73(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4738 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_74(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, int iParam6, BOOL bParam7) // Position - 0x4760 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
void func_75(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x47B5 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_76() // Position - 0x4909 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_77(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4917 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x497E Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x49A7 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_74(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_80(var uParam0, var uParam1, var uParam2) // Position - 0x49F3 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_74(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_81(int iParam0) // Position - 0x4A42 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_82(int iParam0) // Position - 0x4A67 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_83(int iParam0) // Position - 0x4A7A Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_84(int iParam0) // Position - 0x4A8D Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_85(int iParam0) // Position - 0x4AA0 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_86(int iParam0) // Position - 0x4AB2 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_87(int iParam0, int iParam1) // Position - 0x4AC4 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4B5E Hash - 0xA65AB937 ^0xA65AB937
{
	func_151(iParam0, iParam6);
	func_152(iParam0, iParam5);
	func_153(iParam0, iParam4);
...
BOOL func_89() // Position - 0x4B96 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_90(int iParam0) // Position - 0x4BE9 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_93(iParam0))
		return -1;

	return func_158(func_157(iParam0));
}

BOOL func_91(int iParam0) // Position - 0x4C09 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_92(int iParam0, int iParam1) // Position - 0x4C1F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_93(int iParam0) // Position - 0x4C2E Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_94(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4C61 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_159(eptParam1))
		{
			func_160(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_162(pedParam0, false);
			flag = true;
		}
	
		func_163(pedParam0, iParam2);
	}
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4D42 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_102(iParam0, 4);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4D60 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_102(iParam0, 8);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4D80 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_102(iParam0, 16);
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4DAB Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_102(iParam0, 32);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4DCB Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_102(iParam0, 64);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4DEB Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4E0D Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_102(int iParam0, int iParam1) // Position - 0x4E31 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_103(int iParam0, BOOL bParam1, int iParam2) // Position - 0x4E42 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_164(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_166(true))
							func_102(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_166(true) || *iParam0 & 8192 != 0)
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_167(iParam0))
				iParam0->f_15 = func_123();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_123() - iParam0->f_15 > 500)
			{
...
BOOL func_104(Ped pedParam0, int iParam1) // Position - 0x500D Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_169(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_170(pedParam0, pedIndexFromEntityIndex) <= func_171(iParam1))
				return true;
			break;
	}
...
void func_105(Ped pedParam0, int iParam1, int iParam2) // Position - 0x50E4 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_172(iParam2, 1, 1, 1, 0))
		func_102(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_173(iParam1, true);
	func_174();
	return;
}

BOOL func_106(Ped pedParam0, int iParam1) // Position - 0x5121 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	{
		if (func_175(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			num2 = func_176(iParam1);
		
			if (func_177(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_178(iParam1);
...
BOOL func_107(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5208 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_179(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_176(iParam2);
	
		if (func_177(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_178(iParam2))
				{
					func_173(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_108(Ped pedParam0, int iParam1) // Position - 0x52DE Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_169(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_178(iParam1))
		{
			customDistance = func_176(iParam1);
...
BOOL func_109(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x53E7 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_110(int iParam0, int iParam1) // Position - 0x551C Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_111(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5553 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_112(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x565A Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_182(iParam2))
	{
...
BOOL func_113(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x56C5 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_184(pedParam1, entityCoords, outCoords))
					{
						func_173(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_184(pedParam1, entityCoords, outCoords2))
					{
						func_173(iParam2, true);
						return true;
					}
...
BOOL func_114(Ped pedParam0, int iParam1) // Position - 0x580D Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_169(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_185(Global_1935630.f_34[i]);
			...
			if (func_186(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_187(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_188(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_115(var uParam0, int iParam1) // Position - 0x59E9 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_116(int iParam0, int iParam1) // Position - 0x5A61 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_117(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5A90 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_118(int iParam0, Ped pedParam1) // Position - 0x5C16 Hash - 0x42A83B1F ^0x797DD61B
{
	int _int;
...
BOOL func_119(int iParam0, Ped pedParam1) // Position - 0x5C66 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_191(iParam0))
		return true;
...
BOOL func_120(Ped pedParam0, Ped pedParam1) // Position - 0x5D03 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_192(pedParam0, pedParam1, true, true) < 4f)
...
void func_121() // Position - 0x5D50 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_122(int iParam0, Ped pedParam1) // Position - 0x5D58 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_193(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_123();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_194(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_123() // Position - 0x5E19 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_124() // Position - 0x5E37 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_123() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_125(int iParam0, Ped pedParam1) // Position - 0x5E84 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_195(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_196(pedParam1);
	num2 = func_197(iParam0->f_14);
...
BOOL func_126(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5FA0 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_198(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_127(Ped pedParam0, int iParam1) // Position - 0x5FE8 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_199(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_200(iParam1, pedParam0))
						if (func_194(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_128(Ped pedParam0, int iParam1) // Position - 0x6241 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_201(0))
		return false;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x627A Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_130(var uParam0, int iParam1) // Position - 0x62A9 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_131(Ped pedParam0, int iParam1) // Position - 0x62BD Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_123();
	else if (func_123() - iParam1->f_4 > func_202(iParam1))
		return func_203(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_132(int iParam0, Ped pedParam1) // Position - 0x630A Hash - 0x321E75A6 ^0x6B4DDFA8
{
...
void func_133(int iParam0, BOOL bParam1) // Position - 0x635D Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_134(int iParam0) // Position - 0x6434 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_204(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_204(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_204(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_135(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x64B5 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_74(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_136(Ped pedParam0) // Position - 0x65A6 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_137(Ped pedParam0) // Position - 0x65C1 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_138(int iParam0) // Position - 0x65DD Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_139(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6624 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_140(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x6642 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_205(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_141(var uParam0) // Position - 0x6699 Hash - 0x5001E582 ^0x5001E582
{
	return func_206(*uParam0, 1);
}

void func_142(var uParam0) // Position - 0x66A9 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_207(uParam0, 0f);
	return;
}

BOOL func_143(var uParam0, float fParam1) // Position - 0x66B8 Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_148(uParam0, fParam1))
	{
		func_144(uParam0);
		return true;
	}
...
void func_144(var uParam0) // Position - 0x66D6 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_145(var uParam0, BOOL bParam1) // Position - 0x66EC Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_146(var uParam0) // Position - 0x670C Hash - 0x39705408 ^0x39705408
{
	return func_206(*uParam0, 2);
}

void func_147(var uParam0) // Position - 0x671C Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_141(uParam0);

	if (func_146(uParam0))
	{
		uParam0->f_1 = func_208() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_209(uParam0, 2);
	}
...
BOOL func_148(var uParam0, int iParam1) // Position - 0x6750 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_141(uParam0))
		return false;
...
void func_149(var uParam0) // Position - 0x6777 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_141(uParam0);

	if (!func_146(uParam0))
	{
		uParam0->f_2 = func_208() - uParam0->f_1;
		func_211(uParam0, 2);
	}
...
var func_150(BOOL bParam0, var uParam1, var uParam2) // Position - 0x67A7 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_151(int iParam0, int iParam1) // Position - 0x67BE Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_152(int iParam0, int iParam1) // Position - 0x6844 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_153(int iParam0, int iParam1) // Position - 0x6880 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_154(int iParam0, int iParam1) // Position - 0x68D3 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_155(int iParam0, int iParam1) // Position - 0x690E Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_156(int iParam0, int iParam1) // Position - 0x6947 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_157(int iParam0) // Position - 0x697F Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_158(BOOL bParam0) // Position - 0x69BD Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_159(ePedType eptParam0) // Position - 0x69D0 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_160(Ped pedParam0, Hash hParam1) // Position - 0x6E23 Hash - 0xEA1C858E ^0xAC9B2BB2
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_161(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6ECD Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_162(Ped pedParam0, BOOL bParam1) // Position - 0x6EFD Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_163(Ped pedParam0, int iParam1) // Position - 0x6F42 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_164(int iParam0) // Position - 0x6F69 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_165(int iParam0) // Position - 0x70D5 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_166(BOOL bParam0) // Position - 0x70E8 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_167(int iParam0) // Position - 0x7102 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_168(int iParam0) // Position - 0x719C Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_169(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x71C3 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_197(pedParam2);
	else
		num2 = func_196(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_197(pedParam0);
	else
		num = func_196(pedParam0);
...
float func_170(Ped pedParam0, Ped pedParam1) // Position - 0x72BC Hash - 0xF9959663 ^0xF9959663
{
	return func_192(pedParam0, pedParam1, true, true);
}

float func_171(int iParam0) // Position - 0x72CE Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_172(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x72DA Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_173(int iParam0, BOOL bParam1) // Position - 0x733F Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_174() // Position - 0x7365 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_175(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7379 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_192(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_176(int iParam0) // Position - 0x74D9 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_177(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x74E5 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_178(int iParam0) // Position - 0x7546 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_179(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7552 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_180(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7614 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_181(int iParam0) // Position - 0x76B2 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_182(int iParam0) // Position - 0x76BE Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_183(int iParam0) // Position - 0x76CA Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_184(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7807 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_185(Ped pedParam0) // Position - 0x784A Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_186(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78B0 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_187(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78F7 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_188(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7942 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_189(Ped pedParam0, var uParam1) // Position - 0x79BB Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_190(Ped pedParam0, Ped pedParam1) // Position - 0x7A08 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_191(int iParam0) // Position - 0x7A50 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_192(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7A60 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_193(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7AA8 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_194(veParam0, uParam2, true);
...
float func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7AD4 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_195(int iParam0) // Position - 0x7AFC Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_196(Ped pedParam0) // Position - 0x7B08 Hash - 0x161BE138 ^0x34D0530F
{
...
int func_197(Ped pedParam0) // Position - 0x7B5C Hash - 0x10A6562 ^0x8E918C35
{
...
BOOL func_198(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7BC8 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_192(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_192(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_199(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7D38 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_200(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_200(iParam1, ped2))
					if (func_194(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_200(int iParam0, Ped pedParam1) // Position - 0x7E26 Hash - 0x27FC2906 ^0x84B3F8B6
{
...
BOOL func_201(int iParam0) // Position - 0x7E9C Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_229())
		return false;
...
int func_202(int iParam0) // Position - 0x7EBE Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_203(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7ECA Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_204(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7F45 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_205(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7FD1 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_206(int iParam0, int iParam1) // Position - 0x7FEF Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_207(var uParam0, float fParam1) // Position - 0x7FFE Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_208() - fParam1;
	func_211(uParam0, 1);
	func_209(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
float func_208() // Position - 0x8026 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_209(var uParam0, int iParam1) // Position - 0x8058 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_210(var uParam0) // Position - 0x806D Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_141(uParam0))
		return uParam0->f_1;
	...
	return func_208() - uParam0->f_1;
}

void func_211(var uParam0, int iParam1) // Position - 0x80A2 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_212(Ped pedParam0, Hash hParam1) // Position - 0x80B3 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_213(Ped pedParam0, Hash hParam1) // Position - 0x80E1 Hash - 0xA54F3032 ^0xEB14A9F2
{
	Hash _int;
...
BOOL func_214(Ped pedParam0, Hash hParam1) // Position - 0x8132 Hash - 0xA54F3032 ^0xEB14A9F2
{
	Hash _int;
	int _int2;
...
void func_215(Ped pedParam0) // Position - 0x81A4 Hash - 0x446F1BDD ^0x92301E55
{
...
BOOL func_216() // Position - 0x81C2 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_232())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x8218 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82C0 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_219() // Position - 0x8387 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_220(int iParam0) // Position - 0x8395 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_221(int iParam0) // Position - 0x843D Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_222(Ped pedParam0, int iParam1) // Position - 0x84A2 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_223(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x84B9 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_224(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x84E7 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8531 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_226(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8572 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_227(Ped pedParam0) // Position - 0x85EB Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_228(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x86D3 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_229() // Position - 0x8715 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_219() != -1)
		return false;
...
BOOL func_230(int iParam0, BOOL bParam1) // Position - 0x873A Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_231(int iParam0) // Position - 0x876B Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_232() // Position - 0x877E Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_233(int iParam0) // Position - 0x87AF Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_93(iParam0))
		return -1;
...
int func_234(int iParam0) // Position - 0x87CB Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_235(int iParam0) // Position - 0x880C Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
