...
void main() // Position - 0x0 Hash - 0x918FA5C5 ^0x547C92A0
{
	var unk;
	BOOL flag;
...
int func_1() // Position - 0x584 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_2(int iParam0) // Position - 0x592 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
void func_3(var uParam0) // Position - 0x683 Hash - 0x646928F0 ^0x646928F0
{
	func_7(uParam0);
	return;
}

void func_4(var uParam0) // Position - 0x691 Hash - 0x15214583 ^0x343259F6
{
	int i;
	...
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_498))
	{
		...
		func_8(uParam0->f_498);
	}

	return;
}

BOOL func_5(var uParam0) // Position - 0x727 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
	...
	switch (uParam0->f_464)
	{
		case 0:
			if (_IS_NULL_VECTOR(uParam0->f_483))
			{
				...
				{
					num = 0;
					uParam0->f_482 = func_11(*uParam0, &num, true, false, false);
					...
					else
					{
						...
						if (uParam0->f_480 > 1)
						{
							func_12(&(Global_1415419.f_19[*uParam0 /*12*/].f_11), 1);
							uParam0->f_464 = 8;
						}
					}
				}
			...
			if (flag)
			{
				func_13(*uParam0, uParam0->f_483, uParam0->f_1);
				TELEMETRY::_TELEMETRY_AMBIENT_VIGNETTE(func_14(*uParam0), uParam0->f_489, uParam0->f_483, uParam0->f_20[0 /*14*/], uParam0->f_453);
				num2 = func_15(*uParam0);
			
				if (num2 > 0f)
					uParam0->f_496 = func_16(uParam0->f_483, num2, "AMB_VIG", true, 0, 8, false, -1082130432);
			
				func_17(uParam0, uParam0->f_483, uParam0->f_486);
				...
				{
					uParam0->f_497 = VOLUME::CREATE_VOLUME_CYLINDER(uParam0->f_483, 0f, 0f, 0f, func_18(uParam0));
		...
		case 3:
			if (func_20(uParam0) && func_21(uParam0))
				uParam0->f_464 = 5;
			else
				return false;
			break;
		...
		case 4:
			if (func_26(uParam0) && func_27(uParam0) && func_28(uParam0))
			{
				func_29(uParam0);
				uParam0->f_464 = 6;
			}
		...
		case 5:
			if (func_22(uParam0))
			{
				...
				if (func_24(*uParam0))
					func_25(uParam0->f_483, 6f, true, true, false, false, false);
...
int func_6() // Position - 0xACD Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

void func_7(var uParam0) // Position - 0xADB Hash - 0x4DA9BC8C ^0x619CFC2E
{
	func_36(uParam0, &func_33, &func_34, &func_35);
	return;
}

void func_8(Volume volParam0) // Position - 0xAF5 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_9(var uParam0) // Position - 0xB0C Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xBCA Hash - 0x16E871AD ^0x10C54C39
{
...
int func_11(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xBF4 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
	...
	if (Global_1415419.f_19[iParam0 /*12*/].f_8 != -1 && Global_1415419.f_19[iParam0 /*12*/].f_9 < 960 && Global_1415419.f_19[iParam0 /*12*/].f_9 >= Global_1415419.f_19[iParam0 /*12*/].f_8)
	{
		...
		for (i = Global_1415419.f_19[iParam0 /*12*/].f_8; i <= Global_1415419.f_19[iParam0 /*12*/].f_9; i = i + 1)
		{
			*uParam1 = *uParam1 + 1;
			...
			if (!func_40(iParam0, Global_1415419.f_2996[i /*7*/]))
			{
			}
			else
			{
				...
				{
					num5 = func_41(Global_35, Global_1415419.f_2996[i /*7*/], 1060437492);
					...
					{
						if (func_42(Global_1415419.f_2996[i /*7*/], num6, iParam0 <= 33 || iParam0 == 72, bParam4, num3, num4, iParam0))
						{
							num = i;
							num2 = num6;
...
void func_12(int iParam0, int iParam1) // Position - 0xD45 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_13(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD5A Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_43() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_43();

	func_44(&(Global_32074.f_2697.f_6[iParam0 /*6*/].f_5), 0, 0, 1, 0, 0, 0, false);
	func_45(iParam0, 1, 0, 0);
...
int func_14(int iParam0) // Position - 0xDFE Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_15(int iParam0) // Position - 0x1BAF Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_46(iParam0))
	{
...
Volume func_16(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1C15 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
	...
	func_48(volume, bParam8);
	return volume;
}

void func_17(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1CCF Hash - 0x3DF84129 ^0x3DF84129
{
	func_49(uParam0, "LIGHT_SMOKE", "script@ambient@town@LIGHT_SMOKE@action", uParam1, uParam4);
	func_50(uParam0, 1, "pbl_action", "", 0);

	if (func_6() == 78)
	{
		switch (uParam0->f_482 - Global_1415419.f_19[*uParam0 /*12*/].f_8)
		{
			case 4:
			case 5:
			case 6:
				iLocal_37 = joaat("a_m_m_jamesonguard_01");
				break;
		}
	}
	else if (func_6() == 5)
	{
		...
		{
			case 12:
				iLocal_37 = joaat("a_m_m_lowersdtownfolk_01");
				break;
		}
	}
	else
	...
	func_51(uParam0, 0, "MALE_A", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MALE_B", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_52(uParam0, 0, "CIGARETTE_A", joaat("p_cigarette01x"), 0f, 0f, 0f, 0f, 1);
	func_52(uParam0, 1, "CIGARETTE_B", joaat("p_cigarette01x"), 0f, 0f, 0f, 0f, 1);
	func_52(uParam0, 3, "MATCHES", joaat("p_matches01x"), 0f, 0f, 0f, 0f, 1);
	func_52(uParam0, 2, "MATCH", joaat("p_matchstick01x"), 0f, 0f, 0f, 0f, 1);
	return;
}

Vector3 func_18(var uParam0) // Position - 0x1DFC Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_19(var uParam0) // Position - 0x1E9C Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
BOOL func_20(var uParam0) // Position - 0x1FB6 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
BOOL func_21(var uParam0) // Position - 0x217F Hash - 0xB9A18AFE ^0x4D914B0D
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(joaat("world_human_smoke"), false);
}

BOOL func_22(var uParam0) // Position - 0x2191 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_23(var uParam0) // Position - 0x2341 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;

	unk = Global_1415419.f_1;
	unk.f_2 = 0;
	unk.f_3 = func_14(*uParam0);
...
BOOL func_24(int iParam0) // Position - 0x23B5 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_25(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2404 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_26(var uParam0) // Position - 0x245C Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_27(var uParam0) // Position - 0x25C5 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_28(var uParam0) // Position - 0x28EC Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_29(var uParam0) // Position - 0x2A23 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_30(var uParam0) // Position - 0x2B53 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_31(var uParam0) // Position - 0x2B92 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_32(var uParam0) // Position - 0x2B9B Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_33(var uParam0) // Position - 0x2BCD Hash - 0x61F01D8 ^0x58826B1F
{
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("world_human_smoke"), 1, 0, 0);
	func_60(&uLocal_9, false);
	func_61(&uLocal_9, true);
	func_62(&uLocal_9, true);
	func_63(&uLocal_9, true);
	func_64(&uLocal_9, true);
	func_65(&uLocal_9, true);
	func_66(&uLocal_9, true);
	return 1;
}

int func_34(var uParam0) // Position - 0x2C14 Hash - 0x7D5A5143 ^0x7D5A5143
{
	if (!uParam0->f_469[0])
	{
		if (func_67(uParam0, &uLocal_9, false))
		{
			func_68(uParam0);
	...
	if (!uParam0->f_469[0])
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (func_70(uParam0, 0.5f, 80f, 4, 1109393408, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							...
							{
								func_68(uParam0);
								ANIMSCENE::SET_ANIM_SCENE_BOOL(uParam0->f_3.f_1, "Loop", true, false);
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
							}
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 1.5f, 1116471296, 4, joaat("Action"), true))
				{
					func_69(*uParam0, uParam0->f_483, false);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!uParam0->f_469[4])
						{
							if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
							{
								...
								PED::_GIVE_PED_SCENARIO_PROP(uParam0->f_20[0 /*14*/], uParam0->f_372[0 /*8*/], "p_cigarette_cs01x_PH_R_HAND", "WORLD_HUMAN_SMOKE", "WORLD_HUMAN_SMOKE_MALE_A", true);
								TASK::TASK_WALK_AWAY(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/]);
						...
						if (!uParam0->f_469[5])
						{
							if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
							{
								...
								ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_372[1 /*8*/].f_1, uParam0->f_372[1 /*8*/]);
								PED::_GIVE_PED_SCENARIO_PROP(uParam0->f_20[1 /*14*/], uParam0->f_372[1 /*8*/], "p_cigarette_cs01x_PH_R_HAND", "WORLD_HUMAN_SMOKE", "WORLD_HUMAN_SMOKE_MALE_C", true);
								func_72(uParam0->f_20[1 /*14*/], joaat("world_human_smoke"), 60000, false, joaat("world_human_smoke_male_c"), 0.7f);
								PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam0->f_20[1 /*14*/], false, false);
...
int func_35(var uParam0, var uParam1) // Position - 0x2F2D Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_73(uParam0, true, false, false);
	return 1;
}

void func_36(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F3F Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_37(int iParam0) // Position - 0x2F5C Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_38(int iParam0) // Position - 0x3098 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_39(int iParam0) // Position - 0x31D1 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_40(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x327B Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_41(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x32F3 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_74(entityForwardVector, unk5);
	...
	if (func_75(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_42(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3382 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_43() // Position - 0x349D Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x34A9 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_45(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3631 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
	...
	if (iParam3 != 0)
	{
		for (i = 0; i < 248; i = i + 1)
		{
			if (Global_1415419.f_19[i /*12*/].f_5 == iParam3)
			{
				if (i != iParam0)
				{
					if (func_43() > Global_32074.f_2697.f_6[i /*6*/].f_5)
						Global_32074.f_2697.f_6[i /*6*/].f_5 = func_43();
				
					func_44(&(Global_32074.f_2697.f_6[i /*6*/].f_5), 0, 0, iParam1, iParam2, 0, 0, false);
					func_12(&(Global_1415419.f_19[i /*12*/].f_11), 2);
				}
			}
		}
	}
...
BOOL func_46(int iParam0) // Position - 0x36D1 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_47(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36E4 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_48(Volume volParam0, BOOL bParam1) // Position - 0x36FE Hash - 0xEA796703 ^0x695D7925
{
...
void func_49(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3766 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_50(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3792 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37C3 Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_52(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3851 Hash - 0xD25940D1 ^0x34109BE0
{
...
BOOL func_53(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x38AA Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_54(int iParam0) // Position - 0x3AAE Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_55(int iParam0, int iParam1) // Position - 0x3AC2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_56() // Position - 0x3AD1 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_6() != -1;
}

BOOL func_57(var uParam0, Any* panParam1) // Position - 0x3AEC Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_58(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3B4B Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_91(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_59(Ped pedParam0) // Position - 0x3B8D Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x3BB9 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
		func_92(iParam0, true);
		func_93(iParam0, true);
		func_94(iParam0, true);
		func_95(iParam0, true);
		func_96(iParam0, true);
	...
	{
		iParam0->f_1 = -1;
		func_92(iParam0, false);
		func_93(iParam0, false);
		func_94(iParam0, false);
		func_95(iParam0, false);
		func_96(iParam0, false);
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3C35 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
		func_12(&(uParam0->f_1), 256);
	else
		func_99(&(uParam0->f_1), 256);

	return;
}

void func_62(var uParam0, BOOL bParam1) // Position - 0x3C5B Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
		func_12(&(uParam0->f_1), 4);
	else
		func_99(&(uParam0->f_1), 4);

	return;
}

void func_63(var uParam0, BOOL bParam1) // Position - 0x3C7D Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
		func_12(&(uParam0->f_1), 2);
	else
		func_99(&(uParam0->f_1), 2);

	return;
}

void func_64(var uParam0, BOOL bParam1) // Position - 0x3C9F Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
		func_12(&(uParam0->f_1), 1);
	else
		func_99(&(uParam0->f_1), 1);

	return;
}

void func_65(var uParam0, BOOL bParam1) // Position - 0x3CC1 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
		func_12(&(uParam0->f_1), 16);
	else
		func_99(&(uParam0->f_1), 16);

	return;
}

void func_66(var uParam0, BOOL bParam1) // Position - 0x3CE5 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
		func_12(&(uParam0->f_1), 8);
	else
		func_99(&(uParam0->f_1), 8);

	return;
}

BOOL func_67(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3D09 Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_100(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_68(var uParam0) // Position - 0x3D63 Hash - 0xE62223CB ^0xE62223CB
{
	if (!uParam0->f_469[7])
	{
		func_101(*uParam0, false);
		uParam0->f_469[7] = 1;
	}
...
void func_69(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3D88 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_43() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_43();

	func_44(&(Global_32074.f_2697.f_6[iParam0 /*6*/].f_5), 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7, 0, 0, 0, false);
	...
	func_45(iParam0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 2, 0, 0);
	func_102(iParam0);
...
BOOL func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E8C Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_106(fParam2);
		num2 = func_107(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_108(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_109(&(uParam0->f_490)))
							func_110(&(uParam0->f_490));
					
						if (func_111(&(uParam0->f_490), fParam1))
						{
...
BOOL func_71(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4099 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_106(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_108(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_109(&(uParam0->f_490)))
							func_113(&(uParam0->f_490), false);
					
						if (func_114(&(uParam0->f_490)))
							func_115(&(uParam0->f_490));
					
						if (func_116(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_109(&(uParam0->f_490)) && !func_114(&(uParam0->f_490)))
...
void func_72(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, float fParam5) // Position - 0x41C2 Hash - 0x5050B938 ^0x5BDC33E5
{
	TASK::TASK_START_SCENARIO_IN_PLACE_HASH(pedParam0, hParam1, iParam2, bParam3, hParam4, fParam5, false);
	return;
}

void func_73(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x41DB Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
float func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x432F Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4396 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x43BF Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_118(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_77(var uParam0, var uParam1, var uParam2) // Position - 0x440B Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_118(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_78(int iParam0) // Position - 0x445A Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_79(int iParam0) // Position - 0x447F Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_80(int iParam0) // Position - 0x4492 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_81(int iParam0) // Position - 0x44A5 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_82(int iParam0) // Position - 0x44B8 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_83(int iParam0) // Position - 0x44CA Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_84(int iParam0, int iParam1) // Position - 0x44DC Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4576 Hash - 0xA65AB937 ^0xA65AB937
{
	func_120(iParam0, iParam6);
	func_121(iParam0, iParam5);
	func_122(iParam0, iParam4);
	func_123(iParam0, iParam3);
	func_124(iParam0, iParam2);
	func_125(iParam0, iParam1);
	return;
}

BOOL func_86() // Position - 0x45AE Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_87(int iParam0) // Position - 0x4601 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_90(iParam0))
		return -1;
...
BOOL func_88(int iParam0) // Position - 0x4621 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_89(int iParam0, int iParam1) // Position - 0x4637 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_90(int iParam0) // Position - 0x4646 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_91(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4679 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_128(eptParam1))
		{
			func_129(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_131(pedParam0, false);
			flag = true;
		}
	
		func_132(pedParam0, iParam2);
	}
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x475A Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_99(iParam0, 4);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4778 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_99(iParam0, 8);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4798 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_99(iParam0, 16);
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x47C3 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_99(iParam0, 32);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x47E3 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_99(iParam0, 64);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4803 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_99(iParam0, 1024);
	else
		func_12(iParam0, 1024);

	return;
}

void func_98(int iParam0, BOOL bParam1) // Position - 0x4825 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_99(iParam0, 1048576);
	else
		func_12(iParam0, 1048576);

	return;
}

void func_99(int iParam0, int iParam1) // Position - 0x4849 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_100(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x485A Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_133(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_135(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_137(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_135(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_139(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_140(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_141(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_135(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_142(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_135(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_143(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_135(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_143(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_135(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_146(iParam2, 4000))
				{
					if (func_147(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_148(iParam2, pedParam0) && func_149(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_135(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_147(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_148(iParam2, pedParam0) && func_149(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_135(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_150(pedParam0, Global_1935630.f_41))
							{
								func_151();
								*uParam3 = 2;
								func_135(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_152(iParam2, pedParam0) || iParam2->f_9 > 0 && func_153() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_154())
					{
						if (func_150(pedParam0, Global_1935630.f_42))
						{
							func_151();
							*uParam3 = 2;
							func_135(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_156(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_135(pedParam0, iParam2, *uParam3);
					return true;
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4E83 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_43() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_43();
...
void func_102(int iParam0) // Position - 0x4F5A Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_46(iParam0))
	{
		...
		{
			case 1:
				func_163(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_163(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_163(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_103(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4FDB Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_118(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_104(Ped pedParam0) // Position - 0x50CC Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_105(Ped pedParam0) // Position - 0x50E7 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_106(int iParam0) // Position - 0x5103 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_107(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x514A Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_108(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x5168 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_164(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_109(var uParam0) // Position - 0x51BF Hash - 0x5001E582 ^0x5001E582
{
	return func_165(*uParam0, 1);
}

void func_110(var uParam0) // Position - 0x51CF Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_166(uParam0, 0f);
	return;
}

BOOL func_111(var uParam0, float fParam1) // Position - 0x51DE Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_112(var uParam0) // Position - 0x51FC Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_113(var uParam0, BOOL bParam1) // Position - 0x5212 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_114(var uParam0) // Position - 0x5232 Hash - 0x39705408 ^0x39705408
{
	return func_165(*uParam0, 2);
}

void func_115(var uParam0) // Position - 0x5242 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_109(uParam0);

	if (func_114(uParam0))
	{
		uParam0->f_1 = func_167() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_168(uParam0, 2);
	}
...
BOOL func_116(var uParam0, float fParam1) // Position - 0x5276 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_109(uParam0))
		return false;
...
void func_117(var uParam0) // Position - 0x529D Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_109(uParam0);

	if (!func_114(uParam0))
	{
		uParam0->f_2 = func_167() - uParam0->f_1;
		func_170(uParam0, 2);
	}
...
BOOL func_118(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x52CD Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_119(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5322 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_120(int iParam0, int iParam1) // Position - 0x5339 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_121(int iParam0, int iParam1) // Position - 0x53BF Hash - 0x96B01D2A ^0x81E68218
{
...
void func_122(int iParam0, int iParam1) // Position - 0x53FB Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_123(int iParam0, int iParam1) // Position - 0x544E Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_124(int iParam0, int iParam1) // Position - 0x5489 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_125(int iParam0, int iParam1) // Position - 0x54C2 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_126(int iParam0) // Position - 0x54FA Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_127(BOOL bParam0) // Position - 0x5538 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_128(ePedType eptParam0) // Position - 0x554B Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_129(Ped pedParam0, Hash hParam1) // Position - 0x599E Hash - 0x7DC9219D ^0x179B7E7C
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_171(pedParam0, hParam1))
		{
...
void func_130(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5A45 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_131(Ped pedParam0, BOOL bParam1) // Position - 0x5A75 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_132(Ped pedParam0, int iParam1) // Position - 0x5ABA Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_133(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5AE1 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_175(iParam2);
				...
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						if (PED::IS_PED_PLANTING_BOMB(Global_35))
							func_99(iParam0, 33554432);
					else if (!(*iParam0 & 8192 != 0))
						if (func_177(true))
							func_99(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_177(true) || *iParam0 & 8192 != 0)
					func_12(iParam0, 33554432);
			break;
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_178(iParam0))
				iParam0->f_15 = func_153();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_153() - iParam0->f_15 > 500)
			{
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x5CAC Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_180(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_181(pedParam0, pedIndexFromEntityIndex) <= func_182(iParam1))
				return true;
			break;
	}
...
void func_135(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5D83 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_183(iParam2, 1, 1, 1, 0))
		func_99(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_184(iParam1, true);
	func_185();
	return;
}

BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x5DC0 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_186(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_188(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_189(iParam1);
...
BOOL func_137(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5EA7 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_190(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_187(iParam2);
	
		if (func_188(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_189(iParam2))
				{
					func_184(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5F7D Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_180(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_189(iParam1))
		{
			customDistance = func_187(iParam1);
...
BOOL func_139(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6086 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x61BB Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x61F2 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x62F9 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_193(iParam2))
	{
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6364 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_195(pedParam1, entityCoords, outCoords))
					{
						func_184(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_195(pedParam1, entityCoords, outCoords2))
					{
						func_184(iParam2, true);
						return true;
					}
...
BOOL func_144(Ped pedParam0, int iParam1) // Position - 0x64AC Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_180(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_196(Global_1935630.f_34[i]);
			...
			if (func_197(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_198(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_199(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_145(var uParam0, int iParam1) // Position - 0x668C Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0x6704 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_147(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6733 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_148(int iParam0, Ped pedParam1) // Position - 0x68B9 Hash - 0x42A83B1F ^0xC33BD099
{
	int _int;
...
BOOL func_149(int iParam0, Ped pedParam1) // Position - 0x6909 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_202(iParam0))
		return true;
...
BOOL func_150(Ped pedParam0, Ped pedParam1) // Position - 0x69A6 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_203(pedParam0, pedParam1, true, true) < 4f)
...
void func_151() // Position - 0x69F3 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x69FB Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_204(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_153();
			return true;
		}
...
int func_153() // Position - 0x6ABC Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_154() // Position - 0x6ADA Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_153() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6B27 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_206(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_207(pedParam1);
	num2 = func_208(iParam0->f_14);
...
BOOL func_156(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6C43 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_209(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6C8B Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_210(pedParam0, iParam1, true))
			return true;
...
BOOL func_158(Ped pedParam0, int iParam1) // Position - 0x6EE4 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_212(0))
		return false;
...
BOOL func_159(int iParam0, int iParam1) // Position - 0x6F1D Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_160(var uParam0, int iParam1) // Position - 0x6F4C Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6F60 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_153();
	else if (func_153() - iParam1->f_4 > func_213(iParam1))
		return func_214(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_162(int iParam0, Ped pedParam1) // Position - 0x6FAD Hash - 0x81C2F385 ^0x7B63257
{
...
void func_163(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7000 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_215(iParam0) == 1 && bParam7)
		return;
...
float func_164(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x708C Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x70AA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_166(var uParam0, float fParam1) // Position - 0x70B9 Hash - 0x30433BAB ^0xF854D531
{
...
float func_167() // Position - 0x70DF Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_168(var uParam0, int iParam1) // Position - 0x7111 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_169(var uParam0) // Position - 0x7126 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_109(uParam0))
		return uParam0->f_1;
...
void func_170(var uParam0, int iParam1) // Position - 0x715B Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x716C Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x719A Hash - 0xC81D76EC ^0xA0DEB068
{
	Hash _int;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x71EA Hash - 0xC81D76EC ^0xA0DEB068
{
	Hash _int;
	int _int2;
...
void func_174(Ped pedParam0) // Position - 0x725A Hash - 0xACF0EF0D ^0x9D7090E8
{
...
void func_175(int iParam0) // Position - 0x7277 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_218(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_176(int iParam0) // Position - 0x73E3 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_177(BOOL bParam0) // Position - 0x73F6 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_219(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_178(int iParam0) // Position - 0x7410 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_179(int iParam0) // Position - 0x74AA Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_180(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x74D1 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_208(pedParam2);
	else
		num2 = func_207(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_208(pedParam0);
	else
		num = func_207(pedParam0);
...
float func_181(Ped pedParam0, Ped pedParam1) // Position - 0x75CA Hash - 0xF9959663 ^0xF9959663
{
	return func_203(pedParam0, pedParam1, true, true);
}

float func_182(int iParam0) // Position - 0x75DC Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_183(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x75E8 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_184(int iParam0, BOOL bParam1) // Position - 0x764D Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_99(iParam0, 134217728);
	else
		func_12(iParam0, 134217728);

	return;
}

void func_185() // Position - 0x7673 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_186(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7687 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_203(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_222(ped, 0)))
			if (func_223(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_187(int iParam0) // Position - 0x77E7 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_188(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x77F3 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_189(int iParam0) // Position - 0x7854 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_190(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7860 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_222(ped, 0)))
			if (func_224(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_191(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7922 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_192(int iParam0) // Position - 0x79C0 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_193(int iParam0) // Position - 0x79CC Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_194(int iParam0) // Position - 0x79D8 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_195(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7B15 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_225(pedParam0, vParam4, 0.5f))
...
BOOL func_196(Ped pedParam0) // Position - 0x7B58 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_226(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7BBE Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C05 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7C50 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_200(Ped pedParam0, var uParam1) // Position - 0x7CC9 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_201(Ped pedParam0, Ped pedParam1) // Position - 0x7D16 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_228(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_202(int iParam0) // Position - 0x7D5E Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_203(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7D6E Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_204(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7DB6 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_205(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7DE2 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_206(int iParam0) // Position - 0x7E0A Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_207(Ped pedParam0) // Position - 0x7E16 Hash - 0xEB445B10 ^0x9CD13C05
{
...
int func_208(Ped pedParam0) // Position - 0x7E6E Hash - 0x6E063231 ^0x60E09C90
{
...
BOOL func_209(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7EDE Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_203(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_203(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_210(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8050 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_219(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_211(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_211(iParam1, ped2))
...
BOOL func_211(int iParam0, Ped pedParam1) // Position - 0x813E Hash - 0x27FC2906 ^0x8966C2D7
{
...
BOOL func_212(int iParam0) // Position - 0x81B4 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_229())
		return false;

	return func_230(Global_1347702[58 /*49*/].f_15, true);
}

int func_213(int iParam0) // Position - 0x81D6 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_214(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x81E2 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_215(int iParam0) // Position - 0x825D Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_216() // Position - 0x8270 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_217() // Position - 0x827E Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_231())
		return false;
...
void func_218(Any* panParam0, int iParam1) // Position - 0x82D4 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_219(BOOL bParam0, var uParam1, var uParam2) // Position - 0x837E Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_220(int iParam0) // Position - 0x8445 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_221(int iParam0) // Position - 0x84ED Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_222(Ped pedParam0, int iParam1) // Position - 0x8552 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_223(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8569 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_224(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_224(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8597 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x85E1 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_226(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8622 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_227(Ped pedParam0) // Position - 0x869B Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_228(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8783 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_229() // Position - 0x87C5 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_216() != -1)
		return false;
...
BOOL func_230(int iParam0, BOOL bParam1) // Position - 0x87EA Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_231() // Position - 0x881B Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_232(int iParam0) // Position - 0x884C Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_90(iParam0))
		return -1;
...
int func_233(int iParam0) // Position - 0x8868 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_234(int iParam0) // Position - 0x88A9 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
