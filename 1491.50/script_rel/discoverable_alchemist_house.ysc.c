...
void main() // Position - 0x0 Hash - 0x54A9ED6B ^0xBF64DCBB
{
	...
	iLocal_22.f_1 = anScriptParam_0.f_1;
		...
		switch (iLocal_20)
		{
			case 0:
				if (func_3(&iLocal_22))
				{
					...
					if (iLocal_22.f_4 == -1)
						iLocal_22.f_4 = func_4(&iLocal_22);
				}
				break;
...
BOOL func_3(var uParam0) // Position - 0xD1 Hash - 0xF06FC284 ^0xC0DEC5DC
{
	...
	if (iLocal_22 == 0)
	{
		...
		iLocal_22 = func_10(scenarioPointType);
		return false;
	}

	if (func_11(iLocal_22, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0) // Position - 0xA35 Hash - 0xA575530C ^0xA575530C
{
	Ped mount;
	...
	switch (iLocal_14)
	{
		...
		case 1:
			if (func_52(Global_35, func_51(1), 100f, true, true))
			{
				iLocal_14.f_1 = OBJECT::GET_RAYFIRE_MAP_OBJECT(func_51(0), 10f, "DES_dis_alchemist");
			
				if (OBJECT::DOES_RAYFIRE_MAP_OBJECT_EXIST(iLocal_14.f_1))
				{
					OBJECT::SET_STATE_OF_RAYFIRE_MAP_OBJECT(iLocal_14.f_1, 4);
					func_50(&iLocal_14, 2);
				}
			}
			break;
		...
		case 2:
			if (OBJECT::DOES_RAYFIRE_MAP_OBJECT_EXIST(iLocal_14.f_1) && OBJECT::GET_STATE_OF_RAYFIRE_MAP_OBJECT(iLocal_14.f_1) == 5)
				func_50(&iLocal_14, 3);
			break;
	
		case 3:
			if (func_52(Global_35, func_51(1), 75f, true, true))
			{
				if (!PED::IS_PED_IN_ANY_TRAIN(Global_35) && func_53(Global_35, func_51(0), 0))
				{
					func_25(&(iLocal_14.f_2));
					OBJECT::SET_STATE_OF_RAYFIRE_MAP_OBJECT(iLocal_14.f_1, 6);
					AUDIO::AUDIO_TRIGGER_EXPLOSION("EXPLOSIONS_SCRIPTED_WOODEN_BUILDING", func_51(2));
					iLocal_14.f_5 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(joaat("EVENT_SHOCKING_BEAT_TERRIFYING_NEW"), func_51(1), 30f, 100f, 150f, -1082130432, -1082130432, -1, -1);
					func_50(&iLocal_14, 4);
				}
			}
			break;
		...
		case 4:
			if (func_26(&(iLocal_14.f_2)) > 100)
			{
				if (PED::IS_PED_FULLY_ON_MOUNT(Global_35, true))
				{
					...
					{
						PED::_HORSE_AGITATE(mount, false);
						func_54(1635537886);
						func_55(-1123615607);
						func_56(uParam0);
						func_50(&iLocal_14, 5);
...
void func_9(var uParam0) // Position - 0xBF4 Hash - 0xF85FDBFC ^0x93CC13B4
{
	func_57(&(iLocal_14.f_5));
	func_58(1635537886);
	return;
}

int func_10(Hash hParam0) // Position - 0xC0D Hash - 0xB8EC44B7 ^0xB12C5BE7
{
	switch (hParam0)
	{
...
BOOL func_11(int iParam0, BOOL bParam1) // Position - 0x13FE Hash - 0x92045BA6 ^0x92045BA6
{
	if (!func_59(iParam0))
		return false;
...
void func_12(var uParam0) // Position - 0x1428 Hash - 0xDA8817E5 ^0xAD3AC0C4
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
Vector3 func_13(var uParam0, int iParam1) // Position - 0x190D Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case -1859023693:
...
float func_14(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1DC3 Hash - 0x3DAE1415 ^0x2267FA69
{
...
BOOL func_15() // Position - 0x1DEB Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_64() != -1)
		return false;
...
BOOL func_16(int iParam0) // Position - 0x1E10 Hash - 0x7F255B4B ^0xCD4BFF4B
{
...
BOOL func_17(var uParam0) // Position - 0x1E6F Hash - 0x700EF42A ^0x1FB24E73
{
...
void func_18(var uParam0) // Position - 0x1E88 Hash - 0xB1BE772 ^0x50C155FC
{
	if (func_33(uParam0->f_6.f_8))
...
void func_19(var uParam0, int iParam1) // Position - 0x1EC8 Hash - 0x4F8BE4B5 ^0x8A18C31F
{
	uParam0->f_5 = iParam1;
	return;
}

BOOL func_20(var uParam0) // Position - 0x1ED6 Hash - 0x52835008 ^0x3922FFAC
{
	switch (*uParam0)
	{
		case -1859023693:
...
void func_21(var uParam0) // Position - 0x2B91 Hash - 0x32186C70 ^0xD26CF7E4
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2DA9 Hash - 0x16E871AD ^0x10C54C39
{
...
void func_23(var uParam0) // Position - 0x2DD3 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_24(var uParam0) // Position - 0x2DE9 Hash - 0x5001E582 ^0x5001E582
{
	return func_68(*uParam0, 1);
}

void func_25(var uParam0) // Position - 0x2DF9 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_69(uParam0, 0f);
	return;
}

int func_26(var uParam0) // Position - 0x2E08 Hash - 0xE440ADBD ^0x7BE35012
{
	if (!func_24(uParam0))
...
BOOL func_27(var uParam0, BOOL bParam1) // Position - 0x2E5B Hash - 0x1ACEECAF ^0xDBC34297
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (bParam1)
	{
		...
		if (*uParam0 == -1761578407 || *uParam0 == 404434344 || *uParam0 == -1243267511 || *uParam0 == -607940493 || *uParam0 == 1535254161)
		{
			...
			if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, uParam0->f_6.f_9, true, 0) || !func_53(Global_35, uParam0->f_6.f_2, 0))
				return true;
		}
		else if (func_14(Global_35, uParam0->f_6.f_2, true) > uParam0->f_6.f_1 + 0.5f || !func_53(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
	else
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, true) <= uParam0->f_6.f_1 && func_53(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
...
void func_28(var uParam0) // Position - 0x307D Hash - 0x96ECE1F9 ^0x739EAAF6
{
	if (!func_33(uParam0->f_6.f_8))
	{
...
char* func_29(var uParam0) // Position - 0x34CD Hash - 0x7223E95E ^0xFC76A718
{
	if (*uParam0 == 404434344)
		if (func_49(*uParam0))
...
void func_30(var uParam0, int iParam1, char* sParam2, BOOL bParam3) // Position - 0x3D3E Hash - 0x92B8786B ^0x6992BF35
{
	int num;
	int num2;
	int num3;
...
BOOL func_31(var uParam0) // Position - 0x3E09 Hash - 0x87BF472A ^0x8A3FB963
{
...
void func_32(int iParam0, BOOL bParam1) // Position - 0x3E24 Hash - 0x54AA129E ^0x54AA129E
{
	if (!func_59(iParam0))
		return;
...
BOOL func_33(int iParam0) // Position - 0x3E5A Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
void func_34(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3E99 Hash - 0x139797B1 ^0x139797B1
{
	int num;
...
void func_35(var uParam0) // Position - 0x3EC5 Hash - 0xB093A844 ^0xA61CDF5C
{
	if (func_64() != -1)
		return;
...
void func_36(var uParam0, BOOL bParam1) // Position - 0x3F53 Hash - 0x3BBAC949 ^0x751C9296
{
	int num;
...
void func_37(BOOL bParam0, int iParam1) // Position - 0x4024 Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
float func_38(int iParam0, BOOL bParam1) // Position - 0x406A Hash - 0x376EA9F4 ^0xA7A80B21
{
	int num;
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x40C2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_40(var uParam0, int iParam1) // Position - 0x40D1 Hash - 0xF55E891F ^0xF55E891F
{
	func_93(uParam0, iParam1);
	return;
}

void func_41(var uParam0) // Position - 0x40E1 Hash - 0x7DD80D7C ^0x2A3ED7AA
{
...
void func_42(var uParam0) // Position - 0x4128 Hash - 0xC9354E8F ^0x12F79925
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
void func_43(var uParam0, int iParam1) // Position - 0x4148 Hash - 0xF55E891F ^0xF55E891F
{
	func_94(uParam0, iParam1);
	return;
}

void func_44(var uParam0) // Position - 0x4158 Hash - 0x90A3D13B ^0x25DA303B
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
BOOL func_45(int iParam0) // Position - 0x4174 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -1891628345:
...
BOOL func_46(var uParam0) // Position - 0x41F2 Hash - 0xA77C53D8 ^0x41543EB2
{
	Vector3 vector;
	var coords;
...
void func_47(int iParam0, int iParam1, int iParam2, const char* sParam3, Entity eParam4, BOOL bParam5, int iParam6, BOOL bParam7) // Position - 0x427B Hash - 0xA48CCCFA ^0xD20D1AD3
{
	int num;
	int num2;
	int i;
...
int func_48() // Position - 0x437A Hash - 0x9F572D68 ^0xF72C993B
{
	return 233600584;
}

BOOL func_49(int iParam0) // Position - 0x4387 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_11(iParam0, 2);
}

void func_50(var uParam0, int iParam1) // Position - 0x4396 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

Vector3 func_51(int iParam0) // Position - 0x43A3 Hash - 0xAA109ABB ^0xAA109ABB
{
	switch (iParam0)
	{
		case 0:
			return -5093.4424f, -2524.0767f, -8.55588f;
	
		case 1:
			return -5094.269f, -2522.523f, -11.11167f;
	
		case 2:
			return -5094.521f, -2523.1782f, -6.38495f;
...
BOOL func_52(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x440A Hash - 0x4F47D7F1 ^0x1C676405
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
	...
	if (bParam6)
		if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
			return true;
	else if (func_101(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
		return true;

	return false;
}

BOOL func_53(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x4465 Hash - 0xE63CB60C ^0x5133A9E3
{
...
void func_54(Hash hParam0) // Position - 0x44A6 Hash - 0x78302BA0 ^0x558F2DE9
{
...
void func_55(int iParam0) // Position - 0x44BE Hash - 0xE2FB6CC5 ^0x3F95ACE7
{
	int num;
	int num2;
	int offset;
...
void func_56(var uParam0) // Position - 0x4557 Hash - 0x46A0187B ^0x46A0187B
{
	if (!func_49(*uParam0))
	{
		func_103(*uParam0);
...
void func_57(var uParam0) // Position - 0x4577 Hash - 0x8C708434 ^0x4D6FD798
{
	if (*uParam0 != 0)
	{
...
void func_58(Hash hParam0) // Position - 0x4592 Hash - 0x7DD010A2 ^0xA0826F55
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
...
BOOL func_59(int iParam0) // Position - 0x45A9 Hash - 0x1965A61D ^0x1965A61D
{
	int num;
...
int func_60(int iParam0, int iParam1) // Position - 0x45C8 Hash - 0x18EDA9F0 ^0x18EDA9F0
{
	switch (iParam0)
	{
		case -2108030724:
...
Vector3 func_61(var uParam0, int iParam1) // Position - 0x4C11 Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case 2000209669:
...
Vector3 func_62(var uParam0, int iParam1) // Position - 0x4D22 Hash - 0xC47AB599 ^0xC47AB599
{
	switch (*uParam0)
	{
		case -2009137002:
...
Vector3 func_63(var uParam0, int iParam1) // Position - 0x569A Hash - 0xBAE0ABDC ^0xBAE0ABDC
{
	switch (*uParam0)
	{
		case -1887999095:
...
BOOL func_64() // Position - 0x592C Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0, BOOL bParam1) // Position - 0x593A Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_66(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x596B Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
void func_67(var uParam0) // Position - 0x59BF Hash - 0x87234A3C ^0x21D7A27C
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x5F30 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_69(var uParam0, float fParam1) // Position - 0x5F3F Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_109() - fParam1;
	func_110(uParam0, 1);
	func_111(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
BOOL func_70(var uParam0) // Position - 0x5F65 Hash - 0x39705408 ^0x39705408
{
	return func_68(*uParam0, 2);
}

int func_71() // Position - 0x5F75 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_72(var uParam0) // Position - 0x5F93 Hash - 0xD965F2AB ^0x4503AF3C
{
	switch (*uParam0)
	{
		case -1300082860:
			if (func_52(Global_35, func_104(uParam0, 0), 3f, true, true))
				return true;
			break;
...
BOOL func_73(var uParam0, int iParam1) // Position - 0x6064 Hash - 0x787E614B ^0xC23272A0
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
...
int func_74(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x61E7 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
...
void func_75(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x62BE Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
void func_76(int iParam0) // Position - 0x6309 Hash - 0x4FCB23E1 ^0x764A8AAB
{
	int num;
...
int func_77(int iParam0) // Position - 0x634B Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

BOOL func_78(int iParam0, BOOL bParam1) // Position - 0x6355 Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_79(int iParam0, BOOL bParam1) // Position - 0x63AD Hash - 0x7190BAC6 ^0x6DC372CF
{
...
Hash func_80(int iParam0) // Position - 0x6405 Hash - 0xB8EC44B7 ^0x184A6D50
{
	switch (iParam0)
	{
		case 0:
...
Hash func_81(int iParam0, int iParam1) // Position - 0x652E Hash - 0xE1D12727 ^0x5FD78BB4
{
	switch (iParam0)
	{
		case -2009137002:
...
void func_82(var uParam0) // Position - 0x6816 Hash - 0x12B095D ^0x8F05BAE7
{
	if (func_64() != -1)
		return;
...
int func_83() // Position - 0x6857 Hash - 0x1767447B ^0x234018D7
{
	int i;
	int num;
	int num2;
...
BOOL func_84() // Position - 0x6895 Hash - 0xA0319B77 ^0x14CE505F
{
	int i;
	int num;
...
BOOL func_85() // Position - 0x68D1 Hash - 0x37EC066 ^0xC9B08D38
{
	if (func_64() != -1)
		return false;
...
int func_86(int iParam0, int iParam1, int iParam2) // Position - 0x68F7 Hash - 0xFCD0B11D ^0x62D50FE4
{
	if (iParam1 == true)
	{
		switch (iParam0)
...
int func_87(int iParam0, int iParam1) // Position - 0x7103 Hash - 0xF3B2DCFE ^0x9CB24CD5
{
	int num;
...
void func_88(int iParam0, int iParam1) // Position - 0x7140 Hash - 0xC0D8FAC3 ^0xE4233006
{
...
int func_89() // Position - 0x7159 Hash - 0xFA45A8A9 ^0x233CB2BD
{
	int num;
...
BOOL func_90() // Position - 0x71DF Hash - 0x4A33814C ^0x6E4357BF
{
	Hash item;
...
void func_91(Hash hParam0, int iParam1) // Position - 0x730C Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_92() // Position - 0x731F Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

void func_93(var uParam0, int iParam1) // Position - 0x733E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_94(var uParam0, int iParam1) // Position - 0x734F Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_95(Volume volParam0, var uParam1) // Position - 0x7364 Hash - 0x7513460B ^0x6C9F3BDD
{
	float volumeScale;
...
Ped func_96(Ped pedParam0) // Position - 0x73E4 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_97(int iParam0) // Position - 0x73EE Hash - 0xA05361F6 ^0xF8A0FD3E
{
	switch (iParam0)
	{
...
int func_98(int iParam0) // Position - 0x7504 Hash - 0xC25EDEC0 ^0x47BF4274
{
	switch (iParam0)
	{
		case 0:
...
void func_99(int iParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, Entity eParam5, BOOL bParam6, BOOL bParam7) // Position - 0x75EB Hash - 0x9A51185A ^0xD7AFE5F1
{
	int num;
	int num2;
	int num3;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3, Entity eParam4, BOOL bParam5) // Position - 0x7990 Hash - 0x686957A ^0x8F82E8D6
{
...
float func_101(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x79EF Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_102(int iParam0, int iParam1) // Position - 0x7A0D Hash - 0xEA82FE59 ^0xEA82FE59
{
	switch (iParam0)
	{
		case -2106445152:
...
void func_103(int iParam0) // Position - 0x9112 Hash - 0xDA84A767 ^0xDA84A767
{
	func_32(iParam0, 2);
	func_143(iParam0);
	return;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
Vector3 func_104(var uParam0, int iParam1) // Position - 0x9127 Hash - 0xE500AA03 ^0xE500AA03
{
	switch (*uParam0)
	{
		case -2108030724:
...
Vector3 func_105(var uParam0, int iParam1) // Position - 0x9C2D Hash - 0xABFFD40 ^0xABFFD40
{
	switch (*uParam0)
	{
		case -2108030724:
...
int func_106(int iParam0) // Position - 0xA77C Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_146(iParam0))
		return -1;
...
void func_107(int iParam0) // Position - 0xA798 Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_148(iParam0))
		return;
...
char* func_108(var uParam0) // Position - 0xA84B Hash - 0x8601690B ^0x44FFF2C8
{
	switch (*uParam0)
	{
		case -1761578407:
...
float func_109() // Position - 0xAA12 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_110(var uParam0, int iParam1) // Position - 0xAA44 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_111(var uParam0, int iParam1) // Position - 0xAA55 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_112(int iParam0, int iParam1) // Position - 0xAA6A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_113() // Position - 0xAA79 Hash - 0xD50A7FC ^0x92986A81
{
...
BOOL func_114() // Position - 0xAB19 Hash - 0x52218EDE ^0x68EAB229
{
...
BOOL func_115() // Position - 0xABAE Hash - 0xD14A8C13 ^0x8AD85514
{
...
BOOL func_116(BOOL bParam0) // Position - 0xABEB Hash - 0x19762284 ^0xA27A0BCA
{
...
BOOL func_117(int iParam0) // Position - 0xAC23 Hash - 0xEEF44B5 ^0x85627F39
{
...
BOOL func_118() // Position - 0xACFB Hash - 0xFFDF5CA4 ^0x50D2CF98
{
...
BOOL func_119(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xAD12 Hash - 0x37FB14EB ^0x7E496A4A
{
...
BOOL func_120(int iParam0, int iParam1) // Position - 0xAD3B Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
Hash func_122(int iParam0) // Position - 0xB002 Hash - 0xB8EC44B7 ^0xC091C19D
{
	switch (iParam0)
	{
		case -2060865802:
...
int func_123(int iParam0) // Position - 0xB0F3 Hash - 0x333EB83A ^0x37C96C1F
{
	switch (iParam0)
	{
		case 0:
...
void func_124(BOOL bParam0) // Position - 0xB1F1 Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_125(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xB21B Hash - 0x41C0912B ^0x734B270C
{
	int num;
...
BOOL func_126(int iParam0) // Position - 0xB285 Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_162(iParam0);
}

int func_127(BOOL bParam0) // Position - 0xB293 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_64() == -1)
	{
...
void func_128() // Position - 0xB2D4 Hash - 0x5808700A ^0x37855CE9
{
...
int func_129() // Position - 0xB329 Hash - 0x990ADDDC ^0x7D78C12
{
	int num;
...
int func_130(int iParam0) // Position - 0xB43C Hash - 0xFA6423C1 ^0xB73AD7F1
{
	float num;
	float value;
...
BOOL func_131(int iParam0) // Position - 0xB4E1 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_165(iParam0))
		return false;
...
int func_132(int iParam0, int iParam1, int iParam2) // Position - 0xB4FD Hash - 0x1D7642BB ^0x1D7642BB
{
	if (iParam0 > iParam2)
		return iParam2;
...
int func_133(int iParam0) // Position - 0xB522 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case -320:
...
Hash func_134() // Position - 0xB5D9 Hash - 0xA46C8CCA ^0x71ABACD2
{
...
void func_135(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xB731 Hash - 0x25ED411C ^0xE6F9BEA9
{
...
void func_136(int iParam0) // Position - 0xB75D Hash - 0x1FF74488 ^0xA40278BB
{
...
// Unhandled jump detected. Output should be considered invalid
void func_137(BOOL bParam0) // Position - 0xB7C1 Hash - 0x9BEFE017 ^0x9BEFE017
{
	int num;
	Hash unlockHash;
	Hash hash;
...
struct<2> func_138(int iParam0) // Position - 0xB882 Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_139(var uParam0, var uParam1, int iParam2) // Position - 0xB892 Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

const char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xB8A2 Hash - 0xA17D549C ^0x129B24A
{
	switch (iParam0)
	{
		case joaat("honor_event_abandon_animals"):
...
int func_141(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xB9EE Hash - 0x72075C17 ^0x3AC6D3FB
{
	int num;
	var unk13;
	int num2;
...
int func_142(int iParam0, int iParam1) // Position - 0xBA51 Hash - 0x969A241 ^0xB7B020D1
{
	Hash chalHash;
	Hash goalHash;
...
void func_143(int iParam0) // Position - 0xBAAC Hash - 0xF9F788B3 ^0x8192C5D9
{
...
BOOL func_144() // Position - 0xBAE8 Hash - 0x18690106 ^0x764E08E6
{
	if (func_178(932909855))
		return true;

	return false;
}

BOOL func_145() // Position - 0xBB01 Hash - 0x18690106 ^0xE41C0B15
{
	if (func_178(2051822093))
		return true;

	return false;
}

BOOL func_146(int iParam0) // Position - 0xBB1A Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_147(int iParam0) // Position - 0xBB4D Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xBB8E Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_120(iParam0, 2);
}

BOOL func_149(Ped pedParam0) // Position - 0xBB9D Hash - 0xF2F988FE ^0xA63CD631
{
...
BOOL func_150(Ped pedParam0) // Position - 0xBC85 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_180(pedParam0, 4) || func_180(pedParam0, 5);
}

BOOL func_151(Ped pedParam0) // Position - 0xBCA1 Hash - 0x8F7DFED5 ^0x8768F0B4
{
	var lootTarget;
...
int func_152(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xBD0B Hash - 0x8EBD6187 ^0x42F0F0AC
{
	int num;
	var unk13;
	int num2;
...
BOOL func_153(int iParam0) // Position - 0xBD46 Hash - 0xCB0CD3AF ^0x98FF0773
{
	Ped mount;

	mount = PED::GET_MOUNT(Global_35);

	if (!func_181(Global_35))
		return false;

	if (!func_112(iParam0, 16) && !func_182(mount, false))
		return false;

	return true;
}

void func_154(int iParam0, BOOL bParam1) // Position - 0xBD84 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_155(int iParam0, int iParam1) // Position - 0xBDAD Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
void func_156(int iParam0, int iParam1) // Position - 0xBDD5 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_157(int iParam0, int iParam1) // Position - 0xBDE6 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_158(Hash hParam0, int iParam1) // Position - 0xBDFB Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
int func_159(Hash hParam0) // Position - 0xBE15 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_160(Hash hParam0, int iParam1) // Position - 0xBE40 Hash - 0x2A2D0794 ^0x8C1DA314
{
	Hash hash;
	int num;
	int num2;
	...
	hash = func_183(hParam0, iParam1);
	unk.f_9 = joaat("SLOTID_NONE");

	if (func_184("ALL WEAPONS", &num, &num2, joaat("SLOTID_NONE"), false))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			if (!func_185(&unk, i, num, num2))
			{
			}
...
int func_161(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xBEE8 Hash - 0x27EBD222 ^0x461275A8
{
	int num;
	Hash ammoType;
...
BOOL func_162(int iParam0) // Position - 0xBF6A Hash - 0xA059D395 ^0xE600C05
{
	return func_39(Global_1935496.f_27, iParam0);
}

int func_163() // Position - 0xBF7E Hash - 0xC5B83CF5 ^0xDBC2A9A7
{
	return Global_40.f_11095.f_35;
}

var func_164(BOOL bParam0, var uParam1, var uParam2) // Position - 0xBF8E Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_165(int iParam0) // Position - 0xBFA5 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_166(int iParam0) // Position - 0xBFB8 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_167(int iParam0, BOOL bParam1) // Position - 0xBFE2 Hash - 0xE5C16A63 ^0x600C7934
{
...
void func_168(Hash hParam0) // Position - 0xBFFD Hash - 0x246AED7E ^0x92A2F577
{
	COMPAPP::_0x74BCCEB233AD95B2(joaat("HonorMeterValue"), hParam0);
	return;
}

char* func_169(int iParam0) // Position - 0xC013 Hash - 0x8FB6A40C ^0xAEE8D13F
{
	if (iParam0 <= -320)
		return "HONOR_BAD_8";
	else if (iParam0 <= -280)
...
BOOL func_170(var uParam0) // Position - 0xC134 Hash - 0x89D7A86C ^0xC5CDC47A
{
	var unk;
...
BOOL func_171(int iParam0, var uParam1, var uParam2) // Position - 0xC17C Hash - 0x2D6E55B7 ^0xC1202559
{
	var unk;
	var unk6;
...
Hash func_172(Hash hParam0) // Position - 0xC1FC Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

int func_173() // Position - 0xC206 Hash - 0xE17CEFF5 ^0x60DBA116
{
	int num;
...
void func_174(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0xC255 Hash - 0xC233DF85 ^0x5FF82D96
{
...
BOOL func_175(int iParam0) // Position - 0xC286 Hash - 0xB0C53BA8 ^0xB0C53BA8
{
...
BOOL func_176(int iParam0, var uParam1, var uParam2) // Position - 0xC2A5 Hash - 0xB903AED3 ^0x206B1C87
{
	if (!func_175(iParam0))
		return false;
...
BOOL func_177(int iParam0) // Position - 0xC474 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -2009137002:
...
BOOL func_178(int iParam0) // Position - 0xC5A0 Hash - 0xBF89485 ^0x62E162D4
{
	int num;
	int num2;
	int offset;
...
int func_179(int iParam0) // Position - 0xC5EF Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
int func_180(Ped pedParam0, int iParam1) // Position - 0xC670 Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
BOOL func_181(Ped pedParam0) // Position - 0xC6AF Hash - 0x28235D58 ^0x5BD1001B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_182(Ped pedParam0, BOOL bParam1) // Position - 0xC6CC Hash - 0x6BE4D4B ^0xC7F6BBCD
{
	float entitySpeed;
	float num;
...
Hash func_183(Hash hParam0, int iParam1) // Position - 0xC722 Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_184(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xC79C Hash - 0xA7F38D3E ^0x25D43AAB
{
...
BOOL func_185(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC7C3 Hash - 0xF1DE71ED ^0x4F212F50
{
	if (iParam2 < 0)
		return false;
...
BOOL func_186(Hash hParam0) // Position - 0xC7FE Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_187(int iParam0) // Position - 0xC819 Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
int func_188(Hash hParam0, BOOL bParam1) // Position - 0xC83A Hash - 0x884C76BA ^0xDB141D11
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_193(hParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) };

	if (bParam1)
		func_195(&unk, func_194(false));

	if (!func_196(&unk, &num, &num2, false))
		return 0;
...
void func_189(BOOL bParam0) // Position - 0xC898 Hash - 0x970FE035 ^0x92589DF6
{
	func_197(bParam0);
...
BOOL func_190(int iParam0, var uParam1) // Position - 0xC8CB Hash - 0xDBBC0B25 ^0xDBBC0B25
{
	if (!func_198(iParam0))
		return false;
...
BOOL func_191(Hash hParam0, Hash hParam1) // Position - 0xC8F8 Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
void func_192(Hash hParam0, var uParam1, var uParam2) // Position - 0xC929 Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_193(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCB35 Hash - 0x84700F53 ^0xB9E7AA96
{
	Hash hash;
...
struct<4> func_194(BOOL bParam0) // Position - 0xCC07 Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
	...
	if (num == 2)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223200))
			Global_1223200 = { func_200(923904168, func_199(bParam0), -740156546, bParam0) };
	...
	else if (num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223208))
			Global_1223208 = { func_200(923904168, func_199(bParam0), -740156546, false) };
	
		return Global_1223208;
	}

	return func_200(923904168, func_199(bParam0), -740156546, false);
}

void func_195(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCC9C Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_196(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xCCB7 Hash - 0xA09A22CB ^0x2B47F617
{
...
void func_197(BOOL bParam0) // Position - 0xCCDC Hash - 0x246AED7E ^0xB30D729F
{
	COMPAPP::_0xB6FD96420C0126A1(joaat("HonorMeterVisible"), bParam0);
	return;
}

BOOL func_198(int iParam0) // Position - 0xCCEF Hash - 0x3270B633 ^0x3270B633
{
	return iParam0 > -1 && iParam0 < 25;
}

struct<4> func_199(BOOL bParam0) // Position - 0xCD05 Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_200(joaat("character"), func_201(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> func_200(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xCD21 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
struct<4> func_201() // Position - 0xCD52 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
