...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x4F5A7225
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	hLocal_9 = joaat("a_m_m_valfarmer_01");
	hLocal_11 = joaat("world_animal_horse_grazing_domestic");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_1(var uParam0) // Position - 0x588 Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x596 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x62C Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x18650D1C
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9EC Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA03 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAC1 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAEB Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC3C Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC51 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xCF5 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AA6 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B0C Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0xE8214E52 ^0xE8214E52
{
	Hash hash;

	func_46(uParam0, "FISHING_RIVER", "", vParam1, uParam4);
	hLocal_9 = func_48(func_47(), true, true, true, false, false, true);

	switch (*uParam0)
	{
		case 43:
			hash = func_49(joaat("horse_class_riding"), true);
			func_50(uParam0, 1, "FRP_HORSE", hash, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -5f, -2f, 0f), 35f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		
			if (uParam0->f_489 == 1)
				hLocal_11 = joaat("world_animal_horse_drink_ground_domestic");
			else
				hLocal_11 = joaat("world_animal_horse_grazing_domestic");
			break;
	
		case 44:
			hash = joaat("a_c_dogchesbayretriever_01");
			func_50(uParam0, 1, "FRP_DOG", hash, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1f, -1.35f, 0f), -18f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}

	func_50(uParam0, 0, "FRP_FISHERMAN", hLocal_9, vParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);

	if (uParam0->f_20[0 /*14*/].f_8 < 0f)
		uParam0->f_20[0 /*14*/].f_8 = uParam0->f_20[0 /*14*/].f_8 + 360f;

	func_50(uParam0, 2, "FRP_FISH", joaat("a_c_fishbluegil_01_sm"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 33f, -0.5f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1D1C Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1DBC Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1ED6 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x209F Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x20A8 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2258 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x22CC Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x231B Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2373 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24DC Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2803 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x293A Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A6A Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2AA9 Hash - 0xE5DA1988 ^0xC00DD76F
{
	if (*uParam0 == 44)
	{
		if (!VOLUME::DOES_VOLUME_EXIST(volLocal_12))
			volLocal_12 = VOLUME::CREATE_VOLUME_CYLINDER(uParam0->f_20[1 /*14*/].f_5 + { 0f, 3f, 2f }, 0f, 0f, -54f, 7f, 4f, 10f);
	
		if (!VOLUME::DOES_VOLUME_EXIST(volLocal_13))
			volLocal_13 = VOLUME::CREATE_VOLUME_CYLINDER(uParam0->f_483, 0f, 0f, 0f, 15f, 15f, 10f);
	}

	return true;
}

void func_29(var uParam0) // Position - 0x2B10 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B42 Hash - 0xFB958CDA ^0xFB958CDA
{
	func_58(&uLocal_14, false);
	func_59(&uLocal_14, true);
	func_60(&uLocal_14, true);
	func_61(&uLocal_14, true);
	func_62(&uLocal_14, true);
	func_63(&uLocal_14, true);
	func_64(&uLocal_14, true);
	func_65(&uLocal_14, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2B83 Hash - 0xACF5C95D ^0x3D6BE95C
{
	int taskSequenceId;

	if (!uParam0->f_469[1])
	{
		if (func_66(uParam0, &uLocal_14, false) || PED::_0x947E43F544B6AB34(uParam0->f_20[0 /*14*/], PLAYER::GET_PLAYER_INDEX(), 25, 10000))
		{
			func_67(uParam0);
			...
			if (!uParam0->f_469[2])
			{
				func_69(*uParam0, uParam0->f_483, false);
				uParam0->f_469[2] = 1;
			}
	...
	if (!bLocal_82)
	{
		if (func_70(uParam0->f_20[0 /*14*/], Global_35, true) < 144f)
		{
			func_71(uParam0->f_20[0 /*14*/], Global_35, "GREET_MALE", 0, -1082130432, 1, false, 0, 1, true, true, -417894478, true, false, 0);
			bLocal_82 = true;
		}
	}
	...
	if (!bLocal_83)
	{
		if (!uParam0->f_469[1])
		{
			if (!func_72(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_8, 30f))
			{
				if (!PED::_GET_IS_PED_IN_DISPUTE_WITH_PED(uParam0->f_20[0 /*14*/], 0))
				{
					iLocal_10 = 2;
					bLocal_83 = true;
				}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				func_73(&(uParam0->f_20[0 /*14*/].f_5), 50, 10, false);
				func_74(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 2, 1073741824);
				WEAPON::REMOVE_ALL_PED_WEAPONS(uParam0->f_20[0 /*14*/], true, true);
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("weapon_fishingrod"), 1, true, true, 0, false, 1056964608, 1065353216, 752097756, true, 0, false);
				...
				WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], joaat("weapon_fishingrod"), true, 0, false, false);
				MISC::REGISTER_INTERACTION_LOCKON_PROMPT(uParam0->f_20[0 /*14*/], "", 35f, 35f, 8, 0, 0, 0, false, -1);
				...
				func_75(&uParam0->f_20[0 /*14*/], false, true);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_73(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
			
				if (*uParam0 == 43)
				{
					func_74(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, 1073741824);
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], hLocal_11, 0, false, 0, -1082130432, false);
				}
			
				if (*uParam0 == 44)
				{
					PED::_SET_PED_PERSONALITY(uParam0->f_20[1 /*14*/], joaat("GUARD_DOG"));
					PED::_SET_PED_INTERACTION_PERSONALITY(uParam0->f_20[1 /*14*/], joaat("timidguarddog"));
					VOLUME::_0xD52DF30355EA7C8E(volLocal_13, uParam0->f_20[1 /*14*/], 1);
					VOLUME::_0x4A8FEFC43FD8AC9B(volLocal_13, 0, 1);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 297, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 130, false);
					PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], false);
					MISC::REGISTER_INTERACTION_LOCKON_PROMPT(uParam0->f_20[1 /*14*/], "", 2f, 2f, 8, 0, 0, 0, false, -1);
					TASK::TASK_ANIMAL_UNALERTED(uParam0->f_20[1 /*14*/], -1, volLocal_12, 0, 0);
					PED::SET_PED_KEEP_TASK(uParam0->f_20[1 /*14*/], true);
				}
			
				func_75(&uParam0->f_20[1 /*14*/], false, true);
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
				func_75(&uParam0->f_20[2 /*14*/], true, true);
		...
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				if (!bLocal_81)
				{
					if (func_76(uParam0->f_20[0 /*14*/], Global_35, true, true) <= 25f)
					{
						TASK::TASK_LOOK_AT_ENTITY(uParam0->f_20[0 /*14*/], Global_35, 7000, 0, 51, 0);
						func_77(&uLocal_84);
						bLocal_81 = true;
					}
				}
			
				if (PED::IS_PED_RESPONDING_TO_THREAT(uParam0->f_20[0 /*14*/]))
					return 1;
			}
		
			if (!TASK::_GET_TASK_FISHING(uParam0->f_20[0 /*14*/], &iLocal_42))
			{
				if (func_78(&uLocal_75, 120f))
				{
					iLocal_10 = 2;
					return 0;
				}
			...
			if (func_79(uParam0))
				TASK::_SET_TASK_FISHING(uParam0->f_20[0 /*14*/], &iLocal_42);
		
			if (!uParam0->f_469[0])
			{
				if (func_80(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					func_77(&uLocal_75);
					func_68(*uParam0, false);
					uParam0->f_469[0] = 1;
			...
			else if (!uParam0->f_469[2] && iLocal_42 > 2)
			{
				if (func_81(uParam0, 8f, 1116471296, 4, joaat("Action"), false))
				{
					func_69(*uParam0, uParam0->f_483, false);
					uParam0->f_469[2] = 1;
				}
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], joaat("WEAPON_UNARMED"), false, 0, false, false);
				...
				if (*uParam0 == 44)
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0, 0, 2f, 0f, 32, 2f, 0, 1069547520, 1073741824);
		...
		case 4:
			if (!PED::IS_PED_USING_ANY_SCENARIO(uParam0->f_20[1 /*14*/]))
				return 1;
			break;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x3180 Hash - 0xEC7E4735 ^0x876C08BE
{
	func_82(uParam0, false, false, false);

	if (*uParam0 == 44)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			MISC::UNREGISTER_INTERACTION_LOCKON_PROMPT(uParam0->f_20[0 /*14*/]);
	
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			MISC::UNREGISTER_INTERACTION_LOCKON_PROMPT(uParam0->f_20[1 /*14*/]);
	}

	if (VOLUME::DOES_VOLUME_EXIST(volLocal_12))
		VOLUME::DELETE_VOLUME(volLocal_12);

	if (VOLUME::DOES_VOLUME_EXIST(volLocal_13))
		VOLUME::DELETE_VOLUME(volLocal_13);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x31EE Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x320B Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3347 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3480 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x352A Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x35A2 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_84(entityForwardVector, unk5);
	...
	if (func_85(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3631 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x374C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3758 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x38E0 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3980 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3993 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x39AD Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3A15 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x3A41 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3A4F Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
Hash func_49(int iParam0, BOOL bParam1) // Position - 0x3C41 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_50(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3CFB Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D89 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_97(Global_1898164.f_1[0 /*5*/]);
	
		if (func_98(num) && func_99(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_52(int iParam0) // Position - 0x3F8D Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3FA1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3FB0 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_83() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x3FCB Hash - 0xD921C289 ^0x49FA217D
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x402D Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x406F Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x409B Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
		func_102(iParam0, true);
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x4117 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
		func_9(&(uParam0->f_1), 256);
	else
		func_109(&(uParam0->f_1), 256);

	return;
}

void func_60(var uParam0, BOOL bParam1) // Position - 0x413D Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
		func_9(&(uParam0->f_1), 4);
	else
		func_109(&(uParam0->f_1), 4);

	return;
}

void func_61(var uParam0, BOOL bParam1) // Position - 0x415F Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
		func_9(&(uParam0->f_1), 2);
	else
		func_109(&(uParam0->f_1), 2);

	return;
}

void func_62(var uParam0, BOOL bParam1) // Position - 0x4181 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
		func_9(&(uParam0->f_1), 8);
	else
		func_109(&(uParam0->f_1), 8);

	return;
}

void func_63(var uParam0, BOOL bParam1) // Position - 0x41A5 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
		func_9(&(uParam0->f_1), 1);
	else
		func_109(&(uParam0->f_1), 1);

	return;
}

void func_64(var uParam0, BOOL bParam1) // Position - 0x41C7 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
		func_9(&(uParam0->f_1), 16);
	else
		func_109(&(uParam0->f_1), 16);

	return;
}

void func_65(int iParam0, BOOL bParam1) // Position - 0x41EB Hash - 0x3BE1C7D2 ^0x3BE1C7D2
{
	if (bParam1)
		func_109(iParam0, 128);
	else
		func_9(iParam0, 128);
...
BOOL func_66(var uParam0, int iParam1, BOOL bParam2) // Position - 0x420B Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_110(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_67(var uParam0) // Position - 0x4265 Hash - 0xB50B91C5 ^0xA29031DF
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], joaat("weapon_revolver_cattleman"), true, 0, true, false);

	return;
}

void func_68(int iParam0, BOOL bParam1) // Position - 0x4290 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_69(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4367 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
float func_70(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x446B Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_113(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_71(Ped pedParam0, Ped pedParam1, char* sParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12, BOOL bParam13, int iParam14) // Position - 0x44C2 Hash - 0x943CD13D ^0x943CD13D
{
	return func_114(pedParam0, pedParam1, sParam2, iParam3, iParam4, iParam5, bParam6, iParam7, iParam8, bParam9, bParam10, iParam11, false, bParam12, bParam13, iParam14) >= 0;
}

BOOL func_72(Ped pedParam0, float fParam1, float fParam2) // Position - 0x44EF Hash - 0x3EDA83B6 ^0x3EDA83B6
{
	float num;
	float num2;
...
int func_73(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4590 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_74(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x4687 Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_116(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_117(pedParam0))
		if (func_118(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
	...
	if (func_119(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_119(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_119(iParam5, 32), true);
...
void func_75(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4909 Hash - 0x6DE5BABD ^0x14BE368D
{
...
float func_76(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4931 Hash - 0xD54E86C ^0xB31A48E2
{
...
void func_77(var uParam0) // Position - 0x4979 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_120(uParam0, 0f);
	return;
}

BOOL func_78(var uParam0, float fParam1) // Position - 0x4988 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_121(uParam0))
		return false;

	if (func_122(uParam0) > fParam1)
		return true;

	return false;
}

BOOL func_79(var uParam0) // Position - 0x49AF Hash - 0x93418C3 ^0xB26288D6
{
	switch (iLocal_42)
	{
		case 1:
			...
			if (!func_123(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_WEAPON")))
				TASK::TASK_WEAPON(uParam0->f_20[0 /*14*/]);
		
			return true;
	
		case 2:
			if (func_78(&uLocal_72, 2f))
			{
				bLocal_90 = false;
				func_124(&uLocal_78);
				iLocal_42.f_1 = MISC::GET_RANDOM_FLOAT_IN_RANGE(25f, 30f);
				iLocal_42.f_15 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0.9f, 1f);
				iLocal_42.f_14 = 0f;
				func_125(&(iLocal_42.f_6), 2048);
				func_126(&(iLocal_42.f_6), 1024);
			}
		...
		case 6:
			if (func_78(&uLocal_75, 80f) && !bLocal_87 && iLocal_42.f_2 > 15f && *uParam0 != 44)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_42.f_12))
					{
						if (func_76(iLocal_42.f_12, uParam0->f_20[2 /*14*/], true, true) < 1f)
						{
							iLocal_42.f_7 = uParam0->f_20[2 /*14*/];
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_20[2 /*14*/], false, true);
							TASK::_PED_FISHINGROD_HOOK_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[2 /*14*/]);
							func_126(&(iLocal_42.f_6), 8196);
							bLocal_87 = true;
						}
						else if (!func_123(uParam0->f_20[2 /*14*/], SCRIPT_TASK_GO_TO_ENTITY))
						{
							TASK::TASK_GO_TO_ENTITY(uParam0->f_20[2 /*14*/], iLocal_42.f_12, 20000, 0.5f, 1073741824, 1073741824, 0);
						}
					}
				}
			}
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_42.f_11))
					ENTITY::_0x978AA2323ED32209(iLocal_42.f_11, 0f);
			
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_42.f_12))
					ENTITY::_0x978AA2323ED32209(iLocal_42.f_12, 0f);
			
				if (bLocal_90)
				{
					if (!func_121(&uLocal_78))
						func_120(&uLocal_78, -1f * MISC::GET_RANDOM_FLOAT_IN_RANGE(2f, 4f));
				
					if (func_127(&uLocal_78, 0f) && iLocal_42.f_2 >= 4f)
					{
						func_125(&(iLocal_42.f_6), 2048);
						bLocal_90 = false;
					}
					else
					{
						...
						func_126(&(iLocal_42.f_6), 2048);
					}
				}
				else
				{
					if (!func_121(&uLocal_78))
						func_120(&uLocal_78, -1f * MISC::GET_RANDOM_FLOAT_IN_RANGE(7f, 12f));
				
					if (func_127(&uLocal_78, 0f))
						bLocal_90 = true;
				}
			}
		...
		case 7:
			if (func_119(iLocal_42.f_5, 2))
				PED::SET_PED_RESET_FLAG(uParam0->f_20[2 /*14*/], 167, true);
		...
		case 12:
			...
			if (!bLocal_89 && func_119(iLocal_42.f_5, 32))
			{
				func_126(&(iLocal_42.f_6), 32);
				bLocal_89 = true;
			}
		
			if (func_119(iLocal_42.f_5, 64))
				func_128(&uParam0->f_20[2 /*14*/]);
...
BOOL func_80(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4CCF Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_131(fParam2);
		num2 = func_132(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_70(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_121(&(uParam0->f_490)))
							func_77(&(uParam0->f_490));
					
						if (func_127(&(uParam0->f_490), fParam1))
						{
							func_124(&(uParam0->f_490));
							return true;
						}
...
BOOL func_81(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4EDA Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_131(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_70(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_121(&(uParam0->f_490)))
							func_133(&(uParam0->f_490), false);
					
						if (func_134(&(uParam0->f_490)))
							func_135(&(uParam0->f_490));
					
						if (func_78(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_121(&(uParam0->f_490)) && !func_134(&(uParam0->f_490)))
			func_136(&(uParam0->f_490));
	}

	return false;
}

void func_82(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5003 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_83() // Position - 0x5157 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_84(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x5165 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_85(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x51CC Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_86(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x51F5 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_137(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_87(var uParam0, var uParam1, var uParam2) // Position - 0x5241 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_137(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_88(int iParam0) // Position - 0x5290 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_89(int iParam0) // Position - 0x52B5 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_90(int iParam0) // Position - 0x52C8 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_91(int iParam0) // Position - 0x52DB Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_92(int iParam0) // Position - 0x52EE Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_93(int iParam0) // Position - 0x5300 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_94(int iParam0, int iParam1) // Position - 0x5312 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x53AC Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_96() // Position - 0x53E4 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_97(int iParam0) // Position - 0x5437 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_100(iParam0))
		return -1;
...
BOOL func_98(int iParam0) // Position - 0x5457 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_99(int iParam0, int iParam1) // Position - 0x546D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_100(int iParam0) // Position - 0x547C Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_101(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x54AF Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_147(eptParam1))
		{
			func_148(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_150(pedParam0, false);
			flag = true;
		}
	
		func_151(pedParam0, iParam2);
	}
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x5590 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_109(iParam0, 4);
	else
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x55AE Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_109(iParam0, 8);
	else
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x55CE Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_109(iParam0, 16);
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x55F9 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_109(iParam0, 32);
	else
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x5619 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_109(iParam0, 64);
	else
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x5639 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_109(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x565B Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_109(iParam0, 1048576);
	else
...
void func_109(int iParam0, int iParam1) // Position - 0x567F Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_110(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x5690 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_152(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_154(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_156(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_154(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_158(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_159(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_160(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_154(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_161(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_154(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_162(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_154(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_162(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_154(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_165(iParam2, 4000))
				{
					if (func_166(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_167(iParam2, pedParam0) && func_168(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_154(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_166(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_167(iParam2, pedParam0) && func_168(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_154(pedParam0, iParam2, *uParam3);
					return true;
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_171(iParam2, pedParam0) || iParam2->f_9 > 0 && func_172() - iParam2->f_9 < 2000)
				{
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_175(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_154(pedParam0, iParam2, *uParam3);
					return true;
...
void func_111(int iParam0) // Position - 0x5CB9 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_182(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_182(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_182(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_112(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5D3A Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_137(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
float func_113(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5E2B Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_114(Ped pedParam0, Ped pedParam1, char* sParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14, int iParam15) // Position - 0x5E49 Hash - 0xD668806E ^0x3A7B5575
{
	BOOL flag;
	float num;
	int num2;
	...
	if (bParam9)
		if (pedParam0 != Global_35 && pedParam1 != Global_35)
			if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
				if (func_183(pedParam0, true, true) > iParam4)
					return -1;
	...
	{
		if (!flag)
			num = func_76(pedParam0, pedParam1, true, true);
		...
		if (flag || bParam7 || num < iParam4 || bParam9 == false)
		{
			...
			if (!flag && bParam10)
			{
				...
				if (func_184(pedParam0, pedParam1, num, bParam13))
			...
			{
				num2 = func_185(pedParam0, sParam2, iParam11, pedParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, iParam5, iParam15) ? 1 : -1;
			}
...
BOOL func_115(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x603A Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Ped func_116(Ped pedParam0) // Position - 0x6063 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_117(Ped pedParam0) // Position - 0x606D Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_118(Ped pedParam0) // Position - 0x609F Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_119(int iParam0, int iParam1) // Position - 0x60E1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_120(var uParam0, float fParam1) // Position - 0x60F0 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_121(var uParam0) // Position - 0x6116 Hash - 0x5001E582 ^0x5001E582
{
	return func_189(*uParam0, 1);
}

float func_122(var uParam0) // Position - 0x6126 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_121(uParam0))
		return uParam0->f_1;
...
BOOL func_123(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x615B Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
void func_124(var uParam0) // Position - 0x61B4 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_125(var uParam0, int iParam1) // Position - 0x61CA Hash - 0xF55E891F ^0xF55E891F
{
	func_190(uParam0, iParam1);
	return;
}

void func_126(var uParam0, int iParam1) // Position - 0x61DA Hash - 0xF55E891F ^0xF55E891F
{
	func_191(uParam0, iParam1);
	return;
}

BOOL func_127(var uParam0, float fParam1) // Position - 0x61EA Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_128(Ped* ppedParam0) // Position - 0x6208 Hash - 0xC4826352 ^0x8AD0FF3C
{
...
BOOL func_129(Ped pedParam0) // Position - 0x6267 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_130(Ped pedParam0) // Position - 0x6282 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_131(int iParam0) // Position - 0x629E Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()))
	{
		...
		if (WEAPON::_IS_WEAPON_SNIPER(weaponHash) || weaponHash == joaat("weapon_kit_binoculars"))
			if (CAM::IS_FIRST_PERSON_AIM_CAM_ACTIVE())
				iParam0 = iParam0 + (CAM::GET_FIRST_PERSON_AIM_CAM_ZOOM_FACTOR() * iParam0);
	}

	return iParam0;
}

float func_132(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x62E5 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_133(var uParam0, BOOL bParam1) // Position - 0x6303 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_134(var uParam0) // Position - 0x6323 Hash - 0x39705408 ^0x39705408
{
	return func_189(*uParam0, 2);
}

void func_135(var uParam0) // Position - 0x6333 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_121(uParam0);

	if (func_134(uParam0))
	{
		uParam0->f_1 = func_186() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_188(uParam0, 2);
	}
...
void func_136(var uParam0) // Position - 0x6367 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_121(uParam0);

	if (!func_134(uParam0))
	{
		uParam0->f_2 = func_186() - uParam0->f_1;
		func_187(uParam0, 2);
	}
...
BOOL func_137(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x6397 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_138(BOOL bParam0, var uParam1, var uParam2) // Position - 0x63EC Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_139(int iParam0, int iParam1) // Position - 0x6403 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_140(int iParam0, int iParam1) // Position - 0x6489 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_141(int iParam0, int iParam1) // Position - 0x64C5 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_142(int iParam0, int iParam1) // Position - 0x6518 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_143(int iParam0, int iParam1) // Position - 0x6553 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_144(int iParam0, int iParam1) // Position - 0x658C Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_145(int iParam0) // Position - 0x65C4 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_146(BOOL bParam0) // Position - 0x6602 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_147(ePedType eptParam0) // Position - 0x6615 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_148(Ped pedParam0, Hash hParam1) // Position - 0x6A68 Hash - 0x3A8EB3FC ^0xF41C7D41
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_192(pedParam0, hParam1))
		{
			if (func_193(pedParam0, hParam1))
			{
				if (func_194(pedParam0, hParam1))
				{
...
void func_149(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6B0F Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_150(Ped pedParam0, BOOL bParam1) // Position - 0x6B3F Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_151(Ped pedParam0, int iParam1) // Position - 0x6B84 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_152(int iParam0, BOOL bParam1, int iParam2) // Position - 0x6BAB Hash - 0x37D64B11 ^0xE7060A9E
{
	func_196(iParam2);
				...
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						if (PED::IS_PED_PLANTING_BOMB(Global_35))
							func_109(iParam0, 33554432);
					else if (!(*iParam0 & 8192 != 0))
						if (func_198(true))
							func_109(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_198(true) || *iParam0 & 8192 != 0)
...
BOOL func_153(Ped pedParam0, int iParam1) // Position - 0x6D76 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_201(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_202(pedParam0, pedIndexFromEntityIndex) <= func_203(iParam1))
				return true;
			break;
	}
...
void func_154(Ped pedParam0, int iParam1, int iParam2) // Position - 0x6E4D Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_204(iParam2, 1, 1, 1, 0))
		func_109(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_205(iParam1, true);
	func_206();
	return;
}

BOOL func_155(Ped pedParam0, int iParam1) // Position - 0x6E8A Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_207(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_209(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_210(iParam1);
...
BOOL func_156(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6F71 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_211(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_208(iParam2);
	
		if (func_209(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_210(iParam2))
				{
					func_205(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x7047 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_201(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_210(iParam1))
		{
			customDistance = func_208(iParam1);
...
BOOL func_158(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7150 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_212(bParam1, bParam2, bParam3);
...
BOOL func_159(int iParam0, int iParam1) // Position - 0x7285 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_160(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x72BC Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_161(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x73C3 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_214(iParam2))
	{
...
BOOL func_162(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x742E Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_216(pedParam1, entityCoords, outCoords))
					{
						func_205(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_216(pedParam1, entityCoords, outCoords2))
					{
						func_205(iParam2, true);
						return true;
					}
...
BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x7576 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_201(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_217(Global_1935630.f_34[i]);
			...
			if (func_218(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_219(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_220(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_164(var uParam0, int iParam1) // Position - 0x7752 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x77CA Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_166(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77F9 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_167(int iParam0, Ped pedParam1) // Position - 0x797F Hash - 0x232FBE17 ^0x8F20CDAA
{
	int _int;
...
BOOL func_168(int iParam0, Ped pedParam1) // Position - 0x79CC Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_223(iParam0))
		return true;
...
BOOL func_169(Ped pedParam0, Ped pedParam1) // Position - 0x7A69 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_76(pedParam0, pedParam1, true, true) < 4f)
...
void func_170() // Position - 0x7AB6 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_171(int iParam0, Ped pedParam1) // Position - 0x7ABE Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_224(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_225(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_172() // Position - 0x7B7F Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_173() // Position - 0x7B9D Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_174(int iParam0, Ped pedParam1) // Position - 0x7BEA Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_226(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_227(pedParam1);
	num2 = func_228(iParam0->f_14);
...
BOOL func_175(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x7D06 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_229(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_176(Ped pedParam0, int iParam1) // Position - 0x7D4E Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_230(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_231(iParam1, pedParam0))
						if (func_225(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_177(Ped pedParam0, int iParam1) // Position - 0x7FA7 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_232(0))
		return false;
...
BOOL func_178(int iParam0, int iParam1) // Position - 0x7FE0 Hash - 0x1C0DC05F ^0x9DC64B36
{
	int num;
	int num2;
...
BOOL func_179(var uParam0, int iParam1) // Position - 0x8011 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_180(Ped pedParam0, int iParam1) // Position - 0x8025 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_172() - iParam1->f_4 > func_233(iParam1))
		return func_234(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_181(int iParam0, Ped pedParam1) // Position - 0x8072 Hash - 0x1B919E57 ^0xB185C36C
{
...
void func_182(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x80C5 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_235(iParam0) == 1 && bParam7)
		return;
...
float func_183(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8151 Hash - 0x2753566D ^0x575C60D0
{
	if (bParam2 && ENTITY::IS_ENTITY_DEAD(pedParam0))
		return -1f;

	return func_76(Global_35, pedParam0, bParam1, bParam2);
}

BOOL func_184(Ped pedParam0, Ped pedParam1, float fParam2, BOOL bParam3) // Position - 0x817A Hash - 0x3576CBF5 ^0xBF0EF05A
{
	if (!bParam3)
		return false;
...
BOOL func_185(Ped pedParam0, char* sParam1, int iParam2, Ped pedParam3, BOOL bParam4, int iParam5, int iParam6, int iParam7) // Position - 0x81B3 Hash - 0x281BDD5E ^0x8899ECCD
{
	char* str;
	...
	str.f_5 = bParam4;
	str.f_6 = iParam7;
	return func_237(pedParam0, &str);
}

float func_186() // Position - 0x81FA Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_187(var uParam0, int iParam1) // Position - 0x822C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_188(var uParam0, int iParam1) // Position - 0x823D Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_189(int iParam0, int iParam1) // Position - 0x8252 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_190(var uParam0, int iParam1) // Position - 0x8261 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_191(var uParam0, int iParam1) // Position - 0x8276 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_192(Ped pedParam0, Hash hParam1) // Position - 0x8287 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_193(Ped pedParam0, Hash hParam1) // Position - 0x82B5 Hash - 0x39F1096 ^0x53F8C7F5
{
	Hash _int;
...
BOOL func_194(Ped pedParam0, Hash hParam1) // Position - 0x8303 Hash - 0x39F1096 ^0x53F8C7F5
{
	Hash _int;
	int _int2;
...
void func_195(Ped pedParam0) // Position - 0x8371 Hash - 0x4120DB2A ^0x40CD126F
{
...
void func_196(int iParam0) // Position - 0x838D Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_239(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_197(int iParam0) // Position - 0x84F9 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_198(BOOL bParam0) // Position - 0x850C Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_240(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_199(int iParam0) // Position - 0x8526 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_200(int iParam0) // Position - 0x85BE Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_201(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x85E5 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_228(pedParam2);
	else
		num2 = func_227(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_228(pedParam0);
	else
...
float func_202(Ped pedParam0, Ped pedParam1) // Position - 0x86DE Hash - 0xF9959663 ^0xF9959663
{
	return func_76(pedParam0, pedParam1, true, true);
}

float func_203(int iParam0) // Position - 0x86F0 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_204(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x86FC Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_205(int iParam0, BOOL bParam1) // Position - 0x8761 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_109(iParam0, 134217728);
	else
...
void func_206() // Position - 0x8787 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_207(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x879B Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_76(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_208(int iParam0) // Position - 0x88FB Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_209(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x8907 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_210(int iParam0) // Position - 0x8968 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_211(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x8974 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_212(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8A36 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_213(int iParam0) // Position - 0x8AD4 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_214(int iParam0) // Position - 0x8AE0 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_215(int iParam0) // Position - 0x8AEC Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_216(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x8C29 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_217(Ped pedParam0) // Position - 0x8C6C Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_218(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8CD2 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_219(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8D19 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_220(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x8D64 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_221(Ped pedParam0, var uParam1) // Position - 0x8DDD Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_222(Ped pedParam0, Ped pedParam1) // Position - 0x8E2A Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_223(int iParam0) // Position - 0x8E72 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

BOOL func_224(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8E82 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_225(veParam0, uParam2, true);
...
float func_225(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8EAE Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_226(int iParam0) // Position - 0x8ED6 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_227(Ped pedParam0) // Position - 0x8EE2 Hash - 0xC15BC98B ^0x3FAC872B
{
...
int func_228(Ped pedParam0) // Position - 0x8F36 Hash - 0x9CCD08A7 ^0xB08840D8
{
...
BOOL func_229(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8FA0 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_76(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_76(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_230(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x9110 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_240(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_231(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_231(iParam1, ped2))
					if (func_225(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_231(int iParam0, Ped pedParam1) // Position - 0x91FE Hash - 0xB9602DC6 ^0xACEB2C33
{
...
BOOL func_232(int iParam0) // Position - 0x9272 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_250())
		return false;
...
int func_233(int iParam0) // Position - 0x9294 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_234(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x92A0 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_235(int iParam0) // Position - 0x931B Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_236() // Position - 0x932E Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_237(Ped pedParam0, Any* panParam1) // Position - 0x933C Hash - 0x2ACCF512 ^0x38357878
{
	return AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, panParam1);
}

BOOL func_238() // Position - 0x934C Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_252())
		return false;
...
void func_239(Any* panParam0, int iParam1) // Position - 0x93A2 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_240(BOOL bParam0, var uParam1, var uParam2) // Position - 0x944A Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_241(int iParam0) // Position - 0x9511 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_242(int iParam0) // Position - 0x95B9 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_243(Ped pedParam0, int iParam1) // Position - 0x961E Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_244(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x9635 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_245(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x9663 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x96AD Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_247(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x96EE Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_248(Ped pedParam0) // Position - 0x9767 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_249(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x984F Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_250() // Position - 0x9891 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_236() != -1)
		return false;
...
BOOL func_251(int iParam0, BOOL bParam1) // Position - 0x98B6 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_252() // Position - 0x98E7 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_253(int iParam0) // Position - 0x9918 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_100(iParam0))
		return -1;
...
int func_254(int iParam0) // Position - 0x9934 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_255(int iParam0) // Position - 0x9975 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
