#region Local Var
	...
	ItemSet isLocal_40 = 0;
	int iLocal_41 = 0;
	ScrHandle shLocal_42 = 0;
	int iLocal_43 = 0;
...
void main() // Position - 0x0 Hash - 0xDDA86690 ^0x6654F500
{
	var unk;
	BOOL flag;
	...
	hLocal_34 = joaat("world_animal_crow_eating_ground");
	iLocal_43 = 10;
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9DD Hash - 0x4DA9BC8C ^0xF393D8FF
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9F7 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA0E Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xACC Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAF6 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC47 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC5C Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD00 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AB1 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B17 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD1 Hash - 0xD6BC81AE ^0x341A12BD
{
	int num;

	func_46(uParam0, "BIRD_FLEE_SWARM", "", vParam1, uParam4);
	num = 1;
	...
	switch (*uParam0)
	{
		...
		case 92:
			...
			hLocal_34 = joaat("world_animal_duck_ground_resting");
			break;
		...
		case 94:
			...
			hLocal_34 = joaat("world_animal_goosecanada_resting");
			break;
	
		case 95:
			iLocal_9 = joaat("A_C_Pigeon");
			hLocal_34 = joaat("world_animal_pigeon_eat_ground");
			break;
		...
		case 99:
			...
			hLocal_34 = joaat("world_animal_seagull_eat_ground");
			break;
	
		case 100:
			iLocal_9 = joaat("a_c_songbird_01");
			hLocal_34 = joaat("world_animal_sparrow_eating_ground");
			break;
	...
	{
		iLocal_43 = 20;
		func_47(uParam0, 0, "BFS_BIRD_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 1, "BFS_BIRD_2", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1f, 1f, 0f), 35f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 2, "BFS_BIRD_3", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 1f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 3, "BFS_BIRD_4", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 0f, 0f), 45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 4, "BFS_BIRD_5", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 0f), -25f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 5, "BFS_BIRD_6", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, -1f, 0f), -35f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 6, "BFS_BIRD_7", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -2f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 7, "BFS_BIRD_8", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, -2f, 0f), -15f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 8, "BFS_BIRD_9", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, -1f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 9, "BFS_BIRD_10", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, -3f, 0f), 50f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 10, "BFS_BIRD_11", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0.5f, 0f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 11, "BFS_BIRD_12", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 2f, 0f), 35f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 12, "BFS_BIRD_13", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, 2f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 13, "BFS_BIRD_14", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, 0f, 0f), 45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 14, "BFS_BIRD_15", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -4f, 0f, 0f), -100f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 15, "BFS_BIRD_16", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -4f, -2f, 0f), -135f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 16, "BFS_BIRD_17", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -4f, 0f), -145f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 17, "BFS_BIRD_18", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, -4f, 0f), -15f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 18, "BFS_BIRD_19", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 4f, -2f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 19, "BFS_BIRD_20", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, -6f, 0f), 50f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
	else if (*uParam0 == 93)
	{
		iLocal_43 = 20;
		...
		func_47(uParam0, 12, "BFS_BIRD_13", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, 2f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 13, "BFS_BIRD_14", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, 0f, 0f), 45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 14, "BFS_BIRD_15", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -4f, 0f, 0f), -50f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 15, "BFS_BIRD_16", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -4f, -2f, 0f), 75f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 16, "BFS_BIRD_17", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -4f, 0f), -65f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 17, "BFS_BIRD_18", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, -4f, 0f), -15f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 18, "BFS_BIRD_19", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 4f, -2f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 19, "BFS_BIRD_20", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, -6f, 0f), 50f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
	else if (*uParam0 == 99 && uParam0->f_489 == 1)
	{
		iLocal_43 = 5;
		func_47(uParam0, 0, "BFS_BIRD_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 1, "BFS_BIRD_2", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1f, 1f, 0f), 135f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 2, "BFS_BIRD_3", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 1f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 3, "BFS_BIRD_4", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 0f, 0f), 45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 4, "BFS_BIRD_5", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 0f), -100f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
	else
	{
		if (*uParam0 == 100)
		...
		func_47(uParam0, 0, "BFS_BIRD_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 1, "BFS_BIRD_2", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1f, 1f, 0f), 135f + uParam4.f_2, num, 1, 1, 1, iLocal_33, 1);
		func_47(uParam0, 2, "BFS_BIRD_3", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 1f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 3, "BFS_BIRD_4", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 0f, 0f), 45f + uParam4.f_2, num, 1, 1, 1, iLocal_33, 1);
		func_47(uParam0, 4, "BFS_BIRD_5", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 0f), -100f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 5, "BFS_BIRD_6", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, -1f, 0f), -135f + uParam4.f_2, num, 1, 1, 1, iLocal_33, 1);
		func_47(uParam0, 6, "BFS_BIRD_7", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -2f, 0f), -145f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 7, "BFS_BIRD_8", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, -2f, 0f), -15f + uParam4.f_2, num, 1, 1, 1, iLocal_33, 1);
		func_47(uParam0, 8, "BFS_BIRD_9", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, -1f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_47(uParam0, 9, "BFS_BIRD_10", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, -3f, 0f), 50f + uParam4.f_2, num, 1, 1, 1, iLocal_33, 1);
...
Vector3 func_15(var uParam0) // Position - 0x29E3 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x2A83 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x2B9D Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2D66 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2D6F Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2F1F Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2F93 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2FE2 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x303A Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x31A3 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x34CA Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x3601 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x3731 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x3770 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x3779 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x37AB Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

int func_31(var uParam0) // Position - 0x37B4 Hash - 0xB9B4B1F2 ^0x2101F9CB
{
	float num;
	int i;
	BOOL flag;
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				if (!TASK::DOES_SCENARIO_POINT_EXIST(uLocal_12[iLocal_41]))
				{
					if (*uParam0 != 93 && *uParam0 != 163)
						func_55(&(uParam0->f_20[iLocal_41 /*14*/].f_5), 1088421888);
				
					uLocal_12[iLocal_41] = func_56(hLocal_34, uParam0->f_20[iLocal_41 /*14*/].f_5, uParam0->f_20[iLocal_41 /*14*/].f_8, 0, 0, false);
					...
					TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[iLocal_41 /*14*/], uLocal_12[iLocal_41], 0, 0, false, flag, 0, false, -1082130432, false);
					func_57(&uParam0->f_20[iLocal_41 /*14*/], false, true);
				}
			}
		...
		case 1:
			...
			if (func_58(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				flag2 = true;
			}
			else if (num < 3600f && !func_50(uParam0->f_503, 1))
			{
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_41 /*14*/]))
			{
				...
				{
					TASK::TASK_FLEE_PED(uParam0->f_20[iLocal_41 /*14*/], Global_35, 3, 0, -1082130432, -1, 0);
		...
		case 4:
			if (*uParam0 == 79)
				if (func_63(&uLocal_35, 15f))
					return 1;
			else if (func_63(&uLocal_35, 5f))
				return 1;
			break;
	}
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x3A5F Hash - 0x7034CD60 ^0x7763482B
{
	int i;
	...
	if (VOLUME::DOES_VOLUME_EXIST(volLocal_39))
		VOLUME::DELETE_VOLUME(volLocal_39);

	if (VOLUME::DOES_VOLUME_EXIST(volLocal_11))
		VOLUME::DELETE_VOLUME(volLocal_11);

	if (ITEMSET::IS_ITEMSET_VALID(isLocal_40))
		ITEMSET::DESTROY_ITEMSET(isLocal_40);

	if (shLocal_42 != 0)
		EVENT::REMOVE_SHOCKING_EVENT(shLocal_42);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3B32 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x3B4F Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3C8B Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3DC4 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3E6E Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3EE6 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_65(entityForwardVector, unk5);
	...
	if (func_66(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3F75 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x4091 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x409D Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4225 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x42C5 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x42D8 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x42F2 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x435A Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4386 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_48(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4414 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_78(Global_1898164.f_1[0 /*5*/]);
	
		if (func_79(num) && func_80(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}

	if (iParam0 == 0 && func_81(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_49(int iParam0) // Position - 0x4618 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x462C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_51() // Position - 0x463B Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_64() != -1;
}

BOOL func_52(var uParam0, Any* panParam1) // Position - 0x4656 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_53(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x46B5 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_54(Entity eParam0) // Position - 0x46F7 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
int func_55(var uParam0, int iParam1) // Position - 0x4723 Hash - 0x68ED3666 ^0xD16E7DA4
{
	Vector3 vector;
	var groundZ;
...
int func_56(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4757 Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4771 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_58(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4799 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_83(Global_35))
		{
			ped = func_84(Global_35);
		...
		num = num * num;
		fParam2 = func_85(fParam2);
		num2 = func_86(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_87(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_89(&(uParam0->f_490), fParam1))
						{
							func_90(&(uParam0->f_490));
							return true;
						}
...
BOOL func_59(var uParam0) // Position - 0x49A4 Hash - 0xB54AA975 ^0x86B841C0
{
	...
	{
		if (!ITEMSET::IS_ITEMSET_VALID(isLocal_40))
			isLocal_40 = ITEMSET::CREATE_ITEMSET(true);
		else
			ITEMSET::_CLEAR_ITEMSET(isLocal_40);
	
		if (!VOLUME::DOES_VOLUME_EXIST(volLocal_39))
			if (*uParam0 == 90)
				volLocal_39 = VOLUME::CREATE_VOLUME_SPHERE(uParam0->f_20[0 /*14*/].f_5, 0f, 0f, 0f, 6f, 6f, 10f);
			else if (*uParam0 == 93)
				volLocal_39 = VOLUME::CREATE_VOLUME_SPHERE(uParam0->f_20[0 /*14*/].f_5, 0f, 0f, 0f, 20f, 20f, 10f);
			else
				volLocal_39 = VOLUME::CREATE_VOLUME_SPHERE(uParam0->f_20[0 /*14*/].f_5, 0f, 0f, 0f, 25f, 25f, 10f);
	
		entitiesInVolume = ENTITY::_GET_ENTITIES_IN_VOLUME(volLocal_39, isLocal_40, 1);
	
		for (i = 0; i < entitiesInVolume; i = i + 1)
		{
			indexedItemInItemset = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(i, isLocal_40);
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4ADD Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_61(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4BB4 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_62(var uParam0) // Position - 0x4CB8 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_93(uParam0, 0f);
	return;
}

BOOL func_63(var uParam0, float fParam1) // Position - 0x4CC7 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_88(uParam0))
		return false;
...
int func_64() // Position - 0x4CEE Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_65(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4CFC Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_66(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4D63 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_67(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4D8C Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_95(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_68(var uParam0, var uParam1, var uParam2) // Position - 0x4DD8 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_95(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_69(int iParam0) // Position - 0x4E27 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_70(int iParam0) // Position - 0x4E4C Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_71(int iParam0) // Position - 0x4E5F Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_72(int iParam0) // Position - 0x4E72 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_73(int iParam0) // Position - 0x4E85 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_74(int iParam0) // Position - 0x4E97 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_75(int iParam0, int iParam1) // Position - 0x4EA9 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_76(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4F43 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_77() // Position - 0x4F7B Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_78(int iParam0) // Position - 0x4FCE Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_81(iParam0))
		return -1;
...
BOOL func_79(int iParam0) // Position - 0x4FEE Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_80(int iParam0, int iParam1) // Position - 0x5004 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_81(int iParam0) // Position - 0x5013 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_82(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5046 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_105(eptParam1))
		{
			func_106(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_108(pedParam0, false);
			flag = true;
		}
	
		func_109(pedParam0, iParam2);
	}
...
BOOL func_83(Ped pedParam0) // Position - 0x5127 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_84(Ped pedParam0) // Position - 0x5142 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_85(float fParam0) // Position - 0x515E Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_86(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x51A5 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_87(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x51C3 Hash - 0x867DEA0 ^0xA060BC32
{
	...
	return func_110(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_88(var uParam0) // Position - 0x521A Hash - 0x5001E582 ^0x5001E582
{
	return func_111(*uParam0, 1);
}

BOOL func_89(var uParam0, float fParam1) // Position - 0x522A Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_90(var uParam0) // Position - 0x5248 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_91(int iParam0) // Position - 0x525E Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_112(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_112(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_112(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_92(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x52DF Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_95(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
void func_93(var uParam0, float fParam1) // Position - 0x53D0 Hash - 0x30433BAB ^0xF854D531
{
...
float func_94(var uParam0) // Position - 0x53F6 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_88(uParam0))
		return uParam0->f_1;
...
BOOL func_95(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x542B Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_96(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5480 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_97(int iParam0, int iParam1) // Position - 0x5497 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_98(int iParam0, int iParam1) // Position - 0x551D Hash - 0x96B01D2A ^0x81E68218
{
...
void func_99(int iParam0, int iParam1) // Position - 0x5559 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_100(int iParam0, int iParam1) // Position - 0x55AC Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_101(int iParam0, int iParam1) // Position - 0x55E7 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_102(int iParam0, int iParam1) // Position - 0x5620 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_103(int iParam0) // Position - 0x5658 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_104(BOOL bParam0) // Position - 0x5696 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_105(ePedType eptParam0) // Position - 0x56A9 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_106(Ped pedParam0, Hash hParam1) // Position - 0x5AFC Hash - 0xEA1C858E ^0xC2F5259C
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_117(pedParam0, hParam1))
		{
...
void func_107(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5BA6 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_108(Ped pedParam0, BOOL bParam1) // Position - 0x5BD6 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_109(Ped pedParam0, int iParam1) // Position - 0x5C1B Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
float func_110(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5C42 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_111(int iParam0, int iParam1) // Position - 0x5C60 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_112(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5C6F Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_121(iParam0) == 1 && bParam7)
		return;
...
float func_113() // Position - 0x5CFB Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_114(var uParam0, int iParam1) // Position - 0x5D2D Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_115(var uParam0, int iParam1) // Position - 0x5D3E Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_116(var uParam0) // Position - 0x5D53 Hash - 0x39705408 ^0x39705408
{
	return func_111(*uParam0, 2);
}

BOOL func_117(Ped pedParam0, Hash hParam1) // Position - 0x5D63 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_118(Ped pedParam0, Hash hParam1) // Position - 0x5D91 Hash - 0xA54F3032 ^0xF459EA4E
{
	Hash _int;
...
BOOL func_119(Ped pedParam0, Hash hParam1) // Position - 0x5DE2 Hash - 0xA54F3032 ^0xF459EA4E
{
	Hash _int;
	int _int2;
...
void func_120(Ped pedParam0) // Position - 0x5E54 Hash - 0x446F1BDD ^0x2B996457
{
...
int func_121(int iParam0) // Position - 0x5E72 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_122() // Position - 0x5E85 Hash - 0x4228A1C2 ^0x6E8485BE
{
