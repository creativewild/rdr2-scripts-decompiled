...
void main() // Position - 0x0 Hash - 0x9F28A203 ^0xDF7B6DE8
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_c_cardinal_01");
	iLocal_10 = joaat("META_OUTFIT_DEFAULT");
	hLocal_40 = joaat("world_animal_bird_on_perch");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D9 Hash - 0x4DA9BC8C ^0x47AF106B
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BCD Hash - 0xAF10A7F9 ^0x9C695EB2
{
	int num;

	func_46(uParam0, "BIRD_LAND", "", vParam1, uParam4);
	num = 1;

	switch (*uParam0)
	{
		case 103:
			iLocal_9 = joaat("a_c_bluejay_01");
			hLocal_40 = joaat("world_animal_bird_on_perch");
			break;
		...
		case 105:
			...
			hLocal_40 = joaat("Stand");
			break;
	
		case 106:
			iLocal_9 = joaat("a_c_eagle_01");
			hLocal_40 = joaat("world_animal_eagle_on_perch");
			break;
	
		case 107:
			iLocal_9 = joaat("a_c_hawk_01");
			hLocal_40 = joaat("world_animal_eagle_on_perch");
			break;
	
		case 108:
			iLocal_9 = joaat("a_c_heron_01");
			hLocal_40 = joaat("world_animal_heron_on_perch");
			break;
	
		case 109:
			iLocal_9 = joaat("a_c_loon_01");
			hLocal_40 = joaat("Stand");
			break;
	
		case 110:
			iLocal_9 = joaat("a_c_owl_01");
			hLocal_40 = joaat("world_animal_eagle_on_perch");
			break;
	
		case 111:
			iLocal_9 = joaat("a_c_seagull_01");
			hLocal_40 = joaat("world_animal_seagull_on_perch");
			break;
	
		case 112:
			iLocal_9 = joaat("a_c_songbird_01");
			hLocal_40 = joaat("world_animal_sparrow_on_perch");
		
			if (func_47())
			{
				iLocal_10 = joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER");
				num = 0;
			}
			else
			{
	...
	func_48(uParam0, 0, "BL_BIRD_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 5f, -20f), 0f + uParam4.f_2, num, 1, 1, 1, iLocal_10, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1D3A Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1DDA Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1EF4 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x20BD Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x20C6 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2276 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x22EA Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2339 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2391 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24FA Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2821 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2958 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A88 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2AC7 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2AD0 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B02 Hash - 0x6C10550A ^0x6C10550A
{
...
int func_31(var uParam0) // Position - 0x2B35 Hash - 0x15A79D78 ^0x15A79D78
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;

	if (!uParam0->f_469[2])
	{
		if (func_62(uParam0, &uLocal_11, false) || func_63(Global_35, uParam0->f_483, true) < 64f)
		{
			...
			if (!uParam0->f_469[0])
			{
				func_65(*uParam0, uParam0->f_483, false);
				uParam0->f_469[0] = 1;
			}
	...
	switch (iLocal_39)
	{
		case 0:
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[0 /*14*/], true);
				ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_20[0 /*14*/], true);
				ENTITY::SET_ENTITY_VISIBLE(uParam0->f_20[0 /*14*/], false);
				func_66(&uParam0->f_20[0 /*14*/], true, true);
				iLocal_39 = 2;
			}
			break;
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				if (func_63(Global_35, uParam0->f_483, true) < PED::IS_PED_ON_MOUNT(Global_35) ? 1600f : 400f)
				{
					if (CAM::IS_SPHERE_VISIBLE(uParam0->f_483, 1f))
					{
						if (!ENTITY::WOULD_ENTITY_BE_OCCLUDED(uParam0->f_20[0 /*14*/].f_2, uParam0->f_483, true))
						{
							offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_483, uParam0->f_486.f_2, 0f, -35f, 1f) };
						
							if (!CAM::IS_SPHERE_VISIBLE(offsetFromCoordAndHeadingInWorldCoords, 0.25f))
							{
								ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[0 /*14*/], false);
								ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_20[0 /*14*/], false);
								ENTITY::SET_ENTITY_VISIBLE(uParam0->f_20[0 /*14*/], true);
								func_64(uParam0);
								func_69(uParam0->f_20[0 /*14*/], offsetFromCoordAndHeadingInWorldCoords, func_68(offsetFromCoordAndHeadingInWorldCoords, uParam0->f_483), 0, 1073741824);
								PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], -1299979036, false, 0, false);
								TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], hLocal_40, uParam0->f_483, uParam0->f_20[0 /*14*/].f_8, 0, true, false, 0, -1082130432, false);
		...
		case 4:
			if (!uParam0->f_469[0])
			{
				if (func_63(uParam0->f_20[0 /*14*/], uParam0->f_483, true) < 1f)
				{
...
int func_32(var uParam0, var uParam1) // Position - 0x2DE0 Hash - 0x3105A36D ^0x3105A36D
{
	func_71(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DF2 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2E0F Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F4B Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3084 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x312E Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x31A6 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_73(entityForwardVector, unk5);
	...
	if (func_74(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3235 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3350 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x335C Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34E4 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3584 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3597 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x35B1 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3619 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
BOOL func_47() // Position - 0x3645 Hash - 0xEE877ACE ^0xCCE9C802
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3666 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x36F4 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x38F8 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x390C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x391B Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_72() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3936 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3995 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x39D7 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3A03 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3A7F Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
		func_9(&(uParam0->f_1), 256);
	else
		func_98(&(uParam0->f_1), 256);

	return;
}

void func_58(var uParam0, BOOL bParam1) // Position - 0x3AA5 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3AC7 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3AE9 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3B0B Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_62(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3B2F Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_63(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3B89 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_100(entityCoords, vParam1);
}

void func_64(var uParam0) // Position - 0x3BD9 Hash - 0xF9905547 ^0xF9905547
{
	if (!uParam0->f_469[1])
	{
...
void func_65(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3BFE Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_66(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D02 Hash - 0x6DE5BABD ^0x14BE368D
{
...
var func_67(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3D2A Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
float func_68(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x3D41 Hash - 0x34651BCB ^0x51745601
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

void func_69(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3D5B Hash - 0xF46E0F16 ^0xED4BA72A
{
...
BOOL func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3FDD Hash - 0xC34DBE12 ^0x77BD52E4
{
	int i;
	float num;
	Ped ped;
...
void func_71(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x41EA Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_72() // Position - 0x433E Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_73(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x434C Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_74(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x43B3 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x43DC Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_76(var uParam0, var uParam1, var uParam2) // Position - 0x4428 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_77(int iParam0) // Position - 0x4477 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_78(int iParam0) // Position - 0x449C Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_79(int iParam0) // Position - 0x44AF Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_80(int iParam0) // Position - 0x44C2 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_81(int iParam0) // Position - 0x44D5 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_82(int iParam0) // Position - 0x44E7 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_83(int iParam0, int iParam1) // Position - 0x44F9 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4593 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_85() // Position - 0x45CB Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_86(int iParam0) // Position - 0x461E Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_89(iParam0))
		return -1;
...
BOOL func_87(int iParam0) // Position - 0x463E Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_88(int iParam0, int iParam1) // Position - 0x4654 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_89(int iParam0) // Position - 0x4663 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_90(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4696 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x4777 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_98(iParam0, 4);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4795 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_98(iParam0, 8);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x47B5 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_98(iParam0, 16);
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x47E0 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_98(iParam0, 32);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4800 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_98(iParam0, 64);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4820 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_98(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4842 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_98(iParam0, 1048576);
	else
...
void func_98(int iParam0, int iParam1) // Position - 0x4866 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_99(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4877 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_100(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4EA0 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4EBE Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_102(int iParam0) // Position - 0x4F95 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_103(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5016 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
Ped func_104(Ped pedParam0) // Position - 0x5107 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_105(Ped pedParam0) // Position - 0x5111 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_106(Ped pedParam0) // Position - 0x5143 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x5185 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_108(Ped pedParam0) // Position - 0x5194 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_109(Ped pedParam0) // Position - 0x51AF Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_110(float fParam0) // Position - 0x51CB Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_111(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5212 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_112(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x5230 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_100(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_113(var uParam0) // Position - 0x5287 Hash - 0x5001E582 ^0x5001E582
{
	return func_163(*uParam0, 1);
}

void func_114(var uParam0) // Position - 0x5297 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_164(uParam0, 0f);
	return;
}

BOOL func_115(var uParam0, float fParam1) // Position - 0x52A6 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x52C4 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_117(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x52DA Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_118(BOOL bParam0, var uParam1, var uParam2) // Position - 0x532F Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_119(int iParam0, int iParam1) // Position - 0x5346 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_120(int iParam0, int iParam1) // Position - 0x53CC Hash - 0x96B01D2A ^0x81E68218
{
...
void func_121(int iParam0, int iParam1) // Position - 0x5408 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_122(int iParam0, int iParam1) // Position - 0x545B Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_123(int iParam0, int iParam1) // Position - 0x5496 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_124(int iParam0, int iParam1) // Position - 0x54CF Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_125(int iParam0) // Position - 0x5507 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_126(BOOL bParam0) // Position - 0x5545 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_127(ePedType eptParam0) // Position - 0x5558 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_128(Ped pedParam0, Hash hParam1) // Position - 0x59AB Hash - 0x3C4AFFB1 ^0x111C0A97
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_129(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5A52 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_130(Ped pedParam0, BOOL bParam1) // Position - 0x5A82 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_131(Ped pedParam0, int iParam1) // Position - 0x5AC7 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_132(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5AEE Hash - 0x37D64B11 ^0xE7060A9E
{
	func_170(iParam2);
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x5CB9 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_134(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5D90 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_178(iParam2, 1, 1, 1, 0))
		func_98(iParam1, 2048);
...
BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5DCD Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_136(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5EB4 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5F8A Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_138(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6093 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x61C8 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_140(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x61FF Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6306 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6371 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x64B9 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_144(var uParam0, int iParam1) // Position - 0x6695 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x670D Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_146(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x673C Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_147(int iParam0, Ped pedParam1) // Position - 0x68C2 Hash - 0xBA4FDC72 ^0xF76052B4
{
	int _int;
...
BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x690F Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_197(iParam0))
		return true;
...
BOOL func_149(Ped pedParam0, Ped pedParam1) // Position - 0x69AC Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_150() // Position - 0x69F9 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x6A01 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_152() // Position - 0x6AC2 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_153() // Position - 0x6AE0 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6B2D Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_155(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6C49 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_156(Ped pedParam0, int iParam1) // Position - 0x6C91 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6EEA Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_207(0))
		return false;
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x6F23 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_159(var uParam0, int iParam1) // Position - 0x6F52 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6F66 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_152() - iParam1->f_4 > func_208(iParam1))
		return func_209(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_161(int iParam0, Ped pedParam1) // Position - 0x6FB3 Hash - 0xF208D0A7 ^0xD4E83245
{
...
void func_162(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7006 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_210(iParam0) == 1 && bParam7)
		return;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x7092 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_164(var uParam0, float fParam1) // Position - 0x70A1 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_165(var uParam0, float fParam1) // Position - 0x70C7 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_113(uParam0))
		return false;
...
BOOL func_166(Ped pedParam0, Hash hParam1) // Position - 0x70EE Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_167(Ped pedParam0, Hash hParam1) // Position - 0x711C Hash - 0xC4716CB3 ^0x944CB33E
{
	Hash _int;
...
BOOL func_168(Ped pedParam0, Hash hParam1) // Position - 0x716A Hash - 0xC4716CB3 ^0x944CB33E
{
	Hash _int;
	int _int2;
...
void func_169(Ped pedParam0) // Position - 0x71D8 Hash - 0x5FC36696 ^0x9F891C6
{
...
void func_170(int iParam0) // Position - 0x71F4 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_171(int iParam0) // Position - 0x7360 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_172(BOOL bParam0) // Position - 0x7373 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_173(int iParam0) // Position - 0x738D Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_174(int iParam0) // Position - 0x7425 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_175(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x744C Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_176(Ped pedParam0, Ped pedParam1) // Position - 0x7545 Hash - 0xF9959663 ^0xF9959663
{
	return func_198(pedParam0, pedParam1, true, true);
}

float func_177(int iParam0) // Position - 0x7557 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_178(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7563 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x75C8 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_98(iParam0, 134217728);
	else
...
void func_180() // Position - 0x75EE Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_181(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7602 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_182(int iParam0) // Position - 0x7762 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_183(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x776E Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_184(int iParam0) // Position - 0x77CF Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_185(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x77DB Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_186(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x789D Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_187(int iParam0) // Position - 0x793B Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_188(int iParam0) // Position - 0x7947 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_189(int iParam0) // Position - 0x7953 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_190(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7A90 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_191(Ped pedParam0) // Position - 0x7AD3 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_192(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B39 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_193(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B80 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_194(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7BCB Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_195(Ped pedParam0, var uParam1) // Position - 0x7C44 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_196(Ped pedParam0, Ped pedParam1) // Position - 0x7C91 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_197(int iParam0) // Position - 0x7CD9 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_198(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7CE9 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_199(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7D31 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7D5D Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_201(int iParam0) // Position - 0x7D85 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_202(Ped pedParam0) // Position - 0x7D91 Hash - 0x690B8809 ^0xC7F3DF0C
{
...
int func_203(Ped pedParam0) // Position - 0x7DE5 Hash - 0xB5EC8713 ^0x43732DFE
{
...
BOOL func_204(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7E4F Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_205(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7FBF Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_206(int iParam0, Ped pedParam1) // Position - 0x80B0 Hash - 0xEC3F6ED ^0x920C29BB
{
...
BOOL func_207(int iParam0) // Position - 0x8124 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_228())
		return false;
...
int func_208(int iParam0) // Position - 0x8146 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8152 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_210(int iParam0) // Position - 0x81CD Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_211() // Position - 0x81E0 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

float func_212() // Position - 0x81EE Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_213(var uParam0, int iParam1) // Position - 0x8220 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_214(var uParam0, int iParam1) // Position - 0x8231 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_215(var uParam0) // Position - 0x8246 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_113(uParam0))
		return uParam0->f_1;
...
BOOL func_216() // Position - 0x827B Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_231())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x82D1 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8379 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_219(int iParam0) // Position - 0x8440 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x84E8 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_221(Ped pedParam0, int iParam1) // Position - 0x854D Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8564 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_223(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8592 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_224(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x85DC Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x861D Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_226(Ped pedParam0) // Position - 0x8696 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_227(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x877E Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_228() // Position - 0x87C0 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_211() != -1)
		return false;
...
BOOL func_229(int iParam0, BOOL bParam1) // Position - 0x87E5 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_230(var uParam0) // Position - 0x8816 Hash - 0x39705408 ^0x39705408
{
	return func_163(*uParam0, 2);
}

BOOL func_231() // Position - 0x8826 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_232(int iParam0) // Position - 0x8857 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_89(iParam0))
		return -1;
...
int func_233(int iParam0) // Position - 0x8873 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_234(int iParam0) // Position - 0x88B4 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
