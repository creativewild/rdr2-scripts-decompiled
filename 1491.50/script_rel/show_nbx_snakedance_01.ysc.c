...
void func_27(var uParam0) // Position - 0x26B7 Hash - 0xD9A33A44 ^0xA2D30ACE
{
	...
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_48))
		uParam0->f_48 = ANIMSCENE::_CREATE_ANIM_SCENE("script@shows@snake_dancer@act1_p1@action", 2, func_156(0), false, true);
...
void func_63(var uParam0) // Position - 0x3FB7 Hash - 0xF3090811 ^0xF559FE50
{
	...
	switch (iLocal_1141)
	{
		...
		case 3:
			if (!func_2(iLocal_1141.f_1, 2) && AUDIO::LOAD_STREAM(func_238(0), func_239()))
				func_7(&(iLocal_1141.f_1), 2);
			...
			if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_48, func_156(1)))
			{
				if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(uParam0->f_48, func_156(0)))
					func_146(uParam0->f_48, func_156(0), func_156(0));
			
				if (!func_142(uParam0->f_48, func_156(3), "SNAKE DANCE 01") || !func_142(uParam0->f_48, func_156(2), "SNAKE DANCE 01"))
					return;
		...
		case 5:
			if (func_2(iLocal_1141.f_1, 2))
			{
				AUDIO::PLAY_STREAM_FROM_POSITION(2552.5303f, -1310.0686f, 49.21665f, AUDIO::_GET_LOADED_STREAM_ID_FROM_CREATION(func_238(0), func_239()));
				func_3(&(iLocal_1141.f_1), 2);
			}
		...
		case 6:
			...
			if (isAnimSceneRunning)
			{
				if (animScenePhase > 0.85f && ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_48, func_156(2)))
					flag = true;
			
				if (animScenePhase > 0.15f && ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_48, func_156(3)))
					flag = true;
			}
...
float func_64() // Position - 0x42CD Hash - 0x22FB54B8 ^0x22FB54B8
{
	return 0.95f;
}

int func_65(var uParam0) // Position - 0x42DA Hash - 0xA734DC95 ^0xD1B7A127
{
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x433A Hash - 0x7C48D2BA ^0xE188283F
{
...
BOOL func_67() // Position - 0x4387 Hash - 0x601F71E7 ^0x51A86DDA
{
	if (GRAPHICS::GET_TV_CHANNEL() == -1)
		return true;
...
struct<2> func_68(int iParam0) // Position - 0x43AC Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_69(var uParam0, var uParam1, int iParam2) // Position - 0x43BC Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

void func_70(var uParam0) // Position - 0x43CC Hash - 0x240F0FFC ^0x758297AA
{
	...
	if (func_222(uParam0->f_1053[3]))
		func_240(&uParam0->f_1053[3], true, true);

	return;
}

void func_71(var uParam0) // Position - 0x444A Hash - 0x3B9DB8B ^0x181ACD9C
{
	if (GRAPHICS::GET_TV_CHANNEL() == -1)
		return;
...
void func_72(var uParam0) // Position - 0x44B5 Hash - 0xA8CC42FB ^0x6F7590EB
{
	BOOL flag;
	...
	switch (uParam0->f_3)
	{
		case 0:
			...
			{
				if (!CAM::DOES_CAM_EXIST(uParam0->f_4))
					uParam0->f_4 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), func_241(uParam0->f_1, 0), func_242(uParam0->f_1, 0), CAM::GET_FINAL_RENDERED_CAM_FOV(), false, 2);
			
				func_243(&(uParam0->f_3), 1);
			}
			break;
		...
		case 1:
			...
			if (!func_222(uParam0->f_1053[3]))
			{
				uParam0->f_1053[3] = func_244("INTERACT_LOOK", joaat("INPUT_FOCUS_CAM"), 6, 570, 570, 10, 1073741824, 0, 1065353216, false, 1, joaat("SHORT_TIMED_EVENT"), false);
				func_245(uParam0->f_1053[3], 13, true, true);
			}
			else if (func_246(uParam0->f_1053[3], true))
			{
				if (CAM::DOES_CAM_EXIST(uParam0->f_4))
				{
					if (!CAM::IS_CAM_RENDERING(uParam0->f_4))
		...
		case 3:
			...
			if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, joaat("INPUT_CINEMATIC_CAM_CHANGE_SHOT")))
			{
				...
				CAM::SET_CAM_COORD(uParam0->f_4, func_241(uParam0->f_1, uParam0->f_8));
				CAM::SET_CAM_ROT(uParam0->f_4, func_242(uParam0->f_1, uParam0->f_8), 2);
			}
		
			if (func_8(uParam0) == 10 || !flag)
				func_243(&(uParam0->f_3), 5);
			break;
...
void func_73(char* sParam0, char* sParam1) // Position - 0x48A3 Hash - 0xAEE04633 ^0xA9DB7429
{
	AUDIO::_STOP_SOUND_WITH_NAME(sParam0, sParam1);
	return;
}

void func_74(var uParam0) // Position - 0x48B3 Hash - 0xB4C1B7D8 ^0x5E0E5D11
{
	switch (iLocal_8.f_1)
	{
		case 0:
			...
			else if (!func_2(uParam0->f_16, 16384))
			{
				...
				{
					func_248(&(uParam0->f_349), 15, 26);
					func_248(&(uParam0->f_349), 40, 52);
					func_41(&(uParam0->f_941));
					func_7(&(uParam0->f_16), 16384);
				}
			}
			else if (!func_2(uParam0->f_16, 32768))
			{
				if (func_42(&(uParam0->f_941)) > 12f)
				{
					func_248(&(uParam0->f_349), 0, 13);
					func_248(&(uParam0->f_349), 27, 39);
					func_41(&(uParam0->f_941));
					func_7(&(uParam0->f_16), 32768);
				}
			}
...
void func_75(var uParam0) // Position - 0x4A1E Hash - 0xD9601DE6 ^0xD9601DE6
{
	int i;
	...
	for (i = 0; i < uParam0->f_1053; i = i + 1)
	{
		if (func_222(uParam0->f_1053[i]))
			func_240(&uParam0->f_1053[i], true, true);
	}

	return;
}

Vector3 func_76(int iParam0) // Position - 0x4A5B Hash - 0x4CB488BA ^0x4CB488BA
{
	switch (iParam0)
	{
		case 0:
...
void func_77(var uParam0) // Position - 0x4AD4 Hash - 0x4E9E1D75 ^0xC89E0016
{
	int i;
...
void func_78(var uParam0, Volume volParam1) // Position - 0x4B31 Hash - 0xFE12DDF4 ^0x71AD09B7
{
	int num;
	int i;
...
void func_79(var uParam0) // Position - 0x4B8C Hash - 0xEEF37EAB ^0x80EC19A4
{
	int i;
	int num;
...
BOOL func_80(int iParam0) // Position - 0x4BCA Hash - 0xD331D60D ^0x6329BB57
{
	int i;
	Hash hash;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		if (hash != 0)
			if (!func_251(hash) && !func_252(hash))
				func_253(hash, true, 0, false, false, 0, false, false);
	}

	return true;
}

void func_81(int iParam0) // Position - 0x4C52 Hash - 0x5AE1D4F0 ^0xE48E55C0
{
	if (func_254(iParam0))
...
void func_82() // Position - 0x4C6D Hash - 0xFA3971BA ^0xF8E34552
{
	PED::SET_PED_CONFIG_FLAG(Global_35, 489, false);
...
BOOL func_83(int iParam0) // Position - 0x4CC8 Hash - 0x6491FC6C ^0x428660B
{
	int i;
	Hash hash;
...
BOOL func_84(int iParam0) // Position - 0x4D1F Hash - 0x6491FC6C ^0x428660B
{
	int i;
	Hash hash;
...
void func_85(var uParam0) // Position - 0x4D76 Hash - 0xF698EF57 ^0x2FB05687
{
	GRAPHICS::SET_TV_CHANNEL(-1);
...
void func_86(var uParam0) // Position - 0x4DDB Hash - 0x1B452D17 ^0xE21F43E7
{
...
void func_87(var uParam0) // Position - 0x4DED Hash - 0x22732D43 ^0xFC753F50
{
	func_257(uParam0);
...
void func_88(Object obParam0, int iParam1) // Position - 0x4E1B Hash - 0x9815F445 ^0x9815F445
{
	*obParam0 = *obParam0 - *obParam0 && iParam1;
	return;
}

void func_89(var uParam0, int iParam1) // Position - 0x4E30 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_90(var uParam0) // Position - 0x4E41 Hash - 0x86FD8689 ^0x206CE292
{
	uParam0->f_10 = 1;
	return;
}

void func_91(eStackSize essParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x4E4E Hash - 0x2BEE335D ^0x2BEE335D
{
	func_259(func_258(), essParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_92(BOOL bParam0) // Position - 0x4E6C Hash - 0x67777C1C ^0xA5A55B03
{
	if (bParam0)
		func_260(4);
...
int func_93(BOOL bParam0) // Position - 0x4E8E Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_261() == -1)
	{
...
void func_94(Hash hParam0) // Position - 0x4ECF Hash - 0x3934F7F0 ^0xE2E63DDD
{
	if (!bLocal_1)
	{
...
void func_95(var uParam0, BOOL bParam1) // Position - 0x4EE9 Hash - 0xC0D552FF ^0xB3A5A71D
{
	if (bLocal_1)
	{
...
void func_96() // Position - 0x4F0C Hash - 0xFB561F3A ^0x3BEF23F
{
	if (!bLocal_0)
	{
...
void func_97() // Position - 0x4F27 Hash - 0x652CA67C ^0x1A990B
{
	if (bLocal_0)
	{
		INVENTORY::_INVENTORY_ENABLE_WEAPONS(func_93(false));
...
BOOL func_98() // Position - 0x4F40 Hash - 0xF40DE8DC ^0x762A5DC5
{
...
void func_99(var uParam0, int iParam1) // Position - 0x4F6C Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

BOOL func_100(int iParam0) // Position - 0x4F79 Hash - 0xD331D60D ^0x6329BB57
{
	int i;
	Hash hash;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		if (hash != 0)
			if (!func_256(hash))
				func_263(hash, 0, false);
	}

	return true;
}

BOOL func_101(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4FF0 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
int func_102(int iParam0) // Position - 0x508E Hash - 0xF6A7C02B ^0xF6A7C02B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_103(int iParam0) // Position - 0x50E0 Hash - 0xAAD68AF2 ^0x932B637C
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_104(int iParam0, int iParam1) // Position - 0x5142 Hash - 0xEA9A7255 ^0xEA9A7255
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_105(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, int iParam5) // Position - 0x52B7 Hash - 0xA7EC4DCD ^0x75B7B4EC
{
	if (uParam0->f_1 == 0)
...
int func_106(int iParam0) // Position - 0x530B Hash - 0x9D04607 ^0x9D04607
{
	switch (iParam0)
	{
		case 0:
...
Hash func_107(int iParam0) // Position - 0x5360 Hash - 0x67684612 ^0x25640750
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_108(int iParam0, int iParam1) // Position - 0x53BE Hash - 0xEA9A7255 ^0xEA9A7255
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0) // Position - 0x57A6 Hash - 0x325A480B ^0x325A480B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_110(int iParam0) // Position - 0x57F8 Hash - 0xAAD68AF2 ^0xDCF4A759
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_111(int iParam0, int iParam1) // Position - 0x585A Hash - 0x6288DC5 ^0x6288DC5
{
	switch (iParam0)
	{
		case 0:
...
Hash func_112(int iParam0, int iParam1) // Position - 0x597A Hash - 0xB925B99 ^0x792CDA95
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_113(int iParam0, int iParam1) // Position - 0x59EF Hash - 0x23EAC636 ^0x23EAC636
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0) // Position - 0x5C94 Hash - 0x3FB2C67 ^0x3FB2C67
{
	switch (iParam0)
	{
		case 0:
...
float func_115(var uParam0) // Position - 0x5CE8 Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_116(var uParam0) // Position - 0x5CF5 Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
int func_117(var uParam0) // Position - 0x5D02 Hash - 0x8E8FC7AE ^0x8E8FC7AE
{
	int num;
...
BOOL func_118(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5D10 Hash - 0xE7F7CC3B ^0xE7F7CC3B
{
	int i;
	float num;
...
float func_119(var uParam0) // Position - 0x5D6B Hash - 0x236039AD ^0x236039AD
{
	float num;
...
BOOL func_120(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5D78 Hash - 0xE7F7CC3B ^0xE7F7CC3B
{
	int i;
	float num;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		func_265(&uParam0->[i /*5*/], fParam1, num, fParam3, iParam4);
	}
...
float func_121(var uParam0) // Position - 0x5DD3 Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_122(var uParam0) // Position - 0x5DE0 Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
float func_123(var uParam0) // Position - 0x5DED Hash - 0x236039AD ^0x236039AD
{
	float num;
...
float func_124(var uParam0) // Position - 0x5DFA Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_125(var uParam0) // Position - 0x5E07 Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
float func_126(var uParam0) // Position - 0x5E14 Hash - 0x236039AD ^0x236039AD
{
	float num;
...
float func_127(var uParam0) // Position - 0x5E21 Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_128(var uParam0) // Position - 0x5E2E Hash - 0xEAAEEB54 ^0xEAAEEB54
{
	float num;
...
BOOL func_129(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5E3B Hash - 0x6C1C9B04 ^0x6C1C9B04
{
	float num;
...
float func_130(var uParam0) // Position - 0x5E7C Hash - 0x236039AD ^0x236039AD
{
	float num;
...
BOOL func_131(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5E89 Hash - 0x6C1C9B04 ^0x6C1C9B04
{
	float num;
	...
	num = func_42(uParam2);
	func_265(uParam0, fParam1, num, fParam3, iParam4);
...
float func_132(var uParam0) // Position - 0x5ECA Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_133(var uParam0) // Position - 0x5ED7 Hash - 0xEAAEEB54 ^0xEAAEEB54
{
	float num;
...
BOOL func_134(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6) // Position - 0x5EE4 Hash - 0x8B5B4DA7 ^0x8B5B4DA7
{
	int num;
	int num2;
	float num3;
...
float func_135(var uParam0) // Position - 0x5F50 Hash - 0x236039AD ^0x236039AD
{
	float num;
...
BOOL func_136(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6) // Position - 0x5F5D Hash - 0x8B5B4DA7 ^0x8B5B4DA7
{
	int num;
	int num2;
	float num3;
	...
	for (i = num; i <= num2; i = i + 1)
	{
		func_265(&uParam2->[i /*5*/], fParam3, num3, fParam5, iParam6);
	}
...
float func_137(var uParam0) // Position - 0x5FC9 Hash - 0xD3540869 ^0xD3540869
{
	float num;
...
float func_138(var uParam0) // Position - 0x5FDA Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
float func_139(var uParam0) // Position - 0x5FE7 Hash - 0x236039AD ^0x236039AD
{
	float num;
...
char* func_140(int iParam0) // Position - 0x5FF4 Hash - 0xE5247562 ^0x9CB1BE22
{
	switch (iParam0)
	{
		case 0:
...
char* func_141() // Position - 0x603C Hash - 0x306ACA3A ^0xB53AC264
{
	return "script@shows@curtains@curtains";
}

BOOL func_142(AnimScene ansParam0, char* sParam1, char* sParam2) // Position - 0x6048 Hash - 0xCB8E51DD ^0xC86E966C
{
...
void func_143(var uParam0, int iParam1) // Position - 0x6092 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

char* func_144() // Position - 0x609F Hash - 0x7B0ED4E6 ^0x7B0ED4E6
{
	return "CURTAIN";
}

void func_145(AnimScene ansParam0, char* sParam1, char* sParam2) // Position - 0x60AA Hash - 0xD500305B ^0x58F85F30
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(ansParam0))
		return;
...
void func_146(AnimScene ansParam0, char* sParam1, char* sParam2) // Position - 0x60C8 Hash - 0xC0246FAB ^0x902BB279
{
	if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(ansParam0, sParam1))
...
int func_147() // Position - 0x60E4 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_148(int iParam0) // Position - 0x60F3 Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

BOOL func_149(int iParam0, int iParam1) // Position - 0x6109 Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_148(iParam0))
		return false;
...
BOOL func_150(int iParam0) // Position - 0x612C Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_148(iParam0))
		return false;
...
BOOL func_151(int iParam0) // Position - 0x6164 Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_148(iParam0))
		return false;
...
void func_152(int iParam0) // Position - 0x6184 Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_153(int iParam0) // Position - 0x61ED Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

BOOL func_154() // Position - 0x61FD Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_261() != -1)
		return false;
...
void func_155(var uParam0, Ped pedParam1, char* sParam2, BOOL bParam3) // Position - 0x6222 Hash - 0x5AD955B5 ^0x43BD5215
{
	...
	if (func_268(uParam0, pedParam1, sParam2))
...
char* func_156(int iParam0) // Position - 0x627F Hash - 0xE5247562 ^0x12F3B39D
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x62C7 Hash - 0xA17D549C ^0x145C21F9
{
	switch (iParam0)
	{
		case 0:
...
char* func_158() // Position - 0x636A Hash - 0x306ACA3A ^0xCEED2F0E
{
	return "script_shows@show_audience@ig_arthur_applause";
}

BOOL func_159(var uParam0) // Position - 0x6376 Hash - 0x17F3724D ^0x8DFD2B6D
{
	return PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY();
}

BOOL func_160(var uParam0) // Position - 0x6382 Hash - 0x17A65E61 ^0x57FEE670
{
	BOOL flag;
	char* streamName;
	char* soundSet;
...
BOOL func_161(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0x644F Hash - 0xC5676B3C ^0xD21EACDC
{
...
char* func_162() // Position - 0x6496 Hash - 0x306ACA3A ^0xB53AC264
{
	return "script@shows@curtains@curtains";
}

char* func_163(int iParam0) // Position - 0x64A2 Hash - 0xE5247562 ^0x9CB1BE22
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_164(var uParam0, Object obParam1, char* sParam2, char* sParam3, BOOL bParam4) // Position - 0x64EA Hash - 0x94342835 ^0x77ACD9C8
{
...
BOOL func_165(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x6550 Hash - 0xB799E1C5 ^0x99EEAD6
{
	BOOL flag;
	BOOL flag2;
	Hash hash;
...
BOOL func_166(var uParam0) // Position - 0x65E0 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_167(var uParam0) // Position - 0x65E9 Hash - 0x70C03E2A ^0x8CF99647
{
...
void func_168(var uParam0) // Position - 0x6686 Hash - 0x1451D35 ^0xFA17C7A0
{
...
struct<11> func_169(int iParam0, int iParam1) // Position - 0x66DF Hash - 0x640FE314 ^0xBFF01F02
{
	var unk;
...
BOOL func_170(int iParam0, int iParam1) // Position - 0x6BC2 Hash - 0xDDF24FD9 ^0xDDF24FD9
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x6D8A Hash - 0xA17D549C ^0xE81F0204
{
	switch (iParam0)
	{
		case 0:
...
char* func_172(int iParam0, var uParam1) // Position - 0x6E3A Hash - 0x33D51A90 ^0x4BCE2FAA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_173(var uParam0, char* sParam1, const char* sParam2) // Position - 0x6E72 Hash - 0x5AA55923 ^0xA2744C11
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(*uParam0) && ANIMSCENE::IS_ANIM_SCENE_LOADED(*uParam0, true, false))
	{
		uParam0->f_1 = 1;
...
int func_174(int iParam0) // Position - 0x6EBC Hash - 0x6C1105E8 ^0x6C1105E8
{
	switch (iParam0)
	{
		case 0:
...
Hash func_175(int iParam0) // Position - 0x6F0B Hash - 0x8936E2F ^0xA7619EF8
{
	switch (iParam0)
	{
		case 0:
...
int func_176(int iParam0, int iParam1) // Position - 0x6F63 Hash - 0xCB2712C7 ^0xCB2712C7
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_177(int iParam0, int iParam1) // Position - 0x702A Hash - 0xEA9A7255 ^0xEA9A7255
{
	switch (iParam0)
	{
		case 0:
...
float func_178(int iParam0, int iParam1) // Position - 0x7AEF Hash - 0x70FF660 ^0x70FF660
{
	switch (iParam0)
	{
		case 0:
...
int func_179(int iParam0, int iParam1) // Position - 0x801E Hash - 0x72143BA7 ^0x72143BA7
{
	switch (iParam0)
	{
		case 0:
...
Ped func_180(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x80E1 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0x8123 Hash - 0xDC1ED3D3 ^0x1092D668
{
	int i;
	Vector3 vector;
...
BOOL func_182(int iParam0, int iParam1) // Position - 0x81D4 Hash - 0xF5E57FDF ^0xF5E57FDF
{
	switch (iParam1)
	{
		case 0:
...
char* func_183(int iParam0, int iParam1, int iParam2) // Position - 0x83E9 Hash - 0x86DE4110 ^0x7DB4DE99
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(int iParam0) // Position - 0x8AA1 Hash - 0xE4A49BB0 ^0xE4A49BB0
{
	switch (iParam0)
	{
		case 0:
...
void func_185(var uParam0, int iParam1) // Position - 0x8AE0 Hash - 0x30F6C7D6 ^0xB9013AB2
{
...
void func_186(var uParam0, int iParam1) // Position - 0x8B1D Hash - 0xB01519E8 ^0x4AC2559B
{
	int num;
	Vector3 vector;
	float num2;
...
void func_187(Entity eParam0, int iParam1) // Position - 0x8BF6 Hash - 0x9F3718A3 ^0xFA28549
{
	BOOL _int;
...
BOOL func_188(int iParam0, int iParam1) // Position - 0x8C38 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_189(var uParam0, float fParam1) // Position - 0x8C47 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_190(var uParam0) // Position - 0x8C6D Hash - 0x39705408 ^0x39705408
{
	return func_188(*uParam0, 2);
}

float func_191() // Position - 0x8C7D Hash - 0xB5A1F69B ^0x5409CF38
{
...
BOOL func_192(int iParam0) // Position - 0x8CAF Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 1:
...
void func_193(var uParam0, int iParam1) // Position - 0x8CD3 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

ePedType func_194() // Position - 0x8CE0 Hash - 0x9F572D68 ^0xB6D7BD8
{
	return joaat("s_m_m_magiclantern_01");
}

Hash func_195(int iParam0) // Position - 0x8CED Hash - 0xF3E1A6C ^0x79245C78
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_196(int iParam0) // Position - 0x8D28 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 3:
...
Vector3 func_197(int iParam0) // Position - 0x8D43 Hash - 0x9E6D5F11 ^0x9E6D5F11
{
	switch (iParam0)
	{
		case 0:
...
float func_198(int iParam0) // Position - 0x8DC2 Hash - 0x930951C2 ^0x930951C2
{
	switch (iParam0)
	{
		case 0:
...
Hash func_199(int iParam0) // Position - 0x8E15 Hash - 0xE65A3A10 ^0xEC1D0249
{
	switch (iParam0)
	{
		case 3:
...
void func_200(Ped pedParam0, Hash hParam1) // Position - 0x8E34 Hash - 0xEA1C858E ^0xF7DFC12
{
...
Vector3 func_201(int iParam0) // Position - 0x8EDE Hash - 0x563C355B ^0x563C355B
{
	switch (iParam0)
	{
		case 0:
...
char* func_202(int iParam0) // Position - 0x8F75 Hash - 0xE6862179 ^0x9348967C
{
	switch (iParam0)
	{
		case 21:
...
char* func_203(int iParam0, int iParam1) // Position - 0x8FF7 Hash - 0xAE0CA7E3 ^0x70C92BEE
{
	switch (iParam0)
	{
		case 21:
...
Vector3 func_204(int iParam0) // Position - 0x9141 Hash - 0xC00A6A6A ^0xC00A6A6A
{
	switch (iParam0)
	{
		case 21:
...
Vector3 func_205(int iParam0) // Position - 0x91C6 Hash - 0x3BB58CB4 ^0x3BB58CB4
{
	switch (iParam0)
	{
		case 21:
...
char* func_206(int iParam0) // Position - 0x9237 Hash - 0xE6862179 ^0xCA7FC41A
{
	switch (iParam0)
	{
		case 21:
...
char* func_207(int iParam0, int iParam1) // Position - 0x92B9 Hash - 0x2835CAF3 ^0x4B9EE89D
{
	switch (iParam0)
	{
		case 21:
...
int func_208() // Position - 0x9485 Hash - 0xE698BCC8 ^0x3E64CD04
{
	int networkTimeAccurate;
...
char* func_209(int iParam0) // Position - 0x94A3 Hash - 0xE6862179 ^0x95185D03
{
	switch (iParam0)
	{
		case 21:
...
void func_210() // Position - 0x95C5 Hash - 0xBBF53F6B ^0xF8AE51A1
{
...
void func_211() // Position - 0x95F1 Hash - 0xBBF53F6B ^0x6B344E82
{
...
char* func_212(int iParam0) // Position - 0x961D Hash - 0xE5247562 ^0x4BABC3F5
{
	switch (iParam0)
	{
		case 0:
...
void func_213(var uParam0, var uParam1, int iParam2) // Position - 0x966B Hash - 0xEBFB8122 ^0x59B1DD4D
{
	BOOL flag;
	int num;
	float num2;
	...
	for (i = 0; i <= num - 1; i = i + 1)
	{
		...
		else
		{
			...
			{
				if (func_286(*uParam0, i) && uParam1->[i /*10*/].f_1 != 5)
					uParam1->[i /*10*/].f_1 = 5;
			}
			else if (func_286(*uParam0, i) && uParam1->[i /*10*/].f_1 == 5)
			{
			...
			if (uParam0->f_19 && func_288(iParam2))
			{
				...
				{
					if (func_289(iParam2, i) >= 0f && num2 > func_289(iParam2, i))
						uParam1->[i /*10*/].f_1 = 7;
				}
			}
		
			if (!uParam0->f_19 && !func_286(*uParam0, i) && uParam1->[i /*10*/].f_1 != 5)
			{
				if (uParam1->[i /*10*/].f_9)
				{
					num3 = func_290(Global_35, uParam1->[i /*10*/], true, true);
				
					if (num3 > 2f || !func_291(&uParam1->[i /*10*/]))
					{
						uParam1->[i /*10*/].f_9 = 0;
						uParam0->f_21 = 0;
						uParam1->[i /*10*/].f_5 = 2;
				...
				else if (!uParam0->f_21 && uParam1->[i /*10*/].f_1 != 6)
				{
					...
					if (num3 < 1.5f && func_291(&uParam1->[i /*10*/]))
					{
						uParam1->[i /*10*/].f_5 = func_293(i);
						func_292(&uParam1->[i /*10*/], iParam2);
						uParam1->[i /*10*/].f_9 = 1;
						uParam0->f_21 = 1;
					}
			...
			switch (uParam1->[i /*10*/].f_1)
			{
				...
				case 1:
					if (func_294(iParam2, i))
						func_296(&uParam1->[i /*10*/], func_295(iParam2), 500);
					break;
				...
				case 8:
					if (ENTITY::DOES_ENTITY_EXIST(uParam1->[i /*10*/]) && !ENTITY::IS_ENTITY_DEAD(uParam1->[i /*10*/]))
					{
						...
						else if (num2 > func_289(iParam2, i) + 2f)
						{
							uParam1->[i /*10*/].f_1 = 9;
						}
					}
				...
				case 9:
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam1->[i /*10*/], func_299(iParam2), 1f, -1, 0.25f, 5373953, 1193033728);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam1->[i /*10*/], false, false);
						uParam1->[i /*10*/].f_1 = 10;
					}
					break;
				...
				case 10:
					...
					if (func_254(iParam2))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(uParam1->[i /*10*/], 658540077, true) == 1)
							uParam1->[i /*10*/].f_1 = 11;
						else if (num2 > func_289(iParam2, i) + 3f)
							uParam1->[i /*10*/].f_1 = 9;
					}
					else if (!func_300(ENTITY::GET_ENTITY_COORDS(uParam1->[i /*10*/], true, false)))
					{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(uParam1->[i /*10*/], SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD, true) != 1 && num2 > func_289(iParam2, i) + 3f)
					{
						uParam1->[i /*10*/].f_1 = 9;
					}
					break;
...
struct<21> func_214(int iParam0, int iParam1, int iParam2) // Position - 0x9E9F Hash - 0xDD2C6FC5 ^0xD601AFE6
{
	var unk;
...
void func_215(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23) // Position - 0xE499 Hash - 0x7214C603 ^0x36D9EF04
{
	int num;
	int i;
	int j;
...
Vector3 func_216(float fParam0, var uParam1, var uParam2) // Position - 0xE647 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
float func_217(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE686 Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

void func_218(var uParam0) // Position - 0xE6A7 Hash - 0x5DE504EA ^0x21277A8E
{
	var args;
...
void func_219(var uParam0) // Position - 0xE743 Hash - 0x9D2BD848 ^0x9D2BD848
{
	if (func_222(uParam0->f_1053[1]))
		func_240(&uParam0->f_1053[1], true, true);

	if (func_222(uParam0->f_1053[0]))
		func_240(&uParam0->f_1053[0], true, true);

	if (func_222(uParam0->f_1053[2]))
		func_240(&uParam0->f_1053[2], true, true);

	return;
}

void func_220(var uParam0, int iParam1) // Position - 0xE7A2 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

var func_221(var uParam0) // Position - 0xE7AF Hash - 0xC9D82232 ^0xC9D82232
{
	return uParam0;
}

BOOL func_222(int iParam0) // Position - 0xE7B9 Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
int func_223(var uParam0, Ped pedParam1) // Position - 0xE7F8 Hash - 0x513DF076 ^0x21069765
{
	...
	HUD::_UI_PROMPT_SET_GROUP(Global_1945188[func_301(uParam0->f_1053[1]) /*18*/].f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_12), 0);

	if (!func_230(&uParam0->f_1053[0], pedParam1, "SHOW_NEG_RESPONSE", joaat("INPUT_INTERACT_LOCKON_NEG")))
		return 0;

	HUD::_UI_PROMPT_SET_GROUP(Global_1945188[func_301(uParam0->f_1053[0]) /*18*/].f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_12), 0);
	return 1;
}

void func_224(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE89F Hash - 0x89AE2BEC ^0x89AE2BEC
{
	int num;
...
BOOL func_225(int iParam0, BOOL bParam1) // Position - 0xE8EE Hash - 0xC074CB7F ^0xC074CB7F
{
...
BOOL func_226(var uParam0) // Position - 0xE913 Hash - 0x15E2DFC ^0x15E2DFC
{
	if (func_222(*uParam0))
...
BOOL func_227(var uParam0) // Position - 0xE935 Hash - 0xDF953B98 ^0xC30FD2F3
{
	BOOL flag;
	var unk;
	int randomIntInRange;
	...
	if (func_40(&(uParam0->f_950)) && uParam0->f_18 < func_307(*uParam0) && func_47(&(uParam0->f_950)) > 35000)
	{
		uParam0->f_18 = uParam0->f_18 + 1;
		unk = { func_308(*uParam0, 0, true) };
		flag = true;
	}
	else if (func_309(*uParam0) && !func_310(36))
	{
		randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, 10);
	
		if (randomIntInRange < 5)
			unk = { func_308(*uParam0, 2, true) };
		else
			unk = { func_308(*uParam0, 1, true) };
	}
	else
	{
		unk = { func_308(*uParam0, 1, true) };
	...
	if (func_311(uParam0))
		unk = { func_308(*uParam0, 3, true) };

	if (func_312(&(uParam0->f_954), unk, true, -1, false, false))
	{
...
void func_228() // Position - 0xEA38 Hash - 0x8056105 ^0x876D2D3C
{
	BOOL flag;
	...
	if (!flag)
		TASK::TASK_PLAY_ANIM(Global_35, func_158(), func_314(1), 1090519040, -1056964608, -1, 0, 0, false, 0, false, 0, false);
	else
		TASK::TASK_PLAY_ANIM(Global_35, func_158(), func_314(0), 8f, -8f, -1, 67108880, 0, false, 1114114, false, 0, false);

	return;
}

BOOL func_229(var uParam0) // Position - 0xEAD2 Hash - 0xDF953B98 ^0x1A149465
{
	BOOL flag;
	var unk;
	int randomIntInRange;
	...
	if (func_40(&(uParam0->f_950)) && uParam0->f_19 < func_307(*uParam0) && func_47(&(uParam0->f_950)) > 35000)
	{
		uParam0->f_19 = uParam0->f_19 + 1;
		unk = { func_308(*uParam0, 0, false) };
		flag = true;
	}
	else if (func_309(*uParam0) && !func_310(36))
	{
		...
		if (randomIntInRange < 5)
			unk = { func_308(*uParam0, 2, false) };
		else
			unk = { func_308(*uParam0, 1, false) };
	}
	else
	{
		unk = { func_308(*uParam0, 1, false) };
...
BOOL func_230(var uParam0, Ped pedParam1, char* sParam2, Hash hParam3) // Position - 0xEBD5 Hash - 0x9E8CD956 ^0x6E55E820
{
	if (!func_222(*uParam0))
		*uParam0 = func_316(sParam2, hParam3, *pedParam1, 1, 0, false, 0, 0, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
...
Hash func_231(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xEC25 Hash - 0xDD2F88C2 ^0x29E97850
{
	Hash weaponHash;
...
BOOL func_232(Hash hParam0) // Position - 0xEC67 Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

BOOL func_233(int iParam0, BOOL bParam1) // Position - 0xEC82 Hash - 0xAAB142C4 ^0x20EFEF89
{
	int num;
...
void func_234(var uParam0) // Position - 0xECB5 Hash - 0x5DE504EA ^0x21277A8E
{
	var args;
...
void func_235(var uParam0) // Position - 0xED51 Hash - 0x3B2C2856 ^0xF58B7A18
{
	int i;
	int num;
	int num2;

	switch (iLocal_1141.f_14)
	{
		case 0:
			for (i = 0; i <= 7; i = i + 1)
			{
		...
		case 2:
			for (i = 8; i <= 9; i = i + 1)
			{
				...
				if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_81[0], iLocal_1141.f_2[num2]))
					Global_1394141.f_1332 = func_317(num2);
			}
			break;
	
		case 3:
			if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_81[0], iLocal_1141.f_2[10]))
...
void func_236(var uParam0, int iParam1) // Position - 0xEE37 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

void func_237(BOOL bParam0) // Position - 0xEE44 Hash - 0x3831B75B ^0x6AB69738
{
	if (bParam0)
...
char* func_238(int iParam0) // Position - 0xEE7C Hash - 0xDEB3DA4B ^0x2CFCE18D
{
	switch (iParam0)
	{
		case 0:
...
char* func_239() // Position - 0xEE9D Hash - 0x306ACA3A ^0x9F9FF256
{
	return "2150989330_action";
}

void func_240(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEEA9 Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
Vector3 func_241(int iParam0, int iParam1) // Position - 0xEEFD Hash - 0x23EAC636 ^0x23EAC636
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_242(int iParam0, int iParam1) // Position - 0xF07A Hash - 0x33A93AC2 ^0x33A93AC2
{
	switch (iParam0)
	{
		case 0:
...
void func_243(var uParam0, int iParam1) // Position - 0xF1CF Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

int func_244(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, int iParam10, Hash hParam11, BOOL bParam12) // Position - 0xF1DC Hash - 0x6B838E14 ^0xADF883E0
{
	int i;
	int num;
...
void func_245(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF262 Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
BOOL func_246(int iParam0, BOOL bParam1) // Position - 0xF2AD Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_247(var uParam0) // Position - 0xF305 Hash - 0xD2CD4C63 ^0xD2CD4C63
{
	int num;
	int i;
...
void func_248(var uParam0, int iParam1, int iParam2) // Position - 0xF334 Hash - 0x86676F62 ^0x645EBD89
{
	int i;
...
eStackSize func_249() // Position - 0xF3A0 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_250() // Position - 0xF3AE Hash - 0x5B04702E ^0x1B13FCC
{
	Interior interiorAtCoords;
	BOOL flag;
...
BOOL func_251(Hash hParam0) // Position - 0xF423 Hash - 0xD46620F0 ^0x47EF7B12
{
...
BOOL func_252(Hash hParam0) // Position - 0xF45A Hash - 0xB710720E ^0xB710720E
{
	return func_323(hParam0, 23);
}

void func_253(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0xF46A Hash - 0xD777F4CF ^0xBFF3124C
{
	func_321(hParam0, false, false);
...
BOOL func_254(int iParam0) // Position - 0xF4F5 Hash - 0xD6BB6FB5 ^0xD6BB6FB5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_255(Hash hParam0) // Position - 0xF534 Hash - 0x783D8692 ^0xC2190628
{
	func_321(hParam0, false, false);
...
BOOL func_256(Hash hParam0) // Position - 0xF55C Hash - 0x51587F69 ^0xAFC63473
{
	func_321(hParam0, false, false);
...
void func_257(var uParam0) // Position - 0xF585 Hash - 0xB3099499 ^0xA439833A
{
	int i;
...
eStackSize func_258() // Position - 0xF5CD Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_259(eStackSize essParam0, eStackSize essParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xF5D9 Hash - 0x38DA000F ^0x38DA000F
{
	int num;
	int num2;
	int num3;
...
void func_260(int iParam0) // Position - 0xF7DB Hash - 0x3A524DDA ^0x3A524DDA
{
	Global_1900383.f_316 = Global_1900383.f_316 || iParam0;
	return;
}

BOOL func_261() // Position - 0xF7F4 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_262() // Position - 0xF802 Hash - 0x381D116B ^0x52A4862A
{
	Interior interiorAtCoords;
	BOOL flag;
...
void func_263(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xF877 Hash - 0xB9FD135E ^0x2A68E0C1
{
	func_321(hParam0, false, false);
...
void func_264(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xF8B0 Hash - 0x5319EC03 ^0xCD317940
{
	float num;
	float num2;
...
void func_265(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xF921 Hash - 0xE583FF9E ^0x51298DC4
{
	float num;
	float lightIntensity;
...
BOOL func_266(int iParam0) // Position - 0xF98B Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_149(iParam0, Global_1310750.f_16072 | 64);
}

void func_267(int iParam0) // Position - 0xF9A3 Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
BOOL func_268(var uParam0, Ped pedParam1, char* sParam2) // Position - 0xFA30 Hash - 0xFB1C2C0E ^0x6794528D
{
	BOOL flag;
	int i;
...
Hash func_269(ePedType eptParam0) // Position - 0xFAAE Hash - 0x5007D79D ^0xB0A0AB80
{
	return joaat("META_OUTFIT_DEFAULT");
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0xFABB Hash - 0xA17D549C ^0x6F923C73
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(int iParam0) // Position - 0xFB51 Hash - 0xA17D549C ^0x917DCBC4
{
	switch (iParam0)
	{
		case 0:
...
void func_272(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xFBE7 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
int func_273(int iParam0) // Position - 0xFCC8 Hash - 0x9685BE4A ^0x9685BE4A
{
	switch (iParam0)
	{
		case 0:
...
struct<11> func_274(int iParam0, int iParam1) // Position - 0xFD0B Hash - 0x132D6D37 ^0x27252A2E
{
	var unk;
...
int func_275(int iParam0, int iParam1) // Position - 0xFF6D Hash - 0x5F42E2E4 ^0x5F42E2E4
{
	switch (iParam0)
	{
		case 0:
...
char* func_276(int iParam0) // Position - 0xFFD2 Hash - 0x899A1C9C ^0x899A1C9C
{
	switch (iParam0)
	{
		case 0:
...
char* func_277(int iParam0, int iParam1, int iParam2) // Position - 0x10202 Hash - 0x1CC5D4C0 ^0x5E53EED8
{
	switch (iParam0)
	{
		case 0:
...
float func_278() // Position - 0x11764 Hash - 0xA456E2CC ^0x9AE2B714
{
	return MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.25f);
}

BOOL func_279(int iParam0) // Position - 0x11776 Hash - 0xA05361F6 ^0xF8A0FD3E
{
	switch (iParam0)
	{
...
void func_280(var uParam0, int iParam1) // Position - 0x1188C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_281(var uParam0, int iParam1) // Position - 0x1189D Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_282(Ped pedParam0, Hash hParam1) // Position - 0x118B2 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_283(Ped pedParam0, Hash hParam1) // Position - 0x118E0 Hash - 0xA54F3032 ^0x2AFB8617
{
	Hash _int;
...
BOOL func_284(Ped pedParam0, Hash hParam1) // Position - 0x11931 Hash - 0xA54F3032 ^0x2AFB8617
{
	Hash _int;
	int _int2;
...
void func_285(Ped pedParam0) // Position - 0x119A3 Hash - 0x446F1BDD ^0xA431960A
{
...
BOOL func_286(int iParam0, int iParam1) // Position - 0x119C1 Hash - 0xFAECB30D ^0xFAECB30D
{
	switch (iParam0)
	{
		case 9:
...
void func_287(var uParam0, int iParam1) // Position - 0x11A59 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

int func_288(int iParam0) // Position - 0x11A66 Hash - 0xCD657E63 ^0x35128233
{
	switch (iParam0)
	{
		case 0:
...
float func_289(int iParam0, int iParam1) // Position - 0x11AC0 Hash - 0x14C48482 ^0x14C48482
{
	switch (iParam0)
	{
		case 0:
...
float func_290(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x120C1 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_291(var uParam0) // Position - 0x12109 Hash - 0x76491A38 ^0x60C35CA3
{
	var entityCoords;
	var unk3;
	var unk6;
...
void func_292(Ped* ppedParam0, int iParam1) // Position - 0x12176 Hash - 0xE100D481 ^0xD397D024
{
	int num;
	Vector3 vector;
	float num2;
...
int func_293(int iParam0) // Position - 0x12271 Hash - 0xE431F5ED ^0xE431F5ED
{
	if (iParam0 <= 26)
		return 15;
...
BOOL func_294(int iParam0, int iParam1) // Position - 0x122B9 Hash - 0xDA7AE58E ^0xDA7AE58E
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_295(int iParam0) // Position - 0x126AA Hash - 0x1F48C82A ^0x1F48C82A
{
	switch (iParam0)
	{
		case 0:
...
void func_296(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x12720 Hash - 0x62D0D0BF ^0xF17935FD
{
	var args;
...
void func_297(var uParam0, int iParam1) // Position - 0x1279F Hash - 0xD1617FB3 ^0x45B85FC
{
	int num;
	Vector3 vector;
	float num2;
...
void func_298(var uParam0, Ped* ppedParam1) // Position - 0x128ED Hash - 0x82C823ED ^0xECBE4079
{
	float animScenePhase;
	BOOL flag;
...
Vector3 func_299(int iParam0) // Position - 0x12CEC Hash - 0x4CB488BA ^0x4CB488BA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_300(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x12D65 Hash - 0xFA2BBA1 ^0xB0883B47
{
...
int func_301(int iParam0) // Position - 0x12D91 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

void func_302(int iParam0, int iParam1) // Position - 0x12D9B Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_303(int iParam0, BOOL bParam1) // Position - 0x12DCE Hash - 0x7190BAC6 ^0x6DC372CF
{
...
void func_304(int iParam0, BOOL bParam1) // Position - 0x12E26 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_305(int iParam0, int iParam1) // Position - 0x12E4F Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
BOOL func_306(int iParam0, int iParam1) // Position - 0x12E77 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
int func_307(int iParam0) // Position - 0x12E98 Hash - 0xA4ACC31E ^0xA4ACC31E
{
	switch (iParam0)
	{
		case 5:
...
Vector3 func_308(int iParam0, int iParam1, BOOL bParam2) // Position - 0x12F49 Hash - 0x375D51FB ^0x375D51FB
{
	var unk;
...
BOOL func_309(int iParam0) // Position - 0x1408F Hash - 0x8435905 ^0x8435905
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_310(int iParam0) // Position - 0x14108 Hash - 0xBF7DEF91 ^0x6E26B7C2
{
...
BOOL func_311(var uParam0) // Position - 0x14134 Hash - 0x7C604A1E ^0x4A07090F
{
	float animScenePhase;
...
BOOL func_312(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x142E3 Hash - 0x4863E989 ^0xB2E91EEF
{
	BOOL flag;
...
void func_313(var uParam0) // Position - 0x1433D Hash - 0x6C9C0A43 ^0x6C9C0A43
{
...
char* func_314(int iParam0) // Position - 0x143B0 Hash - 0x958AD60F ^0x437A9ED9
{
	switch (iParam0)
	{
		case 0:
...
void func_315(var uParam0) // Position - 0x143DE Hash - 0x1C1CF337 ^0x1C1CF337
{
	switch (uParam0->f_1052)
	{
		case -4:
...
int func_316(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x14467 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
...
int func_317(int iParam0) // Position - 0x1453E Hash - 0x6D3B16F0 ^0x6D3B16F0
{
	switch (iParam0)
	{
		case 0:
...
void func_318(int iParam0) // Position - 0x145C8 Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_466(iParam0))
		return;
...
void func_319(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Ped pedParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x1467B Hash - 0x1B501888 ^0x6546232B
{
	...
	func_303(iParam0, true);
	func_304(iParam0, true);
	func_305(iParam0, 128);
	return;
}

void func_320(Ped pedParam0) // Position - 0x14921 Hash - 0x5C592C2B ^0x4255940A
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
Hash func_321(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x14951 Hash - 0xEC5804B5 ^0x15A1D925
{
...
BOOL func_322(Hash hParam0) // Position - 0x149F5 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_467(hParam0))
...
BOOL func_323(Hash hParam0, int iParam1) // Position - 0x14A10 Hash - 0xC6E98A5B ^0xE9422008
{
...
void func_324(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x14A55 Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_322(hParam0))
	{
...
void func_325(Hash hParam0, BOOL bParam1) // Position - 0x14A8D Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_322(hParam0))
...
void func_326(Hash hParam0, BOOL bParam1) // Position - 0x14ABB Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_322(hParam0))
...
void func_327(Hash hParam0, BOOL bParam1) // Position - 0x14AE9 Hash - 0x4844A91D ^0x50E23246
{
	if (func_322(hParam0))
...
BOOL func_328() // Position - 0x14B17 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_329(eStackSize essParam0, eStackSize essParam1, BOOL bParam2) // Position - 0x14B20 Hash - 0x30CEFC86 ^0x30CEFC86
{
	if (bParam2)
...
int func_330(eStackSize essParam0) // Position - 0x14B4D Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 22) & 15;
}

int func_331(eStackSize essParam0) // Position - 0x14B60 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(essParam0, 26) & 31 * MISC::IS_BIT_SET(essParam0, 31) ? -1 : 1) + 1898;
}

int func_332(eStackSize essParam0) // Position - 0x14B85 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 17) & 31;
}

int func_333(eStackSize essParam0) // Position - 0x14B98 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 12) & 31;
}

int func_334(eStackSize essParam0) // Position - 0x14BAB Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 6) & 63;
}

int func_335(eStackSize essParam0) // Position - 0x14BBD Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 0) & 63;
}

int func_336(int iParam0, int iParam1) // Position - 0x14BCF Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
float func_337(float fParam0, float fParam1, float fParam2) // Position - 0x14C69 Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
float func_338(float fParam0, float fParam1, float fParam2) // Position - 0x14CAB Hash - 0xC55BBAAC ^0xC55BBAAC
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

BOOL func_339(ePedType eptParam0) // Position - 0x14CC0 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_340(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x15113 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_341(Ped pedParam0, BOOL bParam1) // Position - 0x15143 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_342(Ped pedParam0, int iParam1) // Position - 0x15188 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_343(int iParam0, int iParam1, int iParam2) // Position - 0x151AF Hash - 0x952E3ACE ^0x952E3ACE
{
	switch (iParam0)
	{
		case 0:
...
char* func_344(int iParam0) // Position - 0x15D4F Hash - 0xAFCCB9D8 ^0xAFCCB9D8
{
	switch (iParam0)
	{
		case 0:
...
char* func_345(int iParam0) // Position - 0x15D9C Hash - 0xB7C63976 ^0xB7C63976
{
	switch (iParam0)
	{
		case 0:
...
char* func_346(int iParam0) // Position - 0x15DC1 Hash - 0xD91AC249 ^0xD91AC249
{
	switch (iParam0)
	{
		case 0:
...
char* func_347(int iParam0) // Position - 0x15DE6 Hash - 0xE3BA00A9 ^0xE3BA00A9
{
	switch (iParam0)
	{
		case 0:
...
char* func_348(int iParam0) // Position - 0x15E17 Hash - 0x5168CC1A ^0x5168CC1A
{
	switch (iParam0)
	{
		case 0:
...
char* func_349(int iParam0) // Position - 0x15E69 Hash - 0x4F4D5C64 ^0x4F4D5C64
{
	switch (iParam0)
	{
		case 0:
...
char* func_350(int iParam0) // Position - 0x15E8E Hash - 0xD05F100E ^0xD05F100E
{
	switch (iParam0)
	{
		case 0:
...
char* func_351(int iParam0) // Position - 0x15EB3 Hash - 0xB7BD42B4 ^0xB7BD42B4
{
	switch (iParam0)
	{
		case 0:
...
char* func_352(int iParam0) // Position - 0x15EE4 Hash - 0x4292CBC0 ^0x4292CBC0
{
	switch (iParam0)
	{
		case 0:
...
char* func_353(int iParam0) // Position - 0x15F72 Hash - 0x77D3E78F ^0x77D3E78F
{
	switch (iParam0)
	{
		case 0:
...
char* func_354(int iParam0) // Position - 0x15FA6 Hash - 0x1F80CDA5 ^0x1F80CDA5
{
	switch (iParam0)
	{
		case 0:
...
char* func_355(int iParam0) // Position - 0x15FDA Hash - 0x5448A6DD ^0x5448A6DD
{
	switch (iParam0)
	{
		case 0:
...
char* func_356(int iParam0) // Position - 0x16027 Hash - 0x443BDA30 ^0x443BDA30
{
	switch (iParam0)
	{
		case 0:
...
char* func_357(int iParam0) // Position - 0x16097 Hash - 0x761D2D62 ^0x761D2D62
{
	switch (iParam0)
	{
		case 0:
...
char* func_358(int iParam0) // Position - 0x160CB Hash - 0xF6127A4F ^0xF6127A4F
{
	switch (iParam0)
	{
		case 0:
...
char* func_359(int iParam0) // Position - 0x160FF Hash - 0xE5183A1D ^0xE5183A1D
{
	switch (iParam0)
	{
		case 0:
...
char* func_360(int iParam0) // Position - 0x1614C Hash - 0xF10B0370 ^0xF10B0370
{
	switch (iParam0)
	{
		case 0:
...
char* func_361(int iParam0) // Position - 0x16199 Hash - 0x1824D955 ^0x1824D955
{
	switch (iParam0)
	{
		case 0:
...
char* func_362(int iParam0) // Position - 0x161BC Hash - 0x3B0BF74F ^0x3B0BF74F
{
	switch (iParam0)
	{
		case 0:
...
char* func_363(int iParam0) // Position - 0x161E1 Hash - 0xE3BA00A9 ^0xE3BA00A9
{
	switch (iParam0)
	{
		case 0:
...
char* func_364(int iParam0) // Position - 0x16212 Hash - 0xB3FF1847 ^0xB3FF1847
{
	switch (iParam0)
	{
		case 0:
...
char* func_365(int iParam0) // Position - 0x1629B Hash - 0x8ECEA887 ^0x8ECEA887
{
	switch (iParam0)
	{
		case 0:
...
char* func_366(int iParam0) // Position - 0x162CF Hash - 0x158F9A1C ^0x158F9A1C
{
	switch (iParam0)
	{
		case 0:
...
char* func_367(int iParam0) // Position - 0x16303 Hash - 0x9F5E2F9 ^0x9F5E2F9
{
	switch (iParam0)
	{
		case 0:
...
char* func_368(int iParam0) // Position - 0x16350 Hash - 0x1123E3E6 ^0x1123E3E6
{
	switch (iParam0)
	{
		case 0:
...
char* func_369(int iParam0) // Position - 0x163C0 Hash - 0x5236CC9C ^0x5236CC9C
{
	switch (iParam0)
	{
		case 0:
...
char* func_370(int iParam0) // Position - 0x163F4 Hash - 0x761D2D62 ^0x761D2D62
{
	switch (iParam0)
	{
		case 0:
...
char* func_371(int iParam0) // Position - 0x16428 Hash - 0x5448A6DD ^0x5448A6DD
{
	switch (iParam0)
	{
		case 0:
...
char* func_372(int iParam0) // Position - 0x16475 Hash - 0x3CD1999F ^0x3CD1999F
{
	switch (iParam0)
	{
		case 0:
...
char* func_373(int iParam0) // Position - 0x164E5 Hash - 0x77D3E78F ^0x77D3E78F
{
	switch (iParam0)
	{
		case 0:
...
char* func_374(int iParam0) // Position - 0x16519 Hash - 0x1F80CDA5 ^0x1F80CDA5
{
	switch (iParam0)
	{
		case 0:
...
char* func_375(int iParam0) // Position - 0x1654D Hash - 0xE5183A1D ^0xE5183A1D
{
	switch (iParam0)
	{
		case 0:
...
char* func_376(int iParam0) // Position - 0x1659A Hash - 0x16006070 ^0x16006070
{
	switch (iParam0)
	{
		case 0:
...
char* func_377(int iParam0) // Position - 0x165DD Hash - 0xC0FE6BD9 ^0xC0FE6BD9
{
	switch (iParam0)
	{
		case 0:
...
char* func_378(int iParam0) // Position - 0x16602 Hash - 0x603CB86C ^0x603CB86C
{
	switch (iParam0)
	{
		case 0:
...
char* func_379(int iParam0) // Position - 0x16627 Hash - 0x912BC867 ^0x912BC867
{
	switch (iParam0)
	{
		case 0:
...
char* func_380(int iParam0) // Position - 0x16658 Hash - 0x2A576AD6 ^0x2A576AD6
{
	switch (iParam0)
	{
		case 0:
...
char* func_381(int iParam0) // Position - 0x1669B Hash - 0xC7322311 ^0xC7322311
{
	switch (iParam0)
	{
		case 0:
...
char* func_382(int iParam0) // Position - 0x166C0 Hash - 0x82590410 ^0x82590410
{
	switch (iParam0)
	{
		case 0:
...
char* func_383(int iParam0) // Position - 0x166E5 Hash - 0x5CF9E971 ^0x5CF9E971
{
	switch (iParam0)
	{
		case 0:
...
char* func_384(int iParam0) // Position - 0x16716 Hash - 0x16ECADD9 ^0x16ECADD9
{
	switch (iParam0)
	{
		case 0:
...
char* func_385(int iParam0) // Position - 0x16759 Hash - 0x49C02D11 ^0x49C02D11
{
	switch (iParam0)
	{
		case 0:
...
char* func_386(int iParam0) // Position - 0x1677E Hash - 0xF41722F2 ^0xF41722F2
{
	switch (iParam0)
	{
		case 0:
...
char* func_387(int iParam0) // Position - 0x167A3 Hash - 0x69C29F15 ^0x69C29F15
{
	switch (iParam0)
	{
		case 0:
...
char* func_388(int iParam0) // Position - 0x167D4 Hash - 0x7A257100 ^0x7A257100
{
	switch (iParam0)
	{
		case 0:
...
char* func_389(int iParam0) // Position - 0x16817 Hash - 0xFD6BCDAC ^0xFD6BCDAC
{
	switch (iParam0)
	{
		case 0:
...
char* func_390(int iParam0) // Position - 0x1683C Hash - 0xD6092466 ^0xD6092466
{
	switch (iParam0)
	{
		case 0:
...
char* func_391(int iParam0) // Position - 0x16861 Hash - 0x42340438 ^0x42340438
{
	switch (iParam0)
	{
		case 0:
...
char* func_392(int iParam0) // Position - 0x16892 Hash - 0x7101D77B ^0x7101D77B
{
	switch (iParam0)
	{
		case 0:
...
char* func_393(int iParam0) // Position - 0x168D2 Hash - 0x54DF13C7 ^0x54DF13C7
{
	switch (iParam0)
	{
		case 0:
...
char* func_394(int iParam0) // Position - 0x168F7 Hash - 0xB7C63976 ^0xB7C63976
{
	switch (iParam0)
	{
		case 0:
...
char* func_395(int iParam0) // Position - 0x1691C Hash - 0x17531EF7 ^0x17531EF7
{
	switch (iParam0)
	{
		case 0:
...
char* func_396(int iParam0) // Position - 0x1694D Hash - 0x373422F8 ^0x373422F8
{
	switch (iParam0)
	{
		case 0:
...
char* func_397(int iParam0) // Position - 0x1698D Hash - 0xC56BC51F ^0xC56BC51F
{
	switch (iParam0)
	{
		case 0:
...
char* func_398(int iParam0) // Position - 0x169B2 Hash - 0x4F4D5C64 ^0x4F4D5C64
{
	switch (iParam0)
	{
		case 0:
...
char* func_399(int iParam0) // Position - 0x169D7 Hash - 0xECD770D4 ^0xECD770D4
{
	switch (iParam0)
	{
		case 0:
...
char* func_400(int iParam0) // Position - 0x16A08 Hash - 0xD4B9A49F ^0xD4B9A49F
{
	switch (iParam0)
	{
		case 0:
...
char* func_401(int iParam0) // Position - 0x16A4B Hash - 0xE4FD19B7 ^0xE4FD19B7
{
	switch (iParam0)
	{
		case 0:
...
char* func_402(int iParam0) // Position - 0x16A6E Hash - 0xB7C63976 ^0xB7C63976
{
	switch (iParam0)
	{
		case 0:
...
char* func_403(int iParam0) // Position - 0x16A93 Hash - 0x8449F665 ^0x8449F665
{
	switch (iParam0)
	{
		case 0:
...
char* func_404(int iParam0) // Position - 0x16AC7 Hash - 0xEB834F22 ^0xEB834F22
{
	switch (iParam0)
	{
		case 0:
...
char* func_405(int iParam0) // Position - 0x16B37 Hash - 0xB0888488 ^0xB0888488
{
	switch (iParam0)
	{
		case 0:
...
char* func_406(int iParam0) // Position - 0x16B68 Hash - 0x69D94719 ^0x69D94719
{
	switch (iParam0)
	{
		case 0:
...
char* func_407(int iParam0) // Position - 0x16B9C Hash - 0x5F517662 ^0x5F517662
{
	switch (iParam0)
	{
		case 0:
...
char* func_408(int iParam0) // Position - 0x16BEE Hash - 0xADFE55F4 ^0xADFE55F4
{
	switch (iParam0)
	{
		case 0:
...
char* func_409(int iParam0) // Position - 0x16C5E Hash - 0xE5CD89DA ^0xE5CD89DA
{
	switch (iParam0)
	{
		case 0:
...
char* func_410(int iParam0) // Position - 0x16C8F Hash - 0xF6B15126 ^0xF6B15126
{
	switch (iParam0)
	{
		case 0:
...
char* func_411(int iParam0) // Position - 0x16CC3 Hash - 0xCDE0A3BE ^0xCDE0A3BE
{
	switch (iParam0)
	{
		case 0:
...
char* func_412(int iParam0) // Position - 0x16D15 Hash - 0xE98259BD ^0xE98259BD
{
	switch (iParam0)
	{
		case 0:
...
char* func_413(int iParam0) // Position - 0x16D58 Hash - 0x1824D955 ^0x1824D955
{
	switch (iParam0)
	{
		case 0:
...
char* func_414(int iParam0) // Position - 0x16D7B Hash - 0x32FC06D3 ^0x32FC06D3
{
	switch (iParam0)
	{
		case 0:
...
char* func_415(int iParam0) // Position - 0x16DA0 Hash - 0xBB128ADA ^0xBB128ADA
{
	switch (iParam0)
	{
		case 0:
...
char* func_416(int iParam0) // Position - 0x16DD4 Hash - 0xCDA88CDD ^0xCDA88CDD
{
	switch (iParam0)
	{
		case 0:
...
char* func_417(int iParam0) // Position - 0x16E17 Hash - 0x60891455 ^0x60891455
{
	switch (iParam0)
	{
		case 0:
...
char* func_418(int iParam0) // Position - 0x16E3A Hash - 0x74518E1C ^0x74518E1C
{
	switch (iParam0)
	{
		case 0:
...
char* func_419(int iParam0) // Position - 0x16E5F Hash - 0x78C1AF48 ^0x78C1AF48
{
	switch (iParam0)
	{
		case 0:
...
char* func_420(int iParam0) // Position - 0x16E93 Hash - 0xDA57AB01 ^0xDA57AB01
{
	switch (iParam0)
	{
		case 0:
...
char* func_421(int iParam0) // Position - 0x16ED6 Hash - 0x2D5CAC35 ^0x2D5CAC35
{
	switch (iParam0)
	{
		case 0:
...
char* func_422(int iParam0) // Position - 0x16EF9 Hash - 0xA390B420 ^0xA390B420
{
	switch (iParam0)
	{
		case 0:
...
char* func_423(int iParam0) // Position - 0x16F1E Hash - 0xC4B9E871 ^0xC4B9E871
{
	switch (iParam0)
	{
		case 0:
...
char* func_424(int iParam0) // Position - 0x16F52 Hash - 0x8B8A1DFC ^0x8B8A1DFC
{
	switch (iParam0)
	{
		case 0:
...
char* func_425(int iParam0) // Position - 0x16F95 Hash - 0x80E3BA54 ^0x80E3BA54
{
	switch (iParam0)
	{
		case 0:
...
char* func_426(int iParam0) // Position - 0x16FC9 Hash - 0xF6BE04E ^0xF6BE04E
{
	switch (iParam0)
	{
		case 0:
...
char* func_427(int iParam0) // Position - 0x1700C Hash - 0x3B0BF74F ^0x3B0BF74F
{
	switch (iParam0)
	{
		case 0:
...
char* func_428(int iParam0) // Position - 0x17031 Hash - 0x920F7B56 ^0x920F7B56
{
	switch (iParam0)
	{
		case 0:
...
char* func_429(int iParam0) // Position - 0x17056 Hash - 0x873736BB ^0x873736BB
{
	switch (iParam0)
	{
		case 0:
...
char* func_430(int iParam0) // Position - 0x1708A Hash - 0xF30B59F3 ^0xF30B59F3
{
	switch (iParam0)
	{
		case 0:
...
char* func_431(int iParam0) // Position - 0x170FA Hash - 0x14BDC0F4 ^0x14BDC0F4
{
	switch (iParam0)
	{
		case 0:
...
char* func_432(int iParam0) // Position - 0x1712E Hash - 0x5236CC9C ^0x5236CC9C
{
	switch (iParam0)
	{
		case 0:
...
char* func_433(int iParam0) // Position - 0x17162 Hash - 0x46293A55 ^0x46293A55
{
	switch (iParam0)
	{
		case 0:
...
char* func_434(int iParam0) // Position - 0x171B4 Hash - 0xAD8C2622 ^0xAD8C2622
{
	switch (iParam0)
	{
		case 0:
...
char* func_435(int iParam0) // Position - 0x17224 Hash - 0xA5CC57F0 ^0xA5CC57F0
{
	switch (iParam0)
	{
		case 0:
...
char* func_436(int iParam0) // Position - 0x17258 Hash - 0x77D3E78F ^0x77D3E78F
{
	switch (iParam0)
	{
		case 0:
...
char* func_437(int iParam0) // Position - 0x1728C Hash - 0xB0D7C7E5 ^0xB0D7C7E5
{
	switch (iParam0)
	{
		case 0:
...
char* func_438(int iParam0) // Position - 0x172DE Hash - 0xC15A14EA ^0xC15A14EA
{
	switch (iParam0)
	{
		case 0:
...
char* func_439(int iParam0) // Position - 0x17321 Hash - 0xE8157407 ^0xE8157407
{
	switch (iParam0)
	{
		case 0:
...
char* func_440(int iParam0) // Position - 0x17346 Hash - 0x3D5ABE59 ^0x3D5ABE59
{
	switch (iParam0)
	{
		case 0:
...
char* func_441(int iParam0) // Position - 0x1736B Hash - 0xBBFA6DBE ^0xBBFA6DBE
{
	switch (iParam0)
	{
		case 0:
...
char* func_442(int iParam0) // Position - 0x1739F Hash - 0x99DD7FF ^0x99DD7FF
{
	switch (iParam0)
	{
		case 0:
...
char* func_443(int iParam0) // Position - 0x173C4 Hash - 0x3D9CB917 ^0x3D9CB917
{
	switch (iParam0)
	{
		case 0:
...
char* func_444(int iParam0) // Position - 0x173F8 Hash - 0xE4CD9C94 ^0xE4CD9C94
{
	switch (iParam0)
	{
		case 0:
...
char* func_445(int iParam0) // Position - 0x1743B Hash - 0xF8867BC3 ^0xF8867BC3
{
	switch (iParam0)
	{
		case 0:
...
char* func_446(int iParam0) // Position - 0x1746F Hash - 0x1967B219 ^0x1967B219
{
	switch (iParam0)
	{
		case 0:
...
char* func_447(int iParam0) // Position - 0x174B2 Hash - 0x86510C2B ^0x86510C2B
{
	switch (iParam0)
	{
		case 0:
...
char* func_448(int iParam0) // Position - 0x174E6 Hash - 0x3954400F ^0x3954400F
{
	switch (iParam0)
	{
		case 0:
...
char* func_449(int iParam0) // Position - 0x17556 Hash - 0x5404D35 ^0x5404D35
{
	switch (iParam0)
	{
		case 0:
...
char* func_450(int iParam0) // Position - 0x1758A Hash - 0xE8FFD034 ^0xE8FFD034
{
	switch (iParam0)
	{
		case 0:
...
char* func_451(int iParam0) // Position - 0x175FA Hash - 0xD283A5B6 ^0xD283A5B6
{
	switch (iParam0)
	{
		case 0:
...
char* func_452(int iParam0) // Position - 0x1762E Hash - 0xB8753810 ^0xB8753810
{
	switch (iParam0)
	{
		case 0:
...
char* func_453(int iParam0) // Position - 0x176F8 Hash - 0xF7132739 ^0xF7132739
{
	switch (iParam0)
	{
		case 0:
...
char* func_454(int iParam0) // Position - 0x1774A Hash - 0x51C1DD54 ^0x51C1DD54
{
	switch (iParam0)
	{
		case 0:
...
char* func_455(int iParam0) // Position - 0x177B7 Hash - 0x118F7B8D ^0x118F7B8D
{
	switch (iParam0)
	{
		case 0:
...
char* func_456(int iParam0) // Position - 0x177EB Hash - 0x6C462E55 ^0x6C462E55
{
	switch (iParam0)
	{
		case 0:
...
char* func_457(int iParam0) // Position - 0x1781F Hash - 0xD23F86CD ^0xD23F86CD
{
	switch (iParam0)
	{
		case 0:
...
char* func_458(int iParam0) // Position - 0x1786C Hash - 0x8FA636EC ^0x8FA636EC
{
	switch (iParam0)
	{
		case 0:
...
char* func_459(int iParam0) // Position - 0x178DA Hash - 0xB20F47EB ^0xB20F47EB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_460(int iParam0) // Position - 0x17927 Hash - 0xCAB4B86D ^0xCAB4B86D
{
	int num;
...
int func_461(int iParam0) // Position - 0x17945 Hash - 0xDED73C45 ^0xDED73C45
{
	if (iParam0 <= 26)
		return 30;
...
int func_462(int iParam0) // Position - 0x179A9 Hash - 0x4A9F1197 ^0x49200B0
{
	if (iParam0 <= 26)
		return 34;
	else if (iParam0 >= 27 && iParam0 <= 32)
...
BOOL func_463(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x17A07 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
Vector3 func_464(int iParam0) // Position - 0x17A60 Hash - 0x1B01D40F ^0x12445F14
{
	var unk;
...
void func_465(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x17F91 Hash - 0xFDACD718 ^0x658C9335
{
	int i;
...
BOOL func_466(int iParam0) // Position - 0x17FE3 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_306(iParam0, 2);
}

BOOL func_467(Hash hParam0) // Position - 0x17FF2 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_468(eStackSize essParam0) // Position - 0x17FFE Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
...
var func_469(BOOL bParam0, var uParam1, var uParam2) // Position - 0x180DC Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0(int iParam0) // Position - 0x180F3 Hash - 0xA17D549C ^0x6209A856
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(int iParam0) // Position - 0x181F1 Hash - 0xA17D549C ^0xD0272204
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0(int iParam0) // Position - 0x183BF Hash - 0xA17D549C ^0x4C8D4DCA
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0(int iParam0) // Position - 0x18448 Hash - 0xA17D549C ^0x430A507A
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x18546 Hash - 0xA17D549C ^0xE5611039
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x186FA Hash - 0xA17D549C ^0x5BA59001
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x188AE Hash - 0xA17D549C ^0xC9257DBF
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x18992 Hash - 0xA17D549C ^0x9C938BBC
{
	switch (iParam0)
	{
		case 0:
...
int func_479(int iParam0) // Position - 0x19269 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_480(iParam0))
		return -1;
...
BOOL func_480(int iParam0) // Position - 0x19285 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_481(int iParam0) // Position - 0x192B8 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_482(int iParam0) // Position - 0x192F9 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
