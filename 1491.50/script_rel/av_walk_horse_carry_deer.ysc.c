#region Local Var
	...
	var uLocal_54 = 0;
	var uLocal_55 = 0;
	var uLocal_56 = 1097859072;
	var uLocal_57 = 1000;
	var uLocal_58 = 1067450368;
	var uLocal_59 = 5000;
	var uLocal_60 = 42;
	var uLocal_61 = 1103626240;
	var uLocal_62 = 1077936128;
	var uLocal_63 = 1106247680;
	var uLocal_64 = 1103101952;
	var uLocal_65 = 1097859072;
	var uLocal_66 = 1103626240;
	Hash hLocal_67 = 0;
	int iLocal_68 = 0;
	Hash hLocal_69 = 0;
	Hash hLocal_70 = 0;
...
void main() // Position - 0x0 Hash - 0x8408E14A ^0xEC19AAD0
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	hLocal_10 = joaat("dead_carriable_deer");
	iLocal_68 = joaat("META_OUTFIT_DEFAULT");
	hLocal_69 = joaat("a_c_deer_01");
	hLocal_70 = func_1(joaat("horse_class_riding"), true);
...
Hash func_1(int iParam0, BOOL bParam1) // Position - 0x5A2 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_2(var uParam0) // Position - 0x65C Hash - 0x646928F0 ^0x646928F0
{
	func_5(uParam0);
	return;
}

void func_3(var uParam0) // Position - 0x66A Hash - 0x15214583 ^0x343259F6
{
	int i;
	...
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_498))
	{
		...
		func_6(uParam0->f_498);
	}

	return;
}

BOOL func_4(var uParam0) // Position - 0x700 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
	...
	switch (uParam0->f_464)
	{
		case 0:
			if (_IS_NULL_VECTOR(uParam0->f_483))
			{
				...
				{
					num = 0;
					uParam0->f_482 = func_9(*uParam0, &num, true, false, false);
					...
					else
					{
						...
						if (uParam0->f_480 > 1)
						{
							func_10(&(Global_1415419.f_19[*uParam0 /*12*/].f_11), 1);
							uParam0->f_464 = 8;
						}
					}
				}
			...
			if (flag)
			{
				func_11(*uParam0, uParam0->f_483, uParam0->f_1);
				TELEMETRY::_TELEMETRY_AMBIENT_VIGNETTE(func_12(*uParam0), uParam0->f_489, uParam0->f_483, uParam0->f_20[0 /*14*/], uParam0->f_453);
				num2 = func_13(*uParam0);
			
				if (num2 > 0f)
					uParam0->f_496 = func_14(uParam0->f_483, num2, "AMB_VIG", true, 0, 8, false, -1082130432);
			
				func_15(uParam0, uParam0->f_483, uParam0->f_486);
				...
				{
					uParam0->f_497 = VOLUME::CREATE_VOLUME_CYLINDER(uParam0->f_483, 0f, 0f, 0f, func_16(uParam0));
		...
		case 3:
			if (func_18(uParam0) && func_19(uParam0))
				uParam0->f_464 = 5;
			else
				return false;
			break;
		...
		case 4:
			if (func_24(uParam0) && func_25(uParam0) && func_26(uParam0))
			{
				func_27(uParam0);
				uParam0->f_464 = 6;
			}
		...
		case 5:
			if (func_20(uParam0))
			{
				...
				if (func_22(*uParam0))
					func_23(uParam0->f_483, 6f, true, true, false, false, false);
...
void func_5(var uParam0) // Position - 0xAA7 Hash - 0x4DA9BC8C ^0xB6ED3446
{
	func_34(uParam0, &func_31, &func_32, &func_33);
	return;
}

void func_6(Volume volParam0) // Position - 0xAC1 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_7(var uParam0) // Position - 0xAD8 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xB96 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_9(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xBC0 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
	...
	if (Global_1415419.f_19[iParam0 /*12*/].f_8 != -1 && Global_1415419.f_19[iParam0 /*12*/].f_9 < 960 && Global_1415419.f_19[iParam0 /*12*/].f_9 >= Global_1415419.f_19[iParam0 /*12*/].f_8)
	{
		...
		for (i = Global_1415419.f_19[iParam0 /*12*/].f_8; i <= Global_1415419.f_19[iParam0 /*12*/].f_9; i = i + 1)
		{
			*uParam1 = *uParam1 + 1;
			...
			if (!func_38(iParam0, Global_1415419.f_2996[i /*7*/]))
			{
			}
			else
			{
				...
				{
					num5 = func_39(Global_35, Global_1415419.f_2996[i /*7*/], 1060437492);
					...
					{
						if (func_40(Global_1415419.f_2996[i /*7*/], num6, iParam0 <= 33 || iParam0 == 72, bParam4, num3, num4, iParam0))
						{
							num = i;
							num2 = num6;
...
void func_10(int iParam0, int iParam1) // Position - 0xD11 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_11(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD26 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_41();

	func_42(&(Global_32074.f_2697.f_6[iParam0 /*6*/].f_5), 0, 0, 1, 0, 0, 0, false);
	func_43(iParam0, 1, 0, 0);
...
int func_12(int iParam0) // Position - 0xDCA Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_13(int iParam0) // Position - 0x1B7B Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_44(iParam0))
	{
...
Volume func_14(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1BE1 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
	...
	func_46(volume, bParam8);
	return volume;
}

void func_15(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1C9B Hash - 0x259FE046 ^0x259FE046
{
	Hash hash;
	int num;

	func_47(uParam0, "WALK_HORSE_CARRY_DEER", "", vParam1, uParam4);
	hash = func_49(func_48(), true, true, false, true, false, false);
	num = 1;
	...
	switch (*uParam0)
	{
		case 46:
			sLocal_71 = "PD_Deer_Shot";
			hLocal_10 = joaat("dead_carriable_goat");
			hLocal_69 = joaat("a_c_goat_01");
			bLocal_72 = false;
			break;
	
		case 53:
			sLocal_71 = "PD_Ram_Shot";
			hLocal_10 = joaat("dead_carriable_bighornram");
			hLocal_69 = joaat("a_c_bighornram_01");
			bLocal_72 = false;
			num = 0;
		
			if (uParam0->f_489 == 1)
				iLocal_68 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAMDESERT_001");
			else
				iLocal_68 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAMROCKY");
			break;
		...
		case 69:
			sLocal_71 = "PD_Deer_Shot";
			hLocal_10 = joaat("dead_carriable_pronghorn");
			hLocal_69 = joaat("a_c_pronghorn_01");
			...
			if (uParam0->f_489 == 1)
			{
				...
				if (func_50())
					iLocal_68 = joaat("META_ANIMAL_OUTFIT_PRONGHORNSONOM_001");
				else
					iLocal_68 = joaat("META_ANIMAL_OUTFIT_PRONGHORNBAJAM_001");
			}
			break;
	...
	func_51(uParam0, 0, "MPDHP_HORSE", hLocal_70, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MPDHP_MAN", hash, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 0f), 10f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);

	if (*uParam0 != 71)
		func_51(uParam0, 2, "WHCDP_ANIMAL", hLocal_69, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -3f, 0f, 0f), 10f + uParam4.f_2, num, 1, 1, 1, iLocal_68, 1);

	return;
}

Vector3 func_16(var uParam0) // Position - 0x1E66 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_17(var uParam0) // Position - 0x1F06 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_18(var uParam0) // Position - 0x2020 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_19(var uParam0) // Position - 0x21E9 Hash - 0x199641AA ^0x388C7422
{
	if (*uParam0 == 71)
		if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(iLocal_74))
			if (!PED::_HAS_META_PED_OUTFIT_LOADED(iLocal_74))
				return 0;
		else
			func_52(uParam0);
...
BOOL func_20(var uParam0) // Position - 0x221A Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_21(var uParam0) // Position - 0x23CA Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;

	unk = Global_1415419.f_1;
	unk.f_2 = 0;
	unk.f_3 = func_12(*uParam0);

	if (Global_1415419.f_9757 != -1)
	{
		unk.f_4 = Global_1415419.f_9757;
	
		if (func_57(uParam0, &unk))
		{
			return 1;
		}
		else
...
BOOL func_22(int iParam0) // Position - 0x243E Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_23(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x248D Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_24(var uParam0) // Position - 0x24E5 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_25(var uParam0) // Position - 0x264E Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_58(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_26(var uParam0) // Position - 0x2975 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_27(var uParam0) // Position - 0x2AAC Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_28(var uParam0) // Position - 0x2BDC Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_29(var uParam0) // Position - 0x2C1B Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_30(var uParam0) // Position - 0x2C24 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_31(var uParam0) // Position - 0x2C56 Hash - 0xFB958CDA ^0xFB958CDA
{
	func_60(&uLocal_11, false);
	func_61(&uLocal_11, true);
	func_62(&uLocal_11, true);
	func_63(&uLocal_11, true);
	func_64(&uLocal_11, true);
	func_65(&uLocal_11, true);
	func_66(&uLocal_11, true);
	func_67(&uLocal_11, true);
	func_68(&uLocal_11, true);
	func_69(&uLocal_11, true);
	func_70(&uLocal_11, true);
	func_60(&uLocal_39, false);
	func_61(&uLocal_39, true);
	func_62(&uLocal_39, true);
	func_63(&uLocal_39, true);
	func_64(&uLocal_39, true);
...
int func_32(var uParam0) // Position - 0x2CDD Hash - 0xEB2B0783 ^0xCD0443B
{
	var unk;
	var unk2;

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
		PED::SET_PED_RESET_FLAG(uParam0->f_20[1 /*14*/], 42, true);

	if (!uParam0->f_469[1])
	{
		if (MISC::GET_FRAME_COUNT() % 2 == 0)
			if (func_71(uParam0->f_20[1 /*14*/], 0, &uLocal_11, &unk, 0, 0))
				uParam0->f_469[1] = 1;
		else if (func_71(uParam0->f_20[0 /*14*/], 0, &uLocal_39, &unk2, 0, 0))
			uParam0->f_469[1] = 1;
	...
	switch (iLocal_9)
	{
		case 0:
			if (*uParam0 == 71)
				if (!PED::IS_PED_READY_TO_RENDER(uParam0->f_20[0 /*14*/]))
					return 0;
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				{
					PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], false);
				
					if (*uParam0 != 71)
						PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[1 /*14*/], uParam0->f_20[2 /*14*/], false);
				
					if (*uParam0 != 71 && *uParam0 != 53 && *uParam0 != 46)
						PED::_0xED1C764997A86D5A(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/]);
				
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 146, false);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 442, true);
					func_73(&uParam0->f_20[1 /*14*/], false, true);
					func_74(&uLocal_11, uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0);
				
					if (*uParam0 == 71)
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
						{
							PED::_EQUIP_META_PED_OUTFIT(uParam0->f_20[0 /*14*/], hLocal_67);
							PED::_UPDATE_PED_VARIATION(uParam0->f_20[0 /*14*/], false, true, true, true, false);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 388, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 136, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 209, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 214, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 419, true);
							PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), uParam0->f_20[0 /*14*/], 5, 0, true);
							PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::GET_PLAYER_INDEX(), uParam0->f_20[0 /*14*/], 27, 0, true);
							PED::SET_PED_LASSO_HOGTIE_FLAG(uParam0->f_20[0 /*14*/], 0, false);
						}
					}
					else if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
					{
						func_73(&uParam0->f_20[2 /*14*/], true, true);
						PED::APPLY_PED_DAMAGE_PACK(uParam0->f_20[2 /*14*/], sLocal_71, 1f, 1f);
						TASK::TASK_CARRIABLE(uParam0->f_20[2 /*14*/], hLocal_10, uParam0->f_20[0 /*14*/], 0, 0);
						func_75(uParam0->f_20[0 /*14*/], uParam0->f_20[2 /*14*/]);
						PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 517, true);
					}
				
					if (*uParam0 != 46 && *uParam0 != 53)
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0, 0, 3f, 3f, 160, 2f, -2.5f, 1069547520, 1073741824);
				
					PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
				}
			
				WEAPON::REMOVE_ALL_PED_WEAPONS(uParam0->f_20[1 /*14*/], true, true);
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("weapon_repeater_carbine"), 999, bLocal_72, true, 0, false, 1056964608, 1065353216, 752097756, false, 0, false);
			
				if (*uParam0 == 53 || *uParam0 == 46)
					WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[1 /*14*/], joaat("WEAPON_UNARMED"), true, 0, false, false);
			
				func_74(&uLocal_11, uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0);
				func_76(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
			
				if (*uParam0 == 46 || *uParam0 == 53)
					func_77(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], true, -1, true);
			
				func_78(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 34, 1073741824);
				TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[1 /*14*/], 1f, 128, 0);
			}
		...
		case 1:
			...
			if (func_79(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				func_72(uParam0);
				func_73(&uParam0->f_20[1 /*14*/], false, true);
		...
		case 3:
			if (!func_80(&uLocal_75))
				func_81(&uLocal_75);
		
			func_82(&uLocal_75, 6f);
			break;
	}
...
int func_33(var uParam0, var uParam1) // Position - 0x315E Hash - 0xFC62DF67 ^0x72B44857
{
	func_83(uParam0, false, false, false);

	if (*uParam0 == 71)
		if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(iLocal_74))
			PED::_RELEASE_META_PED_OUTFIT_REQUEST(iLocal_74);

	return 1;
}

void func_34(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3187 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_35(int iParam0) // Position - 0x31A4 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_36(int iParam0) // Position - 0x32E0 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_37(int iParam0) // Position - 0x3419 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_38(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x34C3 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_39(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x353B Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_85(entityForwardVector, unk5);
	...
	if (func_86(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_40(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x35CA Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_41() // Position - 0x36E5 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x36F1 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	for (m = func_95(i, num); num2 > m; m = func_95(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_96(iParam0, l, k, j, num2, i, num);
	return;
}

void func_43(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3879 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
	...
	if (iParam3 != 0)
	{
		for (i = 0; i < 248; i = i + 1)
		{
			if (Global_1415419.f_19[i /*12*/].f_5 == iParam3)
			{
				if (i != iParam0)
				{
					if (func_41() > Global_32074.f_2697.f_6[i /*6*/].f_5)
						Global_32074.f_2697.f_6[i /*6*/].f_5 = func_41();
				
					func_42(&(Global_32074.f_2697.f_6[i /*6*/].f_5), 0, 0, iParam1, iParam2, 0, 0, false);
					func_10(&(Global_1415419.f_19[i /*12*/].f_11), 2);
				}
			}
		}
	}
...
BOOL func_44(int iParam0) // Position - 0x3919 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_45(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x392C Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_46(Volume volParam0, BOOL bParam1) // Position - 0x3946 Hash - 0xEA796703 ^0x695D7925
{
...
void func_47(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x39AE Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_48() // Position - 0x39DA Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_49(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x39E8 Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;

	num = joaat("a_m_m_htlroughtravellers_01");
	unk = 6;
	...
	if (bParam6)
	{
		switch (iParam0)
		{
			case 0:
			case 2:
				unk[endRange] = joaat("a_m_m_bynroughtravellers_01");
				endRange = endRange + 1;
				break;
		
			case 1:
				unk[endRange] = joaat("a_m_m_bivroughtravellers_01");
				endRange = endRange + 1;
				break;
			...
			case 9:
			case 12:
				unk[endRange] = joaat("a_m_m_htlroughtravellers_01");
				endRange = endRange + 1;
				break;
		
			case 6:
			case 7:
				unk[endRange] = joaat("a_m_m_griroughtravellers_01");
				endRange = endRange + 1;
				break;
		
			case 10:
				unk[endRange] = joaat("a_m_m_rkrroughtravellers_01");
				endRange = endRange + 1;
				break;
		
			case 11:
				unk[endRange] = joaat("a_m_m_sclroughtravellers_01");
				endRange = endRange + 1;
				break;
		}
	}
	...
	switch (iParam0)
	{
		...
		case 12:
			if (bParam1)
			{
				unk[endRange] = joaat("a_m_m_farmtravelers_cool_01");
				endRange = endRange + 1;
			}
		
			if (bParam2)
			{
				unk[endRange] = joaat("a_m_m_huntertravelers_cool_01");
				endRange = endRange + 1;
			}
		
			if (bParam3)
			{
				unk[endRange] = joaat("a_m_m_familytravelers_cool_01");
				endRange = endRange + 1;
			}
		
			if (bParam4)
			{
				unk[endRange] = joaat("a_m_m_ranchertravelers_cool_01");
				endRange = endRange + 1;
			}
		
			if (bParam5)
			{
				unk[endRange] = joaat("a_m_m_deliverytravelers_cool_01");
				endRange = endRange + 1;
			}
			break;
		...
		default:
			if (bParam1)
			{
				unk[endRange] = joaat("a_m_m_farmtravelers_warm_01");
				endRange = endRange + 1;
			}
		
			if (bParam2)
			{
				unk[endRange] = joaat("a_m_m_huntertravelers_warm_01");
				endRange = endRange + 1;
			}
		
			if (bParam3)
			{
				unk[endRange] = joaat("a_m_m_familytravelers_warm_01");
				endRange = endRange + 1;
			}
		
			if (bParam4)
			{
				unk[endRange] = joaat("a_m_m_ranchertravelers_warm_01");
				endRange = endRange + 1;
			}
		
			if (bParam5)
			{
				unk[endRange] = joaat("a_m_m_deliverytravelers_warm_01");
				endRange = endRange + 1;
			}
			break;
	}
...
BOOL func_50() // Position - 0x3BDA Hash - 0xEE877ACE ^0xCCE9C802
{
...
void func_51(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3BFB Hash - 0x960D7EB7 ^0x57019BBE
{
	uParam0->f_20[iParam1 /*14*/].f_1 = sParam2;
	uParam0->f_20[iParam1 /*14*/].f_2 = hParam3;
	uParam0->f_20[iParam1 /*14*/].f_5 = { uParam4 };
...
void func_52(var uParam0) // Position - 0x3C89 Hash - 0xA2A3D9 ^0xFA86D531
{
	if (uParam0->f_489 == 0)
	...
	switch (uParam0->f_489)
	{
		...
		default:
			hLocal_67 = 1175090374;
			break;
	}

	iLocal_74 = PED::_REQUEST_META_PED_OUTFIT(hLocal_70, hLocal_67);
	return;
}

BOOL func_53(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D04 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_54(int iParam0) // Position - 0x3F08 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_55(int iParam0, int iParam1) // Position - 0x3F1C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_56() // Position - 0x3F2B Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_84() != -1;
}

BOOL func_57(var uParam0, Any* panParam1) // Position - 0x3F46 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_58(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3FA5 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_102(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_59(Ped pedParam0) // Position - 0x3FE7 Hash - 0x9450C6D2 ^0x59E1F748
{
	Hash entityModel;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4017 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x4093 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
		func_10(&(uParam0->f_1), 256);
	else
		func_108(&(uParam0->f_1), 256);

	return;
}

void func_62(var uParam0, BOOL bParam1) // Position - 0x40B9 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
		func_10(&(uParam0->f_1), 4);
	else
		func_108(&(uParam0->f_1), 4);

	return;
}

void func_63(var uParam0, BOOL bParam1) // Position - 0x40DB Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
		func_10(&(uParam0->f_1), 2);
	else
		func_108(&(uParam0->f_1), 2);

	return;
}

void func_64(var uParam0, BOOL bParam1) // Position - 0x40FD Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
		func_10(&(uParam0->f_1), 1);
	else
		func_108(&(uParam0->f_1), 1);

	return;
}

void func_65(var uParam0, BOOL bParam1) // Position - 0x411F Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
		func_10(&(uParam0->f_1), 16);
	else
		func_108(&(uParam0->f_1), 16);

	return;
}

void func_66(var uParam0, BOOL bParam1) // Position - 0x4143 Hash - 0x97140DD8 ^0xA3B87048
{
	if (bParam1)
		func_10(&(uParam0->f_1), 1024);
	else
		func_108(&(uParam0->f_1), 1024);

	return;
}

void func_67(var uParam0, BOOL bParam1) // Position - 0x4169 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
		func_10(&(uParam0->f_1), 8);
	else
		func_108(&(uParam0->f_1), 8);

	return;
}

void func_68(int iParam0, BOOL bParam1) // Position - 0x418D Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_108(iParam0, 32);
	else
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x41AD Hash - 0x97140DD8 ^0xBDBF7A5
{
	if (bParam1)
		func_10(&(uParam0->f_1), 2048);
	else
		func_108(&(uParam0->f_1), 2048);

	return;
}

void func_70(int iParam0, BOOL bParam1) // Position - 0x41D3 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_108(iParam0, 1048576);
	else
		func_10(iParam0, 1048576);

	return;
}

BOOL func_71(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x41F7 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_109(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		{
			if (func_110(pedParam0, iParam2))
			{
				*uParam3 = 128;
				func_111(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				if (func_112(pedParam0, iParam2))
				{
					*uParam3 = 8;
					func_111(pedParam0, iParam2, *uParam3);
					return true;
				}
				else if (func_113(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_111(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_115(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_116(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_117(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_111(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_118(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_111(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_119(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_111(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_119(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_111(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_122(iParam2, 4000))
				{
					if (func_123(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_124(iParam2, pedParam0) && func_125(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_111(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_123(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_124(iParam2, pedParam0) && func_125(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_111(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_126(pedParam0, Global_1935630.f_41))
							{
								func_127();
								*uParam3 = 2;
								func_111(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_128(iParam2, pedParam0) || iParam2->f_9 > 0 && func_129() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_130())
					{
						if (func_126(pedParam0, Global_1935630.f_42))
						{
							func_127();
							*uParam3 = 2;
							func_111(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_132(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_111(pedParam0, iParam2, *uParam3);
					return true;
...
void func_72(var uParam0) // Position - 0x4820 Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
	...
	if (!uParam0->f_469[2])
	{
		func_140(*uParam0, uParam0->f_483, false);
		uParam0->f_469[2] = 1;
	}
...
void func_73(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4869 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_74(var uParam0, Ped pedParam1, Ped pedParam2, int iParam3) // Position - 0x4891 Hash - 0xE2C49436 ^0xE2C49436
{
	func_141(uParam0, pedParam1, iParam3);
	func_142(uParam0, pedParam2, iParam3);
	return;
}

int func_75(Ped pedParam0, Entity eParam1) // Position - 0x48AD Hash - 0x58E57CF6 ^0xB21361CC
{
	...
	if (ENTITY::GET_IS_ANIMAL(eParam1) || ENTITY::_GET_IS_BIRD(eParam1))
	{
		hash = func_143(eParam1);
	
		if (!func_144(hash, 0))
			hash = func_145(eParam1);
	}
	else
	{
		hash = func_145(eParam1);
	...
	num = func_146(inventoryIdFromPed, hash, 1);
	return num;
}

int func_76(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4921 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
int func_77(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x4A18 Hash - 0x32B863AB ^0xCE62541D
{
...
void func_78(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x4A5D Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_148(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_149(pedParam0))
		if (func_150(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
			PHYSICS::_UNHITCH_HORSE(pedParam0);

	if (func_151(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0);
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_78(vehiclePedIsIn, vParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_78(mount, vParam1, fParam4, iParam5, iParam6);
			}
	...
	if (func_151(iParam5, 2))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(pedParam0))
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_151(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_151(iParam5, 32), true);
	...
	else if (func_151(iParam5, 129))
	{
		if (func_151(iParam5, 128))
			if (WATER::GET_WATER_HEIGHT_NO_WAVES(vParam1, &height))
				vParam1.f_2 = height;
	
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, vParam1, func_151(iParam5, 32), true, true);
	...
	if (isEntityAPed)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0) == Global_35 && !func_151(iParam5, 64))
		{
...
BOOL func_79(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4CDF Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_154(fParam2);
		num2 = func_155(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_156(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_80(&(uParam0->f_490)))
							func_81(&(uParam0->f_490));
					
						if (func_157(&(uParam0->f_490), fParam1))
						{
							func_158(&(uParam0->f_490));
							return true;
						}
...
BOOL func_80(var uParam0) // Position - 0x4EEA Hash - 0x5001E582 ^0x5001E582
{
	return func_159(*uParam0, 1);
}

void func_81(var uParam0) // Position - 0x4EFA Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_160(uParam0, 0f);
	return;
}

BOOL func_82(var uParam0, float fParam1) // Position - 0x4F09 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_80(uParam0))
		return false;
...
void func_83(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4F30 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_84() // Position - 0x5084 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_85(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x5092 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_86(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x50F9 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_87(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x5122 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_162(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_88(var uParam0, var uParam1, var uParam2) // Position - 0x516E Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_162(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_89(int iParam0) // Position - 0x51BD Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_90(int iParam0) // Position - 0x51E2 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_91(int iParam0) // Position - 0x51F5 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_92(int iParam0) // Position - 0x5208 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_93(int iParam0) // Position - 0x521B Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_94(int iParam0) // Position - 0x522D Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_95(int iParam0, int iParam1) // Position - 0x523F Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x52D9 Hash - 0xA65AB937 ^0xA65AB937
{
	func_164(iParam0, iParam6);
	func_165(iParam0, iParam5);
	func_166(iParam0, iParam4);
	func_167(iParam0, iParam3);
	func_168(iParam0, iParam2);
	func_169(iParam0, iParam1);
	return;
}

BOOL func_97() // Position - 0x5311 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_98(int iParam0) // Position - 0x5364 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_101(iParam0))
		return -1;

	return func_171(func_170(iParam0));
}

BOOL func_99(int iParam0) // Position - 0x5384 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_100(int iParam0, int iParam1) // Position - 0x539A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_101(int iParam0) // Position - 0x53A9 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_102(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x53DC Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_172(eptParam1))
		{
			func_173(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_175(pedParam0, false);
			flag = true;
		}
	
		func_176(pedParam0, iParam2);
	}
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x54BD Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_108(iParam0, 4);
	else
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x54DB Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_108(iParam0, 8);
	else
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x54FB Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_108(iParam0, 16);
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x5526 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_108(iParam0, 64);
	else
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x5546 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_108(iParam0, 1024);
	else
		func_10(iParam0, 1024);

	return;
}

void func_108(int iParam0, int iParam1) // Position - 0x5568 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_109(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5579 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_177(iParam2);
				...
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						if (PED::IS_PED_PLANTING_BOMB(Global_35))
							func_108(iParam0, 33554432);
					else if (!(*iParam0 & 8192 != 0))
						if (func_179(true))
							func_108(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_179(true) || *iParam0 & 8192 != 0)
					func_10(iParam0, 33554432);
			break;
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_180(iParam0))
				iParam0->f_15 = func_129();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_129() - iParam0->f_15 > 500)
			{
...
BOOL func_110(Ped pedParam0, int iParam1) // Position - 0x5744 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_182(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_183(pedParam0, pedIndexFromEntityIndex) <= func_184(iParam1))
				return true;
			break;
	}
...
void func_111(Ped pedParam0, int iParam1, int iParam2) // Position - 0x581B Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_185(iParam2, 1, 1, 1, 0))
		func_108(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_186(iParam1, true);
	func_187();
	return;
}

BOOL func_112(Ped pedParam0, int iParam1) // Position - 0x5858 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_188(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			num2 = func_189(iParam1);
		
			if (func_190(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_191(iParam1);
...
BOOL func_113(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x593F Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_192(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_189(iParam2);
	
		if (func_190(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_191(iParam2))
				{
					func_186(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_114(Ped pedParam0, int iParam1) // Position - 0x5A15 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_182(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_191(iParam1))
		{
			customDistance = func_189(iParam1);
...
BOOL func_115(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5B1E Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_193(bParam1, bParam2, bParam3);
...
BOOL func_116(int iParam0, int iParam1) // Position - 0x5C53 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_117(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5C8A Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_118(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5D91 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_195(iParam2))
	{
...
BOOL func_119(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5DFC Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_197(pedParam1, entityCoords, outCoords))
					{
						func_186(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_197(pedParam1, entityCoords, outCoords2))
					{
						func_186(iParam2, true);
						return true;
					}
...
BOOL func_120(Ped pedParam0, int iParam1) // Position - 0x5F44 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_182(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_198(Global_1935630.f_34[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false), entityCoords);
		
			if (func_59(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
			...
			if (func_199(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_200(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_201(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_121(var uParam0, int iParam1) // Position - 0x6120 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_122(int iParam0, int iParam1) // Position - 0x6198 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_123(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x61C7 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_124(int iParam0, Ped pedParam1) // Position - 0x634D Hash - 0xC9E4B71F ^0x1E432EDF
{
	int _int;
...
BOOL func_125(int iParam0, Ped pedParam1) // Position - 0x639A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_204(iParam0))
		return true;
...
BOOL func_126(Ped pedParam0, Ped pedParam1) // Position - 0x6437 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_205(pedParam0, pedParam1, true, true) < 4f)
...
void func_127() // Position - 0x6484 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_128(int iParam0, Ped pedParam1) // Position - 0x648C Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_206(vehiclePedIsUsing, pedParam1, entityCoords))
		{
			iParam0->f_9 = func_129();
			return true;
		}
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_207(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_129() // Position - 0x654D Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_130() // Position - 0x656B Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_129() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_131(int iParam0, Ped pedParam1) // Position - 0x65B8 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_208(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_209(pedParam1);
	num2 = func_210(iParam0->f_14);
...
BOOL func_132(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x66D4 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_211(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x671C Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_212(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_213(iParam1, pedParam0))
						if (func_207(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x6975 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_214(0))
		return false;
...
BOOL func_135(int iParam0, int iParam1) // Position - 0x69AE Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_136(var uParam0, int iParam1) // Position - 0x69DD Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x69F1 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_129();
	else if (func_129() - iParam1->f_4 > func_215(iParam1))
		return func_216(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_138(int iParam0, Ped pedParam1) // Position - 0x6A3E Hash - 0x3187BEA8 ^0x799AF6E0
{
...
void func_139(int iParam0, BOOL bParam1) // Position - 0x6A91 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_41();
...
void func_140(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x6B68 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_41() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_41();

	func_42(&(Global_32074.f_2697.f_6[iParam0 /*6*/].f_5), 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7, 0, 0, 0, false);
	...
	func_43(iParam0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 2, 0, 0);
	func_217(iParam0);
	func_218(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

void func_141(var uParam0, Ped pedParam1, int iParam2) // Position - 0x6C6C Hash - 0x4EE29419 ^0xE76A8FC5
{
	if (!PED::IS_PED_HUMAN(pedParam1))
		return;
...
void func_142(var uParam0, Ped pedParam1, int iParam2) // Position - 0x6CD3 Hash - 0xFA7C636A ^0x4F1A846E
{
	if (PED::IS_PED_HUMAN(pedParam1))
		return;
...
Hash func_143(Entity eParam0) // Position - 0x6D47 Hash - 0xC81C18F9 ^0xACAAEE80
{
	Ped pedIndexFromEntityIndex;
	var unk;
	var unk2;
	...
	func_219(pedIndexFromEntityIndex, &unk2, &unk3, &unk, &unk4);

	if (func_220(&num, pedIndexFromEntityIndex, unk, unk2))
	{
	}
...
BOOL func_144(Hash hParam0, int iParam1) // Position - 0x6DA3 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
Hash func_145(Entity eParam0) // Position - 0x6DBD Hash - 0x715B29E5 ^0xAF0BC29E
{
	...
	if (carriableFromEntity == 0)
	{
		...
		{
			pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(eParam0);
			carriableFromEntity = func_221(pedIndexFromEntityIndex);
		}
	}
...
int func_146(int iParam0, Hash hParam1, int iParam2) // Position - 0x6DFC Hash - 0x2E1C6AB2 ^0xB396D62
{
	var guid2;
	var guid1;

	if (!func_144(hParam1, 0))
		return 0;

	guid2 = { func_222(iParam0) };
	guid1 = { func_223(iParam0, hParam1, guid2, guid2.f_4) };

	if (INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(iParam0, &guid1, &guid2, hParam1, guid2.f_4, iParam2, 752097756))
	{
		if (func_224(hParam1, -839724752) && func_225(hParam1, 4))
			if (!func_226(42))
				func_227(hParam1);
...
BOOL func_147(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x6E80 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Ped func_148(Ped pedParam0) // Position - 0x6EA9 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_149(Ped pedParam0) // Position - 0x6EB3 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_150(Ped pedParam0) // Position - 0x6EE5 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x6F27 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_152(Ped pedParam0) // Position - 0x6F36 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_153(Ped pedParam0) // Position - 0x6F51 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_154(float fParam0) // Position - 0x6F6D Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_155(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6FB4 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_156(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x6FD2 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_228(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_157(var uParam0, float fParam1) // Position - 0x7029 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_158(var uParam0) // Position - 0x7047 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_159(int iParam0, int iParam1) // Position - 0x705D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_160(var uParam0, float fParam1) // Position - 0x706C Hash - 0x30433BAB ^0xF854D531
{
...
float func_161(var uParam0) // Position - 0x7092 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_80(uParam0))
		return uParam0->f_1;
...
BOOL func_162(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x70C7 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_163(BOOL bParam0, var uParam1, var uParam2) // Position - 0x711C Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_164(int iParam0, int iParam1) // Position - 0x7133 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_165(int iParam0, int iParam1) // Position - 0x71B9 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_166(int iParam0, int iParam1) // Position - 0x71F5 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;

	num = func_90(*iParam0);
	num2 = func_89(*iParam0);

	if (iParam1 < 1 || iParam1 > func_95(num, num2))
		return;
...
void func_167(int iParam0, int iParam1) // Position - 0x7248 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_168(int iParam0, int iParam1) // Position - 0x7283 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_169(int iParam0, int iParam1) // Position - 0x72BC Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_170(int iParam0) // Position - 0x72F4 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_171(BOOL bParam0) // Position - 0x7332 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_172(ePedType eptParam0) // Position - 0x7345 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_173(Ped pedParam0, Hash hParam1) // Position - 0x7798 Hash - 0xFC9AC4CE ^0xC2E8DFAA
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_233(pedParam0, hParam1))
		{
			if (func_234(pedParam0, hParam1))
			{
...
void func_174(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x783F Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_175(Ped pedParam0, BOOL bParam1) // Position - 0x786F Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_176(Ped pedParam0, int iParam1) // Position - 0x78B4 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_177(int iParam0) // Position - 0x78DB Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_238(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_178(int iParam0) // Position - 0x7A47 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_179(BOOL bParam0) // Position - 0x7A5A Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_239(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_180(int iParam0) // Position - 0x7A74 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_181(int iParam0) // Position - 0x7B0C Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_182(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7B33 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_210(pedParam2);
	else
		num2 = func_209(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_210(pedParam0);
	else
		num = func_209(pedParam0);

	if (num2 == num)
		if (num2 != -1)
			return true;

	if (func_55(*iParam1, 8388608))
		return true;
...
float func_183(Ped pedParam0, Ped pedParam1) // Position - 0x7C2C Hash - 0xF9959663 ^0xF9959663
{
	return func_205(pedParam0, pedParam1, true, true);
}

float func_184(int iParam0) // Position - 0x7C3E Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_185(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C4A Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_186(int iParam0, BOOL bParam1) // Position - 0x7CAF Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_108(iParam0, 134217728);
	else
		func_10(iParam0, 134217728);

	return;
}

void func_187() // Position - 0x7CD5 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_188(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7CE9 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_205(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_243(ped, 0)))
			if (func_244(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_189(int iParam0) // Position - 0x7E49 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_190(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7E55 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_191(int iParam0) // Position - 0x7EB6 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_192(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7EC2 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_243(ped, 0)))
			if (func_245(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_193(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7F84 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_194(int iParam0) // Position - 0x8024 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_195(int iParam0) // Position - 0x8030 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_196(int iParam0) // Position - 0x803C Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x8179 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_246(pedParam0, vParam4, 0.5f))
...
BOOL func_198(Ped pedParam0) // Position - 0x81BC Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_247(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8222 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8269 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x82B4 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_202(Ped pedParam0, var uParam1) // Position - 0x832D Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_203(Ped pedParam0, Ped pedParam1) // Position - 0x837A Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_249(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_204(int iParam0) // Position - 0x83C2 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_205(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x83D2 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_206(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x841A Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_207(veParam0, uParam2, true);
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8446 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_208(int iParam0) // Position - 0x846E Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_209(Ped pedParam0) // Position - 0x847A Hash - 0xA2025797 ^0x80051282
{
...
int func_210(Ped pedParam0) // Position - 0x84CE Hash - 0x5B80FC37 ^0x8C8F349D
{
...
BOOL func_211(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8538 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_205(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_205(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x86A8 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_239(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_213(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_213(iParam1, ped2))
					if (func_207(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_213(int iParam0, Ped pedParam1) // Position - 0x8796 Hash - 0x2C7403C3 ^0xF6F7CD07
{
...
BOOL func_214(int iParam0) // Position - 0x880A Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_250())
		return false;

	return func_251(Global_1347702[58 /*49*/].f_15, true);
}

int func_215(int iParam0) // Position - 0x882C Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_216(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8838 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_217(int iParam0) // Position - 0x88B3 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_44(iParam0))
	{
		...
		{
			case 1:
				func_252(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_252(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_252(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_218(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x8934 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_162(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
void func_219(Ped pedParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8A25 Hash - 0x125E1FB8 ^0x58C5F328
{
...
BOOL func_220(Any anParam0, Ped pedParam1, int iParam2, var uParam3) // Position - 0x8A9A Hash - 0xF684EE16 ^0xD8F147D7
{
	int num;
	var unk;
	BOOL flag;
...
Hash func_221(Ped pedParam0) // Position - 0x8AC3 Hash - 0xF32C828D ^0x75879223
{
	int num;
	var unk;
	var unk2;
	...
	func_219(pedParam0, &unk, &unk2, &num, &unk3);
	func_220(&num2, pedParam0, num, unk);
...
struct<5> func_222(int iParam0) // Position - 0x8B50 Hash - 0xE091DFA ^0x699D572
{
	var unk;

	unk = { func_223(iParam0, joaat("character"), func_253(), joaat("SLOTID_NONE")) };
	unk.f_4 = joaat("SLOTID_SATCHEL");
	return unk;
}

struct<4> func_223(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x8B7D Hash - 0x5F68FD81 ^0xF6C5E078
{
	var outGuid;
...
BOOL func_224(Hash hParam0, Hash hParam1) // Position - 0x8BAA Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
BOOL func_225(Hash hParam0, int iParam1) // Position - 0x8BDB Hash - 0x6D89877F ^0x75E613A5
{
	if (!func_144(hParam0, 0))
		return false;

	return INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_FLAG_ENABLED(hParam0, iParam1);
}

BOOL func_226(int iParam0) // Position - 0x8BFA Hash - 0x5FF09631 ^0xD3AB2726
{
	if (func_240() != -1)
		return false;

	return func_251(Global_1347702[iParam0 /*49*/].f_15, true);
}

void func_227(Hash hParam0) // Position - 0x8C1D Hash - 0x7B1EFD1 ^0x61F0FB99
{
	if (func_226(41))
		func_254(363, false);
	else
	...
	switch (hParam0)
	{
		case joaat("provision_fish_chain_pickerel_legendary"):
			func_255(joaat("legendary_fish_02"));
			func_256(joaat("legendary_fishing_spot_02"));
			func_257(joaat("legendary_fishing_spot_02"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_muskie_legendary"):
			func_255(joaat("legendary_fish_06"));
			func_256(joaat("legendary_fishing_spot_06"));
			func_257(joaat("legendary_fishing_spot_06"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_bluegill_legendary"):
			func_255(joaat("legendary_fish_13"));
			func_256(joaat("legendary_fishing_spot_13"));
			func_257(joaat("legendary_fishing_spot_13"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_lake_sturgeon_legendary"):
			func_255(joaat("legendary_fish_03"));
			func_256(joaat("legendary_fishing_spot_03"));
			func_257(joaat("legendary_fishing_spot_03"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_redfin_pickerel_legendary"):
			func_255(joaat("legendary_fish_08"));
			func_256(joaat("legendary_fishing_spot_08"));
			func_257(joaat("legendary_fishing_spot_08"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_steelhead_trout_legendary"):
			func_255(joaat("legendary_fish_12"));
			func_256(joaat("legendary_fishing_spot_12"));
			func_257(joaat("legendary_fishing_spot_12"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_longnose_gar_legendary"):
			func_255(joaat("legendary_fish_05"));
			func_256(joaat("legendary_fishing_spot_05"));
			func_257(joaat("legendary_fishing_spot_05"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_largemouth_bass_legendary"):
			func_255(joaat("legendary_fish_04"));
			func_256(joaat("legendary_fishing_spot_04"));
			func_257(joaat("legendary_fishing_spot_04"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_northern_pike_legendary"):
			func_255(joaat("legendary_fish_14"));
			func_256(joaat("legendary_fishing_spot_14"));
			func_257(joaat("legendary_fishing_spot_14"));
			break;
	
		case joaat("provision_fish_rock_bass_legendary"):
			func_255(joaat("legendary_fish_09"));
			func_256(joaat("legendary_fishing_spot_09"));
			func_257(joaat("legendary_fishing_spot_09"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_perch_legendary"):
			func_255(joaat("legendary_fish_07"));
			func_256(joaat("legendary_fishing_spot_07"));
			func_257(joaat("legendary_fishing_spot_07"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_bullhead_catfish_legendary"):
			func_255(joaat("legendary_fish_01"));
			func_256(joaat("legendary_fishing_spot_01"));
			func_257(joaat("legendary_fishing_spot_01"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_sockeye_salmon_legendary"):
			func_255(joaat("legendary_fish_11"));
			func_256(joaat("legendary_fishing_spot_11"));
			func_257(joaat("legendary_fishing_spot_11"));
			func_258(false, 10);
			break;
	
		case joaat("provision_fish_smallmouth_bass_legendary"):
			func_255(joaat("legendary_fish_10"));
			func_256(joaat("legendary_fishing_spot_10"));
			func_257(joaat("legendary_fishing_spot_10"));
			func_258(false, 10);
			break;
	}
...
float func_228(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x8E9C Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_229() // Position - 0x8EBA Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_230(var uParam0, int iParam1) // Position - 0x8EEC Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_231(var uParam0, int iParam1) // Position - 0x8EFD Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_232(var uParam0) // Position - 0x8F12 Hash - 0x39705408 ^0x39705408
{
	return func_159(*uParam0, 2);
}

BOOL func_233(Ped pedParam0, Hash hParam1) // Position - 0x8F22 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_234(Ped pedParam0, Hash hParam1) // Position - 0x8F50 Hash - 0x565B54F4 ^0x93E4C27C
{
	Hash _int;
...
BOOL func_235(Ped pedParam0, Hash hParam1) // Position - 0x8F9E Hash - 0x565B54F4 ^0x93E4C27C
{
	Hash _int;
	int _int2;
...
void func_236(Ped pedParam0) // Position - 0x900C Hash - 0xB38C5882 ^0x48E26025
{
...
BOOL func_237() // Position - 0x9028 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_259())
		return false;
...
void func_238(Any* panParam0, int iParam1) // Position - 0x907E Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_239(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9126 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_240() // Position - 0x91ED Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_241(int iParam0) // Position - 0x91FB Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_242(int iParam0) // Position - 0x92A3 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_243(Ped pedParam0, int iParam1) // Position - 0x9308 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_244(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x931F Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_245(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_245(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x934D Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x9397 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_247(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x93D8 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_248(Ped pedParam0) // Position - 0x9451 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_249(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x9539 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_250() // Position - 0x957B Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_240() != -1)
		return false;
...
BOOL func_251(int iParam0, BOOL bParam1) // Position - 0x95A0 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_252(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x95D1 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_261(iParam0) == 1 && bParam7)
		return;
...
struct<4> func_253() // Position - 0x965D Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
void func_254(int iParam0, BOOL bParam1) // Position - 0x9669 Hash - 0x8A4CBA15 ^0x8A4CBA15
{
	int num;
	int num2;

	func_262(iParam0, &num, &num2);

	if (!func_263(iParam0, num, num2, bParam1))
		return;
...
void func_255(Hash hParam0) // Position - 0x9696 Hash - 0x70E4913D ^0x3306E40C
{
	COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(hParam0, 1);
	return;
}

void func_256(Hash hParam0) // Position - 0x96A5 Hash - 0xB02A89A ^0x586D0DC7
{
	if (!func_265(hParam0))
		COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(hParam0, 1);
...
void func_257(Hash hParam0) // Position - 0x96BE Hash - 0x70E4913D ^0xC7621DBD
{
	COLLECTION::_COLLECTABLE_INCREMENT_NUM_TURNED_IN(hParam0, 1);
	return;
}

void func_258(BOOL bParam0, int iParam1) // Position - 0x96CD Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
BOOL func_259() // Position - 0x9713 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_260(int iParam0) // Position - 0x9744 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_101(iParam0))
		return -1;
...
int func_261(int iParam0) // Position - 0x9760 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

void func_262(int iParam0, var uParam1, var uParam2) // Position - 0x9773 Hash - 0xE3170F06 ^0xE3170F06
{
	int num;
...
BOOL func_263(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x978F Hash - 0x7B1D1D5F ^0x7B1D1D5F
{
	...
	if (Global_1898164.f_163 && !func_272(iParam0, 1) || func_273(32768))
		if (!func_272(iParam0, 262144) || !Global_1905944.f_5696)
			return false;
...
void func_264(int iParam0, int iParam1) // Position - 0x9831 Hash - 0x978E21B ^0xA1438975
{
	int address;
...
BOOL func_265(Hash hParam0) // Position - 0x9855 Hash - 0xC5BCA0B1 ^0xC3FDA847
{
	return COLLECTION::_COLLECTABLE_GET_NUM_FOUND(hParam0) > 0;
}

void func_266(Hash hParam0, int iParam1) // Position - 0x9865 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_267() // Position - 0x9878 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

int func_268(int iParam0) // Position - 0x9897 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_269(int iParam0, int iParam1) // Position - 0x98D8 Hash - 0xDD376ADC ^0x3FEE2146
{
	if (func_240() != -1)
...
BOOL func_270(int iParam0) // Position - 0x990B Hash - 0x3E25647A ^0x3E25647A
{
	if (func_240() != -1)
		if (func_272(iParam0, 4))
			return false;
	else if (func_272(iParam0, 2))
		return false;

	return true;
}

BOOL func_271(int iParam0) // Position - 0x993B Hash - 0xF83B91D5 ^0xBF549DB5
{
	int i;
	int cloudTimeAsInt;
	int num;
	...
	if (!func_272(iParam0, 65536) && !func_272(iParam0, 32768))
		return false;
	...
	for (i = 0; i < Global_40.f_7756; i = i + 1)
	{
		if (Global_40.f_7756[i /*3*/].f_2 == iParam0)
		{
			...
			if (num < 1800 && func_272(iParam0, 32768))
				return true;
		}
	}
...
BOOL func_272(int iParam0, int iParam1) // Position - 0x99E7 Hash - 0xECB143B0 ^0x9BF3D063
{
	return Global_1905944.f_22[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_273(int iParam0) // Position - 0x9A00 Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_274() // Position - 0x9A13 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1905944.f_5694;
}

int func_275(int iParam0) // Position - 0x9A22 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
