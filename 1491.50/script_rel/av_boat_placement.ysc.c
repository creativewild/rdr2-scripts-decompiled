...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0x809230C6
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x37AD8036 ^0x575912CA
{
	int randomIntInRange;

	randomIntInRange = uParam0->f_489;

	if (randomIntInRange == 0)
		randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(1, 7);

	switch (randomIntInRange)
	{
		case 1:
		default:
			iLocal_9 = joaat("pirogue");
			break;
	
		case 2:
			iLocal_9 = joaat("pirogue2");
			break;
	
		case 3:
			iLocal_9 = joaat("rowboat");
			break;
	
		case 4:
			iLocal_9 = joaat("rowboatswamp");
			break;
	
		case 5:
			iLocal_9 = joaat("canoe");
			break;
	
		case 6:
			iLocal_9 = joaat("skiff");
			break;
	}

	func_46(uParam0, "VEH_BOAT", iLocal_9, uParam1, uParam4.f_2, 0, 0, 1, 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C54 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CF4 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E0E Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FD7 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FE0 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2190 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2204 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2253 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22AB Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2414 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
	int randomIntInRange;
...
BOOL func_25(var uParam0) // Position - 0x273B Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2872 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29A2 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29E1 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x29EA Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A1C Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

int func_31(var uParam0) // Position - 0x2A25 Hash - 0x8C57133A ^0xE651EE2D
{
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
			{
				...
				VEHICLE::_0x6B53F4B811E583D2(uParam0->f_453, true);
				VEHICLE::SET_BOAT_REMAINS_ANCHORED_WHILE_PLAYER_IS_DRIVER(uParam0->f_453, true, true);
		...
		case 1:
			if (ENTITY::_IS_TRACKED_ENTITY_VISIBLE(uParam0->f_453) || func_55(Global_35, uParam0->f_453, true) < 400f)
			{
		...
		case 2:
			if (func_55(Global_35, uParam0->f_453, true) > 10000f)
				return 1;
			break;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2AD6 Hash - 0x8BC1D41F ^0x323D715E
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_453) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uParam0->f_453));

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B03 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2B20 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2C5C Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2D95 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2E3F Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x2EB7 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_58(entityForwardVector, unk5);
	...
	if (func_59(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x2F46 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3061 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x306D Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x31F5 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3295 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x32A8 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x32C2 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x332A Hash - 0x3AAEDE3B ^0x68D4DDC3
{
...
BOOL func_47(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x337E Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_71(Global_1898164.f_1[0 /*5*/]);
	
		if (func_72(num) && func_73(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_48(int iParam0) // Position - 0x3582 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_49(int iParam0, int iParam1) // Position - 0x3596 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_50() // Position - 0x35A5 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_57() != -1;
}

BOOL func_51(var uParam0, Any* panParam1) // Position - 0x35C0 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_52(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x361F Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_53(Entity eParam0) // Position - 0x3661 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
int func_54(var uParam0, var uParam1) // Position - 0x368D Hash - 0x7126C33E ^0x1B005C67
{
	int i;
...
float func_55(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x36C8 Hash - 0x867DEA0 ^0xA060BC32
{
	...
	return func_76(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

void func_56(int iParam0, BOOL bParam1) // Position - 0x371F Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
int func_57() // Position - 0x37F6 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_58(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x3804 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_59(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x386B Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_60(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3894 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_77(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_61(var uParam0, var uParam1, var uParam2) // Position - 0x38E0 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_77(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_62(int iParam0) // Position - 0x392F Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_63(int iParam0) // Position - 0x3954 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_64(int iParam0) // Position - 0x3967 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_65(int iParam0) // Position - 0x397A Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_66(int iParam0) // Position - 0x398D Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_67(int iParam0) // Position - 0x399F Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_68(int iParam0, int iParam1) // Position - 0x39B1 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_69(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3A4B Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_70() // Position - 0x3A83 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_71(int iParam0) // Position - 0x3AD6 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_74(iParam0))
		return -1;
...
BOOL func_72(int iParam0) // Position - 0x3AF6 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_73(int iParam0, int iParam1) // Position - 0x3B0C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_74(int iParam0) // Position - 0x3B1B Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_75(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3B4E Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
float func_76(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x3C2F Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_77(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x3C4D Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
var func_78(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3CA2 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_79(int iParam0, int iParam1) // Position - 0x3CB9 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_80(int iParam0, int iParam1) // Position - 0x3D3F Hash - 0x96B01D2A ^0x81E68218
{
...
void func_81(int iParam0, int iParam1) // Position - 0x3D7B Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_82(int iParam0, int iParam1) // Position - 0x3DCE Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_83(int iParam0, int iParam1) // Position - 0x3E09 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_84(int iParam0, int iParam1) // Position - 0x3E42 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_85(int iParam0) // Position - 0x3E7A Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_86(BOOL bParam0) // Position - 0x3EB8 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_87(ePedType eptParam0) // Position - 0x3ECB Hash - 0x899A1C9C ^0x899A1C9C
{
	switch (eptParam0)
	{
...
void func_88(Ped pedParam0, Hash hParam1) // Position - 0x444C Hash - 0x9C4F271E ^0x35990ACD
{
...
void func_89(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x44F3 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_90(Ped pedParam0, BOOL bParam1) // Position - 0x4523 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_91(Ped pedParam0, int iParam1) // Position - 0x4568 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
BOOL func_92(Ped pedParam0, Hash hParam1) // Position - 0x458F Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_93(Ped pedParam0, Hash hParam1) // Position - 0x45BD Hash - 0x39815046 ^0x15329F
{
	Hash _int;
...
BOOL func_94(Ped pedParam0, Hash hParam1) // Position - 0x460B Hash - 0x39815046 ^0x15329F
{
	Hash _int;
	int _int2;
...
void func_95(Ped pedParam0) // Position - 0x4679 Hash - 0xE088AE5F ^0x1805FCA0
{
