...
BOOL func_42(var uParam0) // Position - 0x1583 Hash - 0x1188DB91 ^0xBB9B3B0F
{
	*uParam0 = 5;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = joaat("p_bucktufts01x");
	uParam0->f_572[1] = joaat("p_buckscat01x");
	uParam0->f_572[2] = joaat("p_buckscat01x");
	uParam0->f_580[0] = 1;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 0;
	uParam0->f_588[0] = 4;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = joaat("a_c_buck_01");
	uParam0->f_12.f_3 = 0.65f;
	uParam0->f_671 = { -0.422618f, 0.906308f, 1.35f };
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = joaat("META_OUTFIT_ANIMAL_ALBINO_BUCK");
	return true;
}

BOOL func_43(var uParam0) // Position - 0x164B Hash - 0x90008B47 ^0xA0ACAD4E
{
	float num;
	var unk;
	var unk6;
...
int func_44(int iParam0) // Position - 0x1762 Hash - 0x7F390DDD ^0x7F390DDD
{
	int num;
...
void func_45(var uParam0) // Position - 0x1798 Hash - 0xF060930F ^0x679498F2
{
	int i;
...
BOOL func_46(var uParam0) // Position - 0x17E2 Hash - 0x7B76A2ED ^0x317722B6
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x18A7 Hash - 0x43C1809B ^0xD255F79A
{
	float scaleX;
...
BOOL func_48(var uParam0) // Position - 0x18EE Hash - 0xC25AB6F8 ^0xC25AB6F8
{
	int i;
	int j;
...
BOOL func_49(var uParam0) // Position - 0x1939 Hash - 0x10BF63DF ^0x638AC662
{
	int i;
	float radius;
	var unk;
...
void func_50(var uParam0) // Position - 0x1ED9 Hash - 0x85508A28 ^0x573D2B47
{
	float num;
	int num2;
	int i;
...
void func_51(var uParam0) // Position - 0x1F9F Hash - 0x46A37087 ^0x6FADEB49
{
	int i;
	int duration;
	int num;
...
void func_52(var uParam0) // Position - 0x2660 Hash - 0x271CC8B9 ^0x72DC5E80
{
	int taskSequenceId;
	float num;
...
int func_53(var uParam0, var uParam1) // Position - 0x2755 Hash - 0x3AAD93D4 ^0x6348F3E3
{
	int unk;
...
BOOL func_54(var uParam0) // Position - 0x2768 Hash - 0x26561433 ^0x8D630CC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		return true;
...
var func_55(BOOL bParam0, var uParam1, var uParam2) // Position - 0x279D Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_56(Hash hParam0, int iParam1) // Position - 0x27B4 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_57(Hash hParam0, int iParam1) // Position - 0x283A Hash - 0x96B01D2A ^0x81E68218
{
...
void func_58(Hash hParam0, int iParam1) // Position - 0x2876 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_59(Hash hParam0, int iParam1) // Position - 0x28C9 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_60(Hash hParam0, int iParam1) // Position - 0x2904 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_61(Hash hParam0, int iParam1) // Position - 0x293D Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_62(Hash hParam0, int iParam1) // Position - 0x2975 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_63() // Position - 0x2988 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_64() // Position - 0x29A7 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0) // Position - 0x29B5 Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

int func_66(int iParam0) // Position - 0x29CB Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_67(int iParam0) // Position - 0x2E1F Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_123(iParam0, 1);
}

int func_68(int iParam0) // Position - 0x2E2F Hash - 0xA776614E ^0xA776614E
{
	if (!func_65(iParam0))
		return -1;
...
BOOL func_69(int iParam0) // Position - 0x3275 Hash - 0x14DDF3C9 ^0xAD14D790
{
...
BOOL func_70(int iParam0) // Position - 0x32BE Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_125(iParam0))
		return false;
...
Vector3 func_71(int iParam0) // Position - 0x32DF Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_65(iParam0))
		return 0f, 0f, 0f;
...
float func_72(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3B06 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_73(int iParam0) // Position - 0x3B2E Hash - 0x23547602 ^0x23547602
{
	switch (iParam0)
	{
		case 0:
...
int func_74(int iParam0, var uParam1) // Position - 0x3C25 Hash - 0x4931B454 ^0x88362C28
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3D86 Hash - 0x49B3EF5C ^0x9505D01C
{
	var data;
	int size;
	int collectionId;
...
int func_76(Hash hParam0, int iParam1) // Position - 0x3E39 Hash - 0x3B4883DD ^0xBE4A62CA
{
	var unk;
	var guid;
...
BOOL func_77(Hash hParam0, int iParam1) // Position - 0x3E94 Hash - 0xD7B4F3C5 ^0x943C8C22
{
	var unk;
	int num;
	int num2;
...
BOOL func_78(Hash hParam0, int iParam1, int iParam2) // Position - 0x3EF2 Hash - 0xC758F57F ^0x801747D0
{
	int num;
	var unk;
	var unk6;
...
void func_79(var uParam0, int iParam1) // Position - 0x3F69 Hash - 0xF55E891F ^0xF55E891F
{
	func_140(uParam0, iParam1);
	return;
}

int func_80(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F79 Hash - 0xB04D1B6E ^0xB04D1B6E
{
	switch (hParam0)
	{
...
{
	return func_204("ATZ_INS_EXC_BK");
}

Vector3 func_161() // Position - 0x78E0 Hash - 0x1DA0618A ^0xAC40CBAA
{
	return func_204("ATZ_INS_FUR_BK");
}
...
{
	return func_204("ATZ_INS_TRB_BU");
}
...
float func_169(int iParam0, int iParam1) // Position - 0x79A5 Hash - 0xC4503ABD ^0xC4503ABD
{
	switch (iParam0)
	{
		case 0:
...
void func_170(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7AC2 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
Hash func_171() // Position - 0x7BA3 Hash - 0x9F572D68 ^0x6729D1DC
{
	return 990575630;
}

BOOL func_172(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7BB0 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_173(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7BD9 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_174(Ped pedParam0) // Position - 0x7BF7 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_212(pedParam0, 4) || func_212(pedParam0, 5);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x7C13 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_177(int iParam0, int iParam1) // Position - 0x7EDA Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x7F0D Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x7F65 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_180(int iParam0, int iParam1) // Position - 0x7F8E Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
Any func_181(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7FB6 Hash - 0xDFB996B4 ^0xC287A71C
{
	Any any;
...
void func_182(var uParam0) // Position - 0x7FFD Hash - 0xC6A5F393 ^0x3F787E83
{
	int i;
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0x895E Hash - 0x24E72BF3 ^0x24E72BF3
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -2548.9146f, -17.2721f, 170.488f;
			
				case 1:
					return -2510.8665f, 3.0647f, 175.7746f;
			
				case 2:
					return -2516.7395f, 72.1964f, 174.3078f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return -2588.6392f, 109.9716f, 163.9202f;
			
				case 1:
					return -2636.783f, 67.0903f, 161.4891f;
			
				case 2:
					return -2653.4834f, 18.0837f, 160.3569f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return -2560.9187f, 88.8312f, 172.3058f;
			
				case 1:
					return -2630.4011f, 4.9574f, 159.2041f;
			
				case 2:
					return -2612.7913f, 34.4457f, 161.8282f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return -2592.408f, 33.2914f, 164.9132f;
			
				case 1:
					return -2580.0273f, 0.224f, 162.049f;
			
				case 2:
					return -2597.761f, 85.3775f, 165.7993f;
			}
			break;
	}
...
void func_208(Ped pedParam0, Hash hParam1) // Position - 0x8FBF Hash - 0xEA1C858E ^0xBBF5A2A3
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x970B Hash - 0xA54F3032 ^0xFFD4678D
{
	Hash _int;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x975C Hash - 0xA54F3032 ^0xFFD4678D
{
	Hash _int;
	int _int2;
...
void func_241(Ped pedParam0) // Position - 0x97CE Hash - 0x446F1BDD ^0xF31759D8
{
