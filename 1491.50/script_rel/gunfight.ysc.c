...
BOOL func_15(int iParam0) // Position - 0x7EA Hash - 0xC12ECF0C ^0x31D178C7
{
	return func_48(&uLocal_14, 256, &uLocal_14, func_46(), 0, func_47(), false, 0, false);
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x809 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}
...
BOOL func_18(int iParam0) // Position - 0x82A Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_49(iParam0, -1, -1, false);
}

void func_19(int iParam0, BOOL bParam1) // Position - 0x83B Hash - 0x1F53BD85 ^0xA70B55E5
{
...
void func_21(int iParam0) // Position - 0x88C Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9CE Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x9DA Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}
...
void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x9F6 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}
...
void func_34(int iParam0, var uParam1) // Position - 0xA79 Hash - 0x71931A41 ^0x38641BC4
{
	iParam0 = iParam0;
...
void func_35(int iParam0) // Position - 0xA8D Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_53(iParam0))
		return;
...
BOOL func_38(int iParam0) // Position - 0xACF Hash - 0x12878ED6 ^0x12878ED6
{
	iParam0 = iParam0;
	return false;
}

void func_39(var uParam0, int iParam1) // Position - 0xADC Hash - 0x8A7E7334 ^0x9F0B10C1
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_40(int iParam0) // Position - 0xC69 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}
...
BOOL func_43(int iParam0) // Position - 0xD3D Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_53(iParam0))
		return false;
...
int func_46() // Position - 0xD8C Hash - 0x3ECCD4F6 ^0x3ECCD4F6
{
	return 53;
}
...
BOOL func_49(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF74 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_53(int iParam0) // Position - 0x10A5 Hash - 0x7AB6E77F ^0x7AB6E77F
{
...
BOOL func_59(int iParam0) // Position - 0x112C Hash - 0x97598EC0 ^0xADF7FB13
{
	if (!func_53(iParam0))
		return false;
...
BOOL func_60(int iParam0, int iParam1) // Position - 0x116C Hash - 0xA98B69C6 ^0xAD9FDA10
{
...
void func_62(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11A7 Hash - 0xC6F251A1 ^0x9A1E59AF
{
	BOOL flag;
	const char* str;
	char* str2;
...
int func_69() // Position - 0x1BF7 Hash - 0xC5B83CF5 ^0xD520990E
{
...
void func_73(int iParam0, BOOL bParam1) // Position - 0x1C7D Hash - 0x2B17ED40 ^0x23FC9AA5
{
	if (Global_1572887.f_12 == -1)
	{
...
void func_74(int iParam0) // Position - 0x1CD6 Hash - 0x9305378B ^0x9305378B
{
	func_129(&uLocal_14);
	return;
}
...
void func_77(int iParam0) // Position - 0x1D48 Hash - 0x315657D9 ^0xE44E20F6
{
	int num;
	int i;
...
BOOL func_78(int iParam0, BOOL bParam1) // Position - 0x1D98 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_79(int iParam0, BOOL bParam1) // Position - 0x1E4E Hash - 0x34A2E44 ^0x39A823C1
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_93(int iParam0) // Position - 0x2994 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_53(iParam0))
		return false;
...
BOOL func_94(int iParam0) // Position - 0x29B5 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_53(iParam0))
		return false;
...
BOOL func_95(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2A08 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_100(int iParam0) // Position - 0x3223 Hash - 0x43A4311 ^0x43A4311
{
...
char* func_107(int iParam0) // Position - 0x3F62 Hash - 0x21CE226B ^0x12E84085
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_117(int iParam0) // Position - 0x40FE Hash - 0xEC19E423 ^0x3F24553E
{
	int num;
...
BOOL func_161(int iParam0) // Position - 0x4E62 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
