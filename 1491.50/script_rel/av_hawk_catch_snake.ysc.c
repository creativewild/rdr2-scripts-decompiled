...
void main() // Position - 0x0 Hash - 0x89F51C78 ^0x89F51C78
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	sLocal_37 = "script_amb@animal@HAWK_CATCH_SNAKE";
	sLocal_38 = "hawk_exit_a";
	sLocal_39 = "snake_exit_a";
	uLocal_40 = { 0f, 0f, 0f };
	uLocal_43 = { 0f, 0f, 0f };
	iLocal_46 = joaat("a_c_hawk_01");
	iLocal_47 = joaat("a_c_snake_01");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_1(var uParam0) // Position - 0x5A4 Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x5B2 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x648 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9EF Hash - 0x4DA9BC8C ^0xEC0C2DFD
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0xA09 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA20 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xADE Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB08 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC59 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC6E Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD12 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AC3 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B29 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BE3 Hash - 0x18566389 ^0x18566389
{
	char* str;
	...
	switch (*uParam0)
	{
		case 174:
			...
			sLocal_38 = "hawk_exit_a";
			sLocal_39 = "snake_exit_a";
			func_46(uParam0, "HAWK_CATCH_SNAKE", "script@ambient@animal@HAWK_CATCH_SNAKE@action", uParam1, uParam4);
			break;
	
		case 175:
			str = "SQUIRREL";
			iLocal_47 = joaat("a_c_squirrel_01");
			sLocal_37 = "script_amb@animal@HAWK_CATCH_SQUIRREL";
			sLocal_38 = "hawk_exit_a";
			sLocal_39 = "squirrel_exit_a";
			func_46(uParam0, "HAWK_CATCH_SQUIRREL", "script@ambient@animal@HAWK_CATCH_SQUIRREL@action", uParam1, uParam4);
			break;
	
		case 177:
			str = "SNAKE";
			sLocal_37 = "script_amb@animal@HAWK_VS_SNAKE";
			sLocal_38 = "hawk_exit";
			sLocal_39 = "snake_exit";
			func_46(uParam0, "HAWK_VS_SNAKE", "script@ambient@animal@HAWK_VS_SNAKE@action", uParam1, uParam4);
			break;
	}

	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "HAWK", iLocal_46, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 1, str, iLocal_47, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1CD6 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D76 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E90 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2059 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2062 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2212 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2286 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22D5 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x232D Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2496 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27BD Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28F4 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A24 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A63 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A6C Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A9E Hash - 0x2DC81C53 ^0x2DC81C53
{
...
int func_31(var uParam0) // Position - 0x2AC3 Hash - 0x67B0AB47 ^0x58C174A8
{
	if (!uParam0->f_469[0])
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			if (*uParam0 == 177)
				if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], -912283728))
					STREAMING::_0x5288B7F0690F7C1F(uParam0->f_20[0 /*14*/]);
			else
				STREAMING::_0x5288B7F0690F7C1F(uParam0->f_20[0 /*14*/]);
	
		if (!bLocal_51 == true)
			if (func_60(uParam0, &uLocal_9, false) || func_61(uParam0->f_20[0 /*14*/], Global_35, true) < 225f || func_62(Global_35, uParam0->f_483, true) < 100f)
				bLocal_51 = true;
	
		if (bLocal_51)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				if (!func_63(&uLocal_48))
					func_64(&uLocal_48);
				...
				if (!uParam0->f_469[6])
				{
					func_66(*uParam0, uParam0->f_483, true);
					uParam0->f_469[6] = 1;
				}
	...
	if (!uParam0->f_469[0] && !bLocal_51)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 0.75f, 1116471296, 4, joaat("Action"), true))
				{
					func_66(*uParam0, uParam0->f_483, true);
					uParam0->f_469[6] = 1;
				}
			...
			if (!uParam0->f_469[4])
			{
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
					{
						...
						ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 38142), uLocal_40, uLocal_43, true, false, false, false, 2, true, true, false);
						TASK::TASK_PLAY_ANIM(uParam0->f_20[1 /*14*/], sLocal_37, sLocal_39, 8f, -1056964608, -1, 1, 0, false, 0, false, 0, false);
						TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_37, sLocal_38, 8f, -1056964608, -1, 65553, 0, false, 0, false, "LegsOnlyBird_filter", false);
						uParam0->f_469[4] = 1;
						return 1;
					}
				}
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 1688442774))
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
						{
							...
							func_72(&uParam0->f_20[0 /*14*/], true, true);
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2E73 Hash - 0xFBD382D6 ^0xDE753D8A
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	if (!bParam1)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
				if (uParam0->f_469[4] && !uParam0->f_469[5] && func_61(uParam0->f_20[i /*14*/], Global_35, true) < 22500f)
					return 0;
		}
	}
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F7B Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F98 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x30D4 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x320D Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x32B7 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x332F Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x33BE Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x34D9 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x34E5 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x366D Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x370D Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3720 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x373A Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x37A2 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x37CE Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37FF Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x388D Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3A91 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3AA5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3AB4 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_75() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3ACF Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3B2E Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3B70 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3B9C Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3C18 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3C3A Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3C5C Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_60(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C80 Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_61(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3CDA Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_62(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3D31 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_103(entityCoords, vParam1);
}

BOOL func_63(var uParam0) // Position - 0x3D81 Hash - 0x5001E582 ^0x5001E582
{
	return func_104(*uParam0, 1);
}

void func_64(var uParam0) // Position - 0x3D91 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_105(uParam0, 0f);
	return;
}

void func_65(var uParam0) // Position - 0x3DA0 Hash - 0x5F88D024 ^0x5F88D024
{
	if (!uParam0->f_469[7])
	{
...
void func_66(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3DC5 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_67(var uParam0) // Position - 0x3EC9 Hash - 0x700D2E91 ^0xF0DC550E
{
	int taskSequenceId;
...
void func_68(var uParam0) // Position - 0x3F51 Hash - 0xFD3BBB4B ^0x432288EC
{
	Hash motionStateHash;
	...
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], 279791244))
		{
		...
		else
		{
			...
			PED::FORCE_PED_MOTION_STATE(uParam0->f_20[1 /*14*/], motionStateHash, true, 0, false);
...
BOOL func_69(var uParam0, float fParam1) // Position - 0x3FF3 Hash - 0x9F570DDB ^0x9F570DDB
{
	if (!func_63(uParam0))
		return false;

	if (func_109(uParam0) > fParam1)
		return true;

	return false;
}

BOOL func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x401B Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_61(Global_35, uParam0->f_20[i /*14*/], true);
...
BOOL func_71(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4226 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_112(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_61(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_63(&(uParam0->f_490)))
		...
		if (func_63(&(uParam0->f_490)) && !func_117(&(uParam0->f_490)))
...
void func_72(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x434F Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_73(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4377 Hash - 0xC26AC0FE ^0xFF80BBA5
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (bParam1)
...
void func_74(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x43B3 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_75() // Position - 0x4507 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_76(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4515 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x457C Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x45A5 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_79(var uParam0, var uParam1, var uParam2) // Position - 0x45F1 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_80(int iParam0) // Position - 0x4640 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_81(int iParam0) // Position - 0x4665 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_82(int iParam0) // Position - 0x4678 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_83(int iParam0) // Position - 0x468B Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_84(int iParam0) // Position - 0x469E Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_85(int iParam0) // Position - 0x46B0 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_86(int iParam0, int iParam1) // Position - 0x46C2 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x475C Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_88() // Position - 0x4794 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_89(int iParam0) // Position - 0x47E7 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_92(iParam0))
		return -1;
...
BOOL func_90(int iParam0) // Position - 0x4807 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_91(int iParam0, int iParam1) // Position - 0x481D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(int iParam0) // Position - 0x482C Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_93(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x485F Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4940 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_101(iParam0, 4);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x495E Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_101(iParam0, 8);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x497E Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_101(iParam0, 16);
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x49A9 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_101(iParam0, 32);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x49C9 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_101(iParam0, 64);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x49E9 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4A0B Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_101(int iParam0, int iParam1) // Position - 0x4A2F Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4A40 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5069 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x5087 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_105(var uParam0, float fParam1) // Position - 0x5096 Hash - 0x30433BAB ^0xF854D531
{
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x50BC Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_107(int iParam0) // Position - 0x5193 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5214 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_109(var uParam0) // Position - 0x5305 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_63(uParam0))
		return uParam0->f_1;
...
BOOL func_110(Ped pedParam0) // Position - 0x533A Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_111(Ped pedParam0) // Position - 0x5355 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_112(int iParam0) // Position - 0x5371 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_113(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x53B8 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_114(var uParam0, float fParam1) // Position - 0x53D6 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_115(var uParam0) // Position - 0x53F4 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_116(var uParam0, BOOL bParam1) // Position - 0x540A Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_117(var uParam0) // Position - 0x542A Hash - 0x39705408 ^0x39705408
{
	return func_104(*uParam0, 2);
}

void func_118(var uParam0) // Position - 0x543A Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_63(uParam0);
...
void func_119(var uParam0) // Position - 0x546E Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_63(uParam0);
...
BOOL func_120(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x549E Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_121(BOOL bParam0, var uParam1, var uParam2) // Position - 0x54F3 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_122(int iParam0, int iParam1) // Position - 0x550A Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_123(int iParam0, int iParam1) // Position - 0x5590 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_124(int iParam0, int iParam1) // Position - 0x55CC Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_125(int iParam0, int iParam1) // Position - 0x561F Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_126(int iParam0, int iParam1) // Position - 0x565A Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_127(int iParam0, int iParam1) // Position - 0x5693 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_128(int iParam0) // Position - 0x56CB Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_129(BOOL bParam0) // Position - 0x5709 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_130(ePedType eptParam0) // Position - 0x571C Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_131(Ped pedParam0, Hash hParam1) // Position - 0x5B6F Hash - 0xEA1C858E ^0x2765490F
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_132(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5C19 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_133(Ped pedParam0, BOOL bParam1) // Position - 0x5C49 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_134(Ped pedParam0, int iParam1) // Position - 0x5C8E Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_135(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5CB5 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_173(iParam2);
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x5E80 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_137(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5F58 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5F95 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_139(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x607C Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x6152 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_141(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x625B Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x6390 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x63C7 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x64CE Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6539 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_146(Ped pedParam0, int iParam1) // Position - 0x6681 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_147(var uParam0, int iParam1) // Position - 0x6861 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x68D9 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_149(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6908 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_150(int iParam0, Ped pedParam1) // Position - 0x6A8E Hash - 0x42A83B1F ^0x218ECEFE
{
	int _int;
...
BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x6ADE Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_200(iParam0))
		return true;
...
BOOL func_152(Ped pedParam0, Ped pedParam1) // Position - 0x6B7B Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_153() // Position - 0x6BC8 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6BD0 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_155() // Position - 0x6C91 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_156() // Position - 0x6CAF Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6CFC Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_158(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6E18 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6E60 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x70B9 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_210(0))
		return false;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x70F2 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_162(var uParam0, int iParam1) // Position - 0x7121 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x7135 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_164(int iParam0, Ped pedParam1) // Position - 0x7182 Hash - 0x2978E171 ^0x8154A0D4
{
...
float func_165() // Position - 0x71D6 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_166(var uParam0, int iParam1) // Position - 0x7208 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_167(var uParam0, int iParam1) // Position - 0x7219 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_168(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x722E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x72BA Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x72E8 Hash - 0xA54F3032 ^0x4A6DDA26
{
	Hash _int;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x7339 Hash - 0xA54F3032 ^0x4A6DDA26
{
	Hash _int;
	int _int2;
...
void func_172(Ped pedParam0) // Position - 0x73AB Hash - 0x446F1BDD ^0xDB5EB16F
{
...
void func_173(int iParam0) // Position - 0x73C9 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_174(int iParam0) // Position - 0x7535 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_175(BOOL bParam0) // Position - 0x7548 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_176(int iParam0) // Position - 0x7562 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_177(int iParam0) // Position - 0x75FC Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_178(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7623 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_179(Ped pedParam0, Ped pedParam1) // Position - 0x771C Hash - 0xF9959663 ^0xF9959663
{
	return func_201(pedParam0, pedParam1, true, true);
}

float func_180(int iParam0) // Position - 0x772E Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_181(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x773A Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_182(int iParam0, BOOL bParam1) // Position - 0x779F Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_183() // Position - 0x77C5 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_184(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x77D9 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_185(int iParam0) // Position - 0x7939 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_186(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7945 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_187(int iParam0) // Position - 0x79A6 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_188(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x79B2 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_189(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7A74 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_190(int iParam0) // Position - 0x7B12 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_191(int iParam0) // Position - 0x7B1E Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_192(int iParam0) // Position - 0x7B2A Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_193(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7C67 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_194(Ped pedParam0) // Position - 0x7CAA Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D10 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D57 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7DA2 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_198(Ped pedParam0, var uParam1) // Position - 0x7E1B Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_199(Ped pedParam0, Ped pedParam1) // Position - 0x7E68 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_200(int iParam0) // Position - 0x7EB0 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_201(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7EC0 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_202(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7F08 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7F34 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_204(int iParam0) // Position - 0x7F5C Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_205(Ped pedParam0) // Position - 0x7F68 Hash - 0xEB445B10 ^0xF112EA0F
{
...
int func_206(Ped pedParam0) // Position - 0x7FC0 Hash - 0x18700CD1 ^0xA414B38F
{
...
BOOL func_207(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8031 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x81A1 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_209(int iParam0, Ped pedParam1) // Position - 0x828F Hash - 0x27FC2906 ^0x6213BDE4
{
...
BOOL func_210(int iParam0) // Position - 0x8305 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_227())
		return false;
...
int func_211(int iParam0) // Position - 0x8327 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8333 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_213(int iParam0) // Position - 0x83AE Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_214() // Position - 0x83C1 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_215() // Position - 0x83CF Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_229())
		return false;
...
void func_216(Any* panParam0, int iParam1) // Position - 0x8425 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_217(BOOL bParam0, var uParam1, var uParam2) // Position - 0x84D0 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_218(int iParam0) // Position - 0x8597 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_219(int iParam0) // Position - 0x863F Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_220(Ped pedParam0, int iParam1) // Position - 0x86A4 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_221(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x86BB Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_222(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x86E9 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_223(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8733 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_224(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8774 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_225(Ped pedParam0) // Position - 0x87ED Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_226(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x88D5 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_227() // Position - 0x8917 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_214() != -1)
		return false;
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x893C Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_229() // Position - 0x896D Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_230(int iParam0) // Position - 0x899E Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_92(iParam0))
		return -1;
...
int func_231(int iParam0) // Position - 0x89BA Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_232(int iParam0) // Position - 0x89FB Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
