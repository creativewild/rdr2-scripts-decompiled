...
void main() // Position - 0x0 Hash - 0xA112627F ^0x2E5A50EA
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0xF114E4CE
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0xA9F258EA ^0xA9F258EA
{
	func_46(uParam0, "BEAVER_SWIM_WITH_BRANCH", "script@ambient@animal@beaver_swim_with_branch@action", uParam1, uParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "beaver", iLocal_9, uParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 0, "STICK", joaat("p_stickfirepoker01x"), uParam1, uParam4.f_2, 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C1F Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CBF Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DD9 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FA2 Hash - 0x688AAFEC ^0x97AFA27A
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE") || !STREAMING::HAS_ANIM_DICT_LOADED("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE@BASE"))
		return 0;

	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FC8 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2178 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x21EC Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x223B Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2293 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x23FC Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2723 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x285A Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x298A Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29C9 Hash - 0xB07BB1F6 ^0x93149D2F
{
...
void func_29(var uParam0) // Position - 0x29EE Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A20 Hash - 0x773634A6 ^0x4CD30E58
{
	STREAMING::REQUEST_ANIM_DICT("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE");
	STREAMING::REQUEST_ANIM_DICT("CREATURES_MAMMAL@BEAVER@SWIMMING@SURFACE@BASE");
...
int func_31(var uParam0) // Position - 0x2A68 Hash - 0x2D1A565D ^0xF4A65E1C
{
	Vector3 vector;
	Vector3 vector2;
	...
	{
		if (!bLocal_38 == true)
			if (func_65(uParam0, &uLocal_10, true) || func_66(Global_35, uParam0->f_20[0 /*14*/], true) <= 64f)
				bLocal_38 = true;
	...
	if (uParam0->f_469[0])
	{
		if (func_72(&uLocal_39, 2f))
		{
			PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 133, false);
			return 1;
		}
	}
	...
	if (!uParam0->f_469[0])
	{
		if (!uParam0->f_469[1])
		{
			if (!ENTITY::IS_ENTITY_DEAD(Global_35) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_372[0 /*8*/]))
			{
				if (func_73(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							...
							{
								func_70(uParam0);
								ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_372[0 /*8*/], uParam0->f_20[0 /*14*/], false);
								ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_372[0 /*8*/], false);
								ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_372[0 /*8*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 61276), vector, vector2, true, false, false, false, 2, true, true, false);
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[4])
			{
				if (func_74(uParam0, 0.5f, 40f, 4, joaat("Action"), true))
				{
					func_69(*uParam0, uParam0->f_483, false);
					uParam0->f_469[4] = 1;
				}
			...
			if (!uParam0->f_469[3])
			{
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::IS_ANIM_SCENE_FINISHED(uParam0->f_3.f_1, false) || ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(uParam0->f_3.f_1))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
...
int func_32(var uParam0, var uParam1) // Position - 0x2D5E Hash - 0x8E17BD70 ^0x93B6CCBC
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 133, false);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D8D Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DAA Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2EE6 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x301F Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30C9 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3141 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31D0 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x32EB Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x32F7 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x347F Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x351F Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3532 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x354C Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35B4 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x35E0 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3611 Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8) // Position - 0x369F Hash - 0xD25940D1 ^0x34109BE0
{
	uParam0->f_372[iParam1 /*8*/].f_1 = sParam2;
	uParam0->f_372[iParam1 /*8*/].f_2 = iParam3;
	uParam0->f_372[iParam1 /*8*/].f_3 = { uParam4 };
	uParam0->f_372[iParam1 /*8*/].f_6 = uParam7;
	uParam0->f_372[iParam1 /*8*/].f_7 = iParam8;
	uParam0->f_371 = uParam0->f_371 + 1;
	return;
}

BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x36F8 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x38FC Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3910 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x391F Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_77() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x393A Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3999 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x39DB Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A07 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3A2F Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3AAB Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3AD1 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3AF3 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3B15 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3B37 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_102(iParam0, 4);
	else
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3B55 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_65(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3B79 Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_66(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x3BD3 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_67(var uParam0) // Position - 0x3C2A Hash - 0x5001E582 ^0x5001E582
{
	return func_105(*uParam0, 1);
}

void func_68(var uParam0) // Position - 0x3C3A Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_106(uParam0, 0f);
	return;
}

void func_69(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3C49 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_70(var uParam0) // Position - 0x3D4D Hash - 0xCF07921A ^0xCF07921A
{
	if (!uParam0->f_469[5])
	{
...
void func_71(var uParam0) // Position - 0x3D72 Hash - 0x9A7935DF ^0xD4440321
{
	int taskSequenceId;

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 133, true);
		ENTITY::DETACH_ENTITY(uParam0->f_372[0 /*8*/], true, true);
...
BOOL func_72(var uParam0, float fParam1) // Position - 0x3DE3 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_67(uParam0))
		return false;
...
BOOL func_73(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E0A Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_74(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4017 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_67(&(uParam0->f_490)) && !func_118(&(uParam0->f_490)))
...
void func_75(Ped* ppedParam0) // Position - 0x4140 Hash - 0xC4826352 ^0x8AD0FF3C
{
...
void func_76(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x419F Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_77() // Position - 0x42F3 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_78(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4301 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4368 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4391 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_81(var uParam0, var uParam1, var uParam2) // Position - 0x43DD Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_82(int iParam0) // Position - 0x442C Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_83(int iParam0) // Position - 0x4451 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_84(int iParam0) // Position - 0x4464 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_85(int iParam0) // Position - 0x4477 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_86(int iParam0) // Position - 0x448A Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_87(int iParam0) // Position - 0x449C Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_88(int iParam0, int iParam1) // Position - 0x44AE Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4548 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_90() // Position - 0x4580 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_91(int iParam0) // Position - 0x45D3 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_94(iParam0))
		return -1;
...
BOOL func_92(int iParam0) // Position - 0x45F3 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_93(int iParam0, int iParam1) // Position - 0x4609 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_94(int iParam0) // Position - 0x4618 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_95(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x464B Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x472C Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_102(iParam0, 8);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x474C Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_102(iParam0, 16);
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4777 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_102(iParam0, 32);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4797 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_102(iParam0, 64);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x47B7 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x47D9 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_102(int iParam0, int iParam1) // Position - 0x47FD Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_103(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x480E Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_104(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4E37 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x4E55 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_106(var uParam0, float fParam1) // Position - 0x4E64 Hash - 0x30433BAB ^0xF854D531
{
...
void func_107(int iParam0) // Position - 0x4E8A Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4F0B Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x4FFC Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
float func_110(var uParam0) // Position - 0x50D3 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_67(uParam0))
		return uParam0->f_1;
...
BOOL func_111(Ped pedParam0) // Position - 0x5108 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_112(Ped pedParam0) // Position - 0x5123 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_113(float fParam0) // Position - 0x513F Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_114(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5186 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_115(var uParam0, float fParam1) // Position - 0x51A4 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x51C2 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_117(var uParam0, BOOL bParam1) // Position - 0x51D8 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_118(var uParam0) // Position - 0x51F8 Hash - 0x39705408 ^0x39705408
{
	return func_105(*uParam0, 2);
}

void func_119(var uParam0) // Position - 0x5208 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_67(uParam0);
...
void func_120(var uParam0) // Position - 0x523C Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_67(uParam0);
...
BOOL func_121(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x526C Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_122(BOOL bParam0, var uParam1, var uParam2) // Position - 0x52C1 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_123(int iParam0, int iParam1) // Position - 0x52D8 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_124(int iParam0, int iParam1) // Position - 0x535E Hash - 0x96B01D2A ^0x81E68218
{
...
void func_125(int iParam0, int iParam1) // Position - 0x539A Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_126(int iParam0, int iParam1) // Position - 0x53ED Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_127(int iParam0, int iParam1) // Position - 0x5428 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_128(int iParam0, int iParam1) // Position - 0x5461 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_129(int iParam0) // Position - 0x5499 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_130(BOOL bParam0) // Position - 0x54D7 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_131(ePedType eptParam0) // Position - 0x54EA Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_132(Ped pedParam0, Hash hParam1) // Position - 0x593D Hash - 0x880A43F5 ^0x7CDEA76A
{
...
void func_133(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x59E4 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_134(Ped pedParam0, BOOL bParam1) // Position - 0x5A14 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_135(Ped pedParam0, int iParam1) // Position - 0x5A59 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_136(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5A80 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_174(iParam2);
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5C4B Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_138(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5D22 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5D5F Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_140(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5E46 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x5F1C Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_142(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6025 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x615A Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6191 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6298 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6303 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_147(Ped pedParam0, int iParam1) // Position - 0x644B Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_148(var uParam0, int iParam1) // Position - 0x662B Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x66A3 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_150(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x66D2 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_151(int iParam0, Ped pedParam1) // Position - 0x6858 Hash - 0x42A83B1F ^0xEDCB269C
{
	int _int;
...
BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x68A8 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_201(iParam0))
		return true;
...
BOOL func_153(Ped pedParam0, Ped pedParam1) // Position - 0x6945 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_154() // Position - 0x6992 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x699A Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_156() // Position - 0x6A5B Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_157() // Position - 0x6A79 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6AC6 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_159(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6BE2 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6C2A Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6E83 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_211(0))
		return false;
...
BOOL func_162(int iParam0, int iParam1) // Position - 0x6EBC Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_163(var uParam0, int iParam1) // Position - 0x6EEB Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x6EFF Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_165(int iParam0, Ped pedParam1) // Position - 0x6F4C Hash - 0x7E2E3D43 ^0x3B130950
{
...
float func_166() // Position - 0x6F9F Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_167(var uParam0, int iParam1) // Position - 0x6FD1 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_168(var uParam0, int iParam1) // Position - 0x6FE2 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_169(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6FF7 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x7083 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x70B1 Hash - 0xEA5A9751 ^0xE5E8EDA6
{
	Hash _int;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x7101 Hash - 0xEA5A9751 ^0xE5E8EDA6
{
	Hash _int;
	int _int2;
...
void func_173(Ped pedParam0) // Position - 0x7171 Hash - 0xBED12D65 ^0x781CBC01
{
...
void func_174(int iParam0) // Position - 0x718E Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_175(int iParam0) // Position - 0x72FA Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_176(BOOL bParam0) // Position - 0x730D Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_177(int iParam0) // Position - 0x7327 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_178(int iParam0) // Position - 0x73C1 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_179(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x73E8 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_180(Ped pedParam0, Ped pedParam1) // Position - 0x74E1 Hash - 0xF9959663 ^0xF9959663
{
	return func_202(pedParam0, pedParam1, true, true);
}

float func_181(int iParam0) // Position - 0x74F3 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_182(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x74FF Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x7564 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_184() // Position - 0x758A Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_185(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x759E Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_186(int iParam0) // Position - 0x76FE Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x770A Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_188(int iParam0) // Position - 0x776B Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_189(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7777 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_190(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7839 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_191(int iParam0) // Position - 0x78D7 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_192(int iParam0) // Position - 0x78E3 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_193(int iParam0) // Position - 0x78EF Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7A2C Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_195(Ped pedParam0) // Position - 0x7A6F Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7AD5 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B1C Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7B67 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_199(Ped pedParam0, var uParam1) // Position - 0x7BE0 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_200(Ped pedParam0, Ped pedParam1) // Position - 0x7C2D Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_201(int iParam0) // Position - 0x7C75 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_202(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7C85 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_203(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7CCD Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7CF9 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_205(int iParam0) // Position - 0x7D21 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_206(Ped pedParam0) // Position - 0x7D2D Hash - 0xEB445B10 ^0x58A64634
{
...
int func_207(Ped pedParam0) // Position - 0x7D85 Hash - 0x6E063231 ^0x61657953
{
...
BOOL func_208(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7DF5 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7F65 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_210(int iParam0, Ped pedParam1) // Position - 0x8054 Hash - 0x27FC2906 ^0x6084CD9A
{
...
BOOL func_211(int iParam0) // Position - 0x80CA Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_228())
		return false;
...
int func_212(int iParam0) // Position - 0x80EC Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x80F8 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_214(int iParam0) // Position - 0x8173 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_215() // Position - 0x8186 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_216() // Position - 0x8194 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x81EA Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8294 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_219(int iParam0) // Position - 0x835B Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x8403 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_221(Ped pedParam0, int iParam1) // Position - 0x8468 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x847F Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_223(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x84AD Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_224(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x84F7 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8538 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_226(Ped pedParam0) // Position - 0x85B1 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_227(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8699 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_228() // Position - 0x86DB Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_215() != -1)
		return false;
...
BOOL func_229(int iParam0, BOOL bParam1) // Position - 0x8700 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_230() // Position - 0x8731 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x8762 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_94(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x877E Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_233(int iParam0) // Position - 0x87BF Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
