...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0x538C4F1B
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x554DA5DA ^0x554DA5DA
{
	Hash hash;
	int num;
	int num2;

	func_46(uParam0, "TRAVELLER_GALLOP_PAST", "", uParam1, uParam4);
	num = 1;

	switch (*uParam0)
	{
		case 37:
			iLocal_39 = func_48(func_47(), false, false, true, false, false, true);
			hash = func_49(joaat("horse_class_riding"), true);
			break;
	
		case 49:
			iLocal_39 = func_50(func_47());
			hash = joaat("a_c_donkey_01");
			num = 0;
			break;
		...
		case 61:
			switch (uParam0->f_489)
			{
				case 0:
				default:
					iLocal_39 = func_48(func_47(), true, false, true, true, true, true);
					hash = 0;
					iLocal_38 = func_51();
					func_52(uParam0, "CART", iLocal_38, uParam1, uParam4.f_2, 0, 0, 0, 0);
					break;
			
				case 1:
					iLocal_39 = joaat("a_m_m_rhdforeman_01");
					hash = 0;
					iLocal_38 = func_51();
					func_52(uParam0, "CART", iLocal_38, uParam1, uParam4.f_2, 0, 0, 0, 0);
					break;
				...
				case 2:
					...
					hash = 0;
					num2 = 1;
					iLocal_38 = func_54(func_53(), &num2);
					func_52(uParam0, "CART", iLocal_38, uParam1, uParam4.f_2, 0, 0, 0, 0);
					break;
			}
			break;
		...
		case 64:
			iLocal_39 = func_48(func_47(), true, true, true, true, false, true);
			hash = func_49(joaat("horse_class_riding"), true);
			break;
	}

	func_55(uParam0, 0, "TGPP_MAN", iLocal_39, uParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_55(uParam0, 1, "TGPP_HORSE", hash, uParam1, uParam4.f_2, 1, 1, 1, num, joaat("META_OUTFIT_DEFAULT"), 1);

	if (num2 == 2)
		func_55(uParam0, 2, "TGPP_HORSE_2", hash, uParam1, uParam4.f_2, 1, 1, 1, num, joaat("META_OUTFIT_DEFAULT"), 1);

	return;
}

Vector3 func_15(var uParam0) // Position - 0x1D68 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1E08 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1F22 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x20EB Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x20F4 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x22A4 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2318 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2367 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x23BF Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2528 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
		...
		if (uParam0->f_20[i /*14*/].f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (PED::_IS_META_PED_OUTFIT_REQUEST_VALID(uParam0->f_20[i /*14*/].f_4))
					...
					uParam0->f_20[i /*14*/] = func_61(uParam0->f_20[i /*14*/].f_2, uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, true, true, 0, true, uParam0->f_20[i /*14*/].f_11, uParam0->f_20[i /*14*/].f_9, false, false, false, false);
...
BOOL func_25(var uParam0) // Position - 0x284F Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2986 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2AB6 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2AF5 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2AFE Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B30 Hash - 0x67E68B94 ^0x67E68B94
{
	func_63(&uLocal_10, false);
...
int func_31(var uParam0) // Position - 0x2B6A Hash - 0xDFA489DD ^0xDFA489DD
{
	float num;

	if (!uParam0->f_469[1])
	{
		if (func_70(uParam0, &uLocal_10, false))
		{
			func_71(uParam0);
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				num = func_72(uParam0->f_20[0 /*14*/].f_5);
				...
				{
					func_75(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/].f_5, num, 2, 1073741824);
					func_76(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], true, -1, true);
				}
				else if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
				{
					func_75(uParam0->f_453, uParam0->f_20[0 /*14*/].f_5, num, 2, 1073741824);
					PED::SET_PED_INTO_VEHICLE(uParam0->f_20[0 /*14*/], uParam0->f_453, -1);
				}
			
				if (*uParam0 == 49 || *uParam0 == 37)
					TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[0 /*14*/], 1f, 4, 0);
				else if (*uParam0 == 61)
					TASK::TASK_VEHICLE_DRIVE_WANDER(uParam0->f_20[0 /*14*/], uParam0->f_453, MISC::GET_RANDOM_FLOAT_IN_RANGE(3f, 5f), 524311);
				else
					TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[0 /*14*/], 2.001f, 256, 0);
			
				func_77(&uParam0->f_20[0 /*14*/], false, true);
		...
		case 1:
			...
			{
				func_71(uParam0);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_20[0 /*14*/], joaat("rel_player_dislike"));
				iLocal_9 = 2;
			}
			break;
...
int func_32(var uParam0, var uParam1) // Position - 0x2D63 Hash - 0xCAFD5469 ^0x65D187BC
{
	func_79(uParam0, false, false, false);

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_453))
	{
		VEHICLE::_0xC399CC89FBA05DA0(uParam0->f_453, true);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D94 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DB1 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2EED Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3026 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30D0 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3148 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31D7 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x32F2 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x32FE Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3486 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3526 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3539 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3553 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35BB Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x35E7 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x35F5 Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
Hash func_49(int iParam0, BOOL bParam1) // Position - 0x37E7 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
int func_50(int iParam0) // Position - 0x38A1 Hash - 0xFA6B31D2 ^0x22E28C3E
{
	int num;

	num = joaat("u_m_m_riodonkeyrider_01");

	switch (iParam0)
	{
		case 10:
			num = joaat("u_m_m_rkrdonkeyrider_01");
			break;
...
int func_51() // Position - 0x38DA Hash - 0x672AC8F4 ^0x75651DEF
{
	int randomIntInRange;
...
void func_52(var uParam0, char* sParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x393D Hash - 0x3AAEDE3B ^0x68D4DDC3
{
...
int func_53() // Position - 0x3991 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

int func_54(int iParam0, var uParam1) // Position - 0x399F Hash - 0x7706794A ^0x2F5E80B5
{
	int randomIntInRange;
	...
	switch (iParam0)
	{
		case 5:
			...
			switch (randomIntInRange)
			{
				case 0:
					*uParam1 = 1;
					return joaat("buggy02");
			
				case 1:
					*uParam1 = 1;
					return joaat("buggy03");
				...
				case 9:
					*uParam1 = 2;
					return joaat("stagecoach001x");
			
				case 10:
					*uParam1 = 2;
					return joaat("stagecoach002x");
			
				case 11:
					*uParam1 = 2;
					return joaat("stagecoach006x");
...
void func_55(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3AA6 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_56(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B34 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_57(int iParam0) // Position - 0x3D38 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_58(int iParam0, int iParam1) // Position - 0x3D4C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_59() // Position - 0x3D5B Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_53() != -1;
}

BOOL func_60(var uParam0, Any* panParam1) // Position - 0x3D76 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_61(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3DD5 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_62(Ped pedParam0) // Position - 0x3E17 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3E43 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3EBF Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3EE5 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3F07 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x3F29 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
		func_9(&(uParam0->f_1), 8);
	else
		func_105(&(uParam0->f_1), 8);

	return;
}

void func_68(var uParam0, BOOL bParam1) // Position - 0x3F4D Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x3F6F Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_70(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3F93 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_71(var uParam0) // Position - 0x3FED Hash - 0xB025EB34 ^0xB025EB34
{
	if (!uParam0->f_469[3])
	{
		func_107(*uParam0, false);
		uParam0->f_469[3] = 1;
	}

	if (!uParam0->f_469[2])
	{
		func_108(*uParam0, uParam0->f_483, false);
		uParam0->f_469[2] = 1;
	}
...
float func_72(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x4038 Hash - 0x8F7EA071 ^0xF9E8D612
{
	float outHeading;
	var outPosition;
	var unk3;
	...
	if (func_110(unk3, unk6) < 0f)
		outHeading = outHeading + 180f;

	return outHeading;
}

int func_73(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x40A2 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
BOOL func_74(Ped pedParam0, int iParam1) // Position - 0x4199 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
void func_75(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x4298 Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_113(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_114(pedParam0))
		if (func_115(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
			PHYSICS::_UNHITCH_HORSE(pedParam0);

	if (func_112(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0);
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_75(vehiclePedIsIn, vParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_75(mount, vParam1, fParam4, iParam5, iParam6);
			}
	...
	if (func_112(iParam5, 2))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(pedParam0))
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_112(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_112(iParam5, 32), true);
	...
	else if (func_112(iParam5, 129))
	{
		if (func_112(iParam5, 128))
			if (WATER::GET_WATER_HEIGHT_NO_WAVES(vParam1, &height))
				vParam1.f_2 = height;
	
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, vParam1, func_112(iParam5, 32), true, true);
	...
	if (isEntityAPed)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0) == Global_35 && !func_112(iParam5, 64))
		{
...
int func_76(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x451A Hash - 0x32B863AB ^0xCE62541D
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
void func_77(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x455F Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_78(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4587 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_118(fParam2);
		num2 = func_119(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_120(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_123(&(uParam0->f_490), fParam1))
						{
...
void func_79(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4792 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
float func_80(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x48E6 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x494D Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_82(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4976 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_83(var uParam0, var uParam1, var uParam2) // Position - 0x49C2 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_84(int iParam0) // Position - 0x4A11 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_85(int iParam0) // Position - 0x4A36 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_86(int iParam0) // Position - 0x4A49 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_87(int iParam0) // Position - 0x4A5C Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_88(int iParam0) // Position - 0x4A6F Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_89(int iParam0) // Position - 0x4A81 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_90(int iParam0, int iParam1) // Position - 0x4A93 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4B2D Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_92() // Position - 0x4B65 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_93(int iParam0) // Position - 0x4BB8 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_96(iParam0))
		return -1;
...
BOOL func_94(int iParam0) // Position - 0x4BD8 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_95(int iParam0, int iParam1) // Position - 0x4BEE Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_96(int iParam0) // Position - 0x4BFD Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_97(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4C30 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4D11 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_105(iParam0, 4);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4D2F Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_105(iParam0, 8);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4D4F Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_105(iParam0, 16);
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4D7A Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_105(iParam0, 32);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4D9A Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_105(iParam0, 64);
	else
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4DBA Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x4DDC Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_105(int iParam0, int iParam1) // Position - 0x4E00 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_106(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4E11 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x543A Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5511 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
Vector3 func_109(float fParam0, var uParam1, var uParam2) // Position - 0x5615 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
float func_110(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x5654 Hash - 0x9ECDD667 ^0x170D4E4C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL func_111(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x566B Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_112(int iParam0, int iParam1) // Position - 0x5694 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

Ped func_113(Ped pedParam0) // Position - 0x56A3 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_114(Ped pedParam0) // Position - 0x56AD Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_115(Ped pedParam0) // Position - 0x56DF Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_116(Ped pedParam0) // Position - 0x5721 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_117(Ped pedParam0) // Position - 0x573C Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_118(float fParam0) // Position - 0x5758 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_119(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x579F Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_120(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x57BD Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_172(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_121(var uParam0) // Position - 0x5814 Hash - 0x5001E582 ^0x5001E582
{
	return func_173(*uParam0, 1);
}

void func_122(var uParam0) // Position - 0x5824 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_174(uParam0, 0f);
	return;
}

BOOL func_123(var uParam0, float fParam1) // Position - 0x5833 Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_175(uParam0, fParam1))
	{
		func_124(uParam0);
		return true;
	}
...
void func_124(var uParam0) // Position - 0x5851 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_125(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5867 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_126(BOOL bParam0, var uParam1, var uParam2) // Position - 0x58BC Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_127(int iParam0, int iParam1) // Position - 0x58D3 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_128(int iParam0, int iParam1) // Position - 0x5959 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_129(int iParam0, int iParam1) // Position - 0x5995 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_130(int iParam0, int iParam1) // Position - 0x59E8 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_131(int iParam0, int iParam1) // Position - 0x5A23 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_132(int iParam0, int iParam1) // Position - 0x5A5C Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_133(int iParam0) // Position - 0x5A94 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_134(BOOL bParam0) // Position - 0x5AD2 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_135(ePedType eptParam0) // Position - 0x5AE5 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_136(Ped pedParam0, Hash hParam1) // Position - 0x5F38 Hash - 0x90EFE36A ^0x1D0B7756
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_137(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5FDF Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_138(Ped pedParam0, BOOL bParam1) // Position - 0x600F Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_139(Ped pedParam0, int iParam1) // Position - 0x6054 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_140(int iParam0, BOOL bParam1, int iParam2) // Position - 0x607B Hash - 0x37D64B11 ^0xE7060A9E
{
	func_180(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_182(true))
							func_105(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_182(true) || *iParam0 & 8192 != 0)
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x6246 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_185(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_186(pedParam0, pedIndexFromEntityIndex) <= func_187(iParam1))
				return true;
			break;
	}
...
void func_142(Ped pedParam0, int iParam1, int iParam2) // Position - 0x631D Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_188(iParam2, 1, 1, 1, 0))
		func_105(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_189(iParam1, true);
	func_190();
	return;
}

BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x635A Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_191(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_193(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_194(iParam1);
...
BOOL func_144(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6441 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_195(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_192(iParam2);
	
		if (func_193(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_194(iParam2))
				{
					func_189(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x6517 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_185(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_194(iParam1))
		{
			customDistance = func_192(iParam1);
...
BOOL func_146(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6620 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x6755 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x678C Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_149(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6893 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_198(iParam2))
	{
...
BOOL func_150(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x68FE Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_200(pedParam1, entityCoords, outCoords))
					{
						func_189(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_200(pedParam1, entityCoords, outCoords2))
					{
						func_189(iParam2, true);
						return true;
					}
...
BOOL func_151(Ped pedParam0, int iParam1) // Position - 0x6A46 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_185(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_201(Global_1935630.f_34[i]);
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false), entityCoords);
		
			if (func_62(Global_1935630.f_34[i]))
			{
				if (num < 35f)
				{
			...
			if (func_202(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_203(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_204(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_152(var uParam0, int iParam1) // Position - 0x6C22 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x6C9A Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_154(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6CC9 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_155(int iParam0, Ped pedParam1) // Position - 0x6E4F Hash - 0xEAD700A ^0x3A7EE607
{
	int _int;
...
BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6E9C Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_207(iParam0))
		return true;
...
BOOL func_157(Ped pedParam0, Ped pedParam1) // Position - 0x6F39 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_208(pedParam0, pedParam1, true, true) < 4f)
...
void func_158() // Position - 0x6F86 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6F8E Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_209(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_210(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_160() // Position - 0x704F Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_161() // Position - 0x706D Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_162(int iParam0, Ped pedParam1) // Position - 0x70BA Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_211(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_212(pedParam1);
	num2 = func_213(iParam0->f_14);
...
BOOL func_163(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x71D6 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_214(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x721E Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_215(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_216(iParam1, pedParam0))
						if (func_210(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x7477 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_217(0))
		return false;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x74B0 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_167(var uParam0, int iParam1) // Position - 0x74DF Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_168(Ped pedParam0, int iParam1) // Position - 0x74F3 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_160() - iParam1->f_4 > func_218(iParam1))
		return func_219(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_169(int iParam0, Ped pedParam1) // Position - 0x7540 Hash - 0x3376DFA8 ^0x39139827
{
...
void func_170(int iParam0) // Position - 0x7593 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_220(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_220(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_220(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_171(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7614 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_172(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7705 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_173(int iParam0, int iParam1) // Position - 0x7723 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_174(var uParam0, float fParam1) // Position - 0x7732 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_175(var uParam0, float fParam1) // Position - 0x7758 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_121(uParam0))
		return false;
...
BOOL func_176(Ped pedParam0, Hash hParam1) // Position - 0x777F Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_177(Ped pedParam0, Hash hParam1) // Position - 0x77AD Hash - 0xA31A8CC2 ^0x8D5FE422
{
	Hash _int;
...
BOOL func_178(Ped pedParam0, Hash hParam1) // Position - 0x77FB Hash - 0xA31A8CC2 ^0x8D5FE422
{
	Hash _int;
	int _int2;
...
void func_179(Ped pedParam0) // Position - 0x7869 Hash - 0x8092D4C9 ^0xC7C2213
{
...
void func_180(int iParam0) // Position - 0x7885 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_226(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_181(int iParam0) // Position - 0x79F1 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_182(BOOL bParam0) // Position - 0x7A04 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_227(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_183(int iParam0) // Position - 0x7A1E Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_184(int iParam0) // Position - 0x7AB6 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_185(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7ADD Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_213(pedParam2);
	else
		num2 = func_212(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_213(pedParam0);
	else
...
float func_186(Ped pedParam0, Ped pedParam1) // Position - 0x7BD6 Hash - 0xF9959663 ^0xF9959663
{
	return func_208(pedParam0, pedParam1, true, true);
}

float func_187(int iParam0) // Position - 0x7BE8 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_188(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7BF4 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_189(int iParam0, BOOL bParam1) // Position - 0x7C59 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_190() // Position - 0x7C7F Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_191(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7C93 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_208(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_192(int iParam0) // Position - 0x7DF3 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_193(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7DFF Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_194(int iParam0) // Position - 0x7E60 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_195(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7E6C Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_196(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7F2E Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_197(int iParam0) // Position - 0x7FCC Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_198(int iParam0) // Position - 0x7FD8 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_199(int iParam0) // Position - 0x7FE4 Hash - 0x6DBBD85 ^0x777CE5
{
	int num;
...
BOOL func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x8134 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_201(Ped pedParam0) // Position - 0x8177 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_202(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x81DD Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_203(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8224 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_204(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x826F Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_205(Ped pedParam0, var uParam1) // Position - 0x82E8 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_206(Ped pedParam0, Ped pedParam1) // Position - 0x8335 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_207(int iParam0) // Position - 0x837D Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_208(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x838D Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_209(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x83D5 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_210(veParam0, uParam2, true);
...
float func_210(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8401 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_211(int iParam0) // Position - 0x8429 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_212(Ped pedParam0) // Position - 0x8435 Hash - 0xA50E7517 ^0xA96E1F70
{
...
int func_213(Ped pedParam0) // Position - 0x8489 Hash - 0xF627DC9 ^0x90DF2A98
{
...
BOOL func_214(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x84F3 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_208(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_208(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_215(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8663 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_227(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_216(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_216(iParam1, ped2))
					if (func_210(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_216(int iParam0, Ped pedParam1) // Position - 0x8751 Hash - 0x897BB945 ^0x9AEFBD5D
{
...
BOOL func_217(int iParam0) // Position - 0x87C5 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_238())
		return false;

	return func_239(Global_1347702[58 /*49*/].f_15, true);
}

int func_218(int iParam0) // Position - 0x87E7 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_219(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x87F3 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_220(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x886E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_221() // Position - 0x88FA Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_222(var uParam0, int iParam1) // Position - 0x892C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_223(var uParam0, int iParam1) // Position - 0x893D Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_224(var uParam0) // Position - 0x8952 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_121(uParam0))
		return uParam0->f_1;
...
BOOL func_225() // Position - 0x8987 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_242())
		return false;
...
void func_226(Any* panParam0, int iParam1) // Position - 0x89DD Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_227(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8A85 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_228() // Position - 0x8B4C Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_229(int iParam0) // Position - 0x8B5A Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_230(int iParam0) // Position - 0x8C02 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_231(Ped pedParam0, int iParam1) // Position - 0x8C67 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_232(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8C7E Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_233(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8CAC Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_234(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8CF6 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_235(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8D37 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_236(Ped pedParam0) // Position - 0x8DB0 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_237(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8E98 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_238() // Position - 0x8EDA Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_228() != -1)
		return false;
...
BOOL func_239(int iParam0, BOOL bParam1) // Position - 0x8EFF Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_240(int iParam0) // Position - 0x8F30 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_241(var uParam0) // Position - 0x8F43 Hash - 0x39705408 ^0x39705408
{
	return func_173(*uParam0, 2);
}

BOOL func_242() // Position - 0x8F53 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_243(int iParam0) // Position - 0x8F84 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_96(iParam0))
		return -1;
...
int func_244(int iParam0) // Position - 0x8FA0 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_245(int iParam0) // Position - 0x8FE1 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
