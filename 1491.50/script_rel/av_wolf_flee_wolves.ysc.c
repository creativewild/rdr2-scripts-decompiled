...
void main() // Position - 0x0 Hash - 0xC19DE6C9 ^0xE92B84E
{
	var unk;
	BOOL flag;
	...
	sLocal_38 = "CREATURES_MAMMAL@DEER@NORMAL@DEAD";
	sLocal_39 = "dead_left";
	iLocal_46 = MISC::GET_RANDOM_INT_IN_RANGE(60, 71);
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_1(var uParam0) // Position - 0x593 Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x5A1 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x637 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9DE Hash - 0x4DA9BC8C ^0xF8F4071C
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9F8 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA0F Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xACD Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAF7 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC48 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC5D Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD01 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AB2 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B18 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD2 Hash - 0x7730D495 ^0xE45180D4
{
	func_46(uParam0, "WOLF_FLEE_WOLVES", "script@ambient@animal@wolf_flee_from_wolves@action", vParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "wolf_01", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "wolf_02", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 2, "wolf_03", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 3, "wolf_04", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 4, "carcass", joaat("a_c_deer_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0.3f, 0f), uParam4.f_2 - 270f, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C9F Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D3F Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E59 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2022 Hash - 0xE4DD5F40 ^0xB651C101
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_38))
		return 0;

	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(joaat("world_animal_wolf_eating"), false))
		return 0;

	return func_49(uParam0, uParam0->f_20[4 /*14*/].f_5);
}

BOOL func_19(var uParam0) // Position - 0x205B Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x220B Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x227F Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22CE Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2326 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x248F Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27B6 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28ED Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A1D Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A5C Hash - 0x5FC6F268 ^0x505EA608
{
	int i;
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
		{
			EVENT::_0x9520175B35E2268D(uParam0->f_20[i /*14*/], true);
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[4 /*14*/]))
	{
		...
		TASK::TASK_PLAY_ANIM(uParam0->f_20[4 /*14*/], sLocal_38, sLocal_39, 1000f, -1000f, -1, 131072, 0, false, 0, false, 0, false);
		PERSISTENCE::_0x3CA5E58C9731A16B(uParam0->f_20[4 /*14*/], iLocal_46);
		MISC::SET_PED_DECOMPOSED(uParam0->f_20[4 /*14*/], true);
		PED::SET_PED_KEEP_TASK(uParam0->f_20[4 /*14*/], true);
		func_57(&uParam0->f_20[4 /*14*/], true, true);
		ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[4 /*14*/], uParam0->f_20[0 /*14*/], true);
		ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[4 /*14*/], true);
	}

	return true;
}

void func_29(var uParam0) // Position - 0x2B47 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B79 Hash - 0x558CDC8 ^0xB90E6A5
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_38);
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("world_animal_wolf_eating"), 1, joaat("a_c_wolf_medium"), 0);
	func_58(&uLocal_10, false);
	func_59(&uLocal_10, true);
	func_60(&uLocal_10, true);
	func_61(&uLocal_10, true);
	func_62(&uLocal_10, true);
	func_63(&uLocal_10, true);
	func_64(&uLocal_10, true);
	func_65(&uLocal_10, 85);
	return 1;
}

int func_31(var uParam0) // Position - 0x2BD2 Hash - 0x350D1261 ^0x84942AF0
{
	func_66(uParam0);
	...
	{
		if (!bLocal_52 == true)
			if (func_67(uParam0, &uLocal_10, true) || func_68(Global_35, uParam0->f_20[0 /*14*/], true) <= 625f)
				bLocal_52 = true;
	
		if (bLocal_52)
		{
			if (!func_69(&uLocal_43))
				func_70(&uLocal_43);
			...
			if (!uParam0->f_469[8])
			{
				func_72(*uParam0, uParam0->f_483, true);
				uParam0->f_469[8] = 1;
			}
	...
	if (uParam0->f_469[0])
		if (func_74(&uLocal_43, 4f))
			return 1;

	if (!uParam0->f_469[0] && !bLocal_52)
	{
		if (!uParam0->f_469[1])
		{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[8])
			{
				if (func_76(uParam0, 1.5f, 80f, 4, joaat("Action"), true))
				{
					func_72(*uParam0, uParam0->f_483, true);
					uParam0->f_469[8] = 1;
				}
					...
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!uParam0->f_469[3])
							{
								...
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("endsinrun")))
									{
										ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1, uParam0->f_20[0 /*14*/]);
										PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], joaat("MotionState_Run"), false, 0, false);
									
										if (!ENTITY::IS_ENTITY_DEAD(Global_35))
										{
											TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 3, 256, -1082130432, -1, 0);
											PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
										}
									
										TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_20[0 /*14*/], 2f);
							...
							if (!uParam0->f_469[4])
							{
								...
								{
									TASK::TASK_EAT(uParam0->f_20[1 /*14*/], uParam0->f_20[4 /*14*/], 0);
									PED::SET_PED_KEEP_TASK(uParam0->f_20[1 /*14*/], true);
									func_57(&uParam0->f_20[1 /*14*/], true, true);
									uParam0->f_469[4] = 1;
								}
							}
							...
							if (!uParam0->f_469[5])
							{
								...
								{
									TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[2 /*14*/], joaat("world_animal_wolf_eating"), 70000, false, 0, -1082130432, false);
									PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam0->f_20[2 /*14*/], false, false);
									PED::SET_PED_KEEP_TASK(uParam0->f_20[2 /*14*/], true);
									func_57(&uParam0->f_20[2 /*14*/], true, true);
									uParam0->f_469[5] = 1;
								}
							}
							...
							if (!uParam0->f_469[6])
							{
								...
								{
									TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[3 /*14*/], joaat("world_animal_wolf_eating"), 70000, false, 0, -1082130432, false);
									PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam0->f_20[3 /*14*/], false, false);
									PED::SET_PED_KEEP_TASK(uParam0->f_20[3 /*14*/], true);
									func_57(&uParam0->f_20[3 /*14*/], true, true);
									uParam0->f_469[6] = 1;
								}
							}
	...
	if (uParam0->f_469[7] && func_74(&uLocal_40, 2f))
		return 1;

	return 0;
}

int func_32(var uParam0, var uParam1) // Position - 0x3012 Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_77(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3024 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x3041 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x317D Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x32B6 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3360 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x33D8 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3467 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3582 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x358E Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3716 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x37B6 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x37C9 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x37E3 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x384B Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3877 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x38A8 Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_49(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x3936 Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
	...
	{
		if (func_91(entity, vParam1, true) <= 1f)
		{
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x398D Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x3B91 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3BA5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3BB4 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_78() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3BCF Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3C2E Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x3C70 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C9C Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3CC4 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3D40 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3D66 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3D88 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3DAA Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3DCC Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_105(iParam0, 4);
	else
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3DEA Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_65(var uParam0, int iParam1) // Position - 0x3E0E Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

void func_66(var uParam0) // Position - 0x3E1C Hash - 0x932439ED ^0x3EB255F8
{
	int i;
...
BOOL func_67(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3E57 Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_68(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x3EB1 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_69(var uParam0) // Position - 0x3F08 Hash - 0x5001E582 ^0x5001E582
{
	return func_108(*uParam0, 1);
}

void func_70(var uParam0) // Position - 0x3F18 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_109(uParam0, 0f);
	return;
}

void func_71(var uParam0) // Position - 0x3F27 Hash - 0x6AE99CE0 ^0x6AE99CE0
{
	if (!uParam0->f_469[9])
	{
...
void func_72(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3F4E Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_73(var uParam0) // Position - 0x4053 Hash - 0x8BC79DBD ^0x79CCD158
{
	int i;
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
		{
			if (i == 0)
			{
				...
				{
					TASK::TASK_FLEE_PED(uParam0->f_20[i /*14*/], Global_35, 4, 256, -1082130432, -1, 0);
					func_57(&uParam0->f_20[i /*14*/], false, true);
					PED::SET_PED_KEEP_TASK(uParam0->f_20[i /*14*/], true);
				}
			}
			else if (func_91(Global_35, uParam0->f_483, true) <= 2500f)
			{
				if (!func_112(uParam0->f_20[i /*14*/], SCRIPT_TASK_COMBAT))
				{
			...
			else if (!func_112(uParam0->f_20[i /*14*/], 518218985))
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[i /*14*/], Global_35, 4, 256, -1082130432, -1, 0);
				func_57(&uParam0->f_20[i /*14*/], false, true);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[i /*14*/], true);
...
BOOL func_74(var uParam0, float fParam1) // Position - 0x4176 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_69(uParam0))
		return false;
...
BOOL func_75(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x419D Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_68(Global_35, uParam0->f_20[i /*14*/], true);
...
BOOL func_76(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x43A8 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_68(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_69(&(uParam0->f_490)))
							func_120(&(uParam0->f_490), false);
					
						if (func_121(&(uParam0->f_490)))
							func_122(&(uParam0->f_490));
		...
		if (func_69(&(uParam0->f_490)) && !func_121(&(uParam0->f_490)))
...
void func_77(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x44D1 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_78() // Position - 0x4625 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_79(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4633 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x469A Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x46C3 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_124(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_82(var uParam0, var uParam1, var uParam2) // Position - 0x470F Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_124(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_83(int iParam0) // Position - 0x475E Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_84(int iParam0) // Position - 0x4783 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_85(int iParam0) // Position - 0x4796 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_86(int iParam0) // Position - 0x47A9 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_87(int iParam0) // Position - 0x47BC Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_88(int iParam0) // Position - 0x47CE Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_89(int iParam0, int iParam1) // Position - 0x47E0 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x487A Hash - 0xA65AB937 ^0xA65AB937
{
	func_126(iParam0, iParam6);
	func_127(iParam0, iParam5);
	func_128(iParam0, iParam4);
	func_129(iParam0, iParam3);
	func_130(iParam0, iParam2);
	func_131(iParam0, iParam1);
	return;
}

float func_91(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x48B2 Hash - 0x1A58F423 ^0x2317B76D
{
...
void func_92(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4902 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_124(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_93() // Position - 0x49F3 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_94(int iParam0) // Position - 0x4A46 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_97(iParam0))
		return -1;

	return func_133(func_132(iParam0));
}

BOOL func_95(int iParam0) // Position - 0x4A66 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_96(int iParam0, int iParam1) // Position - 0x4A7C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_97(int iParam0) // Position - 0x4A8B Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_98(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4ABE Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4B9F Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_105(iParam0, 8);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4BBF Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_105(iParam0, 16);
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4BEA Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_105(iParam0, 32);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4C0A Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_105(iParam0, 64);
	else
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4C2A Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x4C4C Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_105(int iParam0, int iParam1) // Position - 0x4C70 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_106(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4C81 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_107(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x52AA Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x52C8 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_109(var uParam0, float fParam1) // Position - 0x52D7 Hash - 0x30433BAB ^0xF854D531
{
...
void func_110(int iParam0, BOOL bParam1) // Position - 0x52FD Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_111(int iParam0) // Position - 0x53D4 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_172(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_172(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_172(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
BOOL func_112(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x5455 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_113(var uParam0) // Position - 0x54AE Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_69(uParam0))
		return uParam0->f_1;
...
BOOL func_114(Ped pedParam0) // Position - 0x54E3 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_115(Ped pedParam0) // Position - 0x54FE Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_116(float fParam0) // Position - 0x551A Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_117(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5561 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_118(var uParam0, float fParam1) // Position - 0x557F Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_119(var uParam0) // Position - 0x559D Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_120(var uParam0, BOOL bParam1) // Position - 0x55B3 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_121(var uParam0) // Position - 0x55D3 Hash - 0x39705408 ^0x39705408
{
	return func_108(*uParam0, 2);
}

void func_122(var uParam0) // Position - 0x55E3 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_69(uParam0);
...
void func_123(var uParam0) // Position - 0x5617 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_69(uParam0);
...
BOOL func_124(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5647 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_125(BOOL bParam0, var uParam1, var uParam2) // Position - 0x569C Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_126(int iParam0, int iParam1) // Position - 0x56B3 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_127(int iParam0, int iParam1) // Position - 0x5739 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_128(int iParam0, int iParam1) // Position - 0x5775 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_129(int iParam0, int iParam1) // Position - 0x57C8 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_130(int iParam0, int iParam1) // Position - 0x5803 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_131(int iParam0, int iParam1) // Position - 0x583C Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_132(int iParam0) // Position - 0x5874 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_133(BOOL bParam0) // Position - 0x58B2 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_134(ePedType eptParam0) // Position - 0x58C5 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_135(Ped pedParam0, Hash hParam1) // Position - 0x5D18 Hash - 0xFA6B8BA6 ^0xA28D701B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_136(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5DBF Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_137(Ped pedParam0, BOOL bParam1) // Position - 0x5DEF Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_138(Ped pedParam0, int iParam1) // Position - 0x5E34 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_139(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5E5B Hash - 0x37D64B11 ^0xE7060A9E
{
	func_177(iParam2);
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x6026 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_141(Ped pedParam0, int iParam1, int iParam2) // Position - 0x60FD Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x613A Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_143(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6221 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_144(Ped pedParam0, int iParam1) // Position - 0x62F7 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_145(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6400 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0x6535 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x656C Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6673 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_149(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x66DE Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_150(Ped pedParam0, int iParam1) // Position - 0x6826 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_151(var uParam0, int iParam1) // Position - 0x6A04 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_152(int iParam0, int iParam1) // Position - 0x6A7C Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_153(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6AAB Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_154(int iParam0, Ped pedParam1) // Position - 0x6C31 Hash - 0x42A83B1F ^0x1457AA24
{
	int _int;
...
BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6C81 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_204(iParam0))
		return true;
...
BOOL func_156(Ped pedParam0, Ped pedParam1) // Position - 0x6D1E Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_157() // Position - 0x6D6B Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6D73 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_159() // Position - 0x6E34 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_160() // Position - 0x6E52 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_161(int iParam0, Ped pedParam1) // Position - 0x6E9F Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_162(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6FBB Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x7003 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x725C Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_214(0))
		return false;
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x7295 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_166(var uParam0, int iParam1) // Position - 0x72C4 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_167(Ped pedParam0, int iParam1) // Position - 0x72D8 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_159() - iParam1->f_4 > func_215(iParam1))
		return func_216(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_168(int iParam0, Ped pedParam1) // Position - 0x7325 Hash - 0x88C7C77A ^0xFCA48759
{
...
float func_169() // Position - 0x7378 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_170(var uParam0, int iParam1) // Position - 0x73AA Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_171(var uParam0, int iParam1) // Position - 0x73BB Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_172(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x73D0 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x745C Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x748A Hash - 0xFCE0851E ^0xDF3ABC94
{
	Hash _int;
...
BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x74DA Hash - 0xFCE0851E ^0xDF3ABC94
{
	Hash _int;
	int _int2;
...
void func_176(Ped pedParam0) // Position - 0x754A Hash - 0x2F8103CC ^0x63E7EED9
{
...
void func_177(int iParam0) // Position - 0x7567 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_178(int iParam0) // Position - 0x76D3 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_179(BOOL bParam0) // Position - 0x76E6 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_180(int iParam0) // Position - 0x7700 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_181(int iParam0) // Position - 0x779A Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_182(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x77C1 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_183(Ped pedParam0, Ped pedParam1) // Position - 0x78BA Hash - 0xF9959663 ^0xF9959663
{
	return func_205(pedParam0, pedParam1, true, true);
}

float func_184(int iParam0) // Position - 0x78CC Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_185(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78D8 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_186(int iParam0, BOOL bParam1) // Position - 0x793D Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_187() // Position - 0x7963 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_188(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7977 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_189(int iParam0) // Position - 0x7AD7 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_190(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7AE3 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_191(int iParam0) // Position - 0x7B44 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_192(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7B50 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_193(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7C12 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_194(int iParam0) // Position - 0x7CB0 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_195(int iParam0) // Position - 0x7CBC Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_196(int iParam0) // Position - 0x7CC8 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7E05 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_198(Ped pedParam0) // Position - 0x7E48 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7EAE Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7EF5 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7F40 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_202(Ped pedParam0, var uParam1) // Position - 0x7FB9 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_203(Ped pedParam0, Ped pedParam1) // Position - 0x8007 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_204(int iParam0) // Position - 0x804F Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_205(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x805F Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_206(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x80A7 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x80D3 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_208(int iParam0) // Position - 0x80FB Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_209(Ped pedParam0) // Position - 0x8107 Hash - 0x9F2F2E7D ^0x7379C177
{
...
int func_210(Ped pedParam0) // Position - 0x815D Hash - 0x83B3A835 ^0x42FC41B2
{
...
BOOL func_211(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x81CB Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x833B Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_213(int iParam0, Ped pedParam1) // Position - 0x8429 Hash - 0x27FC2906 ^0xDD838E71
{
...
BOOL func_214(int iParam0) // Position - 0x849F Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_231())
		return false;
...
int func_215(int iParam0) // Position - 0x84C1 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_216(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x84CD Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_217(int iParam0) // Position - 0x8548 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_218() // Position - 0x855B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_219() // Position - 0x8569 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_233())
		return false;
...
void func_220(Any* panParam0, int iParam1) // Position - 0x85BF Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_221(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8668 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_222(int iParam0) // Position - 0x872F Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_223(int iParam0) // Position - 0x87D7 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_224(Ped pedParam0, int iParam1) // Position - 0x883C Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_225(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8853 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_226(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8881 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_227(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x88CB Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_228(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x890C Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_229(Ped pedParam0) // Position - 0x8985 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_230(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8A6D Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_231() // Position - 0x8AAF Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_218() != -1)
		return false;
...
BOOL func_232(int iParam0, BOOL bParam1) // Position - 0x8AD4 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_233() // Position - 0x8B05 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_234(int iParam0) // Position - 0x8B36 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_97(iParam0))
		return -1;
...
int func_235(int iParam0) // Position - 0x8B52 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_236(int iParam0) // Position - 0x8B93 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
