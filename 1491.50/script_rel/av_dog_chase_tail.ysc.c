...
void main() // Position - 0x0 Hash - 0xA112627F ^0x87EE6BE0
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_c_dogamericanfoxhound_01");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0x8108B74B
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x87C3F4BE ^0x60790EC4
{
	func_46(uParam0, "DOG_CHASE_TAIL", "script@ambient@animal@dog_chase_tail@action", uParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "DOG", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}
...
void func_29(var uParam0) // Position - 0x29FE Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A30 Hash - 0x6C10550A ^0x6C10550A
{
...
int func_31(var uParam0) // Position - 0x2A63 Hash - 0x7AEF9275 ^0x6434D2B4
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	...
	if (!uParam0->f_469[0])
	{
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
		{
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
			{
				if (func_63(uParam0, &uLocal_10, true))
				{
					func_64(uParam0);
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[5])
			{
				if (func_67(uParam0, 1.5f, 1116471296, 4, joaat("Action"), true))
				{
					func_65(*uParam0, uParam0->f_483, false);
					uParam0->f_469[5] = 1;
				}
...
int func_32(var uParam0, var uParam1) // Position - 0x2CE1 Hash - 0x373435D2 ^0x26CED1BD
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
	...
	func_68(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D1A Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D37 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2E73 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2FAC Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3056 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x30CE Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_70(entityForwardVector, unk5);
	...
	if (func_71(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x315D Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3278 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3284 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	for (m = func_80(i, num); num2 > m; m = func_80(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_81(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x340C Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x34AC Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x34BF Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x34D9 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3541 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x356D Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x359E Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x362C Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3830 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3844 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3853 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_69() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x386E Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x38CD Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_87(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_55(Ped pedParam0) // Position - 0x390F Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x393B Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x3963 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x39DF Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3A05 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3A27 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3A49 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3A6B Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_63(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3A8F Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_64(var uParam0) // Position - 0x3AE9 Hash - 0xCCDA6E04 ^0xCCDA6E04
{
	if (!uParam0->f_469[6])
	{
...
void func_65(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3B0E Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
	...
	func_98(iParam0);
	func_99(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

BOOL func_66(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3C12 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_67(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3E1D Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_105(&(uParam0->f_490)) && !func_110(&(uParam0->f_490)))
...
void func_68(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3F46 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_69() // Position - 0x409C Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_70(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x40AA Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_71(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4111 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_72(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x413A Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_73(var uParam0, var uParam1, var uParam2) // Position - 0x4186 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_74(int iParam0) // Position - 0x41D5 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_75(int iParam0) // Position - 0x41FA Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_76(int iParam0) // Position - 0x420D Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_77(int iParam0) // Position - 0x4220 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_78(int iParam0) // Position - 0x4233 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_79(int iParam0) // Position - 0x4245 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_80(int iParam0, int iParam1) // Position - 0x4257 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x42F1 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_82() // Position - 0x4329 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_83(int iParam0) // Position - 0x437C Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_86(iParam0))
		return -1;
...
BOOL func_84(int iParam0) // Position - 0x439C Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_85(int iParam0, int iParam1) // Position - 0x43B2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_86(int iParam0) // Position - 0x43C1 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_87(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x43F4 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_88(int iParam0, BOOL bParam1) // Position - 0x44D5 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_95(iParam0, 4);
	else
...
void func_89(int iParam0, BOOL bParam1) // Position - 0x44F3 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_95(iParam0, 8);
	else
...
void func_90(int iParam0, BOOL bParam1) // Position - 0x4513 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_95(iParam0, 16);
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x453E Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_95(iParam0, 32);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x455E Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_95(iParam0, 64);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x457E Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x45A0 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_95(int iParam0, int iParam1) // Position - 0x45C4 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_96(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x45D5 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4BFE Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_98(int iParam0) // Position - 0x4CD5 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_159(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_159(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_159(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_99(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4D56 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_100(Ped pedParam0) // Position - 0x4E47 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_101(Ped pedParam0) // Position - 0x4E62 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_102(int iParam0) // Position - 0x4E7E Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4EC5 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_104(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4EE3 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_105(var uParam0) // Position - 0x4F3A Hash - 0x5001E582 ^0x5001E582
{
	return func_161(*uParam0, 1);
}

void func_106(var uParam0) // Position - 0x4F4A Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_162(uParam0, 0f);
	return;
}

BOOL func_107(var uParam0, float fParam1) // Position - 0x4F59 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_108(var uParam0) // Position - 0x4F77 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_109(var uParam0, BOOL bParam1) // Position - 0x4F8D Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_110(var uParam0) // Position - 0x4FAD Hash - 0x39705408 ^0x39705408
{
	return func_161(*uParam0, 2);
}

void func_111(var uParam0) // Position - 0x4FBD Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_105(uParam0);
...
BOOL func_112(var uParam0, float fParam1) // Position - 0x4FF1 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_105(uParam0))
		return false;
...
void func_113(var uParam0) // Position - 0x5018 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_105(uParam0);
...
BOOL func_114(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5048 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_115(BOOL bParam0, var uParam1, var uParam2) // Position - 0x509D Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_116(int iParam0, int iParam1) // Position - 0x50B4 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_117(int iParam0, int iParam1) // Position - 0x513A Hash - 0x96B01D2A ^0x81E68218
{
...
void func_118(int iParam0, int iParam1) // Position - 0x5176 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_80(num, num2))
		return;
...
void func_119(int iParam0, int iParam1) // Position - 0x51C9 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_120(int iParam0, int iParam1) // Position - 0x5204 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_121(int iParam0, int iParam1) // Position - 0x523D Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_122(int iParam0) // Position - 0x5275 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_123(BOOL bParam0) // Position - 0x52B3 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_124(ePedType eptParam0) // Position - 0x52C6 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_125(Ped pedParam0, Hash hParam1) // Position - 0x5719 Hash - 0x467FD2A5 ^0x57BC296D
{
...
void func_126(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x57C0 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_127(Ped pedParam0, BOOL bParam1) // Position - 0x57F0 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_128(Ped pedParam0, int iParam1) // Position - 0x5835 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_129(int iParam0, BOOL bParam1, int iParam2) // Position - 0x585C Hash - 0x37D64B11 ^0xE7060A9E
{
	func_171(iParam2);
...
BOOL func_130(Ped pedParam0, int iParam1) // Position - 0x5A27 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_131(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5AFE Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x5B3B Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_133(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5C22 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x5CF8 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_135(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5E01 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x5F36 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_137(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5F6D Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_138(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6074 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_139(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x60DF Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x6227 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_141(var uParam0, int iParam1) // Position - 0x6403 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x647B Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_143(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x64AA Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_144(int iParam0, Ped pedParam1) // Position - 0x6630 Hash - 0x7AF525E6 ^0x65C9D395
{
	int _int;
...
BOOL func_145(int iParam0, Ped pedParam1) // Position - 0x667D Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_198(iParam0))
		return true;
...
BOOL func_146(Ped pedParam0, Ped pedParam1) // Position - 0x671A Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_147() // Position - 0x6767 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x676F Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_149() // Position - 0x6830 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_150() // Position - 0x684E Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x689B Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_152(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x69B7 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_153(Ped pedParam0, int iParam1) // Position - 0x69FF Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_154(Ped pedParam0, int iParam1) // Position - 0x6C58 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_208(0))
		return false;
...
BOOL func_155(int iParam0, int iParam1) // Position - 0x6C91 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_156(var uParam0, int iParam1) // Position - 0x6CC0 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6CD4 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_149() - iParam1->f_4 > func_209(iParam1))
		return func_210(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6D21 Hash - 0x413CDCF0 ^0x31FA60EE
{
...
void func_159(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6D74 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_160(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6E00 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x6E1E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_162(var uParam0, float fParam1) // Position - 0x6E2D Hash - 0x30433BAB ^0xF854D531
{
...
float func_163() // Position - 0x6E53 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_164(var uParam0, int iParam1) // Position - 0x6E85 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_165(var uParam0) // Position - 0x6E9A Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_105(uParam0))
		return uParam0->f_1;
...
void func_166(var uParam0, int iParam1) // Position - 0x6ECF Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_167(Ped pedParam0, Hash hParam1) // Position - 0x6EE0 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_168(Ped pedParam0, Hash hParam1) // Position - 0x6F0E Hash - 0xF6906BFC ^0x98E689B0
{
	Hash _int;
...
BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x6F5C Hash - 0xF6906BFC ^0x98E689B0
{
	Hash _int;
	int _int2;
...
void func_170(Ped pedParam0) // Position - 0x6FCA Hash - 0xC12B24AA ^0x310EC255
{
...
void func_171(int iParam0) // Position - 0x6FE6 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_172(int iParam0) // Position - 0x7152 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_173(BOOL bParam0) // Position - 0x7165 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_174(int iParam0) // Position - 0x717F Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_175(int iParam0) // Position - 0x7219 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_176(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7240 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_177(Ped pedParam0, Ped pedParam1) // Position - 0x7339 Hash - 0xF9959663 ^0xF9959663
{
	return func_199(pedParam0, pedParam1, true, true);
}

float func_178(int iParam0) // Position - 0x734B Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_179(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7357 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x73BC Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_181() // Position - 0x73E2 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_182(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x73F6 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_183(int iParam0) // Position - 0x7556 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_184(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7562 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_185(int iParam0) // Position - 0x75C3 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_186(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x75CF Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_187(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7691 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_188(int iParam0) // Position - 0x772F Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_189(int iParam0) // Position - 0x773B Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_190(int iParam0) // Position - 0x7747 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_191(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7884 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_192(Ped pedParam0) // Position - 0x78C7 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_193(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x792D Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_194(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7974 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x79BF Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_196(Ped pedParam0, var uParam1) // Position - 0x7A38 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_197(Ped pedParam0, Ped pedParam1) // Position - 0x7A85 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_198(int iParam0) // Position - 0x7ACD Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_199(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7ADD Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_200(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7B25 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_201(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7B51 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_202(int iParam0) // Position - 0x7B79 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_203(Ped pedParam0) // Position - 0x7B85 Hash - 0xE62D0218 ^0x5F4B2684
{
...
int func_204(Ped pedParam0) // Position - 0x7BD9 Hash - 0xF8ED05DD ^0x6B6FFA40
{
...
BOOL func_205(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7C45 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_206(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7DB5 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_207(int iParam0, Ped pedParam1) // Position - 0x7EA3 Hash - 0x27FC2906 ^0x51DA1763
{
...
BOOL func_208(int iParam0) // Position - 0x7F19 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_225())
		return false;
...
int func_209(int iParam0) // Position - 0x7F3B Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_210(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7F47 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_211(int iParam0) // Position - 0x7FC2 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_212() // Position - 0x7FD5 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_213() // Position - 0x7FE3 Hash - 0x7522C914 ^0x5A930E72
{
	if (func_227())
		return false;
...
void func_214(Any* panParam0, int iParam1) // Position - 0x803C Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_215(BOOL bParam0, var uParam1, var uParam2) // Position - 0x80E4 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_216(int iParam0) // Position - 0x81AB Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_217(int iParam0) // Position - 0x8253 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_218(Ped pedParam0, int iParam1) // Position - 0x82B8 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_219(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x82CF Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_220(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x82FD Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_221(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8347 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_222(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8388 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_223(Ped pedParam0) // Position - 0x8401 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_224(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x84E9 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_225() // Position - 0x852B Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_212() != -1)
		return false;
...
BOOL func_226(int iParam0, BOOL bParam1) // Position - 0x8550 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_227() // Position - 0x8581 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_228(int iParam0) // Position - 0x85B2 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_86(iParam0))
		return -1;
...
int func_229(int iParam0) // Position - 0x85CE Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_230(int iParam0) // Position - 0x860F Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
