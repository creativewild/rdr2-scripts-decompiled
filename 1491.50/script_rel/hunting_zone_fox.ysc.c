...
BOOL func_42(var uParam0) // Position - 0x1583 Hash - 0x116AEF05 ^0xA0251D88
{
	*uParam0 = 11;
	uParam0->f_9 = 80f;
	uParam0->f_10 = 180f;
	uParam0->f_572[0] = joaat("p_foxscat01x");
	uParam0->f_572[1] = joaat("brokensticks_ab");
	uParam0->f_572[2] = joaat("p_foxtuftsfur01x");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 4;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = joaat("a_c_fox_01");
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = joaat("META_OUTFIT_ANIMAL_ALBINO_FOX");
	return true;
}

BOOL func_43(var uParam0) // Position - 0x1638 Hash - 0x90008B47 ^0xA0ACAD4E
{
	float num;
	var unk;
	var unk6;
...
int func_44(int iParam0) // Position - 0x174F Hash - 0x7F390DDD ^0x7F390DDD
{
	int num;
...
void func_45(var uParam0) // Position - 0x1785 Hash - 0xF060930F ^0x679498F2
{
	int i;
...
BOOL func_46(var uParam0) // Position - 0x17CF Hash - 0x7B76A2ED ^0x317722B6
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x1894 Hash - 0x43C1809B ^0xD255F79A
{
	float scaleX;
...
BOOL func_48(var uParam0) // Position - 0x18DB Hash - 0xC25AB6F8 ^0xC25AB6F8
{
	int i;
	int j;
...
BOOL func_49(var uParam0) // Position - 0x1926 Hash - 0x10BF63DF ^0x638AC662
{
	int i;
	float radius;
	var unk;
...
void func_50(var uParam0) // Position - 0x1EC6 Hash - 0x85508A28 ^0x573D2B47
{
	float num;
	int num2;
	int i;
...
void func_51(var uParam0) // Position - 0x1F8C Hash - 0x46A37087 ^0x6FADEB49
{
	int i;
	int duration;
	int num;
...
void func_52(var uParam0) // Position - 0x264D Hash - 0x271CC8B9 ^0x72DC5E80
{
	int taskSequenceId;
	float num;
...
int func_53(var uParam0, var uParam1) // Position - 0x2742 Hash - 0x3AAD93D4 ^0x6348F3E3
{
	int unk;
...
BOOL func_54(var uParam0) // Position - 0x2755 Hash - 0x26561433 ^0x8D630CC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		return true;
...
var func_55(BOOL bParam0, var uParam1, var uParam2) // Position - 0x278A Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_56(Hash hParam0, int iParam1) // Position - 0x27A1 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_57(Hash hParam0, int iParam1) // Position - 0x2827 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_58(Hash hParam0, int iParam1) // Position - 0x2863 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_59(Hash hParam0, int iParam1) // Position - 0x28B6 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_60(Hash hParam0, int iParam1) // Position - 0x28F1 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_61(Hash hParam0, int iParam1) // Position - 0x292A Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_62(Hash hParam0, int iParam1) // Position - 0x2962 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_63() // Position - 0x2975 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_64() // Position - 0x2994 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0) // Position - 0x29A2 Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

int func_66(int iParam0) // Position - 0x29B8 Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_67(int iParam0) // Position - 0x2E0C Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_123(iParam0, 1);
}

int func_68(int iParam0) // Position - 0x2E1C Hash - 0xA776614E ^0xA776614E
{
	if (!func_65(iParam0))
		return -1;
...
BOOL func_69(int iParam0) // Position - 0x3262 Hash - 0x14DDF3C9 ^0xAD14D790
{
...
BOOL func_70(int iParam0) // Position - 0x32AB Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_125(iParam0))
		return false;
...
Vector3 func_71(int iParam0) // Position - 0x32CC Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_65(iParam0))
		return 0f, 0f, 0f;
...
float func_72(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3AF3 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_73(int iParam0) // Position - 0x3B1B Hash - 0x23547602 ^0x23547602
{
	switch (iParam0)
	{
		case 0:
...
int func_74(int iParam0, var uParam1) // Position - 0x3C12 Hash - 0x4931B454 ^0x88362C28
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3D73 Hash - 0x49B3EF5C ^0x9505D01C
{
	var data;
	int size;
	int collectionId;
...
int func_76(Hash hParam0, int iParam1) // Position - 0x3E26 Hash - 0x3B4883DD ^0xBE4A62CA
{
	var unk;
	var guid;
...
BOOL func_77(Hash hParam0, int iParam1) // Position - 0x3E81 Hash - 0xD7B4F3C5 ^0x943C8C22
{
	var unk;
	int num;
	int num2;
...
BOOL func_78(Hash hParam0, int iParam1, int iParam2) // Position - 0x3EDF Hash - 0xC758F57F ^0x801747D0
{
	int num;
	var unk;
	var unk6;
...
void func_79(var uParam0, int iParam1) // Position - 0x3F56 Hash - 0xF55E891F ^0xF55E891F
{
	func_140(uParam0, iParam1);
	return;
}

int func_80(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F66 Hash - 0xB04D1B6E ^0xB04D1B6E
{
	switch (hParam0)
	{
...
{
	return func_204("ATZ_INS_EXC_FX");
}

Vector3 func_161() // Position - 0x78E0 Hash - 0x1DA0618A ^0xAC40CBAA
{
	return func_204("ATZ_INS_FUR_FX");
}
...
Hash func_171() // Position - 0x7BA6 Hash - 0x9F572D68 ^0xFE1F0351
{
	return -2019825792;
}
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0x895E Hash - 0x24E72BF3 ^0x24E72BF3
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 1384.0365f, -949.4642f, 51.4803f;
			
				case 1:
					return 1311.8624f, -927.5496f, 53.5968f;
			
				case 2:
					return 1260.9662f, -970.291f, 61.5573f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return 1265.7504f, -1001.6242f, 66.085f;
			
				case 1:
					return 1334.5355f, -1051.4307f, 66.4558f;
			
				case 2:
					return 1345.7346f, -960.0558f, 52.2121f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return 1295.7719f, -1028.1543f, 79.204f;
			
				case 1:
					return 1347.4253f, -999.2542f, 58.3645f;
			
				case 2:
					return 1323.6487f, -932.9647f, 53.8864f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return 1364.9108f, -1010.9587f, 55.6178f;
			
				case 1:
					return 1377.0984f, -957.1983f, 50.3709f;
			
				case 2:
					return 1297.4093f, -962.6989f, 64.2423f;
			}
			break;
	}
