...
BOOL func_4() // Position - 0x5FA Hash - 0xE2E8709A ^0x1DB718CC
{
	return !UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_CHAL_LEGENDARY_PANTHER"));
}

BOOL func_5(var uParam0) // Position - 0x60C Hash - 0xBA3CD49A ^0x8BDBEB72
{
	BOOL flag;
	BOOL flag2;
	int num;
...
BOOL func_6(var uParam0) // Position - 0x79C Hash - 0xD9E3A7D5 ^0xBB379E2E
{
	switch (uParam0->f_11)
	{
		case 0:
...
int func_7(int iParam0) // Position - 0x9EC Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_8(int iParam0) // Position - 0xA11 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_9(int iParam0) // Position - 0xA24 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_10(int iParam0) // Position - 0xA37 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_11(int iParam0) // Position - 0xA4A Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_12(int iParam0) // Position - 0xA5C Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_13(int iParam0, int iParam1) // Position - 0xA6E Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_14(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB08 Hash - 0xA65AB937 ^0xA65AB937
{
...
Hash func_15(int iParam0) // Position - 0xB40 Hash - 0xED7149D6 ^0x70CFB709
{
	switch (iParam0)
	{
		case 0:
...
Hash func_16(int iParam0) // Position - 0xC30 Hash - 0x2AB77E3A ^0xDDF0AC0D
{
	switch (iParam0)
	{
		case 0:
...
void func_17(BOOL bParam0, int iParam1) // Position - 0xD20 Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
BOOL func_18(int iParam0) // Position - 0xD66 Hash - 0x6F6E313E ^0xFDA66EDA
{
	int num;
	int num2;
	int offset;
...
int func_19(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xDAB Hash - 0x16C9DD13 ^0x16C9DD13
{
	int i;
	int num;
	int num2;
...
void func_20(int iParam0, int iParam1, int iParam2) // Position - 0xE53 Hash - 0xAB9DB255 ^0xDE3F0264
{
...
BOOL func_21(Ped pedParam0) // Position - 0xE7A Hash - 0x8F7DFED5 ^0x8768F0B4
{
	var lootTarget;
...
Entity func_22(Ped pedParam0) // Position - 0xEE4 Hash - 0x3D354C79 ^0x6A3F9034
{
	Entity lootTarget;
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xF44 Hash - 0xF955E936 ^0xF52EED36
{
	int num;
	BOOL flag;
	BOOL flag2;
...
Hash func_24(int iParam0) // Position - 0x1084 Hash - 0xB8EC44B7 ^0x7CA82820
{
	switch (iParam0)
	{
		case 0:
...
void func_25(Hash hParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1175 Hash - 0x1E507D43 ^0xD4646B2A
{
...
struct<2> func_26(int iParam0, Hash hParam1) // Position - 0x1227 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_27(var uParam0, var uParam1, int iParam2) // Position - 0x123D Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

void func_28(Volume volParam0) // Position - 0x124D Hash - 0x4A7DD833 ^0xF771448B
{
	var volumeCoords;
...
void func_29(var uParam0, Volume volParam1, BOOL bParam2) // Position - 0x1275 Hash - 0x2EB65318 ^0x737362FB
{
...
int func_30() // Position - 0x12AD Hash - 0x2160DAA3 ^0x2160DAA3
{
	return 12;
}

void func_31(Volume volParam0) // Position - 0x12B7 Hash - 0x7DD010A2 ^0x16530136
{
	if (VOLUME::DOES_VOLUME_EXIST(volParam0))
...
void func_32(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x12CE Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
void func_33(var uParam0) // Position - 0x1322 Hash - 0x6E0E5DAC ^0x576FCDC5
{
	if (uParam0->f_680)
	{
		AUDIO::_0x6AB944DF68B512D3(uParam0->f_679);
...
BOOL func_34() // Position - 0x1362 Hash - 0x7DF1A9A5 ^0x80A37AC6
{
...
BOOL func_35(int iParam0, int iParam1) // Position - 0x1386 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_36(int iParam0) // Position - 0x1395 Hash - 0xBF7DEF91 ^0x6E26B7C2
{
...
BOOL func_37() // Position - 0x13C1 Hash - 0x4228A1C2 ^0x70D4FBDE
{
	return Global_1898164.f_163;
}

int func_38(int iParam0) // Position - 0x13CF Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_39(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x13E3 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
void func_40(int iParam0, BOOL bParam1) // Position - 0x1518 Hash - 0x8A4CBA15 ^0x8A4CBA15
{
	int num;
	int num2;
...
BOOL func_41(Ped pedParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1545 Hash - 0x281BDD5E ^0x8899ECCD
{
	char* str;
...
BOOL func_42(var uParam0) // Position - 0x158C Hash - 0x6DB1E60E ^0x264EF73D
{
	*uParam0 = 13;
	uParam0->f_1 = 2;
	uParam0->f_9 = 80f;
	uParam0->f_10 = 180f;
	uParam0->f_572[0] = joaat("p_panthescat01x");
	uParam0->f_572[1] = joaat("p_pantherblood01x");
	uParam0->f_572[2] = joaat("a_c_sheep_01");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 3;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_4 = 1.05f;
	uParam0->f_12.f_1 = joaat("a_c_panther_01");
	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_605), "PD_Med_aged_carcass_Hvy_Hot", 64);
	uParam0->f_12.f_5 = 1;
	uParam0->f_623 = 1;
	uParam0->f_12.f_8 = joaat("PANTHER_LEGENDARY");
	return true;
}

BOOL func_43(var uParam0) // Position - 0x1661 Hash - 0x90008B47 ^0xA0ACAD4E
{
	float num;
	var unk;
	var unk6;
...
int func_44(int iParam0) // Position - 0x1778 Hash - 0xBA31BE74 ^0xBA31BE74
{
	int num;
...
void func_45(var uParam0) // Position - 0x17AE Hash - 0xF060930F ^0x679498F2
{
	int i;
...
BOOL func_46(var uParam0) // Position - 0x17F8 Hash - 0x7B76A2ED ^0x317722B6
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x18BD Hash - 0xECBA0509 ^0xFCFF5AA3
{
	float scaleX;
...
BOOL func_48(var uParam0) // Position - 0x1904 Hash - 0xC25AB6F8 ^0xC25AB6F8
{
	int i;
	int j;
...
BOOL func_49(var uParam0) // Position - 0x194F Hash - 0x10BF63DF ^0x638AC662
{
	int i;
	float radius;
	var unk;
...
void func_50(var uParam0) // Position - 0x1EEF Hash - 0x85508A28 ^0x573D2B47
{
	float num;
	int num2;
	int i;
...
void func_51(var uParam0) // Position - 0x1FB5 Hash - 0x46A37087 ^0x6FADEB49
{
	int i;
	int duration;
	int num;
...
void func_52(var uParam0) // Position - 0x2676 Hash - 0x271CC8B9 ^0x72DC5E80
{
	int taskSequenceId;
	float num;
...
int func_53(var uParam0, var uParam1) // Position - 0x276B Hash - 0x3AAD93D4 ^0x6348F3E3
{
	int unk;
...
BOOL func_54(var uParam0) // Position - 0x277E Hash - 0x26561433 ^0x8D630CC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		return true;
...
var func_55(BOOL bParam0, var uParam1, var uParam2) // Position - 0x27B3 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_56(Hash hParam0, int iParam1) // Position - 0x27CA Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_57(Hash hParam0, int iParam1) // Position - 0x2850 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_58(Hash hParam0, int iParam1) // Position - 0x288C Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_59(Hash hParam0, int iParam1) // Position - 0x28DF Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_60(Hash hParam0, int iParam1) // Position - 0x291A Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_61(Hash hParam0, int iParam1) // Position - 0x2953 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_62(Hash hParam0, int iParam1) // Position - 0x298B Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_63() // Position - 0x299E Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_64() // Position - 0x29BD Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0) // Position - 0x29CB Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

int func_66(int iParam0) // Position - 0x29E1 Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_67(int iParam0) // Position - 0x2E35 Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_123(iParam0, 1);
}

int func_68(int iParam0) // Position - 0x2E45 Hash - 0xA776614E ^0xA776614E
{
	if (!func_65(iParam0))
		return -1;
...
BOOL func_69(int iParam0) // Position - 0x328B Hash - 0x14DDF3C9 ^0xAD14D790
{
...
BOOL func_70(int iParam0) // Position - 0x32D4 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_125(iParam0))
		return false;
...
Vector3 func_71(int iParam0) // Position - 0x32F5 Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_65(iParam0))
		return 0f, 0f, 0f;
...
float func_72(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3B1C Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_73(int iParam0) // Position - 0x3B44 Hash - 0x23547602 ^0x23547602
{
	switch (iParam0)
	{
		case 0:
...
int func_74(int iParam0, var uParam1) // Position - 0x3C3B Hash - 0x4931B454 ^0x88362C28
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3D9C Hash - 0x49B3EF5C ^0x9505D01C
{
	var data;
	int size;
	int collectionId;
...
int func_76(Hash hParam0, int iParam1) // Position - 0x3E4F Hash - 0x3B4883DD ^0xBE4A62CA
{
	var unk;
	var guid;
...
BOOL func_77(Hash hParam0, int iParam1) // Position - 0x3EAA Hash - 0xD7B4F3C5 ^0x943C8C22
{
	var unk;
	int num;
	int num2;
...
BOOL func_78(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F08 Hash - 0xC758F57F ^0x801747D0
{
	int num;
	var unk;
	var unk6;
...
void func_79(var uParam0, int iParam1) // Position - 0x3F7F Hash - 0xF55E891F ^0xF55E891F
{
	func_140(uParam0, iParam1);
	return;
}

int func_80(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F8F Hash - 0xB04D1B6E ^0xB04D1B6E
{
	switch (hParam0)
	{
...
float func_99(int iParam0) // Position - 0x63A2 Hash - 0x566AD102 ^0x566AD102
{
	return func_169(0, iParam0);
}

Ped func_100(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x63B1 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
void func_101(var uParam0) // Position - 0x63F3 Hash - 0xB1EA7205 ^0x42F352D8
{
...
void func_102(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x668F Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
Ped func_103(Ped pedParam0) // Position - 0x66CB Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

Vector3 func_104(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x66D5 Hash - 0x88200B15 ^0xE07B704A
{
	float num;
...
int func_105(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x670C Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
const char* func_106(const char* sParam0) // Position - 0x6803 Hash - 0xC9D82232 ^0xC9D82232
{
	return sParam0;
}

float func_107(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x680D Hash - 0x1A58F423 ^0x2317B76D
{
...
float func_108(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x685D Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_109() // Position - 0x68B4 Hash - 0x7A8E245E ^0x59FC764
{
...
int func_110(char* sParam0, Hash hParam1, Object obParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x68D8 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
...
void func_111(int iParam0, float fParam1, BOOL bParam2) // Position - 0x69AF Hash - 0x9018D919 ^0x90AC92B6
{
	int num;
...
int func_112(var uParam0, Entity eParam1) // Position - 0x6A0E Hash - 0x583186B5 ^0x1718BFF6
{
	int num;
...
BOOL func_113(int iParam0, BOOL bParam1) // Position - 0x6A53 Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_114(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6AAB Hash - 0x89AE2BEC ^0x89AE2BEC
{
	int num;
...
void func_115(var uParam0, var uParam1) // Position - 0x6AFA Hash - 0x2173EF1C ^0x6EFEA7E5
{
	int i;
	int num;
	int num2;
...
BOOL func_116(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x6D22 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
void func_117(int iParam0, int iParam1) // Position - 0x6D7B Hash - 0x95CEEAD4 ^0xB0557C21
{
	if (iParam1 == 0)
		if (iParam0 == 0)
...
int func_118(Entity eParam0, const char* sParam1, BOOL bParam2, float fParam3, int iParam4, int iParam5, float fParam6, BOOL bParam7) // Position - 0x6E21 Hash - 0xF2C93E75 ^0x2DDAA8D0
{
	int points;
...
void func_119(Volume volParam0) // Position - 0x6E8D Hash - 0x530B7370 ^0x1B8FEE27
{
	int i;
...
BOOL func_120(int iParam0) // Position - 0x6EBE Hash - 0x90A8253B ^0x90A8253B
{
	switch (iParam0)
	{
		case 0:
...
void func_121(var uParam0) // Position - 0x6F37 Hash - 0x8EF783D9 ^0x83F1A18A
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
...
void func_122(var uParam0) // Position - 0x6FB2 Hash - 0x6C6259DC ^0xF1EA64EB
{
	int num;
...
BOOL func_123(int iParam0, BOOL bParam1) // Position - 0x6FDF Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_65(iParam0))
		return false;
...
eStackSize func_124() // Position - 0x7005 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_125(int iParam0) // Position - 0x7013 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_126(int iParam0, BOOL bParam1) // Position - 0x7029 Hash - 0x34A2E44 ^0x39A823C1
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_127(Hash hParam0, int iParam1) // Position - 0x705C Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
struct<10> func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x7076 Hash - 0x440EE211 ^0xAE2816F9
{
	int num;
...
BOOL func_129(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x714A Hash - 0x72399051 ^0x6D1C1C66
{
	var outData;
	int i;
...
struct<4> func_130(BOOL bParam0) // Position - 0x71E7 Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_132(joaat("character"), func_190(), joaat("SLOTID_NONE"), bParam0);
}

int func_131(int iParam0) // Position - 0x7203 Hash - 0xF3DAE918 ^0xA65130AC
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_132(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x7250 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
int func_133(BOOL bParam0) // Position - 0x7281 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_64() == -1)
	{
...
BOOL func_134(Hash hParam0, var uParam1) // Position - 0x72C2 Hash - 0x6C0FFC3B ^0xB2795CB6
{
	int i;
	var outSlotId;
	var unk;
...
int func_135(Hash hParam0, Any* panParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7316 Hash - 0x9D75BA2C ^0xE0E521B7
{
	if (!func_127(hParam0, 0))
		return 0;
...
int func_136(Hash hParam0, BOOL bParam1) // Position - 0x7364 Hash - 0xE0F47B47 ^0x52A64D28
{
	if (func_195(hParam0))
...
BOOL func_137(Hash hParam0) // Position - 0x738E Hash - 0x5E6E1858 ^0x84C97687
{
	!func_127(hParam0, 0);
...
BOOL func_138(Hash hParam0) // Position - 0x73B4 Hash - 0x33F7D399 ^0xEB534519
{
	if (!func_127(hParam0, 0))
		return false;
...
BOOL func_139(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x73D1 Hash - 0x86E39CDA ^0xCF922D1
{
	!func_127(hParam0, 0);
...
void func_140(var uParam0, int iParam1) // Position - 0x7433 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_141(int iParam0, int iParam1) // Position - 0x7444 Hash - 0xC0D8FAC3 ^0xE4233006
{
...
void func_142(int iParam0) // Position - 0x745D Hash - 0x23AE6B73 ^0x23AE6B73
{
	int i;
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74CB Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_144(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x74F5 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_145(int iParam0) // Position - 0x754A Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_175(iParam0, 2);
}

int func_146(int iParam0) // Position - 0x7559 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_199(iParam0))
		return -1;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x7575 Hash - 0xDD376ADC ^0x3FEE2146
{
	if (func_64() != -1)
...
BOOL func_148(int iParam0) // Position - 0x75A8 Hash - 0x3E25647A ^0x3E25647A
{
	if (func_64() != -1)
...
BOOL func_149(int iParam0) // Position - 0x75D8 Hash - 0xF83B91D5 ^0xBF549DB5
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x7684 Hash - 0xECB143B0 ^0x9BF3D063
{
	return Global_1905944.f_22[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_151(int iParam0) // Position - 0x769D Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_152() // Position - 0x76B0 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1905944.f_5694;
}

BOOL func_153(int iParam0, BOOL bParam1) // Position - 0x76BF Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_154(int iParam0) // Position - 0x76F0 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_155(int iParam0) // Position - 0x7706 Hash - 0x8EF26C67 ^0x9855652A
{
	int num;
...
BOOL func_156(int iParam0, int iParam1) // Position - 0x7771 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

Volume func_157(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x7780 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
Vector3 func_158(int iParam0, int iParam1) // Position - 0x783A Hash - 0xFF60DCDC ^0xFF60DCDC
{
	var unk;
...
float func_159(int iParam0, int iParam1) // Position - 0x788A Hash - 0xA6D14BD7 ^0xA6D14BD7
{
	float num;
...
Vector3 func_160() // Position - 0x78D2 Hash - 0x1DA0618A ^0x3E1023AD
{
	return func_204("ATZ_INS_EXC_PA");
}

Vector3 func_161() // Position - 0x78E2 Hash - 0xAD8E497F ^0xAD8E497F
{
	return func_204("ATZ_INS_FUR");
}

Vector3 func_162() // Position - 0x78F1 Hash - 0x23356CB0 ^0x23356CB0
{
	return func_204("ATZ_INS_KLR");
}

Vector3 func_163() // Position - 0x7900 Hash - 0x267EEC70 ^0x267EEC70
{
	return func_204("ATZ_INS_BLD");
}

Vector3 func_164() // Position - 0x790F Hash - 0x8A1588 ^0x8A1588
{
	return func_204("ATZ_INS_BRK");
}

Vector3 func_165() // Position - 0x791E Hash - 0x23FC60D5 ^0x23FC60D5
{
...
float func_169(int iParam0, int iParam1) // Position - 0x79A5 Hash - 0x8C0B8BA2 ^0x8C0B8BA2
{
	switch (iParam0)
	{
		case 0:
...
void func_170(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7AFA Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
Hash func_171() // Position - 0x7BDB Hash - 0x9F572D68 ^0xDAC2FDE8
{
	return 1120746091;
}

BOOL func_172(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7BE8 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_173(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7C11 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_174(Ped pedParam0) // Position - 0x7C2F Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_212(pedParam0, 4) || func_212(pedParam0, 5);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x7C4B Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_177(int iParam0, int iParam1) // Position - 0x7F12 Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x7F45 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x7F9D Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_180(int iParam0, int iParam1) // Position - 0x7FC6 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
Any func_181(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7FEE Hash - 0xF17C3DFA ^0xDAA04130
{
	Any any;
...
void func_182(var uParam0) // Position - 0x8036 Hash - 0xC6A5F393 ^0x3F787E83
{
	int i;
...
void func_183(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x809B Hash - 0xEF5C52D ^0xEF5C52D
{
	int i;
	int num;
...
void func_184() // Position - 0x8129 Hash - 0x18ACD9D3 ^0xB2ADEAB8
{
...
void func_185(int iParam0, int iParam1, BOOL bParam2) // Position - 0x819C Hash - 0xD61623D0 ^0x48AE56A
{
...
void func_186(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x81B8 Hash - 0xF46E0F16 ^0xED4BA72A
{
...
int func_187() // Position - 0x843A Hash - 0x751BAE0C ^0x751BAE0C
{
	return 4;
}

int func_188(int iParam0, int iParam1, int iParam2) // Position - 0x8443 Hash - 0xC76BC009 ^0xD35219B8
{
...
void func_189(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x84E9 Hash - 0x7EFAC478 ^0x4E4217E0
{
	int i;
	int j;
	int k;
...
struct<4> func_190() // Position - 0x8650 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
Hash func_191(Hash hParam0) // Position - 0x865C Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
int func_192(Hash hParam0) // Position - 0x8687 Hash - 0xF4E671A6 ^0x338FA446
{
	Hash category;
...
BOOL func_193(BOOL bParam0) // Position - 0x86B6 Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_64() == -1)
		return true;
...
BOOL func_194(Hash hParam0) // Position - 0x86D4 Hash - 0x1BC045DA ^0x469FDDE1
{
...
BOOL func_195(Hash hParam0) // Position - 0x86F0 Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_196(Hash hParam0, Hash hParam1) // Position - 0x86FE Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
BOOL func_197(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x872F Hash - 0x6FD18E8B ^0x7C3C83FA
{
	var unk;
	var unk5;
	var unk27;
...
void func_198(BOOL bParam0) // Position - 0x8874 Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_199(int iParam0) // Position - 0x889E Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_200(int iParam0) // Position - 0x88D1 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_201(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x8912 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_202(Volume volParam0, BOOL bParam1) // Position - 0x892C Hash - 0xEA796703 ^0x695D7925
{
	Volume volLockRequestId;
	int i;
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0x8994 Hash - 0x7CA5B2D1 ^0x7CA5B2D1
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 1699.4072f, -2006.2827f, 43.6663f;
			
				case 1:
					return 1660.1094f, -1952.4575f, 48.1455f;
			
				case 2:
					return 1644.8298f, -2010.3499f, 44.1345f;
			
				case 3:
					return 1744.5629f, -1972.1001f, 47.7147f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return 1669.6788f, -1924.351f, 49.3638f;
			
				case 1:
					return 1725.3263f, -2005.1621f, 44.8863f;
			
				case 2:
					return 1735.0079f, -1957.8683f, 46.2365f;
			
				case 3:
					return 1662.0934f, -2009.4454f, 46.0268f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return 1648.6091f, -1937.5675f, 51.1467f;
			
				case 1:
					return 1695.9252f, -2006.4094f, 43.6178f;
			
				case 2:
					return 1716.0242f, -1986.0731f, 45.9922f;
			
				case 3:
					return 1667.511f, -1975.5178f, 45.4956f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return 1648.0668f, -1972.5714f, 47.102f;
			
				case 1:
					return 1655.629f, -1994.5321f, 46.2785f;
			
				case 2:
					return 1691.6575f, -1984.1587f, 44.1613f;
			
				case 3:
					return 1679.6224f, -1943.4088f, 47.0856f;
			}
			break;
	}
...
Vector3 func_204(char* sParam0) // Position - 0x8B9B Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_205(Volume volParam0) // Position - 0x8BAD Hash - 0x1D6344D9 ^0x1D6344D9
{
	int i;
...
int func_206(Volume volParam0) // Position - 0x8BD9 Hash - 0x67695E3A ^0xB4A144D5
{
	int i;
...
BOOL func_207(ePedType eptParam0) // Position - 0x8C0E Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_208(Ped pedParam0, Hash hParam1) // Position - 0x9061 Hash - 0xEA1C858E ^0xBEF588D7
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x910B Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_210(Ped pedParam0, BOOL bParam1) // Position - 0x913B Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_211(Ped pedParam0, int iParam1) // Position - 0x9180 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_212(Ped pedParam0, int iParam1) // Position - 0x91A7 Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
void func_213(Volume volParam0, BOOL bParam1) // Position - 0x91E6 Hash - 0xD6642292 ^0x5A7BA218
{
	int num;
...
int func_214() // Position - 0x9209 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_215(int iParam0) // Position - 0x9218 Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

BOOL func_216(int iParam0, int iParam1) // Position - 0x922E Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_217(int iParam0) // Position - 0x9251 Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_218(int iParam0) // Position - 0x9289 Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_215(iParam0))
		return false;
...
void func_219(int iParam0) // Position - 0x92A9 Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_220(int iParam0) // Position - 0x9312 Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

void func_221(int iParam0, int iParam1, BOOL bParam2) // Position - 0x9322 Hash - 0x4464293B ^0x680D2F86
{
...
BOOL func_222(Ped pedParam0) // Position - 0x93A7 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_223(Ped pedParam0) // Position - 0x93D9 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_224(int iParam0, int iParam1) // Position - 0x941B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_225() // Position - 0x942A Hash - 0xEE877ACE ^0xCCE9C802
{
...
int func_226(Hash hParam0, Hash hParam1) // Position - 0x944B Hash - 0x39B5DB67 ^0xD5694E3C
{
	if (hParam1 == 0)
		return 0;
...
int func_227(var uParam0) // Position - 0x9465 Hash - 0xE0B16A5D ^0x1D9BDFB4
{
...
BOOL func_228(Hash hParam0) // Position - 0x94E1 Hash - 0x1B551CF7 ^0xF7F1B098
{
	return func_245(hParam0) == joaat("WEAPON");
}

struct<4> func_229(BOOL bParam0) // Position - 0x94F5 Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
...
BOOL func_230(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3) // Position - 0x958A Hash - 0x4285A587 ^0x4285A587
{
	return func_234(hParam0, *uParam1, hParam2, bParam3) > 0;
}

BOOL func_231(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x95A2 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;
...
BOOL func_232(Hash hParam0, BOOL bParam1) // Position - 0x95C3 Hash - 0x62864AB ^0xBC339691
{
...
BOOL func_233(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x95FC Hash - 0xDE5D4AAC ^0xDB35B0F6
{
	var unk;
	Hash hash;
	var unk6;
...
int func_234(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x9690 Hash - 0xD01EE834 ^0xC97ABD1E
{
	var guid;
	int inventoryItemCountWithGuid;
...
void func_235(BOOL bParam0, int iParam1) // Position - 0x96D8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

void func_236(BOOL bParam0, int iParam1) // Position - 0x96E9 Hash - 0x9815F445 ^0x9815F445
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

int func_237(int iParam0) // Position - 0x96FE Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
BOOL func_238(Ped pedParam0, Hash hParam1) // Position - 0x977F Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x97AD Hash - 0xA54F3032 ^0x62E6F975
{
	Hash _int;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x97FE Hash - 0xA54F3032 ^0x62E6F975
{
	Hash _int;
	int _int2;
...
void func_241(Ped pedParam0) // Position - 0x9870 Hash - 0x446F1BDD ^0x4EF69F51
{
...
BOOL func_242(int iParam0) // Position - 0x988E Hash - 0xDDC0076D ^0xDDC0076D
{
	return Global_1310750.f_16035 && iParam0 != false;
}

BOOL func_243(int iParam0) // Position - 0x98A2 Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_216(iParam0, Global_1310750.f_16072 | 64);
}

void func_244(int iParam0) // Position - 0x98BA Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
int func_245(Hash hParam0) // Position - 0x9947 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_246(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x9972 Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;
...
BOOL func_247(int iParam0) // Position - 0x99B7 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_250(iParam0))
		return false;
...
struct<5> func_248(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x99D3 Hash - 0xE6705E3C ^0xB9EA38F4
{
	var unk;
	var unk6;
	var unk28;
...
Hash func_249(int iParam0, int iParam1) // Position - 0x9C90 Hash - 0xE1D12727 ^0x71D656A6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_250(int iParam0) // Position - 0xBDDA Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_251(int iParam0) // Position - 0xBDED Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
struct<4> func_252(BOOL bParam0) // Position - 0xBE17 Hash - 0x8A689EFF ^0x60C7E77C
{
	int num;
...
BOOL func_253(Hash hParam0, Hash hParam1) // Position - 0xBE7B Hash - 0x1874093C ^0x7F0FACAB
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_254(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBEDA Hash - 0xC40FC7D1 ^0x18789FFF
{
