...
void main() // Position - 0x0 Hash - 0x9864A286 ^0x4513E62
{
	var unk;
	BOOL flag;
	...
	fLocal_11 = 225f;
	iLocal_13 = joaat("META_OUTFIT_DEFAULT");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D9 Hash - 0x4DA9BC8C ^0xA0E8B555
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BCD Hash - 0x175CC470 ^0x36A757FB
{
	int num;
	BOOL flag;

	func_46(uParam0, "SWIMMING_ANIMAL", "", uParam1, uParam4);
	num = 1;
	flag = func_47();
	...
	switch (*uParam0)
	{
		...
		case 219:
			iLocal_9 = joaat("a_c_dogchesbayretriever_01");
			break;
		...
		case 220:
			...
			{
				num = 0;
				iLocal_13 = joaat("META_OUTFIT_ANIMAL_ELK_M_001");
			}
			break;
		...
		case 222:
			...
			{
				num = 0;
				iLocal_13 = joaat("META_OUTFIT_ANIMAL_MOOSE_M_001");
			}
			break;
	
		case 223:
			iLocal_9 = joaat("a_c_muskrat_01");
			break;
	...
	func_48(uParam0, 0, "SAP_ANIMAL", iLocal_9, uParam1, uParam4.f_2, num, 1, 1, 1, iLocal_13, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1D14 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1DB4 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1ECE Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2097 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x20A0 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2250 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x22C4 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2313 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x236B Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24D4 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27FB Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2932 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A62 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2AA1 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2AAA Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2ADC Hash - 0x67E68B94 ^0x67E68B94
{
	func_56(&uLocal_18, false);
...
int func_31(var uParam0) // Position - 0x2B16 Hash - 0xCFD398BA ^0xEC979B96
{
	if (!uParam0->f_469[1])
	{
		if (func_63(uParam0, &uLocal_18, false))
		{
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				iLocal_17 = func_66(joaat("Stand"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, false);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_17, 0, 0, false, true, 0, false, -1082130432, false);
				TASK::_SET_SCENARIO_POINT_FLAG(iLocal_17, 20, true);
		...
		case 1:
			if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848) || func_69(&uLocal_14, 6f))
			{
				func_65(uParam0);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0->f_20[0 /*14*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[0 /*14*/], 0f, 12f, 0f), 1f, -1, 1048576000, 8193, 1193033728);
				iLocal_10 = 3;
			}
			break;
		...
		case 3:
			if (!bLocal_12)
			{
				if (func_70(uParam0->f_20[0 /*14*/], Global_35, true) < fLocal_11)
				{
					func_64(&uParam0->f_20[0 /*14*/], false, true);
					bLocal_12 = true;
				}
			...
			if (!func_71(uParam0->f_20[0 /*14*/], SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
				return 1;
			break;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2C9D Hash - 0x9B6F32A8 ^0x7F508987
{
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2CBE Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2CDB Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2E17 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2F50 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2FFA Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3072 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3101 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x321C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3228 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x33B0 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3450 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3463 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x347D Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x34E5 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
BOOL func_47() // Position - 0x3511 Hash - 0xEE877ACE ^0xCCE9C802
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3532 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35C0 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x37C4 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x37D8 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x37E7 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_73() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3802 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3861 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x38A3 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x38CF Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x394B Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3971 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3993 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x39B5 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x39D7 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_98(iParam0, 4);
	else
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x39F5 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_63(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3A19 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_64(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A73 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_65(var uParam0) // Position - 0x3A9B Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
...
int func_66(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3AE4 Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

void func_67(var uParam0) // Position - 0x3AFE Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_102(uParam0, 0f);
	return;
}

BOOL func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3B0D Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_69(var uParam0, float fParam1) // Position - 0x3D18 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_107(uParam0))
		return false;
...
float func_70(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3D3F Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_111(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_71(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3D96 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_72(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3DEF Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_73() // Position - 0x3F43 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x3F51 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x3FB8 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3FE1 Hash - 0xF40FF0EC ^0xA8B662B4
{
	int i;
...
BOOL func_77(var uParam0, var uParam1, var uParam2) // Position - 0x402E Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_78(int iParam0) // Position - 0x407D Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_79(int iParam0) // Position - 0x40A2 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_80(int iParam0) // Position - 0x40B5 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_81(int iParam0) // Position - 0x40C8 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_82(int iParam0) // Position - 0x40DB Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_83(int iParam0) // Position - 0x40ED Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_84(int iParam0, int iParam1) // Position - 0x40FF Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4199 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_86() // Position - 0x41D1 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_87(int iParam0) // Position - 0x4224 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_90(iParam0))
		return -1;
...
BOOL func_88(int iParam0) // Position - 0x4244 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_89(int iParam0, int iParam1) // Position - 0x425A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_90(int iParam0) // Position - 0x4269 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_91(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x429C Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x437D Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_98(iParam0, 8);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x439D Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_98(iParam0, 16);
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x43C8 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_98(iParam0, 32);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x43E8 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_98(iParam0, 64);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4408 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x442A Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_98(int iParam0, int iParam1) // Position - 0x444E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_99(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x445F Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4A88 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_101(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4B5F Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_102(var uParam0, float fParam1) // Position - 0x4C63 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_103(Ped pedParam0) // Position - 0x4C89 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_104(Ped pedParam0) // Position - 0x4CA4 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_105(float fParam0) // Position - 0x4CC0 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_106(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4D07 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_107(var uParam0) // Position - 0x4D25 Hash - 0x5001E582 ^0x5001E582
{
	return func_162(*uParam0, 1);
}

BOOL func_108(var uParam0, float fParam1) // Position - 0x4D35 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_109(var uParam0) // Position - 0x4D53 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_110(var uParam0) // Position - 0x4D69 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_107(uParam0))
		return uParam0->f_1;
...
float func_111(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4D9E Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_112(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x4DBC Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_113(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4E11 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_114(int iParam0, int iParam1) // Position - 0x4E28 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_115(int iParam0, int iParam1) // Position - 0x4EAE Hash - 0x96B01D2A ^0x81E68218
{
...
void func_116(int iParam0, int iParam1) // Position - 0x4EEA Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_117(int iParam0, int iParam1) // Position - 0x4F3D Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_118(int iParam0, int iParam1) // Position - 0x4F78 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_119(int iParam0, int iParam1) // Position - 0x4FB1 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_120(int iParam0) // Position - 0x4FE9 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_121(BOOL bParam0) // Position - 0x5027 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_122(ePedType eptParam0) // Position - 0x503A Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_123(Ped pedParam0, Hash hParam1) // Position - 0x548D Hash - 0x3FEAF7FA ^0xCFF00939
{
...
void func_124(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5534 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_125(Ped pedParam0, BOOL bParam1) // Position - 0x5564 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_126(Ped pedParam0, int iParam1) // Position - 0x55A9 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_127(int iParam0, BOOL bParam1, int iParam2) // Position - 0x55D0 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_168(iParam2);
...
BOOL func_128(Ped pedParam0, int iParam1) // Position - 0x579B Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_129(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5872 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_130(Ped pedParam0, int iParam1) // Position - 0x58AF Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_131(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5996 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x5A6C Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_133(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5B75 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_134(int iParam0, int iParam1) // Position - 0x5CAA Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_135(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5CE1 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_136(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5DE8 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_137(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5E53 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5F9B Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_139(var uParam0, int iParam1) // Position - 0x6177 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x61EF Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_141(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x621E Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_142(int iParam0, Ped pedParam1) // Position - 0x63A4 Hash - 0xD5889AAA ^0x4F0E5AB5
{
	int _int;
...
BOOL func_143(int iParam0, Ped pedParam1) // Position - 0x63F1 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_195(iParam0))
		return true;
...
BOOL func_144(Ped pedParam0, Ped pedParam1) // Position - 0x648E Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_145() // Position - 0x64DB Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_146(int iParam0, Ped pedParam1) // Position - 0x64E3 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_147() // Position - 0x65A4 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_148() // Position - 0x65C2 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_149(int iParam0, Ped pedParam1) // Position - 0x660F Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_150(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x672B Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_151(Ped pedParam0, int iParam1) // Position - 0x6773 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_152(Ped pedParam0, int iParam1) // Position - 0x69CC Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_205(0))
		return false;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x6A05 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_154(var uParam0, int iParam1) // Position - 0x6A34 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_155(Ped pedParam0, int iParam1) // Position - 0x6A48 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_147() - iParam1->f_4 > func_206(iParam1))
		return func_207(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6A95 Hash - 0x376A0956 ^0xE219C92F
{
...
void func_157(int iParam0) // Position - 0x6AE8 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_158(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6B69 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_159() // Position - 0x6C5A Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_160(var uParam0, int iParam1) // Position - 0x6C8C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_161(var uParam0, int iParam1) // Position - 0x6C9D Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_162(int iParam0, int iParam1) // Position - 0x6CB2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_163(var uParam0) // Position - 0x6CC1 Hash - 0x39705408 ^0x39705408
{
	return func_162(*uParam0, 2);
}

BOOL func_164(Ped pedParam0, Hash hParam1) // Position - 0x6CD1 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_165(Ped pedParam0, Hash hParam1) // Position - 0x6CFF Hash - 0x5F83F21B ^0x23388B0D
{
	Hash _int;
...
BOOL func_166(Ped pedParam0, Hash hParam1) // Position - 0x6D4D Hash - 0x5F83F21B ^0x23388B0D
{
	Hash _int;
	int _int2;
...
void func_167(Ped pedParam0) // Position - 0x6DBB Hash - 0x71821637 ^0xC8B4D939
{
...
void func_168(int iParam0) // Position - 0x6DD7 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_169(int iParam0) // Position - 0x6F43 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_170(BOOL bParam0) // Position - 0x6F56 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_171(int iParam0) // Position - 0x6F70 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_172(int iParam0) // Position - 0x7008 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_173(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x702F Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_174(Ped pedParam0, Ped pedParam1) // Position - 0x7128 Hash - 0xF9959663 ^0xF9959663
{
	return func_196(pedParam0, pedParam1, true, true);
}

float func_175(int iParam0) // Position - 0x713A Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_176(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7146 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x71AB Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_178() // Position - 0x71D1 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_179(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x71E5 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_180(int iParam0) // Position - 0x7345 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_181(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7351 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_182(int iParam0) // Position - 0x73B2 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_183(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x73BE Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7480 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_185(int iParam0) // Position - 0x751E Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_186(int iParam0) // Position - 0x752A Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_187(int iParam0) // Position - 0x7536 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_188(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7673 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_189(Ped pedParam0) // Position - 0x76B6 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_190(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x771C Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_191(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7763 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_192(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x77AE Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_193(Ped pedParam0, var uParam1) // Position - 0x7827 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_194(Ped pedParam0, Ped pedParam1) // Position - 0x7874 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_195(int iParam0) // Position - 0x78BC Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_196(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x78CC Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_197(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7914 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7940 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_199(int iParam0) // Position - 0x7968 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_200(Ped pedParam0) // Position - 0x7974 Hash - 0xF848D5A5 ^0xBBCA652C
{
...
int func_201(Ped pedParam0) // Position - 0x79C8 Hash - 0xEE21DF1B ^0x18ACBF4F
{
...
BOOL func_202(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7A32 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_203(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7BA2 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_204(int iParam0, Ped pedParam1) // Position - 0x7C90 Hash - 0x6D510B9F ^0xFC436894
{
...
BOOL func_205(int iParam0) // Position - 0x7D04 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_222())
		return false;
...
int func_206(int iParam0) // Position - 0x7D26 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_207(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7D32 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_208(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7DAD Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_209() // Position - 0x7E39 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_225())
		return false;
...
void func_210(Any* panParam0, int iParam1) // Position - 0x7E8F Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_211(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7F37 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_212() // Position - 0x7FFE Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_213(int iParam0) // Position - 0x800E Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_214(int iParam0) // Position - 0x80B6 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_215(Ped pedParam0, int iParam1) // Position - 0x811B Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_216(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8132 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_217(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8160 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_218(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x81AA Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_219(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x81EB Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_220(Ped pedParam0) // Position - 0x8264 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_221(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x834C Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_222() // Position - 0x838E Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_212() != -1)
		return false;
...
BOOL func_223(int iParam0, BOOL bParam1) // Position - 0x83B3 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_224(int iParam0) // Position - 0x83E4 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_225() // Position - 0x83F7 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_226(int iParam0) // Position - 0x8428 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_90(iParam0))
		return -1;
...
int func_227(int iParam0) // Position - 0x8444 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_228(int iParam0) // Position - 0x8485 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
