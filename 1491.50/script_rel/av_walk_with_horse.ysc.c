...
void main() // Position - 0x0 Hash - 0xC91ECEDC ^0x73330BA9
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0xFE75CF09
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x9BC7F374 ^0x9BC7F374
{
	func_46(uParam0, "WALK_WITH_HORSE", "", vParam1, uParam4);

	switch (*uParam0)
	{
		case 30:
			uLocal_38[0] = func_48(func_47());
			uLocal_41[0 /*3*/] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1.5f, 0f, 0f) };
			uLocal_48[0] = uParam4.f_2;
			uLocal_38[1] = func_49(joaat("horse_class_riding"), true);
			uLocal_41[1 /*3*/] = { vParam1 };
			uLocal_48[1] = uParam4.f_2;
		
			switch (func_50())
			{
				case 5:
					iLocal_51[0 /*11*/] = 0;
					iLocal_51[0 /*11*/].f_1 = { 2536.9158f, -1474.1237f, 45.058f };
					iLocal_51[1 /*11*/] = 0;
					iLocal_51[1 /*11*/].f_1 = { 2574.4543f, -1465.209f, 45.3529f };
					uLocal_76[0 /*3*/] = { 2680.1711f, -1413.0077f, 45.4999f };
					uLocal_76[1 /*3*/] = { 2680.1711f, -1413.0077f, 45.4999f };
					fLocal_75 = 5f;
					break;
			
				case 76:
					iLocal_51[0 /*11*/] = 0;
					iLocal_51[0 /*11*/].f_1 = { -357.702f, 777.595f, 115.227f };
					iLocal_51[1 /*11*/] = 0;
					iLocal_51[1 /*11*/].f_1 = { -375.986f, 774.763f, 115.194f };
					uLocal_76[0 /*3*/] = { -380.609f, 783.655f, 115.017f };
					uLocal_76[1 /*3*/] = { -392.294f, 780.579f, 114.735f };
					fLocal_75 = 10f;
					break;
			
				case 115:
					iLocal_51[0 /*11*/] = 0;
					iLocal_51[0 /*11*/].f_1 = { -5563.0684f, -2989.8567f, -1.3539f };
					iLocal_51[1 /*11*/] = 0;
					iLocal_51[1 /*11*/].f_1 = { -5539.921f, -3039.7402f, -2.288f };
					uLocal_76[0 /*3*/] = { -5547.972f, -3041.5806f, -2.1309f };
					uLocal_76[1 /*3*/] = { -5542.16f, -3040.9631f, -2.2175f };
					fLocal_75 = 5f;
					break;
			...
			func_51(uParam0, 0, "WWH_MAN", uLocal_38[0], uLocal_41[0 /*3*/], uLocal_48[0], 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_51(uParam0, 1, "WWH_HORSE", uLocal_38[1], uLocal_41[1 /*3*/], uLocal_48[1], 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}
...
Vector3 func_15(var uParam0) // Position - 0x1E66 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1F06 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x2020 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x21E9 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x21F2 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x23A2 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2416 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2465 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x24BD Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2626 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x294D Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2A84 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2BB4 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2BF3 Hash - 0x167062D9 ^0xDA8716C1
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		TASK::TASK_ANIMAL_INTERACTION(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], joaat("Interaction_Brush"), 0, false);
		PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], false);
		iLocal_9 = 1;
		func_59(&uParam0->f_20[0 /*14*/], false, true);
		func_59(&uParam0->f_20[1 /*14*/], false, true);
	}

	return func_60(uParam0->f_20[0 /*14*/], -1057545828);
}

void func_29(var uParam0) // Position - 0x2C74 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2CA6 Hash - 0x67E68B94 ^0x67E68B94
{
...
int func_31(var uParam0) // Position - 0x2CE0 Hash - 0xEB7147AB ^0x24523A74
{
	if (!uParam0->f_469[0])
	{
		if (func_68(uParam0, &uLocal_10, false))
		{
			uParam0->f_469[0] = 1;
	...
	if (!uParam0->f_469[1])
	{
		if (iLocal_9 > 2)
		{
			if (func_71(uParam0, 2f, 80f, 4, joaat("Action"), false))
			{
				func_70(*uParam0, uParam0->f_483, true);
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_9)
	{
		...
		case 2:
			if (!func_60(uParam0->f_20[0 /*14*/], 985146578))
			{
				if (iLocal_74 < iLocal_51)
				{
					if (!_IS_NULL_VECTOR(iLocal_51[iLocal_74 /*11*/].f_1))
					{
						TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
						TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
						TASK::TASK_LEAD_AND_CONVERSE(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], &iLocal_51[iLocal_74 /*11*/], 1, 5f, 2.5f, 1070386381, 1092616192, 1065353216);
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0, 0, -1082130432, -1082130432, 32, 1.5f, -0.5f, 1069547520, 1073741824);
				...
				TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
				TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
				TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(uParam0->f_20[0 /*14*/], uLocal_76[0 /*3*/], 2f, 65000, false, true, false, false);
				TASK::TASK_WANDER_IN_AREA(uParam0->f_20[1 /*14*/], uLocal_76[1 /*3*/], fLocal_75, 1077936128, 1086324736, 1);
...
int func_32(var uParam0, var uParam1) // Position - 0x2F42 Hash - 0x3105A36D ^0x3105A36D
{
	func_73(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F54 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F71 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x30AD Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x31E6 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3290 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3308 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3397 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x34B2 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x34BE Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3646 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x36E6 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36F9 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3713 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x377B Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x37A7 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_48(int iParam0) // Position - 0x37B5 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
Hash func_49(int iParam0, BOOL bParam1) // Position - 0x38A6 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
int func_50() // Position - 0x3960 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

void func_51(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x396E Hash - 0x960D7EB7 ^0x57019BBE
{
	uParam0->f_20[iParam1 /*14*/].f_1 = sParam2;
	uParam0->f_20[iParam1 /*14*/].f_2 = uParam3;
...
BOOL func_52(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x39FC Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_53(int iParam0) // Position - 0x3C00 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_54(int iParam0, int iParam1) // Position - 0x3C14 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_55() // Position - 0x3C23 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_50() != -1;
}

BOOL func_56(var uParam0, Any* panParam1) // Position - 0x3C3E Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_57(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3C9D Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_58(Ped pedParam0) // Position - 0x3CDF Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_59(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D0B Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_60(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3D33 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x3D8C Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3E08 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3E2E Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3E50 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3E72 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3E94 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x3EB8 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
BOOL func_68(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3EDC Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_69(int iParam0, BOOL bParam1) // Position - 0x3F36 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x400F Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_71(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4113 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		fParam2 = func_103(fParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_104(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_105(&(uParam0->f_490)))
							func_106(&(uParam0->f_490), false);
		...
		if (func_105(&(uParam0->f_490)) && !func_107(&(uParam0->f_490)))
...
BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x423C Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
void func_73(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4447 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
float func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x459B Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4602 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x462B Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_77(var uParam0, var uParam1, var uParam2) // Position - 0x4677 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_78(int iParam0) // Position - 0x46C6 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_79(int iParam0) // Position - 0x46EB Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_80(int iParam0) // Position - 0x46FE Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_81(int iParam0) // Position - 0x4711 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_82(int iParam0) // Position - 0x4724 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_83(int iParam0) // Position - 0x4736 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_84(int iParam0, int iParam1) // Position - 0x4748 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x47E2 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_86() // Position - 0x481A Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_87(int iParam0) // Position - 0x486D Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_90(iParam0))
		return -1;
...
BOOL func_88(int iParam0) // Position - 0x488D Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_89(int iParam0, int iParam1) // Position - 0x48A3 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_90(int iParam0) // Position - 0x48B2 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_91(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x48E5 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x49C6 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_99(iParam0, 4);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x49E4 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_99(iParam0, 8);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4A04 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_99(iParam0, 16);
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4A2F Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_99(iParam0, 32);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4A4F Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_99(iParam0, 64);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4A6F Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4A91 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_99(int iParam0, int iParam1) // Position - 0x4AB5 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_100(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4AC6 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_101(int iParam0) // Position - 0x50EF Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_162(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_162(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_162(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_102(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5170 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_103(float fParam0) // Position - 0x5261 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_104(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x52A8 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_163(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_105(var uParam0) // Position - 0x52FF Hash - 0x5001E582 ^0x5001E582
{
	return func_164(*uParam0, 1);
}

void func_106(var uParam0, BOOL bParam1) // Position - 0x530F Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_107(var uParam0) // Position - 0x532F Hash - 0x39705408 ^0x39705408
{
	return func_164(*uParam0, 2);
}

void func_108(var uParam0) // Position - 0x533F Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_105(uParam0);
...
BOOL func_109(var uParam0, float fParam1) // Position - 0x5373 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_105(uParam0))
		return false;
...
void func_110(var uParam0) // Position - 0x539A Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_105(uParam0);
...
BOOL func_111(Ped pedParam0) // Position - 0x53CA Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_112(Ped pedParam0) // Position - 0x53E5 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_113(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5401 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_114(var uParam0) // Position - 0x541F Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_169(uParam0, 0f);
	return;
}

BOOL func_115(var uParam0, float fParam1) // Position - 0x542E Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x544C Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_117(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5462 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_118(BOOL bParam0, var uParam1, var uParam2) // Position - 0x54B7 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_119(int iParam0, int iParam1) // Position - 0x54CE Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_120(int iParam0, int iParam1) // Position - 0x5554 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_121(int iParam0, int iParam1) // Position - 0x5590 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_122(int iParam0, int iParam1) // Position - 0x55E3 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_123(int iParam0, int iParam1) // Position - 0x561E Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_124(int iParam0, int iParam1) // Position - 0x5657 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_125(int iParam0) // Position - 0x568F Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_126(BOOL bParam0) // Position - 0x56CD Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_127(ePedType eptParam0) // Position - 0x56E0 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_128(Ped pedParam0, Hash hParam1) // Position - 0x5B33 Hash - 0x36192D36 ^0xCB9DC11E
{
...
void func_129(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5BDA Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_130(Ped pedParam0, BOOL bParam1) // Position - 0x5C0A Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_131(Ped pedParam0, int iParam1) // Position - 0x5C4F Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_132(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5C76 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_174(iParam2);
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x5E41 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_134(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5F18 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5F55 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_136(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x603C Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x6112 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_138(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x621B Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_139(int iParam0, int iParam1) // Position - 0x6350 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_140(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6387 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x648E Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x64F9 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x6641 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_144(var uParam0, int iParam1) // Position - 0x681D Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x6895 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_146(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x68C4 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_147(int iParam0, Ped pedParam1) // Position - 0x6A4A Hash - 0xD8E45212 ^0xAD284308
{
	int _int;
...
BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x6A97 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_201(iParam0))
		return true;
...
BOOL func_149(Ped pedParam0, Ped pedParam1) // Position - 0x6B34 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_150() // Position - 0x6B81 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x6B89 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_152() // Position - 0x6C4A Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_153() // Position - 0x6C68 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6CB5 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_155(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6DD1 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_156(Ped pedParam0, int iParam1) // Position - 0x6E19 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x7072 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_211(0))
		return false;
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x70AB Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_159(var uParam0, int iParam1) // Position - 0x70DA Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x70EE Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_161(int iParam0, Ped pedParam1) // Position - 0x713B Hash - 0x7E471104 ^0x140B18C2
{
...
void func_162(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x718E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_163(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x721A Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x7238 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_165() // Position - 0x7247 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_166(var uParam0, int iParam1) // Position - 0x7279 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_167(var uParam0) // Position - 0x728E Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_105(uParam0))
		return uParam0->f_1;
...
void func_168(var uParam0, int iParam1) // Position - 0x72C3 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_169(var uParam0, float fParam1) // Position - 0x72D4 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x72FA Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x7328 Hash - 0x1E0CEDC ^0xAB6B8991
{
	Hash _int;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x7376 Hash - 0x1E0CEDC ^0xAB6B8991
{
	Hash _int;
	int _int2;
...
void func_173(Ped pedParam0) // Position - 0x73E4 Hash - 0x21656020 ^0x15F0FAF0
{
...
void func_174(int iParam0) // Position - 0x7400 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_175(int iParam0) // Position - 0x756C Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_176(BOOL bParam0) // Position - 0x757F Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_177(int iParam0) // Position - 0x7599 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_178(int iParam0) // Position - 0x7631 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_179(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7658 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_180(Ped pedParam0, Ped pedParam1) // Position - 0x7751 Hash - 0xF9959663 ^0xF9959663
{
	return func_202(pedParam0, pedParam1, true, true);
}

float func_181(int iParam0) // Position - 0x7763 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_182(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x776F Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x77D4 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_184() // Position - 0x77FA Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_185(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x780E Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_186(int iParam0) // Position - 0x796E Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x797A Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_188(int iParam0) // Position - 0x79DB Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_189(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x79E7 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_190(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7AA9 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_191(int iParam0) // Position - 0x7B47 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_192(int iParam0) // Position - 0x7B53 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_193(int iParam0) // Position - 0x7B5F Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7C9C Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_195(Ped pedParam0) // Position - 0x7CDF Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D45 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D8C Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7DD7 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_199(Ped pedParam0, var uParam1) // Position - 0x7E50 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_200(Ped pedParam0, Ped pedParam1) // Position - 0x7E9D Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_201(int iParam0) // Position - 0x7EE5 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_202(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7EF5 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_203(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7F3D Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7F69 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_205(int iParam0) // Position - 0x7F91 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_206(Ped pedParam0) // Position - 0x7F9D Hash - 0x657D959D ^0x94083F7C
{
...
int func_207(Ped pedParam0) // Position - 0x7FF1 Hash - 0xB247DEFF ^0x4BE01F57
{
...
BOOL func_208(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x805C Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x81CC Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_210(int iParam0, Ped pedParam1) // Position - 0x82BA Hash - 0x3EC9F5AC ^0xAB24AB82
{
...
BOOL func_211(int iParam0) // Position - 0x832E Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_228())
		return false;
...
int func_212(int iParam0) // Position - 0x8350 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x835C Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_214(int iParam0) // Position - 0x83D7 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_215() // Position - 0x83EA Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_216() // Position - 0x83F8 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x844E Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x84F6 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_219(int iParam0) // Position - 0x85BD Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x8665 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_221(Ped pedParam0, int iParam1) // Position - 0x86CA Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x86E1 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_223(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x870F Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_224(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8759 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x879A Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_226(Ped pedParam0) // Position - 0x8813 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_227(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x88FB Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_228() // Position - 0x893D Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_215() != -1)
		return false;
...
BOOL func_229(int iParam0, BOOL bParam1) // Position - 0x8962 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_230() // Position - 0x8993 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x89C4 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_90(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x89E0 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_233(int iParam0) // Position - 0x8A21 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
