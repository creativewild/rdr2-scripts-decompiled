...
void main() // Position - 0x0 Hash - 0xBD9E0328 ^0xD1897147
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	sLocal_10 = "AI_REACT@REACT_LOOK_LAYERS@BASE_EMOTIONS@SCARED";
	sLocal_11 = "direct";
	sLocal_12 = "CREATURES_MAMMAL@BEAR@GRAPPLE@STREAMED_CORE";
	sLocal_13 = "action";
	hLocal_15 = joaat("AR_BEAR_CHALLENGE_SHORT_KILL");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_1(var uParam0) // Position - 0x594 Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x5A2 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x638 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9DF Hash - 0x4DA9BC8C ^0xEC4B5DD7
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9F9 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA10 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xACE Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAF8 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC49 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC5E Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD02 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AB3 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B19 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD3 Hash - 0x7CB4A826 ^0xE142B1B
{
	int num;

	func_46(uParam0, "ANIMAL_ATTACK", "", vParam1, uParam4);

	switch (*uParam0)
	{
		case 36:
			sLocal_12 = "CREATURES_MAMMAL@COUGAR@GRAPPLE@STREAMED_CORE";
			num = joaat("a_c_cougar_01");
			break;
	
		case 45:
			hLocal_15 = joaat("AR_ALLIGATOR_LEG_GRAB_CHALLENGE");
			sLocal_12 = "AMB_CREATURES_REPTILE@GATOR@GRAPPLE@STREAMED_CORE";
			num = joaat("a_c_alligator_01");
			break;
	}

	func_49(uParam0, 0, "AAP_MAN", func_48(func_47(), false, false, false, false, false, true), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "AAP_ANIMAL", num, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 4f, 0f), 180f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C8D Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D2D Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E47 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2010 Hash - 0x44788D42 ^0x753E71BF
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_10) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_12))
		return 0;

	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2034 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21E4 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2258 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22A7 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22FF Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2468 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x278F Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28C6 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29F6 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A35 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A3E Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A70 Hash - 0x1C44123 ^0xC6D37D09
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_10);
	STREAMING::REQUEST_ANIM_DICT(sLocal_12);
	func_57(&uLocal_16, false);
	func_58(&uLocal_16, true);
	func_59(&uLocal_16, true);
...
int func_31(var uParam0) // Position - 0x2ABD Hash - 0x344E1C9B ^0x3331EB97
{
	var args;
	...
	if (!bLocal_14)
	{
		...
		{
			ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_20[1 /*14*/], false);
			bLocal_14 = true;
		}
	}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				func_65(&uParam0->f_20[0 /*14*/], true, true);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 16, true);
			
				if (*uParam0 == 45)
				{
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("weapon_rifle_varmint"), 5000, true, false, 0, false, 1056964608, 1065353216, 752097756, true, 0, false);
					WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], joaat("weapon_rifle_varmint"), true, 0, false, false);
					args.f_1 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[0 /*14*/], 0f, 1f, 0.24f) };
					args.f_4 = -1;
					args.f_6 = 1;
					args.f_7 = 1;
					TASK::TASK_SHOOT_WITH_WEAPON(uParam0->f_20[0 /*14*/], &args);
				}
				else
				{
					WEAPON::REMOVE_ALL_PED_WEAPONS(uParam0->f_20[0 /*14*/], true, true);
					TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_10, sLocal_11, 4f, -4f, -1, 1, 0, false, 0, false, 0, false);
				}
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_66(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 263, true);
				PED::_SET_PED_DESIRED_LOCO_MOTION_TYPE(uParam0->f_20[1 /*14*/], sLocal_13);
				ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_20[1 /*14*/], true);
				...
				func_65(&uParam0->f_20[1 /*14*/], true, true);
			}
		...
		case 1:
			if (func_67(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848) || func_68(uParam0, &uLocal_16, false))
			{
				if (!uParam0->f_469[1])
				{
		...
		case 3:
			if (!uParam0->f_469[2])
			{
				if (func_71(uParam0, 1065353216, 105f, 4, joaat("Action"), false))
				{
			...
			if (!func_73(uParam0->f_20[1 /*14*/], SCRIPT_TASK_PERFORM_SEQUENCE))
			{
				if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					if (*uParam0 == 45)
					{
						if (!func_74(uParam0->f_20[0 /*14*/], Global_35))
						{
							PED::DELETE_PED(&uParam0->f_20[0 /*14*/]);
							PED::DELETE_PED(&uParam0->f_20[1 /*14*/]);
						}
					}
					else
					{
						func_65(&uParam0->f_20[1 /*14*/], false, true);
					}
...
int func_32(var uParam0, var uParam1) // Position - 0x2D6D Hash - 0x11FFAF5F ^0x2B587E06
{
	func_75(uParam0, false, false, false);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DA8 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DC5 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F01 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x303A Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30E4 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x315C Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_77(entityForwardVector, unk5);
	...
	if (func_78(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31EB Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3306 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3312 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x349A Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x353A Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x354D Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3567 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35CF Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x35FB Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3609 Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37FB Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3889 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_90(Global_1898164.f_1[0 /*5*/]);
	
		if (func_91(num) && func_92(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_51(int iParam0) // Position - 0x3A8D Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3AA1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3AB0 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_76() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3ACB Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3B2A Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_94(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_56(Ped pedParam0) // Position - 0x3B6C Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x3B98 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3C14 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3C3A Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3C5C Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3C7E Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3CA0 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3CC4 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_64(int iParam0, BOOL bParam1) // Position - 0x3CE8 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_101(iParam0, 16);
...
void func_65(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D13 Hash - 0x6DE5BABD ^0x14BE368D
{
...
int func_66(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3D3B Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
int func_67(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E32 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_103(Global_35))
		{
			ped = func_104(Global_35);
		...
		num = num * num;
		fParam2 = func_105(fParam2);
		num2 = func_106(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_107(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_108(&(uParam0->f_490)))
							func_109(&(uParam0->f_490));
					
						if (func_110(&(uParam0->f_490), fParam1))
						{
...
int func_68(var uParam0, int iParam1, BOOL bParam2) // Position - 0x403F Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_69(int iParam0, BOOL bParam1) // Position - 0x4099 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_70(var uParam0) // Position - 0x4170 Hash - 0x6896692D ^0x9A71F7A5
{
	int taskSequenceId;

	PED::_SET_PED_DESIRED_LOCO_MOTION_TYPE(uParam0->f_20[1 /*14*/], "default" /*_*/);
	TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);

	if (*uParam0 == 36)
		TASK::TASK_COMBAT_PED(0, uParam0->f_20[0 /*14*/], 0, 0);
	else
		TASK::TASK_GRAPPLE(0, uParam0->f_20[0 /*14*/], hLocal_15, 1, 2f, 0, 0);
...
BOOL func_71(var uParam0, int iParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x420E Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_107(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_108(&(uParam0->f_490)))
						...
						if (func_116(&(uParam0->f_490), iParam1))
							return true;
						else
							return false;
					}
		...
		if (func_108(&(uParam0->f_490)) && !func_114(&(uParam0->f_490)))
...
void func_72(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4337 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
	...
	func_118(iParam0);
	func_119(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

BOOL func_73(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x443B Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
BOOL func_74(Entity eParam0, Ped pedParam1) // Position - 0x4494 Hash - 0xAECB9873 ^0xB730ABFA
{
...
void func_75(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x44CB Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_76() // Position - 0x461F Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_77(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x462D Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4694 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x46BD Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_80(var uParam0, var uParam1, var uParam2) // Position - 0x4709 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_81(int iParam0) // Position - 0x4758 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_82(int iParam0) // Position - 0x477D Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_83(int iParam0) // Position - 0x4790 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_84(int iParam0) // Position - 0x47A3 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_85(int iParam0) // Position - 0x47B6 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_86(int iParam0) // Position - 0x47C8 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_87(int iParam0, int iParam1) // Position - 0x47DA Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4874 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_89() // Position - 0x48AC Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_90(int iParam0) // Position - 0x48FF Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_93(iParam0))
		return -1;
...
BOOL func_91(int iParam0) // Position - 0x491F Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_92(int iParam0, int iParam1) // Position - 0x4935 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_93(int iParam0) // Position - 0x4944 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_94(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4977 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4A58 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_101(iParam0, 4);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4A76 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_101(iParam0, 8);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4A96 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_101(iParam0, 32);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4AB6 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_101(iParam0, 64);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4AD6 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4AF8 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_101(int iParam0, int iParam1) // Position - 0x4B1C Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x4B2D Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_103(Ped pedParam0) // Position - 0x4B56 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_104(Ped pedParam0) // Position - 0x4B71 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_105(float fParam0) // Position - 0x4B8D Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_106(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4BD4 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_107(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4BF2 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_135(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_108(var uParam0) // Position - 0x4C49 Hash - 0x5001E582 ^0x5001E582
{
	return func_136(*uParam0, 1);
}

void func_109(var uParam0) // Position - 0x4C59 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_137(uParam0, 0f);
	return;
}

BOOL func_110(var uParam0, float fParam1) // Position - 0x4C68 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_111(var uParam0) // Position - 0x4C86 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_112(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4C9C Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_113(var uParam0, BOOL bParam1) // Position - 0x52C5 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_114(var uParam0) // Position - 0x52E5 Hash - 0x39705408 ^0x39705408
{
	return func_136(*uParam0, 2);
}

void func_115(var uParam0) // Position - 0x52F5 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_108(uParam0);

	if (func_114(uParam0))
	{
		uParam0->f_1 = func_168() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_169(uParam0, 2);
	}
...
BOOL func_116(var uParam0, int iParam1) // Position - 0x5329 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_108(uParam0))
		return false;
...
void func_117(var uParam0) // Position - 0x5350 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_108(uParam0);

	if (!func_114(uParam0))
	{
		uParam0->f_2 = func_168() - uParam0->f_1;
		func_171(uParam0, 2);
	}
...
void func_118(int iParam0) // Position - 0x5380 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_119(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5401 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_120(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x54F2 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_121(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5547 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_122(int iParam0, int iParam1) // Position - 0x555E Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_123(int iParam0, int iParam1) // Position - 0x55E4 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_124(int iParam0, int iParam1) // Position - 0x5620 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_125(int iParam0, int iParam1) // Position - 0x5673 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_126(int iParam0, int iParam1) // Position - 0x56AE Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_127(int iParam0, int iParam1) // Position - 0x56E7 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_128(int iParam0) // Position - 0x571F Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_129(BOOL bParam0) // Position - 0x575D Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_130(ePedType eptParam0) // Position - 0x5770 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_131(Ped pedParam0, Hash hParam1) // Position - 0x5BC3 Hash - 0x4D6406DD ^0xFCB8AE48
{
...
void func_132(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5C6C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_133(Ped pedParam0, BOOL bParam1) // Position - 0x5C9C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_134(Ped pedParam0, int iParam1) // Position - 0x5CE1 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
float func_135(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5D08 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x5D26 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_137(var uParam0, float fParam1) // Position - 0x5D35 Hash - 0x30433BAB ^0xF854D531
{
...
void func_138(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5D5B Hash - 0x37D64B11 ^0xE7060A9E
{
	func_177(iParam2);
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5F26 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_140(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5FFE Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x603B Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_142(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6122 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x61F8 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_144(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6301 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x6436 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x646D Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6574 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x65DF Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_149(Ped pedParam0, int iParam1) // Position - 0x6727 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_150(var uParam0, int iParam1) // Position - 0x6907 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x697F Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_152(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x69AE Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_153(int iParam0, Ped pedParam1) // Position - 0x6B34 Hash - 0x42A83B1F ^0x5D65D537
{
	int _int;
...
BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6B84 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_204(iParam0))
		return true;
...
BOOL func_155(Ped pedParam0, Ped pedParam1) // Position - 0x6C21 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_156() // Position - 0x6C6E Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6C76 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_158() // Position - 0x6D37 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_159() // Position - 0x6D55 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_160(int iParam0, Ped pedParam1) // Position - 0x6DA2 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_161(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6EBE Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x6F06 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x715F Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_214(0))
		return false;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x7198 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_165(var uParam0, int iParam1) // Position - 0x71C7 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_166(Ped pedParam0, int iParam1) // Position - 0x71DB Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_167(int iParam0, Ped pedParam1) // Position - 0x7228 Hash - 0x2978E171 ^0xA04F2503
{
...
float func_168() // Position - 0x727C Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_169(var uParam0, int iParam1) // Position - 0x72AE Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_170(var uParam0) // Position - 0x72C3 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_108(uParam0))
		return uParam0->f_1;
...
void func_171(var uParam0, int iParam1) // Position - 0x72F8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_172(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7309 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x7395 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x73C3 Hash - 0x294DAA1E ^0x33838EC5
{
	Hash _int;
...
BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x7413 Hash - 0x294DAA1E ^0x33838EC5
{
	Hash _int;
	int _int2;
...
void func_176(Ped pedParam0) // Position - 0x7483 Hash - 0xE2B15D20 ^0xF8A32AD1
{
...
void func_177(int iParam0) // Position - 0x74A0 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_178(int iParam0) // Position - 0x760C Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_179(BOOL bParam0) // Position - 0x761F Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_180(int iParam0) // Position - 0x7639 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_181(int iParam0) // Position - 0x76D3 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_182(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x76FA Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_183(Ped pedParam0, Ped pedParam1) // Position - 0x77F3 Hash - 0xF9959663 ^0xF9959663
{
	return func_205(pedParam0, pedParam1, true, true);
}

float func_184(int iParam0) // Position - 0x7805 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_185(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7811 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_186(int iParam0, BOOL bParam1) // Position - 0x7876 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_187() // Position - 0x789C Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_188(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x78B0 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_189(int iParam0) // Position - 0x7A10 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_190(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7A1C Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_191(int iParam0) // Position - 0x7A7D Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_192(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7A89 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_193(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7B4B Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_194(int iParam0) // Position - 0x7BE9 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_195(int iParam0) // Position - 0x7BF5 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_196(int iParam0) // Position - 0x7C01 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_197(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7D3E Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_198(Ped pedParam0) // Position - 0x7D81 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7DE7 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7E2E Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7E79 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_202(Ped pedParam0, var uParam1) // Position - 0x7EF2 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_203(Ped pedParam0, Ped pedParam1) // Position - 0x7F3F Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_204(int iParam0) // Position - 0x7F87 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_205(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7F97 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_206(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7FDF Hash - 0x58485C45 ^0xD82D930E
{
	float num;
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x800F Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_208(int iParam0) // Position - 0x8037 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_209(Ped pedParam0) // Position - 0x8043 Hash - 0xEB445B10 ^0xBA9AA075
{
...
int func_210(Ped pedParam0) // Position - 0x809B Hash - 0x6E063231 ^0x2C3CF94D
{
...
BOOL func_211(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x810B Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x827B Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_213(int iParam0, Ped pedParam1) // Position - 0x8369 Hash - 0x27FC2906 ^0x5343D19
{
...
BOOL func_214(int iParam0) // Position - 0x83DF Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_231())
		return false;
...
int func_215(int iParam0) // Position - 0x8401 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_216(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x840D Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_217(int iParam0) // Position - 0x8488 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_218() // Position - 0x849B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_219() // Position - 0x84A9 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_233())
		return false;
...
void func_220(Any* panParam0, int iParam1) // Position - 0x84FF Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_221(BOOL bParam0, var uParam1, var uParam2) // Position - 0x85AA Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_222(int iParam0) // Position - 0x8671 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_223(int iParam0) // Position - 0x8719 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_224(Ped pedParam0, int iParam1) // Position - 0x877E Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_225(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8795 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_226(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x87C3 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_227(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x880D Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_228(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x884E Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_229(Ped pedParam0) // Position - 0x88C7 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_230(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x89AF Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_231() // Position - 0x89F1 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_218() != -1)
		return false;
...
BOOL func_232(int iParam0, BOOL bParam1) // Position - 0x8A16 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_233() // Position - 0x8A47 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_234(int iParam0) // Position - 0x8A78 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_93(iParam0))
		return -1;
...
int func_235(int iParam0) // Position - 0x8A94 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_236(int iParam0) // Position - 0x8AD5 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
