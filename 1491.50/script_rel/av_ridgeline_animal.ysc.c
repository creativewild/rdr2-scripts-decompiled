...
void main() // Position - 0x0 Hash - 0x9F28A203 ^0x55EB48B9
{
	var unk;
	BOOL flag;
	...
	iLocal_11 = joaat("META_OUTFIT_DEFAULT");
	hLocal_40 = joaat("world_animal_deer_grazing");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D9 Hash - 0x4DA9BC8C ^0x575F9604
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BCD Hash - 0x3835826F ^0x3E799D6F
{
	int num;
	int num2;

	func_46(uParam0, "RIDGELINE_ANIMAL", "", vParam1, uParam4);
	num = 1;
	num2 = func_47();
	...
	switch (*uParam0)
	{
		case 129:
			...
			hLocal_40 = joaat("world_animal_buffalo_wallow");
			break;
	
		case 178:
			iLocal_9 = joaat("a_c_horse_morgan_bay");
			hLocal_40 = joaat("world_animal_horse_wallow");
			break;
	
		case 183:
			iLocal_9 = joaat("a_c_moose_01");
			hLocal_40 = joaat("world_animal_moose_grazing");
			break;
	
		case 190:
			iLocal_9 = joaat("a_c_pig_01");
			hLocal_40 = joaat("world_animal_pig_roll_mud");
			break;
	
		case 194:
			iLocal_9 = joaat("a_c_raccoon_01");
			hLocal_40 = joaat("world_animal_raccoon_eating_ground");
			break;
		...
		case 203:
			...
			hLocal_40 = joaat("world_animal_elk_grazing");
			num = 0;
			iLocal_11 = joaat("META_OUTFIT_ANIMAL_ELK_M_001");
			break;
		...
		case 204:
			...
			hLocal_40 = joaat("world_animal_moose_grazing");
			num = 0;
			iLocal_11 = joaat("META_OUTFIT_ANIMAL_MOOSE_M_001");
			break;
		...
		case 205:
			...
			if (num2 == 13 || num2 == 14 || num2 == 15 || num2 == 16)
				iLocal_11 = joaat("META_ANIMAL_OUTFIT_PRONGHORNSONOM_001");
			else
				iLocal_11 = joaat("META_ANIMAL_OUTFIT_PRONGHORNM_001");
			break;
	
		case 206:
			iLocal_9 = joaat("a_c_bighornram_01");
			hLocal_40 = joaat("world_animal_ram_grazing");
			num = 0;
		
			if (num2 == 12 || num2 == 1)
				iLocal_11 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAM_001");
			else if (num2 == 13 || num2 == 14 || num2 == 15)
				iLocal_11 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAMDESERT_001");
			else
				iLocal_11 = joaat("META_ANIMAL_OUTFIT_BIGHORNRAMROCKY_001");
			break;
	
		case 207:
			iLocal_9 = joaat("a_c_wolf");
			hLocal_40 = joaat("world_animal_wolf_sniffing_ground");
			break;
	
		case 240:
			iLocal_9 = joaat("a_c_wolf_medium");
			hLocal_40 = joaat("world_animal_wolf_howling_sitting");
			break;
	}

	func_48(uParam0, 0, "RLA_ANIMAL", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), 0f + uParam4.f_2, num, 1, 0, 1, iLocal_11, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1DD7 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1E77 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1F91 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x215A Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2163 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2313 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2387 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x23D6 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x242E Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2597 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x28BE Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x29F5 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2B25 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2B64 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2B6D Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B9F Hash - 0x7F36B2BF ^0x7F36B2BF
{
	func_56(&uLocal_12, false);
	func_57(&uLocal_12, true);
	func_58(&uLocal_12, true);
	func_59(&uLocal_12, true);
	func_60(&uLocal_12, true);
	func_61(&uLocal_12, true);
	func_62(&uLocal_12, 65);
	return 1;
}

int func_31(var uParam0) // Position - 0x2BDA Hash - 0xC192664B ^0x40E9451
{
	if (*uParam0 == 190)
	{
		if (!uParam0->f_469[1])
		{
			if (func_63(uParam0, &uLocal_12, false) || func_64(uParam0->f_20[0 /*14*/], Global_35, true) <= 9f)
			{
				func_65(uParam0);
				func_66(uParam0);
				uParam0->f_469[1] = 1;
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				func_67(&(uParam0->f_20[0 /*14*/].f_5), 50, 10, false);
			
				if (*uParam0 == 129 || *uParam0 == 178 || *uParam0 == 190)
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], hLocal_40, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, true, true, 0, -1082130432, false);
				else
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], hLocal_40, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
		...
		case 1:
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					TASK::SET_PED_PATH_DEEP_SNOW_COST_MODIFIER(uParam0->f_20[0 /*14*/], 0f);
					PED::SET_PED_SHOULD_PLAY_NORMAL_SCENARIO_EXIT(uParam0->f_20[0 /*14*/]);
				
					if (*uParam0 == 129 || *uParam0 == 178)
					{
						func_70(&uLocal_41);
						iLocal_10 = 2;
					}
		...
		case 3:
			if (func_71(&uLocal_41, 5f) && !PED::IS_PED_USING_ANY_SCENARIO(uParam0->f_20[0 /*14*/]))
				return 1;
			break;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2E11 Hash - 0x3105A36D ^0x3105A36D
{
	func_72(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2E23 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2E40 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F7C Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x30B5 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x315F Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x31D7 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3266 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3381 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x338D Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3515 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x35B5 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x35C8 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x35E2 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x364A Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x3676 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3684 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3712 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3916 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x392A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3939 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_73() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3954 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x39B3 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x39F5 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3A21 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3A9D Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3AC3 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3AE5 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3B07 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3B29 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_62(var uParam0, int iParam1) // Position - 0x3B4D Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_63(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3B5B Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_64(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3BB5 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_101(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

void func_65(var uParam0) // Position - 0x3C0C Hash - 0x58B2C83D ^0x44A7FABD
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
...
void func_66(var uParam0) // Position - 0x3C4E Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
...
int func_67(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3C97 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_68(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D8E Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_69(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3DB6 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
void func_70(var uParam0) // Position - 0x3FC1 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_112(uParam0, 0f);
	return;
}

BOOL func_71(var uParam0, float fParam1) // Position - 0x3FD0 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_109(uParam0))
		return false;
...
void func_72(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3FF7 Hash - 0x1332DCB7 ^0xEBAB97D8
{
	int i;
...
int func_73() // Position - 0x414D Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x415B Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x41C2 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x41EB Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_77(var uParam0, var uParam1, var uParam2) // Position - 0x4237 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_78(int iParam0) // Position - 0x4286 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_79(int iParam0) // Position - 0x42AB Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_80(int iParam0) // Position - 0x42BE Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_81(int iParam0) // Position - 0x42D1 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_82(int iParam0) // Position - 0x42E4 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_83(int iParam0) // Position - 0x42F6 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_84(int iParam0, int iParam1) // Position - 0x4308 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x43A2 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_86() // Position - 0x43DA Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_87(int iParam0) // Position - 0x442D Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_90(iParam0))
		return -1;
...
BOOL func_88(int iParam0) // Position - 0x444D Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_89(int iParam0, int iParam1) // Position - 0x4463 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_90(int iParam0) // Position - 0x4472 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_91(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x44A5 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4586 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_99(iParam0, 4);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x45A4 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_99(iParam0, 8);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x45C4 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_99(iParam0, 16);
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x45EF Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_99(iParam0, 32);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x460F Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_99(iParam0, 64);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x462F Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4651 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_99(int iParam0, int iParam1) // Position - 0x4675 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_100(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4686 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_101(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4CAF Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4CCD Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_103(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4DA4 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_104(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x4EA8 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_105(Ped pedParam0) // Position - 0x4ED1 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_106(Ped pedParam0) // Position - 0x4EEC Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_107(float fParam0) // Position - 0x4F08 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_108(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4F4F Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_109(var uParam0) // Position - 0x4F6D Hash - 0x5001E582 ^0x5001E582
{
	return func_161(*uParam0, 1);
}

BOOL func_110(var uParam0, float fParam1) // Position - 0x4F7D Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_111(var uParam0) // Position - 0x4F9B Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_112(var uParam0, float fParam1) // Position - 0x4FB1 Hash - 0x30433BAB ^0xF854D531
{
...
float func_113(var uParam0) // Position - 0x4FD7 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_109(uParam0))
		return uParam0->f_1;
...
BOOL func_114(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x500C Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_115(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5061 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_116(int iParam0, int iParam1) // Position - 0x5078 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_117(int iParam0, int iParam1) // Position - 0x50FE Hash - 0x96B01D2A ^0x81E68218
{
...
void func_118(int iParam0, int iParam1) // Position - 0x513A Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_119(int iParam0, int iParam1) // Position - 0x518D Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_120(int iParam0, int iParam1) // Position - 0x51C8 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_121(int iParam0, int iParam1) // Position - 0x5201 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_122(int iParam0) // Position - 0x5239 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_123(BOOL bParam0) // Position - 0x5277 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_124(ePedType eptParam0) // Position - 0x528A Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_125(Ped pedParam0, Hash hParam1) // Position - 0x56DD Hash - 0xA2B22D80 ^0x4C1F130B
{
...
void func_126(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5784 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_127(Ped pedParam0, BOOL bParam1) // Position - 0x57B4 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_128(Ped pedParam0, int iParam1) // Position - 0x57F9 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_129(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5820 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_170(iParam2);
...
BOOL func_130(Ped pedParam0, int iParam1) // Position - 0x59EB Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_131(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5AC2 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x5AFF Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_133(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5BE6 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x5CBC Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_135(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5DC5 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x5EFA Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_137(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5F31 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_138(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6038 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_139(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x60A3 Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x61EB Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_141(var uParam0, int iParam1) // Position - 0x63C7 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x643F Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_143(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x646E Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_144(int iParam0, Ped pedParam1) // Position - 0x65F4 Hash - 0x335D9D5E ^0xC465B365
{
	int _int;
...
BOOL func_145(int iParam0, Ped pedParam1) // Position - 0x6641 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_197(iParam0))
		return true;
...
BOOL func_146(Ped pedParam0, Ped pedParam1) // Position - 0x66DE Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_147() // Position - 0x672B Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_148(int iParam0, Ped pedParam1) // Position - 0x6733 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_149() // Position - 0x67F4 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_150() // Position - 0x6812 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_151(int iParam0, Ped pedParam1) // Position - 0x685F Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_152(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x697B Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_153(Ped pedParam0, int iParam1) // Position - 0x69C3 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_154(Ped pedParam0, int iParam1) // Position - 0x6C1C Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_207(0))
		return false;
...
BOOL func_155(int iParam0, int iParam1) // Position - 0x6C55 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_156(var uParam0, int iParam1) // Position - 0x6C84 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6C98 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6CE5 Hash - 0x833D86B9 ^0x7598EC12
{
...
void func_159(int iParam0) // Position - 0x6D38 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_160(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6DB9 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x6EAA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_162() // Position - 0x6EB9 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_163(var uParam0, int iParam1) // Position - 0x6EEB Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_164(var uParam0, int iParam1) // Position - 0x6EFC Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_165(var uParam0) // Position - 0x6F11 Hash - 0x39705408 ^0x39705408
{
	return func_161(*uParam0, 2);
}

BOOL func_166(Ped pedParam0, Hash hParam1) // Position - 0x6F21 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_167(Ped pedParam0, Hash hParam1) // Position - 0x6F4F Hash - 0x435DC421 ^0x9CB693B5
{
	Hash _int;
...
BOOL func_168(Ped pedParam0, Hash hParam1) // Position - 0x6F9D Hash - 0x435DC421 ^0x9CB693B5
{
	Hash _int;
	int _int2;
...
void func_169(Ped pedParam0) // Position - 0x700B Hash - 0xA3934F57 ^0x5B33C0AA
{
...
void func_170(int iParam0) // Position - 0x7027 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_171(int iParam0) // Position - 0x7193 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_172(BOOL bParam0) // Position - 0x71A6 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_173(int iParam0) // Position - 0x71C0 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_174(int iParam0) // Position - 0x7258 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_175(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x727F Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_176(Ped pedParam0, Ped pedParam1) // Position - 0x7378 Hash - 0xF9959663 ^0xF9959663
{
	return func_198(pedParam0, pedParam1, true, true);
}

float func_177(int iParam0) // Position - 0x738A Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_178(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7396 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x73FB Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_180() // Position - 0x7421 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_181(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7435 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_182(int iParam0) // Position - 0x7595 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_183(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x75A1 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_184(int iParam0) // Position - 0x7602 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_185(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x760E Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_186(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x76D0 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_187(int iParam0) // Position - 0x776E Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_188(int iParam0) // Position - 0x777A Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_189(int iParam0) // Position - 0x7786 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_190(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x78C3 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_191(Ped pedParam0) // Position - 0x7906 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_192(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x796C Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_193(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x79B3 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_194(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x79FE Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_195(Ped pedParam0, var uParam1) // Position - 0x7A77 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_196(Ped pedParam0, Ped pedParam1) // Position - 0x7AC4 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_197(int iParam0) // Position - 0x7B0C Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_198(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7B1C Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_199(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7B64 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7B90 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_201(int iParam0) // Position - 0x7BB8 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_202(Ped pedParam0) // Position - 0x7BC4 Hash - 0x8BD89C8F ^0x771F9FB7
{
...
int func_203(Ped pedParam0) // Position - 0x7C18 Hash - 0x91E6E98 ^0x10ECB567
{
...
BOOL func_204(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7C82 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_205(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7DF2 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_206(int iParam0, Ped pedParam1) // Position - 0x7EE0 Hash - 0x7E28833C ^0x24644579
{
...
BOOL func_207(int iParam0) // Position - 0x7F54 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_224())
		return false;
...
int func_208(int iParam0) // Position - 0x7F76 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7F82 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_210(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7FFD Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_211() // Position - 0x808C Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_227())
		return false;
...
void func_212(Any* panParam0, int iParam1) // Position - 0x80E2 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_213(BOOL bParam0, var uParam1, var uParam2) // Position - 0x818A Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_214() // Position - 0x8251 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_215(int iParam0) // Position - 0x825F Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_216(int iParam0) // Position - 0x8307 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_217(Ped pedParam0, int iParam1) // Position - 0x836C Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_218(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8383 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_219(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x83B1 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_220(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x83FB Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_221(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x843C Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_222(Ped pedParam0) // Position - 0x84B5 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_223(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x859D Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_224() // Position - 0x85DF Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_214() != -1)
		return false;
...
BOOL func_225(int iParam0, BOOL bParam1) // Position - 0x8604 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_226(int iParam0) // Position - 0x8635 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_227() // Position - 0x8648 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_228(int iParam0) // Position - 0x8679 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_90(iParam0))
		return -1;
...
int func_229(int iParam0) // Position - 0x8695 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_230(int iParam0) // Position - 0x86D6 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
