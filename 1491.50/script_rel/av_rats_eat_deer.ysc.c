...
void main() // Position - 0x0 Hash - 0xC21F1F42 ^0xD0640723
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9EC Hash - 0x4DA9BC8C ^0xB1C18DB0
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BE0 Hash - 0xFA20A040 ^0xE7E172E8
{
	func_46(uParam0, "RATS_EAT_DEER", "", vParam1, uParam4);
	iLocal_9 = joaat("a_m_m_unicorpse_01");
	sLocal_13 = "AI_DAMAGE@DEAD@BASE";
	sLocal_14 = "Dead_D";
	func_47(uParam0, 0, "RE1_DEER", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "RE1_RAT_1", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.329f, -0.23f, 0f), 15f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "RE1_RAT_2", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.51f, 0.309f, 0f), 87f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "RE1_RAT_3", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.51f, 0.04f, 0f), 98f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "RE1_RAT_4", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.15f, 0.745f, 0f), 115f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 5, "RE1_RAT_5", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -0.265f, 0.84f, 0f), 230f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "RE1_RAT_6", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -0.342f, 0.128f, 0f), -90f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 7, "RE1_RAT_7", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -0.63f, 0.77f, 0f), -90f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 8, "RE1_VULTURE_1", iLocal_11, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, 0f, 25f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 9, "RE1_VULTURE_2", iLocal_11, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 23f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1E1B Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1EBB Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1FD5 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x219E Hash - 0x92ED3FDF ^0xD78BADED
{
...
BOOL func_19(var uParam0) // Position - 0x21C5 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2375 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x23E9 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2438 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2490 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x25F9 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2920 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2A57 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2B87 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2BC6 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2BCF Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2C01 Hash - 0xD4B75367 ^0x13501F11
{
...
int func_31(var uParam0) // Position - 0x2C3A Hash - 0x34392944 ^0x83A0DA13
{
	int i;
	BOOL flag;
	var unk;
	...
	switch (iLocal_12)
	{
		case 0:
			...
			{
				iLocal_19 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1f, 1, 36, 0);
				iLocal_20 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1.5f, 2, -1, 0);
			
				for (i = 1; i <= 7; i = i + 1)
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
					{
						ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[i /*14*/], uParam0->f_20[0 /*14*/], false);
						ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[i /*14*/], false);
						func_62(&(uParam0->f_20[i /*14*/].f_5), 50, 10, false);
						TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[i /*14*/], joaat("world_animal_rat_eating"), uParam0->f_20[i /*14*/].f_5, uParam0->f_20[i /*14*/].f_8, 0, false, true, 0, -1082130432, false);
						func_63(&uParam0->f_20[i /*14*/], true, true);
					}
				}
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]) && ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				else if (func_64(uParam0, 1065353216, 10f, 5, 1109393408, 1112014848))
				{
					flag = true;
				}
				else
				{
					for (i = 0; i < 10; i = i + 1)
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
						{
							if (func_65(uParam0->f_20[i /*14*/], 0, &uLocal_21, &unk, 0, 0))
							{
								flag = true;
								break;
							}
		...
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_49 /*14*/]))
			{
				...
				{
					func_63(&uParam0->f_20[iLocal_49 /*14*/], false, true);
					...
					TASK::TASK_FLEE_PED(uParam0->f_20[iLocal_49 /*14*/], Global_35, 3, 0, -1082130432, -1, 0);
...
int func_32(var uParam0, var uParam1) // Position - 0x2F7E Hash - 0xB5FF068 ^0xEBA69FB7
{
	int i;
	...
	for (i = 0; i < uParam0->f_19; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[i /*14*/]))
		{
			if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uParam0->f_20[i /*14*/], true))
			{
				...
				if (!uParam0->f_469[0] && i == 0)
					PED::DELETE_PED(&uParam0->f_20[i /*14*/]);
				else
	...
	if (iLocal_19 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_19, 1);

	if (iLocal_20 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_20, 1);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x303A Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x3057 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3193 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x32CC Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3376 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x33EE Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x347D Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3598 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x35A4 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x372C Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x37CC Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x37DF Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x37F9 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3861 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x388D Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_48(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x391B Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3972 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3B76 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3B8A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3B99 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_70() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3BB4 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3C13 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3C55 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3C81 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3CFD Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3D23 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3D45 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3D67 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3D89 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
int func_62(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3DAD Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_63(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3EA4 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_64(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3ECC Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (num3 < fParam2 * fParam2)
				{
					if (PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_106(&(uParam0->f_490), iParam1))
						{
							func_107(&(uParam0->f_490));
							return true;
						}
...
BOOL func_65(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x40DA Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_66(int iParam0, BOOL bParam1) // Position - 0x4703 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_67(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x47DA Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_68(var uParam0) // Position - 0x48DE Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_139(uParam0, 0f);
	return;
}

BOOL func_69(var uParam0, int iParam1) // Position - 0x48ED Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_105(uParam0))
		return false;
...
int func_70() // Position - 0x4914 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_71(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4922 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_72(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4989 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x49B2 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_141(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_74(var uParam0, var uParam1, var uParam2) // Position - 0x49FE Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_141(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_75(int iParam0) // Position - 0x4A4D Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_76(int iParam0) // Position - 0x4A72 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_77(int iParam0) // Position - 0x4A85 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_78(int iParam0) // Position - 0x4A98 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_79(int iParam0) // Position - 0x4AAB Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_80(int iParam0) // Position - 0x4ABD Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_81(int iParam0, int iParam1) // Position - 0x4ACF Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4B69 Hash - 0xA65AB937 ^0xA65AB937
{
	func_143(iParam0, iParam6);
	func_144(iParam0, iParam5);
	func_145(iParam0, iParam4);
	func_146(iParam0, iParam3);
	func_147(iParam0, iParam2);
	func_148(iParam0, iParam1);
	return;
}

float func_83(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4BA1 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_149(entityCoords, vParam1);
}

void func_84(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4BF1 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_141(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_85() // Position - 0x4CE2 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_86(int iParam0) // Position - 0x4D35 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_89(iParam0))
		return -1;

	return func_151(func_150(iParam0));
}

BOOL func_87(int iParam0) // Position - 0x4D55 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_88(int iParam0, int iParam1) // Position - 0x4D6B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_89(int iParam0) // Position - 0x4D7A Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_90(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4DAD Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x4E8E Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_98(iParam0, 4);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4EAC Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_98(iParam0, 8);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4ECC Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_98(iParam0, 16);
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4EF7 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_98(iParam0, 32);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4F17 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_98(iParam0, 64);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4F37 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4F59 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_98(int iParam0, int iParam1) // Position - 0x4F7D Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_99(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x4F8E Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_100(Ped pedParam0) // Position - 0x4FB7 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_101(Ped pedParam0) // Position - 0x4FD2 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_102(float fParam0) // Position - 0x4FEE Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5035 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_104(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x5053 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_149(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_105(var uParam0) // Position - 0x50AA Hash - 0x5001E582 ^0x5001E582
{
	return func_157(*uParam0, 1);
}

BOOL func_106(var uParam0, int iParam1) // Position - 0x50BA Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_107(var uParam0) // Position - 0x50D8 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_108(int iParam0, BOOL bParam1, int iParam2) // Position - 0x50EE Hash - 0x37D64B11 ^0xE7060A9E
{
	func_158(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_160(true))
							func_98(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_160(true) || *iParam0 & 8192 != 0)
...
BOOL func_109(Ped pedParam0, int iParam1) // Position - 0x52B9 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_163(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_164(pedParam0, pedIndexFromEntityIndex) <= func_165(iParam1))
				return true;
			break;
	}
...
void func_110(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5390 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_166(iParam2, 1, 1, 1, 0))
		func_98(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_167(iParam1, true);
	func_168();
	return;
}

BOOL func_111(Ped pedParam0, int iParam1) // Position - 0x53CD Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	{
		if (func_169(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			num2 = func_170(iParam1);
		
			if (func_171(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_172(iParam1);
...
BOOL func_112(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x54B4 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_173(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_170(iParam2);
	
		if (func_171(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_172(iParam2))
				{
					func_167(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_113(Ped pedParam0, int iParam1) // Position - 0x558A Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_163(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_172(iParam1))
		{
			customDistance = func_170(iParam1);
...
BOOL func_114(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5693 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_174(bParam1, bParam2, bParam3);
...
BOOL func_115(int iParam0, int iParam1) // Position - 0x57C8 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_116(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x57FF Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_117(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5906 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_176(iParam2))
	{
...
BOOL func_118(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5971 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_178(pedParam1, entityCoords, outCoords))
					{
						func_167(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_178(pedParam1, entityCoords, outCoords2))
					{
						func_167(iParam2, true);
						return true;
					}
...
BOOL func_119(Ped pedParam0, int iParam1) // Position - 0x5AB9 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_163(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_179(Global_1935630.f_34[i]);
			...
			if (func_180(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_181(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_182(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_120(var uParam0, int iParam1) // Position - 0x5C96 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_121(int iParam0, int iParam1) // Position - 0x5D0E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_122(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5D3D Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_123(int iParam0, Ped pedParam1) // Position - 0x5EC3 Hash - 0x42A83B1F ^0xC3E0C1D4
{
	int _int;
...
BOOL func_124(int iParam0, Ped pedParam1) // Position - 0x5F13 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_185(iParam0))
		return true;
...
BOOL func_125(Ped pedParam0, Ped pedParam1) // Position - 0x5FB0 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_126() // Position - 0x5FFD Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_127(int iParam0, Ped pedParam1) // Position - 0x6005 Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_187(vehiclePedIsUsing, pedParam1, entityCoords))
		{
...
int func_128() // Position - 0x60C6 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_129() // Position - 0x60E4 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_130(int iParam0, Ped pedParam1) // Position - 0x6131 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_189(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_190(pedParam1);
	num2 = func_191(iParam0->f_14);
...
BOOL func_131(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x624D Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_192(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x6295 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_193(pedParam0, iParam1, true))
			return true;
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x64EE Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_195(0))
		return false;
...
BOOL func_134(int iParam0, int iParam1) // Position - 0x6527 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_135(var uParam0, int iParam1) // Position - 0x6556 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x656A Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_128() - iParam1->f_4 > func_196(iParam1))
		return func_197(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_137(int iParam0, Ped pedParam1) // Position - 0x65B7 Hash - 0x63E2B24C ^0x6A544491
{
...
void func_138(int iParam0) // Position - 0x660A Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_198(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_198(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_198(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_139(var uParam0, float fParam1) // Position - 0x668B Hash - 0x30433BAB ^0xF854D531
{
...
float func_140(var uParam0) // Position - 0x66B1 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_105(uParam0))
		return uParam0->f_1;
...
BOOL func_141(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x66E6 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_142(BOOL bParam0, var uParam1, var uParam2) // Position - 0x673B Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_143(int iParam0, int iParam1) // Position - 0x6752 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_144(int iParam0, int iParam1) // Position - 0x67D8 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_145(int iParam0, int iParam1) // Position - 0x6814 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_146(int iParam0, int iParam1) // Position - 0x6867 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_147(int iParam0, int iParam1) // Position - 0x68A2 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_148(int iParam0, int iParam1) // Position - 0x68DB Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
float func_149(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6913 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_150(int iParam0) // Position - 0x6931 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_151(BOOL bParam0) // Position - 0x696F Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_152(ePedType eptParam0) // Position - 0x6982 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_153(Ped pedParam0, Hash hParam1) // Position - 0x6DD5 Hash - 0xEA1C858E ^0x2FA997A9
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_154(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6E7F Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_155(Ped pedParam0, BOOL bParam1) // Position - 0x6EAF Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_156(Ped pedParam0, int iParam1) // Position - 0x6EF4 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x6F1B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_158(int iParam0) // Position - 0x6F2A Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_208(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_159(int iParam0) // Position - 0x7096 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_160(BOOL bParam0) // Position - 0x70A9 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_209(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_161(int iParam0) // Position - 0x70C3 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_162(int iParam0) // Position - 0x715D Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_163(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7184 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_191(pedParam2);
	else
		num2 = func_190(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_191(pedParam0);
	else
...
float func_164(Ped pedParam0, Ped pedParam1) // Position - 0x727D Hash - 0xF9959663 ^0xF9959663
{
	return func_186(pedParam0, pedParam1, true, true);
}

float func_165(int iParam0) // Position - 0x728F Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_166(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x729B Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_167(int iParam0, BOOL bParam1) // Position - 0x7300 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_168() // Position - 0x7326 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_169(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x733A Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_213(ped, 0)))
			if (func_214(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_170(int iParam0) // Position - 0x749A Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_171(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x74A6 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_172(int iParam0) // Position - 0x7507 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_173(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7513 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_213(ped, 0)))
			if (func_215(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_174(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x75D5 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_175(int iParam0) // Position - 0x7673 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_176(int iParam0) // Position - 0x767F Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_177(int iParam0) // Position - 0x768B Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_178(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x77C8 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_216(pedParam0, vParam4, 0.5f))
...
BOOL func_179(Ped pedParam0) // Position - 0x780B Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_217(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_180(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7871 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_181(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78B8 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_182(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7903 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_183(Ped pedParam0, var uParam1) // Position - 0x797C Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_184(Ped pedParam0, Ped pedParam1) // Position - 0x79C9 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_185(int iParam0) // Position - 0x7A11 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_186(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7A21 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_187(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7A69 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_188(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7A95 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_189(int iParam0) // Position - 0x7ABD Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_190(Ped pedParam0) // Position - 0x7AC9 Hash - 0xC117A407 ^0xE7130731
{
...
int func_191(Ped pedParam0) // Position - 0x7B1F Hash - 0xE9E642C3 ^0x4665A5CF
{
...
BOOL func_192(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7B8B Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_193(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7CFB Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_209(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_194(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_194(iParam1, ped2))
...
BOOL func_194(int iParam0, Ped pedParam1) // Position - 0x7DE9 Hash - 0x27FC2906 ^0xB016F433
{
...
BOOL func_195(int iParam0) // Position - 0x7E5F Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_220())
		return false;
...
int func_196(int iParam0) // Position - 0x7E81 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_197(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7E8D Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_198(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7F08 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_199() // Position - 0x7F94 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_200(var uParam0, int iParam1) // Position - 0x7FC6 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_201(var uParam0, int iParam1) // Position - 0x7FD7 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_202(var uParam0) // Position - 0x7FEC Hash - 0x39705408 ^0x39705408
{
	return func_157(*uParam0, 2);
}

BOOL func_203(Ped pedParam0, Hash hParam1) // Position - 0x7FFC Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_204(Ped pedParam0, Hash hParam1) // Position - 0x802E Hash - 0xA54F3032 ^0xC26E6963
{
	Hash _int;
...
BOOL func_205(Ped pedParam0, Hash hParam1) // Position - 0x807F Hash - 0xA54F3032 ^0xC26E6963
{
	Hash _int;
	int _int2;
...
void func_206(Ped pedParam0) // Position - 0x80F1 Hash - 0x446F1BDD ^0xF8B55536
{
...
BOOL func_207() // Position - 0x810F Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_223())
		return false;
...
void func_208(Any* panParam0, int iParam1) // Position - 0x8165 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_209(BOOL bParam0, var uParam1, var uParam2) // Position - 0x820D Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_210() // Position - 0x82D4 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_211(int iParam0) // Position - 0x82E2 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_212(int iParam0) // Position - 0x838A Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_213(Ped pedParam0, int iParam1) // Position - 0x83EF Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_214(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8406 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_215(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_215(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8434 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_216(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x847E Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_217(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x84BF Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_218(Ped pedParam0) // Position - 0x8538 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_219(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8620 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_220() // Position - 0x8662 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_210() != -1)
		return false;
...
BOOL func_221(int iParam0, BOOL bParam1) // Position - 0x8687 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_222(int iParam0) // Position - 0x86B8 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_223() // Position - 0x86CB Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_224(int iParam0) // Position - 0x86FC Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_89(iParam0))
		return -1;
...
int func_225(int iParam0) // Position - 0x8718 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_226(int iParam0) // Position - 0x8759 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
