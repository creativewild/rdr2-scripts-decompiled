...
BOOL func_15(eStackSize essParam0) // Position - 0x7EA Hash - 0xC12ECF0C ^0xA1B93E27
{
	return func_48(&uLocal_14, 4096, &uLocal_14, func_46(), 0, func_47(), false, 0, false);
}
...
int func_46() // Position - 0xD8C Hash - 0xD3EC590A ^0xD3EC590A
{
	return 103;
}
...
void func_62(eStackSize essParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11A7 Hash - 0x28183E5C ^0x2F73749A
{
	BOOL flag;
	const char* str;
	char* str2;
...
char* func_107(int iParam0) // Position - 0x3F62 Hash - 0x21CE226B ^0x24F4747D
{
	switch (iParam0)
	{
		case 0:
...
const char* func_114(var uParam0, int iParam1) // Position - 0x4072 Hash - 0xB0CFF0C3 ^0x4639699D
{
...
int func_132(int iParam0) // Position - 0x45B2 Hash - 0xAC39A336 ^0xDF4F13BE
{
	int i;
...
const char* func_160(int iParam0) // Position - 0x4B7E Hash - 0xE6862179 ^0x62DB04D1
{
	switch (iParam0)
	{
		case 0:
...
const char* func_163(const char* sParam0, int iParam1) // Position - 0x4EA8 Hash - 0x9E99F03 ^0xA68447D8
{
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x4FCB Hash - 0x2F9EB0B9 ^0xF5424734
{
	char* ambientZone;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x4FFF Hash - 0x342D57CF ^0x6264772B
{
	switch (iParam0)
	{
		case 5:
