...
BOOL func_32(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xE4F Hash - 0x97FFFA7E ^0x97FFFA7E
{
	var unk;
	int num;
	int num2;
	...
	if (!func_58(true, uParam0, -1, func_57(iLocal_14, false, false, 0)))
		return false;
	...
	if (SCRIPTS::DOES_SCRIPT_WITH_NAME_HASH_EXIST(-777113702) && SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(-777113702) > 0)
		if (!func_51(uParam0, -1165.043f, 91.94646f, 43.90535f, 10f, false))
			return false;

	switch (iLocal_14)
	{
		case 9:
			if (func_51(uParam0, -1712.438f, 606.3528f, 117.7065f, 10f, false))
				return false;
			break;
	
		case 11:
			if (func_51(uParam0, 1504.914f, -1469.925f, 71.38271f, 10f, false))
				return false;
			break;
	}
	...
	{
		func_61(func_60(), &unk, &num, &num2, &num3, &num4, &num5);
	...
	if (!func_63(func_5(), uParam0))
		return false;

	if (!func_64(-1))
		return false;
	else if (!func_64(func_57(iLocal_14, false, false, 0)))
		return false;
	else if (!func_65(func_57(iLocal_14, false, false, 0)))
		return false;

	if (func_67(uParam0, func_66(iLocal_14), 4, 1))
		return false;

	if (func_67(uParam0, func_68(iLocal_14), 2, 1))
		return false;
...
BOOL func_33(var uParam0, var uParam1, var uParam2) // Position - 0x10ED Hash - 0x425D0DCF ^0xC16E757F
{
	int i;
...
BOOL func_34(int iParam0, BOOL bParam1) // Position - 0x1132 Hash - 0xBF0AA8E4 ^0x648F878F
{
	if (func_72(PLAYER::PLAYER_ID(), false, true, true))
		return true;
...
BOOL func_35(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1178 Hash - 0x3F4C1B1 ^0x898E9E6F
{
	var unk;
	var unk6;
...
BOOL func_36(int iParam0) // Position - 0x11C5 Hash - 0xDA17D690 ^0x72CE747C
{
	...
	flag = func_73(iParam0, distanceBetweenCoords, true);
...
BOOL func_37(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x1215 Hash - 0x6F7F60E3 ^0x4D5C0076
{
	int i;
	float distanceBetweenCoords;
	int num;
...
BOOL func_38(var uParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x1298 Hash - 0xD2772B65 ^0xB64779B1
{
...
int func_39(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x131E Hash - 0x56F0811C ^0x278FB5A
{
	return func_76(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

int func_40(int iParam0) // Position - 0x1334 Hash - 0xEF86270 ^0xEF86270
{
	int num;

	num = func_57(iParam0, func_56(), false, 0);
	return func_77(num);
}

float func_41(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1350 Hash - 0x45282B7 ^0x45282B7
{
	if (bParam2)
		return 200f;
...
BOOL func_42(int iParam0, int iParam1) // Position - 0x13B0 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_43() // Position - 0x13BF Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return 0;
}

void func_44(int iParam0, int iParam1) // Position - 0x13C8 Hash - 0x3095F76B ^0x9DAA87F4
{
...
int func_45() // Position - 0x13EE Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_46(int iParam0, int iParam1) // Position - 0x13FC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_47(const char* sParam0) // Position - 0x140B Hash - 0x2124511C ^0xA40AAA4F
{
	int i;
...
void func_48(int iParam0) // Position - 0x1445 Hash - 0x22E7EDA ^0x22E7EDA
{
...
int func_49(int iParam0) // Position - 0x145C Hash - 0xCEAC22E5 ^0x1F8567CD
{
	int num;

	num = Global_1393237.f_11[iParam0 /*30*/];
	func_79(&num, 0, 0, 0, 1, 0, 0, false);
	return num;
}

BOOL func_50(int iParam0) // Position - 0x147F Hash - 0x83DD6E97 ^0x83DD6E97
{
	return Global_1899515 > iParam0;
}

BOOL func_51(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0x148E Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_52(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x14E3 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_53(Volume volParam0, BOOL bParam1) // Position - 0x14FD Hash - 0xEA796703 ^0x695D7925
{
	Volume volLockRequestId;
	int i;
...
int func_54(var uParam0, var uParam1, var uParam2) // Position - 0x1565 Hash - 0xAE09E622 ^0xD3E09CA
{
	int i;
...
int func_55(BOOL bParam0) // Position - 0x15B0 Hash - 0x7F08FD3B ^0xE97B69AA
{
	int num;
	...
	PED::GET_GROUP_SIZE(func_81(), &hasLeader, &numberOfFollowers);
	...
	{
		pedAsGroupMember = PED::GET_PED_AS_GROUP_MEMBER(func_81(), i);
	
		if (func_82(pedAsGroupMember))
			num = num + 1;
	}
...
BOOL func_56() // Position - 0x1610 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_1() != -1)
		return false;
...
int func_57(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x1635 Hash - 0x338ECF1A ^0x338ECF1A
{
	BOOL flag;
...
BOOL func_58(BOOL bParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0x16ED Hash - 0x66339389 ^0xE008D891
{
	BOOL flag;
	...
	{
		if (Global_1393237 != 0 && MISC::GET_GAME_TIMER() - Global_1393237 < func_85())
			return false;
...
BOOL func_59(int iParam0) // Position - 0x17D9 Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
	...
	num3 = func_88(iParam0);

	if (num3 < 0 || num3 > 23)
		return false;

	num4 = func_89(iParam0);
	...
	num6 = func_91(iParam0);

	if (num6 < 1 || num6 > func_92(num5, num4))
		return false;

	return true;
}

int func_60() // Position - 0x18B5 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_61(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x18C1 Hash - 0x2BEE335D ^0x2BEE335D
{
	func_93(func_60(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

BOOL func_62() // Position - 0x18DF Hash - 0x9DDBD4E1 ^0xED0D5A96
{
...
BOOL func_63(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x18FD Hash - 0xC96F6CDF ^0x22B81542
{
	float num;
	BOOL flag;
...
BOOL func_64(int iParam0) // Position - 0x1925 Hash - 0xDA16D62F ^0x3835782C
{
	float num;
	BOOL num2;
...
BOOL func_65(int iParam0) // Position - 0x1962 Hash - 0x23038E2B ^0x15811C53
{
	if (func_95(iParam0, false))
...
float func_66(int iParam0) // Position - 0x198E Hash - 0x9EEAC446 ^0x9EEAC446
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_67(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5) // Position - 0x19B1 Hash - 0x43EBD5CA ^0x361FC829
{
	if (_IS_NULL_VECTOR(vParam0))
		return false;
...
float func_68(int iParam0) // Position - 0x19D9 Hash - 0x9EEAC446 ^0x9EEAC446
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_69() // Position - 0x19FC Hash - 0x8650DF77 ^0x8650DF77
{
	return Global_1310750.f_16077 != 0;
}

BOOL func_70() // Position - 0x1A0D Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_71(int iParam0) // Position - 0x1A16 Hash - 0xBF1DF5C6 ^0xEDF16C34
{
	if (!func_95(iParam0, false))
		return false;
...
BOOL func_72(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A3B Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_73(int iParam0, float fParam1, BOOL bParam2) // Position - 0x1B70 Hash - 0x6B37C385 ^0x70086738
{
	if (fParam1 < 180f)
	{
...
BOOL func_74(int iParam0) // Position - 0x1BDA Hash - 0x74D4CFB3 ^0x928B84E
{
	if (iParam0 < 0 || iParam0 > Global_1393237.f_11)
		return false;
...
BOOL func_75(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1C0A Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_99(Global_1898164.f_1[0 /*5*/]);
	
		if (func_100(num) && func_101(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_76(Hash hParam0) // Position - 0x1E0E Hash - 0x50573299 ^0x50573299
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_77(int iParam0) // Position - 0x1EC8 Hash - 0xAF09CADA ^0xAF09CADA
{
	switch (iParam0)
	{
		case 0:
...
void func_78(int iParam0) // Position - 0x1F01 Hash - 0x13258647 ^0x7EDD98BE
{
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1F44 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
int func_80(BOOL bParam0) // Position - 0x20CC Hash - 0xB9596906 ^0xEA13D3DB
{
	int num;
	BOOL flag;
...
int func_81() // Position - 0x210C Hash - 0xDED80B4D ^0x98F74967
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

BOOL func_82(Ped pedParam0) // Position - 0x211C Hash - 0xCA96D27A ^0x3802A466
{
	int i;
	Ped ped;
...
int func_83(int iParam0) // Position - 0x2175 Hash - 0x4C6F6ED1 ^0x54BF6E41
{
	int i;
	int num;
	int num2;
...
int func_84() // Position - 0x2218 Hash - 0x3CF9FC4B ^0x7CA81256
{
	return 240000;
}

int func_85() // Position - 0x2224 Hash - 0x14265370 ^0x903B3BF0
{
	int i;
	int num;
	int num2;
...
int func_86(int iParam0) // Position - 0x22B1 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_87(int iParam0) // Position - 0x22C3 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_88(int iParam0) // Position - 0x22D5 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_89(int iParam0) // Position - 0x22E8 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_90(int iParam0) // Position - 0x230D Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_91(int iParam0) // Position - 0x2320 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_92(int iParam0, int iParam1) // Position - 0x2333 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_93(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x23CD Hash - 0x38DA000F ^0x38DA000F
{
	int num;
	int num2;
	int num3;
	...
	if (func_107(iParam0, iParam1, true))
	{
		num = func_90(iParam1);
		num2 = func_89(iParam0);
		num3 = func_89(iParam0) - func_89(iParam1);
		num4 = func_90(iParam0) - func_90(iParam1);
		num5 = func_91(iParam0) - func_91(iParam1);
		num6 = func_88(iParam0) - func_88(iParam1);
		num7 = func_87(iParam0) - func_87(iParam1);
		num8 = func_86(iParam0) - func_86(iParam1);
	}
	else
	{
		num = func_90(iParam0);
		num2 = func_89(iParam1);
		num3 = func_89(iParam1) - func_89(iParam0);
		num4 = func_90(iParam1) - func_90(iParam0);
		num5 = func_91(iParam1) - func_91(iParam0);
		num6 = func_88(iParam1) - func_88(iParam0);
		num7 = func_87(iParam1) - func_87(iParam0);
		num8 = func_86(iParam1) - func_86(iParam0);
	}
	...
	while (num5 < 0)
	{
		...
		num5 = num5 + func_92(num, num2);
		num4 = num4 - 1;
		num = BUILTIN::ROUND(func_108(BUILTIN::TO_FLOAT(num + 1), 0f, 12f));
	}
...
float func_94() // Position - 0x25CF Hash - 0xB5A1F69B ^0x5409CF38
{
...
BOOL func_95(int iParam0, BOOL bParam1) // Position - 0x2601 Hash - 0xA712060D ^0xA712060D
{
	if (iParam0 < 0)
		return false;
...
int func_96() // Position - 0x2639 Hash - 0xE698BCC8 ^0x3E64CD04
{
	int networkTimeAccurate;
...
BOOL func_97(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2657 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
BOOL func_98() // Position - 0x26F5 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_99(int iParam0) // Position - 0x2748 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_102(iParam0))
		return -1;
...
BOOL func_100(int iParam0) // Position - 0x2768 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_101(int iParam0, int iParam1) // Position - 0x277E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_102(int iParam0) // Position - 0x278D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_103(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x27C0 Hash - 0xA65AB937 ^0xA65AB937
{
...
void func_104(var uParam0, int iParam1) // Position - 0x27F8 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_105(var uParam0, var uParam1, var uParam2) // Position - 0x280D Hash - 0x69BD406A ^0x360BE94
{
	*uParam0 = 9484;
	*uParam1 = 66;
	*uParam2 = 128;
...
var func_106(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2825 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_107(int iParam0, int iParam1, BOOL bParam2) // Position - 0x283C Hash - 0x30CEFC86 ^0x30CEFC86
{
	if (bParam2)
...
float func_108(float fParam0, float fParam1, float fParam2) // Position - 0x2869 Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
BOOL func_109(int iParam0) // Position - 0x28AB Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_110(BOOL bParam0) // Position - 0x28E9 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

void func_111(var uParam0, int iParam1) // Position - 0x28FC Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_112(var uParam0, int iParam1) // Position - 0x2982 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_113(var uParam0, int iParam1) // Position - 0x29BE Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_114(var uParam0, int iParam1) // Position - 0x2A11 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_115(var uParam0, int iParam1) // Position - 0x2A4C Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_116(var uParam0, int iParam1) // Position - 0x2A85 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
