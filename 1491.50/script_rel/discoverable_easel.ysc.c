...
void main() // Position - 0x0 Hash - 0x54A9ED6B ^0xBF64DCBB
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	anLocal_28 = anScriptParam_0;
	iLocal_29.f_1 = anScriptParam_0.f_1;
		...
		switch (iLocal_27)
		{
			case 0:
				if (func_3(&iLocal_29))
				{
					...
					if (iLocal_29.f_4 == -1)
						iLocal_29.f_4 = func_4(&iLocal_29);
				}
				break;
...
{
	func_9(uParam0);
	SCRIPTS::_0xE7282390542F570D(anLocal_28);
...
BOOL func_3(var uParam0) // Position - 0xD1 Hash - 0xF06FC284 ^0xC0DEC5DC
{
	...
	if (iLocal_29 == 0)
	{
		...
		iLocal_29 = func_10(scenarioPointType);
		return false;
	}

	if (func_11(iLocal_29, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0) // Position - 0xA35 Hash - 0x12CA3F6C ^0x1A501D54
{
	int i;
	int num;
	var unk;
	...
	switch (iLocal_14)
	{
		...
		case 1:
			for (i = 0; i <= 1 - 1; i = i + 1)
			{
				...
				if (!func_52(&iLocal_14.f_4[num], func_51(num)))
					return;
			}
		
			if (!func_39(iLocal_14.f_7, 4))
			{
				if (func_53())
				{
					if (!func_55("SK2_Painting_low_moral", func_54(0), false))
						return;
				
					if (!func_55("SK2_Painting_high_moral", func_54(0), true))
						return;
				}
				else
				{
					if (!func_55("SK2_Painting_high_moral", func_54(0), false))
						return;
				
					if (!func_55("SK2_Painting_low_moral", func_54(0), true))
						return;
				}
			
				func_40(&(iLocal_14.f_7), 8);
			}
		
			if (!func_39(iLocal_14.f_7, 4) && func_16(6))
			{
				if (func_56())
				{
					if (!func_55("stranger_cryptic_lives", func_54(0), false))
						return;
				
					if (!func_55("stranger_cryptic_dies", func_54(0), true))
						return;
				}
				else
				{
					if (!func_55("stranger_cryptic_dies", func_54(0), false))
						return;
				
					if (!func_55("stranger_cryptic_lives", func_54(0), true))
						return;
				}
			...
			if (func_57())
			{
				func_59(func_58(), &unk, &unk2, &unk3, &num2, &unk4, &unk5);
			...
			if (func_65(iLocal_14.f_2))
			{
				if (func_63(45) && iLocal_14.f_2 == 3)
					if (!func_39(iLocal_14.f_7, 16))
						func_40(&(iLocal_14.f_7), 16);
			
				if (func_66(1661737397))
					func_67(1661737397, false, 0f, false, false, 1f, true, false);
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(Global_35))
			{
				if (!func_11(*uParam0, 32))
					if (VOLUME::DOES_VOLUME_EXIST(iLocal_14.f_4[0]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_14.f_4[0], true, 0))
						func_68(*uParam0);
				...
				if (func_70(Global_35, iLocal_14.f_4[0], true, 0))
				{
					if (!func_49(func_48()))
					{
						if (!func_57())
...
void func_9(var uParam0) // Position - 0xD4C Hash - 0x3A071020 ^0xDBB552D3
{
	int i;
	...
	for (i = 0; i <= 1 - 1; i = i + 1)
	{
		func_74(&iLocal_14.f_4[i]);
	}

	if (GRAPHICS::_IS_TRACKED_POINT_VALID(iLocal_14.f_8))
		GRAPHICS::DESTROY_TRACKED_POINT(iLocal_14.f_8);
...
int func_10(Hash hParam0) // Position - 0xD9D Hash - 0xB8EC44B7 ^0xB12C5BE7
{
	switch (hParam0)
	{
...
BOOL func_11(int iParam0, int iParam1) // Position - 0x158E Hash - 0x92045BA6 ^0x92045BA6
{
	if (!func_75(iParam0))
		return false;

	return Global_40.f_8863[func_76(iParam0, 1)] && iParam1 != false;
}

void func_12(var uParam0) // Position - 0x15B8 Hash - 0xDA8817E5 ^0xAD3AC0C4
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
Vector3 func_13(var uParam0, int iParam1) // Position - 0x1AA1 Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case -1859023693:
...
float func_14(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1F57 Hash - 0x3DAE1415 ^0x2267FA69
{
...
BOOL func_15() // Position - 0x1F7F Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_80() != -1)
		return false;
...
BOOL func_16(int iParam0) // Position - 0x1FA4 Hash - 0x7F255B4B ^0xCD4BFF4B
{
	if (!(iParam0 > -1 && iParam0 <= 80))
		return false;

	if (Global_1572887.f_12 == -1)
		return func_81(Global_1835011[iParam0 /*74*/].f_1, true);

	return UNLOCK::UNLOCK_IS_UNLOCKED(Global_1835011[iParam0 /*74*/].f_2) && !UNLOCK::UNLOCK_IS_VISIBLE(Global_1835011[iParam0 /*74*/].f_2);
}

BOOL func_17(var uParam0) // Position - 0x2003 Hash - 0x700EF42A ^0x1FB24E73
{
	if (func_39(uParam0->f_3, 1))
		return true;
...
void func_18(var uParam0) // Position - 0x201C Hash - 0xB1BE772 ^0x50C155FC
{
	if (func_33(uParam0->f_6.f_8))
		func_82(&(uParam0->f_6.f_8), true, true);
...
void func_19(var uParam0, int iParam1) // Position - 0x205C Hash - 0x4F8BE4B5 ^0x8A18C31F
{
	uParam0->f_5 = iParam1;
	return;
}

BOOL func_20(var uParam0) // Position - 0x206A Hash - 0x52835008 ^0x3922FFAC
{
	switch (*uParam0)
	{
		case -1859023693:
...
void func_21(var uParam0) // Position - 0x2D25 Hash - 0x32186C70 ^0xD26CF7E4
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2F3D Hash - 0x16E871AD ^0x10C54C39
{
...
void func_23(var uParam0) // Position - 0x2F67 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_24(var uParam0) // Position - 0x2F7D Hash - 0x5001E582 ^0x5001E582
{
	return func_84(*uParam0, 1);
}

void func_25(var uParam0) // Position - 0x2F8D Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_85(uParam0, 0f);
	return;
}

int func_26(var uParam0) // Position - 0x2F9C Hash - 0xE440ADBD ^0x7BE35012
{
	if (!func_24(uParam0))
...
BOOL func_27(var uParam0, BOOL bParam1) // Position - 0x2FEF Hash - 0x1ACEECAF ^0xDBC34297
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (bParam1)
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, true) > uParam0->f_6.f_1 + 0.5f || !func_90(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
	else
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, true) <= uParam0->f_6.f_1 && func_90(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
...
void func_28(var uParam0) // Position - 0x3211 Hash - 0x96ECE1F9 ^0x928BB1F6
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_49(*uParam0))
			{
				uParam0->f_6.f_8 = func_91("DISCO_FOCUS", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
				func_34(uParam0->f_6.f_8, false, true);
			}
			else
			{
				uParam0->f_6.f_8 = func_91("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_91("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_91("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
		}
	
		func_92(uParam0->f_6.f_8, 13, true, true);
...
char* func_29(var uParam0) // Position - 0x3661 Hash - 0x7223E95E ^0x9E7349AA
{
	if (*uParam0 == 404434344)
		if (func_49(*uParam0))
...
void func_30(var uParam0, int iParam1, char* sParam2, BOOL bParam3) // Position - 0x3ED2 Hash - 0x92B8786B ^0x6992BF35
{
	int num;
	int num2;
	int num3;
...
BOOL func_31(var uParam0) // Position - 0x3F9D Hash - 0x87BF472A ^0x8A3FB963
{
	if (func_95(uParam0->f_6.f_8, true))
		return true;

	return false;
}

void func_32(int iParam0, BOOL bParam1) // Position - 0x3FB8 Hash - 0x54AA129E ^0x54AA129E
{
	if (!func_75(iParam0))
		return;

	Global_40.f_8863[func_76(iParam0, 1)] = Global_40.f_8863[func_76(iParam0, 1)] || bParam1;
	return;
}

BOOL func_33(int iParam0) // Position - 0x3FEE Hash - 0x2E2609D8 ^0x14FF9731
{
	if (iParam0 < 0)
		return false;
...
void func_34(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x402E Hash - 0x139797B1 ^0x139797B1
{
	int num;
...
void func_35(var uParam0) // Position - 0x405A Hash - 0xB093A844 ^0xA61CDF5C
{
	if (func_80() != -1)
		return;
...
void func_36(var uParam0, BOOL bParam1) // Position - 0x40E8 Hash - 0x3BBAC949 ^0x751C9296
{
	int num;
	...
	if (bParam1)
		num = func_103(*uParam0, func_102(), uParam0->f_4);
	else
		num = func_104(*uParam0, uParam0->f_4);
...
void func_37(BOOL bParam0, int iParam1) // Position - 0x41B9 Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
float func_38(int iParam0, BOOL bParam1) // Position - 0x41FF Hash - 0x376EA9F4 ^0xA7A80B21
{
	int num;
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x4257 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_40(var uParam0, int iParam1) // Position - 0x4266 Hash - 0xF55E891F ^0xF55E891F
{
	func_110(uParam0, iParam1);
	return;
}

void func_41(var uParam0) // Position - 0x4276 Hash - 0x7DD80D7C ^0x2A3ED7AA
{
...
void func_42(var uParam0) // Position - 0x42BD Hash - 0xC9354E8F ^0x12F79925
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
void func_43(var uParam0, int iParam1) // Position - 0x42DD Hash - 0xF55E891F ^0xF55E891F
{
	func_111(uParam0, iParam1);
	return;
}

void func_44(var uParam0) // Position - 0x42ED Hash - 0x90A3D13B ^0x25DA303B
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
BOOL func_45(int iParam0) // Position - 0x4309 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -1891628345:
...
BOOL func_46(var uParam0) // Position - 0x4387 Hash - 0xA77C53D8 ^0x41543EB2
{
	Vector3 vector;
	var coords;
	...
	{
		func_112(*uParam0, &vector);
	
		if (FIRE::GET_OWNER_OF_EXPLOSION_IN_ANGLED_AREA(-1, vector, vector.f_3, vector.f_6) == func_113(Global_35))
		{
			return true;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, const char* sParam3, Entity eParam4, BOOL bParam5, int iParam6, BOOL bParam7) // Position - 0x4410 Hash - 0xA48CCCFA ^0xD20D1AD3
{
	int num;
	int num2;
	int i;
	...
	if (Global_36616 && func_114(iParam1) != false)
		return;
	...
	{
		func_116(num, false, iParam0, iParam1, sParam3, eParam4, bParam5, bParam7);
	}
	else
	{
		num2 = -1;
		...
		if (num2 >= 0)
			func_117(num2, num, iParam0, iParam1, eParam4, bParam5);
		else
			func_116(num, true, iParam0, iParam1, sParam3, eParam4, bParam5, false);
	}

	return;
}

int func_48() // Position - 0x450F Hash - 0x9F572D68 ^0x38C8CE76
{
	return 1034793488;
}

BOOL func_49(int iParam0) // Position - 0x451C Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_11(iParam0, 2);
}

void func_50(var uParam0, int iParam1) // Position - 0x452B Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

struct<11> func_51(int iParam0) // Position - 0x4538 Hash - 0x19E1B771 ^0xA521A56C
{
	var unk;
	...
	{
		case 0:
			unk = { 1707.1788f, -1005.64905f, 43.94208f };
			unk.f_3 = { 0f, 0f, -39.03056f };
			unk.f_6 = { 5.358464f, 4.768046f, 3.158976f };
			unk.f_10 = joaat("volBox");
			unk.f_9 = "EASEL_INTERIOR";
			break;
	}
...
BOOL func_52(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x459C Hash - 0xC822A061 ^0xC4A17121
{
	if (!VOLUME::DOES_VOLUME_EXIST(*uParam0))
...
BOOL func_53() // Position - 0x45DE Hash - 0xEDA66953 ^0xEDA66953
{
	return func_118() > 0;
}

Vector3 func_54(int iParam0) // Position - 0x45EC Hash - 0x4CB488BA ^0x4CB488BA
{
	switch (iParam0)
	{
		case 0:
			return 1707.247f, -1005.56506f, 43.94208f;
	
		case 1:
			return 1707.6802f, -1003.15295f, 42.47845f;
	
		case 2:
			return 1707.6426f, -1008.0115f, 43.8409f;
	
		case 3:
			return 1705.8854f, -1006.9387f, 43.8409f;
...
BOOL func_55(char* sParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x465F Hash - 0x8A350A82 ^0x30FE8278
{
...
BOOL func_56() // Position - 0x46A8 Hash - 0x548D52EA ^0xB8AEC728
{
	return func_11(func_48(), -2147483648);
}

BOOL func_57() // Position - 0x46BD Hash - 0xC5B83CF5 ^0x17C40ABD
{
	return Global_40.f_8863.f_147;
}

int func_58() // Position - 0x46CD Hash - 0xC5B83CF5 ^0x65350418
{
	return Global_40.f_8863.f_144;
}

void func_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x46DD Hash - 0x2BEE335D ^0x2BEE335D
{
	func_120(func_119(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

int func_60() // Position - 0x46FB Hash - 0xC5B83CF5 ^0x8AA7CDBE
{
	return Global_40.f_8863.f_145;
}

void func_61() // Position - 0x470B Hash - 0x4E478A83 ^0xC39914D0
{
	Global_40.f_8863.f_145 = Global_40.f_8863.f_145 + 1;
...
void func_62() // Position - 0x473A Hash - 0xA08AF76B ^0xEB9041E7
{
	Global_40.f_8863.f_147 = 0;
	return;
}

BOOL func_63(int iParam0) // Position - 0x474B Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_121(iParam0))
		return false;
...
void func_64(var uParam0) // Position - 0x4767 Hash - 0xB5CF2F99 ^0x310E00AB
{
	uParam0->f_2 = func_60();
	return;
}

BOOL func_65(int iParam0) // Position - 0x4777 Hash - 0x629AEA29 ^0x2D830A0A
{
	int num;
	Interior interiorAtCoords;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(func_123(num)))
	{
		interiorAtCoords = INTERIOR::GET_INTERIOR_AT_COORDS(func_54(0));
	
		if (INTERIOR::IS_VALID_INTERIOR(interiorAtCoords))
		{
			if (INTERIOR::IS_INTERIOR_READY(interiorAtCoords))
			{
				func_124(interiorAtCoords, iParam0);
			
				if (INTERIOR::_IS_INTERIOR_ENTITY_SET_VALID(interiorAtCoords, func_123(num)))
					INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(interiorAtCoords, func_123(num), 0);
...
BOOL func_66(Hash hParam0) // Position - 0x47E1 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

void func_67(Hash hParam0, BOOL bParam1, float fParam2, BOOL bParam3, BOOL bParam4, float fParam5, BOOL bParam6, BOOL bParam7) // Position - 0x47ED Hash - 0xD777F4CF ^0xBFF3124C
{
	func_125(hParam0, false, false);
	...
	if (func_126(hParam0))
	{
		...
		if (bParam3)
			func_127(hParam0, fParam2, true, bParam6);
		else if (bParam1)
			if (bParam4)
				func_128(hParam0, true);
			else
				func_129(hParam0, true);
		else
			func_130(hParam0, true);
...
void func_68(int iParam0) // Position - 0x4878 Hash - 0xF9F788B3 ^0x8192C5D9
{
...
void func_69(var uParam0) // Position - 0x48B4 Hash - 0x55840B69 ^0xACC024FC
{
	switch (uParam0->f_1)
	{
		case 0:
		...
		case 1:
			...
			if (!func_138(&(uParam0->f_3), func_135(), func_54(1), func_137(1), true))
				return;
		
			PED::_0xA967D6A8ED2D713B(uParam0->f_3, false);
			PED::SET_PED_CONFIG_FLAG(uParam0->f_3, 525, true);
		...
		case 2:
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_3, Global_35, -1, -1082130432, -1082130432, -1082130432);
			func_136(&(uParam0->f_1), 3);
			break;
	
		case 3:
			if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY, true) != 1)
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_3, Global_35, -1, -1082130432, -1082130432, -1082130432);
		
			if (func_139(Global_35, func_54(3), 2.6f, true, true))
			{
...
BOOL func_70(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x4A9D Hash - 0x6735ACA9 ^0xD6205CC6
{
...
void func_71() // Position - 0x4AD3 Hash - 0x7179B050 ^0xE0B31284
{
	Global_40.f_8863.f_147 = 1;
	return;
}

void func_72() // Position - 0x4AE4 Hash - 0x48182E9E ^0xD926EEF0
{
	Global_40.f_8863.f_144 = func_119();
	return;
}

void func_73(var uParam0) // Position - 0x4AF8 Hash - 0x46A0187B ^0x46A0187B
{
	if (!func_49(*uParam0))
	{
		func_140(*uParam0);
...
void func_74(var uParam0) // Position - 0x4B18 Hash - 0xBC16CD98 ^0xD54744FF
{
	if (VOLUME::DOES_VOLUME_EXIST(*uParam0))
...
BOOL func_75(int iParam0) // Position - 0x4B31 Hash - 0x1965A61D ^0x1965A61D
{
	int num;

	num = func_76(iParam0, 1);
	return num >= 0 && num < 143;
}

int func_76(int iParam0, int iParam1) // Position - 0x4B50 Hash - 0x18EDA9F0 ^0x18EDA9F0
{
	switch (iParam0)
	{
		case -2108030724:
...
Vector3 func_77(var uParam0, int iParam1) // Position - 0x5199 Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case 2000209669:
...
Vector3 func_78(var uParam0, int iParam1) // Position - 0x52AA Hash - 0xC47AB599 ^0xC47AB599
{
	switch (*uParam0)
	{
		case -2009137002:
...
Vector3 func_79(var uParam0, int iParam1) // Position - 0x5C22 Hash - 0xBAE0ABDC ^0xBAE0ABDC
{
	switch (*uParam0)
	{
		case -1887999095:
...
BOOL func_80() // Position - 0x5EB4 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x5EC2 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_82(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5EF3 Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
void func_83(var uParam0) // Position - 0x5F47 Hash - 0x87234A3C ^0x21D7A27C
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
	...
	if (*uParam0 == 404434344)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vector, vector2, vector3, func_145(uParam0));
	}
	else if (*uParam0 == -1761578407)
	{
		if (uParam0->f_4 == 0)
	...
	else if (*uParam0 == -1243267511 || *uParam0 == 1535254161 || *uParam0 == -607940493)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			if (*uParam0 == -607940493)
				...
				uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vector, vector2, vector3, func_145(uParam0));
	}
	else if (*uParam0 == -890175011)
	{
		if (uParam0->f_4 == 0)
...
BOOL func_84(int iParam0, int iParam1) // Position - 0x64B8 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_85(var uParam0, float fParam1) // Position - 0x64C7 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_86(var uParam0) // Position - 0x64ED Hash - 0x39705408 ^0x39705408
{
	return func_84(*uParam0, 2);
}

int func_87() // Position - 0x64FD Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_88(var uParam0) // Position - 0x651B Hash - 0xD965F2AB ^0x4503AF3C
{
	switch (*uParam0)
	{
		case -1300082860:
			if (func_139(Global_35, func_141(uParam0, 0), 3f, true, true))
				return true;
			break;
...
BOOL func_89(var uParam0, int iParam1) // Position - 0x65EC Hash - 0x787E614B ^0xC23272A0
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (!func_149(iParam1, 2048) && !func_153(false))
		return false;
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1))
		...
		return false;
	else if (func_156(Global_35, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
		return false;

	return true;
}

BOOL func_90(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x676F Hash - 0xE63CB60C ^0x5133A9E3
{
...
int func_91(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x67B0 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_158(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, iParam8, 0, pedParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, bParam16);
		return num;
	}
...
void func_92(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6887 Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
void func_93(int iParam0) // Position - 0x68D2 Hash - 0x4FCB23E1 ^0x764A8AAB
{
	int num;
...
int func_94(int iParam0) // Position - 0x6914 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

BOOL func_95(int iParam0, BOOL bParam1) // Position - 0x691E Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x6976 Hash - 0x7190BAC6 ^0x6DC372CF
{
...
Hash func_97(int iParam0) // Position - 0x69CE Hash - 0xB8EC44B7 ^0x184A6D50
{
	switch (iParam0)
	{
		case 0:
...
Hash func_98(int iParam0, int iParam1) // Position - 0x6AF7 Hash - 0xE1D12727 ^0x5FD78BB4
{
	switch (iParam0)
	{
		case -2009137002:
...
void func_99(var uParam0) // Position - 0x6DDF Hash - 0x12B095D ^0x8F05BAE7
{
	if (func_80() != -1)
		return;
...
int func_100() // Position - 0x6E20 Hash - 0x1767447B ^0x234018D7
{
	int i;
	int num;
	int num2;
...
BOOL func_101() // Position - 0x6E5E Hash - 0xA0319B77 ^0x14CE505F
{
	int i;
	int num;
...
BOOL func_102() // Position - 0x6E9A Hash - 0x37EC066 ^0xC9B08D38
{
	if (func_80() != -1)
		return false;
...
int func_103(int iParam0, int iParam1, int iParam2) // Position - 0x6EC0 Hash - 0xFCD0B11D ^0x62D50FE4
{
	if (iParam1 == true)
	{
		switch (iParam0)
...
int func_104(int iParam0, int iParam1) // Position - 0x76CC Hash - 0xF3B2DCFE ^0x9CB24CD5
{
	int num;

	num = func_103(iParam0, 1, iParam1);

	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(num))
		return num;

	num = func_103(iParam0, 0, iParam1);
...
void func_105(int iParam0, int iParam1) // Position - 0x7709 Hash - 0xC0D8FAC3 ^0xE4233006
{
...
int func_106() // Position - 0x7722 Hash - 0xFA45A8A9 ^0x233CB2BD
{
	int num;
...
BOOL func_107() // Position - 0x77A8 Hash - 0x4A33814C ^0x6E4357BF
{
	Hash item;

	if (!func_162(joaat("document_player_journal"), 1, false))
	{
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) || func_156(Global_35, 1369124074))
		return false;
	...
	if (INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(func_164(false), item, false))
		return false;
...
void func_108(Hash hParam0, int iParam1) // Position - 0x78D5 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_109() // Position - 0x78E8 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

void func_110(var uParam0, int iParam1) // Position - 0x7907 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_111(var uParam0, int iParam1) // Position - 0x7918 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_112(Volume volParam0, var uParam1) // Position - 0x792D Hash - 0x7513460B ^0x6C9F3BDD
{
	float volumeScale;
...
Ped func_113(Ped pedParam0) // Position - 0x79AD Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_114(int iParam0) // Position - 0x79B7 Hash - 0xA05361F6 ^0xF8A0FD3E
{
	switch (iParam0)
	{
...
int func_115(int iParam0) // Position - 0x7ACD Hash - 0xC25EDEC0 ^0x47BF4274
{
	switch (iParam0)
	{
		case 0:
...
void func_116(int iParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, Entity eParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7BB4 Hash - 0x9A51185A ^0x29A0C065
{
	int num;
	int num2;
	int num3;
	...
	Global_40.f_11095.f_35 = func_168(Global_40.f_11095.f_35, num4, num3);
	num2 = func_166();

	if (num2 != num && num2 != 0 || iParam3 == joaat("honor_event_cheat") || bParam7)
	{
		num7 = func_169(num2);
		func_171(func_170(), false, 4000);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
				else
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
				else
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
			}
		}
	}

	statId = { func_133(joaat("honor_current")) };
...
void func_117(int iParam0, int iParam1, int iParam2, int iParam3, Entity eParam4, BOOL bParam5) // Position - 0x7F59 Hash - 0x686957A ^0x8F82E8D6
{
...
int func_118() // Position - 0x7FB8 Hash - 0xC5B83CF5 ^0xDBC2A9A7
{
	return Global_40.f_11095.f_35;
}

int func_119() // Position - 0x7FC8 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_120(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x7FD4 Hash - 0x11BD39FA ^0x11BD39FA
{
	int num;
	int num2;
	int num3;
	...
	if (func_177(iParam0, iParam1, true))
	{
		...
		num2 = func_179(iParam0);
		num3 = func_179(iParam0) - func_179(iParam1);
		num4 = func_178(iParam0) - func_178(iParam1);
		num5 = func_180(iParam0) - func_180(iParam1);
		num6 = func_181(iParam0) - func_181(iParam1);
		num7 = func_182(iParam0) - func_182(iParam1);
		num8 = func_183(iParam0) - func_183(iParam1);
	}
	else
	{
		num = func_178(iParam0);
		num2 = func_179(iParam1);
		num3 = func_179(iParam1) - func_179(iParam0);
		num4 = func_178(iParam1) - func_178(iParam0);
		num5 = func_180(iParam1) - func_180(iParam0);
		num6 = func_181(iParam1) - func_181(iParam0);
		num7 = func_182(iParam1) - func_182(iParam0);
		num8 = func_183(iParam1) - func_183(iParam0);
	}
	...
	while (num5 < 0)
	{
		...
		num5 = num5 + func_184(num, num2);
		num4 = num4 - 1;
		num = BUILTIN::ROUND(func_185(BUILTIN::TO_FLOAT(num + 1), 0f, 12f));
	}
...
BOOL func_121(int iParam0) // Position - 0x81D9 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_122(int iParam0) // Position - 0x81EC Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
char* func_123(int iParam0) // Position - 0x8216 Hash - 0xCF9F0504 ^0xD1418E4B
{
	switch (iParam0)
	{
		case 0:
...
void func_124(Interior inParam0, int iParam1) // Position - 0x828D Hash - 0xCDAAD3D6 ^0x1F502ED2
{
	int num;
	int num2;
	int i;
	...
	{
		if (iParam1 != i)
			if (INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(inParam0, func_123(i)))
				INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(inParam0, func_123(i), true);
	}

	return;
}

Hash func_125(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x82D5 Hash - 0xEC5804B5 ^0x15A1D925
{
...
BOOL func_126(Hash hParam0) // Position - 0x8379 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_66(hParam0))
...
void func_127(Hash hParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8394 Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_126(hParam0))
	{
...
void func_128(Hash hParam0, BOOL bParam1) // Position - 0x83CC Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_126(hParam0))
...
void func_129(Hash hParam0, BOOL bParam1) // Position - 0x83FA Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_126(hParam0))
...
void func_130(Hash hParam0, BOOL bParam1) // Position - 0x8428 Hash - 0x4844A91D ^0x50E23246
{
	if (func_126(hParam0))
...
BOOL func_131() // Position - 0x8456 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_132(int iParam0) // Position - 0x845F Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -2009137002:
...
struct<2> func_133(int iParam0) // Position - 0x858B Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_134(var uParam0, var uParam1, int iParam2) // Position - 0x859B Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

ePedType func_135() // Position - 0x85AB Hash - 0x9F572D68 ^0xB9165711
{
	return joaat("cs_mysteriousstranger");
}

void func_136(var uParam0, int iParam1) // Position - 0x85B8 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

float func_137(int iParam0) // Position - 0x85C5 Hash - 0x7D89E602 ^0x7D89E602
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_138(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x85FC Hash - 0xE56A0C5F ^0xF94510B6
{
	STREAMING::REQUEST_MODEL(eptParam1, false);

	if (STREAMING::HAS_MODEL_LOADED(eptParam1) && !ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*uParam0 = func_186(eptParam1, uParam2, fParam5, true, true, 0, true, true, bParam6, false, false, false, false);
		return false;
	}
...
BOOL func_139(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x864F Hash - 0x4F47D7F1 ^0x1C676405
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
	...
	if (bParam6)
		if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
			return true;
	else if (func_187(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5, false), vParam1) <= fParam4 * fParam4)
		return true;

	return false;
}

void func_140(int iParam0) // Position - 0x86AA Hash - 0xDA84A767 ^0xDA84A767
{
	func_32(iParam0, 2);
	func_68(iParam0);
	return;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
Vector3 func_141(var uParam0, int iParam1) // Position - 0x86BF Hash - 0xE500AA03 ^0xE500AA03
{
	switch (*uParam0)
	{
		case -2108030724:
...
Vector3 func_142(var uParam0, int iParam1) // Position - 0x91C5 Hash - 0xABFFD40 ^0xABFFD40
{
	switch (*uParam0)
	{
		case -2108030724:
...
int func_143(int iParam0) // Position - 0x9D14 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_190(iParam0))
		return -1;
...
void func_144(int iParam0) // Position - 0x9D30 Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_192(iParam0))
		return;
...
char* func_145(var uParam0) // Position - 0x9DE3 Hash - 0x8601690B ^0x10DA2CFD
{
	switch (*uParam0)
	{
		case -1761578407:
...
float func_146() // Position - 0x9FAA Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_147(var uParam0, int iParam1) // Position - 0x9FDC Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_148(var uParam0, int iParam1) // Position - 0x9FED Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_149(int iParam0, int iParam1) // Position - 0xA002 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_150() // Position - 0xA011 Hash - 0xD50A7FC ^0x92986A81
{
...
BOOL func_151() // Position - 0xA0B1 Hash - 0x52218EDE ^0x68EAB229
{
...
BOOL func_152() // Position - 0xA146 Hash - 0xD14A8C13 ^0x8AD85514
{
...
BOOL func_153(BOOL bParam0) // Position - 0xA183 Hash - 0x19762284 ^0xBA49C5AC
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !Global_1392040.f_2)
	{
		if (bParam0)
			func_196("ITEM_UNUSABLE_CARRYING", 10000, 0, 0, 0, true);
...
BOOL func_154(int iParam0) // Position - 0xA1BB Hash - 0xEEF44B5 ^0x85627F39
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if (!func_149(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35) && VEHICLE::GET_DRIVER_OF_VEHICLE(vehiclePedIsUsing) == Global_35)
			return false;
	}
...
BOOL func_155() // Position - 0xA293 Hash - 0xFFDF5CA4 ^0x50D2CF98
{
...
BOOL func_156(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xA2AA Hash - 0x37FB14EB ^0x7E496A4A
{
...
BOOL func_157(int iParam0, int iParam1) // Position - 0xA2D3 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_158(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Ped pedParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0xA2F4 Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
...
Hash func_159(int iParam0) // Position - 0xA59A Hash - 0xB8EC44B7 ^0xC091C19D
{
	switch (iParam0)
	{
		case -2060865802:
...
int func_160(int iParam0) // Position - 0xA68B Hash - 0x333EB83A ^0x37C96C1F
{
	switch (iParam0)
	{
		case 0:
...
void func_161(BOOL bParam0) // Position - 0xA789 Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_162(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xA7B3 Hash - 0x41C0912B ^0x734B270C
{
	int num;

	if (!func_202(hParam0, 0))
		return false;

	num = func_203(hParam0);
	...
	if (num == joaat("WEAPON"))
		...
		if (!func_204(hParam0, 1))
			return false;

	return func_205(hParam0, false, bParam2) >= iParam1;
}

BOOL func_163(int iParam0) // Position - 0xA81D Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_206(iParam0);
}

int func_164(BOOL bParam0) // Position - 0xA82B Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_80() == -1)
	{
...
void func_165() // Position - 0xA86C Hash - 0x5808700A ^0x37855CE9
{
...
int func_166() // Position - 0xA8C1 Hash - 0x990ADDDC ^0x7D78C12
{
	int num;
...
int func_167(int iParam0) // Position - 0xA9D4 Hash - 0xFA6423C1 ^0xB73AD7F1
{
	float num;
	float value;
...
int func_168(int iParam0, int iParam1, int iParam2) // Position - 0xAA79 Hash - 0x1D7642BB ^0x1D7642BB
{
	if (iParam0 > iParam2)
		return iParam2;
...
int func_169(int iParam0) // Position - 0xAA9E Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case -320:
...
Hash func_170() // Position - 0xAB55 Hash - 0xA46C8CCA ^0x71ABACD2
{
...
void func_171(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xACAD Hash - 0x25ED411C ^0xE6F9BEA9
{
...
void func_172(int iParam0) // Position - 0xACD9 Hash - 0x1FF74488 ^0xA40278BB
{
...
// Unhandled jump detected. Output should be considered invalid
void func_173(BOOL bParam0) // Position - 0xAD3D Hash - 0x9BEFE017 ^0x9BEFE017
{
	int num;
	Hash unlockHash;
	Hash hash;
		...
		for (i = 0; i < num2; i = i + 1)
		{
			if (func_212(i, &hash, &num))
			{
				...
				else
				{
					...
					if (func_203(hash) == joaat("weapon_mod"))
						if (num == 1014511709)
							flag = func_166() <= -160;
...
const char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xADFE Hash - 0xA17D549C ^0xF09AC45
{
	switch (iParam0)
	{
		case joaat("honor_event_abandon_animals"):
...
int func_175(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xAF4A Hash - 0x72075C17 ^0x3AC6D3FB
{
	int num;
	var unk13;
	int num2;
	...
	func_215(sParam0, sParam1, hParam2);
	return num2;
}

int func_176(int iParam0, int iParam1) // Position - 0xAFAD Hash - 0x969A241 ^0xB7B020D1
{
	Hash chalHash;
	Hash goalHash;
	...
	if (!func_217(iParam0, &chalHash, &goalHash))
		return 0;
...
BOOL func_177(int iParam0, int iParam1, BOOL bParam2) // Position - 0xB008 Hash - 0x30CEFC86 ^0x30CEFC86
{
	if (bParam2)
...
int func_178(int iParam0) // Position - 0xB035 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_179(int iParam0) // Position - 0xB048 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_180(int iParam0) // Position - 0xB06D Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_181(int iParam0) // Position - 0xB080 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_182(int iParam0) // Position - 0xB093 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_183(int iParam0) // Position - 0xB0A5 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_184(int iParam0, int iParam1) // Position - 0xB0B7 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
float func_185(float fParam0, float fParam1, float fParam2) // Position - 0xB151 Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
Ped func_186(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0xB193 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_220(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

float func_187(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xB1D5 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_188() // Position - 0xB1F3 Hash - 0x18690106 ^0x764E08E6
{
...
BOOL func_189() // Position - 0xB20C Hash - 0x18690106 ^0xE41C0B15
{
...
BOOL func_190(int iParam0) // Position - 0xB225 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_191(int iParam0) // Position - 0xB258 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_192(int iParam0) // Position - 0xB299 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_157(iParam0, 2);
}

BOOL func_193(Ped pedParam0) // Position - 0xB2A8 Hash - 0xF2F988FE ^0xA63CD631
{
...
BOOL func_194(Ped pedParam0) // Position - 0xB390 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_223(pedParam0, 4) || func_223(pedParam0, 5);
}

BOOL func_195(Ped pedParam0) // Position - 0xB3AC Hash - 0x8F7DFED5 ^0x8768F0B4
{
	var lootTarget;
...
int func_196(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xB416 Hash - 0x8EBD6187 ^0x42F0F0AC
{
	int num;
	var unk13;
	int num2;
...
BOOL func_197(int iParam0) // Position - 0xB451 Hash - 0xCB0CD3AF ^0x98FF0773
{
	Ped mount;
	...
	if (!func_149(iParam0, 16) && !func_225(mount, false))
		return false;

	return true;
}

void func_198(int iParam0, BOOL bParam1) // Position - 0xB48F Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_199(int iParam0, int iParam1) // Position - 0xB4B8 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
void func_200(int iParam0, int iParam1) // Position - 0xB4E0 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_201(int iParam0, int iParam1) // Position - 0xB4F1 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_202(Hash hParam0, int iParam1) // Position - 0xB506 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
int func_203(Hash hParam0) // Position - 0xB520 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_204(Hash hParam0, int iParam1) // Position - 0xB54B Hash - 0x2A2D0794 ^0x8C1DA314
{
	Hash hash;
	int num;
	int num2;
...
int func_205(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB5F3 Hash - 0x27EBD222 ^0x461275A8
{
	int num;
	Hash ammoType;
	...
	{
		return func_231(hParam0, false);
	}

	inventoryItemCountWithItemid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_164(bParam2), hParam0, false);
	return inventoryItemCountWithItemid;
}

BOOL func_206(int iParam0) // Position - 0xB675 Hash - 0xA059D395 ^0xE600C05
{
	return func_39(Global_1935496.f_27, iParam0);
}

var func_207(BOOL bParam0, var uParam1, var uParam2) // Position - 0xB689 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_208(int iParam0, BOOL bParam1) // Position - 0xB6A0 Hash - 0xE5C16A63 ^0x600C7934
{
...
void func_209(Hash hParam0) // Position - 0xB6BB Hash - 0x246AED7E ^0x92A2F577
{
	COMPAPP::_0x74BCCEB233AD95B2(joaat("HonorMeterValue"), hParam0);
	return;
}

char* func_210(int iParam0) // Position - 0xB6CE Hash - 0x8FB6A40C ^0x27D8B4F2
{
	if (iParam0 <= -320)
		return "HONOR_BAD_8";
	else if (iParam0 <= -280)
...
BOOL func_211(var uParam0) // Position - 0xB7EF Hash - 0x89D7A86C ^0xC5CDC47A
{
	var unk;
...
BOOL func_212(int iParam0, var uParam1, var uParam2) // Position - 0xB837 Hash - 0x2D6E55B7 ^0xC1202559
{
	var unk;
	var unk6;
...
Hash func_213(Hash hParam0) // Position - 0xB8B7 Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

int func_214() // Position - 0xB8C1 Hash - 0xE17CEFF5 ^0x60DBA116
{
	int num;
...
void func_215(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0xB910 Hash - 0xC233DF85 ^0x5FF82D96
{
...
BOOL func_216(int iParam0) // Position - 0xB941 Hash - 0xB0C53BA8 ^0xB0C53BA8
{
...
BOOL func_217(int iParam0, var uParam1, var uParam2) // Position - 0xB960 Hash - 0xB903AED3 ^0x206B1C87
{
	if (!func_216(iParam0))
		return false;
...
BOOL func_218(int iParam0) // Position - 0xBB2F Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
	...
	num4 = func_179(iParam0);

	if (num4 <= 0 || num4 > 1930 || num4 < 1866)
		return false;

	num5 = func_178(iParam0);

	if (num5 < 0 || num5 > 11)
		return false;

	num6 = func_180(iParam0);
...
var func_219(BOOL bParam0, var uParam1, var uParam2) // Position - 0xBC0B Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_220(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xBC22 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_234(eptParam1))
		{
			func_235(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_237(pedParam0, false);
			flag = true;
		}
	
		func_238(pedParam0, iParam2);
	}
...
BOOL func_221(int iParam0) // Position - 0xBD03 Hash - 0xBF89485 ^0x62E162D4
{
	int num;
	int num2;
	int offset;

	num = func_239(iParam0, 1);
	num2 = num / 31;
	offset = num % 31;
...
int func_222(int iParam0) // Position - 0xBD52 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
int func_223(Ped pedParam0, int iParam1) // Position - 0xBDD3 Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
BOOL func_224(Ped pedParam0) // Position - 0xBE12 Hash - 0x28235D58 ^0x5BD1001B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_225(Ped pedParam0, BOOL bParam1) // Position - 0xBE2F Hash - 0x6BE4D4B ^0xC7F6BBCD
{
	float entitySpeed;
	float num;
...
Hash func_226(Hash hParam0, int iParam1) // Position - 0xBE85 Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
	...
	if (func_240(hParam0, 1399091007))
	{
		func_241(hParam0, &unk, &hash);
		return hash;
	}
...
BOOL func_227(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xBEFF Hash - 0xA7F38D3E ^0x25D43AAB
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_164(bParam4), sParam0, hParam3, piParam2);
...
BOOL func_228(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBF26 Hash - 0xF1DE71ED ^0x4F212F50
{
	if (iParam2 < 0)
		return false;
...
BOOL func_229(Hash hParam0) // Position - 0xBF61 Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_230(int iParam0) // Position - 0xBF7C Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
int func_231(Hash hParam0, BOOL bParam1) // Position - 0xBF9D Hash - 0x884C76BA ^0xDB141D11
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_242(hParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) };

	if (bParam1)
		func_244(&unk, func_243(false));

	if (!func_245(&unk, &num, &num2, false))
		return 0;
...
void func_232(BOOL bParam0) // Position - 0xBFFB Hash - 0x970FE035 ^0x92589DF6
{
	func_246(bParam0);
...
BOOL func_233(int iParam0, var uParam1) // Position - 0xC033 Hash - 0xDBBC0B25 ^0xDBBC0B25
{
	if (!func_247(iParam0))
		return false;
...
BOOL func_234(ePedType eptParam0) // Position - 0xC060 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_235(Ped pedParam0, Hash hParam1) // Position - 0xC4B3 Hash - 0xEA1C858E ^0x5FFAC167
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_248(pedParam0, hParam1))
		{
			if (func_249(pedParam0, hParam1))
			{
				if (func_250(pedParam0, hParam1))
				{
...
void func_236(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0xC55D Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_237(Ped pedParam0, BOOL bParam1) // Position - 0xC58D Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_238(Ped pedParam0, int iParam1) // Position - 0xC5D2 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_239(int iParam0, int iParam1) // Position - 0xC5F9 Hash - 0x8FA0E29 ^0xC3F68E87
{
	switch (iParam0)
	{
		case -2106445152:
...
BOOL func_240(Hash hParam0, Hash hParam1) // Position - 0xD712 Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
void func_241(Hash hParam0, var uParam1, var uParam2) // Position - 0xD743 Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_242(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD94F Hash - 0x84700F53 ^0xB9E7AA96
{
	Hash hash;
...
struct<4> func_243(BOOL bParam0) // Position - 0xDA21 Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;

	num = func_164(bParam0);

	if (num == 2)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223200))
			Global_1223200 = { func_253(923904168, func_252(bParam0), -740156546, bParam0) };
	...
	else if (num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223208))
			Global_1223208 = { func_253(923904168, func_252(bParam0), -740156546, false) };
	
		return Global_1223208;
	}

	return func_253(923904168, func_252(bParam0), -740156546, false);
}

void func_244(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDAB6 Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_245(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xDAD1 Hash - 0xA09A22CB ^0x2B47F617
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_164(bParam3), panParam0, piParam2);
...
void func_246(BOOL bParam0) // Position - 0xDAF6 Hash - 0x246AED7E ^0xB30D729F
{
	COMPAPP::_0xB6FD96420C0126A1(joaat("HonorMeterVisible"), bParam0);
	return;
}

BOOL func_247(int iParam0) // Position - 0xDB09 Hash - 0x3270B633 ^0x3270B633
{
	return iParam0 > -1 && iParam0 < 25;
}

BOOL func_248(Ped pedParam0, Hash hParam1) // Position - 0xDB1F Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_249(Ped pedParam0, Hash hParam1) // Position - 0xDB4D Hash - 0xA54F3032 ^0x306EB664
{
	Hash _int;
...
BOOL func_250(Ped pedParam0, Hash hParam1) // Position - 0xDB9E Hash - 0xA54F3032 ^0x306EB664
{
	Hash _int;
	int _int2;
...
void func_251(Ped pedParam0) // Position - 0xDC10 Hash - 0x446F1BDD ^0x66BFB11E
{
...
struct<4> func_252(BOOL bParam0) // Position - 0xDC2E Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_253(joaat("character"), func_254(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> func_253(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xDC4A Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_164(bParam6), &uParam1, hParam0, hParam5, &outGuid);
	return outGuid;
}

struct<4> func_254() // Position - 0xDC7B Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
