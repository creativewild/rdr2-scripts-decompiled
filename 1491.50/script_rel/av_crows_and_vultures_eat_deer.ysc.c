...
void main() // Position - 0x0 Hash - 0x2ECD2754 ^0x7A26324E
{
	var unk;
	BOOL flag;
	...
	sLocal_13 = "SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_VULTURES_EATING_DEER_CARCASS_A";
	sLocal_14 = "LOOP_DEER";
	iLocal_15 = 15;
...
void func_4(var uParam0) // Position - 0x9F7 Hash - 0x4DA9BC8C ^0xC570E957
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BEB Hash - 0x9ACBF547 ^0x14A09952
{
	float num;
	int num2;
	int num3;
	...
	{
		case 140:
			func_47(uParam0, "CROWS_AND_VULTURES_EAT_DEER", "script@ambient@animal@scavengers@crows_vultures_eat_deer@action", uParam1, uParam4);
			iLocal_11 = joaat("a_c_deer_01");
			sLocal_13 = "SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_VULTURES_EATING_DEER_CARCASS_A";
			sLocal_14 = "LOOP_DEER";
			num = 0f;
		...
		case 141:
			func_47(uParam0, "CROWS_AND_VULTURES_EAT_HUMAN", "script@ambient@animal@scavengers@crows_vultures_eat_human@action", uParam1, uParam4);
	...
	func_48(uParam0, 1, "pbl_action", "", 0);

	if (*uParam0 == 140 || *uParam0 == 141)
	{
		iLocal_15 = 15;
		...
		func_49(uParam0, 0, "CROW_1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 1, "CROW_2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 2, "CROW_3", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 3, "CROW_4", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 4, "CROW_5", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 5, "CROW_6", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 6, "CROW_7", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 7, "CROW_8", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 8, "CROW_9", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 9, "CROW_10", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 10, "CROW_11", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 11, "CROW_12", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 12, "VULTURE_1", iLocal_10, 0f, 0f, 0f, 0f, num2, 1, 1, 1, iLocal_17, 1);
		func_49(uParam0, 13, "VULTURE_2", iLocal_10, 0f, 0f, 0f, 0f, num2, 1, 1, 1, iLocal_17, 1);
		func_49(uParam0, 14, "VULTURE_3", iLocal_10, 0f, 0f, 0f, 0f, num2, 1, 1, 1, iLocal_17, 1);
	}
	else
	{
		uParam0->f_19 = 8;
		...
		func_49(uParam0, 2, "CROW_3", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 3, "CROW_4", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 4, "VULTURE_1", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 5, "VULTURE_2", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 6, "VULTURE_3", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}

	func_49(uParam0, 15, "DEER", iLocal_11, uParam1, num + uParam4.f_2, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1F4C Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1FEC Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x2106 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x22CF Hash - 0x923C329E ^0x672BE313
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_13))
		return 0;

	return func_50(uParam0, uParam0->f_20[15 /*14*/].f_5);
}

BOOL func_19(var uParam0) // Position - 0x22F7 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x24A7 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x251B Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x256A Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x25C2 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x272B Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2A52 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2B89 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2CB9 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2CF8 Hash - 0xA9E15E87 ^0xA7707939
{
	int i;
	...
	for (i = 0; i < iLocal_15; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
		{
			func_58(&uParam0->f_20[i /*14*/], true, true);
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[i /*14*/], uParam0->f_20[15 /*14*/], false);
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0->f_20[15 /*14*/], uParam0->f_20[i /*14*/], false);
		}
	}

	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[15 /*14*/]))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[15 /*14*/], 186, true);
		PED::_SET_PED_QUALITY(uParam0->f_20[15 /*14*/], 0);
		TASK::TASK_PLAY_ANIM(uParam0->f_20[15 /*14*/], sLocal_13, sLocal_14, 1000f, -1000f, -1, 131072, 0, false, 0, false, 0, false);
		MISC::SET_PED_DECOMPOSED(uParam0->f_20[15 /*14*/], true);
		ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[15 /*14*/], true);
		PERSISTENCE::_0x3CA5E58C9731A16B(uParam0->f_20[15 /*14*/], iLocal_16);
		func_58(&uParam0->f_20[15 /*14*/], true, true);
		PED::SET_PED_KEEP_TASK(uParam0->f_20[15 /*14*/], true);
	}

	return true;
}

void func_29(var uParam0) // Position - 0x2DF0 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2E22 Hash - 0x8C5FB44F ^0xF3128791
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_13);
	func_59(&uLocal_18, false);
	func_60(&uLocal_18, true);
...
int func_31(var uParam0) // Position - 0x2E6A Hash - 0xC52FA4EA ^0xEFB8F074
{
	int i;
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_20[15 /*14*/], false);
							iLocal_12 = 0;
							uParam0->f_469[1] = 1;
							return 0;
						}
...
int func_32(var uParam0, var uParam1) // Position - 0x2FF8 Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_76(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x300A Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x3027 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3163 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x329C Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3346 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x33BE Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x344D Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3568 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3574 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x36FC Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x379C Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x37AF Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x37C9 Hash - 0xEA796703 ^0x695D7925
{
...
int func_46() // Position - 0x3831 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

void func_47(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x383F Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_48(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x386B Hash - 0xF0D98862 ^0x21440CE
{
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x389C Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_50(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x392A Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3981 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x3B85 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3B99 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3BA8 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_77() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x3BC3 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3C22 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3C64 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C90 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_59(int iParam0, BOOL bParam1) // Position - 0x3CB8 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
		func_64(iParam0, true);
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3D34 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3D5A Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3D7C Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3D9E Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_64(int iParam0, BOOL bParam1) // Position - 0x3DC0 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_104(iParam0, 4);
	else
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3DDE Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_66(var uParam0, int iParam1) // Position - 0x3E02 Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

int func_67(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E10 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_105(Global_35))
		{
			ped = func_106(Global_35);
		...
		num = num * num;
		fParam2 = func_107(fParam2);
		num2 = func_108(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_109(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_110(&(uParam0->f_490)))
							func_111(&(uParam0->f_490));
					
						if (func_112(&(uParam0->f_490), fParam1))
						{
...
int func_68(var uParam0, int iParam1, BOOL bParam2) // Position - 0x401C Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_114(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return 1;
...
void func_69(int iParam0, BOOL bParam1) // Position - 0x4076 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_70(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x414D Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_109(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_110(&(uParam0->f_490)))
		...
		if (func_110(&(uParam0->f_490)) && !func_116(&(uParam0->f_490)))
...
void func_71(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4276 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_72(var uParam0, int iParam1) // Position - 0x437A Hash - 0x937E8C4 ^0xC4DA331A
{
...
BOOL func_73(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x439F Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_74(var uParam0, int iParam1) // Position - 0x43F8 Hash - 0x238E8D89 ^0x8E899489
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iParam1 /*14*/]))
	{
		if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[iParam1 /*14*/].f_1))
		{
			...
			func_58(&uParam0->f_20[iParam1 /*14*/], true, true);
...
BOOL func_75(var uParam0) // Position - 0x44A3 Hash - 0x12B030F3 ^0x20AC075
{
	int i;
...
void func_76(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x44E8 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_77() // Position - 0x463C Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_78(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x464A Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x46B1 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x46DA Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_121(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_81(var uParam0, var uParam1, var uParam2) // Position - 0x4726 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_121(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_82(int iParam0) // Position - 0x4775 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_83(int iParam0) // Position - 0x479A Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_84(int iParam0) // Position - 0x47AD Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_85(int iParam0) // Position - 0x47C0 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_86(int iParam0) // Position - 0x47D3 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_87(int iParam0) // Position - 0x47E5 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_88(int iParam0, int iParam1) // Position - 0x47F7 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4891 Hash - 0xA65AB937 ^0xA65AB937
{
	func_123(iParam0, iParam6);
	func_124(iParam0, iParam5);
...
float func_90(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x48C9 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_129(entityCoords, vParam1);
}

void func_91(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4919 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_121(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_92() // Position - 0x4A0A Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_93(int iParam0) // Position - 0x4A5D Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_96(iParam0))
		return -1;

	return func_131(func_130(iParam0));
}

BOOL func_94(int iParam0) // Position - 0x4A7D Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_95(int iParam0, int iParam1) // Position - 0x4A93 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_96(int iParam0) // Position - 0x4AA2 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_97(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4AD5 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_132(eptParam1))
		{
			func_133(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_135(pedParam0, false);
			flag = true;
		}
	
		func_136(pedParam0, iParam2);
	}
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4BB6 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_104(iParam0, 8);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4BD6 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_104(iParam0, 16);
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4C01 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_104(iParam0, 32);
	else
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4C21 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_104(iParam0, 64);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4C41 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4C63 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_104(int iParam0, int iParam1) // Position - 0x4C87 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_105(Ped pedParam0) // Position - 0x4C98 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_106(Ped pedParam0) // Position - 0x4CB3 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_107(float fParam0) // Position - 0x4CCF Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_108(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4D16 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_109(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4D34 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_129(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_110(var uParam0) // Position - 0x4D8B Hash - 0x5001E582 ^0x5001E582
{
	return func_137(*uParam0, 1);
}

void func_111(var uParam0) // Position - 0x4D9B Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_138(uParam0, 0f);
	return;
}

BOOL func_112(var uParam0, float fParam1) // Position - 0x4DAA Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_113(var uParam0) // Position - 0x4DC8 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_114(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4DDE Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_139(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_141(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_143(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_141(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_145(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_146(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_149(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_141(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_149(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_141(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_152(iParam2, 4000))
				{
					if (func_153(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_154(iParam2, pedParam0) && func_155(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_141(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_153(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_154(iParam2, pedParam0) && func_155(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_141(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_156(pedParam0, Global_1935630.f_41))
							{
								func_157();
								*uParam3 = 2;
								func_141(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_158(iParam2, pedParam0) || iParam2->f_9 > 0 && func_159() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_160())
					{
						if (func_156(pedParam0, Global_1935630.f_42))
						{
							func_157();
							*uParam3 = 2;
							func_141(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_162(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_141(pedParam0, iParam2, *uParam3);
					return true;
...
BOOL func_116(var uParam0) // Position - 0x5427 Hash - 0x39705408 ^0x39705408
{
	return func_137(*uParam0, 2);
}

void func_117(var uParam0) // Position - 0x5437 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_110(uParam0);

	if (func_116(uParam0))
	{
		uParam0->f_1 = func_169() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_170(uParam0, 2);
	}
...
BOOL func_118(var uParam0, float fParam1) // Position - 0x546B Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_110(uParam0))
		return false;

	if (func_171(uParam0) > fParam1)
		return true;

	return false;
}

void func_119(var uParam0) // Position - 0x5492 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_110(uParam0);

	if (!func_116(uParam0))
	{
		uParam0->f_2 = func_169() - uParam0->f_1;
		func_172(uParam0, 2);
	}
...
void func_120(int iParam0) // Position - 0x54C2 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
BOOL func_121(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5543 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_122(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5598 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_123(int iParam0, int iParam1) // Position - 0x55AF Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_124(int iParam0, int iParam1) // Position - 0x5635 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_125(int iParam0, int iParam1) // Position - 0x5671 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_126(int iParam0, int iParam1) // Position - 0x56C4 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_127(int iParam0, int iParam1) // Position - 0x56FF Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_128(int iParam0, int iParam1) // Position - 0x5738 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
float func_129(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5770 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_130(int iParam0) // Position - 0x578E Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_131(BOOL bParam0) // Position - 0x57CC Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_132(ePedType eptParam0) // Position - 0x57DF Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_133(Ped pedParam0, Hash hParam1) // Position - 0x5C32 Hash - 0xEA1C858E ^0x8ABEA54C
{
...
void func_134(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5CDC Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_135(Ped pedParam0, BOOL bParam1) // Position - 0x5D0C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_136(Ped pedParam0, int iParam1) // Position - 0x5D51 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
BOOL func_137(int iParam0, int iParam1) // Position - 0x5D78 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_138(var uParam0, float fParam1) // Position - 0x5D87 Hash - 0x30433BAB ^0xF854D531
{
...
void func_139(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5DAD Hash - 0x37D64B11 ^0xE7060A9E
{
	func_178(iParam2);
	...
	if (!(iParam0->f_1 & 1024 != 0))
	{
		...
		{
			if (func_181(iParam0))
				iParam0->f_15 = func_159();
		}
		else if (iParam0->f_15 > 0)
		{
			if (func_159() - iParam0->f_15 > 500)
			{
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x5F78 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_141(Ped pedParam0, int iParam1, int iParam2) // Position - 0x6050 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x608D Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_143(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6174 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_144(Ped pedParam0, int iParam1) // Position - 0x624A Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_145(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6353 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0x6488 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x64BF Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x65C6 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_149(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6631 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_150(Ped pedParam0, int iParam1) // Position - 0x6779 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_151(var uParam0, int iParam1) // Position - 0x6959 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_152(int iParam0, int iParam1) // Position - 0x69D1 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_153(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6A00 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_154(int iParam0, Ped pedParam1) // Position - 0x6B86 Hash - 0x42A83B1F ^0x6104CDB0
{
	int _int;
...
BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6BD6 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_205(iParam0))
		return true;
...
BOOL func_156(Ped pedParam0, Ped pedParam1) // Position - 0x6C73 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_157() // Position - 0x6CC0 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6CC8 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_159() // Position - 0x6D89 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_160() // Position - 0x6DA7 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_159() - Global_1935630.f_43 >= 10000)
		return false;

	return true;
}

BOOL func_161(int iParam0, Ped pedParam1) // Position - 0x6DF4 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_162(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6F10 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x6F58 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x71B1 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_215(0))
		return false;
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x71EA Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_166(var uParam0, int iParam1) // Position - 0x7219 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_167(Ped pedParam0, int iParam1) // Position - 0x722D Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;

	if (iParam1->f_4 == 0)
		iParam1->f_4 = func_159();
	else if (func_159() - iParam1->f_4 > func_216(iParam1))
		return func_217(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_168(int iParam0, Ped pedParam1) // Position - 0x727A Hash - 0x2978E171 ^0x7325113A
{
...
float func_169() // Position - 0x72CE Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_170(var uParam0, int iParam1) // Position - 0x7300 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_171(var uParam0) // Position - 0x7315 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_110(uParam0))
		return uParam0->f_1;
...
void func_172(var uParam0, int iParam1) // Position - 0x734A Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_173(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x735B Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x73E7 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x7415 Hash - 0xA54F3032 ^0x9132D857
{
	Hash _int;
...
BOOL func_176(Ped pedParam0, Hash hParam1) // Position - 0x7466 Hash - 0xA54F3032 ^0x9132D857
{
	Hash _int;
	int _int2;
...
void func_177(Ped pedParam0) // Position - 0x74D8 Hash - 0x446F1BDD ^0x1D4E2623
{
...
void func_178(int iParam0) // Position - 0x74F6 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_179(int iParam0) // Position - 0x7662 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_180(BOOL bParam0) // Position - 0x7675 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_181(int iParam0) // Position - 0x768F Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_182(int iParam0) // Position - 0x7729 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_183(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7750 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_184(Ped pedParam0, Ped pedParam1) // Position - 0x7849 Hash - 0xF9959663 ^0xF9959663
{
	return func_206(pedParam0, pedParam1, true, true);
}

float func_185(int iParam0) // Position - 0x785B Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_186(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7867 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_187(int iParam0, BOOL bParam1) // Position - 0x78CC Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_188() // Position - 0x78F2 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_189(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7906 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_190(int iParam0) // Position - 0x7A66 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_191(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7A72 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_192(int iParam0) // Position - 0x7AD3 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_193(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7ADF Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_194(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7BA1 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_195(int iParam0) // Position - 0x7C3F Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_196(int iParam0) // Position - 0x7C4B Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_197(int iParam0) // Position - 0x7C57 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_198(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7D94 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_199(Ped pedParam0) // Position - 0x7DD7 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7E3D Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7E84 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_202(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7ECF Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_203(Ped pedParam0, var uParam1) // Position - 0x7F48 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_204(Ped pedParam0, Ped pedParam1) // Position - 0x7F95 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_205(int iParam0) // Position - 0x7FDD Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_206(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7FED Hash - 0x326FE55E ^0x344CF7C7
{
...
BOOL func_207(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8036 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_208(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8062 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_209(int iParam0) // Position - 0x808A Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_210(Ped pedParam0) // Position - 0x8096 Hash - 0xEB445B10 ^0xF726FB5
{
...
int func_211(Ped pedParam0) // Position - 0x80EE Hash - 0x6E063231 ^0x6217F5E8
{
...
BOOL func_212(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x815E Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x82CE Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_214(int iParam0, Ped pedParam1) // Position - 0x83BC Hash - 0x27FC2906 ^0x4DDF72E8
{
...
BOOL func_215(int iParam0) // Position - 0x8432 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_232())
		return false;
...
int func_216(int iParam0) // Position - 0x8454 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_217(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8460 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_218(int iParam0) // Position - 0x84DB Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_219() // Position - 0x84EE Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_220() // Position - 0x84FC Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_234())
		return false;
...
void func_221(Any* panParam0, int iParam1) // Position - 0x8552 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_222(BOOL bParam0, var uParam1, var uParam2) // Position - 0x85FD Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_223(int iParam0) // Position - 0x86C4 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_224(int iParam0) // Position - 0x876C Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_225(Ped pedParam0, int iParam1) // Position - 0x87D1 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_226(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x87E8 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_227(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8816 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_228(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8860 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_229(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x88A1 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_230(Ped pedParam0) // Position - 0x891A Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_231(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8A02 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_232() // Position - 0x8A44 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_219() != -1)
		return false;
...
BOOL func_233(int iParam0, BOOL bParam1) // Position - 0x8A69 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_234() // Position - 0x8A9A Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_235(int iParam0) // Position - 0x8ACB Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_96(iParam0))
		return -1;
...
int func_236(int iParam0) // Position - 0x8AE7 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_237(int iParam0) // Position - 0x8B28 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
