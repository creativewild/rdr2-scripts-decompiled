#region Local Var
	...
	var uLocal_27 = 0;
	var uLocal_28 = 0;
	var uLocal_29 = 1097859072;
	var uLocal_30 = 1000;
	var uLocal_31 = 1067450368;
	var uLocal_32 = 5000;
	var uLocal_33 = 42;
	var uLocal_34 = 1103626240;
	var uLocal_35 = 1077936128;
	var uLocal_36 = 1106247680;
	var uLocal_37 = 1103101952;
...
void main() // Position - 0x0 Hash - 0x2B7E5802 ^0xC38A9D95
{
	var unk;
	BOOL flag;
...
void func_1(var uParam0) // Position - 0x57A Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x588 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x61E Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0xA90C83AE
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9DE Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0x9F5 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAB3 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xADD Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC2E Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC43 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xCE7 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1A98 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1AFE Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x2934F477 ^0x3EEAB13F
{
	iLocal_11 = func_46(3);
	...
	if (func_47(3, iLocal_11))
	{
		uParam0->f_499 = 1;
		return;
	}

	if (!SCRIPTS::IS_THREAD_ACTIVE(Global_1914319.f_3[3 /*446*/].f_18, false))
	{
		uParam0->f_499 = 1;
		return;
	}
...
Vector3 func_15(var uParam0) // Position - 0x1C0C Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CAC Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DC6 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1F8F Hash - 0xC01CD655 ^0xA545D7BB
{
	switch (iLocal_10)
	{
		case 1:
		...
		case 2:
			if (func_49(&(uParam0->f_499)))
				iLocal_10 = 3;
			break;
	
		case 3:
			STREAMING::REQUEST_MODEL(hLocal_49, false);
			return 1;
	}
...
BOOL func_19(var uParam0) // Position - 0x1FE1 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2191 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2205 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2254 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22AC Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2415 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x273C Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2873 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29A3 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29E2 Hash - 0x93C573AF ^0x9E440D13
{
	if (!STREAMING::HAS_MODEL_LOADED(hLocal_49))
		return false;
	...
	switch (iLocal_10)
	{
		case 3:
			if (bLocal_9)
			{
				if (ENTITY::IS_ENTITY_DEAD(obLocal_57))
				{
					obLocal_57 = OBJECT::CREATE_OBJECT(hLocal_49, uParam0->f_483, true, true, false, false, true);
					return false;
				}
			}
		
			if (ENTITY::IS_ENTITY_DEAD(obLocal_56))
			{
				obLocal_56 = OBJECT::CREATE_OBJECT(hLocal_49, uParam0->f_483, true, true, false, false, true);
				return false;
			}
		...
		case 4:
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
			{
				...
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_20[0 /*14*/], false, true);
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, "MALE_SKELETON", uParam0->f_20[0 /*14*/], 0);
				}
			
				if (!ENTITY::IS_ENTITY_DEAD(obLocal_56))
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, "p_can01x", obLocal_56, 0);
			
				if (!ENTITY::IS_ENTITY_DEAD(obLocal_57))
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, "p_can03x", obLocal_57, 0);
			
				func_57(&uLocal_61, false);
				return true;
			}
			break;
	}
...
void func_29(var uParam0) // Position - 0x2ADC Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B0E Hash - 0x56C56195 ^0xBFE7EAAD
{
	int num;
	...
	if (iLocal_10 == 0)
	{
		if (func_58(&uParam0->f_20[0 /*14*/], uParam0->f_483))
		{
			func_59();
			iLocal_10 = 1;
		}
	...
	num = func_38(uParam0->f_20[0 /*14*/], uLocal_50, 0.5f);

	if (*uParam0 == 16)
	{
		if (num == 1 || num == 0)
			sLocal_53 = "pl_RESTOCK_HIGH_1_ITEM_BACK";
		else if (num == 3)
			sLocal_53 = "pl_RESTOCK_HIGH_1_ITEM_RIGHT";
		else if (num == 2)
			sLocal_53 = "pl_RESTOCK_HIGH_1_ITEM_LEFT";
	}
	else if (*uParam0 == 17)
	{
		if (num == 1 || num == 0)
			sLocal_53 = "pl_RESTOCK_MID_1_ITEM_BACK";
		else if (num == 3)
			sLocal_53 = "pl_RESTOCK_MID_1_ITEM_RIGHT";
		else if (num == 2)
			sLocal_53 = "pl_RESTOCK_MID_1_ITEM_LEFT";
	}
	else if (*uParam0 == 18)
	{
		bLocal_9 = true;
		...
		if (num == 1 || num == 0)
			sLocal_53 = "pl_RESTOCK_HIGH_2_ITEM_BACK";
		else if (num == 3)
			sLocal_53 = "pl_RESTOCK_HIGH_2_ITEM_RIGHT";
		else if (num == 2)
			sLocal_53 = "pl_RESTOCK_HIGH_2_ITEM_LEFT";
	}
	else if (*uParam0 == 19)
	{
		bLocal_9 = true;
		...
		if (num == 1 || num == 0)
			sLocal_53 = "pl_RESTOCK_MID_2_ITEM_BACK";
		else if (num == 3)
			sLocal_53 = "pl_RESTOCK_MID_2_ITEM_RIGHT";
		else if (num == 2)
			sLocal_53 = "pl_RESTOCK_MID_2_ITEM_LEFT";
	}
	...
	if (bLocal_9)
		func_60(uParam0, "AV_SHOPKEEPER_RESTOCK_2_CANS", "script@ambient@town@shopkeeper_shelf_restock@restock_2_items", uParam0->f_483, uParam0->f_486);
	else
		func_60(uParam0, "AV_SHOPKEEPER_RESTOCK_1_CAN", "script@ambient@town@shopkeeper_shelf_restock@restock_1_item", uParam0->f_483, uParam0->f_486);

	func_61(uParam0, 1, sLocal_53, "", 0);
	func_62(uParam0, 0, "MALE_SKELETON", hLocal_41, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_63(&uLocal_12, false);
	func_64(&uLocal_12, true);
	func_65(&uLocal_12, true);
	func_66(&uLocal_12, true);
	func_67(&uLocal_12, true);
	func_68(&uLocal_12, true);
	func_69(&uLocal_12, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2D0F Hash - 0xC91DF27F ^0xE8C46FA0
{
	...
	if (!uParam0->f_469[0])
	{
		if (func_70(uParam0, &uLocal_12, false))
		{
			TASK::TASK_SMART_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, -1f, -1, 0, 1077936128, 0);
			func_71(uParam0);
		
			if (!uParam0->f_469[3])
			{
				func_72(*uParam0, uParam0->f_483, false);
				uParam0->f_469[3] = 1;
			}
	...
	if (!uParam0->f_469[1])
	{
		if (func_73(&uLocal_61) > 90f)
			return 1;
	
		if (func_74(uParam0, 1065353216, 9f, 4, 6f, 1112014848))
		{
			func_71(uParam0);
			ANIMSCENE::SET_ANIM_SCENE_BOOL(uParam0->f_3.f_1, "b_breakout", true, false);
			uParam0->f_469[1] = 1;
		}
	}
	...
	if (uParam0->f_469[1])
	{
		if (!uParam0->f_469[3])
		{
			if (func_75(uParam0, 1.3f, 20f, 4, joaat("Action"), false))
			{
				func_72(*uParam0, uParam0->f_483, false);
				uParam0->f_469[3] = 1;
			}
		...
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, "MALE_SKELETON"))
			{
				TASK::TASK_PERSISTENT_CHARACTER(uParam0->f_20[0 /*14*/]);
...
int func_32(var uParam0, var uParam1) // Position - 0x2E7D Hash - 0x9A0DBF10 ^0xE76BED8F
{
	int i;
	...
	if (iLocal_40 != -1)
		if (func_76(iLocal_40))
			func_77(iLocal_40, false, false, false, false);
	...
	if (ITEMSET::IS_ITEMSET_VALID(isLocal_60))
		ITEMSET::DESTROY_ITEMSET(isLocal_60);

	PED::_UNRESERVE_AMBIENT_PEDS(1);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F32 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F4F Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x308B Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x31C4 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x326E Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x32E6 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_79(entityForwardVector, unk5);
	...
	if (func_80(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3375 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3490 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x349C Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	func_90(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3624 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x36C4 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36D7 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x36F1 Hash - 0xEA796703 ^0x695D7925
{
...
int func_46(int iParam0) // Position - 0x3759 Hash - 0xCDB90269 ^0xCDB90269
{
	return func_91(func_78(), iParam0);
}

BOOL func_47(int iParam0, int iParam1) // Position - 0x376B Hash - 0x8172A768 ^0x8172A768
{
	if (!func_92(iParam1))
		return true;
	...
	if (!func_97(iParam0, 16384))
		if (func_98(Global_1914319.f_3[iParam0 /*446*/].f_21))
			if (!func_99(Global_1914319.f_3[iParam0 /*446*/].f_21, false))
				return false;

	return false;
}

BOOL func_48(var uParam0) // Position - 0x37F4 Hash - 0x32354CCD ^0x6B63BADD
{
	var matrix;

	if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(uParam0->f_3.f_1, "p_can01x", &matrix, false, 0, 2))
	{
		if (!VOLUME::DOES_VOLUME_EXIST(volLocal_54))
		{
			volLocal_54 = VOLUME::CREATE_VOLUME_SPHERE(matrix.f_6, 0f, 0f, 0f, 0.3f, 0.4f, 0.3f);
			isLocal_60 = ITEMSET::CREATE_ITEMSET(false);
			return false;
		}
		else if (func_100(volLocal_54))
		{
			return true;
		}
		else
...
BOOL func_49(var uParam0) // Position - 0x3862 Hash - 0x1905466F ^0x80357E5A
{
	...
	indexedItemInItemset = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iLocal_59, isLocal_60);
	...
	for (i = 0; i < 6; i = i + 1)
	{
		...
		if (entityModel == uLocal_42[i])
		{
			hLocal_49 = entityModel;
			return true;
		}
	}
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x38F7 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x3AFB Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3B0F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3B1E Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_78() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3B39 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3B98 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x3BDA Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3C06 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_58(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3C26 Hash - 0x7AC6F5D4 ^0xDEE4EA1
{
	int num;
	...
	num = func_109(uParam1);

	if (num == -1)
		return false;

	if (func_110(num, uParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(*uParam0) || !ENTITY::DOES_ENTITY_EXIST(*uParam0))
			return false;
	
		iLocal_40 = func_111(*uParam0, false);
	
		if (!func_98(iLocal_40))
			return false;
	
		if (func_112(iLocal_40, false))
			return false;
	
		*uParam0 = func_113(iLocal_40, false, false, false, true, true);
	
		if (ENTITY::IS_ENTITY_DEAD(*uParam0) || !ENTITY::DOES_ENTITY_EXIST(*uParam0))
			return false;
	
		hLocal_41 = func_114(iLocal_40);
	
		if (hLocal_41 == 0)
			return false;
	
		iLocal_55 = TASK::_GET_SCENARIO_POINT_PED_IS_USING(*uParam0, false);
	
		if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_55))
			uLocal_50 = { ENTITY::GET_ENTITY_COORDS(*uParam0, true, false) };
		else
			uLocal_50 = { TASK::_GET_SCENARIO_POINT_COORDS(iLocal_55, true) };
...
void func_59() // Position - 0x3D11 Hash - 0xC5DB22BD ^0x655D9672
{
	uLocal_42[0] = joaat("s_cancorn01x");
	uLocal_42[1] = joaat("s_canpeaches01x");
	uLocal_42[2] = joaat("s_crackers01x");
	uLocal_42[3] = joaat("s_canbeans01x");
	uLocal_42[4] = joaat("s_wormcan01x");
	uLocal_42[5] = joaat("s_canpeas01x");
	return;
}

void func_60(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3D55 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_61(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3D81 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_62(var uParam0, int iParam1, char* sParam2, Hash hParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3DB2 Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3E40 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
		func_115(iParam0, true);
		func_116(iParam0, true);
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3EBC Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3EE0 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3F06 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x3F28 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_68(var uParam0, BOOL bParam1) // Position - 0x3F4A Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x3F6C Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_70(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3F90 Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_123(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
void func_71(var uParam0) // Position - 0x3FEA Hash - 0x46EA99E1 ^0x46EA99E1
{
	if (!uParam0->f_469[4])
	{
		func_124(*uParam0, false);
		uParam0->f_469[4] = 1;
	}
...
void func_72(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4010 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
float func_73(var uParam0) // Position - 0x4114 Hash - 0x5E6CC847 ^0xFCFB84EF
{
	if (!func_107(uParam0))
		return 0f;
...
BOOL func_74(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4146 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_133(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_107(&(uParam0->f_490)))
							func_108(&(uParam0->f_490));
					
						if (func_134(&(uParam0->f_490), iParam1))
						{
...
BOOL func_75(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4351 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_133(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_107(&(uParam0->f_490)))
							func_57(&(uParam0->f_490), false);
					
						if (func_127(&(uParam0->f_490)))
							func_136(&(uParam0->f_490));
					
						if (func_137(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_107(&(uParam0->f_490)) && !func_127(&(uParam0->f_490)))
			func_138(&(uParam0->f_490));
	}

	return false;
}

BOOL func_76(int iParam0) // Position - 0x447A Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_98(iParam0))
		return false;
...
void func_77(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x449F Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
...
int func_78() // Position - 0x458B Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_79(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4599 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4600 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4629 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_147(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_82(var uParam0, var uParam1, var uParam2) // Position - 0x4675 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_147(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_83(int iParam0) // Position - 0x46C4 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_84(int iParam0) // Position - 0x46E9 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_85(int iParam0) // Position - 0x46FC Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_86(int iParam0) // Position - 0x470F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_87(int iParam0) // Position - 0x4722 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_88(int iParam0) // Position - 0x4734 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_89(int iParam0, int iParam1) // Position - 0x4746 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x47E0 Hash - 0xA65AB937 ^0xA65AB937
{
...
int func_91(int iParam0, int iParam1) // Position - 0x4818 Hash - 0x8A1A59F3 ^0x8A1A59F3
{
	if (iParam1 == 11)
		return 101;
	else if (iParam1 == 32)
...
BOOL func_92(int iParam0) // Position - 0x502C Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

BOOL func_93(int iParam0) // Position - 0x5042 Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_155(iParam0, 1);
}

BOOL func_94(int iParam0) // Position - 0x5052 Hash - 0x23EB7FEB ^0xEA1B4703
{
	BOOL flag;

	flag = func_155(iParam0, 256);
	return flag;
}

BOOL func_95(int iParam0) // Position - 0x5067 Hash - 0x14952E1F ^0xA4C9DEBB
{
	return func_155(iParam0, 512);
}

BOOL func_96(int iParam0, int iParam1) // Position - 0x5078 Hash - 0x7D6A72B8 ^0x1C942B92
{
	BOOL flag;
	int frameCount;
	...
	{
		if (iParam1 == -1)
			iParam1 = func_91(func_78(), iParam0);
		...
		flag = func_157(iParam1) || func_159(func_158(iParam0));
...
BOOL func_97(int iParam0, int iParam1) // Position - 0x5101 Hash - 0x36B8C524 ^0x73960CC8
{
	return func_52(Global_1914319.f_3[iParam0 /*446*/].f_5, iParam1);
}

BOOL func_98(int iParam0) // Position - 0x511C Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

BOOL func_99(int iParam0, BOOL bParam1) // Position - 0x5133 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_156() != -1)
		return false;
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_160(iParam0)))
		return false;

	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_145(iParam0));
}

BOOL func_100(Volume volParam0) // Position - 0x518B Hash - 0x622168DB ^0xB7640254
{
	ScrHandle indexedItemInItemset;
	int i;

	iLocal_58 = ENTITY::_GET_ENTITIES_IN_VOLUME(volParam0, isLocal_60, 3);

	if (iLocal_58 > 0)
	{
		for (i = 0; i < iLocal_58; i = i + 1)
		{
			indexedItemInItemset = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(i, isLocal_60);
		
			if (MISC::_DOES_ITEM_HAVE_VALID_BASE(indexedItemInItemset))
				MISC::_0x553D67295DDD2309(indexedItemInItemset);
		}
...
BOOL func_101() // Position - 0x51D8 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_102(int iParam0) // Position - 0x522B Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_105(iParam0))
		return -1;

	return func_162(func_161(iParam0));
}

BOOL func_103(int iParam0) // Position - 0x524B Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_104(int iParam0, int iParam1) // Position - 0x5261 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_105(int iParam0) // Position - 0x5270 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_106(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x52A3 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_163(eptParam1))
		{
			func_164(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_166(pedParam0, false);
			flag = true;
		}
	
		func_167(pedParam0, iParam2);
	}
...
BOOL func_107(var uParam0) // Position - 0x5384 Hash - 0x5001E582 ^0x5001E582
{
	return func_168(*uParam0, 1);
}

void func_108(var uParam0) // Position - 0x5394 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_169(uParam0, 0f);
	return;
}

int func_109(var uParam0, var uParam1, var uParam2) // Position - 0x53A3 Hash - 0xD6B36E91 ^0xD6B36E91
{
	int i;

	for (i = 0; i <= 25; i = i + 1)
	{
		if (func_170(uParam0, i))
			return i;
	}
...
BOOL func_110(int iParam0, var uParam1) // Position - 0x53D1 Hash - 0x3651FB70 ^0xFA6F4E3D
{
	if (!func_171(iParam0))
		return false;
...
int func_111(Ped pedParam0, BOOL bParam1) // Position - 0x544F Hash - 0x46B9578F ^0x31193522
{
	return func_172(pedParam0, Global_1894899.f_2, bParam1);
}

BOOL func_112(int iParam0, BOOL bParam1) // Position - 0x5465 Hash - 0x956894C4 ^0x956894C4
{
	if (func_156() != -1)
		return false;
	...
	if (!func_76(iParam0) && bParam1)
		return false;

	return func_139(iParam0, 1);
}

Ped func_113(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x54A3 Hash - 0x816A3A36 ^0x24211010
{
	Ped ped;
	PersChar persChar;

	if (!func_173(iParam0, true))
		return 0;
...
Hash func_114(int iParam0) // Position - 0x5560 Hash - 0xED567DFA ^0x7CDFEFC2
{
	if (!func_98(iParam0))
		return 0;
...
void func_115(int iParam0, BOOL bParam1) // Position - 0x5582 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_122(iParam0, 4);
	else
...
void func_116(int iParam0, BOOL bParam1) // Position - 0x55A0 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_122(iParam0, 8);
	else
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x55C0 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_122(iParam0, 16);
...
void func_118(int iParam0, BOOL bParam1) // Position - 0x55EB Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_122(iParam0, 32);
	else
...
void func_119(int iParam0, BOOL bParam1) // Position - 0x560B Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_122(iParam0, 64);
	else
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x562B Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_122(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x564D Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_122(iParam0, 1048576);
	else
...
void func_122(int iParam0, int iParam1) // Position - 0x5671 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_123(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x5682 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_176(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_178(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_180(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_178(pedParam0, iParam2, *uParam3);
					return true;
		...
		{
			if (func_183(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_184(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_178(pedParam0, iParam2, *uParam3);
						return true;
				...
				{
					if (func_185(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 256;
						func_178(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_186(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_178(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_186(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_178(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_189(iParam2, 4000))
				{
					if (func_190(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_191(iParam2, pedParam0) && func_192(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_178(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_190(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_191(iParam2, pedParam0) && func_192(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_178(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_193(pedParam0, Global_1935630.f_41))
							{
								func_194();
								*uParam3 = 2;
								func_178(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_195(iParam2, pedParam0) || iParam2->f_9 > 0 && func_196() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_197())
					{
						if (func_193(pedParam0, Global_1935630.f_42))
						{
							func_194();
							*uParam3 = 2;
							func_178(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_199(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_178(pedParam0, iParam2, *uParam3);
					return true;
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x5CAB Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_125(int iParam0) // Position - 0x5D82 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_206(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_206(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_206(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_126(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5E03 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_147(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_127(var uParam0) // Position - 0x5EF4 Hash - 0x39705408 ^0x39705408
{
	return func_168(*uParam0, 2);
}

float func_128() // Position - 0x5F04 Hash - 0xB5A1F69B ^0x5409CF38
{
...
BOOL func_129(Ped pedParam0) // Position - 0x5F36 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_130(Ped pedParam0) // Position - 0x5F51 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_131(float fParam0) // Position - 0x5F6D Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_132(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5FB4 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_133(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x5FD2 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_207(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_134(var uParam0, int iParam1) // Position - 0x6029 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_135(var uParam0) // Position - 0x6047 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_136(var uParam0) // Position - 0x605D Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_107(uParam0);

	if (func_127(uParam0))
	{
		uParam0->f_1 = func_128() - uParam0->f_2;
		uParam0->f_2 = 0f;
		func_208(uParam0, 2);
	}
...
BOOL func_137(var uParam0, float fParam1) // Position - 0x6091 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_107(uParam0))
		return false;
...
void func_138(var uParam0) // Position - 0x60B8 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_107(uParam0);

	if (!func_127(uParam0))
	{
		uParam0->f_2 = func_128() - uParam0->f_1;
		func_210(uParam0, 2);
	}
...
BOOL func_139(int iParam0, BOOL bParam1) // Position - 0x60E8 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_156() != -1)
		return false;
...
BOOL func_140(int iParam0) // Position - 0x6116 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_98(iParam0))
		return false;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x613A Hash - 0x452DF11A ^0x452DF11A
{
	if (func_156() != -1)
		return;
...
void func_142(int iParam0) // Position - 0x6173 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
Hash func_143(int iParam0) // Position - 0x61B7 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_98(iParam0))
		return 0;
...
BOOL func_144(Hash hParam0) // Position - 0x61D5 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

PersChar func_145(int iParam0) // Position - 0x61E1 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_98(iParam0))
		return 0;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0x6201 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_98(iParam0))
		return 0;
...
BOOL func_147(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x6284 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_148(BOOL bParam0, var uParam1, var uParam2) // Position - 0x62D9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_149(int iParam0, int iParam1) // Position - 0x62F0 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_150(int iParam0, int iParam1) // Position - 0x6376 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_151(int iParam0, int iParam1) // Position - 0x63B2 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_152(int iParam0, int iParam1) // Position - 0x6405 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_153(int iParam0, int iParam1) // Position - 0x6440 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_154(int iParam0, int iParam1) // Position - 0x6479 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_155(int iParam0, BOOL bParam1) // Position - 0x64B1 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_156() // Position - 0x64D7 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

int func_157(int iParam0) // Position - 0x64E5 Hash - 0x6646587B ^0x6646587B
{
	int num;
	...
	if (num == 2 && func_213(28) || num == 18 && iParam0 != 55 || num == 1 || num == 11 || iParam0 == 69 || num == 33 || num == 20 || num == 19 || num == 9 || func_94(iParam0))
		return 1;

	return 0;
}

int func_158(int iParam0) // Position - 0x6587 Hash - 0xFBD7120C ^0x4ABFA698
{
	if (iParam0 == 15)
		return 65539;
...
int func_159(int iParam0) // Position - 0x65A1 Hash - 0x259E3CFD ^0x259E3CFD
{
	int num;
	...
	if (func_52(iParam0, 8192))
		if (num >= 6 && num < 20)
			return 1;

	if (func_52(iParam0, 2048))
		if (num >= 1 && num < 3)
			return 1;

	if (func_52(iParam0, 16384))
		if (num >= 6 && num < 24)
			return 1;

	if (func_52(iParam0, 32768))
		if (num >= 21 || num < 6)
			return 1;

	if (func_52(iParam0, 65536))
		if (num >= 18 && num < 19)
			return 1;
...
Ped func_160(int iParam0) // Position - 0x67F5 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_161(int iParam0) // Position - 0x6823 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_162(BOOL bParam0) // Position - 0x6861 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_163(ePedType eptParam0) // Position - 0x6874 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_164(Ped pedParam0, Hash hParam1) // Position - 0x6CC7 Hash - 0xEA1C858E ^0xE43B3FA9
{
...
void func_165(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6D71 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_166(Ped pedParam0, BOOL bParam1) // Position - 0x6DA1 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_167(Ped pedParam0, int iParam1) // Position - 0x6DE6 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
BOOL func_168(int iParam0, int iParam1) // Position - 0x6E0D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_169(var uParam0, float fParam1) // Position - 0x6E1C Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_170(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6E42 Hash - 0x72D781CD ^0x8982B3E6
{
...
BOOL func_171(int iParam0) // Position - 0x6E78 Hash - 0x895544C2 ^0x895544C2
{
	return iParam0 > -1 && iParam0 < 35;
}

int func_172(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6E8E Hash - 0x7B4C7353 ^0x7B4C7353
{
	var unk;
	var unk2;
	...
	if (!func_219(iParam1, &unk, &unk2, false, false))
		return -1;

	return func_220(pedParam0, unk, unk2, bParam2);
}

BOOL func_173(int iParam0, BOOL bParam1) // Position - 0x6EC0 Hash - 0x5C4302E7 ^0x5C4302E7
{
	if (!func_98(iParam0))
		return false;
...
void func_174(int iParam0, BOOL bParam1) // Position - 0x6F20 Hash - 0x61515A20 ^0x61515A20
{
	if (func_156() != -1)
		return;
...
void func_175(int iParam0) // Position - 0x6F51 Hash - 0x5A948764 ^0xFC1342AE
{
	if (!func_98(iParam0))
		return;
...
void func_176(int iParam0, BOOL bParam1, int iParam2) // Position - 0x6F74 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_221(iParam2);
				...
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						if (PED::IS_PED_PLANTING_BOMB(Global_35))
							func_122(iParam0, 33554432);
					else if (!(*iParam0 & 8192 != 0))
						if (func_223(true))
							func_122(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_223(true) || *iParam0 & 8192 != 0)
...
BOOL func_177(Ped pedParam0, int iParam1) // Position - 0x713F Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_226(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_227(pedParam0, pedIndexFromEntityIndex) <= func_228(iParam1))
				return true;
			break;
	}
...
void func_178(Ped pedParam0, int iParam1, int iParam2) // Position - 0x7217 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_229(iParam2, 1, 1, 1, 0))
		func_122(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_230(iParam1, true);
	func_231();
	return;
}

BOOL func_179(Ped pedParam0, int iParam1) // Position - 0x7254 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_232(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_234(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_235(iParam1);
...
BOOL func_180(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x733B Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_236(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_233(iParam2);
	
		if (func_234(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_235(iParam2))
				{
					func_230(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_181(Ped pedParam0, int iParam1) // Position - 0x7411 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_226(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_235(iParam1))
		{
			customDistance = func_233(iParam1);
...
BOOL func_182(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x751A Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		return func_237(bParam1, bParam2, bParam3);
...
BOOL func_183(int iParam0, int iParam1) // Position - 0x764F Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_184(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x7686 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_185(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x778D Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_239(iParam2))
	{
...
BOOL func_186(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x77F8 Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_241(pedParam1, entityCoords, outCoords))
					{
						func_230(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_241(pedParam1, entityCoords, outCoords2))
					{
						func_230(iParam2, true);
						return true;
					}
...
BOOL func_187(Ped pedParam0, int iParam1) // Position - 0x7940 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_226(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_242(Global_1935630.f_34[i]);
			...
			if (func_243(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_244(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_245(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_188(var uParam0, int iParam1) // Position - 0x7B20 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_189(int iParam0, int iParam1) // Position - 0x7B98 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_190(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7BC7 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_191(int iParam0, Ped pedParam1) // Position - 0x7D4D Hash - 0x42A83B1F ^0x1608DDD6
{
	int _int;
...
BOOL func_192(int iParam0, Ped pedParam1) // Position - 0x7D9D Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_248(iParam0))
		return true;
...
BOOL func_193(Ped pedParam0, Ped pedParam1) // Position - 0x7E3A Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_249(pedParam0, pedParam1, true, true) < 4f)
...
void func_194() // Position - 0x7E87 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_195(int iParam0, Ped pedParam1) // Position - 0x7E8F Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_250(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_251(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_196() // Position - 0x7F50 Hash - 0xE698BCC8 ^0x3E64CD04
{
	int networkTimeAccurate;
...
BOOL func_197() // Position - 0x7F6E Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_198(int iParam0, Ped pedParam1) // Position - 0x7FBB Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_252(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_253(pedParam1);
	num2 = func_254(iParam0->f_14);
...
BOOL func_199(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x80D7 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_255(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_200(Ped pedParam0, int iParam1) // Position - 0x811F Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_256(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_257(iParam1, pedParam0))
						if (func_251(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_201(Ped pedParam0, int iParam1) // Position - 0x8378 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_258(0))
		return false;
...
BOOL func_202(int iParam0, int iParam1) // Position - 0x83B1 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_203(var uParam0, int iParam1) // Position - 0x83E0 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_204(Ped pedParam0, int iParam1) // Position - 0x83F4 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_196() - iParam1->f_4 > func_259(iParam1))
		return func_260(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_205(int iParam0, Ped pedParam1) // Position - 0x8441 Hash - 0x2978E171 ^0xC3674E3E
{
...
void func_206(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x8495 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_207(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x8521 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_208(var uParam0, int iParam1) // Position - 0x853F Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_209(var uParam0) // Position - 0x8554 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_107(uParam0))
		return uParam0->f_1;
...
void func_210(var uParam0, int iParam1) // Position - 0x8589 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_211(int iParam0, int iParam1) // Position - 0x859A Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_98(iParam0))
		return;
...
int func_212(int iParam0) // Position - 0x85BB Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_213(int iParam0) // Position - 0x8A0F Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_262(iParam0))
		return false;
...
int func_214() // Position - 0x8A2B Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

BOOL func_215(Ped pedParam0, Hash hParam1) // Position - 0x8A37 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_216(Ped pedParam0, Hash hParam1) // Position - 0x8A65 Hash - 0xA54F3032 ^0x54579B7D
{
	Hash _int;
...
BOOL func_217(Ped pedParam0, Hash hParam1) // Position - 0x8AB6 Hash - 0xA54F3032 ^0x54579B7D
{
	Hash _int;
	int _int2;
...
void func_218(Ped pedParam0) // Position - 0x8B28 Hash - 0x446F1BDD ^0x57D6B2ED
{
...
BOOL func_219(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8B46 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
int func_220(Ped pedParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x9206 Hash - 0x32945A99 ^0xFCA9036B
{
	...
	for (i = uParam1; i <= uParam2; i = i + 1)
	{
		...
		if (func_143(num) != 0 && PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_145(num)))
			if (func_145(num) == perscharIndexFromPedIndex)
				return num;
	}
...
void func_221(int iParam0) // Position - 0x9280 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_265(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_222(int iParam0) // Position - 0x93EC Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_223(BOOL bParam0) // Position - 0x93FF Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_266(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_224(int iParam0) // Position - 0x9419 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_225(int iParam0) // Position - 0x94B3 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_226(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x94DA Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_254(pedParam2);
	else
		num2 = func_253(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_254(pedParam0);
	else
...
float func_227(Ped pedParam0, Ped pedParam1) // Position - 0x95D3 Hash - 0xF9959663 ^0xF9959663
{
	return func_249(pedParam0, pedParam1, true, true);
}

float func_228(int iParam0) // Position - 0x95E5 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_229(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x95F1 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_230(int iParam0, BOOL bParam1) // Position - 0x9656 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
		func_122(iParam0, 134217728);
	else
...
void func_231() // Position - 0x967C Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_232(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x9690 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_249(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_269(ped, 0)))
			if (func_270(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_233(int iParam0) // Position - 0x97F0 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_234(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x97FC Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_235(int iParam0) // Position - 0x985D Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_236(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x9869 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_269(ped, 0)))
			if (func_271(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_237(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x992B Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_238(int iParam0) // Position - 0x99C9 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_239(int iParam0) // Position - 0x99D5 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_240(int iParam0) // Position - 0x99E1 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_241(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x9B1E Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_272(pedParam0, vParam4, 0.5f))
...
BOOL func_242(Ped pedParam0) // Position - 0x9B61 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_273(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_243(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x9BC7 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_244(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x9C0E Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_245(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x9C59 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_246(Ped pedParam0, var uParam1) // Position - 0x9CD2 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_247(Ped pedParam0, Ped pedParam1) // Position - 0x9D1F Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_275(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_248(int iParam0) // Position - 0x9D67 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_249(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9D77 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_250(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x9DBF Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_251(veParam0, uParam2, true);
...
float func_251(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x9DEB Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_252(int iParam0) // Position - 0x9E13 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_253(Ped pedParam0) // Position - 0x9E1F Hash - 0xEB445B10 ^0x4350C008
{
...
int func_254(Ped pedParam0) // Position - 0x9E77 Hash - 0x6E063231 ^0x42A8E5A3
{
...
BOOL func_255(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x9EE7 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_249(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_249(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_256(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0xA057 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_266(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_257(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_257(iParam1, ped2))
					if (func_251(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_257(int iParam0, Ped pedParam1) // Position - 0xA145 Hash - 0x27FC2906 ^0x4612D529
{
...
BOOL func_258(int iParam0) // Position - 0xA1BB Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_276())
		return false;

	return func_277(Global_1347702[58 /*49*/].f_15, true);
}

int func_259(int iParam0) // Position - 0xA1DD Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_260(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xA1E9 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_261(int iParam0) // Position - 0xA264 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_262(int iParam0) // Position - 0xA277 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_263(int iParam0) // Position - 0xA28A Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
BOOL func_264() // Position - 0xA2B4 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_278())
		return false;
...
void func_265(Any* panParam0, int iParam1) // Position - 0xA30A Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_266(BOOL bParam0, var uParam1, var uParam2) // Position - 0xA3B5 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_267(int iParam0) // Position - 0xA47C Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_268(int iParam0) // Position - 0xA524 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_269(Ped pedParam0, int iParam1) // Position - 0xA589 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_270(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xA5A0 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_271(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_271(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0xA5CE Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_272(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0xA618 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_273(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA659 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_274(Ped pedParam0) // Position - 0xA6D2 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_275(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xA7BA Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_276() // Position - 0xA7FC Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_156() != -1)
		return false;
...
BOOL func_277(int iParam0, BOOL bParam1) // Position - 0xA821 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_278() // Position - 0xA852 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_279(int iParam0) // Position - 0xA883 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_105(iParam0))
		return -1;
...
int func_280(int iParam0) // Position - 0xA89F Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_281(int iParam0) // Position - 0xA8E0 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
