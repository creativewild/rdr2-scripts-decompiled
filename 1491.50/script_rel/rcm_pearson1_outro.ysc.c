...
void main() // Position - 0x0 Hash - 0xB19DBA86 ^0x5FFEE16
{
	...
	func_2(&uLocal_3, &uScriptParam_0);

	while (!func_3(&uLocal_3))
	{
		func_4(&uLocal_3);
	
		switch (func_5(uLocal_3))
		{
			case 0:
				if (func_6(&uLocal_3))
					func_7(&uLocal_3, 1);
...
BOOL func_6(var uParam0) // Position - 0x257 Hash - 0xE4F2D4A8 ^0xDD146E7
{
	return ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_2, true, false);
}

void func_7(var uParam0, int iParam1) // Position - 0x269 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

BOOL func_8(var uParam0) // Position - 0x276 Hash - 0xE70F011 ^0xCE61FB0
{
...
BOOL func_9(var uParam0) // Position - 0x2AE Hash - 0xEDB66132 ^0xEDB66132
{
	BOOL num;
...
void func_10() // Position - 0x2D3 Hash - 0xF2ADC204 ^0xF23F9A2E
{
	int i;
...
int func_11(var uParam0) // Position - 0x316 Hash - 0x2A73F000 ^0xBED6661
{
...
BOOL func_12(eStackSize essParam0) // Position - 0x33E Hash - 0xFD10BCB1 ^0xFD10BCB1
{
...
BOOL func_13(eStackSize essParam0) // Position - 0x35D Hash - 0xDA629583 ^0xDA629583
{
	return func_27(essParam0, 16, true);
}

BOOL func_14(eStackSize essParam0) // Position - 0x36E Hash - 0xC2BA9D92 ^0x340F97FF
{
...
void func_15(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x3A2 Hash - 0xA4706F79 ^0xAF27D1D3
{
	BOOL flag;
	PersChar persChar;
	BOOL flag2;
...
BOOL func_16(var uParam0, int iParam1) // Position - 0x657 Hash - 0x718DD1EF ^0x66842345
{
	return uParam0->f_3 && iParam1 != false;
}

void func_17(var uParam0, int iParam1) // Position - 0x668 Hash - 0xA4EAD31F ^0x3F77773B
{
	uParam0->f_3 = uParam0->f_3 - uParam0->f_3 && iParam1;
	return;
}

void func_18(var uParam0, int iParam1) // Position - 0x680 Hash - 0x53A96DDB ^0xA013391F
{
	uParam0->f_3 = uParam0->f_3 || iParam1;
	return;
}

void func_19(var uParam0) // Position - 0x693 Hash - 0xA2B4B513 ^0xC34980E5
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2))
	{
...
BOOL func_20(int iParam0, int iParam1) // Position - 0x6BD Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_21(var uParam0) // Position - 0x6CC Hash - 0xDB19CDAD ^0x53698838
{
...
BOOL func_22() // Position - 0x6F6 Hash - 0x9773414E ^0x9773414E
{
	BOOL num;
...
BOOL func_23(var uParam0) // Position - 0x703 Hash - 0xE45AC0BF ^0xE45AC0BF
{
	return func_45();
}

void func_24(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x70F Hash - 0xA83ABB27 ^0x3839CF85
{
	int num;
	int offset;
...
void func_25(var uParam0, BOOL bParam1) // Position - 0x749 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
void func_26(int iParam0, int iParam1) // Position - 0x769 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_27(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x77E Hash - 0x456A22D3 ^0x456A22D3
{
	if (bParam2)
		if (!func_46(essParam0))
			return false;
...
void func_28(eStackSize essParam0, BOOL bParam1) // Position - 0x7A8 Hash - 0x7065DB4C ^0xB94EA2C3
{
	if (!func_46(essParam0))
		return;
...
void func_29(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x7EA Hash - 0x322BF689 ^0x724E8BC3
{
	if (!func_46(essParam0))
		return;
...
void func_30(eStackSize essParam0) // Position - 0x812 Hash - 0x7895582D ^0x7895582D
{
	func_29(essParam0, 8, false);
	return;
}

void func_31(eStackSize essParam0) // Position - 0x823 Hash - 0x8577BCFD ^0x8577BCFD
{
	func_24(essParam0, 36, true);
	return;
}

void func_32(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x834 Hash - 0xA83ABB27 ^0xCD66A93E
{
	int num;
	int offset;
...
BOOL func_33(Ped pedParam0, int iParam1) // Position - 0x86E Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
PersChar func_34(eStackSize essParam0, BOOL bParam1) // Position - 0x96D Hash - 0xA2FCAA5A ^0xC4849EF1
{
	if (!func_12(essParam0))
		return 0;
...
BOOL func_35(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x9AC Hash - 0x6ED0C3E9 ^0xD0355731
{
	int num;
	int offset;
...
void func_36(eStackSize essParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9E7 Hash - 0x31BF1139 ^0xA046F8A2
{
	int pedMaxHealth;
	Ped ped;
...
void func_37(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA39 Hash - 0x4B52E53C ^0x4B52E53C
{
	if (!func_46(essParam0))
		return;
...
void func_38(eStackSize essParam0, BOOL bParam1) // Position - 0xB0B Hash - 0x2F921122 ^0x884B6C77
{
	if (!func_46(essParam0))
		return;
...
void func_39(var uParam0) // Position - 0xB42 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_40(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB58 Hash - 0x6E8FD624 ^0x6E8FD624
{
	PersChar char;
	Ped ped;
...
void func_41(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC66 Hash - 0xC1057B0F ^0xC1057B0F
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
Player func_42(eStackSize essParam0) // Position - 0xCA2 Hash - 0x8D7C83E2 ^0x9E26FAD3
{
	if (!func_12(essParam0))
		return 0;
...
void func_43(int iParam0, eStackSize essParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xCE2 Hash - 0xBD80856C ^0xBD80856C
{
	Player player;
...
void func_44(int iParam0, int iParam1) // Position - 0xD84 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_45() // Position - 0xD95 Hash - 0x477323 ^0x8EF93AF8
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_43800) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_43800, false);
}

BOOL func_46(eStackSize essParam0) // Position - 0xDB1 Hash - 0xEC8E4F18 ^0xEC8E4F18
{
	return essParam0 > -1;
}

int func_47(int iParam0, var uParam1, var uParam2) // Position - 0xDBD Hash - 0x28CD1A67 ^0x28CD1A67
{
	int num;
...
BOOL func_48(var uParam0) // Position - 0xDDA Hash - 0x5001E582 ^0x5001E582
{
	return func_62(*uParam0, 1);
}

void func_49(var uParam0) // Position - 0xDEA Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_63(uParam0, 0f);
	return;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0xDF9 Hash - 0xE46677C2 ^0xE46677C2
{
	return *iParam0 && iParam1 != false;
}

void func_51(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE09 Hash - 0x70644665 ^0x70644665
{
	if (bParam2)
		*iParam0 = *iParam0 || iParam1;
	else
...
BOOL func_52(int iParam0, int iParam1) // Position - 0xE2F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_53(eStackSize essParam0) // Position - 0xE3E Hash - 0x7F4CEA57 ^0x7A0A798F
{
	Hash hash;
...
Ped func_54(eStackSize essParam0) // Position - 0xEA6 Hash - 0x81E6D8DD ^0x27F8E742
{
	if (!func_46(essParam0))
		return 0;
...
void func_55(eStackSize essParam0) // Position - 0xEE0 Hash - 0xA3F1079A ^0xFE58BB91
{
	if (func_12(essParam0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_54(essParam0)))
		{
			func_65(essParam0, 67108864, true);
...
float func_56(eStackSize essParam0) // Position - 0xF13 Hash - 0xA42CC07F ^0x2E7483CB
{
	if (!func_46(essParam0))
		return 0f;
...
void func_57(eStackSize essParam0) // Position - 0xF34 Hash - 0xC4A0D69D ^0x461393B6
{
	Ped ped;
	PersChar persChar;
	BOOL flag;
...
BOOL func_58(eStackSize essParam0) // Position - 0xF8E Hash - 0x6410553A ^0x46627D03
{
	if (!func_46(essParam0))
		return false;
...
BOOL func_59(eStackSize essParam0) // Position - 0xFDA Hash - 0xDC3E0094 ^0xA822A7E2
{
	if (!func_46(essParam0))
		return false;
...
void func_60(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x1002 Hash - 0x7FA68C0F ^0xF104E0DF
{
	if (!func_46(essParam0))
		return;
...
int func_61(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1067 Hash - 0x9AECF115 ^0xB93A91A1
{
	Player mount;
	Hash hash;
	PersChar persChar;
	...
	if (func_33(mount, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(mount) && func_67(PLAYER::PLAYER_PED_ID(), mount, true) < 10000f))
			{
				hash = func_68(essParam0, true);
				...
				if (hash != 0)
				{
					...
					func_69(essParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_70(essParam0, false));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_70(essParam0, false));
					func_71(essParam0);
				}
			}
			else
			{
				...
				{
					persChar = func_70(essParam0, false);
...
BOOL func_62(int iParam0, int iParam1) // Position - 0x1218 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_63(var uParam0, float fParam1) // Position - 0x1227 Hash - 0x30433BAB ^0xF854D531
{
...
Hash func_64(int iParam0) // Position - 0x124D Hash - 0xBA965109 ^0xCB1D208B
{
	switch (iParam0)
	{
		case 0:
...
void func_65(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1429 Hash - 0x2E4D3D00 ^0x2E4D3D00
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
void func_66(eStackSize essParam0, Ped pedParam1) // Position - 0x145A Hash - 0xC6503D1A ^0x107B4B14
{
...
float func_67(Ped pedParam0, Player plParam1, BOOL bParam2) // Position - 0x1474 Hash - 0x867DEA0 ^0xA060BC32
{
	...
	return func_77(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(plParam1, false, false));
}

Hash func_68(eStackSize essParam0, BOOL bParam1) // Position - 0x14CB Hash - 0xA64DC151 ^0x7D83907B
{
	if (!func_46(essParam0))
		return 0;
	...
	if (bParam1)
	{
		Global_1360165[essParam0 /*1157*/].f_127 = func_78(essParam0);
		return Global_1360165[essParam0 /*1157*/].f_127;
	}
...
void func_69(eStackSize essParam0) // Position - 0x1610 Hash - 0xF7FD9E75 ^0xF411CFCB
{
	Player player;
	ItemSet itemset;
	int i;
...
PersChar func_70(eStackSize essParam0, BOOL bParam1) // Position - 0x1686 Hash - 0xF1265AC3 ^0xD7133EF8
{
	if (!func_46(essParam0))
		return 0;

	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(Global_1360165[essParam0 /*1157*/].f_126) && bParam1)
		Global_1360165[essParam0 /*1157*/].f_126 = func_79(essParam0);

	return Global_1360165[essParam0 /*1157*/].f_126;
}

void func_71(eStackSize essParam0) // Position - 0x16D2 Hash - 0xA6C3B06B ^0x3AB8265A
{
	int i;
...
void func_72(eStackSize essParam0, int iParam1) // Position - 0x1725 Hash - 0xEBFF508D ^0x493427AF
{
	if (!func_46(essParam0))
		return;
...
float func_73() // Position - 0x1749 Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_74(var uParam0, int iParam1) // Position - 0x177B Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_75(var uParam0, int iParam1) // Position - 0x178C Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_76(Ped pedParam0) // Position - 0x17A1 Hash - 0x6B11B31E ^0xBBDA1FC0
{
	int _int;
...
float func_77(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1804 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
Hash func_78(eStackSize essParam0) // Position - 0x1822 Hash - 0xEB890713 ^0xB40CD388
{
	Hash hash;
	int i;
...
PersChar func_79(eStackSize essParam0) // Position - 0x1903 Hash - 0xF15D53A9 ^0x3132AAF6
{
	Hash persCharHash;
	...
	{
		persCharHash = func_68(essParam0, true);
