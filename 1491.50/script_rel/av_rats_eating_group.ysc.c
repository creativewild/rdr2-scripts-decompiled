...
void main() // Position - 0x0 Hash - 0xA112627F ^0xFB1EFEC0
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0xBB64D37D
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x19C94E67 ^0x72227314
{
	func_46(uParam0, "RATS_EATING_GROUP", "", vParam1, uParam4);
	func_47(uParam0, 0, "REG_RAT_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "REG_RAT_2", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -0.25f, 0.25f, 0f), 135f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "REG_RAT_3", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.25f, 0.25f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "REG_RAT_4", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.25f, 0f, 0f), 45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "REG_RAT_5", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -0.5f, 0f, 0f), -100f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 5, "REG_RAT_6", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -0.5f, -0.25f, 0f), -135f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "REG_RAT_7", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -0.5f, 0f), -145f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 7, "REG_RAT_8", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.25f, -0.5f, 0f), -15f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 8, "REG_RAT_9", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.5f, -0.25f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 9, "REG_RAT_10", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.25f, -0.75f, 0f), 50f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1DE9 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1E89 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1FA3 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x216C Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2175 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2325 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2399 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x23E8 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2440 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x25A9 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x28D0 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2A07 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2B37 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2B76 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2B7F Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2BB1 Hash - 0x6C10550A ^0x6C10550A
{
...
int func_31(var uParam0) // Position - 0x2BE4 Hash - 0x4F17EDAD ^0xF364D68D
{
	var unk;
	int i;
	BOOL flag;
	...
	switch (iLocal_10)
	{
		case 0:
			for (i = 0; i < 10; i = i + 1)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
				{
					func_61(&(uParam0->f_20[i /*14*/].f_5), 1, 5, false);
					...
					func_62(&uParam0->f_20[i /*14*/], true, true);
				}
			}
		...
		case 1:
			if (func_63(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				flag = true;
			}
			else
			{
				for (i = 0; i < 10; i = i + 1)
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
					{
						if (func_64(uParam0->f_20[i /*14*/], 0, &uLocal_11, &unk, 0, 0))
						{
							flag = true;
							break;
						}
		...
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_42 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_42 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(Global_35))
				{
					func_62(&uParam0->f_20[iLocal_42 /*14*/], false, true);
					TASK::TASK_FLEE_PED(uParam0->f_20[iLocal_42 /*14*/], Global_35, 3, 0, -1082130432, -1, 0);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[iLocal_42 /*14*/], 230, true);
				}
			
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uParam0->f_20[iLocal_42 /*14*/]);
			}
...
int func_32(var uParam0, var uParam1) // Position - 0x2DAA Hash - 0x3105A36D ^0x3105A36D
{
	func_69(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DBC Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DD9 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F15 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x304E Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30F8 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3170 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31FF Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x331A Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3326 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34AE Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x354E Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3561 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x357B Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35E3 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x360F Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_48(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x369D Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_49(int iParam0) // Position - 0x38A1 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x38B5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_51() // Position - 0x38C4 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_70() != -1;
}

BOOL func_52(var uParam0, Any* panParam1) // Position - 0x38DF Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_53(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x393E Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_54(Ped pedParam0) // Position - 0x3980 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_55(int iParam0, BOOL bParam1) // Position - 0x39AC Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_56(var uParam0, BOOL bParam1) // Position - 0x3A28 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3A4E Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3A70 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3A92 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3AB4 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
		func_9(&(uParam0->f_1), 16);
	else
		func_96(&(uParam0->f_1), 16);

	return;
}

int func_61(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3AD8 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_62(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3BCF Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_63(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3BF7 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_98(Global_35))
		{
			ped = func_99(Global_35);
		...
		num = num * num;
		fParam2 = func_100(fParam2);
		num2 = func_101(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_102(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_103(&(uParam0->f_490)))
							func_67(&(uParam0->f_490));
					
						if (func_104(&(uParam0->f_490), fParam1))
						{
							func_105(&(uParam0->f_490));
							return true;
						}
...
BOOL func_64(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x3E02 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_65(int iParam0, BOOL bParam1) // Position - 0x442B Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_66(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4502 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
	...
	func_136(iParam0);
	func_137(iParam0, uParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/] = Global_32074.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32074.f_2697.f_2 = Global_32074.f_2697.f_2 + 1;
	return;
}

void func_67(var uParam0) // Position - 0x4606 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_138(uParam0, 0f);
	return;
}

BOOL func_68(var uParam0, float fParam1) // Position - 0x4615 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_103(uParam0))
		return false;
...
void func_69(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x463C Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_70() // Position - 0x4790 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_71(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x479E Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_72(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4805 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x482E Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_140(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_74(var uParam0, var uParam1, var uParam2) // Position - 0x487A Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_140(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_75(int iParam0) // Position - 0x48C9 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_76(int iParam0) // Position - 0x48EE Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_77(int iParam0) // Position - 0x4901 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_78(int iParam0) // Position - 0x4914 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_79(int iParam0) // Position - 0x4927 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_80(int iParam0) // Position - 0x4939 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_81(int iParam0, int iParam1) // Position - 0x494B Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x49E5 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_83() // Position - 0x4A1D Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_84(int iParam0) // Position - 0x4A70 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_87(iParam0))
		return -1;
...
BOOL func_85(int iParam0) // Position - 0x4A90 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_86(int iParam0, int iParam1) // Position - 0x4AA6 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_87(int iParam0) // Position - 0x4AB5 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_88(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4AE8 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_150(eptParam1))
		{
			func_151(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_89(int iParam0, BOOL bParam1) // Position - 0x4BC9 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_96(iParam0, 4);
	else
...
void func_90(int iParam0, BOOL bParam1) // Position - 0x4BE7 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_96(iParam0, 8);
	else
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x4C07 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_96(iParam0, 16);
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4C32 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_96(iParam0, 32);
	else
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4C52 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_96(iParam0, 64);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4C72 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4C94 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_96(iParam0, 1048576);
	else
...
void func_96(int iParam0, int iParam1) // Position - 0x4CB8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_97(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x4CC9 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_98(Ped pedParam0) // Position - 0x4CF2 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_99(Ped pedParam0) // Position - 0x4D0D Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_100(float fParam0) // Position - 0x4D29 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_101(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4D70 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_102(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4D8E Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_155(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_103(var uParam0) // Position - 0x4DE5 Hash - 0x5001E582 ^0x5001E582
{
	return func_156(*uParam0, 1);
}

BOOL func_104(var uParam0, float fParam1) // Position - 0x4DF5 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_105(var uParam0) // Position - 0x4E13 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_106(int iParam0, BOOL bParam1, int iParam2) // Position - 0x4E29 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_157(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_159(true))
							func_96(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_159(true) || *iParam0 & 8192 != 0)
...
BOOL func_107(Ped pedParam0, int iParam1) // Position - 0x4FF4 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_162(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_163(pedParam0, pedIndexFromEntityIndex) <= func_164(iParam1))
				return true;
			break;
	}
...
void func_108(Ped pedParam0, int iParam1, int iParam2) // Position - 0x50CB Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
		iParam1->f_10 = pedParam0;

	if (func_165(iParam2, 1, 1, 1, 0))
		func_96(iParam1, 2048);

	iParam1->f_16 = iParam2;
	func_166(iParam1, true);
	func_167();
	return;
}

BOOL func_109(Ped pedParam0, int iParam1) // Position - 0x5108 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	{
		if (func_168(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			num2 = func_169(iParam1);
		
			if (func_170(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_171(iParam1);
...
BOOL func_110(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x51EF Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_172(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_169(iParam2);
	
		if (func_170(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_171(iParam2))
				{
					func_166(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_111(Ped pedParam0, int iParam1) // Position - 0x52C5 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_162(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_171(iParam1))
		{
			customDistance = func_169(iParam1);
...
BOOL func_112(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x53CE Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_113(int iParam0, int iParam1) // Position - 0x5503 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_114(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x553A Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_115(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5641 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_175(iParam2))
	{
...
BOOL func_116(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x56AC Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_177(pedParam1, entityCoords, outCoords))
					{
						func_166(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_177(pedParam1, entityCoords, outCoords2))
					{
						func_166(iParam2, true);
						return true;
					}
...
BOOL func_117(Ped pedParam0, int iParam1) // Position - 0x57F4 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_162(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_178(Global_1935630.f_34[i]);
			...
			if (func_179(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_180(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_181(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_118(var uParam0, int iParam1) // Position - 0x59D0 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_119(int iParam0, int iParam1) // Position - 0x5A48 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_120(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5A77 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_121(int iParam0, Ped pedParam1) // Position - 0x5BFD Hash - 0xBA12A9ED ^0x961A43EA
{
	int _int;
...
BOOL func_122(int iParam0, Ped pedParam1) // Position - 0x5C4A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_184(iParam0))
		return true;
...
BOOL func_123(Ped pedParam0, Ped pedParam1) // Position - 0x5CE7 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_185(pedParam0, pedParam1, true, true) < 4f)
...
void func_124() // Position - 0x5D34 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_125(int iParam0, Ped pedParam1) // Position - 0x5D3C Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_186(vehiclePedIsUsing, pedParam1, entityCoords))
		{
...
int func_126() // Position - 0x5DFD Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_127() // Position - 0x5E1B Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_128(int iParam0, Ped pedParam1) // Position - 0x5E68 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_188(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_189(pedParam1);
	num2 = func_190(iParam0->f_14);
...
BOOL func_129(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5F84 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_191(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_130(Ped pedParam0, int iParam1) // Position - 0x5FCC Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_192(pedParam0, iParam1, true))
			return true;
...
BOOL func_131(Ped pedParam0, int iParam1) // Position - 0x6225 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_194(0))
		return false;
...
BOOL func_132(int iParam0, int iParam1) // Position - 0x625E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_133(var uParam0, int iParam1) // Position - 0x628D Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x62A1 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_126() - iParam1->f_4 > func_195(iParam1))
		return func_196(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_135(int iParam0, Ped pedParam1) // Position - 0x62EE Hash - 0xB0576310 ^0xAFA1ED2F
{
...
void func_136(int iParam0) // Position - 0x6341 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_197(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_197(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_197(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_137(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x63C2 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_140(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
void func_138(var uParam0, float fParam1) // Position - 0x64B3 Hash - 0x30433BAB ^0xF854D531
{
	uParam0->f_1 = func_198() - fParam1;
	func_199(uParam0, 1);
	func_200(uParam0, 2);
	uParam0->f_2 = 0f;
	return;
...
float func_139(var uParam0) // Position - 0x64D9 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_103(uParam0))
		return uParam0->f_1;
	...
	return func_198() - uParam0->f_1;
}

BOOL func_140(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x650E Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_141(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6563 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_142(int iParam0, int iParam1) // Position - 0x657A Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_143(int iParam0, int iParam1) // Position - 0x6600 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_144(int iParam0, int iParam1) // Position - 0x663C Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_145(int iParam0, int iParam1) // Position - 0x668F Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_146(int iParam0, int iParam1) // Position - 0x66CA Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_147(int iParam0, int iParam1) // Position - 0x6703 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_148(int iParam0) // Position - 0x673B Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_149(BOOL bParam0) // Position - 0x6779 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_150(ePedType eptParam0) // Position - 0x678C Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_151(Ped pedParam0, Hash hParam1) // Position - 0x6BDF Hash - 0x68B470E ^0x7B35115A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_152(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6C86 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_153(Ped pedParam0, BOOL bParam1) // Position - 0x6CB6 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_154(Ped pedParam0, int iParam1) // Position - 0x6CFB Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
float func_155(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6D22 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_156(int iParam0, int iParam1) // Position - 0x6D40 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_157(int iParam0) // Position - 0x6D4F Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_207(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_158(int iParam0) // Position - 0x6EBB Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_159(BOOL bParam0) // Position - 0x6ECE Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_208(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_160(int iParam0) // Position - 0x6EE8 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_161(int iParam0) // Position - 0x6F80 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_162(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x6FA7 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		...
		num2 = func_189(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_190(pedParam0);
	else
		num = func_189(pedParam0);
...
float func_163(Ped pedParam0, Ped pedParam1) // Position - 0x70A0 Hash - 0xF9959663 ^0xF9959663
{
	return func_185(pedParam0, pedParam1, true, true);
}

float func_164(int iParam0) // Position - 0x70B2 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_165(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x70BE Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_166(int iParam0, BOOL bParam1) // Position - 0x7123 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_167() // Position - 0x7149 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_168(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x715D Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_185(ped, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_212(ped, 0)))
			if (func_213(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_169(int iParam0) // Position - 0x72BD Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_170(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x72C9 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_171(int iParam0) // Position - 0x732A Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_172(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7336 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_212(ped, 0)))
			if (func_214(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_173(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x73F8 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_174(int iParam0) // Position - 0x7496 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_175(int iParam0) // Position - 0x74A2 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_176(int iParam0) // Position - 0x74AE Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_177(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x75EB Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_215(pedParam0, vParam4, 0.5f))
...
BOOL func_178(Ped pedParam0) // Position - 0x762E Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_216(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_179(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7694 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_180(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x76DB Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_181(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7726 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_182(Ped pedParam0, var uParam1) // Position - 0x779F Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_183(Ped pedParam0, Ped pedParam1) // Position - 0x77EC Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_218(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_184(int iParam0) // Position - 0x7834 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_185(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7844 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_186(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x788C Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_187(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x78B8 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_188(int iParam0) // Position - 0x78E0 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_189(Ped pedParam0) // Position - 0x78EC Hash - 0x2937C9E7 ^0x3373E12D
{
...
int func_190(Ped pedParam0) // Position - 0x7940 Hash - 0xB05D5864 ^0x17C89142
{
...
BOOL func_191(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x79AA Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_185(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_185(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_192(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7B1A Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_208(true, &ped, &ped2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_193(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_193(iParam1, ped2))
...
BOOL func_193(int iParam0, Ped pedParam1) // Position - 0x7C08 Hash - 0x27FC2906 ^0xF338E38D
{
...
BOOL func_194(int iParam0) // Position - 0x7C7E Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_219())
		return false;

	return func_220(Global_1347702[58 /*49*/].f_15, true);
}

int func_195(int iParam0) // Position - 0x7CA0 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_196(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7CAC Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_197(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7D27 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_221(iParam0) == 1 && bParam7)
		return;
...
float func_198() // Position - 0x7DB3 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_199(var uParam0, int iParam1) // Position - 0x7DE5 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_200(var uParam0, int iParam1) // Position - 0x7DF6 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_201(var uParam0) // Position - 0x7E0B Hash - 0x39705408 ^0x39705408
{
	return func_156(*uParam0, 2);
}

BOOL func_202(Ped pedParam0, Hash hParam1) // Position - 0x7E1B Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_203(Ped pedParam0, Hash hParam1) // Position - 0x7E49 Hash - 0x8D3E8777 ^0x659BBABA
{
	Hash _int;
...
BOOL func_204(Ped pedParam0, Hash hParam1) // Position - 0x7E99 Hash - 0x8D3E8777 ^0x659BBABA
{
	Hash _int;
	int _int2;
...
void func_205(Ped pedParam0) // Position - 0x7F09 Hash - 0x3B285314 ^0x11F290FA
{
...
BOOL func_206() // Position - 0x7F26 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_222())
		return false;
...
void func_207(Any* panParam0, int iParam1) // Position - 0x7F7C Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_208(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8026 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_209() // Position - 0x80ED Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_210(int iParam0) // Position - 0x80FB Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_211(int iParam0) // Position - 0x81A3 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_212(Ped pedParam0, int iParam1) // Position - 0x8208 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_213(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x821F Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_214(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_214(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x824D Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_215(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8297 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_216(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x82D8 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_217(Ped pedParam0) // Position - 0x8351 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_218(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8439 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_219() // Position - 0x847B Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_209() != -1)
		return false;
...
BOOL func_220(int iParam0, BOOL bParam1) // Position - 0x84A0 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_221(int iParam0) // Position - 0x84D1 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_222() // Position - 0x84E4 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_223(int iParam0) // Position - 0x8515 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_87(iParam0))
		return -1;
...
int func_224(int iParam0) // Position - 0x8531 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_225(int iParam0) // Position - 0x8572 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
