...
void main() // Position - 0x0 Hash - 0x3ACF616F ^0x76591AEF
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_c_fox_01");
	hLocal_11 = joaat("world_animal_fox_sitting");
	iLocal_12 = joaat("META_OUTFIT_DEFAULT");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_1(var uParam0) // Position - 0x58E Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x59C Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x632 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9D8 Hash - 0x4DA9BC8C ^0x12074BC6
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9F2 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA09 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAC7 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAF1 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC42 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC57 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xCFB Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AAC Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B12 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BCC Hash - 0xF2EA67D6 ^0x62A95D06
{
	int num;
	int num2;
	int randomIntInRange;

	func_46(uParam0, "FOX_SIT", "", uParam1, uParam4);
	num = 1;
	num2 = func_47();
	...
	switch (*uParam0)
	{
		case 124:
			...
			hLocal_11 = joaat("world_animal_bird_on_perch");
			break;
	
		case 130:
			iLocal_9 = joaat("a_c_californiacondor_01");
			hLocal_11 = joaat("world_animal_vulture_on_perch");
			break;
		...
		case 131:
			...
			if (func_48(128))
			{
				...
				hLocal_11 = joaat("world_animal_eagle_on_perch");
			}
			else if (func_48(1))
			{
		...
		case 189:
			iLocal_9 = joaat("a_c_pelican_01");
			hLocal_11 = joaat("world_animal_pelican_on_perch");
			break;
		...
		case 201:
			iLocal_9 = joaat("a_c_redfootedbooby_01");
			hLocal_11 = joaat("Stand");
			break;
	
		case 232:
			iLocal_9 = joaat("a_c_vulture_01");
			hLocal_11 = joaat("world_animal_vulture_on_perch");
		
			if (num2 == 0 || num2 == 2 || num2 == 10 || num2 == 11 || num2 == 9)
			{
				num = 0;
				iLocal_12 = joaat("META_OUTFIT_ANIMAL_VULTUREEAST");
			}
			break;
	}

	func_49(uParam0, 0, "FS_ANIMAL", iLocal_9, uParam1, 0f + uParam4.f_2, num, 1, 1, 1, iLocal_12, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1DF9 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1E99 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1FB3 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x217C Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2185 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2335 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x23A9 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x23F8 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2450 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x25B9 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
	int randomIntInRange;
...
BOOL func_25(var uParam0) // Position - 0x28E0 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2A17 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2B47 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2B86 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2B8F Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2BC1 Hash - 0x295F8D23 ^0x295F8D23
{
	...
	func_64(&uLocal_17, 65);
	func_65(&uLocal_17, 5f);
	uLocal_45 = { 0f, 0f, 0f };
	uLocal_45.f_8 = 4;
	uLocal_45.f_4 = 21030;
	uLocal_45.f_21 = 3;
...
int func_31(var uParam0) // Position - 0x2C40 Hash - 0xFEBB5B4A ^0xC759ADAC
{
	if (!uParam0->f_469[1])
	{
		if (func_66(uParam0, &uLocal_17, true))
		{
			if (*uParam0 == 172)
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], hLocal_11, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
		...
		case 1:
			if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848) || func_72(&uLocal_13, 20f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					if (*uParam0 != 172)
						...
						TASK::TASK_STAND_STILL(uParam0->f_20[0 /*14*/], BUILTIN::FLOOR(5f * 1000f));
			...
			else if (*uParam0 == 172)
			{
				if (!bLocal_16)
				{
					TASK::REACT_LOOK_AT(uParam0->f_20[0 /*14*/], Global_35, 1, 1, 30000f, 1, 0, 0, 0);
					uLocal_45.f_3 = Global_35;
					uLocal_45.f_7 = 0;
					func_70(&uLocal_13);
					bLocal_16 = true;
				}
				...
				{
					IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[0 /*14*/], &uLocal_45);
				}
			}
			break;
	
		case 2:
			if (func_72(&uLocal_13, 5f))
			{
				if (*uParam0 != 172)
...
int func_32(var uParam0, var uParam1) // Position - 0x2E67 Hash - 0x3105A36D ^0x3105A36D
{
	func_73(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2E79 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2E96 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2FD2 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x310B Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x31B5 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x322D Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x32BC Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x33D7 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x33E3 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x356B Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x360B Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x361E Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3638 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x36A0 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x36CC Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

BOOL func_48(int iParam0) // Position - 0x36DA Hash - 0x259E3CFD ^0x259E3CFD
{
	int num;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x392E Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_50(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x39BC Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_51(int iParam0) // Position - 0x3BC0 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x3BD4 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_53() // Position - 0x3BE3 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_74() != -1;
}

BOOL func_54(var uParam0, Any* panParam1) // Position - 0x3BFE Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_55(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3C5D Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_56(Ped pedParam0) // Position - 0x3C9F Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x3CCB Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3D47 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3D6D Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3D8F Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3DB1 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3DD3 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3DF7 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_64(var uParam0, int iParam1) // Position - 0x3E1B Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

void func_65(var uParam0, float fParam1) // Position - 0x3E29 Hash - 0x4F8BE4B5 ^0x3B01A701
{
	uParam0->f_23 = fParam1;
	return;
}

BOOL func_66(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3E37 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_67(var uParam0) // Position - 0x3E91 Hash - 0xD1221E9 ^0xD1221E9
{
	if (!uParam0->f_469[3])
	{
...
void func_68(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3EDA Hash - 0x6DE5BABD ^0x14BE368D
{
...
int func_69(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3F02 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_70(var uParam0) // Position - 0x3FF9 Hash - 0x4A362F74 ^0x4A362F74
{
	func_106(uParam0, 0f);
	return;
}

BOOL func_71(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x400A Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_72(var uParam0, float fParam1) // Position - 0x4215 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_112(uParam0))
		return false;
...
void func_73(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x423C Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_74() // Position - 0x4390 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_75(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x439E Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4405 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x442E Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_78(var uParam0, var uParam1, var uParam2) // Position - 0x447A Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_79(int iParam0) // Position - 0x44C9 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_80(int iParam0) // Position - 0x44EE Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_81(int iParam0) // Position - 0x4501 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_82(int iParam0) // Position - 0x4514 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_83(int iParam0) // Position - 0x4527 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_84(int iParam0) // Position - 0x4539 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_85(int iParam0, int iParam1) // Position - 0x454B Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x45E5 Hash - 0xA65AB937 ^0xA65AB937
{
...
int func_87() // Position - 0x461D Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

BOOL func_88() // Position - 0x4629 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_89(int iParam0) // Position - 0x467C Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_92(iParam0))
		return -1;
...
BOOL func_90(int iParam0) // Position - 0x469C Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_91(int iParam0, int iParam1) // Position - 0x46B2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(int iParam0) // Position - 0x46C1 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_93(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x46F4 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x47D5 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_101(iParam0, 4);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x47F3 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_101(iParam0, 8);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4813 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_101(iParam0, 16);
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x483E Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_101(iParam0, 32);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x485E Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_101(iParam0, 64);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x487E Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x48A0 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_101(int iParam0, int iParam1) // Position - 0x48C4 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x48D5 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4EFE Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_104(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4FD5 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_105(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x50D9 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_106(var uParam0, float fParam1) // Position - 0x5102 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_107(Ped pedParam0) // Position - 0x5128 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_108(Ped pedParam0) // Position - 0x5143 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_109(float fParam0) // Position - 0x515F Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_110(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x51A6 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_111(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x51C4 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_112(var uParam0) // Position - 0x521B Hash - 0x5001E582 ^0x5001E582
{
	return func_167(*uParam0, 1);
}

BOOL func_113(var uParam0, float fParam1) // Position - 0x522B Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_114(var uParam0) // Position - 0x5249 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_115(var uParam0) // Position - 0x525F Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_112(uParam0))
		return uParam0->f_1;
...
BOOL func_116(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5294 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_117(BOOL bParam0, var uParam1, var uParam2) // Position - 0x52E9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_118(int iParam0, int iParam1) // Position - 0x5300 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_119(int iParam0, int iParam1) // Position - 0x5386 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_120(int iParam0, int iParam1) // Position - 0x53C2 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_121(int iParam0, int iParam1) // Position - 0x5415 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_122(int iParam0, int iParam1) // Position - 0x5450 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_123(int iParam0, int iParam1) // Position - 0x5489 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_124(int iParam0) // Position - 0x54C1 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_125(BOOL bParam0) // Position - 0x54FF Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_126(ePedType eptParam0) // Position - 0x5512 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_127(Ped pedParam0, Hash hParam1) // Position - 0x5965 Hash - 0xF1114F48 ^0x6D830570
{
...
void func_128(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5A0C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_129(Ped pedParam0, BOOL bParam1) // Position - 0x5A3C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_130(Ped pedParam0, int iParam1) // Position - 0x5A81 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_131(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5AA8 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_173(iParam2);
...
BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x5C73 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_133(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5D4A Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x5D87 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_135(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5E6E Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x5F44 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_137(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x604D Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_138(int iParam0, int iParam1) // Position - 0x6182 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_139(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x61B9 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_140(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x62C0 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x632B Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x6473 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_143(var uParam0, int iParam1) // Position - 0x664F Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0x66C7 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_145(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x66F6 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_146(int iParam0, Ped pedParam1) // Position - 0x687C Hash - 0x6F12CB32 ^0x50C88487
{
	int _int;
...
BOOL func_147(int iParam0, Ped pedParam1) // Position - 0x68C9 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_200(iParam0))
		return true;
...
BOOL func_148(Ped pedParam0, Ped pedParam1) // Position - 0x6966 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_149() // Position - 0x69B3 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_150(int iParam0, Ped pedParam1) // Position - 0x69BB Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_151() // Position - 0x6A7C Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_152() // Position - 0x6A9A Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x6AE7 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_154(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6C03 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_155(Ped pedParam0, int iParam1) // Position - 0x6C4B Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_156(Ped pedParam0, int iParam1) // Position - 0x6EA4 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_210(0))
		return false;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x6EDD Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_158(var uParam0, int iParam1) // Position - 0x6F0C Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6F20 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_160(int iParam0, Ped pedParam1) // Position - 0x6F6D Hash - 0x668F59A5 ^0x6678FF6C
{
...
void func_161(int iParam0) // Position - 0x6FC0 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_162(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7041 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_163() // Position - 0x7132 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_164(var uParam0, int iParam1) // Position - 0x7164 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_165(var uParam0, int iParam1) // Position - 0x7175 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_166(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x718A Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_167(int iParam0, int iParam1) // Position - 0x71A8 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_168(var uParam0) // Position - 0x71B7 Hash - 0x39705408 ^0x39705408
{
	return func_167(*uParam0, 2);
}

BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x71C7 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x71F5 Hash - 0x49FCDF05 ^0x2459BA07
{
	Hash _int;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x7243 Hash - 0x49FCDF05 ^0x2459BA07
{
	Hash _int;
	int _int2;
...
void func_172(Ped pedParam0) // Position - 0x72B1 Hash - 0xEDE9FC56 ^0x1002D53D
{
...
void func_173(int iParam0) // Position - 0x72CD Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_174(int iParam0) // Position - 0x7439 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_175(BOOL bParam0) // Position - 0x744C Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_176(int iParam0) // Position - 0x7466 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_177(int iParam0) // Position - 0x74FE Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_178(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7525 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_179(Ped pedParam0, Ped pedParam1) // Position - 0x761E Hash - 0xF9959663 ^0xF9959663
{
	return func_201(pedParam0, pedParam1, true, true);
}

float func_180(int iParam0) // Position - 0x7630 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_181(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x763C Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_182(int iParam0, BOOL bParam1) // Position - 0x76A1 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_183() // Position - 0x76C7 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_184(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x76DB Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_185(int iParam0) // Position - 0x783B Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_186(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7847 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_187(int iParam0) // Position - 0x78A8 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_188(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x78B4 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_189(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7976 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_190(int iParam0) // Position - 0x7A14 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_191(int iParam0) // Position - 0x7A20 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_192(int iParam0) // Position - 0x7A2C Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_193(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7B69 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_194(Ped pedParam0) // Position - 0x7BAC Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C12 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C59 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7CA4 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_198(Ped pedParam0, var uParam1) // Position - 0x7D1D Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_199(Ped pedParam0, Ped pedParam1) // Position - 0x7D6A Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_200(int iParam0) // Position - 0x7DB2 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_201(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7DC2 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_202(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7E0A Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7E36 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_204(int iParam0) // Position - 0x7E5E Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_205(Ped pedParam0) // Position - 0x7E6A Hash - 0x2EB68617 ^0x489889E4
{
...
int func_206(Ped pedParam0) // Position - 0x7EBE Hash - 0x6713168A ^0x4EB795D1
{
...
BOOL func_207(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7F28 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_208(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x809A Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_209(int iParam0, Ped pedParam1) // Position - 0x8188 Hash - 0x253FFEB9 ^0x6354886
{
...
BOOL func_210(int iParam0) // Position - 0x81FC Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_227())
		return false;
...
int func_211(int iParam0) // Position - 0x821E Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_212(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x822A Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_213(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x82A5 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_214() // Position - 0x8331 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_215(Any* panParam0, int iParam1) // Position - 0x8387 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_216(BOOL bParam0, var uParam1, var uParam2) // Position - 0x842F Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_217() // Position - 0x84F6 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_218(int iParam0) // Position - 0x8504 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_219(int iParam0) // Position - 0x85AC Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_220(Ped pedParam0, int iParam1) // Position - 0x8611 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_221(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8628 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_222(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8656 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_223(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x86A0 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_224(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x86E1 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_225(Ped pedParam0) // Position - 0x875A Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_226(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8842 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_227() // Position - 0x8884 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_217() != -1)
		return false;
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x88A9 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_229(int iParam0) // Position - 0x88DA Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_230() // Position - 0x88ED Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x891E Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_92(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x893A Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_233(int iParam0) // Position - 0x897B Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
