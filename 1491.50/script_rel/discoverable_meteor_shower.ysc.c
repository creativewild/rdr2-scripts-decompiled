...
void func_8(var uParam0) // Position - 0xA35 Hash - 0xCEDC48A4 ^0xE48C7C26
{
	int num;
	int num2;
	int i;
	...
	switch (iLocal_14)
	{
		case 0:
			...
			for (i = 0; i <= 0; i = i + 1)
			{
				if (!func_54(&iLocal_14.f_5[i], func_53(i)))
					return;
			}
		...
		case 1:
			if (!func_55(Global_35, iLocal_14.f_5[0], true, 0))
				return;
		...
		case 3:
			iLocal_14.f_7 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(func_57(), func_58(0), 0f, 0f, 0f, 1065353216, false, false, false, false);
			func_25(&(iLocal_14.f_1));
			func_52(&iLocal_14, 4);
			break;
	
		case 4:
			if (func_59(&(iLocal_14.f_1)) > 60f)
			{
				GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_14.f_7, false);
				func_60(uParam0);
				func_52(&iLocal_14, 5);
			}
			break;
...
void func_9(var uParam0) // Position - 0xB66 Hash - 0x19A4A379 ^0xD17077A
{
	int i;

	for (i = 0; i <= 0; i = i + 1)
	{
		func_61(&iLocal_14.f_5[i]);
	}

	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_14.f_7))
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_14.f_7, false);
...
int func_10(Hash hParam0) // Position - 0xBA4 Hash - 0xB8EC44B7 ^0xB12C5BE7
{
	switch (hParam0)
	{
...
BOOL func_11(int iParam0, BOOL bParam1) // Position - 0x1395 Hash - 0x92045BA6 ^0x92045BA6
{
	if (!func_62(iParam0))
		return false;

	return Global_40.f_8863[func_63(iParam0, 1)] && bParam1 != false;
}

void func_12(var uParam0) // Position - 0x13BF Hash - 0xDA8817E5 ^0xAD3AC0C4
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
Vector3 func_13(var uParam0, int iParam1) // Position - 0x18A3 Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case -1859023693:
		...
		case 2000209669:
			return func_64(uParam0, iParam1);
...
float func_14(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1D59 Hash - 0x3DAE1415 ^0x2267FA69
{
...
BOOL func_15() // Position - 0x1D81 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_67() != -1)
		return false;
...
BOOL func_16(int iParam0) // Position - 0x1DA6 Hash - 0x7F255B4B ^0xCD4BFF4B
{
	if (!(iParam0 > -1 && iParam0 <= 80))
		return false;

	if (Global_1572887.f_12 == -1)
		return func_68(Global_1835011[iParam0 /*74*/].f_1, true);

	return UNLOCK::UNLOCK_IS_UNLOCKED(Global_1835011[iParam0 /*74*/].f_2) && !UNLOCK::UNLOCK_IS_VISIBLE(Global_1835011[iParam0 /*74*/].f_2);
}

BOOL func_17(var uParam0) // Position - 0x1E05 Hash - 0x700EF42A ^0x1FB24E73
{
...
void func_18(var uParam0) // Position - 0x1E1E Hash - 0xB1BE772 ^0x50C155FC
{
	if (func_33(uParam0->f_6.f_8))
		func_69(&(uParam0->f_6.f_8), true, true);
...
void func_19(var uParam0, int iParam1) // Position - 0x1E5E Hash - 0x4F8BE4B5 ^0x8A18C31F
{
	uParam0->f_5 = iParam1;
	return;
}

BOOL func_20(var uParam0) // Position - 0x1E6C Hash - 0x52835008 ^0x3922FFAC
{
	switch (*uParam0)
	{
		case -1859023693:
...
void func_21(var uParam0) // Position - 0x2B27 Hash - 0x32186C70 ^0xD26CF7E4
{
	uParam0->f_6.f_2 = { func_65(uParam0, uParam0->f_4) };
	uParam0->f_6.f_1 = 5f;
	uParam0->f_6 = 10f;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2D3F Hash - 0x16E871AD ^0x10C54C39
{
...
void func_23(var uParam0) // Position - 0x2D69 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_24(var uParam0) // Position - 0x2D7F Hash - 0x5001E582 ^0x5001E582
{
	return func_71(*uParam0, 1);
}

void func_25(var uParam0) // Position - 0x2D8F Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_72(uParam0, 0f);
	return;
}

int func_26(var uParam0) // Position - 0x2D9E Hash - 0xE440ADBD ^0x7BE35012
{
	if (!func_24(uParam0))
	...
	return func_74() - BUILTIN::ROUND(uParam0->f_1 * 1000f);
}

BOOL func_27(var uParam0, BOOL bParam1) // Position - 0x2DF1 Hash - 0x1ACEECAF ^0xDBC34297
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;
	...
	if (bParam1)
	{
		...
		if (*uParam0 == -1761578407 || *uParam0 == 404434344 || *uParam0 == -1243267511 || *uParam0 == -607940493 || *uParam0 == 1535254161)
		{
			...
			if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, uParam0->f_6.f_9, true, 0) || !func_77(Global_35, uParam0->f_6.f_2, 0))
				return true;
		}
		else if (func_14(Global_35, uParam0->f_6.f_2, true) > uParam0->f_6.f_1 + 0.5f || !func_77(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
	else
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, true) <= uParam0->f_6.f_1 && func_77(Global_35, uParam0->f_6.f_2, 0))
		{
			return true;
		}
	}
...
void func_28(var uParam0) // Position - 0x3013 Hash - 0x8F06DBDB ^0x2EE20047
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_51(*uParam0))
			{
				uParam0->f_6.f_8 = func_78("DISCO_FOCUS", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
				func_34(uParam0->f_6.f_8, false, true);
			}
			else
			{
				uParam0->f_6.f_8 = func_78("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_78("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_78("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, false, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("PLAYER_FOCUS_TIMING"), false, false);
		}
	
		func_79(uParam0->f_6.f_8, 13, true, true);
		func_80(uParam0->f_6.f_8);
	}

	return;
}

char* func_29(var uParam0) // Position - 0x3455 Hash - 0xAD1F4E36 ^0xB9AF6B11
{
	if (*uParam0 == 404434344)
		if (func_51(*uParam0))
...
void func_30(var uParam0, int iParam1, char* sParam2, BOOL bParam3) // Position - 0x3CC1 Hash - 0x92B8786B ^0x6992BF35
{
	int num;
	int num2;
	int num3;
...
BOOL func_31(var uParam0) // Position - 0x3D8C Hash - 0x87BF472A ^0x8A3FB963
{
	if (func_82(uParam0->f_6.f_8, true))
		return true;

	return false;
}

void func_32(int iParam0, BOOL bParam1) // Position - 0x3DA7 Hash - 0x54AA129E ^0x54AA129E
{
	if (!func_62(iParam0))
		return;

	Global_40.f_8863[func_63(iParam0, 1)] = Global_40.f_8863[func_63(iParam0, 1)] || bParam1;
	return;
}

BOOL func_33(int iParam0) // Position - 0x3DDD Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
void func_34(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3E1C Hash - 0x139797B1 ^0x139797B1
{
	int num;
...
void func_35(var uParam0) // Position - 0x3E48 Hash - 0xB093A844 ^0xA61CDF5C
{
	if (func_67() != -1)
		return;
	...
	if (*uParam0 == -321841939)
	{
		if (func_84(uParam0->f_4) != 0)
		{
			if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(uParam0->f_4))
				MAP::_MAP_DISCOVER_REGION(func_84(uParam0->f_4));
	...
	{
		if (func_85(*uParam0, uParam0->f_4) != 0)
		{
			if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(func_85(*uParam0, uParam0->f_4)))
				MAP::_MAP_DISCOVER_REGION(func_85(*uParam0, uParam0->f_4));
...
void func_36(var uParam0, BOOL bParam1) // Position - 0x3ED6 Hash - 0x3BBAC949 ^0x751C9296
{
	int num;
	...
	if (bParam1)
		num = func_90(*uParam0, func_89(), uParam0->f_4);
	else
		num = func_91(*uParam0, uParam0->f_4);
		...
		if (bParam1)
		{
			...
			if (*uParam0 == -890175011)
			{
				if (func_93() == 5 - 1)
				{
					if (func_89())
					{
						func_92(joaat("journal_town_secret_vampmap_ar"), 0);
						num = joaat("journal_town_secret_vampmap_ar");
					}
					else
					{
						func_92(joaat("journal_town_secret_vampmap_jn"), 0);
...
void func_37(BOOL bParam0, int iParam1) // Position - 0x3FA7 Hash - 0x28F6DA48 ^0xFBF7E1AC
{
...
float func_38(int iParam0, BOOL bParam1) // Position - 0x3FED Hash - 0x84BA49FE ^0x8706598E
{
	int num;
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x4046 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_40(var uParam0, int iParam1) // Position - 0x4055 Hash - 0xF55E891F ^0xF55E891F
{
	func_97(uParam0, iParam1);
	return;
}

void func_41(var uParam0) // Position - 0x4065 Hash - 0x7DD80D7C ^0x2A3ED7AA
{
	...
	uParam0->f_6.f_10 = { func_65(uParam0, uParam0->f_4) };
	return;
}

void func_42(var uParam0) // Position - 0x40AC Hash - 0xC9354E8F ^0x12F79925
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
void func_43(var uParam0, int iParam1) // Position - 0x40CC Hash - 0xF55E891F ^0xF55E891F
{
	func_98(uParam0, iParam1);
	return;
}

void func_44(var uParam0) // Position - 0x40DC Hash - 0x90A3D13B ^0x25DA303B
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
...
BOOL func_45(int iParam0) // Position - 0x40F8 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -1891628345:
...
BOOL func_46(var uParam0) // Position - 0x4176 Hash - 0xA77C53D8 ^0x41543EB2
{
	Vector3 vector;
	var coords;
	...
	{
		func_99(*uParam0, &vector);
	
		if (FIRE::GET_OWNER_OF_EXPLOSION_IN_ANGLED_AREA(-1, vector, vector.f_3, vector.f_6) == func_100(Global_35))
		{
			return true;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, const char* sParam3, Entity eParam4, BOOL bParam5, int iParam6, BOOL bParam7) // Position - 0x41FF Hash - 0xA48CCCFA ^0xD20D1AD3
{
	int num;
	int num2;
	int i;
	...
	if (Global_36616 && func_101(iParam1) != false)
		return;
	...
	{
		func_103(num, false, iParam0, iParam1, sParam3, eParam4, bParam5, bParam7);
	}
	else
	{
		num2 = -1;
		...
		if (num2 >= 0)
			func_104(num2, num, iParam0, iParam1, eParam4, bParam5);
		else
			func_103(num, true, iParam0, iParam1, sParam3, eParam4, bParam5, false);
	}

	return;
}

int func_48() // Position - 0x42FE Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

int func_49(int iParam0) // Position - 0x430A Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_50() // Position - 0x431D Hash - 0x9F572D68 ^0xF777D570
{
	return -777150535;
}

BOOL func_51(int iParam0) // Position - 0x432A Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_11(iParam0, 2);
}

void func_52(var uParam0, int iParam1) // Position - 0x4339 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

struct<11> func_53(int iParam0) // Position - 0x4346 Hash - 0xFE1923F2 ^0xEFA6466A
{
	var unk;
	...
	{
		case 0:
			unk = { 2383.6667f, 2032.5778f, 171.66655f };
			unk.f_3 = { 0f, 0f, 0f };
			unk.f_6 = { 5f, 5f, 5f };
			unk.f_9 = "METEOR_SHOWER_CLIFF_SPAWN";
...
BOOL func_54(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x439A Hash - 0xC822A061 ^0xC4A17121
{
	if (!VOLUME::DOES_VOLUME_EXIST(*uParam0))
...
BOOL func_55(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x43DC Hash - 0x6735ACA9 ^0xD6205CC6
{
...
BOOL func_56(int iParam0, int iParam1, int iParam2) // Position - 0x4412 Hash - 0xD8381BE7 ^0xD8381BE7
{
	BOOL flag;
	int num;
	int num2;
...
char* func_57() // Position - 0x44BB Hash - 0x306ACA3A ^0xD5B2693A
{
	return "scr_disc_meteor_shower";
}

Vector3 func_58(int iParam0) // Position - 0x44C7 Hash - 0x72DB1375 ^0x72DB1375
{
	switch (iParam0)
	{
		case 0:
			return 2895.893f, 1650.2129f, 1000.86316f;
...
float func_59(var uParam0) // Position - 0x44F2 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_24(uParam0))
		return uParam0->f_1;
...
void func_60(var uParam0) // Position - 0x4527 Hash - 0x46A0187B ^0x46A0187B
{
	if (!func_51(*uParam0))
	{
		func_106(*uParam0);
...
void func_61(var uParam0) // Position - 0x4547 Hash - 0xBC16CD98 ^0xD54744FF
{
	if (VOLUME::DOES_VOLUME_EXIST(*uParam0))
...
BOOL func_62(int iParam0) // Position - 0x4560 Hash - 0x1965A61D ^0x1965A61D
{
	int num;

	num = func_63(iParam0, 1);
	return num >= 0 && num < 143;
}

int func_63(int iParam0, int iParam1) // Position - 0x457F Hash - 0x18EDA9F0 ^0x18EDA9F0
{
	switch (iParam0)
	{
		case -2108030724:
...
Vector3 func_64(var uParam0, int iParam1) // Position - 0x4BC8 Hash - 0xAF22EF00 ^0xAF22EF00
{
	switch (*uParam0)
	{
		case 2000209669:
...
Vector3 func_65(var uParam0, int iParam1) // Position - 0x4CD9 Hash - 0xC47AB599 ^0xC47AB599
{
	switch (*uParam0)
	{
		case -2009137002:
...
Vector3 func_66(var uParam0, int iParam1) // Position - 0x5651 Hash - 0xBAE0ABDC ^0xBAE0ABDC
{
	switch (*uParam0)
	{
		case -1887999095:
...
BOOL func_67() // Position - 0x58E3 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_68(int iParam0, BOOL bParam1) // Position - 0x58F1 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_69(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5922 Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
void func_70(var uParam0) // Position - 0x5976 Hash - 0x87234A3C ^0x21D7A27C
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
	...
	if (*uParam0 == 404434344)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vector, vector2, vector3, func_111(uParam0));
	}
	else if (*uParam0 == -1761578407)
	{
		if (uParam0->f_4 == 0)
	...
	else if (*uParam0 == -1243267511 || *uParam0 == 1535254161 || *uParam0 == -607940493)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_6.f_9))
			if (*uParam0 == -607940493)
				...
				uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vector, vector2, vector3, func_111(uParam0));
	}
	else if (*uParam0 == -890175011)
	{
		if (uParam0->f_4 == 0)
...
BOOL func_71(int iParam0, int iParam1) // Position - 0x5EE7 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_72(var uParam0, float fParam1) // Position - 0x5EF6 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_73(var uParam0) // Position - 0x5F1C Hash - 0x39705408 ^0x39705408
{
	return func_71(*uParam0, 2);
}

int func_74() // Position - 0x5F2C Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_75(var uParam0) // Position - 0x5F4A Hash - 0xD965F2AB ^0x4503AF3C
{
	switch (*uParam0)
	{
		case -1300082860:
			if (func_114(Global_35, func_107(uParam0, 0), 3f, true, true))
				return true;
			break;
...
BOOL func_76(var uParam0, int iParam1) // Position - 0x601B Hash - 0x787E614B ^0xC23272A0
{
	if (ENTITY::IS_ENTITY_DEAD(Global_35))
		return false;

	if (!func_115(iParam1, 1))
	{
	...
	if (!func_115(iParam1, 2) && !func_116())
		return false;

	if (!func_115(iParam1, 4) && !func_117())
		return false;

	if (!func_115(iParam1, 128) && !func_118())
		return false;

	if (!func_115(iParam1, 2048) && !func_119(false))
		return false;

	if (!func_115(iParam1, 32) && !func_120(iParam1))
		return false;

	if (!func_115(iParam1, 64) && !func_121())
		return false;

	if (!func_115(iParam1, 256) && CAM::IS_CINEMATIC_CAM_RENDERING())
		return false;

	if (!func_115(iParam1, 512))
		if (PED::GET_PED_CROUCH_MOVEMENT(Global_35))
			return false;

	if (!func_115(iParam1, 1024))
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1))
		return false;
	else if (func_122(Global_35, 1369124074))
		return false;
	else if (func_122(Global_35, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
		return false;

	return true;
}

BOOL func_77(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x619E Hash - 0xE63CB60C ^0x5133A9E3
{
...
int func_78(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x61DF Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_124(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, iParam8, 0, pedParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, bParam16);
		return num;
	}
...
void func_79(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x62B6 Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
void func_80(int iParam0) // Position - 0x6301 Hash - 0x4FCB23E1 ^0x764A8AAB
{
	int num;
...
int func_81(int iParam0) // Position - 0x6343 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x634D Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_83(int iParam0, BOOL bParam1) // Position - 0x63A5 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
		if (Global_1945188[iParam0 /*18*/].f_5 == 5 && !func_123(iParam0, 8))
...
Hash func_84(int iParam0) // Position - 0x63FD Hash - 0xB8EC44B7 ^0x184A6D50
{
	switch (iParam0)
	{
		case 0:
...
Hash func_85(int iParam0, int iParam1) // Position - 0x6526 Hash - 0xE1D12727 ^0x5FD78BB4
{
	switch (iParam0)
	{
		case -2009137002:
...
void func_86(var uParam0) // Position - 0x680E Hash - 0x12B095D ^0x8F05BAE7
{
	if (func_67() != -1)
		return;

	if (func_125(*uParam0) != 0)
	{
		if (!MAP::_MAP_IS_DISCOVERY_ACTIVE(func_125(*uParam0)))
			MAP::_MAP_DISCOVER_REGION(func_125(*uParam0));
...
int func_87() // Position - 0x684F Hash - 0x1767447B ^0x234018D7
{
	int i;
	int num;
	int num2;
...
BOOL func_88() // Position - 0x688D Hash - 0xA0319B77 ^0x14CE505F
{
	int i;
	int num;
...
BOOL func_89() // Position - 0x68C9 Hash - 0x37EC066 ^0xC9B08D38
{
	if (func_67() != -1)
		return false;
...
int func_90(int iParam0, int iParam1, int iParam2) // Position - 0x68EF Hash - 0xFCD0B11D ^0x62D50FE4
{
	if (iParam1 == true)
	{
		switch (iParam0)
...
int func_91(int iParam0, int iParam1) // Position - 0x70FB Hash - 0xF3B2DCFE ^0x9CB24CD5
{
	int num;

	num = func_90(iParam0, 1, iParam1);

	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(num))
		return num;

	num = func_90(iParam0, 0, iParam1);
...
void func_92(int iParam0, int iParam1) // Position - 0x7138 Hash - 0xC0D8FAC3 ^0xE4233006
{
...
int func_93() // Position - 0x7151 Hash - 0xFA45A8A9 ^0x233CB2BD
{
	int num;
...
BOOL func_94() // Position - 0x71D7 Hash - 0x4A33814C ^0x6E4357BF
{
	Hash item;

	if (!func_128(joaat("document_player_journal"), 1, false))
	{
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) || func_122(Global_35, 1369124074))
		return false;
	...
	if (INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(func_130(false), item, false))
		return false;
...
void func_95(Hash hParam0, int iParam1) // Position - 0x7304 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_96() // Position - 0x7317 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

void func_97(var uParam0, int iParam1) // Position - 0x7336 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_98(var uParam0, int iParam1) // Position - 0x7347 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_99(Volume volParam0, var uParam1) // Position - 0x735C Hash - 0x7513460B ^0x6C9F3BDD
{
	float volumeScale;
...
Ped func_100(Ped pedParam0) // Position - 0x73DC Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_101(int iParam0) // Position - 0x73E6 Hash - 0xA05361F6 ^0xF8A0FD3E
{
	switch (iParam0)
	{
...
int func_102(int iParam0) // Position - 0x74FC Hash - 0xC25EDEC0 ^0x47BF4274
{
	switch (iParam0)
	{
		case 0:
...
void func_103(int iParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, Entity eParam5, BOOL bParam6, BOOL bParam7) // Position - 0x75E3 Hash - 0x9A51185A ^0x2E856182
{
	int num;
	int num2;
	int num3;
	...
	Global_40.f_11095.f_35 = func_135(Global_40.f_11095.f_35, num4, num3);
	num2 = func_132();

	if (num2 != num && num2 != 0 || iParam3 == joaat("honor_event_cheat") || bParam7)
	{
		num7 = func_136(num2);
		func_138(func_137(), false, 4000);
		func_139(Global_40.f_11095.f_35);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_142(func_141(joaat("honor_positive_total")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_144(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
				else
					func_144(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", str, 0, true);
			}
		}
		else
		{
			func_142(func_141(joaat("honor_negative_total")), 1);
			Global_1347477.f_204 = 0;
		
			if (!bParam1)
			{
				if (iParam0 < func_102(4))
				{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
					func_144(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
				else
					func_144(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", str, 0, true);
			}
		}
	}

	statId = { func_141(joaat("honor_current")) };
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3, Entity eParam4, BOOL bParam5) // Position - 0x7988 Hash - 0x686957A ^0x8F82E8D6
{
...
float func_105() // Position - 0x79E7 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_106(int iParam0) // Position - 0x7A19 Hash - 0xDA84A767 ^0xDA84A767
{
	func_32(iParam0, 2);
	func_146(iParam0);
	return;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
Vector3 func_107(var uParam0, int iParam1) // Position - 0x7A2E Hash - 0xE500AA03 ^0xE500AA03
{
	switch (*uParam0)
	{
		case -2108030724:
...
Vector3 func_108(var uParam0, int iParam1) // Position - 0x8535 Hash - 0xABFFD40 ^0xABFFD40
{
	switch (*uParam0)
	{
		case -2108030724:
...
int func_109(int iParam0) // Position - 0x9084 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_149(iParam0))
		return -1;
...
void func_110(int iParam0) // Position - 0x90A0 Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_151(iParam0))
		return;
...
char* func_111(var uParam0) // Position - 0x9153 Hash - 0x8601690B ^0x732FA1AE
{
	switch (*uParam0)
	{
		case -1761578407:
...
void func_112(var uParam0, int iParam1) // Position - 0x931A Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_113(var uParam0, int iParam1) // Position - 0x932B Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_114(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9340 Hash - 0x4F47D7F1 ^0x1C676405
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_115(int iParam0, int iParam1) // Position - 0x939B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_116() // Position - 0x93AA Hash - 0xD50A7FC ^0x92986A81
{
...
BOOL func_117() // Position - 0x944A Hash - 0x52218EDE ^0x68EAB229
{
...
BOOL func_118() // Position - 0x94DF Hash - 0xD14A8C13 ^0x8AD85514
{
...
BOOL func_119(BOOL bParam0) // Position - 0x951C Hash - 0x19762284 ^0x80872951
{
...
BOOL func_120(int iParam0) // Position - 0x9554 Hash - 0xEEF44B5 ^0x85627F39
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if (!func_115(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35) && VEHICLE::GET_DRIVER_OF_VEHICLE(vehiclePedIsUsing) == Global_35)
			return false;
	}
...
BOOL func_121() // Position - 0x962C Hash - 0xFFDF5CA4 ^0x50D2CF98
{
...
BOOL func_122(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x9643 Hash - 0x37FB14EB ^0x7E496A4A
{
...
BOOL func_123(int iParam0, int iParam1) // Position - 0x966C Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_124(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Ped pedParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x968D Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
...
Hash func_125(int iParam0) // Position - 0x9933 Hash - 0xB8EC44B7 ^0xC091C19D
{
	switch (iParam0)
	{
		case -2060865802:
...
int func_126(int iParam0) // Position - 0x9A24 Hash - 0x333EB83A ^0x37C96C1F
{
	switch (iParam0)
	{
		case 0:
...
void func_127(BOOL bParam0) // Position - 0x9B22 Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_128(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x9B4C Hash - 0x41C0912B ^0x734B270C
{
	int num;
...
BOOL func_129(int iParam0) // Position - 0x9BB6 Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_166(iParam0);
}

int func_130(BOOL bParam0) // Position - 0x9BC4 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_67() == -1)
	{
...
void func_131() // Position - 0x9C05 Hash - 0x5808700A ^0x37855CE9
{
...
int func_132() // Position - 0x9C5A Hash - 0x990ADDDC ^0x7D78C12
{
	int num;
...
int func_133(int iParam0) // Position - 0x9D6D Hash - 0xFA6423C1 ^0xB73AD7F1
{
	float num;
	float value;
...
BOOL func_134(int iParam0) // Position - 0x9E12 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_169(iParam0))
		return false;
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0x9E2E Hash - 0x1D7642BB ^0x1D7642BB
{
	if (iParam0 > iParam2)
		return iParam2;
...
int func_136(int iParam0) // Position - 0x9E53 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case -320:
...
Hash func_137() // Position - 0x9F0A Hash - 0xA46C8CCA ^0x71ABACD2
{
...
void func_138(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xA062 Hash - 0x25ED411C ^0xE6F9BEA9
{
...
void func_139(int iParam0) // Position - 0xA08E Hash - 0x1FF74488 ^0xA40278BB
{
...
// Unhandled jump detected. Output should be considered invalid
void func_140(BOOL bParam0) // Position - 0xA0F2 Hash - 0x9BEFE017 ^0x9BEFE017
{
	int num;
	Hash unlockHash;
	Hash hash;
...
struct<2> func_141(int iParam0) // Position - 0xA1B3 Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_142(var uParam0, var uParam1, int iParam2) // Position - 0xA1C3 Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

const char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xA1D3 Hash - 0xA17D549C ^0x293FE95A
{
	switch (iParam0)
	{
		case joaat("honor_event_abandon_animals"):
...
int func_144(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xA31F Hash - 0x72075C17 ^0x3AC6D3FB
{
	int num;
	var unk13;
	int num2;
...
int func_145(int iParam0, int iParam1) // Position - 0xA382 Hash - 0x969A241 ^0xB7B020D1
{
	Hash chalHash;
	Hash goalHash;
...
void func_146(int iParam0) // Position - 0xA3DD Hash - 0xF9F788B3 ^0x8192C5D9
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_181(iParam0))
			func_142(func_141(joaat("discoverable_found")), 1);
	}

	return;
}

BOOL func_147() // Position - 0xA419 Hash - 0x18690106 ^0x764E08E6
{
...
BOOL func_148() // Position - 0xA432 Hash - 0x18690106 ^0xE41C0B15
{
...
BOOL func_149(int iParam0) // Position - 0xA44B Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_150(int iParam0) // Position - 0xA47E Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_151(int iParam0) // Position - 0xA4BF Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_123(iParam0, 2);
}

float func_152(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xA4CE Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_153(Ped pedParam0) // Position - 0xA4EC Hash - 0xF2F988FE ^0xA63CD631
{
...
BOOL func_154(Ped pedParam0) // Position - 0xA5D4 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_184(pedParam0, 4) || func_184(pedParam0, 5);
}

BOOL func_155(Ped pedParam0) // Position - 0xA5F0 Hash - 0x8F7DFED5 ^0x8768F0B4
{
	var lootTarget;
...
int func_156(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xA65A Hash - 0x8EBD6187 ^0x42F0F0AC
{
	int num;
	var unk13;
	int num2;
...
BOOL func_157(int iParam0) // Position - 0xA695 Hash - 0xCB0CD3AF ^0x98FF0773
{
	Ped mount;
	...
	if (!func_115(iParam0, 16) && !func_186(mount, false))
		return false;

	return true;
}

void func_158(int iParam0, BOOL bParam1) // Position - 0xA6D3 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_159(int iParam0, int iParam1) // Position - 0xA6FC Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
void func_160(int iParam0, int iParam1) // Position - 0xA724 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_161(int iParam0, int iParam1) // Position - 0xA735 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_162(Hash hParam0, int iParam1) // Position - 0xA74A Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
int func_163(Hash hParam0) // Position - 0xA764 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_164(Hash hParam0, int iParam1) // Position - 0xA78F Hash - 0x2A2D0794 ^0x8C1DA314
{
	Hash hash;
	int num;
	int num2;
...
int func_165(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA837 Hash - 0x27EBD222 ^0x461275A8
{
	int num;
	Hash ammoType;
	...
	inventoryItemCountWithItemid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_130(bParam2), hParam0, false);
	return inventoryItemCountWithItemid;
}

BOOL func_166(int iParam0) // Position - 0xA8B9 Hash - 0xA059D395 ^0xE600C05
{
	return func_39(Global_1935496.f_27, iParam0);
}

int func_167() // Position - 0xA8CD Hash - 0xC5B83CF5 ^0xDBC2A9A7
{
	return Global_40.f_11095.f_35;
}

var func_168(BOOL bParam0, var uParam1, var uParam2) // Position - 0xA8DD Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_169(int iParam0) // Position - 0xA8F4 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_170(int iParam0) // Position - 0xA907 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_171(int iParam0, BOOL bParam1) // Position - 0xA931 Hash - 0xE5C16A63 ^0x600C7934
{
...
void func_172(Hash hParam0) // Position - 0xA94C Hash - 0x246AED7E ^0x92A2F577
{
	COMPAPP::_0x74BCCEB233AD95B2(joaat("HonorMeterValue"), hParam0);
	return;
}

char* func_173(int iParam0) // Position - 0xA95F Hash - 0x8FB6A40C ^0x2EA08DB
{
	if (iParam0 <= -320)
		return "HONOR_BAD_8";
	else if (iParam0 <= -280)
...
BOOL func_174(var uParam0) // Position - 0xAA80 Hash - 0x89D7A86C ^0xC5CDC47A
{
	var unk;
...
BOOL func_175(int iParam0, var uParam1, var uParam2) // Position - 0xAAC8 Hash - 0x2D6E55B7 ^0xC1202559
{
	var unk;
	var unk6;
...
Hash func_176(Hash hParam0) // Position - 0xAB48 Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

int func_177() // Position - 0xAB52 Hash - 0xE17CEFF5 ^0x60DBA116
{
	int num;
...
void func_178(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0xABA1 Hash - 0xC233DF85 ^0x5FF82D96
{
...
BOOL func_179(int iParam0) // Position - 0xABD2 Hash - 0xB0C53BA8 ^0xB0C53BA8
{
...
BOOL func_180(int iParam0, var uParam1, var uParam2) // Position - 0xABF1 Hash - 0xB903AED3 ^0x206B1C87
{
	if (!func_179(iParam0))
		return false;
...
BOOL func_181(int iParam0) // Position - 0xADC0 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case -2009137002:
...
BOOL func_182(int iParam0) // Position - 0xAEEC Hash - 0xBF89485 ^0x62E162D4
{
	int num;
	int num2;
	int offset;
...
int func_183(int iParam0) // Position - 0xAF3B Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
int func_184(Ped pedParam0, int iParam1) // Position - 0xAFBC Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
BOOL func_185(Ped pedParam0) // Position - 0xAFFB Hash - 0x28235D58 ^0x5BD1001B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_186(Ped pedParam0, BOOL bParam1) // Position - 0xB018 Hash - 0x6BE4D4B ^0xC7F6BBCD
{
	float entitySpeed;
	float num;
...
Hash func_187(Hash hParam0, int iParam1) // Position - 0xB06E Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_188(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xB0E8 Hash - 0xA7F38D3E ^0x25D43AAB
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_130(bParam4), sParam0, hParam3, piParam2);
...
BOOL func_189(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB10F Hash - 0xF1DE71ED ^0x4F212F50
{
	if (iParam2 < 0)
		return false;
...
BOOL func_190(Hash hParam0) // Position - 0xB14A Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_191(int iParam0) // Position - 0xB165 Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
int func_192(Hash hParam0, BOOL bParam1) // Position - 0xB186 Hash - 0x884C76BA ^0xDB141D11
{
	var unk;
	int num;
	int num2;
...
void func_193(BOOL bParam0) // Position - 0xB1E4 Hash - 0x970FE035 ^0x92589DF6
{
	func_202(bParam0);
...
BOOL func_194(int iParam0, var uParam1) // Position - 0xB217 Hash - 0xDBBC0B25 ^0xDBBC0B25
{
	if (!func_203(iParam0))
		return false;
...
int func_195(int iParam0, int iParam1) // Position - 0xB244 Hash - 0x8FA0E29 ^0xC3F68E87
{
	switch (iParam0)
	{
		case -2106445152:
...
BOOL func_196(Hash hParam0, Hash hParam1) // Position - 0xC35F Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
void func_197(Hash hParam0, var uParam1, var uParam2) // Position - 0xC390 Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_198(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC59C Hash - 0x84700F53 ^0xB9E7AA96
{
	Hash hash;
...
struct<4> func_199(BOOL bParam0) // Position - 0xC66E Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;

	num = func_130(bParam0);
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xC703 Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_201(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xC71E Hash - 0xA09A22CB ^0x2B47F617
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_130(bParam3), panParam0, piParam2);
...
void func_202(BOOL bParam0) // Position - 0xC743 Hash - 0x246AED7E ^0xB30D729F
{
	COMPAPP::_0xB6FD96420C0126A1(joaat("HonorMeterVisible"), bParam0);
	return;
}

BOOL func_203(int iParam0) // Position - 0xC756 Hash - 0x3270B633 ^0x3270B633
{
	return iParam0 > -1 && iParam0 < 25;
}

struct<4> func_204(BOOL bParam0) // Position - 0xC76C Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_205(joaat("character"), func_206(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> func_205(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xC788 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_130(bParam6), &uParam1, hParam0, hParam5, &outGuid);
	return outGuid;
}

struct<4> func_206() // Position - 0xC7B9 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
