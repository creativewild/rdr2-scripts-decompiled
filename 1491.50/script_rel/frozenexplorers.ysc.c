...
BOOL func_15(int iParam0) // Position - 0x7EA Hash - 0x7CDD5F0D ^0x7CDD5F0D
{
	return func_48(&uLocal_14, 128, &uLocal_14, func_46(), 0, func_47(), false, 0, false);
}
...
int func_46() // Position - 0xD8B Hash - 0xF7BF776E ^0xF7BF776E
{
	return 44;
}
...
void func_62(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11A6 Hash - 0x970C9C8F ^0x6975580E
{
	BOOL flag;
	const char* str;
	char* str2;
...
char* func_107(int iParam0) // Position - 0x3F61 Hash - 0x21CE226B ^0x42DC1C40
{
	switch (iParam0)
	{
		case 0:
...
const char* func_114(var uParam0, int iParam1) // Position - 0x4070 Hash - 0xB0CFF0C3 ^0x3DA9E338
{
...
const char* func_160(int iParam0) // Position - 0x4B7C Hash - 0xE6862179 ^0x4D455654
{
	switch (iParam0)
	{
		case 0:
...
const char* func_163(const char* sParam0, int iParam1) // Position - 0x4EA6 Hash - 0x9E99F03 ^0x8B7A259
{
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x4FC9 Hash - 0x2F9EB0B9 ^0xD627DC62
{
	char* ambientZone;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x4FFD Hash - 0x342D57CF ^0x54B657C1
{
	switch (iParam0)
	{
		case 5:
