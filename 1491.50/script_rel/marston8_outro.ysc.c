...
int func_11(var uParam0) // Position - 0x31C Hash - 0xDDDC5092 ^0x130BCF4B
{
...
BOOL func_12(eStackSize essParam0) // Position - 0x343 Hash - 0xFD10BCB1 ^0xFD10BCB1
{
...
BOOL func_13(eStackSize essParam0) // Position - 0x362 Hash - 0xDA629583 ^0xDA629583
{
	return func_26(essParam0, 16, true);
}

BOOL func_14(eStackSize essParam0) // Position - 0x373 Hash - 0xC2BA9D92 ^0x340F97FF
{
...
void func_15(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x3A7 Hash - 0xA4706F79 ^0xAF27D1D3
{
	BOOL flag;
	PersChar persChar;
	BOOL flag2;
...
BOOL func_16(var uParam0, int iParam1) // Position - 0x65C Hash - 0x718DD1EF ^0x66842345
{
	return uParam0->f_3 && iParam1 != false;
}

void func_17(var uParam0, int iParam1) // Position - 0x66D Hash - 0xA4EAD31F ^0x3F77773B
{
	uParam0->f_3 = uParam0->f_3 - uParam0->f_3 && iParam1;
	return;
}

void func_18(var uParam0, int iParam1) // Position - 0x685 Hash - 0x53A96DDB ^0xA013391F
{
	uParam0->f_3 = uParam0->f_3 || iParam1;
	return;
}

void func_19(var uParam0) // Position - 0x698 Hash - 0xC901464A ^0x76BABB9A
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2))
	{
...
BOOL func_20(int iParam0, int iParam1) // Position - 0x6C2 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_21(var uParam0) // Position - 0x6D1 Hash - 0xE055D1E9 ^0x618D5768
{
...
BOOL func_22() // Position - 0x715 Hash - 0x9773414E ^0x9773414E
{
	BOOL num;
...
BOOL func_23(var uParam0) // Position - 0x722 Hash - 0x384949EB ^0xE26CB2D6
{
...
void func_24(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x768 Hash - 0xA83ABB27 ^0x3839CF85
{
	int num;
	int offset;
...
void func_25(var uParam0, BOOL bParam1) // Position - 0x7A2 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_26(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7C2 Hash - 0x456A22D3 ^0x456A22D3
{
	if (bParam2)
		if (!func_45(essParam0))
			return false;
...
void func_27(eStackSize essParam0, BOOL bParam1) // Position - 0x7EC Hash - 0x7065DB4C ^0xB94EA2C3
{
	if (!func_45(essParam0))
		return;

	if (bParam1)
		if (func_49(&(Global_1360165[essParam0 /*1157*/].f_12), 1))
...
void func_28(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x82E Hash - 0x322BF689 ^0x724E8BC3
{
	if (!func_45(essParam0))
		return;

	func_50(&(Global_1360165[essParam0 /*1157*/].f_13), iParam1, bParam2);
	return;
}

void func_29(eStackSize essParam0) // Position - 0x856 Hash - 0x7895582D ^0x7895582D
{
	func_28(essParam0, 8, false);
	return;
}

void func_30(eStackSize essParam0) // Position - 0x867 Hash - 0x8577BCFD ^0x8577BCFD
{
	func_24(essParam0, 36, true);
	return;
}

void func_31(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x878 Hash - 0xA83ABB27 ^0xCD66A93E
{
	int num;
	int offset;
...
BOOL func_32(Ped pedParam0, int iParam1) // Position - 0x8B2 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
PersChar func_33(eStackSize essParam0, BOOL bParam1) // Position - 0x9B1 Hash - 0xA2FCAA5A ^0xC4849EF1
{
	if (!func_12(essParam0))
		return 0;
...
BOOL func_34(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x9F0 Hash - 0x6ED0C3E9 ^0xD0355731
{
	int num;
	int offset;
...
void func_35(eStackSize essParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA2B Hash - 0x31BF1139 ^0xA046F8A2
{
	int pedMaxHealth;
	Ped ped;
	...
	if (func_34(essParam0, 5, true))
		PED::SET_PED_CONFIG_FLAG(func_53(essParam0), 137, true);

	return;
}

void func_36(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA7D Hash - 0x4B52E53C ^0x4B52E53C
{
	if (!func_45(essParam0))
		return;
...
void func_37(eStackSize essParam0, BOOL bParam1) // Position - 0xB4F Hash - 0x2F921122 ^0x884B6C77
{
	if (!func_45(essParam0))
		return;

	if (bParam1)
		PED::SET_PED_CONFIG_FLAG(func_53(essParam0), 204, true);
	else
		PED::SET_PED_CONFIG_FLAG(func_53(essParam0), 204, false);

	return;
}

void func_38(var uParam0) // Position - 0xB86 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_39(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB9C Hash - 0x6E8FD624 ^0x6E8FD624
{
	PersChar char;
	Ped ped;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped) && func_55(essParam0) < 10000f && !bParam3 && !CAM::IS_SCREEN_FADED_OUT())
		return;
...
void func_40(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0xCAA Hash - 0xC1057B0F ^0xC1057B0F
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
Player func_41(eStackSize essParam0) // Position - 0xCE6 Hash - 0x8D7C83E2 ^0x9E26FAD3
{
	if (!func_12(essParam0))
		return 0;
...
void func_42(int iParam0, eStackSize essParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xD26 Hash - 0xBD80856C ^0xBD80856C
{
	Player player;

	if (!func_45(essParam1))
		return;
...
void func_43(int iParam0, int iParam1) // Position - 0xDC8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_44(int iParam0, int iParam1) // Position - 0xDD9 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_45(eStackSize essParam0) // Position - 0xDEE Hash - 0xEC8E4F18 ^0xEC8E4F18
{
	return essParam0 > -1;
}

int func_46(int iParam0, var uParam1, var uParam2) // Position - 0xDFA Hash - 0x28CD1A67 ^0x28CD1A67
{
	int num;
...
BOOL func_47(var uParam0) // Position - 0xE17 Hash - 0x5001E582 ^0x5001E582
{
	return func_61(*uParam0, 1);
}

void func_48(var uParam0) // Position - 0xE27 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_62(uParam0, 0f);
	return;
}

BOOL func_49(int iParam0, int iParam1) // Position - 0xE36 Hash - 0xE46677C2 ^0xE46677C2
{
	return *iParam0 && iParam1 != false;
}

void func_50(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE46 Hash - 0x70644665 ^0x70644665
{
	if (bParam2)
		*iParam0 = *iParam0 || iParam1;
	else
...
BOOL func_51(int iParam0, int iParam1) // Position - 0xE6C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_52(eStackSize essParam0) // Position - 0xE7B Hash - 0x7F4CEA57 ^0x7A0A798F
{
	Hash hash;
...
Ped func_53(eStackSize essParam0) // Position - 0xEE3 Hash - 0x81E6D8DD ^0x27F8E742
{
	if (!func_45(essParam0))
		return 0;
...
void func_54(eStackSize essParam0) // Position - 0xF1D Hash - 0xA3F1079A ^0xFE58BB91
{
	if (func_12(essParam0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_53(essParam0)))
		{
			func_64(essParam0, 67108864, true);
...
float func_55(eStackSize essParam0) // Position - 0xF50 Hash - 0xA42CC07F ^0x2E7483CB
{
	if (!func_45(essParam0))
		return 0f;
...
void func_56(eStackSize essParam0) // Position - 0xF71 Hash - 0xC4A0D69D ^0x461393B6
{
	Ped ped;
	PersChar persChar;
	BOOL flag;
...
BOOL func_57(eStackSize essParam0) // Position - 0xFCB Hash - 0x6410553A ^0x46627D03
{
	if (!func_45(essParam0))
		return false;
...
BOOL func_58(eStackSize essParam0) // Position - 0x1017 Hash - 0xDC3E0094 ^0xA822A7E2
{
	if (!func_45(essParam0))
		return false;
...
void func_59(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x103F Hash - 0x7FA68C0F ^0xF104E0DF
{
	if (!func_45(essParam0))
		return;
...
int func_60(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x10A4 Hash - 0x9AECF115 ^0xB93A91A1
{
	Player mount;
	Hash hash;
	PersChar persChar;
	...
	if (func_32(mount, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(mount) && func_66(PLAYER::PLAYER_PED_ID(), mount, true) < 10000f))
			{
				hash = func_67(essParam0, true);
				...
				if (hash != 0)
				{
					...
					func_68(essParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_69(essParam0, false));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_69(essParam0, false));
					func_70(essParam0);
				}
			}
			else
			{
				...
				{
					persChar = func_69(essParam0, false);
...
BOOL func_61(int iParam0, int iParam1) // Position - 0x1255 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_62(var uParam0, float fParam1) // Position - 0x1264 Hash - 0x30433BAB ^0xF854D531
{
...
Hash func_63(int iParam0) // Position - 0x128A Hash - 0xBA965109 ^0xCB1D208B
{
	switch (iParam0)
	{
		case 0:
...
void func_64(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1466 Hash - 0x2E4D3D00 ^0x2E4D3D00
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
void func_65(eStackSize essParam0, Ped pedParam1) // Position - 0x1497 Hash - 0xC6503D1A ^0x107B4B14
{
...
float func_66(Ped pedParam0, Player plParam1, BOOL bParam2) // Position - 0x14B1 Hash - 0x867DEA0 ^0xA060BC32
{
	...
	return func_76(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(plParam1, false, false));
}

Hash func_67(eStackSize essParam0, BOOL bParam1) // Position - 0x1508 Hash - 0xA64DC151 ^0x7D83907B
{
	if (!func_45(essParam0))
		return 0;
	...
	if (bParam1)
	{
		Global_1360165[essParam0 /*1157*/].f_127 = func_77(essParam0);
		return Global_1360165[essParam0 /*1157*/].f_127;
	}
...
void func_68(eStackSize essParam0) // Position - 0x164D Hash - 0xF7FD9E75 ^0xF411CFCB
{
	Player player;
	ItemSet itemset;
	int i;
...
PersChar func_69(eStackSize essParam0, BOOL bParam1) // Position - 0x16C3 Hash - 0xF1265AC3 ^0xD7133EF8
{
	if (!func_45(essParam0))
		return 0;

	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(Global_1360165[essParam0 /*1157*/].f_126) && bParam1)
		Global_1360165[essParam0 /*1157*/].f_126 = func_78(essParam0);

	return Global_1360165[essParam0 /*1157*/].f_126;
}

void func_70(eStackSize essParam0) // Position - 0x170F Hash - 0xA6C3B06B ^0x3AB8265A
{
	int i;
...
void func_71(eStackSize essParam0, int iParam1) // Position - 0x1762 Hash - 0xEBFF508D ^0x493427AF
{
	if (!func_45(essParam0))
		return;
...
float func_72() // Position - 0x1786 Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_73(var uParam0, int iParam1) // Position - 0x17B8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_74(var uParam0, int iParam1) // Position - 0x17C9 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_75(Ped pedParam0) // Position - 0x17DE Hash - 0xE4199812 ^0xEC01775
{
	int _int;
...
float func_76(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1841 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
Hash func_77(eStackSize essParam0) // Position - 0x185F Hash - 0xEB890713 ^0xB40CD388
{
	Hash hash;
	int i;
...
PersChar func_78(eStackSize essParam0) // Position - 0x1940 Hash - 0xF15D53A9 ^0x3132AAF6
{
	Hash persCharHash;
	...
	{
		persCharHash = func_67(essParam0, true);
