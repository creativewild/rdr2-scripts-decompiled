...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x57326570
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x8AC13A09
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x3035F587 ^0x7B4D1D7F
{
	func_46(uParam0, "CAT_CATCH_BIRD", "script@ambient@animal@cat_catch_bird@action", uParam1, uParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "CAT", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "PIGEON", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	return;
}
...
int func_30(var uParam0) // Position - 0x2A19 Hash - 0xAB241DBF ^0xAB241DBF
{
...
int func_31(var uParam0) // Position - 0x2A45 Hash - 0xB1380C5A ^0xB1380C5A
{
	char* animDict;
	char* animName;
	char* animName2;
	...
	animDict = "script_amb@animal@cat_catch_bird";
	animName = "cat_exit";
	animName2 = "pigeon_exit";
	vector = { 0f, 0f, 0f };
	vector2 = { 0f, 0f, 0f };
	...
	{
		if (!bLocal_42 == true)
			if (func_61(uParam0, &uLocal_9, true) || func_62(Global_35, uParam0->f_20[0 /*14*/], true) <= 100f)
				bLocal_42 = true;
		...
		if (bLocal_42)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (!uParam0->f_469[6])
				{
					func_66(*uParam0, uParam0->f_483, false);
					uParam0->f_469[6] = 1;
				}
	...
	if (uParam0->f_469[0])
		if (!ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(uParam0->f_20[0 /*14*/], -1))
			if (func_69(&uLocal_44, 4f))
				return 1;

	if (!uParam0->f_469[0] && !bLocal_42)
	{
		if (!uParam0->f_469[1])
		{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 1.5f, 40f, 4, joaat("Action"), true))
				{
					func_66(*uParam0, uParam0->f_483, false);
					uParam0->f_469[6] = 1;
				}
							...
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
									{
										...
										func_72(&uParam0->f_20[1 /*14*/], true, true);
						...
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("endsinwalk")))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									...
									func_72(&uParam0->f_20[0 /*14*/], false, true);
									func_74(uParam0->f_20[0 /*14*/], joaat("world_animal_cat_resting"), uLocal_39, 0f, 60000, true, false, 0, -1082130432);
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2EEB Hash - 0xFBD382D6 ^0xDE753D8A
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	if (uParam0->f_469[4] && !uParam0->f_469[5])
	{
		if (!flag || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uParam0->f_20[1 /*14*/], false, false), 0.5f, true, true))
		{
			...
			if (flag2)
				func_75(uParam0->f_20[1 /*14*/], false, false);
	...
	if (!bParam1)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
				if (uParam0->f_469[4] && !uParam0->f_469[5] && func_62(uParam0->f_20[i /*14*/], Global_35, true) < 22500f)
					return 0;
		}
	}
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3077 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x3094 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x31D0 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3309 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x33B3 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x342B Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x34BA Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x35D5 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x35E1 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3769 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3809 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x381C Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3836 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x389E Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x38CA Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x38FB Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3989 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3B8D Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3BA1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3BB0 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_77() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3BCB Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3C2A Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_95(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_55(Ped pedParam0) // Position - 0x3C6C Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3C98 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3D14 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3D3A Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3D5C Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3D7E Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_61(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3DA2 Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_104(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
float func_62(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3DFC Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_105(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_63(var uParam0) // Position - 0x3E53 Hash - 0x5001E582 ^0x5001E582
{
	return func_106(*uParam0, 1);
}

void func_64(var uParam0) // Position - 0x3E63 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_107(uParam0, 0f);
	return;
}

void func_65(var uParam0) // Position - 0x3E72 Hash - 0xE62223CB ^0xE62223CB
{
	if (!uParam0->f_469[7])
	{
...
void func_66(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3E97 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_67(var uParam0) // Position - 0x3F9B Hash - 0x28326647 ^0x16D32202
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (uParam0->f_468 == 256 || uParam0->f_468 == 4 || uParam0->f_468 == 2 || uParam0->f_468 == 16)
		{
			if (!func_111(uParam0->f_20[0 /*14*/], 518218985))
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 256, -1082130432, -1, 0);
				func_72(&uParam0->f_20[0 /*14*/], false, true);
			}
		}
		else if (!func_111(uParam0->f_20[0 /*14*/], 1139527981))
		{
...
void func_68(var uParam0) // Position - 0x4060 Hash - 0x5C40EAAE ^0xF306426
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], 1228204929))
		{
		...
		else
		{
			...
			func_72(&uParam0->f_20[1 /*14*/], false, true);
		}
	}
...
BOOL func_69(var uParam0, float fParam1) // Position - 0x40E8 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_63(uParam0))
		return false;
...
BOOL func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x410F Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_62(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_63(&(uParam0->f_490)))
							func_64(&(uParam0->f_490));
...
BOOL func_71(var uParam0, float fParam1, float fParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x431A Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_62(Global_35, uParam0->f_20[i /*14*/], true) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_63(&(uParam0->f_490)))
							func_119(&(uParam0->f_490), false);
					
						if (func_120(&(uParam0->f_490)))
							func_121(&(uParam0->f_490));
					
						if (func_69(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_63(&(uParam0->f_490)) && !func_120(&(uParam0->f_490)))
...
void func_72(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4443 Hash - 0x6DE5BABD ^0x14BE368D
{
...
Vector3 func_73(var uParam0) // Position - 0x446B Hash - 0x706EBC49 ^0x706EBC49
{
	var unk;
	float num;
	int num2;
	...
	num2[1 /*3*/] = { 1823.751f, -1248.367f, 41.491f };
...
void func_74(Ped pedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, int iParam6, BOOL bParam7, BOOL bParam8, const char* sParam9, int iParam10) // Position - 0x4506 Hash - 0xFE770A83 ^0xBFD078B3
{
	TASK::TASK_START_SCENARIO_AT_POSITION(pedParam0, hParam1, vParam2, fParam5, iParam6, bParam7, bParam8, sParam9, iParam10, false);
	return;
}

void func_75(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4527 Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
void func_76(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4563 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_77() // Position - 0x46B7 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_78(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x46C5 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x472C Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4755 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_81(var uParam0, var uParam1, var uParam2) // Position - 0x47A1 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_82(int iParam0) // Position - 0x47F0 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_83(int iParam0) // Position - 0x4815 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_84(int iParam0) // Position - 0x4828 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_85(int iParam0) // Position - 0x483B Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_86(int iParam0) // Position - 0x484E Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_87(int iParam0) // Position - 0x4860 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_88(int iParam0, int iParam1) // Position - 0x4872 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x490C Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_90() // Position - 0x4944 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_91(int iParam0) // Position - 0x4997 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_94(iParam0))
		return -1;
...
BOOL func_92(int iParam0) // Position - 0x49B7 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_93(int iParam0, int iParam1) // Position - 0x49CD Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_94(int iParam0) // Position - 0x49DC Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_95(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4A0F Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4AF0 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_103(iParam0, 4);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4B0E Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_103(iParam0, 8);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4B2E Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_103(iParam0, 16);
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4B59 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_103(iParam0, 32);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4B79 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_103(iParam0, 64);
	else
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4B99 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_103(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4BBB Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
		func_103(iParam0, 1048576);
	else
...
void func_103(int iParam0, int iParam1) // Position - 0x4BDF Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_104(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4BF0 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_105(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5219 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x5237 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_107(var uParam0, float fParam1) // Position - 0x5246 Hash - 0x30433BAB ^0xF854D531
{
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x526C Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_109(int iParam0) // Position - 0x5343 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_171(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_171(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_171(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_110(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x53C4 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_111(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x54B5 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
float func_112(var uParam0) // Position - 0x550E Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_63(uParam0))
		return uParam0->f_1;
...
BOOL func_113(Ped pedParam0) // Position - 0x5543 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_114(Ped pedParam0) // Position - 0x555E Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_115(float fParam0) // Position - 0x557A Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_116(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x55C1 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_117(var uParam0, float fParam1) // Position - 0x55DF Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_69(uParam0, fParam1))
	{
		func_118(uParam0);
		return true;
	}
...
void func_118(var uParam0) // Position - 0x55FD Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_119(var uParam0, BOOL bParam1) // Position - 0x5613 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_120(var uParam0) // Position - 0x5633 Hash - 0x39705408 ^0x39705408
{
	return func_106(*uParam0, 2);
}

void func_121(var uParam0) // Position - 0x5643 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_63(uParam0);
...
void func_122(var uParam0) // Position - 0x5677 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_63(uParam0);
...
BOOL func_123(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x56A7 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_124(BOOL bParam0, var uParam1, var uParam2) // Position - 0x56FC Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_125(int iParam0, int iParam1) // Position - 0x5713 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_126(int iParam0, int iParam1) // Position - 0x5799 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_127(int iParam0, int iParam1) // Position - 0x57D5 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_128(int iParam0, int iParam1) // Position - 0x5828 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_129(int iParam0, int iParam1) // Position - 0x5863 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_130(int iParam0, int iParam1) // Position - 0x589C Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_131(int iParam0) // Position - 0x58D4 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_132(BOOL bParam0) // Position - 0x5912 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_133(ePedType eptParam0) // Position - 0x5925 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_134(Ped pedParam0, Hash hParam1) // Position - 0x5D78 Hash - 0xF3E8E085 ^0x1B53083C
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_135(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5E1F Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_136(Ped pedParam0, BOOL bParam1) // Position - 0x5E4F Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_137(Ped pedParam0, int iParam1) // Position - 0x5E94 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_138(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5EBB Hash - 0x37D64B11 ^0xE7060A9E
{
	func_176(iParam2);
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x6086 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_140(Ped pedParam0, int iParam1, int iParam2) // Position - 0x615D Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x619A Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_142(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6281 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_143(Ped pedParam0, int iParam1) // Position - 0x6357 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_144(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6460 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x6595 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x65CC Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x66D3 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_148(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x673E Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_149(Ped pedParam0, int iParam1) // Position - 0x6886 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_150(var uParam0, int iParam1) // Position - 0x6A63 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x6ADB Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_152(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6B0A Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_153(int iParam0, Ped pedParam1) // Position - 0x6C90 Hash - 0x42A83B1F ^0xD83E7D88
{
	int _int;
...
BOOL func_154(int iParam0, Ped pedParam1) // Position - 0x6CE0 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_203(iParam0))
		return true;
...
BOOL func_155(Ped pedParam0, Ped pedParam1) // Position - 0x6D7D Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_156() // Position - 0x6DCA Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_157(int iParam0, Ped pedParam1) // Position - 0x6DD2 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_158() // Position - 0x6E93 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_159() // Position - 0x6EB1 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
	...
	if (func_158() - Global_1935630.f_43 >= &func_25)
		return false;

	return true;
}

BOOL func_160(int iParam0, Ped pedParam1) // Position - 0x6EFE Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_161(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x701A Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x7062 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x72BB Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_213(0))
		return false;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x72F4 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_165(var uParam0, int iParam1) // Position - 0x7323 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_166(Ped pedParam0, int iParam1) // Position - 0x7337 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_158() - iParam1->f_4 > func_214(iParam1))
		return func_215(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_167(int iParam0, Ped pedParam1) // Position - 0x7384 Hash - 0xE5A9D1A6 ^0x6CF19E09
{
...
float func_168() // Position - 0x73D7 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_169(var uParam0, int iParam1) // Position - 0x7409 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_170(var uParam0, int iParam1) // Position - 0x741A Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_171(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x742F Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_216(iParam0) == 1 && bParam7)
		return;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x74BB Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x74E9 Hash - 0xD463BE93 ^0x8B28AA45
{
	Hash _int;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x7539 Hash - 0xD463BE93 ^0x8B28AA45
{
	Hash _int;
	int _int2;
...
void func_175(Ped pedParam0) // Position - 0x75A9 Hash - 0x63CBBE00 ^0x361C5674
{
...
void func_176(int iParam0) // Position - 0x75C6 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_219(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_177(int iParam0) // Position - 0x7732 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_178(BOOL bParam0) // Position - 0x7745 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_220(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_179(int iParam0) // Position - 0x775F Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_180(int iParam0) // Position - 0x77F9 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_181(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7820 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_182(Ped pedParam0, Ped pedParam1) // Position - 0x7919 Hash - 0xF9959663 ^0xF9959663
{
	return func_204(pedParam0, pedParam1, true, true);
}

float func_183(int iParam0) // Position - 0x792B Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_184(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7937 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_185(int iParam0, BOOL bParam1) // Position - 0x799C Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_186() // Position - 0x79C2 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_187(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x79D6 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_223(ped, 0)))
			if (func_224(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_188(int iParam0) // Position - 0x7B36 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_189(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7B42 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_190(int iParam0) // Position - 0x7BA3 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_191(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7BAF Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_223(ped, 0)))
			if (func_225(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_192(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7C71 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_193(int iParam0) // Position - 0x7D0F Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_194(int iParam0) // Position - 0x7D1B Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_195(int iParam0) // Position - 0x7D27 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_196(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7E64 Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_226(pedParam0, vParam4, 0.5f))
...
BOOL func_197(Ped pedParam0) // Position - 0x7EA7 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_227(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F0D Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F54 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7F9F Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_201(Ped pedParam0, var uParam1) // Position - 0x8019 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_202(Ped pedParam0, Ped pedParam1) // Position - 0x8066 Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_229(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_203(int iParam0) // Position - 0x80AE Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_204(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x80BE Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_205(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8106 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8132 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_207(int iParam0) // Position - 0x815A Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_208(Ped pedParam0) // Position - 0x8166 Hash - 0xC98AEB0B ^0x3C802B84
{
...
int func_209(Ped pedParam0) // Position - 0x81BC Hash - 0x832C386B ^0xE5AF6759
{
...
BOOL func_210(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8228 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_211(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x8398 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_220(true, &ped, &ped2);
...
BOOL func_212(int iParam0, Ped pedParam1) // Position - 0x8486 Hash - 0x27FC2906 ^0x422F4DC6
{
...
BOOL func_213(int iParam0) // Position - 0x84FC Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_230())
		return false;

	return func_231(Global_1347702[58 /*49*/].f_15, true);
}

int func_214(int iParam0) // Position - 0x851E Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_215(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x852A Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_216(int iParam0) // Position - 0x85A5 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_217() // Position - 0x85B8 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_218() // Position - 0x85C6 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_232())
		return false;
...
void func_219(Any* panParam0, int iParam1) // Position - 0x861C Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_220(BOOL bParam0, var uParam1, var uParam2) // Position - 0x86C4 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_221(int iParam0) // Position - 0x878B Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_222(int iParam0) // Position - 0x8833 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_223(Ped pedParam0, int iParam1) // Position - 0x8898 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_224(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x88AF Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_225(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_225(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x88DD Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_226(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8927 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_227(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8968 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_228(Ped pedParam0) // Position - 0x89E1 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_229(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8AC9 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_230() // Position - 0x8B0B Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_217() != -1)
		return false;
...
BOOL func_231(int iParam0, BOOL bParam1) // Position - 0x8B30 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_232() // Position - 0x8B61 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_233(int iParam0) // Position - 0x8B92 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_94(iParam0))
		return -1;
...
int func_234(int iParam0) // Position - 0x8BAE Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_235(int iParam0) // Position - 0x8BEF Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
