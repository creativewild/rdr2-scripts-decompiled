...
void main() // Position - 0x0 Hash - 0xA112627F ^0xBE25894E
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0xB1656066
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x85C8FD10 ^0x20979B64
{
	func_46(uParam0, "BIRD_SWARM", "", vParam1, uParam4);
	func_47(uParam0, 0, "BS_BIRD_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 0f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "BS_BIRD_2", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -1f, 1f, 0f), 135f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "BS_BIRD_3", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 1f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "BS_BIRD_4", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, 0f, 0f), 45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "BS_BIRD_5", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 0f), -100f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 5, "BS_BIRD_6", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, -1f, 0f), -135f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "BS_BIRD_7", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, -2f, 0f), -145f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 7, "BS_BIRD_8", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, -2f, 0f), -15f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 8, "BS_BIRD_9", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, -1f, 0f), -45f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 9, "BS_BIRD_10", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 1f, -3f, 0f), 50f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1DC1 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1E61 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1F7B Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2144 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x214D Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x22FD Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2371 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x23C0 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2418 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2581 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x28A8 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x29DF Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2B0F Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2B4E Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2B57 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B89 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

int func_31(var uParam0) // Position - 0x2B92 Hash - 0xAFF2C7AA ^0xAFF2C7AA
{
	float num;
	float num2;
	float num3;
	...
	switch (iLocal_10)
	{
		case 0:
			...
			num5 = 100f;
			num6 = 0f;
			vector = { num, num2, num3 };
			vector2 = { num4, num5, num6 };
			vector3 = { uParam0->f_483 };
			vector3.f_2 = vector3.f_2 + 30f;
			FLOCK::_0xF2CCA7B68CFAB2B9(joaat("SPECIES_BIRD_CROW"), vector3, vector, vector2, 9.5f, 50f, 1f, 6f);
			iLocal_10 = 1;
			break;
	
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_11 /*14*/]))
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_11 /*14*/]))
					TASK::TASK_ANIMAL_UNALERTED(uParam0->f_20[iLocal_11 /*14*/], -1, 0, 0, 0);
		...
		case 2:
			if (func_55(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				func_56(*uParam0, false);
				func_57(*uParam0, uParam0->f_483, false);
				iLocal_10 = 3;
			}
			break;
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2CB0 Hash - 0x3F8039C7 ^0x3F8039C7
{
	if (!bParam1)
		if (!_IS_NULL_VECTOR(uParam0->f_483))
			if (func_58(Global_35, uParam0->f_483, true) < 40000f)
				return 0;

	func_59(uParam0, false, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2CF3 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D10 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2E4C Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2F85 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x302F Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x30A7 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_61(entityForwardVector, unk5);
	...
	if (func_62(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3136 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3251 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x325D Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x33E5 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3485 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3498 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x34B2 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x351A Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3546 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_48(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35D4 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_74(Global_1898164.f_1[0 /*5*/]);
	
		if (func_75(num) && func_76(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_49(int iParam0) // Position - 0x37D8 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x37EC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_51() // Position - 0x37FB Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_60() != -1;
}

BOOL func_52(var uParam0, Any* panParam1) // Position - 0x3816 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_53(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3875 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_54(Entity eParam0) // Position - 0x38B7 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
BOOL func_55(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x38E3 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_79(Global_35))
		{
			ped = func_80(Global_35);
		...
		num = num * num;
		fParam2 = func_81(fParam2);
		num2 = func_82(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_83(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_84(&(uParam0->f_490)))
							func_85(&(uParam0->f_490));
					
						if (func_86(&(uParam0->f_490), fParam1))
						{
							func_87(&(uParam0->f_490));
							return true;
						}
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3AEE Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_57(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3BC5 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
float func_58(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3CC9 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_90(entityCoords, vParam1);
}

void func_59(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3D19 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_60() // Position - 0x3E6D Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_61(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x3E7B Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_62(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x3EE2 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_63(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3F0B Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_91(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_64(var uParam0, var uParam1, var uParam2) // Position - 0x3F57 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_91(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_65(int iParam0) // Position - 0x3FA6 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_66(int iParam0) // Position - 0x3FCB Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_67(int iParam0) // Position - 0x3FDE Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_68(int iParam0) // Position - 0x3FF1 Hash - 0xB8EEC50 ^0x4CDE0777
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_69(int iParam0) // Position - 0x4006 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_70(int iParam0) // Position - 0x4018 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_71(int iParam0, int iParam1) // Position - 0x402A Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_72(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x40C4 Hash - 0xA65AB937 ^0xA65AB937
{
	func_93(iParam0, iParam6);
	func_94(iParam0, iParam5);
	func_95(iParam0, iParam4);
	func_96(iParam0, iParam3);
	func_97(iParam0, iParam2);
	func_98(iParam0, iParam1);
	return;
}

BOOL func_73() // Position - 0x40FC Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_74(int iParam0) // Position - 0x414F Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_77(iParam0))
		return -1;
...
BOOL func_75(int iParam0) // Position - 0x416F Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_76(int iParam0, int iParam1) // Position - 0x4185 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_77(int iParam0) // Position - 0x4194 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_78(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x41C7 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_101(eptParam1))
		{
			func_102(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_104(pedParam0, false);
			flag = true;
		}
	
		func_105(pedParam0, iParam2);
	}
...
BOOL func_79(Ped pedParam0) // Position - 0x42A8 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_80(Ped pedParam0) // Position - 0x42C3 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_81(float fParam0) // Position - 0x42DF Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_82(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4326 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_83(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4344 Hash - 0x867DEA0 ^0xA060BC32
{
	...
	return func_90(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_84(var uParam0) // Position - 0x439B Hash - 0x5001E582 ^0x5001E582
{
	return func_106(*uParam0, 1);
}

void func_85(var uParam0) // Position - 0x43AB Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_107(uParam0, 0f);
	return;
}

BOOL func_86(var uParam0, float fParam1) // Position - 0x43BA Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_87(var uParam0) // Position - 0x43D8 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_88(int iParam0) // Position - 0x43EE Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_109(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_109(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_109(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_89(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x446F Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_91(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
float func_90(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4560 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_91(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x457E Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_92(BOOL bParam0, var uParam1, var uParam2) // Position - 0x45D3 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_93(int iParam0, int iParam1) // Position - 0x45EA Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_94(int iParam0, int iParam1) // Position - 0x4670 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_95(int iParam0, int iParam1) // Position - 0x46AC Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_96(int iParam0, int iParam1) // Position - 0x46FF Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_97(int iParam0, int iParam1) // Position - 0x473A Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_98(int iParam0, int iParam1) // Position - 0x4773 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_99(int iParam0) // Position - 0x47AB Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_100(BOOL bParam0) // Position - 0x47E9 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_101(ePedType eptParam0) // Position - 0x47FC Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_102(Ped pedParam0, Hash hParam1) // Position - 0x4C4F Hash - 0x2D030F16 ^0xB931C09C
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_110(pedParam0, hParam1))
		{
...
void func_103(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x4CF6 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_104(Ped pedParam0, BOOL bParam1) // Position - 0x4D26 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_105(Ped pedParam0, int iParam1) // Position - 0x4D6B Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x4D92 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_107(var uParam0, float fParam1) // Position - 0x4DA1 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_108(var uParam0, float fParam1) // Position - 0x4DC7 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_84(uParam0))
		return false;
...
void func_109(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4DEE Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_118(iParam0) == 1 && bParam7)
		return;
...
BOOL func_110(Ped pedParam0, Hash hParam1) // Position - 0x4E7A Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_111(Ped pedParam0, Hash hParam1) // Position - 0x4EA8 Hash - 0x1CCAD41C ^0xA981445E
{
	Hash _int;
...
BOOL func_112(Ped pedParam0, Hash hParam1) // Position - 0x4EF6 Hash - 0x1CCAD41C ^0xA981445E
{
	Hash _int;
	int _int2;
...
void func_113(Ped pedParam0) // Position - 0x4F64 Hash - 0x54D64D3B ^0xD2AF1BED
{
...
float func_114() // Position - 0x4F80 Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_115(var uParam0, int iParam1) // Position - 0x4FB2 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_116(var uParam0, int iParam1) // Position - 0x4FC3 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_117(var uParam0) // Position - 0x4FD8 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_84(uParam0))
		return uParam0->f_1;
...
int func_118(int iParam0) // Position - 0x500D Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_119() // Position - 0x5020 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_120(var uParam0) // Position - 0x502E Hash - 0x39705408 ^0x39705408
{
