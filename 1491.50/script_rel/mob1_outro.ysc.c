...
int func_11(var uParam0) // Position - 0x30D Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_12(eStackSize essParam0) // Position - 0x316 Hash - 0xFD10BCB1 ^0xFD10BCB1
{
...
BOOL func_13(eStackSize essParam0) // Position - 0x335 Hash - 0xDA629583 ^0xDA629583
{
	return func_26(essParam0, 16, true);
}

BOOL func_14(eStackSize essParam0) // Position - 0x346 Hash - 0xC2BA9D92 ^0x340F97FF
{
...
void func_15(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x37A Hash - 0xA4706F79 ^0xAF27D1D3
{
	BOOL flag;
	PersChar persChar;
	BOOL flag2;
...
BOOL func_16(var uParam0, int iParam1) // Position - 0x62F Hash - 0x718DD1EF ^0x66842345
{
	return uParam0->f_3 && iParam1 != false;
}

void func_17(var uParam0, int iParam1) // Position - 0x640 Hash - 0xA4EAD31F ^0x3F77773B
{
	uParam0->f_3 = uParam0->f_3 - uParam0->f_3 && iParam1;
	return;
}

void func_18(var uParam0, int iParam1) // Position - 0x658 Hash - 0x53A96DDB ^0xA013391F
{
	uParam0->f_3 = uParam0->f_3 || iParam1;
	return;
}

void func_19(var uParam0) // Position - 0x66B Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_20(int iParam0, int iParam1) // Position - 0x673 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_21(var uParam0) // Position - 0x682 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_22() // Position - 0x68B Hash - 0x9773414E ^0x9773414E
{
	BOOL num;
...
BOOL func_23(var uParam0) // Position - 0x698 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_24(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x6A1 Hash - 0xA83ABB27 ^0x3839CF85
{
	int num;
	int offset;
...
void func_25(var uParam0, BOOL bParam1) // Position - 0x6DB Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_26(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6FB Hash - 0x456A22D3 ^0x456A22D3
{
	if (bParam2)
		if (!func_43(essParam0))
			return false;
...
void func_27(eStackSize essParam0, BOOL bParam1) // Position - 0x725 Hash - 0x7065DB4C ^0xB94EA2C3
{
	if (!func_43(essParam0))
		return;
...
void func_28(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x767 Hash - 0x322BF689 ^0x724E8BC3
{
	if (!func_43(essParam0))
		return;
...
void func_29(eStackSize essParam0) // Position - 0x78F Hash - 0x7895582D ^0x7895582D
{
	func_28(essParam0, 8, false);
	return;
}

void func_30(eStackSize essParam0) // Position - 0x7A0 Hash - 0x8577BCFD ^0x8577BCFD
{
	func_24(essParam0, 36, true);
	return;
}

void func_31(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x7B1 Hash - 0xA83ABB27 ^0xCD66A93E
{
	int num;
	int offset;
...
BOOL func_32(Ped pedParam0, int iParam1) // Position - 0x7EB Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
PersChar func_33(eStackSize essParam0, BOOL bParam1) // Position - 0x8EA Hash - 0xA2FCAA5A ^0xC4849EF1
{
	if (!func_12(essParam0))
		return 0;
...
BOOL func_34(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x929 Hash - 0x6ED0C3E9 ^0xD0355731
{
	int num;
	int offset;
...
void func_35(eStackSize essParam0, int iParam1, int iParam2, int iParam3) // Position - 0x964 Hash - 0x31BF1139 ^0xA046F8A2
{
	int pedMaxHealth;
	Ped ped;
...
void func_36(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9B6 Hash - 0x4B52E53C ^0x4B52E53C
{
	if (!func_43(essParam0))
		return;
...
void func_37(eStackSize essParam0, BOOL bParam1) // Position - 0xA88 Hash - 0x2F921122 ^0x884B6C77
{
	if (!func_43(essParam0))
		return;
...
void func_38(var uParam0) // Position - 0xABF Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_39(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAD5 Hash - 0x6E8FD624 ^0x6E8FD624
{
	PersChar char;
	Ped ped;
...
void func_40(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0xBE3 Hash - 0xC1057B0F ^0xC1057B0F
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
Player func_41(eStackSize essParam0) // Position - 0xC1F Hash - 0x8D7C83E2 ^0x9E26FAD3
{
	if (!func_12(essParam0))
		return 0;
...
void func_42(int iParam0, eStackSize essParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xC5F Hash - 0xBD80856C ^0xBD80856C
{
	Player player;
...
BOOL func_43(eStackSize essParam0) // Position - 0xD01 Hash - 0xEC8E4F18 ^0xEC8E4F18
{
	return essParam0 > -1;
}

int func_44(int iParam0, var uParam1, var uParam2) // Position - 0xD0D Hash - 0x28CD1A67 ^0x28CD1A67
{
	int num;
...
BOOL func_45(var uParam0) // Position - 0xD2A Hash - 0x5001E582 ^0x5001E582
{
	return func_59(*uParam0, 1);
}

void func_46(var uParam0) // Position - 0xD3A Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_60(uParam0, 0f);
	return;
}

BOOL func_47(int iParam0, int iParam1) // Position - 0xD49 Hash - 0xE46677C2 ^0xE46677C2
{
	return *iParam0 && iParam1 != false;
}

void func_48(int iParam0, int iParam1, BOOL bParam2) // Position - 0xD59 Hash - 0x70644665 ^0x70644665
{
	if (bParam2)
...
BOOL func_49(int iParam0, int iParam1) // Position - 0xD7F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_50(eStackSize essParam0) // Position - 0xD8E Hash - 0x7F4CEA57 ^0x7A0A798F
{
	Hash hash;
...
Ped func_51(eStackSize essParam0) // Position - 0xDF6 Hash - 0x81E6D8DD ^0x27F8E742
{
	if (!func_43(essParam0))
		return 0;
...
void func_52(eStackSize essParam0) // Position - 0xE30 Hash - 0xA3F1079A ^0xFE58BB91
{
	if (func_12(essParam0))
	{
...
float func_53(eStackSize essParam0) // Position - 0xE63 Hash - 0xA42CC07F ^0x2E7483CB
{
	if (!func_43(essParam0))
		return 0f;
...
void func_54(eStackSize essParam0) // Position - 0xE84 Hash - 0xC4A0D69D ^0x461393B6
{
	Ped ped;
	PersChar persChar;
	BOOL flag;
...
BOOL func_55(eStackSize essParam0) // Position - 0xEDE Hash - 0x6410553A ^0x46627D03
{
	if (!func_43(essParam0))
		return false;
...
BOOL func_56(eStackSize essParam0) // Position - 0xF2A Hash - 0xDC3E0094 ^0xA822A7E2
{
	if (!func_43(essParam0))
		return false;
...
void func_57(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0xF52 Hash - 0x7FA68C0F ^0xF104E0DF
{
	if (!func_43(essParam0))
		return;
...
int func_58(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFB7 Hash - 0x9AECF115 ^0xB93A91A1
{
	Player mount;
	Hash hash;
	PersChar persChar;
...
BOOL func_59(int iParam0, int iParam1) // Position - 0x1168 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_60(var uParam0, float fParam1) // Position - 0x1177 Hash - 0x30433BAB ^0xF854D531
{
...
Hash func_61(int iParam0) // Position - 0x119D Hash - 0xBA965109 ^0xCB1D208B
{
	switch (iParam0)
	{
		case 0:
...
void func_62(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1379 Hash - 0x2E4D3D00 ^0x2E4D3D00
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
void func_63(eStackSize essParam0, Ped pedParam1) // Position - 0x13AA Hash - 0xC6503D1A ^0x107B4B14
{
...
float func_64(Ped pedParam0, Player plParam1, BOOL bParam2) // Position - 0x13C4 Hash - 0x867DEA0 ^0xA060BC32
{
...
Hash func_65(eStackSize essParam0, BOOL bParam1) // Position - 0x141B Hash - 0xA64DC151 ^0x7D83907B
{
	if (!func_43(essParam0))
		return 0;
...
void func_66(eStackSize essParam0) // Position - 0x1560 Hash - 0xF7FD9E75 ^0xF411CFCB
{
	Player player;
	ItemSet itemset;
	int i;
...
PersChar func_67(eStackSize essParam0, BOOL bParam1) // Position - 0x15D6 Hash - 0xF1265AC3 ^0xD7133EF8
{
	if (!func_43(essParam0))
		return 0;
...
void func_68(eStackSize essParam0) // Position - 0x1622 Hash - 0xA6C3B06B ^0x3AB8265A
{
	int i;
...
void func_69(eStackSize essParam0, int iParam1) // Position - 0x1675 Hash - 0xEBFF508D ^0x493427AF
{
	if (!func_43(essParam0))
		return;
...
float func_70() // Position - 0x1699 Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_71(var uParam0, int iParam1) // Position - 0x16CB Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_72(var uParam0, int iParam1) // Position - 0x16DC Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_73(Ped pedParam0) // Position - 0x16F1 Hash - 0x37CD25A4 ^0xD4CCB7B5
{
	int _int;
...
float func_74(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1751 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
Hash func_75(eStackSize essParam0) // Position - 0x176F Hash - 0xEB890713 ^0xB40CD388
{
	Hash hash;
	int i;
...
PersChar func_76(eStackSize essParam0) // Position - 0x1850 Hash - 0xF15D53A9 ^0x3132AAF6
{
	Hash persCharHash;
