...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0x62FBBF0E
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0x789EFC39
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0xCDCC091E ^0x33D7E19C
{
	char* str;
	...
	{
		case 138:
			func_46(uParam0, "WOLF_TAKEDOWN_MISS", "script@ambient@animal@COYOTE_TAKEDOWN_MISS_DEER@action", uParam1, uParam4);
			iLocal_9 = joaat("a_c_coyote_01");
			str = "COYOTE";
			break;
	
		case 247:
			func_46(uParam0, "WOLF_TAKEDOWN_MISS", "script@ambient@animal@WOLF_TAKEDOWN_MISS_DEER@action", uParam1, uParam4);
			iLocal_9 = joaat("a_c_wolf_medium");
			str = "WOLF";
			break;
	}
	...
	func_48(uParam0, 0, str, iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "DEER", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C6F Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D0F Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E29 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FF2 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FFB Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21AB Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x221F Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x226E Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22C6 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x242F Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2756 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x288D Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29BD Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29FC Hash - 0x74F10F98 ^0x53256055
{
...
void func_29(var uParam0) // Position - 0x2A8C Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2ABE Hash - 0xB3423CB7 ^0xB3423CB7
{
	func_57(&uLocal_19, false);
	func_58(&uLocal_19, true);
	func_59(&uLocal_19, true);
	func_60(&uLocal_19, true);
	func_61(&uLocal_19, true);
	func_62(&uLocal_19, true);
	func_63(&uLocal_19, 75);
	return 1;
}

int func_31(var uParam0) // Position - 0x2AF9 Hash - 0x97C84207 ^0x7B03088B
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	...
	{
		if (!bLocal_13 == true)
			if (func_64(uParam0, &uLocal_19, true) || func_65(Global_35, uParam0->f_20[0 /*14*/], true) <= 625f)
				bLocal_13 = true;
	
		if (bLocal_13)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				if (!func_66(&uLocal_15))
					func_67(&uLocal_15);
	...
	if (uParam0->f_469[0])
		if (func_71(&uLocal_15, 3f))
			return 1;

	if (!uParam0->f_469[1] && !bLocal_13)
	{
	...
	if (!uParam0->f_469[7])
	{
		if (func_73(uParam0, 1.5f, 1116471296, 4, joaat("Action"), true))
		{
			func_69(*uParam0, uParam0->f_483, true);
			uParam0->f_469[7] = 1;
		}
	...
	if (!uParam0->f_469[0] && !bLocal_13)
	{
		switch (iLocal_18)
		{
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!uParam0->f_469[6])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
									{
										...
										PED::FORCE_PED_MOTION_STATE(uParam0->f_20[1 /*14*/], joaat("MotionState_Sprint"), false, 0, false);
							...
							if (!uParam0->f_469[5])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
									{
										...
										TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0f, 5f, 0f, 2f, 7500, 1036831949, true, true, false, true, true, false);
							...
							if (uParam0->f_469[5] == 1 && uParam0->f_469[6] == 1)
								iLocal_18 = 1;
						}
					}
				}
			...
			case 1:
				if (!func_74(uParam0->f_20[0 /*14*/], SCRIPT_TASK_FOLLOW_TO_OFFSET_OF_ENTITY))
				{
...
int func_32(var uParam0, var uParam1) // Position - 0x2F2A Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_75(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2F3C Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F59 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3095 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x31CE Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3278 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x32F0 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x337F Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x349A Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x34A6 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x362E Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x36CE Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36E1 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x36FB Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3763 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x378F Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x37C0 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x384E Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3A52 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3A66 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3A75 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_76() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3A90 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3AEF Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3B31 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B5D Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x3B85 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3C01 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3C27 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3C49 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3C6B Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3C8D Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_63(var uParam0, int iParam1) // Position - 0x3CB1 Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_64(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3CBF Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_65(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3D19 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_104(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_66(var uParam0) // Position - 0x3D70 Hash - 0x5001E582 ^0x5001E582
{
	return func_105(*uParam0, 1);
}

void func_67(var uParam0) // Position - 0x3D80 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_106(uParam0, 0f);
	return;
}

void func_68(var uParam0) // Position - 0x3D8F Hash - 0xC18BD09E ^0xC18BD09E
{
	if (!uParam0->f_469[8])
	{
...
void func_69(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3DB6 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_70(var uParam0) // Position - 0x3EBA Hash - 0x8E8F870D ^0x86B67B16
{
	if (*uParam0 == 247)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
			if (func_65(uParam0->f_20[0 /*14*/], Global_35, true) <= 3600f)
			{
				if (!func_74(uParam0->f_20[0 /*14*/], SCRIPT_TASK_COMBAT))
				{
			...
			else if (!func_74(uParam0->f_20[0 /*14*/], 518218985))
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 4, 256, -1082130432, -1, 0);
				func_56(&uParam0->f_20[0 /*14*/], false, true);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
			}
		}
	}
	else if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!func_74(uParam0->f_20[0 /*14*/], 518218985))
		{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (!func_74(uParam0->f_20[1 /*14*/], 518218985))
		{
...
BOOL func_71(var uParam0, float fParam1) // Position - 0x4027 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_66(uParam0))
		return false;
...
BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x404E Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_66(&(uParam0->f_490)))
							func_67(&(uParam0->f_490));
...
BOOL func_73(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4259 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_113(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_65(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_66(&(uParam0->f_490)))
						...
						if (func_71(&(uParam0->f_490), fParam1))
							return true;
						else
							return false;
					}
		...
		if (func_66(&(uParam0->f_490)) && !func_118(&(uParam0->f_490)))
...
BOOL func_74(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x4382 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_75(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x43DB Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_76() // Position - 0x452F Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_77(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x453D Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x45A4 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x45CD Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_80(var uParam0, var uParam1, var uParam2) // Position - 0x4619 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_81(int iParam0) // Position - 0x4668 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_82(int iParam0) // Position - 0x468D Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_83(int iParam0) // Position - 0x46A0 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_84(int iParam0) // Position - 0x46B3 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_85(int iParam0) // Position - 0x46C6 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_86(int iParam0) // Position - 0x46D8 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_87(int iParam0, int iParam1) // Position - 0x46EA Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4784 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_89() // Position - 0x47BC Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_90(int iParam0) // Position - 0x480F Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_93(iParam0))
		return -1;
...
BOOL func_91(int iParam0) // Position - 0x482F Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_92(int iParam0, int iParam1) // Position - 0x4845 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_93(int iParam0) // Position - 0x4854 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_94(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4887 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4968 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_102(iParam0, 4);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4986 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_102(iParam0, 8);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x49A6 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_102(iParam0, 16);
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x49D1 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_102(iParam0, 32);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x49F1 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_102(iParam0, 64);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4A11 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4A33 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_102(int iParam0, int iParam1) // Position - 0x4A57 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_103(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4A68 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_104(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5091 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x50AF Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_106(var uParam0, float fParam1) // Position - 0x50BE Hash - 0x30433BAB ^0xF854D531
{
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x50E4 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_108(int iParam0) // Position - 0x51BB Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_109(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x523C Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_110(var uParam0) // Position - 0x532D Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_66(uParam0))
		return uParam0->f_1;
...
BOOL func_111(Ped pedParam0) // Position - 0x5362 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_112(Ped pedParam0) // Position - 0x537D Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_113(int iParam0) // Position - 0x5399 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_114(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x53E0 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_115(var uParam0, float fParam1) // Position - 0x53FE Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_116(var uParam0) // Position - 0x541C Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_117(var uParam0, BOOL bParam1) // Position - 0x5432 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_118(var uParam0) // Position - 0x5452 Hash - 0x39705408 ^0x39705408
{
	return func_105(*uParam0, 2);
}

void func_119(var uParam0) // Position - 0x5462 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_66(uParam0);
...
void func_120(var uParam0) // Position - 0x5496 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_66(uParam0);
...
BOOL func_121(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x54C6 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_122(BOOL bParam0, var uParam1, var uParam2) // Position - 0x551B Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_123(int iParam0, int iParam1) // Position - 0x5532 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_124(int iParam0, int iParam1) // Position - 0x55B8 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_125(int iParam0, int iParam1) // Position - 0x55F4 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_126(int iParam0, int iParam1) // Position - 0x5647 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_127(int iParam0, int iParam1) // Position - 0x5682 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_128(int iParam0, int iParam1) // Position - 0x56BB Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_129(int iParam0) // Position - 0x56F3 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_130(BOOL bParam0) // Position - 0x5731 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_131(ePedType eptParam0) // Position - 0x5744 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_132(Ped pedParam0, Hash hParam1) // Position - 0x5B97 Hash - 0xF0951E5D ^0xB22BED72
{
...
void func_133(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5C3E Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_134(Ped pedParam0, BOOL bParam1) // Position - 0x5C6E Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_135(Ped pedParam0, int iParam1) // Position - 0x5CB3 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_136(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5CDA Hash - 0x37D64B11 ^0xE7060A9E
{
	func_174(iParam2);
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5EA5 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_138(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5F7C Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5FB9 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_140(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x60A0 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x6176 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_142(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x627F Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x63B4 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x63EB Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x64F2 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x655D Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_147(Ped pedParam0, int iParam1) // Position - 0x66A5 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_148(var uParam0, int iParam1) // Position - 0x6882 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x68FA Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_150(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6929 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_151(int iParam0, Ped pedParam1) // Position - 0x6AAF Hash - 0x42A83B1F ^0xC3E0C1D4
{
	int _int;
...
BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x6AFF Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_201(iParam0))
		return true;
...
BOOL func_153(Ped pedParam0, Ped pedParam1) // Position - 0x6B9C Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_154() // Position - 0x6BE9 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6BF1 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_156() // Position - 0x6CB2 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_157() // Position - 0x6CD0 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_158(int iParam0, Ped pedParam1) // Position - 0x6D1D Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_159(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6E39 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_160(Ped pedParam0, int iParam1) // Position - 0x6E81 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x70DA Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_211(0))
		return false;
...
BOOL func_162(int iParam0, int iParam1) // Position - 0x7113 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_163(var uParam0, int iParam1) // Position - 0x7142 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_164(Ped pedParam0, int iParam1) // Position - 0x7156 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_165(int iParam0, Ped pedParam1) // Position - 0x71A3 Hash - 0x63E2B24C ^0x6A544491
{
...
float func_166() // Position - 0x71F6 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_167(var uParam0, int iParam1) // Position - 0x7228 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_168(var uParam0, int iParam1) // Position - 0x7239 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_169(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x724E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x72DA Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x7308 Hash - 0x5C8A17B4 ^0x9A7CB550
{
	Hash _int;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x7358 Hash - 0x5C8A17B4 ^0x9A7CB550
{
	Hash _int;
	int _int2;
...
void func_173(Ped pedParam0) // Position - 0x73C8 Hash - 0x4A4CC0EA ^0x377505E2
{
...
void func_174(int iParam0) // Position - 0x73E5 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_175(int iParam0) // Position - 0x7551 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_176(BOOL bParam0) // Position - 0x7564 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_177(int iParam0) // Position - 0x757E Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_178(int iParam0) // Position - 0x7618 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_179(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x763F Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_180(Ped pedParam0, Ped pedParam1) // Position - 0x7738 Hash - 0xF9959663 ^0xF9959663
{
	return func_202(pedParam0, pedParam1, true, true);
}

float func_181(int iParam0) // Position - 0x774A Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_182(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7756 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x77BB Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_184() // Position - 0x77E1 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_185(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x77F5 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_186(int iParam0) // Position - 0x7955 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7961 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_188(int iParam0) // Position - 0x79C2 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_189(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x79CE Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_190(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7A90 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_191(int iParam0) // Position - 0x7B2E Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_192(int iParam0) // Position - 0x7B3A Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_193(int iParam0) // Position - 0x7B46 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_194(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7C83 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_195(Ped pedParam0) // Position - 0x7CC6 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D2C Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D73 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7DBE Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_199(Ped pedParam0, var uParam1) // Position - 0x7E37 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_200(Ped pedParam0, Ped pedParam1) // Position - 0x7E84 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_201(int iParam0) // Position - 0x7ECC Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_202(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7EDC Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_203(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7F24 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7F50 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_205(int iParam0) // Position - 0x7F78 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_206(Ped pedParam0) // Position - 0x7F84 Hash - 0xC117A407 ^0xE7130731
{
...
int func_207(Ped pedParam0) // Position - 0x7FDA Hash - 0xF332EF67 ^0x45F21037
{
...
BOOL func_208(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x8047 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x81B7 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_210(int iParam0, Ped pedParam1) // Position - 0x82A5 Hash - 0x27FC2906 ^0x1FD05156
{
...
BOOL func_211(int iParam0) // Position - 0x831B Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_228())
		return false;
...
int func_212(int iParam0) // Position - 0x833D Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_213(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8349 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_214(int iParam0) // Position - 0x83C4 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_215() // Position - 0x83D7 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_216() // Position - 0x83E5 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_217(Any* panParam0, int iParam1) // Position - 0x843B Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_218(BOOL bParam0, var uParam1, var uParam2) // Position - 0x84E3 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_219(int iParam0) // Position - 0x85AA Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x8652 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_221(Ped pedParam0, int iParam1) // Position - 0x86B7 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_222(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x86CE Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_223(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x86FC Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_224(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8746 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_225(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8787 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_226(Ped pedParam0) // Position - 0x8800 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_227(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x88E8 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_228() // Position - 0x892A Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_215() != -1)
		return false;
...
BOOL func_229(int iParam0, BOOL bParam1) // Position - 0x894F Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_230() // Position - 0x8980 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x89B1 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_93(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x89CD Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_233(int iParam0) // Position - 0x8A0E Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
