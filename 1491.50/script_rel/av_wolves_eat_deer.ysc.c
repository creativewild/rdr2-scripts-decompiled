...
void main() // Position - 0x0 Hash - 0xC21F1F42 ^0x2BEADDFC
{
	var unk;
	BOOL flag;
...
void func_1(var uParam0) // Position - 0x5A1 Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x5AF Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x645 Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9EC Hash - 0x4DA9BC8C ^0x7866DF55
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0xA06 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA1D Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xADB Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB05 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC56 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC6B Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD0F Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AC0 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B26 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BE0 Hash - 0x391987C ^0x9288F84D
{
	func_46(uParam0, "WOLVES_EAT_DEER", "", vParam1, uParam4);
	func_47(uParam0, 0, "WED1_DEER", iLocal_9, vParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "WED1_WOLF_1", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.9f, -0.3f, 0f), 90f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "WED1_WOLF_2", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 3f, 2f, 0f), 135f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "WED1_WOLF_3", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -0.85f, -0.1f, 0f), -70f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "WED1_VULTURE_1", iLocal_11, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 23f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 5, "WED1_VULTURE_2", iLocal_11, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 4f, 28f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "WED1_VULTURE_3", iLocal_11, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 2f, 0f, 25f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1D48 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1DE8 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1F02 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x20CB Hash - 0x92ED3FDF ^0xD78BADED
{
	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_13))
		return 0;

	return func_48(uParam0, uParam0->f_20[0 /*14*/].f_5);
}

BOOL func_19(var uParam0) // Position - 0x20F2 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x22A2 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2316 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2365 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x23BD Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2526 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x284D Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2984 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2AB4 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2AF3 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2AFC Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2B2E Hash - 0x8C5FB44F ^0xF3128791
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_13);
	func_56(&uLocal_19, false);
	func_57(&uLocal_19, true);
...
int func_31(var uParam0) // Position - 0x2B6E Hash - 0x49C8C5BE ^0x49C8C5BE
{
	if (!uParam0->f_469[2])
	{
		if (func_63(uParam0, &uLocal_19, false))
		{
			func_64(uParam0);
			func_65(uParam0);
			uParam0->f_469[2] = 1;
	...
	switch (iLocal_12)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_13, sLocal_14, 1000f, -1000f, -1, 131072, 0, false, 0, false, 0, false);
				...
				iLocal_16 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1f, 1, -1, 0);
				iLocal_17 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1.5f, 2, -1, 0);
				iLocal_18 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1.5f, 4, -1, 0);
				func_66(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("world_animal_wolf_eating"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
				EVENT::_0x9520175B35E2268D(uParam0->f_20[1 /*14*/], true);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[1 /*14*/], true);
				func_66(&(uParam0->f_20[2 /*14*/].f_5), 50, 10, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[2 /*14*/], joaat("world_animal_wolf_sitting"), uParam0->f_20[2 /*14*/].f_5, uParam0->f_20[2 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[2 /*14*/], true);
				EVENT::_0x9520175B35E2268D(uParam0->f_20[2 /*14*/], true);
				func_66(&(uParam0->f_20[3 /*14*/].f_5), 50, 10, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[3 /*14*/], joaat("world_animal_wolf_eating"), uParam0->f_20[3 /*14*/].f_5, uParam0->f_20[3 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[3 /*14*/], true);
				EVENT::_0x9520175B35E2268D(uParam0->f_20[3 /*14*/], true);
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[4 /*14*/]))
			{
				...
				func_67(&uParam0->f_20[4 /*14*/], false, true);
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[5 /*14*/]))
			{
				...
				func_67(&uParam0->f_20[5 /*14*/], false, true);
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[6 /*14*/]))
			{
				...
				func_67(&uParam0->f_20[6 /*14*/], false, true);
			}
		...
		case 1:
			if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				func_65(uParam0);
				func_64(uParam0);
				iLocal_12 = 2;
...
int func_32(var uParam0, var uParam1) // Position - 0x2EC2 Hash - 0xB5A2CE46 ^0x35E28A71
{
	func_69(uParam0, false, false, false);

	if (iLocal_16 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_16, 1);

	if (iLocal_17 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_17, 1);

	if (iLocal_18 != -1)
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&iLocal_18, 1);

	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2EFB Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F18 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3054 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x318D Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3237 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x32AF Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x333E Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3459 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3465 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35ED Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x368D Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36A0 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x36BA Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3722 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x374E Hash - 0x960D7EB7 ^0x57019BBE
{
...
int func_48(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x37DC Hash - 0xC6A27419 ^0xF20AC559
{
	Entity entity;
	...
	{
		if (func_83(entity, vParam1, true) <= 1f)
		{
			func_84(*uParam0, uParam0->f_483);
			uParam0->f_499 = 1;
			return 0;
		}
	}
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3833 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_86(Global_1898164.f_1[0 /*5*/]);
	
		if (func_87(num) && func_88(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}

	if (iParam0 == 0 && func_89(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_50(int iParam0) // Position - 0x3A37 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3A4B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3A5A Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_70() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3A75 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3AD4 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_90(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_55(Ped pedParam0) // Position - 0x3B16 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3B42 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3BBE Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3BE4 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3C06 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3C28 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x3C4A Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_97(iParam0, 4);
	else
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3C68 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_63(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C8C Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_64(var uParam0) // Position - 0x3CE6 Hash - 0xBF0CCA08 ^0x87AC7FD5
{
	int i;
	...
	for (i = 1; i <= 6; i = i + 1)
	{
		...
		{
			if (i > 3)
				TASK::TASK_FLY_AWAY(uParam0->f_20[i /*14*/], Global_35);
...
void func_65(var uParam0) // Position - 0x3D33 Hash - 0x411E0BA9 ^0x411E0BA9
{
	if (!uParam0->f_469[1])
	{
...
int func_66(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3D7C Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_67(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3E73 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3E9B Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
void func_69(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x40A8 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_70() // Position - 0x41FC Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_71(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x420A Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_72(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4271 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_73(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x429A Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_111(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_74(var uParam0, var uParam1, var uParam2) // Position - 0x42E6 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_111(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_75(int iParam0) // Position - 0x4335 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_76(int iParam0) // Position - 0x435A Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_77(int iParam0) // Position - 0x436D Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_78(int iParam0) // Position - 0x4380 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_79(int iParam0) // Position - 0x4393 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_80(int iParam0) // Position - 0x43A5 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_81(int iParam0, int iParam1) // Position - 0x43B7 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4451 Hash - 0xA65AB937 ^0xA65AB937
{
...
float func_83(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4489 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_119(entityCoords, vParam1);
}

void func_84(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x44D9 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_111(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_85() // Position - 0x45CA Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_86(int iParam0) // Position - 0x461D Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_89(iParam0))
		return -1;

	return func_121(func_120(iParam0));
}

BOOL func_87(int iParam0) // Position - 0x463D Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_88(int iParam0, int iParam1) // Position - 0x4653 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_89(int iParam0) // Position - 0x4662 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_90(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4695 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_125(pedParam0, false);
			flag = true;
		}
	
		func_126(pedParam0, iParam2);
	}
...
void func_91(int iParam0, BOOL bParam1) // Position - 0x4776 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_97(iParam0, 8);
	else
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x4796 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_97(iParam0, 16);
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x47C1 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_97(iParam0, 32);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x47E1 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_97(iParam0, 64);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4801 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4823 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_97(int iParam0, int iParam1) // Position - 0x4847 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_98(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4858 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_127(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_129(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_131(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_129(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_133(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_134(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_135(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_129(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_137(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_129(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_137(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_129(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				if (func_140(iParam2, 4000))
				{
					if (func_141(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_142(iParam2, pedParam0) && func_143(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_129(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_141(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_142(iParam2, pedParam0) && func_143(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_129(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_144(pedParam0, Global_1935630.f_41))
							{
								func_145();
								*uParam3 = 2;
								func_129(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_146(iParam2, pedParam0) || iParam2->f_9 > 0 && func_147() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_148())
					{
						if (func_144(pedParam0, Global_1935630.f_42))
						{
							func_145();
							*uParam3 = 2;
							func_129(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_150(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_129(pedParam0, iParam2, *uParam3);
					return true;
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4E81 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_100(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4F58 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_101(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x505C Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_102(Ped pedParam0) // Position - 0x5085 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_103(Ped pedParam0) // Position - 0x50A0 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_104(float fParam0) // Position - 0x50BC Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_105(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5103 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_106(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x5121 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_119(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_107(var uParam0) // Position - 0x5178 Hash - 0x5001E582 ^0x5001E582
{
	return func_158(*uParam0, 1);
}

void func_108(var uParam0) // Position - 0x5188 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_159(uParam0, 0f);
	return;
}

BOOL func_109(var uParam0, float fParam1) // Position - 0x5197 Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_160(uParam0, fParam1))
	{
		func_110(uParam0);
		return true;
	}
...
void func_110(var uParam0) // Position - 0x51B5 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_111(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x51CB Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_112(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5220 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_113(int iParam0, int iParam1) // Position - 0x5237 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_114(int iParam0, int iParam1) // Position - 0x52BD Hash - 0x96B01D2A ^0x81E68218
{
...
void func_115(int iParam0, int iParam1) // Position - 0x52F9 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_116(int iParam0, int iParam1) // Position - 0x534C Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_117(int iParam0, int iParam1) // Position - 0x5387 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_118(int iParam0, int iParam1) // Position - 0x53C0 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
float func_119(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x53F8 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_120(int iParam0) // Position - 0x5416 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_121(BOOL bParam0) // Position - 0x5454 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_122(ePedType eptParam0) // Position - 0x5467 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_123(Ped pedParam0, Hash hParam1) // Position - 0x58BA Hash - 0x8A45D584 ^0x3ECF33F8
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_161(pedParam0, hParam1))
		{
			if (func_162(pedParam0, hParam1))
			{
...
void func_124(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5961 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_125(Ped pedParam0, BOOL bParam1) // Position - 0x5991 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_126(Ped pedParam0, int iParam1) // Position - 0x59D6 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_127(int iParam0, BOOL bParam1, int iParam2) // Position - 0x59FD Hash - 0x37D64B11 ^0xE7060A9E
{
	func_165(iParam2);
...
BOOL func_128(Ped pedParam0, int iParam1) // Position - 0x5BC8 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_129(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5C9F Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_130(Ped pedParam0, int iParam1) // Position - 0x5CDC Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_131(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5DC3 Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x5E99 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_133(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5FA2 Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_134(int iParam0, int iParam1) // Position - 0x60D7 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_135(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x610E Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_136(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6215 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_137(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x6280 Hash - 0x8CBDE6BD ^0xE1F008CE
{
	Vector3 entityCoords;
	int num;
	var outCoords;
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x63C8 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_139(var uParam0, int iParam1) // Position - 0x65A4 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x661C Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_141(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x664B Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_142(int iParam0, Ped pedParam1) // Position - 0x67D1 Hash - 0x42A83B1F ^0xC2785BD4
{
	int _int;
...
BOOL func_143(int iParam0, Ped pedParam1) // Position - 0x6821 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_192(iParam0))
		return true;
...
BOOL func_144(Ped pedParam0, Ped pedParam1) // Position - 0x68BE Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_145() // Position - 0x690B Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_146(int iParam0, Ped pedParam1) // Position - 0x6913 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_147() // Position - 0x69D4 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_148() // Position - 0x69F2 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_149(int iParam0, Ped pedParam1) // Position - 0x6A3F Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_150(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6B5B Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_151(Ped pedParam0, int iParam1) // Position - 0x6BA3 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_152(Ped pedParam0, int iParam1) // Position - 0x6DFC Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_202(0))
		return false;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x6E35 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_154(var uParam0, int iParam1) // Position - 0x6E64 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_155(Ped pedParam0, int iParam1) // Position - 0x6E78 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_147() - iParam1->f_4 > func_203(iParam1))
		return func_204(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6EC5 Hash - 0x59FF164E ^0x611FF8A
{
...
void func_157(int iParam0) // Position - 0x6F18 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x6F99 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_159(var uParam0, float fParam1) // Position - 0x6FA8 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_160(var uParam0, float fParam1) // Position - 0x6FCE Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_107(uParam0))
		return false;
...
BOOL func_161(Ped pedParam0, Hash hParam1) // Position - 0x6FF5 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_162(Ped pedParam0, Hash hParam1) // Position - 0x7023 Hash - 0x47529916 ^0x27FD79C1
{
	Hash _int;
...
BOOL func_163(Ped pedParam0, Hash hParam1) // Position - 0x7073 Hash - 0x47529916 ^0x27FD79C1
{
	Hash _int;
	int _int2;
...
void func_164(Ped pedParam0) // Position - 0x70E3 Hash - 0x161E9590 ^0x64A16B89
{
...
void func_165(int iParam0) // Position - 0x7100 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
	...
	{
		case 0:
			func_211(&(Global_1935630.f_34), &(Global_1935630.f_39));
...
var func_166(int iParam0) // Position - 0x726C Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_167(BOOL bParam0) // Position - 0x727F Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;

	if (func_212(bParam0, &unk, &unk2))
		return true;

	return false;
}

BOOL func_168(int iParam0) // Position - 0x7299 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_169(int iParam0) // Position - 0x7333 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_170(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x735A Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_171(Ped pedParam0, Ped pedParam1) // Position - 0x7453 Hash - 0xF9959663 ^0xF9959663
{
	return func_193(pedParam0, pedParam1, true, true);
}

float func_172(int iParam0) // Position - 0x7465 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_173(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7471 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_174(int iParam0, BOOL bParam1) // Position - 0x74D6 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_175() // Position - 0x74FC Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_176(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7510 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_216(ped, 0)))
			if (func_217(pedParam0, 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

float func_177(int iParam0) // Position - 0x7670 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_178(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x767C Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_179(int iParam0) // Position - 0x76DD Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_180(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x76E9 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_216(ped, 0)))
			if (func_218(ENTITY::GET_ENTITY_COORDS(eParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
				return true;

	return false;
}

int func_181(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x77AB Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_182(int iParam0) // Position - 0x7849 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_183(int iParam0) // Position - 0x7855 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_184(int iParam0) // Position - 0x7861 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_185(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x799E Hash - 0xB38C72E2 ^0xD400E0B7
{
	if (func_219(pedParam0, vParam4, 0.5f))
...
BOOL func_186(Ped pedParam0) // Position - 0x79E1 Hash - 0x4A20E6BA ^0x550F792B
{
	...
	if (func_220(pedParam0, 200, false, true))
		return 1;

	return 0;
}

BOOL func_187(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A47 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_188(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A8E Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_189(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7AD9 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_190(Ped pedParam0, var uParam1) // Position - 0x7B52 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_191(Ped pedParam0, Ped pedParam1) // Position - 0x7B9F Hash - 0x32A55AFE ^0x7FDC2FE
{
	if (PED::_GET_LASSO_TARGET(pedParam0) == pedParam1)
		return true;

	if (func_222(pedParam0, true, 0, false) != joaat("WEAPON_LASSO"))
		return false;
...
BOOL func_192(int iParam0) // Position - 0x7BE7 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_193(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7BF7 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_194(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7C3F Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_195(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7C6B Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_196(int iParam0) // Position - 0x7C93 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_197(Ped pedParam0) // Position - 0x7C9F Hash - 0x55C19E23 ^0xFD72705B
{
...
int func_198(Ped pedParam0) // Position - 0x7CF3 Hash - 0xE4A295C9 ^0xF1B19B55
{
...
BOOL func_199(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7D5F Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_200(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7ECF Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;

	func_212(true, &ped, &ped2);
...
BOOL func_201(int iParam0, Ped pedParam1) // Position - 0x7FBD Hash - 0x27FC2906 ^0x84B3F8B6
{
...
BOOL func_202(int iParam0) // Position - 0x8038 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_223())
		return false;

	return func_224(Global_1347702[58 /*49*/].f_15, true);
}

int func_203(int iParam0) // Position - 0x805A Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_204(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8066 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_205(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x80E1 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_225(iParam0) == 1 && bParam7)
		return;
...
float func_206() // Position - 0x816D Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_207(var uParam0, int iParam1) // Position - 0x819F Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_208(var uParam0, int iParam1) // Position - 0x81B0 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_209(var uParam0) // Position - 0x81C5 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_107(uParam0))
		return uParam0->f_1;
...
BOOL func_210() // Position - 0x81FA Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_227())
		return false;
...
void func_211(Any* panParam0, int iParam1) // Position - 0x8250 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_212(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82F8 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_213() // Position - 0x83BF Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_214(int iParam0) // Position - 0x83CD Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_215(int iParam0) // Position - 0x8475 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_216(Ped pedParam0, int iParam1) // Position - 0x84DA Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_217(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x84F1 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		if (func_218(ENTITY::GET_ENTITY_COORDS(pedParam0, true, false), fParam1, fParam2, fParam3, fParam4))
			return true;

	return false;
}

BOOL func_218(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x851F Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_219(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8569 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_220(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x85AA Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_221(Ped pedParam0) // Position - 0x8623 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_222(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x870B Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_223() // Position - 0x874D Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_213() != -1)
		return false;
...
BOOL func_224(int iParam0, BOOL bParam1) // Position - 0x8772 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_225(int iParam0) // Position - 0x87A3 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_226(var uParam0) // Position - 0x87B6 Hash - 0x39705408 ^0x39705408
{
	return func_158(*uParam0, 2);
}

BOOL func_227() // Position - 0x87C6 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_228(int iParam0) // Position - 0x87F7 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_89(iParam0))
		return -1;
...
int func_229(int iParam0) // Position - 0x8813 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_230(int iParam0) // Position - 0x8854 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
