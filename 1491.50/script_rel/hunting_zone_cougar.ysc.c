...
int func_30() // Position - 0x12A4 Hash - 0x2160DAA3 ^0x2160DAA3
{
	return 12;
}
...
BOOL func_42(var uParam0) // Position - 0x1583 Hash - 0x1D74D9D ^0x6036E69
{
	*uParam0 = 8;
	uParam0->f_1 = 2;
	uParam0->f_572[0] = joaat("p_cougarscat01x");
	uParam0->f_572[1] = joaat("p_cougarbloodpools01x");
	uParam0->f_572[2] = joaat("p_cougarkillremains01x");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 3;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_12.f_1 = joaat("a_c_cougar_01");
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = joaat("COUGAR_LEGENDARY");
	return true;
}

BOOL func_43(var uParam0) // Position - 0x1636 Hash - 0x90008B47 ^0xA0ACAD4E
{
	float num;
	var unk;
	var unk6;
...
int func_44(int iParam0) // Position - 0x174D Hash - 0xBA31BE74 ^0xBA31BE74
{
	int num;
...
void func_45(var uParam0) // Position - 0x1783 Hash - 0xF060930F ^0x679498F2
{
	int i;
...
BOOL func_46(var uParam0) // Position - 0x17CD Hash - 0x7B76A2ED ^0x317722B6
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x1892 Hash - 0x43C1809B ^0xD255F79A
{
	float scaleX;
...
BOOL func_48(var uParam0) // Position - 0x18D9 Hash - 0xC25AB6F8 ^0xC25AB6F8
{
	int i;
	int j;
...
BOOL func_49(var uParam0) // Position - 0x1924 Hash - 0x10BF63DF ^0x638AC662
{
	int i;
	float radius;
	var unk;
...
void func_50(var uParam0) // Position - 0x1EC4 Hash - 0x85508A28 ^0x573D2B47
{
	float num;
	int num2;
	int i;
...
void func_51(var uParam0) // Position - 0x1F8A Hash - 0x46A37087 ^0x6FADEB49
{
	int i;
	int duration;
	int num;
...
void func_52(var uParam0) // Position - 0x264B Hash - 0x271CC8B9 ^0x72DC5E80
{
	int taskSequenceId;
	float num;
...
int func_53(var uParam0, var uParam1) // Position - 0x2740 Hash - 0x3AAD93D4 ^0x6348F3E3
{
	int unk;
...
BOOL func_54(var uParam0) // Position - 0x2753 Hash - 0x26561433 ^0x8D630CC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		return true;
...
var func_55(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2788 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_56(Hash hParam0, int iParam1) // Position - 0x279F Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_57(Hash hParam0, int iParam1) // Position - 0x2825 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_58(Hash hParam0, int iParam1) // Position - 0x2861 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_59(Hash hParam0, int iParam1) // Position - 0x28B4 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_60(Hash hParam0, int iParam1) // Position - 0x28EF Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_61(Hash hParam0, int iParam1) // Position - 0x2928 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_62(Hash hParam0, int iParam1) // Position - 0x2960 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_63() // Position - 0x2973 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_64() // Position - 0x2992 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0) // Position - 0x29A0 Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

int func_66(int iParam0) // Position - 0x29B6 Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_67(int iParam0) // Position - 0x2E0A Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_123(iParam0, 1);
}

int func_68(int iParam0) // Position - 0x2E1A Hash - 0xA776614E ^0xA776614E
{
	if (!func_65(iParam0))
		return -1;
...
BOOL func_69(int iParam0) // Position - 0x3260 Hash - 0x14DDF3C9 ^0xAD14D790
{
...
BOOL func_70(int iParam0) // Position - 0x32A9 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_125(iParam0))
		return false;
...
Vector3 func_71(int iParam0) // Position - 0x32CA Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_65(iParam0))
		return 0f, 0f, 0f;
...
float func_72(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3AF1 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_73(int iParam0) // Position - 0x3B19 Hash - 0x23547602 ^0x23547602
{
	switch (iParam0)
	{
		case 0:
...
int func_74(int iParam0, var uParam1) // Position - 0x3C10 Hash - 0x4931B454 ^0x88362C28
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3D71 Hash - 0x49B3EF5C ^0x9505D01C
{
	var data;
	int size;
	int collectionId;
...
int func_76(Hash hParam0, int iParam1) // Position - 0x3E24 Hash - 0x3B4883DD ^0xBE4A62CA
{
	var unk;
	var guid;
...
BOOL func_77(Hash hParam0, int iParam1) // Position - 0x3E7F Hash - 0xD7B4F3C5 ^0x943C8C22
{
	var unk;
	int num;
	int num2;
...
BOOL func_78(Hash hParam0, int iParam1, int iParam2) // Position - 0x3EDD Hash - 0xC758F57F ^0x801747D0
{
	int num;
	var unk;
	var unk6;
...
void func_79(var uParam0, int iParam1) // Position - 0x3F54 Hash - 0xF55E891F ^0xF55E891F
{
	func_140(uParam0, iParam1);
	return;
}

int func_80(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F64 Hash - 0xB04D1B6E ^0xB04D1B6E
{
	switch (hParam0)
	{
...
float func_99(int iParam0) // Position - 0x63A1 Hash - 0xC38D7DC0 ^0xC38D7DC0
{
	return 0f;
}

Ped func_100(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x63AA Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_169(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

void func_101(var uParam0) // Position - 0x63EC Hash - 0xB1EA7205 ^0x42F352D8
{
	PED::_SET_PED_SCALE(uParam0->f_12, uParam0->f_12.f_4);
	PED::_SET_PED_PROMPT_NAME_FROM_GXT_ENTRY(uParam0->f_12, func_170());
...
void func_102(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6688 Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
Ped func_103(Ped pedParam0) // Position - 0x66C4 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

Vector3 func_104(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x66CE Hash - 0x88200B15 ^0xE07B704A
{
	float num;
...
int func_105(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6705 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
const char* func_106(const char* sParam0) // Position - 0x67FC Hash - 0xC9D82232 ^0xC9D82232
{
	return sParam0;
}

float func_107(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x6806 Hash - 0x1A58F423 ^0x2317B76D
{
	...
	return func_172(entityCoords, vParam1);
}

float func_108(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x6856 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_109() // Position - 0x68AD Hash - 0x7A8E245E ^0x59FC764
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) || func_173(Global_35))
		return true;
...
int func_110(char* sParam0, Hash hParam1, Object obParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x68D1 Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_175(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, iParam8, 0, obParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, bParam16);
		return num;
	}
...
void func_111(int iParam0, float fParam1, BOOL bParam2) // Position - 0x69A8 Hash - 0x9018D919 ^0x90AC92B6
{
	int num;
...
int func_112(var uParam0, Entity eParam1) // Position - 0x6A07 Hash - 0x583186B5 ^0x1718BFF6
{
	int num;
...
BOOL func_113(int iParam0, BOOL bParam1) // Position - 0x6A4C Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_114(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6AA4 Hash - 0x89AE2BEC ^0x89AE2BEC
{
	int num;
...
void func_115(var uParam0, var uParam1) // Position - 0x6AF3 Hash - 0x2173EF1C ^0x6EFEA7E5
{
	int i;
	int num;
	int num2;
	...
	if (uParam0->f_614 == 0)
	{
		...
		uParam0->f_5 = func_180(uParam0->f_4, 0, false, 0);
		func_181(uParam0);
		...
		func_182(-1, false, 0, false, false);
		func_183();
		func_184(num2, 0, true);
		func_28(uParam0->f_3);
...
BOOL func_116(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x6D1A Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
void func_117(int iParam0, int iParam1) // Position - 0x6D73 Hash - 0x95CEEAD4 ^0xCB13CDAE
{
	if (iParam1 == 0)
		if (iParam0 == 0)
...
int func_118(Entity eParam0, const char* sParam1, BOOL bParam2, float fParam3, int iParam4, int iParam5, float fParam6, BOOL bParam7) // Position - 0x6E19 Hash - 0xF2C93E75 ^0x2DDAA8D0
{
	int points;
...
void func_119(Volume volParam0) // Position - 0x6E85 Hash - 0x530B7370 ^0x1B8FEE27
{
	int i;
...
BOOL func_120(int iParam0) // Position - 0x6EB6 Hash - 0x90A8253B ^0x90A8253B
{
	switch (iParam0)
	{
		case 0:
...
void func_121(var uParam0) // Position - 0x6F2F Hash - 0x8EF783D9 ^0x83F1A18A
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
		func_185(uParam0->f_12, uParam0->f_12.f_10, func_99(uParam0->f_615), 2, 1073741824);
...
void func_122(var uParam0) // Position - 0x6FAA Hash - 0x6C6259DC ^0xF1EA64EB
{
	int num;

	num = func_187(0, func_186(), uParam0->f_616);
	uParam0->f_616 = num;
	uParam0->f_12.f_16 = { func_168(num) };
	return;
}

BOOL func_123(int iParam0, BOOL bParam1) // Position - 0x6FD7 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_65(iParam0))
		return false;
...
eStackSize func_124() // Position - 0x6FFD Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_125(int iParam0) // Position - 0x700B Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_126(int iParam0, BOOL bParam1) // Position - 0x7021 Hash - 0x34A2E44 ^0x39A823C1
{
	if (Global_1572887.f_12 == -1)
...
BOOL func_127(Hash hParam0, int iParam1) // Position - 0x7054 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
struct<10> func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x706E Hash - 0x440EE211 ^0xAE2816F9
{
	int num;
...
BOOL func_129(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7142 Hash - 0x72399051 ^0x6D1C1C66
{
	var outData;
	int i;
	...
	*uParam3 = outData.f_3;
	...
	if (bParam4)
		func_188(hParam0, hParam1, uParam2, *uParam3);

	return true;
}

struct<4> func_130(BOOL bParam0) // Position - 0x71DF Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_132(joaat("character"), func_189(), joaat("SLOTID_NONE"), bParam0);
}

int func_131(int iParam0) // Position - 0x71FB Hash - 0xF3DAE918 ^0xA65130AC
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_132(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x7248 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
int func_133(BOOL bParam0) // Position - 0x7279 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_64() == -1)
	{
...
BOOL func_134(Hash hParam0, var uParam1) // Position - 0x72BA Hash - 0x6C0FFC3B ^0xB2795CB6
{
	int i;
	var outSlotId;
	var unk;
...
int func_135(Hash hParam0, Any* panParam1, BOOL bParam2, BOOL bParam3) // Position - 0x730E Hash - 0x9D75BA2C ^0xE0E521B7
{
	if (!func_127(hParam0, 0))
		return 0;
...
int func_136(Hash hParam0, BOOL bParam1) // Position - 0x735C Hash - 0xE0F47B47 ^0x52A64D28
{
	if (func_194(hParam0))
...
BOOL func_137(Hash hParam0) // Position - 0x7386 Hash - 0x5E6E1858 ^0x84C97687
{
	!func_127(hParam0, 0);

	if (func_195(hParam0, 173360570))
		return true;

	return false;
}

BOOL func_138(Hash hParam0) // Position - 0x73AC Hash - 0x33F7D399 ^0xEB534519
{
	if (!func_127(hParam0, 0))
		return false;
...
BOOL func_139(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x73C9 Hash - 0x86E39CDA ^0xCF922D1
{
	!func_127(hParam0, 0);
	...
	if (func_196(hParam0, panParam2, iParam3, bParam5, false))
		return false;
...
void func_140(var uParam0, int iParam1) // Position - 0x742B Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_141(int iParam0, int iParam1) // Position - 0x743C Hash - 0xC0D8FAC3 ^0xE4233006
{
...
void func_142(int iParam0) // Position - 0x7455 Hash - 0x23AE6B73 ^0x23AE6B73
{
	int i;
	int num;
...
BOOL func_144(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x74ED Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_145(int iParam0) // Position - 0x7542 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_174(iParam0, 2);
}

int func_146(int iParam0) // Position - 0x7551 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_198(iParam0))
		return -1;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x756D Hash - 0xDD376ADC ^0x3FEE2146
{
	if (func_64() != -1)
...
BOOL func_148(int iParam0) // Position - 0x75A0 Hash - 0x3E25647A ^0x3E25647A
{
	if (func_64() != -1)
...
BOOL func_149(int iParam0) // Position - 0x75D0 Hash - 0xF83B91D5 ^0xBF549DB5
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x767C Hash - 0xECB143B0 ^0x9BF3D063
{
	return Global_1905944.f_22[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_151(int iParam0) // Position - 0x7695 Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_152() // Position - 0x76A8 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1905944.f_5694;
}

BOOL func_153(int iParam0, BOOL bParam1) // Position - 0x76B7 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_154(int iParam0) // Position - 0x76E8 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_155(int iParam0) // Position - 0x76FE Hash - 0x8EF26C67 ^0x9855652A
{
	int num;
...
BOOL func_156(int iParam0, int iParam1) // Position - 0x7769 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

Volume func_157(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x7778 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
	...
	func_201(volume, bParam8);
	return volume;
}

Vector3 func_158(int iParam0, int iParam1) // Position - 0x7832 Hash - 0xFF60DCDC ^0xFF60DCDC
{
	var unk;
	...
	{
		case 0:
			unk = { func_202(1, iParam1) };
			break;
	
		case 1:
			unk = { func_202(2, iParam1) };
			break;
	
		case 2:
			unk = { func_202(3, iParam1) };
			break;
	}
...
float func_159(int iParam0, int iParam1) // Position - 0x7882 Hash - 0xA6D14BD7 ^0xA6D14BD7
{
	float num;
	...
	{
		case 0:
			num = func_203(1, iParam1);
			break;
	
		case 1:
			num = func_203(2, iParam1);
			break;
	
		case 2:
			num = func_203(3, iParam1);
			break;
	}
...
Vector3 func_160() // Position - 0x78CA Hash - 0x1DA0618A ^0x8AE75639
{
	return func_204("ATZ_INS_EXC_CO");
}

Vector3 func_161() // Position - 0x78DA Hash - 0xFD080E93 ^0xFD080E93
{
	return func_204("ATZ_INS_FUR");
}

Vector3 func_162() // Position - 0x78E9 Hash - 0x54479E84 ^0x54479E84
{
	return func_204("ATZ_INS_KLR");
}

Vector3 func_163() // Position - 0x78F8 Hash - 0x77F9FE5D ^0x77F9FE5D
{
	return func_204("ATZ_INS_BLD");
}

Vector3 func_164() // Position - 0x7907 Hash - 0xCB393341 ^0xCB393341
{
	return func_204("ATZ_INS_BRK");
}

Vector3 func_165() // Position - 0x7916 Hash - 0xD62475FD ^0xD62475FD
{
	return func_204("ATZ_INS_TRB");
}

void func_166(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, char* sParam10) // Position - 0x7925 Hash - 0x3A05F50D ^0x6A8E2731
{
	*uParam0 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam1, fParam4, vParam7, sParam10);
	return;
}

void func_167(Volume volParam0, int iParam1) // Position - 0x7942 Hash - 0x28736565 ^0xF0314607
{
...
Vector3 func_168(int iParam0) // Position - 0x798E Hash - 0x783205AD ^0x783205AD
{
	return func_202(0, iParam0);
}

void func_169(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x799D Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
Hash func_170() // Position - 0x7A7E Hash - 0x9F572D68 ^0xECDCFA93
{
	return -734153718;
}

BOOL func_171(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7A8B Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_172(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7AB4 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_173(Ped pedParam0) // Position - 0x7AD2 Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_212(pedParam0, 4) || func_212(pedParam0, 5);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0x7AEE Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_175(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Object obParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x7B0F Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
	...
	func_177(iParam0, true);
	func_178(iParam0, true);
	func_179(iParam0, 128);
	return;
}

void func_176(int iParam0, int iParam1) // Position - 0x7DB5 Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x7DE8 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
		if (Global_1945188[iParam0 /*18*/].f_5 == 5 && !func_174(iParam0, 8))
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x7E40 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_179(int iParam0, int iParam1) // Position - 0x7E69 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
Any func_180(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7E91 Hash - 0xDFB996B4 ^0xC287A71C
{
	Any any;
...
void func_181(var uParam0) // Position - 0x7ED8 Hash - 0xC6A5F393 ^0x3F787E83
{
	int i;
...
void func_182(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F3D Hash - 0xEF5C52D ^0xEF5C52D
{
	int i;
	int num;
...
void func_183() // Position - 0x7FCB Hash - 0x1DEBFEF3 ^0x9E9672AD
{
...
void func_184(int iParam0, int iParam1, BOOL bParam2) // Position - 0x8040 Hash - 0xD61623D0 ^0x48AE56A
{
...
void func_185(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x805C Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	if (func_224(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_185(vehiclePedIsIn, vParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_185(mount, vParam1, fParam4, iParam5, iParam6);
			}
...
int func_186() // Position - 0x82DE Hash - 0x751BAE0C ^0x751BAE0C
{
	return 4;
}

int func_187(int iParam0, int iParam1, int iParam2) // Position - 0x82E7 Hash - 0xC76BC009 ^0xD35219B8
{
...
void func_188(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x838D Hash - 0x7EFAC478 ^0x4E4217E0
{
	int i;
	int j;
	int k;
...
struct<4> func_189() // Position - 0x84F4 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
Hash func_190(Hash hParam0) // Position - 0x8500 Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
int func_191(Hash hParam0) // Position - 0x852B Hash - 0xF4E671A6 ^0x338FA446
{
	Hash category;
...
BOOL func_192(BOOL bParam0) // Position - 0x855A Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_64() == -1)
		return true;
...
BOOL func_193(Hash hParam0) // Position - 0x8578 Hash - 0x1BC045DA ^0x469FDDE1
{
...
BOOL func_194(Hash hParam0) // Position - 0x8594 Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_195(Hash hParam0, Hash hParam1) // Position - 0x85A2 Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
BOOL func_196(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x85D3 Hash - 0x6FD18E8B ^0x7C3C83FA
{
	var unk;
	var unk5;
	var unk27;
...
void func_197(BOOL bParam0) // Position - 0x8718 Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_198(int iParam0) // Position - 0x8742 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_199(int iParam0) // Position - 0x8775 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_200(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x87B6 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_201(Volume volParam0, BOOL bParam1) // Position - 0x87D0 Hash - 0xEA796703 ^0x695D7925
{
	Volume volLockRequestId;
	int i;
...
Vector3 func_202(int iParam0, int iParam1) // Position - 0x8838 Hash - 0x7CA5B2D1 ^0x7CA5B2D1
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -5969.762f, -2952.0654f, -5.676f;
			
				case 1:
					return -5986.9893f, -2991.7292f, -2.5421f;
			
				case 2:
					return -5926.0835f, -2912.0818f, -9.2908f;
			
				case 3:
					return -5834.757f, -3004.4993f, 5.3048f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return -5864.64f, -3044.6648f, 1.4876f;
			
				case 1:
					return -5929.088f, -2913.8867f, -9.2588f;
			
				case 2:
					return -5900.4f, -3070.0923f, 2.917f;
			
				case 3:
					return -5978.562f, -3055.3318f, 1.1985f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return -5878.279f, -2993.1685f, -1.3802f;
			
				case 1:
					return -5923.1157f, -2955.6726f, -6.553f;
			
				case 2:
					return -5874.387f, -3020.0112f, 0.047f;
			
				case 3:
					return -5983.9624f, -2993.239f, -2.5363f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return -5927.58f, -2993.242f, -5.3246f;
			
				case 1:
					return -5928.657f, -2996.074f, -5.528f;
			
				case 2:
					return -5894.69f, -2973.8162f, -1.8362f;
			
				case 3:
					return -5944.3247f, -2964.1387f, -5.5828f;
			}
			break;
	}
...
float func_203(int iParam0, int iParam1) // Position - 0x8A3F Hash - 0xA760312B ^0xA760312B
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_204(char* sParam0) // Position - 0x8BA4 Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_205(Volume volParam0) // Position - 0x8BB6 Hash - 0x1D6344D9 ^0x1D6344D9
{
	int i;
...
int func_206(Volume volParam0) // Position - 0x8BE2 Hash - 0x67695E3A ^0xB4A144D5
{
	int i;
...
BOOL func_207(ePedType eptParam0) // Position - 0x8C17 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_208(Ped pedParam0, Hash hParam1) // Position - 0x906A Hash - 0xEA1C858E ^0xEDF5A040
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x9114 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_210(Ped pedParam0, BOOL bParam1) // Position - 0x9144 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_211(Ped pedParam0, int iParam1) // Position - 0x9189 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_212(Ped pedParam0, int iParam1) // Position - 0x91B0 Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
void func_213(Volume volParam0, BOOL bParam1) // Position - 0x91EF Hash - 0xD6642292 ^0x5A7BA218
{
	int num;
...
int func_214() // Position - 0x9212 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_215(int iParam0) // Position - 0x9221 Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

BOOL func_216(int iParam0, int iParam1) // Position - 0x9237 Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_217(int iParam0) // Position - 0x925A Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_218(int iParam0) // Position - 0x9292 Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_215(iParam0))
		return false;
...
void func_219(int iParam0) // Position - 0x92B2 Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_220(int iParam0) // Position - 0x931B Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

void func_221(int iParam0, int iParam1, BOOL bParam2) // Position - 0x932B Hash - 0x4464293B ^0x680D2F86
{
...
BOOL func_222(Ped pedParam0) // Position - 0x93B0 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_223(Ped pedParam0) // Position - 0x93E2 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_224(int iParam0, int iParam1) // Position - 0x9424 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_225() // Position - 0x9433 Hash - 0xEE877ACE ^0xCCE9C802
{
...
int func_226(Hash hParam0, Hash hParam1) // Position - 0x9454 Hash - 0x39B5DB67 ^0xD5694E3C
{
	if (hParam1 == 0)
		return 0;
...
int func_227(var uParam0) // Position - 0x946E Hash - 0xE0B16A5D ^0x1D9BDFB4
{
...
BOOL func_228(Hash hParam0) // Position - 0x94EA Hash - 0x1B551CF7 ^0xF7F1B098
{
	return func_245(hParam0) == joaat("WEAPON");
}

struct<4> func_229(BOOL bParam0) // Position - 0x94FE Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
...
BOOL func_230(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3) // Position - 0x9593 Hash - 0x4285A587 ^0x4285A587
{
	return func_234(hParam0, *uParam1, hParam2, bParam3) > 0;
}

BOOL func_231(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x95AB Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;
...
BOOL func_232(Hash hParam0, BOOL bParam1) // Position - 0x95CC Hash - 0x62864AB ^0xBC339691
{
...
BOOL func_233(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x9605 Hash - 0xDE5D4AAC ^0xDB35B0F6
{
	var unk;
	Hash hash;
	var unk6;
...
int func_234(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x9699 Hash - 0xD01EE834 ^0xC97ABD1E
{
	var guid;
	int inventoryItemCountWithGuid;
...
void func_235(BOOL bParam0, int iParam1) // Position - 0x96E1 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

void func_236(BOOL bParam0, int iParam1) // Position - 0x96F2 Hash - 0x9815F445 ^0x9815F445
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

int func_237(int iParam0) // Position - 0x9707 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
BOOL func_238(Ped pedParam0, Hash hParam1) // Position - 0x9788 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x97B6 Hash - 0xA54F3032 ^0xE5AEE97B
{
	Hash _int;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x9807 Hash - 0xA54F3032 ^0xE5AEE97B
{
	Hash _int;
	int _int2;
...
void func_241(Ped pedParam0) // Position - 0x9879 Hash - 0x446F1BDD ^0x6F6DDA4E
{
...
BOOL func_242(int iParam0) // Position - 0x9897 Hash - 0xDDC0076D ^0xDDC0076D
{
	return Global_1310750.f_16035 && iParam0 != false;
}

BOOL func_243(int iParam0) // Position - 0x98AB Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_216(iParam0, Global_1310750.f_16072 | 64);
}

void func_244(int iParam0) // Position - 0x98C3 Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
int func_245(Hash hParam0) // Position - 0x9950 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_246(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x997B Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;
...
BOOL func_247(int iParam0) // Position - 0x99C0 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_250(iParam0))
		return false;
...
struct<5> func_248(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x99DC Hash - 0xE6705E3C ^0xB9EA38F4
{
	var unk;
	var unk6;
	var unk28;
...
Hash func_249(int iParam0, int iParam1) // Position - 0x9C99 Hash - 0xE1D12727 ^0x71D656A6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_250(int iParam0) // Position - 0xBDE3 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_251(int iParam0) // Position - 0xBDF6 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
struct<4> func_252(BOOL bParam0) // Position - 0xBE20 Hash - 0x8A689EFF ^0x60C7E77C
{
	int num;
...
BOOL func_253(Hash hParam0, Hash hParam1) // Position - 0xBE84 Hash - 0x1874093C ^0x7F0FACAB
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_254(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBEE3 Hash - 0xC40FC7D1 ^0x18789FFF
{
