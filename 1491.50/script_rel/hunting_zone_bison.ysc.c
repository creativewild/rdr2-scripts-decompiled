...
BOOL func_42(var uParam0) // Position - 0x1583 Hash - 0xFA904F44 ^0x876FD909
{
	*uParam0 = 3;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = joaat("p_bisontuftsfur01x");
	uParam0->f_572[1] = joaat("p_bisonscat01x");
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = joaat("a_c_buffalo_01");
	uParam0->f_12.f_3 = 1.55f;
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = joaat("DISCOVERABLES_WHITE_BUFFALO");
	uParam0->f_674 = { 0f, 0f, 1f };
	return true;
}

BOOL func_43(var uParam0) // Position - 0x163F Hash - 0x90008B47 ^0xA0ACAD4E
{
	float num;
	var unk;
	var unk6;
...
int func_44(int iParam0) // Position - 0x1756 Hash - 0x7F390DDD ^0x7F390DDD
{
	int num;
...
void func_45(var uParam0) // Position - 0x178C Hash - 0xF060930F ^0x679498F2
{
	int i;
...
BOOL func_46(var uParam0) // Position - 0x17D6 Hash - 0x7B76A2ED ^0x317722B6
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x189B Hash - 0x43C1809B ^0xD255F79A
{
	float scaleX;
...
BOOL func_48(var uParam0) // Position - 0x18E2 Hash - 0xC25AB6F8 ^0xC25AB6F8
{
	int i;
	int j;
...
BOOL func_49(var uParam0) // Position - 0x192D Hash - 0x10BF63DF ^0x638AC662
{
	int i;
	float radius;
	var unk;
...
void func_50(var uParam0) // Position - 0x1ECD Hash - 0x85508A28 ^0x573D2B47
{
	float num;
	int num2;
	int i;
...
void func_51(var uParam0) // Position - 0x1F93 Hash - 0x46A37087 ^0x6FADEB49
{
	int i;
	int duration;
	int num;
...
void func_52(var uParam0) // Position - 0x2654 Hash - 0x271CC8B9 ^0x72DC5E80
{
	int taskSequenceId;
	float num;
...
int func_53(var uParam0, var uParam1) // Position - 0x2749 Hash - 0x3AAD93D4 ^0x6348F3E3
{
	int unk;
...
BOOL func_54(var uParam0) // Position - 0x275C Hash - 0x26561433 ^0x8D630CC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		return true;
...
var func_55(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2791 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_56(Hash hParam0, int iParam1) // Position - 0x27A8 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_57(Hash hParam0, int iParam1) // Position - 0x282E Hash - 0x96B01D2A ^0x81E68218
{
...
void func_58(Hash hParam0, int iParam1) // Position - 0x286A Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_59(Hash hParam0, int iParam1) // Position - 0x28BD Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_60(Hash hParam0, int iParam1) // Position - 0x28F8 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_61(Hash hParam0, int iParam1) // Position - 0x2931 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_62(Hash hParam0, int iParam1) // Position - 0x2969 Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_63() // Position - 0x297C Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_64() // Position - 0x299B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0) // Position - 0x29A9 Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

int func_66(int iParam0) // Position - 0x29BF Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_67(int iParam0) // Position - 0x2E13 Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_123(iParam0, 1);
}

int func_68(int iParam0) // Position - 0x2E23 Hash - 0xA776614E ^0xA776614E
{
	if (!func_65(iParam0))
		return -1;
...
BOOL func_69(int iParam0) // Position - 0x3269 Hash - 0x14DDF3C9 ^0xAD14D790
{
...
BOOL func_70(int iParam0) // Position - 0x32B2 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_125(iParam0))
		return false;
...
Vector3 func_71(int iParam0) // Position - 0x32D3 Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_65(iParam0))
		return 0f, 0f, 0f;
...
float func_72(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3AFA Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_73(int iParam0) // Position - 0x3B22 Hash - 0x23547602 ^0x23547602
{
	switch (iParam0)
	{
		case 0:
...
int func_74(int iParam0, var uParam1) // Position - 0x3C19 Hash - 0x4931B454 ^0x88362C28
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3D7A Hash - 0x49B3EF5C ^0x9505D01C
{
	var data;
	int size;
	int collectionId;
...
int func_76(Hash hParam0, int iParam1) // Position - 0x3E2D Hash - 0x3B4883DD ^0xBE4A62CA
{
	var unk;
	var guid;
...
BOOL func_77(Hash hParam0, int iParam1) // Position - 0x3E88 Hash - 0xD7B4F3C5 ^0x943C8C22
{
	var unk;
	int num;
	int num2;
...
BOOL func_78(Hash hParam0, int iParam1, int iParam2) // Position - 0x3EE6 Hash - 0xC758F57F ^0x801747D0
{
	int num;
	var unk;
	var unk6;
...
void func_79(var uParam0, int iParam1) // Position - 0x3F5D Hash - 0xF55E891F ^0xF55E891F
{
	func_140(uParam0, iParam1);
	return;
}

int func_80(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F6D Hash - 0xB04D1B6E ^0xB04D1B6E
{
	switch (hParam0)
	{
...
BOOL func_89(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x5DFF Hash - 0x7B1D1D5F ^0x7B1D1D5F
{
	...
	if (Global_1898164.f_163 && !func_150(iParam0, 1) || func_151(&func_182))
...
BOOL func_149(int iParam0) // Position - 0x75D6 Hash - 0xF83B91D5 ^0xBF549DB5
{
	...
	if (!func_150(iParam0, 65536) && !func_150(iParam0, &func_182))
		return false;
	...
	for (i = 0; i < Global_40.f_7756; i = i + 1)
	{
		if (Global_40.f_7756[i /*3*/].f_2 == iParam0)
		{
			...
			if (num < 1800 && func_150(iParam0, &func_182))
				return true;
		}
	}
...
{
	return func_204("ATZ_INS_EXC_BS");
}

Vector3 func_161() // Position - 0x78E0 Hash - 0x1DA0618A ^0xAC40CBAA
{
	return func_204("ATZ_INS_FUR_BS");
}
...
Vector3 func_165() // Position - 0x791D Hash - 0xD62475FD ^0xD62475FD
{
	return func_204("ATZ_INS_TRB");
}

void func_166(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, char* sParam10) // Position - 0x792C Hash - 0x3A05F50D ^0x6A8E2731
{
	*uParam0 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam1, fParam4, vParam7, sParam10);
	return;
}

void func_167(Volume volParam0, int iParam1) // Position - 0x7949 Hash - 0x28736565 ^0xF0314607
{
...
Vector3 func_168(int iParam0) // Position - 0x7995 Hash - 0x783205AD ^0x783205AD
{
	return func_203(0, iParam0);
}

float func_169(int iParam0, int iParam1) // Position - 0x79A4 Hash - 0x7009ECAD ^0x7009ECAD
{
	switch (iParam0)
	{
		case 0:
...
void func_170(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7AC5 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
Hash func_171() // Position - 0x7BA6 Hash - 0x9F572D68 ^0xD264AE3B
{
	return -597119687;
}

BOOL func_172(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7BB3 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_173(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7BDC Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_174(Ped pedParam0) // Position - 0x7BFA Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_212(pedParam0, 4) || func_212(pedParam0, 5);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x7C16 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_177(int iParam0, int iParam1) // Position - 0x7EDD Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x7F10 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x7F68 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_180(int iParam0, int iParam1) // Position - 0x7F91 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
Any func_181(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7FB9 Hash - 0xDFB996B4 ^0xC287A71C
{
	Any any;
...
void func_182(var uParam0) // Position - 0x8000 Hash - 0xC6A5F393 ^0x3F787E83
{
	int i;
...
void func_183(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8065 Hash - 0xEF5C52D ^0xEF5C52D
{
	int i;
	int num;
...
void func_184() // Position - 0x80F3 Hash - 0x18ACD9D3 ^0xB2ADEAB8
{
...
void func_185(int iParam0, int iParam1, BOOL bParam2) // Position - 0x8166 Hash - 0xD61623D0 ^0x48AE56A
{
...
void func_186(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x8182 Hash - 0xF46E0F16 ^0xED4BA72A
{
...
int func_187() // Position - 0x8404 Hash - 0xDF9E118A ^0xDF9E118A
{
	return 3;
}

int func_188(int iParam0, int iParam1, int iParam2) // Position - 0x840D Hash - 0xC76BC009 ^0xD35219B8
{
...
void func_189(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x84B3 Hash - 0x7EFAC478 ^0x4E4217E0
{
	int i;
	int j;
	int k;
...
struct<4> func_190() // Position - 0x861A Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
Hash func_191(Hash hParam0) // Position - 0x8626 Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
int func_192(Hash hParam0) // Position - 0x8651 Hash - 0xF4E671A6 ^0x338FA446
{
	Hash category;
...
BOOL func_193(BOOL bParam0) // Position - 0x8680 Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_64() == -1)
		return true;
...
BOOL func_194(Hash hParam0) // Position - 0x869E Hash - 0x1BC045DA ^0x469FDDE1
{
...
BOOL func_195(Hash hParam0) // Position - 0x86BA Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_196(Hash hParam0, Hash hParam1) // Position - 0x86C8 Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
BOOL func_197(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x86F9 Hash - 0x6FD18E8B ^0x7C3C83FA
{
	var unk;
	var unk5;
	var unk27;
...
void func_198(BOOL bParam0) // Position - 0x883E Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_199(int iParam0) // Position - 0x8868 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_200(int iParam0) // Position - 0x889B Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_201(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x88DC Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_202(Volume volParam0, BOOL bParam1) // Position - 0x88F6 Hash - 0xEA796703 ^0x695D7925
{
	Volume volLockRequestId;
	int i;
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0x895E Hash - 0x24E72BF3 ^0x24E72BF3
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -1904.6345f, 1743.7946f, 237.12f;
			
				case 1:
					return -1843.005f, 1810.343f, 234.7091f;
			
				case 2:
					return -1685.485f, 1749.6826f, 238.5458f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return -1784.1165f, 1758.2552f, 234.5248f;
			
				case 1:
					return -1795.7518f, 1672.4171f, 234.2808f;
			
				case 2:
					return -1814.9285f, 1779.9668f, 234.7679f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return -1782.7191f, 1705.6078f, 238.4491f;
			
				case 1:
					return -1803.5504f, 1709.5767f, 236.2907f;
			
				case 2:
					return -1773.5204f, 1768.7457f, 239.968f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return -1820.1111f, 1660.4512f, 235.5432f;
			
				case 1:
					return -1776.9963f, 1762.6228f, 237.2977f;
			
				case 2:
					return -1743.5287f, 1753.7786f, 234.3225f;
			}
			break;
	}
...
Vector3 func_204(char* sParam0) // Position - 0x8AF9 Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_205(Volume volParam0) // Position - 0x8B0B Hash - 0x1D6344D9 ^0x1D6344D9
{
	int i;
...
int func_206(Volume volParam0) // Position - 0x8B37 Hash - 0x67695E3A ^0xB4A144D5
{
	int i;
...
BOOL func_207(ePedType eptParam0) // Position - 0x8B6C Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_208(Ped pedParam0, Hash hParam1) // Position - 0x8FBF Hash - 0xEA1C858E ^0x58220AFF
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x9069 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_210(Ped pedParam0, BOOL bParam1) // Position - 0x9099 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_211(Ped pedParam0, int iParam1) // Position - 0x90DE Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_212(Ped pedParam0, int iParam1) // Position - 0x9105 Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
void func_213(Volume volParam0, BOOL bParam1) // Position - 0x9144 Hash - 0xD6642292 ^0x5A7BA218
{
	int num;
...
int func_214() // Position - 0x9167 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_215(int iParam0) // Position - 0x9176 Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

BOOL func_216(int iParam0, int iParam1) // Position - 0x918C Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_217(int iParam0) // Position - 0x91AF Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_218(int iParam0) // Position - 0x91E7 Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_215(iParam0))
		return false;
...
void func_219(int iParam0) // Position - 0x9207 Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_220(int iParam0) // Position - 0x9270 Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

void func_221(int iParam0, int iParam1, BOOL bParam2) // Position - 0x9280 Hash - 0x4464293B ^0x680D2F86
{
...
BOOL func_222(Ped pedParam0) // Position - 0x9305 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_223(Ped pedParam0) // Position - 0x9337 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_224(int iParam0, int iParam1) // Position - 0x9379 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_225() // Position - 0x9388 Hash - 0xEE877ACE ^0xCCE9C802
{
...
int func_226(Hash hParam0, Hash hParam1) // Position - 0x93A9 Hash - 0x39B5DB67 ^0xD5694E3C
{
	if (hParam1 == 0)
		return 0;
...
int func_227(var uParam0) // Position - 0x93C3 Hash - 0xE0B16A5D ^0x1D9BDFB4
{
...
BOOL func_228(Hash hParam0) // Position - 0x943F Hash - 0x1B551CF7 ^0xF7F1B098
{
	return func_245(hParam0) == joaat("WEAPON");
}

struct<4> func_229(BOOL bParam0) // Position - 0x9453 Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
...
BOOL func_230(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3) // Position - 0x94E8 Hash - 0x4285A587 ^0x4285A587
{
	return func_234(hParam0, *uParam1, hParam2, bParam3) > 0;
}

BOOL func_231(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x9500 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;
...
BOOL func_232(Hash hParam0, BOOL bParam1) // Position - 0x9521 Hash - 0x62864AB ^0xBC339691
{
...
BOOL func_233(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x955A Hash - 0xDE5D4AAC ^0xDB35B0F6
{
	var unk;
	Hash hash;
	var unk6;
...
int func_234(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x95EE Hash - 0xD01EE834 ^0xC97ABD1E
{
	var guid;
	int inventoryItemCountWithGuid;
...
void func_235(BOOL bParam0, int iParam1) // Position - 0x9636 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

void func_236(BOOL bParam0, int iParam1) // Position - 0x9647 Hash - 0x9815F445 ^0x9815F445
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

int func_237(int iParam0) // Position - 0x965C Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
BOOL func_238(Ped pedParam0, Hash hParam1) // Position - 0x96DD Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x970B Hash - 0xA54F3032 ^0x7A2EF519
{
	Hash _int;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x975C Hash - 0xA54F3032 ^0x7A2EF519
{
	Hash _int;
	int _int2;
...
void func_241(Ped pedParam0) // Position - 0x97CE Hash - 0x446F1BDD ^0x32F3DED3
{
...
BOOL func_242(int iParam0) // Position - 0x97EC Hash - 0xDDC0076D ^0xDDC0076D
{
	return Global_1310750.f_16035 && iParam0 != false;
}

BOOL func_243(int iParam0) // Position - 0x9800 Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_216(iParam0, Global_1310750.f_16072 | 64);
}

void func_244(int iParam0) // Position - 0x9818 Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
int func_245(Hash hParam0) // Position - 0x98A5 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_246(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x98D0 Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;
...
BOOL func_247(int iParam0) // Position - 0x9915 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_250(iParam0))
		return false;
...
struct<5> func_248(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9931 Hash - 0xE6705E3C ^0xB9EA38F4
{
	var unk;
	var unk6;
	var unk28;
...
Hash func_249(int iParam0, int iParam1) // Position - 0x9BEE Hash - 0xE1D12727 ^0x71D656A6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_250(int iParam0) // Position - 0xBD38 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_251(int iParam0) // Position - 0xBD4B Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
struct<4> func_252(BOOL bParam0) // Position - 0xBD75 Hash - 0x8A689EFF ^0x60C7E77C
{
	int num;
...
BOOL func_253(Hash hParam0, Hash hParam1) // Position - 0xBDD9 Hash - 0x1874093C ^0x7F0FACAB
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_254(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBE38 Hash - 0xC40FC7D1 ^0x18789FFF
{
