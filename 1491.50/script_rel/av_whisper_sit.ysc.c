...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0x9DCC501B
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x1B12E527 ^0x1B12E527
{
	int num;
	int num2;
	...
	{
		case 31:
			func_46(uParam0, "WHISPER_SIT", "script@ambient@town@WHISPER@SIT@action", uParam1, uParam4);
			break;
	
		case 32:
			func_46(uParam0, "WHISPER_STAND", "script@ambient@town@whisper@stand@action", uParam1, uParam4);
			uParam0->f_16 = 1;
			break;
	}
	...
	switch (uParam0->f_489)
	{
		case 0:
			num = func_48(func_47());
			num2 = func_48(func_47());
			break;
	
		case 1:
			num = joaat("a_m_m_sddockforeman_01");
			num2 = joaat("a_m_m_sddockworkers_02");
			break;
	}

	func_49(uParam0, 1, "pbl_action", "", 0);
	func_50(uParam0, 0, "MALE_A", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "MALE_B", num2, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C89 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D29 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
BOOL func_17(var uParam0) // Position - 0x1E43 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
BOOL func_18(var uParam0) // Position - 0x200C Hash - 0xE99426E ^0x9FB386A5
{
	if (*uParam0 == 31)
		return func_51(joaat("prop_camp_fire_seat_chair"));

	return true;
}

BOOL func_19(var uParam0) // Position - 0x2029 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21D9 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x224D Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x229C Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22F4 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x245D Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x2784 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28BB Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29EB Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A2A Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A33 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A65 Hash - 0x3DAD17EA ^0x34338E47
{
	if (*uParam0 == 31)
		func_59(joaat("prop_camp_fire_seat_chair"), 1, 0, joaat("prop_camp_fire_seat_chair_male_c"));
...
int func_31(var uParam0) // Position - 0x2ABF Hash - 0x6D80AAE ^0x6D80AAE
{
	...
	if (!uParam0->f_469[2])
	{
		if (func_71(uParam0, 1065353216, 60f, 4, 40f, 1112014848))
		{
			func_69(uParam0);
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[7])
		{
			if (func_72(uParam0, 1.1f, 1116471296, 4, joaat("Action"), true))
			{
				func_70(*uParam0, uParam0->f_483, false);
				uParam0->f_469[7] = 1;
			}
	...
	if (uParam0->f_469[2])
	{
		...
		if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
		{
			...
			if (*uParam0 == 32)
			{
				TASK::TASK_WALK_AWAY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/]);
			}
			else
			{
				func_73(uParam0->f_20[1 /*14*/], joaat("prop_camp_fire_seat_chair"), 60000, false, joaat("prop_camp_fire_seat_chair_male_c"), -1082130432);
...
int func_32(var uParam0, var uParam1) // Position - 0x2CF8 Hash - 0x9F0EDB6F ^0x9F0EDB6F
{
	func_74(uParam0, true, false, false);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D0A Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D27 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2E63 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x2F9C Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3046 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x30BE Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x314D Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3268 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3274 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x33FC Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x349C Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x34AF Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x34C9 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3531 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x355D Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

int func_48(int iParam0) // Position - 0x356B Hash - 0xA6D0F253 ^0xBA6871A0
{
	int num;
...
void func_49(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x35E4 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_50(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3615 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_51(Hash hParam0) // Position - 0x36A3 Hash - 0xF47DA3FB ^0x3523541A
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(hParam0, false);
}

BOOL func_52(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x36B2 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_53(int iParam0) // Position - 0x38B6 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_54(int iParam0, int iParam1) // Position - 0x38CA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_55() // Position - 0x38D9 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_47() != -1;
}

BOOL func_56(var uParam0, Any* panParam1) // Position - 0x38F4 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_57(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3953 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_58(Ped pedParam0) // Position - 0x3995 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
int func_59(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x39C1 Hash - 0x4C6F92F6 ^0x312B6988
{
	return STREAMING::_REQUEST_SCENARIO_TYPE(hParam0, iParam1, iParam2, iParam3);
}

void func_60(int iParam0, BOOL bParam1) // Position - 0x39D5 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3A51 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3A75 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3A9B Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3ABD Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3ADF Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3B01 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_67(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3B25 Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_68(var uParam0) // Position - 0x3B7F Hash - 0x6D8164E6 ^0x4B2A3211
{
	int i;
...
void func_69(var uParam0) // Position - 0x3BED Hash - 0xCCDA6E04 ^0xCCDA6E04
{
	if (!uParam0->f_469[6])
	{
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3C12 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_71(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3D16 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_72(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3F21 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;
...
void func_73(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x404A Hash - 0x5050B938 ^0x5BDC33E5
{
	TASK::TASK_START_SCENARIO_IN_PLACE_HASH(pedParam0, hParam1, iParam2, bParam3, hParam4, iParam5, false);
	return;
}

void func_74(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4063 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
float func_75(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x41B7 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x421E Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4247 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_78(var uParam0, var uParam1, var uParam2) // Position - 0x4293 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_79(int iParam0) // Position - 0x42E2 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_80(int iParam0) // Position - 0x4307 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_81(int iParam0) // Position - 0x431A Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_82(int iParam0) // Position - 0x432D Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_83(int iParam0) // Position - 0x4340 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_84(int iParam0) // Position - 0x4352 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_85(int iParam0, int iParam1) // Position - 0x4364 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x43FE Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_87() // Position - 0x4436 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_88(int iParam0) // Position - 0x4489 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_91(iParam0))
		return -1;
...
BOOL func_89(int iParam0) // Position - 0x44A9 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_90(int iParam0, int iParam1) // Position - 0x44BF Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_91(int iParam0) // Position - 0x44CE Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_92(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4501 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x45E2 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_100(iParam0, 4);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4600 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_100(iParam0, 8);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4620 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_100(iParam0, 16);
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x464B Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_100(iParam0, 32);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x466B Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_100(iParam0, 64);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x468B Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x46AD Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_100(int iParam0, int iParam1) // Position - 0x46D1 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_101(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x46E2 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4D0B Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_103(int iParam0) // Position - 0x4DE2 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_104(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4E63 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_105(Ped pedParam0) // Position - 0x4F54 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_106(Ped pedParam0) // Position - 0x4F6F Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_107(int iParam0) // Position - 0x4F8B Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_108(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4FD2 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_109(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4FF0 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_110(var uParam0) // Position - 0x5047 Hash - 0x5001E582 ^0x5001E582
{
	return func_166(*uParam0, 1);
}

void func_111(var uParam0) // Position - 0x5057 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_167(uParam0, 0f);
	return;
}

BOOL func_112(var uParam0, int iParam1) // Position - 0x5066 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_113(var uParam0) // Position - 0x5084 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_114(var uParam0, BOOL bParam1) // Position - 0x509A Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_115(var uParam0) // Position - 0x50BA Hash - 0x39705408 ^0x39705408
{
	return func_166(*uParam0, 2);
}

void func_116(var uParam0) // Position - 0x50CA Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_110(uParam0);
...
BOOL func_117(var uParam0, float fParam1) // Position - 0x50FE Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_110(uParam0))
		return false;
...
void func_118(var uParam0) // Position - 0x5125 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_110(uParam0);
...
BOOL func_119(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5155 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_120(BOOL bParam0, var uParam1, var uParam2) // Position - 0x51AA Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_121(int iParam0, int iParam1) // Position - 0x51C1 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_122(int iParam0, int iParam1) // Position - 0x5247 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_123(int iParam0, int iParam1) // Position - 0x5283 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_124(int iParam0, int iParam1) // Position - 0x52D6 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_125(int iParam0, int iParam1) // Position - 0x5311 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_126(int iParam0, int iParam1) // Position - 0x534A Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_127(int iParam0) // Position - 0x5382 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_128(BOOL bParam0) // Position - 0x53C0 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_129(ePedType eptParam0) // Position - 0x53D3 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_130(Ped pedParam0, Hash hParam1) // Position - 0x5826 Hash - 0xD4D6440A ^0x6C318FAF
{
...
void func_131(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x58CD Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_132(Ped pedParam0, BOOL bParam1) // Position - 0x58FD Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_133(Ped pedParam0, int iParam1) // Position - 0x5942 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_134(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5969 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_176(iParam2);
...
BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5B34 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_136(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5C0B Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5C48 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_138(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5D2F Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x5E05 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_140(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5F0E Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_141(int iParam0, int iParam1) // Position - 0x6043 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x607A Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6181 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x61EC Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x6334 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_146(var uParam0, int iParam1) // Position - 0x6510 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x6588 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_148(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x65B7 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_149(int iParam0, Ped pedParam1) // Position - 0x673D Hash - 0x65886798 ^0xB8428DC3
{
	int _int;
...
BOOL func_150(int iParam0, Ped pedParam1) // Position - 0x678A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_203(iParam0))
		return true;
...
BOOL func_151(Ped pedParam0, Ped pedParam1) // Position - 0x6827 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_152() // Position - 0x6874 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x687C Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_154() // Position - 0x693D Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_155() // Position - 0x695B Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x69A8 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_157(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6AC4 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_158(Ped pedParam0, int iParam1) // Position - 0x6B0C Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6D65 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_213(0))
		return false;
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x6D9E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_161(var uParam0, int iParam1) // Position - 0x6DCD Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x6DE1 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_163(int iParam0, Ped pedParam1) // Position - 0x6E2E Hash - 0x90A80412 ^0xF609012B
{
...
void func_164(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6E81 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_165(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6F0D Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x6F2B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_167(var uParam0, float fParam1) // Position - 0x6F3A Hash - 0x30433BAB ^0xF854D531
{
...
float func_168() // Position - 0x6F60 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_169(var uParam0, int iParam1) // Position - 0x6F92 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_170(var uParam0) // Position - 0x6FA7 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_110(uParam0))
		return uParam0->f_1;
...
void func_171(var uParam0, int iParam1) // Position - 0x6FDC Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x6FED Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x701B Hash - 0xC579DDA4 ^0x8F0CF194
{
	Hash _int;
...
BOOL func_174(Ped pedParam0, Hash hParam1) // Position - 0x706B Hash - 0xC579DDA4 ^0x8F0CF194
{
	Hash _int;
	int _int2;
...
void func_175(Ped pedParam0) // Position - 0x70DB Hash - 0x82853334 ^0xDE51FAF6
{
...
void func_176(int iParam0) // Position - 0x70F8 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_177(int iParam0) // Position - 0x7264 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_178(BOOL bParam0) // Position - 0x7277 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_179(int iParam0) // Position - 0x7291 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_180(int iParam0) // Position - 0x732B Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_181(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7352 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_182(Ped pedParam0, Ped pedParam1) // Position - 0x744B Hash - 0xF9959663 ^0xF9959663
{
	return func_204(pedParam0, pedParam1, true, true);
}

float func_183(int iParam0) // Position - 0x745D Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_184(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7469 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_185(int iParam0, BOOL bParam1) // Position - 0x74CE Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_186() // Position - 0x74F4 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_187(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7508 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_188(int iParam0) // Position - 0x7668 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_189(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7674 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_190(int iParam0) // Position - 0x76D5 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_191(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x76E1 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_192(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x77A3 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_193(int iParam0) // Position - 0x7841 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_194(int iParam0) // Position - 0x784D Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_195(int iParam0) // Position - 0x7859 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_196(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7996 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_197(Ped pedParam0) // Position - 0x79D9 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A3F Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A86 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_200(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7AD1 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_201(Ped pedParam0, var uParam1) // Position - 0x7B4A Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_202(Ped pedParam0, Ped pedParam1) // Position - 0x7B97 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_203(int iParam0) // Position - 0x7BDF Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_204(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7BEF Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_205(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7C37 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7C63 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_207(int iParam0) // Position - 0x7C8B Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_208(Ped pedParam0) // Position - 0x7C97 Hash - 0x96A64BA9 ^0x4C9507E2
{
...
int func_209(Ped pedParam0) // Position - 0x7CEB Hash - 0xC9319FCC ^0x2C047795
{
...
BOOL func_210(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7D57 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_211(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7EC7 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_212(int iParam0, Ped pedParam1) // Position - 0x7FB5 Hash - 0x27FC2906 ^0xE9CF7148
{
...
BOOL func_213(int iParam0) // Position - 0x8038 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_230())
		return false;
...
int func_214(int iParam0) // Position - 0x805A Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_215(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8066 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_216(int iParam0) // Position - 0x80E1 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_217() // Position - 0x80F4 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_218() // Position - 0x8102 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_232())
		return false;
...
void func_219(Any* panParam0, int iParam1) // Position - 0x8158 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_220(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8200 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_221(int iParam0) // Position - 0x82C7 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_222(int iParam0) // Position - 0x836F Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_223(Ped pedParam0, int iParam1) // Position - 0x83D4 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_224(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x83EB Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_225(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8419 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_226(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8463 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_227(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x84A4 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_228(Ped pedParam0) // Position - 0x851D Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_229(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8605 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_230() // Position - 0x8647 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_217() != -1)
		return false;
...
BOOL func_231(int iParam0, BOOL bParam1) // Position - 0x866C Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_232() // Position - 0x869D Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_233(int iParam0) // Position - 0x86CE Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_91(iParam0))
		return -1;
...
int func_234(int iParam0) // Position - 0x86EA Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_235(int iParam0) // Position - 0x872B Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
