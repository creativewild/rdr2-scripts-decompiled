...
void main() // Position - 0x0 Hash - 0xCF1A36A2 ^0xCDDDF7FA
{
	var unk;
	BOOL flag;
	...
	iLocal_10 = joaat("a_c_snakewater_01");
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
	unk.f_20 = 25;
...
void func_4(var uParam0) // Position - 0x9D2 Hash - 0x4DA9BC8C ^0xF6D88564
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC6 Hash - 0x7D066955 ^0x7D066955
{
	func_46(uParam0, "EAGLE_CATCH_SEASNAKE", "script@ambient@animal@EAGLE_CATCH_SEASNAKE@action", uParam1, uParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 1, "SNAKE", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}
...
int func_31(var uParam0) // Position - 0x2A11 Hash - 0x17BF70A1 ^0x17BF70A1
{
	char* animDict;
	char* animName;
	char* animName2;
	...
	animDict = "script_amb@animal@EAGLE_CATCH_SEASNAKE";
	animName = "eagle_exit_a";
	animName2 = "snake_exit_a";
	vector = { 0f, 0f, 0f };
	vector2 = { 0f, 0f, 0f };
	...
	if (!uParam0->f_469[0])
	{
		...
		if (func_60(uParam0, &uLocal_11, false) || func_61(uParam0->f_20[0 /*14*/], Global_35, true) < 225f)
		{
			if (!func_62(&uLocal_39))
				func_63(&uLocal_39);
			...
			if (!uParam0->f_469[6])
			{
				func_65(*uParam0, uParam0->f_483, true);
				uParam0->f_469[6] = 1;
			}
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_70(uParam0, 1065353216, 1116471296, 4, joaat("Action"), true))
				{
					func_65(*uParam0, uParam0->f_483, true);
					uParam0->f_469[6] = 1;
				}
...
int func_32(var uParam0, BOOL bParam1) // Position - 0x2DF7 Hash - 0xFBD382D6 ^0xDE753D8A
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	if (uParam0->f_469[4] && !uParam0->f_469[5])
	{
		if (!flag || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uParam0->f_20[1 /*14*/], false, false), 0.5f, true, true))
		{
			...
			if (flag2)
				func_72(uParam0->f_20[1 /*14*/], false, false);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2EFF Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2F1C Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3058 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3191 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x323B Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x32B3 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3342 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x345D Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3469 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35F1 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3691 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x36A4 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x36BE Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3726 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3752 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3783 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3811 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x3A15 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x3A29 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x3A38 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_74() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3A53 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3AB2 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x3AF4 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x3B20 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3B9C Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3BBE Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3BE0 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
BOOL func_60(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C04 Hash - 0xD3438796 ^0xAD2A1935
{
...
float func_61(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3C5E Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_102(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_62(var uParam0) // Position - 0x3CB5 Hash - 0x5001E582 ^0x5001E582
{
	return func_103(*uParam0, 1);
}

void func_63(var uParam0) // Position - 0x3CC5 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_104(uParam0, 0f);
	return;
}

void func_64(var uParam0) // Position - 0x3CD4 Hash - 0x5F88D024 ^0x5F88D024
{
	if (!uParam0->f_469[7])
	{
...
void func_65(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3CF9 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_66(var uParam0) // Position - 0x3DFD Hash - 0x3B3F3300 ^0xF68D7450
{
	int taskSequenceId;
...
void func_67(var uParam0) // Position - 0x3E5F Hash - 0x5C40EAAE ^0x70D99A5
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], 1508352418))
		{
...
BOOL func_68(var uParam0, int iParam1) // Position - 0x3EDA Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_62(uParam0))
		return false;
...
BOOL func_69(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x3F01 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_62(&(uParam0->f_490)))
							func_63(&(uParam0->f_490));
...
BOOL func_70(var uParam0, int iParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x410C Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_111(iParam2);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				if (!bParam5 || ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[i /*14*/], hParam4))
				{
					if (func_61(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						...
						if (func_68(&(uParam0->f_490), iParam1))
							return true;
						else
							return false;
					}
		...
		if (func_62(&(uParam0->f_490)) && !func_116(&(uParam0->f_490)))
...
void func_71(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4235 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_72(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x425D Hash - 0xC26AC0FE ^0xFF80BBA5
{
...
void func_73(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4299 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_74() // Position - 0x43ED Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_75(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x43FB Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4462 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_77(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x448B Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_78(var uParam0, var uParam1, var uParam2) // Position - 0x44D7 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_79(int iParam0) // Position - 0x4526 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_80(int iParam0) // Position - 0x454B Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_81(int iParam0) // Position - 0x455E Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_82(int iParam0) // Position - 0x4571 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_83(int iParam0) // Position - 0x4584 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_84(int iParam0) // Position - 0x4596 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_85(int iParam0, int iParam1) // Position - 0x45A8 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4642 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_87() // Position - 0x467A Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_88(int iParam0) // Position - 0x46CD Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_91(iParam0))
		return -1;
...
BOOL func_89(int iParam0) // Position - 0x46ED Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_90(int iParam0, int iParam1) // Position - 0x4703 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_91(int iParam0) // Position - 0x4712 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_92(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4745 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_93(int iParam0, BOOL bParam1) // Position - 0x4826 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_100(iParam0, 4);
	else
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x4844 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_100(iParam0, 8);
	else
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4864 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_100(iParam0, 16);
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x488F Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_100(iParam0, 32);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x48AF Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_100(iParam0, 64);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x48CF Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x48F1 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_100(int iParam0, int iParam1) // Position - 0x4915 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_101(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4926 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
float func_102(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4F4F Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_103(int iParam0, int iParam1) // Position - 0x4F6D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_104(var uParam0, float fParam1) // Position - 0x4F7C Hash - 0x30433BAB ^0xF854D531
{
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x4FA2 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_106(int iParam0) // Position - 0x5079 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
...
void func_107(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x50FA Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_108(var uParam0) // Position - 0x51EB Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_62(uParam0))
		return uParam0->f_1;
...
BOOL func_109(Ped pedParam0) // Position - 0x5220 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_110(Ped pedParam0) // Position - 0x523B Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_111(int iParam0) // Position - 0x5257 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_112(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x529E Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_113(var uParam0, float fParam1) // Position - 0x52BC Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_114(var uParam0) // Position - 0x52DA Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_115(var uParam0, BOOL bParam1) // Position - 0x52F0 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_116(var uParam0) // Position - 0x5310 Hash - 0x39705408 ^0x39705408
{
	return func_103(*uParam0, 2);
}

void func_117(var uParam0) // Position - 0x5320 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_62(uParam0);
...
void func_118(var uParam0) // Position - 0x5354 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_62(uParam0);
...
BOOL func_119(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5384 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_120(BOOL bParam0, var uParam1, var uParam2) // Position - 0x53D9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_121(int iParam0, int iParam1) // Position - 0x53F0 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_122(int iParam0, int iParam1) // Position - 0x5476 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_123(int iParam0, int iParam1) // Position - 0x54B2 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_124(int iParam0, int iParam1) // Position - 0x5505 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_125(int iParam0, int iParam1) // Position - 0x5540 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_126(int iParam0, int iParam1) // Position - 0x5579 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_127(int iParam0) // Position - 0x55B1 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_128(BOOL bParam0) // Position - 0x55EF Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_129(ePedType eptParam0) // Position - 0x5602 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_130(Ped pedParam0, Hash hParam1) // Position - 0x5A55 Hash - 0xD6034EBF ^0x3BF6DF3
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_131(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5AFC Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_132(Ped pedParam0, BOOL bParam1) // Position - 0x5B2C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_133(Ped pedParam0, int iParam1) // Position - 0x5B71 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_134(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5B98 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_172(iParam2);
...
BOOL func_135(Ped pedParam0, int iParam1) // Position - 0x5D63 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_136(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5E3A Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_137(Ped pedParam0, int iParam1) // Position - 0x5E77 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_138(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5F5E Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_139(Ped pedParam0, int iParam1) // Position - 0x6034 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_140(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x613D Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_141(int iParam0, int iParam1) // Position - 0x6272 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x62A9 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x63B0 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_144(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x641B Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_145(Ped pedParam0, int iParam1) // Position - 0x6563 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_146(var uParam0, int iParam1) // Position - 0x6742 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x67BA Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_148(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x67E9 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_149(int iParam0, Ped pedParam1) // Position - 0x696F Hash - 0x42A83B1F ^0x28160B12
{
	int _int;
...
BOOL func_150(int iParam0, Ped pedParam1) // Position - 0x69BF Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_199(iParam0))
		return true;
...
BOOL func_151(Ped pedParam0, Ped pedParam1) // Position - 0x6A5C Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_152() // Position - 0x6AA9 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x6AB1 Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_154() // Position - 0x6B72 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_155() // Position - 0x6B90 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6BDD Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_157(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6CF9 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_158(Ped pedParam0, int iParam1) // Position - 0x6D41 Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_159(Ped pedParam0, int iParam1) // Position - 0x6F9A Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_209(0))
		return false;
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x6FD3 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_161(var uParam0, int iParam1) // Position - 0x7002 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x7016 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_163(int iParam0, Ped pedParam1) // Position - 0x7063 Hash - 0x74FF7121 ^0x61F1D8B3
{
...
float func_164() // Position - 0x70B6 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_165(var uParam0, int iParam1) // Position - 0x70E8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_166(var uParam0, int iParam1) // Position - 0x70F9 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_167(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x710E Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_168(Ped pedParam0, Hash hParam1) // Position - 0x719A Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_169(Ped pedParam0, Hash hParam1) // Position - 0x71C8 Hash - 0x772969C4 ^0x68DFE668
{
	Hash _int;
...
BOOL func_170(Ped pedParam0, Hash hParam1) // Position - 0x7218 Hash - 0x772969C4 ^0x68DFE668
{
	Hash _int;
	int _int2;
...
void func_171(Ped pedParam0) // Position - 0x7288 Hash - 0x75D3C2FB ^0xE5312FFC
{
...
void func_172(int iParam0) // Position - 0x72A5 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_173(int iParam0) // Position - 0x7411 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_174(BOOL bParam0) // Position - 0x7424 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_175(int iParam0) // Position - 0x743E Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_176(int iParam0) // Position - 0x74D8 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_177(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x74FF Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_178(Ped pedParam0, Ped pedParam1) // Position - 0x75F8 Hash - 0xF9959663 ^0xF9959663
{
	return func_200(pedParam0, pedParam1, true, true);
}

float func_179(int iParam0) // Position - 0x760A Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_180(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7616 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_181(int iParam0, BOOL bParam1) // Position - 0x767B Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_182() // Position - 0x76A1 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_183(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x76B5 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_184(int iParam0) // Position - 0x7815 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_185(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7821 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_186(int iParam0) // Position - 0x7882 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_187(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x788E Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_188(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7950 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_189(int iParam0) // Position - 0x79EE Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_190(int iParam0) // Position - 0x79FA Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_191(int iParam0) // Position - 0x7A06 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_192(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7B43 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_193(Ped pedParam0) // Position - 0x7B86 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_194(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7BEC Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_195(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7C33 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_196(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7C7E Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_197(Ped pedParam0, var uParam1) // Position - 0x7CF7 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_198(Ped pedParam0, Ped pedParam1) // Position - 0x7D44 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_199(int iParam0) // Position - 0x7D8C Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_200(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7D9C Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_201(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7DE4 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7E10 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_203(int iParam0) // Position - 0x7E38 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_204(Ped pedParam0) // Position - 0x7E44 Hash - 0xEB445B10 ^0xEF1E5BDA
{
...
int func_205(Ped pedParam0) // Position - 0x7E9C Hash - 0x8D697DD9 ^0x58D4DB26
{
...
BOOL func_206(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7F0A Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_207(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x807B Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_208(int iParam0, Ped pedParam1) // Position - 0x8169 Hash - 0x27FC2906 ^0x55B9FBF9
{
...
BOOL func_209(int iParam0) // Position - 0x81DF Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_226())
		return false;
...
int func_210(int iParam0) // Position - 0x8201 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_211(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x820D Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_212(int iParam0) // Position - 0x8288 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_213() // Position - 0x829B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_214() // Position - 0x82A9 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_228())
		return false;
...
void func_215(Any* panParam0, int iParam1) // Position - 0x82FF Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_216(BOOL bParam0, var uParam1, var uParam2) // Position - 0x83A8 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_217(int iParam0) // Position - 0x846F Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_218(int iParam0) // Position - 0x8517 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_219(Ped pedParam0, int iParam1) // Position - 0x857C Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_220(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8593 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_221(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x85C1 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_222(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x860B Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_223(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x864C Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_224(Ped pedParam0) // Position - 0x86C5 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_225(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x87AD Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_226() // Position - 0x87EF Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_213() != -1)
		return false;
...
BOOL func_227(int iParam0, BOOL bParam1) // Position - 0x8814 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_228() // Position - 0x8845 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_229(int iParam0) // Position - 0x8876 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_91(iParam0))
		return -1;
...
int func_230(int iParam0) // Position - 0x8892 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_231(int iParam0) // Position - 0x88D3 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
