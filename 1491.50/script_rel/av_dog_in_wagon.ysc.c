...
void func_4(var uParam0) // Position - 0x9C4 Hash - 0x4DA9BC8C ^0xE91A2064
{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BB8 Hash - 0x1972D06C ^0x1972D06C
{
	int num;

	func_46(uParam0, "DOG_IN_WAGON", "", vParam1, uParam4);
	num = func_48(func_47());
	func_49(uParam0, 0, "DIWP_MAN", num, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -3f, -2f, 0f), 94f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "DIWP_DOG", joaat("a_c_dogbluetickcoonhound_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -5f, -2f, 0f), -85f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 2, "DIWP_HORSE_1", 0, vParam1, uParam4.f_2, 0, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 3, "DIWP_HORSE_2", 0, vParam1, uParam4.f_2, 0, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, "WAGON", joaat("wagon02x"), vParam1, uParam4.f_2, 0, 0, 0, 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1CA3 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1D43 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E5D Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2026 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x202F Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x21DF Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2253 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22A2 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22FA Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2463 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x278A Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28C1 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29F1 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A30 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A39 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A6B Hash - 0xFB958CDA ^0xFB958CDA
{
...
int func_31(var uParam0) // Position - 0x2AAC Hash - 0x66056571 ^0x66056571
{
	BOOL flag;
	BOOL flag2;
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				func_68(&(uParam0->f_20[0 /*14*/].f_5), 50, 10, false);
				func_69(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 2, 1073741824);
				func_70(uParam0->f_20[0 /*14*/], joaat("world_human_crouch_inspect"), 0, false, 0, -1082130432);
				func_71(&uParam0->f_20[0 /*14*/], false, true);
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_68(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, false);
				func_69(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, 1073741824);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 297, true);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 130, false);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 262, true);
				func_70(uParam0->f_20[1 /*14*/], joaat("world_animal_dog_sitting"), 0, false, 0, -1082130432);
				func_71(&uParam0->f_20[1 /*14*/], false, true);
			}
		...
		case 1:
			...
			{
				func_67(uParam0);
				TASK::TASK_ENTER_VEHICLE(uParam0->f_20[1 /*14*/], uParam0->f_453, -1, 3, 1f, 1, 0);
				TASK::TASK_ENTER_VEHICLE(uParam0->f_20[0 /*14*/], uParam0->f_453, -1, -1, 1f, 131072, 0);
		...
		case 2:
			flag = func_73(uParam0->f_20[0 /*14*/], uParam0->f_453, false);
			flag2 = func_73(uParam0->f_20[1 /*14*/], uParam0->f_453, false);
			...
			{
				if (!flag2)
					if (!func_75(uParam0->f_20[1 /*14*/], SCRIPT_TASK_ENTER_VEHICLE))
						TASK::TASK_ENTER_VEHICLE(uParam0->f_20[1 /*14*/], uParam0->f_453, -1, 3, 1f, 1, 0);
			
				if (!flag)
					if (!func_75(uParam0->f_20[0 /*14*/], SCRIPT_TASK_ENTER_VEHICLE))
						TASK::TASK_ENTER_VEHICLE(uParam0->f_20[0 /*14*/], uParam0->f_453, -1, -1, 1f, 131072, 0);
			}
			break;
	
		case 3:
			if (func_76(&uLocal_38, 6f))
			{
...
int func_32(var uParam0, var uParam1) // Position - 0x2D6C Hash - 0xBCF64754 ^0xBCF64754
{
	func_77(uParam0, false, false, true);
	return 1;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2D7E Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2D9B Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2ED7 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3010 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30BA Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3132 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x31C1 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x32DC Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x32E8 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3470 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3510 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3523 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x353D Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35A5 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x35D1 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_48(int iParam0) // Position - 0x35DF Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x36D0 Hash - 0x960D7EB7 ^0x57019BBE
{
...
void func_50(var uParam0, char* sParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x375E Hash - 0x3AAEDE3B ^0x68D4DDC3
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37B2 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_52(int iParam0) // Position - 0x39B6 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x39CA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x39D9 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_78() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x39F4 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3A53 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_57(Ped pedParam0) // Position - 0x3A95 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3AC1 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3B3D Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3B63 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3B85 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3BA7 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3BC9 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3BED Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_65(int iParam0, BOOL bParam1) // Position - 0x3C11 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_103(iParam0, 16);
...
BOOL func_66(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3C3C Hash - 0xD3438796 ^0xAD2A1935
{
...
void func_67(var uParam0) // Position - 0x3C96 Hash - 0xC4C556C ^0xC4C556C
{
	if (!uParam0->f_469[2])
	{
		func_105(*uParam0, false);
		uParam0->f_469[2] = 1;
	}

	if (!uParam0->f_469[1])
	{
		func_106(*uParam0, uParam0->f_483, false);
		uParam0->f_469[1] = 1;
	}
...
int func_68(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3CDF Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_69(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3DD6 Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_108(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_109(pedParam0))
		if (func_110(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
	...
	if (func_111(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_111(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_111(iParam5, 32), true);
...
void func_70(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x4058 Hash - 0x5050B938 ^0x5BDC33E5
{
	TASK::TASK_START_SCENARIO_IN_PLACE_HASH(pedParam0, hParam1, iParam2, bParam3, hParam4, iParam5, false);
	return;
}

void func_71(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4071 Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x4099 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
...
BOOL func_73(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Position - 0x42A4 Hash - 0xF4F2DC7C ^0xA69B6C83
{
...
void func_74(var uParam0) // Position - 0x42D8 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_120(uParam0, 0f);
	return;
}

BOOL func_75(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x42E7 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
BOOL func_76(var uParam0, float fParam1) // Position - 0x4340 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_117(uParam0))
		return false;
...
void func_77(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4367 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_78() // Position - 0x44BB Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_79(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x44C9 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_80(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4530 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_81(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4559 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_82(var uParam0, var uParam1, var uParam2) // Position - 0x45A5 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_83(int iParam0) // Position - 0x45F4 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_84(int iParam0) // Position - 0x4619 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_85(int iParam0) // Position - 0x462C Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_86(int iParam0) // Position - 0x463F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_87(int iParam0) // Position - 0x4652 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_88(int iParam0) // Position - 0x4664 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_89(int iParam0, int iParam1) // Position - 0x4676 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4710 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_91() // Position - 0x4748 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_92(int iParam0) // Position - 0x479B Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_95(iParam0))
		return -1;
...
BOOL func_93(int iParam0) // Position - 0x47BB Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_94(int iParam0, int iParam1) // Position - 0x47D1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_95(int iParam0) // Position - 0x47E0 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_96(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4813 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x48F4 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_103(iParam0, 4);
	else
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4912 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_103(iParam0, 8);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4932 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_103(iParam0, 32);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4952 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_103(iParam0, 64);
	else
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4972 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4994 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_103(int iParam0, int iParam1) // Position - 0x49B8 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_104(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x49C9 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x4FF2 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_106(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x50C9 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_107(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x51CD Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Ped func_108(Ped pedParam0) // Position - 0x51F6 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_109(Ped pedParam0) // Position - 0x5200 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_110(Ped pedParam0) // Position - 0x5232 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_111(int iParam0, int iParam1) // Position - 0x5274 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_112(Ped pedParam0) // Position - 0x5283 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_113(Ped pedParam0) // Position - 0x529E Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_114(float fParam0) // Position - 0x52BA Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_115(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5301 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_116(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x531F Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_169(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_117(var uParam0) // Position - 0x5376 Hash - 0x5001E582 ^0x5001E582
{
	return func_170(*uParam0, 1);
}

BOOL func_118(var uParam0, float fParam1) // Position - 0x5386 Hash - 0xBBD67703 ^0xBBD67703
{
	if (func_76(uParam0, fParam1))
	{
		func_119(uParam0);
		return true;
	}
...
void func_119(var uParam0) // Position - 0x53A4 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_120(var uParam0, float fParam1) // Position - 0x53BA Hash - 0x30433BAB ^0xF854D531
{
...
float func_121(var uParam0) // Position - 0x53E0 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_117(uParam0))
		return uParam0->f_1;
...
BOOL func_122(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5415 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_123(BOOL bParam0, var uParam1, var uParam2) // Position - 0x546A Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_124(int iParam0, int iParam1) // Position - 0x5481 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_125(int iParam0, int iParam1) // Position - 0x5507 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_126(int iParam0, int iParam1) // Position - 0x5543 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_127(int iParam0, int iParam1) // Position - 0x5596 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_128(int iParam0, int iParam1) // Position - 0x55D1 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_129(int iParam0, int iParam1) // Position - 0x560A Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_130(int iParam0) // Position - 0x5642 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_131(BOOL bParam0) // Position - 0x5680 Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_132(ePedType eptParam0) // Position - 0x5693 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_133(Ped pedParam0, Hash hParam1) // Position - 0x5AE6 Hash - 0x20B01AF8 ^0xB10886B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_134(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5B8D Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_135(Ped pedParam0, BOOL bParam1) // Position - 0x5BBD Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_136(Ped pedParam0, int iParam1) // Position - 0x5C02 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_137(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5C29 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_179(iParam2);
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5DF4 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_139(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5ECB Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_140(Ped pedParam0, int iParam1) // Position - 0x5F08 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_141(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5FEF Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x60C5 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_143(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x61CE Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0x6303 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_145(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x633A Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_146(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6441 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x64AC Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_148(Ped pedParam0, int iParam1) // Position - 0x65F4 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_149(var uParam0, int iParam1) // Position - 0x67D0 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x6848 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_151(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6877 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_152(int iParam0, Ped pedParam1) // Position - 0x69FD Hash - 0xB7C59D62 ^0x3B8AD4C7
{
	int _int;
...
BOOL func_153(int iParam0, Ped pedParam1) // Position - 0x6A4A Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_206(iParam0))
		return true;
...
BOOL func_154(Ped pedParam0, Ped pedParam1) // Position - 0x6AE7 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_155() // Position - 0x6B34 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_156(int iParam0, Ped pedParam1) // Position - 0x6B3C Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_157() // Position - 0x6BFD Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_158() // Position - 0x6C1B Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_159(int iParam0, Ped pedParam1) // Position - 0x6C68 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_160(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6D84 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6DCC Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_162(Ped pedParam0, int iParam1) // Position - 0x7025 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_216(0))
		return false;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x705E Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_164(var uParam0, int iParam1) // Position - 0x708D Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x70A1 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_166(int iParam0, Ped pedParam1) // Position - 0x70EE Hash - 0x32BE111E ^0x73C83B2B
{
...
void func_167(int iParam0) // Position - 0x7141 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_219(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_219(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_219(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_168(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x71C2 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_169(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x72B3 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_170(int iParam0, int iParam1) // Position - 0x72D1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_171() // Position - 0x72E0 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_172(var uParam0, int iParam1) // Position - 0x7312 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_173(var uParam0, int iParam1) // Position - 0x7323 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_174(var uParam0) // Position - 0x7338 Hash - 0x39705408 ^0x39705408
{
	return func_170(*uParam0, 2);
}

BOOL func_175(Ped pedParam0, Hash hParam1) // Position - 0x7348 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_176(Ped pedParam0, Hash hParam1) // Position - 0x7376 Hash - 0x31141107 ^0xF20E5AC2
{
	Hash _int;
...
BOOL func_177(Ped pedParam0, Hash hParam1) // Position - 0x73C4 Hash - 0x31141107 ^0xF20E5AC2
{
	Hash _int;
	int _int2;
...
void func_178(Ped pedParam0) // Position - 0x7432 Hash - 0x5E1E982C ^0xB802F8D
{
...
void func_179(int iParam0) // Position - 0x744E Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_180(int iParam0) // Position - 0x75BA Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_181(BOOL bParam0) // Position - 0x75CD Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_182(int iParam0) // Position - 0x75E7 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_183(int iParam0) // Position - 0x767F Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_184(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x76A6 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_185(Ped pedParam0, Ped pedParam1) // Position - 0x779F Hash - 0xF9959663 ^0xF9959663
{
	return func_207(pedParam0, pedParam1, true, true);
}

float func_186(int iParam0) // Position - 0x77B1 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_187(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x77BD Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_188(int iParam0, BOOL bParam1) // Position - 0x7822 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_189() // Position - 0x7848 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_190(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x785C Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_191(int iParam0) // Position - 0x79BC Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_192(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x79C8 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_193(int iParam0) // Position - 0x7A29 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_194(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7A35 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7AF7 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_196(int iParam0) // Position - 0x7B95 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_197(int iParam0) // Position - 0x7BA1 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_198(int iParam0) // Position - 0x7BAD Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_199(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7CEA Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_200(Ped pedParam0) // Position - 0x7D2D Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_201(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7D93 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_202(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7DDA Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_203(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7E25 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_204(Ped pedParam0, var uParam1) // Position - 0x7E9E Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_205(Ped pedParam0, Ped pedParam1) // Position - 0x7EEB Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_206(int iParam0) // Position - 0x7F33 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_207(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7F43 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_208(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7F8B Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_209(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7FB7 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_210(int iParam0) // Position - 0x7FDF Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_211(Ped pedParam0) // Position - 0x7FEB Hash - 0xFF90A606 ^0xDE23630E
{
...
int func_212(Ped pedParam0) // Position - 0x8040 Hash - 0xF8352061 ^0xD292B0F4
{
...
BOOL func_213(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x80AA Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_214(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x821A Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_215(int iParam0, Ped pedParam1) // Position - 0x8308 Hash - 0xF551226 ^0xA04CD395
{
...
BOOL func_216(int iParam0) // Position - 0x837C Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_233())
		return false;
...
int func_217(int iParam0) // Position - 0x839E Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_218(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x83AA Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_219(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x8425 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_220() // Position - 0x84B1 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_236())
		return false;
...
void func_221(Any* panParam0, int iParam1) // Position - 0x8507 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_222(BOOL bParam0, var uParam1, var uParam2) // Position - 0x85AF Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_223() // Position - 0x8676 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_224(int iParam0) // Position - 0x8684 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_225(int iParam0) // Position - 0x872C Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_226(Ped pedParam0, int iParam1) // Position - 0x8791 Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_227(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x87A8 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_228(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x87D6 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_229(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8820 Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_230(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8861 Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_231(Ped pedParam0) // Position - 0x88DA Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_232(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x89C2 Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_233() // Position - 0x8A04 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_223() != -1)
		return false;
...
BOOL func_234(int iParam0, BOOL bParam1) // Position - 0x8A29 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_235(int iParam0) // Position - 0x8A5A Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_236() // Position - 0x8A6D Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_237(int iParam0) // Position - 0x8A9E Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_95(iParam0))
		return -1;
...
int func_238(int iParam0) // Position - 0x8ABA Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_239(int iParam0) // Position - 0x8AFB Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
