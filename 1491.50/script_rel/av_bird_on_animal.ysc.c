...
void main() // Position - 0x0 Hash - 0xBAEE6669 ^0x941AC683
{
	var unk;
	BOOL flag;
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = joaat("a_c_elk_01");
	iLocal_10 = joaat("a_c_cardinal_01");
	hLocal_11 = joaat("world_animal_elk_grazing");
...
void func_1(var uParam0) // Position - 0x596 Hash - 0x646928F0 ^0x646928F0
{
	func_4(uParam0);
	return;
}

void func_2(var uParam0) // Position - 0x5A4 Hash - 0x15214583 ^0x343259F6
{
	int i;
...
BOOL func_3(var uParam0) // Position - 0x63A Hash - 0x9D8F0B2F ^0x9D8F0B2F
{
	BOOL flag;
	int num;
	float num2;
...
void func_4(var uParam0) // Position - 0x9E0 Hash - 0x4DA9BC8C ^0x82CB9DBF
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9FA Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA11 Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xACF Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAF9 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC4A Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC5F Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xD03 Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AB4 Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B1A Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BD4 Hash - 0x5B7E65F9 ^0xD7BD4C90
{
	int num;
	BOOL flag;
	int randomIntInRange;

	func_46(uParam0, "BIRD_ON_ANIMAL", "", vParam1, uParam4);
	num = 1;
	flag = func_47();
	...
	switch (*uParam0)
	{
		...
		case 117:
			hLocal_11 = joaat("world_animal_deer_grazing");
			iLocal_9 = joaat("a_c_buck_01");
			break;
	
		case 118:
			hLocal_11 = joaat("world_animal_buffalo_grazing");
			iLocal_9 = joaat("a_c_buffalo_01");
			break;
	
		case 119:
			hLocal_11 = joaat("world_animal_cow_grazing");
			iLocal_9 = joaat("A_C_Cow");
			break;
		...
		case 120:
			...
			{
				num = 0;
				iLocal_12 = joaat("META_OUTFIT_ANIMAL_ELK_M_001");
			}
			break;
	
		case 121:
			iLocal_9 = joaat("a_c_moose_01");
			hLocal_11 = joaat("world_animal_moose_grazing");
		
			if (flag)
			{
				num = 0;
				iLocal_12 = joaat("META_OUTFIT_ANIMAL_MOOSE_M_001");
			}
			break;
	}
	...
	if (*uParam0 == 116)
	{
		iLocal_10 = joaat("a_c_heron_01");
	}
	else
	{
		if (*uParam0 == 118 || *uParam0 == 119)
		...
		switch (randomIntInRange)
		{
			...
			case 1:
				iLocal_10 = joaat("a_c_bluejay_01");
				break;
		
			case 2:
				iLocal_10 = joaat("a_c_crow_01");
				break;
		}
	}

	func_48(uParam0, 1, "BOA_BIRD_1", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0.25f, -1f, 1f), 0f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 0, "BOA_ANIMAL_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, 0f, 0f, 1f), 0f + uParam4.f_2, num, 1, 1, 1, iLocal_12, 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1D74 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1E14 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1F2E Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x20F7 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x2100 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x22B0 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2324 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2373 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x23CB Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2534 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
	int randomIntInRange;
...
BOOL func_25(var uParam0) // Position - 0x285B Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2992 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2AC2 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2B01 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}
...
int func_30(var uParam0) // Position - 0x2B3C Hash - 0x7F36B2BF ^0x7F36B2BF
{
	func_56(&uLocal_17, false);
	func_57(&uLocal_17, true);
	func_58(&uLocal_17, true);
	func_59(&uLocal_17, true);
	func_60(&uLocal_17, true);
	func_61(&uLocal_17, true);
	func_62(&uLocal_17, 65);
	return 1;
}

int func_31(var uParam0) // Position - 0x2B77 Hash - 0x6CF146A9 ^0xA5D8A94A
{
	var unk;
	int i;
	...
	if (!uParam0->f_469[1])
	{
		for (i = 0; i < 2; i = i + 1)
		{
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]) || func_63(uParam0->f_20[i /*14*/], 0, &uLocal_17, &unk, 0, 0))
			{
				iLocal_13 = 1;
				uParam0->f_469[1] = 1;
				break;
	...
	switch (iLocal_13)
	{
		case 0:
			...
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], func_66(uParam0), func_67(uParam0), func_68(uParam0), true, true, false, true, 2, true, false, false);
		...
		case 1:
			if (uParam0->f_469[1] || func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				func_70(uParam0);
				PED::SET_PED_SHOULD_PLAY_FLEE_SCENARIO_EXIT(uParam0->f_20[0 /*14*/], Global_36, 0);
				func_71(uParam0->f_20[1 /*14*/], true, true);
			
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					TASK::TASK_FLY_AWAY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/]);
		...
		case 2:
			if (func_73(uParam0->f_20[0 /*14*/], 0))
			{
				if (*uParam0 != 119)
					TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 0, -1082130432, -1, 0);
				else
...
int func_32(var uParam0, var uParam1) // Position - 0x2DA1 Hash - 0xC02302C6 ^0x1093F5AF
{
	func_71(uParam0->f_20[1 /*14*/], true, true);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2DC0 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2DDD Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x2F19 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3052 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30FC Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3174 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3203 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x331E Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x332A Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34B2 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3552 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3565 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x357F Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x35E7 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
BOOL func_47() // Position - 0x3613 Hash - 0xEE877ACE ^0xCCE9C802
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3634 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_49(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x36C2 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_50(int iParam0) // Position - 0x38C6 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x38DA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_52() // Position - 0x38E9 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_76() != -1;
}

BOOL func_53(var uParam0, Any* panParam1) // Position - 0x3904 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_54(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3963 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_55(Ped pedParam0) // Position - 0x39A5 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x39D1 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_57(var uParam0, BOOL bParam1) // Position - 0x3A4D Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_58(var uParam0, BOOL bParam1) // Position - 0x3A73 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3A95 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3AB7 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3AD9 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_62(var uParam0, int iParam1) // Position - 0x3AFD Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_63(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x3B0B Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
int func_64(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4135 Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_65(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x422C Hash - 0x6DE5BABD ^0x14BE368D
{
...
int func_66(var uParam0) // Position - 0x4254 Hash - 0xC8FA495A ^0xB7DF5249
{
	switch (*uParam0)
	{
		case 116:
			return PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 14412);
	
		case 117:
		case 119:
		case 120:
			return PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 14413);
	
		case 118:
			return PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 14410);
...
Vector3 func_67(var uParam0) // Position - 0x42DA Hash - 0x51A436D0 ^0xCB161C78
{
	switch (*uParam0)
	{
		case 116:
		...
		case 118:
			if (iLocal_10 == joaat("a_c_crow_01"))
				return 0f, -0.41f, 0f;
			else
				return 0f, -0.35f, 0f;
			break;
...
Vector3 func_68(var uParam0) // Position - 0x438E Hash - 0xD82A1E3D ^0xD82A1E3D
{
	switch (*uParam0)
	{
		case 116:
...
int func_69(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x43EC Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num = num * num;
		fParam2 = func_136(fParam2);
		num2 = func_137(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_138(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_139(&(uParam0->f_490)))
							func_72(&(uParam0->f_490));
					
						if (func_140(&(uParam0->f_490), fParam1))
						{
...
void func_70(var uParam0) // Position - 0x45F7 Hash - 0xCB0808C5 ^0xCB0808C5
{
	if (!uParam0->f_469[3])
	{
		func_142(*uParam0, false);
		uParam0->f_469[3] = 1;
	}

	if (!uParam0->f_469[4])
	{
		func_143(*uParam0, uParam0->f_483, false);
		uParam0->f_469[4] = 1;
	}
...
void func_71(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4640 Hash - 0xC4F231CE ^0xB86F5EAB
{
...
void func_72(var uParam0) // Position - 0x4665 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_144(uParam0, 0f);
	return;
}

BOOL func_73(Ped pedParam0, int iParam1) // Position - 0x4674 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
BOOL func_74(var uParam0, float fParam1) // Position - 0x4773 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_139(uParam0))
		return false;
...
void func_75(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x479A Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_76() // Position - 0x48EE Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_77(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x48FC Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4963 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_79(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x498C Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_80(var uParam0, var uParam1, var uParam2) // Position - 0x49D8 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_81(int iParam0) // Position - 0x4A27 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_82(int iParam0) // Position - 0x4A4C Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_83(int iParam0) // Position - 0x4A5F Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_84(int iParam0) // Position - 0x4A72 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_85(int iParam0) // Position - 0x4A85 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_86(int iParam0) // Position - 0x4A97 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_87(int iParam0, int iParam1) // Position - 0x4AA9 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4B43 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_89() // Position - 0x4B7B Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_90(int iParam0) // Position - 0x4BCE Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_93(iParam0))
		return -1;
...
BOOL func_91(int iParam0) // Position - 0x4BEE Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_92(int iParam0, int iParam1) // Position - 0x4C04 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_93(int iParam0) // Position - 0x4C13 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_94(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4C46 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x4D27 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_102(iParam0, 4);
	else
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x4D45 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_102(iParam0, 8);
	else
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x4D65 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_102(iParam0, 16);
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x4D90 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_102(iParam0, 32);
	else
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x4DB0 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_102(iParam0, 64);
	else
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4DD0 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x4DF2 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_102(int iParam0, int iParam1) // Position - 0x4E16 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_103(int iParam0, BOOL bParam1, int iParam2) // Position - 0x4E27 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_162(iParam2);
...
BOOL func_104(Ped pedParam0, int iParam1) // Position - 0x4FF2 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_105(Ped pedParam0, int iParam1, int iParam2) // Position - 0x50C9 Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_106(Ped pedParam0, int iParam1) // Position - 0x5106 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_107(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x51ED Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_108(Ped pedParam0, int iParam1) // Position - 0x52C3 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_109(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x53CC Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_110(int iParam0, int iParam1) // Position - 0x5501 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_111(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5538 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_112(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x563F Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_113(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x56AA Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_114(Ped pedParam0, int iParam1) // Position - 0x57F2 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_115(var uParam0, int iParam1) // Position - 0x59CE Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_116(int iParam0, int iParam1) // Position - 0x5A46 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_117(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5A75 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_118(int iParam0, Ped pedParam1) // Position - 0x5BFB Hash - 0xFF4D5871 ^0x5D7AC581
{
	int _int;
...
BOOL func_119(int iParam0, Ped pedParam1) // Position - 0x5C48 Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_189(iParam0))
		return true;
...
BOOL func_120(Ped pedParam0, Ped pedParam1) // Position - 0x5CE5 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_121() // Position - 0x5D32 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_122(int iParam0, Ped pedParam1) // Position - 0x5D3A Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_123() // Position - 0x5DFB Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_124() // Position - 0x5E19 Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_125(int iParam0, Ped pedParam1) // Position - 0x5E66 Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_126(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5F82 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_127(Ped pedParam0, int iParam1) // Position - 0x5FCA Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_128(Ped pedParam0, int iParam1) // Position - 0x6223 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_199(0))
		return false;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x625C Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_130(var uParam0, int iParam1) // Position - 0x628B Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_131(Ped pedParam0, int iParam1) // Position - 0x629F Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_123() - iParam1->f_4 > func_200(iParam1))
		return func_201(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_132(int iParam0, Ped pedParam1) // Position - 0x62EC Hash - 0x43328E76 ^0x37AF705
{
...
BOOL func_133(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x633F Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_134(Ped pedParam0) // Position - 0x6368 Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_135(Ped pedParam0) // Position - 0x6383 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_136(float fParam0) // Position - 0x639F Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_137(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x63E6 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_138(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x6404 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_202(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_139(var uParam0) // Position - 0x645B Hash - 0x5001E582 ^0x5001E582
{
	return func_203(*uParam0, 1);
}

BOOL func_140(var uParam0, float fParam1) // Position - 0x646B Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_141(var uParam0) // Position - 0x6489 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x649F Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_143(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x6576 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_144(var uParam0, float fParam1) // Position - 0x667A Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x66A0 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_146(var uParam0) // Position - 0x66AF Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_139(uParam0))
		return uParam0->f_1;
...
BOOL func_147(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x66E4 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_148(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6739 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_149(int iParam0, int iParam1) // Position - 0x6750 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_150(int iParam0, int iParam1) // Position - 0x67D6 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_151(int iParam0, int iParam1) // Position - 0x6812 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_152(int iParam0, int iParam1) // Position - 0x6865 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_153(int iParam0, int iParam1) // Position - 0x68A0 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_154(int iParam0, int iParam1) // Position - 0x68D9 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_155(int iParam0) // Position - 0x6911 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_156(BOOL bParam0) // Position - 0x694F Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_157(ePedType eptParam0) // Position - 0x6962 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_158(Ped pedParam0, Hash hParam1) // Position - 0x6DB5 Hash - 0x16B04E3F ^0x1C8E2F42
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_159(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6E5C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_160(Ped pedParam0, BOOL bParam1) // Position - 0x6E8C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_161(Ped pedParam0, int iParam1) // Position - 0x6ED1 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_162(int iParam0) // Position - 0x6EF8 Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_163(int iParam0) // Position - 0x7064 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_164(BOOL bParam0) // Position - 0x7077 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_165(int iParam0) // Position - 0x7091 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_166(int iParam0) // Position - 0x7129 Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_167(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7150 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_168(Ped pedParam0, Ped pedParam1) // Position - 0x7249 Hash - 0xF9959663 ^0xF9959663
{
	return func_190(pedParam0, pedParam1, true, true);
}

float func_169(int iParam0) // Position - 0x725B Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_170(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7267 Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_171(int iParam0, BOOL bParam1) // Position - 0x72CC Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_172() // Position - 0x72F2 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_173(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x7306 Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_174(int iParam0) // Position - 0x7466 Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_175(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7472 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_176(int iParam0) // Position - 0x74D3 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_177(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x74DF Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_178(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x75A1 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_179(int iParam0) // Position - 0x763F Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_180(int iParam0) // Position - 0x764B Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_181(int iParam0) // Position - 0x7657 Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_182(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7794 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_183(Ped pedParam0) // Position - 0x77D7 Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_184(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x783D Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_185(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7884 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_186(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x78CF Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_187(Ped pedParam0, var uParam1) // Position - 0x7948 Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_188(Ped pedParam0, Ped pedParam1) // Position - 0x7995 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_189(int iParam0) // Position - 0x79DD Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_190(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x79ED Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_191(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7A35 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_192(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7A61 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_193(int iParam0) // Position - 0x7A89 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_194(Ped pedParam0) // Position - 0x7A95 Hash - 0x7F62AA86 ^0xD27587F3
{
...
int func_195(Ped pedParam0) // Position - 0x7AE9 Hash - 0x9DC9370 ^0x7505B019
{
...
BOOL func_196(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7B53 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_197(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7CC3 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_198(int iParam0, Ped pedParam1) // Position - 0x7DB1 Hash - 0x6BEC9554 ^0x5E970E9F
{
...
BOOL func_199(int iParam0) // Position - 0x7E25 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_227())
		return false;
...
int func_200(int iParam0) // Position - 0x7E47 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_201(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7E53 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
float func_202(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7ECE Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_203(int iParam0, int iParam1) // Position - 0x7EEC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_204(int iParam0) // Position - 0x7EFB Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_229(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_229(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_229(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_205(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7F7C Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
float func_206() // Position - 0x8070 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_207(var uParam0, int iParam1) // Position - 0x80A2 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_208(var uParam0, int iParam1) // Position - 0x80B3 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_209(var uParam0) // Position - 0x80C8 Hash - 0x39705408 ^0x39705408
{
	return func_203(*uParam0, 2);
}

BOOL func_210(Ped pedParam0, Hash hParam1) // Position - 0x80D8 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_211(Ped pedParam0, Hash hParam1) // Position - 0x8106 Hash - 0xF8DFA92C ^0x3D11FEFF
{
	Hash _int;
...
BOOL func_212(Ped pedParam0, Hash hParam1) // Position - 0x8154 Hash - 0xF8DFA92C ^0x3D11FEFF
{
	Hash _int;
	int _int2;
...
void func_213(Ped pedParam0) // Position - 0x81C2 Hash - 0x25698A4D ^0xE65FE709
{
...
BOOL func_214() // Position - 0x81DE Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_230())
		return false;
...
void func_215(Any* panParam0, int iParam1) // Position - 0x8234 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_216(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82DC Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_217() // Position - 0x83A3 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_218(int iParam0) // Position - 0x83B1 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_219(int iParam0) // Position - 0x8459 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_220(Ped pedParam0, int iParam1) // Position - 0x84BE Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_221(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x84D5 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_222(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8503 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_223(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x854D Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_224(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x858E Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_225(Ped pedParam0) // Position - 0x8607 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_226(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x86EF Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_227() // Position - 0x8731 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_217() != -1)
		return false;
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x8756 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
void func_229(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x8787 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
BOOL func_230() // Position - 0x8813 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_231(int iParam0) // Position - 0x8844 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_93(iParam0))
		return -1;
...
int func_232(int iParam0) // Position - 0x8860 Hash - 0x69AF6CF8 ^0x64DBA37A
{
