...
BOOL func_42(var uParam0) // Position - 0x1583 Hash - 0xF652F649 ^0xEE0172D4
{
	*uParam0 = 14;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = joaat("p_pronghorntuftsfur01x");
	uParam0->f_572[1] = joaat("p_pronghornscat01x");
	uParam0->f_572[2] = joaat("p_pronghorntuftsfur01x");
	uParam0->f_580[0] = 1;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 4;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = joaat("a_c_pronghorn_01");
	uParam0->f_12.f_3 = 0.75f;
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = joaat("META_OUTFIT_ANIMAL_ALBINO_PRONGHORN");
	return true;
}
...
{
	return func_204("ATZ_INS_EXC_PR");
}

Vector3 func_161() // Position - 0x78E0 Hash - 0x1DA0618A ^0xAC40CBAA
{
	return func_204("ATZ_INS_FUR_PR");
}
...
float func_169(int iParam0, int iParam1) // Position - 0x79A4 Hash - 0xA760312B ^0xA760312B
{
	switch (iParam0)
	{
		case 0:
...
void func_170(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7B09 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
Hash func_171() // Position - 0x7BEA Hash - 0x9F572D68 ^0x5FAAC5AF
{
	return -57428692;
}

BOOL func_172(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7BF7 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_173(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7C20 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_174(Ped pedParam0) // Position - 0x7C3E Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_212(pedParam0, 4) || func_212(pedParam0, 5);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x7C5A Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_177(int iParam0, int iParam1) // Position - 0x7F21 Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x7F54 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x7FAC Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_180(int iParam0, int iParam1) // Position - 0x7FD5 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
Any func_181(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7FFD Hash - 0xDFB996B4 ^0xC287A71C
{
	Any any;
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0x89A5 Hash - 0x7CA5B2D1 ^0x7CA5B2D1
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -3916.267f, -3657.7651f, 47.1306f;
			
				case 1:
					return -3781.8809f, -3653.0532f, 39.5285f;
			
				case 2:
					return -3863.08f, -3672.1538f, 41.0701f;
			
				case 3:
					return -3824.7546f, -3527.483f, 53.7911f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return -3791.538f, -3588.9524f, 45.8875f;
			
				case 1:
					return -3931.3408f, -3602.614f, 52.8594f;
			
				case 2:
					return -3863.2627f, -3523.0386f, 55.3003f;
			
				case 3:
					return -3861.089f, -3673.9258f, 40.741f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return -3846.0662f, -3542.3318f, 52.0003f;
			
				case 1:
					return -3886.203f, -3649.9895f, 43.989f;
			
				case 2:
					return -3809.4734f, -3562.3975f, 49.9921f;
			
				case 3:
					return -3785.587f, -3632.509f, 39.9253f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return -3889.806f, -3592.1003f, 50.8374f;
			
				case 1:
					return -3859.0164f, -3680.142f, 39.9526f;
			
				case 2:
					return -3836.1162f, -3606.8113f, 44.1589f;
			
				case 3:
					return -3799.8857f, -3588.5562f, 46.021f;
			}
			break;
	}
...
void func_208(Ped pedParam0, Hash hParam1) // Position - 0x9072 Hash - 0xEA1C858E ^0x58220AFF
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x97BE Hash - 0xA54F3032 ^0x7A2EF519
{
	Hash _int;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x980F Hash - 0xA54F3032 ^0x7A2EF519
{
	Hash _int;
	int _int2;
...
void func_241(Ped pedParam0) // Position - 0x9881 Hash - 0x446F1BDD ^0x32F3DED3
{
