...
void func_27(var uParam0) // Position - 0x26B7 Hash - 0xAF1FB808 ^0xAC8CBB7A
{
	int i;
	int num;
	...
	uParam0->f_58[1] = joaat("s_firestick01x");
	uParam0->f_58[2] = joaat("s_firestick01x");
	uParam0->f_58[3] = joaat("p_table_sd_theater01x");
	uParam0->f_58[4] = joaat("p_light_sd_theater01x");
	...
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_48))
		uParam0->f_48 = ANIMSCENE::_CREATE_ANIM_SCENE("script@shows@fire_breather@act2_p1@action", 2, func_156(0), false, true);
	...
	{
		num = i;
		iLocal_1141.f_9[i] = MISC::GET_HASH_KEY(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(num));
	}
...
void func_28(var uParam0) // Position - 0x27CF Hash - 0x1D8D3B5 ^0x12AA7EF9
{
	int i;
	Hash model;
	Hash model2;
...
void func_29(var uParam0) // Position - 0x28B5 Hash - 0xBA5A1D5A ^0x2104F386
{
	uParam0->f_10 = 0;
	return;
}

BOOL func_30(var uParam0) // Position - 0x28C2 Hash - 0x9C46E10 ^0x67E4B804
{
	int i;
	Interior interiorAtCoords;
	Hash model;
...
int func_31(var uParam0) // Position - 0x2AC4 Hash - 0xE893ED2E ^0x180F195
{
...
BOOL func_32(var uParam0) // Position - 0x2B02 Hash - 0xE1A70819 ^0xC6770BB
{
	int i;
...
void func_33(var uParam0) // Position - 0x2C3E Hash - 0xBEDCB394 ^0xF84F5570
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_48))
		return;
...
void func_34(var uParam0) // Position - 0x2C71 Hash - 0x7EC1FB44 ^0x982146DB
{
	Vector3 vector;
...
void func_35(var uParam0, int iParam1) // Position - 0x2D84 Hash - 0x63DF4C14 ^0xC320F13D
{
	int i;
	int num;
...
BOOL func_36(var uParam0, int iParam1) // Position - 0x2E3C Hash - 0xA90F6824 ^0x4F8D15CD
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_37(var uParam0, int iParam1, int iParam2) // Position - 0x2EE1 Hash - 0x469D9B5C ^0xFBFE69BE
{
	int num;
	BOOL flag;
	int i;
...
BOOL func_38(var uParam0, var uParam1, int iParam2) // Position - 0x2FF8 Hash - 0x8BDD24CD ^0xAC396C13
{
	int num;
	int i;
...
BOOL func_39(var uParam0, int iParam1) // Position - 0x30CE Hash - 0x14C3A2FD ^0x410B68E1
{
	int num;
	int i;
...
BOOL func_40(var uParam0) // Position - 0x315E Hash - 0x5001E582 ^0x5001E582
{
	return func_188(*uParam0, 1);
}

void func_41(var uParam0) // Position - 0x316E Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_189(uParam0, 0f);
	return;
}

float func_42(var uParam0) // Position - 0x317D Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_40(uParam0))
		return uParam0->f_1;
...
void func_43(var uParam0) // Position - 0x31B2 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_44(var uParam0) // Position - 0x31C8 Hash - 0x8A06FBE1 ^0xD68C11D0
{
	uParam0->f_15;
	return;
}

void func_45(var uParam0, int iParam1) // Position - 0x31D7 Hash - 0xA1D2156 ^0x915CDD7D
{
	BOOL flag;
	int i;
	int num;
...
BOOL func_46(var uParam0) // Position - 0x3455 Hash - 0x1FC68E7D ^0xF66318F
{
	var unk;
	var unk3;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_81[1]))
	{
		...
		if (func_208(&unk, &unk3, 1, 2548.364f, -1303.3759f, 47.48392f, 0.5f, false, true, true, -1, true, false, -1082130432, false, false) > 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(unk[0]) && !ENTITY::IS_ENTITY_DEAD(unk[0]))
			{
				...
				ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_81[1], true);
...
int func_47(var uParam0) // Position - 0x3516 Hash - 0xE440ADBD ^0x7BE35012
{
	if (!func_40(uParam0))
...
float func_48(var uParam0) // Position - 0x3569 Hash - 0x5E6CC847 ^0xFCFB84EF
{
	if (!func_40(uParam0))
		return 0f;
...
int func_49(var uParam0, int iParam1) // Position - 0x359B Hash - 0x9C24B1C8 ^0x38EAA238
{
	Vector3 vector;
...
void func_50(var uParam0) // Position - 0x3619 Hash - 0x36ED6EEB ^0xFD82CB62
{
	if (uParam0->f_1071 == 0)
		return;
...
void func_51(int iParam0) // Position - 0x3706 Hash - 0xF5186149 ^0xF5186149
{
	switch (iParam0)
	{
		case 21:
...
char* func_52(int iParam0) // Position - 0x379C Hash - 0xB291B268 ^0x20895610
{
	switch (iParam0)
	{
		case 0:
...
char* func_53() // Position - 0x3807 Hash - 0x306ACA3A ^0x987949EE
{
	return "SHOWS_sounds";
}

void func_54(char* sParam0, char* sParam1) // Position - 0x3813 Hash - 0x83DC3D8F ^0x23DED81A
{
	AUDIO::PLAY_SOUND_FRONTEND(sParam0, sParam1, true, 0);
	return;
}

char* func_55(int iParam0) // Position - 0x3825 Hash - 0x21CE226B ^0xBBA96EC9
{
	switch (iParam0)
	{
		case 9:
...
char* func_56(int iParam0) // Position - 0x3860 Hash - 0x21CE226B ^0xB313989A
{
	switch (iParam0)
	{
		case 9:
...
void func_57(var uParam0, var uParam1, int iParam2) // Position - 0x389B Hash - 0x6A7F1E78 ^0x8B64B816
{
...
BOOL func_58(int iParam0) // Position - 0x39A2 Hash - 0xDDC0076D ^0xDDC0076D
{
	return Global_1310750.f_16035 && iParam0 != false;
}

void func_59(int iParam0) // Position - 0x39B6 Hash - 0xB89DF92F ^0xB89DF92F
{
	Global_1310750.f_16035 = Global_1310750.f_16035 - Global_1310750.f_16035 && iParam0;
	return;
}

void func_60(var uParam0) // Position - 0x39D7 Hash - 0x96216186 ^0x93AF06B2
{
...
void func_61(var uParam0) // Position - 0x3A43 Hash - 0x18FD7C7E ^0x894D0903
{
	int i;
	int j;
	var outEntity;
...
void func_62(var uParam0) // Position - 0x400A Hash - 0x67A2A23D ^0xCD2F3594
{
	int i;
...
void func_63(var uParam0) // Position - 0x40C4 Hash - 0xF76108FC ^0x2F7EA6B9
{
	...
	switch (iLocal_1141)
	{
		case 0:
			func_7(&(Global_1394141.f_1325), 16);
			Global_1394141.f_1322 = 1;
			func_237(&iLocal_1141, 1);
			break;
	
		case 1:
			if (!func_142(uParam0->f_48, func_156(2), "LOOP PLAYLIST"))
				return;
		
			func_237(&iLocal_1141, 2);
			break;
		...
		case 2:
			if (animScenePhase > 0.99f)
			{
				...
				func_238(true);
				func_145(uParam0->f_48, func_156(2), "Fire Breath 01");
				iLocal_1141.f_8 = 2;
				func_41(&(iLocal_1141.f_5));
				func_237(&iLocal_1141, 3);
			}
			break;
	
		case 3:
			if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_48, func_156(2)))
			{
				...
				if (!func_40(&(iLocal_1141.f_5)))
					func_41(&(iLocal_1141.f_5));
			
				if (animScenePhase > 0f)
				{
					if (func_142(uParam0->f_48, func_156(1), "FAIL PLAYLIST") && func_2(uParam0->f_16, 32))
					{
						if (!func_40(&(iLocal_1141.f_2)))
						{
							func_41(&(iLocal_1141.f_2));
						}
						else if (func_42(&(iLocal_1141.f_2)) > 1f && animScenePhase > 0.8f)
						{
							if (uParam0->f_14)
								Global_1394141.f_1324 = 1;
						
							func_145(uParam0->f_48, func_156(1), "Fire Breath 01");
							iLocal_1141.f_8 = 1;
							func_237(&iLocal_1141, 4);
						}
					
						return;
					}
				
					if (func_142(uParam0->f_48, func_156(3), "WIN PLAYLIST") && func_42(&(iLocal_1141.f_5)) > 4f && animScenePhase > 0.8f)
					{
						func_145(uParam0->f_48, func_156(3), "Fire Breath 01");
						iLocal_1141.f_8 = 3;
						func_237(&iLocal_1141, 5);
					}
				}
			}
			break;
		...
		case 4:
			...
			{
				func_238(false);
				func_237(&iLocal_1141, 6);
			}
			break;
	
		case 5:
			if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_48, func_156(3)))
			{
				func_238(false);
				func_237(&iLocal_1141, 7);
			}
			break;
	
		case 6:
			if (FIRE::IS_ENTITY_ON_FIRE(uParam0->f_81[1]))
				FIRE::STOP_ENTITY_FIRE(uParam0->f_81[1], 0);
		
			if (animScenePhase > 0.71f)
				func_237(&iLocal_1141, 8);
			break;
...
float func_64() // Position - 0x43DE Hash - 0x22FB54B8 ^0x22FB54B8
{
	return 0.95f;
}

int func_65(var uParam0) // Position - 0x43EB Hash - 0xA734DC95 ^0xD1B7A127
{
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x444B Hash - 0x7C48D2BA ^0xE188283F
{
...
BOOL func_67() // Position - 0x4498 Hash - 0x601F71E7 ^0x51A86DDA
{
	if (GRAPHICS::GET_TV_CHANNEL() == -1)
		return true;
...
struct<2> func_68(int iParam0) // Position - 0x44BD Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_69(var uParam0, var uParam1, int iParam2) // Position - 0x44CD Hash - 0x8FAA7FE4 ^0x7A58E602
{
	STATS::_STAT_ID_INCREMENT_INT(&uParam0, iParam2);
	return;
}

void func_70(var uParam0) // Position - 0x44DD Hash - 0x240F0FFC ^0x758297AA
{
...
void func_71(var uParam0) // Position - 0x455B Hash - 0x3B9DB8B ^0x181ACD9C
{
	if (GRAPHICS::GET_TV_CHANNEL() == -1)
		return;
...
void func_72(var uParam0) // Position - 0x45C6 Hash - 0xA8CC42FB ^0x6F7590EB
{
	BOOL flag;
...
void func_73(char* sParam0, char* sParam1) // Position - 0x49B4 Hash - 0xAEE04633 ^0xA9DB7429
{
	AUDIO::_STOP_SOUND_WITH_NAME(sParam0, sParam1);
	return;
}

void func_74(var uParam0) // Position - 0x49C4 Hash - 0xB4C1B7D8 ^0x5E0E5D11
{
	switch (iLocal_8.f_1)
	{
		case 0:
...
void func_75(var uParam0) // Position - 0x4B2F Hash - 0xD9601DE6 ^0xD9601DE6
{
	int i;
...
Vector3 func_76(int iParam0) // Position - 0x4B6C Hash - 0x4CB488BA ^0x4CB488BA
{
	switch (iParam0)
	{
		case 0:
...
void func_77(var uParam0) // Position - 0x4BE5 Hash - 0x4E9E1D75 ^0xC89E0016
{
	int i;
...
void func_78(var uParam0, Volume volParam1) // Position - 0x4C42 Hash - 0xFE12DDF4 ^0x71AD09B7
{
	int num;
	int i;
...
void func_79(var uParam0) // Position - 0x4C9D Hash - 0xEEF37EAB ^0x80EC19A4
{
	int i;
	int num;
...
BOOL func_80(int iParam0) // Position - 0x4CDB Hash - 0xD331D60D ^0x6329BB57
{
	int i;
	Hash hash;
...
void func_81(int iParam0) // Position - 0x4D63 Hash - 0x5AE1D4F0 ^0xE48E55C0
{
	if (func_253(iParam0))
...
void func_82() // Position - 0x4D7E Hash - 0xFA3971BA ^0xF8E34552
{
	PED::SET_PED_CONFIG_FLAG(Global_35, 489, false);
...
BOOL func_83(int iParam0) // Position - 0x4DD9 Hash - 0x6491FC6C ^0x428660B
{
	int i;
	Hash hash;
...
BOOL func_84(int iParam0) // Position - 0x4E30 Hash - 0x6491FC6C ^0x428660B
{
	int i;
	Hash hash;
...
void func_85(var uParam0) // Position - 0x4E87 Hash - 0xF698EF57 ^0x2FB05687
{
	GRAPHICS::SET_TV_CHANNEL(-1);
...
void func_86(var uParam0) // Position - 0x4EEC Hash - 0xEE8B338A ^0x3B880615
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_81[1]))
		ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_81[1], false);
...
void func_87(var uParam0) // Position - 0x4F18 Hash - 0x22732D43 ^0xFC753F50
{
	func_256(uParam0);
...
void func_88(Object obParam0, int iParam1) // Position - 0x4F46 Hash - 0x9815F445 ^0x9815F445
{
	*obParam0 = *obParam0 - *obParam0 && iParam1;
	return;
}

void func_89(var uParam0, int iParam1) // Position - 0x4F5B Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_90(var uParam0) // Position - 0x4F6C Hash - 0x86FD8689 ^0x206CE292
{
	uParam0->f_10 = 1;
	return;
}

void func_91(eStackSize essParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x4F79 Hash - 0x2BEE335D ^0x2BEE335D
{
	func_258(func_257(), essParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_92(BOOL bParam0) // Position - 0x4F97 Hash - 0x67777C1C ^0xA5A55B03
{
	if (bParam0)
		func_259(4);
...
int func_93(BOOL bParam0) // Position - 0x4FB9 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_260() == -1)
	{
...
void func_94(Hash hParam0) // Position - 0x4FFA Hash - 0x3934F7F0 ^0xE2E63DDD
{
	if (!bLocal_1)
	{
...
void func_95(var uParam0, BOOL bParam1) // Position - 0x5014 Hash - 0xC0D552FF ^0xB3A5A71D
{
	if (bLocal_1)
	{
...
void func_96() // Position - 0x5037 Hash - 0xFB561F3A ^0x3BEF23F
{
	if (!bLocal_0)
	{
...
void func_97() // Position - 0x5052 Hash - 0x652CA67C ^0x1A990B
{
	if (bLocal_0)
	{
		INVENTORY::_INVENTORY_ENABLE_WEAPONS(func_93(false));
...
BOOL func_98() // Position - 0x506B Hash - 0xF40DE8DC ^0x762A5DC5
{
...
void func_99(var uParam0, int iParam1) // Position - 0x5097 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

BOOL func_100(int iParam0) // Position - 0x50A4 Hash - 0xD331D60D ^0x6329BB57
{
	int i;
	Hash hash;
...
BOOL func_101(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x511B Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
int func_102(int iParam0) // Position - 0x51B9 Hash - 0xF6A7C02B ^0xF6A7C02B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_103(int iParam0) // Position - 0x520B Hash - 0xAAD68AF2 ^0x932B637C
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_104(int iParam0, int iParam1) // Position - 0x526D Hash - 0xEA9A7255 ^0xEA9A7255
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_105(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, int iParam5) // Position - 0x53E2 Hash - 0xA7EC4DCD ^0x75B7B4EC
{
	if (uParam0->f_1 == 0)
...
int func_106(int iParam0) // Position - 0x5436 Hash - 0x9D04607 ^0x9D04607
{
	switch (iParam0)
	{
		case 0:
...
Hash func_107(int iParam0) // Position - 0x548B Hash - 0x67684612 ^0x25640750
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_108(int iParam0, int iParam1) // Position - 0x54E9 Hash - 0xEA9A7255 ^0xEA9A7255
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0) // Position - 0x58D1 Hash - 0x325A480B ^0x325A480B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_110(int iParam0) // Position - 0x5923 Hash - 0xAAD68AF2 ^0xDCF4A759
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_111(int iParam0, int iParam1) // Position - 0x5985 Hash - 0x6288DC5 ^0x6288DC5
{
	switch (iParam0)
	{
		case 0:
...
Hash func_112(int iParam0, int iParam1) // Position - 0x5AA5 Hash - 0xB925B99 ^0x792CDA95
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_113(int iParam0, int iParam1) // Position - 0x5B1A Hash - 0x23EAC636 ^0x23EAC636
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0) // Position - 0x5DBF Hash - 0x3FB2C67 ^0x3FB2C67
{
	switch (iParam0)
	{
		case 0:
...
float func_115(var uParam0) // Position - 0x5E13 Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_116(var uParam0) // Position - 0x5E20 Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
int func_117(var uParam0) // Position - 0x5E2D Hash - 0x8E8FC7AE ^0x8E8FC7AE
{
	int num;
...
BOOL func_118(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5E3B Hash - 0xE7F7CC3B ^0xE7F7CC3B
{
	int i;
	float num;
...
float func_119(var uParam0) // Position - 0x5E96 Hash - 0x236039AD ^0x236039AD
{
	float num;
...
BOOL func_120(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5EA3 Hash - 0xE7F7CC3B ^0xE7F7CC3B
{
	int i;
	float num;
...
float func_121(var uParam0) // Position - 0x5EFE Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_122(var uParam0) // Position - 0x5F0B Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
float func_123(var uParam0) // Position - 0x5F18 Hash - 0x236039AD ^0x236039AD
{
	float num;
...
float func_124(var uParam0) // Position - 0x5F25 Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_125(var uParam0) // Position - 0x5F32 Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
float func_126(var uParam0) // Position - 0x5F3F Hash - 0x236039AD ^0x236039AD
{
	float num;
...
float func_127(var uParam0) // Position - 0x5F4C Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_128(var uParam0) // Position - 0x5F59 Hash - 0xEAAEEB54 ^0xEAAEEB54
{
	float num;
...
BOOL func_129(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5F66 Hash - 0x6C1C9B04 ^0x6C1C9B04
{
	float num;
...
float func_130(var uParam0) // Position - 0x5FA7 Hash - 0x236039AD ^0x236039AD
{
	float num;
...
BOOL func_131(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4) // Position - 0x5FB4 Hash - 0x6C1C9B04 ^0x6C1C9B04
{
	float num;
...
float func_132(var uParam0) // Position - 0x5FF5 Hash - 0xC1711080 ^0xC1711080
{
	float num;
...
float func_133(var uParam0) // Position - 0x6002 Hash - 0xEAAEEB54 ^0xEAAEEB54
{
	float num;
...
BOOL func_134(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6) // Position - 0x600F Hash - 0x8B5B4DA7 ^0x8B5B4DA7
{
	int num;
	int num2;
	float num3;
...
float func_135(var uParam0) // Position - 0x607B Hash - 0x236039AD ^0x236039AD
{
	float num;
...
BOOL func_136(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6) // Position - 0x6088 Hash - 0x8B5B4DA7 ^0x8B5B4DA7
{
	int num;
	int num2;
	float num3;
...
float func_137(var uParam0) // Position - 0x60F4 Hash - 0xD3540869 ^0xD3540869
{
	float num;
...
float func_138(var uParam0) // Position - 0x6105 Hash - 0x6453E6F9 ^0x6453E6F9
{
	float num;
...
float func_139(var uParam0) // Position - 0x6112 Hash - 0x236039AD ^0x236039AD
{
	float num;
...
char* func_140(int iParam0) // Position - 0x611F Hash - 0xE5247562 ^0xC9A48854
{
	switch (iParam0)
	{
		case 0:
...
char* func_141() // Position - 0x6167 Hash - 0x306ACA3A ^0x3C857FCC
{
	return "script@shows@curtains@curtains";
}

BOOL func_142(AnimScene ansParam0, char* sParam1, char* sParam2) // Position - 0x6173 Hash - 0xCB8E51DD ^0xC86E966C
{
...
void func_143(var uParam0, int iParam1) // Position - 0x61BD Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

char* func_144() // Position - 0x61CA Hash - 0x872D172F ^0x872D172F
{
	return "CURTAIN";
}

void func_145(AnimScene ansParam0, char* sParam1, char* sParam2) // Position - 0x61D5 Hash - 0xD500305B ^0x58F85F30
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(ansParam0))
		return;
...
void func_146(AnimScene ansParam0, char* sParam1, char* sParam2) // Position - 0x61F3 Hash - 0xC0246FAB ^0x902BB279
{
	if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(ansParam0, sParam1))
...
int func_147() // Position - 0x620F Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_148(int iParam0) // Position - 0x621E Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

BOOL func_149(int iParam0, int iParam1) // Position - 0x6234 Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_148(iParam0))
		return false;
...
BOOL func_150(int iParam0) // Position - 0x6257 Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_148(iParam0))
		return false;
...
BOOL func_151(int iParam0) // Position - 0x628F Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_148(iParam0))
		return false;
...
void func_152(int iParam0) // Position - 0x62AF Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_153(int iParam0) // Position - 0x6318 Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

BOOL func_154() // Position - 0x6328 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_260() != -1)
		return false;
...
void func_155(var uParam0, Ped pedParam1, char* sParam2, BOOL bParam3) // Position - 0x634D Hash - 0x5AD955B5 ^0x43BD5215
{
...
char* func_156(int iParam0) // Position - 0x63AA Hash - 0xE5247562 ^0x642F5AF9
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			return "Pl_BreathFail";
	
		case 2:
			return "Pl_BreathLoop";
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x63F2 Hash - 0xA17D549C ^0xE4BBBB0D
{
	switch (iParam0)
	{
		case 0:
			return "CROWD_FIREBREATHER_01";
	
		case 1:
			return "CROWD_FIREBREATHER_02";
	
		case 2:
			return "CROWD_FIREBREATHER_03";
	
		case 3:
			return "CROWD_FIREBREATHER_04";
	
		case 4:
			return "CROWD_FIREBREATHER_05";
	
		case 5:
			return "CROWD_FIREBREATHER_06";
	
		case 6:
			return "CROWD_FIREBREATHER_07";
	
		case 7:
			return "CROWD_FIREBREATHER_08";
	
		case 8:
			return "CROWD_FIREBREATHER_09";
	
		case 9:
			return "CROWD_FIREBREATHER_10";
	
		case 10:
			return "CROWD_FIREBREATHER_11";
...
char* func_158() // Position - 0x64BC Hash - 0x306ACA3A ^0x950CD7EA
{
	return "script_shows@show_audience@ig_arthur_applause";
}

BOOL func_159(var uParam0) // Position - 0x64C8 Hash - 0x17F3724D ^0x8DFD2B6D
{
	return PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY();
}

BOOL func_160(var uParam0) // Position - 0x64D4 Hash - 0x17A65E61 ^0x57FEE670
{
	BOOL flag;
	char* streamName;
	char* soundSet;
...
BOOL func_161(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0x65A1 Hash - 0xC5676B3C ^0xD21EACDC
{
...
char* func_162() // Position - 0x65E8 Hash - 0x306ACA3A ^0x3C857FCC
{
	return "script@shows@curtains@curtains";
}

char* func_163(int iParam0) // Position - 0x65F4 Hash - 0xE5247562 ^0xC9A48854
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_164(var uParam0, Object obParam1, char* sParam2, char* sParam3, BOOL bParam4) // Position - 0x663C Hash - 0x94342835 ^0x77ACD9C8
{
...
BOOL func_165(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x66A2 Hash - 0xB799E1C5 ^0x99EEAD6
{
	BOOL flag;
	BOOL flag2;
	Hash hash;
...
BOOL func_166(var uParam0) // Position - 0x6732 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_167(var uParam0) // Position - 0x673B Hash - 0x923B7FA7 ^0x14FA47E1
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66[0]))
		uParam0->f_66[0] = OBJECT::CREATE_OBJECT(uParam0->f_58[0], func_269(0), true, true, false, false, true);

	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66[1]))
		uParam0->f_66[1] = OBJECT::CREATE_OBJECT(uParam0->f_58[1], func_269(1), true, true, false, false, true);

	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66[2]))
		uParam0->f_66[2] = OBJECT::CREATE_OBJECT(uParam0->f_58[2], func_269(2), true, true, false, false, true);

	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66[3]))
		uParam0->f_66[3] = OBJECT::CREATE_OBJECT(uParam0->f_58[3], func_269(3), true, true, false, false, true);

	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66[4]))
		uParam0->f_66[4] = OBJECT::CREATE_OBJECT(uParam0->f_58[4], func_269(4), true, true, false, false, true);
...
void func_168(var uParam0) // Position - 0x685B Hash - 0x9A4045F5 ^0x2EC8C8E2
{
	...
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_48, "STICK_0_", uParam0->f_66[1], 0);
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_48, "STICK_1_", uParam0->f_66[2], 0);
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_48, "TABLE", uParam0->f_66[3], 0);
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_48, "lantern", uParam0->f_66[4], 0);
	return;
}

struct<11> func_169(int iParam0, int iParam1) // Position - 0x68DB Hash - 0x640FE314 ^0xBFF01F02
{
	var unk;
...
BOOL func_170(int iParam0, int iParam1) // Position - 0x6DBE Hash - 0xDDF24FD9 ^0xDDF24FD9
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x6F86 Hash - 0xA17D549C ^0x655EF608
{
	switch (iParam0)
	{
		case 0:
...
char* func_172(int iParam0, var uParam1) // Position - 0x7036 Hash - 0x33D51A90 ^0xA0D86898
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_173(var uParam0, char* sParam1, const char* sParam2) // Position - 0x706E Hash - 0x5AA55923 ^0xA2744C11
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(*uParam0) && ANIMSCENE::IS_ANIM_SCENE_LOADED(*uParam0, true, false))
	{
		uParam0->f_1 = 1;
...
int func_174(int iParam0) // Position - 0x70B8 Hash - 0x6C1105E8 ^0x6C1105E8
{
	switch (iParam0)
	{
		case 0:
...
Hash func_175(int iParam0) // Position - 0x7107 Hash - 0x8936E2F ^0xA7619EF8
{
	switch (iParam0)
	{
		case 0:
...
int func_176(int iParam0, int iParam1) // Position - 0x715F Hash - 0xCB2712C7 ^0xCB2712C7
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_177(int iParam0, int iParam1) // Position - 0x7226 Hash - 0xEA9A7255 ^0xEA9A7255
{
	switch (iParam0)
	{
		case 0:
...
float func_178(int iParam0, int iParam1) // Position - 0x7CEB Hash - 0x70FF660 ^0x70FF660
{
	switch (iParam0)
	{
		case 0:
...
int func_179(int iParam0, int iParam1) // Position - 0x821C Hash - 0x72143BA7 ^0x72143BA7
{
	switch (iParam0)
	{
		case 0:
...
Ped func_180(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x82DF Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_272(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_181(var uParam0, int iParam1) // Position - 0x8321 Hash - 0xDC1ED3D3 ^0x1092D668
{
	int i;
	Vector3 vector;
	...
	if (func_273(iParam1) != -1)
	{
		...
		for (i = 0; i <= func_273(iParam1); i = i + 1)
		{
			if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_22[i]))
			{
				vector = { func_274(iParam1, i) };
...
BOOL func_182(int iParam0, int iParam1) // Position - 0x83D2 Hash - 0xF5E57FDF ^0xF5E57FDF
{
	switch (iParam1)
	{
		case 0:
...
char* func_183(int iParam0, int iParam1, int iParam2) // Position - 0x85E7 Hash - 0x86DE4110 ^0x1FAC43D9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(int iParam0) // Position - 0x8C9F Hash - 0xE4A49BB0 ^0xE4A49BB0
{
	switch (iParam0)
	{
		case 0:
...
void func_185(var uParam0, int iParam1) // Position - 0x8CDE Hash - 0x30F6C7D6 ^0xB9013AB2
{
...
void func_186(var uParam0, int iParam1) // Position - 0x8D1B Hash - 0xB01519E8 ^0x4AC2559B
{
	int num;
	Vector3 vector;
	float num2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		...
		vector2 = { 0f, 0f, num2 };
		num3 = func_275(iParam1, uParam0->f_2);
		uParam0->f_5 = 1;
		uParam0->f_6 = -1;
		uParam0->f_7 = func_276(uParam0->f_5);
		uParam0->f_8 = func_277(uParam0->f_5, num, num3);
	
		if (num3 == 0)
			TASK::TASK_PLAY_ANIM_ADVANCED(*uParam0, uParam0->f_7, uParam0->f_8, vector, vector2, 1000f, -1000f, -1, 49153, func_278(), 2, 1, 0);
		else
			TASK::TASK_PLAY_ANIM_ADVANCED(*uParam0, uParam0->f_7, uParam0->f_8, vector, vector2, 1000f, -1000f, -1, 49153, func_278(), 2, 0, 0);
	}

	return;
}

void func_187(Entity eParam0, int iParam1) // Position - 0x8DF4 Hash - 0x9F3718A3 ^0x7EA7A911
{
	BOOL _int;
...
BOOL func_188(int iParam0, int iParam1) // Position - 0x8E36 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_189(var uParam0, float fParam1) // Position - 0x8E45 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_190(var uParam0) // Position - 0x8E6B Hash - 0x39705408 ^0x39705408
{
	return func_188(*uParam0, 2);
}

float func_191() // Position - 0x8E7B Hash - 0xB5A1F69B ^0x5409CF38
{
...
BOOL func_192(int iParam0) // Position - 0x8EAD Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 1:
...
void func_193(var uParam0, int iParam1) // Position - 0x8ED1 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

ePedType func_194() // Position - 0x8EDE Hash - 0x9F572D68 ^0xB6D7BD8
{
	return joaat("s_m_m_magiclantern_01");
}

Hash func_195(int iParam0) // Position - 0x8EEB Hash - 0xF3E1A6C ^0x79245C78
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_196(int iParam0) // Position - 0x8F26 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 3:
...
Vector3 func_197(int iParam0) // Position - 0x8F41 Hash - 0x9E6D5F11 ^0x9E6D5F11
{
	switch (iParam0)
	{
		case 0:
...
float func_198(int iParam0) // Position - 0x8FC0 Hash - 0x930951C2 ^0x930951C2
{
	switch (iParam0)
	{
		case 0:
...
Hash func_199(int iParam0) // Position - 0x9013 Hash - 0xE65A3A10 ^0xEC1D0249
{
	switch (iParam0)
	{
		case 3:
...
void func_200(Ped pedParam0, Hash hParam1) // Position - 0x9032 Hash - 0xEA1C858E ^0x3A54E22D
{
...
Vector3 func_201(int iParam0) // Position - 0x90DC Hash - 0x563C355B ^0x563C355B
{
	switch (iParam0)
	{
		case 0:
...
char* func_202(int iParam0) // Position - 0x9173 Hash - 0xE6862179 ^0x52539E7D
{
	switch (iParam0)
	{
		case 21:
...
char* func_203(int iParam0, int iParam1) // Position - 0x91F5 Hash - 0xAE0CA7E3 ^0xBDEB1F95
{
	switch (iParam0)
	{
		case 21:
...
Vector3 func_204(int iParam0) // Position - 0x933F Hash - 0xC00A6A6A ^0xC00A6A6A
{
	switch (iParam0)
	{
		case 21:
...
Vector3 func_205(int iParam0) // Position - 0x93C4 Hash - 0x3BB58CB4 ^0x3BB58CB4
{
	switch (iParam0)
	{
		case 21:
...
char* func_206(int iParam0) // Position - 0x9435 Hash - 0xE6862179 ^0x94C8932D
{
	switch (iParam0)
	{
		case 21:
...
char* func_207(int iParam0, int iParam1) // Position - 0x94B7 Hash - 0x2835CAF3 ^0xA194646C
{
	switch (iParam0)
	{
		case 21:
...
int func_208(var uParam0, var uParam1, int iParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, Hash hParam10, BOOL bParam11, BOOL bParam12, int iParam13, BOOL bParam14, BOOL bParam15) // Position - 0x9683 Hash - 0x1CD7D100 ^0xAEA25770
{
	Volume volume;
	int num;
	...
	num = func_286(uParam0, uParam1, iParam2, volume, bParam7, bParam8, bParam9, hParam10, bParam11, bParam12, bParam14, bParam15);
	func_287(volume);
	return num;
}

int func_209() // Position - 0x96E1 Hash - 0xE698BCC8 ^0x3E64CD04
{
	int networkTimeAccurate;
...
char* func_210(int iParam0) // Position - 0x96FF Hash - 0xE6862179 ^0x4DAF1996
{
	switch (iParam0)
	{
		case 21:
...
void func_211() // Position - 0x9821 Hash - 0xBBF53F6B ^0xF8AE51A1
{
...
void func_212() // Position - 0x984D Hash - 0xBBF53F6B ^0x6B344E82
{
...
char* func_213(int iParam0) // Position - 0x9879 Hash - 0xE5247562 ^0x7007D2A2
{
	switch (iParam0)
	{
		case 0:
...
void func_214(var uParam0, var uParam1, int iParam2) // Position - 0x98C7 Hash - 0xEBFB8122 ^0x59B1DD4D
{
	BOOL flag;
	int num;
	float num2;
	...
	for (i = 0; i <= num - 1; i = i + 1)
	{
		...
		else
		{
			...
			{
				if (func_288(*uParam0, i) && uParam1->[i /*10*/].f_1 != 5)
					uParam1->[i /*10*/].f_1 = 5;
			}
			else if (func_288(*uParam0, i) && uParam1->[i /*10*/].f_1 == 5)
			{
				func_289(&(uParam0->f_11), 0);
				uParam1->[i /*10*/].f_1 = 3;
			}
		
			if (uParam0->f_19 && func_290(iParam2))
			{
				if (!func_40(&(uParam0->f_8)))
				{
				...
				{
					if (func_291(iParam2, i) >= 0f && num2 > func_291(iParam2, i))
						uParam1->[i /*10*/].f_1 = 7;
				}
			}
		
			if (!uParam0->f_19 && !func_288(*uParam0, i) && uParam1->[i /*10*/].f_1 != 5)
			{
				if (uParam1->[i /*10*/].f_9)
				{
					num3 = func_292(Global_35, uParam1->[i /*10*/], true, true);
				
					if (num3 > 2f || !func_293(&uParam1->[i /*10*/]))
					{
						uParam1->[i /*10*/].f_9 = 0;
						uParam0->f_21 = 0;
						uParam1->[i /*10*/].f_5 = 2;
				...
				else if (!uParam0->f_21 && uParam1->[i /*10*/].f_1 != 6)
				{
					...
					if (num3 < 1.5f && func_293(&uParam1->[i /*10*/]))
					{
						uParam1->[i /*10*/].f_5 = func_295(i);
						func_294(&uParam1->[i /*10*/], iParam2);
						uParam1->[i /*10*/].f_9 = 1;
						uParam0->f_21 = 1;
					}
			...
			switch (uParam1->[i /*10*/].f_1)
			{
				...
				case 1:
					if (func_296(iParam2, i))
						func_298(&uParam1->[i /*10*/], func_297(iParam2), 500);
					break;
				...
				case 7:
					...
					if (func_275(iParam2, i) == 0 && !func_184(iParam2))
					{
						TASK::TASK_START_SCENARIO_AT_POSITION(uParam1->[i /*10*/], joaat("PROP_HUMAN_SEAT_CHAIR"), func_177(iParam2, i), func_178(iParam2, i), -1, false, true, 0, 0.25f, false);
				...
				case 8:
					if (ENTITY::DOES_ENTITY_EXIST(uParam1->[i /*10*/]) && !ENTITY::IS_ENTITY_DEAD(uParam1->[i /*10*/]))
					{
						...
						else if (num2 > func_291(iParam2, i) + 2f)
						{
							uParam1->[i /*10*/].f_1 = 9;
						}
					}
				...
				case 9:
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam1->[i /*10*/], func_301(iParam2), 1f, -1, 0.25f, 5373953, 1193033728);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam1->[i /*10*/], false, false);
						uParam1->[i /*10*/].f_1 = 10;
					}
					break;
				...
				case 10:
					...
					if (func_253(iParam2))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(uParam1->[i /*10*/], 658540077, true) == 1)
							uParam1->[i /*10*/].f_1 = 11;
						else if (num2 > func_291(iParam2, i) + 3f)
							uParam1->[i /*10*/].f_1 = 9;
					}
					else if (!func_302(ENTITY::GET_ENTITY_COORDS(uParam1->[i /*10*/], true, false)))
					{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(uParam1->[i /*10*/], SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD, true) != 1 && num2 > func_291(iParam2, i) + 3f)
					{
						uParam1->[i /*10*/].f_1 = 9;
					}
					break;
...
struct<21> func_215(int iParam0, int iParam1, int iParam2) // Position - 0xA0FB Hash - 0xDD2C6FC5 ^0xD601AFE6
{
	var unk;
...
void func_216(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23) // Position - 0xE6F6 Hash - 0x7214C603 ^0x36D9EF04
{
	int num;
	int i;
	int j;
...
Vector3 func_217(float fParam0, var uParam1, var uParam2) // Position - 0xE8A4 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
float func_218(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE8E3 Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

void func_219(var uParam0) // Position - 0xE904 Hash - 0x5DE504EA ^0x21277A8E
{
	var args;
...
void func_220(var uParam0) // Position - 0xE9A0 Hash - 0x9D2BD848 ^0x9D2BD848
{
...
void func_221(var uParam0, int iParam1) // Position - 0xE9FF Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

var func_222(var uParam0) // Position - 0xEA0C Hash - 0xC9D82232 ^0xC9D82232
{
	return uParam0;
}

BOOL func_223(int iParam0) // Position - 0xEA16 Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
int func_224(var uParam0, Ped pedParam1) // Position - 0xEA55 Hash - 0x513DF076 ^0x2F552737
{
	...
	HUD::_UI_PROMPT_SET_GROUP(Global_1945188[func_303(uParam0->f_1053[1]) /*18*/].f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_12), 0);

	if (!func_231(&uParam0->f_1053[0], pedParam1, "SHOW_NEG_RESPONSE", joaat("INPUT_INTERACT_LOCKON_NEG")))
		return 0;

	HUD::_UI_PROMPT_SET_GROUP(Global_1945188[func_303(uParam0->f_1053[0]) /*18*/].f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_12), 0);
	return 1;
}

void func_225(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEAFC Hash - 0x89AE2BEC ^0x89AE2BEC
{
	int num;
...
BOOL func_226(int iParam0, BOOL bParam1) // Position - 0xEB4B Hash - 0xC074CB7F ^0xC074CB7F
{
	if (bParam1 && !func_223(iParam0))
		return false;

	return !func_308(iParam0, 4);
}

BOOL func_227(var uParam0) // Position - 0xEB70 Hash - 0x15E2DFC ^0x15E2DFC
{
	if (func_223(*uParam0))
...
BOOL func_228(var uParam0) // Position - 0xEB92 Hash - 0xDF953B98 ^0xC30FD2F3
{
	BOOL flag;
	var unk;
	int randomIntInRange;
	...
	if (func_40(&(uParam0->f_950)) && uParam0->f_18 < func_309(*uParam0) && func_47(&(uParam0->f_950)) > 35000)
	{
		uParam0->f_18 = uParam0->f_18 + 1;
		unk = { func_310(*uParam0, 0, true) };
		flag = true;
	}
	else if (func_311(*uParam0) && !func_312(36))
	{
		randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, 10);
	
		if (randomIntInRange < 5)
			unk = { func_310(*uParam0, 2, true) };
		else
			unk = { func_310(*uParam0, 1, true) };
	}
	else
	{
		unk = { func_310(*uParam0, 1, true) };
	...
	if (func_313(uParam0))
		unk = { func_310(*uParam0, 3, true) };

	if (func_314(&(uParam0->f_954), unk, true, -1, false, false))
	{
...
void func_229() // Position - 0xEC95 Hash - 0x8056105 ^0x876D2D3C
{
	BOOL flag;
	...
	if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1) || func_312(36) && ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1))
		flag = true;

	if (!flag)
		TASK::TASK_PLAY_ANIM(Global_35, func_158(), func_316(1), 1090519040, -1056964608, -1, 0, 0, false, 0, false, 0, false);
	else
		TASK::TASK_PLAY_ANIM(Global_35, func_158(), func_316(0), 8f, -8f, -1, 67108880, 0, false, 1114114, false, 0, false);

	return;
}

BOOL func_230(var uParam0) // Position - 0xED2F Hash - 0xDF953B98 ^0x1A149465
{
	BOOL flag;
	var unk;
	int randomIntInRange;
	...
	if (func_40(&(uParam0->f_950)) && uParam0->f_19 < func_309(*uParam0) && func_47(&(uParam0->f_950)) > 35000)
	{
		uParam0->f_19 = uParam0->f_19 + 1;
		unk = { func_310(*uParam0, 0, false) };
		flag = true;
	}
	else if (func_311(*uParam0) && !func_312(36))
	{
		...
		if (randomIntInRange < 5)
			unk = { func_310(*uParam0, 2, false) };
		else
			unk = { func_310(*uParam0, 1, false) };
	}
	else
	{
		unk = { func_310(*uParam0, 1, false) };
...
BOOL func_231(var uParam0, Ped pedParam1, char* sParam2, Hash hParam3) // Position - 0xEE32 Hash - 0x9E8CD956 ^0x6E55E820
{
	if (!func_223(*uParam0))
		*uParam0 = func_318(sParam2, hParam3, *pedParam1, 1, 0, false, 0, 0, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), false, false);
...
Hash func_232(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xEE82 Hash - 0xDD2F88C2 ^0x29E97850
{
	Hash weaponHash;
...
BOOL func_233(Hash hParam0) // Position - 0xEEC4 Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

BOOL func_234(int iParam0, BOOL bParam1) // Position - 0xEEDF Hash - 0xAAB142C4 ^0x20EFEF89
{
	int num;
...
void func_235(var uParam0) // Position - 0xEF12 Hash - 0x5DE504EA ^0x21277A8E
{
	var args;
...
void func_236(var uParam0) // Position - 0xEFAE Hash - 0xBDD5BF87 ^0x876AC40F
{
	int i;
	int num;
	int num2;

	switch (iLocal_1141.f_8)
	{
		case 0:
			for (i = 0; i <= 10; i = i + 1)
			{
				...
				if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_81[0], iLocal_1141.f_9[num]))
				{
					if (num == 1)
						func_7(&(Global_1394141.f_1326), 32768);
				
					Global_1394141.f_1332 = func_319(num);
				}
			}
			break;
	
		case 1:
			if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_81[0], iLocal_1141.f_9[13]))
				Global_1394141.f_1332 = func_319(13);
			break;
		...
		case 3:
			for (i = 11; i <= 12; i = i + 1)
			{
				...
				if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_81[0], iLocal_1141.f_9[num2]))
					Global_1394141.f_1332 = func_319(num2);
			}
			break;
	}
...
void func_237(var uParam0, int iParam1) // Position - 0xF095 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

void func_238(BOOL bParam0) // Position - 0xF0A2 Hash - 0x3831B75B ^0x47AC778A
{
	if (bParam0)
...
void func_239(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF0DA Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
Vector3 func_240(int iParam0, int iParam1) // Position - 0xF12E Hash - 0x23EAC636 ^0x23EAC636
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_241(int iParam0, int iParam1) // Position - 0xF2AB Hash - 0x33A93AC2 ^0x33A93AC2
{
	switch (iParam0)
	{
		case 0:
...
void func_242(var uParam0, int iParam1) // Position - 0xF400 Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

int func_243(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, int iParam10, Hash hParam11, BOOL bParam12) // Position - 0xF40D Hash - 0x6B838E14 ^0xADF883E0
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_321(num, hParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, bParam9, false, 0, hParam11, bParam12);
		return num;
	}
...
void func_244(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF493 Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
BOOL func_245(int iParam0, BOOL bParam1) // Position - 0xF4DE Hash - 0x4D69B900 ^0x415C6741
{
	int num;
...
void func_246(var uParam0) // Position - 0xF536 Hash - 0xD2CD4C63 ^0xD2CD4C63
{
	int num;
	int i;
	...
	for (i = 0; i <= num - 1; i = i + 1)
	{
		func_322(uParam0->[i /*10*/]);
	}

	return;
}

void func_247(var uParam0, int iParam1, int iParam2) // Position - 0xF565 Hash - 0x86676F62 ^0x645EBD89
{
	int i;
...
eStackSize func_248() // Position - 0xF5D1 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

BOOL func_249() // Position - 0xF5DF Hash - 0x5B04702E ^0xC214C9C1
{
	Interior interiorAtCoords;
	BOOL flag;
...
BOOL func_250(Hash hParam0) // Position - 0xF654 Hash - 0xD46620F0 ^0x47EF7B12
{
	func_323(hParam0, false, false);
...
BOOL func_251(Hash hParam0) // Position - 0xF68B Hash - 0xB710720E ^0xB710720E
{
	return func_325(hParam0, 23);
}

void func_252(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0xF69B Hash - 0xD777F4CF ^0xBFF3124C
{
	func_323(hParam0, false, false);
	...
	if (func_324(hParam0))
	{
		...
		if (bParam3)
			func_326(hParam0, iParam2, true, bParam6);
		else if (bParam1)
			if (bParam4)
...
BOOL func_253(int iParam0) // Position - 0xF726 Hash - 0xD6BB6FB5 ^0xD6BB6FB5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_254(Hash hParam0) // Position - 0xF765 Hash - 0x783D8692 ^0xC2190628
{
	func_323(hParam0, false, false);
...
BOOL func_255(Hash hParam0) // Position - 0xF78D Hash - 0x51587F69 ^0xAFC63473
{
	func_323(hParam0, false, false);
...
void func_256(var uParam0) // Position - 0xF7B6 Hash - 0xB3099499 ^0xA439833A
{
	int i;
...
eStackSize func_257() // Position - 0xF7FE Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_258(eStackSize essParam0, eStackSize essParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xF80A Hash - 0x38DA000F ^0x38DA000F
{
	int num;
	int num2;
	int num3;
	...
	if (func_331(essParam0, essParam1, true))
	{
		num = func_332(essParam1);
		num2 = func_333(essParam0);
		num3 = func_333(essParam0) - func_333(essParam1);
		num4 = func_332(essParam0) - func_332(essParam1);
		num5 = func_334(essParam0) - func_334(essParam1);
		num6 = func_335(essParam0) - func_335(essParam1);
		num7 = func_336(essParam0) - func_336(essParam1);
		num8 = func_337(essParam0) - func_337(essParam1);
	}
	else
	{
		num = func_332(essParam0);
		num2 = func_333(essParam1);
		num3 = func_333(essParam1) - func_333(essParam0);
		num4 = func_332(essParam1) - func_332(essParam0);
		num5 = func_334(essParam1) - func_334(essParam0);
		num6 = func_335(essParam1) - func_335(essParam0);
		num7 = func_336(essParam1) - func_336(essParam0);
		num8 = func_337(essParam1) - func_337(essParam0);
	}
	...
	while (num5 < 0)
	{
		...
		num5 = num5 + func_338(num, num2);
		num4 = num4 - 1;
		num = BUILTIN::ROUND(func_339(BUILTIN::TO_FLOAT(num + 1), 0f, 12f));
	}
...
void func_259(int iParam0) // Position - 0xFA0C Hash - 0x3A524DDA ^0x3A524DDA
{
	Global_1900383.f_316 = Global_1900383.f_316 || iParam0;
	return;
}

BOOL func_260() // Position - 0xFA25 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_261() // Position - 0xFA33 Hash - 0x381D116B ^0x4F7CBFEB
{
	Interior interiorAtCoords;
	BOOL flag;
...
void func_262(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xFAA8 Hash - 0xB9FD135E ^0x2A68E0C1
{
	func_323(hParam0, false, false);
...
void func_263(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xFAE1 Hash - 0x5319EC03 ^0xCD317940
{
	float num;
	float num2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			num = num2 / fParam3;
			uParam0->f_2 = func_340(fParam1, uParam0->f_4, num);
...
void func_264(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xFB52 Hash - 0xE583FF9E ^0x51298DC4
{
	float num;
	float lightIntensity;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		...
		{
			num = fParam2 / fParam3;
			uParam0->f_2 = func_340(uParam0->f_3, fParam1, num);
...
BOOL func_265(int iParam0) // Position - 0xFBBC Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_149(iParam0, Global_1310750.f_16072 | 64);
}

void func_266(int iParam0) // Position - 0xFBD4 Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
BOOL func_267(var uParam0, Ped pedParam1, char* sParam2) // Position - 0xFC61 Hash - 0xFB1C2C0E ^0x6794528D
{
	BOOL flag;
	int i;
...
Hash func_268(ePedType eptParam0) // Position - 0xFCDF Hash - 0x5007D79D ^0xB0A0AB80
{
	return joaat("META_OUTFIT_DEFAULT");
}

Vector3 func_269(int iParam0) // Position - 0xFCEC Hash - 0x563C355B ^0x563C355B
{
	switch (iParam0)
	{
		case 0:
			return 2543.209f, -1310.0529f, 49.20665f;
	
		case 1:
			return 2543.209f, -1310.1528f, 49.21665f;
	
		case 2:
			return 2543.209f, -1310.2528f, 49.21665f;
	
		case 3:
			return 2543.6729f, -1308.6016f, 48.6201f;
	
		case 4:
			return 2548.5513f, -1308.5466f, 48.6211f;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0xFD83 Hash - 0xA17D549C ^0xA7EAE87B
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(int iParam0) // Position - 0xFE19 Hash - 0xA17D549C ^0x9271AF84
{
	switch (iParam0)
	{
		case 0:
...
void func_272(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xFEAF Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_343(pedParam0, false);
			flag = true;
		}
	
		func_344(pedParam0, iParam2);
	}
...
int func_273(int iParam0) // Position - 0xFF90 Hash - 0x9685BE4A ^0x9685BE4A
{
	switch (iParam0)
	{
		case 0:
...
struct<11> func_274(int iParam0, int iParam1) // Position - 0xFFD3 Hash - 0x6685837 ^0x6685837
{
	var unk;
...
int func_275(int iParam0, int iParam1) // Position - 0x1024D Hash - 0x5F42E2E4 ^0x5F42E2E4
{
	switch (iParam0)
	{
		case 0:
...
char* func_276(int iParam0) // Position - 0x102B2 Hash - 0xCB271E46 ^0xCB271E46
{
	switch (iParam0)
	{
		case 0:
...
char* func_277(int iParam0, int iParam1, int iParam2) // Position - 0x104BB Hash - 0x1CC5D4C0 ^0x5E53EED8
{
	switch (iParam0)
	{
		case 0:
...
float func_278() // Position - 0x11A1D Hash - 0xA456E2CC ^0x9AE2B714
{
	return MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.25f);
}

BOOL func_279(int iParam0) // Position - 0x11A2F Hash - 0xA05361F6 ^0xF8A0FD3E
{
	switch (iParam0)
	{
...
void func_280(var uParam0, int iParam1) // Position - 0x11B45 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_281(var uParam0, int iParam1) // Position - 0x11B56 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_282(Ped pedParam0, Hash hParam1) // Position - 0x11B6B Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_283(Ped pedParam0, Hash hParam1) // Position - 0x11B99 Hash - 0xA54F3032 ^0xA4C6B6BD
{
	Hash _int;
...
BOOL func_284(Ped pedParam0, Hash hParam1) // Position - 0x11BEA Hash - 0xA54F3032 ^0xA4C6B6BD
{
	Hash _int;
	int _int2;
...
void func_285(Ped pedParam0) // Position - 0x11C5C Hash - 0x446F1BDD ^0xE4F35F1E
{
...
int func_286(var uParam0, var uParam1, int iParam2, Volume volParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, Hash hParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0x11C7A Hash - 0x27EEDACD ^0xD08EAB77
{
	ItemSet itemSet;
	...
	if (entitiesInVolume > 0)
	{
		for (i = 0; i < entitiesInVolume; i = i + 1)
		{
			...
			{
				if (func_462(ped, bParam4, bParam6, bParam8, bParam9, bParam10) && !DECORATOR::DECOR_EXIST_ON(ped, "bIgnoreThisPed"))
				{
					if (!func_463(ped, uParam1))
					{
						flag = false;
...
void func_287(Volume volParam0) // Position - 0x11D8F Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_288(int iParam0, int iParam1) // Position - 0x11DA6 Hash - 0xFAECB30D ^0xFAECB30D
{
	switch (iParam0)
	{
		case 9:
...
void func_289(var uParam0, int iParam1) // Position - 0x11E3E Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

int func_290(int iParam0) // Position - 0x11E4B Hash - 0xCD657E63 ^0x35128233
{
	switch (iParam0)
	{
		case 0:
			if (func_464(Global_1835011[36 /*74*/].f_1))
				return 0;
			else
				return 1;
			break;
...
float func_291(int iParam0, int iParam1) // Position - 0x11EA5 Hash - 0x14C48482 ^0x14C48482
{
	switch (iParam0)
	{
		case 0:
...
float func_292(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x124A6 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_293(var uParam0) // Position - 0x124EE Hash - 0x76491A38 ^0x60C35CA3
{
	var entityCoords;
	var unk3;
	var unk6;
...
void func_294(Ped* ppedParam0, int iParam1) // Position - 0x1255B Hash - 0xE100D481 ^0xD397D024
{
	int num;
	Vector3 vector;
	float num2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0) && !ppedParam0->f_9 && ppedParam0->f_5 != -1)
	{
		...
		vector2 = { 0f, 0f, num2 };
		num3 = func_275(iParam1, ppedParam0->f_2);
		ppedParam0->f_6 = -1;
		ppedParam0->f_7 = func_276(ppedParam0->f_5);
		ppedParam0->f_8 = func_277(ppedParam0->f_5, num, num3);
	
		if (num3 == 0)
			TASK::TASK_PLAY_ANIM_ADVANCED(*ppedParam0, ppedParam0->f_7, ppedParam0->f_8, vector, vector2, 0.75f, -0.75f, -1, 49153, func_278(), 2, 1, 0);
		else
			TASK::TASK_PLAY_ANIM_ADVANCED(*ppedParam0, ppedParam0->f_7, ppedParam0->f_8, vector, vector2, 0.75f, -0.75f, -1, 49153, func_278(), 2, 0, 0);
	}
...
int func_295(int iParam0) // Position - 0x12656 Hash - 0xE431F5ED ^0xE431F5ED
{
	if (iParam0 <= 26)
		return 15;
...
BOOL func_296(int iParam0, int iParam1) // Position - 0x1269E Hash - 0xDA7AE58E ^0xDA7AE58E
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_297(int iParam0) // Position - 0x12A8F Hash - 0x1F48C82A ^0x1F48C82A
{
	switch (iParam0)
	{
		case 0:
...
void func_298(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x12B05 Hash - 0x62D0D0BF ^0xF17935FD
{
	var args;
...
void func_299(var uParam0, int iParam1) // Position - 0x12B84 Hash - 0xD1617FB3 ^0x45B85FC
{
	int num;
	Vector3 vector;
	float num2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && uParam0->f_6 != -1 && !uParam0->f_9)
	{
		...
		if (uParam0->f_6 == 26)
		{
			num4 = func_465(uParam0->f_2);
			uParam0->f_6 = num4;
			uParam0->f_7 = func_276(uParam0->f_6);
			uParam0->f_8 = func_277(uParam0->f_6, num, num3);
		}
		else if (uParam0->f_6 == 31)
		{
			num5 = func_466(uParam0->f_2);
			uParam0->f_6 = num5;
			uParam0->f_7 = func_276(uParam0->f_6);
			uParam0->f_8 = func_277(uParam0->f_6, num, num3);
		}
...
void func_300(var uParam0, Ped* ppedParam1) // Position - 0x12CD2 Hash - 0x82C823ED ^0xECBE4079
{
	float animScenePhase;
	BOOL flag;
			...
			if (flag)
			{
				switch (uParam0->f_11)
				{
					...
					case 1:
						...
						{
							func_294(ppedParam1, 0);
							func_289(&(uParam0->f_11), 2);
						}
						break;
		...
		case 12:
			if (flag)
			{
				switch (uParam0->f_11)
				{
					...
					case 2:
						if (func_467(*ppedParam1, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
						{
...
Vector3 func_301(int iParam0) // Position - 0x130CF Hash - 0x4CB488BA ^0x4CB488BA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_302(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x13148 Hash - 0xFA2BBA1 ^0xB0883B47
{
...
int func_303(int iParam0) // Position - 0x13174 Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

void func_304(int iParam0, int iParam1) // Position - 0x1317E Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_305(int iParam0, BOOL bParam1) // Position - 0x131B1 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
		if (Global_1945188[iParam0 /*18*/].f_5 == 5 && !func_308(iParam0, 8))
...
void func_306(int iParam0, BOOL bParam1) // Position - 0x13209 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_307(int iParam0, int iParam1) // Position - 0x13232 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
BOOL func_308(int iParam0, int iParam1) // Position - 0x1325A Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
int func_309(int iParam0) // Position - 0x1327B Hash - 0xA4ACC31E ^0xA4ACC31E
{
	switch (iParam0)
	{
		case 5:
...
Vector3 func_310(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1332C Hash - 0x375D51FB ^0x375D51FB
{
	var unk;
...
BOOL func_311(int iParam0) // Position - 0x14473 Hash - 0x8435905 ^0x8435905
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_312(int iParam0) // Position - 0x144EC Hash - 0xBF7DEF91 ^0x6E26B7C2
{
...
BOOL func_313(var uParam0) // Position - 0x14518 Hash - 0x7C604A1E ^0x4A07090F
{
	float animScenePhase;
...
BOOL func_314(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x146C7 Hash - 0x4863E989 ^0xB2E91EEF
{
	BOOL flag;
...
void func_315(var uParam0) // Position - 0x14721 Hash - 0x6C9C0A43 ^0x6C9C0A43
{
...
char* func_316(int iParam0) // Position - 0x14794 Hash - 0x958AD60F ^0xFD0B2B81
{
	switch (iParam0)
	{
		case 0:
...
void func_317(var uParam0) // Position - 0x147C2 Hash - 0x1C1CF337 ^0x1C1CF337
{
	switch (uParam0->f_1052)
	{
		case -4:
...
int func_318(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, BOOL bParam16) // Position - 0x1484B Hash - 0xA9244E74 ^0xC0A4C4ED
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_321(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, iParam8, 0, pedParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, bParam16);
		return num;
	}
...
int func_319(int iParam0) // Position - 0x14922 Hash - 0x6D3B16F0 ^0x6D3B16F0
{
	switch (iParam0)
	{
		case 0:
...
void func_320(int iParam0) // Position - 0x149CD Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_470(iParam0))
		return;
...
void func_321(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, int iParam9, Volume volParam10, Ped pedParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0x14A80 Hash - 0x1B501888 ^0x6546232B
{
	Prompt prompt;
	...
	func_306(iParam0, true);
	func_307(iParam0, 128);
	return;
}

void func_322(Ped pedParam0) // Position - 0x14D26 Hash - 0x5C592C2B ^0x4255940A
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
Hash func_323(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x14D56 Hash - 0xEC5804B5 ^0x15A1D925
{
...
BOOL func_324(Hash hParam0) // Position - 0x14DFA Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_471(hParam0))
...
BOOL func_325(Hash hParam0, int iParam1) // Position - 0x14E15 Hash - 0xC6E98A5B ^0xE9422008
{
...
void func_326(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x14E5A Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_324(hParam0))
	{
...
void func_327(Hash hParam0, BOOL bParam1) // Position - 0x14E92 Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_324(hParam0))
...
void func_328(Hash hParam0, BOOL bParam1) // Position - 0x14EC0 Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_324(hParam0))
...
void func_329(Hash hParam0, BOOL bParam1) // Position - 0x14EEE Hash - 0x4844A91D ^0x50E23246
{
	if (func_324(hParam0))
...
BOOL func_330() // Position - 0x14F1C Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_331(eStackSize essParam0, eStackSize essParam1, BOOL bParam2) // Position - 0x14F25 Hash - 0x30CEFC86 ^0x30CEFC86
{
	if (bParam2)
		if (!func_472(essParam1) || !func_472(essParam0))
			return true;

	return essParam0 > essParam1;
}

int func_332(eStackSize essParam0) // Position - 0x14F52 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 22) & 15;
}

int func_333(eStackSize essParam0) // Position - 0x14F65 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(essParam0, 26) & 31 * MISC::IS_BIT_SET(essParam0, 31) ? -1 : 1) + 1898;
}

int func_334(eStackSize essParam0) // Position - 0x14F8A Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 17) & 31;
}

int func_335(eStackSize essParam0) // Position - 0x14F9D Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 12) & 31;
}

int func_336(eStackSize essParam0) // Position - 0x14FB0 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 6) & 63;
}

int func_337(eStackSize essParam0) // Position - 0x14FC2 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(essParam0, 0) & 63;
}

int func_338(int iParam0, int iParam1) // Position - 0x14FD4 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
float func_339(float fParam0, float fParam1, float fParam2) // Position - 0x1506E Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
float func_340(float fParam0, float fParam1, float fParam2) // Position - 0x150B0 Hash - 0xC55BBAAC ^0xC55BBAAC
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

BOOL func_341(ePedType eptParam0) // Position - 0x150C5 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_342(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x15518 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_343(Ped pedParam0, BOOL bParam1) // Position - 0x15548 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_344(Ped pedParam0, int iParam1) // Position - 0x1558D Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_345(int iParam0, int iParam1, int iParam2) // Position - 0x155B4 Hash - 0x952E3ACE ^0x952E3ACE
{
	switch (iParam0)
	{
		case 0:
...
char* func_346(int iParam0) // Position - 0x16154 Hash - 0xAFCCB9D8 ^0xAFCCB9D8
{
	switch (iParam0)
	{
		case 0:
...
char* func_347(int iParam0) // Position - 0x161A1 Hash - 0xB7C63976 ^0xB7C63976
{
	switch (iParam0)
	{
		case 0:
...
char* func_348(int iParam0) // Position - 0x161C6 Hash - 0xD91AC249 ^0xD91AC249
{
	switch (iParam0)
	{
		case 0:
...
char* func_349(int iParam0) // Position - 0x161EB Hash - 0xE3BA00A9 ^0xE3BA00A9
{
	switch (iParam0)
	{
		case 0:
...
char* func_350(int iParam0) // Position - 0x1621C Hash - 0x5168CC1A ^0x5168CC1A
{
	switch (iParam0)
	{
		case 0:
...
char* func_351(int iParam0) // Position - 0x1626E Hash - 0x4F4D5C64 ^0x4F4D5C64
{
	switch (iParam0)
	{
		case 0:
...
char* func_352(int iParam0) // Position - 0x16293 Hash - 0xD05F100E ^0xD05F100E
{
	switch (iParam0)
	{
		case 0:
...
char* func_353(int iParam0) // Position - 0x162B8 Hash - 0xB7BD42B4 ^0xB7BD42B4
{
	switch (iParam0)
	{
		case 0:
...
char* func_354(int iParam0) // Position - 0x162E9 Hash - 0x4292CBC0 ^0x4292CBC0
{
	switch (iParam0)
	{
		case 0:
...
char* func_355(int iParam0) // Position - 0x16377 Hash - 0x77D3E78F ^0x77D3E78F
{
	switch (iParam0)
	{
		case 0:
...
char* func_356(int iParam0) // Position - 0x163AB Hash - 0x1F80CDA5 ^0x1F80CDA5
{
	switch (iParam0)
	{
		case 0:
...
char* func_357(int iParam0) // Position - 0x163DF Hash - 0x5448A6DD ^0x5448A6DD
{
	switch (iParam0)
	{
		case 0:
...
char* func_358(int iParam0) // Position - 0x1642C Hash - 0x443BDA30 ^0x443BDA30
{
	switch (iParam0)
	{
		case 0:
...
char* func_359(int iParam0) // Position - 0x1649C Hash - 0x761D2D62 ^0x761D2D62
{
	switch (iParam0)
	{
		case 0:
...
char* func_360(int iParam0) // Position - 0x164D0 Hash - 0xF6127A4F ^0xF6127A4F
{
	switch (iParam0)
	{
		case 0:
...
char* func_361(int iParam0) // Position - 0x16504 Hash - 0xE5183A1D ^0xE5183A1D
{
	switch (iParam0)
	{
		case 0:
...
char* func_362(int iParam0) // Position - 0x16551 Hash - 0xF10B0370 ^0xF10B0370
{
	switch (iParam0)
	{
		case 0:
...
char* func_363(int iParam0) // Position - 0x1659E Hash - 0x1824D955 ^0x1824D955
{
	switch (iParam0)
	{
		case 0:
...
char* func_364(int iParam0) // Position - 0x165C1 Hash - 0x3B0BF74F ^0x3B0BF74F
{
	switch (iParam0)
	{
		case 0:
...
char* func_365(int iParam0) // Position - 0x165E6 Hash - 0xE3BA00A9 ^0xE3BA00A9
{
	switch (iParam0)
	{
		case 0:
...
char* func_366(int iParam0) // Position - 0x16617 Hash - 0xB3FF1847 ^0xB3FF1847
{
	switch (iParam0)
	{
		case 0:
...
char* func_367(int iParam0) // Position - 0x166A0 Hash - 0x8ECEA887 ^0x8ECEA887
{
	switch (iParam0)
	{
		case 0:
...
char* func_368(int iParam0) // Position - 0x166D4 Hash - 0x158F9A1C ^0x158F9A1C
{
	switch (iParam0)
	{
		case 0:
...
char* func_369(int iParam0) // Position - 0x16708 Hash - 0x9F5E2F9 ^0x9F5E2F9
{
	switch (iParam0)
	{
		case 0:
...
char* func_370(int iParam0) // Position - 0x16755 Hash - 0x1123E3E6 ^0x1123E3E6
{
	switch (iParam0)
	{
		case 0:
...
char* func_371(int iParam0) // Position - 0x167C5 Hash - 0x5236CC9C ^0x5236CC9C
{
	switch (iParam0)
	{
		case 0:
...
char* func_372(int iParam0) // Position - 0x167F9 Hash - 0x761D2D62 ^0x761D2D62
{
	switch (iParam0)
	{
		case 0:
...
char* func_373(int iParam0) // Position - 0x1682D Hash - 0x5448A6DD ^0x5448A6DD
{
	switch (iParam0)
	{
		case 0:
...
char* func_374(int iParam0) // Position - 0x1687A Hash - 0x3CD1999F ^0x3CD1999F
{
	switch (iParam0)
	{
		case 0:
...
char* func_375(int iParam0) // Position - 0x168EA Hash - 0x77D3E78F ^0x77D3E78F
{
	switch (iParam0)
	{
		case 0:
...
char* func_376(int iParam0) // Position - 0x1691E Hash - 0x1F80CDA5 ^0x1F80CDA5
{
	switch (iParam0)
	{
		case 0:
...
char* func_377(int iParam0) // Position - 0x16952 Hash - 0xE5183A1D ^0xE5183A1D
{
	switch (iParam0)
	{
		case 0:
...
char* func_378(int iParam0) // Position - 0x1699F Hash - 0x16006070 ^0x16006070
{
	switch (iParam0)
	{
		case 0:
...
char* func_379(int iParam0) // Position - 0x169E2 Hash - 0xC0FE6BD9 ^0xC0FE6BD9
{
	switch (iParam0)
	{
		case 0:
...
char* func_380(int iParam0) // Position - 0x16A07 Hash - 0x603CB86C ^0x603CB86C
{
	switch (iParam0)
	{
		case 0:
...
char* func_381(int iParam0) // Position - 0x16A2C Hash - 0x912BC867 ^0x912BC867
{
	switch (iParam0)
	{
		case 0:
...
char* func_382(int iParam0) // Position - 0x16A5D Hash - 0x2A576AD6 ^0x2A576AD6
{
	switch (iParam0)
	{
		case 0:
...
char* func_383(int iParam0) // Position - 0x16AA0 Hash - 0xC7322311 ^0xC7322311
{
	switch (iParam0)
	{
		case 0:
...
char* func_384(int iParam0) // Position - 0x16AC5 Hash - 0x82590410 ^0x82590410
{
	switch (iParam0)
	{
		case 0:
...
char* func_385(int iParam0) // Position - 0x16AEA Hash - 0x5CF9E971 ^0x5CF9E971
{
	switch (iParam0)
	{
		case 0:
...
char* func_386(int iParam0) // Position - 0x16B1B Hash - 0x16ECADD9 ^0x16ECADD9
{
	switch (iParam0)
	{
		case 0:
...
char* func_387(int iParam0) // Position - 0x16B5E Hash - 0x49C02D11 ^0x49C02D11
{
	switch (iParam0)
	{
		case 0:
...
char* func_388(int iParam0) // Position - 0x16B83 Hash - 0xF41722F2 ^0xF41722F2
{
	switch (iParam0)
	{
		case 0:
...
char* func_389(int iParam0) // Position - 0x16BA8 Hash - 0x69C29F15 ^0x69C29F15
{
	switch (iParam0)
	{
		case 0:
...
char* func_390(int iParam0) // Position - 0x16BD9 Hash - 0x7A257100 ^0x7A257100
{
	switch (iParam0)
	{
		case 0:
...
char* func_391(int iParam0) // Position - 0x16C1C Hash - 0xFD6BCDAC ^0xFD6BCDAC
{
	switch (iParam0)
	{
		case 0:
...
char* func_392(int iParam0) // Position - 0x16C41 Hash - 0xD6092466 ^0xD6092466
{
	switch (iParam0)
	{
		case 0:
...
char* func_393(int iParam0) // Position - 0x16C66 Hash - 0x42340438 ^0x42340438
{
	switch (iParam0)
	{
		case 0:
...
char* func_394(int iParam0) // Position - 0x16C97 Hash - 0x7101D77B ^0x7101D77B
{
	switch (iParam0)
	{
		case 0:
...
char* func_395(int iParam0) // Position - 0x16CD7 Hash - 0x54DF13C7 ^0x54DF13C7
{
	switch (iParam0)
	{
		case 0:
...
char* func_396(int iParam0) // Position - 0x16CFC Hash - 0xB7C63976 ^0xB7C63976
{
	switch (iParam0)
	{
		case 0:
...
char* func_397(int iParam0) // Position - 0x16D21 Hash - 0x17531EF7 ^0x17531EF7
{
	switch (iParam0)
	{
		case 0:
...
char* func_398(int iParam0) // Position - 0x16D52 Hash - 0x373422F8 ^0x373422F8
{
	switch (iParam0)
	{
		case 0:
...
char* func_399(int iParam0) // Position - 0x16D92 Hash - 0xC56BC51F ^0xC56BC51F
{
	switch (iParam0)
	{
		case 0:
...
char* func_400(int iParam0) // Position - 0x16DB7 Hash - 0x4F4D5C64 ^0x4F4D5C64
{
	switch (iParam0)
	{
		case 0:
...
char* func_401(int iParam0) // Position - 0x16DDC Hash - 0xECD770D4 ^0xECD770D4
{
	switch (iParam0)
	{
		case 0:
...
char* func_402(int iParam0) // Position - 0x16E0D Hash - 0xD4B9A49F ^0xD4B9A49F
{
	switch (iParam0)
	{
		case 0:
...
char* func_403(int iParam0) // Position - 0x16E50 Hash - 0xE4FD19B7 ^0xE4FD19B7
{
	switch (iParam0)
	{
		case 0:
...
char* func_404(int iParam0) // Position - 0x16E73 Hash - 0xB7C63976 ^0xB7C63976
{
	switch (iParam0)
	{
		case 0:
...
char* func_405(int iParam0) // Position - 0x16E98 Hash - 0x8449F665 ^0x8449F665
{
	switch (iParam0)
	{
		case 0:
...
char* func_406(int iParam0) // Position - 0x16ECC Hash - 0xEB834F22 ^0xEB834F22
{
	switch (iParam0)
	{
		case 0:
...
char* func_407(int iParam0) // Position - 0x16F3C Hash - 0xB0888488 ^0xB0888488
{
	switch (iParam0)
	{
		case 0:
...
char* func_408(int iParam0) // Position - 0x16F6D Hash - 0x69D94719 ^0x69D94719
{
	switch (iParam0)
	{
		case 0:
...
char* func_409(int iParam0) // Position - 0x16FA1 Hash - 0x5F517662 ^0x5F517662
{
	switch (iParam0)
	{
		case 0:
...
char* func_410(int iParam0) // Position - 0x16FF3 Hash - 0xADFE55F4 ^0xADFE55F4
{
	switch (iParam0)
	{
		case 0:
...
char* func_411(int iParam0) // Position - 0x17063 Hash - 0xE5CD89DA ^0xE5CD89DA
{
	switch (iParam0)
	{
		case 0:
...
char* func_412(int iParam0) // Position - 0x17094 Hash - 0xF6B15126 ^0xF6B15126
{
	switch (iParam0)
	{
		case 0:
...
char* func_413(int iParam0) // Position - 0x170C8 Hash - 0xCDE0A3BE ^0xCDE0A3BE
{
	switch (iParam0)
	{
		case 0:
...
char* func_414(int iParam0) // Position - 0x1711A Hash - 0xE98259BD ^0xE98259BD
{
	switch (iParam0)
	{
		case 0:
...
char* func_415(int iParam0) // Position - 0x1715D Hash - 0x1824D955 ^0x1824D955
{
	switch (iParam0)
	{
		case 0:
...
char* func_416(int iParam0) // Position - 0x17180 Hash - 0x32FC06D3 ^0x32FC06D3
{
	switch (iParam0)
	{
		case 0:
...
char* func_417(int iParam0) // Position - 0x171A5 Hash - 0xBB128ADA ^0xBB128ADA
{
	switch (iParam0)
	{
		case 0:
...
char* func_418(int iParam0) // Position - 0x171D9 Hash - 0xCDA88CDD ^0xCDA88CDD
{
	switch (iParam0)
	{
		case 0:
...
char* func_419(int iParam0) // Position - 0x1721C Hash - 0x60891455 ^0x60891455
{
	switch (iParam0)
	{
		case 0:
...
char* func_420(int iParam0) // Position - 0x1723F Hash - 0x74518E1C ^0x74518E1C
{
	switch (iParam0)
	{
		case 0:
...
char* func_421(int iParam0) // Position - 0x17264 Hash - 0x78C1AF48 ^0x78C1AF48
{
	switch (iParam0)
	{
		case 0:
...
char* func_422(int iParam0) // Position - 0x17298 Hash - 0xDA57AB01 ^0xDA57AB01
{
	switch (iParam0)
	{
		case 0:
...
char* func_423(int iParam0) // Position - 0x172DB Hash - 0x2D5CAC35 ^0x2D5CAC35
{
	switch (iParam0)
	{
		case 0:
...
char* func_424(int iParam0) // Position - 0x172FE Hash - 0xA390B420 ^0xA390B420
{
	switch (iParam0)
	{
		case 0:
...
char* func_425(int iParam0) // Position - 0x17323 Hash - 0xC4B9E871 ^0xC4B9E871
{
	switch (iParam0)
	{
		case 0:
...
char* func_426(int iParam0) // Position - 0x17357 Hash - 0x8B8A1DFC ^0x8B8A1DFC
{
	switch (iParam0)
	{
		case 0:
...
char* func_427(int iParam0) // Position - 0x1739A Hash - 0x80E3BA54 ^0x80E3BA54
{
	switch (iParam0)
	{
		case 0:
...
char* func_428(int iParam0) // Position - 0x173CE Hash - 0xF6BE04E ^0xF6BE04E
{
	switch (iParam0)
	{
		case 0:
...
char* func_429(int iParam0) // Position - 0x17411 Hash - 0x3B0BF74F ^0x3B0BF74F
{
	switch (iParam0)
	{
		case 0:
...
char* func_430(int iParam0) // Position - 0x17436 Hash - 0x920F7B56 ^0x920F7B56
{
	switch (iParam0)
	{
		case 0:
...
char* func_431(int iParam0) // Position - 0x1745B Hash - 0x873736BB ^0x873736BB
{
	switch (iParam0)
	{
		case 0:
...
char* func_432(int iParam0) // Position - 0x1748F Hash - 0xF30B59F3 ^0xF30B59F3
{
	switch (iParam0)
	{
		case 0:
...
char* func_433(int iParam0) // Position - 0x174FF Hash - 0x14BDC0F4 ^0x14BDC0F4
{
	switch (iParam0)
	{
		case 0:
...
char* func_434(int iParam0) // Position - 0x17533 Hash - 0x5236CC9C ^0x5236CC9C
{
	switch (iParam0)
	{
		case 0:
...
char* func_435(int iParam0) // Position - 0x17567 Hash - 0x46293A55 ^0x46293A55
{
	switch (iParam0)
	{
		case 0:
...
char* func_436(int iParam0) // Position - 0x175B9 Hash - 0xAD8C2622 ^0xAD8C2622
{
	switch (iParam0)
	{
		case 0:
...
char* func_437(int iParam0) // Position - 0x17629 Hash - 0xA5CC57F0 ^0xA5CC57F0
{
	switch (iParam0)
	{
		case 0:
...
char* func_438(int iParam0) // Position - 0x1765D Hash - 0x77D3E78F ^0x77D3E78F
{
	switch (iParam0)
	{
		case 0:
...
char* func_439(int iParam0) // Position - 0x17691 Hash - 0xB0D7C7E5 ^0xB0D7C7E5
{
	switch (iParam0)
	{
		case 0:
...
char* func_440(int iParam0) // Position - 0x176E3 Hash - 0xC15A14EA ^0xC15A14EA
{
	switch (iParam0)
	{
		case 0:
...
char* func_441(int iParam0) // Position - 0x17726 Hash - 0xE8157407 ^0xE8157407
{
	switch (iParam0)
	{
		case 0:
...
char* func_442(int iParam0) // Position - 0x1774B Hash - 0x3D5ABE59 ^0x3D5ABE59
{
	switch (iParam0)
	{
		case 0:
...
char* func_443(int iParam0) // Position - 0x17770 Hash - 0xBBFA6DBE ^0xBBFA6DBE
{
	switch (iParam0)
	{
		case 0:
...
char* func_444(int iParam0) // Position - 0x177A4 Hash - 0x99DD7FF ^0x99DD7FF
{
	switch (iParam0)
	{
		case 0:
...
char* func_445(int iParam0) // Position - 0x177C9 Hash - 0x3D9CB917 ^0x3D9CB917
{
	switch (iParam0)
	{
		case 0:
...
char* func_446(int iParam0) // Position - 0x177FD Hash - 0xE4CD9C94 ^0xE4CD9C94
{
	switch (iParam0)
	{
		case 0:
...
char* func_447(int iParam0) // Position - 0x17840 Hash - 0xF8867BC3 ^0xF8867BC3
{
	switch (iParam0)
	{
		case 0:
...
char* func_448(int iParam0) // Position - 0x17874 Hash - 0x1967B219 ^0x1967B219
{
	switch (iParam0)
	{
		case 0:
...
char* func_449(int iParam0) // Position - 0x178B7 Hash - 0x86510C2B ^0x86510C2B
{
	switch (iParam0)
	{
		case 0:
...
char* func_450(int iParam0) // Position - 0x178EB Hash - 0x3954400F ^0x3954400F
{
	switch (iParam0)
	{
		case 0:
...
char* func_451(int iParam0) // Position - 0x1795B Hash - 0x5404D35 ^0x5404D35
{
	switch (iParam0)
	{
		case 0:
...
char* func_452(int iParam0) // Position - 0x1798F Hash - 0xE8FFD034 ^0xE8FFD034
{
	switch (iParam0)
	{
		case 0:
...
char* func_453(int iParam0) // Position - 0x179FF Hash - 0xD283A5B6 ^0xD283A5B6
{
	switch (iParam0)
	{
		case 0:
...
char* func_454(int iParam0) // Position - 0x17A33 Hash - 0xB8753810 ^0xB8753810
{
	switch (iParam0)
	{
		case 0:
...
char* func_455(int iParam0) // Position - 0x17AFD Hash - 0xF7132739 ^0xF7132739
{
	switch (iParam0)
	{
		case 0:
...
char* func_456(int iParam0) // Position - 0x17B4F Hash - 0x51C1DD54 ^0x51C1DD54
{
	switch (iParam0)
	{
		case 0:
...
char* func_457(int iParam0) // Position - 0x17BBC Hash - 0x118F7B8D ^0x118F7B8D
{
	switch (iParam0)
	{
		case 0:
...
char* func_458(int iParam0) // Position - 0x17BF0 Hash - 0x6C462E55 ^0x6C462E55
{
	switch (iParam0)
	{
		case 0:
...
char* func_459(int iParam0) // Position - 0x17C24 Hash - 0xD23F86CD ^0xD23F86CD
{
	switch (iParam0)
	{
		case 0:
...
char* func_460(int iParam0) // Position - 0x17C71 Hash - 0x8FA636EC ^0x8FA636EC
{
	switch (iParam0)
	{
		case 0:
...
char* func_461(int iParam0) // Position - 0x17CDF Hash - 0xB20F47EB ^0xB20F47EB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_462(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x17D2C Hash - 0x866F5694 ^0x9EEAB7E1
{
	...
	if (bParam2)
		if (func_484(pedParam0, false) != -1)
			return false;

	return true;
}

BOOL func_463(Ped pedParam0, var uParam1) // Position - 0x17DB8 Hash - 0xDC7D3FF5 ^0xDC7D3FF5
{
	int i;
...
BOOL func_464(int iParam0) // Position - 0x17DE4 Hash - 0xCAB4B86D ^0xCAB4B86D
{
	int num;
...
int func_465(int iParam0) // Position - 0x17E02 Hash - 0xDED73C45 ^0xDED73C45
{
	if (iParam0 <= 26)
		return 30;
...
int func_466(int iParam0) // Position - 0x17E66 Hash - 0x4A9F1197 ^0x49200B0
{
	if (iParam0 <= 26)
		return 34;
	else if (iParam0 >= 27 && iParam0 <= 32)
...
BOOL func_467(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x17EC4 Hash - 0xBA023B92 ^0x16E0B707
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
Vector3 func_468(int iParam0) // Position - 0x17F1D Hash - 0xD7EA81F1 ^0xD7EA81F1
{
	var unk;
...
void func_469(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1852A Hash - 0xFDACD718 ^0x658C9335
{
	int i;
...
BOOL func_470(int iParam0) // Position - 0x1857C Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_308(iParam0, 2);
}

BOOL func_471(Hash hParam0) // Position - 0x1858B Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_472(eStackSize essParam0) // Position - 0x18597 Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
	...
	num = func_337(essParam0);

	if (num < 0 || num >= 60)
		return false;

	num2 = func_336(essParam0);

	if (num2 < 0 || num2 >= 60)
		return false;

	num3 = func_335(essParam0);

	if (num3 < 0 || num3 > 23)
		return false;

	num4 = func_333(essParam0);

	if (num4 <= 0 || num4 > 1930 || num4 < 1866)
		return false;

	num5 = func_332(essParam0);

	if (num5 < 0 || num5 > 11)
		return false;

	num6 = func_334(essParam0);

	if (num6 < 1 || num6 > func_338(num5, num4))
		return false;

	return true;
}

var func_473(BOOL bParam0, var uParam1, var uParam2) // Position - 0x18673 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0(int iParam0) // Position - 0x1868A Hash - 0xA17D549C ^0x345D21E
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(int iParam0) // Position - 0x18788 Hash - 0xA17D549C ^0xA4E82E31
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0(int iParam0) // Position - 0x18956 Hash - 0xA17D549C ^0x2FD7078D
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0(int iParam0) // Position - 0x189DF Hash - 0xA17D549C ^0xEEDE0A92
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x18ADD Hash - 0xA17D549C ^0x803B42B4
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x18C91 Hash - 0xA17D549C ^0x6618C8AC
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x18E45 Hash - 0xA17D549C ^0x6BE9CF04
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x18F29 Hash - 0xA17D549C ^0x3C30107B
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x196DB Hash - 0xA17D549C ^0xA8A5F5F5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_483(Ped pedParam0) // Position - 0x19800 Hash - 0x66CDA584 ^0x67C9C44C
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0;

	if (PED::IS_PED_GROUP_MEMBER(pedParam0, func_486(), true))
		return 1;

	return 0;
}

int func_484(Ped pedParam0, BOOL bParam1) // Position - 0x19829 Hash - 0x46B9578F ^0x31193522
{
	return func_487(pedParam0, Global_1894899.f_2, bParam1);
}

int func_485(int iParam0) // Position - 0x1983F Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_488(iParam0))
		return -1;
...
int func_486() // Position - 0x1985B Hash - 0xDED80B4D ^0x98F74967
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_487(Ped pedParam0, eStackSize essParam1, BOOL bParam2) // Position - 0x1986B Hash - 0x7B4C7353 ^0x7B4C7353
{
	var unk;
	var unk2;
	...
	if (!func_490(essParam1, &unk, &unk2, false, false))
		return -1;

	return func_491(pedParam0, unk, unk2, bParam2);
}

BOOL func_488(int iParam0) // Position - 0x1989D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_489(int iParam0) // Position - 0x198D0 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_490(eStackSize essParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x19911 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
int func_491(Ped pedParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x19FD1 Hash - 0x32945A99 ^0xFCA9036B
{
	...
	for (i = uParam1; i <= uParam2; i = i + 1)
	{
		...
		if (func_493(num) != 0 && PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_494(num)))
			if (func_494(num) == perscharIndexFromPedIndex)
				return num;
	}
...
int func_492(int iParam0) // Position - 0x1A04B Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
Hash func_493(int iParam0) // Position - 0x1A0CC Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_495(iParam0))
		return 0;
...
PersChar func_494(int iParam0) // Position - 0x1A0EA Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_495(iParam0))
		return 0;
...
BOOL func_495(int iParam0) // Position - 0x1A10A Hash - 0x958B152F ^0x174871D
{
