...
BOOL func_15(eStackSize essParam0) // Position - 0x7EA Hash - 0xC12ECF0C ^0xA3F00570
{
	return func_48(&uLocal_14, 512, &uLocal_14, func_46(), 0, func_47(), false, 0, false);
}
...
int func_46() // Position - 0xD8C Hash - 0x8EBDB6A3 ^0x8EBDB6A3
{
	return 84;
}
