...
void func_4(var uParam0) // Position - 0x9CE Hash - 0x4DA9BC8C ^0x79EC81F6
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BC2 Hash - 0xA12A8BD4 ^0xA12A8BD4
{
	int num;
	...
	{
		case 21:
			func_46(uParam0, "AV_STARTING_TO_RAIN_FEMALE", "script@ambient@generic@startingtorain@female01", uParam1, uParam4);
			num = func_48(func_47());
			break;
	
		case 22:
			func_46(uParam0, "AV_STARTING_TO_RAIN_MALE", "script@ambient@generic@startingtorain@male01", uParam1, uParam4);
			num = func_49(func_47());
			break;
	}

	func_50(uParam0, 1, "PBL_ACTION", "", 0);
	func_51(uParam0, 0, "Ped", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C49 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CE9 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1E03 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FCC Hash - 0xCEFD7F9F ^0x7F5C9B7F
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(hLocal_37, false))
		return 0;

	return 1;
}

BOOL func_19(var uParam0) // Position - 0x1FE4 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2194 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2208 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2257 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x22AF Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2418 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x273F Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2876 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x29A6 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x29E5 Hash - 0x1F5294F9 ^0x5487E3A1
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 1) && !func_59(uParam0->f_20[0 /*14*/], SCRIPT_TASK_START_SCENARIO_IN_PLACE))
		{
			PED::SET_PED_SHOULD_PLAY_FLEE_SCENARIO_EXIT(uParam0->f_20[0 /*14*/], ENTITY::GET_ENTITY_COORDS(uParam0->f_20[0 /*14*/], true, false), 3);
			TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], hLocal_37, 0, false, hLocal_38, -1082130432, false);
		}
	
		if (func_60(uParam0, &uLocal_9, false))
		{
			uParam0->f_499 = 1;
			return false;
		}
	
		if (TASK::_PED_IS_IN_SCENARIO_BASE(uParam0->f_20[0 /*14*/]) && func_61(uParam0, 1065353216, 40f, 4, 15f, 15f))
		{
			func_62(uParam0);
			return true;
		}
...
void func_29(var uParam0) // Position - 0x2AAF Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2AE1 Hash - 0x3DE7CC81 ^0xD7079966
{
	if (*uParam0 == 21)
	{
		hLocal_37 = joaat("world_human_stare_stoic");
		hLocal_38 = joaat("world_human_stare_stoic_female_a");
	}
	else
	{
		hLocal_37 = joaat("world_human_stand_waiting");
		hLocal_38 = joaat("world_human_stand_waiting_male_a");
	}

	STREAMING::_REQUEST_SCENARIO_TYPE(hLocal_37, 15, 0, hLocal_38);
	func_63(&uLocal_9, false);
...
int func_31(var uParam0) // Position - 0x2B4E Hash - 0x19BC3868 ^0xEEFF08A4
{
	if (!uParam0->f_469[0])
	{
		if (func_60(uParam0, &uLocal_9, false))
	...
	if (!uParam0->f_469[3])
	{
		if (!uParam0->f_469[4])
		{
			if (func_71(uParam0, fLocal_39, 1116471296, 4, joaat("Action"), true))
			{
				func_70(*uParam0, uParam0->f_483, true);
				uParam0->f_469[4] = 1;
			}
	...
	if (!uParam0->f_469[3])
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
			{
				...
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], hLocal_37, 15000, false, hLocal_38, -1082130432, false);
...
int func_32(var uParam0, var uParam1) // Position - 0x2C8B Hash - 0x2EA14DF4 ^0xB965AC35
{
	func_72(uParam0, false, false, false);

	if (hLocal_37 != 0)
		if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(hLocal_37, false))
			STREAMING::_REMOVE_SCENARIO_ASSET(hLocal_37);
...
int func_48(int iParam0) // Position - 0x3515 Hash - 0xA6D0F253 ^0x6683D66D
{
	int num;
...
int func_49(int iParam0) // Position - 0x3604 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
void func_50(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x36F5 Hash - 0xF0D98862 ^0x21440CE
{
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3726 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_52(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37B4 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
...
int func_53(int iParam0) // Position - 0x39B8 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_54(int iParam0, int iParam1) // Position - 0x39CC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_55() // Position - 0x39DB Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_73() != -1;
}

BOOL func_56(var uParam0, Any* panParam1) // Position - 0x39F6 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_57(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3A55 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_58(Ped pedParam0) // Position - 0x3A97 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
BOOL func_59(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3AC3 Hash - 0x37FB14EB ^0x7E496A4A
{
...
BOOL func_60(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3AEC Hash - 0xD3438796 ^0xAD2A1935
{
	if (MISC::GET_FRAME_COUNT() % 3 == 0 || bParam2)
	{
		if (func_92(uParam0->f_20[uParam0->f_501 /*14*/], 0, iParam1, &(uParam0->f_468), 0, 0))
			return true;
...
BOOL func_61(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, float fParam5) // Position - 0x3B46 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_93(Global_35))
		{
			ped = func_94(Global_35);
		...
		num = num * num;
		fParam2 = func_95(fParam2);
		num2 = func_96(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_97(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_98(&(uParam0->f_490)))
							func_99(&(uParam0->f_490));
					
						if (func_100(&(uParam0->f_490), iParam1))
						{
							func_101(&(uParam0->f_490));
							return true;
						}
...
void func_62(var uParam0) // Position - 0x3D51 Hash - 0xB9AF1204 ^0xB9AF1204
{
	if (!uParam0->f_469[5])
	{
		func_102(*uParam0, true);
		uParam0->f_469[5] = 1;
	}
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x3D76 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_64(var uParam0, BOOL bParam1) // Position - 0x3DF2 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_65(var uParam0, BOOL bParam1) // Position - 0x3E16 Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_66(var uParam0, BOOL bParam1) // Position - 0x3E3C Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_67(var uParam0, BOOL bParam1) // Position - 0x3E5E Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_68(var uParam0, BOOL bParam1) // Position - 0x3E80 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x3EA2 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3EC6 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_71(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3FCA Hash - 0xFE5C7466 ^0xD8EEC0C6
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_95(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_97(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_98(&(uParam0->f_490)))
		...
		if (func_98(&(uParam0->f_490)) && !func_114(&(uParam0->f_490)))
...
void func_72(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x40F4 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_73() // Position - 0x4248 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4256 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_75(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x42BD Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_76(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x42E6 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_77(var uParam0, var uParam1, var uParam2) // Position - 0x4332 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_78(int iParam0) // Position - 0x4381 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_79(int iParam0) // Position - 0x43A6 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_80(int iParam0) // Position - 0x43B9 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_81(int iParam0) // Position - 0x43CC Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_82(int iParam0) // Position - 0x43DF Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_83(int iParam0) // Position - 0x43F1 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_84(int iParam0, int iParam1) // Position - 0x4403 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x449D Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_86() // Position - 0x44D5 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_87(int iParam0) // Position - 0x4528 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_90(iParam0))
		return -1;
...
BOOL func_88(int iParam0) // Position - 0x4548 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_89(int iParam0, int iParam1) // Position - 0x455E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_90(int iParam0) // Position - 0x456D Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_91(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x45A0 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
BOOL func_92(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x4681 Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
...
BOOL func_93(Ped pedParam0) // Position - 0x4CAA Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_94(Ped pedParam0) // Position - 0x4CC5 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_95(int iParam0) // Position - 0x4CE1 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_96(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4D28 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_97(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x4D46 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_98(var uParam0) // Position - 0x4D9D Hash - 0x5001E582 ^0x5001E582
{
	return func_164(*uParam0, 1);
}

void func_99(var uParam0) // Position - 0x4DAD Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_165(uParam0, 0f);
	return;
}

BOOL func_100(var uParam0, int iParam1) // Position - 0x4DBC Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_101(var uParam0) // Position - 0x4DDA Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4DF0 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x4EC7 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_110(iParam0, 4);
	else
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x4EE5 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_110(iParam0, 8);
	else
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x4F05 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_110(iParam0, 16);
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x4F30 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_110(iParam0, 32);
	else
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x4F50 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_110(iParam0, 64);
	else
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x4F70 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x4F92 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_110(int iParam0, int iParam1) // Position - 0x4FB6 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_111(int iParam0) // Position - 0x4FC7 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_166(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_166(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_166(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_112(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5048 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
void func_113(var uParam0, BOOL bParam1) // Position - 0x5139 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_114(var uParam0) // Position - 0x5159 Hash - 0x39705408 ^0x39705408
{
	return func_164(*uParam0, 2);
}

void func_115(var uParam0) // Position - 0x5169 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_98(uParam0);
...
BOOL func_116(var uParam0, float fParam1) // Position - 0x519D Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_98(uParam0))
		return false;
...
void func_117(var uParam0) // Position - 0x51C4 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_98(uParam0);
...
BOOL func_118(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x51F4 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_119(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5249 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_120(int iParam0, int iParam1) // Position - 0x5260 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_121(int iParam0, int iParam1) // Position - 0x52E6 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_122(int iParam0, int iParam1) // Position - 0x5322 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_123(int iParam0, int iParam1) // Position - 0x5375 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_124(int iParam0, int iParam1) // Position - 0x53B0 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_125(int iParam0, int iParam1) // Position - 0x53E9 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_126(int iParam0) // Position - 0x5421 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_127(BOOL bParam0) // Position - 0x545F Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_128(ePedType eptParam0) // Position - 0x5472 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_129(Ped pedParam0, Hash hParam1) // Position - 0x58C5 Hash - 0xFC0422EA ^0x13ACF3B7
{
...
void func_130(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x596C Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_131(Ped pedParam0, BOOL bParam1) // Position - 0x599C Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_132(Ped pedParam0, int iParam1) // Position - 0x59E1 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_133(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5A08 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_175(iParam2);
...
BOOL func_134(Ped pedParam0, int iParam1) // Position - 0x5BD3 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
...
void func_135(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5CAA Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
...
BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x5CE7 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
...
BOOL func_137(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x5DCE Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
...
BOOL func_138(Ped pedParam0, int iParam1) // Position - 0x5EA4 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
BOOL func_139(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5FAD Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x60E2 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_141(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6119 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_142(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x6220 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;
...
BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x628B Hash - 0x8CBDE6BD ^0xE1F008CE
{
...
BOOL func_144(Ped pedParam0, int iParam1) // Position - 0x63D3 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
...
BOOL func_145(var uParam0, int iParam1) // Position - 0x65AF Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0x6627 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_147(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6656 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_148(int iParam0, Ped pedParam1) // Position - 0x67DC Hash - 0x42A83B1F ^0xEA3A2883
{
	int _int;
...
BOOL func_149(int iParam0, Ped pedParam1) // Position - 0x682C Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_202(iParam0))
		return true;
...
BOOL func_150(Ped pedParam0, Ped pedParam1) // Position - 0x68C9 Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_151() // Position - 0x6916 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_152(int iParam0, Ped pedParam1) // Position - 0x691E Hash - 0x6BE02E92 ^0x188EF1A2
{
...
int func_153() // Position - 0x69DF Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_154() // Position - 0x69FD Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_155(int iParam0, Ped pedParam1) // Position - 0x6A4A Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
...
BOOL func_156(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6B66 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_157(Ped pedParam0, int iParam1) // Position - 0x6BAE Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_158(Ped pedParam0, int iParam1) // Position - 0x6E07 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_212(0))
		return false;
...
BOOL func_159(int iParam0, int iParam1) // Position - 0x6E40 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_160(var uParam0, int iParam1) // Position - 0x6E6F Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_161(Ped pedParam0, int iParam1) // Position - 0x6E83 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_162(int iParam0, Ped pedParam1) // Position - 0x6ED0 Hash - 0x6A2A3ADB ^0x2BB4AA9F
{
...
float func_163(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6F23 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x6F41 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_165(var uParam0, float fParam1) // Position - 0x6F50 Hash - 0x30433BAB ^0xF854D531
{
...
void func_166(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6F76 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_167() // Position - 0x7002 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_168(var uParam0, int iParam1) // Position - 0x7034 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_169(var uParam0) // Position - 0x7049 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_98(uParam0))
		return uParam0->f_1;
...
void func_170(var uParam0, int iParam1) // Position - 0x707E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_171(Ped pedParam0, Hash hParam1) // Position - 0x708F Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_172(Ped pedParam0, Hash hParam1) // Position - 0x70BD Hash - 0x4252B6E4 ^0x87BCD88A
{
	Hash _int;
...
BOOL func_173(Ped pedParam0, Hash hParam1) // Position - 0x710D Hash - 0x4252B6E4 ^0x87BCD88A
{
	Hash _int;
	int _int2;
...
void func_174(Ped pedParam0) // Position - 0x717D Hash - 0x12A19BD ^0x2C86239F
{
...
void func_175(int iParam0) // Position - 0x719A Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_176(int iParam0) // Position - 0x7306 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_177(BOOL bParam0) // Position - 0x7319 Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_178(int iParam0) // Position - 0x7333 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_179(int iParam0) // Position - 0x73CD Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_180(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x73F4 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
...
float func_181(Ped pedParam0, Ped pedParam1) // Position - 0x74ED Hash - 0xF9959663 ^0xF9959663
{
	return func_203(pedParam0, pedParam1, true, true);
}

float func_182(int iParam0) // Position - 0x74FF Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_183(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x750B Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_184(int iParam0, BOOL bParam1) // Position - 0x7570 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_185() // Position - 0x7596 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_186(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x75AA Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
...
float func_187(int iParam0) // Position - 0x770A Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_188(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7716 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_189(int iParam0) // Position - 0x7777 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_190(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7783 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_191(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7845 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_192(int iParam0) // Position - 0x78E3 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_193(int iParam0) // Position - 0x78EF Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_194(int iParam0) // Position - 0x78FB Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_195(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7A38 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_196(Ped pedParam0) // Position - 0x7A7B Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_197(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7AE1 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_198(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7B28 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_199(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7B73 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_200(Ped pedParam0, var uParam1) // Position - 0x7BEC Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_201(Ped pedParam0, Ped pedParam1) // Position - 0x7C39 Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_202(int iParam0) // Position - 0x7C81 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_203(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7C91 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_204(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7CD9 Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;
...
float func_205(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x7D05 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_206(int iParam0) // Position - 0x7D2D Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_207(Ped pedParam0) // Position - 0x7D39 Hash - 0x9302C393 ^0xD5B8371F
{
...
int func_208(Ped pedParam0) // Position - 0x7D8D Hash - 0x85BE14AD ^0x548ED1B6
{
...
BOOL func_209(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x7DF9 Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
...
BOOL func_210(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x7F69 Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
...
BOOL func_211(int iParam0, Ped pedParam1) // Position - 0x8059 Hash - 0x27FC2906 ^0x15FE9842
{
...
BOOL func_212(int iParam0) // Position - 0x80CF Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_229())
		return false;
...
int func_213(int iParam0) // Position - 0x80F1 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_214(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x80FD Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
int func_215(int iParam0) // Position - 0x8178 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_216() // Position - 0x818B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_217() // Position - 0x8199 Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_231())
		return false;
...
void func_218(Any* panParam0, int iParam1) // Position - 0x81EF Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_219(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8297 Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_220(int iParam0) // Position - 0x835E Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_221(int iParam0) // Position - 0x8406 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_222(Ped pedParam0, int iParam1) // Position - 0x846B Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_223(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8482 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_224(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x84B0 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x84FA Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_226(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x853B Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_227(Ped pedParam0) // Position - 0x85B4 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_228(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x869C Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_229() // Position - 0x86DE Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_216() != -1)
		return false;
...
BOOL func_230(int iParam0, BOOL bParam1) // Position - 0x8703 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_231() // Position - 0x8734 Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_232(int iParam0) // Position - 0x8765 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_90(iParam0))
		return -1;
...
int func_233(int iParam0) // Position - 0x8781 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_234(int iParam0) // Position - 0x87C2 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
