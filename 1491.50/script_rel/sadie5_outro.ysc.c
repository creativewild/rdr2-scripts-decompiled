...
void main() // Position - 0x0 Hash - 0xC9319E9C ^0xB2C0574E
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	eptLocal_16 = joaat("mes_sadie5_males_01");
	hLocal_17 = -2013410069;

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(555))
		func_1(&uLocal_126);

	func_2(&uLocal_126, &uScriptParam_0);

	while (!func_3(&uLocal_126))
	{
		func_4(&uLocal_126);
	
		switch (func_5(uLocal_126))
		{
			case 0:
				if (func_6(&uLocal_126))
					func_7(&uLocal_126, 1);
				break;
		
			case 1:
				if (func_8(&uLocal_126))
					func_7(&uLocal_126, 2);
				break;
		
			case 2:
				if (func_9(&uLocal_126))
					func_7(&uLocal_126, 3);
				break;
...
void func_1(var uParam0) // Position - 0xBF Hash - 0x5C967931 ^0xE89D747F
{
	eStackSize i;
...
int func_2(var uParam0, var uParam1) // Position - 0x157 Hash - 0x11824BFA ^0x305C042C
{
...
BOOL func_6(var uParam0) // Position - 0x26B Hash - 0xABC6AF55 ^0x5A649598
{
	STREAMING::REQUEST_MODEL(eptLocal_16, false);
	TASK::REQUEST_WAYPOINT_RECORDING("sad5_outro");

	if (!TASK::GET_IS_WAYPOINT_RECORDING_LOADED("sad5_outro"))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(eptLocal_16))
		return false;

	return true;
}

void func_7(var uParam0, int iParam1) // Position - 0x29D Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

BOOL func_8(var uParam0) // Position - 0x2AA Hash - 0xE70F011 ^0xCE61FB0
{
...
BOOL func_9(var uParam0) // Position - 0x2E2 Hash - 0xEDB66132 ^0xEDB66132
{
	BOOL num;
...
void func_10() // Position - 0x307 Hash - 0xF2ADC204 ^0xF23F9A2E
{
	int i;
...
int func_11(var uParam0) // Position - 0x34A Hash - 0xA92ACD71 ^0xA92ACD71
{
	func_26(0);
	return 1;
}

BOOL func_12(eStackSize essParam0) // Position - 0x358 Hash - 0xFD10BCB1 ^0xFD10BCB1
{
...
BOOL func_13(eStackSize essParam0) // Position - 0x377 Hash - 0xDA629583 ^0xDA629583
{
	return func_27(essParam0, 16, true);
}

BOOL func_14(eStackSize essParam0) // Position - 0x388 Hash - 0xC2BA9D92 ^0x340F97FF
{
...
void func_15(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x3BC Hash - 0xA4706F79 ^0xAF27D1D3
{
	BOOL flag;
	PersChar persChar;
	BOOL flag2;
...
BOOL func_16(var uParam0, int iParam1) // Position - 0x671 Hash - 0x718DD1EF ^0x66842345
{
	return uParam0->f_3 && iParam1 != false;
}

void func_17(var uParam0, int iParam1) // Position - 0x682 Hash - 0xA4EAD31F ^0x3F77773B
{
	uParam0->f_3 = uParam0->f_3 - uParam0->f_3 && iParam1;
	return;
}

void func_18(var uParam0, int iParam1) // Position - 0x69A Hash - 0x53A96DDB ^0xA013391F
{
	uParam0->f_3 = uParam0->f_3 || iParam1;
	return;
}

void func_19(var uParam0) // Position - 0x6AD Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_20(int iParam0, int iParam1) // Position - 0x6B5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_21(var uParam0) // Position - 0x6C4 Hash - 0x68E4B51F ^0x316E0858
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_14))
	{
		pedLocal_14 = func_44(11, true, 0, 0f, 0f, 0f, 0f, false, 1, false, true, false, 0, -1248623443, false, false, false, true, true, true, false, false, true, false, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_14, true);
		PED::SET_PED_CONFIG_FLAG(pedLocal_14, 130, true);
		TASK::TASK_FOLLOW_WAYPOINT_RECORDING(pedLocal_14, "sad5_outro", 0, 9224, -1, false, 0, -1);
		return 0;
	}
	...
	if (func_45(Global_1835011[72 /*74*/].f_1) == 0)
	{
		...
		{
			pedLocal_15 = func_46(eptLocal_16, -766.3174f, -1262.8126f, 43.0245f, 272.9365f, true, true, 0, true, true, true, false, false, false, false);
			PED::_EQUIP_META_PED_OUTFIT(pedLocal_15, hLocal_17);
			PED::_UPDATE_PED_VARIATION(pedLocal_15, true, true, true, true, false);
			return 0;
		}
		...
		func_48(&uLocal_19, pedLocal_15, "SAD5_FINLEY", false);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Global_35, true);
		PED::_SET_PED_PROMPT_NAME_FROM_GXT_ENTRY(pedLocal_15, joaat("sad5_finley"));
	}

	return 1;
}

BOOL func_22() // Position - 0x7C2 Hash - 0x9773414E ^0x9773414E
{
	BOOL num;
...
BOOL func_23(var uParam0) // Position - 0x7CF Hash - 0x14FC959C ^0x9ACD20EA
{
	if (func_45(Global_1835011[72 /*74*/].f_1) == 0)
	{
		func_49(uParam0);
	
		if (func_50(Global_35, -766.3275f, -1264.0553f, 43.0245f, true) > 100f)
		{
	...
	if (!func_51(iLocal_18, 1))
	{
		if (func_52(Global_35, pedLocal_14, false, false) > 150f || !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(pedLocal_14, 0))
		{
			PED::SET_PED_CONFIG_FLAG(pedLocal_14, 130, false);
			PED::SET_PED_KEEP_TASK(pedLocal_14, false);
			func_15(11, true, false, true, -1082130432, true, true, false, false, false, false);
			func_53(&iLocal_18, 1);
		}
	}
...
void func_24(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x872 Hash - 0xA83ABB27 ^0x3839CF85
{
	int num;
	int offset;
...
void func_25(var uParam0, BOOL bParam1) // Position - 0x8AC Hash - 0xA95D0C2 ^0xA95D0C2
{
...
void func_26(int iParam0) // Position - 0x8CC Hash - 0x29A8F290 ^0x64CD603A
{
	Global_1396116.f_139 = iParam0;
	return;
}

BOOL func_27(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8DC Hash - 0x456A22D3 ^0x456A22D3
{
	if (bParam2)
		if (!func_54(essParam0))
			return false;
...
void func_28(eStackSize essParam0, BOOL bParam1) // Position - 0x906 Hash - 0x7065DB4C ^0xB94EA2C3
{
	if (!func_54(essParam0))
		return;
...
void func_29(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x948 Hash - 0x322BF689 ^0x724E8BC3
{
	if (!func_54(essParam0))
		return;
...
void func_30(eStackSize essParam0) // Position - 0x970 Hash - 0x7895582D ^0x7895582D
{
	func_29(essParam0, 8, false);
	return;
}

void func_31(eStackSize essParam0) // Position - 0x981 Hash - 0x8577BCFD ^0x8577BCFD
{
	func_24(essParam0, 36, true);
	return;
}

void func_32(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x992 Hash - 0xA83ABB27 ^0xCD66A93E
{
	int num;
	int offset;
...
BOOL func_33(Ped pedParam0, int iParam1) // Position - 0x9CC Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
PersChar func_34(eStackSize essParam0, BOOL bParam1) // Position - 0xACB Hash - 0xA2FCAA5A ^0xC4849EF1
{
	if (!func_12(essParam0))
		return 0;
...
BOOL func_35(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0xB0A Hash - 0x6ED0C3E9 ^0xD0355731
{
	int num;
	int offset;
...
void func_36(eStackSize essParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB45 Hash - 0x31BF1139 ^0xA046F8A2
{
	int pedMaxHealth;
	Ped ped;
...
void func_37(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB97 Hash - 0x4B52E53C ^0x4B52E53C
{
	if (!func_54(essParam0))
		return;
...
void func_38(eStackSize essParam0, BOOL bParam1) // Position - 0xC69 Hash - 0x2F921122 ^0x884B6C77
{
	if (!func_54(essParam0))
		return;
...
void func_39(var uParam0) // Position - 0xCA0 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_40(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xCB6 Hash - 0x6E8FD624 ^0x6E8FD624
{
	PersChar char;
	Ped ped;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped) && func_64(essParam0) < 10000f && !bParam3 && !CAM::IS_SCREEN_FADED_OUT())
		return;
...
void func_41(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDC4 Hash - 0xC1057B0F ^0xC1057B0F
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
Player func_42(eStackSize essParam0) // Position - 0xE00 Hash - 0x8D7C83E2 ^0x9E26FAD3
{
	if (!func_12(essParam0))
		return 0;
...
void func_43(int iParam0, eStackSize essParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xE40 Hash - 0xBD80856C ^0xBD80856C
{
	Player player;
	...
	func_68(essParam1, 64, false);
	Global_1360165[essParam1 /*1157*/].f_70.f_11 = 0;
	func_68(essParam1, 8, false);

	if (ENTITY::DOES_ENTITY_EXIST(player))
	{
		if (!bParam2)
		{
			func_68(essParam1, 512, true);
		...
		if (bParam4)
			func_69(essParam1, false, true, true, true);
	}

	return;
}

Ped func_44(eStackSize essParam0, BOOL bParam1, int iParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7, int iParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, int iParam12, int iParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18, BOOL bParam19, BOOL bParam20, BOOL bParam21, BOOL bParam22, BOOL bParam23, BOOL bParam24) // Position - 0xEE2 Hash - 0x79A2D2D9 ^0x5019CC83
{
	float num;
	BOOL flag;
	int num2;
	...
	{
		case 0:
			if (func_35(essParam0, 2, true))
				func_32(essParam0, 2, true);
		
			if (func_27(essParam0, 16, true))
			{
				...
				else if (func_33(Global_1360165[essParam0 /*1157*/], 0))
				{
					return Global_1360165[essParam0 /*1157*/];
				}
			}
		
			if (func_33(Global_1360165[essParam0 /*1157*/], 0))
			{
				...
				if (PED::IS_PED_RAGDOLL(Global_1360165[essParam0 /*1157*/]))
					if (bParam1)
						func_70(essParam0, true, "Stealing, but companion is a ragdoll");
					else
						return 0;
		...
		case 1:
			...
			if (!func_35(essParam0, 44, false))
				func_24(essParam0, 44, false);
		
			if (func_72(essParam0, num, iParam13, false, true, bParam17, bParam20, -1, 1, false))
				func_71(essParam0, 2);
			break;
		...
		case 2:
			...
			func_37(essParam0, bParam9, true, false);
		
			if (bParam22)
				func_73(essParam0, false, false, true);
		
			func_32(essParam0, 33, true);
			func_32(essParam0, 34, true);
			func_32(essParam0, 29, true);
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[essParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[essParam0 /*1157*/], -1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(Global_1360165[essParam0 /*1157*/]))
				{
					...
					{
						func_70(essParam0, true, "Teleporting a stolen companion using a scenario.");
					}
					else
					{
				...
				func_75(Global_1360165[essParam0 /*1157*/], num, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
		...
		case 4:
			if (iParam13 != 0 || flag)
			{
				...
				if (func_76(essParam0, iParam13))
				{
					if (PED::IS_PED_READY_TO_RENDER(Global_1360165[essParam0 /*1157*/]))
					{
						func_77(essParam0, iParam13, false);
						func_78(essParam0, Global_1360165[essParam0 /*1157*/], iParam13, true);
					
						if (func_35(essParam0, 25, false))
							func_32(essParam0, 25, false);
		...
		case 6:
			if (func_33(Global_1360165[essParam0 /*1157*/], 0))
			{
				...
				if (bParam21)
				{
					...
					func_80(Global_1360165[essParam0 /*1157*/], 1);
				}
			}
		...
		case 7:
			func_37(essParam0, bParam9, bParam15, false);
			func_29(essParam0, 4, bParam11);
			func_31(essParam0);
		
			if (bParam20)
				func_81(Global_1360165[essParam0 /*1157*/]);
		
			func_82(essParam0, Global_1360165[essParam0 /*1157*/]);
...
int func_45(int iParam0) // Position - 0x154F Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_84(iParam0))
		return -1;
...
Ped func_46(ePedType eptParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x156B Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
...
BOOL func_47(int iParam0) // Position - 0x15AD Hash - 0x1B19432F ^0x9C562F71
{
	...
	perscharPedIndex = PERSCHAR::_GET_PERSCHAR_PED_INDEX(func_90(iParam0));
...
void func_48(var uParam0, Ped pedParam1, char* sParam2, BOOL bParam3) // Position - 0x1636 Hash - 0x5AD955B5 ^0x43BD5215
{
	...
	if (func_91(uParam0, pedParam1, sParam2))
...
void func_49(var uParam0) // Position - 0x1693 Hash - 0x96A7FB4C ^0xB6EF5D56
{
	func_92(pedLocal_15, "SAD5_FINLEY", 5f, 0, 0, 4);
	PED::SET_PED_RESET_FLAG(pedLocal_15, 49, true);

	if (func_52(Global_35, pedLocal_15, true, true) > 6f)
		if (func_93(true))
			func_94(true, false, false);

	switch (iLocal_120)
	{
		case 0:
			if (func_95(Global_35, pedLocal_15, 5f, true))
			{
				if (!func_56(&uLocal_123))
				{
					func_57(&uLocal_123);
					TASK::TASK_USE_NEAREST_SCENARIO_CHAIN_TO_COORD(pedLocal_15, ENTITY::GET_ENTITY_COORDS(pedLocal_15, true, false), 2f, false, false, false, false);
					func_97(&uLocal_19, func_96("SAD5_JRETURN"), false, -1, false, false);
				}
			}
			...
			if (func_98(&uLocal_123) > (float)MISC::GET_RANDOM_INT_IN_RANGE(13, 17))
			{
				if (iLocal_121 != 0 && iLocal_122 != 0)
					func_97(&uLocal_19, func_96("SAD5_GOAWAY"), false, -1, false, false);
				else
					func_97(&uLocal_19, func_96("SAD5_JRETURN"), false, -1, false, false);
			...
			if (func_99(PLAYER::PLAYER_ID(), pedLocal_15))
			{
				if (!func_100(uLocal_117[0]))
				{
					uLocal_117[0] = func_101("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824, 0, 1065353216, false, 3, joaat("SHORT_TIMED_EVENT"), false);
					func_102(uLocal_117[0], pedLocal_15, 0, 0, true);
				}
			
				if (!func_100(uLocal_117[1]))
				{
					uLocal_117[1] = func_101("INTERACT_INSULT", joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824, 0, 1065353216, false, 3, joaat("SHORT_TIMED_EVENT"), false);
					func_102(uLocal_117[1], pedLocal_15, 0, 0, true);
				}
			
				if (iLocal_121 > 2)
					if (!func_103(uLocal_117[0]))
						func_104(uLocal_117[0], true);
			
				if (iLocal_122 > 2)
					if (!func_103(uLocal_117[1]))
						func_104(uLocal_117[1], true);
			}
			else
			{
				if (func_100(uLocal_117[0]))
					func_105(&uLocal_117[0], true, true);
			
				if (func_100(uLocal_117[1]))
					func_105(&uLocal_117[1], true, true);
			}
		
			if (func_100(uLocal_117[0]) && func_106(uLocal_117[0], true))
			{
				if (func_93(true))
					func_94(true, false, false);
			
				if (iLocal_121 == 0)
					func_97(&uLocal_19, func_96("SAD5_ILOPOS1"), false, -1, false, false);
				else if (iLocal_121 == 1)
					func_97(&uLocal_19, func_96("SAD5_ILOPOS2"), false, -1, false, false);
				else if (iLocal_121 == 2)
					func_97(&uLocal_19, func_96("SAD5_ILOPOS3"), false, -1, false, false);
			
				iLocal_121 = iLocal_121 + 1;
				iLocal_120 = iLocal_120 + 1;
			}
		
			if (func_100(uLocal_117[1]) && func_106(uLocal_117[1], true))
			{
				if (func_93(true))
					func_94(true, false, false);
			
				if (iLocal_122 == 0)
					func_97(&uLocal_19, func_96("SAD5_ILONEG1"), false, -1, false, false);
				else if (iLocal_122 == 1)
					func_97(&uLocal_19, func_96("SAD5_ILONEG2"), false, -1, false, false);
				else if (iLocal_122 == 2)
					func_97(&uLocal_19, func_96("SAD5_ILONEG3"), false, -1, false, false);
		...
		case 1:
			if (!func_93(true))
			{
				...
				if (func_103(uLocal_117[0]))
					func_104(uLocal_117[0], false);
			
				if (func_103(uLocal_117[1]))
					func_104(uLocal_117[1], false);
			}
			else
			{
				if (!func_103(uLocal_117[0]))
...
float func_50(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x19FB Hash - 0x3DAE1415 ^0x2267FA69
{
...
BOOL func_51(int iParam0, int iParam1) // Position - 0x1A23 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_52(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A32 Hash - 0xD54E86C ^0xB31A48E2
{
...
void func_53(var uParam0, int iParam1) // Position - 0x1A7A Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_54(eStackSize essParam0) // Position - 0x1A8B Hash - 0xEC8E4F18 ^0xEC8E4F18
{
	return essParam0 > -1;
}

int func_55(int iParam0, var uParam1, var uParam2) // Position - 0x1A97 Hash - 0x28CD1A67 ^0x28CD1A67
{
	int num;
...
BOOL func_56(var uParam0) // Position - 0x1AB4 Hash - 0x5001E582 ^0x5001E582
{
	return func_107(*uParam0, 1);
}

void func_57(var uParam0) // Position - 0x1AC4 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_108(uParam0, 0f);
	return;
}

BOOL func_58(int iParam0, int iParam1) // Position - 0x1AD3 Hash - 0xE46677C2 ^0xE46677C2
{
	return *iParam0 && iParam1 != false;
}

void func_59(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1AE3 Hash - 0x70644665 ^0x70644665
{
	if (bParam2)
...
BOOL func_60(int iParam0, int iParam1) // Position - 0x1B09 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_61(eStackSize essParam0) // Position - 0x1B18 Hash - 0x7F4CEA57 ^0x7A0A798F
{
	Hash hash;
...
Ped func_62(eStackSize essParam0) // Position - 0x1B80 Hash - 0x81E6D8DD ^0x27F8E742
{
	if (!func_54(essParam0))
		return 0;
...
void func_63(eStackSize essParam0) // Position - 0x1BBA Hash - 0xA3F1079A ^0xFE58BB91
{
	if (func_12(essParam0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_62(essParam0)))
		{
			func_83(essParam0, 67108864, true);
...
float func_64(eStackSize essParam0) // Position - 0x1BED Hash - 0xA42CC07F ^0x2E7483CB
{
	if (!func_54(essParam0))
		return 0f;
...
void func_65(eStackSize essParam0) // Position - 0x1C0E Hash - 0xC4A0D69D ^0x461393B6
{
	Ped ped;
	PersChar persChar;
	BOOL flag;
...
BOOL func_66(eStackSize essParam0) // Position - 0x1C68 Hash - 0x6410553A ^0x46627D03
{
	if (!func_54(essParam0))
		return false;
...
BOOL func_67(eStackSize essParam0) // Position - 0x1CB4 Hash - 0xDC3E0094 ^0xA822A7E2
{
	if (!func_54(essParam0))
		return false;
...
void func_68(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x1CDC Hash - 0x7FA68C0F ^0xF104E0DF
{
	if (!func_54(essParam0))
		return;
...
int func_69(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D41 Hash - 0x9AECF115 ^0xB93A91A1
{
	Player mount;
	Hash hash;
	PersChar persChar;
	...
	if (func_33(mount, 0))
	{
		...
		if (bParam1 || !func_66(essParam0) || func_67(essParam0))
		{
...
void func_70(eStackSize essParam0, BOOL bParam1, char* sParam2) // Position - 0x1EF2 Hash - 0x4393BBFF ^0x711C558C
{
	Ped ped;
...
void func_71(eStackSize essParam0, int iParam1) // Position - 0x1F39 Hash - 0x61FF61E0 ^0x2C6117ED
{
	if (!func_54(essParam0))
		return;
...
BOOL func_72(eStackSize essParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9, BOOL bParam10, BOOL bParam11) // Position - 0x1F5B Hash - 0x5B7A656E ^0x3AAC2B26
{
	if (!func_54(essParam0))
		return false;
	...
	switch (Global_1360165[essParam0 /*1157*/].f_3)
	{
		...
		case 2:
			if (!func_33(func_62(essParam0), 0))
				return false;
...
void func_73(eStackSize essParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2144 Hash - 0xE11FEEB6 ^0xE11FEEB6
{
	if (!func_12(essParam0))
		return;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2189 Hash - 0x16E871AD ^0x10C54C39
{
...
void func_75(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x21B3 Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	if (func_60(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0);
	...
	if (func_60(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_60(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_60(iParam5, 32), true);
	...
	else if (func_60(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, vParam1, func_60(iParam5, 32), true, true);
	...
	if (isEntityAPed)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0) == Global_35 && !func_60(iParam5, 64))
		{
...
BOOL func_76(eStackSize essParam0, int iParam1) // Position - 0x2435 Hash - 0xB10CB915 ^0x7678EBC
{
	BOOL flag;
...
void func_77(eStackSize essParam0, int iParam1, BOOL bParam2) // Position - 0x2474 Hash - 0xE34CA2E4 ^0x9C7D0427
{
	if (!func_12(essParam0))
		return;

	if (!func_76(essParam0, iParam1))
		return;
...
void func_78(eStackSize essParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x24B4 Hash - 0x1300E8EE ^0xFBE7C64E
{
	Hash hash;
...
void func_79(eStackSize essParam0) // Position - 0x2587 Hash - 0x73C1F6C ^0x73C1F6C
{
	func_138(essParam0);
...
void func_80(Ped pedParam0, int iParam1) // Position - 0x259C Hash - 0x7F605CB ^0x28CA17AF
{
...
BOOL func_81(Ped pedParam0) // Position - 0x25F7 Hash - 0x4E8A039F ^0x9F8FB293
{
	int i;
	Hash weaponHash;
	BOOL num;
...
void func_82(eStackSize essParam0, Ped pedParam1) // Position - 0x2675 Hash - 0x9D727A3E ^0xB12CD64B
{
	if (!func_54(essParam0))
		return;
...
void func_83(eStackSize essParam0, BOOL bParam1, BOOL bParam2) // Position - 0x26EF Hash - 0x2E4D3D00 ^0x2E4D3D00
{
	if (bParam2)
		if (!func_12(essParam0))
			return;
...
BOOL func_84(int iParam0) // Position - 0x2720 Hash - 0xB07F56E4 ^0xA1690581
{
...
int func_85(int iParam0) // Position - 0x2753 Hash - 0xB1EC3C9 ^0x256D499C
{
	if (Global_1572887.f_12 == -1)
...
void func_86(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2772 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_141(eptParam1))
		{
			func_142(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_144(pedParam0, false);
			flag = true;
		}
	
		func_145(pedParam0, iParam2);
	}
...
BOOL func_87(int iParam0) // Position - 0x2853 Hash - 0x958B152F ^0x174871D
{
	return iParam0 > -1 && iParam0 < 954;
}

Hash func_88(int iParam0) // Position - 0x286A Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_87(iParam0))
		return 0;
...
BOOL func_89(Hash hParam0) // Position - 0x2888 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

PersChar func_90(int iParam0) // Position - 0x2894 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_87(iParam0))
		return 0;
...
BOOL func_91(var uParam0, Ped pedParam1, char* sParam2) // Position - 0x28B4 Hash - 0xFB1C2C0E ^0x6794528D
{
	BOOL flag;
	int i;
...
void func_92(Ped pedParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2932 Hash - 0x3CFBB744 ^0xD4A78981
{
	Ped pedIndexFromEntityIndex;
	Object objectIndexFromEntityIndex;

	if (ENTITY::DOES_ENTITY_EXIST(pedParam0) && !ENTITY::IS_ENTITY_DEAD(pedParam0) && fParam2 > 0f)
	{
		...
		{
			objectIndexFromEntityIndex = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(pedParam0);
			OBJECT::_SET_OBJECT_TARGETTABLE_FOCUS(objectIndexFromEntityIndex, true, true);
		}
	
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(pedParam0, sParam1, fParam2, iParam4, iParam5, 0, 0, 0, false, -1);
	}

	return;
}

BOOL func_93(BOOL bParam0) // Position - 0x29D3 Hash - 0xD6E12BEB ^0xEB8894D
{
	return AUDIO::_IS_ANY_CONVERSATION_PLAYING(bParam0);
}

void func_94(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x29E1 Hash - 0x7990926B ^0xBD6909E0
{
	AUDIO::_STOP_ALL_SCRIPTED_CONVERSIONS(bParam0, bParam1, bParam2);
	return;
}

BOOL func_95(Ped pedParam0, Ped pedParam1, float fParam2, BOOL bParam3) // Position - 0x29F3 Hash - 0x6DF7EDD6 ^0x5000CFB6
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
Vector3 func_96(char* sParam0) // Position - 0x2A3B Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_97(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2A4D Hash - 0x4863E989 ^0xB2E91EEF
{
	BOOL flag;
...
float func_98(var uParam0) // Position - 0x2AA7 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_56(uParam0))
		return uParam0->f_1;
...
BOOL func_99(Player plParam0, Ped pedParam1) // Position - 0x2ADC Hash - 0xD760EA9F ^0x4A3F313B
{
	Ped outEntity;
...
BOOL func_100(int iParam0) // Position - 0x2B4E Hash - 0xB0D16BD7 ^0x968915A6
{
	if (iParam0 < 0)
		return false;
...
int func_101(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, int iParam10, Hash hParam11, BOOL bParam12) // Position - 0x2B8D Hash - 0x6B838E14 ^0xADF883E0
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_150(num, hParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, bParam9, false, 0, hParam11, bParam12);
		return num;
	}
...
void func_102(int iParam0, Ped pedParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2C13 Hash - 0xBB7D5433 ^0x394CAC04
{
	int num;

	if (bParam4 && !func_100(iParam0) || !ENTITY::DOES_ENTITY_EXIST(pedParam1))
		return;
	...
	if (iParam3 == 1)
	{
		func_152(iParam0, 18, false, true);
		func_152(iParam0, 17, false, true);
	}

	HUD::_UI_PROMPT_SET_GROUP(Global_1945188[num /*18*/].f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(pedParam1), iParam2);
	return;
}

BOOL func_103(int iParam0) // Position - 0x2C89 Hash - 0x2251CD4F ^0xDC4374D1
{
	int num;
	...
	num = func_151(iParam0);
	return !HUD::_UI_PROMPT_IS_ENABLED(Global_1945188[num /*18*/].f_3);
}

void func_104(int iParam0, BOOL bParam1) // Position - 0x2CB6 Hash - 0x2E594B0B ^0x96F335B4
{
	int num;
...
void func_105(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2CE4 Hash - 0xDB5555BD ^0xDAB11740
{
	int num;
...
BOOL func_106(int iParam0, BOOL bParam1) // Position - 0x2D38 Hash - 0xAAB142C4 ^0x152C664A
{
	int num;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x2D6B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_108(var uParam0, float fParam1) // Position - 0x2D7A Hash - 0x30433BAB ^0xF854D531
{
...
Hash func_109(int iParam0) // Position - 0x2DA0 Hash - 0xBA965109 ^0xCB1D208B
{
	switch (iParam0)
	{
		case 0:
...
void func_110(eStackSize essParam0, Ped pedParam1) // Position - 0x2F7C Hash - 0xC6503D1A ^0x107B4B14
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam1))
		func_156(pedParam1);
...
float func_111(Ped pedParam0, Player plParam1, BOOL bParam2) // Position - 0x2F96 Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_157(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(plParam1, false, false));
}

Hash func_112(eStackSize essParam0, BOOL bParam1) // Position - 0x2FED Hash - 0xA64DC151 ^0x7D83907B
{
	if (!func_54(essParam0))
		return 0;
	...
	if (bParam1)
	{
		Global_1360165[essParam0 /*1157*/].f_127 = func_158(essParam0);
		return Global_1360165[essParam0 /*1157*/].f_127;
	}
...
void func_113(eStackSize essParam0) // Position - 0x3132 Hash - 0xF7FD9E75 ^0xF411CFCB
{
	Player player;
	ItemSet itemset;
	int i;
...
PersChar func_114(eStackSize essParam0, BOOL bParam1) // Position - 0x31A8 Hash - 0xF1265AC3 ^0xD7133EF8
{
	if (!func_54(essParam0))
		return 0;

	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(Global_1360165[essParam0 /*1157*/].f_126) && bParam1)
		Global_1360165[essParam0 /*1157*/].f_126 = func_159(essParam0);

	return Global_1360165[essParam0 /*1157*/].f_126;
}

void func_115(eStackSize essParam0) // Position - 0x31F4 Hash - 0xA6C3B06B ^0x3AB8265A
{
	int i;
...
void func_116(eStackSize essParam0, int iParam1) // Position - 0x3247 Hash - 0xEBFF508D ^0x493427AF
{
	if (!func_54(essParam0))
		return;
...
int func_117(eStackSize essParam0, eStackSize essParam1, BOOL bParam2, BOOL bParam3) // Position - 0x326B Hash - 0xEC801E93 ^0x8D937378
{
	int num;
	var unk;
	int endRange;
	...
	switch (essParam1)
	{
		...
		case 1:
			switch (essParam0)
			{
				...
				case 10:
					if (func_160(Global_1347702[63 /*49*/].f_15, true) || func_119(Global_1347702[63 /*49*/].f_15))
						unk[0] = -268604689;
					else
						unk[0] = -310473775;
					break;
				...
				case 18:
					...
					else if (func_27(18, 134217728, true))
					{
						unk[0] = 961676983;
					}
					else
		...
		case 3:
			switch (essParam0)
			{
				...
				case 11:
					if (func_160(Global_1347702[134 /*49*/].f_15, true) || func_119(Global_1347702[134 /*49*/].f_15))
					{
						unk[0] = -2040275819;
						unk[1] = 1205492208;
						endRange = 2;
		...
		case 7:
			...
			{
				case 4:
					if (func_162(joaat("CSTAG_FLOW_MAR8_POST"), true) && !func_160(Global_1347702[1 /*49*/].f_15, true))
						unk[0] = -1155031950;
					else
						unk[0] = -1341683964;
					break;
	...
	if (bParam3 && ENTITY::DOES_ENTITY_EXIST(func_62(essParam0)))
	{
	...
	if (!func_76(essParam0, num2))
		num2 = Global_40.f_4942[essParam0 /*60*/].f_3;

	return num2;
}

BOOL func_118(int iParam0) // Position - 0x4054 Hash - 0x8EF26C67 ^0x9855652A
{
	int num;
...
BOOL func_119(int iParam0) // Position - 0x40BF Hash - 0xCAB4B86D ^0xCAB4B86D
{
	int num;
...
BOOL func_120(int iParam0) // Position - 0x40DD Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case -1205468859:
...
BOOL func_121(eStackSize essParam0, BOOL bParam1) // Position - 0x410A Hash - 0xAA2527A1 ^0x8C2C75CE
{
	int num;
	...
	if (!bParam1)
		if (func_13(essParam0) || func_35(essParam0, 44, true))
			return false;
...
struct<7> func_122(eStackSize essParam0, int iParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0x4193 Hash - 0xDA7D22BD ^0xF82EFD7F
{
	eStackSize stackSize;
...
void func_123(eStackSize essParam0, BOOL bParam1) // Position - 0x41F6 Hash - 0x14E0BC6D ^0x14E0BC6D
{
	Ped ped;
...
void func_124(eStackSize essParam0, BOOL bParam1) // Position - 0x422D Hash - 0x14E0BC6D ^0x14E0BC6D
{
	Ped ped;
...
void func_125(eStackSize essParam0, BOOL bParam1) // Position - 0x4264 Hash - 0xD602D5AC ^0xD602D5AC
{
	Ped ped;
...
void func_126(eStackSize essParam0, BOOL bParam1) // Position - 0x42A8 Hash - 0x1364490 ^0x1364490
{
	Ped ped;
...
Ped func_127(Ped pedParam0) // Position - 0x42DF Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_128(Ped pedParam0) // Position - 0x42E9 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_129(Ped pedParam0) // Position - 0x431B Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_130(eStackSize essParam0, int iParam1) // Position - 0x435D Hash - 0xE0095B63 ^0x929CAC47
{
	int num;
	int offset;
	...
	func_174(iParam1, &num, &offset);
	return MISC::IS_BIT_SET(Global_1360165[essParam0 /*1157*/].f_65[num], offset);
}

BOOL func_131(int iParam0) // Position - 0x4393 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
Hash func_132(int iParam0, eStackSize essParam1) // Position - 0x43A6 Hash - 0xE1D12727 ^0x6E706E61
{
	int num;
	...
	switch (iParam0)
	{
		...
		case 296923297:
			num = func_175(296923297, essParam1);
			return func_176(num);
		...
		case 1237718549:
			num = func_175(1237718549, essParam1);
			return func_176(num);
...
BOOL func_133(Ped pedParam0, Hash hParam1) // Position - 0x4848 Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_134(Ped pedParam0, Hash hParam1) // Position - 0x4876 Hash - 0x294DAA1E ^0x7D27D179
{
	Hash _int;
...
BOOL func_135(Ped pedParam0, Hash hParam1) // Position - 0x48C6 Hash - 0x294DAA1E ^0x7D27D179
{
	Hash _int;
	int _int2;
...
void func_136(Ped pedParam0) // Position - 0x4936 Hash - 0xE2B15D20 ^0xD326BE0E
{
...
void func_137(eStackSize essParam0, Ped pedParam1, BOOL bParam2) // Position - 0x4953 Hash - 0xF8298322 ^0x7D3D3E5
{
...
void func_138(eStackSize essParam0) // Position - 0x4F31 Hash - 0x83966A8E ^0x24FDDDED
{
	func_177(essParam0, 1);
	func_177(essParam0, MICRO);
	func_177(essParam0, 256);
	func_177(essParam0, MINI);
	func_177(essParam0, 1024);
	func_177(essParam0, 2048);
	func_177(essParam0, 4096);
	func_177(essParam0, 65536);
	func_177(essParam0, 16384);
	func_177(essParam0, 262144);
	func_177(essParam0, 524288);
	func_177(essParam0, 1048576);
	func_177(essParam0, 2097152);
	func_177(essParam0, 32768);
	func_177(essParam0, 131072);
	func_177(essParam0, 134217728);
	func_177(essParam0, 1073741824);
	return;
}

void func_139(eStackSize essParam0, BOOL bParam1) // Position - 0x4FDA Hash - 0xA7580A6E ^0x4C436D0C
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_1360165[essParam0 /*1157*/]))
		return;
...
Hash func_140(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13) // Position - 0x504D Hash - 0xAB9CFACB ^0x8DB6D77C
{
	Hash weaponHash;
		...
		default:
			...
			if (WEAPON::IS_WEAPON_A_GUN(weaponHash) || WEAPON::IS_WEAPON_MELEE_WEAPON(weaponHash) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(pedParam0) == joaat("rel_gang_dutchs"))
			{
				...
				if (!Global_43891 && MISC::_DOES_STRING_EXIST_IN_STRING(&string1, "_DUALWIELD"))
				{
					...
					if (func_178(hashKey) && WEAPON::_0xF252A85B8F3F8C58(defaultPedWeaponCollection, hashKey))
						flag = true;
				}
				...
				if (!flag)
				{
					...
					if (weapontypeGroup != 0 && defaultPedWeaponCollection != 0)
					{
						...
						if (!Global_43891)
							if (func_178(hash) && hash != weaponHash)
								weaponHash = hash;
						else
							hash == weaponHash;
					}
	...
	if (func_179() == -1 && !func_180(weaponHash))
	{
	...
	if (iParam9 < 0)
	{
		if (pedParam0 != Global_35 && func_178(weaponHash))
		{
	...
	{
		func_181(weaponHash, iParam9, bParam2, bParam5, bParam4, bParam11, 752097756, false);
	}
	else if (!bParam13)
	{
		permanentDegradation = 0f;
		func_182(pedParam0, &weaponHash, &permanentDegradation);
...
BOOL func_141(ePedType eptParam0) // Position - 0x53F9 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_142(Ped pedParam0, Hash hParam1) // Position - 0x584C Hash - 0x4D6406DD ^0xFCB8AE48
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_143(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x58F3 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_144(Ped pedParam0, BOOL bParam1) // Position - 0x5923 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_145(Ped pedParam0, int iParam1) // Position - 0x5968 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_146(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x598F Hash - 0xFDACD718 ^0x658C9335
{
	int i;
...
BOOL func_147(var uParam0) // Position - 0x59E1 Hash - 0x39705408 ^0x39705408
{
	return func_107(*uParam0, 2);
}

float func_148() // Position - 0x59F1 Hash - 0xB5A1F69B ^0x5409CF38
{
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x5A23 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
int func_151(int iParam0) // Position - 0x5CEA Hash - 0xC9D82232 ^0xC9D82232
{
	return iParam0;
}

void func_152(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5CF4 Hash - 0x4C8DF022 ^0x193FDB49
{
	int num;
...
void func_153(int iParam0) // Position - 0x5D3F Hash - 0x8FF365FE ^0xD4724536
{
	if (!func_187(iParam0))
		return;
...
void func_154(var uParam0, int iParam1) // Position - 0x5DF2 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_155(var uParam0, int iParam1) // Position - 0x5E03 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_156(Ped pedParam0) // Position - 0x5E18 Hash - 0x55F7AFFF ^0x3C957658
{
	int _int;
...
float func_157(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5E7D Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
Hash func_158(eStackSize essParam0) // Position - 0x5E9B Hash - 0xEB890713 ^0xB40CD388
{
	Hash hash;
	int i;
...
PersChar func_159(eStackSize essParam0) // Position - 0x5F7C Hash - 0xF15D53A9 ^0x3132AAF6
{
	Hash persCharHash;
...
BOOL func_160(int iParam0, BOOL bParam1) // Position - 0x6018 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
BOOL func_161(int iParam0, int iParam1, int iParam2) // Position - 0x6049 Hash - 0xD8381BE7 ^0xD8381BE7
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_162(int iParam0, BOOL bParam1) // Position - 0x60F2 Hash - 0xB6F2B948 ^0x8948B8BB
{
	int i;
...
int func_163(int iParam0) // Position - 0x6131 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_164(int iParam0) // Position - 0x6172 Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_84(iParam0))
		return -1;
...
void func_165(Player plParam0) // Position - 0x618E Hash - 0x68A3D5AB ^0x62583FE3
{
	if (func_190(plParam0, false))
		return;
...
void func_166(eStackSize essParam0) // Position - 0x61DA Hash - 0xB1E2E498 ^0xC7EBD371
{
	Player player;
	...
	if (func_112(essParam0, false) == 0)
		return;

	player = func_42(essParam0);
	func_165(player);
	func_68(essParam0, 8192, true);
	return;
}

void func_167(Player plParam0) // Position - 0x6215 Hash - 0xB38DCC50 ^0x941BF21E
{
	if (func_190(plParam0, false))
		return;
...
void func_168(eStackSize essParam0) // Position - 0x6242 Hash - 0x28CD0E89 ^0xB9FC8A12
{
	Player player;
	...
	player = func_42(essParam0);
	func_167(player);
	func_68(essParam0, 8192, false);
	return;
}

void func_169(Player plParam0) // Position - 0x627D Hash - 0x26D51EE5 ^0xA25A14D9
{
	if (func_190(plParam0, false))
		return;
...
void func_170(Ped pedParam0) // Position - 0x62B3 Hash - 0x6EDA2DDB ^0x823A87C9
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_171(eStackSize essParam0) // Position - 0x6332 Hash - 0xB1E2E498 ^0x545B1681
{
	Player player;
	...
	player = func_42(essParam0);
	func_169(player);
	func_68(essParam0, 16384, true);
	return;
}

void func_172(Player plParam0) // Position - 0x636D Hash - 0x972BAF6E ^0xD19596A6
{
	if (func_190(plParam0, false))
		return;
...
void func_173(eStackSize essParam0) // Position - 0x63A1 Hash - 0x28CD0E89 ^0x67E48CA5
{
	Player player;
	...
	player = func_42(essParam0);
	func_172(player);
	func_68(essParam0, 16384, false);
	return;
}

int func_174(int iParam0, var uParam1, var uParam2) // Position - 0x63DC Hash - 0x44294A7 ^0x44294A7
{
	int num;
...
int func_175(int iParam0, eStackSize essParam1) // Position - 0x63FE Hash - 0x2641680 ^0x6B70222B
{
	int randomIntInRange;
	int num;
	int num2;
	...
	if (essParam1 != -1)
		if (func_76(essParam1, num))
			num2 = num;

	return num2;
}

int func_176(int iParam0) // Position - 0x64D5 Hash - 0xDEAE5330 ^0x7DE1135D
{
	switch (iParam0)
	{
		case -2040275819:
...
void func_177(eStackSize essParam0, eStackSize essParam1) // Position - 0x654C Hash - 0x319C37AC ^0x8ABBFC1F
{
	Global_40.f_4942[essParam0 /*60*/].f_5 = Global_40.f_4942[essParam0 /*60*/].f_5 - Global_40.f_4942[essParam0 /*60*/].f_5 && essParam1;
	return;
}

BOOL func_178(Hash hParam0) // Position - 0x657C Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

BOOL func_179() // Position - 0x6597 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_180(Hash hParam0) // Position - 0x65A5 Hash - 0x8C6B1607 ^0xFBDEB3EC
{
	Hash weaponUnlock;
...
int func_181(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x65CD Hash - 0x61DE9CAE ^0x4ADCEE54
{
	var unk;
	Hash hash;
	var unk6;
	...
	{
		unk = { func_192(hParam0, false, true) };
	...
	if (func_198(false))
	{
		...
		func_199(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0), iParam1, hParam6);
		func_200(hParam0, iParam1);
		return 1;
	}
...
void func_182(Ped pedParam0, var uParam1, var uParam2) // Position - 0x671F Hash - 0x236D39D4 ^0x39F583A
{
	BOOL flag;
	Hash entityModel;
...
BOOL func_183(Hash hParam0) // Position - 0x6936 Hash - 0xE6B34BF5 ^0xE4729149
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

void func_184(int iParam0, BOOL bParam1) // Position - 0x6948 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_185(int iParam0, BOOL bParam1) // Position - 0x69A0 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_186(int iParam0, int iParam1) // Position - 0x69C9 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
BOOL func_187(int iParam0) // Position - 0x69F1 Hash - 0xF7D98D06 ^0xF7D98D06
{
	return func_149(iParam0, 2);
}

BOOL func_188(int iParam0) // Position - 0x6A00 Hash - 0x8232DC08 ^0x5AF1E79C
{
	int num;
	int offset;
...
int func_189(int iParam0) // Position - 0x6A24 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
BOOL func_190(Ped pedParam0, BOOL bParam1) // Position - 0x6AA5 Hash - 0x4B9AB644 ^0x1F788987
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (bParam1)
...
int func_191(int iParam0, int iParam1) // Position - 0x6AD2 Hash - 0xB7443904 ^0xB7443904
{
	switch (iParam0)
	{
		case -2051275045:
...
struct<5> func_192(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6E66 Hash - 0xE6705E3C ^0xB9EA38F4
{
	var unk;
	var unk6;
	var unk28;
	...
	{
		case joaat("UPGRADE"):
			if (func_208(hParam0, -1823706425))
			{
				unk = { func_196(joaat("kit_camp"), unk, joaat("SLOTID_SATCHEL"), bParam1) };
				unk.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(hParam0, joaat("kit_camp"));
			}
			else if (func_208(hParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
		...
		case joaat("WEAPON"):
			unk = { func_204(bParam1) };
		
			if (bParam2 && func_205(hParam0, true))
			{
				unk6.f_9 = joaat("SLOTID_NONE");
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(hParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_209(unk, &unk28, bParam1, false))
				{
					unk.f_4 = 0;
				}
				else
...
Hash func_193(int iParam0, int iParam1) // Position - 0x7123 Hash - 0xE1D12727 ^0x71D656A6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_194(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3) // Position - 0x926E Hash - 0x4285A587 ^0x4285A587
{
	return func_210(hParam0, *uParam1, hParam2, bParam3) > 0;
}

BOOL func_195(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x9286 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;

	if (func_211(hParam0, &unk, panParam1, hParam2))
		return panParam1->f_17 > 0f;

	return false;
}

struct<4> func_196(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x92A7 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
BOOL func_197(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x92D8 Hash - 0xA0AA5F74 ^0x6BC7AEA2
{
	var unk;
	int num;
	...
	if (!func_209(*panParam1, &unk, bParam6, false))
		return false;
...
BOOL func_198(BOOL bParam0) // Position - 0x9368 Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_179() == -1)
		return true;
...
int func_199(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x9386 Hash - 0xCABE5725 ^0xB186E46E
{
	if (iParam1 < 1)
		return 1;
...
void func_200(Hash hParam0, int iParam1) // Position - 0x93C1 Hash - 0xBFC80B98 ^0x997FC438
{
	int ammo;
	int ammo2;
	...
	{
		ammo2 = func_216(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
int func_201(int iParam0, var uParam1, var uParam2) // Position - 0x9409 Hash - 0x44294A7 ^0x44294A7
{
	int num;

	num = func_217(iParam0, 1);
	*uParam1 = num / 31;
	*uParam2 = num % 31;
	return 1;
}

struct<4> func_202(BOOL bParam0) // Position - 0x942B Hash - 0x90FA0E77 ^0x3A1AB59A
{
	return func_196(joaat("character"), func_218(), joaat("SLOTID_NONE"), bParam0);
}

int func_203(Hash hParam0) // Position - 0x9447 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
struct<4> func_204(BOOL bParam0) // Position - 0x9472 Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
	...
	if (num == 2)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223200))
			Global_1223200 = { func_196(923904168, func_202(bParam0), -740156546, bParam0) };
	...
	else if (num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223208))
			Global_1223208 = { func_196(923904168, func_202(bParam0), -740156546, false) };
	
		return Global_1223208;
	}

	return func_196(923904168, func_202(bParam0), -740156546, false);
}

BOOL func_205(Hash hParam0, BOOL bParam1) // Position - 0x9507 Hash - 0x62864AB ^0xBC339691
{
...
struct<4> func_206(BOOL bParam0) // Position - 0x9540 Hash - 0x8A689EFF ^0x60C7E77C
{
	int num;
	...
	if (num == 2 || num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1223204))
			Global_1223204 = { func_196(271701509, func_202(bParam0), 12999093, false) };
	
		return Global_1223204;
	}

	return func_196(271701509, func_202(bParam0), 12999093, false);
}

Hash func_207(Hash hParam0) // Position - 0x95A4 Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
BOOL func_208(Hash hParam0, Hash hParam1) // Position - 0x95CF Hash - 0x1874093C ^0x7F0FACAB
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_209(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6) // Position - 0x962E Hash - 0xC40FC7D1 ^0x18789FFF
{
...
int func_210(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x965E Hash - 0xD01EE834 ^0xC97ABD1E
{
	var guid;
...
BOOL func_211(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x96A6 Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;

	inventoryId = func_213(false);
	*panParam1 = { func_196(hParam0, func_204(false), hParam3, false) };
...
BOOL func_212(Hash hParam0, int iParam1) // Position - 0x96EB Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
int func_213(BOOL bParam0) // Position - 0x9705 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_179() == -1)
	{
...
BOOL func_214(Hash hParam0) // Position - 0x9746 Hash - 0xC561A1F5 ^0xE0EE3BCE
{
...
BOOL func_215(Hash hParam0) // Position - 0x975C Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_216(int iParam0, int iParam1) // Position - 0x976A Hash - 0x20FBB09E ^0x20FBB09E
{
	if (iParam0 > iParam1)
		return iParam1;
...
int func_217(int iParam0, int iParam1) // Position - 0x9780 Hash - 0x99A93628 ^0x27AE8C83
{
	switch (iParam0)
	{
...
struct<4> func_218() // Position - 0xAE8D Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
BOOL func_219(int iParam0) // Position - 0xAE99 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_220(iParam0))
		return false;
...
BOOL func_220(int iParam0) // Position - 0xAEB5 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_221(int iParam0) // Position - 0xAEC8 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
