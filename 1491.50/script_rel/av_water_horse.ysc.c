...
void main() // Position - 0x0 Hash - 0x74327A09 ^0x7605E972
{
	var unk;
	BOOL flag;
	...
	hLocal_44 = joaat("world_animal_horse_drink_ground_domestic");
	iLocal_45 = -1;
	fLocal_46 = 0.5f;
	unk.f_1 = -1;
	unk.f_3.f_9 = 3;
...
void func_4(var uParam0) // Position - 0x9DA Hash - 0x4DA9BC8C ^0x9E5CB607
{
	func_33(uParam0, &func_30, &func_31, &func_32);
	return;
}

void func_5(Volume volParam0) // Position - 0x9F4 Hash - 0x7DD010A2 ^0x16530136
{
...
BOOL func_6(var uParam0) // Position - 0xA0B Hash - 0x66ED4AB7 ^0x77055C23
{
	float num;
	float num2;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xAC9 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_8(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAF3 Hash - 0x746D7F2E ^0x5120CFB
{
	int i;
	int num;
	float num2;
...
void func_9(int iParam0, int iParam1) // Position - 0xC44 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_10(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC59 Hash - 0x563CDE2F ^0xDC1014A4
{
...
int func_11(int iParam0) // Position - 0xCFD Hash - 0xB8EC44B7 ^0xC519E6BC
{
	switch (iParam0)
	{
		case -1:
...
float func_12(int iParam0) // Position - 0x1AAE Hash - 0xD8BD2EF7 ^0x95BA15D9
{
	if (func_43(iParam0))
	{
...
Volume func_13(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x1B14 Hash - 0xC1E3A062 ^0xD42263D3
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BCE Hash - 0x52EDCA13 ^0x5ED8B7A1
{
	func_46(uParam0, "WATER_HORSE", "", vParam1, uParam4);
	hLocal_38 = joaat("a_m_m_htlroughtravellers_01");

	switch (*uParam0)
	{
		case 54:
			sLocal_43 = "script_respawn@looping@hybrid@generic@unarmed_hat@sit_wake_up@a";
			hLocal_44 = joaat("world_animal_horse_grazing_domestic");
			hLocal_38 = func_48(func_47(), false, false, false, false, false, true);
			hLocal_39 = func_49(joaat("horse_class_riding"), true);
			func_50(uParam0, 0, "MPDHP_MAN", hLocal_38, vParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 1, "MPDHP_HORSE", hLocal_39, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -4f, 0f, 0f), 10f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	
		case 74:
			hLocal_38 = func_48(func_47(), true, true, true, true, true, true);
			sLocal_43 = "script_respawn@one_shot@hybrid@near_water@unarmed@crouch_stream_wash@b";
			hLocal_39 = func_49(joaat("horse_class_riding"), true);
			func_50(uParam0, 1, "MPDHP_HORSE", hLocal_39, vParam1, uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 0, "MPDHP_MAN", hLocal_38, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, uParam4.f_2, -2f, 0f, 0f), 10f + uParam4.f_2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
Vector3 func_15(var uParam0) // Position - 0x1D02 Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1DA2 Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1EBC Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x2085 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return 1;
}

BOOL func_19(var uParam0) // Position - 0x208E Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x223E Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x22B2 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2301 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x2359 Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x24C2 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27E9 Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x2920 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A50 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A8F Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A98 Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2ACA Hash - 0xE5D8AE7A ^0x5FB90E97
{
...
int func_31(var uParam0) // Position - 0x2B19 Hash - 0x94A0D06D ^0xFA229AD6
{
	var unk;
	int i;
	Entity outEntity;
	...
	if (!uParam0->f_469[0])
	{
		for (i = 0; i < 2; i = i + 1)
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				if (func_65(uParam0->f_20[i /*14*/], 0, &uLocal_10, &unk, 0, 0))
				{
					func_66(uParam0);
					uParam0->f_469[0] = 1;
					break;
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_67(&(uParam0->f_20[1 /*14*/].f_5), 1, 10, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], hLocal_44, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1082130432, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				func_67(&(uParam0->f_20[0 /*14*/].f_5), 1, 10, false);
				func_69(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 2, 1073741824);
			
				if (*uParam0 == 54)
				{
					func_70(uParam0->f_20[0 /*14*/], joaat("world_human_sit_fall_asleep"), 0, false, 0, -1082130432);
					PED::_0xF9CBD46433E36713(Global_35, uParam0->f_20[0 /*14*/], 0f, 0f, 0f, 4f, 20f, 200f, -1f, "MPDHP_MAN");
				}
				else
				{
					TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_43, "respawn_loop", 1090519040, -1056964608, -1, 1, 0, false, 0, false, 0, false);
				}
			
				func_68(&uParam0->f_20[0 /*14*/], false, true);
		...
		case 1:
			if (*uParam0 == 54)
			{
				if (PLAYER::GET_PLAYER_INTERACTION_TARGET_ENTITY(PLAYER::GET_PLAYER_INDEX(), &outEntity, false, false))
				{
					...
					{
						if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(outEntity) == uParam0->f_20[0 /*14*/] && PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, joaat("INPUT_INTERACT_LOCKON_POS")) || PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, joaat("INPUT_INTERACT_LOCKON_NEG")))
						{
							if (PED::_GET_ACTIVE_DYNAMIC_SCENARIO_2(uParam0->f_20[0 /*14*/]) != joaat("world_human_sit_ground_sleeping_male_a"))
							{
								func_66(uParam0);
								iLocal_9 = 2;
							}
			...
			else if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
		...
		case 2:
			...
			{
				if (func_77(&uLocal_40, *uParam0 == 54 ? 240f : fLocal_46) || func_78(uParam0->f_20[0 /*14*/], Global_35, true) < 100f)
				{
					PED::SET_PED_SHOULD_PLAY_DIRECTED_NORMAL_SCENARIO_EXIT(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/].f_5);
					TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
				
					if (*uParam0 != 54)
						TASK::TASK_PLAY_ANIM(0, sLocal_43, "respawn_action", 1090519040, -1056964608, -1, 0, 0, false, 0, false, 0, false);
		...
		case 3:
			...
			if (func_77(&uLocal_40, 20f) && func_78(Global_35, uParam0->f_20[0 /*14*/], true) > 10000f)
				return 1;
			break;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2F4E Hash - 0xB5FF068 ^0xEBA69FB7
{
	int i;
	...
	for (i = 0; i < uParam0->f_19; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[i /*14*/]))
		{
			if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uParam0->f_20[i /*14*/], true))
			{
				...
				func_80(&uParam0->f_20[i /*14*/], true, true, true);
...
void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2FD6 Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2FF3 Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x312F Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3268 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3312 Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x338A Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
...
BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3419 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x3534 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3540 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x36C8 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3768 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x377B Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x3795 Hash - 0xEA796703 ^0x695D7925
{
...
void func_46(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x37FD Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_47() // Position - 0x3829 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

Hash func_48(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3837 Hash - 0x47080353 ^0x770B5231
{
	int num;
	var unk;
	int endRange;
...
Hash func_49(int iParam0, BOOL bParam1) // Position - 0x3A29 Hash - 0x573C265C ^0xB5DCB17B
{
	switch (iParam0)
	{
...
void func_50(var uParam0, int iParam1, char* sParam2, Hash hParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3AE3 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_51(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B71 Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	{
		num = func_95(Global_1898164.f_1[0 /*5*/]);
	
		if (func_96(num) && func_97(Global_1347702[num /*49*/].f_12, 131072))
			return false;
	}
...
int func_52(int iParam0) // Position - 0x3D75 Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3D89 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_54() // Position - 0x3D98 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_81() != -1;
}

BOOL func_55(var uParam0, Any* panParam1) // Position - 0x3DB3 Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3E12 Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_99(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_57(Ped pedParam0) // Position - 0x3E54 Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x3E80 Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_59(var uParam0, BOOL bParam1) // Position - 0x3EFC Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_60(var uParam0, BOOL bParam1) // Position - 0x3F22 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3F44 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3F66 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_63(var uParam0, BOOL bParam1) // Position - 0x3F88 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_64(var uParam0, int iParam1) // Position - 0x3FAC Hash - 0x4F8BE4B5 ^0x8254350D
{
	uParam0->f_21 = iParam1;
	return;
}

BOOL func_65(Ped pedParam0, Entity eParam1, int iParam2, var uParam3, int iParam4, int iParam5) // Position - 0x3FBA Hash - 0xED93B9E0 ^0x288D4ED6
{
	int frameCount;
	...
	if (frameCount > iParam2->f_5)
		func_108(iParam2, true, frameCount);
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		...
		if (!(iParam2->f_1 & 128 != 0))
		{
			...
			{
				*uParam3 = 128;
				func_110(pedParam0, iParam2, *uParam3);
				return true;
			}
		}
		...
		if (Global_1935630.f_27)
		{
			if (!(iParam2->f_1 & 8 != 0))
			{
				...
				else if (func_112(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 8;
					func_110(pedParam0, iParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_114(PLAYER::PLAYER_ID(), false, true, iParam2->f_1 & 524288 == 0))
		{
		...
		if (Global_1935630.f_25)
		{
			if (func_115(iParam2, 1065353216))
			{
				if (!(iParam2->f_1 & 4 != 0))
				{
					if (func_116(Global_35, pedParam0, iParam2))
					{
						*uParam3 = 4;
						func_110(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 16 != 0))
		{
			...
			{
				if (func_118(Global_35, pedParam0, iParam2, false))
				{
					*uParam3 = 16;
					func_110(pedParam0, iParam2, *uParam3);
					return true;
			...
			else if (func_118(Global_35, pedParam0, iParam2, true))
			{
				*uParam3 = 16;
				func_110(pedParam0, iParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!(iParam2->f_1 & 2 != 0))
			{
				...
				{
					if (func_122(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, false, *iParam2 & 256 != 0) && func_123(iParam2, pedParam0) && func_124(iParam2, pedParam0))
					{
						*uParam3 = 2;
						func_110(pedParam0, iParam2, *uParam3);
						return true;
		...
		if (!(iParam2->f_1 & 2 != 0))
		{
			if (iParam2->f_12 < 4f)
			{
				if (func_122(pedParam0, Global_1935630.f_41, *iParam2 & 128 != 0, true, *iParam2 & 256 != 0) && func_123(iParam2, pedParam0) && func_124(iParam2, pedParam0))
				{
					*uParam3 = 2;
					func_110(pedParam0, iParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*iParam2 & 131072 == 0)
						{
							if (func_125(pedParam0, Global_1935630.f_41))
							{
								func_126();
								*uParam3 = 2;
								func_110(pedParam0, iParam2, *uParam3);
			...
			if (iParam2->f_12 < 10f)
			{
				if (func_127(iParam2, pedParam0) || iParam2->f_9 > 0 && func_128() - iParam2->f_9 < 2000)
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*iParam2 & 131072 == 0)
				{
					if (func_129())
					{
						if (func_125(pedParam0, Global_1935630.f_42))
						{
							func_126();
							*uParam3 = 2;
							func_110(pedParam0, iParam2, *uParam3);
		...
		if (iParam2->f_12 < iParam2->f_26)
		{
			...
			{
				if (func_131(pedParam0, eParam1, iParam2))
				{
					*uParam3 = 2048;
					func_110(pedParam0, iParam2, *uParam3);
					return true;
...
void func_66(var uParam0) // Position - 0x45E5 Hash - 0x9AAA1A3 ^0x9AAA1A3
{
	if (!uParam0->f_469[1])
	{
		func_72(*uParam0, false);
...
int func_67(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x462E Hash - 0x3FCE88FF ^0x3FCE88FF
{
	var groundZ;
	int num;
	BOOL flag;
...
void func_68(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4725 Hash - 0x6DE5BABD ^0x14BE368D
{
...
void func_69(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x474D Hash - 0xF46E0F16 ^0xED4BA72A
{
	...
	pedParam0 == func_139(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_140(pedParam0))
		if (func_141(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
			PHYSICS::_UNHITCH_HORSE(pedParam0);

	if (func_142(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0);
	...
	if (func_142(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_142(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, vParam1, fParam4, true, func_142(iParam5, 32), true);
	...
	else if (func_142(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, vParam1, func_142(iParam5, 32), true, true);
	...
	if (isEntityAPed)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0) == Global_35 && !func_142(iParam5, 64))
		{
...
void func_70(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x49CF Hash - 0x5050B938 ^0x5BDC33E5
{
	TASK::TASK_START_SCENARIO_IN_PLACE_HASH(pedParam0, hParam1, iParam2, bParam3, hParam4, iParam5, false);
	return;
}

BOOL func_71(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x49E8 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		num2 = func_146(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_78(Global_35, uParam0->f_20[i /*14*/], true);
...
void func_72(int iParam0, BOOL bParam1) // Position - 0x4BF3 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_73(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4CCA Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
BOOL func_74(var uParam0) // Position - 0x4DCE Hash - 0x5001E582 ^0x5001E582
{
	return func_151(*uParam0, 1);
}

void func_75(var uParam0) // Position - 0x4DDE Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_152(uParam0, 0f);
	return;
}

var func_76(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4DED Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_77(var uParam0, float fParam1) // Position - 0x4E04 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_74(uParam0))
		return false;
...
float func_78(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x4E2B Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_154(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

BOOL func_79(Ped pedParam0, int iParam1) // Position - 0x4E82 Hash - 0x9BD5E73F ^0xD367FD44
{
	int num;
...
void func_80(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4F81 Hash - 0xEB76F1D1 ^0xF1B7E213
{
...
int func_81() // Position - 0x4FEF Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_82(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4FFD Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_83(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x5064 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_84(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x508D Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_1415419.f_9721[i /*8*/].f_2)
			if (func_155(uParam0, Global_1415419.f_9721[i /*8*/].f_4, fParam3, false))
				return true;
	}
...
BOOL func_85(var uParam0, var uParam1, var uParam2) // Position - 0x50D9 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (Global_32074.f_2697.f_1495[i /*4*/] != -1)
			if (func_155(uParam0, Global_32074.f_2697.f_1495[i /*4*/].f_1, 1f, false))
				return true;
	}
...
int func_86(int iParam0) // Position - 0x5128 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_87(int iParam0) // Position - 0x514D Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_88(int iParam0) // Position - 0x5160 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_89(int iParam0) // Position - 0x5173 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_90(int iParam0) // Position - 0x5186 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_91(int iParam0) // Position - 0x5198 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_92(int iParam0, int iParam1) // Position - 0x51AA Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5244 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_94() // Position - 0x527C Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_95(int iParam0) // Position - 0x52CF Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_98(iParam0))
		return -1;
...
BOOL func_96(int iParam0) // Position - 0x52EF Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_97(int iParam0, int iParam1) // Position - 0x5305 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_98(int iParam0) // Position - 0x5314 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_99(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5347 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_165(eptParam1))
		{
			func_166(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_168(pedParam0, false);
			flag = true;
		}
	
		func_169(pedParam0, iParam2);
	}
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x5428 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_107(iParam0, 4);
	else
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x5446 Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_107(iParam0, 8);
	else
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x5466 Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_107(iParam0, 16);
...
void func_103(int iParam0, BOOL bParam1) // Position - 0x5491 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_107(iParam0, 32);
	else
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x54B1 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_107(iParam0, 64);
	else
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x54D1 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x54F3 Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_107(int iParam0, int iParam1) // Position - 0x5517 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_108(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5528 Hash - 0x37D64B11 ^0xE7060A9E
{
	func_170(iParam2);
			...
			if (*iParam0 & 16 != 0)
				if (!(*iParam0 & 33554432 != 0))
					if (iParam0->f_13 == joaat("weapon_thrown_dynamite"))
						...
						if (func_172(true))
							func_107(iParam0, 33554432);
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && !func_172(true) || *iParam0 & 8192 != 0)
...
BOOL func_109(Ped pedParam0, int iParam1) // Position - 0x56F3 Hash - 0x3A755B4E ^0xDBAC23C2
{
	Hash recentEvent;
	...
	switch (recentEvent)
	{
		...
		case joaat("event_dead_ped_found"):
			...
			if (!func_175(pedParam0, iParam1, pedIndexFromEntityIndex))
				return false;
		
			if (func_176(pedParam0, pedIndexFromEntityIndex) <= func_177(iParam1))
				return true;
			break;
	}
...
void func_110(Ped pedParam0, int iParam1, int iParam2) // Position - 0x57CA Hash - 0x7B438605 ^0x99F8E9DA
{
	if (iParam2 != 16384)
	...
	func_179(iParam1, true);
	func_180();
	return;
}

BOOL func_111(Ped pedParam0, int iParam1) // Position - 0x5807 Hash - 0x48FE638E ^0x6AD20F95
{
	float num;
	float num2;
	int num3;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_181(pedParam0, !(*iParam1 & 268435456 != 0), !(*iParam1 & 536870912 != 0), !(*iParam1 & 1073741824 != 0), 0, false))
		{
			if (iParam1->f_12 < 5f)
				num = 95f;
			...
			if (func_183(iParam1, pedParam0, num, num2))
			{
				if (iParam1->f_2 == 0)
					iParam1->f_2 = MISC::GET_GAME_TIMER();
			
				num3 = MISC::GET_GAME_TIMER() - iParam1->f_2;
				num4 = func_184(iParam1);
...
BOOL func_112(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x58EE Hash - 0x899101A2 ^0xBCA80002
{
	float num;
	float num2;
	...
	if (func_185(eParam1, !(*iParam2 & 268435456 != 0), !(*iParam2 & 536870912 != 0), !(*iParam2 & 1073741824 != 0), 0))
	{
		if (iParam2->f_12 < 5f)
			num = 95f;
		...
		num2 = func_182(iParam2);
	
		if (func_183(iParam2, pedParam0, num, num2))
		{
			if (iParam2->f_2 == 0)
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2 > func_184(iParam2))
				{
					func_179(iParam2, true);
					return true;
				}
			}
		}
...
BOOL func_113(Ped pedParam0, int iParam1) // Position - 0x59C4 Hash - 0xC62373A5 ^0xD1ADE674
{
	Entity entity;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_175(pedParam0, iParam1, pedIndexFromEntityIndex))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3 > func_184(iParam1))
		{
			customDistance = func_182(iParam1);
...
BOOL func_114(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5ACD Hash - 0x7FC88506 ^0xB203680D
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_115(int iParam0, int iParam1) // Position - 0x5C02 Hash - 0x7EB9A53B ^0xCA234572
{
	int num;
	int num2;
...
BOOL func_116(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5C39 Hash - 0xCE2053EC ^0x1CC9B32D
{
	float num;
...
BOOL func_117(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x5D40 Hash - 0x7A43493E ^0x1475EBFE
{
	var weaponHash;

	if (iParam2->f_12 < (float)func_188(iParam2))
	{
...
BOOL func_118(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3) // Position - 0x5DAB Hash - 0x8CBDE6BD ^0xE1F008CE
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_190(pedParam1, entityCoords, outCoords))
					{
						func_179(iParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, iParam2->f_22))
				{
					...
					if (func_190(pedParam1, entityCoords, outCoords2))
					{
						func_179(iParam2, true);
						return true;
					}
...
BOOL func_119(Ped pedParam0, int iParam1) // Position - 0x5EF3 Hash - 0xEB9C0B04 ^0x4A60CD30
{
	int i;
	float num;
	var unk;
	...
	{
		if (!func_175(pedParam0, iParam1, Global_1935630.f_34[i]) || pedParam0 == Global_1935630.f_34[i])
		{
		}
		else
		{
			flag2 = func_191(Global_1935630.f_34[i]);
			...
			if (func_192(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_193(iParam1, pedParam0, num, flag, flag2))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
			...
			else if (func_194(iParam1, pedParam0, num, i))
			{
				unk[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[i], false, false) };
				unk[1 /*3*/] = { entityCoords };
				iParam1->f_10 = pedParam0;
...
BOOL func_120(var uParam0, int iParam1) // Position - 0x60D0 Hash - 0xF223CED2 ^0xA472D0A4
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_121(int iParam0, int iParam1) // Position - 0x6148 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
int func_122(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6177 Hash - 0x8119700D ^0x42D5A76B
{
	Ped entity2;
...
int func_123(int iParam0, Ped pedParam1) // Position - 0x62FD Hash - 0x42A83B1F ^0x5059E529
{
	int _int;
...
BOOL func_124(int iParam0, Ped pedParam1) // Position - 0x634D Hash - 0xA4C024EF ^0xFFB65FFB
{
	if (func_197(iParam0))
		return true;
...
BOOL func_125(Ped pedParam0, Ped pedParam1) // Position - 0x63EA Hash - 0xB0548679 ^0x1C6DC58A
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
		...
		if (func_198(pedParam0, pedParam1, true, true) < 4f)
...
void func_126() // Position - 0x6437 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_127(int iParam0, Ped pedParam1) // Position - 0x643F Hash - 0x6BE02E92 ^0x188EF1A2
{
	...
	if (vehiclePedIsUsing != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(vehiclePedIsUsing)))
	{
		...
		if (func_199(vehiclePedIsUsing, pedParam1, entityCoords))
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(vehiclePedIsUsing, &expected, &actual))
		{
			...
			else if (actual == expected)
			{
				for (i = 0; i < actual; i = i + 1)
				{
					...
					{
						if (func_200(pedInDraftHarness, entityCoords, true) < 3f)
						{
...
int func_128() // Position - 0x6500 Hash - 0xE698BCC8 ^0x3E64CD04
{
...
BOOL func_129() // Position - 0x651E Hash - 0xAD122F0E ^0xC8AE0775
{
	if (Global_1935630.f_42 == 0)
		return false;
...
BOOL func_130(int iParam0, Ped pedParam1) // Position - 0x656B Hash - 0xD0836592 ^0x2A09A5E1
{
	float num;
	int num2;
	int num3;
	...
	if (iParam0->f_12 > func_201(iParam0) && iParam0->f_12 > num)
		return false;

	num3 = func_202(pedParam1);
	num2 = func_203(iParam0->f_14);
...
BOOL func_131(Ped pedParam0, Entity eParam1, int iParam2) // Position - 0x6687 Hash - 0xE4FFEDE ^0xE432D572
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	flag3 = *iParam2 & 128 != 0;
	return func_204(pedParam0, eParam1, flag, flag3, iParam2->f_12, flag2);
}

BOOL func_132(Ped pedParam0, int iParam1) // Position - 0x66CF Hash - 0x23BB3370 ^0x36BD6CCF
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	...
	{
		if (func_205(pedParam0, iParam1, true))
			return true;
		...
		case joaat("event_shocking_entity_hogtied"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, pedIndexFromEntityIndex, -1082130432, -1082130432, -1082130432, -1082130432) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedIndexFromEntityIndex, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!func_206(iParam1, pedParam0))
						if (func_200(pedIndexFromEntityIndex, Global_36, true) < 7f)
							return true;
			break;
	}
...
BOOL func_133(Ped pedParam0, int iParam1) // Position - 0x6928 Hash - 0xB0E3CEF5 ^0x6602867A
{
	if (!func_207(0))
		return false;
...
BOOL func_134(int iParam0, int iParam1) // Position - 0x6961 Hash - 0xEBE56966 ^0xD1622B8
{
	int num;
	int num2;
...
BOOL func_135(var uParam0, int iParam1) // Position - 0x6990 Hash - 0x7B43AD8E ^0x2B906BDE
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_136(Ped pedParam0, int iParam1) // Position - 0x69A4 Hash - 0xA06525EC ^0x3DA5C48E
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
	...
	else if (func_128() - iParam1->f_4 > func_208(iParam1))
		return func_209(pedParam0, iParam1, false, -1082130432);

	return false;
}

BOOL func_137(int iParam0, Ped pedParam1) // Position - 0x69F1 Hash - 0xF7CC8BF6 ^0x8A0AF48E
{
...
BOOL func_138(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x6A44 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Ped func_139(Ped pedParam0) // Position - 0x6A6D Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_140(Ped pedParam0) // Position - 0x6A77 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_141(Ped pedParam0) // Position - 0x6AA9 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x6AEB Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_143(Ped pedParam0) // Position - 0x6AFA Hash - 0x6D7E69FC ^0x1FD723DA
{
...
Ped func_144(Ped pedParam0) // Position - 0x6B15 Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_145(float fParam0) // Position - 0x6B31 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_146(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6B78 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_147(var uParam0, float fParam1) // Position - 0x6B96 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_148(var uParam0) // Position - 0x6BB4 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_149(int iParam0) // Position - 0x6BCA Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_210(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_210(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_210(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_150(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6C4B Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_32074.f_2697.f_1495[i /*4*/] == iParam0)
			if (func_155(Global_32074.f_2697.f_1495[i /*4*/].f_1, uParam1, 1056964608, true))
				return;
	}
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x6D3C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_152(var uParam0, float fParam1) // Position - 0x6D4B Hash - 0x30433BAB ^0xF854D531
{
...
float func_153(var uParam0) // Position - 0x6D71 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_74(uParam0))
		return uParam0->f_1;
...
float func_154(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x6DA6 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_155(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x6DC4 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_156(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6E19 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_157(int iParam0, int iParam1) // Position - 0x6E30 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_158(int iParam0, int iParam1) // Position - 0x6EB6 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_159(int iParam0, int iParam1) // Position - 0x6EF2 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_160(int iParam0, int iParam1) // Position - 0x6F45 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_161(int iParam0, int iParam1) // Position - 0x6F80 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_162(int iParam0, int iParam1) // Position - 0x6FB9 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_163(int iParam0) // Position - 0x6FF1 Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_164(BOOL bParam0) // Position - 0x702F Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_165(ePedType eptParam0) // Position - 0x7042 Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_166(Ped pedParam0, Hash hParam1) // Position - 0x7495 Hash - 0xEA1C858E ^0x1B7164CC
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_167(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x753F Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_168(Ped pedParam0, BOOL bParam1) // Position - 0x756F Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_169(Ped pedParam0, int iParam1) // Position - 0x75B4 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_170(int iParam0) // Position - 0x75DB Hash - 0xE5B9C958 ^0xF9A51EF
{
	int num;
	Hash* weaponHash;
...
var func_171(int iParam0) // Position - 0x7747 Hash - 0x85F4CB4C ^0x85F4CB4C
{
	return Global_1109000.f_266[iParam0 /*3*/];
}

BOOL func_172(BOOL bParam0) // Position - 0x775A Hash - 0xBA1E2285 ^0xBA1E2285
{
	var unk;
	var unk2;
...
BOOL func_173(int iParam0) // Position - 0x7774 Hash - 0xA6E07A0A ^0x31605A1E
{
	Ped ped;
...
void func_174(int iParam0) // Position - 0x780E Hash - 0x256C27DD ^0x256C27DD
{
...
BOOL func_175(Ped pedParam0, int iParam1, Ped pedParam2) // Position - 0x7835 Hash - 0x7FBD27D8 ^0x4C0BB7C4
{
	int num;
	int num2;
	...
	if (!PED::IS_PED_HUMAN(pedParam2))
		num2 = func_203(pedParam2);
	else
		num2 = func_202(pedParam2);

	if (!PED::IS_PED_HUMAN(pedParam0))
		num = func_203(pedParam0);
	else
		num = func_202(pedParam0);
...
float func_176(Ped pedParam0, Ped pedParam1) // Position - 0x792E Hash - 0xF9959663 ^0xF9959663
{
	return func_198(pedParam0, pedParam1, true, true);
}

float func_177(int iParam0) // Position - 0x7940 Hash - 0xD73B9827 ^0xDE12990D
{
	return iParam0->f_26;
}

BOOL func_178(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x794C Hash - 0x5A9E12AC ^0x5A9E12AC
{
	switch (iParam0)
	{
		case 1:
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x79B1 Hash - 0x562373AA ^0xDBA63849
{
	if (bParam1)
...
void func_180() // Position - 0x79D7 Hash - 0x66B46B05 ^0x51003404
{
...
BOOL func_181(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x79EB Hash - 0x7ED53456 ^0xD7A590DD
{
	Ped ped;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(ped, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_198(ped, pedParam0, true, true) <= 4f)
			return true;
...
float func_182(int iParam0) // Position - 0x7B4B Hash - 0xD73B9827 ^0x8CE07B2A
{
	return iParam0->f_17;
}

BOOL func_183(int iParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x7B57 Hash - 0x8FF3FF1B ^0x45FC6EEC
{
	float num;
...
int func_184(int iParam0) // Position - 0x7BB8 Hash - 0xD73B9827 ^0x372EC0B
{
	return iParam0->f_18;
}

BOOL func_185(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7BC4 Hash - 0x838BDEFB ^0xB1D5C032
{
	Ped ped;
	Player playerIndex;
...
int func_186(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7C86 Hash - 0xC9655EC3 ^0x88C9AFE1
{
...
float func_187(int iParam0) // Position - 0x7D24 Hash - 0xD73B9827 ^0x9F7F0764
{
	return iParam0->f_23;
}

int func_188(int iParam0) // Position - 0x7D30 Hash - 0xD73B9827 ^0x303D0BA3
{
	return iParam0->f_21;
}

int func_189(int iParam0) // Position - 0x7D3C Hash - 0xB202FF2A ^0xFD1BAB10
{
	int num;
...
BOOL func_190(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x7E79 Hash - 0xB38C72E2 ^0xD400E0B7
{
...
BOOL func_191(Ped pedParam0) // Position - 0x7EBC Hash - 0x4A20E6BA ^0x550F792B
{
...
BOOL func_192(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F22 Hash - 0xF74D67F4 ^0x88DBF437
{
	float num;
...
BOOL func_193(int iParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7F69 Hash - 0xA25E5C03 ^0xFB206DE4
{
	float num;
...
BOOL func_194(int iParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x7FB4 Hash - 0xBD53E6FC ^0x2E9374BE
{
	float num;
...
BOOL func_195(Ped pedParam0, var uParam1) // Position - 0x802F Hash - 0x64FF5121 ^0xD9ABCD76
{
...
BOOL func_196(Ped pedParam0, Ped pedParam1) // Position - 0x807C Hash - 0x32A55AFE ^0x7FDC2FE
{
...
BOOL func_197(int iParam0) // Position - 0x80C4 Hash - 0x21EEA2C5 ^0x21EEA2C5
{
	return !(*iParam0 & 2 != 0);
}

float func_198(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x80D4 Hash - 0xD54E86C ^0xB31A48E2
{
...
BOOL func_199(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x811C Hash - 0x94A6C6F0 ^0xC51111A6
{
	float num;

	num = func_200(veParam0, uParam2, true);
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x8148 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_201(int iParam0) // Position - 0x8170 Hash - 0xD73B9827 ^0x4905FA06
{
	return iParam0->f_24;
}

int func_202(Ped pedParam0) // Position - 0x817C Hash - 0x6F437A76 ^0xB909E495
{
...
int func_203(Ped pedParam0) // Position - 0x81D2 Hash - 0xE9D077C ^0x6DA19901
{
...
BOOL func_204(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x823E Hash - 0x89708384 ^0x6760E23F
{
	BOOL flag;
	Entity entity;
	float num;
	...
	if (fParam4 <= 0f)
		num = func_198(pedParam0, PLAYER::PLAYER_PED_ID(), false, true);
	else
		num = fParam4;
	...
	if (flag)
		if (func_198(pedParam0, Global_1935630.f_40, false, true) < 2.5f)
...
BOOL func_205(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x83AE Hash - 0x3E8B6245 ^0x84E29058
{
	Ped ped;
	Ped ped2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
		if (ped != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
					if (!bParam2 || !func_206(iParam1, ped))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped2))
		if (ped2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_35, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_35, 17))
				if (!bParam2 || !func_206(iParam1, ped2))
					if (func_200(ped2, Global_36, true) < 5f)
						return true;

	return false;
}

BOOL func_206(int iParam0, Ped pedParam1) // Position - 0x849C Hash - 0x27FC2906 ^0xD9B9FA57
{
...
BOOL func_207(int iParam0) // Position - 0x8512 Hash - 0x548D1D18 ^0x4AC0DF7D
{
	if (func_232())
		return false;
...
int func_208(int iParam0) // Position - 0x8534 Hash - 0xD73B9827 ^0xAC2E3C80
{
	return iParam0->f_20;
}

BOOL func_209(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x8540 Hash - 0x9E17B061 ^0x19F2F061
{
	if (!bParam2)
		if (iParam1->f_4 == 0)
			return 0;
...
void func_210(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x85BB Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;
...
float func_211() // Position - 0x8647 Hash - 0xB5A1F69B ^0x5409CF38
{
	int networkTimeAccurate;
...
void func_212(var uParam0, int iParam1) // Position - 0x8679 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_213(var uParam0, int iParam1) // Position - 0x868A Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_214(var uParam0) // Position - 0x869F Hash - 0x39705408 ^0x39705408
{
	return func_151(*uParam0, 2);
}

BOOL func_215(Ped pedParam0, Hash hParam1) // Position - 0x86AF Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_216(Ped pedParam0, Hash hParam1) // Position - 0x86DD Hash - 0xA54F3032 ^0x863CC6D3
{
	Hash _int;
...
BOOL func_217(Ped pedParam0, Hash hParam1) // Position - 0x872E Hash - 0xA54F3032 ^0x863CC6D3
{
	Hash _int;
	int _int2;
...
void func_218(Ped pedParam0) // Position - 0x87A0 Hash - 0x446F1BDD ^0x7C9ECF8A
{
...
BOOL func_219() // Position - 0x87BE Hash - 0x60155C48 ^0x6CED0E68
{
	if (func_235())
		return false;
...
void func_220(Any* panParam0, int iParam1) // Position - 0x8814 Hash - 0x787BB1AC ^0x11099E69
{
	int num;
	int i;
	Player player;
...
BOOL func_221(BOOL bParam0, var uParam1, var uParam2) // Position - 0x88BC Hash - 0x2A9340EF ^0xAD765E32
{
	BOOL num;
	Ped lassoTarget;
...
BOOL func_222() // Position - 0x8983 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

Ped func_223(int iParam0) // Position - 0x8991 Hash - 0xF229F24F ^0x47381422
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_224(int iParam0) // Position - 0x8A39 Hash - 0x59730BCA ^0xE779676B
{
	int i;
...
Hash func_225(Ped pedParam0, int iParam1) // Position - 0x8A9E Hash - 0xB13A3864 ^0x7FBAE642
{
	Hash weaponHash;
...
BOOL func_226(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x8AB5 Hash - 0x2C51465B ^0x98B13A1D
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_227(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8AE3 Hash - 0xBF2250D5 ^0x34592C3E
{
	float screenX;
	float screenY;
...
BOOL func_228(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x8B2D Hash - 0xE63CB60C ^0x5133A9E3
{
...
BOOL func_229(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8B6E Hash - 0x1D055735 ^0x5D260F19
{
...
BOOL func_230(Ped pedParam0) // Position - 0x8BE7 Hash - 0xF2F988FE ^0xA63CD631
{
...
int func_231(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8CCF Hash - 0xDD2F88C2 ^0x29E97850
{
	int weaponHash;
...
BOOL func_232() // Position - 0x8D11 Hash - 0xD5D58EB4 ^0xC93B1BFF
{
	if (func_222() != -1)
		return false;
...
BOOL func_233(int iParam0, BOOL bParam1) // Position - 0x8D36 Hash - 0xAA5BFD67 ^0xAA5BFD67
{
...
int func_234(int iParam0) // Position - 0x8D67 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_235() // Position - 0x8D7A Hash - 0x50F36DAB ^0xF55A49EF
{
...
int func_236(int iParam0) // Position - 0x8DAB Hash - 0x71D355F9 ^0x71D355F9
{
	if (!func_98(iParam0))
		return -1;
...
int func_237(int iParam0) // Position - 0x8DC7 Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
int func_238(int iParam0) // Position - 0x8E08 Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
