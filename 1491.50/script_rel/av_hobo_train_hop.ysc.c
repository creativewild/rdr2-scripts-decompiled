...
void main() // Position - 0x0 Hash - 0xA112627F ^0x577A333F
{
	var unk;
	BOOL flag;
...
void func_4(var uParam0) // Position - 0x9CB Hash - 0x4DA9BC8C ^0x6FA782FB
{
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF Hash - 0x5286D378 ^0x5286D378
{
	int num;

	iLocal_49 = -1;
	veLocal_42 = func_46(iLocal_49);

	switch (*uParam0)
	{
		case 47:
			func_47(uParam0, "AV_HOBO_TRAIN_HOP_NO_SACK", "script@ambient@generic@hobo_train_hop@Action_no_lootsack", uParam1, uParam4);
			func_48(uParam0, 1, "Pl_Action_Without_Lootsack", "", 0);
			break;
	}

	num = func_50(func_49());
	func_51(uParam0, 0, "Ped", num, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	return;
}

Vector3 func_15(var uParam0) // Position - 0x1C2A Hash - 0x6131D3C3 ^0x6131D3C3
{
	switch (*uParam0)
	{
		case 7:
...
BOOL func_16(var uParam0) // Position - 0x1CCA Hash - 0x508B9D0B ^0x9525A4FE
{
	int flags;
	int i;
...
int func_17(var uParam0) // Position - 0x1DE4 Hash - 0xD64BDDB0 ^0x6649AEFE
{
	int i;
...
int func_18(var uParam0) // Position - 0x1FAD Hash - 0xBC593D3A ^0x5D7AC4CA
{
	if (!func_52(joaat("world_human_seat_ledge_new")))
		return 0;

	if (!func_53(hLocal_50))
		return 0;

	if (Global_1415419.f_9757 != -310375866)
	{
		if (!func_54(&uLocal_54))
			func_55(&uLocal_54, false);
	
		if (func_56(&uLocal_54) > 60f)
		{
			uParam0->f_499 = 1;
			return 0;
		}
	...
	{
		iLocal_48 = 3;
		func_57(uParam0->f_483, 0);
	}
	else if (!ENTITY::IS_ENTITY_DEAD(veLocal_42))
	{
		iLocal_48 = 4;
	
		if (!func_58(uParam0->f_483))
			uParam0->f_499 = 1;
	}
	else
	{
	...
	return func_59(uParam0);
}

BOOL func_19(var uParam0) // Position - 0x2060 Hash - 0x595D6BD4 ^0x9D293229
{
	float num;
	int i;
	float num2;
...
int func_20(var uParam0) // Position - 0x2210 Hash - 0xE9CB60C1 ^0x884DE345
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x2284 Hash - 0x7DFC1A23 ^0xD6849B09
{
	int num;
...
void func_22(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22D3 Hash - 0xDCA0A629 ^0x65C02C4D
{
	int num;
...
int func_23(var uParam0) // Position - 0x232B Hash - 0xC59D483A ^0xE9F7DC8
{
	var matrix;
...
int func_24(var uParam0) // Position - 0x2494 Hash - 0xD2ADCB31 ^0x23D387DE
{
	var matrix;
	int i;
...
BOOL func_25(var uParam0) // Position - 0x27BB Hash - 0x427C3B86 ^0x72BCBF03
{
	int i;
	var matrix;
...
void func_26(var uParam0) // Position - 0x28F2 Hash - 0x4C71684F ^0x7A94D86C
{
	int i;
...
void func_27(var uParam0) // Position - 0x2A22 Hash - 0xFA70D137 ^0x7F492FB6
{
	int i;
...
BOOL func_28(var uParam0) // Position - 0x2A61 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_29(var uParam0) // Position - 0x2A6A Hash - 0xACCC6A89 ^0xFA95CC86
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
	{
...
int func_30(var uParam0) // Position - 0x2A9C Hash - 0x5E3A55E4 ^0x6C1FD91
{
	func_67(joaat("world_human_seat_ledge_new"), 1, 0, 0);
	func_68(&uLocal_14, false);
	func_69(&uLocal_14, true);
	func_70(&uLocal_14, true);
	func_71(&uLocal_14, true);
	func_72(&uLocal_14, true);
	func_73(&uLocal_14, true);
	func_74(&uLocal_14, true);
	return 1;
}

int func_31(var uParam0) // Position - 0x2AE3 Hash - 0xEB9A5BEE ^0x4176CBDF
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (!uParam0->f_469[4])
		{
			func_76(*uParam0, uParam0->f_483, true);
			uParam0->f_469[4] = 1;
		}
	...
	if (!uParam0->f_469[2])
	{
		...
		{
			if (!bLocal_10 && func_78(Global_36, uParam0->f_483) < 15625f && !ENTITY::IS_ENTITY_DEAD(veLocal_42))
			{
				VEHICLE::_TRIGGER_TRAIN_WHISTLE(VEHICLE::GET_TRAIN_CARRIAGE(veLocal_42, 0), "MOVING", false, false);
				bLocal_10 = true;
			}
		}
	
		if (Global_1415419.f_9757 == -310375866 && func_78(Global_36, uParam0->f_483) < 12100f || func_79(uParam0, 1065353216, 100f, 4, 50f, 1112014848) || func_56(&uLocal_51) > 100f)
		{
			func_75(uParam0);
			VEHICLE::_SET_TRAIN_LEAVE_STATION(veLocal_42);
		
			if (bLocal_12)
				VEHICLE::SET_TRAIN_CRUISE_SPEED(veLocal_42, 4.91f);
			else
				VEHICLE::_0x15206E88FF7617DF(iLocal_43, 4.91f);
		
			uParam0->f_469[2] = 1;
		}
	}

	if (uParam0->f_469[2] && !uParam0->f_469[0])
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 246822123))
		{
			func_80(&uParam0->f_20[0 /*14*/], true, true);
			uParam0->f_469[6] = 1;
		}
	
		if (!bLocal_13)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 584530007))
			{
		...
		if (!ENTITY::IS_ENTITY_DEAD(veLocal_42))
		{
			if (!bLocal_11)
			{
				offsetFromEntityGivenWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(veLocal_44, uParam0->f_20[0 /*14*/].f_5) };
			
				if (offsetFromEntityGivenWorldCoords.f_1 <= uLocal_45.f_1)
				{
					ANIMSCENE::ATTACH_ANIM_SCENE_TO_ENTITY_PRESERVING_LOCATION(uParam0->f_3.f_1, veLocal_44, 0);
					bLocal_11 = true;
			...
			{
				VEHICLE::SET_TRAIN_SPEED(veLocal_42, 4.91f);
			}
		}
	
		if (!uParam0->f_469[4])
		{
			if (func_81(uParam0, 3f, 1116471296, 4, joaat("Action"), true))
			{
				func_76(*uParam0, uParam0->f_483, true);
				uParam0->f_469[4] = 1;
			}
		...
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::COULD_ANIM_SCENE_ENTITY_REACH_EXIT_NEXT_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1, 1, 0))
			{
				if (uParam0->f_469[6])
				{
					ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1, uParam0->f_20[0 /*14*/]);
					ANIMSCENE::DETACH_ANIM_SCENE(uParam0->f_3.f_1);
					vector = { -1.681865f, 3.105037f, 0.880301f };
					offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veLocal_44, vector) };
					ENTITY::SET_ENTITY_COORDS(uParam0->f_20[0 /*14*/], offsetFromEntityInWorldCoords, true, false, true, true);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[0 /*14*/], veLocal_44, 0, vector, 0f, 0f, 86.11757f, false, false, false, false, 2, true, true, false);
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], joaat("world_human_seat_ledge_new"), -1, false, 0, 0f, true);
		...
		if (bLocal_12)
			if (func_78(Global_36, ENTITY::GET_ENTITY_COORDS(veLocal_42, true, false)) > 62500f)
				uParam0->f_469[3] = 1;
	}
...
int func_32(var uParam0, var uParam1) // Position - 0x2E5B Hash - 0xBEEE9A8A ^0xC67C031F
{
	...
	if (bLocal_12)
	{
		VEHICLE::DELETE_MISSION_TRAIN(&veLocal_42);
		return 1;
	}
	else if (VEHICLE::_0x0516FAE561276EFC(iLocal_43))
	{
		VEHICLE::_0x615B3B8E73634509(iLocal_43, 60f);
		VEHICLE::_0x15206E88FF7617DF(iLocal_43, func_84(iLocal_49));
		VEHICLE::_0x63509DDF102E08E8(iLocal_43, func_85(iLocal_49));
		return 1;
	}

	func_86(uParam0, true, true, false);
	return 0;
}

void func_33(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2EBE Hash - 0xDCA31891 ^0xDCA31891
{
...
float func_34(int iParam0) // Position - 0x2EDB Hash - 0x8CED6A02 ^0xD603ABD2
{
	float num;
...
float func_35(int iParam0) // Position - 0x3017 Hash - 0xA8E8CC38 ^0x51F588E5
{
	float num;
...
float func_36(int iParam0) // Position - 0x3150 Hash - 0xC36889AE ^0xC36889AE
{
	float num;
...
BOOL func_37(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x31FA Hash - 0x414F77D3 ^0xA2303EA9
{
	switch (iParam0)
	{
		case 58:
...
int func_38(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3272 Hash - 0x2AE5C8B1 ^0x9995651A
{
	var entityCoords;
	...
	value = func_88(entityForwardVector, unk5);
	...
	if (func_89(entityCoords, entityCoords + entityForwardVector, uParam1))
		return 3;

	return 2;
}

BOOL func_39(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, float fParam6, float fParam7, int iParam8) // Position - 0x3301 Hash - 0x43D58A3 ^0xFD80116C
{
	float num;
	var unk;
	var unk5;
...
int func_40() // Position - 0x341C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1899515;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x3428 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
	...
	for (m = func_98(i, num); num2 > m; m = func_98(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_99(iParam0, l, k, j, num2, i, num);
	return;
}

void func_42(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35B0 Hash - 0xF543C309 ^0x6A5F3FAF
{
	int i;
...
BOOL func_43(int iParam0) // Position - 0x3650 Hash - 0xDC21AF4A ^0xDC21AF4A
{
	if (iParam0 != -1)
		return true;
...
BOOL func_44(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3663 Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_45(Volume volParam0, BOOL bParam1) // Position - 0x367D Hash - 0xEA796703 ^0x695D7925
{
...
Vehicle func_46(int iParam0) // Position - 0x36E5 Hash - 0xD6FCDEE8 ^0xA17CE125
{
	if (!func_82(iParam0))
		return 0;
...
void func_47(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x3729 Hash - 0x99CB1C8D ^0x1337392D
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_48(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4) // Position - 0x3755 Hash - 0xF0D98862 ^0x21440CE
{
...
int func_49() // Position - 0x3786 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1897952.f_41;
}

int func_50(int iParam0) // Position - 0x3794 Hash - 0x25BBA47B ^0x96A625FD
{
	int num;
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x3885 Hash - 0x960D7EB7 ^0x57019BBE
{
...
BOOL func_52(Hash hParam0) // Position - 0x3913 Hash - 0xF47DA3FB ^0x3523541A
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(hParam0, false);
}

BOOL func_53(Hash hParam0) // Position - 0x3922 Hash - 0x268735DA ^0x578DFECA
{
...
BOOL func_54(var uParam0) // Position - 0x3968 Hash - 0x5001E582 ^0x5001E582
{
	return func_101(*uParam0, 1);
}

void func_55(var uParam0, BOOL bParam1) // Position - 0x3978 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
float func_56(var uParam0) // Position - 0x3998 Hash - 0x5E6CC847 ^0xFCFB84EF
{
	if (!func_54(uParam0))
		return 0f;
...
int func_57(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x39CA Hash - 0x79BD3AD8 ^0x42E3759D
{
	if (!ENTITY::DOES_ENTITY_EXIST(veLocal_42))
	{
		veLocal_42 = VEHICLE::_CREATE_MISSION_TRAIN(hLocal_50, vParam0, true, false, true, true);
		VEHICLE::SET_TRAIN_SPEED(veLocal_42, 0f);
		VEHICLE::SET_TRAIN_CRUISE_SPEED(veLocal_42, 0f);
		VEHICLE::SET_VEHICLE_ENGINE_ON(veLocal_42, false, true);
		VEHICLE::_0x1BFBAFCC6760FF02(veLocal_42, false);
		bLocal_12 = true;
	}

	if (!VEHICLE::_HAS_TRAIN_LOADED(veLocal_42))
		return 0;

	return 1;
}

BOOL func_58(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3A1B Hash - 0x366F9253 ^0x80208F81
{
	Vector3 nearestTrainTrackPosition;
	int trackIndex;

	if (!ENTITY::IS_ENTITY_DEAD(veLocal_42))
		iLocal_43 = VEHICLE::_GET_TRAIN_TRACK_FROM_TRAIN_VEHICLE(veLocal_42);

	if (VEHICLE::_0x0516FAE561276EFC(iLocal_43))
	{
		nearestTrainTrackPosition = { VEHICLE::_GET_NEAREST_TRAIN_TRACK_POSITION(vParam0) };
		trackIndex = VEHICLE::_0x6C87F49BFA181DB5(nearestTrainTrackPosition);
		VEHICLE::_ADD_TRAIN_TEMPORARY_STOP(veLocal_42, trackIndex, nearestTrainTrackPosition);
		return true;
	}
...
int func_59(var uParam0) // Position - 0x3A65 Hash - 0xBD1DDDB4 ^0x313A40E9
{
	Vector3 matrix;
	...
	if (!bLocal_12)
	{
		if (ENTITY::IS_ENTITY_DEAD(veLocal_42))
		{
			veLocal_42 = VEHICLE::_GET_TRAIN_VEHICLE_FROM_TRACK_INDEX(iLocal_43);
			return 0;
		}
	...
	if (ENTITY::IS_ENTITY_DEAD(veLocal_44))
	{
		veLocal_44 = VEHICLE::GET_TRAIN_CARRIAGE(veLocal_42, iLocal_48);
		return 0;
	}

	if (!bLocal_9)
	{
		VEHICLE::SET_VEHICLE_DOOR_OPEN(veLocal_44, 0, false, true);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(veLocal_44, 2, false, true);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(veLocal_44, 1, false, true);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(veLocal_44, 3, false, true);
		bLocal_9 = true;
	}

	if (ENTITY::GET_ENTITY_SPEED(veLocal_42) < 0.001f)
	{
		if (Global_1415419.f_9757 != -310375866)
			func_55(&uLocal_51, false);
	
		ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_3.f_1, ENTITY::GET_ENTITY_COORDS(veLocal_44, true, false), ENTITY::GET_ENTITY_ROTATION(veLocal_44, 2), 2);
	
		if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(uParam0->f_3.f_1, "Ped", &matrix, true, "Pl_Action_Without_Lootsack", 2))
		{
			uParam0->f_20[0 /*14*/].f_5 = { matrix };
			uLocal_45 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(veLocal_44, matrix) };
			return 1;
		}
	}
...
BOOL func_60(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3B6A Hash - 0xB13E2226 ^0xA63BD3BC
{
	int num;
	...
	if (iParam0 == 0 && func_109(Global_1898164.f_1[0 /*5*/]))
		return true;
...
int func_61(int iParam0) // Position - 0x3D6E Hash - 0x1B04F1B9 ^0x733D143B
{
	return Global_1898164.f_1[iParam0 /*5*/].f_2;
}

BOOL func_62(int iParam0, int iParam1) // Position - 0x3D82 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_63() // Position - 0x3D91 Hash - 0x378FC94F ^0x378FC94F
{
	return Global_1894899 & true != 0 && func_87() != -1;
}

BOOL func_64(var uParam0, Any* panParam1) // Position - 0x3DAC Hash - 0x1B6187F7 ^0x93FC7285
{
	var unk;
...
Ped func_65(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14) // Position - 0x3E0B Hash - 0xA2E56CA0 ^0x72EAA6BD
{
	Ped ped;
	...
	func_110(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

BOOL func_66(Entity eParam0) // Position - 0x3E4D Hash - 0x966B8CCF ^0xFAFF1653
{
	Hash entityModel;
...
int func_67(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3E79 Hash - 0x4C6F92F6 ^0x312B6988
{
	return STREAMING::_REQUEST_SCENARIO_TYPE(hParam0, iParam1, iParam2, iParam3);
}

void func_68(int iParam0, BOOL bParam1) // Position - 0x3E8D Hash - 0x80C5A75F ^0xCEA3E822
{
	if (bParam1)
	{
		iParam0->f_1 = 0;
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x3F09 Hash - 0x6418D0A4 ^0x15BADFF8
{
	if (bParam1)
...
void func_70(var uParam0, BOOL bParam1) // Position - 0x3F2D Hash - 0x97140DD8 ^0x96C23302
{
	if (bParam1)
...
void func_71(var uParam0, BOOL bParam1) // Position - 0x3F53 Hash - 0xB272A69C ^0x2A37F53B
{
	if (bParam1)
...
void func_72(var uParam0, BOOL bParam1) // Position - 0x3F75 Hash - 0xF7B0944E ^0xC84C2F80
{
	if (bParam1)
...
void func_73(var uParam0, BOOL bParam1) // Position - 0x3F97 Hash - 0x8AC5A45 ^0x8880FB31
{
	if (bParam1)
...
void func_74(var uParam0, BOOL bParam1) // Position - 0x3FB9 Hash - 0xC115F03A ^0x2E6EAB19
{
	if (bParam1)
...
void func_75(var uParam0) // Position - 0x3FDD Hash - 0xE31841FA ^0xE31841FA
{
	if (!uParam0->f_469[5])
	{
		func_119(*uParam0, true);
		uParam0->f_469[5] = 1;
	}
...
void func_76(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x4003 Hash - 0x563CDE2F ^0xDC1014A4
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_77(var uParam0) // Position - 0x4107 Hash - 0x5C00F5B7 ^0x689560ED
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 584530007) && MISC::_0x7A76104CC2CC69E8(uParam0->f_20[0 /*14*/], 1, 1))
		{
			if (!func_122(uParam0->f_20[0 /*14*/], 518218985))
			{
				...
				func_80(&uParam0->f_20[0 /*14*/], false, true);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
				uParam0->f_469[0] = 1;
			}
		}
...
float func_78(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4192 Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_79(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4, int iParam5) // Position - 0x41B0 Hash - 0x842F27B6 ^0xD8EEFFC
{
	int i;
	float num;
	Ped ped;
	...
	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		...
		if (func_123(Global_35))
		{
			ped = func_124(Global_35);
		...
		num = num * num;
		fParam2 = func_125(fParam2);
		num2 = func_126(Global_36, uParam0->f_483);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				num3 = func_127(Global_35, uParam0->f_20[i /*14*/], true);
				...
				if (num3 < fParam2 * fParam2)
				{
					...
					{
						if (!func_54(&(uParam0->f_490)))
							func_102(&(uParam0->f_490));
					
						if (func_128(&(uParam0->f_490), iParam1))
						{
							func_129(&(uParam0->f_490));
							return true;
						}
...
void func_80(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x43BB Hash - 0x6DE5BABD ^0x14BE368D
{
...
BOOL func_81(var uParam0, float fParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x43E3 Hash - 0xCD766A10 ^0x5BC9ADAF
{
	int i;

	if (MISC::GET_FRAME_COUNT() % 8 == 0)
	{
		iParam2 = func_125(iParam2);
		...
		for (i = 0; i < uParam0->f_19; i = i + 1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[i /*14*/]))
			{
				...
				{
					if (func_127(Global_35, uParam0->f_20[i /*14*/], true) < iParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[i /*14*/]) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[i /*14*/]))
					{
						if (!func_54(&(uParam0->f_490)))
							func_55(&(uParam0->f_490), false);
					
						if (func_103(&(uParam0->f_490)))
							func_130(&(uParam0->f_490));
		...
		if (func_54(&(uParam0->f_490)) && !func_103(&(uParam0->f_490)))
...
BOOL func_82(int iParam0) // Position - 0x450C Hash - 0xB32B029D ^0xB32B029D
{
...
void func_83(int iParam0) // Position - 0x452B Hash - 0x7D366319 ^0x7D366319
{
	func_133(iParam0, 16);
	return;
}

float func_84(int iParam0) // Position - 0x453B Hash - 0x83D20521 ^0x83D20521
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0) // Position - 0x45F6 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 0:
...
void func_86(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4647 Hash - 0xDC3D292 ^0xEF3943D3
{
	int i;
...
int func_87() // Position - 0x479B Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1894899.f_2;
}

float func_88(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x47A9 Hash - 0x4C6A3038 ^0xA855205
{
	float num;
...
BOOL func_89(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4810 Hash - 0x86FD6754 ^0x7FA3CE23
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

BOOL func_90(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x4839 Hash - 0xFB3B5DBC ^0x49C12B1A
{
	int i;
...
BOOL func_91(var uParam0, var uParam1, var uParam2) // Position - 0x4885 Hash - 0xAD02BF52 ^0xC6AFBFA8
{
	int i;
...
int func_92(int iParam0) // Position - 0x48D4 Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_93(int iParam0) // Position - 0x48F9 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_94(int iParam0) // Position - 0x490C Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_95(int iParam0) // Position - 0x491F Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_96(int iParam0) // Position - 0x4932 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_97(int iParam0) // Position - 0x4944 Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_98(int iParam0, int iParam1) // Position - 0x4956 Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x49F0 Hash - 0xA65AB937 ^0xA65AB937
{
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x4A28 Hash - 0x9A8E96E6 ^0x9A8E96E6
{
	if (!func_82(iParam0))
		return;
...
BOOL func_101(int iParam0, int iParam1) // Position - 0x4A54 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_102(var uParam0) // Position - 0x4A63 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_142(uParam0, 0f);
	return;
}

BOOL func_103(var uParam0) // Position - 0x4A72 Hash - 0x39705408 ^0x39705408
{
	return func_101(*uParam0, 2);
}

float func_104() // Position - 0x4A82 Hash - 0xB5A1F69B ^0x5409CF38
{
...
BOOL func_105() // Position - 0x4AB4 Hash - 0x2C13EB06 ^0x38F12C8A
{
	if (Global_1048576)
		return true;
...
int func_106(int iParam0) // Position - 0x4B07 Hash - 0x6FF652AC ^0x6FF652AC
{
	if (!func_109(iParam0))
		return -1;

	return func_144(func_143(iParam0));
}

BOOL func_107(int iParam0) // Position - 0x4B27 Hash - 0x5A094C43 ^0x5A094C43
{
	return iParam0 > -1 && iParam0 < 200;
}

BOOL func_108(int iParam0, int iParam1) // Position - 0x4B3D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_109(int iParam0) // Position - 0x4B4C Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
void func_110(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4B7F Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
	...
	if (!bParam7)
	{
		if (func_145(eptParam1))
		{
			func_146(pedParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	else if (PED::_IS_THIS_MODEL_A_HORSE(ENTITY::GET_ENTITY_MODEL(pedParam0)))
	{
		...
		if (bParam4)
		{
			func_148(pedParam0, false);
			flag = true;
		}
	
		func_149(pedParam0, iParam2);
	}
...
void func_111(int iParam0, BOOL bParam1) // Position - 0x4C60 Hash - 0x57EE9974 ^0x57EE9974
{
	if (bParam1)
		func_118(iParam0, 4);
	else
...
void func_112(int iParam0, BOOL bParam1) // Position - 0x4C7E Hash - 0x776268CE ^0x776268CE
{
	if (bParam1)
		func_118(iParam0, 8);
	else
...
void func_113(int iParam0, BOOL bParam1) // Position - 0x4C9E Hash - 0x6E38DCCC ^0x27E8693B
{
	if (bParam1)
	{
		func_118(iParam0, 16);
...
void func_114(int iParam0, BOOL bParam1) // Position - 0x4CC9 Hash - 0x82AFDBEA ^0x82AFDBEA
{
	if (bParam1)
		func_118(iParam0, 32);
	else
...
void func_115(int iParam0, BOOL bParam1) // Position - 0x4CE9 Hash - 0x7BFDDC82 ^0x7BFDDC82
{
	if (bParam1)
		func_118(iParam0, 64);
	else
...
void func_116(int iParam0, BOOL bParam1) // Position - 0x4D09 Hash - 0x9CA625A6 ^0x5835CEE9
{
	if (bParam1)
		func_118(iParam0, 1024);
	else
		func_9(iParam0, 1024);
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x4D2B Hash - 0xC16273CD ^0x19098BB1
{
	if (bParam1)
...
void func_118(int iParam0, int iParam1) // Position - 0x4D4F Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_119(int iParam0, BOOL bParam1) // Position - 0x4D60 Hash - 0x4919699E ^0xFD97C4E2
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
void func_120(int iParam0) // Position - 0x4E37 Hash - 0xB0330CDF ^0xBFB3064F
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_150(0, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				func_150(1, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		
			case 37:
				func_150(60, true, 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7 / 4, 0, false, true);
				break;
		}
	}
...
void func_121(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4EB8 Hash - 0xF0580228 ^0xF0580228
{
	int i;
	int num;
...
BOOL func_122(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x4FA9 Hash - 0xBA023B92 ^0x16E0B707
{
...
BOOL func_123(Ped pedParam0) // Position - 0x5002 Hash - 0x6D7E69FC ^0x1FD723DA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
Ped func_124(Ped pedParam0) // Position - 0x501D Hash - 0x2F4187EE ^0xDD4F0EB9
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
int func_125(int iParam0) // Position - 0x5039 Hash - 0xC65E6274 ^0xC318629A
{
	Hash* weaponHash;
...
float func_126(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x5080 Hash - 0x6A10E689 ^0x100E8618
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_127(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0x509E Hash - 0x867DEA0 ^0xA060BC32
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_78(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(eParam1, false, false));
}

BOOL func_128(var uParam0, int iParam1) // Position - 0x50F5 Hash - 0xBBD67703 ^0xBBD67703
{
...
void func_129(var uParam0) // Position - 0x5113 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_130(var uParam0) // Position - 0x5129 Hash - 0x104B2E99 ^0xE5DC1BE8
{
	!func_54(uParam0);
...
BOOL func_131(var uParam0, float fParam1) // Position - 0x515D Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_54(uParam0))
		return false;
...
void func_132(var uParam0) // Position - 0x5184 Hash - 0x2B2F09DF ^0x183AF97A
{
	!func_54(uParam0);
...
void func_133(int iParam0, BOOL bParam1) // Position - 0x51B4 Hash - 0x1A79E98B ^0x1A79E98B
{
	if (!func_82(iParam0))
		return;
...
BOOL func_134(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x51EB Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
var func_135(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5240 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_136(int iParam0, int iParam1) // Position - 0x5257 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_137(int iParam0, int iParam1) // Position - 0x52DD Hash - 0x96B01D2A ^0x81E68218
{
...
void func_138(int iParam0, int iParam1) // Position - 0x5319 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_98(num, num2))
		return;
...
void func_139(int iParam0, int iParam1) // Position - 0x536C Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_140(int iParam0, int iParam1) // Position - 0x53A7 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_141(int iParam0, int iParam1) // Position - 0x53E0 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_142(var uParam0, float fParam1) // Position - 0x5418 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_143(int iParam0) // Position - 0x543E Hash - 0xCF02205D ^0x2D99561F
{
	if (Global_1572887.f_12 == -1)
...
int func_144(BOOL bParam0) // Position - 0x547C Hash - 0x8C5A395C ^0x61226A3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 5) & 1023;
}

BOOL func_145(ePedType eptParam0) // Position - 0x548F Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_146(Ped pedParam0, Hash hParam1) // Position - 0x58E2 Hash - 0xD4D6440A ^0x6C318FAF
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (func_154(pedParam0, hParam1))
		{
			if (func_155(pedParam0, hParam1))
			{
				if (func_156(pedParam0, hParam1))
				{
...
void func_147(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x5989 Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_148(Ped pedParam0, BOOL bParam1) // Position - 0x59B9 Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_149(Ped pedParam0, int iParam1) // Position - 0x59FE Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
void func_150(int iParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5A25 Hash - 0x4654DD91 ^0x21FEF3E7
{
	int num;

	num = iParam2 + (60 * iParam3) + (3600 * iParam4) + (86400 * iParam5);

	if (func_158(iParam0) == 1 && bParam7)
		return;
...
void func_151(var uParam0, int iParam1) // Position - 0x5AB1 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_152(var uParam0) // Position - 0x5AC6 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_54(uParam0))
		return uParam0->f_1;
...
void func_153(var uParam0, int iParam1) // Position - 0x5AFB Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_154(Ped pedParam0, Hash hParam1) // Position - 0x5B0C Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_155(Ped pedParam0, Hash hParam1) // Position - 0x5B3A Hash - 0x794150A0 ^0x7A6F1DB4
{
	Hash _int;
...
BOOL func_156(Ped pedParam0, Hash hParam1) // Position - 0x5B88 Hash - 0x794150A0 ^0x7A6F1DB4
{
	Hash _int;
	int _int2;
...
void func_157(Ped pedParam0) // Position - 0x5BF6 Hash - 0x7D255E9F ^0xF0F5D3A1
{
...
int func_158(int iParam0) // Position - 0x5C12 Hash - 0x69AF6CF8 ^0x64DBA37A
{
	return Global_17504.f_42[iParam0 /*8*/].f_5;
}

BOOL func_159() // Position - 0x5C25 Hash - 0x4228A1C2 ^0x6E8485BE
{
