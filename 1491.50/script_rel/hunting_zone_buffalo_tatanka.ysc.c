...
BOOL func_42(var uParam0) // Position - 0x1583 Hash - 0xA3669F68 ^0x177612BB
{
	*uParam0 = 6;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = joaat("p_bisonscat01x");
	uParam0->f_572[1] = joaat("brokensticks_ab");
	uParam0->f_572[2] = joaat("p_bisontuftsfur01x");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 4;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_596[4] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = joaat("a_c_buffalo_tatanka_01");
...
BOOL func_43(var uParam0) // Position - 0x1635 Hash - 0x90008B47 ^0xA0ACAD4E
{
	float num;
	var unk;
	var unk6;
...
int func_44(int iParam0) // Position - 0x174C Hash - 0x7F390DDD ^0x7F390DDD
{
	int num;
...
void func_45(var uParam0) // Position - 0x1782 Hash - 0xF060930F ^0x679498F2
{
	int i;
...
BOOL func_46(var uParam0) // Position - 0x17CC Hash - 0x7B76A2ED ^0x317722B6
{
	int i;
...
BOOL func_47(var uParam0) // Position - 0x1891 Hash - 0x43C1809B ^0xD255F79A
{
	float scaleX;
...
BOOL func_48(var uParam0) // Position - 0x18D8 Hash - 0xC25AB6F8 ^0xC25AB6F8
{
	int i;
	int j;
...
BOOL func_49(var uParam0) // Position - 0x1923 Hash - 0x10BF63DF ^0x638AC662
{
	int i;
	float radius;
	var unk;
...
void func_50(var uParam0) // Position - 0x1EC3 Hash - 0x85508A28 ^0x573D2B47
{
	float num;
	int num2;
	int i;
...
void func_51(var uParam0) // Position - 0x1F89 Hash - 0x46A37087 ^0x6FADEB49
{
	int i;
	int duration;
	int num;
...
void func_52(var uParam0) // Position - 0x264A Hash - 0x271CC8B9 ^0x72DC5E80
{
	int taskSequenceId;
	float num;
...
int func_53(var uParam0, var uParam1) // Position - 0x273F Hash - 0x3AAD93D4 ^0x6348F3E3
{
	int unk;
...
BOOL func_54(var uParam0) // Position - 0x2752 Hash - 0x26561433 ^0x8D630CC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		return true;
...
var func_55(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2787 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_56(Hash hParam0, int iParam1) // Position - 0x279E Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_57(Hash hParam0, int iParam1) // Position - 0x2824 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_58(Hash hParam0, int iParam1) // Position - 0x2860 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_59(Hash hParam0, int iParam1) // Position - 0x28B3 Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_60(Hash hParam0, int iParam1) // Position - 0x28EE Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_61(Hash hParam0, int iParam1) // Position - 0x2927 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_62(Hash hParam0, int iParam1) // Position - 0x295F Hash - 0x53A96DDB ^0xB6A79257
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_63() // Position - 0x2972 Hash - 0x65674CA9 ^0x17A1348F
{
	return true;
}

BOOL func_64() // Position - 0x2991 Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1572887.f_12;
}

BOOL func_65(int iParam0) // Position - 0x299F Hash - 0x91023C9F ^0x91023C9F
{
	return iParam0 > -1 && iParam0 < 153;
}

int func_66(int iParam0) // Position - 0x29B5 Hash - 0x1497AC6A ^0x1497AC6A
{
...
BOOL func_67(int iParam0) // Position - 0x2E09 Hash - 0xE4B93749 ^0xE4B93749
{
	return !func_123(iParam0, 1);
}

int func_68(int iParam0) // Position - 0x2E19 Hash - 0xA776614E ^0xA776614E
{
	if (!func_65(iParam0))
		return -1;
...
BOOL func_69(int iParam0) // Position - 0x325F Hash - 0x14DDF3C9 ^0xAD14D790
{
...
BOOL func_70(int iParam0) // Position - 0x32A8 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_125(iParam0))
		return false;
...
Vector3 func_71(int iParam0) // Position - 0x32C9 Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_65(iParam0))
		return 0f, 0f, 0f;
...
float func_72(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3AF0 Hash - 0x3DAE1415 ^0x2267FA69
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_73(int iParam0) // Position - 0x3B18 Hash - 0x23547602 ^0x23547602
{
	switch (iParam0)
	{
		case 0:
...
int func_74(int iParam0, var uParam1) // Position - 0x3C0F Hash - 0x4931B454 ^0x88362C28
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_75(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x3D70 Hash - 0x49B3EF5C ^0x9505D01C
{
	var data;
	int size;
	int collectionId;
...
int func_76(Hash hParam0, int iParam1) // Position - 0x3E23 Hash - 0x3B4883DD ^0xBE4A62CA
{
	var unk;
	var guid;
...
BOOL func_77(Hash hParam0, int iParam1) // Position - 0x3E7E Hash - 0xD7B4F3C5 ^0x943C8C22
{
	var unk;
	int num;
	int num2;
...
BOOL func_78(Hash hParam0, int iParam1, int iParam2) // Position - 0x3EDC Hash - 0xC758F57F ^0x801747D0
{
	int num;
	var unk;
	var unk6;
...
void func_79(var uParam0, int iParam1) // Position - 0x3F53 Hash - 0xF55E891F ^0xF55E891F
{
	func_140(uParam0, iParam1);
	return;
}

int func_80(Hash hParam0, int iParam1, int iParam2) // Position - 0x3F63 Hash - 0xB04D1B6E ^0xB04D1B6E
{
	switch (hParam0)
	{
...
{
	return func_204("ATZ_INS_EXC_BU");
}

Vector3 func_161() // Position - 0x78E0 Hash - 0x1DA0618A ^0xAC40CBAA
{
	return func_204("ATZ_INS_FUR_BU");
}
...
float func_169(int iParam0, int iParam1) // Position - 0x79A4 Hash - 0x2D02D958 ^0x2D02D958
{
	switch (iParam0)
	{
		case 0:
...
void func_170(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x7AA5 Hash - 0x34B16A84 ^0xB920827
{
	BOOL flag;
...
Hash func_171() // Position - 0x7B86 Hash - 0x9F572D68 ^0xB3ACFA5C
{
	return 773716431;
}

BOOL func_172(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x7B93 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_173(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x7BBC Hash - 0x6A10E689 ^0x9AB5BF75
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_174(Ped pedParam0) // Position - 0x7BDA Hash - 0xBEDFC3C1 ^0xBEDFC3C1
{
	return func_212(pedParam0, 4) || func_212(pedParam0, 5);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x7BF6 Hash - 0xFED667A ^0x326E18C5
{
	if (iParam0 < 0)
		return false;
...
void func_177(int iParam0, int iParam1) // Position - 0x7EBD Hash - 0x3CB91E05 ^0x9B77B27B
{
	if (iParam0 < 0)
		return;
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x7EF0 Hash - 0x7190BAC6 ^0x6DC372CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_179(int iParam0, BOOL bParam1) // Position - 0x7F48 Hash - 0x7CAB2FC9 ^0x77D638E9
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1945188[iParam0 /*18*/].f_3))
...
void func_180(int iParam0, int iParam1) // Position - 0x7F71 Hash - 0x6CA42F68 ^0x7439A78D
{
	if (iParam0 < 0)
		return;
...
Any func_181(Volume volParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7F99 Hash - 0xDFB996B4 ^0xC287A71C
{
	Any any;
...
void func_182(var uParam0) // Position - 0x7FE0 Hash - 0xC1AC8F8B ^0xC4E787DF
{
	int i;
...
void func_183(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8046 Hash - 0xEF5C52D ^0xEF5C52D
{
	int i;
	int num;
...
void func_184() // Position - 0x80D4 Hash - 0x18ACD9D3 ^0xB2ADEAB8
{
...
void func_185(int iParam0, int iParam1, BOOL bParam2) // Position - 0x8147 Hash - 0xD61623D0 ^0x48AE56A
{
...
void func_186(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x8163 Hash - 0xF46E0F16 ^0xED4BA72A
{
...
int func_187() // Position - 0x83E5 Hash - 0xDF9E118A ^0xDF9E118A
{
	return 3;
}

int func_188(int iParam0, int iParam1, int iParam2) // Position - 0x83EE Hash - 0xC76BC009 ^0xD35219B8
{
...
void func_189(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x8494 Hash - 0x7EFAC478 ^0x4E4217E0
{
	int i;
	int j;
	int k;
...
struct<4> func_190() // Position - 0x85FB Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
Hash func_191(Hash hParam0) // Position - 0x8607 Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
int func_192(Hash hParam0) // Position - 0x8632 Hash - 0xF4E671A6 ^0x338FA446
{
	Hash category;
...
BOOL func_193(BOOL bParam0) // Position - 0x8661 Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_64() == -1)
		return true;
...
BOOL func_194(Hash hParam0) // Position - 0x867F Hash - 0x1BC045DA ^0x469FDDE1
{
...
BOOL func_195(Hash hParam0) // Position - 0x869B Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_196(Hash hParam0, Hash hParam1) // Position - 0x86A9 Hash - 0x34B85114 ^0xAAD93A99
{
	if (hParam0 == 0)
		return false;
...
BOOL func_197(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x86DA Hash - 0x6FD18E8B ^0x7C3C83FA
{
	var unk;
	var unk5;
	var unk27;
...
void func_198(BOOL bParam0) // Position - 0x881F Hash - 0xED2925F ^0xCA812B62
{
	if (bParam0)
...
BOOL func_199(int iParam0) // Position - 0x8849 Hash - 0xB07F56E4 ^0xA1690581
{
	if (Global_1572887.f_12 == -1)
...
int func_200(int iParam0) // Position - 0x887C Hash - 0x73B9D562 ^0xF1D88D6F
{
	int num;
...
BOOL func_201(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x88BD Hash - 0x3CD10F27 ^0xAC09280E
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 16384);
}

int func_202(Volume volParam0, BOOL bParam1) // Position - 0x88D7 Hash - 0xEA796703 ^0x695D7925
{
	Volume volLockRequestId;
	int i;
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0x893F Hash - 0x24E72BF3 ^0x24E72BF3
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -1889.5646f, -2683.6514f, 65.1969f;
			
				case 1:
					return -1970.3932f, -2692.4353f, 66.185f;
			
				case 2:
					return -1905.3186f, -2674.1565f, 65.1905f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return -2017.0356f, -2738.4019f, 69.0467f;
			
				case 1:
					return -1873.5638f, -2703.457f, 65.6522f;
			
				case 2:
					return -2005.1433f, -2649.5967f, 66.1986f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return -1990.3821f, -2699.3474f, 66.3076f;
			
				case 1:
					return -1910.4011f, -2637.6f, 64.1917f;
			
				case 2:
					return -1972.1377f, -2676.2725f, 65.2693f;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					return -1954.5614f, -2696.5002f, 66.2369f;
			
				case 1:
					return -1956.372f, -2642.887f, 65.1954f;
			
				case 2:
					return -1969.9559f, -2716.7332f, 67.2008f;
			}
			break;
	}
...
Vector3 func_204(char* sParam0) // Position - 0x8ADA Hash - 0xB2B2D053 ^0xB2B2D053
{
	var unk;
...
BOOL func_205(Volume volParam0) // Position - 0x8AEC Hash - 0x1D6344D9 ^0x1D6344D9
{
	int i;
...
int func_206(Volume volParam0) // Position - 0x8B18 Hash - 0x67695E3A ^0xB4A144D5
{
	int i;
...
BOOL func_207(ePedType eptParam0) // Position - 0x8B4D Hash - 0x5000025C ^0x5000025C
{
	switch (eptParam0)
	{
...
void func_208(Ped pedParam0, Hash hParam1) // Position - 0x8FA0 Hash - 0xEA1C858E ^0x58220AFF
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
void func_209(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x904A Hash - 0x6668C7E2 ^0xE9524C34
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_210(Ped pedParam0, BOOL bParam1) // Position - 0x907A Hash - 0xC422C7A4 ^0x3D93F520
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_211(Ped pedParam0, int iParam1) // Position - 0x90BF Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
int func_212(Ped pedParam0, int iParam1) // Position - 0x90E6 Hash - 0x25D0971D ^0xF7D4E234
{
	var unk;
	int num;
...
void func_213(Volume volParam0, BOOL bParam1) // Position - 0x9125 Hash - 0xD6642292 ^0x5A7BA218
{
	int num;
...
int func_214() // Position - 0x9148 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1310750.f_16037;
}

BOOL func_215(int iParam0) // Position - 0x9157 Hash - 0xC80B63B8 ^0xC80B63B8
{
	return iParam0 > -1 && iParam0 < 120;
}

BOOL func_216(int iParam0, int iParam1) // Position - 0x916D Hash - 0x2AF6C326 ^0x2AF6C326
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_217(int iParam0) // Position - 0x9190 Hash - 0x23BA4BD8 ^0x6ABCB1DC
{
	if (!func_215(iParam0))
		return false;
...
BOOL func_218(int iParam0) // Position - 0x91C8 Hash - 0xE4DA9E55 ^0x745EA523
{
	if (!func_215(iParam0))
		return false;
...
void func_219(int iParam0) // Position - 0x91E8 Hash - 0xA37733A1 ^0x23C2C6AE
{
	int num;
...
void func_220(int iParam0) // Position - 0x9251 Hash - 0x29A8F290 ^0x8EC25CC8
{
	Global_1327479.f_3 = iParam0;
	return;
}

void func_221(int iParam0, int iParam1, BOOL bParam2) // Position - 0x9261 Hash - 0x4464293B ^0x680D2F86
{
...
BOOL func_222(Ped pedParam0) // Position - 0x92E6 Hash - 0x7410A97D ^0x34EB7DBA
{
	Hash entityModel;
...
BOOL func_223(Ped pedParam0) // Position - 0x9318 Hash - 0x7462ED7A ^0x2A6FBCB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_224(int iParam0, int iParam1) // Position - 0x935A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_225() // Position - 0x9369 Hash - 0xEE877ACE ^0xCCE9C802
{
...
int func_226(Hash hParam0, Hash hParam1) // Position - 0x938A Hash - 0x39B5DB67 ^0xD5694E3C
{
	if (hParam1 == 0)
		return 0;
...
int func_227(var uParam0) // Position - 0x93A4 Hash - 0xE0B16A5D ^0x1D9BDFB4
{
...
BOOL func_228(Hash hParam0) // Position - 0x9420 Hash - 0x1B551CF7 ^0xF7F1B098
{
	return func_245(hParam0) == joaat("WEAPON");
}

struct<4> func_229(BOOL bParam0) // Position - 0x9434 Hash - 0xBD79B8DD ^0x2443BBA9
{
	int num;
...
BOOL func_230(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3) // Position - 0x94C9 Hash - 0x4285A587 ^0x4285A587
{
	return func_234(hParam0, *uParam1, hParam2, bParam3) > 0;
}

BOOL func_231(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x94E1 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;
...
BOOL func_232(Hash hParam0, BOOL bParam1) // Position - 0x9502 Hash - 0x62864AB ^0xBC339691
{
...
BOOL func_233(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x953B Hash - 0xDE5D4AAC ^0xDB35B0F6
{
	var unk;
	Hash hash;
	var unk6;
...
int func_234(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x95CF Hash - 0xD01EE834 ^0xC97ABD1E
{
	var guid;
	int inventoryItemCountWithGuid;
...
void func_235(BOOL bParam0, int iParam1) // Position - 0x9617 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

void func_236(BOOL bParam0, int iParam1) // Position - 0x9628 Hash - 0x9815F445 ^0x9815F445
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

int func_237(int iParam0) // Position - 0x963D Hash - 0x6EC15CF9 ^0xE613EBE0
{
	int num;
	int num2;
	int num3;
...
BOOL func_238(Ped pedParam0, Hash hParam1) // Position - 0x96BE Hash - 0x902FAF7B ^0x852CA371
{
	BOOL flag;
...
BOOL func_239(Ped pedParam0, Hash hParam1) // Position - 0x96EC Hash - 0xA54F3032 ^0x7A2EF519
{
	Hash _int;
...
BOOL func_240(Ped pedParam0, Hash hParam1) // Position - 0x973D Hash - 0xA54F3032 ^0x7A2EF519
{
	Hash _int;
	int _int2;
...
void func_241(Ped pedParam0) // Position - 0x97AF Hash - 0x446F1BDD ^0x32F3DED3
{
...
BOOL func_242(int iParam0) // Position - 0x97CD Hash - 0xDDC0076D ^0xDDC0076D
{
	return Global_1310750.f_16035 && iParam0 != false;
}

BOOL func_243(int iParam0) // Position - 0x97E1 Hash - 0x169E8D3F ^0x169E8D3F
{
	return func_216(iParam0, Global_1310750.f_16072 | 64);
}

void func_244(int iParam0) // Position - 0x97F9 Hash - 0x3D0B339A ^0xB87B2B3D
{
	int i;
...
int func_245(Hash hParam0) // Position - 0x9886 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_246(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x98B1 Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;
...
BOOL func_247(int iParam0) // Position - 0x98F6 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_250(iParam0))
		return false;
...
struct<5> func_248(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9912 Hash - 0xE6705E3C ^0xB9EA38F4
{
	var unk;
	var unk6;
	var unk28;
...
Hash func_249(int iParam0, int iParam1) // Position - 0x9BCF Hash - 0xE1D12727 ^0x71D656A6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_250(int iParam0) // Position - 0xBD19 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_251(int iParam0) // Position - 0xBD2C Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
struct<4> func_252(BOOL bParam0) // Position - 0xBD56 Hash - 0x8A689EFF ^0x60C7E77C
{
	int num;
...
BOOL func_253(Hash hParam0, Hash hParam1) // Position - 0xBDBA Hash - 0x1874093C ^0x7F0FACAB
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_254(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBE19 Hash - 0xC40FC7D1 ^0x18789FFF
{
