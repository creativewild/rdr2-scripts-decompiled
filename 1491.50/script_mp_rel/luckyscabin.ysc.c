...
void main() // Position - 0x0 Hash - 0x4674E439 ^0xF52451CA
{
	int num;

	fLocal_14 = 1f;
	fLocal_15 = 1f;
	hLocal_17 = joaat("p_strongbox01x");
	uLocal_19 = { -613.3514f, 529.5198f, 94.413f };
	uLocal_22 = { 0f, 0f, -50f };
	iLocal_31 = 20000;
	iLocal_34 = iScriptParam_0;
	iLocal_32 = iScriptParam_0.f_2;
	bLocal_36 = false;
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_33)
		{
			iLocal_33 = 0;
			func_5(iLocal_34, &iLocal_32);
			...
			switch (iLocal_32)
			{
				case 0:
					if (Global_1901671.f_2.f_26 > 0)
					{
						iLocal_35 = MISC::GET_GAME_TIMER() + Global_1901671.f_2.f_26;
						iLocal_32 = 1;
					}
					else
					{
				...
				case 1:
					if (!func_1() || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						bLocal_36 = false;
						iLocal_32 = 2;
					}
				...
				case 2:
					...
					if (func_10(func_9(iLocal_34)))
						func_11(func_9(iLocal_34), 4);
				
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_34));
					Global_1896644 = -1;
					iLocal_35 = iLocal_31 + MISC::GET_GAME_TIMER();
					iLocal_32 = 3;
					break;
			
				case 3:
					if (func_13() || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT(iLocal_34);
						iLocal_35 = MISC::GET_GAME_TIMER() + iLocal_31;
						iLocal_32 = 4;
					}
					break;
			
				case 4:
					if (func_15(iLocal_34) || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0(iLocal_34);
						iLocal_35 = MISC::GET_GAME_TIMER() + iLocal_31;
						iLocal_32 = 5;
					}
					break;
				...
				case 5:
					if (func_17(iLocal_34) || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0_0(iLocal_34);
						iLocal_35 = iLocal_31 + MISC::GET_GAME_TIMER();
						iLocal_32 = 7;
					}
					break;
				...
				case 7:
					if (func_10(func_9(iLocal_34)))
						if (func_19(func_9(iLocal_34), 4) && !(iLocal_35 < MISC::GET_GAME_TIMER()))
							break;
				
					if (func_20(iLocal_34) || iLocal_35 < MISC::GET_GAME_TIMER())
					{
						func_21(iLocal_34, 4);
						iLocal_35 = MISC::GET_GAME_TIMER() + iLocal_31;
						iLocal_32 = 8;
				...
				case 8:
					...
					func_27();
					func_28();
					_DEBUG_PRINT_0_0_0_0(iLocal_34);
					_DEBUG_PRINT_0_0_0_0_0(iLocal_34);
					func_31();
					func_32();
					iLocal_32 = 9;
					break;
				...
				case 9:
					_DEBUG_PRINT_0_0_0_0_0_0(iLocal_34);
					func_34();
					iLocal_32 = 10;
					break;
				...
				case 10:
					...
					func_36(iLocal_34, &Global_1896698);
					iLocal_32 = 11;
					break;
				...
				case 12:
					if (func_40(iLocal_34))
						iLocal_33 = MISC::GET_GAME_TIMER() + 1000;
				
					func_41(&Global_1896698, iLocal_34);
					func_42(iLocal_34);
					func_21(iLocal_34, 8);
					...
					PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_34 /*36*/].f_11);
				
					if (Global_1887363[iLocal_34 /*36*/].f_12 > 0f)
						PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_34 /*36*/].f_12);
					break;
		...
		if (Global_1887363[iLocal_34 /*36*/].f_13 == 0)
		{
		}
		else
		{
			PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1887363[iLocal_34 /*36*/].f_13);
		}
...
BOOL func_1() // Position - 0x3AA Hash - 0x51BBAF33 ^0x51BBAF33
{
	if (!bLocal_36)
	{
		if (Global_1051194)
...
void func_2() // Position - 0x3FB Hash - 0x2D3C4881 ^0x5F6A96E
{
	int num;
...
void func_3() // Position - 0x44C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_4() // Position - 0x454 Hash - 0xC69268B8 ^0xC69268B8
{
	if (func_45() != -1)
...
void func_5(int iParam0, var uParam1) // Position - 0x46F Hash - 0x1DD95532 ^0x798CA2F1
{
	if (!func_38(16))
		return;
...
void func_6(int iParam0) // Position - 0x59F Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_7() // Position - 0x5A7 Hash - 0xFC5DFC3D ^0xFC5DFC3D
{
...
void func_8() // Position - 0x5C5 Hash - 0x6E39B93A ^0x6E39B93A
{
...
int func_9(int iParam0) // Position - 0x5E0 Hash - 0x4D13899D ^0x4D13899D
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_10(int iParam0) // Position - 0x6DC Hash - 0xE49023EE ^0xE49023EE
{
	return iParam0 > -1 && iParam0 < 17;
}

void func_11(int iParam0, BOOL bParam1) // Position - 0x6F2 Hash - 0xACB2A3A5 ^0xACB2A3A5
{
	Global_1896646[iParam0 /*2*/] = Global_1896646[iParam0 /*2*/] || bParam1;
	return;
}

Hash func_12(int iParam0) // Position - 0x70D Hash - 0x9C8621E4 ^0xA7A3B249
{
	Hash num;
...
BOOL func_13() // Position - 0x7F5 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x7FE Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x80A Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x817 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x823 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x830 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x83C Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x851 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x862 Hash - 0x85549BC4 ^0xED99428
{
...
void func_23() // Position - 0x8AD Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8B5 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x965 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0x96D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0x975 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x97D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x985 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x991 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x99D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0x9A5 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x9AD Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0x9B9 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0x9EA Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA30 Hash - 0x71931A41 ^0x38641BC4
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA44 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_58(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xA5D Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xA6E Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xA86 Hash - 0x81D0CE89 ^0x81D0CE89
{
	func_60();
	func_61();
	return false;
...
void func_41(var uParam0, int iParam1) // Position - 0xA97 Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBD6 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBE3 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xC19 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_74();
		LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), 0);
		func_21(iLocal_34, 2048);
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_34)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_34, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_81(iLocal_34, false))
			return false;
	}
	else if (!func_82(iLocal_34))
	{
		return false;
	}
...
int func_45() // Position - 0xD2D Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD3B Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD47 Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xD72 Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDB4 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xE94 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEB2 Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xEC5 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEE3 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0xFDB Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0xFEC Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1000 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1014 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

BOOL func_58(int iParam0) // Position - 0x101E Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_59() // Position - 0x1034 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_60() // Position - 0x1061 Hash - 0x43F0051 ^0x4838B929
{
	switch (iLocal_26)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(hLocal_17) && STREAMING::HAS_ANIM_DICT_LOADED("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A"))
			{
				func_91();
			
				if (NETWORK::NETWORK_AWARD_HAS_REACHED_MAXCLAIM(-448258490))
					obLocal_18 = OBJECT::CREATE_OBJECT(joaat("p_strongbox01x"), uLocal_19, false, false, false, true, true);
				else if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("PROMO_GTAO_GATING_NAVY_REVOLVER")))
					obLocal_18 = OBJECT::CREATE_OBJECT(joaat("p_strongbox01x"), uLocal_19, false, false, false, true, true);
				else
					obLocal_18 = OBJECT::CREATE_OBJECT(joaat("p_strongbox01x"), uLocal_19, false, false, false, false, true);
			
				DECORATOR::DECOR_SET_BOOL(obLocal_18, "chest_local_only", true);
				ENTITY::SET_ENTITY_ROTATION(obLocal_18, uLocal_22, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(obLocal_18, true);
			
				if (NETWORK::NETWORK_AWARD_HAS_REACHED_MAXCLAIM(-448258490))
				{
					TASK::_SET_SCENARIO_CONTAINER_OPENING_STATE(obLocal_18, true);
					ENTITY::PLAY_ENTITY_ANIM(obLocal_18, "base_lockbox", "MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A", 1f, false, true, false, 0, 0);
					iLocal_26 = 2;
				}
				else if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("PROMO_GTAO_GATING_NAVY_REVOLVER")))
				{
		...
		case 1:
			if (func_92(obLocal_18))
			{
				!func_93(-448258490, 0, 255, 1, false);
				iLocal_26 = 2;
			}
			break;
...
void func_61() // Position - 0x118C Hash - 0xA3B130 ^0x854E6CAE
{
	if (!INTERIOR::IS_VALID_INTERIOR(inLocal_25))
		inLocal_25 = INTERIOR::GET_INTERIOR_AT_COORDS(uLocal_19);

	switch (iLocal_27)
	{
		case 0:
			if (INTERIOR::IS_VALID_INTERIOR(inLocal_25) && inLocal_25 == INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33))
			{
		...
		case 1:
			if (!INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33)) || inLocal_25 != INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33))
			{
				if (NETWORK::NETWORK_IS_IN_MP_CUTSCENE())
...
BOOL func_62(int iParam0, int iParam1) // Position - 0x123C Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x124B Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_64() // Position - 0x125C Hash - 0x463DA432 ^0x857E19AF
{
	return func_62(Global_1940199, 8192);
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x126F Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_66(int iParam0) // Position - 0x1280 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x12C0 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_68() // Position - 0x12ED Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x12FB Hash - 0xF31398E6 ^0xD1C5DFCD
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	str = func_96(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	if (flag && bParam3)
	{
		str2 = func_101(func_100(iParam2));
	}
	...
	else if (func_58(iParam0) && func_83(iParam0, 16777216) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str2 = MISC::VAR_STRING(674, str3, num2, func_108(&unk, joaat("COLOR_PURE_WHITE")), str4, func_108(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num2, func_108(&unk, joaat("COLOR_PURE_WHITE")), func_108(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_109(str, str2, 4000, 0, 0, 0, false, true);
	return;
}

void func_70(var uParam0, int iParam1) // Position - 0x1560 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_71(int iParam0, BOOL bParam1) // Position - 0x1573 Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_72(BOOL bParam0) // Position - 0x1BDC Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_73(int iParam0) // Position - 0x1C05 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_74() // Position - 0x1C4A Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_75(int iParam0, BOOL bParam1) // Position - 0x1C52 Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_76(int iParam0, BOOL bParam1) // Position - 0x2417 Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_77(BOOL bParam0) // Position - 0x246A Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_78(int iParam0) // Position - 0x2493 Hash - 0x8BB3CD14 ^0xABC40183
{
	if (VOLUME::DOES_VOLUME_EXIST(volLocal_16))
		VOLUME::DELETE_VOLUME(volLocal_16);

	if (DECORATOR::DECOR_EXIST_ON(obLocal_18, "chest_local_only"))
		DECORATOR::DECOR_REMOVE(obLocal_18, "chest_local_only");
...
void func_79(int iParam0) // Position - 0x24EA Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_80(int iParam0) // Position - 0x251B Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x254E Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_82(int iParam0) // Position - 0x2604 Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x267E Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_84(int iParam0) // Position - 0x26AF Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_85(int iParam0) // Position - 0x26D0 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2723 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x2DE3 Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x2DFA Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x2E3D Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_87(iParam0))
		return 0;
...
BOOL func_90(int iParam0) // Position - 0x2F28 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

void func_91() // Position - 0x2F3E Hash - 0x5BD39558 ^0xF45E37F8
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
	...
	if (!VOLUME::DOES_VOLUME_EXIST(volLocal_16))
	{
		vector = { -615.837f, 530.269f, 94.935f };
		vector2 = { 0f, 0f, -140.167f };
		vector3 = { 7f, 8f, 5f };
		volLocal_16 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vector, vector2, vector3, "LuckysCabin");
		NETWORK::_NETWORK_SPAWN_CONFIG_ADD_EXCLUSION_VOLUME(volLocal_16);
	}

	return;
}

BOOL func_92(Object obParam0) // Position - 0x2F94 Hash - 0xF278C89A ^0x12B18729
{
	struct<4> eventData;
	int i;
	...
	{
		if (SCRIPTS::GET_EVENT_AT_INDEX(SCRIPT_EVENT_QUEUE_AI, i) == 1352063587)
			if (SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_AI, i, &eventData, 4))
				if (eventData.f_1 == obParam0)
					if (eventData == Global_33)
						return true;
	}
...
BOOL func_93(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2FE4 Hash - 0xC51EFF01 ^0xD252B7CC
{
	var unk;
	var unk13;
	var unk26;
	...
	unk.f_1 = 10;
	unk13.f_1 = 11;
	return func_128(iParam0, &unk26, &unk13, &unk, iParam1, iParam2, iParam3, bParam4);
}

BOOL func_94(int iParam0) // Position - 0x3014 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_129())
		return true;
...
BOOL func_95() // Position - 0x3049 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_131(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x308C Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_132(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_134(func_133(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_135(iParam0) || func_136(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_97(int iParam0) // Position - 0x3AF2 Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_98(int iParam0) // Position - 0x3B07 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_99(int iParam0) // Position - 0x3BC2 Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
	...
	i = 0;
	gamerHandle = { func_137(PLAYER::PLAYER_ID()) };
...
int func_100(int iParam0) // Position - 0x3C30 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_101(int iParam0) // Position - 0x3D8B Hash - 0x21CE226B ^0x688FF77A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x3DC6 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_103(int iParam0, int iParam1) // Position - 0x3E08 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_97(iParam0))
		return false;
...
int func_104() // Position - 0x3E4D Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_105(int iParam0) // Position - 0x3E59 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_106(int iParam0) // Position - 0x3E6C Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_107(float fParam0) // Position - 0x3E7E Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_108(var uParam0, int iParam1) // Position - 0x3E94 Hash - 0xB0CFF0C3 ^0x707CB230
{
...
int func_109(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3ECA Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_110(int iParam0) // Position - 0x3F0D Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_135(iParam0))
		if (!func_136(44))
			return false;
...
void func_111(int iParam0, int iParam1) // Position - 0x3F2D Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_112(int iParam0, int iParam1) // Position - 0x3F3E Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_113(var uParam0, var uParam1, int iParam2) // Position - 0x3F54 Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_114(int iParam0) // Position - 0x3F71 Hash - 0x3E288458 ^0xC75F9664
{
...
void func_115(int iParam0) // Position - 0x4052 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;
...
BOOL func_116(int iParam0, BOOL bParam1) // Position - 0x422A Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_117(int iParam0, BOOL bParam1) // Position - 0x4258 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_87(iParam0))
		return 0;
...
int func_118(int iParam0) // Position - 0x42DB Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_119(int iParam0) // Position - 0x4302 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_120() // Position - 0x4323 Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_121() // Position - 0x44EA Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_122(int iParam0, BOOL bParam1) // Position - 0x4565 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
...
Hash func_123(int iParam0) // Position - 0x4914 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_87(iParam0))
		return 0;
...
void func_124(int iParam0, PersChar pchParam1) // Position - 0x4932 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_87(iParam0))
		return;
...
PersChar func_125(int iParam0) // Position - 0x4953 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_87(iParam0))
		return 0;
...
void func_126(int iParam0, BOOL bParam1) // Position - 0x4973 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_127(int iParam0) // Position - 0x49AC Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_128(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x49D2 Hash - 0x72C1A759 ^0xD848AFAA
{
	BOOL flag;
	int num;
	var unk;
	...
	unk2.f_14 = iParam6;
	unk2 = { *iParam2 };
	func_163(anParam1, iParam0, unk2);
	return 1;
}

BOOL func_129() // Position - 0x4AB3 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_130() // Position - 0x4ABC Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_131(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4B24 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_132(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4C9A Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_133(var uParam0, var uParam1, var uParam2) // Position - 0x4CAE Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_134(int iParam0) // Position - 0x4CDC Hash - 0xE6862179 ^0x1B031C3E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_135(int iParam0) // Position - 0x4FC0 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_136(int iParam0) // Position - 0x4FEA Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_169(iParam0))
		return false;
...
struct<2> func_137(Player plParam0) // Position - 0x5006 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_138(const char* sParam0, int iParam1) // Position - 0x501A Hash - 0x9E99F03 ^0xD325BDA4
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_139(int iParam0, BOOL bParam1) // Position - 0x5034 Hash - 0x2F9EB0B9 ^0xE5504EC
{
	char* ambientZone;
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x5068 Hash - 0x342D57CF ^0xF05A0E29
{
	switch (iParam0)
	{
		case 5:
...
void func_141(int iParam0, int iParam1) // Position - 0x509D Hash - 0x823E3440 ^0x340E01B4
{
	func_171(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_142(int iParam0) // Position - 0x50B7 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_87(iParam0))
		return false;
...
void func_143(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x50DC Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_142(iParam0) && func_172(iParam0))
		return;

	func_126(iParam0, 1);
	func_150(iParam0);

	if (func_173(func_123(iParam0)))
	{
...
void func_144(int iParam0, BOOL bParam1) // Position - 0x51C8 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_174(iParam0))
		return;
...
void func_145(int iParam0, int iParam1) // Position - 0x521E Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_179(iParam0))
		return;
...
int func_146(int iParam0) // Position - 0x5291 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_147(Hash hParam0) // Position - 0x52A7 Hash - 0xDB9A74EC ^0x13B3F16D
{
...
void func_148(int iParam0) // Position - 0x52C7 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_149(int iParam0, BOOL bParam1) // Position - 0x52DD Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_150(int iParam0) // Position - 0x530E Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_151(int iParam0) // Position - 0x5352 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_152(int iParam0) // Position - 0x5367 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_153(int iParam0) // Position - 0x537C Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_154(int iParam0) // Position - 0x5391 Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_155(int iParam0) // Position - 0x5410 Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_156(int iParam0, int iParam1) // Position - 0x546D Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_157(int iParam0, int iParam1) // Position - 0x5486 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_158(int iParam0, int iParam1) // Position - 0x549F Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_159(int iParam0) // Position - 0x54DA Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_160(int iParam0) // Position - 0x54EE Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_161(int iParam0, int iParam1) // Position - 0x54F6 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;

	return func_183(Global_1051832.f_92[iParam0 /*75*/].f_50, iParam1);
}

void func_162(int iParam0, int iParam1) // Position - 0x551D Hash - 0xC00BEAB5 ^0x728D99B1
{
	if (iParam1 == 0)
		return;
...
void func_163(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x554D Hash - 0xE040F56 ^0xE040F56
{
	int i;
	var unk;

	if (!func_184(anParam0))
		return;
...
BOOL func_164() // Position - 0x5608 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
...
struct<2> func_165() // Position - 0x5660 Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_166(var uParam0, var uParam1) // Position - 0x566E Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_185(uParam0))
		return false;
	...
	if (uParam0.f_1 >= func_186(uParam0))
		return false;

	return true;
}

struct<2> func_167() // Position - 0x56A2 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_168(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x56ED Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;

	func_187(iParam3, &unk, &num, &num2);

	if (func_188(uParam0, unk, num, num.f_1, num2))
		return true;

	return false;
}

BOOL func_169(int iParam0) // Position - 0x571D Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_170(int iParam0) // Position - 0x5730 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_171(var uParam0, int iParam1) // Position - 0x575A Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_172(int iParam0) // Position - 0x576F Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_173(Hash hParam0) // Position - 0x5793 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_174(int iParam0) // Position - 0x579F Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_175(int iParam0, BOOL bParam1) // Position - 0x57B5 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_174(iParam0))
		return false;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x57DB Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_174(iParam0))
		return;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x5809 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_174(iParam0))
		return;
...
void func_178(int iParam0) // Position - 0x5843 Hash - 0xB29062D ^0xB29062D
{
	func_190(func_189(iParam0));
	return;
}

BOOL func_179(int iParam0) // Position - 0x5855 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_180(Hash hParam0) // Position - 0x586B Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_191(hParam0))
...
BOOL func_181() // Position - 0x5886 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

Ped func_182(int iParam0) // Position - 0x588F Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_183(int iParam0, int iParam1) // Position - 0x58BD Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_184(Any anParam0) // Position - 0x58CC Hash - 0x36229A1B ^0x2A9934D3
{
...
BOOL func_185(int iParam0) // Position - 0x5912 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_186(int iParam0) // Position - 0x5951 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_187(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x59E7 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_188(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x6484 Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_189(int iParam0) // Position - 0x64EA Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_190(int iParam0) // Position - 0x6A07 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_191(Hash hParam0) // Position - 0x6A18 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
