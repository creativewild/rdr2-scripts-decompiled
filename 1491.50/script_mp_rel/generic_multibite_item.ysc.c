...
void func_1(var uParam0, var uParam1) // Position - 0x183 Hash - 0x4355AD91 ^0xA1D5252D
{
	*uParam1 = uParam0->f_2;
...
int func_2(var uParam0) // Position - 0x1A1 Hash - 0x11288838 ^0xE3C355F
{
...
BOOL func_3(Hash hParam0, int iParam1) // Position - 0x210 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
void func_4(var uParam0) // Position - 0x22A Hash - 0x9FDF9381 ^0x3B8D525B
{
	int i;
...
void func_5(var uParam0, int iParam1) // Position - 0x26A Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

void func_6(var uParam0, BOOL bParam1) // Position - 0x277 Hash - 0xD734C260 ^0xF4862D2C
{
	int i;
	float num;
	float num2;
...
void func_7(var uParam0) // Position - 0x61E Hash - 0xA2F56449 ^0xA1F38980
{
	if (!uParam0->f_176)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_174))
...
BOOL func_8(Hash hParam0, Hash hParam1) // Position - 0x648 Hash - 0x99BEDC80 ^0x850557FF
{
	if (!func_3(hParam0, 0))
...
BOOL func_9(int iParam0) // Position - 0x689 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
...
float func_10(int iParam0, float fParam1) // Position - 0x701 Hash - 0x17EDCAD1 ^0xD87169C2
{
	float pedStamina;
	float pedMaxStamina;
	float num;
...
void func_11(float fParam0) // Position - 0x792 Hash - 0xC5B8A029 ^0xEE3B2C23
{
	Ped ped;
	int num;
...
void func_12(float fParam0, BOOL bParam1) // Position - 0x7D2 Hash - 0x3C04298E ^0xB65A98E1
{
	int num;
...
void func_13(float fParam0) // Position - 0x80A Hash - 0xC5B8A029 ^0xA3577BA4
{
	Ped ped;
	int num;
...
float func_14(float fParam0, float fParam1) // Position - 0x84A Hash - 0x2BA4B8ED ^0x2BA4B8ED
{
	if (fParam1 != 0f)
...
void func_15(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x878 Hash - 0xF1ADCC2F ^0xF1ADCC2F
{
	if (fParam1 == 0f)
		return;
...
void func_16(float fParam0, BOOL bParam1) // Position - 0x8B1 Hash - 0xF3A2F5AE ^0x22F56C08
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
float func_17(float fParam0, int iParam1) // Position - 0x909 Hash - 0x4EDD98F5 ^0x4EDD98F5
{
	switch (iParam1)
	{
		case 0:
...
int func_18(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x95B Hash - 0xAC70E962 ^0x1F9746E0
{
...
void func_19(var uParam0) // Position - 0x97F Hash - 0x98F103C7 ^0xDC387ECE
{
	switch (*uParam0)
	{
		case -2109344034:
...
void func_20(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x9FF Hash - 0xF84CCCD4 ^0x73109519
{
...
Hash func_21(Hash hParam0) // Position - 0xC69 Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

BOOL func_22(Hash hParam0, Hash hParam1) // Position - 0xC73 Hash - 0xD0E10453 ^0x5A74626C
{
...
int func_23(int iParam0) // Position - 0xCA9 Hash - 0x262796A6 ^0x32C91F91
{
	if (iParam0 == 2)
		iParam0 = func_45(1);
...
void func_24(float fParam0, Ped pedParam1) // Position - 0xCE9 Hash - 0x81B8D237 ^0xD25A4B21
{
	if (fParam0 == 0f)
		return;
...
int func_25(int iParam0) // Position - 0xD2D Hash - 0x3229E1B0 ^0x75954C0C
{
	if (iParam0 == 2)
		iParam0 = func_45(1);
...
void func_26(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD71 Hash - 0x5072E518 ^0x6DDAEE0A
{
	Player player;
	Ped ped;
...
int func_27(int iParam0) // Position - 0xE22 Hash - 0x3229E1B0 ^0x4F226FB4
{
	if (iParam0 == 2)
		iParam0 = func_45(1);
...
void func_28(float fParam0, Ped pedParam1) // Position - 0xE66 Hash - 0xFCEEE112 ^0xFADF1B0E
{
	if (fParam0 == 0f)
		return;
...
float func_29(int iParam0, float fParam1, BOOL bParam2) // Position - 0xEA8 Hash - 0xFB55A421 ^0xFB55A421
{
	int num;
	int num2;
...
float func_30(int iParam0, int iParam1) // Position - 0xF11 Hash - 0x76523351 ^0x92907141
{
	if (iParam1 == 2)
		iParam1 = func_45(2);
...
int func_31(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xF5D Hash - 0x695E4FDE ^0x4AB12C4E
{
	Ped ped;
...
BOOL func_32() // Position - 0xFD6 Hash - 0x57305A7F ^0x41946F5D
{
...
void func_33(float fParam0, int iParam1) // Position - 0xFFF Hash - 0x6AFE3513 ^0x6AFE3513
{
	float num;
	int num2;
	int num3;
...
void func_34(int iParam0, BOOL bParam1) // Position - 0x1072 Hash - 0x8A4CBA15 ^0x8A4CBA15
{
	int num;
	int num2;
...
int func_35(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x109F Hash - 0xFF5C68E3 ^0x564C72DE
{
	char* effectName;
	Ped ped;
...
int func_36(int iParam0, int iParam1, int iParam2) // Position - 0x1255 Hash - 0xF97EDB1D ^0xF97EDB1D
{
	int num;
...
struct<2> func_37(int iParam0) // Position - 0x12E9 Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_38(var uParam0, var uParam1, int iParam2) // Position - 0x12F9 Hash - 0x31B6F9FF ^0xF5CD2283
{
...
int func_39(Hash hParam0) // Position - 0x1316 Hash - 0x4DAA6E6F ^0x4DAA6E6F
{
	switch (hParam0)
	{
...
void func_40(int iParam0, int iParam1) // Position - 0x14F1 Hash - 0xDB5B57E1 ^0x4CB48A48
{
	var statId;
...
struct<2> func_41(int iParam0, int iParam1) // Position - 0x1523 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
int func_42() // Position - 0x1539 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_43(Hash hParam0, int iParam1) // Position - 0x1547 Hash - 0x5F9FD31D ^0xFCD5D23C
{
	int num;
...
BOOL func_44(Hash hParam0, int iParam1) // Position - 0x16E8 Hash - 0x2B935ABB ^0x3E9B8BD9
{
	if (hParam0 == 0)
		return false;
...
int func_45(int iParam0) // Position - 0x1702 Hash - 0x616E2FF8 ^0x616E2FF8
{
	return func_86(func_85(iParam0));
}

BOOL func_46(Player plParam0) // Position - 0x1714 Hash - 0xD9DF34E9 ^0x1EDCC4EC
{
	float num;
...
int func_47() // Position - 0x172F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

void func_48(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x173B Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int j;
...
int func_49(int iParam0, int iParam1) // Position - 0x18AE Hash - 0xAECFF2CE ^0x28AB7A26
{
	if (iParam1 == 2)
		iParam1 = func_45(2);
...
int func_50(int iParam0, int iParam1) // Position - 0x18FE Hash - 0xAECFF2CE ^0xA6B4AB7D
{
	if (iParam1 == 2)
		iParam1 = func_45(2);
...
BOOL func_51(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1950 Hash - 0x30CEFC86 ^0x30CEFC86
{
	if (bParam2)
...
void func_52(int iParam0, int iParam1, int iParam2) // Position - 0x197D Hash - 0x7E1E307C ^0xC0CC80A4
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
void func_53(int iParam0, int iParam1, int iParam2) // Position - 0x19D3 Hash - 0x7E1E307C ^0x81E4DDD9
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
BOOL func_54(Ped pedParam0, int iParam1, float fParam2) // Position - 0x1A29 Hash - 0xD72B3B3A ^0x22A28347
{
...
void func_55(int iParam0, int iParam1, int iParam2) // Position - 0x1A7E Hash - 0x9FB0AAD8 ^0x433FFF3E
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
void func_56(Ped pedParam0, int iParam1, float fParam2) // Position - 0x1ADF Hash - 0x10CC1594 ^0xA098FFFF
{
	char* str;
...
void func_57(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x1B0B Hash - 0xD1E7435D ^0x45C01A35
{
	int num;
...
BOOL func_58(int iParam0, BOOL bParam1) // Position - 0x1B41 Hash - 0x10DE2364 ^0x10DE2364
{
	return func_51(func_47(), iParam0, bParam1);
}

float func_59(int iParam0, int iParam1) // Position - 0x1B55 Hash - 0x422268C7 ^0x22464E0E
{
	if (iParam1 == 2)
		iParam1 = func_45(1);
...
int func_60(float fParam0) // Position - 0x1BA1 Hash - 0x991CF40A ^0x6EC613A5
{
	float num;
...
float func_61(float fParam0, float fParam1, float fParam2) // Position - 0x1BCC Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1BF3 Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
int func_63(int iParam0, float fParam1, int iParam2) // Position - 0x1D7B Hash - 0x91D240B ^0x31A81242
{
	if (!func_102(iParam0))
		return 0;
...
void func_64(int iParam0, var uParam1, var uParam2) // Position - 0x1DCC Hash - 0xE3170F06 ^0xE3170F06
{
	int num;
...
BOOL func_65(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1DE8 Hash - 0x6E07CB9 ^0x6E07CB9
{
...
void func_66(int iParam0, int iParam1) // Position - 0x1E8A Hash - 0x978E21B ^0xA1438975
{
	var address;
...
BOOL func_67(int iParam0) // Position - 0x1EAE Hash - 0x3FEE6090 ^0x3FEE6090
{
	switch (iParam0)
	{
		case 0:
...
char* func_68(int iParam0) // Position - 0x1EDD Hash - 0xF5064C18 ^0xF5064C18
{
	switch (iParam0)
	{
		case 0:
...
void func_69(int iParam0) // Position - 0x1F14 Hash - 0x265AFF44 ^0xECA4C539
{
	Ped ped;
	int num;
...
void func_70(int iParam0) // Position - 0x1F51 Hash - 0x5D78382 ^0x8F13B3A8
{
	int num;
	int num2;
	int i;
...
void func_71(int iParam0) // Position - 0x2021 Hash - 0x265AFF44 ^0xE695F6B4
{
	Ped ped;
	int num;
...
void func_72(int iParam0, BOOL bParam1) // Position - 0x205E Hash - 0x71081FC9 ^0xE795FB69
{
	int num;
...
void func_73(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2093 Hash - 0x5C29635D ^0x5C29635D
{
	func_31(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_74(int iParam0) // Position - 0x20AD Hash - 0xE114E312 ^0xE114E312
{
	int num;
...
BOOL func_75(int iParam0) // Position - 0x20D5 Hash - 0x2BE93DAE ^0x2BE93DAE
{
	int num;
...
BOOL func_76(int iParam0) // Position - 0x20FD Hash - 0x58B99E54 ^0x58B99E54
{
	int num;
...
BOOL func_77(int iParam0) // Position - 0x2125 Hash - 0xFFB3C2F0 ^0xFFB3C2F0
{
	int num;
...
BOOL func_78(int iParam0) // Position - 0x214D Hash - 0x29DE2428 ^0x62E85AA
{
	if (!func_77(iParam0))
		return false;
...
int func_79(int iParam0) // Position - 0x217A Hash - 0x85160494 ^0x6688B38
{
	int num;
	int num2;
	int num3;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_80(int iParam0, int iParam1) // Position - 0x240A Hash - 0x7239F0F1 ^0x156DB2F1
{
	int num;
	int num2;
	int num3;
...
int func_81(int iParam0) // Position - 0x25C2 Hash - 0x37C30FDA ^0x37C30FDA
{
	int num;
...
int func_82(int iParam0) // Position - 0x265C Hash - 0xBA965109 ^0xDF65C4FE
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_83(int iParam0) // Position - 0x29F2 Hash - 0xE1D56150 ^0x706BE6DE
{
	var unk;
...
int func_84(Hash hParam0, int iParam1) // Position - 0x2A04 Hash - 0x7A1C2599 ^0xFF9B5634
{
	var outData;
	int outIndex;
	int i;
...
BOOL func_85(int iParam0) // Position - 0x2A4E Hash - 0x745CE6FE ^0x745CE6FE
{
	return func_127(&(Global_1956875.f_1565), iParam0, 1);
}

int func_86(BOOL bParam0) // Position - 0x2A64 Hash - 0x770A7C8B ^0x770A7C8B
{
	if (bParam0)
		return 1;
...
float func_87(Player plParam0) // Position - 0x2A76 Hash - 0x67CAB99C ^0xC9B69B05
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_128(2);
}

int func_88(int iParam0) // Position - 0x2A8C Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_89(int iParam0) // Position - 0x2AB1 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_90(int iParam0) // Position - 0x2AC4 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_91(int iParam0) // Position - 0x2AD7 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_92(int iParam0) // Position - 0x2AEA Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_93(int iParam0) // Position - 0x2AFC Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_94(int iParam0, int iParam1) // Position - 0x2B0E Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2BA8 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_96(int iParam0) // Position - 0x2BE0 Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
...
int func_97(int iParam0) // Position - 0x2CBC Hash - 0x26AB94C2 ^0x26AB94C2
{
	switch (iParam0)
	{
		case 0:
...
char* func_98(int iParam0) // Position - 0x2CEB Hash - 0x8933FE60 ^0x8933FE60
{
	switch (iParam0)
	{
		case 0:
...
char* func_99(int iParam0) // Position - 0x2D22 Hash - 0x729DD382 ^0x729DD382
{
	switch (iParam0)
	{
		case 0:
...
void func_100(int iParam0, float fParam1, int iParam2) // Position - 0x2D59 Hash - 0xB327C991 ^0xFEB529B
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
void func_101(int iParam0, int iParam1, int iParam2) // Position - 0x2DAB Hash - 0x7E1E307C ^0x5642EBD7
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
BOOL func_102(int iParam0) // Position - 0x2E01 Hash - 0x969D658D ^0x969D658D
{
	if (func_67(iParam0))
		return true;
...
void func_103(int iParam0, float fParam1, int iParam2) // Position - 0x2E27 Hash - 0xF69206DE ^0x1EC60A3A
{
	if (fParam1 < 0f)
		return;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x2E83 Hash - 0x5A86BEFA ^0xB951E1EF
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_105(int iParam0) // Position - 0x2E9B Hash - 0x773BFB67 ^0x773BFB67
{
...
BOOL func_106(int iParam0) // Position - 0x2EB2 Hash - 0x7F4C96B ^0x650690F6
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x2F7E Hash - 0xECB143B0 ^0xE41A70C5
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_108(int iParam0) // Position - 0x2F97 Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_109() // Position - 0x2FAA Hash - 0xD9A24882 ^0xD9A24882
{
	if (!func_137())
		return false;
...
int func_110(int iParam0, int iParam1) // Position - 0x2FC5 Hash - 0x26934C66 ^0x26934C66
{
	switch (iParam0)
	{
		case -2101912686:
...
int func_111(int iParam0, int iParam1) // Position - 0x37C6 Hash - 0x89B5041A ^0x89B5041A
{
	switch (iParam0)
	{
...
int func_112(int iParam0, int iParam1) // Position - 0x3E7D Hash - 0x39669B5F ^0xB47C98D2
{
	int num;
	int num2;
	int num3;
...
int func_113(int iParam0, int iParam1, int iParam2) // Position - 0x3F00 Hash - 0xE22C7CA2 ^0xE22C7CA2
{
	int num;
	int num2;
...
void func_114(int iParam0) // Position - 0x3FF8 Hash - 0x3854739A ^0xCA84ED75
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_115(int iParam0, int iParam1) // Position - 0x4010 Hash - 0x9DD4188 ^0x9DD4188
{
	switch (iParam0)
	{
...
void func_116(int iParam0, int iParam1) // Position - 0x48C1 Hash - 0x73AEC1AE ^0x984E1AE9
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 + iParam1;
	return;
}

void func_117(int iParam0, int iParam1) // Position - 0x48F0 Hash - 0x3B92C3EA ^0xE3D6CCE1
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	return;
}

void func_118(int iParam0) // Position - 0x490C Hash - 0x430DB350 ^0x725C69ED
{
	int i;
...
int func_119(int iParam0, int iParam1) // Position - 0x493A Hash - 0x36ABDA29 ^0x3AF62EAA
{
	int num;
	int num2;
	int num3;
...
int func_120(int iParam0, int iParam1, int iParam2) // Position - 0x49B5 Hash - 0x769F0B2E ^0x769F0B2E
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_121(int iParam0) // Position - 0x4A8C Hash - 0x56C0B35E ^0x56C0B35E
{
	int num;
...
BOOL func_122(int iParam0) // Position - 0x4AB3 Hash - 0xCDD61996 ^0xCDD61996
{
	int num;
...
BOOL func_123(int iParam0) // Position - 0x4ADB Hash - 0x5052208B ^0x5052208B
{
	int num;
...
BOOL func_124(int iParam0) // Position - 0x4B03 Hash - 0x7F6CD4C4 ^0x7F6CD4C4
{
	int num;
...
BOOL func_125(int iParam0) // Position - 0x4B2B Hash - 0xD766BF57 ^0xD766BF57
{
	int num;
...
BOOL func_126(int iParam0) // Position - 0x4B53 Hash - 0xA1A1461E ^0xA1A1461E
{
	int num;
...
BOOL func_127(var uParam0, int iParam1, int iParam2) // Position - 0x4B7B Hash - 0x15F7E5EE ^0x39F4E7C
{
	return MISC::IS_BIT_SET(uParam0->[iParam1 / 31], iParam1 % 31);
}

int func_128(int iParam0) // Position - 0x4BB2 Hash - 0xF103C6A6 ^0xF103C6A6
{
	switch (iParam0)
	{
		case 0:
...
var func_129(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4BF3 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_130(int iParam0, int iParam1) // Position - 0x4C0A Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_131(int iParam0, int iParam1) // Position - 0x4C90 Hash - 0x96B01D2A ^0x81E68218
{
...
void func_132(int iParam0, int iParam1) // Position - 0x4CCC Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_133(int iParam0, int iParam1) // Position - 0x4D1F Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_134(int iParam0, int iParam1) // Position - 0x4D5A Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_135(int iParam0, int iParam1) // Position - 0x4D93 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_136(int iParam0) // Position - 0x4DCB Hash - 0x830CD3BA ^0x830CD3BA
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_137() // Position - 0x4DF0 Hash - 0x9AF3EE3F ^0xBF53F360
{
...
int func_138(int iParam0) // Position - 0x4E04 Hash - 0xF3F3BDC0 ^0xF3F3BDC0
{
	if (func_121(iParam0))
...
BOOL func_139(int iParam0) // Position - 0x4E25 Hash - 0xE6FB7F28 ^0xE6FB7F28
{
	int num;
...
BOOL func_140(int iParam0, int iParam1, int iParam2) // Position - 0x4E4D Hash - 0xAE2CC17B ^0x2CD7F4CE
{
	int num;
	int num2;
	int num3;
...
BOOL func_141(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x503E Hash - 0x911ECD26 ^0x92039873
{
	return uParam0.f_4 != 0;
}

BOOL func_142(int iParam0, int iParam1) // Position - 0x504C Hash - 0xBA8D4E8F ^0x2A068003
{
	int num;
...
Vector3 func_143(int iParam0) // Position - 0x508C Hash - 0x4827F1DB ^0x96104558
{
	int num;
	var unk;
...
BOOL func_144(int iParam0, var uParam1, var uParam2) // Position - 0x50C8 Hash - 0xB201D59F ^0xA3399F39
{
	if (!func_139(iParam0))
		return false;
...
BOOL func_145(int iParam0, int iParam1, int iParam2) // Position - 0x50FF Hash - 0xAE2CC17B ^0x2CD7F4CE
{
	int num;
	int num2;
	int num3;
...
void func_146(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x532D Hash - 0x562CA30C ^0x562CA30C
{
	int num;
...
void func_147(int iParam0) // Position - 0x53AC Hash - 0x9AA5A92B ^0xCC01F112
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0x5401 Hash - 0x7B05DC41 ^0x7B05DC41
{
...
BOOL func_149(int iParam0) // Position - 0x541F Hash - 0x82822340 ^0x82822340
{
	int num;
...
Vector3 func_150(int iParam0) // Position - 0x544C Hash - 0x57721B17 ^0x45053CFB
{
	var unk;
	int num;
...
int func_151(int iParam0, int iParam1) // Position - 0x548D Hash - 0x40BB17AB ^0x40BB17AB
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_152(int iParam0) // Position - 0x58C6 Hash - 0x2139C0B7 ^0x2139C0B7
{
	int num;
...
float func_153(int iParam0) // Position - 0x58EE Hash - 0x91CDD150 ^0x11569D1A
{
	float num;
...
void func_154(int iParam0) // Position - 0x591D Hash - 0x825D7B7E ^0x825D7B7E
{
	int num;
	int num2;
	int i;
...
BOOL func_155(int iParam0) // Position - 0x5AFC Hash - 0xD61CC19E ^0xD61CC19E
{
	int num;
...
int func_156(int iParam0, int iParam1) // Position - 0x5B24 Hash - 0x49B3A5C3 ^0x49B3A5C3
{
	switch (iParam0)
	{
...
void func_157(int iParam0) // Position - 0x5E34 Hash - 0xFC2A3E07 ^0xFD4CE356
{
	Ped ped;
	Player player;
...
BOOL func_158(int iParam0) // Position - 0x6043 Hash - 0x13096A7F ^0x13096A7F
{
	int num;
...
int func_159(int iParam0, int iParam1) // Position - 0x606A Hash - 0xD3D45784 ^0xD3D45784
{
	switch (iParam0)
	{
...
int func_160(int iParam0) // Position - 0x60C7 Hash - 0x76D9051B ^0xE68FE534
{
	int num;
	var unk;
	var unk32;
...
void func_161(int iParam0) // Position - 0x620B Hash - 0x825D7B7E ^0x825D7B7E
{
	int num;
	int num2;
	int i;
...
BOOL func_162(int iParam0) // Position - 0x6360 Hash - 0xF3070D3A ^0x9C23C212
{
	BOOL flag;
...
void func_163(int iParam0) // Position - 0x6389 Hash - 0xE1E3399D ^0xAAA920BB
{
	Ped ped;
	Player player;
	int num;
...
void func_164(int iParam0) // Position - 0x6623 Hash - 0x4D7CA01F ^0xE11E9732
{
	char* audioName;
	char* audioRef;
...
int func_165(int iParam0) // Position - 0x666D Hash - 0x7AD8D3DF ^0x2C577CC4
{
	int num;
...
float func_166(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x669C Hash - 0xFE4D9153 ^0xACBF575D
{
	var unk;
	float num;
...
BOOL func_167(int iParam0) // Position - 0x66D2 Hash - 0xCFB57BFC ^0xD6F1E06
{
...
BOOL func_168(int iParam0) // Position - 0x6741 Hash - 0x3374FEFF ^0x3374FEFF
{
	int num;
...
int func_169(int iParam0, int iParam1) // Position - 0x6768 Hash - 0xAF8796DC ^0xAF8796DC
{
	switch (iParam0)
	{
...
void func_170() // Position - 0x67C5 Hash - 0x8482C9D6 ^0xF644936D
{
	BOOL value;
	BOOL value2;
...
void func_171() // Position - 0x6827 Hash - 0x1EC790D6 ^0xC31DC9FE
{
	BOOL value;
...
char* func_172(int iParam0) // Position - 0x6857 Hash - 0x442E3FF7 ^0x442E3FF7
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_173(int iParam0) // Position - 0x689A Hash - 0x21FAF347 ^0xA1AE9E4F
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_174(int iParam0) // Position - 0x68D5 Hash - 0x2CE3A2A0 ^0xF0457356
{
	int i;
...
void func_175() // Position - 0x6915 Hash - 0xFDAE0587 ^0x5AB4C733
{
...
BOOL func_176(int iParam0, int iParam1) // Position - 0x6935 Hash - 0xB2431B7B ^0xEC29640E
{
	int num;
	int num2;
	int num3;
	...
	{
		num4 = Global_1156111.f_35859.f_9286[func_159(num3, 1) /*3*/];
		unk = { func_177(num4) };
	...
	switch (Global_1156111.f_35859.f_3116[num /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (num2 != Global_1295666 && !func_188(Global_1295666.f_149[num2]))
				return false;
		
			if (!func_189(512, num2))
				return false;
...
struct<31> func_177(int iParam0) // Position - 0x6C0A Hash - 0xCDBF4D5E ^0x8519EC8B
{
	int num;
...
BOOL func_178(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x6C2E Hash - 0xFE4D9153 ^0x67064BE4
{
	var unk;
	BOOL flag;
...
char* func_179(int iParam0, int iParam1) // Position - 0x6C64 Hash - 0xCD176C93 ^0xFA313C1E
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_180(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x6CBB Hash - 0x4DFFD3F3 ^0xFBF31414
{
	int i;
...
void func_181() // Position - 0x6D40 Hash - 0x54572B7C ^0x904B9528
{
...
char* func_182(int iParam0) // Position - 0x6D65 Hash - 0xC900296F ^0x5528C910
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_183(int iParam0) // Position - 0x6D85 Hash - 0xC900296F ^0xDBC0547A
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_184(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x6DA5 Hash - 0xBD123D0 ^0xD5CDFAB
{
	int num;
	int num2;
...
BOOL func_185(int iParam0, int iParam1) // Position - 0x6FC6 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_186() // Position - 0x6FD5 Hash - 0x4228A1C2 ^0x4A2C267D
{
	return Global_1572887.f_7;
}

BOOL func_187() // Position - 0x6FE3 Hash - 0x7C45C36E ^0x2F146C3F
{
	if (!Global_1048577)
		return false;
...
BOOL func_188(Player plParam0) // Position - 0x702E Hash - 0x2484E1E ^0x4707F690
{
...
BOOL func_189(int iParam0, int iParam1) // Position - 0x7073 Hash - 0xAF32F835 ^0x6534FA19
{
	if (iParam1 == 255)
...
int func_190(int iParam0) // Position - 0x709F Hash - 0xF3C27EA9 ^0xF3C27EA9
{
	int num;
...
struct<2> func_191(int iParam0) // Position - 0x70D5 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_192(var uParam0, var uParam1) // Position - 0x70E9 Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_196(uParam0))
		return false;
...
BOOL func_193(int iParam0) // Position - 0x711D Hash - 0x92B1FA90 ^0xB975289D
{
	return iParam0 == -1759663922 || iParam0 == -318976023 || iParam0 == 772881414 || iParam0 == 31269700 || iParam0 == -133550749;
}

BOOL func_194(Player plParam0) // Position - 0x7165 Hash - 0x18353CAA ^0x646BAFB
{
...
void func_195(Player plParam0) // Position - 0x7182 Hash - 0x40571888 ^0x70336487
{
	Player player;
...
BOOL func_196(int iParam0) // Position - 0x7205 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_197(int iParam0) // Position - 0x7244 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_198(Player plParam0) // Position - 0x72DA Hash - 0x40571888 ^0x70336487
{
	Player player;
...
void func_199(Player plParam0) // Position - 0x7346 Hash - 0xB360DAF6 ^0xEDA5F101
{
