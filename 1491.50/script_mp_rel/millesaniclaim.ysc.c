...
void main() // Position - 0x0 Hash - 0x5B140B50 ^0xD1F02007
{
	...
	fLocal_15 = 1f;
	iLocal_30 = 20000;
	iLocal_33 = iScriptParam_0;
	iLocal_31 = iScriptParam_0.f_2;
	bLocal_35 = false;
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				case 0:
					if (Global_1901671.f_2.f_26 > 0)
					{
						iLocal_34 = MISC::GET_GAME_TIMER() + Global_1901671.f_2.f_26;
						iLocal_31 = 1;
					}
					else
					{
				...
				case 1:
					if (!func_1() || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						bLocal_35 = false;
						iLocal_31 = 2;
					}
				...
				case 2:
					...
					if (func_10(func_9(iLocal_33)))
						func_11(func_9(iLocal_33), 4);
				
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_33));
					Global_1896644 = -1;
				...
				case 3:
					if (func_13() || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT(iLocal_33);
				...
				case 4:
					if (func_15(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_33);
						iLocal_34 = MISC::GET_GAME_TIMER() + iLocal_30;
						iLocal_31 = 5;
				...
				case 5:
					if (func_17(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0(iLocal_33);
						iLocal_34 = iLocal_30 + MISC::GET_GAME_TIMER();
						iLocal_31 = 7;
					}
					break;
				...
				case 7:
					if (func_10(func_9(iLocal_33)))
						if (func_19(func_9(iLocal_33), 4) && !(iLocal_34 < MISC::GET_GAME_TIMER()))
							break;
				
					if (func_20(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						func_21(iLocal_33, 4);
						iLocal_34 = MISC::GET_GAME_TIMER() + iLocal_30;
						iLocal_31 = 8;
				...
				case 8:
					...
					func_27();
					func_28();
					_DEBUG_PRINT_0_0_0(iLocal_33);
					_DEBUG_PRINT_0_0_0_0(iLocal_33);
					func_31();
					func_32();
					iLocal_31 = 9;
					break;
				...
				case 9:
					_DEBUG_PRINT_0_0_0_0_0(iLocal_33);
					func_34();
					iLocal_31 = 10;
					break;
				...
				case 10:
					...
					func_36(iLocal_33, &Global_1896698);
					iLocal_31 = 11;
					break;
				...
				case 12:
					if (func_40(iLocal_33))
						iLocal_32 = MISC::GET_GAME_TIMER() + 1000;
				
					func_41(&Global_1896698, iLocal_33);
					func_42(iLocal_33);
					func_21(iLocal_33, 8);
					...
					PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_33 /*36*/].f_11);
				
					if (Global_1887363[iLocal_33 /*36*/].f_12 > 0f)
						PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_33 /*36*/].f_12);
					break;
		...
		if (Global_1887363[iLocal_33 /*36*/].f_13 == 0)
		{
		}
		else
		{
			PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1887363[iLocal_33 /*36*/].f_13);
		}
...
BOOL func_13() // Position - 0x7D0 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x7D9 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x7E5 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x7F2 Hash - 0x1E501B4C ^0xD409926
{
	iParam0 = iParam0;
	uLocal_16[0] = INTERIOR::GET_INTERIOR_AT_COORDS(-1420.2783f, 1171.5925f, 226.7f);
	uLocal_16[1] = INTERIOR::GET_INTERIOR_AT_COORDS(-1440.1267f, 1189.5485f, 226.4f);
	uLocal_16[2] = INTERIOR::GET_INTERIOR_AT_COORDS(-1418.7623f, 1197.3196f, 225.4f);
	uLocal_16[3] = INTERIOR::GET_INTERIOR_AT_COORDS(-1393.2585f, 1181.4202f, 222.2f);
	uLocal_21[0] = "mil_cave_lights_01";
	uLocal_21[1] = "mil_cave_lights_02";
	uLocal_21[2] = "mil_cave_lights_03";
	uLocal_21[3] = "mil_cave_lights_04";
	return;
}

BOOL func_17(int iParam0) // Position - 0x87D Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x88A Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x896 Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8AB Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8BC Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x8FB Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x907 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x90F Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x9BF Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0x9C7 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0x9CF Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x9D7 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}
...
void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x9EB Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x9F7 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0x9FF Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xA07 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA13 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xA44 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA8A Hash - 0x71931A41 ^0x38641BC4
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA9E Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_58(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xAB7 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAC8 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xAE0 Hash - 0x5D5615B ^0xB5ED2615
{
	if (func_45() != -1)
		func_60();

	if (func_61(&bLocal_26))
	{
		if (bLocal_26)
		{
			func_62(-1382959706, false, false);
			func_62(-76557983, false, false);
...
void func_41(var uParam0, int iParam1) // Position - 0xB2F Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC6E Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC7B Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xCB1 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_75();
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_33)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_76(iLocal_33, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_82(iLocal_33, false))
			return false;
	}
	else if (!func_83(iLocal_33))
	{
		return false;
	}
...
int func_45() // Position - 0xDC5 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDD3 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDDF Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xE0A Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE4C Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF2C Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF4A Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF5D Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF7B Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1073 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x1084 Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1098 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x10AC Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

BOOL func_58(int iParam0) // Position - 0x10B6 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_59() // Position - 0x10CC Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_60() // Position - 0x10F9 Hash - 0x93B8F460 ^0x2045C1E4
{
	int i;

	for (i = 0; i <= 3; i = i + 1)
	{
		if (INTERIOR::IS_VALID_INTERIOR(uLocal_16[i]))
			if (INTERIOR::IS_INTERIOR_READY(uLocal_16[i]) && INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_33) != uLocal_16[i] || CAM::IS_SCREEN_FADED_OUT())
				if (!INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(uLocal_16[i], uLocal_21[i]))
					INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(uLocal_16[i], uLocal_21[i], 0);
	}

	return;
}

BOOL func_61(var uParam0) // Position - 0x116F Hash - 0xB4769808 ^0xB4769808
{
	if (func_92())
	{
		if (!*uParam0)
...
Hash func_62(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x119F Hash - 0xEC5804B5 ^0xE95C34A9
{
...
BOOL func_63(int iParam0, int iParam1) // Position - 0x1243 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x1252 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_65() // Position - 0x1263 Hash - 0x463DA432 ^0x857E19AF
{
	return func_63(Global_1940199, 8192);
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x1276 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_67(int iParam0) // Position - 0x1287 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x12C7 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_69() // Position - 0x12F4 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_70(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1302 Hash - 0xCBD8E812 ^0x35E2D49A
{
	BOOL flag;
	const char* str;
	char* str2;
...
void func_71(var uParam0, int iParam1) // Position - 0x1567 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_72(int iParam0, BOOL bParam1) // Position - 0x157A Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_73(BOOL bParam0) // Position - 0x1BE3 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_74(int iParam0) // Position - 0x1C0C Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_75() // Position - 0x1C51 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_76(int iParam0, BOOL bParam1) // Position - 0x1C59 Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_77(int iParam0, BOOL bParam1) // Position - 0x241E Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_78(BOOL bParam0) // Position - 0x2471 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_79(int iParam0) // Position - 0x249A Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_80(int iParam0) // Position - 0x24A2 Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_81(int iParam0) // Position - 0x24D3 Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x2506 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
	...
	if (func_87(iParam0, &num, &num2, false, false))
	{
		...
		while (true)
		{
			if (!func_115(Global_1896644.f_1, 16))
				func_116(Global_1896644.f_1, false);
...
BOOL func_83(int iParam0) // Position - 0x25BC Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;

	for (i = 0; i < 40; i = i + 1)
	{
		if (func_117(i) || func_118(i))
		{
		}
		else
		{
...
BOOL func_84(int iParam0, BOOL bParam1) // Position - 0x2636 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_85(int iParam0) // Position - 0x2667 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_86(int iParam0) // Position - 0x2688 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_87(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x26DB Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_88(int iParam0) // Position - 0x2D9B Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_89(int iParam0) // Position - 0x2DB2 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_90(int iParam0, BOOL bParam1) // Position - 0x2DF5 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_88(iParam0))
		return 0;
	...
	{
		func_123(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_122(iParam0)));
	
		if (func_45() == -1)
		{
			if (func_115(iParam0, 2048))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_124(iParam0));
				func_125(iParam0, 2048);
			}
		
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_124(iParam0));
		}
	
		return 0;
	}

	if (!func_126(iParam0) && func_45() == -1)
		return 0;

	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_124(iParam0)))
	{
	...
	func_123(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_122(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_124(iParam0));
...
BOOL func_91(int iParam0) // Position - 0x2EE0 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_92() // Position - 0x2EF6 Hash - 0x2C6DE8F6 ^0xBF042FB1
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_93(int iParam0) // Position - 0x2F12 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_127())
		return true;
...
BOOL func_94() // Position - 0x2F47 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_129(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_95(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2F8A Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_130(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_132(func_131(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_133(iParam0) || func_134(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_96(int iParam0) // Position - 0x39EF Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_97(int iParam0) // Position - 0x3A04 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_98(int iParam0) // Position - 0x3ABF Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
	...
	i = 0;
	gamerHandle = { func_135(PLAYER::PLAYER_ID()) };
...
int func_99(int iParam0) // Position - 0x3B2D Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_100(int iParam0) // Position - 0x3C88 Hash - 0x21CE226B ^0xC13E5B88
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_101(int iParam0, BOOL bParam1) // Position - 0x3CC3 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_102(int iParam0, int iParam1) // Position - 0x3D05 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_96(iParam0))
		return false;
...
int func_103() // Position - 0x3D4A Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_104(int iParam0) // Position - 0x3D56 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_105(int iParam0) // Position - 0x3D69 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_106(float fParam0) // Position - 0x3D7B Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_107(var uParam0, int iParam1) // Position - 0x3D91 Hash - 0xB0CFF0C3 ^0x7B870AAB
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
		return MISC::VAR_STRING(10, "LITERAL_STRING", uParam0);

	return func_136(MISC::VAR_STRING(10, "LITERAL_STRING", uParam0), iParam1);
}

int func_108(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3DC7 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_109(int iParam0) // Position - 0x3E0A Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_133(iParam0))
		if (!func_134(44))
			return false;
...
void func_110(int iParam0, int iParam1) // Position - 0x3E2A Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_111(int iParam0, int iParam1) // Position - 0x3E3B Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_112(var uParam0, var uParam1, int iParam2) // Position - 0x3E51 Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_113(int iParam0) // Position - 0x3E6E Hash - 0x3E288458 ^0xC75F9664
{
	func_137(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_138(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
	...
	func_139(iParam0, 8192);
	func_139(iParam0, 32768);
	func_139(iParam0, 524288);
	func_139(iParam0, 1048576);
...
void func_114(int iParam0) // Position - 0x3F4E Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_88(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_140(Global_1915656.f_3[iParam0 /*447*/].f_21))
		func_141(Global_1915656.f_3[iParam0 /*447*/].f_21, false, true, false, false);
	...
	func_142(Global_1915656.f_3[iParam0 /*447*/].f_9, false);
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_145(Global_1915656.f_3[iParam0 /*447*/].f_318[i /*6*/]);
...
BOOL func_115(int iParam0, BOOL bParam1) // Position - 0x4128 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_116(int iParam0, BOOL bParam1) // Position - 0x4156 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_88(iParam0))
		return 0;
	...
	if (func_115(iParam0, true) && !bParam1)
	{
	...
	func_148(iParam0);
	PERSCHAR::_DELETE_PERSCHAR(func_124(iParam0));
	func_123(iParam0, 0);
	return 1;
}

int func_117(int iParam0) // Position - 0x41D9 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_118(int iParam0) // Position - 0x4200 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_119() // Position - 0x4221 Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_120() // Position - 0x43E8 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x4463 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	if (!flag && !func_154(iParam0, 65536))
	{
	...
	else if (func_155(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	if (func_155(iParam0, 16384) && !flag)
	{
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_145(Global_1051832.f_92[iParam0 /*75*/].f_31[i]);
...
Hash func_122(int iParam0) // Position - 0x4812 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_88(iParam0))
		return 0;
...
void func_123(int iParam0, PersChar pchParam1) // Position - 0x4830 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_88(iParam0))
		return;
...
PersChar func_124(int iParam0) // Position - 0x4851 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_88(iParam0))
		return 0;
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x4871 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_126(int iParam0) // Position - 0x48AA Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_127() // Position - 0x48D0 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_128() // Position - 0x48D9 Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_129(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4941 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_162(func_56(0)))
		return true;
...
const char* func_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4AB7 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_131(var uParam0, var uParam1, var uParam2) // Position - 0x4ACB Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_132(int iParam0) // Position - 0x4AF9 Hash - 0xE6862179 ^0xEF038297
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_133(int iParam0) // Position - 0x4DDD Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_134(int iParam0) // Position - 0x4E07 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_165(iParam0))
		return false;
...
struct<2> func_135(Player plParam0) // Position - 0x4E23 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_136(const char* sParam0, int iParam1) // Position - 0x4E37 Hash - 0x9E99F03 ^0xF72678E2
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_137(int iParam0, BOOL bParam1) // Position - 0x4E51 Hash - 0x2F9EB0B9 ^0xACDC7192
{
	char* ambientZone;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4E85 Hash - 0x342D57CF ^0x441AC331
{
	switch (iParam0)
	{
		case 5:
...
void func_139(int iParam0, int iParam1) // Position - 0x4EBA Hash - 0x823E3440 ^0x340E01B4
{
	func_167(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_140(int iParam0) // Position - 0x4ED4 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_88(iParam0))
		return false;
...
void func_141(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4EF9 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_140(iParam0) && func_168(iParam0))
		return;

	func_125(iParam0, 1);
	func_148(iParam0);

	if (func_169(func_122(iParam0)))
	{
		persChar = func_124(iParam0);
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x4FE5 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_170(iParam0))
		return;
...
void func_143(int iParam0, int iParam1) // Position - 0x503B Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_175(iParam0))
		return;
...
int func_144(int iParam0) // Position - 0x50AE Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_145(Hash hParam0) // Position - 0x50C4 Hash - 0xDB9A74EC ^0x13B3F16D
{
	if (func_176(hParam0) && func_177())
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(hParam0);

	return;
}

void func_146(int iParam0) // Position - 0x50E4 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_147(int iParam0, BOOL bParam1) // Position - 0x50FA Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_148(int iParam0) // Position - 0x512B Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_149(int iParam0) // Position - 0x516F Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_150(int iParam0) // Position - 0x5184 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_151(int iParam0) // Position - 0x5199 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_152(int iParam0) // Position - 0x51AE Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_153(int iParam0) // Position - 0x522D Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x528A Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x52A3 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_156(int iParam0, int iParam1) // Position - 0x52BC Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_157(int iParam0) // Position - 0x52F7 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_158(int iParam0) // Position - 0x530B Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x5313 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;

	return func_179(Global_1051832.f_92[iParam0 /*75*/].f_50, iParam1);
}

BOOL func_160() // Position - 0x533A Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_162(Global_1051268) && Global_1572887.f_8 & 1 != 0)
		return true;

	return false;
}

struct<2> func_161() // Position - 0x5392 Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_162(var uParam0, var uParam1) // Position - 0x53A0 Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_180(uParam0))
		return false;
	...
	if (uParam0.f_1 >= func_181(uParam0))
		return false;

	return true;
}

struct<2> func_163() // Position - 0x53D4 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_164(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x541F Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;

	func_182(iParam3, &unk, &num, &num2);

	if (func_183(uParam0, unk, num, num.f_1, num2))
		return true;

	return false;
}

BOOL func_165(int iParam0) // Position - 0x544F Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_166(int iParam0) // Position - 0x5462 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_167(var uParam0, int iParam1) // Position - 0x548C Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_168(int iParam0) // Position - 0x54A1 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_169(Hash hParam0) // Position - 0x54C5 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_170(int iParam0) // Position - 0x54D1 Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_171(int iParam0, BOOL bParam1) // Position - 0x54E7 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_170(iParam0))
		return false;
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x550D Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_170(iParam0))
		return;
...
void func_173(int iParam0, BOOL bParam1) // Position - 0x553B Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_170(iParam0))
		return;
...
void func_174(int iParam0) // Position - 0x5575 Hash - 0xB29062D ^0xB29062D
{
	func_185(func_184(iParam0));
	return;
}

BOOL func_175(int iParam0) // Position - 0x5587 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_176(Hash hParam0) // Position - 0x559D Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_186(hParam0))
...
BOOL func_177() // Position - 0x55B8 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

Ped func_178(int iParam0) // Position - 0x55C1 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_179(int iParam0, int iParam1) // Position - 0x55EF Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_180(int iParam0) // Position - 0x55FE Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_181(int iParam0) // Position - 0x563D Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_182(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x56D3 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x6170 Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_184(int iParam0) // Position - 0x61D6 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_185(int iParam0) // Position - 0x66F3 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_186(Hash hParam0) // Position - 0x6704 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
