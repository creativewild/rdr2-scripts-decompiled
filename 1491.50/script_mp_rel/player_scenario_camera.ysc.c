...
BOOL func_4() // Position - 0xD0 Hash - 0xB0528571 ^0xDADB95FC
{
	...
	{
		case 0:
			iLocal_0.f_32 = TASK::_GET_SCENARIO_POINT_PED_IS_USING(Global_33, false);
		...
		case 1:
			if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1) && DATAFILE::PARSEDDATA_IS_FILE_LOADED(iLocal_0.f_34))
			{
				func_5();
