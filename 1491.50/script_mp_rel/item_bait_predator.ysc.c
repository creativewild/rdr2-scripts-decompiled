...
void func_4(var uParam0) // Position - 0x40D Hash - 0xB2A2BEC6 ^0x9521CF5B
{
	uParam0->f_12 = 1;
	uParam0->f_14 = 1;
...
BOOL func_5(var uParam0) // Position - 0x445 Hash - 0x93FE03D1 ^0x9BD9D200
{
	BOOL flag;
...
int func_6(var uParam0) // Position - 0x4DC Hash - 0x51136ED0 ^0x51136ED0
{
	return *uParam0;
}

BOOL func_7(var uParam0) // Position - 0x4E7 Hash - 0xD73B9827 ^0x8E05EC78
{
	return uParam0->f_8;
}

void func_8(var uParam0) // Position - 0x4F3 Hash - 0xBA5A1D5A ^0x2C0A2EA5
{
	uParam0->f_8 = 0;
	return;
}

var func_9(Ped pedParam0, int iParam1) // Position - 0x500 Hash - 0xB13A3864 ^0x7FBAE642
{
	var weaponHash;
...
int func_10(Hash hParam0) // Position - 0x517 Hash - 0x7EAE6538 ^0x2F2C4FF7
{
...
void func_11(var uParam0) // Position - 0x595 Hash - 0xC6AC853C ^0x4ADF66A2
{
...
BOOL func_12(var uParam0) // Position - 0x5F3 Hash - 0x248D9017 ^0x65AE88D1
{
	if (func_30(uParam0->f_16))
...
void func_13(BOOL bParam0) // Position - 0x67D Hash - 0xC088D43F ^0xCCE076F5
{
	if (!bParam0)
		func_33(false, 0);
...
void func_14(var uParam0) // Position - 0x699 Hash - 0x4B123285 ^0x8FD5F6F7
{
...
void func_15(var uParam0) // Position - 0x70C Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_16(var uParam0) // Position - 0x714 Hash - 0xDE35A32E ^0xAB184093
{
	if (uParam0->f_14)
	{
		if (uParam0->f_15 != 0)
...
int func_17(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x7F4 Hash - 0x6E56F3C0 ^0x23695AE
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_18(var uParam0) // Position - 0x9A6 Hash - 0xE6BC8CC5 ^0xF95999CA
{
	if (!func_31(uParam0->f_17))
		return;
...
BOOL func_19(var uParam0) // Position - 0x9F8 Hash - 0xE0AE880E ^0xBE0D46B1
{
	int num;
	int boneId;
...
void func_20(Hash hParam0) // Position - 0xC34 Hash - 0xD8F93303 ^0x277E9FFE
{
	int outData;
	var outData2;
	int i;
...
void func_21(var uParam0) // Position - 0xF78 Hash - 0x53A0C634 ^0xD8091FC3
{
	...
	{
		if (uParam0->f_1 == joaat("consumable_predator_bait"))
			if (Global_1958675.f_1)
				num = 5;
			else
				num = 2;
		else if (Global_1958675.f_1)
			num = 6;
		else
			num = 3;
...
void func_22(Hash hParam0, int iParam1) // Position - 0xFE0 Hash - 0x5F9FD31D ^0xFCD5D23C
{
	int num;
...
BOOL func_23(var uParam0) // Position - 0x1181 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void func_24(var uParam0) // Position - 0x118A Hash - 0x86FD8689 ^0xC4149B0D
{
	uParam0->f_8 = 1;
	return;
}

BOOL func_25(Hash hParam0, int iParam1) // Position - 0x1197 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
int func_26(Hash hParam0) // Position - 0x11B1 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
BOOL func_27(Hash hParam0, int iParam1) // Position - 0x11DC Hash - 0x2A2D0794 ^0xC823165
{
	Hash hash;
	int num;
	int num2;
	...
	if (func_63("ALL WEAPONS", &num, &num2, joaat("SLOTID_NONE"), false))
	{
...
BOOL func_28(Hash hParam0) // Position - 0x1282 Hash - 0x52397408 ^0x52397408
{
	int num;
	int num2;
	int num3;
...
int func_29(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x133E Hash - 0x68EBB232 ^0xEAD633B4
{
...
BOOL func_30(int iParam0) // Position - 0x1400 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return iParam0 != 0;
}

BOOL func_31(const char* sParam0) // Position - 0x140C Hash - 0x38726239 ^0x48BDE31D
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

BOOL func_32(const char* sParam0) // Position - 0x141B Hash - 0x38726239 ^0x48BDE31D
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

void func_33(BOOL bParam0, int iParam1) // Position - 0x142A Hash - 0xCC16269 ^0xB563FF97
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_34(const char* sParam0) // Position - 0x144C Hash - 0x38726239 ^0x48BDE31D
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

BOOL func_35(Hash hParam0) // Position - 0x145B Hash - 0x1B551CF7 ^0xD3BB1F31
{
	return func_26(hParam0) == joaat("consumable");
}

Hash func_36(Hash hParam0, int iParam1) // Position - 0x146F Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
...
void func_37(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x14E9 Hash - 0x81C6837 ^0x21B516A3
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_80(hParam0, &str, num3, num2, 0, joaat("ui_itemviewer")))
	{
		str = "_PLACEHOLDER";
	...
	hash2 = func_83(hParam0, false);

	if (func_84(hash) && func_48(hParam0, -306684263) && hash2 != 0)
	{
		hash2 = func_85(hParam0);
	}
	else if (func_26(hParam0) == joaat("CLOTHING"))
	{
		hash3 = func_86(hParam0);
	
		if (func_25(hash3, 0))
			hash2 = func_83(hash3, false);
	}
	...
	str5 = func_89(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash2), value), num4);
	...
	if (hash == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || hash == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || hash == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || hash == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str5 = MISC::VAR_STRING(0, func_90(hParam0, -442898163));
	...
	if (hash == -126813555 || hash == 1946043663)
	{
		...
		if (func_91(hParam0, &unk7))
			str5 = func_93(func_92(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_94(str5, str.f_1, MISC::GET_HASH_KEY(str), num5, num4, str3, str2, 0, true);
	return;
}

struct<2> func_38(Hash hParam0) // Position - 0x19B3 Hash - 0xA94BD8E0 ^0x321CB6EB
{
	var unk;
	var unk3;
...
BOOL func_39(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1A47 Hash - 0x4C808C39 ^0x99CF3799
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_95(hParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0, 0) };
...
BOOL func_40(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1B13 Hash - 0xDDC024C0 ^0x60000BA4
{
	int num;
	var unk;
	var unk6;
...
struct<5> func_41(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x1B8B Hash - 0xFD1D83A6 ^0x412BEE1D
{
	var unk;
	int num;
	var unk6;
	...
	switch (num)
	{
		...
		case joaat("DOG"):
			...
			{
				unk = { func_101(joaat("kit_camp"), unk, joaat("SLOTID_SATCHEL"), bParam1) };
				unk.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(hParam0, joaat("kit_camp"));
			}
			else if (func_107(hParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				unk = { func_101(joaat("WARDROBE"), unk, joaat("SLOTID_WARDROBE"), bParam1) };
...
BOOL func_42(BOOL bParam0) // Position - 0x1EFF Hash - 0x5FE544FD ^0x9DF7DC41
{
	if (func_61() == -1)
		return true;
...
void func_43(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1F1D Hash - 0x2B098F6F ^0x2F7D859F
{
...
BOOL func_44(var uParam0) // Position - 0x1F57 Hash - 0x476956F8 ^0x77017D93
{
	if (!uParam0->f_13)
		return false;
...
BOOL func_45(Ped pedParam0, const char* sParam1, const char* sParam2, int iParam3, int iParam4) // Position - 0x1FA4 Hash - 0xD54C15FA ^0x4FC46E8D
{
...
int func_46(Ped pedParam0, AnimScene ansParam1) // Position - 0x1FFF Hash - 0xB707C1D1 ^0x9A625077
{
	var entityId;
...
void func_47(var uParam0) // Position - 0x20B8 Hash - 0x664A9260 ^0x90AAAA2D
{
	BOOL flag;
...
BOOL func_48(Hash hParam0, Hash hParam1) // Position - 0x2141 Hash - 0x99BEDC80 ^0x850557FF
{
	if (!func_25(hParam0, 0))
...
float func_49(int iParam0, int iParam1) // Position - 0x2182 Hash - 0x882BA7B3 ^0xDE52A593
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_50(int iParam0) // Position - 0x2237 Hash - 0x265AFF44 ^0xECA4C539
{
	Ped ped;
	int num;
...
void func_51(int iParam0, BOOL bParam1) // Position - 0x2274 Hash - 0x71081FC9 ^0xE795FB69
{
	int num;
...
void func_52(int iParam0) // Position - 0x22A9 Hash - 0x265AFF44 ^0xE695F6B4
{
	Ped ped;
	int num;
...
float func_53(float fParam0, float fParam1) // Position - 0x22E6 Hash - 0x2BA4B8ED ^0x2BA4B8ED
{
	if (fParam1 != 0f)
...
void func_54(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2314 Hash - 0xF1ADCC2F ^0xF1ADCC2F
{
	if (fParam1 == 0f)
		return;
...
float func_55(float fParam0, int iParam1) // Position - 0x234D Hash - 0x4EDD98F5 ^0x4EDD98F5
{
	switch (iParam1)
	{
		case 0:
...
int func_56(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x239F Hash - 0xAC70E962 ^0x1F9746E0
{
...
void func_57(float fParam0, BOOL bParam1) // Position - 0x23C3 Hash - 0xF3A2F5AE ^0x22F56C08
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
struct<2> func_58(int iParam0) // Position - 0x241B Hash - 0x573E385B ^0x573E385B
{
	int num;
...
void func_59(var uParam0, var uParam1, int iParam2) // Position - 0x242B Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x2448 Hash - 0x8A4CBA15 ^0x8A4CBA15
{
	int num;
	int num2;
...
int func_61() // Position - 0x2475 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

int func_62(Hash hParam0, int iParam1) // Position - 0x2483 Hash - 0x7A1C2599 ^0xFF9B5634
{
	var outData;
	int outIndex;
	int i;
...
BOOL func_63(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x24CD Hash - 0xA7F38D3E ^0x25D43AAB
{
...
BOOL func_64(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x24F4 Hash - 0xF1DE71ED ^0x4F212F50
{
	if (iParam2 < 0)
		return false;
...
BOOL func_65(Hash hParam0) // Position - 0x252F Hash - 0x7830C71D ^0x6BD1FDB5
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_66(int iParam0) // Position - 0x254A Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
Hash func_67(Hash hParam0) // Position - 0x256B Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
int func_68(Hash hParam0) // Position - 0x2596 Hash - 0xB8EC44B7 ^0x72487142
{
	switch (hParam0)
	{
...
int func_69(var uParam0, int iParam1) // Position - 0x2679 Hash - 0x6AC2726E ^0xDB215040
{
	int i;
...
int func_70(Hash hParam0) // Position - 0x26B6 Hash - 0xD114ACC1 ^0x3428F85C
{
	int num;
...
int func_71(Hash hParam0, BOOL bParam1) // Position - 0x2723 Hash - 0xF271562B ^0x8AA3413F
{
	var unk;
	int num;
	int num2;
...
int func_72(Hash hParam0, Hash hParam1) // Position - 0x2782 Hash - 0x865BD5D3 ^0xA4D690BD
{
	if (hParam1 == 0)
		return 0;
...
int func_73(BOOL bParam0) // Position - 0x27AE Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_61() == -1)
	{
...
struct<4> func_74(Hash hParam0, BOOL bParam1) // Position - 0x27EF Hash - 0x8EFC92E9 ^0xE8DA0FF0
{
	var unk;
...
void func_75(Hash hParam0, var uParam1, var uParam2) // Position - 0x2814 Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
BOOL func_76() // Position - 0x2A20 Hash - 0xC631EDDE ^0xC631EDDE
{
	return !Global_1913444;
}

void func_77(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x2A2D Hash - 0x3B7A5BE9 ^0xEE7A100D
{
	int i;
...
var func_78(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2B50 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_79(Hash hParam0, int iParam1) // Position - 0x2B67 Hash - 0x6D89877F ^0x75E613A5
{
	if (!func_25(hParam0, 0))
		return false;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_80(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x2B86 Hash - 0x92B705D3 ^0xB783F681
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_81(Hash hParam0) // Position - 0x2C79 Hash - 0xFBA883FB ^0x640772AF
{
...
BOOL func_82(Hash hParam0) // Position - 0x2D75 Hash - 0x12CDDB68 ^0xF31C74A7
{
...
Hash func_83(Hash hParam0, BOOL bParam1) // Position - 0x2DF4 Hash - 0x88397BA6 ^0x88397BA6
{
	Hash hash;
...
BOOL func_84(Hash hParam0) // Position - 0x2E22 Hash - 0x339D45CE ^0x339D45CE
{
	switch (hParam0)
	{
		case -1696039442:
...
Hash func_85(Hash hParam0) // Position - 0x2E49 Hash - 0x9C7FC6B8 ^0x60951C4B
{
	var outData;
	int i;
...
Hash func_86(Hash hParam0) // Position - 0x2EB7 Hash - 0xD046EEF0 ^0xB8E66C21
{
	int num;
	var unk;
	int collectionId;
	...
	unk = { func_134(joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0, 0, 0, -1, num, 0) };

	if (func_135(unk, &collectionId, &num2, 0))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			if (ITEMDATABASE::_ITEMDATABASE_GET_COMPONENT_ITEM(collectionId, i, &outKey) && func_136(outKey))
			{
...
BOOL func_87(Hash hParam0, Hash hParam1) // Position - 0x2F3C Hash - 0x34B85114 ^0x6986CE99
{
	if (hParam0 == 0)
		return false;
...
int func_88(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3) // Position - 0x2F6D Hash - 0x6E96D276 ^0x9A3B0071
{
	var outData;
...
const char* func_89(const char* sParam0, int iParam1) // Position - 0x2FCC Hash - 0x9E99F03 ^0x2CB812B3
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_90(Hash hParam0, int iParam1) // Position - 0x2FE6 Hash - 0x7C967237 ^0x7C967237
{
	 num;
...
BOOL func_91(Hash hParam0, char* sParam1) // Position - 0x3004 Hash - 0xE779657E ^0x44FD4FF7
{
	...
	TEXT_LABEL_ASSIGN_STRING(&unk, func_141(hParam0), 128);
...
const char* func_92(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x3081 Hash - 0xE80420B9 ^0x2740E778
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_93(const char* sParam0, int iParam1) // Position - 0x3095 Hash - 0xB0CFF0C3 ^0x272D0977
{
...
int func_94(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x30CB Hash - 0x72075C17 ^0x3AC6D3FB
{
	int num;
	var unk13;
	int num2;
...
struct<18> func_95(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x312E Hash - 0x90CCF0F4 ^0xA5F3D799
{
	Hash hash;
...
struct<4> func_96(BOOL bParam0) // Position - 0x320C Hash - 0xC271E2E0 ^0xF6B4968C
{
	int num;
...
void func_97(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x32AD Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_98(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x32C8 Hash - 0xA09A22CB ^0x2B47F617
{
...
BOOL func_99(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6) // Position - 0x32ED Hash - 0xA0AA5F74 ^0x6BC7AEA2
{
	var unk;
	int num;
	var unk15;
...
BOOL func_100(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x340B Hash - 0x1D349B48 ^0xBDB6885B
{
	int num;
	var unk;
	int num2;
...
struct<4> func_101(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x3523 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
struct<4> func_102(BOOL bParam0) // Position - 0x3554 Hash - 0xCD4C5B4C ^0x5BC3600A
{
	int num;
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (num == 2)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1292143))
				Global_1292143 = { func_101(joaat("character"), func_148(), joaat("SLOTID_NONE"), bParam0) };
		...
		else if (num == 3)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_12)))
				Global_1292143.f_12 = { func_101(joaat("character"), func_148(), joaat("SLOTID_NONE"), false) };
		
			return Global_1292143.f_12;
		}
	}

	return func_101(joaat("character"), func_148(), joaat("SLOTID_NONE"), bParam0);
}

int func_103(Hash hParam0, BOOL bParam1) // Position - 0x35F4 Hash - 0x5D0FB4E0 ^0x17177DE5
{
...
BOOL func_104(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x362B Hash - 0x28ECC25A ^0x28ECC25A
{
	return func_150(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_105(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x3646 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;
...
struct<4> func_106(BOOL bParam0) // Position - 0x3667 Hash - 0x9E4BFC8E ^0xE92FDA8B
{
	int num;
...
BOOL func_107(Hash hParam0, Hash hParam1) // Position - 0x36D1 Hash - 0x3516CCA0 ^0x327E5212
{
	Hash outSlotId;
	Hash category;
	int i;
	...
	for (i = 0; i < fitsSlotCount; i = i + 1)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_FITS_SLOT_INFO(category, i, &outSlotId))
			if (func_152(hParam0, hParam1, outSlotId))
				return true;
	}
...
BOOL func_108(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x373E Hash - 0x113CD144 ^0x113CD144
{
	return func_153(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_109() // Position - 0x3754 Hash - 0xA30B23E7 ^0xAB29D7A2
{
...
void func_110(int iParam0) // Position - 0x37B3 Hash - 0x29A8F290 ^0x82294867
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_111(int iParam0) // Position - 0x37C3 Hash - 0x29A8F290 ^0x1CB9B41C
{
	Global_1940252.f_10 = iParam0;
	return;
}

BOOL func_112(AnimScene ansParam0) // Position - 0x37D3 Hash - 0x1956A549 ^0x3490599A
{
...
Hash func_113(Hash hParam0) // Position - 0x37EB Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

BOOL func_114(Hash hParam0, Hash hParam1) // Position - 0x37F5 Hash - 0xD0E10453 ^0x5A74626C
{
...
int func_115(int iParam0) // Position - 0x382B Hash - 0x262796A6 ^0x32C91F91
{
	if (iParam0 == 2)
		iParam0 = func_157(1);
...
void func_116(float fParam0, Ped pedParam1) // Position - 0x386B Hash - 0x81B8D237 ^0xD25A4B21
{
	if (fParam0 == 0f)
		return;
...
int func_117(int iParam0) // Position - 0x38AF Hash - 0x3229E1B0 ^0x75954C0C
{
	if (iParam0 == 2)
		iParam0 = func_157(1);
...
void func_118(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x38F3 Hash - 0x5072E518 ^0x6DDAEE0A
{
	Player player;
	Ped ped;
...
int func_119(int iParam0) // Position - 0x39A4 Hash - 0x3229E1B0 ^0x4F226FB4
{
	if (iParam0 == 2)
		iParam0 = func_157(1);
...
void func_120(float fParam0, Ped pedParam1) // Position - 0x39E8 Hash - 0xFCEEE112 ^0xFADF1B0E
{
	if (fParam0 == 0f)
		return;
...
float func_121(int iParam0, float fParam1, BOOL bParam2) // Position - 0x3A2A Hash - 0xFB55A421 ^0xFB55A421
{
	int num;
	int num2;
...
float func_122(int iParam0, int iParam1) // Position - 0x3A93 Hash - 0x76523351 ^0x92907141
{
	if (iParam1 == 2)
		iParam1 = func_157(2);
...
int func_123(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3ADF Hash - 0xF5F03980 ^0xFD230D27
{
	Ped ped;
...
int func_124(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3B5D Hash - 0xFF5C68E3 ^0x564C72DE
{
	char* effectName;
	Ped ped;
...
BOOL func_125() // Position - 0x3D13 Hash - 0x57305A7F ^0x41946F5D
{
...
void func_126(float fParam0, int iParam1) // Position - 0x3D3C Hash - 0x6AFE3513 ^0x6AFE3513
{
	float num;
	int num2;
	int num3;
...
void func_127(int iParam0, var uParam1, var uParam2) // Position - 0x3DAF Hash - 0xE3170F06 ^0xE3170F06
{
	int num;
...
BOOL func_128(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3DCB Hash - 0x6E07CB9 ^0x6E07CB9
{
...
void func_129(int iParam0, int iParam1) // Position - 0x3E6D Hash - 0x978E21B ^0xA1438975
{
	var address;
...
BOOL func_130(Hash hParam0, int iParam1) // Position - 0x3E91 Hash - 0x2B935ABB ^0x3E9B8BD9
{
	if (hParam0 == 0)
		return false;
...
BOOL func_131(Hash hParam0, Hash hParam1) // Position - 0x3EAB Hash - 0xCB56AA2F ^0x760BB648
{
	if (hParam1 == 0)
		return false;
...
Hash func_132(Hash hParam0, BOOL bParam1) // Position - 0x3ED2 Hash - 0xBBDA5425 ^0x61248A33
{
	switch (hParam0)
	{
...
int func_133(Hash hParam0) // Position - 0x3F74 Hash - 0xE1F3DDAE ^0xC8D3B326
{
	var outData;
	int num;
...
struct<10> func_134(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x3FAE Hash - 0x440EE211 ^0xAE2816F9
{
	int num;
...
BOOL func_135(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x4084 Hash - 0xB0933807 ^0x5CBA43FF
{
...
BOOL func_136(Hash hParam0) // Position - 0x40A5 Hash - 0x5E6E1858 ^0xE905275C
{
	!func_25(hParam0, 0);
...
int func_137(int iParam0) // Position - 0x40CB Hash - 0x6B3C6310 ^0x9A4DF434
{
	if (iParam0 < 0)
		return 0;
...
int func_138(Hash hParam0, int iParam1) // Position - 0x40EC Hash - 0x193BF536 ^0xD3271214
{
	var outData;
	int num;
	int outIndex;
...
char* func_139(Hash hParam0) // Position - 0x413A Hash - 0x40E070C8 ^0x4AF8C7B6
{
	Hash labelHash;
...
BOOL func_140(Hash hParam0) // Position - 0x4170 Hash - 0xB0090776 ^0x189C4477
{
...
char* func_141(Hash hParam0) // Position - 0x419E Hash - 0xB15BC7E7 ^0xFC7313A6
{
	Hash labelHash;
...
void func_142(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x41D3 Hash - 0xC233DF85 ^0x5FF82D96
{
...
BOOL func_143(Hash hParam0) // Position - 0x4204 Hash - 0xC561A1F5 ^0xE0EE3BCE
{
...
int func_144(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x421A Hash - 0xE31FD889 ^0x3309583A
{
	int num;
...
void func_145(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x4284 Hash - 0x4EE39F09 ^0x4C62B7DF
{
	int i;
...
BOOL func_146(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x4302 Hash - 0xF48E6FC8 ^0xA8BADD49
{
	*uParam1 = 0;
...
struct<17> func_147(Hash hParam0, var uParam1) // Position - 0x436F Hash - 0x692393AE ^0xF1DF31F2
{
	var unk;
...
struct<4> func_148() // Position - 0x43C2 Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
int func_149() // Position - 0x43CE Hash - 0x7BDD8F67 ^0x9160E7D8
{
...
int func_150(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x43EB Hash - 0xC754D793 ^0x26C4E67C
{
...
BOOL func_151(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x446A Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;
...
BOOL func_152(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x44AF Hash - 0x7F891916 ^0x5CD7D9F0
{
...
BOOL func_153(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x44E2 Hash - 0xC845006B ^0xAA568F17
{
...
Ped func_154(int iParam0) // Position - 0x451C Hash - 0x829B7265 ^0xE21C4F30
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_155(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x452C Hash - 0x586BF778 ^0x586BF778
{
	int num;
...
void func_156(int iParam0) // Position - 0x4561 Hash - 0x1B4614B0 ^0x73E476F0
{
...
int func_157(int iParam0) // Position - 0x45E6 Hash - 0x616E2FF8 ^0x616E2FF8
{
	return func_195(func_194(iParam0));
}

BOOL func_158(Player plParam0) // Position - 0x45F8 Hash - 0xD9DF34E9 ^0x1EDCC4EC
{
	float num;
...
int func_159() // Position - 0x4613 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

void func_160(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x461F Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int j;
...
int func_161(int iParam0, int iParam1) // Position - 0x4792 Hash - 0xAECFF2CE ^0x28AB7A26
{
	if (iParam1 == 2)
		iParam1 = func_157(2);
...
int func_162(int iParam0, int iParam1) // Position - 0x47E2 Hash - 0xAECFF2CE ^0xA6B4AB7D
{
	if (iParam1 == 2)
		iParam1 = func_157(2);
...
BOOL func_163(int iParam0, int iParam1, BOOL bParam2) // Position - 0x4834 Hash - 0x30CEFC86 ^0x30CEFC86
{
	if (bParam2)
...
void func_164(int iParam0, int iParam1, int iParam2) // Position - 0x4861 Hash - 0x7E1E307C ^0xC0CC80A4
{
	if (iParam2 == 2)
		iParam2 = func_157(2);
...
void func_165(int iParam0, int iParam1, int iParam2) // Position - 0x48B7 Hash - 0x7E1E307C ^0x81E4DDD9
{
	if (iParam2 == 2)
		iParam2 = func_157(2);
...
BOOL func_166(Ped pedParam0, int iParam1, float fParam2) // Position - 0x490D Hash - 0xD72B3B3A ^0x22A28347
{
...
void func_167(int iParam0, int iParam1, int iParam2) // Position - 0x4962 Hash - 0x9FB0AAD8 ^0x433FFF3E
{
	if (iParam2 == 2)
		iParam2 = func_157(2);
...
void func_168(Ped pedParam0, int iParam1, float fParam2) // Position - 0x49C3 Hash - 0x10CC1594 ^0xA098FFFF
{
	char* str;

	str = func_207(iParam1);
...
void func_169(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x49EF Hash - 0xD1E7435D ^0x45C01A35
{
	int num;
...
BOOL func_170(int iParam0) // Position - 0x4A25 Hash - 0x3FEE6090 ^0x3FEE6090
{
	switch (iParam0)
	{
		case 0:
...
char* func_171(int iParam0) // Position - 0x4A54 Hash - 0x21CE226B ^0x9EEE72EC
{
	switch (iParam0)
	{
		case 0:
...
void func_172(int iParam0) // Position - 0x4A8F Hash - 0x5D78382 ^0x8F13B3A8
{
	int num;
	int num2;
	int i;
...
void func_173(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4B5F Hash - 0x5C29635D ^0x5C29635D
{
	func_123(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_174(int iParam0, BOOL bParam1) // Position - 0x4B79 Hash - 0x10DE2364 ^0x10DE2364
{
	return func_163(func_159(), iParam0, bParam1);
}

float func_175(int iParam0, int iParam1) // Position - 0x4B8D Hash - 0x422268C7 ^0x22464E0E
{
	if (iParam1 == 2)
		iParam1 = func_157(1);
...
int func_176(float fParam0) // Position - 0x4BD9 Hash - 0x991CF40A ^0x6EC613A5
{
	float num;
...
float func_177(float fParam0, float fParam1, float fParam2) // Position - 0x4C04 Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_178(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4C2B Hash - 0x898C409B ^0x898C409B
{
	int num;
	int i;
	int num2;
...
int func_179(int iParam0, float fParam1, int iParam2) // Position - 0x4DB3 Hash - 0x91D240B ^0x31A81242
{
	if (!func_213(iParam0))
		return 0;
...
BOOL func_180(int iParam0, int iParam1) // Position - 0x4E04 Hash - 0x5A86BEFA ^0xB951E1EF
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_181(int iParam0) // Position - 0x4E1C Hash - 0x773BFB67 ^0x773BFB67
{
...
BOOL func_182(int iParam0) // Position - 0x4E33 Hash - 0x7F4C96B ^0x650690F6
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_183(int iParam0, int iParam1) // Position - 0x4EFF Hash - 0xECB143B0 ^0xE41A70C5
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_184(int iParam0) // Position - 0x4F18 Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_185() // Position - 0x4F2B Hash - 0xD9A24882 ^0xD9A24882
{
	if (!func_215())
		return false;
...
BOOL func_186(Hash hParam0, Any* panParam1) // Position - 0x4F46 Hash - 0xB914F903 ^0x1DD44828
{
	int num;
...
BOOL func_187(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x511C Hash - 0xC2FFDE1C ^0x97706777
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_188(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x5133 Hash - 0x85216370 ^0xE7D00C30
{
	if (bParam0)
	{
...
int func_189(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x517C Hash - 0xE2AB25BA ^0xE2AB25BA
{
	if (bParam0)
	{
		func_217(iParam1, 1, 0, 0);
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_190(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x5198 Hash - 0x8E6DB586 ^0xC3CF8308
{
	int i;
...
int func_191(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x52AF Hash - 0x118F0611 ^0x5AC648CA
{
...
int func_192(Ped pedParam0, Hash hParam1) // Position - 0x52E2 Hash - 0x83F00AF7 ^0x32031FF8
{
	int num;
	int i;
...
int func_193(Hash hParam0, BOOL bParam1) // Position - 0x5340 Hash - 0x19ACB934 ^0xDEF82372
{
	if (!bParam1 || func_222())
...
BOOL func_194(int iParam0) // Position - 0x536F Hash - 0x745CE6FE ^0x745CE6FE
{
	return func_223(&(Global_1956875.f_1565), iParam0, 1);
}

int func_195(BOOL bParam0) // Position - 0x5385 Hash - 0x770A7C8B ^0x770A7C8B
{
	if (bParam0)
		return 1;
...
float func_196(Player plParam0) // Position - 0x5397 Hash - 0x67CAB99C ^0xC9B69B05
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_224(2);
}

int func_197(int iParam0) // Position - 0x53AD Hash - 0xB4F18402 ^0x7A49D6D2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_198(int iParam0) // Position - 0x53D2 Hash - 0xB778A86 ^0x59904CDE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_199(int iParam0) // Position - 0x53E5 Hash - 0x78117956 ^0xDE0FB172
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_200(int iParam0) // Position - 0x53F8 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_201(int iParam0) // Position - 0x540B Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_202(int iParam0) // Position - 0x541D Hash - 0xD4A2C8FF ^0x5655DDE9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_203(int iParam0, int iParam1) // Position - 0x542F Hash - 0x893AC59E ^0x893AC59E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x54C9 Hash - 0xA65AB937 ^0xA65AB937
{
...
BOOL func_205(int iParam0) // Position - 0x5501 Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
...
int func_206(int iParam0) // Position - 0x55DD Hash - 0x26AB94C2 ^0x26AB94C2
{
	switch (iParam0)
	{
		case 0:
...
char* func_207(int iParam0) // Position - 0x560C Hash - 0x21CE226B ^0x8695626D
{
	switch (iParam0)
	{
		case 0:
...
char* func_208(int iParam0) // Position - 0x5647 Hash - 0x21CE226B ^0x38119A51
{
	switch (iParam0)
	{
		case 0:
...
void func_209(int iParam0, float fParam1, int iParam2) // Position - 0x5682 Hash - 0xB327C991 ^0xFEB529B
{
	if (iParam2 == 2)
		iParam2 = func_157(2);
...
void func_210(int iParam0, int iParam1, int iParam2) // Position - 0x56D4 Hash - 0x7E1E307C ^0x5642EBD7
{
	if (iParam2 == 2)
		iParam2 = func_157(2);
...
int func_211(int iParam0, int iParam1) // Position - 0x572A Hash - 0x26934C66 ^0x26934C66
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_212(int iParam0) // Position - 0x5F2B Hash - 0x85160494 ^0x6688B38
{
	int num;
	int num2;
	int num3;
...
BOOL func_213(int iParam0) // Position - 0x61BB Hash - 0x969D658D ^0x969D658D
{
	if (func_170(iParam0))
		return true;
...
void func_214(int iParam0, float fParam1, int iParam2) // Position - 0x61E1 Hash - 0xF69206DE ^0x1EC60A3A
{
	if (fParam1 < 0f)
		return;
...
BOOL func_215() // Position - 0x623D Hash - 0x9AF3EE3F ^0xBF53F360
{
...
BOOL func_216(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x6251 Hash - 0xF94ED236 ^0xF94ED236
{
...
void func_217(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6269 Hash - 0x3169A239 ^0x47E831EC
{
	int i;
...
BOOL func_218(Any* panParam0) // Position - 0x6307 Hash - 0x7865E948 ^0x92258F24
{
...
BOOL func_219(Hash hParam0) // Position - 0x6323 Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_220(Hash hParam0) // Position - 0x6331 Hash - 0xDB8363F2 ^0xB30A7F5C
{
...
int func_221(int iParam0, Hash hParam1) // Position - 0x635C Hash - 0x9ED796B6 ^0xF436F83
{
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_222() // Position - 0x639A Hash - 0xC82BB3B3 ^0x6740E474
{
...
BOOL func_223(Any* panParam0, int iParam1, int iParam2) // Position - 0x63E9 Hash - 0x15F7E5EE ^0x39F4E7C
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_224(int iParam0) // Position - 0x6420 Hash - 0xF103C6A6 ^0xF103C6A6
{
	switch (iParam0)
	{
		case 0:
...
var func_225(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6461 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_226(var uParam0, int iParam1) // Position - 0x6478 Hash - 0xD05180BA ^0x39589262
{
	if (iParam1 < 0)
		return;
...
void func_227(var uParam0, int iParam1) // Position - 0x64FE Hash - 0x96B01D2A ^0x81E68218
{
...
void func_228(var uParam0, int iParam1) // Position - 0x653A Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_229(var uParam0, int iParam1) // Position - 0x658D Hash - 0xEAE0DB0 ^0x5D80487B
{
...
void func_230(var uParam0, int iParam1) // Position - 0x65C8 Hash - 0x7641A9E6 ^0xCBDBD6AE
{
...
void func_231(var uParam0, int iParam1) // Position - 0x6601 Hash - 0xE78E2A7B ^0x42E1E438
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_232(int iParam0) // Position - 0x6639 Hash - 0xFFB3C2F0 ^0xFFB3C2F0
{
	int num;
...
BOOL func_233(int iParam0) // Position - 0x6661 Hash - 0x2BE93DAE ^0x2BE93DAE
{
	int num;
...
int func_234(int iParam0, int iParam1) // Position - 0x6689 Hash - 0x89B5041A ^0x89B5041A
{
	switch (iParam0)
	{
...
int func_235(int iParam0, int iParam1) // Position - 0x6D40 Hash - 0x39669B5F ^0xB47C98D2
{
	Player player;
	Player player2;
	int num;
...
int func_236(int iParam0, int iParam1, int iParam2) // Position - 0x6DC3 Hash - 0xE22C7CA2 ^0xE22C7CA2
{
	int num;
	int num2;
...
void func_237(int iParam0) // Position - 0x6EBB Hash - 0xBACBE486 ^0xD8F73B9E
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_238(int iParam0, int iParam1) // Position - 0x6ED1 Hash - 0x9DD4188 ^0x9DD4188
{
	switch (iParam0)
	{
...
void func_239(int iParam0, int iParam1) // Position - 0x7782 Hash - 0x73AEC1AE ^0x984E1AE9
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 + iParam1;
	return;
}

void func_240(int iParam0, int iParam1) // Position - 0x77B1 Hash - 0x3B92C3EA ^0xE3D6CCE1
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	return;
}

void func_241(int iParam0) // Position - 0x77CD Hash - 0x430DB350 ^0x725C69ED
{
	int i;
...
BOOL func_242(int iParam0) // Position - 0x77FB Hash - 0x830CD3BA ^0x830CD3BA
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_243(int iParam0, int iParam1) // Position - 0x7820 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_244(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x782F Hash - 0xBC161045 ^0xD3B33F74
{
	int i;
...
BOOL func_245(Any* panParam0) // Position - 0x790B Hash - 0xCC4B0CF2 ^0xC0C1FD86
{
...
BOOL func_246(Hash hParam0, int iParam1) // Position - 0x7941 Hash - 0xC9BD5171 ^0xC9BD5171
{
	int num;
...
struct<4> func_247(int iParam0, Hash hParam1) // Position - 0x7960 Hash - 0x4379F5A3 ^0xD8DD7D07
{
	var unk;
...
BOOL func_248(Vehicle veParam0) // Position - 0x7982 Hash - 0xDEF9F967 ^0x717FC3F4
{
...
Player func_249(int iParam0) // Position - 0x79A1 Hash - 0xF3F3BDC0 ^0xF3F3BDC0
{
	if (func_263(iParam0))
...
BOOL func_250(int iParam0) // Position - 0x79C2 Hash - 0xE6FB7F28 ^0xE6FB7F28
{
	int num;
...
int func_251(int iParam0, int iParam1, int iParam2) // Position - 0x79EA Hash - 0xAE2CC17B ^0x2CD7F4CE
{
	int num;
	int num2;
	int num3;
...
BOOL func_252(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x7BDB Hash - 0x911ECD26 ^0x92039873
{
	return uParam0.f_4 != 0;
}

BOOL func_253(int iParam0, int iParam1) // Position - 0x7BE9 Hash - 0xBA8D4E8F ^0x2A068003
{
	int num;
...
Vector3 func_254(int iParam0) // Position - 0x7C29 Hash - 0x4827F1DB ^0x96104558
{
	int num;
	var unk;
...
BOOL func_255(int iParam0, var uParam1, var uParam2) // Position - 0x7C65 Hash - 0xB201D59F ^0xA3399F39
{
	if (!func_250(iParam0))
		return false;
...
BOOL func_256(int iParam0, int iParam1, int iParam2) // Position - 0x7C9C Hash - 0xAE2CC17B ^0x2CD7F4CE
{
	int num;
	int num2;
	int num3;
...
void func_257(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7ECA Hash - 0x562CA30C ^0x562CA30C
{
	int num;
...
void func_258(int iParam0) // Position - 0x7F49 Hash - 0x9AA5A92B ^0xCC01F112
{
	int num;
...
void func_259(int iParam0) // Position - 0x7F9E Hash - 0x84E910A9 ^0x5650392D
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
int func_260(Hash hParam0) // Position - 0x7FC1 Hash - 0x1E74E236 ^0xF004CA87
{
...
struct<5> func_261(int iParam0) // Position - 0x7FDB Hash - 0xE00E6CC3 ^0x967EFE74
{
	var unk;

	unk = { func_262(iParam0, joaat("character"), func_148(), joaat("SLOTID_NONE")) };
	unk.f_4 = joaat("SLOTID_SATCHEL");
	return unk;
}

struct<4> func_262(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x8009 Hash - 0x5F68FD81 ^0xF6C5E078
{
	var outGuid;
...
BOOL func_263(int iParam0) // Position - 0x8036 Hash - 0x56C0B35E ^0x56C0B35E
{
	int num;
...
int func_264(int iParam0) // Position - 0x805D Hash - 0x37C30FDA ^0x37C30FDA
{
	int num;
...
int func_265(int iParam0, int iParam1) // Position - 0x80F7 Hash - 0x40BB17AB ^0x40BB17AB
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_266(int iParam0) // Position - 0x8530 Hash - 0x2139C0B7 ^0x2139C0B7
{
	int num;
...
float func_267(int iParam0) // Position - 0x8558 Hash - 0xB1BB29D1 ^0xE7240837
{
	float num;
...
void func_268(int iParam0) // Position - 0x8588 Hash - 0x825D7B7E ^0x825D7B7E
{
	int num;
	int num2;
	int i;
...
BOOL func_269(int iParam0) // Position - 0x8767 Hash - 0xD61CC19E ^0xD61CC19E
{
	int num;
...
int func_270(int iParam0, int iParam1) // Position - 0x878F Hash - 0x49B3A5C3 ^0x49B3A5C3
{
	switch (iParam0)
	{
...
void func_271(int iParam0) // Position - 0x8A9F Hash - 0xFC2A3E07 ^0xFD4CE356
{
	Ped ped;
	Player player;
...
BOOL func_272(int iParam0) // Position - 0x8CAF Hash - 0x13096A7F ^0x13096A7F
{
	int num;
...
int func_273(int iParam0, int iParam1) // Position - 0x8CD6 Hash - 0xD3D45784 ^0xD3D45784
{
	switch (iParam0)
	{
...
int func_274(int iParam0) // Position - 0x8D33 Hash - 0x76D9051B ^0xE68FE534
{
	int num;
	var unk;
	var unk32;
...
BOOL func_275(int iParam0) // Position - 0x8E77 Hash - 0x7B05DC41 ^0x7B05DC41
{
...
void func_276(int iParam0) // Position - 0x8E95 Hash - 0x825D7B7E ^0x825D7B7E
{
	int num;
	int num2;
	int i;
...
BOOL func_277(int iParam0) // Position - 0x8FEA Hash - 0x69745F36 ^0x8F937BAE
{
	BOOL flag;
...
void func_278(int iParam0) // Position - 0x9014 Hash - 0xE1E3399D ^0xAAA920BB
{
	Ped ped;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_294(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(ped, func_301(iParam0, 0));
			func_302(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(ped, func_301(iParam0, 1));
			func_302(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(ped, func_301(iParam0, 2));
			func_302(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(ped, func_301(iParam0, 3));
			func_302(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_279(int iParam0) // Position - 0x92AF Hash - 0x4D7CA01F ^0xE11E9732
{
	char* audioName;
	char* audioRef;
	...
	audioName = func_304(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(audioName))
		return;

	audioRef = func_305(iParam0);
...
void func_280(var uParam0) // Position - 0x92F9 Hash - 0x58FD8C3D ^0x7E71AD66
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_281(int iParam0) // Position - 0x9355 Hash - 0xCDD61996 ^0xCDD61996
{
	int num;
...
BOOL func_282(int iParam0) // Position - 0x937D Hash - 0x5052208B ^0x5052208B
{
	int num;
...
BOOL func_283(int iParam0) // Position - 0x93A5 Hash - 0x7F6CD4C4 ^0x7F6CD4C4
{
	int num;
...
BOOL func_284(int iParam0) // Position - 0x93CD Hash - 0xD766BF57 ^0xD766BF57
{
	int num;
...
BOOL func_285(int iParam0) // Position - 0x93F5 Hash - 0x58B99E54 ^0x58B99E54
{
	int num;
...
BOOL func_286(int iParam0) // Position - 0x941D Hash - 0xA1A1461E ^0xA1A1461E
{
	int num;
...
float func_287(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x9445 Hash - 0xFE4D9153 ^0xACBF575D
{
	var unk;
	float num;
...
BOOL func_288(int iParam0) // Position - 0x947B Hash - 0xCFB57BFC ^0xD6F1E06
{
...
BOOL func_289(int iParam0) // Position - 0x94EA Hash - 0x3374FEFF ^0x3374FEFF
{
	int num;
...
int func_290(int iParam0, int iParam1) // Position - 0x9511 Hash - 0xAF8796DC ^0xAF8796DC
{
	switch (iParam0)
	{
...
void func_291() // Position - 0x956E Hash - 0x8482C9D6 ^0xF644936D
{
	BOOL value;
	BOOL value2;
...
void func_292() // Position - 0x95D0 Hash - 0x1EC790D6 ^0xC31DC9FE
{
	BOOL value;
...
char* func_293(int iParam0) // Position - 0x9600 Hash - 0xE5247562 ^0xF36E839D
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_294(int iParam0) // Position - 0x9648 Hash - 0x21FAF347 ^0xA1AE9E4F
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_295(int iParam0) // Position - 0x9683 Hash - 0x2CE3A2A0 ^0xF0457356
{
	int i;
...
void func_296() // Position - 0x96C3 Hash - 0xFDAE0587 ^0x5AB4C733
{
...
int func_297(int iParam0) // Position - 0x96E3 Hash - 0x7AD8D3DF ^0x2C577CC4
{
	int num;
...
BOOL func_298(int iParam0, int iParam1) // Position - 0x9712 Hash - 0xB2431B7B ^0xEC29640E
{
	int num;
	Player player;
	int num2;
...
struct<31> func_299(int iParam0) // Position - 0x99E7 Hash - 0xCDBF4D5E ^0x8519EC8B
{
	int num;
...
BOOL func_300(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x9A0B Hash - 0xFE4D9153 ^0x67064BE4
{
	var unk;
	BOOL flag;
...
char* func_301(int iParam0, int iParam1) // Position - 0x9A41 Hash - 0xD9A01784 ^0xD0A415BA
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_302(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x9A9A Hash - 0x4DFFD3F3 ^0xFBF31414
{
	int i;
...
void func_303() // Position - 0x9B1F Hash - 0x54572B7C ^0x904B9528
{
...
char* func_304(int iParam0) // Position - 0x9B44 Hash - 0xDEB3DA4B ^0xC9C27881
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_305(int iParam0) // Position - 0x9B65 Hash - 0xDEB3DA4B ^0x69514217
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_306(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x9B86 Hash - 0xBD123D0 ^0xD5CDFAB
{
	int num;
	int num2;
...
BOOL func_307() // Position - 0x9DA8 Hash - 0x4228A1C2 ^0x4A2C267D
{
	return Global_1572887.f_7;
}

BOOL func_308() // Position - 0x9DB6 Hash - 0x7C45C36E ^0x2F146C3F
{
	if (!Global_1048577)
		return false;
...
BOOL func_309(Player plParam0) // Position - 0x9E01 Hash - 0x2484E1E ^0x4707F690
{
...
BOOL func_310(int iParam0, Player plParam1) // Position - 0x9E46 Hash - 0xAF32F835 ^0x6534FA19
{
	if (plParam1 == 255)
...
int func_311(int iParam0) // Position - 0x9E72 Hash - 0xF3C27EA9 ^0xF3C27EA9
{
	int num;
...
struct<2> func_312(int iParam0) // Position - 0x9EA8 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_313(var uParam0, var uParam1) // Position - 0x9EBC Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_317(uParam0))
		return false;
...
BOOL func_314(int iParam0) // Position - 0x9EF0 Hash - 0x92B1FA90 ^0xB975289D
{
	return iParam0 == -1759663922 || iParam0 == -318976023 || iParam0 == 772881414 || iParam0 == 31269700 || iParam0 == -133550749;
}

BOOL func_315(Player plParam0) // Position - 0x9F38 Hash - 0x18353CAA ^0x646BAFB
{
...
void func_316(Player plParam0) // Position - 0x9F55 Hash - 0x40571888 ^0x70336487
{
	Player player;
...
BOOL func_317(int iParam0) // Position - 0x9FD8 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_318(int iParam0) // Position - 0xA017 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_319(Player plParam0) // Position - 0xA0AD Hash - 0x40571888 ^0x70336487
{
	Player player;
...
void func_320(Player plParam0) // Position - 0xA119 Hash - 0xB360DAF6 ^0xEDA5F101
{
