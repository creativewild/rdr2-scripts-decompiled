...
void func_16(int iParam0) // Position - 0x7F2 Hash - 0xDBBE56B6 ^0xDBBE56B6
{
	if (!func_53(true))
		bLocal_15 = true;
...
BOOL func_17(int iParam0) // Position - 0x806 Hash - 0xA8BEBF8F ^0xA8BEBF8F
{
	if (bLocal_15)
		return true;
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0x828 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x834 Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x849 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_54(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x85A Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x899 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8A5 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8AD Hash - 0xB323866B ^0xE9E411E6
{
	if (func_55(iParam0))
		return true;
...
void func_25() // Position - 0x95D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0x965 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0x96D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x975 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x97D Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x989 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x995 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0x99D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x9A5 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0x9B1 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0x9E2 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA28 Hash - 0x71931A41 ^0x38641BC4
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA3C Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_59(iParam0))
		return;
...
BOOL func_38(int iParam0) // Position - 0xA55 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xA66 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && iParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xA7E Hash - 0x12878ED6 ^0x12878ED6
{
	iParam0 = iParam0;
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xA8B Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBCA Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBD7 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xC0D Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_73();
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_74(iLocal_24, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_80(iLocal_24, false))
			return false;
	}
	else if (!func_81(iLocal_24))
	{
		return false;
	}
...
int func_45() // Position - 0xD21 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD2F Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD3B Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xD66 Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDA8 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xE88 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEA6 Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xEB9 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(BOOL bParam0) // Position - 0xED7 Hash - 0x727840BB ^0x9921C45E
{
	int num;
	var unk;
	var unk6;
	...
	unk = 4;
	unk6 = 4;
	unk6[0] = joaat("s_lootablemoneybox");
	unk6[1] = joaat("p_goldnugget01x");
	unk6[2] = joaat("s_inv_pocketwatch01x");
	unk6[3] = joaat("s_jewlerybox_sm_fancy01x");

	if (func_83(&unk, &unk6, 4, 1583.83f, 2193.08f, 324.18f, 5f) > 0)
	{
		for (i = 0; i < 4; i = i + 1)
		{
...
BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF91 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x1089 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_56(int iParam0) // Position - 0x109A Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_57(int iParam0) // Position - 0x10AE Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x10C2 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

BOOL func_59(int iParam0) // Position - 0x10CC Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_60() // Position - 0x10E2 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
BOOL func_61(int iParam0, int iParam1) // Position - 0x110F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_62(var uParam0, int iParam1) // Position - 0x111E Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_63() // Position - 0x112F Hash - 0x463DA432 ^0x857E19AF
{
	return func_61(Global_1940199, 8192);
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x1142 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_65(int iParam0) // Position - 0x1153 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_66(int iParam0, int iParam1) // Position - 0x1193 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_67() // Position - 0x11C0 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_68(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11CE Hash - 0x659AC4C5 ^0x8A3286AA
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	else if (func_59(iParam0) && func_82(iParam0, 16777216) && !Global_1893611.f_9)
	{
...
void func_69(var uParam0, int iParam1) // Position - 0x1432 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_70(int iParam0, BOOL bParam1) // Position - 0x1445 Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_71(BOOL bParam0) // Position - 0x1AAE Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_72(int iParam0) // Position - 0x1AD7 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_73() // Position - 0x1B1C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_74(int iParam0, BOOL bParam1) // Position - 0x1B24 Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_75(int iParam0, BOOL bParam1) // Position - 0x22E9 Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_76(BOOL bParam0) // Position - 0x233C Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x2365 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_78(int iParam0) // Position - 0x2371 Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_79(int iParam0) // Position - 0x23A2 Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_80(int iParam0, BOOL bParam1) // Position - 0x23D5 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_81(int iParam0) // Position - 0x248B Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x2505 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
int func_83(var uParam0, var uParam1, int iParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x2536 Hash - 0x76785467 ^0x34019397
{
	Volume volume;
	int num;

	volume = VOLUME::CREATE_VOLUME_SPHERE(fParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	num = func_120(uParam0, uParam1, volume, iParam2);
	func_121(volume);
	return num;
}

BOOL func_84(int iParam0) // Position - 0x2567 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_85(int iParam0) // Position - 0x2588 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x25DB Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x2C9B Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x2CB2 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x2CF5 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_87(iParam0))
		return 0;
...
BOOL func_90(int iParam0) // Position - 0x2DE0 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_91(int iParam0) // Position - 0x2DF6 Hash - 0x6A6EE485 ^0x6A6EE485
{
...
BOOL func_92() // Position - 0x2E2B Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
...
const char* func_93(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2E6E Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;
...
BOOL func_94(int iParam0) // Position - 0x38CD Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_95(int iParam0) // Position - 0x38E2 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0) // Position - 0x399D Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_97(int iParam0) // Position - 0x3A0B Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_98(int iParam0) // Position - 0x3B66 Hash - 0x21CE226B ^0x117FC044
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_99(int iParam0, BOOL bParam1) // Position - 0x3BA1 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x3BE3 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_94(iParam0))
		return false;
...
int func_101() // Position - 0x3C28 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_102(int iParam0) // Position - 0x3C34 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_103(int iParam0) // Position - 0x3C47 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_104(float fParam0) // Position - 0x3C59 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_105(var uParam0, int iParam1) // Position - 0x3C6F Hash - 0xB0CFF0C3 ^0x9F1AE808
{
...
int func_106(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3CA5 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_107(int iParam0) // Position - 0x3CE8 Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_133(iParam0))
		if (!func_134(44))
			return false;
...
void func_108(int iParam0, int iParam1) // Position - 0x3D08 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_109(int iParam0, int iParam1) // Position - 0x3D19 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_110(var uParam0, var uParam1, int iParam2) // Position - 0x3D2F Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_111(int iParam0) // Position - 0x3D4C Hash - 0x3E288458 ^0xC75F9664
{
...
void func_112(int iParam0) // Position - 0x3E2C Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;
...
BOOL func_113(int iParam0, BOOL bParam1) // Position - 0x4005 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_114(int iParam0, BOOL bParam1) // Position - 0x4033 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_87(iParam0))
		return 0;
...
int func_115(int iParam0) // Position - 0x40B6 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_116(int iParam0) // Position - 0x40DD Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_117() // Position - 0x40FE Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_118() // Position - 0x42C5 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_119(int iParam0, BOOL bParam1) // Position - 0x4340 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
...
int func_120(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x46EF Hash - 0xF4BE06E5 ^0x21E9A98D
{
	ItemSet itemSet;
...
void func_121(Volume volParam0) // Position - 0x47AA Hash - 0x7DD010A2 ^0x16530136
{
...
Hash func_122(int iParam0) // Position - 0x47C1 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_87(iParam0))
		return 0;
...
void func_123(int iParam0, PersChar pchParam1) // Position - 0x47DF Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_87(iParam0))
		return;
...
PersChar func_124(int iParam0) // Position - 0x4800 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_87(iParam0))
		return 0;
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x4820 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_126(int iParam0) // Position - 0x4859 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_127() // Position - 0x487F Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_128() // Position - 0x4888 Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_129(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x48F0 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4A66 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_131(var uParam0, var uParam1, var uParam2) // Position - 0x4A7A Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_132(int iParam0) // Position - 0x4AA8 Hash - 0xE6862179 ^0xFB4FB2C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_133(int iParam0) // Position - 0x4D8C Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_134(int iParam0) // Position - 0x4DB6 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_165(iParam0))
		return false;
...
struct<2> func_135(Player plParam0) // Position - 0x4DD2 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_136(const char* sParam0, int iParam1) // Position - 0x4DE6 Hash - 0x9E99F03 ^0xEF793D5A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_137(int iParam0, BOOL bParam1) // Position - 0x4E00 Hash - 0x2F9EB0B9 ^0x60E893CE
{
	char* ambientZone;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4E34 Hash - 0x342D57CF ^0x2222C2EF
{
	switch (iParam0)
	{
		case 5:
...
void func_139(int iParam0, int iParam1) // Position - 0x4E69 Hash - 0x823E3440 ^0x340E01B4
{
	func_167(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_140(int iParam0) // Position - 0x4E83 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_87(iParam0))
		return false;
...
void func_141(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4EA8 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x4F94 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_170(iParam0))
		return;
...
void func_143(int iParam0, int iParam1) // Position - 0x4FEA Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_175(iParam0))
		return;
...
int func_144(int iParam0) // Position - 0x505D Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_145(Hash hParam0) // Position - 0x5073 Hash - 0xDB9A74EC ^0x13B3F16D
{
...
void func_146(int iParam0) // Position - 0x5093 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_147(int iParam0, BOOL bParam1) // Position - 0x50A9 Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_148(int iParam0) // Position - 0x50DA Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_149(int iParam0) // Position - 0x511E Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_150(int iParam0) // Position - 0x5133 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_151(int iParam0) // Position - 0x5148 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_152(int iParam0) // Position - 0x515D Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_153(int iParam0) // Position - 0x51DC Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x5239 Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x5252 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_156(int iParam0, int iParam1) // Position - 0x526B Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_157(int iParam0) // Position - 0x52A6 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_158(int iParam0) // Position - 0x52BA Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x52C2 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;
...
BOOL func_160() // Position - 0x52E9 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
...
struct<2> func_161() // Position - 0x5341 Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_162(var uParam0, var uParam1) // Position - 0x534F Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_180(uParam0))
		return false;
...
struct<2> func_163() // Position - 0x5383 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_164(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x53CE Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;
...
BOOL func_165(int iParam0) // Position - 0x53FE Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_166(int iParam0) // Position - 0x5411 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_167(var uParam0, int iParam1) // Position - 0x543B Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_168(int iParam0) // Position - 0x5450 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_169(Hash hParam0) // Position - 0x5474 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_170(int iParam0) // Position - 0x5480 Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_171(int iParam0, BOOL bParam1) // Position - 0x5496 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_170(iParam0))
		return false;
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x54BC Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_170(iParam0))
		return;
...
void func_173(int iParam0, BOOL bParam1) // Position - 0x54EA Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_170(iParam0))
		return;
...
void func_174(int iParam0) // Position - 0x5524 Hash - 0xB29062D ^0xB29062D
{
	func_185(func_184(iParam0));
	return;
}

BOOL func_175(int iParam0) // Position - 0x5536 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_176(Hash hParam0) // Position - 0x554C Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_186(hParam0))
...
BOOL func_177() // Position - 0x5567 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

Ped func_178(int iParam0) // Position - 0x5570 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_179(int iParam0, int iParam1) // Position - 0x559E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_180(int iParam0) // Position - 0x55AD Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_181(int iParam0) // Position - 0x55EC Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_182(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5682 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x611F Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_184(int iParam0) // Position - 0x6185 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_185(int iParam0) // Position - 0x66A2 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_186(Hash hParam0) // Position - 0x66B3 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
