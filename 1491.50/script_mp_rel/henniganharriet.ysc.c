...
BOOL func_13() // Position - 0x7D0 Hash - 0x3D5BD9B6 ^0x364DF4AD
{
	...
	volLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2183.916f, -2135.043f, 75.907f, 0f, 0f, 130f, 14.456f, 10.148f, 8.8f, "HEN Harriet - m_volHarriet");
	volLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2185.6304f, -2132.3474f, 75.0567f, 0f, 0f, 30f, 3.7f, 3.7f, 4.2f, "HEN Harriet - m_volHarrietPrompt");
	volLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2182.134f, -2134.707f, 73.87f, 0f, 0f, 130f, 3.364f, 3.818f, 2f, "HEN Harriet - m_volHarrietOffLimits");
	args = volLocal_21;
	args.f_2 = -1;
	AICOVERPOINT::_0x733077295AB51304(&args);
	volLocal_22 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("volBox"), -2183.285f, -2133.454f, 73.87f, 0f, 0f, 130f, 1f, 1f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(volLocal_22, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(volLocal_22, true);
	volLocal_23 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("volBox"), -2184.635f, -2132.268f, 73.87f, 0f, 0f, 130f, 3.2f, 7.3f, 2f);
...
BOOL func_38(int iParam0) // Position - 0xB6E Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xB7F Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
...
void func_145(var uParam0) // Position - 0x576D Hash - 0xFBC3ACC8 ^0xFBC3ACC8
{
	var unk;
...
BOOL func_185(var uParam0, int iParam1, int iParam2) // Position - 0x6362 Hash - 0x8AC008A3 ^0x375BADC3
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_192(var uParam0, int iParam1, int iParam2) // Position - 0x6458 Hash - 0xA8F08582 ^0x9810C45C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_198() // Position - 0x6ECD Hash - 0x9D650775 ^0xA87234F9
{
	...
	if (!func_200(Global_1051268) && Global_1572887.f_8 & 1 != 0)
		return true;
...
void func_205(var uParam0, int iParam1) // Position - 0x701F Hash - 0x9815F445 ^0x9815F445
{
...
BOOL func_214(var uParam0, int iParam1, int iParam2) // Position - 0x714C Hash - 0x15F7E5EE ^0x39F4E7C
{
