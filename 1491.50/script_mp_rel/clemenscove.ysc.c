#region Local Var
	...
	var uLocal_64 = 0;
	var uLocal_65 = 570;
	var uLocal_66 = 1065353216;
	var uLocal_67 = -1082130432;
	var uLocal_68 = 0;
	var uLocal_69 = 0;
	var uLocal_70 = 0;
	var uLocal_71 = 0;
...
void main() // Position - 0x0 Hash - 0x5B140B50 ^0xD1F02007
{
	...
	fLocal_84 = 1f;
	iLocal_88 = 20000;
	iLocal_91 = iScriptParam_0;
	iLocal_89 = iScriptParam_0.f_2;
	bLocal_93 = false;
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_90)
		{
			iLocal_90 = 0;
			func_5(iLocal_91, &iLocal_89);
			...
			switch (iLocal_89)
			{
				case 0:
					if (Global_1901671.f_2.f_26 > 0)
					{
						iLocal_92 = MISC::GET_GAME_TIMER() + Global_1901671.f_2.f_26;
						iLocal_89 = 1;
					}
					else
					{
				...
				case 1:
					if (!func_1() || iLocal_92 < MISC::GET_GAME_TIMER())
					{
						bLocal_93 = false;
						iLocal_89 = 2;
					}
				...
				case 2:
					...
					if (func_10(func_9(iLocal_91)))
						func_11(func_9(iLocal_91), 4);
				
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_91));
					Global_1896644 = -1;
					iLocal_92 = iLocal_88 + MISC::GET_GAME_TIMER();
					iLocal_89 = 3;
					break;
			
				case 3:
					if (func_13() || iLocal_92 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT(iLocal_91);
						iLocal_92 = MISC::GET_GAME_TIMER() + iLocal_88;
						iLocal_89 = 4;
					}
					break;
			
				case 4:
					if (func_15(iLocal_91) || iLocal_92 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_91);
						iLocal_92 = MISC::GET_GAME_TIMER() + iLocal_88;
						iLocal_89 = 5;
				...
				case 5:
					if (func_17(iLocal_91) || iLocal_92 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0(iLocal_91);
						iLocal_92 = iLocal_88 + MISC::GET_GAME_TIMER();
						iLocal_89 = 7;
					}
					break;
				...
				case 7:
					if (func_10(func_9(iLocal_91)))
						if (func_19(func_9(iLocal_91), 4) && !(iLocal_92 < MISC::GET_GAME_TIMER()))
							break;
				
					if (func_20(iLocal_91) || iLocal_92 < MISC::GET_GAME_TIMER())
					{
						func_21(iLocal_91, 4);
						iLocal_92 = MISC::GET_GAME_TIMER() + iLocal_88;
						iLocal_89 = 8;
				...
				case 8:
					...
					func_27();
					func_28();
					_DEBUG_PRINT_0_0_0(iLocal_91);
					_DEBUG_PRINT_0_0_0_0(iLocal_91);
					func_31();
					func_32();
					iLocal_89 = 9;
					break;
				...
				case 9:
					_DEBUG_PRINT_0_0_0_0_0(iLocal_91);
					func_34();
					iLocal_89 = 10;
					break;
				...
				case 10:
					...
					func_36(iLocal_91, &Global_1896698);
					iLocal_89 = 11;
					break;
				...
				case 12:
					if (func_40(iLocal_91))
						iLocal_90 = MISC::GET_GAME_TIMER() + 1000;
				
					func_41(&Global_1896698, iLocal_91);
					func_42(iLocal_91);
					func_21(iLocal_91, 8);
					...
					PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_91 /*36*/].f_11);
				
					if (Global_1887363[iLocal_91 /*36*/].f_12 > 0f)
						PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_91 /*36*/].f_12);
					break;
		...
		if (Global_1887363[iLocal_91 /*36*/].f_13 == 0)
		{
		}
		else
		{
			PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1887363[iLocal_91 /*36*/].f_13);
		}
...
BOOL func_13() // Position - 0x7D0 Hash - 0x2BA080DF ^0x62D88A5F
{
	if (!VOLUME::DOES_VOLUME_EXIST(volLocal_14))
	{
		volLocal_14 = VOLUME::CREATE_VOLUME_BOX(737.34985f, -1127.4335f, 46.633076f, 0f, 0f, 26.054787f, 73.07784f, 115.7075f, 16.725319f);
		func_53(volLocal_14);
	}

	if (!VOLUME::DOES_VOLUME_EXIST(uLocal_16.f_64))
		uLocal_16.f_64 = VOLUME::CREATE_VOLUME_CYLINDER(718.817f, -827.245f, 50.334f, 0f, 0f, 0f, 12f, 12f, 3f);

	if (!VOLUME::DOES_VOLUME_EXIST(volLocal_15) && func_54(0))
	{
		volLocal_15 = VOLUME::CREATE_VOLUME_BOX(711.732f, -828.585f, 50.703f, 0f, 0f, 0f, 4.161f, 2.683f, 3.852f);
	
		if (VOLUME::DOES_VOLUME_EXIST(volLocal_15))
			PATHFIND::_ADD_NAVMESH_BLOCKING_VOLUME(volLocal_15, 7);
	}

	if (!VOLUME::DOES_VOLUME_EXIST(uLocal_16.f_65))
		uLocal_16.f_65 = VOLUME::CREATE_VOLUME_CYLINDER(721.465f, -827.139f, 50.334f, 0f, 0f, 0f, 3f, 3f, 3f);

	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x8BA Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x8C6 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x8D3 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_17(int iParam0) // Position - 0x8DB Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x8E4 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x8F0 Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x905 Hash - 0x1EA23D2B ^0x1EA23D2B
{
	if (func_54(0))
...
void func_21(int iParam0, BOOL bParam1) // Position - 0x922 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x961 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x96D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x975 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_56(iParam0))
		return true;
...
void func_25() // Position - 0xA25 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0xA2D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0xA35 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0xA3D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xA45 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xA51 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0xA5D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xA65 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xA6D Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA79 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xAAA Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xAF0 Hash - 0x71931A41 ^0x38641BC4
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xB04 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_60(iParam0))
		return;
...
BOOL func_38(int iParam0) // Position - 0xB1D Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xB2E Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && iParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB46 Hash - 0x4A181B5A ^0x4A181B5A
{
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xB4F Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC8E Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC9B Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xCD1 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_74();
		LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), 0);
		func_21(iLocal_91, 2048);
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_91)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_91, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_81(iLocal_91, false))
			return false;
	}
	else if (!func_82(iLocal_91))
	{
		return false;
	}
...
int func_45() // Position - 0xDE5 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDF3 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDFF Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xE2A Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE6C Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF4C Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF6A Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF7D Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53(Volume volParam0) // Position - 0xF9B Hash - 0x14EA5472 ^0xD9C3A23E
{
...
BOOL func_54(int iParam0) // Position - 0xFDC Hash - 0x4A181B5A ^0x4A181B5A
{
	return false;
}

BOOL func_55(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xFE5 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_56(int iParam0) // Position - 0x10DD Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_57(int iParam0) // Position - 0x10EE Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_58(int iParam0) // Position - 0x1102 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_59(var uParam0, var uParam1) // Position - 0x1116 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

BOOL func_60(int iParam0) // Position - 0x1120 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_61() // Position - 0x1136 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
BOOL func_62(int iParam0, int iParam1) // Position - 0x1163 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x1172 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_64() // Position - 0x1183 Hash - 0x463DA432 ^0x857E19AF
{
	return func_62(Global_1940199, 8192);
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x1196 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_66(int iParam0) // Position - 0x11A7 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_60(iParam0))
		return false;

	return Global_1887363[iParam0 /*36*/].f_21 == 1 || Global_1887363[iParam0 /*36*/].f_21 == 2 && !func_91(iParam0);
}

BOOL func_67(int iParam0, int iParam1) // Position - 0x11E7 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_68() // Position - 0x1214 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1222 Hash - 0x659AC4C5 ^0x8A3286AA
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	if (!func_94(iParam4))
		if (func_60(iParam0))
			iParam4 = func_95(func_9(iParam0));
		else
	...
	else if (func_99(iParam1, 2) || func_100(iParam4, 2) && !Global_1893611.f_9)
	{
	...
	{
		num2 = func_102(func_101());
		num3 = func_103(func_101());
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str2 = MISC::VAR_STRING(674, str3, num2, func_105(&unk, joaat("COLOR_PURE_WHITE")), str4, func_105(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num2, func_105(&unk, joaat("COLOR_PURE_WHITE")), func_105(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_106(str, str2, 4000, 0, 0, 0, false, true);
	return;
}

void func_70(var uParam0, int iParam1) // Position - 0x1486 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_71(int iParam0, BOOL bParam1) // Position - 0x1499 Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_72(BOOL bParam0) // Position - 0x1B02 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_73(int iParam0) // Position - 0x1B2B Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_74() // Position - 0x1B70 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_75(int iParam0, BOOL bParam1) // Position - 0x1B78 Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_76(int iParam0, BOOL bParam1) // Position - 0x233D Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_77(BOOL bParam0) // Position - 0x2390 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_78(int iParam0) // Position - 0x23B9 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_79(int iParam0) // Position - 0x23C1 Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_80(int iParam0) // Position - 0x23F2 Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x2425 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
	...
	if (func_86(iParam0, &num, &num2, false, false))
	{
		...
		while (true)
		{
			if (!func_113(Global_1896644.f_1, 16))
				func_114(Global_1896644.f_1, false);
...
BOOL func_82(int iParam0) // Position - 0x24DB Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;

	for (i = 0; i < 40; i = i + 1)
	{
		if (func_115(i) || func_116(i))
		{
		}
		else
		{
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2555 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_84(int iParam0) // Position - 0x2586 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_85(int iParam0) // Position - 0x25A7 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x25FA Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x2CBA Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x2CD1 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x2D14 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_87(iParam0))
		return 0;
	...
	if (func_113(iParam0, 32) && !bParam1)
	{
...
BOOL func_90(int iParam0) // Position - 0x2DFF Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_91(int iParam0) // Position - 0x2E15 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_125())
		return true;
...
BOOL func_92() // Position - 0x2E4A Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
...
const char* func_93(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2E8D Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_128(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_130(func_129(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_131(iParam0) || func_132(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_94(int iParam0) // Position - 0x38EC Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_95(int iParam0) // Position - 0x3901 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0) // Position - 0x39BC Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
	...
	i = 0;
	gamerHandle = { func_133(PLAYER::PLAYER_ID()) };
...
int func_97(int iParam0) // Position - 0x3A2A Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_98(int iParam0) // Position - 0x3B85 Hash - 0x21CE226B ^0x117FC044
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_99(int iParam0, int iParam1) // Position - 0x3BC0 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x3C02 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_94(iParam0))
		return false;
...
int func_101() // Position - 0x3C47 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_102(int iParam0) // Position - 0x3C53 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_103(int iParam0) // Position - 0x3C66 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_104(float fParam0) // Position - 0x3C78 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_105(var uParam0, int iParam1) // Position - 0x3C8E Hash - 0xB0CFF0C3 ^0x9F1AE808
{
...
int func_106(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3CC4 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_107(int iParam0) // Position - 0x3D07 Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_131(iParam0))
		if (!func_132(44))
			return false;
...
void func_108(int iParam0, int iParam1) // Position - 0x3D27 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_109(int iParam0, int iParam1) // Position - 0x3D38 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_110(var uParam0, var uParam1, int iParam2) // Position - 0x3D4E Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_111(int iParam0) // Position - 0x3D6B Hash - 0x3E288458 ^0xC75F9664
{
	func_135(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_136(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
...
void func_112(int iParam0) // Position - 0x3E4B Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_87(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_138(Global_1915656.f_3[iParam0 /*447*/].f_21))
		func_139(Global_1915656.f_3[iParam0 /*447*/].f_21, false, true, false, false);
	...
	func_140(Global_1915656.f_3[iParam0 /*447*/].f_9, false);
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_143(Global_1915656.f_3[iParam0 /*447*/].f_318[i /*6*/]);
...
BOOL func_113(int iParam0, BOOL bParam1) // Position - 0x4025 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_114(int iParam0, BOOL bParam1) // Position - 0x4053 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_87(iParam0))
		return 0;
	...
	if (func_113(iParam0, true) && !bParam1)
	{
...
int func_115(int iParam0) // Position - 0x40D6 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_116(int iParam0) // Position - 0x40FD Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_117() // Position - 0x411E Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_118() // Position - 0x42E5 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_119(int iParam0, BOOL bParam1) // Position - 0x4360 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	flag = func_151(iParam0) && !bParam1;

	if (!flag && !func_152(iParam0, 65536))
	{
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_143(Global_1051832.f_92[iParam0 /*75*/].f_31[i]);
...
Hash func_120(int iParam0) // Position - 0x470F Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_87(iParam0))
		return 0;
...
void func_121(int iParam0, PersChar pchParam1) // Position - 0x472D Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_87(iParam0))
		return;
...
PersChar func_122(int iParam0) // Position - 0x474E Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_87(iParam0))
		return 0;
...
void func_123(int iParam0, BOOL bParam1) // Position - 0x476E Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_124(int iParam0) // Position - 0x47A7 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_125() // Position - 0x47CD Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_126() // Position - 0x47D6 Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_127(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x483E Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_160(func_58(0)))
		return true;
...
const char* func_128(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x49B4 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_129(var uParam0, var uParam1, var uParam2) // Position - 0x49C8 Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_130(int iParam0) // Position - 0x49F6 Hash - 0xE6862179 ^0xFB4FB2C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_131(int iParam0) // Position - 0x4CDA Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_132(int iParam0) // Position - 0x4D04 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_163(iParam0))
		return false;
...
struct<2> func_133(Player plParam0) // Position - 0x4D20 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_134(const char* sParam0, int iParam1) // Position - 0x4D34 Hash - 0x9E99F03 ^0xEF793D5A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_135(int iParam0, BOOL bParam1) // Position - 0x4D4E Hash - 0x2F9EB0B9 ^0x60E893CE
{
	char* ambientZone;
...
void func_136(int iParam0, BOOL bParam1) // Position - 0x4D82 Hash - 0x342D57CF ^0x2222C2EF
{
	switch (iParam0)
	{
		case 5:
...
void func_137(int iParam0, int iParam1) // Position - 0x4DB7 Hash - 0x823E3440 ^0x340E01B4
{
	func_165(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_138(int iParam0) // Position - 0x4DD1 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_87(iParam0))
		return false;
...
void func_139(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4DF6 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_138(iParam0) && func_166(iParam0))
		return;

	func_123(iParam0, 1);
	func_146(iParam0);

	if (func_167(func_120(iParam0)))
	{
	...
	if (func_113(iParam0, 128) && !bParam3)
		func_114(iParam0, false);

	return;
}

void func_140(int iParam0, BOOL bParam1) // Position - 0x4EE2 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_168(iParam0))
		return;
...
void func_141(int iParam0, int iParam1) // Position - 0x4F38 Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_173(iParam0))
		return;
...
int func_142(int iParam0) // Position - 0x4FAB Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_143(Hash hParam0) // Position - 0x4FC1 Hash - 0xDB9A74EC ^0x13B3F16D
{
...
void func_144(int iParam0) // Position - 0x4FE1 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_145(int iParam0, BOOL bParam1) // Position - 0x4FF7 Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_146(int iParam0) // Position - 0x5028 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_147(int iParam0) // Position - 0x506C Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_148(int iParam0) // Position - 0x5081 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_149(int iParam0) // Position - 0x5096 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_150(int iParam0) // Position - 0x50AB Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_151(int iParam0) // Position - 0x512A Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_152(int iParam0, int iParam1) // Position - 0x5187 Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_153(int iParam0, int iParam1) // Position - 0x51A0 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_154(int iParam0, int iParam1) // Position - 0x51B9 Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_155(int iParam0) // Position - 0x51F4 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_156(int iParam0) // Position - 0x5208 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_157(int iParam0, int iParam1) // Position - 0x5210 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;

	return func_177(Global_1051832.f_92[iParam0 /*75*/].f_50, iParam1);
}

BOOL func_158() // Position - 0x5237 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_160(Global_1051268) && Global_1572887.f_8 & 1 != 0)
		return true;

	return false;
}

struct<2> func_159() // Position - 0x528F Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_160(var uParam0, var uParam1) // Position - 0x529D Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_178(uParam0))
		return false;
	...
	if (uParam0.f_1 >= func_179(uParam0))
		return false;

	return true;
}

struct<2> func_161() // Position - 0x52D1 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_162(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x531C Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;
...
BOOL func_163(int iParam0) // Position - 0x534C Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_164(int iParam0) // Position - 0x535F Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_165(var uParam0, int iParam1) // Position - 0x5389 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_166(int iParam0) // Position - 0x539E Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_167(Hash hParam0) // Position - 0x53C2 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_168(int iParam0) // Position - 0x53CE Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_169(int iParam0, BOOL bParam1) // Position - 0x53E4 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_168(iParam0))
		return false;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x540A Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_168(iParam0))
		return;
...
void func_171(int iParam0, BOOL bParam1) // Position - 0x5438 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_168(iParam0))
		return;
...
void func_172(int iParam0) // Position - 0x5472 Hash - 0xB29062D ^0xB29062D
{
	func_183(func_182(iParam0));
	return;
}

BOOL func_173(int iParam0) // Position - 0x5484 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_174(Hash hParam0) // Position - 0x549A Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_184(hParam0))
...
BOOL func_175() // Position - 0x54B5 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

Ped func_176(int iParam0) // Position - 0x54BE Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_177(int iParam0, int iParam1) // Position - 0x54EC Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_178(int iParam0) // Position - 0x54FB Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_179(int iParam0) // Position - 0x553A Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_180(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x55D0 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_181(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x606D Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_182(int iParam0) // Position - 0x60D3 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_183(int iParam0) // Position - 0x65F0 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_184(Hash hParam0) // Position - 0x6601 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
