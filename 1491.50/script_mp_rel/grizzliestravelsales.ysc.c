...
{
	volLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1387.506f, 1317.969f, 163.969f, 0f, 0f, 170f, 14.456f, 10.148f, 8.8f, "GRZ TravellingSalesman - m_volTravellingSalesman");
	volLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1390.109f, 1317.562f, 163.969f, 0f, 0f, 170f, 3.7f, 3.7f, 4.2f, "GRZ TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
...
BOOL func_115(int iParam0, BOOL bParam1) // Position - 0x4ECA Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
int func_201() // Position - 0x702A Hash - 0x4F5358E7 ^0x4EB0CC4F
{
