...
{
	volLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1572.349f, -1708.204f, 54f, 0f, 0f, 160f, 14.456f, 10.148f, 8.8f, "SCM TravellingSalesman - m_volTravellingSalesman");
	volLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1570.219f, -1707.457f, 54f, 0f, 0f, 160f, 3.7f, 3.7f, 4.2f, "SCM TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
...
BOOL func_38(BOOL bParam0) // Position - 0xA9A Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAAB Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
...
void func_147(float* pfParam0) // Position - 0x5841 Hash - 0xFBC3ACC8 ^0xFBC3ACC8
{
	var unk;
...
BOOL func_188(int* piParam0, int iParam1, int iParam2) // Position - 0x64BF Hash - 0x8AC008A3 ^0x375BADC3
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_195(int* piParam0, int iParam1, int iParam2) // Position - 0x65B5 Hash - 0xA8F08582 ^0x9810C45C
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_209(int iParam0, int iParam1) // Position - 0x7191 Hash - 0x9815F445 ^0x9815F445
{
...
BOOL func_219(int* piParam0, int iParam1, int iParam2) // Position - 0x72D4 Hash - 0x15F7E5EE ^0x39F4E7C
{
