...
BOOL func_13() // Position - 0x7D0 Hash - 0x4D5AE514 ^0xAF91A39A
{
	volLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1134.233f, 447.732f, 77.166f, 0f, 0f, 0f, 75f, 75f, 75f, "Guthrie Farm - m_volTown");

	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		volLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherThreat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 1119.1025f, 491.62497f, 94.789f, 0f, 0f, 40.292812f, 4.983408f, 12.470925f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 1116.4022f, 489.3356f, 94.789f, 0f, 0f, 40.292812f, 11.856084f, 5.358582f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 1178.0833f, 428.8635f, 93.85277f, 0f, 0f, 53.304512f, 6.700057f, 7.386477f, 11.968384f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 1122.7262f, 433.03238f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 1117.072f, 440.52597f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_18, 1111.1824f, 447.2959f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		volLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherRestricted Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_17, volLocal_18);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 1158.5192f, 410.67694f, 92.74591f, 0f, 0f, -42.87345f, 53.389023f, 36.784046f, 32.92925f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 1183.084f, 409.24536f, 94.789f, 0f, 0f, 62.77261f, 47.984554f, 17.143759f, 15.405313f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 1155.9137f, 449.3743f, 96.186104f, 0f, 0f, 47.14103f, 50.95671f, 69.55695f, 12.928934f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 1195.0931f, 434.53296f, 81.04297f, 0f, 0f, 0f, 7.797928f, 12.21736f, 21.629528f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 1170.3923f, 385.8856f, 94.80865f, 0f, 0f, 21.339607f, 15.421211f, 9.785769f, 12.928934f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 1125.095f, 489.77924f, 81.04297f, 0f, 0f, 0f, 22.933926f, 22.402626f, 21.629528f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_17, 1116.0164f, 455.35455f, 94.789f, 0f, 0f, 39.843098f, 36.45f, 74.7347f, 15.405313f);
		volLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherWarning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_19, volLocal_17);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 1125.095f, 466.7386f, 81.04297f, 0f, 0f, 31.951836f, 48.083958f, 52.233044f, 21.629528f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 1151.546f, 440.5756f, 81.04297f, 0f, 0f, -44.244987f, 55.60196f, 50.994522f, 21.629528f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, 1158.0931f, 392.03943f, 81.04297f, 0f, 0f, -24.173864f, 18.534718f, 13.095561f, 21.629528f);
		volLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherRegistration Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_16, volLocal_19);
		...
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_15, 1117.1301f, 490.0274f, 97.598f);
...
void _DEBUG_PRINT(int iParam0) // Position - 0xB36 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xB42 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xB4F Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0xB5B Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xB68 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xB74 Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xB89 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xB9A Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xBD9 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xBE5 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xBED Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xC9D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0xCA5 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0xCAD Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0xCB5 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xCBD Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_30(int iParam0) // Position - 0xCC9 Hash - 0xCC8EEAB3 ^0x486AD537
{
	if (func_45() != -1)
		return;

	func_58(739, volLocal_17, true);
	func_58(740, volLocal_17, false);
	func_58(742, volLocal_17, false);
	VOLUME::_0x4A8FEFC43FD8AC9B(volLocal_17, 3, 1);
	VOLUME::_0x53D05D60E5F5B40C(volLocal_17, 3, 1, func_59(740));
	VOLUME::_0x53D05D60E5F5B40C(volLocal_17, 3, 1, func_59(742));
	PED::SET_PED_OWNS_ANIMAL(func_60(739), func_60(742), false);
	return;
}

void func_31() // Position - 0xD36 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xD3E Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xD46 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xD52 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xD83 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xDC9 Hash - 0x41BC629D ^0x41BC629D
{
	iParam0 = iParam0;
	func_61(uParam1, volLocal_14, 1);
	return;
}

void func_37(int iParam0) // Position - 0xDDE Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_62(iParam0))
		return;
...
BOOL func_38(int iParam0) // Position - 0xDF7 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xE08 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && iParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xE20 Hash - 0xFC78EB8C ^0xFC78EB8C
{
	if (func_45() == -1)
		func_64();
...
void func_41(var uParam0, int iParam1) // Position - 0xE35 Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xF74 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xF81 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xFB7 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_77();
...
int func_45() // Position - 0x10CB Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x10D9 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x10E5 Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0x1110 Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x1152 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1232 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1250 Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1263 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1281 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1379 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x138A Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x139E Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x13B2 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

int func_58(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x13BC Hash - 0xEDF440C1 ^0x32727141
{
	PersChar persChar;
...
PersChar func_59(int iParam0) // Position - 0x140A Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_90(iParam0))
		return 0;
...
Ped func_60(int iParam0) // Position - 0x142A Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
void func_61(var uParam0, Volume volParam1, int iParam2) // Position - 0x1458 Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_62(int iParam0) // Position - 0x14B1 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_63() // Position - 0x14C7 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_64() // Position - 0x14F4 Hash - 0x7979BB71 ^0x98069E24
{
	PersChar persChar;
	PersChar persChar2;

	persChar = PERSCHAR::_0x112DDF56300BC6E5(joaat("cro_rancher"));
	persChar2 = PERSCHAR::_0x112DDF56300BC6E5(joaat("cro_ranch_hand"));
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x1590 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x159F Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_67() // Position - 0x15B0 Hash - 0x463DA432 ^0x857E19AF
{
	return func_65(Global_1940199, 8192);
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x15C3 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_69(int iParam0) // Position - 0x15D4 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_70(int iParam0, int iParam1) // Position - 0x1614 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_71() // Position - 0x1641 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_72(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x164F Hash - 0xB75E10F ^0xB5C32352
{
	BOOL flag;
	const char* str;
	char* str2;
...
void func_73(var uParam0, int iParam1) // Position - 0x18BD Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_74(int iParam0, BOOL bParam1) // Position - 0x18D0 Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_75(BOOL bParam0) // Position - 0x1F39 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_76(int iParam0) // Position - 0x1F62 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_77() // Position - 0x1FA7 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_78(int iParam0, BOOL bParam1) // Position - 0x1FAF Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_79(int iParam0, BOOL bParam1) // Position - 0x2774 Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_80(BOOL bParam0) // Position - 0x27C7 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_81(int iParam0) // Position - 0x27F0 Hash - 0x5C5F9EAF ^0xADB27AA5
{
	func_116(volLocal_16);
	func_116(volLocal_19);
...
void func_82(int iParam0) // Position - 0x282B Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_83(int iParam0) // Position - 0x285C Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_84(int iParam0, BOOL bParam1) // Position - 0x288F Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_85(int iParam0) // Position - 0x2945 Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;
...
BOOL func_86(int iParam0, BOOL bParam1) // Position - 0x29BF Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_87(int iParam0) // Position - 0x29F0 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_88(int iParam0) // Position - 0x2A11 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_89(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2A64 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_90(int iParam0) // Position - 0x3124 Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_91(int iParam0) // Position - 0x313B Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_92(int iParam0, BOOL bParam1) // Position - 0x317E Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_90(iParam0))
		return 0;
...
BOOL func_93(int iParam0, BOOL bParam1) // Position - 0x3269 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_45() != -1)
		return false;
...
BOOL func_94(int iParam0) // Position - 0x32C1 Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_95(int iParam0) // Position - 0x32D7 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_96(int iParam0) // Position - 0x32ED Hash - 0x6A6EE485 ^0x6A6EE485
{
...
BOOL func_97() // Position - 0x3322 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
...
const char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x3365 Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;
...
BOOL func_99(int iParam0) // Position - 0x3DCB Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_100(int iParam0) // Position - 0x3DE0 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_101(int iParam0) // Position - 0x3E9B Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_102(int iParam0) // Position - 0x3F09 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_103(int iParam0) // Position - 0x4064 Hash - 0x21CE226B ^0x5FA20CA6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x409F Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x40E1 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_99(iParam0))
		return false;
...
int func_106() // Position - 0x4126 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_107(int iParam0) // Position - 0x4132 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_108(int iParam0) // Position - 0x4145 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_109(float fParam0) // Position - 0x4157 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_110(var uParam0, int iParam1) // Position - 0x416D Hash - 0xB0CFF0C3 ^0x362254DF
{
...
int func_111(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x41A3 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_112(int iParam0) // Position - 0x41E6 Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_136(iParam0))
		if (!func_137(44))
			return false;
...
void func_113(int iParam0, int iParam1) // Position - 0x4206 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_114(int iParam0, int iParam1) // Position - 0x4217 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_115(var uParam0, var uParam1, int iParam2) // Position - 0x422D Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_116(Volume volParam0) // Position - 0x424A Hash - 0x7DD010A2 ^0x16530136
{
...
void func_117(int iParam0) // Position - 0x4261 Hash - 0x3E288458 ^0xC75F9664
{
...
void func_118(int iParam0) // Position - 0x4341 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_90(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_143(Global_1915656.f_3[iParam0 /*447*/].f_21))
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x4519 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_120(int iParam0, BOOL bParam1) // Position - 0x4547 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_90(iParam0))
		return 0;
...
int func_121(int iParam0) // Position - 0x45CA Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_122(int iParam0) // Position - 0x45F1 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_123() // Position - 0x4612 Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_124() // Position - 0x47D9 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x4854 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
...
Hash func_126(int iParam0) // Position - 0x4C03 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_90(iParam0))
		return 0;
...
void func_127(int iParam0, PersChar pchParam1) // Position - 0x4C21 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_90(iParam0))
		return;
...
void func_128(int iParam0, BOOL bParam1) // Position - 0x4C42 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_129(int iParam0) // Position - 0x4C7B Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_90(iParam0))
		return false;
...
BOOL func_130() // Position - 0x4CA1 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_131() // Position - 0x4CAA Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_132(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4D12 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_133(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4E88 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_134(var uParam0, var uParam1, var uParam2) // Position - 0x4E9C Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_135(int iParam0) // Position - 0x4ECA Hash - 0xE6862179 ^0x1AAB7042
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_136(int iParam0) // Position - 0x51AE Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_137(int iParam0) // Position - 0x51D8 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_168(iParam0))
		return false;
...
struct<2> func_138(Player plParam0) // Position - 0x51F4 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_139(const char* sParam0, int iParam1) // Position - 0x5208 Hash - 0x9E99F03 ^0xB3128A23
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_140(int iParam0, BOOL bParam1) // Position - 0x5222 Hash - 0x2F9EB0B9 ^0x1F1FB33
{
	char* ambientZone;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x5256 Hash - 0x342D57CF ^0x81574A39
{
	switch (iParam0)
	{
		case 5:
...
void func_142(int iParam0, int iParam1) // Position - 0x528B Hash - 0x823E3440 ^0x340E01B4
{
	func_170(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_143(int iParam0) // Position - 0x52A5 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_90(iParam0))
		return false;
...
void func_144(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x52CA Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
...
void func_145(int iParam0, BOOL bParam1) // Position - 0x53B6 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_173(iParam0))
		return;
...
void func_146(int iParam0, int iParam1) // Position - 0x540C Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_178(iParam0))
		return;
...
int func_147(int iParam0) // Position - 0x547F Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_148(Hash hParam0) // Position - 0x5495 Hash - 0xDB9A74EC ^0x13B3F16D
{
...
void func_149(int iParam0) // Position - 0x54B5 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_150(int iParam0, BOOL bParam1) // Position - 0x54CB Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_151(int iParam0) // Position - 0x54FC Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_152(int iParam0) // Position - 0x5540 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_153(int iParam0) // Position - 0x5555 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_154(int iParam0) // Position - 0x556A Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_155(int iParam0) // Position - 0x557F Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_156(int iParam0) // Position - 0x55FE Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x565B Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_158(int iParam0, int iParam1) // Position - 0x5674 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_159(int iParam0, int iParam1) // Position - 0x568D Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_160(int iParam0) // Position - 0x56C8 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_161(int iParam0) // Position - 0x56DC Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_162(int iParam0, int iParam1) // Position - 0x56E4 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;
...
BOOL func_163() // Position - 0x570B Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
...
struct<2> func_164() // Position - 0x5763 Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_165(var uParam0, var uParam1) // Position - 0x5771 Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_182(uParam0))
		return false;
...
struct<2> func_166() // Position - 0x57A5 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_167(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x57F0 Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;
...
BOOL func_168(int iParam0) // Position - 0x5820 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_169(int iParam0) // Position - 0x5833 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_170(var uParam0, int iParam1) // Position - 0x585D Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_171(int iParam0) // Position - 0x5872 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_90(iParam0))
		return false;
...
BOOL func_172(Hash hParam0) // Position - 0x5896 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_173(int iParam0) // Position - 0x58A2 Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_174(int iParam0, BOOL bParam1) // Position - 0x58B8 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_173(iParam0))
		return false;
...
void func_175(int iParam0, BOOL bParam1) // Position - 0x58DE Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_173(iParam0))
		return;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x590C Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_173(iParam0))
		return;
...
void func_177(int iParam0) // Position - 0x5946 Hash - 0xB29062D ^0xB29062D
{
	func_187(func_186(iParam0));
	return;
}

BOOL func_178(int iParam0) // Position - 0x5958 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_179(Hash hParam0) // Position - 0x596E Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_188(hParam0))
...
BOOL func_180() // Position - 0x5989 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

BOOL func_181(int iParam0, int iParam1) // Position - 0x5992 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_182(int iParam0) // Position - 0x59A1 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_183(int iParam0) // Position - 0x59E0 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_184(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5A76 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x6513 Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_186(int iParam0) // Position - 0x6579 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_187(int iParam0) // Position - 0x6A96 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_188(Hash hParam0) // Position - 0x6AA7 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
