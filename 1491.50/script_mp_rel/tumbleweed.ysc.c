...
void main() // Position - 0x0 Hash - 0x5B140B50 ^0xD1F02007
{
	...
	fLocal_15 = 1f;
	iLocal_45 = 20000;
	iLocal_48 = iScriptParam_0;
	iLocal_46 = iScriptParam_0.f_2;
	bLocal_50 = false;
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_47)
		{
			...
			switch (iLocal_46)
			{
				case 0:
					if (Global_1901671.f_2.f_26 > 0)
					{
						iLocal_49 = MISC::GET_GAME_TIMER() + Global_1901671.f_2.f_26;
						iLocal_46 = 1;
					}
					else
					{
				...
				case 1:
					if (!func_1() || iLocal_49 < MISC::GET_GAME_TIMER())
					{
						bLocal_50 = false;
						iLocal_46 = 2;
					}
				...
				case 2:
					...
					if (func_10(func_9(iLocal_48)))
						func_11(func_9(iLocal_48), 4);
				
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_48));
					Global_1896644 = -1;
					iLocal_49 = iLocal_45 + MISC::GET_GAME_TIMER();
					iLocal_46 = 3;
					break;
			
				case 3:
					if (func_13() || iLocal_49 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT(iLocal_48);
						iLocal_49 = MISC::GET_GAME_TIMER() + iLocal_45;
						iLocal_46 = 4;
					}
					break;
			
				case 4:
					if (func_15(iLocal_48) || iLocal_49 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0(iLocal_48);
						iLocal_49 = MISC::GET_GAME_TIMER() + iLocal_45;
						iLocal_46 = 5;
					}
					break;
				...
				case 5:
					if (func_17(iLocal_48) || iLocal_49 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0_0(iLocal_48);
						iLocal_49 = iLocal_45 + MISC::GET_GAME_TIMER();
						iLocal_46 = 7;
					}
					break;
				...
				case 7:
					if (func_10(func_9(iLocal_48)))
						if (func_19(func_9(iLocal_48), 4) && !(iLocal_49 < MISC::GET_GAME_TIMER()))
							break;
				
					if (func_20(iLocal_48) || iLocal_49 < MISC::GET_GAME_TIMER())
					{
						func_21(iLocal_48, 4);
						iLocal_49 = MISC::GET_GAME_TIMER() + iLocal_45;
						iLocal_46 = 8;
				...
				case 10:
					...
					func_36(iLocal_48, &Global_1896698);
					iLocal_46 = 11;
					break;
				...
				case 12:
					if (func_40(iLocal_48))
						iLocal_47 = MISC::GET_GAME_TIMER() + 1000;
				
					func_41(&Global_1896698, iLocal_48);
					func_42(iLocal_48);
					func_21(iLocal_48, 8);
					...
					PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_48 /*36*/].f_11);
				
					if (Global_1887363[iLocal_48 /*36*/].f_12 > 0f)
						PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_48 /*36*/].f_12);
					break;
		...
		if (Global_1887363[iLocal_48 /*36*/].f_13 == 0)
		{
		}
		else
		{
			PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1887363[iLocal_48 /*36*/].f_13);
		}
...
BOOL func_13() // Position - 0x7D0 Hash - 0x42BA5C1E ^0x8A0CD535
{
	volLocal_19 = Global_1887363[121 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(volLocal_19, 28);
	volLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5507.5493f, -2965.1958f, -0.228844f, 0f, 0f, 14.500125f, 5.533408f, 8.440951f, 3.311345f, "Tumbleweed - m_volGunsmith");
	volLocal_23 = VOLUME::CREATE_VOLUME_BOX(-5508.2124f, -2964.6296f, -0.4536f, 0f, 0f, 15.486084f, 1.15206f, 1.211619f, 2.44214f);
	volLocal_24 = VOLUME::CREATE_VOLUME_BOX(-5506.2124f, -2964.2402f, -0.546059f, 0f, 0f, 15.382086f, 1.208323f, 1.559606f, 2.24757f);
	volLocal_22 = VOLUME::CREATE_VOLUME_BOX(-5508.861f, -2960.1492f, -0.730614f, 0f, 0f, 14.060832f, 5.590748f, 1.871594f, 1.963433f);
	VOLUME::_0xB469CFD9E065EB99(volLocal_21, 10108);
	volLocal_25 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Armadillo - m_volGeneral Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_25, -5486.925f, -2936.908f, -0.632f, 0f, 0f, 37.506f, 12.127f, 6.213f, 4.544f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_25, -5479.7583f, -2933.3557f, -0.464321f, 0f, 0f, 37.595207f, 2.825781f, 2.131215f, 1.882721f);
	volLocal_26 = VOLUME::CREATE_VOLUME_BOX(-5487.4155f, -2939.0173f, -0.416119f, 0f, 0f, 36.365124f, 1.251111f, 3.269273f, 2.026726f);
	volLocal_28 = VOLUME::CREATE_VOLUME_BOX(-5485.543f, -2937.639f, -0.416119f, 0f, 0f, 36.365124f, 2.087f, 2.06f, 2.027f);
	volLocal_27 = VOLUME::CREATE_VOLUME_BOX(-5492.82f, -2941.371f, -0.730614f, 0f, 0f, 127.434875f, 6.522694f, 1.871594f, 1.963433f);
	VOLUME::_0xB469CFD9E065EB99(volLocal_25, 10107);
	volLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5514.4536f, -2910.941f, 0.196263f, 0f, 0f, 28.00368f, 12.959498f, 18.614845f, 9.427321f, "Tumbleweed - m_volBartender");
	volLocal_33 = VOLUME::CREATE_VOLUME_BOX(-5507.8164f, -2947.645f, -1.491075f, 0f, 0f, -17.451584f, 8.984022f, 7.283852f, 4.458558f);
	volLocal_34 = VOLUME::CREATE_VOLUME_BOX(-5507.615f, -2947.708f, -1.491075f, 0f, 0f, -17.451584f, 1.750185f, 2.572302f, 2.75889f);
	volLocal_35 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5539.5327f, -3039.8237f, 2.031336f, 0f, 0f, 3.990272f, 17.491302f, 32.035217f, 11.887803f, "Tumbleweed - m_volHorseShopPen");
	volLocal_32 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5602.3257f, -2982.2534f, 2.901444f, 0f, 0f, 141.00616f, 3.082703f, 10.214708f, 4.224741f, "Tumbleweed - m_volHomeStable");

	if (func_45() == -1)
	{
		volLocal_30 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5519.2275f, -3044.4265f, -1.508f, 0f, 0f, 0f, 14.363173f, 12.105839f, 4.473f, "Tumbleweed Horse Shop - m_volHorseShop");
		volLocal_31 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5510.71f, -3044.3936f, -1.897282f, 0f, 0f, 0f, 4.170004f, 4.757886f, 3.852559f, "Tumbleweed Horse Shop - m_volHorseShopOutsideDoor");
		func_53(9, volLocal_31);
		VOLUME::_0xB469CFD9E065EB99(volLocal_30, 10109);
	}
	else
	{
		volLocal_30 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5519.2275f, -3044.4265f, -1.40419f, 0f, 0f, 0f, 14.363173f, 12.105839f, 4.472662f, "Tumbleweed Horse Shop - m_volHorseShop");
		VOLUME::_0xB469CFD9E065EB99(volLocal_30, 10109);
	}

	volLocal_36 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Tumbleweed - JAIL");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_36, -5529.713f, -2927.5386f, -1.328089f, 0f, 0f, 24.839975f, 6.747131f, 6.870256f, 6.016601f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_36, -5534.146f, -2922.7205f, -1.771596f, 0f, 0f, 24.839975f, 10.620264f, 7.054735f, 6.016601f);
	VOLUME::_0x3EFABB21E14A6BD1(volLocal_36, 5, 1);
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0xB77 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xB83 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xB90 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0xB9C Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xBA5 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xBB1 Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xBC6 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_54(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xBD7 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xC16 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xC22 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xC2A Hash - 0xB323866B ^0xE9E411E6
{
	if (func_55(iParam0))
		return true;
...
void func_25() // Position - 0xCDA Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0xCE2 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0xCEA Hash - 0x18F7BC37 ^0x18F7BC37
{
	func_59(0, -5514.4536f, -2910.941f, 0.196263f, volLocal_20, 121);
	return;
}

void func_28() // Position - 0xD0A Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_29(int iParam0) // Position - 0xD12 Hash - 0xD78B3015 ^0x319800AC
{
	func_60(3, volLocal_25, iParam0, volLocal_26, volLocal_28, 4, false, false, -1082130432, 0);
	func_61(3, -460561996, 0, false, false);
	func_61(3, 687453229, 0, false, false);
	func_62(3, 8192);
	func_63(3, false);
	func_64();
	func_65(105);
	func_60(6, volLocal_21, iParam0, volLocal_23, volLocal_24, 20, false, false, -1082130432, 0);
	func_61(6, 1880285656, 0, false, false);
	func_63(6, false);
	ENTITY::CREATE_MODEL_HIDE(-5479.709f, -2932.5544f, -1.3902f, 1f, joaat("p_blouseground01x"), false);
	func_60(10, volLocal_33, iParam0, volLocal_34, 0, 460, false, false, -1082130432, 0);
	func_62(10, 536870912);
	func_63(10, false);
	func_60(9, volLocal_30, iParam0, 0, 0, 2, true, false, -1082130432, 0);
	func_62(9, 536870912);
	func_62(9, 16384);
	func_62(9, 32768);
	func_62(9, 1);
	...
	if (!func_66() && func_67())
	{
		func_61(9, joaat("TUM_BARN_INT_DOOR_01"), 0, false, false);
		func_61(9, joaat("TUM_BARN_INT_DOOR_02"), 0, false, false);
	}
	else
	{
		func_61(9, joaat("TUM_BARN_INT_DOOR_01"), 1f, true, true);
		func_61(9, joaat("TUM_BARN_INT_DOOR_02"), -1f, true, true);
	}

	return;
}

void func_30(int iParam0) // Position - 0xE89 Hash - 0x348D0B7A ^0xC4739FCF
{
	if (func_45() != -1)
		return;

	func_68(339, volLocal_32, true);
	func_68(340, volLocal_32, false);
	func_68(341, volLocal_35, true);
	func_68(369, volLocal_35, false);
	func_68(367, volLocal_35, false);
	func_68(368, volLocal_35, false);
	return;
}

void func_31() // Position - 0xEDE Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xEE6 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_33(int iParam0) // Position - 0xEEE Hash - 0xF7C4AEFF ^0xF7C4AEFF
{
	func_69(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_34() // Position - 0xF06 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xF37 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xF7D Hash - 0x41BC629D ^0x41BC629D
{
	iParam0 = iParam0;
	func_70(uParam1, volLocal_19, 1);
	return;
}

void func_37(int iParam0) // Position - 0xF92 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_71(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xFAB Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xFBC Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xFD4 Hash - 0xBC948047 ^0xFEA7FCAE
{
	if (func_73(&bLocal_44))
	{
		if (bLocal_44)
		{
			func_74(1024322021, 1);
			func_74(111672606, 1);
		}
	}
...
void func_41(var uParam0, int iParam1) // Position - 0xFFF Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x113E Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x114B Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0x1181 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_87();
		LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), 0);
		func_21(iLocal_48, 2048);
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_48)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_88(iLocal_48, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_94(iLocal_48, false))
			return false;
	}
	else if (!func_95(iLocal_48))
	{
		return false;
	}
...
int func_45() // Position - 0x1295 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x12A3 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x12AF Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0x12DA Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x131C Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x13FC Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x141A Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x142D Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53(int iParam0, Volume volParam1) // Position - 0x144B Hash - 0xEC3F4CFF ^0x709A6C55
{
	Global_1915656.f_3[iParam0 /*447*/].f_32 = volParam1;
	return;
}

BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1462 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x155A Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_56(int iParam0) // Position - 0x156B Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_57(int iParam0) // Position - 0x157F Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x1593 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

void func_59(int iParam0, float fParam1, float fParam2, float fParam3, Volume volParam4, int iParam5) // Position - 0x159D Hash - 0x9EF36A74 ^0xC77BDF43
{
	...
	Global_1939959.f_5[iParam0 /*11*/].f_6 = func_105(iParam5, iParam0);
	return;
}

void func_60(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x15FB Hash - 0x11E8E9ED ^0xEE89D83
{
	if (iParam0 == 9 && !(!func_66() && func_106()))
		if (func_107(255))
	...
	Global_1051832.f_92[iParam0 /*75*/].f_18 = func_110(iParam2, iParam0);
...
void func_61(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x17AA Hash - 0x95E39C5E ^0x11A3DB9C
{
	int num;
	...
	Global_1051832.f_92[iParam0 /*75*/].f_31[num] = func_116(hParam1, false, false);

	if (func_117(Global_1051832.f_92[iParam0 /*75*/].f_31[num]))
		if (!func_118(Global_1051832.f_92[iParam0 /*75*/].f_31[num]))
			func_119(Global_1051832.f_92[iParam0 /*75*/].f_31[num], false, iParam2, bParam3, true, 0, bParam4, false);

	Global_1051832.f_92[iParam0 /*75*/].f_47 = Global_1051832.f_92[iParam0 /*75*/].f_47 + 1;
	return;
}

void func_62(int iParam0, int iParam1) // Position - 0x184E Hash - 0x823E3440 ^0x4606FBC5
{
	func_120(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_63(int iParam0, BOOL bParam1) // Position - 0x1868 Hash - 0xD0FD971 ^0x657364CB
{
	int num;
	Hash hash;
	float num2;
	...
	if (func_121(iParam0, 16384) || func_121(iParam0, 32768) || _IS_NULL_VECTOR(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
...
void func_64() // Position - 0x198F Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_65(int iParam0) // Position - 0x1B56 Hash - 0xE7BDE93F ^0xE7BDE93F
{
	int i;
	Hash hash;
	float num;
	...
	if (func_123(Global_1051832.f_3654[i /*19*/], &hash, &num, &unk))
	{
		Global_1051832.f_3654[i /*19*/].f_6 = func_130(hash, unk, num, 0, 0, false);
	...
	num2 = func_131(Global_1051832.f_3654[i /*19*/]);
	flag = num2 != -1;
	...
	if (flag)
	{
		...
		if (func_123(num2, &hash, &num, &unk))
		{
			Global_1051832.f_3654[i /*19*/].f_13 = func_130(hash, unk, num, 0, 0, false);
	...
	Global_1051832.f_3654[i /*19*/].f_5 = func_111(Global_1051832.f_3654[i /*19*/]);
...
BOOL func_66() // Position - 0x1CD3 Hash - 0x9AF3EE3F ^0xBF53F360
{
...
BOOL func_67() // Position - 0x1CE7 Hash - 0x16C45944 ^0x16C45944
{
	return func_133(func_57(0));
}

int func_68(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x1CF8 Hash - 0xEDF440C1 ^0x32727141
{
	PersChar persChar;
...
void func_69(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1D46 Hash - 0x1E885EDE ^0x3AA465F4
{
...
void func_70(var uParam0, Volume volParam1, int iParam2) // Position - 0x1D6E Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_71(int iParam0) // Position - 0x1DC7 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_72() // Position - 0x1DDD Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
BOOL func_73(var uParam0) // Position - 0x1E0A Hash - 0xB4769808 ^0xB4769808
{
	if (func_138())
	{
		if (!*uParam0)
...
void func_74(Hash hParam0, int iParam1) // Position - 0x1E3A Hash - 0x1879777F ^0x1879777F
{
	func_119(hParam0, true, 0, false, false, 0, false, false);
	return;
}

BOOL func_75(int iParam0, int iParam1) // Position - 0x1E4F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_76(var uParam0, int iParam1) // Position - 0x1E5E Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_77() // Position - 0x1E6F Hash - 0x463DA432 ^0x857E19AF
{
	return func_75(Global_1940199, 8192);
}

BOOL func_78(var uParam0, int iParam1) // Position - 0x1E82 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_79(int iParam0) // Position - 0x1E93 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_80(int iParam0, int iParam1) // Position - 0x1ED3 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_81() // Position - 0x1F00 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_82(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1F0E Hash - 0x62837D33 ^0x9CE06B43
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	else if (func_71(iParam0) && func_96(iParam0, 16777216) && !Global_1893611.f_9)
	{
	...
	{
		num = func_150(func_149());
		num2 = func_151(func_149());
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str2 = MISC::VAR_STRING(674, str3, num, func_153(&unk, joaat("COLOR_PURE_WHITE")), str4, func_153(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num, func_153(&unk, joaat("COLOR_PURE_WHITE")), func_153(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_83(var uParam0, int iParam1) // Position - 0x217E Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_84(int iParam0, BOOL bParam1) // Position - 0x2191 Hash - 0x2CB19C60 ^0x579311F8
{
	...
	func_158(func_157(joaat("discovered"), joaat("AREAS")), 1);
	...
	switch (func_9(iParam0))
	{
		...
		case 2:
		case 11:
			func_158(func_157(joaat("discovered"), joaat("lowlands_areas")), 1);
			break;
		...
		case 7:
		case 12:
			func_158(func_157(joaat("discovered"), joaat("mountain_areas")), 1);
			break;
	
		case 3:
		case 10:
			func_158(func_157(joaat("discovered"), joaat("foothills_areas")), 1);
			break;
	
		case 4:
		case 9:
			func_158(func_157(joaat("discovered"), joaat("plains_areas")), 1);
			break;
	
		case 8:
			func_158(func_157(joaat("discovered"), joaat("guama_areas")), 1);
			break;
		...
		case 15:
		case 16:
			func_158(func_157(joaat("discovered"), joaat("new_austin_areas")), 1);
			break;
	}
...
void func_85(BOOL bParam0) // Position - 0x27FA Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_86(int iParam0) // Position - 0x2823 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_87() // Position - 0x2868 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_88(int iParam0, BOOL bParam1) // Position - 0x2870 Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_89(int iParam0, BOOL bParam1) // Position - 0x3035 Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_90(BOOL bParam0) // Position - 0x3088 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_91(int iParam0) // Position - 0x30B1 Hash - 0xEC8DE156 ^0x24D8D92C
{
	func_69(0.775f, 0.2f, 0.025f, 0f);
	ENTITY::REMOVE_MODEL_HIDE(-5479.709f, -2932.5544f, -1.3902f, 1f, joaat("p_blouseground01x"), 0);
...
void func_92(int iParam0) // Position - 0x3114 Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_93(int iParam0) // Position - 0x3145 Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_94(int iParam0, BOOL bParam1) // Position - 0x3178 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
	...
	if (func_99(iParam0, &num, &num2, false, false))
	{
		...
		while (true)
		{
			if (!func_160(Global_1896644.f_1, 16))
				func_161(Global_1896644.f_1, false);
...
BOOL func_95(Hash hParam0) // Position - 0x322E Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;

	for (i = 0; i < 40; i = i + 1)
	{
		if (func_162(i) || func_163(i))
		{
		}
		else
		{
...
BOOL func_96(int iParam0, BOOL bParam1) // Position - 0x32A8 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_97(int iParam0) // Position - 0x32D9 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_98(int iParam0) // Position - 0x32FA Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_99(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x334D Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_100(int iParam0) // Position - 0x3A0D Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_101(int iParam0) // Position - 0x3A24 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_102(int iParam0, BOOL bParam1) // Position - 0x3A67 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_100(iParam0))
		return 0;
	...
	if (func_160(iParam0, 32) && !bParam1)
	{
		func_166(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_165(iParam0)));
	
		if (func_45() == -1)
		{
			if (func_160(iParam0, 2048))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_135(iParam0));
				func_167(iParam0, 2048);
			}
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x3B52 Hash - 0x16E871AD ^0x10C54C39
{
...
void func_104(int iParam0) // Position - 0x3B7C Hash - 0x3E288458 ^0xC75F9664
{
	func_169(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_170(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
...
int func_105(int iParam0, int iParam1) // Position - 0x3C5C Hash - 0x19643788 ^0x19643788
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_106() // Position - 0x3D3F Hash - 0x16C45944 ^0x16C45944
{
	return func_172(func_57(0));
}

BOOL func_107(int iParam0) // Position - 0x3D50 Hash - 0x4B08C8C4 ^0x4B08C8C4
{
	return !func_173(iParam0);
}

void func_108(BOOL bParam0, BOOL bParam1) // Position - 0x3D5F Hash - 0x2F17103B ^0x1C4D2C36
{
	if (func_174(255) == 4)
		return;
	...
	{
		if (bParam1)
			func_176(0, false, 0, true);
	
		func_177(0);
		func_178(&(Global_1102813.f_3839));
		...
		func_179(&(Global_1102813.f_3878));
	...
	func_180(Global_1102813.f_3839, 36);
	func_181(Global_1102813.f_3878, 36);
	return;
}

void func_109(int iParam0, BOOL bParam1) // Position - 0x3EAA Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	flag = func_182(iParam0) && !bParam1;

	if (!flag && !func_121(iParam0, 65536))
	{
	...
	else if (func_132(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	if (func_132(iParam0, 16384) && !flag)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_6))
		{
	...
	if (func_121(iParam0, 262144))
		Global_1051832.f_92[iParam0 /*75*/].f_49 = 262144;
	else
		func_126(iParam0);

	if (VOLUME::DOES_VOLUME_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_24) && func_186(iParam0, 2))
	{
...
int func_110(Hash hParam0, int iParam1) // Position - 0x425B Hash - 0x274C8E8A ^0x274C8E8A
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_111(int iParam0) // Position - 0x4BC1 Hash - 0xF53EDEBA ^0xF53EDEBA
{
	if (!func_187(iParam0))
		return 0;

	if (Global_1051832.f_4492[iParam0] == 0)
		Global_1051832.f_4492[iParam0] = func_188(iParam0);

	return Global_1051832.f_4492[iParam0];
}

int func_112(int iParam0) // Position - 0x4C02 Hash - 0xFE1A3B7C ^0xFE1A3B7C
{
	switch (iParam0)
	{
		case 3:
...
void func_113(int iParam0, int iParam1) // Position - 0x4C9F Hash - 0xDCFC48D0 ^0xCB4861A2
{
...
void func_114(int iParam0) // Position - 0x4CCE Hash - 0x93134738 ^0x938C636D
{
...
int func_115(int iParam0) // Position - 0x4D07 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_116(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4D1B Hash - 0xEC5804B5 ^0xE95C34A9
{
...
BOOL func_117(Hash hParam0) // Position - 0x4DBF Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_189(hParam0))
...
BOOL func_118(Hash hParam0) // Position - 0x4DDA Hash - 0x51587F69 ^0xAFC63473
{
	func_116(hParam0, false, false);
...
void func_119(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4E03 Hash - 0xD777F4CF ^0xBFF3124C
{
	func_116(hParam0, false, false);
	...
	if (func_117(hParam0))
	{
		...
		if (bParam3)
			func_190(hParam0, iParam2, true, bParam6);
		else if (bParam1)
			if (bParam4)
...
void func_120(BOOL bParam0, int iParam1) // Position - 0x4E8E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_121(int iParam0, BOOL bParam1) // Position - 0x4E9F Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

Hash func_122() // Position - 0x4EB8 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1893611.f_2;
}

BOOL func_123(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4EC6 Hash - 0xC625CFBA ^0xC1EA8449
{
	return func_195(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_124(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4EE6 Hash - 0xC625CFBA ^0xF80EEB70
{
	return func_195(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_125(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4F06 Hash - 0xCAA352A8 ^0x24D53CD4
{
	if (bParam6)
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);

	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_130(hParam1, vParam2, fParam5, 0, 0, false);
...
void func_126(int iParam0) // Position - 0x4F82 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_127(int iParam0) // Position - 0x4F97 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_128(int iParam0) // Position - 0x4FAC Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_129(int iParam0) // Position - 0x4FC1 Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
int func_130(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5040 Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

int func_131(int iParam0) // Position - 0x505A Hash - 0x8CBBEB73 ^0x8CBBEB73
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_132(int iParam0, int iParam1) // Position - 0x50B8 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

BOOL func_133(var uParam0, var uParam1) // Position - 0x50D1 Hash - 0x3EFAE063 ^0x3EFAE063
{
	return func_196(uParam0, 9, 12);
}

BOOL func_134(int iParam0, BOOL bParam1) // Position - 0x50E4 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_45() != -1)
		return false;
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_197(iParam0)))
		return false;

	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_135(iParam0));
}

PersChar func_135(int iParam0) // Position - 0x513C Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_100(iParam0))
		return 0;
...
BOOL func_136(int iParam0) // Position - 0x515C Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_137(int iParam0) // Position - 0x5172 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_138() // Position - 0x5188 Hash - 0x2C6DE8F6 ^0xBF042FB1
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_139(int iParam0) // Position - 0x51A4 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_198())
		return true;
...
BOOL func_140() // Position - 0x51D9 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_200(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_141(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x521C Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_201(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_203(func_202(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_204(iParam0) || func_205(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_142(int iParam0) // Position - 0x5C82 Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_143(int iParam0) // Position - 0x5C97 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
Hash func_144(int iParam0) // Position - 0x5D52 Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	Hash bountyData;
	...
	i = 0;
	gamerHandle = { func_206(PLAYER::PLAYER_ID()) };
...
int func_145(int iParam0) // Position - 0x5DC0 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_146(int iParam0) // Position - 0x5F1B Hash - 0x21CE226B ^0x697EA607
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_147(int iParam0, BOOL bParam1) // Position - 0x5F56 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x5F98 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_142(iParam0))
		return false;
...
BOOL func_149() // Position - 0x5FDD Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_150(BOOL bParam0) // Position - 0x5FE9 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_151(BOOL bParam0) // Position - 0x5FFC Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_152(float fParam0) // Position - 0x600E Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_153(var uParam0, int iParam1) // Position - 0x6024 Hash - 0xB0CFF0C3 ^0x44AB9936
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
		return MISC::VAR_STRING(10, "LITERAL_STRING", uParam0);

	return func_207(MISC::VAR_STRING(10, "LITERAL_STRING", uParam0), iParam1);
}

int func_154(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x605A Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_155(int iParam0) // Position - 0x609D Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_204(iParam0))
		if (!func_205(44))
			return false;
...
void func_156(int iParam0, int iParam1) // Position - 0x60BD Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_157(int iParam0, int iParam1) // Position - 0x60CE Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_158(var uParam0, var uParam1, int iParam2) // Position - 0x60E4 Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_159(int iParam0) // Position - 0x6101 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_100(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_208(Global_1915656.f_3[iParam0 /*447*/].f_21))
		func_209(Global_1915656.f_3[iParam0 /*447*/].f_21, false, true, false, false);
	...
	func_210(Global_1915656.f_3[iParam0 /*447*/].f_9, false);
...
BOOL func_160(int iParam0, BOOL bParam1) // Position - 0x62D9 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_161(int iParam0, BOOL bParam1) // Position - 0x6307 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_100(iParam0))
		return 0;
	...
	if (func_160(iParam0, true) && !bParam1)
	{
		func_214(iParam0, 128);
		return 1;
	}

	func_167(iParam0, 129);
	func_215(iParam0);
...
int func_162(int iParam0) // Position - 0x638A Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_163(int iParam0) // Position - 0x63B1 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_164() // Position - 0x63D2 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
Hash func_165(int iParam0) // Position - 0x644D Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_100(iParam0))
		return 0;
...
void func_166(int iParam0, PersChar pchParam1) // Position - 0x646B Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_100(iParam0))
		return;
...
void func_167(int iParam0, BOOL bParam1) // Position - 0x648C Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_168(int iParam0) // Position - 0x64C5 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_100(iParam0))
		return false;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x64EB Hash - 0x2F9EB0B9 ^0x98C6E452
{
	char* ambientZone;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x651F Hash - 0x342D57CF ^0x945D8131
{
	switch (iParam0)
	{
		case 5:
...
void func_171(int iParam0, int iParam1) // Position - 0x6554 Hash - 0x823E3440 ^0x340E01B4
{
	func_216(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_172(var uParam0, var uParam1) // Position - 0x656E Hash - 0x1268D0E3 ^0x1268D0E3
{
	return func_196(uParam0, 5, 8);
}

BOOL func_173(int iParam0) // Position - 0x6581 Hash - 0xA3986FDD ^0xA3986FDD
{
	return func_217(1, iParam0);
}

int func_174(int iParam0) // Position - 0x6590 Hash - 0x8D78E39F ^0x46194076
{
	if (iParam0 == 255)
...
int func_175(int iParam0) // Position - 0x65DB Hash - 0x5423E6F3 ^0xE2118439
{
	if (func_218(&(Global_1102813.f_4), iParam0, 5))
		return 1;

	return 0;
}

void func_176(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x65F8 Hash - 0x79169E9C ^0xA3FE4569
{
	func_219(iParam0);
...
int func_177(int iParam0) // Position - 0x665A Hash - 0x5423E6F3 ^0xE2118439
{
...
void func_178(var uParam0) // Position - 0x6677 Hash - 0xCF95012E ^0xCF95012E
{
	var unk;
...
void func_179(float* pfParam0) // Position - 0x6689 Hash - 0xFBC3ACC8 ^0xFBC3ACC8
{
	var unk;
...
void func_181(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x66F1 Hash - 0x6DF4F0B2 ^0x7B946ED1
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_182(int iParam0) // Position - 0x671E Hash - 0x287157F6 ^0x287157F6
{
	if (iParam0 == 28 || iParam0 == 29 || iParam0 == 38 || iParam0 == 27 || iParam0 == 15 || iParam0 == 39)
		return true;

	if (func_121(iParam0, 65536))
		return true;

	return false;
}

void func_183(int iParam0, int iParam1) // Position - 0x677B Hash - 0x9E30ADED ^0xA0DD8460
{
	func_132(iParam0, iParam1);
...
void func_184(Hash hParam0) // Position - 0x67B6 Hash - 0xDB9A74EC ^0x13B3F16D
{
	if (func_117(hParam0) && func_226())
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(hParam0);

	return;
}

void func_185(int iParam0) // Position - 0x67D6 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_186(int iParam0, int iParam1) // Position - 0x67DE Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;

	return func_227(Global_1051832.f_92[iParam0 /*75*/].f_50, iParam1);
}

BOOL func_187(int iParam0) // Position - 0x6805 Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_188(int iParam0) // Position - 0x681B Hash - 0xB89C4DF3 ^0x1393EE39
{
	var unk;

	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149432.f_7) && !func_229(12, func_228(iParam0), &unk))
		return 0;

	return unk.f_2;
}

BOOL func_189(Hash hParam0) // Position - 0x684C Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

void func_190(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6858 Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_117(hParam0))
	{
...
void func_191(Hash hParam0, BOOL bParam1) // Position - 0x6890 Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_117(hParam0))
...
void func_192(Hash hParam0, BOOL bParam1) // Position - 0x68BE Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_117(hParam0))
...
void func_193(Hash hParam0, BOOL bParam1) // Position - 0x68EC Hash - 0x4844A91D ^0x50E23246
{
	if (func_117(hParam0))
...
BOOL func_194() // Position - 0x691A Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_195(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x6923 Hash - 0x5851BC53 ^0x8A1263E0
{
	int num;

	num = func_230();
	num.f_2 = -738708473;
	num.f_3 = func_228(iParam0);
...
BOOL func_196(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x69AB Hash - 0x9EA53184 ^0x9EA53184
{
	int num;
...
Ped func_197(int iParam0) // Position - 0x69E6 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_198() // Position - 0x6A14 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_199() // Position - 0x6A1D Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_200(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6A85 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_231(func_57(0)))
		return true;
...
const char* func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6BFB Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_202(var uParam0, var uParam1, var uParam2) // Position - 0x6C0F Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_203(int iParam0) // Position - 0x6C3D Hash - 0xE6862179 ^0xB6F54D1C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_204(int iParam0) // Position - 0x6F21 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_205(int iParam0) // Position - 0x6F4B Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_237(iParam0))
		return false;
...
struct<2> func_206(Player plParam0) // Position - 0x6F67 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_207(const char* sParam0, int iParam1) // Position - 0x6F7B Hash - 0x9E99F03 ^0x988DB6F6
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

BOOL func_208(int iParam0) // Position - 0x6F95 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_100(iParam0))
		return false;
...
void func_209(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6FBA Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_208(iParam0) && func_239(iParam0))
		return;

	func_167(iParam0, 1);
	func_215(iParam0);

	if (func_240(func_165(iParam0)))
	{
		persChar = func_135(iParam0);
	...
	if (func_160(iParam0, 128) && !bParam3)
		func_161(iParam0, false);

	return;
}

void func_210(int iParam0, BOOL bParam1) // Position - 0x70A6 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_187(iParam0))
		return;
	...
	if (bParam1)
	{
		if (!func_241(iParam0, 1024))
		{
			func_242(iParam0, 1024);
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_241(iParam0, 1024))
	{
		func_243(iParam0, 1024);
		INVENTORY::_0x9B4E793B1CB6550A();
	}
...
void func_211(int iParam0, int iParam1) // Position - 0x70FC Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_245(iParam0))
		return;
...
int func_212(int iParam0) // Position - 0x716F Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_213(int iParam0) // Position - 0x7185 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_214(int iParam0, BOOL bParam1) // Position - 0x719B Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_215(int iParam0) // Position - 0x71CC Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_216(int iParam0, int iParam1) // Position - 0x7210 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_217(int iParam0, int iParam1) // Position - 0x7225 Hash - 0x61AB4BED ^0x265134F3
{
	int num;
	...
	if (iParam1 == 255)
		return func_246(&(Global_1102813.f_4), num, 5);
	...
	if (Global_1295666.f_17[iParam1])
		return func_246(&(Global_1101558[iParam1 /*38*/].f_4), num, 5);

	return false;
}

BOOL func_218(int* piParam0, int iParam1, int iParam2) // Position - 0x7299 Hash - 0x8AC008A3 ^0x375BADC3
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_219(int iParam0) // Position - 0x72CB Hash - 0x42868A8 ^0x3D52297C
{
	Global_1102813.f_26.f_12 = iParam0;
	return;
}

BOOL func_220(int iParam0) // Position - 0x72DD Hash - 0xA1D29AFD ^0xABA18533
{
	return Global_1102813.f_26.f_7 && iParam0 != false;
}

BOOL func_221(BOOL bParam0) // Position - 0x72F2 Hash - 0xA1D29AFD ^0x8B9D4F17
{
	return Global_1102813.f_26.f_9 && bParam0 != false;
}

BOOL func_222(int iParam0) // Position - 0x7307 Hash - 0x10DA64DD ^0x85E01D27
{
	return Global_1102813.f_4[Global_1106895[iParam0 /*2*/]] && Global_1106895[iParam0 /*2*/].f_1 == Global_1106895[iParam0 /*2*/].f_1;
}

int func_223() // Position - 0x7335 Hash - 0xE5D277D5 ^0xE5D277D5
{
	if (Global_1102813 <= 5)
...
void func_224(BOOL bParam0) // Position - 0x7368 Hash - 0xEBD3AD20 ^0x6E10961F
{
	if (func_248(bParam0))
		return;
...
BOOL func_225(int* piParam0, int iParam1, int iParam2) // Position - 0x738F Hash - 0xA8F08582 ^0x9810C45C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_226() // Position - 0x73C2 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

BOOL func_227(BOOL bParam0, BOOL bParam1) // Position - 0x73CB Hash - 0x178D9C09 ^0x178D9C09
{
	return bParam0 && bParam1 != false;
}

int func_228(int iParam0) // Position - 0x73DA Hash - 0xB8EC44B7 ^0x241D648F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_229(int iParam0, int iParam1, var uParam2) // Position - 0x7DC2 Hash - 0xDC10368D ^0xDC10368D
{
	var unk;

	if (func_249(iParam0, iParam1, &unk))
		func_250(&unk, iParam0, uParam2);
	else
		return false;
...
int func_230() // Position - 0x7DE9 Hash - 0x4F5358E7 ^0x4EB0CC4F
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_231(var uParam0, var uParam1) // Position - 0x7DFE Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_251(uParam0))
		return false;
	...
	if (uParam0.f_1 >= func_252(uParam0))
		return false;

	return true;
}

int func_232(int iParam0, var uParam1) // Position - 0x7E32 Hash - 0x9C3ED8B4 ^0x9C3ED8B4
{
	if (iParam0 == 2)
...
BOOL func_233() // Position - 0x7E4C Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_231(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_234() // Position - 0x7EA4 Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

struct<2> func_235() // Position - 0x7EB2 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_236(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7EFD Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;

	func_254(iParam3, &unk, &num, &num2);

	if (func_255(uParam0, unk, num, num.f_1, num2))
		return true;

	return false;
}

BOOL func_237(int iParam0) // Position - 0x7F2D Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_238(int iParam0) // Position - 0x7F40 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
BOOL func_239(int iParam0) // Position - 0x7F6A Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_100(iParam0))
		return false;
...
BOOL func_240(Hash hParam0) // Position - 0x7F8E Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_241(int iParam0, BOOL bParam1) // Position - 0x7F9A Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_187(iParam0))
		return false;
...
void func_242(int iParam0, BOOL bParam1) // Position - 0x7FC0 Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_187(iParam0))
		return;
...
void func_243(int iParam0, BOOL bParam1) // Position - 0x7FEE Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_187(iParam0))
		return;
...
void func_244(int iParam0) // Position - 0x8028 Hash - 0xB29062D ^0xB29062D
{
	func_257(func_256(iParam0));
	return;
}

BOOL func_245(int iParam0) // Position - 0x803A Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_246(int* piParam0, int iParam1, int iParam2) // Position - 0x8050 Hash - 0x15F7E5EE ^0x39F4E7C
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_247() // Position - 0x8087 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1102813.f_3672;
}

BOOL func_248(BOOL bParam0) // Position - 0x8096 Hash - 0x695C3191 ^0x86E70E17
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_249(int iParam0, int iParam1, Any* panParam2) // Position - 0x80AC Hash - 0x8467BB0B ^0xA289B29B
{
	*panParam2 = Global_1149432.f_7;
	panParam2->f_2 = 1351168281;
	panParam2->f_3 = func_258(iParam0);
	panParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam2->f_1), panParam2);
}

void func_250(Any* panParam0, int iParam1, var uParam2) // Position - 0x80E0 Hash - 0x59F43AD2 ^0xB9A366FE
{
	var unk;
...
BOOL func_251(int iParam0) // Position - 0x815A Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_252(int iParam0) // Position - 0x8199 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
int func_253(var uParam0, var uParam1) // Position - 0x822F Hash - 0xF9339824 ^0x8CB8B693
{
	var unk;
	...
	if (func_259(uParam0, &unk))
		return unk.f_1;

	return -1;
}

void func_254(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x825B Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x8CF8 Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_256(int iParam0) // Position - 0x8D5E Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_257(int iParam0) // Position - 0x927B Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_258(int iParam0) // Position - 0x928C Hash - 0x5FB59AC3 ^0xE293EFF
{
	int num;
...
BOOL func_259(int iParam0, var uParam1, Any* panParam2) // Position - 0x9401 Hash - 0xEDAACC68 ^0x7998E850
{
	if (!func_231(iParam0))
		return false;
...
void func_260(Any* panParam0) // Position - 0x950C Hash - 0xE2B2004A ^0x20B50C0B
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
