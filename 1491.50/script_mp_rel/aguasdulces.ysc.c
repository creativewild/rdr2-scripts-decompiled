...
BOOL func_13() // Position - 0x7D0 Hash - 0x754B56C4 ^0xA3E09684
{
	volLocal_16 = Global_1887363[62 /*36*/].f_5;
	volLocal_17 = VOLUME::CREATE_VOLUME_CYLINDER(1411.869f, -7032.4717f, 71.507744f, 0f, 0f, -25.352884f, 142.44946f, 133.16826f, 45.877743f);
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x810 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x81C Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x829 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x835 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x842 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x84E Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x863 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x874 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x8B3 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8BF Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8C7 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x977 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0x97F Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0x987 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x98F Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x997 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x9A3 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x9AF Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0x9B7 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_33(int iParam0) // Position - 0x9BF Hash - 0xF7C4AEFF ^0xF7C4AEFF
{
	func_58(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_34() // Position - 0x9D7 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xA08 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA4E Hash - 0x41BC629D ^0x41BC629D
{
	iParam0 = iParam0;
	func_59(uParam1, volLocal_16, 1);
	return;
}

void func_37(int iParam0) // Position - 0xA63 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_60(iParam0))
		return;
...
BOOL func_38(int iParam0) // Position - 0xA7C Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xA8D Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && iParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xAA5 Hash - 0x8B279415 ^0x5DC2C927
{
	if (VOLUME::DOES_VOLUME_EXIST(volLocal_17))
	{
		if (func_62(62, 33554432))
		{
			if (!bLocal_18)
			{
				PATHFIND::_0xF2A2177AC848B3A8(volLocal_17, 0, 1);
				bLocal_18 = true;
			}
		}
		else if (bLocal_18)
		{
			PATHFIND::_0xF2A2177AC848B3A8(volLocal_17, 1, 1);
			bLocal_18 = false;
		}
	}
...
void func_41(var uParam0, int iParam1) // Position - 0xAE9 Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC28 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC35 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xC6B Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_75();
...
int func_45() // Position - 0xD7F Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD8D Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD99 Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xDC4 Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE06 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xEE6 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_60(iParam0))
		return false;

	return func_62(iParam0, 8);
}

BOOL func_51(int iParam0) // Position - 0xF04 Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF17 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF35 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x102D Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x103E Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1052 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1066 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

void func_58(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1070 Hash - 0x1E885EDE ^0x3AA465F4
{
...
void func_59(var uParam0, Volume volParam1, int iParam2) // Position - 0x1098 Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_60(int iParam0) // Position - 0x10F1 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_61() // Position - 0x1107 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
BOOL func_62(int iParam0, BOOL bParam1) // Position - 0x1134 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_63(int iParam0, int iParam1) // Position - 0x1165 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x1174 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_65() // Position - 0x1185 Hash - 0x463DA432 ^0x857E19AF
{
	return func_63(Global_1940199, 8192);
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x1198 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_67(int iParam0) // Position - 0x11A9 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_60(iParam0))
		return false;

	return Global_1887363[iParam0 /*36*/].f_21 == 1 || Global_1887363[iParam0 /*36*/].f_21 == 2 && !func_92(iParam0);
}

BOOL func_68(int iParam0, int iParam1) // Position - 0x11E9 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_69() // Position - 0x1216 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_70(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1224 Hash - 0x659AC4C5 ^0x8A3286AA
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	str = func_94(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	if (!func_95(iParam4))
		if (func_60(iParam0))
			iParam4 = func_96(func_9(iParam0));
		else
			iParam4 = func_96(iParam1);
	...
	if (flag && bParam3)
	{
		str2 = func_99(func_98(iParam2));
	}
	else if (func_100(iParam1, 2) || func_101(iParam4, 2) && !Global_1893611.f_9)
	{
	...
	else if (func_60(iParam0) && func_62(iParam0, 16777216) && !Global_1893611.f_9)
	{
	...
	{
		num2 = func_103(func_102());
		num3 = func_104(func_102());
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				temperatureAtCoords = func_105(temperatureAtCoords);
				str3 = "TIME_AND_TEMP_F";
			}
		
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(674, str3, num2, func_106(&unk, joaat("COLOR_PURE_WHITE")), str4, func_106(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num2, func_106(&unk, joaat("COLOR_PURE_WHITE")), func_106(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_107(str, str2, 4000, 0, 0, 0, false, true);
	return;
}

void func_71(var uParam0, int iParam1) // Position - 0x1488 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_72(int iParam0, BOOL bParam1) // Position - 0x149B Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_73(BOOL bParam0) // Position - 0x1B04 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_74(int iParam0) // Position - 0x1B2D Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_75() // Position - 0x1B72 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_76(int iParam0, BOOL bParam1) // Position - 0x1B7A Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_77(int iParam0, BOOL bParam1) // Position - 0x233F Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_78(BOOL bParam0) // Position - 0x2392 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_79(int iParam0) // Position - 0x23BB Hash - 0x580E4353 ^0x580E4353
{
	func_58(0.775f, 0.2f, 0.025f, 0f);
	iParam0 = iParam0;
	return;
}

void func_80(int iParam0) // Position - 0x23DB Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_81(int iParam0) // Position - 0x240C Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x243F Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
	...
	if (func_86(iParam0, &num, &num2, false, false))
	{
		...
		while (true)
		{
			if (!func_114(Global_1896644.f_1, 16))
				func_115(Global_1896644.f_1, false);
...
BOOL func_83(int iParam0) // Position - 0x24F5 Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;

	for (i = 0; i < 40; i = i + 1)
	{
		if (func_116(i) || func_117(i))
		{
		}
		else
		{
...
BOOL func_84(int iParam0) // Position - 0x256F Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_60(iParam0))
		return false;

	return func_62(iParam0, 33554432);
}

BOOL func_85(int iParam0) // Position - 0x2590 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x25E3 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x2CA3 Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x2CBA Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x2CFD Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_87(iParam0))
		return 0;
	...
	if (func_114(iParam0, 32) && !bParam1)
	{
		func_122(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_121(iParam0)));
	
		if (func_45() == -1)
		{
			if (func_114(iParam0, 2048))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_123(iParam0));
				func_124(iParam0, 2048);
			}
		
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_123(iParam0));
		}
	
		return 0;
	}

	if (!func_125(iParam0) && func_45() == -1)
		return 0;

	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_123(iParam0)))
	{
	...
	func_122(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_121(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_123(iParam0));
...
BOOL func_90(int iParam0) // Position - 0x2DE8 Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_91(int iParam0) // Position - 0x2DFE Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_92(int iParam0) // Position - 0x2E14 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_126())
		return true;
...
BOOL func_93() // Position - 0x2E49 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_128(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_94(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2E8C Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_129(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_131(func_130(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_132(iParam0) || func_133(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_95(int iParam0) // Position - 0x38EB Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_96(int iParam0) // Position - 0x3900 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_97(int iParam0) // Position - 0x39BB Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
	...
	i = 0;
	gamerHandle = { func_134(PLAYER::PLAYER_ID()) };
...
int func_98(int iParam0) // Position - 0x3A29 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_99(int iParam0) // Position - 0x3B84 Hash - 0x21CE226B ^0x117FC044
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x3BBF Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_101(int iParam0, int iParam1) // Position - 0x3C01 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_95(iParam0))
		return false;
...
int func_102() // Position - 0x3C46 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_103(int iParam0) // Position - 0x3C52 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_104(int iParam0) // Position - 0x3C65 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_105(float fParam0) // Position - 0x3C77 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_106(var uParam0, int iParam1) // Position - 0x3C8D Hash - 0xB0CFF0C3 ^0x9F1AE808
{
...
int func_107(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3CC3 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_108(int iParam0) // Position - 0x3D06 Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_132(iParam0))
		if (!func_133(44))
			return false;
...
void func_109(int iParam0, int iParam1) // Position - 0x3D26 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_110(int iParam0, int iParam1) // Position - 0x3D37 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_111(var uParam0, var uParam1, int iParam2) // Position - 0x3D4D Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_112(int iParam0) // Position - 0x3D6A Hash - 0x3E288458 ^0xC75F9664
{
	func_136(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_137(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
	...
	func_138(iParam0, 8192);
	func_138(iParam0, 32768);
	func_138(iParam0, 524288);
	func_138(iParam0, 1048576);
...
void func_113(int iParam0) // Position - 0x3E4A Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_87(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_139(Global_1915656.f_3[iParam0 /*447*/].f_21))
		func_140(Global_1915656.f_3[iParam0 /*447*/].f_21, false, true, false, false);
	...
	func_141(Global_1915656.f_3[iParam0 /*447*/].f_9, false);
	func_142(iParam0, 536870912);
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_144(Global_1915656.f_3[iParam0 /*447*/].f_318[i /*6*/]);
...
BOOL func_114(int iParam0, BOOL bParam1) // Position - 0x4023 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_115(int iParam0, BOOL bParam1) // Position - 0x4051 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_87(iParam0))
		return 0;
	...
	if (func_114(iParam0, true) && !bParam1)
	{
	...
	func_147(iParam0);
	PERSCHAR::_DELETE_PERSCHAR(func_123(iParam0));
	func_122(iParam0, 0);
	return 1;
}

int func_116(int iParam0) // Position - 0x40D4 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_117(int iParam0) // Position - 0x40FB Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_118() // Position - 0x411C Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_119() // Position - 0x42E3 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x435E Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	if (!flag && !func_153(iParam0, 65536))
	{
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_144(Global_1051832.f_92[iParam0 /*75*/].f_31[i]);
	...
	if (VOLUME::DOES_VOLUME_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_24) && func_158(iParam0, 2))
	{
...
Hash func_121(int iParam0) // Position - 0x470D Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_87(iParam0))
		return 0;
...
void func_122(int iParam0, PersChar pchParam1) // Position - 0x472B Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_87(iParam0))
		return;
...
PersChar func_123(int iParam0) // Position - 0x474C Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_87(iParam0))
		return 0;
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x476C Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_125(int iParam0) // Position - 0x47A5 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_126() // Position - 0x47CB Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_127() // Position - 0x47D4 Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_128(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x483C Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_161(func_56(0)))
		return true;
...
const char* func_129(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x49B2 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_130(var uParam0, var uParam1, var uParam2) // Position - 0x49C6 Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_131(int iParam0) // Position - 0x49F4 Hash - 0xE6862179 ^0xFB4FB2C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_132(int iParam0) // Position - 0x4CD8 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_133(int iParam0) // Position - 0x4D02 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_164(iParam0))
		return false;
...
struct<2> func_134(Player plParam0) // Position - 0x4D1E Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_135(const char* sParam0, int iParam1) // Position - 0x4D32 Hash - 0x9E99F03 ^0xEF793D5A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_136(int iParam0, BOOL bParam1) // Position - 0x4D4C Hash - 0x2F9EB0B9 ^0x60E893CE
{
	char* ambientZone;
...
void func_137(int iParam0, BOOL bParam1) // Position - 0x4D80 Hash - 0x342D57CF ^0x2222C2EF
{
	switch (iParam0)
	{
		case 5:
...
void func_138(int iParam0, int iParam1) // Position - 0x4DB5 Hash - 0x823E3440 ^0x340E01B4
{
	func_166(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_139(int iParam0) // Position - 0x4DCF Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_87(iParam0))
		return false;
...
void func_140(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4DF4 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_139(iParam0) && func_167(iParam0))
		return;

	func_124(iParam0, 1);
	func_147(iParam0);

	if (func_168(func_121(iParam0)))
	{
		persChar = func_123(iParam0);
	...
	if (func_114(iParam0, 128) && !bParam3)
		func_115(iParam0, false);

	return;
}

void func_141(int iParam0, BOOL bParam1) // Position - 0x4EE0 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_169(iParam0))
		return;
...
void func_142(int iParam0, int iParam1) // Position - 0x4F36 Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_174(iParam0))
		return;
...
int func_143(int iParam0) // Position - 0x4FA9 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_144(Hash hParam0) // Position - 0x4FBF Hash - 0xDB9A74EC ^0x13B3F16D
{
	if (func_175(hParam0) && func_176())
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(hParam0);

	return;
}

void func_145(int iParam0) // Position - 0x4FDF Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_146(int iParam0, BOOL bParam1) // Position - 0x4FF5 Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_147(int iParam0) // Position - 0x5026 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_148(int iParam0) // Position - 0x506A Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_149(int iParam0) // Position - 0x507F Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_150(int iParam0) // Position - 0x5094 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_151(int iParam0) // Position - 0x50A9 Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_152(int iParam0) // Position - 0x5128 Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x5185 Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_154(int iParam0, int iParam1) // Position - 0x519E Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_155(int iParam0, int iParam1) // Position - 0x51B7 Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_156(int iParam0) // Position - 0x51F2 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_157(int iParam0) // Position - 0x5206 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_158(int iParam0, int iParam1) // Position - 0x520E Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;
...
BOOL func_159() // Position - 0x5235 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_161(Global_1051268) && Global_1572887.f_8 & 1 != 0)
		return true;

	return false;
}

struct<2> func_160() // Position - 0x528D Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_161(var uParam0, var uParam1) // Position - 0x529B Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_179(uParam0))
		return false;
...
struct<2> func_162() // Position - 0x52CF Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_163(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x531A Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;
...
BOOL func_164(int iParam0) // Position - 0x534A Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_165(int iParam0) // Position - 0x535D Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_166(var uParam0, int iParam1) // Position - 0x5387 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_167(int iParam0) // Position - 0x539C Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_168(Hash hParam0) // Position - 0x53C0 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_169(int iParam0) // Position - 0x53CC Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_170(int iParam0, BOOL bParam1) // Position - 0x53E2 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_169(iParam0))
		return false;
...
void func_171(int iParam0, BOOL bParam1) // Position - 0x5408 Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_169(iParam0))
		return;
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x5436 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_169(iParam0))
		return;
...
void func_173(int iParam0) // Position - 0x5470 Hash - 0xB29062D ^0xB29062D
{
	func_184(func_183(iParam0));
	return;
}

BOOL func_174(int iParam0) // Position - 0x5482 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_175(Hash hParam0) // Position - 0x5498 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_185(hParam0))
...
BOOL func_176() // Position - 0x54B3 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

Ped func_177(int iParam0) // Position - 0x54BC Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_178(int iParam0, int iParam1) // Position - 0x54EA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_179(int iParam0) // Position - 0x54F9 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_180(int iParam0) // Position - 0x5538 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_181(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x55CE Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_182(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x606B Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_183(int iParam0) // Position - 0x60D1 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_184(int iParam0) // Position - 0x65EE Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_185(Hash hParam0) // Position - 0x65FF Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
