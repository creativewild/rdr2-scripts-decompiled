...
BOOL func_13() // Position - 0x7D0 Hash - 0x2951B1A2 ^0x239FCF51
{
	volLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1402.731f, -2317.543f, 43.425f, 0f, 0f, 3.94f, 5.574f, 3.58f, 2.824f, "ThievesLanding - m_volFence");
	volLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1402.731f, -2317.543f, 43.425f, 0f, 0f, 3.94f, 3.27f, 2.497f, 2.824f, "ThievesLanding - m_volFencePrompt");
	func_53(&volLocal_21, -1355.28f, -2296.67f, 40.62f, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	volLocal_21.f_1 = 0;
	volLocal_21.f_2 = 0;
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x85C Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x868 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x875 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x881 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x88E Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x89A Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8AF Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_54(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8C0 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x8FF Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x90B Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x913 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_55(iParam0))
		return true;
...
void func_25() // Position - 0x9C3 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0x9CB Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0x9D3 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x9DB Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_29(int iParam0) // Position - 0x9E3 Hash - 0xE361EF18 ^0xDD341398
{
	if (func_45() == -1)
	{
	}
	...
	{
		func_59(4, volLocal_19, iParam0, volLocal_20, 0, 44, false, false, -1082130432, 0);
		func_60(4, false);
	}
...
void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xA13 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0xA1F Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xA27 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xA2F Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA3B Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xA6C Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xAB2 Hash - 0x71931A41 ^0x38641BC4
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xAC6 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_61(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xADF Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAF0 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB08 Hash - 0x2EF4A62 ^0x2EF4A62
{
	func_63();
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xB15 Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC54 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC61 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xC97 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_76();
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_28, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_83(iLocal_28, false))
			return false;
	}
	else if (!func_84(iLocal_28))
	{
		return false;
	}
...
int func_45() // Position - 0xDAB Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDB9 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDC5 Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xDF0 Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE32 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF12 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF30 Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF43 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, char* sParam10) // Position - 0xF61 Hash - 0x3A05F50D ^0xD816AE7A
{
	*uParam0 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(fParam1, fParam4, fParam7, sParam10);
	return;
}

BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF7E Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x1076 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_56(int iParam0) // Position - 0x1087 Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_57(int iParam0) // Position - 0x109B Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x10AF Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

void func_59(int iParam0, Volume volParam1, int iParam2, Volume volParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x10B9 Hash - 0x11E8E9ED ^0xEE89D83
{
	if (iParam0 == 9 && !(!func_92() && func_93()))
		if (func_94(255))
	...
	Global_1051832.f_92[iParam0 /*75*/].f_18 = func_97(iParam2, iParam0);
...
int func_60(int iParam0, BOOL bParam1) // Position - 0x1268 Hash - 0xD0FD971 ^0x657364CB
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_61(int iParam0) // Position - 0x138F Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_62() // Position - 0x13A5 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_63() // Position - 0x13D2 Hash - 0x755841D8 ^0x18E6AE24
{
	if (!volLocal_21.f_1)
	{
		if (MISC::GET_FRAME_COUNT() % 10 == 0)
		{
			volLocal_21.f_3 = ENTITY::_SEARCH_BUILDING_POOL_FOR_ENTITY_WITH_THIS_MODEL(joaat("a_water_lmr_l_inside_ship"));
		
			if (ENTITY::DOES_ENTITY_EXIST(volLocal_21.f_3))
			{
				ENTITY::SET_ENTITY_VISIBLE(volLocal_21.f_3, false);
				volLocal_21.f_1 = 1;
			}
		}
	}
	...
	if (volLocal_21.f_2)
	{
		if (!func_109(PLAYER::PLAYER_PED_ID(), volLocal_21, 0, true))
		{
	...
	else if (func_109(PLAYER::PLAYER_PED_ID(), volLocal_21, 0, true))
	{
		WATER::DISABLE_WATER_LOOKUP();
		volLocal_21.f_2 = 1;
	}
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x147D Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x148C Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_66() // Position - 0x149D Hash - 0x463DA432 ^0x857E19AF
{
	return func_64(Global_1940199, 8192);
}

BOOL func_67(var uParam0, int iParam1) // Position - 0x14B0 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_68(int iParam0) // Position - 0x14C1 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x1501 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_70() // Position - 0x152E Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_71(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x153C Hash - 0x89AD6A19 ^0x9CC65DB7
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	else if (func_61(iParam0) && func_85(iParam0, 16777216) && !Global_1893611.f_9)
	{
	...
	{
		num = func_121(func_120());
		num2 = func_122(func_120());
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str2 = MISC::VAR_STRING(674, str3, num, func_124(&unk, joaat("COLOR_PURE_WHITE")), str4, func_124(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num, func_124(&unk, joaat("COLOR_PURE_WHITE")), func_124(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_72(var uParam0, int iParam1) // Position - 0x17A1 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_73(int iParam0, BOOL bParam1) // Position - 0x17B4 Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_74(BOOL bParam0) // Position - 0x1E1D Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_75(int iParam0) // Position - 0x1E46 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_76() // Position - 0x1E8B Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_77(int iParam0, BOOL bParam1) // Position - 0x1E93 Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x2658 Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_79(BOOL bParam0) // Position - 0x26AB Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_80(int iParam0) // Position - 0x26D4 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_81(int iParam0) // Position - 0x26DC Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_82(int iParam0) // Position - 0x270D Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2740 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(Hash hParam0) // Position - 0x27F6 Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x2870 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_86(int iParam0) // Position - 0x28A1 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_87(int iParam0) // Position - 0x28C2 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_88(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2915 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_89(int iParam0) // Position - 0x2FD5 Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_90(int iParam0) // Position - 0x2FEC Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x302F Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_89(iParam0))
		return 0;
...
BOOL func_92() // Position - 0x311A Hash - 0x9AF3EE3F ^0xBF53F360
{
...
BOOL func_93() // Position - 0x312E Hash - 0x16C45944 ^0x16C45944
{
	return func_143(func_57(0));
}

BOOL func_94(int iParam0) // Position - 0x313F Hash - 0x4B08C8C4 ^0x4B08C8C4
{
	return !func_144(iParam0);
}

void func_95(BOOL bParam0, BOOL bParam1) // Position - 0x314E Hash - 0x2F17103B ^0x1C4D2C36
{
	if (func_145(255) == 4)
		return;
	...
	{
		if (bParam1)
			func_147(0, false, 0, true);
	
		func_148(0);
		func_149(&(Global_1102813.f_3839));
		...
		func_150(&(Global_1102813.f_3878));
	...
	func_151(Global_1102813.f_3839, 36);
	func_152(Global_1102813.f_3878, 36);
	return;
}

void func_96(int iParam0, BOOL bParam1) // Position - 0x3299 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	else if (func_154(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	if (func_154(iParam0, 16384) && !flag)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_6))
		{
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_157(Global_1051832.f_92[iParam0 /*75*/].f_31[i]);
...
int func_97(Hash hParam0, int iParam1) // Position - 0x3648 Hash - 0x274C8E8A ^0x274C8E8A
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_98(int iParam0) // Position - 0x3FAE Hash - 0xF53EDEBA ^0xF53EDEBA
{
	if (!func_162(iParam0))
		return 0;

	if (Global_1051832.f_4492[iParam0] == 0)
		Global_1051832.f_4492[iParam0] = func_163(iParam0);

	return Global_1051832.f_4492[iParam0];
}

int func_99(int iParam0) // Position - 0x3FEF Hash - 0x5A1CB076 ^0x5A1CB076
{
	switch (iParam0)
	{
		case 3:
...
void func_100(int iParam0, int iParam1) // Position - 0x4096 Hash - 0xDCFC48D0 ^0xCB4861A2
{
...
void func_101(int iParam0) // Position - 0x40C5 Hash - 0x93134738 ^0x938C636D
{
...
BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x40FE Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4117 Hash - 0x16E871AD ^0x10C54C39
{
...
Hash func_104() // Position - 0x4141 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1893611.f_2;
}

BOOL func_105(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x414F Hash - 0xC625CFBA ^0x4612F745
{
	return func_164(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_106(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x416F Hash - 0xC625CFBA ^0x97094DE5
{
	return func_164(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_107(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x418F Hash - 0xCAA352A8 ^0x24D53CD4
{
	if (bParam6)
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);

	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_165(hParam1, vParam2, fParam5, 0, 0, false);
...
BOOL func_108(int iParam0) // Position - 0x420B Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_109(Ped pedParam0, Volume volParam1, int iParam2, BOOL bParam3) // Position - 0x4221 Hash - 0x425E360D ^0xB9BEF16F
{
...
BOOL func_110(int iParam0) // Position - 0x4255 Hash - 0x6A6EE485 ^0x6A6EE485
{
...
BOOL func_111() // Position - 0x428A Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_168(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x42CD Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_169(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_171(func_170(Global_34));
...
BOOL func_113(int iParam0) // Position - 0x4D33 Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_114(int iParam0) // Position - 0x4D48 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
Hash func_115(int iParam0) // Position - 0x4E03 Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	Hash bountyData;
	...
	i = 0;
	gamerHandle = { func_174(PLAYER::PLAYER_ID()) };
...
int func_116(int iParam0) // Position - 0x4E71 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_117(int iParam0) // Position - 0x4FCC Hash - 0x21CE226B ^0x1B4DCB4B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x5007 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_119(int iParam0, int iParam1) // Position - 0x5049 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_113(iParam0))
		return false;
...
BOOL func_120() // Position - 0x508E Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_121(BOOL bParam0) // Position - 0x509A Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_122(BOOL bParam0) // Position - 0x50AD Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_123(float fParam0) // Position - 0x50BF Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_124(var uParam0, int iParam1) // Position - 0x50D5 Hash - 0xB0CFF0C3 ^0x206A2B78
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
		return MISC::VAR_STRING(10, "LITERAL_STRING", uParam0);

	return func_175(MISC::VAR_STRING(10, "LITERAL_STRING", uParam0), iParam1);
}

int func_125(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x510B Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_126(int iParam0) // Position - 0x514E Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_172(iParam0))
		if (!func_173(44))
			return false;
...
void func_127(int iParam0, int iParam1) // Position - 0x516E Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_128(int iParam0, int iParam1) // Position - 0x517F Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_129(var uParam0, var uParam1, int iParam2) // Position - 0x5195 Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_130(int iParam0) // Position - 0x51B2 Hash - 0x3E288458 ^0xC75F9664
{
	func_176(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_177(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
...
void func_131(int iParam0) // Position - 0x5292 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_89(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_179(Global_1915656.f_3[iParam0 /*447*/].f_21))
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_157(Global_1915656.f_3[iParam0 /*447*/].f_318[i /*6*/]);
...
BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x546A Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_133(int iParam0, BOOL bParam1) // Position - 0x5498 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_89(iParam0))
		return 0;
...
int func_134(int iParam0) // Position - 0x551B Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_135(int iParam0) // Position - 0x5542 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_136() // Position - 0x5563 Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_137() // Position - 0x572A Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
Hash func_138(int iParam0) // Position - 0x57A5 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_89(iParam0))
		return 0;
...
void func_139(int iParam0, PersChar pchParam1) // Position - 0x57C3 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_89(iParam0))
		return;
...
PersChar func_140(int iParam0) // Position - 0x57E4 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_89(iParam0))
		return 0;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x5804 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_142(int iParam0) // Position - 0x583D Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_143(var uParam0, var uParam1) // Position - 0x5863 Hash - 0x1268D0E3 ^0x1268D0E3
{
	return func_189(uParam0, 5, 8);
}

BOOL func_144(int iParam0) // Position - 0x5876 Hash - 0xA3986FDD ^0xA3986FDD
{
	return func_190(1, iParam0);
}

int func_145(int iParam0) // Position - 0x5885 Hash - 0x8D78E39F ^0x46194076
{
	if (iParam0 == 255)
...
int func_146(int iParam0) // Position - 0x58D0 Hash - 0x5423E6F3 ^0xE2118439
{
	if (func_191(&(Global_1102813.f_4), iParam0, 5))
		return 1;

	return 0;
}

void func_147(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x58ED Hash - 0x79169E9C ^0xA3FE4569
{
	func_192(iParam0);
	...
	else if (!func_194(128) && !func_195(19))
		CAM::DO_SCREEN_FADE_OUT(iParam2);

	if (bParam3 && func_196() == 4)
		func_146(18);
...
int func_148(int iParam0) // Position - 0x594F Hash - 0x5423E6F3 ^0xE2118439
{
...
void func_149(var uParam0) // Position - 0x596C Hash - 0xCF95012E ^0xCF95012E
{
	var unk;
...
void func_150(float* pfParam0) // Position - 0x597E Hash - 0xFBC3ACC8 ^0xFBC3ACC8
{
	var unk;
...
void func_152(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x59E6 Hash - 0x6DF4F0B2 ^0x7B946ED1
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_153(int iParam0) // Position - 0x5A13 Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x5A70 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_155(int iParam0, int iParam1) // Position - 0x5A89 Hash - 0x9E30ADED ^0xA0DD8460
{
	func_154(iParam0, iParam1);
...
int func_156(int iParam0) // Position - 0x5AC4 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_157(Hash hParam0) // Position - 0x5AD8 Hash - 0xDB9A74EC ^0x13B3F16D
{
	if (func_199(hParam0) && func_200())
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(hParam0);

	return;
}

void func_158(int iParam0) // Position - 0x5AF8 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_159(int iParam0) // Position - 0x5B00 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_160(int iParam0, int iParam1) // Position - 0x5B15 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;

	return func_201(Global_1051832.f_92[iParam0 /*75*/].f_50, iParam1);
}

void func_161(int iParam0) // Position - 0x5B3C Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_162(int iParam0) // Position - 0x5BBB Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_163(int iParam0) // Position - 0x5BD1 Hash - 0xB89C4DF3 ^0x1393EE39
{
	var unk;

	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149432.f_7) && !func_203(12, func_202(iParam0), &unk))
		return 0;

	return unk.f_2;
}

BOOL func_164(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5C02 Hash - 0x5851BC53 ^0x8A1263E0
{
	int num;

	num = func_204();
	num.f_2 = -738708473;
	num.f_3 = func_202(iParam0);
...
int func_165(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5C8A Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_166() // Position - 0x5CA4 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_167() // Position - 0x5CAD Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_168(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5D15 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_207(func_57(0)))
		return true;
...
const char* func_169(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5E8B Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_170(var uParam0, var uParam1, var uParam2) // Position - 0x5E9F Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;

	for (i = 0; i < 51; i = i + 1)
	{
		if (func_209(uParam0, i))
			return i;
	}
...
const char* func_171(int iParam0) // Position - 0x5ECD Hash - 0xE6862179 ^0xE5023107
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_172(int iParam0) // Position - 0x61B1 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_173(int iParam0) // Position - 0x61DB Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_210(iParam0))
		return false;
...
struct<2> func_174(Player plParam0) // Position - 0x61F7 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_175(const char* sParam0, int iParam1) // Position - 0x620B Hash - 0x9E99F03 ^0x84D91242
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_176(int iParam0, BOOL bParam1) // Position - 0x6225 Hash - 0x2F9EB0B9 ^0xE3F0CE80
{
	char* ambientZone;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x6259 Hash - 0x342D57CF ^0x6370AF04
{
	switch (iParam0)
	{
		case 5:
...
void func_178(int iParam0, int iParam1) // Position - 0x628E Hash - 0x823E3440 ^0x340E01B4
{
	func_212(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_179(int iParam0) // Position - 0x62A8 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_89(iParam0))
		return false;
...
void func_180(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x62CD Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_179(iParam0) && func_213(iParam0))
		return;

	func_141(iParam0, 1);
	func_186(iParam0);

	if (func_214(func_138(iParam0)))
	{
...
void func_181(int iParam0, BOOL bParam1) // Position - 0x63B9 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_162(iParam0))
		return;
...
void func_182(int iParam0, int iParam1) // Position - 0x640F Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_219(iParam0))
		return;
...
int func_183(int iParam0) // Position - 0x6482 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_184(int iParam0) // Position - 0x6498 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_185(int iParam0, BOOL bParam1) // Position - 0x64AE Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_186(int iParam0) // Position - 0x64DF Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_187(int iParam0) // Position - 0x6523 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_188(int iParam0) // Position - 0x6538 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_189(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x654D Hash - 0x9EA53184 ^0x9EA53184
{
	int num;
...
BOOL func_190(int iParam0, int iParam1) // Position - 0x6588 Hash - 0x61AB4BED ^0x265134F3
{
	int num;
	...
	if (iParam1 == 255)
		return func_222(&(Global_1102813.f_4), num, 5);
	...
	if (Global_1295666.f_17[iParam1])
		return func_222(&(Global_1101558[iParam1 /*38*/].f_4), num, 5);

	return false;
}

BOOL func_191(int* piParam0, int iParam1, int iParam2) // Position - 0x65FC Hash - 0x8AC008A3 ^0x375BADC3
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_192(int iParam0) // Position - 0x662E Hash - 0x42868A8 ^0x3D52297C
{
	Global_1102813.f_26.f_12 = iParam0;
	return;
}

BOOL func_193(int iParam0) // Position - 0x6640 Hash - 0xA1D29AFD ^0xABA18533
{
	return Global_1102813.f_26.f_7 && iParam0 != false;
}

BOOL func_194(BOOL bParam0) // Position - 0x6655 Hash - 0xA1D29AFD ^0x8B9D4F17
{
	return Global_1102813.f_26.f_9 && bParam0 != false;
}

BOOL func_195(int iParam0) // Position - 0x666A Hash - 0x10DA64DD ^0x85E01D27
{
	return Global_1102813.f_4[Global_1106895[iParam0 /*2*/]] && Global_1106895[iParam0 /*2*/].f_1 == Global_1106895[iParam0 /*2*/].f_1;
}

int func_196() // Position - 0x6698 Hash - 0xE5D277D5 ^0xE5D277D5
{
	if (Global_1102813 <= 5)
...
void func_197(BOOL bParam0) // Position - 0x66CB Hash - 0xEBD3AD20 ^0x6E10961F
{
	if (func_224(bParam0))
		return;
...
BOOL func_198(int* piParam0, int iParam1, int iParam2) // Position - 0x66F2 Hash - 0xA8F08582 ^0x9810C45C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_199(Hash hParam0) // Position - 0x6725 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_225(hParam0))
...
BOOL func_200() // Position - 0x6740 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

BOOL func_201(BOOL bParam0, BOOL bParam1) // Position - 0x6749 Hash - 0x178D9C09 ^0x178D9C09
{
	return bParam0 && bParam1 != false;
}

int func_202(int iParam0) // Position - 0x6758 Hash - 0xB8EC44B7 ^0x241D648F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_203(int iParam0, int iParam1, var uParam2) // Position - 0x7140 Hash - 0xDC10368D ^0xDC10368D
{
	var unk;

	if (func_226(iParam0, iParam1, &unk))
		func_227(&unk, iParam0, uParam2);
	else
		return false;
...
int func_204() // Position - 0x7167 Hash - 0x4F5358E7 ^0x4EB0CC4F
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_205() // Position - 0x717C Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_207(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_206() // Position - 0x71D4 Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_207(var uParam0, var uParam1) // Position - 0x71E2 Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_228(uParam0))
		return false;
...
struct<2> func_208() // Position - 0x7216 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_209(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7261 Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;
...
BOOL func_210(int iParam0) // Position - 0x7291 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_211(int iParam0) // Position - 0x72A4 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_212(int iParam0, int iParam1) // Position - 0x72CE Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_213(int iParam0) // Position - 0x72E3 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_214(Hash hParam0) // Position - 0x7307 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_215(int iParam0, BOOL bParam1) // Position - 0x7313 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_162(iParam0))
		return false;
...
void func_216(int iParam0, BOOL bParam1) // Position - 0x7339 Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_162(iParam0))
		return;
...
void func_217(int iParam0, BOOL bParam1) // Position - 0x7367 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_162(iParam0))
		return;
...
void func_218(int iParam0) // Position - 0x73A1 Hash - 0xB29062D ^0xB29062D
{
	func_233(func_232(iParam0));
	return;
}

BOOL func_219(int iParam0) // Position - 0x73B3 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_220(int iParam0) // Position - 0x73C9 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
int func_221(int iParam0, var uParam1) // Position - 0x73F7 Hash - 0x9C3ED8B4 ^0x9C3ED8B4
{
	if (iParam0 == 2)
...
BOOL func_222(int* piParam0, int iParam1, int iParam2) // Position - 0x7411 Hash - 0x15F7E5EE ^0x39F4E7C
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_223() // Position - 0x7448 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1102813.f_3672;
}

BOOL func_224(BOOL bParam0) // Position - 0x7457 Hash - 0x695C3191 ^0x86E70E17
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_225(Hash hParam0) // Position - 0x746D Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_226(int iParam0, int iParam1, Any* panParam2) // Position - 0x7479 Hash - 0x8467BB0B ^0xA289B29B
{
	*panParam2 = Global_1149432.f_7;
	panParam2->f_2 = 1351168281;
	panParam2->f_3 = func_235(iParam0);
	panParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam2->f_1), panParam2);
}

void func_227(Any* panParam0, int iParam1, var uParam2) // Position - 0x74AD Hash - 0x59F43AD2 ^0xB9A366FE
{
	var unk;
...
BOOL func_228(int iParam0) // Position - 0x7527 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_229(int iParam0) // Position - 0x7566 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_230(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x75FC Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x809E Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_232(int iParam0) // Position - 0x8104 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_233(int iParam0) // Position - 0x8621 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_234(var uParam0, var uParam1) // Position - 0x8632 Hash - 0xF9339824 ^0x8CB8B693
{
	var unk;
	...
	if (func_236(uParam0, &unk))
		return unk.f_1;

	return -1;
}

int func_235(int iParam0) // Position - 0x865E Hash - 0x5FB59AC3 ^0xE293EFF
{
	int num;
...
BOOL func_236(int iParam0, var uParam1, Any* panParam2) // Position - 0x87D3 Hash - 0xEDAACC68 ^0x7998E850
{
	if (!func_207(iParam0))
		return false;
...
void func_237(Any* panParam0) // Position - 0x88DE Hash - 0xE2B2004A ^0x20B50C0B
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
