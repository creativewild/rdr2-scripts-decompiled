...
void main() // Position - 0x0 Hash - 0xF67D5A80 ^0xDBD0A5F1
{
	BOOL flag;
...
void func_1() // Position - 0x4E Hash - 0x93CB8779 ^0xB3D1DA9
{
...
void func_4() // Position - 0x175 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}
