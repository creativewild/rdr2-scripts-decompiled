#region Local Var
	...
	var uLocal_46 = 0;
	int iLocal_47 = 0;
	ePedType eptLocal_48 = PED_TYPE_PLAYER_0;
	int iLocal_49 = 0;
	var uLocal_50 = 0;
	var uLocal_51 = 0;
	var uLocal_52 = 0;
...
void main() // Position - 0x0 Hash - 0x20B6E41B ^0x76864BAD
{
	fLocal_14 = 1f;
	fLocal_15 = 1f;
	eptLocal_48 = joaat("s_m_m_ambientlawrural_01");
...
BOOL func_3(var uParam0) // Position - 0x70 Hash - 0x4A181B5A ^0x4A181B5A
{
	return false;
}

void func_4() // Position - 0x79 Hash - 0xB6A7A115 ^0xC264D423
{
	switch (iLocal_47)
	{
		case 1:
		...
		case 2:
			STREAMING::REQUEST_MODEL(eptLocal_48, false);
		
			if (STREAMING::HAS_MODEL_LOADED(eptLocal_48) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
				iLocal_47 = 4;
			break;
...
int func_5(int iParam0) // Position - 0xE5 Hash - 0x562558FC ^0x562558FC
{
	int num;
...
BOOL func_6() // Position - 0x137 Hash - 0x2FCFB1E1 ^0x2FCFB1E1
{
	Ped ped;
	...
	ped = func_8(eptLocal_48, uLocal_44, 0, true, true, 0, true, true, true, false, false);
	PED::SET_PED_AS_COP(ped, true);
	func_9(&ped, true, false, true);
	func_10(&uLocal_50, 1, false);
...
BOOL func_7() // Position - 0x18C Hash - 0x4DF488A2 ^0x6E8D6D5F
{
	float num;
	float num2;
	int num3;
	...
	num = 55f;
	num2 = 90f;
	num3 = func_11(iLocal_49, uLocal_50.f_2);
	num4 = (float)num3 * 25f;
	num5 = num4 + 45f;
	...
	if (!func_12(Global_34, &uLocal_50, &unk, 1, true, num5, 50f, num, num2, num4))
		return false;

	uLocal_44 = { uLocal_50.f_3 };
	return true;
}

Ped func_8(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x216 Hash - 0xA67C0C52 ^0xA10AD291
{
	Ped ped;
	...
	func_13(ped, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return ped;
}

void func_9(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x256 Hash - 0xEB76F1D1 ^0xF1B7E213
{
...
void func_10(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2C4 Hash - 0xDC7EB85A ^0x8E2A3227
{
	uParam0->f_2 = 0;
...
int func_11(var uParam0, var uParam1) // Position - 0x2FF Hash - 0xD4B46002 ^0xD4B46002
{
	if (uParam0 > uParam1)
		return uParam0;
...
BOOL func_12(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0x315 Hash - 0xC31BF175 ^0x915D2C1C
{
	int num;
	...
	switch (*uParam3)
	{
		case 0:
			...
			func_14(&(uParam3->f_1), uParam3->f_2, uParam0, iParam5, fParam7, fParam8, fParam9, fParam10, fParam11);
			...
			{
				func_15(&(uParam3->f_1), iParam5, uParam0);
			
				if (!_IS_NULL_VECTOR(uParam3->f_6))
					TASK::_0xCE4E669400E5F8AA(uParam3->f_1, func_17(uParam3->f_6));
...
void func_13(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x43A Hash - 0x81861438 ^0x93C66BE8
{
	BOOL flag;
...
void func_14(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10) // Position - 0x504 Hash - 0xF3743088 ^0xD7A675F3
{
	int num;
	int num2;
	...
	if (fParam8 == -0.01f)
	{
		switch (iParam5)
		{
			...
			case 36:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(10f, 40f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(30f, 60f, 5f, iParam1));
			...
			case 37:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(40f, 80f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(50f, 90f, 5f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 10f);
			...
			case 38:
				TASK::_0x2EB977293923C723(*uParam0, 30f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(30f, 60f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(50f, 80f, 5f, iParam1));
			...
			case 39:
				TASK::_0x2EB977293923C723(*uParam0, 10f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(0f, 10f, 1f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(5f, 15f, 1f, iParam1));
			...
			case 40:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(60f, 120f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(100f, 130f, 5f, iParam1));
			...
			case 41:
				TASK::_0x2EB977293923C723(*uParam0, 10f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(10f, 35f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(25f, 50f, 5f, iParam1));
			...
			case 42:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(50f, 70f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(65f, 85f, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
			...
			case 43:
				TASK::_0x2EB977293923C723(*uParam0, func_21(95f, 90f, 80f, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(95f, 90f, 80f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(125f, 115f, 100f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 5f);
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			...
			case 45:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(60f, 80f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(75f, 95f, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
				TASK::_0x450080DDEDB91258(*uParam0, 25f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			...
			case 46:
				num = func_22(uParam2, true);
				num2 = func_23(uParam2);
			
				if (num2 == 15 || num2 == 14 || num2 == 13 || num2 == 9 && num == -1 || num2 == 4 && num == -1)
				{
					TASK::_0x2EB977293923C723(*uParam0, func_21(100f, 80f, -5f, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, func_21(100f, 80f, -5f, iParam1));
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(110f, 160f, 12.5f, iParam1));
				}
				else
				{
					TASK::_0x2EB977293923C723(*uParam0, func_21(100f, 70f, -7.5f, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, 70f);
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(80f, 150f, 17.5f, iParam1));
				}
			...
			case 47:
				...
				TASK::_0x2EB977293923C723(*uParam0, 50f);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(50f, 90f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
			...
			case 48:
				...
				TASK::_0x2EB977293923C723(*uParam0, func_21(100f, 70f, -7.5f, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, 70f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(150f, 190f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
			...
			case 49:
				...
				TASK::_0x2EB977293923C723(*uParam0, 50f);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(10f, 50f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
		
			case 50:
				TASK::_0x2EB977293923C723(*uParam0, 30f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(30f, 70f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(65f, 95f, 5f, iParam1));
			...
			case 51:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_21(25f, 35f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(40f, 50f, 5f, iParam1));
			...
			case 52:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_21(40f, 100f, 10f, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
...
void func_15(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1312 Hash - 0xF7709AA0 ^0xA0B87357
{
	switch (iParam1)
	{
		case 0:
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1AD2 Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_17(float fParam0, var uParam1, var uParam2) // Position - 0x1AFC Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_18(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B3B Hash - 0x4FE4E8A8 ^0x44655508
{
...
void func_19(Ped pedParam0, BOOL bParam1) // Position - 0x1B80 Hash - 0xC422C7A4 ^0x3D93F520
{
...
void func_20(Ped pedParam0, int iParam1) // Position - 0x1BC5 Hash - 0xF0F93A59 ^0xE762BF9D
{
	if (iParam1 == 1)
...
float func_21(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x1BEC Hash - 0x3A11F625 ^0x3A11F625
{
	float num;
...
int func_22(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1C11 Hash - 0x4DC6667D ^0xBA61FD45
{
	int num;
	...
	return func_26(vParam0, bParam3);
}

int func_23(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1C5F Hash - 0x56F0811C ^0x278FB5A
{
	return func_27(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

int func_24() // Position - 0x1C75 Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1893611.f_2;
}

BOOL func_25(int iParam0) // Position - 0x1C83 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_26(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1C99 Hash - 0xA4504257 ^0xA4504257
{
	int num;
	int num2;
	int num3;
...
int func_27(Hash hParam0) // Position - 0x1D50 Hash - 0x50573299 ^0x50573299
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_28(var uParam0, var uParam1, var uParam2) // Position - 0x1E0A Hash - 0x5486635E ^0x2FAAB3B2
{
	int num;

	num = func_29(uParam0, 0f, 0f, 0, 2);
	return func_29(uParam0, Global_1892764[num /*3*/].f_1, Global_1892764[num /*3*/].f_2, Global_1892764[num /*3*/], 4);
}

int func_29(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x1E45 Hash - 0xA452440E ^0xD3F785A1
{
	if (fParam0 < fParam3)
