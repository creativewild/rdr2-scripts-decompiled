...
void main() // Position - 0x0 Hash - 0x5B140B50 ^0xD1F02007
{
	...
	fLocal_15 = 1f;
	iLocal_53 = 20000;
	iLocal_56 = iScriptParam_0;
	iLocal_54 = iScriptParam_0.f_2;
	bLocal_58 = false;
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_55)
		{
			...
			switch (iLocal_54)
			{
				case 0:
					if (Global_1901671.f_2.f_26 > 0)
					{
						iLocal_57 = MISC::GET_GAME_TIMER() + Global_1901671.f_2.f_26;
						iLocal_54 = 1;
					}
					else
					{
				...
				case 1:
					if (!func_1() || iLocal_57 < MISC::GET_GAME_TIMER())
					{
						bLocal_58 = false;
						iLocal_54 = 2;
					}
				...
				case 2:
					...
					if (func_10(func_9(iLocal_56)))
						func_11(func_9(iLocal_56), 4);
				
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_56));
					Global_1896644 = -1;
					iLocal_57 = iLocal_53 + MISC::GET_GAME_TIMER();
					iLocal_54 = 3;
					break;
			
				case 3:
					if (func_13() || iLocal_57 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT(iLocal_56);
						iLocal_57 = MISC::GET_GAME_TIMER() + iLocal_53;
						iLocal_54 = 4;
					}
					break;
			
				case 4:
					if (func_15(iLocal_56) || iLocal_57 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_56);
						iLocal_57 = MISC::GET_GAME_TIMER() + iLocal_53;
						iLocal_54 = 5;
				...
				case 5:
					if (func_17(iLocal_56) || iLocal_57 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0(iLocal_56);
						iLocal_57 = iLocal_53 + MISC::GET_GAME_TIMER();
						iLocal_54 = 7;
					}
					break;
				...
				case 7:
					if (func_10(func_9(iLocal_56)))
						if (func_19(func_9(iLocal_56), 4) && !(iLocal_57 < MISC::GET_GAME_TIMER()))
							break;
				
					if (func_20(iLocal_56) || iLocal_57 < MISC::GET_GAME_TIMER())
					{
						func_21(iLocal_56, 4);
						iLocal_57 = MISC::GET_GAME_TIMER() + iLocal_53;
						iLocal_54 = 8;
				...
				case 8:
					...
					func_27();
					func_28();
					_DEBUG_PRINT_0_0_0(iLocal_56);
					_DEBUG_PRINT_0_0_0_0(iLocal_56);
					func_31();
					func_32();
					iLocal_54 = 9;
					break;
				...
				case 10:
					...
					func_36(iLocal_56, &Global_1896698);
					iLocal_54 = 11;
					break;
				...
				case 12:
					if (func_40(iLocal_56))
						iLocal_55 = MISC::GET_GAME_TIMER() + 1000;
				
					func_41(&Global_1896698, iLocal_56);
					func_42(iLocal_56);
					func_21(iLocal_56, 8);
					...
					PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_56 /*36*/].f_11);
				
					if (Global_1887363[iLocal_56 /*36*/].f_12 > 0f)
						PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_56 /*36*/].f_12);
					break;
		...
		if (Global_1887363[iLocal_56 /*36*/].f_13 == 0)
		{
		}
		else
		{
			PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1887363[iLocal_56 /*36*/].f_13);
		}
...
BOOL func_13() // Position - 0x7D0 Hash - 0x5C632287 ^0x534AD2D1
{
	volLocal_19 = Global_1887363[60 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(volLocal_19, 14);
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(volLocal_19, 12519, 18432, 0, -1, -1, 2);
	POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(volLocal_19, 12775, 18432, 0, -1, -1, 0);
	POPULATION::_0x2161278C6322F740(12775, 18432, 0, -1, -1, volLocal_19);
	func_53(volLocal_19, false);
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x823 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x82F Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x83C Hash - 0xA7E8EE3C ^0x4D1EBE53
{
	if (func_45() == -1)
		if (bLocal_41)
			func_21(iParam0, 16);
...
BOOL func_17(int iParam0) // Position - 0x882 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x88F Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x89B Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8B0 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_56(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8C1 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x900 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x90C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x914 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_57(iParam0))
		return true;
...
void func_27() // Position - 0x9D4 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x9DC Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9E4 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x9F0 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x9FC Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xA04 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_33(int iParam0) // Position - 0xA0C Hash - 0x27A575FA ^0x27A575FA
{
	func_61(0.775f, 0.2f, 0.025f, 0f);
	return;
}

void func_34() // Position - 0xA28 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xA59 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA9F Hash - 0x41BC629D ^0x41BC629D
{
	iParam0 = iParam0;
	func_62(uParam1, volLocal_19, 1);
	return;
}

void func_37(int iParam0) // Position - 0xAB4 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_63(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xACD Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xADE Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xAF6 Hash - 0x4A181B5A ^0x4A181B5A
{
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xAFF Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC3E Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC4B Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xC81 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_77();
		LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), 0);
		func_21(iLocal_56, 2048);
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_56)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_56, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_83(iLocal_56, false))
			return false;
	}
	else if (!func_84(iLocal_56))
	{
		return false;
	}
...
int func_45() // Position - 0xD95 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDA3 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDAF Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xDDA Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE1C Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xEFC Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF1A Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF2D Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53(Volume volParam0, BOOL bParam1) // Position - 0xF4B Hash - 0xD6642292 ^0x5A7BA218
{
	int num;
...
void func_54(int iParam0, BOOL bParam1) // Position - 0xF6E Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
BOOL func_55() // Position - 0xFC1 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_56(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xFCA Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_57(int iParam0) // Position - 0x10C2 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_58(int iParam0) // Position - 0x10D3 Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_59(int iParam0) // Position - 0x10E7 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_60(var uParam0, var uParam1) // Position - 0x10FB Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

void func_61(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1105 Hash - 0x1E885EDE ^0x3AA465F4
{
...
void func_62(var uParam0, Volume volParam1, int iParam2) // Position - 0x112D Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_63(int iParam0) // Position - 0x1186 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_64() // Position - 0x119C Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x11C9 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x11D8 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_67() // Position - 0x11E9 Hash - 0x463DA432 ^0x857E19AF
{
	return func_65(Global_1940199, 8192);
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x11FC Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_69(int iParam0) // Position - 0x120D Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_70(int iParam0, int iParam1) // Position - 0x124D Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_71() // Position - 0x127A Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_72(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1288 Hash - 0x659AC4C5 ^0x8A3286AA
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	else if (func_63(iParam0) && func_85(iParam0, 16777216) && !Global_1893611.f_9)
	{
	...
	{
		num = func_105(func_104());
		num2 = func_106(func_104());
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str2 = MISC::VAR_STRING(674, str3, num, func_108(&unk, joaat("COLOR_PURE_WHITE")), str4, func_108(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num, func_108(&unk, joaat("COLOR_PURE_WHITE")), func_108(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_73(var uParam0, int iParam1) // Position - 0x14EC Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_74(int iParam0, BOOL bParam1) // Position - 0x14FF Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_75(BOOL bParam0) // Position - 0x1B68 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_76(int iParam0) // Position - 0x1B91 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_77() // Position - 0x1BD6 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_78(int iParam0, BOOL bParam1) // Position - 0x1BDE Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_79(BOOL bParam0) // Position - 0x23A3 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_80(int iParam0) // Position - 0x23CC Hash - 0xA53F62E9 ^0xD61F0844
{
	func_61(0.775f, 0.2f, 0.025f, 0f);
	...
	func_115(volLocal_20);
	func_115(volLocal_21);
	func_115(volLocal_22);
...
void func_81(int iParam0) // Position - 0x245B Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_82(int iParam0) // Position - 0x248C Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x24BF Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(Hash hParam0) // Position - 0x2575 Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x25EF Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_86(int iParam0) // Position - 0x2620 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_87(int iParam0) // Position - 0x2641 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_88(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2694 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_89(int iParam0) // Position - 0x2D54 Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_90(int iParam0) // Position - 0x2D6B Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x2DAE Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_89(iParam0))
		return 0;
...
BOOL func_92(int iParam0) // Position - 0x2E99 Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_93(int iParam0) // Position - 0x2EAF Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_94(int iParam0) // Position - 0x2EC5 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_55())
		return true;
...
BOOL func_95() // Position - 0x2EFA Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
...
const char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2F3D Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;
...
BOOL func_97(int iParam0) // Position - 0x399C Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_98(int iParam0) // Position - 0x39B1 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
Hash func_99(int iParam0) // Position - 0x3A6C Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_100(int iParam0) // Position - 0x3ADA Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_101(int iParam0) // Position - 0x3C35 Hash - 0x21CE226B ^0x117FC044
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x3C70 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_103(int iParam0, int iParam1) // Position - 0x3CB2 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_97(iParam0))
		return false;
...
BOOL func_104() // Position - 0x3CF7 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_105(BOOL bParam0) // Position - 0x3D03 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_106(BOOL bParam0) // Position - 0x3D16 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_107(float fParam0) // Position - 0x3D28 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_108(var uParam0, int iParam1) // Position - 0x3D3E Hash - 0xB0CFF0C3 ^0x9F1AE808
{
...
int func_109(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3D74 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_110(int iParam0) // Position - 0x3DB7 Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_136(iParam0))
		if (!func_137(44))
			return false;
...
void func_111(int iParam0, int iParam1) // Position - 0x3DD7 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_112(int iParam0, int iParam1) // Position - 0x3DE8 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_113(var uParam0, var uParam1, int iParam2) // Position - 0x3DFE Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_114(Volume volParam0, var uParam1) // Position - 0x3E1B Hash - 0xBA8C9219 ^0x3ACD28B4
{
...
void func_115(Volume volParam0) // Position - 0x3E82 Hash - 0x7DD010A2 ^0x16530136
{
...
void func_116(BOOL bParam0) // Position - 0x3E99 Hash - 0x5D1342E6 ^0x41116E92
{
	if (bParam0)
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
		func_140(&Global_1940199, 8388608);
	}
	else
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
		func_111(&Global_1940199, 8388608);
	}
...
void func_117(int iParam0) // Position - 0x3F3C Hash - 0x3E288458 ^0xC75F9664
{
...
void func_118(int iParam0) // Position - 0x401E Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_89(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_144(Global_1915656.f_3[iParam0 /*447*/].f_21))
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x41F6 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_120(int iParam0, BOOL bParam1) // Position - 0x4224 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_89(iParam0))
		return 0;
...
int func_121(int iParam0) // Position - 0x42A7 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_122(int iParam0) // Position - 0x42CE Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_123() // Position - 0x42EF Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_124() // Position - 0x44B6 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x4531 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
...
Hash func_126(int iParam0) // Position - 0x48E0 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_89(iParam0))
		return 0;
...
void func_127(int iParam0, PersChar pchParam1) // Position - 0x48FE Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_89(iParam0))
		return;
...
PersChar func_128(int iParam0) // Position - 0x491F Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_89(iParam0))
		return 0;
...
void func_129(int iParam0, BOOL bParam1) // Position - 0x493F Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_130(int iParam0) // Position - 0x4978 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_131() // Position - 0x499E Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_132(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4A06 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_166(func_59(0)))
		return true;
...
const char* func_133(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4B7C Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_134(var uParam0, var uParam1, var uParam2) // Position - 0x4B90 Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_135(int iParam0) // Position - 0x4BBE Hash - 0xE6862179 ^0xFB4FB2C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_136(int iParam0) // Position - 0x4EA2 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_137(int iParam0) // Position - 0x4ECC Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_169(iParam0))
		return false;
...
struct<2> func_138(Player plParam0) // Position - 0x4EE8 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_139(const char* sParam0, int iParam1) // Position - 0x4EFC Hash - 0x9E99F03 ^0xEF793D5A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_140(int iParam0, int iParam1) // Position - 0x4F16 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_141(int iParam0, BOOL bParam1) // Position - 0x4F2B Hash - 0x2F9EB0B9 ^0x60E893CE
{
	char* ambientZone;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x4F5F Hash - 0x342D57CF ^0x2222C2EF
{
	switch (iParam0)
	{
		case 5:
...
void func_143(int iParam0, int iParam1) // Position - 0x4F94 Hash - 0x823E3440 ^0x340E01B4
{
	func_171(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_144(int iParam0) // Position - 0x4FAE Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_89(iParam0))
		return false;
...
void func_145(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4FD3 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x50BF Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_174(iParam0))
		return;
...
void func_147(int iParam0, int iParam1) // Position - 0x5115 Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_179(iParam0))
		return;
...
int func_148(int iParam0) // Position - 0x5188 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_149(Hash hParam0) // Position - 0x519E Hash - 0xDB9A74EC ^0x13B3F16D
{
...
void func_150(int iParam0) // Position - 0x51BE Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_151(int iParam0, BOOL bParam1) // Position - 0x51D4 Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_152(int iParam0) // Position - 0x5205 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_153(int iParam0) // Position - 0x5249 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_154(int iParam0) // Position - 0x525E Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_155(int iParam0) // Position - 0x5273 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_156(int iParam0) // Position - 0x5288 Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_157(int iParam0) // Position - 0x5307 Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_158(int iParam0, BOOL bParam1) // Position - 0x5364 Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x537D Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_160(int iParam0, int iParam1) // Position - 0x5396 Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_161(int iParam0) // Position - 0x53D1 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_162(int iParam0) // Position - 0x53E5 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_163(int iParam0, int iParam1) // Position - 0x53ED Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;
...
BOOL func_164() // Position - 0x5414 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_166(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_165() // Position - 0x546C Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_166(var uParam0, var uParam1) // Position - 0x547A Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_184(uParam0))
		return false;
	...
	if (uParam0.f_1 >= func_185(uParam0))
		return false;

	return true;
}

struct<2> func_167() // Position - 0x54AE Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_168(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x54F9 Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;

	func_186(iParam3, &unk, &num, &num2);

	if (func_187(uParam0, unk, num, num.f_1, num2))
		return true;

	return false;
}

BOOL func_169(int iParam0) // Position - 0x5529 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_170(int iParam0) // Position - 0x553C Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_171(int iParam0, int iParam1) // Position - 0x5566 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_172(int iParam0) // Position - 0x557B Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_173(Hash hParam0) // Position - 0x559F Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_174(int iParam0) // Position - 0x55AB Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_175(int iParam0, BOOL bParam1) // Position - 0x55C1 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_174(iParam0))
		return false;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x55E7 Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_174(iParam0))
		return;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x5615 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_174(iParam0))
		return;
...
void func_178(int iParam0) // Position - 0x564F Hash - 0xB29062D ^0xB29062D
{
	func_189(func_188(iParam0));
	return;
}

BOOL func_179(int iParam0) // Position - 0x5661 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_180(Hash hParam0) // Position - 0x5677 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_190(hParam0))
...
BOOL func_181() // Position - 0x5692 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

Ped func_182(int iParam0) // Position - 0x569B Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_183(BOOL bParam0, BOOL bParam1) // Position - 0x56C9 Hash - 0x178D9C09 ^0x178D9C09
{
	return bParam0 && bParam1 != false;
}

BOOL func_184(int iParam0) // Position - 0x56D8 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_185(int iParam0) // Position - 0x5717 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_186(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x57AD Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_187(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x624A Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_188(int iParam0) // Position - 0x62B0 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_189(int iParam0) // Position - 0x67CD Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_190(Hash hParam0) // Position - 0x67DE Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
