...
BOOL func_13() // Position - 0x7D0 Hash - 0x653F0D7B ^0xC942F9AF
{
	volLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volPostOfficePrompt Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_20, -1301.158f, 398.81f, 95.65845f, 0f, 0f, 61.99999f, 1.32f, 1.421f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_20, -1299.192f, 402.038f, 95.658f, 0f, 0f, 61.99999f, 1.537f, 2.022f, 3f);
	volLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volPostOfficeOwner");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, -1301.045f, 400.748f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 5f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, -1301.309f, 398.458f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 2.006f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, -1298.877f, 402.661f, 95.8015f, 0f, 0f, 61.99999f, 3.035f, 2.644f, 3f);
	VOLUME::_0xB469CFD9E065EB99(volLocal_19, 10047);
	volLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volGeneralShop Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -1303.001f, 395.221f, 95.824f, 0f, 0f, 62f, 13.808f, 6.791f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -1296.65f, 397.28f, 95.553f, 0f, 0f, 62f, 3.882f, 2.263f, 2.603f);
	volLocal_22 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1303.289f, 394.199f, 95.824f, 0f, 0f, 62f, 2.042f, 1.5f, 3f, "WalStn-m_volGeneralShopPrompt");
	volLocal_23 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1301.095f, 393.54602f, 95.824f, 0f, 0f, 60.000004f, 3.235947f, 2.050864f, 3f, "WalStn-m_volGeneralShopOff");
	VOLUME::_0xB469CFD9E065EB99(volLocal_21, 10112);
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x96A Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x976 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x983 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_17(int iParam0) // Position - 0x98B Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x994 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x9A0 Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x9B5 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x9C6 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xA05 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xA11 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xA19 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xAC9 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0xAD1 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0xAD9 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0xAE1 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_29(int iParam0) // Position - 0xAE9 Hash - 0xD78B3015 ^0xFE7E99CB
{
	func_58(3, volLocal_21, iParam0, volLocal_22, volLocal_23, 4, false, false, -1082130432, 0);
	func_59(3, 96424206, 0, false, false);
	func_59(3, 381066979, 0, false, false);
	func_60(3, 8192);
	func_61(3, false);
	func_58(2, volLocal_19, iParam0, volLocal_20, 0, 1277952, false, false, -1082130432, 0);
	func_59(2, 96424206, 0, false, false);
	func_59(2, 381066979, 0, false, false);
	func_61(2, false);
	return;
}

void func_30(int iParam0) // Position - 0xB69 Hash - 0x21EF4CBD ^0xDB91E852
{
	func_62(796, volLocal_19, true);
	func_62(797, volLocal_21, true);
	return;
}

void func_31() // Position - 0xB87 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xB8F Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xB97 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xBA3 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xBD4 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xC1A Hash - 0x3290A14C ^0x3290A14C
{
	func_63(uParam1, volLocal_21, 2);
	func_63(uParam1, volLocal_19, 10);
	return;
}

void func_37(int iParam0) // Position - 0xC35 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_64(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xC4E Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xC5F Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xC77 Hash - 0xD82145E5 ^0xD82145E5
{
	func_66(100, volLocal_19, &uLocal_24);
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xC8A Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	if (BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_67(Global_1940199, 32768) || func_67(Global_1940199, 16777216))
		return;
			...
			case 1:
				if (VOLUME::DOES_VOLUME_EXIST(uParam0->[i /*3*/]))
				{
					if (VOLUME::IS_POINT_IN_VOLUME(uParam0->[i /*3*/], Global_34))
					{
						if (!flag2 && !flag3)
						{
							if (!func_70(&uParam0->[i /*3*/], 1) && func_71(iParam1) && !func_72(iParam1, 16))
							{
								func_74(iParam1, func_73(), -1, false, -1, false);
								func_75(&uParam0->[i /*3*/], 1);
							}
						
							func_76(iParam1, false);
						}
...
int func_42(int iParam0) // Position - 0xDC9 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xDD6 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xE0C Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_79();
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_80(iLocal_28, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_86(iLocal_28, false))
			return false;
	}
	else if (!func_87(iLocal_28))
	{
		return false;
	}
...
int func_45() // Position - 0xF20 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xF2E Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xF3A Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xF65 Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xFA7 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1087 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x10A5 Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x10B8 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x10D6 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
	...
	if (func_91(iParam0, &num, &num2, false, false))
	{
		...
		while (true)
		{
			if (!func_89(iParam0) || func_90(iParam0) || func_93(Global_1896644))
				func_94(Global_1896644, false);
...
BOOL func_54(int iParam0) // Position - 0x11CE Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x11DF Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x11F3 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1207 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1211 Hash - 0x11E8E9ED ^0xEE89D83
{
	if (iParam0 == 9 && !(!func_95() && func_96()))
		if (func_97(255))
	...
	Global_1051832.f_92[iParam0 /*75*/].f_18 = func_100(iParam2, iParam0);
...
void func_59(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13C0 Hash - 0x95E39C5E ^0x11A3DB9C
{
	int num;
	...
	Global_1051832.f_92[iParam0 /*75*/].f_31[num] = func_106(hParam1, false, false);

	if (func_107(Global_1051832.f_92[iParam0 /*75*/].f_31[num]))
		if (!func_108(Global_1051832.f_92[iParam0 /*75*/].f_31[num]))
			func_109(Global_1051832.f_92[iParam0 /*75*/].f_31[num], false, iParam2, bParam3, true, 0, bParam4, false);

	Global_1051832.f_92[iParam0 /*75*/].f_47 = Global_1051832.f_92[iParam0 /*75*/].f_47 + 1;
	return;
}

void func_60(int iParam0, int iParam1) // Position - 0x1464 Hash - 0x823E3440 ^0x4606FBC5
{
	func_110(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_61(int iParam0, BOOL bParam1) // Position - 0x147E Hash - 0xD0FD971 ^0x657364CB
{
	int num;
	Hash hash;
	float num2;
	...
	if (func_111(iParam0, 16384) || func_111(iParam0, 32768) || _IS_NULL_VECTOR(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
	...
	num = func_100(func_113(), iParam0);

	if (!bParam1 && func_114(num, &hash, &num2, &unk) || bParam1 && func_115(num, &hash, &num2, &unk))
	{
		func_116(iParam0, hash, unk, num2, false);
...
int func_62(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x15A5 Hash - 0xEDF440C1 ^0x32727141
{
	PersChar persChar;
	...
	if (!func_117(iParam0, false))
		return 0;

	if (!VOLUME::DOES_VOLUME_EXIST(volParam1))
		return 0;

	persChar = func_118(iParam0);
...
void func_63(var uParam0, Volume volParam1, int iParam2) // Position - 0x15F3 Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_64(int iParam0) // Position - 0x164C Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_65() // Position - 0x1662 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_66(int iParam0, Volume volParam1, var uParam2) // Position - 0x168F Hash - 0xA38B575 ^0xA38B575
{
	if (!*uParam2)
	{
		if (func_121(Global_33, volParam1, true, 0))
		{
			func_123(func_122(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_121(Global_33, volParam1, true, 0))
	{
		*uParam2 = 0;
	}
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x16D1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x16E0 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_69() // Position - 0x16F1 Hash - 0x463DA432 ^0x857E19AF
{
	return func_67(Global_1940199, 8192);
}

BOOL func_70(var uParam0, int iParam1) // Position - 0x1704 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_71(int iParam0) // Position - 0x1715 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_64(iParam0))
		return false;

	return Global_1887363[iParam0 /*36*/].f_21 == 1 || Global_1887363[iParam0 /*36*/].f_21 == 2 && !func_124(iParam0);
}

BOOL func_72(int iParam0, int iParam1) // Position - 0x1755 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_73() // Position - 0x1782 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_74(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1790 Hash - 0xC1C9C223 ^0x45FB2664
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	str = func_126(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	if (!func_127(iParam4))
		if (func_64(iParam0))
			iParam4 = func_128(func_9(iParam0));
		else
			iParam4 = func_128(iParam1);

	if (func_127(iParam4))
		hash = func_129(iParam4);

	if (flag && bParam3)
	{
		str2 = func_131(func_130(iParam2));
	}
	else if (func_132(iParam1, 2) || func_133(iParam4, 2) && !Global_1893611.f_9)
	{
	...
	else if (func_64(iParam0) && func_88(iParam0, 16777216) && !Global_1893611.f_9)
	{
	...
	{
		num = func_135(func_134());
		num2 = func_136(func_134());
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				temperatureAtCoords = func_137(temperatureAtCoords);
				str3 = "TIME_AND_TEMP_F";
			}
		
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(674, str3, num, func_138(&unk, joaat("COLOR_PURE_WHITE")), str4, func_138(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num, func_138(&unk, joaat("COLOR_PURE_WHITE")), func_138(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_139(str, str2, 4000, 0, 0, 0, false, true);
	return;
}

void func_75(var uParam0, int iParam1) // Position - 0x19F8 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_76(int iParam0, BOOL bParam1) // Position - 0x1A0B Hash - 0x2CB19C60 ^0x579311F8
{
	...
	func_21(iParam0, 32);
	func_141(&Global_1940199, 16384);
	func_123(func_142(joaat("discovered"), joaat("AREAS")), 1);
	...
	switch (func_9(iParam0))
	{
		...
		case 2:
		case 11:
			func_123(func_142(joaat("discovered"), joaat("lowlands_areas")), 1);
			break;
		...
		case 7:
		case 12:
			func_123(func_142(joaat("discovered"), joaat("mountain_areas")), 1);
			break;
	
		case 3:
		case 10:
			func_123(func_142(joaat("discovered"), joaat("foothills_areas")), 1);
			break;
	
		case 4:
		case 9:
			func_123(func_142(joaat("discovered"), joaat("plains_areas")), 1);
			break;
	
		case 8:
			func_123(func_142(joaat("discovered"), joaat("guama_areas")), 1);
			break;
		...
		case 15:
		case 16:
			func_123(func_142(joaat("discovered"), joaat("new_austin_areas")), 1);
			break;
	}
...
void func_77(BOOL bParam0) // Position - 0x2074 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_78(int iParam0) // Position - 0x209D Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_79() // Position - 0x20E2 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_80(int iParam0, BOOL bParam1) // Position - 0x20EA Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, BOOL bParam1) // Position - 0x28AF Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_82(BOOL bParam0) // Position - 0x2902 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_83(int iParam0) // Position - 0x292B Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_84(int iParam0) // Position - 0x2933 Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_85(int iParam0) // Position - 0x2964 Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_86(int iParam0, BOOL bParam1) // Position - 0x2997 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
	...
	if (func_91(iParam0, &num, &num2, false, false))
	{
		...
		while (true)
		{
			if (!func_145(Global_1896644.f_1, 16))
				func_146(Global_1896644.f_1, false);
...
BOOL func_87(Hash hParam0) // Position - 0x2A4D Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;

	for (i = 0; i < 40; i = i + 1)
	{
		if (func_147(i) || func_148(i))
		{
		}
		else
		{
...
BOOL func_88(int iParam0, BOOL bParam1) // Position - 0x2AC7 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_89(int iParam0) // Position - 0x2AF8 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_90(int iParam0) // Position - 0x2B19 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_91(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2B6C Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_92(int iParam0) // Position - 0x322C Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_93(int iParam0) // Position - 0x3243 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_94(int iParam0, BOOL bParam1) // Position - 0x3286 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_92(iParam0))
		return 0;
	...
	if (func_145(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_118(iParam0));
...
BOOL func_95() // Position - 0x3371 Hash - 0x9AF3EE3F ^0xBF53F360
{
...
BOOL func_96() // Position - 0x3385 Hash - 0x16C45944 ^0x16C45944
{
	return func_155(func_56(0));
}

BOOL func_97(int iParam0) // Position - 0x3396 Hash - 0x4B08C8C4 ^0x4B08C8C4
{
	return !func_156(iParam0);
}

void func_98(BOOL bParam0, BOOL bParam1) // Position - 0x33A5 Hash - 0x2F17103B ^0x1C4D2C36
{
	if (func_157(255) == 4)
		return;
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x34F0 Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	flag = func_165(iParam0) && !bParam1;

	if (!flag && !func_111(iParam0, 65536))
	{
	...
	else if (func_166(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	if (func_166(iParam0, 16384) && !flag)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_6))
		{
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_168(Global_1051832.f_92[iParam0 /*75*/].f_31[i]);
	...
	if (func_111(iParam0, 262144))
		Global_1051832.f_92[iParam0 /*75*/].f_49 = 262144;
	else
		func_170(iParam0);

	if (VOLUME::DOES_VOLUME_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_24) && func_171(iParam0, 2))
	{
...
int func_100(Hash hParam0, int iParam1) // Position - 0x389F Hash - 0x274C8E8A ^0x274C8E8A
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_101(int iParam0) // Position - 0x420A Hash - 0xF53EDEBA ^0xF53EDEBA
{
	if (!func_173(iParam0))
		return 0;

	if (Global_1051832.f_4492[iParam0] == 0)
		Global_1051832.f_4492[iParam0] = func_174(iParam0);

	return Global_1051832.f_4492[iParam0];
}

int func_102(int iParam0) // Position - 0x424B Hash - 0xFE1A3B7C ^0xFE1A3B7C
{
	switch (iParam0)
	{
		case 3:
...
void func_103(int iParam0, int iParam1) // Position - 0x42E8 Hash - 0xDCFC48D0 ^0xCB4861A2
{
...
void func_104(int iParam0) // Position - 0x4317 Hash - 0x93134738 ^0x938C636D
{
...
int func_105(int iParam0) // Position - 0x4350 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_106(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4364 Hash - 0xEC5804B5 ^0xE95C34A9
{
...
BOOL func_107(Hash hParam0) // Position - 0x4408 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_175(hParam0))
...
BOOL func_108(Hash hParam0) // Position - 0x4423 Hash - 0x51587F69 ^0xAFC63473
{
...
void func_109(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x444C Hash - 0xD777F4CF ^0xBFF3124C
{
	func_106(hParam0, false, false);
	...
	if (func_107(hParam0))
	{
		...
		if (bParam3)
			func_176(hParam0, iParam2, true, bParam6);
		else if (bParam1)
			if (bParam4)
				func_177(hParam0, true);
			else
				func_178(hParam0, true);
		else
			func_179(hParam0, true);
...
void func_110(BOOL bParam0, int iParam1) // Position - 0x44D7 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_111(int iParam0, BOOL bParam1) // Position - 0x44E8 Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4501 Hash - 0x16E871AD ^0x10C54C39
{
...
Hash func_113() // Position - 0x452B Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1893611.f_2;
}

BOOL func_114(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4539 Hash - 0xC625CFBA ^0x2E4D48FB
{
	return func_181(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_115(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4559 Hash - 0xC625CFBA ^0x4848F5EC
{
	return func_181(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_116(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4579 Hash - 0xCAA352A8 ^0x24D53CD4
{
	if (bParam6)
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);

	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_182(hParam1, vParam2, fParam5, 0, 0, false);
...
BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x45F5 Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_45() != -1)
		return false;
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_183(iParam0)))
		return false;

	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_118(iParam0));
}

PersChar func_118(int iParam0) // Position - 0x464D Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_119(int iParam0) // Position - 0x466D Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_120(int iParam0) // Position - 0x4683 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_121(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x4699 Hash - 0x6735ACA9 ^0xD6205CC6
{
...
struct<2> func_122(int iParam0) // Position - 0x46CF Hash - 0xFB53CD87 ^0xA9AA4BC8
{
	int num;

	num = func_184(iParam0);
	return func_142(joaat("visited"), num);
}

void func_123(var uParam0, var uParam1, int iParam2) // Position - 0x46EA Hash - 0x31B6F9FF ^0xF5CD2283
{
...
BOOL func_124(int iParam0) // Position - 0x4707 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_185())
		return true;
...
BOOL func_125() // Position - 0x473C Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_187(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_126(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x477F Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_188(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_190(func_189(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_191(iParam0) || func_192(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_127(int iParam0) // Position - 0x51E5 Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_128(int iParam0) // Position - 0x51FA Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
Hash func_129(int iParam0) // Position - 0x52B5 Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	Hash bountyData;
	...
	i = 0;
	gamerHandle = { func_193(PLAYER::PLAYER_ID()) };
...
int func_130(int iParam0) // Position - 0x5323 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_131(int iParam0) // Position - 0x547E Hash - 0x21CE226B ^0xE1FEFC83
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x54B9 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x54FB Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_127(iParam0))
		return false;
...
BOOL func_134() // Position - 0x5540 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_135(BOOL bParam0) // Position - 0x554C Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_136(BOOL bParam0) // Position - 0x555F Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_137(float fParam0) // Position - 0x5571 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_138(var uParam0, int iParam1) // Position - 0x5587 Hash - 0xB0CFF0C3 ^0xC373566
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
		return MISC::VAR_STRING(10, "LITERAL_STRING", uParam0);

	return func_194(MISC::VAR_STRING(10, "LITERAL_STRING", uParam0), iParam1);
}

int func_139(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x55BD Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_140(int iParam0) // Position - 0x5600 Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_191(iParam0))
		if (!func_192(44))
			return false;
...
void func_141(int iParam0, int iParam1) // Position - 0x5620 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_142(int iParam0, int iParam1) // Position - 0x5631 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_143(int iParam0) // Position - 0x5647 Hash - 0x3E288458 ^0xC75F9664
{
	func_195(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_196(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
	...
	func_197(iParam0, 8192);
	func_197(iParam0, 32768);
	func_197(iParam0, 524288);
	func_197(iParam0, 1048576);
...
void func_144(int iParam0) // Position - 0x5727 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_92(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_198(Global_1915656.f_3[iParam0 /*447*/].f_21))
		func_199(Global_1915656.f_3[iParam0 /*447*/].f_21, false, true, false, false);
	...
	func_200(Global_1915656.f_3[iParam0 /*447*/].f_9, false);
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_168(Global_1915656.f_3[iParam0 /*447*/].f_318[i /*6*/]);
...
BOOL func_145(int iParam0, BOOL bParam1) // Position - 0x58FF Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0x592D Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_92(iParam0))
		return 0;
	...
	if (func_145(iParam0, true) && !bParam1)
	{
	...
	func_205(iParam0);
	PERSCHAR::_DELETE_PERSCHAR(func_118(iParam0));
	func_152(iParam0, 0);
	return 1;
}

int func_147(int iParam0) // Position - 0x59B0 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_148(int iParam0) // Position - 0x59D7 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_149() // Position - 0x59F8 Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_150() // Position - 0x5BBF Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
Hash func_151(int iParam0) // Position - 0x5C3A Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_92(iParam0))
		return 0;
...
void func_152(int iParam0, PersChar pchParam1) // Position - 0x5C58 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_92(iParam0))
		return;
...
void func_153(int iParam0, BOOL bParam1) // Position - 0x5C79 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_154(int iParam0) // Position - 0x5CB2 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_155(var uParam0, var uParam1) // Position - 0x5CD8 Hash - 0x1268D0E3 ^0x1268D0E3
{
	return func_208(uParam0, 5, 8);
}

BOOL func_156(int iParam0) // Position - 0x5CEB Hash - 0xA3986FDD ^0xA3986FDD
{
	return func_209(1, iParam0);
}

int func_157(int iParam0) // Position - 0x5CFA Hash - 0x8D78E39F ^0x46194076
{
	if (iParam0 == 255)
...
int func_158(int iParam0) // Position - 0x5D45 Hash - 0x5423E6F3 ^0xE2118439
{
	if (func_210(&(Global_1102813.f_4), iParam0, 5))
		return 1;

	return 0;
}

void func_159(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5D62 Hash - 0x79169E9C ^0xA3FE4569
{
	func_211(iParam0);
...
int func_160(int iParam0) // Position - 0x5DC4 Hash - 0x5423E6F3 ^0xE2118439
{
	if (func_217(&(Global_1102813.f_4), iParam0, 5))
		return 1;

	return 0;
}

void func_161(var uParam0) // Position - 0x5DE1 Hash - 0xCF95012E ^0xCF95012E
{
	var unk;
...
void func_162(float* pfParam0) // Position - 0x5DF3 Hash - 0xFBC3ACC8 ^0xFBC3ACC8
{
	var unk;
...
void func_164(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5E5B Hash - 0x6DF4F0B2 ^0x7B946ED1
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_165(int iParam0) // Position - 0x5E88 Hash - 0x287157F6 ^0x287157F6
{
	if (iParam0 == 28 || iParam0 == 29 || iParam0 == 38 || iParam0 == 27 || iParam0 == 15 || iParam0 == 39)
		return true;

	if (func_111(iParam0, 65536))
		return true;

	return false;
}

BOOL func_166(int iParam0, int iParam1) // Position - 0x5EE5 Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_167(int iParam0, int iParam1) // Position - 0x5EFE Hash - 0x9E30ADED ^0xA0DD8460
{
	func_166(iParam0, iParam1);
...
void func_168(Hash hParam0) // Position - 0x5F39 Hash - 0xDB9A74EC ^0x13B3F16D
{
	if (func_107(hParam0) && func_218())
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(hParam0);

	return;
}

void func_169(int iParam0) // Position - 0x5F59 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_170(int iParam0) // Position - 0x5F61 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_171(int iParam0, int iParam1) // Position - 0x5F76 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;

	return func_219(Global_1051832.f_92[iParam0 /*75*/].f_50, iParam1);
}

void func_172(int iParam0) // Position - 0x5F9D Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_173(int iParam0) // Position - 0x601C Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_174(int iParam0) // Position - 0x6032 Hash - 0xB89C4DF3 ^0x1393EE39
{
	var unk;

	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149432.f_7) && !func_221(12, func_220(iParam0), &unk))
		return 0;

	return unk.f_2;
}

BOOL func_175(Hash hParam0) // Position - 0x6063 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

void func_176(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x606F Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_107(hParam0))
	{
...
void func_177(Hash hParam0, BOOL bParam1) // Position - 0x60A7 Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_107(hParam0))
...
void func_178(Hash hParam0, BOOL bParam1) // Position - 0x60D5 Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_107(hParam0))
...
void func_179(Hash hParam0, BOOL bParam1) // Position - 0x6103 Hash - 0x4844A91D ^0x50E23246
{
	if (func_107(hParam0))
...
BOOL func_180() // Position - 0x6131 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_181(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x613A Hash - 0x5851BC53 ^0x8A1263E0
{
	int num;

	num = func_222();
	num.f_2 = -738708473;
	num.f_3 = func_220(iParam0);
...
int func_182(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x61C2 Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

Ped func_183(int iParam0) // Position - 0x61DC Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
int func_184(int iParam0) // Position - 0x620A Hash - 0x4FE01E4C ^0x4FE01E4C
{
	int num;
...
BOOL func_185() // Position - 0x6222 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_186() // Position - 0x622B Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_187(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6293 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_225(func_56(0)))
		return true;
...
const char* func_188(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6409 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_189(var uParam0, var uParam1, var uParam2) // Position - 0x641D Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_190(int iParam0) // Position - 0x644B Hash - 0xE6862179 ^0x864F511B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_191(int iParam0) // Position - 0x672F Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_192(int iParam0) // Position - 0x6759 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_228(iParam0))
		return false;
...
struct<2> func_193(Player plParam0) // Position - 0x6775 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_194(const char* sParam0, int iParam1) // Position - 0x6789 Hash - 0x9E99F03 ^0xFC2B7BF9
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_195(int iParam0, BOOL bParam1) // Position - 0x67A3 Hash - 0x2F9EB0B9 ^0x932C2236
{
	char* ambientZone;
...
void func_196(int iParam0, BOOL bParam1) // Position - 0x67D7 Hash - 0x342D57CF ^0x8D9531E5
{
	switch (iParam0)
	{
		case 5:
...
void func_197(int iParam0, int iParam1) // Position - 0x680C Hash - 0x823E3440 ^0x340E01B4
{
	func_230(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_198(int iParam0) // Position - 0x6826 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_92(iParam0))
		return false;
...
void func_199(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x684B Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_198(iParam0) && func_231(iParam0))
		return;

	func_153(iParam0, 1);
	func_205(iParam0);

	if (func_232(func_151(iParam0)))
	{
		persChar = func_118(iParam0);
...
void func_200(int iParam0, BOOL bParam1) // Position - 0x6937 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_173(iParam0))
		return;
...
void func_201(int iParam0, int iParam1) // Position - 0x698D Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_237(iParam0))
		return;
...
int func_202(int iParam0) // Position - 0x6A00 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_203(int iParam0) // Position - 0x6A16 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_204(int iParam0, BOOL bParam1) // Position - 0x6A2C Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_205(int iParam0) // Position - 0x6A5D Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_206(int iParam0) // Position - 0x6AA1 Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_207(int iParam0) // Position - 0x6AB6 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_208(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6ACB Hash - 0x9EA53184 ^0x9EA53184
{
	int num;
...
BOOL func_209(int iParam0, int iParam1) // Position - 0x6B06 Hash - 0x61AB4BED ^0x265134F3
{
	int num;
	...
	if (iParam1 == 255)
		return func_239(&(Global_1102813.f_4), num, 5);
	...
	if (Global_1295666.f_17[iParam1])
		return func_239(&(Global_1101558[iParam1 /*38*/].f_4), num, 5);

	return false;
}

BOOL func_210(int* piParam0, int iParam1, int iParam2) // Position - 0x6B7A Hash - 0x8AC008A3 ^0x375BADC3
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_211(int iParam0) // Position - 0x6BAC Hash - 0x42868A8 ^0x3D52297C
{
	Global_1102813.f_26.f_12 = iParam0;
	return;
}

BOOL func_212(int iParam0) // Position - 0x6BBE Hash - 0xA1D29AFD ^0xABA18533
{
	return Global_1102813.f_26.f_7 && iParam0 != false;
}

BOOL func_213(BOOL bParam0) // Position - 0x6BD3 Hash - 0xA1D29AFD ^0x8B9D4F17
{
	return Global_1102813.f_26.f_9 && bParam0 != false;
}

BOOL func_214(int iParam0) // Position - 0x6BE8 Hash - 0x10DA64DD ^0x85E01D27
{
	return Global_1102813.f_4[Global_1106895[iParam0 /*2*/]] && Global_1106895[iParam0 /*2*/].f_1 == Global_1106895[iParam0 /*2*/].f_1;
}

int func_215() // Position - 0x6C16 Hash - 0xE5D277D5 ^0xE5D277D5
{
	if (Global_1102813 <= 5)
...
void func_216(BOOL bParam0) // Position - 0x6C49 Hash - 0xEBD3AD20 ^0x6E10961F
{
	if (func_241(bParam0))
		return;
...
BOOL func_217(int* piParam0, int iParam1, int iParam2) // Position - 0x6C70 Hash - 0xA8F08582 ^0x9810C45C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_218() // Position - 0x6CA3 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

BOOL func_219(BOOL bParam0, BOOL bParam1) // Position - 0x6CAC Hash - 0x178D9C09 ^0x178D9C09
{
	return bParam0 && bParam1 != false;
}

int func_220(int iParam0) // Position - 0x6CBB Hash - 0xB8EC44B7 ^0x241D648F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_221(int iParam0, int iParam1, var uParam2) // Position - 0x76A3 Hash - 0xDC10368D ^0xDC10368D
{
	var unk;

	if (func_242(iParam0, iParam1, &unk))
		func_243(&unk, iParam0, uParam2);
	else
		return false;
...
int func_222() // Position - 0x76CA Hash - 0x4F5358E7 ^0x4EB0CC4F
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_223() // Position - 0x76DF Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_225(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_224() // Position - 0x7737 Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_225(var uParam0, var uParam1) // Position - 0x7745 Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_244(uParam0))
		return false;
...
struct<2> func_226() // Position - 0x7779 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_227(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x77C4 Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;

	func_246(iParam3, &unk, &num, &num2);

	if (func_247(uParam0, unk, num, num.f_1, num2))
		return true;

	return false;
}

BOOL func_228(int iParam0) // Position - 0x77F4 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_229(int iParam0) // Position - 0x7807 Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_230(int iParam0, int iParam1) // Position - 0x7831 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_231(int iParam0) // Position - 0x7846 Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_232(Hash hParam0) // Position - 0x786A Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_233(int iParam0, BOOL bParam1) // Position - 0x7876 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_173(iParam0))
		return false;
...
void func_234(int iParam0, BOOL bParam1) // Position - 0x789C Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_173(iParam0))
		return;
...
void func_235(int iParam0, BOOL bParam1) // Position - 0x78CA Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_173(iParam0))
		return;
...
void func_236(int iParam0) // Position - 0x7904 Hash - 0xB29062D ^0xB29062D
{
	func_249(func_248(iParam0));
	return;
}

BOOL func_237(int iParam0) // Position - 0x7916 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_238(int iParam0, var uParam1) // Position - 0x792C Hash - 0x9C3ED8B4 ^0x9C3ED8B4
{
	if (iParam0 == 2)
...
BOOL func_239(int* piParam0, int iParam1, int iParam2) // Position - 0x7946 Hash - 0x15F7E5EE ^0x39F4E7C
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_240() // Position - 0x797D Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1102813.f_3672;
}

BOOL func_241(BOOL bParam0) // Position - 0x798C Hash - 0x695C3191 ^0x86E70E17
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_242(int iParam0, int iParam1, Any* panParam2) // Position - 0x79A2 Hash - 0x8467BB0B ^0xA289B29B
{
	*panParam2 = Global_1149432.f_7;
	panParam2->f_2 = 1351168281;
	panParam2->f_3 = func_251(iParam0);
	panParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam2->f_1), panParam2);
}

void func_243(Any* panParam0, int iParam1, var uParam2) // Position - 0x79D6 Hash - 0x59F43AD2 ^0xB9A366FE
{
	var unk;
...
BOOL func_244(int iParam0) // Position - 0x7A50 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_245(int iParam0) // Position - 0x7A8F Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_246(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7B25 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_247(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x85C7 Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_248(int iParam0) // Position - 0x862D Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_249(int iParam0) // Position - 0x8B4A Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_250(var uParam0, var uParam1) // Position - 0x8B5B Hash - 0xF9339824 ^0x8CB8B693
{
	var unk;
	...
	if (func_252(uParam0, &unk))
		return unk.f_1;

	return -1;
}

int func_251(int iParam0) // Position - 0x8B87 Hash - 0x5FB59AC3 ^0xE293EFF
{
	int num;
...
BOOL func_252(int iParam0, var uParam1, Any* panParam2) // Position - 0x8CFC Hash - 0xEDAACC68 ^0x7998E850
{
	if (!func_225(iParam0))
		return false;
...
void func_253(Any* panParam0) // Position - 0x8E07 Hash - 0xE2B2004A ^0x20B50C0B
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
