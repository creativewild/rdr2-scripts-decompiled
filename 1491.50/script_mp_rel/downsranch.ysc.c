...
BOOL func_13() // Position - 0x7D0 Hash - 0x1F0863A2 ^0x37ED8EB1
{
	volLocal_16 = Global_1887363[73 /*36*/].f_5;

	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		volLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Down's Ranch - m_volThreat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -861.1559f, 337.39487f, 97.83562f, 0f, 0f, -10.527636f, 11.362564f, 15.179712f, 10.227591f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -864.78906f, 321.06805f, 94.98614f, 0f, 0f, -10.527636f, 8.645713f, 12.503981f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -62.543896f, -392.43353f, 72.1382f, 0f, 0f, 29.04495f, 7.979648f, 6.063315f, 6.900121f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -851.4187f, 361.481f, 97.83562f, 0f, 0f, -13.366555f, 0.863879f, 8.798125f, 5.594934f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -846.2698f, 364.29935f, 96.90186f, 0f, 0f, -7.59012f, 9.607594f, 16.137781f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -854.86334f, 319.22342f, 94.98614f, 0f, 0f, -10.527634f, 11.770657f, 11.274507f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -790.8695f, 346.954f, 98.00078f, 0f, 0f, -8.615136f, 13.377618f, 8.146093f, 7.736006f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -797.30054f, 347.90393f, 98.692406f, -178.96689f, -86.9581f, 158.54645f, 6.802914f, 7.671669f, 3.322031f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -817.6839f, 353.51584f, 98.00078f, 0f, 0f, -9.719018f, 10.098038f, 10.205086f, 7.736006f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -874.6434f, 323.23175f, 94.98614f, 0f, 0f, -10.527632f, 12.960121f, 12.503981f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -883.0225f, 334.15833f, 94.98614f, 0f, 0f, -23.197018f, 8.645713f, 14.331077f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -857.59796f, 357.7791f, 94.98614f, 0f, 0f, -4.378916f, 9.184352f, 2.478699f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -868.08716f, 338.0298f, 94.98614f, 0f, 0f, -10.527631f, 22.801994f, 22.799383f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -859.0131f, 352.2604f, 94.98614f, 0f, 0f, -10.527631f, 9.726913f, 9.194143f, 4.525191f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -868.4409f, 352.29437f, 95.5f, 0f, 0f, 121.51578f, 4.6843f, 11.066764f, 5.382992f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -879.65674f, 344.24533f, 95.5f, 0f, 0f, -38.53438f, 2.935173f, 7.713624f, 5.382992f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -882.3352f, 327.0211f, 95.5f, 0f, 0f, 156.22534f, 7.625237f, 7.713624f, 5.382992f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_21, -810.5886f, 353.7103f, 98.00078f, 0f, 0f, -9.719017f, 3.779373f, 6.791281f, 7.736006f);
		volLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Down's Ranch - m_volRestricted Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_20, volLocal_21);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_20, -858.1369f, 346.62238f, 95.5f, 0f, 0f, -0.107f, 36.560566f, 35.554146f, 44f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(volLocal_20, -815.75446f, 352.59842f, 105.69082f, 0f, 0f, -12.066726f, 85.78142f, 37.625134f, 28.168f);
		volLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Down's Ranch - m_volWarning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_19, volLocal_20);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(volLocal_19, -834.0826f, 345.05853f, 95.5f, 0f, 0f, -0.107f, 73.14397f, 44.90614f, 45.702488f);
		volLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Down's Ranch - m_volRegistration Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(volLocal_18, volLocal_19);
		sLocal_17 = "DOWNS_RANCH";
		...
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_17, volLocal_19);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_17, -818.1168f, 354.8587f, 98.5042f);
...
void _DEBUG_PRINT(int iParam0) // Position - 0xBFF Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xC0B Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xC18 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0xC24 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xC31 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xC3D Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xC52 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xC63 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xCA2 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xCAE Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xCB6 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xD66 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0xD6E Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0xD76 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0xD7E Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xD86 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_30(int iParam0) // Position - 0xD92 Hash - 0xF6A7C8D6 ^0x776F3DB4
{
	if (func_45() != -1)
		return;

	func_58(559, volLocal_20, true);
	func_58(558, volLocal_20, false);
	VOLUME::_0x4A8FEFC43FD8AC9B(volLocal_20, 3, 1);
	VOLUME::_0x53D05D60E5F5B40C(volLocal_20, 3, 1, func_59(558));
	PED::SET_PED_OWNS_ANIMAL(func_60(559), func_60(558), false);
	return;
}

void func_31() // Position - 0xDE5 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xDED Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xDF5 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xE01 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xE32 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xE78 Hash - 0x41BC629D ^0x41BC629D
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xE8D Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_62(iParam0))
		return;
...
BOOL func_38(int iParam0) // Position - 0xEA6 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xEB7 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && iParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xECF Hash - 0xFC78EB8C ^0xFC78EB8C
{
	if (func_45() == -1)
		func_64();
...
void func_41(var uParam0, int iParam1) // Position - 0xEE4 Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x1023 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x1030 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0x1066 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_77();
...
int func_45() // Position - 0x117A Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x1188 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x1194 Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0x11BF Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x1201 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x12E1 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x12FF Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1312 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1330 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1428 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x1439 Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x144D Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1461 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

int func_58(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x146B Hash - 0xEDF440C1 ^0x32727141
{
	PersChar persChar;
...
PersChar func_59(int iParam0) // Position - 0x14B9 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_90(iParam0))
		return 0;
...
Ped func_60(int iParam0) // Position - 0x14D9 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
void func_61(var uParam0, Volume volParam1, int iParam2) // Position - 0x1507 Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_62(int iParam0) // Position - 0x1560 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_63() // Position - 0x1576 Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_64() // Position - 0x15A3 Hash - 0x671A6B2C ^0x2B6EE09
{
	PersChar persChar;

	persChar = PERSCHAR::_0x112DDF56300BC6E5(joaat("dor_husband"));
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x1613 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x1622 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_67() // Position - 0x1633 Hash - 0x463DA432 ^0x857E19AF
{
	return func_65(Global_1940199, 8192);
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x1646 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_69(int iParam0) // Position - 0x1657 Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_70(int iParam0, int iParam1) // Position - 0x1697 Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_71() // Position - 0x16C4 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_72(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x16D2 Hash - 0xB6F2F238 ^0x96196553
{
	BOOL flag;
	const char* str;
	char* str2;
...
void func_73(var uParam0, int iParam1) // Position - 0x193A Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_74(int iParam0, BOOL bParam1) // Position - 0x194D Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_75(BOOL bParam0) // Position - 0x1FB6 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_76(int iParam0) // Position - 0x1FDF Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_77() // Position - 0x2024 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_78(int iParam0, BOOL bParam1) // Position - 0x202C Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_79(int iParam0, BOOL bParam1) // Position - 0x27F1 Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_80(BOOL bParam0) // Position - 0x2844 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_81(int iParam0) // Position - 0x286D Hash - 0x1A189743 ^0x92142A8
{
	func_116(0.775f, 0.2f, 0.025f, 0f);
	LAW::_REMOVE_GUARD_ZONE(sLocal_17);
	func_117(volLocal_18);
	func_117(volLocal_19);
	func_117(volLocal_21);
...
void func_82(int iParam0) // Position - 0x28BC Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_83(int iParam0) // Position - 0x28ED Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_84(int iParam0, BOOL bParam1) // Position - 0x2920 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_85(int iParam0) // Position - 0x29D6 Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;
...
BOOL func_86(int iParam0, BOOL bParam1) // Position - 0x2A50 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_87(int iParam0) // Position - 0x2A81 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_88(int iParam0) // Position - 0x2AA2 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_89(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2AF5 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_90(int iParam0) // Position - 0x31B5 Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_91(int iParam0) // Position - 0x31CC Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_92(int iParam0, BOOL bParam1) // Position - 0x320F Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_90(iParam0))
		return 0;
...
BOOL func_93(int iParam0, BOOL bParam1) // Position - 0x32FA Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_45() != -1)
		return false;
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_60(iParam0)))
		return false;

	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_59(iParam0));
}

BOOL func_94(int iParam0) // Position - 0x3352 Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_95(int iParam0) // Position - 0x3368 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_96(int iParam0) // Position - 0x337E Hash - 0x6A6EE485 ^0x6A6EE485
{
...
BOOL func_97() // Position - 0x33B3 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
...
const char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x33F6 Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;
...
BOOL func_99(int iParam0) // Position - 0x3E5C Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_100(int iParam0) // Position - 0x3E71 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_101(int iParam0) // Position - 0x3F2C Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_102(int iParam0) // Position - 0x3F9A Hash - 0x899A1C9C ^0x899A1C9C
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_103(int iParam0) // Position - 0x4154 Hash - 0x21CE226B ^0x5A30D647
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x418F Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x41D1 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_99(iParam0))
		return false;
...
int func_106() // Position - 0x4216 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_107(int iParam0) // Position - 0x4222 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_108(int iParam0) // Position - 0x4235 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_109(float fParam0) // Position - 0x4247 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_110(var uParam0, int iParam1) // Position - 0x425D Hash - 0xB0CFF0C3 ^0x5903397C
{
...
int func_111(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4293 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_112(int iParam0) // Position - 0x42D6 Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_137(iParam0))
		if (!func_138(44))
			return false;
...
void func_113(int iParam0, int iParam1) // Position - 0x42F6 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_114(int iParam0, int iParam1) // Position - 0x4307 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_115(var uParam0, var uParam1, int iParam2) // Position - 0x431D Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_116(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x433A Hash - 0x1E885EDE ^0x3AA465F4
{
...
void func_117(Volume volParam0) // Position - 0x4362 Hash - 0x7DD010A2 ^0x16530136
{
...
void func_118(int iParam0) // Position - 0x4379 Hash - 0x3E288458 ^0xC75F9664
{
...
void func_119(int iParam0) // Position - 0x4459 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;
...
BOOL func_120(int iParam0, BOOL bParam1) // Position - 0x4631 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_121(int iParam0, BOOL bParam1) // Position - 0x465F Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_90(iParam0))
		return 0;
...
int func_122(int iParam0) // Position - 0x46E2 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_123(int iParam0) // Position - 0x4709 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_124() // Position - 0x472A Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_125() // Position - 0x48F1 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_126(int iParam0, BOOL bParam1) // Position - 0x496C Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
...
Hash func_127(int iParam0) // Position - 0x4D1B Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_90(iParam0))
		return 0;
...
void func_128(int iParam0, PersChar pchParam1) // Position - 0x4D39 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_90(iParam0))
		return;
...
void func_129(int iParam0, BOOL bParam1) // Position - 0x4D5A Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_130(int iParam0) // Position - 0x4D93 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_90(iParam0))
		return false;
...
BOOL func_131() // Position - 0x4DB9 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_132() // Position - 0x4DC2 Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_133(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4E2A Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_134(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4FA0 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_135(var uParam0, var uParam1, var uParam2) // Position - 0x4FB4 Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_136(int iParam0) // Position - 0x4FE2 Hash - 0xE6862179 ^0x7099055B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_137(int iParam0) // Position - 0x52C6 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_138(int iParam0) // Position - 0x52F0 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_169(iParam0))
		return false;
...
struct<2> func_139(Player plParam0) // Position - 0x530C Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_140(const char* sParam0, int iParam1) // Position - 0x5320 Hash - 0x9E99F03 ^0xCD7E15DD
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_141(int iParam0, BOOL bParam1) // Position - 0x533A Hash - 0x2F9EB0B9 ^0x750343FF
{
	char* ambientZone;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x536E Hash - 0x342D57CF ^0x65E5C66B
{
	switch (iParam0)
	{
		case 5:
...
void func_143(int iParam0, int iParam1) // Position - 0x53A3 Hash - 0x823E3440 ^0x340E01B4
{
	func_171(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_144(int iParam0) // Position - 0x53BD Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_90(iParam0))
		return false;
...
void func_145(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x53E2 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x54CE Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_174(iParam0))
		return;
...
void func_147(int iParam0, int iParam1) // Position - 0x5524 Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_179(iParam0))
		return;
...
int func_148(int iParam0) // Position - 0x5597 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_149(Hash hParam0) // Position - 0x55AD Hash - 0xDB9A74EC ^0x13B3F16D
{
...
void func_150(int iParam0) // Position - 0x55CD Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_151(int iParam0, BOOL bParam1) // Position - 0x55E3 Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_152(int iParam0) // Position - 0x5614 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_153(int iParam0) // Position - 0x5658 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_154(int iParam0) // Position - 0x566D Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_155(int iParam0) // Position - 0x5682 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_156(int iParam0) // Position - 0x5697 Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_157(int iParam0) // Position - 0x5716 Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x5773 Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x578C Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_160(int iParam0, int iParam1) // Position - 0x57A5 Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_161(int iParam0) // Position - 0x57E0 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_162(int iParam0) // Position - 0x57F4 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_163(int iParam0, int iParam1) // Position - 0x57FC Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;
...
BOOL func_164() // Position - 0x5823 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
...
struct<2> func_165() // Position - 0x587B Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_166(var uParam0, var uParam1) // Position - 0x5889 Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_183(uParam0))
		return false;
...
struct<2> func_167() // Position - 0x58BD Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_168(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x5908 Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;
...
BOOL func_169(int iParam0) // Position - 0x5938 Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_170(int iParam0) // Position - 0x594B Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_171(var uParam0, int iParam1) // Position - 0x5975 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_172(int iParam0) // Position - 0x598A Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_90(iParam0))
		return false;
...
BOOL func_173(Hash hParam0) // Position - 0x59AE Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_174(int iParam0) // Position - 0x59BA Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_175(int iParam0, BOOL bParam1) // Position - 0x59D0 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_174(iParam0))
		return false;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x59F6 Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_174(iParam0))
		return;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x5A24 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_174(iParam0))
		return;
...
void func_178(int iParam0) // Position - 0x5A5E Hash - 0xB29062D ^0xB29062D
{
	func_188(func_187(iParam0));
	return;
}

BOOL func_179(int iParam0) // Position - 0x5A70 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_180(Hash hParam0) // Position - 0x5A86 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_189(hParam0))
...
BOOL func_181() // Position - 0x5AA1 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

BOOL func_182(int iParam0, int iParam1) // Position - 0x5AAA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_183(int iParam0) // Position - 0x5AB9 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_184(int iParam0) // Position - 0x5AF8 Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_185(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5B8E Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_186(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x662B Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_187(int iParam0) // Position - 0x6691 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_188(int iParam0) // Position - 0x6BAE Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_189(Hash hParam0) // Position - 0x6BBF Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}
