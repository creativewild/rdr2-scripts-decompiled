...
void main() // Position - 0x0 Hash - 0x9AB7AE7A ^0x301A1A0E
{
	...
	func_5(&uLocal_42, joaat("COLLECTIBLE_EGG_CONDOR"), joaat("provision_condor_egg"), joaat("mp005_s_bdeg_condornest01x"), joaat("mp005_s_bdeg_condor_egg01x"), 7, 1);
...
int func_1() // Position - 0xB5 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

struct<2> func_2(int iParam0) // Position - 0xC3 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_3(int iParam0, var uParam1) // Position - 0xD7 Hash - 0x72C53F65 ^0x72C53F65
{
	return iParam0;
}

void func_4(var uParam0) // Position - 0xE1 Hash - 0x1A4E3FB8 ^0x93ABA2E
{
	int num;
	int i;
...
void func_5(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6) // Position - 0x18D Hash - 0x480912BA ^0x64206099
{
	*uParam0 = 5;
...
BOOL func_6(var uParam0) // Position - 0x1D4 Hash - 0x3F9A5B3E ^0xE1E8ABCC
{
...
BOOL func_7() // Position - 0x1EE Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x1F7 Hash - 0x1C147EB ^0x5DCF9F38
{
	switch (uParam0->f_4)
	{
		case 0:
...
int func_9(var uParam0) // Position - 0x228 Hash - 0x588B3CC6 ^0xDF07CC7
{
	var unk;
...
void func_10(BOOL bParam0) // Position - 0x279 Hash - 0xEFDB7ACC ^0xEFDB7ACC
{
	if (bParam0)
		func_21(0, 6);
	else
...
void func_11(var uParam0) // Position - 0x296 Hash - 0x530C41A5 ^0x73534952
{
...
int func_12(var uParam0) // Position - 0x2B1 Hash - 0x18F86012 ^0x18F86012
{
	int i;
...
int func_13(Object obParam0, Object obParam1, int iParam2) // Position - 0x357 Hash - 0xC1227CDD ^0xCCB24A9F
{
	int i;
	var src;
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x401 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_15(int iParam0, int iParam1) // Position - 0x410 Hash - 0xF55E891F ^0xF55E891F
{
	func_23(iParam0, iParam1);
	return;
}

void func_16(var uParam0) // Position - 0x420 Hash - 0x6197CFB5 ^0xB076B5A9
{
	func_24(uParam0);
...
void func_17(var uParam0) // Position - 0x437 Hash - 0xDE49ABC ^0xDA8A17AF
{
	BOOL flag;
	int i;
...
void func_18(var uParam0) // Position - 0x8A1 Hash - 0x18F398F3 ^0x72B604C0
{
	BOOL flag;
	int i;
...
BOOL func_19(var uParam0) // Position - 0xB74 Hash - 0x7C47DD35 ^0xA17069D6
{
	if (uParam0->f_4 == 0)
...
int func_20(int iParam0, Any anParam1) // Position - 0xBC3 Hash - 0xD4D5B736 ^0x6C5BEB38
{
	var unk;
...
void func_21(int iParam0, int iParam1) // Position - 0xBEC Hash - 0xA79B1A85 ^0x2E5A8FFD
{
...
void func_22(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC30 Hash - 0x8217C894 ^0xF71820D2
{
...
void func_23(int iParam0, int iParam1) // Position - 0xC97 Hash - 0x9815F445 ^0x9815F445
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_24(var uParam0) // Position - 0xCAC Hash - 0xED199DE8 ^0x5D4E4887
{
	if (uParam0->f_4 != -1)
	{
...
void func_25(int iParam0, int iParam1) // Position - 0xCDF Hash - 0x3ABC36EE ^0x53B64BE1
{
	if (func_58(iParam0))
...
int _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xCF8 Hash - 0xD73B9827 ^0x2D8CE86B
{
	return uParam0->f_1;
}

void func_27(var uParam0) // Position - 0xD04 Hash - 0xB9FDCB12 ^0xFEDA60D0
{
	if (func_59(*uParam0))
	{
...
BOOL func_28(var uParam0) // Position - 0xD74 Hash - 0x561F7581 ^0xBC8B9936
{
	var unk;
...
void func_29(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xDBA Hash - 0x9EDD889C ^0xE38DDFD2
{
	BOOL flag;
	BOOL flag2;
	float num;
...
BOOL func_30(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0xFE3 Hash - 0x5B2C7E35 ^0x6A87462A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
int func_31(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1038 Hash - 0x8EBD6187 ^0x42F0F0AC
{
	int num;
	var unk13;
	int num2;
...
float func_32(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1073 Hash - 0x3DAE1415 ^0x2267FA69
{
...
void func_33(var uParam0) // Position - 0x109B Hash - 0x710CC8BD ^0x676E12E7
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
void func_34(Object obParam0, BOOL bParam1) // Position - 0x10DE Hash - 0xF2B472C2 ^0x79BD1E06
{
	if (ENTITY::DOES_ENTITY_EXIST(obParam0))
		if (!bParam1)
...
void func_35(var uParam0, int iParam1) // Position - 0x1150 Hash - 0x4F8BE4B5 ^0x2E599B99
{
	uParam0->f_1 = iParam1;
	return;
}

void func_36(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x115E Hash - 0xA400C89E ^0xDFDC4B6A
{
	if (!func_58(iParam0))
	{
...
void func_37(var uParam0) // Position - 0x1192 Hash - 0x999A53A6 ^0x6EB284C9
{
...
BOOL func_38(var uParam0) // Position - 0x11A8 Hash - 0x3B95E3A3 ^0xE3C0FF60
{
...
BOOL func_39(var uParam0) // Position - 0x11C9 Hash - 0xD44051D8 ^0x442FD26D
{
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_38))
...
void func_40(var uParam0) // Position - 0x11FA Hash - 0x4184F18F ^0x443F5DD1
{
	int i;
...
int func_41(Object obParam0, Object obParam1, int iParam2) // Position - 0x12E5 Hash - 0xF2B92A32 ^0xAD1DE34B
{
	int i;
...
BOOL func_42() // Position - 0x1395 Hash - 0xBBBD490D ^0xE114687D
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_38))
...
void func_43(var uParam0, var uParam1, Any anParam2) // Position - 0x13B2 Hash - 0x419530E8 ^0xA050DEAC
{
	var unk;
	int num;
	int num2;
...
void func_44(var uParam0, var uParam1, Any anParam2) // Position - 0x1454 Hash - 0xCD9DE76A ^0x1A292441
{
	var unk;
	int num;
	int num2;
...
void func_45(var uParam0) // Position - 0x14F6 Hash - 0x50C75968 ^0x8F184E9F
{
	var entityCoords;
	var unk3;
...
int func_46(var uParam0, var uParam1) // Position - 0x160D Hash - 0x7C008337 ^0xEB61F93B
{
	int num;
	int i;
...
void func_47(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1649 Hash - 0xBFD68399 ^0x1C9959F8
{
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
	{
...
void func_48(var uParam0) // Position - 0x1680 Hash - 0xF6CFFA30 ^0x942FF57D
{
	TASK::_REQUEST_HERB_COMPOSITE_ASSET(hLocal_40);
	return;
}

BOOL func_49(var uParam0) // Position - 0x168F Hash - 0xF849599 ^0xC92763ED
{
...
BOOL func_50(var uParam0) // Position - 0x16A5 Hash - 0xDD3E74DB ^0x11D34146
{
	var unk;
...
int func_51(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6) // Position - 0x16E7 Hash - 0x76785467 ^0x34019397
{
	Volume volume;
	int num;
...
int func_52(var uParam0) // Position - 0x1718 Hash - 0xEA24E94A ^0xC6A7F091
{
...
int func_53(var uParam0) // Position - 0x175B Hash - 0x9947E91F ^0x5CF92E84
{
	if (func_14(Global_1222327[*uParam0 /*251*/][uParam0->f_13], 2))
		return 1;
...
void func_54(var uParam0, int iParam1) // Position - 0x177F Hash - 0x624BD2B7 ^0x9DA59487
{
	BOOL flag;
	int i;
...
int func_55(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x18AB Hash - 0x4F430DA4 ^0x658D22B6
{
	var unk;
	int num;
...
BOOL func_56(int iParam0, int iParam1) // Position - 0x191A Hash - 0x1876A9B8 ^0x3CC6BD5B
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_57() // Position - 0x1936 Hash - 0x3A47228D ^0x15AE20E5
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

BOOL func_58(int iParam0) // Position - 0x194C Hash - 0x5499D461 ^0x5499D461
{
	if (*iParam0 == 0)
		return false;
...
BOOL func_59(Entity eParam0) // Position - 0x1964 Hash - 0xBB5840AD ^0x4A267E7
{
	Hash entityModel;
...
BOOL func_60() // Position - 0x19BA Hash - 0x3E672B00 ^0x5E7DB22A
{
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x19FA Hash - 0x8A4CBA15 ^0x8A4CBA15
{
	int num;
	int num2;
...
struct<5> func_62(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1A27 Hash - 0xFD1D83A6 ^0x412BEE1D
{
	var unk;
	int num;
	var unk6;
...
BOOL func_63(Hash hParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x1D9B Hash - 0x83727B4C ^0xA6F6F598
{
	var unk;
	var unk5;
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1ECF Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_65(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1EF9 Hash - 0x556D3123 ^0xD74EAB49
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_66() // Position - 0x1FF8 Hash - 0x20414E16 ^0x28E659F3
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_67(var uParam0, int iParam1) // Position - 0x200D Hash - 0x3D5489B0 ^0x3D5489B0
{
	*uParam0 = iParam1;
	return;
}

void func_68(int iParam0) // Position - 0x201A Hash - 0x81B61271 ^0x22A3D4FE
{
	if (iParam0 <= 0)
		return;
...
void func_69(var uParam0) // Position - 0x2041 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_110(uParam0, 0f);
	return;
}

float func_70(var uParam0) // Position - 0x2050 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_111(uParam0))
		return uParam0->f_1;
...
BOOL func_71(Entity eParam0) // Position - 0x2085 Hash - 0xE74E8D6A ^0xDC71868A
{
	int num;
	var unk5;
	Hash entityModel;
...
var func_72(BOOL bParam0, int iParam1) // Position - 0x211F Hash - 0x42C305C ^0x81DF2F42
{
	return func_73(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), bParam0, iParam1);
}

var func_73(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x213D Hash - 0x63C3F71D ^0x3019B977
{
	var value;
	Player bitIndex;
	int i;
...
void func_75(Any* panParam0, int* piParam1) // Position - 0x256A Hash - 0x46785048 ^0xC0630F6
{
...
BOOL func_76(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x259B Hash - 0x19DF3458 ^0x19DF3458
{
	var groundZ;
	int num;
	BOOL flag;
...
int func_77(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x269F Hash - 0xF4BE06E5 ^0x21E9A98D
{
	ItemSet itemSet;
...
void func_78(Volume volParam0) // Position - 0x275A Hash - 0x7DD010A2 ^0x16530136
{
...
void func_79(var uParam0, var uParam1, int iParam2) // Position - 0x2771 Hash - 0x49943F1A ^0x7403C87A
{
	var value;
	int num;
	int num2;
...
void func_80(var uParam0) // Position - 0x2836 Hash - 0x333BC7D4 ^0xCB2892E1
{
...
void func_81(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x286E Hash - 0x15598973 ^0x15598973
{
	int i;
	var unk;
...
Hash func_82(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x2924 Hash - 0xDD2F88C2 ^0x29E97850
{
	Hash weaponHash;
...
BOOL func_83(Hash hParam0) // Position - 0x2966 Hash - 0xD6E12BEB ^0x5BC6EDF6
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_84(int iParam0, var uParam1, var uParam2) // Position - 0x2974 Hash - 0xE3170F06 ^0xE3170F06
{
	int num;
...
BOOL func_85(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2990 Hash - 0x6E07CB9 ^0x6E07CB9
{
...
void func_86(int iParam0, int iParam1) // Position - 0x2A32 Hash - 0x978E21B ^0xA1438975
{
	int address;
...
struct<4> func_87(BOOL bParam0) // Position - 0x2A56 Hash - 0xCD4C5B4C ^0x5BC3600A
{
	int num;
...
int func_88(Hash hParam0) // Position - 0x2AF6 Hash - 0x199110B9 ^0xAC31347C
{
	var outData;
...
struct<4> func_89(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x2B21 Hash - 0x7592A56E ^0x2977A7FA
{
	var outGuid;
...
struct<4> func_90(BOOL bParam0) // Position - 0x2B52 Hash - 0xC271E2E0 ^0xF6B4968C
{
	int num;
...
BOOL func_91(Hash hParam0, BOOL bParam1) // Position - 0x2BF3 Hash - 0x5D0FB4E0 ^0x17177DE5
{
...
BOOL func_92(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2C2A Hash - 0x28ECC25A ^0x28ECC25A
{
	return func_105(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_93(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2C45 Hash - 0x3A11B8CD ^0x3324439A
{
	var unk;
...
struct<4> func_94(BOOL bParam0) // Position - 0x2C66 Hash - 0x9E4BFC8E ^0xE92FDA8B
{
	int num;
...
Hash func_95(Hash hParam0) // Position - 0x2CD0 Hash - 0x199110B9 ^0xEA34403C
{
	var outData;
...
BOOL func_96(Hash hParam0, Hash hParam1) // Position - 0x2CFB Hash - 0x3516CCA0 ^0x327E5212
{
	Hash outSlotId;
	Hash category;
	int i;
...
BOOL func_97(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2D68 Hash - 0x113CD144 ^0x113CD144
{
	return func_137(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_98(var uParam0) // Position - 0x2D7E Hash - 0x8D760BCC ^0xB90089A3
{
...
BOOL func_99(Hash hParam0, int iParam1) // Position - 0x2E08 Hash - 0x2B935ABB ^0xABFBDF54
{
	if (hParam0 == 0)
		return false;
...
Hash func_100(Hash hParam0) // Position - 0x2E22 Hash - 0xC9D82232 ^0xC9D82232
{
	return hParam0;
}

BOOL func_101(Hash hParam0, int iParam1) // Position - 0x2E2C Hash - 0x2B935ABB ^0x3E9B8BD9
{
	if (hParam0 == 0)
		return false;
...
int func_102(Hash hParam0, Hash hParam1) // Position - 0x2E46 Hash - 0x865BD5D3 ^0xA4D690BD
{
	if (hParam1 == 0)
		return 0;
...
BOOL func_103(Hash hParam0) // Position - 0x2E72 Hash - 0x1B551CF7 ^0xF7F1B098
{
	return func_88(hParam0) == joaat("WEAPON");
}

int func_104(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2E86 Hash - 0xFE9D5798 ^0xDB9F4CF5
{
	if (!func_99(hParam0, 0))
	{
		if (func_101(func_100(hParam0), 2))
...
int func_105(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2EFA Hash - 0xC754D793 ^0x26C4E67C
{
...
int func_106(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2F79 Hash - 0x68EBB232 ^0xEAD633B4
{
...
BOOL func_107(BOOL bParam0) // Position - 0x303B Hash - 0xAF6688CF ^0xA8FFE08D
{
	if (bParam0)
...
BOOL func_108() // Position - 0x306B Hash - 0x4B5A576F ^0x4B5A576F
{
	return func_142() != -1;
}

BOOL func_109() // Position - 0x3079 Hash - 0xA84EDD52 ^0x62087878
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_110(var uParam0, float fParam1) // Position - 0x309E Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_111(var uParam0) // Position - 0x30C4 Hash - 0x5001E582 ^0x5001E582
{
	return func_145(*uParam0, 1);
}

BOOL func_112(var uParam0) // Position - 0x30D4 Hash - 0x39705408 ^0x39705408
{
	return func_145(*uParam0, 2);
}

float func_113() // Position - 0x30E4 Hash - 0xB5A1F69B ^0x5409CF38
{
...
int func_114() // Position - 0x3116 Hash - 0x14C87721 ^0x9AEBE8A8
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

int func_115() // Position - 0x312B Hash - 0x4228A1C2 ^0x6E8485BE
{
	return Global_1051645.f_12;
}

char* func_116() // Position - 0x3139 Hash - 0x804B0F2D ^0x804B0F2D
{
	return "unnamed";
}

BOOL func_117(int iParam0) // Position - 0x3144 Hash - 0xC360B8E6 ^0xCBE2AF9D
{
	int num;
...
BOOL func_118(int iParam0) // Position - 0x31D3 Hash - 0x38220669 ^0xFB404699
{
...
int func_119(int iParam0) // Position - 0x31F1 Hash - 0x8D78E39F ^0x46194076
{
	if (iParam0 == 255)
...
BOOL func_120(Player plParam0) // Position - 0x323C Hash - 0x2484E1E ^0x4707F690
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x3281 Hash - 0xDF93FBF9 ^0x193910B6
{
	if (!func_149(uParam0))
		return 0;
...
BOOL func_122(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x32B1 Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_123(int iParam0) // Position - 0x32DA Hash - 0x17E198BB ^0x87862F46
{
	var memberHandles;
	var value;
	int gangMembers;
...
int func_124() // Position - 0x3333 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_1953292.f_1;
}

BOOL func_125(Any anParam0) // Position - 0x3341 Hash - 0x36229A1B ^0x2A9934D3
{
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x3387 Hash - 0x5A86BEFA ^0xB951E1EF
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_127(int iParam0) // Position - 0x339F Hash - 0x773BFB67 ^0x773BFB67
{
...
BOOL func_128(int iParam0) // Position - 0x33B6 Hash - 0x7F4C96B ^0x650690F6
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x3482 Hash - 0xECB143B0 ^0xE41A70C5
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_130(int iParam0) // Position - 0x349B Hash - 0xC67CC87B ^0xCFDC16A8
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_131() // Position - 0x34AE Hash - 0xD9A24882 ^0xD9A24882
{
	if (!func_150())
		return false;
...
int func_132(BOOL bParam0) // Position - 0x34C9 Hash - 0x58DE66BA ^0xF4629DE1
{
	if (func_1() == -1)
	{
...
struct<4> func_133() // Position - 0x350A Hash - 0xEC8CF1E8 ^0xEC8CF1E8
{
	var unk;
...
int func_134() // Position - 0x3516 Hash - 0x7BDD8F67 ^0x9160E7D8
{
...
BOOL func_135(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x3533 Hash - 0xE51043B0 ^0xB0CA6EA5
{
	int inventoryId;
...
BOOL func_136(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x3578 Hash - 0x7F891916 ^0x5CD7D9F0
{
...
BOOL func_137(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x35AB Hash - 0xC845006B ^0xAA568F17
{
...
BOOL func_138(Hash hParam0) // Position - 0x35E5 Hash - 0xD47FBCD ^0xAB7C7E88
{
	return func_152(hParam0, 1279601681);
}

Hash func_139(Hash hParam0, int iParam1) // Position - 0x35F8 Hash - 0x4BCFEB5A ^0x390DECDB
{
	int num;
	var unk;
	Hash hash;
...
int func_140(Hash hParam0, BOOL bParam1) // Position - 0x3672 Hash - 0xF271562B ^0x8AA3413F
{
	var unk;
	int num;
	int num2;
...
struct<4> func_141(Hash hParam0, BOOL bParam1) // Position - 0x36D1 Hash - 0x8EFC92E9 ^0xE8DA0FF0
{
	var unk;
...
int func_142() // Position - 0x36F6 Hash - 0x4228A1C2 ^0x247D3B40
{
	return Global_1149172.f_137;
}

void func_143(var uParam0, int iParam1) // Position - 0x3704 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_144(var uParam0, int iParam1) // Position - 0x3715 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_145(int iParam0, int iParam1) // Position - 0x372A Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_146(int iParam0, int iParam1) // Position - 0x3739 Hash - 0x61AB4BED ^0x265134F3
{
	int num;
...
BOOL func_147(Player plParam0) // Position - 0x37AD Hash - 0x18353CAA ^0x646BAFB
{
...
void func_148(Player plParam0) // Position - 0x37CA Hash - 0x40571888 ^0x70336487
{
	Player player;
...
BOOL func_149(var uParam0) // Position - 0x384D Hash - 0xEF8B385D ^0xEF8B385D
{
	if (*uParam0 >= 40)
		return false;
...
BOOL func_150() // Position - 0x3862 Hash - 0x9AF3EE3F ^0xBF53F360
{
...
int func_151(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3876 Hash - 0x118F0611 ^0x5AC648CA
{
...
BOOL func_152(Hash hParam0, Hash hParam1) // Position - 0x38A9 Hash - 0x99BEDC80 ^0x850557FF
{
	if (!func_99(hParam0, 0))
...
void func_153(Hash hParam0, var uParam1, var uParam2) // Position - 0x38EA Hash - 0x38E6C2DD ^0xA4FE6475
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_154(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3AF6 Hash - 0x90CCF0F4 ^0xA5F3D799
{
	Hash hash;
...
void func_155(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3BD4 Hash - 0x281CBA7C ^0xED4677E6
{
...
BOOL func_156(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x3BEF Hash - 0xA09A22CB ^0x2B47F617
{
...
int func_157(int iParam0) // Position - 0x3C14 Hash - 0x6B3C6310 ^0x48F4F81A
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_158(Any* panParam0, int iParam1, int iParam2) // Position - 0x3C35 Hash - 0x15F7E5EE ^0x39F4E7C
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_159() // Position - 0x3C6C Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1102813.f_3672;
}

void func_160(Player plParam0) // Position - 0x3C7B Hash - 0x40571888 ^0x70336487
{
	Player player;
...
void func_161(Player plParam0) // Position - 0x3CE7 Hash - 0xB360DAF6 ^0xEDA5F101
{
...
BOOL func_162(Hash hParam0) // Position - 0x3D22 Hash - 0xD6E12BEB ^0xA529D76A
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_163(Hash hParam0, Hash hParam1) // Position - 0x3D30 Hash - 0xD0E10453 ^0x5A74626C
{
