...
void main() // Position - 0x0 Hash - 0x5B140B50 ^0xD1F02007
{
	...
	fLocal_15 = 1f;
	iLocal_27 = 20000;
	iLocal_30 = iScriptParam_0;
	iLocal_28 = iScriptParam_0.f_2;
	bLocal_32 = false;
	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_29)
		{
			iLocal_29 = 0;
			func_5(iLocal_30, &iLocal_28);
			...
			switch (iLocal_28)
			{
				case 0:
					if (Global_1901671.f_2.f_26 > 0)
					{
						iLocal_31 = MISC::GET_GAME_TIMER() + Global_1901671.f_2.f_26;
						iLocal_28 = 1;
					}
					else
					{
				...
				case 1:
					if (!func_1() || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						bLocal_32 = false;
						iLocal_28 = 2;
					}
				...
				case 2:
					...
					if (func_10(func_9(iLocal_30)))
						func_11(func_9(iLocal_30), 4);
				
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_12(iLocal_30));
					Global_1896644 = -1;
					iLocal_31 = iLocal_27 + MISC::GET_GAME_TIMER();
					iLocal_28 = 3;
					break;
			
				case 3:
					if (func_13() || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT(iLocal_30);
						iLocal_31 = MISC::GET_GAME_TIMER() + iLocal_27;
						iLocal_28 = 4;
					}
					break;
			
				case 4:
					if (func_15(iLocal_30) || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0(iLocal_30);
						iLocal_31 = MISC::GET_GAME_TIMER() + iLocal_27;
						iLocal_28 = 5;
					}
					break;
				...
				case 5:
					if (func_17(iLocal_30) || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						_DEBUG_PRINT_0_0(iLocal_30);
						iLocal_31 = iLocal_27 + MISC::GET_GAME_TIMER();
						iLocal_28 = 7;
					}
					break;
				...
				case 7:
					if (func_10(func_9(iLocal_30)))
						if (func_19(func_9(iLocal_30), 4) && !(iLocal_31 < MISC::GET_GAME_TIMER()))
							break;
				
					if (func_20(iLocal_30) || iLocal_31 < MISC::GET_GAME_TIMER())
					{
						func_21(iLocal_30, 4);
						iLocal_31 = MISC::GET_GAME_TIMER() + iLocal_27;
						iLocal_28 = 8;
				...
				case 10:
					...
					func_36(iLocal_30, &Global_1896698);
					iLocal_28 = 11;
					break;
				...
				case 12:
					if (func_40(iLocal_30))
						iLocal_29 = MISC::GET_GAME_TIMER() + 1000;
				
					func_41(&Global_1896698, iLocal_30);
					func_42(iLocal_30);
					func_21(iLocal_30, 8);
					...
					PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_30 /*36*/].f_11);
				
					if (Global_1887363[iLocal_30 /*36*/].f_12 > 0f)
						PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887363[iLocal_30 /*36*/].f_12);
					break;
		...
		if (Global_1887363[iLocal_30 /*36*/].f_13 == 0)
		{
		}
		else
		{
			PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1887363[iLocal_30 /*36*/].f_13);
		}
...
BOOL func_13() // Position - 0x7D0 Hash - 0xD62C34DC ^0x3D043788
{
	Volume args;

	volLocal_19 = Global_1887363[3 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(volLocal_19, 1);
	volLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2162.926f, -618.1368f, 42.473f, 0f, 0f, 44.5f, 10.521f, 13f, 4f, "Lagras - m_volBaitShop");
	volLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2162.323f, -619.085f, 43.189f, 0f, 0f, -44f, 2.27f, 2.954f, 2.579f, "Lagras - m_volBaitPrompt");
	VOLUME::_0xB469CFD9E065EB99(volLocal_20, 10000);
	volLocal_22 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1964.833f, -527.56f, 41.499f, 0f, 0f, 0f, 14.456f, 10.148f, 8.8f, "BAY Harriet - m_volHarriet");
	volLocal_23 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1966.6788f, -527.5971f, 41.941f, 0f, 0f, 30f, 3.7f, 3.7f, 4.2f, "BAY Harriet - m_volHarrietPrompt");
	volLocal_24 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1963.142f, -528.919f, 41.852f, 0f, 0f, 0f, 4.045f, 4.156f, 2f, "BAY Harriet - m_volHarrietOffLimits");
	args = volLocal_24;
	args.f_2 = -1;
	AICOVERPOINT::_0x733077295AB51304(&args);
	volLocal_25 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("volBox"), 1964.789f, -528.676f, 41.852f, 0f, 0f, 0f, 1f, 1f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(volLocal_25, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(volLocal_25, true);
	volLocal_26 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("volBox"), 1966.414f, -528.38f, 41.852f, 0f, 0f, 0f, 3.2f, 7.3f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(volLocal_26, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(volLocal_26, false);
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x93C Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x948 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x955 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x961 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x96E Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x97A Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x98F Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x9A0 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9DF Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x9EB Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x9F3 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xAA3 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0xAAB Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0xAB3 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0xABB Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_29(int iParam0) // Position - 0xAC3 Hash - 0xBA267B26 ^0xEA063113
{
	func_58(14, volLocal_20, iParam0, volLocal_21, 0, 4, false, false, -1082130432, 0);
	func_59(14, false);
	func_58(39, volLocal_22, iParam0, volLocal_23, volLocal_24, 2097164, true, false, -1082130432, 0);
	func_60(39, 65536);
	func_60(39, 32768);
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", true, true);
	AUDIO::_SET_AMBIENT_ZONE_POSITION("AZ_Naturalist_Camp", VOLUME::GET_VOLUME_COORDS(volLocal_22), 0f);
	func_61(39, 4096);
	return;
}

void func_30(int iParam0) // Position - 0xB37 Hash - 0xC6EC040B ^0xE4BDE2D8
{
	func_62(638, volLocal_20, true);
	return;
}

void func_31() // Position - 0xB4A Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0xB52 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_33(int iParam0) // Position - 0xB5A Hash - 0xCBAE7496 ^0xCBAE7496
{
	iParam0 = iParam0;
	func_63(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_34() // Position - 0xB76 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0xBA7 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xBED Hash - 0x20E74CDB ^0x20E74CDB
{
	iParam0 = iParam0;
	func_64(uParam1, volLocal_19, 1);
	func_64(uParam1, volLocal_20, 2);
	return;
}

void func_37(int iParam0) // Position - 0xC0B Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_65(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xC24 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xC35 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xC4D Hash - 0x12878ED6 ^0x12878ED6
{
	iParam0 = iParam0;
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xC5A Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xD99 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xDA6 Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xDDC Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_79();
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_30)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_80(iLocal_30, false), 1);
					break;
			}
		}
	...
	else if (func_45() == -1)
	{
		...
		if (!func_86(iLocal_30, false))
			return false;
	}
	else if (!func_87(iLocal_30))
	{
		return false;
	}
...
int func_45() // Position - 0xEF0 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xEFE Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xF0A Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xF35 Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xF77 Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1057 Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1075 Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1088 Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x10A6 Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x119E Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x11AF Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x11C3 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x11D7 Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x11E1 Hash - 0x11E8E9ED ^0xEE89D83
{
...
int func_59(int iParam0, BOOL bParam1) // Position - 0x1390 Hash - 0xD0FD971 ^0x657364CB
{
	int num;
	Hash hash;
	float num2;
	...
	if (func_105(iParam0, 16384) || func_105(iParam0, 32768) || _IS_NULL_VECTOR(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
	...
	num = func_100(func_107(), iParam0);

	if (!bParam1 && func_108(num, &hash, &num2, &unk) || bParam1 && func_109(num, &hash, &num2, &unk))
	{
		func_110(iParam0, hash, unk, num2, false);
...
void func_60(int iParam0, int iParam1) // Position - 0x14B7 Hash - 0x823E3440 ^0x4606FBC5
{
	func_111(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

void func_61(int iParam0, int iParam1) // Position - 0x14D1 Hash - 0x63A5F33B ^0xAED2C1AF
{
	if (!func_112(iParam0))
		return;

	func_111(&(Global_1915656.f_3[iParam0 /*447*/].f_7), iParam1);
	return;
}

int func_62(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x14F9 Hash - 0xEDF440C1 ^0x32727141
{
	PersChar persChar;
...
void func_63(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1547 Hash - 0x1E885EDE ^0x3AA465F4
{
...
void func_64(var uParam0, Volume volParam1, int iParam2) // Position - 0x156F Hash - 0x5828D351 ^0x6F1B8F85
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_65(int iParam0) // Position - 0x15C8 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_66() // Position - 0x15DE Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x160B Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x161A Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_69() // Position - 0x162B Hash - 0x463DA432 ^0x857E19AF
{
	return func_67(Global_1940199, 8192);
}

BOOL func_70(var uParam0, int iParam1) // Position - 0x163E Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_71(int iParam0) // Position - 0x164F Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_65(iParam0))
		return false;

	return Global_1887363[iParam0 /*36*/].f_21 == 1 || Global_1887363[iParam0 /*36*/].f_21 == 2 && !func_117(iParam0);
}

BOOL func_72(int iParam0, int iParam1) // Position - 0x168F Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_73() // Position - 0x16BC Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_74(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x16CA Hash - 0x69CA23BF ^0xAC7CF4CC
{
	BOOL flag;
	const char* str;
	char* str2;
	...
	str = func_119(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	if (!func_120(iParam4))
		if (func_65(iParam0))
			iParam4 = func_121(func_9(iParam0));
		else
			iParam4 = func_121(iParam1);

	if (func_120(iParam4))
		num = func_122(iParam4);

	if (flag && bParam3)
	{
		str2 = func_124(func_123(iParam2));
	}
	else if (func_125(iParam1, 2) || func_126(iParam4, 2) && !Global_1893611.f_9)
	{
	...
	else if (func_65(iParam0) && func_88(iParam0, 16777216) && !Global_1893611.f_9)
	{
	...
	{
		num2 = func_128(func_127());
		num3 = func_129(func_127());
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				temperatureAtCoords = func_130(temperatureAtCoords);
				str3 = "TIME_AND_TEMP_F";
			}
		
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(674, str3, num2, func_131(&unk, joaat("COLOR_PURE_WHITE")), str4, func_131(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str2 = MISC::VAR_STRING(162, str3, num2, func_131(&unk, joaat("COLOR_PURE_WHITE")), func_131(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_132(str, str2, 4000, 0, 0, 0, false, true);
	return;
}

void func_75(var uParam0, int iParam1) // Position - 0x1936 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_76(int iParam0, BOOL bParam1) // Position - 0x1949 Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_77(BOOL bParam0) // Position - 0x1FB2 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_78(int iParam0) // Position - 0x1FDB Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_79() // Position - 0x2020 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_80(int iParam0, BOOL bParam1) // Position - 0x2028 Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, BOOL bParam1) // Position - 0x27ED Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_82(BOOL bParam0) // Position - 0x2840 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void func_83(int iParam0) // Position - 0x2869 Hash - 0x8ACC617D ^0x5E28FE41
{
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", false, true);
	func_63(0.775f, 0.2f, 0.025f, 0f);
	iParam0 = iParam0;
	return;
}

void func_84(int iParam0) // Position - 0x2892 Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_85(int iParam0) // Position - 0x28C3 Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_86(int iParam0, BOOL bParam1) // Position - 0x28F6 Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
	...
	if (func_91(iParam0, &num, &num2, false, false))
	{
		...
		while (true)
		{
			if (!func_139(Global_1896644.f_1, 16))
				func_140(Global_1896644.f_1, false);
...
BOOL func_87(int iParam0) // Position - 0x29AC Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;

	for (i = 0; i < 40; i = i + 1)
	{
		if (func_141(i) || func_142(i))
		{
		}
		else
		{
...
BOOL func_88(int iParam0, BOOL bParam1) // Position - 0x2A26 Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_89(int iParam0) // Position - 0x2A57 Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_90(int iParam0) // Position - 0x2A78 Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_91(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2ACB Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_92(int iParam0) // Position - 0x318B Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_93(int iParam0) // Position - 0x31A2 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_94(int iParam0, BOOL bParam1) // Position - 0x31E5 Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_92(iParam0))
		return 0;
	...
	{
		func_146(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_145(iParam0)));
...
BOOL func_95() // Position - 0x32D0 Hash - 0x9AF3EE3F ^0xBF53F360
{
...
BOOL func_96() // Position - 0x32E4 Hash - 0x16C45944 ^0x16C45944
{
	return func_149(func_56(0));
}

BOOL func_97(int iParam0) // Position - 0x32F5 Hash - 0x4B08C8C4 ^0x4B08C8C4
{
	return !func_150(iParam0);
}

void func_98(BOOL bParam0, BOOL bParam1) // Position - 0x3304 Hash - 0x2F17103B ^0x1C4D2C36
{
	if (func_151(255) == 4)
		return;
	...
	{
		if (bParam1)
			func_153(0, false, 0, true);
	
		func_154(0);
		func_155(&(Global_1102813.f_3839));
		...
		func_156(&(Global_1102813.f_3878));
	...
	func_157(Global_1102813.f_3839, 36);
	func_158(Global_1102813.f_3878, 36);
	return;
}

void func_99(int iParam0, BOOL bParam1) // Position - 0x344F Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	flag = func_159(iParam0) && !bParam1;

	if (!flag && !func_105(iParam0, 65536))
	{
	...
	else if (func_160(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	if (func_160(iParam0, 16384) && !flag)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_6))
		{
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_163(Global_1051832.f_92[iParam0 /*75*/].f_31[i]);
	...
	if (func_105(iParam0, 262144))
		Global_1051832.f_92[iParam0 /*75*/].f_49 = 262144;
	else
		func_165(iParam0);

	if (VOLUME::DOES_VOLUME_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_24) && func_166(iParam0, 2))
	{
...
int func_100(int iParam0, int iParam1) // Position - 0x37FE Hash - 0x274C8E8A ^0x274C8E8A
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_101(int iParam0) // Position - 0x4164 Hash - 0xF53EDEBA ^0xF53EDEBA
{
	if (!func_168(iParam0))
		return 0;

	if (Global_1051832.f_4492[iParam0] == 0)
		Global_1051832.f_4492[iParam0] = func_169(iParam0);

	return Global_1051832.f_4492[iParam0];
}

int func_102(int iParam0) // Position - 0x41A5 Hash - 0xFE1A3B7C ^0xFE1A3B7C
{
	switch (iParam0)
	{
		case 3:
...
void func_103(int iParam0, int iParam1) // Position - 0x4242 Hash - 0xDCFC48D0 ^0xCB4861A2
{
...
void func_104(int iParam0) // Position - 0x4271 Hash - 0x93134738 ^0x938C636D
{
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x42AA Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x42C3 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_107() // Position - 0x42ED Hash - 0x4228A1C2 ^0x45DCDFAE
{
	return Global_1893611.f_2;
}

BOOL func_108(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x42FB Hash - 0xC625CFBA ^0x2BDC490F
{
	return func_170(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_109(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x431B Hash - 0xC625CFBA ^0x3684DAEE
{
	return func_170(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_110(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x433B Hash - 0xCAA352A8 ^0x24D53CD4
{
	if (bParam6)
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);

	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_171(hParam1, vParam2, fParam5, 0, 0, false);
...
void func_111(int iParam0, int iParam1) // Position - 0x43B7 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_112(int iParam0) // Position - 0x43C8 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_113(int iParam0, BOOL bParam1) // Position - 0x43DE Hash - 0xB10222FA ^0xCD9754C3
{
	if (func_45() != -1)
		return false;
...
PersChar func_114(int iParam0) // Position - 0x4436 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_115(int iParam0) // Position - 0x4456 Hash - 0x1F2EC350 ^0x1F2EC350
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_116(int iParam0) // Position - 0x446C Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_117(int iParam0) // Position - 0x4482 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_173())
		return true;
...
BOOL func_118() // Position - 0x44B7 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_175(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_119(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x44FA Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_176(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_178(func_177(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_179(iParam0) || func_180(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_120(int iParam0) // Position - 0x4F60 Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_121(int iParam0) // Position - 0x4F75 Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0x5030 Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
	...
	i = 0;
	gamerHandle = { func_181(PLAYER::PLAYER_ID()) };
...
int func_123(int iParam0) // Position - 0x509E Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_124(int iParam0) // Position - 0x51F9 Hash - 0x21CE226B ^0xB5CB042
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_125(int iParam0, BOOL bParam1) // Position - 0x5234 Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x5276 Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_120(iParam0))
		return false;
...
int func_127() // Position - 0x52BB Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_128(int iParam0) // Position - 0x52C7 Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_129(int iParam0) // Position - 0x52DA Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_130(float fParam0) // Position - 0x52EC Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_131(var uParam0, int iParam1) // Position - 0x5302 Hash - 0xB0CFF0C3 ^0xBACAC7D9
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
		return MISC::VAR_STRING(10, "LITERAL_STRING", uParam0);

	return func_182(MISC::VAR_STRING(10, "LITERAL_STRING", uParam0), iParam1);
}

int func_132(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5338 Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_133(int iParam0) // Position - 0x537B Hash - 0xD7EC85BD ^0xD7EC85BD
{
	if (func_179(iParam0))
		if (!func_180(44))
			return false;
...
void func_134(int iParam0, int iParam1) // Position - 0x539B Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_135(int iParam0, int iParam1) // Position - 0x53AC Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_136(var uParam0, var uParam1, int iParam2) // Position - 0x53C2 Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_137(int iParam0) // Position - 0x53DF Hash - 0x3E288458 ^0xC75F9664
{
	func_183(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_184(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
	...
	func_185(iParam0, 8192);
	func_185(iParam0, 32768);
	func_185(iParam0, 524288);
...
void func_138(int iParam0) // Position - 0x54BF Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_92(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_186(Global_1915656.f_3[iParam0 /*447*/].f_21))
		func_187(Global_1915656.f_3[iParam0 /*447*/].f_21, false, true, false, false);
	...
	func_188(Global_1915656.f_3[iParam0 /*447*/].f_9, false);
	func_189(iParam0, 536870912);
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_163(Global_1915656.f_3[iParam0 /*447*/].f_318[i /*6*/]);
...
BOOL func_139(int iParam0, BOOL bParam1) // Position - 0x5697 Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_140(int iParam0, BOOL bParam1) // Position - 0x56C5 Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_92(iParam0))
		return 0;
...
int func_141(int iParam0) // Position - 0x5748 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_142(int iParam0) // Position - 0x576F Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_143() // Position - 0x5790 Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_144() // Position - 0x5957 Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
Hash func_145(int iParam0) // Position - 0x59D2 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_92(iParam0))
		return 0;
...
void func_146(int iParam0, PersChar pchParam1) // Position - 0x59F0 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_92(iParam0))
		return;
...
void func_147(int iParam0, BOOL bParam1) // Position - 0x5A11 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_148(int iParam0) // Position - 0x5A4A Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_149(var uParam0, var uParam1) // Position - 0x5A70 Hash - 0x1268D0E3 ^0x1268D0E3
{
	return func_196(uParam0, 5, 8);
}

BOOL func_150(int iParam0) // Position - 0x5A83 Hash - 0xA3986FDD ^0xA3986FDD
{
	return func_197(1, iParam0);
}

int func_151(int iParam0) // Position - 0x5A92 Hash - 0x8D78E39F ^0x46194076
{
	if (iParam0 == 255)
...
int func_152(int iParam0) // Position - 0x5ADD Hash - 0x5423E6F3 ^0xE2118439
{
	if (func_198(&(Global_1102813.f_4), iParam0, 5))
		return 1;

	return 0;
}

void func_153(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5AFA Hash - 0x79169E9C ^0xA3FE4569
{
	func_199(iParam0);
	...
	else if (!func_201(128) && !func_202(19))
		CAM::DO_SCREEN_FADE_OUT(iParam2);

	if (bParam3 && func_203() == 4)
		func_152(18);
...
int func_154(int iParam0) // Position - 0x5B5C Hash - 0x5423E6F3 ^0xE2118439
{
	if (func_205(&(Global_1102813.f_4), iParam0, 5))
		return 1;

	return 0;
}

void func_155(var uParam0) // Position - 0x5B79 Hash - 0xCF95012E ^0xCF95012E
{
	var unk;
...
void func_156(var uParam0) // Position - 0x5B8B Hash - 0xFBC3ACC8 ^0xFBC3ACC8
{
	var unk;
...
void func_158(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5BF3 Hash - 0x6DF4F0B2 ^0x7B946ED1
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_159(int iParam0) // Position - 0x5C20 Hash - 0x287157F6 ^0x287157F6
{
	if (iParam0 == 28 || iParam0 == 29 || iParam0 == 38 || iParam0 == 27 || iParam0 == 15 || iParam0 == 39)
		return true;

	if (func_105(iParam0, 65536))
		return true;

	return false;
}

BOOL func_160(int iParam0, int iParam1) // Position - 0x5C7D Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_161(int iParam0, int iParam1) // Position - 0x5C96 Hash - 0x9E30ADED ^0xA0DD8460
{
	func_160(iParam0, iParam1);
...
int func_162(int iParam0) // Position - 0x5CD1 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_163(Hash hParam0) // Position - 0x5CE5 Hash - 0xDB9A74EC ^0x13B3F16D
{
...
void func_164(int iParam0) // Position - 0x5D05 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_165(int iParam0) // Position - 0x5D0D Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_166(int iParam0, int iParam1) // Position - 0x5D22 Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;

	return func_208(Global_1051832.f_92[iParam0 /*75*/].f_50, iParam1);
}

void func_167(int iParam0) // Position - 0x5D49 Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_168(int iParam0) // Position - 0x5DC8 Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_169(int iParam0) // Position - 0x5DDE Hash - 0xB89C4DF3 ^0x1393EE39
{
	var unk;

	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149432.f_7) && !func_210(12, func_209(iParam0), &unk))
		return 0;

	return unk.f_2;
}

BOOL func_170(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5E0F Hash - 0x5851BC53 ^0x8A1263E0
{
	int num;

	num = func_211();
	num.f_2 = -738708473;
	num.f_3 = func_209(iParam0);
...
int func_171(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5E97 Hash - 0x9EF7DC49 ^0x7633F111
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

Ped func_172(int iParam0) // Position - 0x5EB1 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_173() // Position - 0x5EDF Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_174() // Position - 0x5EE8 Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_175(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5F50 Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_214(func_56(0)))
		return true;
...
const char* func_176(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x60C6 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_177(var uParam0, var uParam1, var uParam2) // Position - 0x60DA Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_178(int iParam0) // Position - 0x6108 Hash - 0xE6862179 ^0x46D1F906
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_179(int iParam0) // Position - 0x63EC Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_180(int iParam0) // Position - 0x6416 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_217(iParam0))
		return false;
...
struct<2> func_181(Player plParam0) // Position - 0x6432 Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_182(const char* sParam0, int iParam1) // Position - 0x6446 Hash - 0x9E99F03 ^0xAC532778
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_183(int iParam0, BOOL bParam1) // Position - 0x6460 Hash - 0x2F9EB0B9 ^0xFDFCE1AF
{
	char* ambientZone;
...
void func_184(int iParam0, BOOL bParam1) // Position - 0x6494 Hash - 0x342D57CF ^0xDF9EFF3A
{
	switch (iParam0)
	{
		case 5:
...
void func_185(int iParam0, int iParam1) // Position - 0x64C9 Hash - 0x823E3440 ^0x340E01B4
{
	func_219(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_186(int iParam0) // Position - 0x64E3 Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_92(iParam0))
		return false;
...
void func_187(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6508 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_186(iParam0) && func_220(iParam0))
		return;

	func_147(iParam0, 1);
	func_193(iParam0);

	if (func_221(func_145(iParam0)))
	{
		persChar = func_114(iParam0);
...
void func_188(int iParam0, BOOL bParam1) // Position - 0x65F4 Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_168(iParam0))
		return;
	...
	if (bParam1)
	{
		if (!func_222(iParam0, 1024))
		{
			func_223(iParam0, 1024);
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_222(iParam0, 1024))
	{
		func_224(iParam0, 1024);
		INVENTORY::_0x9B4E793B1CB6550A();
	}
...
void func_189(int iParam0, int iParam1) // Position - 0x664A Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_112(iParam0))
		return;
...
int func_190(int iParam0) // Position - 0x66BD Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_191(int iParam0) // Position - 0x66D3 Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_192(int iParam0, BOOL bParam1) // Position - 0x66E9 Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_193(int iParam0) // Position - 0x671A Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_194(int iParam0) // Position - 0x675E Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_195(int iParam0) // Position - 0x6773 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_196(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6788 Hash - 0x9EA53184 ^0x9EA53184
{
	int num;
...
BOOL func_197(int iParam0, int iParam1) // Position - 0x67C3 Hash - 0x61AB4BED ^0x265134F3
{
	int num;
	...
	if (iParam1 == 255)
		return func_227(&(Global_1102813.f_4), num, 5);
	...
	if (Global_1295666.f_17[iParam1])
		return func_227(&(Global_1101558[iParam1 /*38*/].f_4), num, 5);

	return false;
}

BOOL func_198(Any* panParam0, int iParam1, int iParam2) // Position - 0x6837 Hash - 0x8AC008A3 ^0x375BADC3
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_199(int iParam0) // Position - 0x6869 Hash - 0x42868A8 ^0x3D52297C
{
	Global_1102813.f_26.f_12 = iParam0;
	return;
}

BOOL func_200(int iParam0) // Position - 0x687B Hash - 0xA1D29AFD ^0xABA18533
{
	return Global_1102813.f_26.f_7 && iParam0 != false;
}

BOOL func_201(BOOL bParam0) // Position - 0x6890 Hash - 0xA1D29AFD ^0x8B9D4F17
{
	return Global_1102813.f_26.f_9 && bParam0 != false;
}

BOOL func_202(int iParam0) // Position - 0x68A5 Hash - 0x10DA64DD ^0x85E01D27
{
	return Global_1102813.f_4[Global_1106895[iParam0 /*2*/]] && Global_1106895[iParam0 /*2*/].f_1 == Global_1106895[iParam0 /*2*/].f_1;
}

int func_203() // Position - 0x68D3 Hash - 0xE5D277D5 ^0xE5D277D5
{
	if (Global_1102813 <= 5)
...
void func_204(BOOL bParam0) // Position - 0x6906 Hash - 0xEBD3AD20 ^0x6E10961F
{
	if (func_229(bParam0))
		return;
...
BOOL func_205(Any* panParam0, int iParam1, int iParam2) // Position - 0x692D Hash - 0xA8F08582 ^0x9810C45C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_206(Hash hParam0) // Position - 0x6960 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_230(hParam0))
...
BOOL func_207() // Position - 0x697B Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

BOOL func_208(int iParam0, int iParam1) // Position - 0x6984 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_209(int iParam0) // Position - 0x6993 Hash - 0xB8EC44B7 ^0x241D648F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_210(int iParam0, int iParam1, var uParam2) // Position - 0x737B Hash - 0xDC10368D ^0xDC10368D
{
	var unk;

	if (func_231(iParam0, iParam1, &unk))
		func_232(&unk, iParam0, uParam2);
	else
		return false;
...
int func_211() // Position - 0x73A2 Hash - 0x4F5358E7 ^0x4EB0CC4F
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_212() // Position - 0x73B7 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_214(Global_1051268) && Global_1572887.f_8 & 1 != 0)
		return true;

	return false;
}

struct<2> func_213() // Position - 0x740F Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_214(var uParam0, var uParam1) // Position - 0x741D Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_233(uParam0))
		return false;
	...
	if (uParam0.f_1 >= func_234(uParam0))
		return false;

	return true;
}

struct<2> func_215() // Position - 0x7451 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_216(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x749C Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;

	func_235(iParam3, &unk, &num, &num2);

	if (func_236(uParam0, unk, num, num.f_1, num2))
		return true;

	return false;
}

BOOL func_217(int iParam0) // Position - 0x74CC Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_218(int iParam0) // Position - 0x74DF Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_219(var uParam0, int iParam1) // Position - 0x7509 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_220(int iParam0) // Position - 0x751E Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_221(Hash hParam0) // Position - 0x7542 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_222(int iParam0, BOOL bParam1) // Position - 0x754E Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_168(iParam0))
		return false;
...
void func_223(int iParam0, BOOL bParam1) // Position - 0x7574 Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_168(iParam0))
		return;
...
void func_224(int iParam0, BOOL bParam1) // Position - 0x75A2 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_168(iParam0))
		return;
...
void func_225(int iParam0) // Position - 0x75DC Hash - 0xB29062D ^0xB29062D
{
	func_238(func_237(iParam0));
	return;
}

int func_226(int iParam0, var uParam1) // Position - 0x75EE Hash - 0x9C3ED8B4 ^0x9C3ED8B4
{
	if (iParam0 == 2)
...
BOOL func_227(Any* panParam0, int iParam1, int iParam2) // Position - 0x7608 Hash - 0x15F7E5EE ^0x39F4E7C
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_228() // Position - 0x763F Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_1102813.f_3672;
}

BOOL func_229(BOOL bParam0) // Position - 0x764E Hash - 0x695C3191 ^0x86E70E17
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_230(Hash hParam0) // Position - 0x7664 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_231(int iParam0, int iParam1, Any* panParam2) // Position - 0x7670 Hash - 0x8467BB0B ^0xA289B29B
{
	*panParam2 = Global_1149432.f_7;
	panParam2->f_2 = 1351168281;
	panParam2->f_3 = func_240(iParam0);
	panParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam2->f_1), panParam2);
}

void func_232(Any* panParam0, int iParam1, var uParam2) // Position - 0x76A4 Hash - 0x59F43AD2 ^0xB9A366FE
{
	var unk;
...
BOOL func_233(int iParam0) // Position - 0x771E Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_234(int iParam0) // Position - 0x775D Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_235(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x77F3 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_236(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x8291 Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_237(int iParam0) // Position - 0x82F7 Hash - 0xA78B2E8C ^0xA78B2E8C
{
...
void func_238(int iParam0) // Position - 0x8814 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_239(var uParam0, var uParam1) // Position - 0x8825 Hash - 0xF9339824 ^0x8CB8B693
{
	var unk;
	...
	if (func_241(uParam0, &unk))
		return unk.f_1;

	return -1;
}

int func_240(int iParam0) // Position - 0x8851 Hash - 0x5FB59AC3 ^0xE293EFF
{
	int num;
...
BOOL func_241(int iParam0, var uParam1, Any* panParam2) // Position - 0x89C6 Hash - 0xEDAACC68 ^0x7998E850
{
	if (!func_214(iParam0))
		return false;
...
void func_242(Any* panParam0) // Position - 0x8AD1 Hash - 0xE2B2004A ^0x20B50C0B
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
