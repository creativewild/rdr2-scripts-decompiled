...
void func_6() // Position - 0x10C Hash - 0x5482D413 ^0x4A286B86
{
	...
	{
		case 0:
			uLocal_62[0 /*3*/] = { func_16() };
			uLocal_62[1 /*3*/] = { func_17() };
			uLocal_62[2 /*3*/] = { func_18() };
			func_19(Global_33, &uLocal_62, &unk);
			hLocal_72 = func_20(unk);
			func_15(1);
			break;
		...
		case 1:
			...
			{
				OBJECT::_DOOR_SYSTEM_FORCE_SHUT(hLocal_72, true);
				func_22(&uLocal_20, false);
			}
		...
		case 2:
			...
			func_27(&uLocal_23, true, true, false, false, 1);
...
void func_7() // Position - 0x256 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_8() // Position - 0x25E Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x26A Hash - 0x5A8C3AF6 ^0xD29C94E1
{
	struct<2> eventData;
...
void func_10(int iParam0) // Position - 0x292 Hash - 0x5A8C3AF6 ^0xD29C94E1
{
	struct<2> eventData;
...
void func_11(int iParam0) // Position - 0x2BA Hash - 0x5A8C3AF6 ^0xD29C94E1
{
	struct<2> eventData;
...
BOOL func_12(int iParam0) // Position - 0x2E2 Hash - 0xE2693F54 ^0xE2693F54
{
	return bLocal_18 && iParam0 != false;
}

void func_13(int iParam0) // Position - 0x2F1 Hash - 0xA35734FF ^0xA35734FF
{
	if (!func_12(iParam0))
		return;
...
void func_14() // Position - 0x310 Hash - 0x815A523A ^0xAD6F40B1
{
	func_31(&uLocal_23);
...
void func_15(int iParam0) // Position - 0x33E Hash - 0x28DF00E8 ^0x28DF00E8
{
	iLocal_19 = iParam0;
	return;
}

Vector3 func_16() // Position - 0x34A Hash - 0x21158019 ^0x21158019
{
	return 2710.57f, -1291.2f, 48.63f;
}

Vector3 func_17() // Position - 0x361 Hash - 0x21158019 ^0x21158019
{
	return -290.86f, 813.36f, 118.42f;
}

Vector3 func_18() // Position - 0x378 Hash - 0x21158019 ^0x21158019
{
	return -281.07f, 815.24f, 118.42f;
}

Vector3 func_19(Ped pedParam0, var uParam1, var uParam2) // Position - 0x38F Hash - 0x50F8524F ^0x50F8524F
{
	int i;
	var unk;
	float num;
...
Hash func_20(int iParam0) // Position - 0x40B Hash - 0x21FAF347 ^0xD42F2588
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_21(var uParam0) // Position - 0x446 Hash - 0x5001E582 ^0x5001E582
{
	return func_34(*uParam0, 1);
}

void func_22(var uParam0, BOOL bParam1) // Position - 0x456 Hash - 0xA95D0C2 ^0xA95D0C2
{
...
BOOL func_23(var uParam0, float fParam1) // Position - 0x476 Hash - 0xAC057F02 ^0xAC057F02
{
	if (!func_21(uParam0))
		return false;
...
void func_24(var uParam0) // Position - 0x49D Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_36(uParam0, 0f);
	return;
}

void func_25(BOOL bParam0) // Position - 0x4AC Hash - 0xBDD9F5CB ^0xBDD9F5CB
{
	if (func_12(bParam0))
		return;
...
BOOL func_26() // Position - 0x4C7 Hash - 0xA4A1F612 ^0x922FF16E
{
	Entity entity;
...
void func_27(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x593 Hash - 0xA34D2F63 ^0xEADEBB8F
{
	float num;
	float num2;
	float num3;
...
void func_28(var uParam0) // Position - 0x924 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_29(var uParam0) // Position - 0x92C Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_30(var uParam0) // Position - 0x934 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_31(var uParam0) // Position - 0x93C Hash - 0x9795EF4C ^0x78847681
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
...
float func_32(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x9E2 Hash - 0x3DAE1415 ^0x2267FA69
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xA0A Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_34(int iParam0, int iParam1) // Position - 0xA34 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

float func_35(var uParam0) // Position - 0xA43 Hash - 0xEA3FCDB ^0x60B224E0
{
	if (!func_21(uParam0))
		return uParam0->f_1;
...
void func_36(var uParam0, float fParam1) // Position - 0xA78 Hash - 0x30433BAB ^0xF854D531
{
...
BOOL func_37(Hash hParam0) // Position - 0xA9E Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

Entity func_38(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xAAA Hash - 0x12AC5078 ^0x43862B34
{
	Entity entity;
...
Vector3 func_39() // Position - 0xAEF Hash - 0x21158019 ^0x21158019
{
	return 0.537029f, 0.426005f, 1.6552f;
}

Vector3 func_40() // Position - 0xB06 Hash - 0x6E62356A ^0x6E62356A
{
	return -7.766f, 0f, 175.2488f;
}

void func_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, BOOL bParam15, int iParam16, int iParam17) // Position - 0xB19 Hash - 0x9B9CE59C ^0xA7B44C13
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
BOOL func_42(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xC1A Hash - 0x4D0D3D49 ^0xB736304C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Vector3 func_43(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0xC43 Hash - 0x4C194BC9 ^0x4C194BC9
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

float func_44(float fParam0, float fParam1, float fParam2) // Position - 0xC5E Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_45(var uParam0) // Position - 0xC85 Hash - 0x39705408 ^0x39705408
{
	return func_34(*uParam0, 2);
}

float func_46() // Position - 0xC95 Hash - 0xB5A1F69B ^0x5409CF38
{
...
void func_47(var uParam0, int iParam1) // Position - 0xCC7 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_48(var uParam0, int iParam1) // Position - 0xCD8 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

Entity func_49(Hash hParam0, int iParam1) // Position - 0xCED Hash - 0x3D4C4025 ^0x9DFFA56D
{
...
Hash func_50(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD23 Hash - 0xEC5804B5 ^0xE95C34A9
{
...
BOOL func_51(Hash hParam0) // Position - 0xDC7 Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_37(hParam0))
