...
void func_7() // Position - 0x1BD Hash - 0xD8C6DE12 ^0xD8C6DE12
{
	func_14();
	return;
}

void func_8() // Position - 0x1C9 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x1D5 Hash - 0x5A8C3AF6 ^0xD29C94E1
{
	struct<2> eventData;
...
void func_10(int iParam0) // Position - 0x1FD Hash - 0x5A8C3AF6 ^0xD29C94E1
{
	struct<2> eventData;
...
void func_11(int iParam0) // Position - 0x225 Hash - 0x5A8C3AF6 ^0xD29C94E1
{
	struct<2> eventData;
...
void func_12(Ped pedParam0, Entity eParam1) // Position - 0x24D Hash - 0xE7380651 ^0xAF20DF79
{
	switch (iLocal_18)
	{
		case 0:
...
void func_13() // Position - 0x329 Hash - 0x27403788 ^0x27403788
{
	if (iLocal_18 == 1)
		func_21(2);
...
void func_14() // Position - 0x33C Hash - 0x58498352 ^0xD7F74811
{
	if (iLocal_18 == 0)
		return;
...
void func_15(var uParam0) // Position - 0x3A8 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_16(var uParam0) // Position - 0x3B0 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

void func_17(var uParam0) // Position - 0x3B8 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

int func_18() // Position - 0x3C0 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

BOOL func_19() // Position - 0x3CE Hash - 0xC29D95D0 ^0x7D8F0322
{
...
BOOL func_20(Entity eParam0) // Position - 0x41B Hash - 0x5070C850 ^0x54F9FDB3
{
...
void func_21(int iParam0) // Position - 0x66F Hash - 0x74B49122 ^0x74B49122
{
...
BOOL func_22(Ped pedParam0) // Position - 0x682 Hash - 0x207127FF ^0x2A9AAC90
{
...
BOOL func_23() // Position - 0x6F3 Hash - 0xDBECE400 ^0x8D7B8A13
{
...
void func_24(Object* pobParam0) // Position - 0x789 Hash - 0x93C0E130 ^0xADF3BC31
{
...
void func_25(Ped pedParam0) // Position - 0x7DB Hash - 0xEB7905E3 ^0x6D05C958
{
	Vector3 entityCoords;
	float entityHeading;
...
Vector3 func_26(float fParam0, var uParam1, float fParam2) // Position - 0x8D5 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_27(var uParam0, var uParam1, float fParam2) // Position - 0x914 Hash - 0x8B8B65A8 ^0x5D806065
{
	float num;
	float num2;
