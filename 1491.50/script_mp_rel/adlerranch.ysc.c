	...
	while (func_4())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_23)
		{
			...
			switch (iLocal_22)
			{
				...
				case 9:
					_DEBUG_PRINT_0_0_0_0_0_0_0(iLocal_24);
					func_34();
					iLocal_22 = 10;
					break;
...
void _DEBUG_PRINT(int iParam0) // Position - 0x57A Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}
...
BOOL func_13() // Position - 0x7D4 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x7DD Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x7E9 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x7F6 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x802 Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x80F Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x81B Hash - 0xFB77C6C8 ^0xFB77C6C8
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x830 Hash - 0x6DE0FDC2 ^0x6DE0FDC2
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x841 Hash - 0x85549BC4 ^0xED99428
{
...
void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x880 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x88C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x894 Hash - 0xB323866B ^0xE9E411E6
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x944 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_26() // Position - 0x94C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_27() // Position - 0x954 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x95C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x964 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x970 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x97C Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_32() // Position - 0x984 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0_0_0(int iParam0) // Position - 0x98C Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0x998 Hash - 0x2E7B6F22 ^0x3889AD2B
{
...
void func_35(var uParam0) // Position - 0x9C9 Hash - 0x28951280 ^0x95B241A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA0F Hash - 0x71931A41 ^0x38641BC4
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA23 Hash - 0xD90F0DEC ^0xD90F0DEC
{
	if (!func_58(iParam0))
		return;
...
BOOL func_38(int iParam0) // Position - 0xA3C Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1893611 && iParam0 != false;
}

void func_39(int iParam0) // Position - 0xA4D Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_1893611 = Global_1893611 - Global_1893611 && iParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xA65 Hash - 0xB667D07F ^0x443E6A9
{
	iParam0 = iParam0;
	func_60();

	if (func_61(&bLocal_17))
	{
		if (bLocal_17)
		{
			func_62(2051127971, true, -1f, false, false, 0, false, false);
			func_63(2051127971, 1, true);
		}
	}
...
void func_41(var uParam0, int iParam1) // Position - 0xA9F Hash - 0xD10A9199 ^0x6508B54A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBDE Hash - 0xBF2BBCFF ^0xBF2BBCFF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBEB Hash - 0x1E5EE2B6 ^0xA7F309C
{
	var weatherType1;
	var weatherType2;
...
BOOL func_44(int iParam0) // Position - 0xC21 Hash - 0x6217D08D ^0x2FD90261
{
	if (iParam0 == 0)
	{
		func_76();
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("mpac_travel"), joaat("mpac_travel_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_24, false), 1);
					break;
			}
		}
		...
		_DEBUG_PRINT_0_0_0_0_0_0_0_0(iLocal_24);
		func_34();
		return false;
	}
	else if (func_45() == -1)
	{
		...
		if (!func_83(iLocal_24, false))
			return false;
	}
	else if (!func_84(iLocal_24))
	{
		return false;
	}
...
int func_45() // Position - 0xD35 Hash - 0x4228A1C2 ^0xC7CA5F45
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD43 Hash - 0xCE5FB49E ^0x89989AD6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD4F Hash - 0x9B63752F ^0x341C80A6
{
...
BOOL func_48() // Position - 0xD7A Hash - 0x5CB4FB5 ^0x16ECF26F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDBC Hash - 0x8CDC02F2 ^0xDB4E8541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xE9C Hash - 0xEECF70F1 ^0xEECF70F1
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEBA Hash - 0xC67CC87B ^0x33ED18E1
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xECD Hash - 0xDD4F2B2E ^0xED52CD7
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEEB Hash - 0x156C7489 ^0x156C7489
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0xFE3 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0xFF4 Hash - 0x9C8B9DFE ^0x5874CE32
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1008 Hash - 0x93EB5DDA ^0xBB7477DE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x101C Hash - 0x72C53F65 ^0x72C53F65
{
	return uParam0;
}

BOOL func_58(int iParam0) // Position - 0x1026 Hash - 0x7AB6E77F ^0x7AB6E77F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_59() // Position - 0x103C Hash - 0xC70365F7 ^0xC70365F7
{
	int i;
...
void func_60() // Position - 0x1069 Hash - 0xAFDD19BE ^0xF50822F8
{
	BOOL flag;

	flag = false;

	if (func_93(356365161) || func_93(-1187950766))
		flag = true;
...
BOOL func_61(var uParam0) // Position - 0x10D2 Hash - 0xB4769808 ^0xB4769808
{
	if (func_96())
	{
		if (!*uParam0)
...
void func_62(Hash hParam0, BOOL bParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1102 Hash - 0xD777F4CF ^0xBFF3124C
{
	func_97(hParam0, false, false);
	...
	if (func_98(hParam0))
	{
		...
		if (bParam3)
			func_99(hParam0, fParam2, true, bParam6);
		else if (bParam1)
			if (bParam4)
				func_100(hParam0, true);
			else
				func_101(hParam0, true);
		else
...
void func_63(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x118D Hash - 0xB9FD135E ^0x2A68E0C1
{
	func_97(hParam0, false, false);
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x11C6 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x11D5 Hash - 0x718DD1EF ^0x7E064505
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_66() // Position - 0x11E6 Hash - 0x463DA432 ^0x857E19AF
{
	return func_64(Global_1940199, 8192);
}

BOOL func_67(var uParam0, int iParam1) // Position - 0x11F9 Hash - 0x718DD1EF ^0xD9260236
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_68(int iParam0) // Position - 0x120A Hash - 0x97598EC0 ^0xB0C0A04B
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x124A Hash - 0xA98B69C6 ^0x8AB18C7C
{
...
int func_70() // Position - 0x1277 Hash - 0x4228A1C2 ^0xB47FB21D
{
	return Global_1896646.f_41;
}

void func_71(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1285 Hash - 0x659AC4C5 ^0x8A3286AA
{
	BOOL flag;
	const char* str;
	char* str2;
...
void func_72(var uParam0, int iParam1) // Position - 0x14E9 Hash - 0x53A96DDB ^0xB6A79257
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_73(int iParam0, BOOL bParam1) // Position - 0x14FC Hash - 0x2CB19C60 ^0x579311F8
{
...
void func_74(BOOL bParam0) // Position - 0x1B65 Hash - 0x8A5944E9 ^0x8A5944E9
{
	if (bParam0)
...
BOOL func_75(int iParam0) // Position - 0x1B8E Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_76() // Position - 0x1BD3 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

Hash func_77(int iParam0, BOOL bParam1) // Position - 0x1BDB Hash - 0xE1D12727 ^0xC0A2F1C4
{
	switch (iParam0)
	{
		case 0:
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x23A0 Hash - 0x5DE9DDE5 ^0xCE0029B2
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_79(BOOL bParam0) // Position - 0x23F3 Hash - 0x3703A155 ^0x3703A155
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0_0_0_0(int iParam0) // Position - 0x241C Hash - 0x6EF28A6B ^0x6EF28A6B
{
	iParam0 = iParam0;
	return;
}

void func_81(int iParam0) // Position - 0x2428 Hash - 0x1BC1B95A ^0xE45E58CB
{
	int i;
...
void func_82(int iParam0) // Position - 0x2459 Hash - 0x602FEA97 ^0x32262E5A
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x248C Hash - 0xF908F79F ^0xFA4C6B92
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(int iParam0) // Position - 0x2542 Hash - 0x3CF47CAC ^0x9AC30644
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x25BC Hash - 0x34341F7C ^0xD1267D8C
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_86(int iParam0) // Position - 0x25ED Hash - 0x6430C01F ^0x7E62419A
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_87(int iParam0) // Position - 0x260E Hash - 0xA5F6A570 ^0xA5F6A570
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_88(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2661 Hash - 0xCBEA69A ^0xCBEA69A
{
	BOOL flag;
...
BOOL func_89(int iParam0) // Position - 0x2D21 Hash - 0x958B152F ^0x888D9460
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_90(int iParam0) // Position - 0x2D38 Hash - 0xDEBEF6D4 ^0xDEBEF6D4
{
	switch (iParam0)
	{
		case 64:
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x2D7B Hash - 0x9F6E755B ^0x9F6E755B
{
	if (!func_89(iParam0))
		return 0;
	...
	{
		func_134(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_133(iParam0)));
...
BOOL func_92(int iParam0) // Position - 0x2E66 Hash - 0x532FA545 ^0x532FA545
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_93(int iParam0) // Position - 0x2E7C Hash - 0x319C5EC2 ^0xB18B248
{
	int num;
	int num2;
	int offset;
	...
	if (func_139(num2))
	{
		if (Global_1072759.f_19585.f_24 && !func_140(iParam0))
			return false;
...
int func_94(Hash hParam0) // Position - 0x2EFB Hash - 0x4D60F41E ^0xCD4529DF
{
...
int func_95(Hash hParam0) // Position - 0x2F22 Hash - 0xC7B42F6B ^0x68D64A95
{
	if (!STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
BOOL func_96() // Position - 0x2F4A Hash - 0x2C6DE8F6 ^0xBF042FB1
{
	if (Global_1572887.f_14 == -1)
		return false;
...
Hash func_97(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2F66 Hash - 0xEC5804B5 ^0xE95C34A9
{
...
BOOL func_98(Hash hParam0) // Position - 0x300A Hash - 0xCD60E05 ^0x368E4BC
{
	if (func_142(hParam0))
...
void func_99(Hash hParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3025 Hash - 0x6DA9F066 ^0x2A9066C3
{
	if (func_98(hParam0))
	{
...
void func_100(Hash hParam0, BOOL bParam1) // Position - 0x305D Hash - 0xC342281D ^0xB1F97AC8
{
	if (func_98(hParam0))
...
void func_101(Hash hParam0, BOOL bParam1) // Position - 0x308B Hash - 0xA39475C2 ^0x7E382EA4
{
	if (func_98(hParam0))
...
void func_102(Hash hParam0, BOOL bParam1) // Position - 0x30B9 Hash - 0x4844A91D ^0x50E23246
{
	if (func_98(hParam0))
...
BOOL func_103() // Position - 0x30E7 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_104(int iParam0) // Position - 0x30F0 Hash - 0x6A6EE485 ^0x6A6EE485
{
	if (iParam0 == 22 || iParam0 == 39 && !func_143())
		return true;
...
BOOL func_105() // Position - 0x3125 Hash - 0xB5F1D039 ^0x59A8BE9D
{
	if (Global_13)
		return false;
	...
	if (func_145(-1 ^ 9, false, true))
		return false;

	return true;
}

const char* func_106(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x3168 Hash - 0xAA95C4FB ^0xB3C7DDA0
{
	const char* str;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		str = func_146(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(str) && bParam4)
		str = func_148(func_147(Global_34));

	if (MISC::IS_STRING_NULL_OR_EMPTY(str))
	{
		if (!func_149(iParam0) || func_150(44))
		{
			switch (iParam0)
			{
				case 1:
...
BOOL func_107(int iParam0) // Position - 0x3BC7 Hash - 0xA5768850 ^0xA5768850
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_108(int iParam0) // Position - 0x3BDC Hash - 0xA08D7C4E ^0xA08D7C4E
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0) // Position - 0x3C97 Hash - 0xDE3AB7BF ^0xBF88E2D7
{
	int i;
	var gamerHandle;
	int bountyData;
	...
	i = 0;
	gamerHandle = { func_151(PLAYER::PLAYER_ID()) };
...
int func_110(int iParam0) // Position - 0x3D05 Hash - 0x653F925B ^0x653F925B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_111(int iParam0) // Position - 0x3E60 Hash - 0x21CE226B ^0x117FC044
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_112(int iParam0, int iParam1) // Position - 0x3E9B Hash - 0x420CBA68 ^0x9F9619A9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_113(int iParam0, int iParam1) // Position - 0x3EDD Hash - 0x9AD134EA ^0x3BFBD1FE
{
	if (!func_107(iParam0))
		return false;
...
int func_114() // Position - 0x3F22 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1902569;
}

int func_115(int iParam0) // Position - 0x3F2E Hash - 0xF4D85E05 ^0xA287BB5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_116(int iParam0) // Position - 0x3F41 Hash - 0xA0361328 ^0x659968B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_117(float fParam0) // Position - 0x3F53 Hash - 0xC643B4E3 ^0xC643B4E3
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_118(var uParam0, int iParam1) // Position - 0x3F69 Hash - 0xB0CFF0C3 ^0x9F1AE808
{
...
int func_119(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3F9F Hash - 0x10503CC4 ^0x6232183B
{
	int duration;
	var data;
	int num;
...
BOOL func_120(int iParam0) // Position - 0x3FE2 Hash - 0xA0FFCC68 ^0xA0FFCC68
{
	if (func_149(iParam0))
		if (!func_150(44))
			return false;
...
void func_121(int iParam0, int iParam1) // Position - 0x4003 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_122(int iParam0, int iParam1) // Position - 0x4014 Hash - 0xDB125B20 ^0x71B3ED52
{
	int num;
...
void func_123(var uParam0, var uParam1, int iParam2) // Position - 0x402A Hash - 0x31B6F9FF ^0xF5CD2283
{
...
void func_124(int iParam0) // Position - 0x4047 Hash - 0x3E288458 ^0xC75F9664
{
	func_153(Global_1939959.f_5[iParam0 /*11*/].f_6, true);
	func_154(Global_1939959.f_5[iParam0 /*11*/].f_6, false);
...
void func_125(int iParam0) // Position - 0x4127 Hash - 0x3CD01C93 ^0xBF009143
{
	int i;
	int num;

	if (func_89(Global_1915656.f_3[iParam0 /*447*/].f_21) && func_156(Global_1915656.f_3[iParam0 /*447*/].f_21))
		func_157(Global_1915656.f_3[iParam0 /*447*/].f_21, false, true, false, false);
	...
	func_158(Global_1915656.f_3[iParam0 /*447*/].f_9, false);
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_161(Global_1915656.f_3[iParam0 /*447*/].f_318[i /*6*/]);
...
BOOL func_126(int iParam0, BOOL bParam1) // Position - 0x42FF Hash - 0x3F05A93A ^0x3F05A93A
{
	if (func_45() != -1)
		return false;
...
int func_127(int iParam0, BOOL bParam1) // Position - 0x432D Hash - 0x4B9D82B ^0x1C7581CD
{
	if (!func_89(iParam0))
		return 0;
...
int func_128(int iParam0) // Position - 0x43B0 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 27:
...
int func_129(int iParam0) // Position - 0x43D7 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 33:
...
void func_130() // Position - 0x43F8 Hash - 0xDE81FF54 ^0x39F3D85F
{
	int i;
	var unk;
...
void func_131() // Position - 0x45BF Hash - 0x93D7F24D ^0x457E2679
{
	int i;
...
void func_132(int iParam0, BOOL bParam1) // Position - 0x463A Hash - 0x3F1AD274 ^0x4EDF9754
{
	BOOL flag;
	...
	flag = func_169(iParam0) && !bParam1;

	if (!flag && !func_170(iParam0, 65536))
	{
	...
	else if (func_171(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	if (func_171(iParam0, 16384) && !flag)
	{
	...
	else
	{
		for (i = 0; i < num; i = i + 1)
		{
			func_161(Global_1051832.f_92[iParam0 /*75*/].f_31[i]);
	...
	if (VOLUME::DOES_VOLUME_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_24) && func_175(iParam0, 2))
	{
...
Hash func_133(int iParam0) // Position - 0x49E9 Hash - 0xB7A722DE ^0xB7A722DE
{
	if (!func_89(iParam0))
		return 0;
...
void func_134(int iParam0, PersChar pchParam1) // Position - 0x4A07 Hash - 0x9642AD01 ^0x291C3DA3
{
	if (!func_89(iParam0))
		return;
...
PersChar func_135(int iParam0) // Position - 0x4A28 Hash - 0xE4DA9E55 ^0x1956E0E8
{
	if (!func_89(iParam0))
		return 0;
...
void func_136(int iParam0, BOOL bParam1) // Position - 0x4A48 Hash - 0x452DF11A ^0x452DF11A
{
	if (func_45() != -1)
		return;
...
BOOL func_137(int iParam0) // Position - 0x4A81 Hash - 0xF5815C8D ^0xF5815C8D
{
	if (!func_89(iParam0))
		return false;
...
int func_138(int iParam0, int iParam1) // Position - 0x4AA7 Hash - 0xC0F3E3A4 ^0x6F5CEED
{
	switch (iParam0)
	{
...
BOOL func_139(int iParam0) // Position - 0x634C Hash - 0xA3250C27 ^0x2A3A4993
{
	int num;
...
BOOL func_140(int iParam0) // Position - 0x6369 Hash - 0xAD766E45 ^0x511834A9
{
...
BOOL func_141() // Position - 0x6380 Hash - 0x4C1900E6 ^0x4C1900E6
{
	return func_177() == 4;
}

BOOL func_142(Hash hParam0) // Position - 0x638E Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_143() // Position - 0x639A Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_144() // Position - 0x63A3 Hash - 0xC0177349 ^0xA55DEE6F
{
	var unk;
	var unk3;
...
BOOL func_145(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x640B Hash - 0xB13E2226 ^0x3E0E04BA
{
	if (Global_1572887.f_14 != -1)
	{
	...
	if (iParam0 == 0 && func_180(func_56(0)))
		return true;
...
const char* func_146(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6581 Hash - 0x115DEB2 ^0x766BAF01
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_147(var uParam0, var uParam1, var uParam2) // Position - 0x6595 Hash - 0xD993B6FD ^0xD993B6FD
{
	int i;
...
const char* func_148(int iParam0) // Position - 0x65C3 Hash - 0xE6862179 ^0xFB4FB2C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_149(int iParam0) // Position - 0x68A7 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_150(int iParam0) // Position - 0x68D1 Hash - 0xA0FCEF7F ^0xA0FCEF7F
{
	if (!func_183(iParam0))
		return false;
...
struct<2> func_151(Player plParam0) // Position - 0x68ED Hash - 0x9BA8C2A6 ^0xEC10CC00
{
	var gamerHandle;
...
const char* func_152(const char* sParam0, int iParam1) // Position - 0x6901 Hash - 0x9E99F03 ^0xEF793D5A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_153(int iParam0, BOOL bParam1) // Position - 0x691B Hash - 0x2F9EB0B9 ^0x60E893CE
{
	char* ambientZone;
...
void func_154(int iParam0, BOOL bParam1) // Position - 0x694F Hash - 0x342D57CF ^0x2222C2EF
{
	switch (iParam0)
	{
		case 5:
...
void func_155(int iParam0, int iParam1) // Position - 0x6984 Hash - 0x823E3440 ^0x340E01B4
{
	func_185(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_156(int iParam0) // Position - 0x699E Hash - 0x9BC71541 ^0x89F7971
{
	if (!func_89(iParam0))
		return false;
...
void func_157(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x69C3 Hash - 0x9D6C88B4 ^0x9D6C88B4
{
	PersChar persChar;
	...
	if (!bParam4 && !func_156(iParam0) && func_186(iParam0))
		return;

	func_136(iParam0, 1);
	func_164(iParam0);

	if (func_187(func_133(iParam0)))
	{
...
void func_158(int iParam0, BOOL bParam1) // Position - 0x6AAF Hash - 0x6FB1865F ^0x85C63E45
{
	if (!func_188(iParam0))
		return;
...
void func_159(int iParam0, int iParam1) // Position - 0x6B05 Hash - 0x6F4899EB ^0x5624A2EB
{
	if (!func_193(iParam0))
		return;
...
int func_160(int iParam0) // Position - 0x6B78 Hash - 0x47F93C28 ^0x59A8BC1F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_161(Hash hParam0) // Position - 0x6B8E Hash - 0xDB9A74EC ^0x13B3F16D
{
	if (func_98(hParam0) && func_194())
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(hParam0);

	return;
}

void func_162(int iParam0) // Position - 0x6BAE Hash - 0x53643336 ^0xF32C683E
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_163(int iParam0, BOOL bParam1) // Position - 0x6BC4 Hash - 0x61515A20 ^0x61515A20
{
	if (func_45() != -1)
		return;
...
void func_164(int iParam0) // Position - 0x6BF5 Hash - 0x6CFD5248 ^0x5A80A028
{
	Ped ped;
...
void func_165(int iParam0) // Position - 0x6C39 Hash - 0xEAA35366 ^0xF96CFACE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_166(int iParam0) // Position - 0x6C4E Hash - 0xEAA35366 ^0x5C75D9EC
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_167(int iParam0) // Position - 0x6C63 Hash - 0xEAA35366 ^0x1439656C
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_168(int iParam0) // Position - 0x6C78 Hash - 0xF0369B46 ^0xC17C02F0
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_169(int iParam0) // Position - 0x6CF7 Hash - 0x287157F6 ^0x287157F6
{
...
BOOL func_170(int iParam0, int iParam1) // Position - 0x6D54 Hash - 0xECB143B0 ^0x238A26BC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_171(int iParam0, int iParam1) // Position - 0x6D6D Hash - 0xECB143B0 ^0x5DBA9B53
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_172(int iParam0, int iParam1) // Position - 0x6D86 Hash - 0x9E30ADED ^0xA0DD8460
{
...
int func_173(int iParam0) // Position - 0x6DC1 Hash - 0x1B04F1B9 ^0x527C4649
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_174(int iParam0) // Position - 0x6DD5 Hash - 0xB22D5C46 ^0xB22D5C46
{
	return;
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x6DDD Hash - 0x685DE635 ^0x335BF63C
{
	if (iParam0 == -1)
		return false;
...
int func_176(int iParam0) // Position - 0x6E04 Hash - 0x3620388 ^0x3620388
{
	return func_197(iParam0) + 30;
}

int func_177() // Position - 0x6E14 Hash - 0xE5D277D5 ^0xE5D277D5
{
	if (Global_1102813 <= 5)
...
BOOL func_178() // Position - 0x6E47 Hash - 0x9D650775 ^0xA87234F9
{
	if (Global_1048576)
		return true;
	...
	if (!func_180(Global_1051268) && Global_1572887.f_8 & 1 != 0)
		return true;

	return false;
}

struct<2> func_179() // Position - 0x6E9F Hash - 0x46B5D72E ^0x46B5D72E
{
	return Global_1051268;
}

BOOL func_180(var uParam0, var uParam1) // Position - 0x6EAD Hash - 0x53C8D2D2 ^0x6C02BA71
{
	if (!func_198(uParam0))
		return false;
...
struct<2> func_181() // Position - 0x6EE1 Hash - 0xA30248B6 ^0x10CDE073
{
...
BOOL func_182(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6F2C Hash - 0x5431B0F9 ^0x1E2109F7
{
	var unk;
	float num;
	float num2;
...
BOOL func_183(int iParam0) // Position - 0x6F5C Hash - 0xA19B21D2 ^0xA19B21D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_184(int iParam0) // Position - 0x6F6F Hash - 0x22102713 ^0x1660170E
{
	int num;
	int num2;
	int offset;
...
void func_185(var uParam0, int iParam1) // Position - 0x6F99 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_186(int iParam0) // Position - 0x6FAE Hash - 0xC37911D0 ^0x7051484B
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_187(Hash hParam0) // Position - 0x6FD2 Hash - 0x5681CDD4 ^0x5681CDD4
{
	return hParam0 != 0;
}

BOOL func_188(int iParam0) // Position - 0x6FDE Hash - 0x8858DE32 ^0x8858DE32
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_189(int iParam0, BOOL bParam1) // Position - 0x6FF4 Hash - 0xC3E950D6 ^0xC3E950D6
{
	if (!func_188(iParam0))
		return false;
...
void func_190(int iParam0, BOOL bParam1) // Position - 0x701A Hash - 0x7639AFD6 ^0x7639AFD6
{
	if (!func_188(iParam0))
		return;
...
void func_191(int iParam0, BOOL bParam1) // Position - 0x7048 Hash - 0xECD22DFB ^0xECD22DFB
{
	if (!func_188(iParam0))
		return;
...
void func_192(int iParam0) // Position - 0x7082 Hash - 0xB29062D ^0xB29062D
{
	func_203(func_202(iParam0));
	return;
}

BOOL func_193(int iParam0) // Position - 0x7094 Hash - 0xDFD519AF ^0xDFD519AF
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_194() // Position - 0x70AA Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

Ped func_195(int iParam0) // Position - 0x70B3 Hash - 0x9E175D46 ^0xBCF88463
{
	PersChar persChar;
...
BOOL func_196(int iParam0, int iParam1) // Position - 0x70E1 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_197(int iParam0) // Position - 0x70F0 Hash - 0x4BF88485 ^0x4BF88485
{
	return iParam0 * 31;
}

BOOL func_198(int iParam0) // Position - 0x70FC Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 2:
...
int func_199(int iParam0) // Position - 0x713B Hash - 0xE34A477A ^0xE34A477A
{
	switch (iParam0)
	{
		case 2:
...
void func_200(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x71D1 Hash - 0x7A16E50C ^0x7A16E50C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7C6E Hash - 0x3D2F8087 ^0xB0BC8DD5
{
	float num;
	float num2;
	float num3;
...
int func_202(int iParam0) // Position - 0x7CD4 Hash - 0x5A5E71CA ^0x5A5E71CA
{
...
void func_203(int iParam0) // Position - 0x8500 Hash - 0xE47D2A15 ^0xE47D2A15
{
